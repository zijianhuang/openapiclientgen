...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		GetInventoryLocations(limit: string, offset: string): Observable<LocationResponse> {
		 ...
		 */
		GetInventoryItems(limit: string, offset: string): Observable<InventoryItems> {
		 ...
		 */
		GetOffers(sku: string, marketplace_id: string, format: string, limit: string, offset: string): Observable<Offers> {
