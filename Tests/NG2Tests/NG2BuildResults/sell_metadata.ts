...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		GetProductAdoptionPolicies(filter: string | null | undefined, marketplace_id: string): Observable<ProductAdoptionPolicyResponse> {
			return this.http.get<ProductAdoptionPolicyResponse>(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_product_adoption_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {});
		}
