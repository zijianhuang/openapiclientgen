...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		GetAutomotivePartsCompatibilityPolicies(filter: string, marketplace_id: string): Observable<AutomotivePartsCompatibilityPolicyResponse> {
		 ...
		 */
		GetItemConditionPolicies(filter: string, marketplace_id: string): Observable<ItemConditionPolicyResponse> {
		 ...
		 */
		GetListingStructurePolicies(filter: string, marketplace_id: string): Observable<ListingStructurePolicyResponse> {
		 ...
		 */
		GetNegotiatedPricePolicies(filter: string, marketplace_id: string): Observable<NegotiatedPricePolicyResponse> {
		 ...
		 */
		GetProductAdoptionPolicies(filter: string, marketplace_id: string): Observable<ProductAdoptionPolicyResponse> {
		 ...
		 */
		GetReturnPolicies(filter: string, marketplace_id: string): Observable<ReturnPolicyResponse> {
