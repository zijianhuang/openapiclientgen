...
export namespace MyNS {
	...
	export interface CreateOffersRequest {
		...
		offerDuration?: TimeDuration | null;
		...
		offeredItems?: Array<OfferedItem> | null;
	}
	...
	export interface PagedEligibleItemCollection {
		...
		eligibleItems?: Array<EligibleItem> | null;
	...
	export class MyClient {
		 ...
		 */
		FindEligibleItems(limit: string, offset: string): Observable<PagedEligibleItemCollection> {
