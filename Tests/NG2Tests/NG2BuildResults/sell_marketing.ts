...
export namespace MyNS {
	...
	export interface BulkAdResponse {
		...
		responses?: Array<AdResponse> | null;
	}
	...
	export interface BulkCreateAdRequest {
		...
		requests?: Array<CreateAdRequest> | null;
	}
	...
	export interface BulkCreateAdsByInventoryReferenceRequest {
		...
		requests?: Array<CreateAdsByInventoryReferenceRequest> | null;
	}
	...
	export interface BulkCreateAdsByInventoryReferenceResponse {
		...
		responses?: Array<CreateAdsByInventoryReferenceResponse> | null;
	}
	...
	export interface BulkDeleteAdRequest {
		...
		requests?: Array<DeleteAdRequest> | null;
	}
	...
	export interface BulkDeleteAdResponse {
		...
		responses?: Array<DeleteAdResponse> | null;
	}
	...
	export interface BulkDeleteAdsByInventoryReferenceRequest {
		...
		requests?: Array<DeleteAdsByInventoryReferenceRequest> | null;
	}
	...
	export interface BulkDeleteAdsByInventoryReferenceResponse {
		...
		responses?: Array<DeleteAdsByInventoryReferenceResponse> | null;
	}
	...
	export interface CampaignCriterion {
		...
		selectionRules?: Array<SelectionRule> | null;
	}
	...
	export interface SelectionRule {
		...
		listingConditionIds?: Array<string> | null;
	...
	export interface CreateReportTask {
		...
		inventoryReferences?: Array<InventoryReference> | null;
	...
	export interface Dimension {
		...
		annotationKeys?: Array<string> | null;
	...
	export interface DimensionMetadata {
		...
		dimensionKeyAnnotations?: Array<DimensionKeyAnnotation> | null;
	}
	...
	export interface DiscountBenefit {
		...
		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		amountOffItem?: Amount | null;

		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		amountOffOrder?: Amount | null;
	...
	export interface DiscountRule {
		...
		discountSpecification?: DiscountSpecification | null;
	...
	export interface RuleCriteria {
		...
		excludeInventoryItems?: Array<InventoryItem> | null;
		...
		excludeListingIds?: Array<string> | null;
		...
		markupInventoryItems?: Array<InventoryItem> | null;
		...
		markupListingIds?: Array<string> | null;
	...
	export interface ItemPriceMarkdown {
		...
		selectedInventoryDiscounts?: Array<SelectedInventoryDiscount> | null;
	...
	export interface SelectedInventoryDiscount {
		...
		/** This type defines either the selections rules or the list of listing IDs for the promotion. The &quot;listing IDs&quot; are are either the seller's item IDs or the eBay listing IDs. */
		inventoryCriterion?: InventoryCriterion | null;
	...
	export interface ItemPromotion {
		...
		discountRules?: Array<DiscountRule> | null;
	...
	export interface PromotionReportDetail {
		...
		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		averageItemDiscount?: Amount | null;

		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		averageItemRevenue?: Amount | null;

		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		averageOrderDiscount?: Amount | null;

		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		averageOrderRevenue?: Amount | null;
		...
		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		promotionSale?: Amount | null;

		/** Indicates the type of the promotion, either MARKDOWN_SALE, ORDER_DISCOUNT, or VOLUME_DISCOUNT. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/PromotionTypeEnum.html'>eBay API documentation</a> */
		promotionType?: string | null;

		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		totalDiscount?: Amount | null;

		/** This type defines a monetary value as represented by a currency. The currency is normally set to the currency used on the associated eBay marketplace. */
		totalSale?: Amount | null;
	}
	...
	export interface PromotionsPagedCollection {
		...
		promotions?: Array<PromotionDetail> | null;
	...
	export interface PromotionsReportPagedCollection {
		...
		promotionReports?: Array<PromotionReportDetail> | null;
	...
	export interface ReportMetadata {
		...
		dimensionMetadata?: Array<DimensionMetadata> | null;
		...
		metricMetadata?: Array<MetricMetadata> | null;
	...
	export interface ReportMetadatas {
		...
		reportMetadata?: Array<ReportMetadata> | null;
	}
	...
	export interface ReportTaskPagedCollection {
		...
		reportTasks?: Array<ReportTask> | null;
	}
	...
	export class MyClient {
		 ...
		 * @return {BulkCreateAdsByInventoryReferenceResponse} Success
		 */
		BulkUpdateAdsBidByInventoryReference(campaign_id: string, requestBody: BulkCreateAdsByInventoryReferenceRequest): Observable<BulkCreateAdsByInventoryReferenceResponse> {
			return this.http.post<BulkCreateAdsByInventoryReferenceResponse>(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_update_ads_bid_by_inventory_reference', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {BulkAdResponse} Success
		 */
		BulkUpdateAdsBidByListingId(campaign_id: string, requestBody: BulkCreateAdRequest): Observable<BulkAdResponse> {
			return this.http.post<BulkAdResponse>(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_update_ads_bid_by_listing_id', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		GetAds(campaign_id: string, limit: string, listing_ids: string, offset: string): Observable<AdPagedCollection> {
			return this.http.get<AdPagedCollection>(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&listing_ids=' + (listing_ids == null ? '' : encodeURIComponent(listing_ids)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {});
		}
		 ...
		 */
		GetCampaigns(campaign_name: string, campaign_status: string, end_date_range: string, limit: string, offset: string, start_date_range: string): Observable<CampaignPagedCollection> {
			return this.http.get<CampaignPagedCollection>(this.baseUri + 'ad_campaign?campaign_name=' + (campaign_name == null ? '' : encodeURIComponent(campaign_name)) + '&campaign_status=' + (campaign_status == null ? '' : encodeURIComponent(campaign_status)) + '&end_date_range=' + (end_date_range == null ? '' : encodeURIComponent(end_date_range)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&start_date_range=' + (start_date_range == null ? '' : encodeURIComponent(start_date_range)), {});
		}
		 ...
		 */
		FindCampaignByAdReference(inventory_reference_id: string, inventory_reference_type: string, listing_id: string): Observable<Campaigns> {
		 ...
		 */
		GetReportTasks(limit: string, offset: string, report_task_statuses: string): Observable<ReportTaskPagedCollection> {
		 ...
		 * @return {void} 
		 */
		GetListingSet(limit: string, offset: string, promotion_id: string, q: string, sort: string, status: string): Observable<HttpResponse<string>> {
		 ...
		 */
		GetPromotions(limit: string, marketplace_id: string, offset: string, promotion_status: string, promotion_type: string, q: string, sort: string): Observable<PromotionsPagedCollection> {
		 ...
		 */
		GetPromotionReports(limit: string, marketplace_id: string, offset: string, promotion_status: string, promotion_type: string, q: string): Observable<PromotionsReportPagedCollection> {
