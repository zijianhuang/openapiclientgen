...
export namespace MyNS {
	...
	export interface AspectRecommendations {
		...
		suggestedValues?: Array<string> | null;
	}
	...
	export interface ComplianceDetail {
		...
		variation?: VariationDetails | null;
		...
		violationData?: Array<NameValueList> | null;
		...
		correctiveRecommendations?: CorrectiveRecommendations | null;
	...
	export interface VariationDetails {
		...
		variationAspects?: Array<NameValueList> | null;
	}
	...
	export interface CorrectiveRecommendations {
		...
		aspectRecommendations?: Array<AspectRecommendations> | null;
	}
	...
	export interface ComplianceSummary {
		...
		violationSummaries?: Array<ComplianceSummaryInfo> | null;
	}
	...
	export interface ComplianceViolation {
		...
		violations?: Array<ComplianceDetail> | null;
	}
	...
	export interface PagedComplianceViolationCollection {
		...
		listingViolations?: Array<ComplianceViolation> | null;
	}
	...
	export class MyClient {
		 ...
		 * @return {void} Success
		 */
		GetListingViolationsSummary(compliance_type: string): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GetListingViolations(compliance_type: string, offset: string, listing_id: string, limit: string, filter: string): Observable<HttpResponse<string>> {
