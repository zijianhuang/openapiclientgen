...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {string} shipmentId This path parameter specifies the unique eBay-assigned ID of the shipment you want to retrieve. The shipmentId value is generated and returned by a call to createFromShippingQuote.
		 ...
		 * @param {string} shipmentId This path parameter specifies the unique eBay-assigned ID of the shipment associated with the shipping label you want to download. The shipmentId value is generated and returned by a call to createFromShippingQuote.
		 * @return {void} Success
		 */
		 ...
		 * @param {string} shipmentId This path parameter specifies the unique eBay-assigned ID of the shipment to be canceled. The shipmentId value is generated and returned by a call to createFromShippingQuote.
		 * @return {Shipment} Success
		 */
		 ...
		 * Post shipping_quote
		 * @param {ShippingQuoteRequest} requestBody The request object for createShippingQuote.
		 * @return {void} 
		 */
		 ...
		 * @param {string} shippingQuoteId This path parameter specifies the unique eBay-assigned ID of the shipping quote you want to retrieve. The shippingQuoteId value is generated and returned by a call to createShippingQuote.
