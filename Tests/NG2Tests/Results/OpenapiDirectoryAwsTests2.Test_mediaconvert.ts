...
export namespace MyNS {
	...
	export interface Job {
		...
		SimulateReservedQueue?: CmafGroupSettingsClientCache;
	...
	export interface Input {
		...
		DenoiseFilter?: InputDeblockFilter;
		FileInput?: string;
	...
	export interface CmafGroupSettings {
		...
		StreamInfResolution?: CmafEncryptionSettingsInitializationVectorInManifest;

		/** When set to ENABLED, a DASH MPD manifest will be generated for this output. */
		WriteDashManifest?: CmafGroupSettingsClientCache;

		/** When set to ENABLED, an Apple HLS manifest will be generated for this output. */
		WriteHlsManifest?: CmafGroupSettingsClientCache;

		/** When you enable Precise segment duration in DASH manifests (writeSegmentTimelineInRepresentation), your DASH manifest shows precise segment durations. The segment duration information appears inside the SegmentTimeline element, inside SegmentTemplate at the Representation level. When this feature isn't enabled, the segment durations in your DASH manifest are approximate. The segment duration information appears in the duration attribute of the SegmentTemplate element. */
		WriteSegmentTimelineInRepresentation?: InputDeblockFilter;
	}
	...
	export interface HlsGroupSettings {
		...
		ProgramDateTime?: CmafEncryptionSettingsInitializationVectorInManifest;
	...
	export interface HlsEncryptionSettings {
		...
		OfflineEncrypted?: InputDeblockFilter;
	...
	export interface Eac3AtmosSettings {
		...
		DialogueIntelligence?: InputDeblockFilter;

		/** Specify the absolute peak level for a signal with dynamic range compression. */
		DynamicRangeCompressionLine?: Eac3AtmosSettingsDynamicRangeCompressionLine;

		/** Specify how the service limits the audio dynamic range when compressing the audio. */
		DynamicRangeCompressionRf?: Eac3AtmosSettingsDynamicRangeCompressionLine;
	...
	export interface Eac3Settings {
		...
		SurroundMode?: Eac3AtmosSettingsSurroundExMode;
	}
	...
	export interface ImscDestinationSettings {
		...
		StylePassthrough?: InputDeblockFilter;
	}
	...
	export interface M2tsSettings {
		...
		EsRateInPes?: CmafEncryptionSettingsInitializationVectorInManifest;
		...
		NielsenId3?: CmfcSettingsScte35Esam;
	...
	export interface M3u8Settings {
		...
		TimedMetadata?: CmfcSettingsScte35Source;
		TimedMetadataPid?: number;
		TransportStreamId?: number;
		VideoPid?: number;
	}
	...
	export interface MovSettings {
		...
		ClapAtom?: CmafEncryptionSettingsInitializationVectorInManifest;

		/** When enabled, file composition times will start at zero, composition times in the 'ctts' (composition time to sample) box for B-frames will be negative, and a 'cslg' (composition shift least greatest) box will be included per 14496-1 amendment 1. This improves compatibility with Apple players and tools. */
		CslgAtom?: CmafEncryptionSettingsInitializationVectorInManifest;
	...
	export interface Mp4Settings {
		...
		FreeSpaceBox?: CmafEncryptionSettingsInitializationVectorInManifest;
	...
	export interface HlsSettings {
		...
		IFrameOnlyManifest?: CmafEncryptionSettingsInitializationVectorInManifest;
	...
	export interface VideoDescription {
		...
		AntiAlias?: CmafGroupSettingsClientCache;
		...
		DropFrameTimecode?: CmafGroupSettingsClientCache;
		FixedAfd?: number;
		Height?: number;
	...
	export interface Av1Settings {
		...
		SpatialAdaptiveQuantization?: CmafGroupSettingsClientCache;
	}
	...
	export interface H264Settings {
		...
		FlickerAdaptiveQuantization?: CmafGroupSettingsClientCache;
		...
		GopBReference?: CmafGroupSettingsClientCache;
		...
		ParControl?: Av1SettingsFramerateControl;
		...
		RepeatPps?: CmafGroupSettingsClientCache;
		...
		SlowPal?: CmafGroupSettingsClientCache;
		Softness?: number;
		...
		TemporalAdaptiveQuantization?: CmafGroupSettingsClientCache;

		/** Inserts timecode for each frame as 4 bytes of an unregistered SEI message. */
		UnregisteredSeiTimecode?: CmafGroupSettingsClientCache;
	}
	...
	export interface H265Settings {
		...
		AlternateTransferFunctionSei?: CmafGroupSettingsClientCache;
		Bitrate?: number;
		...
		TemporalIds?: CmafGroupSettingsClientCache;

		/** Enable use of tiles, allowing horizontal as well as vertical subdivision of the encoded pictures. */
		Tiles?: CmafGroupSettingsClientCache;
	...
	export interface Mpeg2Settings {
		...
		RateControlMode?: M2tsSettingsRateMode;

		/** Enable this setting to insert I-frames at scene changes that the service automatically detects. This improves video quality and is enabled by default. */
		SceneChangeDetect?: CmafGroupSettingsClientCache;
