...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {BroadcastsGetByOffsetAndLimitAndService_idAndOn_airAndNextAndPreviousAndSortSort} sort Sort by provided query. E.g. 'start_at' sorts in ascending order, and '-start_at' sorts in descending order
		 * @return {BroadcastsResponse} OK
		 */
		BroadcastsGetByOffsetAndLimitAndService_idAndOn_airAndNextAndPreviousAndSort(offset: number | null | undefined, limit: number | null | undefined, service_id: string | null | undefined, on_air: BroadcastsGetByOffsetAndLimitAndService_idAndOn_airAndNextAndPreviousAndSortOn_air | null | undefined, next: string | null | undefined, previous: string | null | undefined, sort: BroadcastsGetByOffsetAndLimitAndService_idAndOn_airAndNextAndPreviousAndSortSort | null | undefined): Observable<BroadcastsResponse> {
	...
	export enum BroadcastsGetByOffsetAndLimitAndService_idAndOn_airAndNextAndPreviousAndSortSort { start_at = 0, '-start_at' = 1, end_at = 2, '-end_at' = 3 }
