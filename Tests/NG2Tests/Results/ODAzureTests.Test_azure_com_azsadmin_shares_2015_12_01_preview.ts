...
export namespace MyNS {
	...
	export interface Shares_ListMetricDefinitionsReturnValue {
		...
		/** Localizable string. */
		name?: Shares_ListMetricDefinitionsReturnName;
	...
	export interface Shares_ListMetricDefinitionsReturnName {
	...
	export interface Shares_ListMetricDefinitionsReturnNameFormProperties {
	...
	export function CreateShares_ListMetricDefinitionsReturnNameFormGroup() {
		return new FormGroup<Shares_ListMetricDefinitionsReturnNameFormProperties>({
	...
	export interface Shares_ListMetricsReturnValue {
		...
		/** Localizable string. */
		name?: Shares_ListMetricsReturnName;
	...
	export interface Shares_ListMetricsReturnName {
	...
	export interface Shares_ListMetricsReturnNameFormProperties {
	...
	export function CreateShares_ListMetricsReturnNameFormGroup() {
		return new FormGroup<Shares_ListMetricsReturnNameFormProperties>({
			localizedValue: new FormControl<string | null | undefined>(undefined),
			value: new FormControl<string | null | undefined>(undefined),
		});
