...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {number} limit Number of results to return per page.
		 * @param {number} offset The initial index from which to return the results.
		 * @param {GlobalWineScoreGetByWine_idAndVintageAndColorAndIs_primeursAndLwinAndLwin_11AndLimitAndOffsetAndOrderingOrdering} ordering Which field to use when ordering the results.
		 * @return {void} 
		 */
		GlobalWineScoreGetByWine_idAndVintageAndColorAndIs_primeursAndLwinAndLwin_11AndLimitAndOffsetAndOrdering(wine_id: Array<number> | null | undefined, vintage: string | null | undefined, color: ListHistoricalGWSColor | null | undefined, is_primeurs: boolean | null | undefined, lwin: string | null | undefined, lwin_11: string | null | undefined, limit: number | null | undefined, offset: number | null | undefined, ordering: GlobalWineScoreGetByWine_idAndVintageAndColorAndIs_primeursAndLwinAndLwin_11AndLimitAndOffsetAndOrderingOrdering | null | undefined): Observable<HttpResponse<string>> {
	...
	export enum GlobalWineScoreGetByWine_idAndVintageAndColorAndIs_primeursAndLwinAndLwin_11AndLimitAndOffsetAndOrderingOrdering { date = 0, '-date' = 1, score = 2, '-score' = 3 }
