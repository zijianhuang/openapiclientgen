...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {void} Success
		 */
		GET_ChangeMessageVisibility(ReceiptHandle: string, VisibilityTimeout: number, AccountNumber: number, QueueName: string, Action: GET_ChangeMessageVisibilityAction, Version: GET_ChangeMessageVisibilityVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_ChangeMessageVisibilityBatch(Entries: Array<ChangeMessageVisibilityBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: GET_ChangeMessageVisibilityBatchAction, Version: GET_ChangeMessageVisibilityBatchVersion): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ChangeMessageVisibilityBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + Action + '&Version=' + Version + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteMessage(ReceiptHandle: string, AccountNumber: number, QueueName: string, Action: GET_DeleteMessageAction, Version: GET_DeleteMessageVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DeleteMessageBatch(Entries: Array<DeleteMessageBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: GET_DeleteMessageBatchAction, Version: GET_DeleteMessageBatchVersion): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=DeleteMessageBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + Action + '&Version=' + Version + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteQueue(AccountNumber: number, QueueName: string, Action: GET_DeleteQueueAction, Version: GET_DeleteQueueVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_ListDeadLetterSourceQueues(AccountNumber: number, QueueName: string, Action: GET_ListDeadLetterSourceQueuesAction, Version: GET_ListDeadLetterSourceQueuesVersion): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ListDeadLetterSourceQueues&Action=' + Action + '&Version=' + Version + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListQueueTags(AccountNumber: number, QueueName: string, Action: GET_ListQueueTagsAction, Version: GET_ListQueueTagsVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_PurgeQueue(AccountNumber: number, QueueName: string, Action: GET_PurgeQueueAction, Version: GET_PurgeQueueVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_RemovePermission(Label: string, AccountNumber: number, QueueName: string, Action: GET_RemovePermissionAction, Version: GET_RemovePermissionVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_SendMessageBatch(Entries: Array<SendMessageBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: GET_SendMessageBatchAction, Version: GET_SendMessageBatchVersion): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=SendMessageBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + Action + '&Version=' + Version + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetQueueAttributes(Attribute: {[id: string]: string }, AccountNumber: number, QueueName: string, Action: GET_SetQueueAttributesAction, Version: GET_SetQueueAttributesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_TagQueue(Tags: {[id: string]: string }, AccountNumber: number, QueueName: string, Action: GET_TagQueueAction, Version: GET_TagQueueVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_UntagQueue(TagKeys: Array<string>, AccountNumber: number, QueueName: string, Action: GET_UntagQueueAction, Version: GET_UntagQueueVersion): Observable<HttpResponse<string>> {
	...
	export enum GET_AddPermissionVersion { _2012_11_05 = 0 }

	export enum POST_AddPermissionVersion { _2012_11_05 = 0 }

	export enum GET_ChangeMessageVisibilityAction { ChangeMessageVisibility = 0 }

	export enum GET_ChangeMessageVisibilityVersion { _2012_11_05 = 0 }

	export enum POST_ChangeMessageVisibilityVersion { _2012_11_05 = 0 }

	export enum GET_ChangeMessageVisibilityBatchAction { ChangeMessageVisibilityBatch = 0 }

	export enum GET_ChangeMessageVisibilityBatchVersion { _2012_11_05 = 0 }

	export enum POST_ChangeMessageVisibilityBatchVersion { _2012_11_05 = 0 }

	export enum GET_CreateQueueAction { CreateQueue = 0 }

	export enum GET_CreateQueueVersion { _2012_11_05 = 0 }

	export enum POST_CreateQueueVersion { _2012_11_05 = 0 }

	export enum GET_DeleteMessageAction { DeleteMessage = 0 }

	export enum GET_DeleteMessageVersion { _2012_11_05 = 0 }

	export enum POST_DeleteMessageVersion { _2012_11_05 = 0 }

	export enum GET_DeleteMessageBatchAction { DeleteMessageBatch = 0 }

	export enum GET_DeleteMessageBatchVersion { _2012_11_05 = 0 }

	export enum POST_DeleteMessageBatchVersion { _2012_11_05 = 0 }

	export enum GET_DeleteQueueAction { DeleteQueue = 0 }

	export enum GET_DeleteQueueVersion { _2012_11_05 = 0 }

	export enum POST_DeleteQueueVersion { _2012_11_05 = 0 }

	export enum GET_GetQueueAttributesAction { GetQueueAttributes = 0 }

	export enum GET_GetQueueAttributesVersion { _2012_11_05 = 0 }

	export enum POST_GetQueueAttributesVersion { _2012_11_05 = 0 }

	export enum GET_GetQueueUrlAction { GetQueueUrl = 0 }

	export enum GET_GetQueueUrlVersion { _2012_11_05 = 0 }

	export enum POST_GetQueueUrlVersion { _2012_11_05 = 0 }

	export enum GET_ListDeadLetterSourceQueuesAction { ListDeadLetterSourceQueues = 0 }

	export enum GET_ListDeadLetterSourceQueuesVersion { _2012_11_05 = 0 }

	export enum POST_ListDeadLetterSourceQueuesVersion { _2012_11_05 = 0 }

	export enum GET_ListQueueTagsAction { ListQueueTags = 0 }

	export enum GET_ListQueueTagsVersion { _2012_11_05 = 0 }

	export enum POST_ListQueueTagsVersion { _2012_11_05 = 0 }

	export enum GET_ListQueuesAction { ListQueues = 0 }

	export enum GET_ListQueuesVersion { _2012_11_05 = 0 }

	export enum POST_ListQueuesVersion { _2012_11_05 = 0 }

	export enum GET_PurgeQueueAction { PurgeQueue = 0 }

	export enum GET_PurgeQueueVersion { _2012_11_05 = 0 }

	export enum POST_PurgeQueueVersion { _2012_11_05 = 0 }

	export enum GET_ReceiveMessageAction { ReceiveMessage = 0 }

	export enum GET_ReceiveMessageVersion { _2012_11_05 = 0 }

	export enum POST_ReceiveMessageVersion { _2012_11_05 = 0 }

	export enum GET_RemovePermissionAction { RemovePermission = 0 }

	export enum GET_RemovePermissionVersion { _2012_11_05 = 0 }

	export enum POST_RemovePermissionVersion { _2012_11_05 = 0 }

	export enum GET_SendMessageAction { SendMessage = 0 }

	export enum GET_SendMessageVersion { _2012_11_05 = 0 }

	export enum POST_SendMessageVersion { _2012_11_05 = 0 }

	export enum GET_SendMessageBatchAction { SendMessageBatch = 0 }

	export enum GET_SendMessageBatchVersion { _2012_11_05 = 0 }

	export enum POST_SendMessageBatchVersion { _2012_11_05 = 0 }

	export enum GET_SetQueueAttributesAction { SetQueueAttributes = 0 }

	export enum GET_SetQueueAttributesVersion { _2012_11_05 = 0 }

	export enum POST_SetQueueAttributesVersion { _2012_11_05 = 0 }

	export enum GET_TagQueueAction { TagQueue = 0 }

	export enum GET_TagQueueVersion { _2012_11_05 = 0 }

	export enum POST_TagQueueVersion { _2012_11_05 = 0 }

	export enum GET_UntagQueueAction { UntagQueue = 0 }

	export enum GET_UntagQueueVersion { _2012_11_05 = 0 }

	export enum POST_UntagQueueVersion { _2012_11_05 = 0 }
