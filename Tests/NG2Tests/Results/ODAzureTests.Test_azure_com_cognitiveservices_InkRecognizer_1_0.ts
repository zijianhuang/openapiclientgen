...
export namespace MyNS {
	...
	export enum AnalysisRequestInputDeviceKind { digitizer = 0, pen = 1, lightPen = 2, touchScreen = 3, touchPad = 4, whiteBoard = 5, _3dDigitizer = 6, stereoPlotter = 7, articulatedArm = 8, armature = 9 }
	...
	export interface AnalysisResponseRecognitionUnits {
		...
		AnalysisResponseRecognitionUnitsAlternates?: Array<AnalysisResponseRecognitionUnitsAlternates>;
		...
		boundingRectangle?: AnalysisResponseBoundingRectangle;
	...
	export interface AnalysisResponseRecognitionUnitsAlternates {
	...
	export interface AnalysisResponseRecognitionUnitsAlternatesFormProperties {
	...
	export function CreateAnalysisResponseRecognitionUnitsAlternatesFormGroup() {
		return new FormGroup<AnalysisResponseRecognitionUnitsAlternatesFormProperties>({
			category: new FormControl<AlternatePatternElementCategory | null | undefined>(undefined, [Validators.required]),
			confidence: new FormControl<number | null | undefined>(undefined),
			recognizedString: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rotationAngle: new FormControl<number | null | undefined>(undefined),
	...
	export interface AnalysisResponseBoundingRectangle {
	...
	export interface AnalysisResponseBoundingRectangleFormProperties {
	...
	export function CreateAnalysisResponseBoundingRectangleFormGroup() {
		return new FormGroup<AnalysisResponseBoundingRectangleFormProperties>({
			height: new FormControl<number | null | undefined>(undefined),
	...
	export interface RecognitionUnitElement {
		...
		/** The list of alternates for the core recognition result. In case of handwriting related recognition units, this list includes other words that are close possibilities to the results provided as 'recognizedText'. */
		RecognitionUnitElementAlternates?: Array<RecognitionUnitElementAlternates>;
	...
	export interface RecognitionUnitElementAlternates {
	...
	export interface RecognitionUnitElementAlternatesFormProperties {
	...
	export function CreateRecognitionUnitElementAlternatesFormGroup() {
		return new FormGroup<RecognitionUnitElementAlternatesFormProperties>({
			category: new FormControl<AlternatePatternElementCategory | null | undefined>(undefined, [Validators.required]),
			confidence: new FormControl<number | null | undefined>(undefined),
			recognizedString: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rotationAngle: new FormControl<number | null | undefined>(undefined),
