...
export namespace MyNS {
	...
	export interface KpiThresholdsFormProperties {
		 ...
		 * Required
		 */
		lowerLimit: FormControl<string | null | undefined>,

		/**
		 * The upper threshold limit.
		 * Required
		 */
		upperLimit: FormControl<string | null | undefined>,
	}
	export function CreateKpiThresholdsFormGroup() {
		return new FormGroup<KpiThresholdsFormProperties>({
			...
			lowerLimit: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			upperLimit: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
