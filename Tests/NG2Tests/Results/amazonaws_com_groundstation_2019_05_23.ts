...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {ConfigIdResponse} Success
		 */
		DeleteConfig(configId: string, configType: ConfigIdResponseConfigType): Observable<ConfigIdResponse> {
		 ...
		 */
		GetConfig(configId: string, configType: ConfigIdResponseConfigType): Observable<GetConfigResponse> {
		 ...
		 * @return {ConfigIdResponse} Success
		 */
		UpdateConfig(configId: string, configType: ConfigIdResponseConfigType, requestBody: UpdateConfigPutBody): Observable<ConfigIdResponse> {
