...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {AutoProvisioningSettings_GetApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} settingName Auto provisioning setting key
		 * @return {AutoProvisioningSetting} OK
		 */
		AutoProvisioningSettings_Get(api_version: AutoProvisioningSettings_GetApi_version, subscriptionId: string, settingName: string): Observable<AutoProvisioningSetting> {
		 ...
		 * @param {AutoProvisioningSettings_CreateApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} settingName Auto provisioning setting key
		 * @param {AutoProvisioningSetting} requestBody Auto provisioning setting key
		 * @return {AutoProvisioningSetting} OK
		 */
		AutoProvisioningSettings_Create(api_version: AutoProvisioningSettings_CreateApi_version, subscriptionId: string, settingName: string, requestBody: AutoProvisioningSetting): Observable<AutoProvisioningSetting> {
		 ...
		 * @param {Pricings_ListApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @return {PricingList} OK
		 */
		Pricings_List(api_version: Pricings_ListApi_version, subscriptionId: string): Observable<PricingList> {
		 ...
		 * @param {Pricings_GetSubscriptionPricingApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} pricingName name of the pricing configuration
		 * @return {Pricing} OK
		 */
		Pricings_GetSubscriptionPricing(api_version: Pricings_GetSubscriptionPricingApi_version, subscriptionId: string, pricingName: string): Observable<Pricing> {
		 ...
		 * @param {Pricings_UpdateSubscriptionPricingApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} pricingName name of the pricing configuration
		 * @param {Pricing} requestBody Pricing object
		 * @return {Pricing} OK
		 */
		Pricings_UpdateSubscriptionPricing(api_version: Pricings_UpdateSubscriptionPricingApi_version, subscriptionId: string, pricingName: string, requestBody: Pricing): Observable<Pricing> {
		 ...
		 * @param {SecurityContacts_ListApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @return {SecurityContactList} OK
		 */
		SecurityContacts_List(api_version: SecurityContacts_ListApi_version, subscriptionId: string): Observable<SecurityContactList> {
		 ...
		 * @param {SecurityContacts_GetApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} securityContactName Name of the security contact object
		 * @return {SecurityContact} OK
		 */
		SecurityContacts_Get(api_version: SecurityContacts_GetApi_version, subscriptionId: string, securityContactName: string): Observable<SecurityContact> {
		 ...
		 * @param {SecurityContacts_CreateApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} securityContactName Name of the security contact object
		 * @param {SecurityContact} requestBody Security contact object
		 * @return {SecurityContact} OK
		 */
		SecurityContacts_Create(api_version: SecurityContacts_CreateApi_version, subscriptionId: string, securityContactName: string, requestBody: SecurityContact): Observable<SecurityContact> {
		 ...
		 * @param {SecurityContacts_DeleteApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} securityContactName Name of the security contact object
		 * @return {void} 
		 */
		SecurityContacts_Delete(api_version: SecurityContacts_DeleteApi_version, subscriptionId: string, securityContactName: string): Observable<HttpResponse<string>> {
		 ...
		 * @param {SecurityContacts_UpdateApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} securityContactName Name of the security contact object
		 * @param {SecurityContact} requestBody Security contact object
		 * @return {SecurityContact} OK
		 */
		SecurityContacts_Update(api_version: SecurityContacts_UpdateApi_version, subscriptionId: string, securityContactName: string, requestBody: SecurityContact): Observable<SecurityContact> {
		 ...
		 * @param {Settings_ListApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @return {SettingsList} OK
		 */
		Settings_List(api_version: Settings_ListApi_version, subscriptionId: string): Observable<SettingsList> {
		 ...
		 * @param {Settings_GetApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {Settings_GetSettingName} settingName Name of setting: (MCAS/WDATP)
		 * @return {Setting} OK
		 */
		Settings_Get(api_version: Settings_GetApi_version, subscriptionId: string, settingName: Settings_GetSettingName): Observable<Setting> {
		 ...
		 * @param {Settings_UpdateApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {Settings_GetSettingName} settingName Name of setting: (MCAS/WDATP)
		 * @param {Setting} requestBody Setting object
		 * @return {Setting} OK
		 */
		Settings_Update(api_version: Settings_UpdateApi_version, subscriptionId: string, settingName: Settings_GetSettingName, requestBody: Setting): Observable<Setting> {
		 ...
		 * @param {WorkspaceSettings_ListApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @return {WorkspaceSettingList} OK
		 */
		WorkspaceSettings_List(api_version: WorkspaceSettings_ListApi_version, subscriptionId: string): Observable<WorkspaceSettingList> {
		 ...
		 * @param {WorkspaceSettings_GetApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} workspaceSettingName Name of the security setting
		 * @return {WorkspaceSetting} OK
		 */
		WorkspaceSettings_Get(api_version: WorkspaceSettings_GetApi_version, subscriptionId: string, workspaceSettingName: string): Observable<WorkspaceSetting> {
		 ...
		 * @param {WorkspaceSettings_CreateApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} workspaceSettingName Name of the security setting
		 * @param {WorkspaceSetting} requestBody Security data setting object
		 * @return {WorkspaceSetting} OK
		 */
		WorkspaceSettings_Create(api_version: WorkspaceSettings_CreateApi_version, subscriptionId: string, workspaceSettingName: string, requestBody: WorkspaceSetting): Observable<WorkspaceSetting> {
		 ...
		 * @param {WorkspaceSettings_DeleteApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} workspaceSettingName Name of the security setting
		 * @return {void} 
		 */
		WorkspaceSettings_Delete(api_version: WorkspaceSettings_DeleteApi_version, subscriptionId: string, workspaceSettingName: string): Observable<HttpResponse<string>> {
		 ...
		 * @param {WorkspaceSettings_UpdateApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} workspaceSettingName Name of the security setting
		 * @param {WorkspaceSetting} requestBody Security data setting object
		 * @return {WorkspaceSetting} OK
		 */
		WorkspaceSettings_Update(api_version: WorkspaceSettings_UpdateApi_version, subscriptionId: string, workspaceSettingName: string, requestBody: WorkspaceSetting): Observable<WorkspaceSetting> {
		 ...
		 * @param {Pricings_ListByResourceGroupApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 ...
		 * @return {PricingList} OK
		 */
		Pricings_ListByResourceGroup(api_version: Pricings_ListByResourceGroupApi_version, subscriptionId: string, resourceGroupName: string): Observable<PricingList> {
		 ...
		 * @param {Pricings_GetResourceGroupPricingApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} resourceGroupName The name of the resource group within the user's subscription. The name is case insensitive.
		 * @param {string} pricingName name of the pricing configuration
		 * @return {Pricing} OK
		 */
		Pricings_GetResourceGroupPricing(api_version: Pricings_GetResourceGroupPricingApi_version, subscriptionId: string, resourceGroupName: string, pricingName: string): Observable<Pricing> {
		 ...
		 * @param {Pricings_CreateOrUpdateResourceGroupPricingApi_version} api_version API version for the operation
		 * @param {string} subscriptionId Azure subscription ID
		 * @param {string} resourceGroupName The name of the resource group within the user's subscription. The name is case insensitive.
		 * @param {string} pricingName name of the pricing configuration
		 * @param {Pricing} requestBody Pricing object
		 * @return {Pricing} OK
		 */
		Pricings_CreateOrUpdateResourceGroupPricing(api_version: Pricings_CreateOrUpdateResourceGroupPricingApi_version, subscriptionId: string, resourceGroupName: string, pricingName: string, requestBody: Pricing): Observable<Pricing> {
		 ...
		 * @param {AdvancedThreatProtection_GetApi_version} api_version API version for the operation
		 ...
		 */
		AdvancedThreatProtection_Get(api_version: AdvancedThreatProtection_GetApi_version, resourceId: string, settingName: AdvancedThreatProtection_GetSettingName): Observable<AdvancedThreatProtectionSetting> {
		 ...
		 * @param {AdvancedThreatProtection_CreateApi_version} api_version API version for the operation
		 * @param {string} resourceId The identifier of the resource.
		 * @param {AdvancedThreatProtection_GetSettingName} settingName Advanced Threat Protection setting name.
		 ...
		 */
		AdvancedThreatProtection_Create(api_version: AdvancedThreatProtection_CreateApi_version, resourceId: string, settingName: AdvancedThreatProtection_GetSettingName, requestBody: AdvancedThreatProtectionSetting): Observable<AdvancedThreatProtectionSetting> {
		 ...
		 * @param {Compliances_ListApi_version} api_version API version for the operation
		 ...
		 */
		Compliances_List(api_version: Compliances_ListApi_version, scope: string): Observable<ComplianceList> {
		 ...
		 * @param {Compliances_GetApi_version} api_version API version for the operation
		 * @param {string} scope Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).
		 * @param {string} complianceName name of the Compliance
		 * @return {Compliance} OK
		 */
		Compliances_Get(api_version: Compliances_GetApi_version, scope: string, complianceName: string): Observable<Compliance> {
		 ...
		 * @param {InformationProtectionPolicies_ListApi_version} api_version API version for the operation
		 * @param {string} scope Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).
		 * @return {InformationProtectionPolicyList} OK
		 */
		InformationProtectionPolicies_List(api_version: InformationProtectionPolicies_ListApi_version, scope: string): Observable<InformationProtectionPolicyList> {
		 ...
		 * @param {InformationProtectionPolicies_GetApi_version} api_version API version for the operation
		 * @param {string} scope Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).
		 ...
		 */
		InformationProtectionPolicies_Get(api_version: InformationProtectionPolicies_GetApi_version, scope: string, informationProtectionPolicyName: InformationProtectionPolicies_GetInformationProtectionPolicyName): Observable<InformationProtectionPolicy> {
		 ...
		 * @param {InformationProtectionPolicies_CreateOrUpdateApi_version} api_version API version for the operation
		 * @param {string} scope Scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group (/providers/Microsoft.Management/managementGroups/mgName).
		 * @param {InformationProtectionPolicies_GetInformationProtectionPolicyName} informationProtectionPolicyName Name of the information protection policy.
		 * @return {InformationProtectionPolicy} OK
		 */
		InformationProtectionPolicies_CreateOrUpdate(api_version: InformationProtectionPolicies_CreateOrUpdateApi_version, scope: string, informationProtectionPolicyName: InformationProtectionPolicies_GetInformationProtectionPolicyName): Observable<InformationProtectionPolicy> {
	...
	export enum AutoProvisioningSettings_ListApi_version { _2017_08_01_preview = 0 }

	export enum AutoProvisioningSettings_GetApi_version { _2017_08_01_preview = 0 }

	export enum AutoProvisioningSettings_CreateApi_version { _2017_08_01_preview = 0 }

	export enum Pricings_ListApi_version { _2017_08_01_preview = 0 }

	export enum Pricings_GetSubscriptionPricingApi_version { _2017_08_01_preview = 0 }

	export enum Pricings_UpdateSubscriptionPricingApi_version { _2017_08_01_preview = 0 }

	export enum SecurityContacts_ListApi_version { _2017_08_01_preview = 0 }

	export enum SecurityContacts_GetApi_version { _2017_08_01_preview = 0 }

	export enum SecurityContacts_CreateApi_version { _2017_08_01_preview = 0 }

	export enum SecurityContacts_DeleteApi_version { _2017_08_01_preview = 0 }

	export enum SecurityContacts_UpdateApi_version { _2017_08_01_preview = 0 }

	export enum Settings_ListApi_version { _2017_08_01_preview = 0 }

	export enum Settings_GetApi_version { _2017_08_01_preview = 0 }

	export enum Settings_GetSettingName { MCAS = 0, WDATP = 1 }

	export enum Settings_UpdateApi_version { _2017_08_01_preview = 0 }

	export enum WorkspaceSettings_ListApi_version { _2017_08_01_preview = 0 }

	export enum WorkspaceSettings_GetApi_version { _2017_08_01_preview = 0 }

	export enum WorkspaceSettings_CreateApi_version { _2017_08_01_preview = 0 }

	export enum WorkspaceSettings_DeleteApi_version { _2017_08_01_preview = 0 }

	export enum WorkspaceSettings_UpdateApi_version { _2017_08_01_preview = 0 }

	export enum Pricings_ListByResourceGroupApi_version { _2017_08_01_preview = 0 }

	export enum Pricings_GetResourceGroupPricingApi_version { _2017_08_01_preview = 0 }

	export enum Pricings_CreateOrUpdateResourceGroupPricingApi_version { _2017_08_01_preview = 0 }

	export enum AdvancedThreatProtection_GetApi_version { _2017_08_01_preview = 0 }

	export enum AdvancedThreatProtection_GetSettingName { current = 0 }

	export enum AdvancedThreatProtection_CreateApi_version { _2017_08_01_preview = 0 }

	export enum Compliances_ListApi_version { _2017_08_01_preview = 0 }

	export enum Compliances_GetApi_version { _2017_08_01_preview = 0 }

	export enum InformationProtectionPolicies_ListApi_version { _2017_08_01_preview = 0 }

	export enum InformationProtectionPolicies_GetApi_version { _2017_08_01_preview = 0 }

	export enum InformationProtectionPolicies_GetInformationProtectionPolicyName { effective = 0, custom = 1 }

	export enum InformationProtectionPolicies_CreateOrUpdateApi_version { _2017_08_01_preview = 0 }
