...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {IoTSpaces_ListApi_version} api_version The version of the API.
		 ...
		 */
		IoTSpaces_List(api_version: IoTSpaces_ListApi_version, subscriptionId: string): Observable<IoTSpacesDescriptionListResult> {
		 ...
		 * @param {IoTSpaces_CheckNameAvailabilityApi_version} api_version The version of the API.
		 * @param {string} subscriptionId The subscription identifier.
		 ...
		 */
		IoTSpaces_CheckNameAvailability(api_version: IoTSpaces_CheckNameAvailabilityApi_version, subscriptionId: string, requestBody: OperationInputs): Observable<IoTSpacesNameAvailabilityInfo> {
		 ...
		 * @param {IoTSpaces_ListByResourceGroupApi_version} api_version The version of the API.
		 * @param {string} subscriptionId The subscription identifier.
		 ...
		 */
		IoTSpaces_ListByResourceGroup(api_version: IoTSpaces_ListByResourceGroupApi_version, subscriptionId: string, resourceGroupName: string): Observable<IoTSpacesDescriptionListResult> {
		 ...
		 * @param {IoTSpaces_GetApi_version} api_version The version of the API.
		 * @param {string} subscriptionId The subscription identifier.
		 * @param {string} resourceGroupName The name of the resource group that contains the IoTSpaces instance.
		 ...
		 */
		IoTSpaces_Get(api_version: IoTSpaces_GetApi_version, subscriptionId: string, resourceGroupName: string, resourceName: string): Observable<IoTSpacesDescription> {
		 ...
		 * @param {IoTSpaces_CreateOrUpdateApi_version} api_version The version of the API.
		 * @param {string} subscriptionId The subscription identifier.
		 * @param {string} resourceGroupName The name of the resource group that contains the IoTSpaces instance.
		 * @param {string} resourceName The name of the IoTSpaces instance.
		 ...
		 */
		IoTSpaces_CreateOrUpdate(api_version: IoTSpaces_CreateOrUpdateApi_version, subscriptionId: string, resourceGroupName: string, resourceName: string, requestBody: IoTSpacesDescription): Observable<IoTSpacesDescription> {
		 ...
		 * @param {IoTSpaces_DeleteApi_version} api_version The version of the API.
		 * @param {string} subscriptionId The subscription identifier.
		 * @param {string} resourceGroupName The name of the resource group that contains the IoTSpaces instance.
		 * @param {string} resourceName The name of the IoTSpaces instance.
		 ...
		 */
		IoTSpaces_Delete(api_version: IoTSpaces_DeleteApi_version, subscriptionId: string, resourceGroupName: string, resourceName: string): Observable<IoTSpacesDescription> {
		 ...
		 * @param {IoTSpaces_UpdateApi_version} api_version The version of the API.
		 * @param {string} subscriptionId The subscription identifier.
		 * @param {string} resourceGroupName The name of the resource group that contains the IoTSpaces instance.
		 * @param {string} resourceName The name of the IoTSpaces instance.
		 ...
		 * @return {IoTSpacesDescription} This is returned as a response to the status polling request for the create or update operation. The body contains the resource representation that indicates a transitional provisioning state.
		 */
		IoTSpaces_Update(api_version: IoTSpaces_UpdateApi_version, subscriptionId: string, resourceGroupName: string, resourceName: string, requestBody: IoTSpacesPatchDescription): Observable<IoTSpacesDescription> {
			return this.http.patch<IoTSpacesDescription>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.IoTSpaces/Graph/' + (resourceName == null ? '' : encodeURIComponent(resourceName)) + '?api_version=' + api_version, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}

	export enum Operations_ListApi_version { _2017_10_01_preview = 0 }

	export enum IoTSpaces_ListApi_version { _2017_10_01_preview = 0 }

	export enum IoTSpaces_CheckNameAvailabilityApi_version { _2017_10_01_preview = 0 }

	export enum IoTSpaces_ListByResourceGroupApi_version { _2017_10_01_preview = 0 }

	export enum IoTSpaces_GetApi_version { _2017_10_01_preview = 0 }

	export enum IoTSpaces_CreateOrUpdateApi_version { _2017_10_01_preview = 0 }

	export enum IoTSpaces_DeleteApi_version { _2017_10_01_preview = 0 }

	export enum IoTSpaces_UpdateApi_version { _2017_10_01_preview = 0 }
