...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {ApplicationTypes_GetApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {ApplicationTypeResource} The operation completed successfully.
		 */
		ApplicationTypes_Get(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationTypeName: string, api_version: ApplicationTypes_GetApi_version): Observable<ApplicationTypeResource> {
		 ...
		 * @param {string} clusterName The name of the cluster resource.
		 * @param {string} applicationTypeName The name of the application type name resource.
		 * @param {ApplicationTypes_CreateOrUpdateApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @param {ApplicationTypeResource} requestBody The application type name resource.
		 * @return {ApplicationTypeResource} The operation completed successfully.
		 */
		ApplicationTypes_CreateOrUpdate(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationTypeName: string, api_version: ApplicationTypes_CreateOrUpdateApi_version, requestBody: ApplicationTypeResource): Observable<ApplicationTypeResource> {
		 ...
		 * @param {string} clusterName The name of the cluster resource.
		 * @param {string} applicationTypeName The name of the application type name resource.
		 * @param {ApplicationTypes_DeleteApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {void} 
		 */
		ApplicationTypes_Delete(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationTypeName: string, api_version: ApplicationTypes_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} clusterName The name of the cluster resource.
		 * @param {string} applicationTypeName The name of the application type name resource.
		 * @param {ApplicationTypeVersions_ListApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {ApplicationTypeVersionResourceList} The operation completed successfully.
		 */
		ApplicationTypeVersions_List(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationTypeName: string, api_version: ApplicationTypeVersions_ListApi_version): Observable<ApplicationTypeVersionResourceList> {
		 ...
		 * @param {ApplicationTypeVersions_GetApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {ApplicationTypeVersionResource} The operation completed successfully.
		 */
		ApplicationTypeVersions_Get(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationTypeName: string, version: string, api_version: ApplicationTypeVersions_GetApi_version): Observable<ApplicationTypeVersionResource> {
		 ...
		 * @param {string} applicationTypeName The name of the application type name resource.
		 * @param {string} version The application type version.
		 * @param {ApplicationTypeVersions_CreateOrUpdateApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @param {ApplicationTypeVersionResource} requestBody The application type version resource.
		 * @return {void} 
		 */
		ApplicationTypeVersions_CreateOrUpdate(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationTypeName: string, version: string, api_version: ApplicationTypeVersions_CreateOrUpdateApi_version, requestBody: ApplicationTypeVersionResource): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} applicationTypeName The name of the application type name resource.
		 * @param {string} version The application type version.
		 * @param {ApplicationTypeVersions_DeleteApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {void} 
		 */
		ApplicationTypeVersions_Delete(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationTypeName: string, version: string, api_version: ApplicationTypeVersions_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} resourceGroupName The name of the resource group.
		 * @param {string} clusterName The name of the cluster resource.
		 * @param {Applications_ListApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {ApplicationResourceList} The operation completed successfully.
		 */
		Applications_List(subscriptionId: string, resourceGroupName: string, clusterName: string, api_version: Applications_ListApi_version): Observable<ApplicationResourceList> {
		 ...
		 * @param {Applications_GetApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {ApplicationResource} The operation completed successfully.
		 */
		Applications_Get(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, api_version: Applications_GetApi_version): Observable<ApplicationResource> {
		 ...
		 * @param {string} clusterName The name of the cluster resource.
		 * @param {string} applicationName The name of the application resource.
		 * @param {Applications_CreateOrUpdateApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @param {ApplicationResource} requestBody The application resource.
		 * @return {void} 
		 */
		Applications_CreateOrUpdate(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, api_version: Applications_CreateOrUpdateApi_version, requestBody: ApplicationResource): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} clusterName The name of the cluster resource.
		 * @param {string} applicationName The name of the application resource.
		 * @param {Applications_DeleteApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {void} 
		 */
		Applications_Delete(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, api_version: Applications_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} clusterName The name of the cluster resource.
		 * @param {string} applicationName The name of the application resource.
		 * @param {Applications_UpdateApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @param {ApplicationResourceUpdate} requestBody The application resource for patch operations.
		 * @return {void} 
		 */
		Applications_Update(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, api_version: Applications_UpdateApi_version, requestBody: ApplicationResourceUpdate): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} clusterName The name of the cluster resource.
		 * @param {string} applicationName The name of the application resource.
		 * @param {Services_ListApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {ServiceResourceList} The operation completed successfully.
		 */
		Services_List(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, api_version: Services_ListApi_version): Observable<ServiceResourceList> {
		 ...
		 * @param {Services_GetApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {ServiceResource} The operation completed successfully.
		 */
		Services_Get(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, serviceName: string, api_version: Services_GetApi_version): Observable<ServiceResource> {
		 ...
		 * @param {string} applicationName The name of the application resource.
		 * @param {string} serviceName The name of the service resource in the format of {applicationName}~{serviceName}.
		 * @param {Services_CreateOrUpdateApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @param {ServiceResource} requestBody The service resource.
		 * @return {void} 
		 */
		Services_CreateOrUpdate(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, serviceName: string, api_version: Services_CreateOrUpdateApi_version, requestBody: ServiceResource): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} applicationName The name of the application resource.
		 * @param {string} serviceName The name of the service resource in the format of {applicationName}~{serviceName}.
		 * @param {Services_DeleteApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @return {void} 
		 */
		Services_Delete(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, serviceName: string, api_version: Services_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} applicationName The name of the application resource.
		 * @param {string} serviceName The name of the service resource in the format of {applicationName}~{serviceName}.
		 * @param {Services_UpdateApi_version} api_version The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01" for this specification.
		 * @param {ServiceResourceUpdate} requestBody The service resource for patch operations.
		 * @return {void} 
		 */
		Services_Update(subscriptionId: string, resourceGroupName: string, clusterName: string, applicationName: string, serviceName: string, api_version: Services_UpdateApi_version, requestBody: ServiceResourceUpdate): Observable<HttpResponse<string>> {
			return this.http.patch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ServiceFabric/clusters/' + (clusterName == null ? '' : encodeURIComponent(clusterName)) + '/applications/' + (applicationName == null ? '' : encodeURIComponent(applicationName)) + '/services/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '&api_version=' + api_version, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export enum ApplicationTypes_ListApi_version { _2019_03_01 = 0 }

	export enum ApplicationTypes_GetApi_version { _2019_03_01 = 0 }

	export enum ApplicationTypes_CreateOrUpdateApi_version { _2019_03_01 = 0 }

	export enum ApplicationTypes_DeleteApi_version { _2019_03_01 = 0 }

	export enum ApplicationTypeVersions_ListApi_version { _2019_03_01 = 0 }

	export enum ApplicationTypeVersions_GetApi_version { _2019_03_01 = 0 }

	export enum ApplicationTypeVersions_CreateOrUpdateApi_version { _2019_03_01 = 0 }

	export enum ApplicationTypeVersions_DeleteApi_version { _2019_03_01 = 0 }

	export enum Applications_ListApi_version { _2019_03_01 = 0 }

	export enum Applications_GetApi_version { _2019_03_01 = 0 }

	export enum Applications_CreateOrUpdateApi_version { _2019_03_01 = 0 }

	export enum Applications_DeleteApi_version { _2019_03_01 = 0 }

	export enum Applications_UpdateApi_version { _2019_03_01 = 0 }

	export enum Services_ListApi_version { _2019_03_01 = 0 }

	export enum Services_GetApi_version { _2019_03_01 = 0 }

	export enum Services_CreateOrUpdateApi_version { _2019_03_01 = 0 }

	export enum Services_DeleteApi_version { _2019_03_01 = 0 }

	export enum Services_UpdateApi_version { _2019_03_01 = 0 }
