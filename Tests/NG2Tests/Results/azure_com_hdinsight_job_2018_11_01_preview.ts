...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Job_Get(user_name: string, jobId: string, fields: Job_ListFields): Observable<JobDetailRootJsonObject> {
		 ...
		 * @return {Array<JobListJsonObject>} OK response definition.
		 */
		Job_ListAfterJobId(user_name: string, jobid: string | null | undefined, numrecords: number | null | undefined, showall: Job_ListShowall, fields: Job_ListFields): Observable<Array<JobListJsonObject>> {
