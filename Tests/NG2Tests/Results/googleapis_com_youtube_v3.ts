...
export namespace MyNS {
	...
	export enum CdnSettingsResolution { '1080p' = 0, '1440p' = 1, '2160p' = 2, '240p' = 3, '360p' = 4, '480p' = 5, '720p' = 6, variable = 7 }
	...
	export enum Youtube_search_listVideoDimension { '2d' = 0, '3d' = 1, any = 2 }
