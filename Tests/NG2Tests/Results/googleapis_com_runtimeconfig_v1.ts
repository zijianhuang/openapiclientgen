...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Runtimeconfig_operations_delete(name: string): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Successful response
		 */
		Runtimeconfig_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Successful response
		 */
		Runtimeconfig_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<HttpResponse<string>> {
