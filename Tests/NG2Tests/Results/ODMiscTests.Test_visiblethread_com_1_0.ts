...
export namespace MyNS {
	...
	export interface DocumentResponseDetailedStats {
	...
	export interface DocumentResponseDetailedStatsFormProperties {
	}
	export function CreateDocumentResponseDetailedStatsFormGroup() {
		return new FormGroup<DocumentResponseDetailedStatsFormProperties>({
		});
	...
	export interface WebUrlDetailStats {
		adverbs?: Array<Array<AdverbsElement>>;
		hiddenVerbs?: Array<Array<HiddenVerbsElement>>;
		longSentences?: Array<Array<LongSentencesElement>>;
		passives?: Array<Array<PassivesElement>>;
	...
	export interface WebUrlDetailStatsFormProperties {
	}
	export function CreateWebUrlDetailStatsFormGroup() {
		return new FormGroup<WebUrlDetailStatsFormProperties>({
		});
