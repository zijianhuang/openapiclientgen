...
export namespace MyNS {
	...
	export class MyClient {
		...
		LocationBasedRecommendedActionSessionsOperationStatus_Get(api_version: string, subscriptionId: string, locationName: string, operationId: string): Observable<RecommendedActionSessionsOperationStatus> {
			return this.http.get<RecommendedActionSessionsOperationStatus>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.DBforMariaDB/locations/' + (locationName == null ? '' : encodeURIComponent(locationName)) + '/recommendedActionSessionsAzureAsyncOperation/' + (operationId == null ? '' : encodeURIComponent(operationId)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		LocationBasedRecommendedActionSessionsResult_List(api_version: string, subscriptionId: string, locationName: string, operationId: string): Observable<RecommendationActionsResultList> {
			return this.http.get<RecommendationActionsResultList>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.DBforMariaDB/locations/' + (locationName == null ? '' : encodeURIComponent(locationName)) + '/recommendedActionSessionsOperationResults/' + (operationId == null ? '' : encodeURIComponent(operationId)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		Advisors_ListByServer(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string): Observable<AdvisorsResultList> {
			return this.http.get<AdvisorsResultList>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/advisors?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		Advisors_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string, advisorName: string): Observable<Advisor> {
			return this.http.get<Advisor>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/advisors/' + (advisorName == null ? '' : encodeURIComponent(advisorName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		CreateRecommendedActionSession(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string, advisorName: string, databaseName: string): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/advisors/' + (advisorName == null ? '' : encodeURIComponent(advisorName)) + '/createRecommendedActionSession?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&databaseName=' + (databaseName == null ? '' : encodeURIComponent(databaseName)), null, { observe: 'response', responseType: 'text' });
		}
		...
		RecommendedActions_ListByServer(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string, advisorName: string, sessionId: string | null | undefined): Observable<RecommendationActionsResultList> {
			return this.http.get<RecommendationActionsResultList>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/advisors/' + (advisorName == null ? '' : encodeURIComponent(advisorName)) + '/recommendedActions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&sessionId=' + (sessionId == null ? '' : encodeURIComponent(sessionId)), {});
		}
		...
		RecommendedActions_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string, advisorName: string, recommendedActionName: string): Observable<RecommendationAction> {
			return this.http.get<RecommendationAction>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/advisors/' + (advisorName == null ? '' : encodeURIComponent(advisorName)) + '/recommendedActions/' + (recommendedActionName == null ? '' : encodeURIComponent(recommendedActionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
	}
