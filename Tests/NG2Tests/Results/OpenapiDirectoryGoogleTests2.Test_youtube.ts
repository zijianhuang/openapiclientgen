...
export namespace MyNS {
	...
	export interface ActivityContentDetailsPromotedItem {
		...
		forecastingUrl?: Array<string> | null;

		/** The list of impression URLs. The client should ping all of these URLs to indicate that the user was shown this promoted item. */
		impressionUrl?: Array<string> | null;
	...
	export interface ActivityContentDetailsRecommendation {
		...
		/** A resource id is a generic reference that points to another YouTube resource. */
		seedResourceId?: ResourceId | null;
	}
	...
	export interface Channel {
		...
		localizations?: {[id: string]: ChannelLocalization } | null;
	...
	export interface ChannelContentDetails {
		relatedPlaylists?: ChannelContentDetailsRelatedPlaylists | null;
	}
	...
	export interface ChannelSection {
		...
		/** Localizations for different languages */
		localizations?: {[id: string]: ChannelSectionLocalization } | null;
	...
	export interface ChannelSectionListResponse {
		...
		items?: Array<ChannelSection> | null;
	...
	export interface CommentThreadListResponse {
		...
		items?: Array<CommentThread> | null;
	...
	export interface GuideCategoryListResponse {
		...
		items?: Array<GuideCategory> | null;
	...
	export interface LiveBroadcastListResponse {
		...
		items?: Array<LiveBroadcast> | null;
	...
	export interface LiveChatPollEditedDetails {
		id?: string | null;
		items?: Array<LiveChatPollItem> | null;
		prompt?: string | null;
	}
	...
	export interface LiveChatMessageListResponse {
		...
		items?: Array<LiveChatMessage> | null;
	...
	export interface LiveChatModeratorSnippet {
		...
		liveChatId?: string | null;
		moderatorDetails?: ChannelProfileDetails | null;
	}
	...
	export interface LiveChatModeratorListResponse {
		...
		items?: Array<LiveChatModerator> | null;
	...
	export interface LiveStreamStatus {
		healthStatus?: LiveStreamHealthStatus | null;
	...
	export interface LiveStreamHealthStatus {
		...
		configurationIssues?: Array<LiveStreamConfigurationIssue> | null;
	...
	export interface MemberSnippet {
		...
		memberDetails?: ChannelProfileDetails | null;
		membershipsDetails?: MembershipsDetails | null;
	}

	export interface MembershipsDetails {

		/** Ids of all levels that the user has access to. This includes the currently active level and all other levels that are included because of a higher purchase. */
		accessibleLevels?: Array<string> | null;
		...
		membershipsDuration?: MembershipsDuration | null;

		/** Data about memberships duration on particular pricing levels. */
		membershipsDurationAtLevels?: Array<MembershipsDurationAtLevel> | null;
	}
	...
	export interface MembershipsLevel {
		...
		kind?: string | null;
		snippet?: MembershipsLevelSnippet | null;
	}
	...
	export interface MembershipsLevelListResponse {
		...
		items?: Array<MembershipsLevel> | null;
	...
	export interface Playlist {
		...
		/** Localizations for different languages */
		localizations?: {[id: string]: PlaylistLocalization } | null;
	...
	export interface SuperChatEventListResponse {
		...
		items?: Array<SuperChatEvent> | null;
	...
	export interface ThumbnailSetResponse {
		...
		items?: Array<ThumbnailDetails> | null;
	...
	export interface Video {
		...
		localizations?: {[id: string]: VideoLocalization } | null;
	...
	export interface VideoAbuseReportReasonSnippet {
		...
		secondaryReasons?: Array<VideoAbuseReportSecondaryReason> | null;
	}
	...
	export interface VideoAbuseReportReasonListResponse {
		...
		items?: Array<VideoAbuseReportReason> | null;
	...
	export interface VideoCategoryListResponse {
		...
		items?: Array<VideoCategory> | null;
