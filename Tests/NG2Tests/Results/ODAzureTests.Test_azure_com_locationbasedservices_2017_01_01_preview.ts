...
export namespace MyNS {
	...
	export interface LocationBasedServicesOperationsValue {
		...
		display?: LocationBasedServicesOperationsDisplay;
	...
	export interface LocationBasedServicesOperationsDisplay {
	...
	export interface LocationBasedServicesOperationsDisplayFormProperties {
	...
	export function CreateLocationBasedServicesOperationsDisplayFormGroup() {
		return new FormGroup<LocationBasedServicesOperationsDisplayFormProperties>({
