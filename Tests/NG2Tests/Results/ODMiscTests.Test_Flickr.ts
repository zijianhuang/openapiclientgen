...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {PublicGetByApi_keyAndGroup_idReturn} OK
		 */
		PublicGetByApi_keyAndGroup_id(api_key: string, group_id: string | null | undefined): Observable<PublicGetByApi_keyAndGroup_idReturn> {
			return this.http.get<PublicGetByApi_keyAndGroup_idReturn>(this.baseUri + 'rest?method=flickr.groups.pools.getPhotos&api_key=' + (api_key == null ? '' : encodeURIComponent(api_key)) + '&group_id=' + (group_id == null ? '' : encodeURIComponent(group_id)), {});
		}
	...
	export interface PublicGetByApi_keyAndGroup_idReturn {
		photos?: Array<Photo>;
	}
	export interface PublicGetByApi_keyAndGroup_idReturnFormProperties {
	}
	export function CreatePublicGetByApi_keyAndGroup_idReturnFormGroup() {
		return new FormGroup<PublicGetByApi_keyAndGroup_idReturnFormProperties>({
		});
	...
	export interface GetPhotoExifByIDReturnPhotoExif {
		label?: string | null;
		raw?: GetPhotoExifByIDReturnPhotoRaw;
		tag?: string | null;
	...
	export interface GetPhotoExifByIDReturnPhotoRaw {
		_content?: string | null;
	}
	export interface GetPhotoExifByIDReturnPhotoRawFormProperties {
		_content: FormControl<string | null | undefined>,
	}
	export function CreateGetPhotoExifByIDReturnPhotoRawFormGroup() {
		return new FormGroup<GetPhotoExifByIDReturnPhotoRawFormProperties>({
			_content: new FormControl<string | null | undefined>(undefined),
		});
