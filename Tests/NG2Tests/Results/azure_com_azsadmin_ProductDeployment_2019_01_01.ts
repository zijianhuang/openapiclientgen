...
export namespace MyNS {
	...
	/** Parameters for bootstrap action */
	export interface BootstrapActionParameter {
	...
	/** Parameters for bootstrap action */
	export interface BootstrapActionParameterFormProperties {

		/** Generic Version object */
		version: FormControl<string | null | undefined>,
	}
	export function CreateBootstrapActionParameterFormGroup() {
		return new FormGroup<BootstrapActionParameterFormProperties>({
			version: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Parameters for deploy action */
	export interface DeployActionParameter {
	...
	/** Parameters for deploy action */
	export interface DeployActionParameterFormProperties {
	...
	export function CreateDeployActionParameterFormGroup() {
		return new FormGroup<DeployActionParameterFormProperties>({
			parameters: new FormControl<string | null | undefined>(undefined),
			version: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Parameters for bootstrap action */
	export interface UnlockActionParameter {
	...
	/** Parameters for bootstrap action */
	export interface UnlockActionParameterFormProperties {

		/** Duration in TimeSpan format(Define which ISO format) */
		duration: FormControl<string | null | undefined>,
	}
	export function CreateUnlockActionParameterFormGroup() {
		return new FormGroup<UnlockActionParameterFormProperties>({
			duration: new FormControl<string | null | undefined>(undefined),
		});
