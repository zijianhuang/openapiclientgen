...
export namespace MyNS {
	...
	export interface DownloadLineItemsRequest {
		...
		fileSpec?: DownloadLineItemsRequestFileSpec;
		...
		filterType?: DownloadLineItemsRequestFilterType;

		/** Format in which the line items will be returned. Default to CSV. */
		format?: DownloadLineItemsRequestFormat;
	}
	...
	export interface DownloadRequest {
		...
		filterType?: DownloadRequestFilterType;
	...
	export interface QueryMetadata {
		...
		dataRange?: QueryMetadataDataRange;

		/** Format of the generated report. */
		format?: QueryMetadataFormat;
	...
	export interface QuerySchedule {
		...
		frequency?: QueryScheduleFrequency;
	...
	export interface ReportFailure {
		...
		errorCode?: ReportFailureErrorCode;
	}
