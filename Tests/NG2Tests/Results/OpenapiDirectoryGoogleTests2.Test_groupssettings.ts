...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		GroupsSettings_groups_get(groupUniqueId: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + (groupUniqueId == null ? '' : encodeURIComponent(groupUniqueId)) + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Successful response
		 */
		GroupsSettings_groups_patch(groupUniqueId: string, requestBody: Groups): Observable<HttpResponse<string>> {
			return this.http.patch(this.baseUri + (groupUniqueId == null ? '' : encodeURIComponent(groupUniqueId)) + '', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Successful response
		 */
		GroupsSettings_groups_update(groupUniqueId: string, requestBody: Groups): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + (groupUniqueId == null ? '' : encodeURIComponent(groupUniqueId)) + '', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
