...
export namespace MyNS {
	...
	export interface BlobServices_ListMetricDefinitionsReturnValue {
		...
		/** Localizable string. */
		name?: BlobServices_ListMetricDefinitionsReturnName;
	...
	export interface BlobServices_ListMetricDefinitionsReturnName {
	...
	export interface BlobServices_ListMetricDefinitionsReturnNameFormProperties {
	...
	export function CreateBlobServices_ListMetricDefinitionsReturnNameFormGroup() {
		return new FormGroup<BlobServices_ListMetricDefinitionsReturnNameFormProperties>({
	...
	export interface BlobServices_ListMetricsReturnValue {
		...
		/** Localizable string. */
		name?: BlobServices_ListMetricsReturnName;
	...
	export interface BlobServices_ListMetricsReturnName {
	...
	export interface BlobServices_ListMetricsReturnNameFormProperties {
	...
	export function CreateBlobServices_ListMetricsReturnNameFormGroup() {
		return new FormGroup<BlobServices_ListMetricsReturnNameFormProperties>({
			localizedValue: new FormControl<string | null | undefined>(undefined),
			value: new FormControl<string | null | undefined>(undefined),
		});
