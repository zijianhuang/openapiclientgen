...
export namespace MyNS {
	...
	export interface SerialConsoleOperationsValue {
		display?: SerialConsoleOperationsDisplay;
	...
	export interface SerialConsoleOperationsDisplay {
		description?: string | null;
		operation?: string | null;
		provider?: string | null;
		resource?: string | null;
	}
	export interface SerialConsoleOperationsDisplayFormProperties {
		description: FormControl<string | null | undefined>,
		operation: FormControl<string | null | undefined>,
		provider: FormControl<string | null | undefined>,
		resource: FormControl<string | null | undefined>,
	}
	export function CreateSerialConsoleOperationsDisplayFormGroup() {
		return new FormGroup<SerialConsoleOperationsDisplayFormProperties>({
	...
	export class MyClient {
		...
		GetConsoleStatus(api_version: string, subscriptionId: string, _default: string): Observable<SerialConsoleStatus> {
			return this.http.get<SerialConsoleStatus>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.SerialConsole/consoleServices/{default}?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		DisableConsole(api_version: string, subscriptionId: string, _default: string): Observable<DisableSerialConsoleResult> {
			return this.http.post<DisableSerialConsoleResult>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.SerialConsole/consoleServices/{default}/disableConsole?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, {});
		}
		...
		EnableConsole(api_version: string, subscriptionId: string, _default: string): Observable<EnableSerialConsoleResult> {
			return this.http.post<EnableSerialConsoleResult>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.SerialConsole/consoleServices/{default}/enableConsole?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, {});
		}
	}
