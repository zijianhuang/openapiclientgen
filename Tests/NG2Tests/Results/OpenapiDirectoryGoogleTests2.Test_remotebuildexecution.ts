...
export namespace MyNS {
	...
	export interface BuildBazelRemoteExecutionV2Action {
		 ...
		 */
		commandDigest?: BuildBazelRemoteExecutionV2Digest | null;
		 ...
		 * concatenating two messages to merge them may produce duplicate fields.
		 */
		inputRootDigest?: BuildBazelRemoteExecutionV2Digest | null;
		 ...
		 * error.
		 */
		outputNodeProperties?: Array<string> | null;
	...
	export interface BuildBazelRemoteExecutionV2ActionResult {
		...
		executionMetadata?: BuildBazelRemoteExecutionV2ExecutedActionMetadata | null;
		 ...
		 */
		outputDirectories?: Array<BuildBazelRemoteExecutionV2OutputDirectory> | null;
		 ...
		 */
		outputDirectorySymlinks?: Array<BuildBazelRemoteExecutionV2OutputSymlink> | null;
		 ...
		 * should still populate this field in addition to `output_symlinks`.
		 */
		outputFileSymlinks?: Array<BuildBazelRemoteExecutionV2OutputSymlink> | null;
		 ...
		 * list as desired; clients MUST NOT assume that the output list is sorted.
		 */
		outputFiles?: Array<BuildBazelRemoteExecutionV2OutputFile> | null;
		 ...
		 * list as desired; clients MUST NOT assume that the output list is sorted.
		 */
		outputSymlinks?: Array<BuildBazelRemoteExecutionV2OutputSymlink> | null;
		 ...
		 * concatenating two messages to merge them may produce duplicate fields.
		 */
		stderrDigest?: BuildBazelRemoteExecutionV2Digest | null;
		 ...
		 * concatenating two messages to merge them may produce duplicate fields.
		 */
		stdoutDigest?: BuildBazelRemoteExecutionV2Digest | null;
	...
	export interface BuildBazelRemoteExecutionV2OutputDirectory {
		 ...
		 * concatenating two messages to merge them may produce duplicate fields.
		 */
		treeDigest?: BuildBazelRemoteExecutionV2Digest | null;
	}
	...
	export interface BuildBazelRemoteExecutionV2OutputSymlink {
		 ...
		 * Action.
		 */
		nodeProperties?: Array<BuildBazelRemoteExecutionV2NodeProperty> | null;
	...
	export interface BuildBazelRemoteExecutionV2OutputFile {
		 ...
		 * concatenating two messages to merge them may produce duplicate fields.
		 */
		digest?: BuildBazelRemoteExecutionV2Digest | null;
	...
	export interface BuildBazelRemoteExecutionV2Command {
		 ...
		 * Sorting of strings is done by code point, equivalently, by the UTF-8 bytes.
		 */
		environmentVariables?: Array<BuildBazelRemoteExecutionV2CommandEnvironmentVariable> | null;
		 ...
		 */
		outputDirectories?: Array<string> | null;
		 ...
		 */
		platform?: BuildBazelRemoteExecutionV2Platform | null;
	...
	export interface BuildBazelRemoteExecutionV2Platform {
		 ...
		 */
		properties?: Array<BuildBazelRemoteExecutionV2PlatformProperty> | null;
	}
	...
	export interface BuildBazelRemoteExecutionV2Directory {
		...
		directories?: Array<BuildBazelRemoteExecutionV2DirectoryNode> | null;

		/** The files in the directory. */
		files?: Array<BuildBazelRemoteExecutionV2FileNode> | null;

		/** The node properties of the Directory. */
		nodeProperties?: Array<BuildBazelRemoteExecutionV2NodeProperty> | null;

		/** The symlinks in the directory. */
		symlinks?: Array<BuildBazelRemoteExecutionV2SymlinkNode> | null;
	}
	...
	export interface BuildBazelRemoteExecutionV2ExecuteOperationMetadata {
		 ...
		 * concatenating two messages to merge them may produce duplicate fields.
		 */
		actionDigest?: BuildBazelRemoteExecutionV2Digest | null;
	...
	export interface BuildBazelRemoteExecutionV2ExecuteResponse {
		 ...
		 * Action being run.
		 */
		result?: BuildBazelRemoteExecutionV2ActionResult | null;
		 ...
		 * to a user.
		 */
		serverLogs?: {[id: string]: BuildBazelRemoteExecutionV2LogFile } | null;
	...
	export interface BuildBazelRemoteExecutionV2RequestMetadata {
		...
		toolDetails?: BuildBazelRemoteExecutionV2ToolDetails | null;
	...
	export interface BuildBazelRemoteExecutionV2Tree {
		 ...
		 */
		children?: Array<BuildBazelRemoteExecutionV2Directory> | null;
		 ...
		 * ```
		 */
		root?: BuildBazelRemoteExecutionV2Directory | null;
	}
	...
	export interface GoogleDevtoolsRemotebuildbotResourceUsage {
		...
		diskUsage?: GoogleDevtoolsRemotebuildbotResourceUsageStat | null;
		memoryUsage?: GoogleDevtoolsRemotebuildbotResourceUsageStat | null;
	}
	...
	export interface GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest {
		 ...
		 */
		instance?: GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance | null;
	...
	export interface GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest {
		...
		workerPool?: GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool | null;
	}
	...
	export interface GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool {
		 ...
		 * the worker pool.
		 */
		workerConfig?: GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig | null;
	...
	export interface GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig {
		...
		/** AcceleratorConfig defines the accelerator cards to attach to the VM. */
		accelerator?: GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfig | null;
	...
	export interface GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse {
		...
		instances?: Array<GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance> | null;
	}
	...
	export interface GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse {
		...
		workerPools?: Array<GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool> | null;
	}
	...
	export interface GoogleDevtoolsRemoteworkersV1test2Blob {
		 ...
		 */
		digest?: GoogleDevtoolsRemoteworkersV1test2Digest | null;
	}
	...
	export interface GoogleDevtoolsRemoteworkersV1test2CommandOutputs {
		 ...
		 * byte-encoded Directory message.
		 */
		outputs?: GoogleDevtoolsRemoteworkersV1test2Digest | null;
	}
	...
	export interface GoogleDevtoolsRemoteworkersV1test2CommandTask {
		...
		expectedOutputs?: GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs | null;

		/** Describes the inputs to a shell-style task. */
		inputs?: GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs | null;

		/** Describes the timeouts associated with this task. */
		timeouts?: GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts | null;
	}
	...
	export interface GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs {
		...
		environmentVariables?: Array<GoogleDevtoolsRemoteworkersV1test2CommandTaskInputsEnvironmentVariable> | null;
		 ...
		 */
		files?: Array<GoogleDevtoolsRemoteworkersV1test2Digest> | null;
		 ...
		 * remote CAS server.
		 */
		inlineBlobs?: Array<GoogleDevtoolsRemoteworkersV1test2Blob> | null;
	...
	export interface GoogleDevtoolsRemoteworkersV1test2Directory {
		...
		/** Any subdirectories */
		directories?: Array<GoogleDevtoolsRemoteworkersV1test2DirectoryMetadata> | null;

		/** The files in this directory */
		files?: Array<GoogleDevtoolsRemoteworkersV1test2FileMetadata> | null;
	}
