...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {ElasticsearchClusterConfigInstanceType} InstanceType  The instance type for an Elasticsearch cluster for which Elasticsearch <code> <a>Limits</a> </code> are needed. 
		 ...
		 */
		DescribeElasticsearchInstanceTypeLimits(domainName: string | null | undefined, InstanceType: ElasticsearchClusterConfigInstanceType, ElasticsearchVersion: string): Observable<DescribeElasticsearchInstanceTypeLimitsResponse> {
