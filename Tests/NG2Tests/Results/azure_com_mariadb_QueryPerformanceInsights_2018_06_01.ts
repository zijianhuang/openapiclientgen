...
export namespace MyNS {
	...
	export class MyClient {
		...
		QueryTexts_ListByServer(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string, queryIds: Array<string>): Observable<QueryTextsResultList> {
			return this.http.get<QueryTextsResultList>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/queryTexts?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&' + queryIds.map(z => `queryIds=${encodeURIComponent(z)}`).join('&'), {});
		}
		...
		QueryTexts_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string, queryId: string): Observable<QueryText> {
			return this.http.get<QueryText>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/queryTexts/' + (queryId == null ? '' : encodeURIComponent(queryId)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		TopQueryStatistics_ListByServer(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string): Observable<TopQueryStatisticsResultList> {
			return this.http.get<TopQueryStatisticsResultList>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/topQueryStatistics?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		TopQueryStatistics_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string, queryStatisticId: string): Observable<QueryStatistic> {
			return this.http.get<QueryStatistic>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/topQueryStatistics/' + (queryStatisticId == null ? '' : encodeURIComponent(queryStatisticId)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		WaitStatistics_ListByServer(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string): Observable<WaitStatisticsResultList> {
			return this.http.get<WaitStatisticsResultList>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/waitStatistics?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		WaitStatistics_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serverName: string, waitStatisticsId: string): Observable<WaitStatistic> {
			return this.http.get<WaitStatistic>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.DBforMariaDB/servers/' + (serverName == null ? '' : encodeURIComponent(serverName)) + '/waitStatistics/' + (waitStatisticsId == null ? '' : encodeURIComponent(waitStatisticsId)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
	}
