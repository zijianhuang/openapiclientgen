...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {BusIncidentsGetByRouteRoute} Route Base bus route; variations are not recognized (i.e.: C2 instead of C2v1, C2v2, etc.).
		 * @return {void} Default response code.
		 */
		JsonBusIncidentsGetByRoute(Route: BusIncidentsGetByRouteRoute | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
