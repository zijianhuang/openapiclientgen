...
export namespace MyNS {
	...
	/** Contains the status of the Deidentify operation. */
	export interface DeidentifyErrorDetailsFormProperties {

		/** Number of resources that failed to process. */
		failureResourceCount: FormControl<string | null | undefined>,

		/** Number of stores that failed to process. */
		failureStoreCount: FormControl<string | null | undefined>,

		/** Number of resources successfully processed. */
		successResourceCount: FormControl<string | null | undefined>,

		/** Number of stores successfully processed. */
		successStoreCount: FormControl<string | null | undefined>,
	}
	export function CreateDeidentifyErrorDetailsFormGroup() {
		return new FormGroup<DeidentifyErrorDetailsFormProperties>({
			failureResourceCount: new FormControl<string | null | undefined>(undefined),
			failureStoreCount: new FormControl<string | null | undefined>(undefined),
			successResourceCount: new FormControl<string | null | undefined>(undefined),
			successStoreCount: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The configuration for exporting to Cloud Storage. */
	export interface GoogleCloudHealthcareV1beta1FhirRestGcsDestinationFormProperties {
	...
	export function CreateGoogleCloudHealthcareV1beta1FhirRestGcsDestinationFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirRestGcsDestinationFormProperties>({
			uriPrefix: new FormControl<string | null | undefined>(undefined),
		});
	 ...
	 * only included when the operation finishes with errors.
	 */
	export interface GoogleCloudHealthcareV1beta1FhirRestExportResourcesErrorDetailsFormProperties {
	...
	export function CreateGoogleCloudHealthcareV1beta1FhirRestExportResourcesErrorDetailsFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirRestExportResourcesErrorDetailsFormProperties>({
	 ...
	 * outcome. It will only be included when the operation finishes successfully.
	 */
	export interface GoogleCloudHealthcareV1beta1FhirRestExportResourcesResponseFormProperties {
	...
	export function CreateGoogleCloudHealthcareV1beta1FhirRestExportResourcesResponseFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirRestExportResourcesResponseFormProperties>({
			fhirStore: new FormControl<string | null | undefined>(undefined),
			resourceCount: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Specifies the configuration for importing data from Cloud Storage. */
	export interface GoogleCloudHealthcareV1beta1FhirRestGcsSourceFormProperties {
	...
	export function CreateGoogleCloudHealthcareV1beta1FhirRestGcsSourceFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirRestGcsSourceFormProperties>({
			uri: new FormControl<string | null | undefined>(undefined),
		});
	 ...
	 * only be included when the operation finishes with some failure.
	 */
	export interface GoogleCloudHealthcareV1beta1FhirRestImportResourcesErrorDetailsFormProperties {
		 ...
		 * of the success and error counts.
		 */
		inputSize: FormControl<string | null | undefined>,

		/** The number of resources that have been imported. */
		successCount: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudHealthcareV1beta1FhirRestImportResourcesErrorDetailsFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirRestImportResourcesErrorDetailsFormProperties>({
			errorCount: new FormControl<string | null | undefined>(undefined),
			fhirStore: new FormControl<string | null | undefined>(undefined),
			inputSize: new FormControl<string | null | undefined>(undefined),
			successCount: new FormControl<string | null | undefined>(undefined),
		});
	 ...
	 * outcome. It will only be included when the operation finishes successfully.
	 */
	export interface GoogleCloudHealthcareV1beta1FhirRestImportResourcesResponseFormProperties {
	...
	export function CreateGoogleCloudHealthcareV1beta1FhirRestImportResourcesResponseFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirRestImportResourcesResponseFormProperties>({
			fhirStore: new FormControl<string | null | undefined>(undefined),
			inputSize: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Returns the errors encountered during DICOM store import. */
	export interface ImportDicomDataErrorDetailsFormProperties {
	}
	export function CreateImportDicomDataErrorDetailsFormGroup() {
		return new FormGroup<ImportDicomDataErrorDetailsFormProperties>({
		});
