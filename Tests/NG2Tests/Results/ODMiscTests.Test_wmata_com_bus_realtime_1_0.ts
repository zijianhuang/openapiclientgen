...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {JsonJPredictionsGetByStopIDStopID} StopID 7-digit regional stop ID.
		 * @return {void} Default response type.
		 */
		JsonJPredictionsGetByStopID(StopID: JsonJPredictionsGetByStopIDStopID, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
	...
	export enum JsonJPredictionsGetByStopIDStopID { _1001195 = 0 }
