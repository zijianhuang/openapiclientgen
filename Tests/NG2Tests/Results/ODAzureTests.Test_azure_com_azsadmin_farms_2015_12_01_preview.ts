...
export namespace MyNS {
	...
	export interface Farms_ListMetricDefinitionsReturnValue {
		...
		/** Localizable string. */
		name?: Farms_ListMetricDefinitionsReturnName;
	...
	export interface Farms_ListMetricDefinitionsReturnName {
	...
	export interface Farms_ListMetricDefinitionsReturnNameFormProperties {
	...
	export function CreateFarms_ListMetricDefinitionsReturnNameFormGroup() {
		return new FormGroup<Farms_ListMetricDefinitionsReturnNameFormProperties>({
	...
	export interface Farms_ListMetricsReturnValue {
		...
		/** Localizable string. */
		name?: Farms_ListMetricsReturnName;
	...
	export interface Farms_ListMetricsReturnName {
	...
	export interface Farms_ListMetricsReturnNameFormProperties {
	...
	export function CreateFarms_ListMetricsReturnNameFormGroup() {
		return new FormGroup<Farms_ListMetricsReturnNameFormProperties>({
			localizedValue: new FormControl<string | null | undefined>(undefined),
			value: new FormControl<string | null | undefined>(undefined),
		});
