...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {Cluster} The operation completed successfully.
		 */
		Clusters_Create(resourceGroupName: string, clusterName: string, api_version: Clusters_ListApi_version, subscriptionId: string, requestBody: Cluster): Observable<Cluster> {
