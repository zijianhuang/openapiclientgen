...
export namespace MyNS {
	...
	export enum RedisCommonPropertiesMinimumTlsVersion { _1_0 = 0, _1_1 = 1, _1_2 = 2 }
	...
	export enum RedisLinkedServerCreatePropertiesServerRole { Primary = 0, Secondary = 1 }
	...
	export enum RedisPropertiesProvisioningState { Creating = 0, Deleting = 1, Disabled = 2, Failed = 3, Linking = 4, Provisioning = 5, RecoveringScaleFailure = 6, Scaling = 7, Succeeded = 8, Unlinking = 9, Unprovisioning = 10, Updating = 11 }
	...
	export enum RedisRebootParametersRebootType { PrimaryNode = 0, SecondaryNode = 1, AllNodes = 2 }
	...
	export enum ScheduleEntryDayOfWeek { Monday = 0, Tuesday = 1, Wednesday = 2, Thursday = 3, Friday = 4, Saturday = 5, Sunday = 6, Everyday = 7, Weekend = 8 }
	...
	export enum SkuFamily { C = 0, P = 1 }

	export enum SkuName { Basic = 0, Standard = 1, Premium = 2 }
	...
	export class MyClient {
		...
		PatchSchedules_Get(resourceGroupName: string, name: string, _default: PatchSchedules_GetDefault, api_version: string, subscriptionId: string): Observable<RedisPatchSchedule> {
			return this.http.get<RedisPatchSchedule>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.Cache/Redis/' + (name == null ? '' : encodeURIComponent(name)) + '/patchSchedules/{default}&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), {});
		}
		...
		PatchSchedules_CreateOrUpdate(resourceGroupName: string, name: string, _default: PatchSchedules_GetDefault, api_version: string, subscriptionId: string, requestBody: RedisPatchSchedule): Observable<RedisPatchSchedule> {
			return this.http.put<RedisPatchSchedule>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.Cache/Redis/' + (name == null ? '' : encodeURIComponent(name)) + '/patchSchedules/{default}&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PatchSchedules_Delete(resourceGroupName: string, name: string, _default: PatchSchedules_GetDefault, api_version: string, subscriptionId: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.Cache/Redis/' + (name == null ? '' : encodeURIComponent(name)) + '/patchSchedules/{default}&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { observe: 'response', responseType: 'text' });
		}
	...
	export enum PatchSchedules_GetDefault { default = 0 }
