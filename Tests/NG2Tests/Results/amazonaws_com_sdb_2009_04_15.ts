...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {void} Success
		 */
		GET_BatchPutAttributes(DomainName: string, Items: Array<ReplaceableItem>, Action: GET_BatchPutAttributesAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DeleteAttributes(DomainName: string, ItemName: string, Attributes: Array<DeletableAttribute> | null | undefined, Expected: GET_DeleteAttributesExpected | null | undefined, Action: GET_DeleteAttributesAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_PutAttributes(DomainName: string, ItemName: string, Attributes: Array<ReplaceableAttribute>, Expected: GET_PutAttributesExpected | null | undefined, Action: GET_PutAttributesAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
