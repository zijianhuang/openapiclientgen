...
export namespace MyNS {
	...
	export interface Contact {
		...
		Balances?: Array<BalancesElement>;
	...
	export interface ContactPaymentTerms {
		Bills?: ContactPaymentTermsBills;
		Sales?: ContactPaymentTermsSales;
	}
	...
	export interface ContactPaymentTermsBills {
		Days?: string | null;
		Type?: ContactPaymentTermsBillsType | null;
	}
	export interface ContactPaymentTermsBillsFormProperties {
		Days: FormControl<string | null | undefined>,
		Type: FormControl<ContactPaymentTermsBillsType | null | undefined>,
	}
	export function CreateContactPaymentTermsBillsFormGroup() {
		return new FormGroup<ContactPaymentTermsBillsFormProperties>({
			Days: new FormControl<string | null | undefined>(undefined),
			Type: new FormControl<ContactPaymentTermsBillsType | null | undefined>(undefined),
		});

	}

	export enum ContactPaymentTermsBillsType { DAYSAFTERBILLDATE = 0, DAYSAFTERBILLMONTH = 1, OFCURRENTMONTH = 2, OFFOLLOWINGMONTH = 3 }

	export interface ContactPaymentTermsSales {
		Days?: string | null;
		Type?: ContactPaymentTermsBillsType | null;
	}
	export interface ContactPaymentTermsSalesFormProperties {
		Days: FormControl<string | null | undefined>,
		Type: FormControl<ContactPaymentTermsBillsType | null | undefined>,
	}
	export function CreateContactPaymentTermsSalesFormGroup() {
		return new FormGroup<ContactPaymentTermsSalesFormProperties>({
			Days: new FormControl<string | null | undefined>(undefined),
			Type: new FormControl<ContactPaymentTermsBillsType | null | undefined>(undefined),
		});
