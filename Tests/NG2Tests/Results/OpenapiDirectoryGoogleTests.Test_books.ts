...
export namespace MyNS {
	...
	export interface AnnotationdataFormProperties {
		...
		/** Base64 encoded data for this annotation data. */
		encoded_data: FormControl<string | null | undefined>,
	...
	export function CreateAnnotationdataFormGroup() {
		return new FormGroup<AnnotationdataFormProperties>({
			annotationType: new FormControl<string | null | undefined>(undefined),
			data: new FormControl<any | null | undefined>(undefined),
			encoded_data: new FormControl<string | null | undefined>(undefined),
			id: new FormControl<string | null | undefined>(undefined),
			kind: new FormControl<string | null | undefined>(undefined),
			layerId: new FormControl<string | null | undefined>(undefined),
			selfLink: new FormControl<string | null | undefined>(undefined),
	...
	export interface BooksSubscriptionReleaseInfoFormProperties {

		/** Amount in micros of the specified currency code. */
		amountInMicros: FormControl<string | null | undefined>,
		...
		/** The release date. */
		releaseTimestampUs: FormControl<string | null | undefined>,
	}
	export function CreateBooksSubscriptionReleaseInfoFormGroup() {
		return new FormGroup<BooksSubscriptionReleaseInfoFormProperties>({
			amountInMicros: new FormControl<string | null | undefined>(undefined),
			currencyCode: new FormControl<string | null | undefined>(undefined),
			releaseNumber: new FormControl<string | null | undefined>(undefined),
			releaseTimestampUs: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface BookshelfFormProperties {
		...
		/** Last time a volume was added or removed from this bookshelf (formatted UTC timestamp with millisecond resolution). */
		volumesLastUpdated: FormControl<Date | null | undefined>,
	}
	export function CreateBookshelfFormGroup() {
		return new FormGroup<BookshelfFormProperties>({
			...
			volumesLastUpdated: new FormControl<Date | null | undefined>(undefined),
		});
	...
	export interface DiscoveryclustersBanner_with_content_containerFormProperties {
	...
	export function CreateDiscoveryclustersBanner_with_content_containerFormGroup() {
		return new FormGroup<DiscoveryclustersBanner_with_content_containerFormProperties>({
	...
	export interface VolumeSaleInfoFormProperties {
		...
		/** The date on which this book is available for sale. */
		onSaleDate: FormControl<Date | null | undefined>,
	...
	export function CreateVolumeSaleInfoFormGroup() {
		return new FormGroup<VolumeSaleInfoFormProperties>({
			...
			onSaleDate: new FormControl<Date | null | undefined>(undefined),
	...
	export interface VolumeSaleInfoRentalDurationFormProperties {
		count: FormControl<number | null | undefined>,
		unit: FormControl<string | null | undefined>,
	}
	export function CreateVolumeSaleInfoRentalDurationFormGroup() {
		return new FormGroup<VolumeSaleInfoRentalDurationFormProperties>({
	...
	export interface VolumeUserInfoFormProperties {
		...
		/** Timestamp when this volume was acquired by the user. (RFC 3339 UTC date-time format) Acquiring includes purchase, user upload, receiving family sharing, etc. */
		acquiredTime: FormControl<Date | null | undefined>,
	...
	export function CreateVolumeUserInfoFormGroup() {
		return new FormGroup<VolumeUserInfoFormProperties>({
			acquiredTime: new FormControl<Date | null | undefined>(undefined),
	...
	export interface VolumeVolumeInfoFormProperties {
		...
		/** The reading modes available for this volume. */
		readingModes: FormControl<any | null | undefined>,
	...
	export function CreateVolumeVolumeInfoFormGroup() {
		return new FormGroup<VolumeVolumeInfoFormProperties>({
			...
			readingModes: new FormControl<any | null | undefined>(undefined),
	...
	export interface RequestAccessFormProperties {

		/** Resource type. */
		kind: FormControl<string | null | undefined>,
	}
	export function CreateRequestAccessFormGroup() {
		return new FormGroup<RequestAccessFormProperties>({
			kind: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface SeriesSeriesSubscriptionReleaseInfoFormProperties {

		/** Cancellation date of the series subscription (or when it ends). */
		cancellationTimestampUs: FormControl<string | null | undefined>,

		/** series subscription type. */
		seriesSubscriptionType: FormControl<string | null | undefined>,
	}
	export function CreateSeriesSeriesSubscriptionReleaseInfoFormGroup() {
		return new FormGroup<SeriesSeriesSubscriptionReleaseInfoFormProperties>({
			cancellationTimestampUs: new FormControl<string | null | undefined>(undefined),
	...
	export enum Books_mylibrary_readingpositions_setPositionAction { bookmark = 0, chapter = 1, 'next-page' = 2, 'prev-page' = 3, scroll = 4, search = 5 }

	export enum Books_onboarding_listCategoryVolumesMaxAllowedMaturityRating { mature = 0, 'not-mature' = 1 }

	export enum Books_personalizedstream_getMaxAllowedMaturityRating { mature = 0, 'not-mature' = 1 }

	export enum Books_volumes_listDownload { epub = 0 }

	export enum Books_volumes_listFilter { ebooks = 0, 'free-ebooks' = 1, full = 2, 'paid-ebooks' = 3, partial = 4 }

	export enum Books_volumes_listLibraryRestrict { 'my-library' = 0, 'no-restrict' = 1 }

	export enum Books_volumes_listMaxAllowedMaturityRating { mature = 0, 'not-mature' = 1 }
	...
	export enum Books_volumes_recommended_listMaxAllowedMaturityRating { mature = 0, 'not-mature' = 1 }

	export enum Books_volumes_recommended_rateRating { HAVE_IT = 0, NOT_INTERESTED = 1 }

	export enum Books_volumes_associated_listAssociation { 'end-of-sample' = 0, 'end-of-volume' = 1, 'related-for-play' = 2 }

	export enum Books_volumes_associated_listMaxAllowedMaturityRating { mature = 0, 'not-mature' = 1 }
