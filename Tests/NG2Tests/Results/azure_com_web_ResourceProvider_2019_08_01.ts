...
export namespace MyNS {
	...
	export interface DeploymentLocationsHostingEnvironments {
		 ...
		 * Required
		 */
		virtualNetwork: DeploymentLocationsHostingEnvironmentsVirtualNetwork;
	...
	export interface DeploymentLocationsHostingEnvironmentsVirtualNetwork {
	...
	export interface DeploymentLocationsHostingEnvironmentsVirtualNetworkFormProperties {
	...
	export function CreateDeploymentLocationsHostingEnvironmentsVirtualNetworkFormGroup() {
		return new FormGroup<DeploymentLocationsHostingEnvironmentsVirtualNetworkFormProperties>({
