...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Servicenetworking_operations_delete(name: string): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Successful response
		 */
		Servicenetworking_operations_get(name: string): Observable<HttpResponse<string>> {
		 ...
		 * Patch v1/{name}
		 * @param {string} name The private service connection that connects to a service producer
		 ...
		 * @param {boolean} force If a previously defined allocated range is removed, force flag must be
		 * set to true.
		 * @param {string} updateMask The update mask. If this is omitted, it defaults to "*". You can only
		 ...
		 * @return {void} Successful response
		 */
		Servicenetworking_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} parent The service that is managing peering connectivity for a service producer's
		 ...
		 * services are listed.
		 * @param {string} network The name of service consumer's VPC network that's connected with service
		 ...
		 * @return {void} Successful response
		 */
		Servicenetworking_services_connections_create(parent: string, requestBody: Connection): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/connections', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {string} parent Required. This is in a form services/{service} where {service} is the name of the
		 * private access management service. For example
		 * 'service-peering.example.com'.
		 * @return {void} Successful response
		 */
		Servicenetworking_services_roles_add(parent: string, requestBody: AddRolesRequest): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/roles:add', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {string} parent Required. A tenant project in the service producer organization, in the
		 ...
		 * @return {void} Successful response
		 */
		Servicenetworking_services_addSubnetwork(parent: string, requestBody: AddSubnetworkRequest): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':addSubnetwork', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Successful response
		 */
		Servicenetworking_services_disableVpcServiceControls(parent: string, requestBody: DisableVpcServiceControlsRequest): Observable<HttpResponse<string>> {
			return this.http.patch(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':disableVpcServiceControls', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Successful response
		 */
		Servicenetworking_services_enableVpcServiceControls(parent: string, requestBody: EnableVpcServiceControlsRequest): Observable<HttpResponse<string>> {
			return this.http.patch(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':enableVpcServiceControls', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {string} parent Required. This is in a form services/{service}. {service} the name of the private
		 * access management service, for example 'service-peering.example.com'.
		 * @return {void} Successful response
		 */
		Servicenetworking_services_searchRange(parent: string, requestBody: SearchRangeRequest): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':searchRange', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Successful response
		 */
		Servicenetworking_services_validate(parent: string, requestBody: ValidateConsumerConfigRequest): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':validate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
