...
export namespace MyNS {
	...
	export interface OfferObjectParameter {

		/** Required */
		isAvailable: boolean;
	}
	export interface OfferObjectParameterFormProperties {

		/** Required */
		isAvailable: FormControl<boolean | null | undefined>,
	}
	export function CreateOfferObjectParameterFormGroup() {
		return new FormGroup<OfferObjectParameterFormProperties>({
			isAvailable: new FormControl<boolean | null | undefined>(undefined, [Validators.required]),
		});
