...
export namespace MyNS {
	...
	export interface Application {
		...
		appTracks?: Array<AppTrackInfo> | null;

		/** The set of managed properties available to be pre-configured for the app. */
		managedProperties?: Array<ManagedProperty> | null;

		/** The name of the app in the form enterprises/{enterpriseId}/applications/{package_name}. */
		name?: string | null;

		/** The permissions required by the app. */
		permissions?: Array<ApplicationPermission> | null;
	...
	export interface ManagedProperty {
		...
		entries?: Array<ManagedPropertyEntry> | null;
		...
		nestedProperties?: Array<ManagedProperty> | null;
	...
	export interface ApplicationPolicy {
		...
		accessibleTrackIds?: Array<string> | null;
		...
		delegatedScopes?: Array<string> | null;
		...
		managedConfiguration?: {[id: string]: any } | null;

		/** The managed configurations template for the app, saved from the managed configurations iframe. */
		managedConfigurationTemplate?: ManagedConfigurationTemplate | null;
		...
		permissionGrants?: Array<PermissionGrant> | null;
	}
	...
	export interface ManagedConfigurationTemplate {
		...
		configurationVariables?: {[id: string]: string } | null;
	...
	export interface ApplicationReport {
		...
		events?: Array<ApplicationEvent> | null;

		/** The package name of the app that installed this app. */
		installerPackageName?: string | null;

		/** List of keyed app states reported by the app. */
		keyedAppStates?: Array<KeyedAppState> | null;
		...
		signingKeyCertFingerprints?: Array<string> | null;
	...
	export interface ChoosePrivateKeyRule {
		...
		packageNames?: Array<string> | null;
	...
	export interface Command {
		...
		resetPasswordFlags?: Array<string> | null;
	...
	export interface ComplianceRule {
		...
		packageNamesToDisable?: Array<string> | null;
	}
	...
	export interface Device {
		...
		applicationReports?: Array<ApplicationReport> | null;
		...
		hardwareStatusSamples?: Array<HardwareStatus> | null;
		...
		memoryEvents?: Array<MemoryEvent> | null;
		...
		nonComplianceDetails?: Array<NonComplianceDetail> | null;
		...
		powerManagementEvents?: Array<PowerManagementEvent> | null;
		...
		previousDeviceNames?: Array<string> | null;
		...
		systemProperties?: {[id: string]: string } | null;
	...
	export interface UserFacingMessage {
		...
		localizedMessages?: {[id: string]: string } | null;
	}
	...
	export interface HardwareInfo {
		...
		batteryShutdownTemperatures?: Array<number> | null;

		/** Battery throttling temperature thresholds in Celsius for each battery on the device. */
		batteryThrottlingTemperatures?: Array<number> | null;

		/** Brand of the device. For example, Google. */
		brand?: string | null;

		/** CPU shutdown temperature thresholds in Celsius for each CPU on the device. */
		cpuShutdownTemperatures?: Array<number> | null;

		/** CPU throttling temperature thresholds in Celsius for each CPU on the device. */
		cpuThrottlingTemperatures?: Array<number> | null;

		/** Baseband version. For example, MDM9625_104662.22.05.34p. */
		deviceBasebandVersion?: string | null;

		/** GPU shutdown temperature thresholds in Celsius for each GPU on the device. */
		gpuShutdownTemperatures?: Array<number> | null;

		/** GPU throttling temperature thresholds in Celsius for each GPU on the device. */
		gpuThrottlingTemperatures?: Array<number> | null;
		...
		skinShutdownTemperatures?: Array<number> | null;

		/** Device skin throttling temperature thresholds in Celsius. */
		skinThrottlingTemperatures?: Array<number> | null;
	}
	...
	export interface HardwareStatus {
		...
		batteryTemperatures?: Array<number> | null;

		/** Current CPU temperatures in Celsius for each CPU on the device. */
		cpuTemperatures?: Array<number> | null;
		...
		fanSpeeds?: Array<number> | null;

		/** Current GPU temperatures in Celsius for each GPU on the device. */
		gpuTemperatures?: Array<number> | null;

		/** Current device skin temperatures in Celsius. */
		skinTemperatures?: Array<number> | null;
	}
	...
	export interface SecurityPosture {
		...
		postureDetails?: Array<PostureDetail> | null;
	}
	...
	export interface PostureDetail {
		...
		advice?: Array<UserFacingMessage> | null;
	...
	export interface Enterprise {
		...
		enabledNotificationTypes?: Array<string> | null;
		...
		signinDetails?: Array<SigninDetail> | null;
		...
		termsAndConditions?: Array<TermsAndConditions> | null;
	}
	...
	export interface TermsAndConditions {
		...
		/** Provides a user-facing message with locale info. The maximum message length is 4096 characters. */
		content?: UserFacingMessage | null;

		/** Provides a user-facing message with locale info. The maximum message length is 4096 characters. */
		header?: UserFacingMessage | null;
	}
	...
	export interface Policy {
		...
		accountTypesWithManagementDisabled?: Array<string> | null;
		...
		/** Security policies set to the most secure values by default. To maintain the security posture of a device, we don't recommend overriding any of the default values. */
		advancedSecurityOverrides?: AdvancedSecurityOverrides | null;

		/** Configuration for an always-on VPN connection. */
		alwaysOnVpnPackage?: AlwaysOnVpnPackage | null;
		...
		androidDevicePolicyTracks?: Array<string> | null;
		...
		applications?: Array<ApplicationPolicy> | null;
		...
		choosePrivateKeyRules?: Array<ChoosePrivateKeyRule> | null;
		...
		complianceRules?: Array<ComplianceRule> | null;
		...
		/** Provides a user-facing message with locale info. The maximum message length is 4096 characters. */
		deviceOwnerLockScreenInfo?: UserFacingMessage | null;
		...
		frpAdminEmails?: Array<string> | null;
		...
		keyguardDisabledFeatures?: Array<string> | null;
		...
		/** Settings controlling the behavior of a device in kiosk mode. To enable kiosk mode, set kioskCustomLauncherEnabled to true or specify an app in the policy with installType KIOSK. */
		kioskCustomization?: KioskCustomization | null;
		...
		/** Provides a user-facing message with locale info. The maximum message length is 4096 characters. */
		longSupportMessage?: UserFacingMessage | null;
		...
		openNetworkConfiguration?: {[id: string]: any } | null;
		...
		passwordPolicies?: Array<PasswordRequirements> | null;
		...
		permittedAccessibilityServices?: PackageNameList | null;

		/** A list of package names. */
		permittedInputMethods?: PackageNameList | null;

		/** Default intent handler activities. */
		persistentPreferredActivities?: Array<PersistentPreferredActivity> | null;
		...
		policyEnforcementRules?: Array<PolicyEnforcementRule> | null;
		...
		recommendedGlobalProxy?: ProxyInfo | null;
		...
		setupActions?: Array<SetupAction> | null;

		/** Whether location sharing is disabled. */
		shareLocationDisabled?: boolean | null;

		/** Provides a user-facing message with locale info. The maximum message length is 4096 characters. */
		shortSupportMessage?: UserFacingMessage | null;
		...
		stayOnPluggedModes?: Array<string> | null;
	...
	export interface ProxyInfo {
		...
		excludedHosts?: Array<string> | null;
	...
	export interface SetupAction {
		...
		/** Provides a user-facing message with locale info. The maximum message length is 4096 characters. */
		description?: UserFacingMessage | null;

		/** An action to launch an app. */
		launchApp?: LaunchAppAction | null;

		/** Provides a user-facing message with locale info. The maximum message length is 4096 characters. */
		title?: UserFacingMessage | null;
	}
	...
	export interface StatusReportingSettings {
		...
		/** Settings controlling the behavior of application reports. */
		applicationReportingSettings?: ApplicationReportingSettings | null;
	...
	export interface SystemUpdate {
		...
		freezePeriods?: Array<FreezePeriod> | null;
