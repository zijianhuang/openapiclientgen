...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {string} resourceGroupName Name of the Resource group within the Azure subscription.
		 * @param {string} namespaceName The namespace name
		 * @param {MigrationConfigs_CreateAndStartMigrationConfigName} configName The configuration name. Should always be "$default".
		 * @param {string} api_version Client API version.
		 * @param {string} subscriptionId Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
		 ...
		 */
		MigrationConfigs_CreateAndStartMigration(resourceGroupName: string, namespaceName: string, configName: MigrationConfigs_CreateAndStartMigrationConfigName, api_version: string, subscriptionId: string, requestBody: MigrationConfigProperties): Observable<MigrationConfigProperties> {
		 ...
		 * @param {string} resourceGroupName Name of the Resource group within the Azure subscription.
		 * @param {string} namespaceName The namespace name
		 * @param {MigrationConfigs_DeleteConfigName} configName The configuration name. Should always be "$default".
		 * @param {string} api_version Client API version.
		 * @param {string} subscriptionId Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
		 * @return {void} Delete Migration Config request accepted
		 */
		MigrationConfigs_Delete(resourceGroupName: string, namespaceName: string, configName: MigrationConfigs_DeleteConfigName, api_version: string, subscriptionId: string): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} resourceGroupName Name of the Resource group within the Azure subscription.
		 * @param {string} namespaceName The namespace name
		 * @param {MigrationConfigs_RevertConfigName} configName The configuration name. Should always be "$default".
		 * @param {string} api_version Client API version.
		 * @param {string} subscriptionId Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
		 * @return {void} MigrationConfig Revert operation is successful.
		 */
		MigrationConfigs_Revert(resourceGroupName: string, namespaceName: string, configName: MigrationConfigs_RevertConfigName, api_version: string, subscriptionId: string): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} resourceGroupName Name of the Resource group within the Azure subscription.
		 * @param {string} namespaceName The namespace name
		 * @param {MigrationConfigs_CompleteMigrationConfigName} configName The configuration name. Should always be "$default".
		 * @param {string} api_version Client API version.
		 * @param {string} subscriptionId Subscription credentials that uniquely identify a Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
		 * @return {void} upgrade operation of Migration Config is successful.
		 */
		MigrationConfigs_CompleteMigration(resourceGroupName: string, namespaceName: string, configName: MigrationConfigs_CompleteMigrationConfigName, api_version: string, subscriptionId: string): Observable<HttpResponse<string>> {
	...
	export enum MigrationConfigs_CreateAndStartMigrationConfigName { '$default' = 0 }

	export enum MigrationConfigs_DeleteConfigName { '$default' = 0 }

	export enum MigrationConfigs_RevertConfigName { '$default' = 0 }

	export enum MigrationConfigs_CompleteMigrationConfigName { '$default' = 0 }
