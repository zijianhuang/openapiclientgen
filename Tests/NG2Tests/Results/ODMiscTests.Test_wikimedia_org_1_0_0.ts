...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {MetricsBytes_differenceAbsolutePer_page_project_page_title_editor_type_granularity_start_endGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 ...
		 */
		MetricsBytes_differenceAbsolutePer_page_project_page_title_editor_type_granularity_start_endGet(project: string, page_title: string, editor_type: MetricsBytes_differenceAbsolutePer_page_project_page_title_editor_type_granularity_start_endGetEditor_type, granularity: MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity, start: string, end: string, headersHandler?: () => HttpHeaders): Observable<Absolute_bytes_difference_per_page> {
			return this.http.get<Absolute_bytes_difference_per_page>(this.baseUri + 'metrics/bytes-difference/absolute/per-page/' + (project == null ? '' : encodeURIComponent(project)) + '/' + (page_title == null ? '' : encodeURIComponent(page_title)) + '/' + editor_type + '/' + granularity + '/' + (start == null ? '' : encodeURIComponent(start)) + '/' + (end == null ? '' : encodeURIComponent(end)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * or mediawiki.org. If you're interested in the aggregation of all projects, use
		 * all-projects.
		 * @param {MetricsBytes_differenceNetAggregate_project_editor_type_page_type_granularity_start_endGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 * @param {MetricsBytes_differenceNetAggregate_project_editor_type_page_type_granularity_start_endGetPage_type} page_type If you want to filter by page-type, use one of content (edits on pages in content
		 * namespaces) or non-content (edits on pages in non-content namespaces). If you are
		 * interested in edits regardless of their page-type, use all-page-types.
		 * @param {MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity} granularity Time unit for the response data. As of today, supported values are daily and monthly
		 * @param {string} start The date of the first day to include, in YYYYMMDD format
		 ...
		 */
		MetricsBytes_differenceNetAggregate_project_editor_type_page_type_granularity_start_endGet(project: string, editor_type: MetricsBytes_differenceNetAggregate_project_editor_type_page_type_granularity_start_endGetEditor_type, page_type: MetricsBytes_differenceNetAggregate_project_editor_type_page_type_granularity_start_endGetPage_type, granularity: MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity, start: string, end: string, headersHandler?: () => HttpHeaders): Observable<Net_bytes_difference> {
		 ...
		 * page canonical namespace.
		 * @param {MetricsBytes_differenceNetPer_page_project_page_title_editor_type_granularity_start_endGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 ...
		 */
		MetricsBytes_differenceNetPer_page_project_page_title_editor_type_granularity_start_endGet(project: string, page_title: string, editor_type: MetricsBytes_differenceNetPer_page_project_page_title_editor_type_granularity_start_endGetEditor_type, granularity: MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity, start: string, end: string, headersHandler?: () => HttpHeaders): Observable<Net_bytes_difference_per_page> {
			return this.http.get<Net_bytes_difference_per_page>(this.baseUri + 'metrics/bytes-difference/net/per-page/' + (project == null ? '' : encodeURIComponent(project)) + '/' + (page_title == null ? '' : encodeURIComponent(page_title)) + '/' + editor_type + '/' + granularity + '/' + (start == null ? '' : encodeURIComponent(start)) + '/' + (end == null ? '' : encodeURIComponent(end)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @param {MetricsEdited_pagesAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 * @param {MetricsEdited_pagesAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetPage_type} page_type If you want to filter by page-type, use one of content (edited-pages in content
		 ...
		 * @param {MetricsEdited_pagesNew_project_editor_type_page_type_granularity_start_endGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 ...
		 * @param {MetricsEdited_pagesNew_project_editor_type_page_type_granularity_start_endGetPage_type} page_type If you want to filter by page-type, use one of content (new pages in content
		 ...
		 */
		MetricsEdited_pagesNew_project_editor_type_page_type_granularity_start_endGet(project: string, editor_type: MetricsEdited_pagesNew_project_editor_type_page_type_granularity_start_endGetEditor_type, page_type: MetricsEdited_pagesNew_project_editor_type_page_type_granularity_start_endGetPage_type, granularity: MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity, start: string, end: string, headersHandler?: () => HttpHeaders): Observable<New_pages> {
		 ...
		 * projects like www.mediawiki.org, you can use that full string, or just use mediawiki
		 * or mediawiki.org.
		 * @param {MetricsEdited_pagesTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 * @param {MetricsEdited_pagesTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type} page_type If you want to filter by page-type, use one of content (edits on pages in content
		 * namespaces) or non-content (edits on pages in non-content namespaces). If you are
		 * interested in edits regardless of their page-type, use all-page-types.
		 ...
		 */
		MetricsEdited_pagesTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGet(project: string, editor_type: MetricsEdited_pagesTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type, page_type: MetricsEdited_pagesTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type, year: string, month: string, day: string, headersHandler?: () => HttpHeaders): Observable<Top_edited_pages_by_abs_bytes_diff> {
		 ...
		 * projects like www.mediawiki.org, you can use that full string, or just use mediawiki
		 * or mediawiki.org.
		 * @param {MetricsEdited_pagesTop_by_edits_project_editor_type_page_type_year_month_dayGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 * @param {MetricsEdited_pagesTop_by_edits_project_editor_type_page_type_year_month_dayGetPage_type} page_type If you want to filter by page-type, use one of content (edits on pages in content
		 * namespaces) or non-content (edits on pages in non-content namespaces). If you are
		 * interested in edits regardless of their page-type, use all-page-types.
		 * @param {string} year The year of the date for which to retrieve top edited-pages, in YYYY format.
		 * @param {string} month The month of the date for which to retrieve top edited-pages, in MM format. If you want to get the top edited-pages of a whole month, the day parameter should be all-days.
		 ...
		 */
		MetricsEdited_pagesTop_by_edits_project_editor_type_page_type_year_month_dayGet(project: string, editor_type: MetricsEdited_pagesTop_by_edits_project_editor_type_page_type_year_month_dayGetEditor_type, page_type: MetricsEdited_pagesTop_by_edits_project_editor_type_page_type_year_month_dayGetPage_type, year: string, month: string, day: string, headersHandler?: () => HttpHeaders): Observable<Top_edited_pages_by_edits> {
		 ...
		 * projects like www.mediawiki.org, you can use that full string, or just use mediawiki
		 * or mediawiki.org.
		 * @param {MetricsEdited_pagesTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 * @param {MetricsEdited_pagesTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type} page_type If you want to filter by page-type, use one of content (edits on pages in content
		 * namespaces) or non-content (edits on pages in non-content namespaces). If you are
		 * interested in edits regardless of their page-type, use all-page-types.
		 * @param {string} year The year of the date for which to retrieve top edited-pages, in YYYY format.
		 * @param {string} month The month of the date for which to retrieve top edited-pages, in MM format. If you want to get the top edited-pages of a whole month, the day parameter should be all-days.
		 ...
		 */
		MetricsEdited_pagesTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGet(project: string, editor_type: MetricsEdited_pagesTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type, page_type: MetricsEdited_pagesTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type, year: string, month: string, day: string, headersHandler?: () => HttpHeaders): Observable<Top_edited_pages_by_net_bytes_diff> {
		 ...
		 * For projects like www.mediawiki.org, you can use that full string, or just use
		 * mediawiki or mediawiki.org.
		 * @param {MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging
		 * to the bot group but having bot-like names) or user (registered account not in bot
		 * group nor having bot-like name). If you are interested in edits regardless
		 * of their editor-type, use all-editor-types.
		 * @param {MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetPage_type} page_type If you want to filter by page-type, use one of content (edits made in content
		 ...
		 * @param {MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetActivity_level} activity_level If you want to filter by activity-level, use one of 1..4-edits, 5..24-edits,
		 ...
		 */
		MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGet(project: string, editor_type: MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetEditor_type, page_type: MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetPage_type, activity_level: MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetActivity_level, granularity: MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity, start: string, end: string, headersHandler?: () => HttpHeaders): Observable<Editors> {
		 ...
		 * projects like www.mediawiki.org, you can use that full string, or just use mediawiki
		 * or mediawiki.org.
		 * @param {MetricsEditorsTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 * @param {MetricsEditorsTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type} page_type If you want to filter by page-type, use one of content (edits on pages in content
		 * namespaces) or non-content (edits on pages in non-content namespaces). If you are
		 * interested in edits regardless of their page-type, use all-page-types.
		 ...
		 */
		MetricsEditorsTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGet(project: string, editor_type: MetricsEditorsTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type, page_type: MetricsEditorsTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type, year: string, month: string, day: string, headersHandler?: () => HttpHeaders): Observable<Top_editors_by_abs_bytes_diff> {
		 ...
		 * projects like www.mediawiki.org, you can use that full string, or just use mediawiki
		 * or mediawiki.org.
		 * @param {MetricsEditorsTop_by_edits_project_editor_type_page_type_year_month_dayGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 * @param {MetricsEditorsTop_by_edits_project_editor_type_page_type_year_month_dayGetPage_type} page_type If you want to filter by page-type, use one of content (edits on pages in content
		 * namespaces) or non-content (edits on pages in non-content namespaces). If you are
		 * interested in edits regardless of their page-type, use all-page-types.
		 * @param {string} year The year of the date for which to retrieve top editors, in YYYY format.
		 * @param {string} month The month of the date for which to retrieve top editors, in MM format. If you want to get the top editors of a whole month, the day parameter should be all-days.
		 ...
		 */
		MetricsEditorsTop_by_edits_project_editor_type_page_type_year_month_dayGet(project: string, editor_type: MetricsEditorsTop_by_edits_project_editor_type_page_type_year_month_dayGetEditor_type, page_type: MetricsEditorsTop_by_edits_project_editor_type_page_type_year_month_dayGetPage_type, year: string, month: string, day: string, headersHandler?: () => HttpHeaders): Observable<Top_editors_by_edits> {
		 ...
		 * projects like www.mediawiki.org, you can use that full string, or just use mediawiki
		 * or mediawiki.org.
		 * @param {MetricsEditorsTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 * @param {MetricsEditorsTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type} page_type If you want to filter by page-type, use one of content (edits on pages in content
		 * namespaces) or non-content (edits on pages in non-content namespaces). If you are
		 * interested in edits regardless of their page-type, use all-page-types.
		 * @param {string} year The year of the date for which to retrieve top editors, in YYYY format.
		 * @param {string} month The month of the date for which to retrieve top editors, in MM format. If you want to get the top editors of a whole month, the day parameter should be all-days.
		 ...
		 */
		MetricsEditorsTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGet(project: string, editor_type: MetricsEditorsTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type, page_type: MetricsEditorsTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type, year: string, month: string, day: string, headersHandler?: () => HttpHeaders): Observable<Top_editors_by_net_bytes_diff> {
		 ...
		 * @param {MetricsEditsAggregate_project_editor_type_page_type_granularity_start_endGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging
		 * to the bot group but having bot-like names) or user (registered account not in bot
		 * group nor having bot-like name). If you are interested in edits regardless
		 * of their editor-type, use all-editor-types.
		 * @param {MetricsEditsAggregate_project_editor_type_page_type_granularity_start_endGetPage_type} page_type If you want to filter by page-type, use one of content (edits on pages in content
		 * namespaces) or non-content (edits on pages in non-content namespaces). If you are
		 * interested in edits regardless of their page-type, use all-page-types.
		 * @param {MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity} granularity The time unit for the response data. As of today, supported values are
		 * daily and monthly.
		 ...
		 */
		MetricsEditsAggregate_project_editor_type_page_type_granularity_start_endGet(project: string, editor_type: MetricsEditsAggregate_project_editor_type_page_type_granularity_start_endGetEditor_type, page_type: MetricsEditsAggregate_project_editor_type_page_type_granularity_start_endGetPage_type, granularity: MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity, start: string, end: string, headersHandler?: () => HttpHeaders): Observable<Edits> {
		 ...
		 * @param {MetricsEditsPer_page_project_page_title_editor_type_granularity_start_endGetEditor_type} editor_type If you want to filter by editor-type, use one of anonymous, group-bot (registered
		 * accounts belonging to the bot group), name-bot (registered accounts not belonging to
		 * the bot group but having bot-like names) or user (registered account not in bot group
		 * nor having bot-like name). If you are interested in edits regardless of their
		 * editor-type, use all-editor-types.
		 ...
		 */
		MetricsEditsPer_page_project_page_title_editor_type_granularity_start_endGet(project: string, page_title: string, editor_type: MetricsEditsPer_page_project_page_title_editor_type_granularity_start_endGetEditor_type, granularity: MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity, start: string, end: string, headersHandler?: () => HttpHeaders): Observable<Edits_per_page> {
			return this.http.get<Edits_per_page>(this.baseUri + 'metrics/edits/per-page/' + (project == null ? '' : encodeURIComponent(project)) + '/' + (page_title == null ? '' : encodeURIComponent(page_title)) + '/' + editor_type + '/' + granularity + '/' + (start == null ? '' : encodeURIComponent(start)) + '/' + (end == null ? '' : encodeURIComponent(end)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @param {string} project If you want to filter by project, use the domain of any Wikimedia project,
		 * for example 'en.wikipedia.org', 'www.mediawiki.org' or 'commons.wikimedia.org'.
		 * @param {MetricsPageviewsPer_article_project_access_agent_article_granularity_start_endGetAccess} access If you want to filter by access method, use one of desktop, mobile-app
		 ...
		 * @param {string} project If you want to filter by project, use the domain of any Wikimedia project,
		 * for example 'en.wikipedia.org', 'www.mediawiki.org' or 'commons.wikimedia.org'.
		 * @param {MetricsPageviewsTop_by_country_project_access_year_monthGetAccess} access If you want to filter by access method, use one of desktop, mobile-app or mobile-web.
		 * If you are interested in pageviews regardless of access method, use all-access.
		 ...
		 */
		MetricsPageviewsTop_by_country_project_access_year_monthGet(project: string, access: MetricsPageviewsTop_by_country_project_access_year_monthGetAccess, year: string, month: string, headersHandler?: () => HttpHeaders): Observable<By_country> {
		 ...
		 * @param {string} project If you want to filter by project, use the domain of any Wikimedia project,
		 * for example 'en.wikipedia.org', 'www.mediawiki.org' or 'commons.wikimedia.org'.
		 * @param {MetricsPageviewsTop_project_access_year_month_dayGetAccess} access If you want to filter by access method, use one of desktop, mobile-app or mobile-web.
		 * If you are interested in pageviews regardless of access method, use all-access.
		 ...
		 */
		MetricsPageviewsTop_project_access_year_month_dayGet(project: string, access: MetricsPageviewsTop_project_access_year_month_dayGetAccess, year: string, month: string, day: string, headersHandler?: () => HttpHeaders): Observable<Pageview_tops> {
		 ...
		 * @param {string} project If you want to filter by project, use the domain of any Wikimedia project,
		 * for example 'en.wikipedia.org', 'www.mediawiki.org' or 'commons.wikimedia.org'.
		 * @param {MetricsUnique_devices_project_access_site_granularity_start_endGetAccess_site} access_site If you want to filter by accessed site, use one of desktop-site or mobile-site.
		 ...
		 */
		MetricsUnique_devices_project_access_site_granularity_start_endGet(project: string, access_site: MetricsUnique_devices_project_access_site_granularity_start_endGetAccess_site, granularity: MetricsBytes_differenceAbsoluteAggregate_project_editor_type_page_type_granularity_start_endGetGranularity, start: string, end: string, headersHandler?: () => HttpHeaders): Observable<Unique_devices> {
	...
	export enum MetricsBytes_differenceAbsolutePer_page_project_page_title_editor_type_granularity_start_endGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsBytes_differenceNetAggregate_project_editor_type_page_type_granularity_start_endGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsBytes_differenceNetAggregate_project_editor_type_page_type_granularity_start_endGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsBytes_differenceNetPer_page_project_page_title_editor_type_granularity_start_endGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEdited_pagesAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEdited_pagesAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEdited_pagesAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetActivity_level { 'all-activity-levels' = 0, _1__4_edits = 1, _5__24_edits = 2, _25__99_edits = 3, _100___edits = 4 }

	export enum MetricsEdited_pagesNew_project_editor_type_page_type_granularity_start_endGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEdited_pagesNew_project_editor_type_page_type_granularity_start_endGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEdited_pagesTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEdited_pagesTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEdited_pagesTop_by_edits_project_editor_type_page_type_year_month_dayGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEdited_pagesTop_by_edits_project_editor_type_page_type_year_month_dayGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEdited_pagesTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEdited_pagesTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEditorsAggregate_project_editor_type_page_type_activity_level_granularity_start_endGetActivity_level { 'all-activity-levels' = 0, _1__4_edits = 1, _5__24_edits = 2, _25__99_edits = 3, _100___edits = 4 }

	export enum MetricsEditorsTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEditorsTop_by_absolute_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEditorsTop_by_edits_project_editor_type_page_type_year_month_dayGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEditorsTop_by_edits_project_editor_type_page_type_year_month_dayGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEditorsTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEditorsTop_by_net_bytes_difference_project_editor_type_page_type_year_month_dayGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEditsAggregate_project_editor_type_page_type_granularity_start_endGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }

	export enum MetricsEditsAggregate_project_editor_type_page_type_granularity_start_endGetPage_type { 'all-page-types' = 0, content = 1, 'non-content' = 2 }

	export enum MetricsEditsPer_page_project_page_title_editor_type_granularity_start_endGetEditor_type { 'all-editor-types' = 0, anonymous = 1, 'group-bot' = 2, 'name-bot' = 3, user = 4 }
	...
	export enum MetricsPageviewsPer_article_project_access_agent_article_granularity_start_endGetAccess { 'all-access' = 0, desktop = 1, 'mobile-app' = 2, 'mobile-web' = 3 }
	...
	export enum MetricsPageviewsTop_by_country_project_access_year_monthGetAccess { 'all-access' = 0, desktop = 1, 'mobile-app' = 2, 'mobile-web' = 3 }

	export enum MetricsPageviewsTop_project_access_year_month_dayGetAccess { 'all-access' = 0, desktop = 1, 'mobile-app' = 2, 'mobile-web' = 3 }

	export enum MetricsUnique_devices_project_access_site_granularity_start_endGetAccess_site { 'all-sites' = 0, 'desktop-site' = 1, 'mobile-site' = 2 }
