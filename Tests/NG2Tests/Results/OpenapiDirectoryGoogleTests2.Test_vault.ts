...
export namespace MyNS {
	...
	export interface AddHeldAccountsResponse {
		...
		responses?: Array<AddHeldAccountResult> | null;
	}
	...
	export interface Matter {
		 ...
		 */
		matterPermissions?: Array<MatterPermission> | null;
	...
	export interface CloudStorageSink {
		...
		files?: Array<CloudStorageFile> | null;
	}
	...
	export interface CorpusQuery {
		...
		hangoutsChatQuery?: HeldHangoutsChatQuery | null;
	...
	export interface Export {
		...
		/** Export sink for cloud storage files. */
		cloudStorageSink?: CloudStorageSink | null;
	...
	export interface ExportOptions {
		...
		/** The options for Drive export. */
		driveOptions?: DriveExportOptions | null;

		/** The options for groups export. */
		groupsOptions?: GroupsExportOptions | null;

		/** The options for hangouts chat export. */
		hangoutsChatOptions?: HangoutsChatExportOptions | null;

		/** The options for mail export. */
		mailOptions?: MailExportOptions | null;
	...
	export interface Query {
		...
		/** Accounts to search */
		hangoutsChatInfo?: HangoutsChatInfo | null;

		/** Hangouts chat search advanced options */
		hangoutsChatOptions?: HangoutsChatOptions | null;
		...
		sharedDriveInfo?: SharedDriveInfo | null;
		...
		teamDriveInfo?: TeamDriveInfo | null;
	...
	export interface SharedDriveInfo {
		 ...
		 */
		sharedDriveIds?: Array<string> | null;
	}
	...
	export interface TeamDriveInfo {
		 ...
		 * href="https://developers.google.com/drive">Drive API</a>.
		 */
		teamDriveIds?: Array<string> | null;
	}
	...
	export interface Hold {
		 ...
		 * empty.
		 */
		accounts?: Array<HeldAccount> | null;
	...
	export interface ListSavedQueriesResponse {
		...
		savedQueries?: Array<SavedQuery> | null;
	}
