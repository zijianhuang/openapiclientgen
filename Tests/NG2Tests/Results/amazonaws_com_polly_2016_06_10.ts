...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {VoiceLanguageCode} LanguageCode  The language identification tag (ISO 639 code for the language name-ISO 3166 country code) for filtering the list of voices returned. If you don't specify this optional parameter, all available voices are returned. 
		 ...
		 */
		DescribeVoices(Engine: Engine | null | undefined, LanguageCode: VoiceLanguageCode | null | undefined, IncludeAdditionalLanguageCodes: boolean | null | undefined, NextToken: string | null | undefined): Observable<DescribeVoicesOutput> {
