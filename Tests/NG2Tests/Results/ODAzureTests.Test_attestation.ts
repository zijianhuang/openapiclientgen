...
export namespace MyNS {
	...
	export enum Policy_GetApi_version { _2018_09_01_preview = 0 }

	export enum Policy_GetTee { SgxEnclave = 0, OpenEnclave = 1, CyResComponent = 2, AzureGuest = 3 }

	export enum Policy_SetApi_version { _2018_09_01_preview = 0 }

	export enum Policy_ResetApi_version { _2018_09_01_preview = 0 }

	export enum Policy_PrepareToSetApi_version { _2018_09_01_preview = 0 }
