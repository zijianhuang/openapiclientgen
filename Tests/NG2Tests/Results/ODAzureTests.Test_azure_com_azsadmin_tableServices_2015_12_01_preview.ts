...
export namespace MyNS {
	...
	export enum TableServices_GetServiceType { default = 0 }
	...
	export interface TableServices_ListMetricDefinitionsReturnValue {
		...
		/** Localizable string. */
		name?: TableServices_ListMetricDefinitionsReturnName;
	...
	export interface TableServices_ListMetricDefinitionsReturnName {
	...
	export interface TableServices_ListMetricDefinitionsReturnNameFormProperties {
	...
	export function CreateTableServices_ListMetricDefinitionsReturnNameFormGroup() {
		return new FormGroup<TableServices_ListMetricDefinitionsReturnNameFormProperties>({
	...
	export enum TableServices_ListMetricDefinitionsReturnValuePrimaryAggregationType { None = 0, Average = 1, Total = 2, Minimum = 3, Maximum = 4, Last = 5 }

	export enum TableServices_ListMetricDefinitionsReturnValueUnit { Count = 0, Bytes = 1, Seconds = 2, CountPerSecond = 3, BytesPerSecond = 4 }
	...
	export interface TableServices_ListMetricsReturnValue {
		...
		/** Localizable string. */
		name?: TableServices_ListMetricsReturnName;
	...
	export interface TableServices_ListMetricsReturnName {
	...
	export interface TableServices_ListMetricsReturnNameFormProperties {
	...
	export function CreateTableServices_ListMetricsReturnNameFormGroup() {
		return new FormGroup<TableServices_ListMetricsReturnNameFormProperties>({
			localizedValue: new FormControl<string | null | undefined>(undefined),
			value: new FormControl<string | null | undefined>(undefined),
		});
