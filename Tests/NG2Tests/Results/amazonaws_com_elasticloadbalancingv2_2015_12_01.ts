...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {void} Success
		 */
		GET_CreateListener(LoadBalancerArn: string, Protocol: ListenerProtocol, Port: number, SslPolicy: string | null | undefined, Certificates: Array<Certificate> | null | undefined, DefaultActions: Array<Action>, AlpnPolicy: Array<string> | null | undefined, Action: GET_CreateListenerAction, Version: GET_AddListenerCertificatesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_CreateLoadBalancer(Name: string, Subnets: Array<string> | null | undefined, SubnetMappings: Array<SubnetMapping> | null | undefined, SecurityGroups: Array<string> | null | undefined, Scheme: LoadBalancerScheme | null | undefined, Tags: Array<Tag> | null | undefined, Type: LoadBalancerType | null | undefined, IpAddressType: LoadBalancerIpAddressType | null | undefined, Action: GET_CreateLoadBalancerAction, Version: GET_AddListenerCertificatesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_CreateRule(ListenerArn: string, Conditions: Array<RuleCondition>, Priority: number, Actions: Array<Action>, Action: GET_CreateRuleAction, Version: GET_AddListenerCertificatesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_CreateTargetGroup(Name: string, Protocol: ListenerProtocol | null | undefined, Port: number | null | undefined, VpcId: string | null | undefined, HealthCheckProtocol: ListenerProtocol | null | undefined, HealthCheckPort: string | null | undefined, HealthCheckEnabled: boolean | null | undefined, HealthCheckPath: string | null | undefined, HealthCheckIntervalSeconds: number | null | undefined, HealthCheckTimeoutSeconds: number | null | undefined, HealthyThresholdCount: number | null | undefined, UnhealthyThresholdCount: number | null | undefined, Matcher: GET_CreateTargetGroupMatcher | null | undefined, TargetType: TargetGroupTargetType | null | undefined, Action: GET_CreateTargetGroupAction, Version: GET_AddListenerCertificatesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DescribeSSLPolicies(Names: Array<string> | null | undefined, Marker: string | null | undefined, PageSize: number | null | undefined, Action: GET_DescribeSSLPoliciesAction, Version: GET_AddListenerCertificatesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_ModifyTargetGroup(TargetGroupArn: string, HealthCheckProtocol: ListenerProtocol | null | undefined, HealthCheckPort: string | null | undefined, HealthCheckPath: string | null | undefined, HealthCheckEnabled: boolean | null | undefined, HealthCheckIntervalSeconds: number | null | undefined, HealthCheckTimeoutSeconds: number | null | undefined, HealthyThresholdCount: number | null | undefined, UnhealthyThresholdCount: number | null | undefined, Matcher: GET_ModifyTargetGroupMatcher | null | undefined, Action: GET_ModifyTargetGroupAction, Version: GET_AddListenerCertificatesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_SetIpAddressType(LoadBalancerArn: string, IpAddressType: LoadBalancerIpAddressType, Action: GET_SetIpAddressTypeAction, Version: GET_AddListenerCertificatesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_SetSubnets(LoadBalancerArn: string, Subnets: Array<string> | null | undefined, SubnetMappings: Array<SubnetMapping> | null | undefined, Action: GET_SetSubnetsAction, Version: GET_AddListenerCertificatesVersion): Observable<HttpResponse<string>> {
