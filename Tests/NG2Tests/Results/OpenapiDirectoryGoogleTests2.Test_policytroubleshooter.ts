...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Policytroubleshooter_iam_troubleshoot(requestBody: GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v1beta/iam:troubleshoot', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
