...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {Assessments_ListByProjectApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {AssessmentResultList} OK. Returns list of Assessment objects.
		 */
		Assessments_ListByProject(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: Assessments_ListByProjectApi_version): Observable<AssessmentResultList> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {Groups_ListByProjectApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {GroupResultList} OK. Returns list of groups.
		 */
		Groups_ListByProject(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: Groups_ListByProjectApi_version): Observable<GroupResultList> {
		 ...
		 * @param {Groups_GetApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {Group} OK. Returns the group with the specified name.
		 */
		Groups_Get(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, api_version: Groups_GetApi_version): Observable<Group> {
		 ...
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {string} groupName Unique name of a group within a project.
		 * @param {Groups_CreateApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @param {Group} requestBody New or Updated Group object.
		 * @return {Group} OK. Existing group updated.
		 */
		Groups_Create(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, api_version: Groups_CreateApi_version, requestBody: Group): Observable<Group> {
		 ...
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {string} groupName Unique name of a group within a project.
		 * @param {Groups_DeleteApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {void} OK. Deleted the group.
		 */
		Groups_Delete(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, api_version: Groups_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {string} groupName Unique name of a group within a project.
		 * @param {Assessments_ListByGroupApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {AssessmentResultList} OK. Returns list of Assessment objects.
		 */
		Assessments_ListByGroup(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, api_version: Assessments_ListByGroupApi_version): Observable<AssessmentResultList> {
		 ...
		 * @param {Assessments_GetApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {Assessment} OK. Returns Assessment object.
		 */
		Assessments_Get(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, assessmentName: string, api_version: Assessments_GetApi_version): Observable<Assessment> {
		 ...
		 * @param {string} groupName Unique name of a group within a project.
		 * @param {string} assessmentName Unique name of an assessment within a project.
		 * @param {Assessments_CreateApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @param {Assessment} requestBody New or Updated Assessment object.
		 * @return {Assessment} OK. Existing assessment updated.
		 */
		Assessments_Create(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, assessmentName: string, api_version: Assessments_CreateApi_version, requestBody: Assessment): Observable<Assessment> {
		 ...
		 * @param {string} groupName Unique name of a group within a project.
		 * @param {string} assessmentName Unique name of an assessment within a project.
		 * @param {Assessments_DeleteApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {void} OK. Deleted the assessment.
		 */
		Assessments_Delete(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, assessmentName: string, api_version: Assessments_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} groupName Unique name of a group within a project.
		 * @param {string} assessmentName Unique name of an assessment within a project.
		 * @param {AssessedMachines_ListByAssessmentApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {AssessedMachineResultList} OK. Returns list of machines with their assessment data in the assessment.
		 */
		AssessedMachines_ListByAssessment(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, assessmentName: string, api_version: AssessedMachines_ListByAssessmentApi_version): Observable<AssessedMachineResultList> {
		 ...
		 * @param {AssessedMachines_GetApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {AssessedMachine} OK. Returns a specific assessed machine.
		 */
		AssessedMachines_Get(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, assessmentName: string, assessedMachineName: string, api_version: AssessedMachines_GetApi_version): Observable<AssessedMachine> {
		 ...
		 * @param {string} groupName Unique name of a group within a project.
		 * @param {string} assessmentName Unique name of an assessment within a project.
		 * @param {Assessments_GetReportDownloadUrlApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {DownloadUrl} OK.
		 */
		Assessments_GetReportDownloadUrl(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, assessmentName: string, api_version: Assessments_GetReportDownloadUrlApi_version): Observable<DownloadUrl> {
		 ...
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {string} groupName Unique name of a group within a project.
		 * @param {Groups_UpdateMachinesApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @param {UpdateGroupBody} requestBody Machines list to be added or removed from group.
		 * @return {Group} OK. Existing group updated.
		 */
		Groups_UpdateMachines(subscriptionId: string, resourceGroupName: string, projectName: string, groupName: string, api_version: Groups_UpdateMachinesApi_version, requestBody: UpdateGroupBody): Observable<Group> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {HyperVCollectors_ListByProjectApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {HyperVCollectorList} OK. Returns list of Hyper-V collectors.
		 */
		HyperVCollectors_ListByProject(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: HyperVCollectors_ListByProjectApi_version): Observable<HyperVCollectorList> {
		 ...
		 * @param {HyperVCollectors_GetApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {HyperVCollector} OK. Returns the specific Hyper-V collector.
		 */
		HyperVCollectors_Get(subscriptionId: string, resourceGroupName: string, projectName: string, hyperVCollectorName: string, api_version: HyperVCollectors_GetApi_version): Observable<HyperVCollector> {
		 ...
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {string} hyperVCollectorName Unique name of a Hyper-V collector within a project.
		 * @param {HyperVCollectors_CreateApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @param {HyperVCollector} requestBody New or Updated Hyper-V collector.
		 * @return {HyperVCollector} OK. Existing Hyper-V collector.
		 */
		HyperVCollectors_Create(subscriptionId: string, resourceGroupName: string, projectName: string, hyperVCollectorName: string, api_version: HyperVCollectors_CreateApi_version, requestBody: HyperVCollector): Observable<HyperVCollector> {
		 ...
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {string} hyperVCollectorName Unique name of a Hyper-V collector within a project.
		 * @param {HyperVCollectors_DeleteApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {void} OK. Deleted the Hyper-V collector.
		 */
		HyperVCollectors_Delete(subscriptionId: string, resourceGroupName: string, projectName: string, hyperVCollectorName: string, api_version: HyperVCollectors_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {Machines_ListByProjectApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {MachineResultList} OK. Returns list of all machine objects.
		 */
		Machines_ListByProject(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: Machines_ListByProjectApi_version): Observable<MachineResultList> {
		 ...
		 * @param {Machines_GetApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {Machine} OK. Returns the machine with the specified name.
		 */
		Machines_Get(subscriptionId: string, resourceGroupName: string, projectName: string, machineName: string, api_version: Machines_GetApi_version): Observable<Machine> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {VMwareCollectors_ListByProjectApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {VMwareCollectorList} OK. Returns list of VMware collectors.
		 */
		VMwareCollectors_ListByProject(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: VMwareCollectors_ListByProjectApi_version): Observable<VMwareCollectorList> {
		 ...
		 * @param {VMwareCollectors_GetApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {VMwareCollector} OK. Returns the specific VMware collector.
		 */
		VMwareCollectors_Get(subscriptionId: string, resourceGroupName: string, projectName: string, vmWareCollectorName: string, api_version: VMwareCollectors_GetApi_version): Observable<VMwareCollector> {
		 ...
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {string} vmWareCollectorName Unique name of a VMware collector within a project.
		 * @param {VMwareCollectors_CreateApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @param {VMwareCollector} requestBody New or Updated VMware collector.
		 * @return {VMwareCollector} OK. Existing VMware collector.
		 */
		VMwareCollectors_Create(subscriptionId: string, resourceGroupName: string, projectName: string, vmWareCollectorName: string, api_version: VMwareCollectors_CreateApi_version, requestBody: VMwareCollector): Observable<VMwareCollector> {
		 ...
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {string} vmWareCollectorName Unique name of a VMware collector within a project.
		 * @param {VMwareCollectors_DeleteApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {void} OK. Deleted the VMware collector.
		 */
		VMwareCollectors_Delete(subscriptionId: string, resourceGroupName: string, projectName: string, vmWareCollectorName: string, api_version: VMwareCollectors_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} subscriptionId Azure Subscription Id in which project was created.
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {Projects_ListApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {ProjectResultList} OK.
		 */
		Projects_List(subscriptionId: string, resourceGroupName: string, api_version: Projects_ListApi_version): Observable<ProjectResultList> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {Projects_GetApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {Project} OK.
		 */
		Projects_Get(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: Projects_GetApi_version): Observable<Project> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {Projects_CreateApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @param {Project} requestBody New or Updated project object.
		 * @return {Project} OK. Existing project updated.
		 */
		Projects_Create(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: Projects_CreateApi_version, requestBody: Project): Observable<Project> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {Projects_DeleteApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {void} OK. Deleted the group.
		 */
		Projects_Delete(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: Projects_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {Projects_UpdateApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @param {Project} requestBody Updated project object.
		 * @return {Project} OK. Existing project updated.
		 */
		Projects_Update(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: Projects_UpdateApi_version, requestBody: Project): Observable<Project> {
		 ...
		 * @param {string} resourceGroupName Name of the Azure Resource Group that project is part of.
		 * @param {string} projectName Name of the Azure Migrate project.
		 * @param {Project_AssessmentOptionsListApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {AssessmentOptionsResultList} OK.
		 */
		Project_AssessmentOptionsList(subscriptionId: string, resourceGroupName: string, projectName: string, api_version: Project_AssessmentOptionsListApi_version): Observable<AssessmentOptionsResultList> {
		 ...
		 * @param {Project_AssessmentOptionsApi_version} api_version Standard request header. Used by service to identify API version used by client.
		 * @return {AssessmentOptions} OK.
		 */
		Project_AssessmentOptions(subscriptionId: string, resourceGroupName: string, projectName: string, assessmentOptionsName: string, api_version: Project_AssessmentOptionsApi_version): Observable<AssessmentOptions> {
	...
	export enum Projects_ListBySubscriptionApi_version { _2019_10_01 = 0 }

	export enum Assessments_ListByProjectApi_version { _2019_10_01 = 0 }

	export enum Groups_ListByProjectApi_version { _2019_10_01 = 0 }

	export enum Groups_GetApi_version { _2019_10_01 = 0 }

	export enum Groups_CreateApi_version { _2019_10_01 = 0 }

	export enum Groups_DeleteApi_version { _2019_10_01 = 0 }

	export enum Assessments_ListByGroupApi_version { _2019_10_01 = 0 }

	export enum Assessments_GetApi_version { _2019_10_01 = 0 }

	export enum Assessments_CreateApi_version { _2019_10_01 = 0 }

	export enum Assessments_DeleteApi_version { _2019_10_01 = 0 }

	export enum AssessedMachines_ListByAssessmentApi_version { _2019_10_01 = 0 }

	export enum AssessedMachines_GetApi_version { _2019_10_01 = 0 }

	export enum Assessments_GetReportDownloadUrlApi_version { _2019_10_01 = 0 }

	export enum Groups_UpdateMachinesApi_version { _2019_10_01 = 0 }

	export enum HyperVCollectors_ListByProjectApi_version { _2019_10_01 = 0 }

	export enum HyperVCollectors_GetApi_version { _2019_10_01 = 0 }

	export enum HyperVCollectors_CreateApi_version { _2019_10_01 = 0 }

	export enum HyperVCollectors_DeleteApi_version { _2019_10_01 = 0 }

	export enum Machines_ListByProjectApi_version { _2019_10_01 = 0 }

	export enum Machines_GetApi_version { _2019_10_01 = 0 }

	export enum VMwareCollectors_ListByProjectApi_version { _2019_10_01 = 0 }

	export enum VMwareCollectors_GetApi_version { _2019_10_01 = 0 }

	export enum VMwareCollectors_CreateApi_version { _2019_10_01 = 0 }

	export enum VMwareCollectors_DeleteApi_version { _2019_10_01 = 0 }

	export enum Projects_ListApi_version { _2019_10_01 = 0 }

	export enum Projects_GetApi_version { _2019_10_01 = 0 }

	export enum Projects_CreateApi_version { _2019_10_01 = 0 }

	export enum Projects_DeleteApi_version { _2019_10_01 = 0 }

	export enum Projects_UpdateApi_version { _2019_10_01 = 0 }

	export enum Project_AssessmentOptionsListApi_version { _2019_10_01 = 0 }

	export enum Project_AssessmentOptionsApi_version { _2019_10_01 = 0 }
