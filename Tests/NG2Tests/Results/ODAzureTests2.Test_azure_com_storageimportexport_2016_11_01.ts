...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {Locations_GetApi_version} api_version Specifies the API version to use for this request.
		 * @return {Location} OK
		 */
		Locations_Get(locationName: string, api_version: Locations_GetApi_version): Observable<Location> {
		 ...
		 * @param {Operations_ListApi_version} api_version Specifies the API version to use for this request.
		 * @return {ListOperationsResponse} OK
		 */
		Operations_List(api_version: Operations_ListApi_version): Observable<ListOperationsResponse> {
		 ...
		 * @param {Jobs_ListBySubscriptionApi_version} api_version Specifies the API version to use for this request.
		 * @return {ListJobsResponse} OK
		 */
		Jobs_ListBySubscription(top: number | null | undefined, filter: string | null | undefined, subscriptionId: string, api_version: Jobs_ListBySubscriptionApi_version): Observable<ListJobsResponse> {
		 ...
		 * @param {Jobs_ListByResourceGroupApi_version} api_version Specifies the API version to use for this request.
		 * @return {ListJobsResponse} OK
		 */
		Jobs_ListByResourceGroup(top: number | null | undefined, filter: string | null | undefined, subscriptionId: string, resourceGroupName: string, api_version: Jobs_ListByResourceGroupApi_version): Observable<ListJobsResponse> {
		 ...
		 * @param {string} subscriptionId The subscription ID for the Azure user.
		 * @param {string} resourceGroupName The resource group name uniquely identifies the resource group within the user subscription.
		 * @param {Jobs_GetApi_version} api_version Specifies the API version to use for this request.
		 * @return {JobResponse} OK
		 */
		Jobs_Get(jobName: string, subscriptionId: string, resourceGroupName: string, api_version: Jobs_GetApi_version): Observable<JobResponse> {
		 ...
		 * @param {string} subscriptionId The subscription ID for the Azure user.
		 * @param {string} resourceGroupName The resource group name uniquely identifies the resource group within the user subscription.
		 * @param {Jobs_CreateApi_version} api_version Specifies the API version to use for this request.
		 * @param {PutJobParameters} requestBody The parameters used for creating the job
		 * @return {JobResponse} OK
		 */
		Jobs_Create(jobName: string, subscriptionId: string, resourceGroupName: string, api_version: Jobs_CreateApi_version, requestBody: PutJobParameters): Observable<JobResponse> {
		 ...
		 * @param {string} subscriptionId The subscription ID for the Azure user.
		 * @param {string} resourceGroupName The resource group name uniquely identifies the resource group within the user subscription.
		 * @param {Jobs_DeleteApi_version} api_version Specifies the API version to use for this request.
		 * @return {void} OK
		 */
		Jobs_Delete(jobName: string, subscriptionId: string, resourceGroupName: string, api_version: Jobs_DeleteApi_version): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} subscriptionId The subscription ID for the Azure user.
		 * @param {string} resourceGroupName The resource group name uniquely identifies the resource group within the user subscription.
		 * @param {Jobs_UpdateApi_version} api_version Specifies the API version to use for this request.
		 * @param {UpdateJobParameters} requestBody The parameters to update in the job
		 * @return {JobResponse} OK
		 */
		Jobs_Update(jobName: string, subscriptionId: string, resourceGroupName: string, api_version: Jobs_UpdateApi_version, requestBody: UpdateJobParameters): Observable<JobResponse> {
		 ...
		 * @param {string} subscriptionId The subscription ID for the Azure user.
		 * @param {string} resourceGroupName The resource group name uniquely identifies the resource group within the user subscription.
		 * @param {BitLockerKeys_ListApi_version} api_version Specifies the API version to use for this request.
		 * @return {GetBitLockerKeysResponse} OK
		 */
		BitLockerKeys_List(jobName: string, subscriptionId: string, resourceGroupName: string, api_version: BitLockerKeys_ListApi_version): Observable<GetBitLockerKeysResponse> {
	...
	export enum Locations_ListApi_version { _2016_11_01 = 0 }

	export enum Locations_GetApi_version { _2016_11_01 = 0 }

	export enum Operations_ListApi_version { _2016_11_01 = 0 }

	export enum Jobs_ListBySubscriptionApi_version { _2016_11_01 = 0 }

	export enum Jobs_ListByResourceGroupApi_version { _2016_11_01 = 0 }

	export enum Jobs_GetApi_version { _2016_11_01 = 0 }

	export enum Jobs_CreateApi_version { _2016_11_01 = 0 }

	export enum Jobs_DeleteApi_version { _2016_11_01 = 0 }

	export enum Jobs_UpdateApi_version { _2016_11_01 = 0 }

	export enum BitLockerKeys_ListApi_version { _2016_11_01 = 0 }
