...
export namespace MyNS {
	...
	export enum QueueServices_GetServiceType { default = 'default' }
	...
	export interface QueueServices_ListMetricDefinitionsReturnValue {
		...
		/** Localizable string. */
		name?: QueueServices_ListMetricDefinitionsReturnValueName;
	...
	export interface QueueServices_ListMetricDefinitionsReturnValueName {
	...
	export interface QueueServices_ListMetricDefinitionsReturnValueNameFormProperties {
	...
	export function CreateQueueServices_ListMetricDefinitionsReturnValueNameFormGroup() {
		return new FormGroup<QueueServices_ListMetricDefinitionsReturnValueNameFormProperties>({
	...
	export enum QueueServices_ListMetricDefinitionsReturnValuePrimaryAggregationType { None = 'None', Average = 'Average', Total = 'Total', Minimum = 'Minimum', Maximum = 'Maximum', Last = 'Last' }

	export enum QueueServices_ListMetricDefinitionsReturnValueUnit { Count = 'Count', Bytes = 'Bytes', Seconds = 'Seconds', CountPerSecond = 'CountPerSecond', BytesPerSecond = 'BytesPerSecond' }
	...
	export interface QueueServices_ListMetricsReturnValue {
		...
		/** Localizable string. */
		name?: QueueServices_ListMetricsReturnValueName;
	...
	export interface QueueServices_ListMetricsReturnValueName {
	...
	export interface QueueServices_ListMetricsReturnValueNameFormProperties {
	...
	export function CreateQueueServices_ListMetricsReturnValueNameFormGroup() {
		return new FormGroup<QueueServices_ListMetricsReturnValueNameFormProperties>({
			localizedValue: new FormControl<string | null | undefined>(undefined),
			value: new FormControl<string | null | undefined>(undefined),
		});
