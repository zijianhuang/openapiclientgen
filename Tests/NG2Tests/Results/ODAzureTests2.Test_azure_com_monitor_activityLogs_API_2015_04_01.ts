...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {EventDataCollection} Successful request to get a page of events in the activity logs
		 */
		ActivityLogs_List(api_version: string, filter: string, select: string | null | undefined, subscriptionId: string): Observable<EventDataCollection> {
			return this.http.get<EventDataCollection>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/microsoft.insights/eventtypes/management/values?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&select=' + (select == null ? '' : encodeURIComponent(select)), {});
		}
	}
