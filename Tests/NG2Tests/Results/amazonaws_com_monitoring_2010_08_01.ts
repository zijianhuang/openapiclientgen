...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {void} Success
		 */
		GET_DeleteAnomalyDetector(Namespace: string, MetricName: string, Dimensions: Array<Dimension> | null | undefined, Stat: string, Action: GET_DeleteAnomalyDetectorAction, Version: GET_DeleteAlarmsVersion): Observable<HttpResponse<string>> {
		 ...
		 * @param {MetricAlarmUnit} Unit The unit for the metric.
		 * @return {void} Success
		 */
		GET_DescribeAlarmsForMetric(MetricName: string, Namespace: string, Statistic: MetricAlarmStatistic | null | undefined, ExtendedStatistic: string | null | undefined, Dimensions: Array<Dimension> | null | undefined, Period: number | null | undefined, Unit: MetricAlarmUnit | null | undefined, Action: GET_DescribeAlarmsForMetricAction, Version: GET_DeleteAlarmsVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DescribeAnomalyDetectors(NextToken: string | null | undefined, MaxResults: number | null | undefined, Namespace: string | null | undefined, MetricName: string | null | undefined, Dimensions: Array<Dimension> | null | undefined, Action: GET_DescribeAnomalyDetectorsAction, Version: GET_DeleteAlarmsVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_GetMetricData(MetricDataQueries: Array<MetricDataQuery>, StartTime: Date, EndTime: Date, NextToken: string | null | undefined, ScanBy: ScanBy | null | undefined, MaxDatapoints: number | null | undefined, Action: GET_GetMetricDataAction, Version: GET_DeleteAlarmsVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_ListMetrics(Namespace: string | null | undefined, MetricName: string | null | undefined, Dimensions: Array<DimensionFilter> | null | undefined, NextToken: string | null | undefined, Action: GET_ListMetricsAction, Version: GET_DeleteAlarmsVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_PutAnomalyDetector(Namespace: string, MetricName: string, Dimensions: Array<Dimension> | null | undefined, Stat: string, Configuration: GET_PutAnomalyDetectorConfiguration | null | undefined, Action: GET_PutAnomalyDetectorAction, Version: GET_DeleteAlarmsVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_SetAlarmState(AlarmName: string, StateValue: CompositeAlarmStateValue, StateReason: string, StateReasonData: string | null | undefined, Action: GET_SetAlarmStateAction, Version: GET_DeleteAlarmsVersion): Observable<HttpResponse<string>> {
