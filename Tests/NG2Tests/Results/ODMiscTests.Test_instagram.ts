...
export namespace MyNS {
	...
	export class MyClient {
		...
		Geographies_geo_idMediaRecentGetByCountAndMin_id(geo_id: string, count: number | null | undefined, min_id: string | null | undefined, headersHandler?: () => HttpHeaders): Observable<MediaListResponse> {
			return this.http.get<MediaListResponse>(this.baseUri + 'geographies/' + (geo_id == null ? '' : encodeURIComponent(geo_id)) + '/media/recent&count=' + count + '&min_id=' + (min_id == null ? '' : encodeURIComponent(min_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Locations_location_idGet(location_id: string, headersHandler?: () => HttpHeaders): Observable<LocationInfoResponse> {
			return this.http.get<LocationInfoResponse>(this.baseUri + 'locations/' + (location_id == null ? '' : encodeURIComponent(location_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Locations_location_idMediaRecentGetByMin_timestampAndMax_timestampAndMin_idAndMax_id(location_id: string, min_timestamp: number | null | undefined, max_timestamp: number | null | undefined, min_id: string | null | undefined, max_id: string | null | undefined, headersHandler?: () => HttpHeaders): Observable<MediaListResponse> {
			return this.http.get<MediaListResponse>(this.baseUri + 'locations/' + (location_id == null ? '' : encodeURIComponent(location_id)) + '/media/recent&min_timestamp=' + min_timestamp + '&max_timestamp=' + max_timestamp + '&min_id=' + (min_id == null ? '' : encodeURIComponent(min_id)) + '&max_id=' + (max_id == null ? '' : encodeURIComponent(max_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Media_media_idGet(media_id: string, headersHandler?: () => HttpHeaders): Observable<MediaEntryResponse> {
			return this.http.get<MediaEntryResponse>(this.baseUri + 'media/' + (media_id == null ? '' : encodeURIComponent(media_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Media_media_idCommentsGet(media_id: string, headersHandler?: () => HttpHeaders): Observable<CommentsResponse> {
			return this.http.get<CommentsResponse>(this.baseUri + 'media/' + (media_id == null ? '' : encodeURIComponent(media_id)) + '/comments', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Media_media_idCommentsPostByText(media_id: string, text: string, headersHandler?: () => HttpHeaders): Observable<StatusResponse> {
			return this.http.post<StatusResponse>(this.baseUri + 'media/' + (media_id == null ? '' : encodeURIComponent(media_id)) + '/comments&text=' + (text == null ? '' : encodeURIComponent(text)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Media_media_idComments_comment_idDelete(media_id: string, comment_id: string, headersHandler?: () => HttpHeaders): Observable<StatusResponse> {
			return this.http.delete<StatusResponse>(this.baseUri + 'media/' + (media_id == null ? '' : encodeURIComponent(media_id)) + '/comments/' + (comment_id == null ? '' : encodeURIComponent(comment_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Media_media_idLikesGet(media_id: string, headersHandler?: () => HttpHeaders): Observable<UsersInfoResponse> {
			return this.http.get<UsersInfoResponse>(this.baseUri + 'media/' + (media_id == null ? '' : encodeURIComponent(media_id)) + '/likes', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Media_media_idLikesPost(media_id: string, headersHandler?: () => HttpHeaders): Observable<StatusResponse> {
			return this.http.post<StatusResponse>(this.baseUri + 'media/' + (media_id == null ? '' : encodeURIComponent(media_id)) + '/likes', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Media_media_idLikesDelete(media_id: string, headersHandler?: () => HttpHeaders): Observable<StatusResponse> {
			return this.http.delete<StatusResponse>(this.baseUri + 'media/' + (media_id == null ? '' : encodeURIComponent(media_id)) + '/likes', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Tags_tag_nameGet(tag_name: string, headersHandler?: () => HttpHeaders): Observable<TagInfoResponse> {
			return this.http.get<TagInfoResponse>(this.baseUri + 'tags/' + (tag_name == null ? '' : encodeURIComponent(tag_name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Tags_tag_nameMediaRecentGetByCountAndMin_tag_idAndMax_tag_id(tag_name: string, count: number | null | undefined, min_tag_id: string | null | undefined, max_tag_id: string | null | undefined, headersHandler?: () => HttpHeaders): Observable<TagMediaListResponse> {
			return this.http.get<TagMediaListResponse>(this.baseUri + 'tags/' + (tag_name == null ? '' : encodeURIComponent(tag_name)) + '/media/recent&count=' + count + '&min_tag_id=' + (min_tag_id == null ? '' : encodeURIComponent(min_tag_id)) + '&max_tag_id=' + (max_tag_id == null ? '' : encodeURIComponent(max_tag_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_user_idGet(user_id: string, headersHandler?: () => HttpHeaders): Observable<UserResponse> {
			return this.http.get<UserResponse>(this.baseUri + 'users/' + (user_id == null ? '' : encodeURIComponent(user_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_user_idFollowed_byGet(user_id: string, headersHandler?: () => HttpHeaders): Observable<UsersPagingResponse> {
			return this.http.get<UsersPagingResponse>(this.baseUri + 'users/' + (user_id == null ? '' : encodeURIComponent(user_id)) + '/followed-by', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_user_idFollowsGet(user_id: string, headersHandler?: () => HttpHeaders): Observable<UsersPagingResponse> {
			return this.http.get<UsersPagingResponse>(this.baseUri + 'users/' + (user_id == null ? '' : encodeURIComponent(user_id)) + '/follows', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_user_idMediaRecentGetByCountAndMax_timestampAndMin_timestampAndMin_idAndMax_id(user_id: string, count: number | null | undefined, max_timestamp: number | null | undefined, min_timestamp: number | null | undefined, min_id: string | null | undefined, max_id: string | null | undefined, headersHandler?: () => HttpHeaders): Observable<MediaListResponse> {
			return this.http.get<MediaListResponse>(this.baseUri + 'users/' + (user_id == null ? '' : encodeURIComponent(user_id)) + '/media/recent&count=' + count + '&max_timestamp=' + max_timestamp + '&min_timestamp=' + min_timestamp + '&min_id=' + (min_id == null ? '' : encodeURIComponent(min_id)) + '&max_id=' + (max_id == null ? '' : encodeURIComponent(max_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_user_idRelationshipGet(user_id: string, headersHandler?: () => HttpHeaders): Observable<RelationshipResponse> {
			return this.http.get<RelationshipResponse>(this.baseUri + 'users/' + (user_id == null ? '' : encodeURIComponent(user_id)) + '/relationship', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_user_idRelationshipPostByAction(user_id: string, action: Users_user_idRelationshipPostByActionAction, headersHandler?: () => HttpHeaders): Observable<RelationshipPostResponse> {
			return this.http.post<RelationshipPostResponse>(this.baseUri + 'users/' + (user_id == null ? '' : encodeURIComponent(user_id)) + '/relationship&action=' + action, null, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
