...
export namespace MyNS {
	...
	export interface MapsOperationsDisplay {
	...
	export interface MapsOperationsDisplayFormProperties {
	...
	export function CreateMapsOperationsDisplayFormGroup() {
		return new FormGroup<MapsOperationsDisplayFormProperties>({
