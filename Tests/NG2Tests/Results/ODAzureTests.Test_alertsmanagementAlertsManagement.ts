...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {SmartGroups_GetAllMonitorService} monitorService Filter by monitor service which generates the alert instance. Default value is select all.
		 ...
		 * @param {SmartGroups_GetAllApi_version} api_version API version.
		 * @return {SmartGroupsList} OK. Returns list of all smartGroups.
		 */
		SmartGroups_GetAll(subscriptionId: string, targetResource: string | null | undefined, targetResourceGroup: string | null | undefined, targetResourceType: string | null | undefined, monitorService: SmartGroups_GetAllMonitorService | null | undefined, monitorCondition: EssentialsMonitorCondition | null | undefined, severity: EssentialsSeverity | null | undefined, smartGroupState: EssentialsAlertState | null | undefined, timeRange: SmartGroups_GetAllTimeRange | null | undefined, pageCount: number | null | undefined, sortBy: SmartGroups_GetAllSortBy | null | undefined, sortOrder: SmartGroups_GetAllSortOrder | null | undefined, api_version: SmartGroups_GetAllApi_version): Observable<SmartGroupsList> {
		 ...
		 * @param {SmartGroups_GetByIdApi_version} api_version API version.
		 * @return {SmartGroup} OK. Returns the group with the specified smart group Id.
		 */
		SmartGroups_GetById(subscriptionId: string, smartGroupId: string, api_version: SmartGroups_GetByIdApi_version): Observable<SmartGroup> {
		 ...
		 * @param {string} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
		 * @param {string} smartGroupId Smart group unique id. 
		 * @param {SmartGroups_ChangeStateApi_version} api_version API version.
		 * @param {EssentialsAlertState} newState New state of the alert.
		 * @return {SmartGroup} OK. Smart Group state updated.
		 */
		SmartGroups_ChangeState(subscriptionId: string, smartGroupId: string, api_version: SmartGroups_ChangeStateApi_version, newState: EssentialsAlertState): Observable<SmartGroup> {
		 ...
		 * @param {string} subscriptionId Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
		 * @param {string} smartGroupId Smart group unique id. 
		 * @param {SmartGroups_GetHistoryApi_version} api_version API version.
		 * @return {SmartGroupModification} OK. Returns the list of changes of smart group.
		 */
		SmartGroups_GetHistory(subscriptionId: string, smartGroupId: string, api_version: SmartGroups_GetHistoryApi_version): Observable<SmartGroupModification> {
		 ...
		 * @param {string} targetResourceType Filter by target resource type. Default value is select all.
		 * @param {string} targetResourceGroup Filter by target resource group name. Default value is select all.
		 * @param {Alerts_GetAllMonitorService} monitorService Filter by monitor service which generates the alert instance. Default value is select all.
		 * @param {EssentialsMonitorCondition} monitorCondition Filter by monitor condition which is either 'Fired' or 'Resolved'. Default value is to select all.
		 * @param {EssentialsSeverity} severity Filter by severity.  Default value is select all.
		 ...
		 * @param {Alerts_GetAllTimeRange} timeRange Filter by time range by below listed values. Default value is 1 day.
		 ...
		 * @param {Alerts_GetAllApi_version} api_version API version.
		 * @return {AlertsList} OK. Successfully listed alert objects.
		 */
		Alerts_GetAll(scope: string, targetResource: string | null | undefined, targetResourceType: string | null | undefined, targetResourceGroup: string | null | undefined, monitorService: Alerts_GetAllMonitorService | null | undefined, monitorCondition: EssentialsMonitorCondition | null | undefined, severity: EssentialsSeverity | null | undefined, alertState: EssentialsAlertState | null | undefined, alertRule: string | null | undefined, smartGroupId: string | null | undefined, includeContext: boolean | null | undefined, includeEgressConfig: boolean | null | undefined, pageCount: number | null | undefined, sortBy: Alerts_GetAllSortBy | null | undefined, sortOrder: SmartGroups_GetAllSortOrder | null | undefined, select: string | null | undefined, timeRange: Alerts_GetAllTimeRange | null | undefined, customTimeRange: string | null | undefined, api_version: Alerts_GetAllApi_version): Observable<AlertsList> {
		 ...
		 * @param {Alerts_GetByIdApi_version} api_version API version.
		 * @return {Alert} OK. Returns the alert with the specified ID.
		 */
		Alerts_GetById(scope: string, alertId: string, api_version: Alerts_GetByIdApi_version): Observable<Alert> {
		 ...
		 * @param {string} scope scope here is resourceId for which alert is created.
		 * @param {string} alertId Unique ID of an alert instance.
		 * @param {Alerts_ChangeStateApi_version} api_version API version.
		 * @param {EssentialsAlertState} newState New state of the alert.
		 * @return {Alert} OK. Alert state updated.
		 */
		Alerts_ChangeState(scope: string, alertId: string, api_version: Alerts_ChangeStateApi_version, newState: EssentialsAlertState): Observable<Alert> {
		 ...
		 * @param {string} scope scope here is resourceId for which alert is created.
		 * @param {string} alertId Unique ID of an alert instance.
		 * @param {Alerts_GetHistoryApi_version} api_version API version.
		 * @return {AlertModification} OK. Returns the history of the specified alert.
		 */
		Alerts_GetHistory(scope: string, alertId: string, api_version: Alerts_GetHistoryApi_version): Observable<AlertModification> {
		 ...
		 * @param {string} targetResourceType Filter by target resource type. Default value is select all.
		 * @param {string} targetResourceGroup Filter by target resource group name. Default value is select all.
		 * @param {Alerts_GetSummaryMonitorService} monitorService Filter by monitor service which generates the alert instance. Default value is select all.
		 * @param {EssentialsMonitorCondition} monitorCondition Filter by monitor condition which is either 'Fired' or 'Resolved'. Default value is to select all.
		 * @param {EssentialsSeverity} severity Filter by severity.  Default value is select all.
		 * @param {EssentialsAlertState} alertState Filter by state of the alert instance. Default value is to select all.
		 * @param {string} alertRule Filter by specific alert rule.  Default value is to select all.
		 * @param {Alerts_GetSummaryTimeRange} timeRange Filter by time range by below listed values. Default value is 1 day.
		 * @param {string} customTimeRange Filter by custom time range in the format <start-time>/<end-time>  where time is in (ISO-8601 format)'. Permissible values is within 30 days from  query time. Either timeRange or customTimeRange could be used but not both. Default is none.
		 * @param {Alerts_GetSummaryApi_version} api_version API version.
		 * @return {AlertsSummary} OK. Alert summary returned.
		 */
		Alerts_GetSummary(scope: string, groupby: Alerts_GetSummaryGroupby, includeSmartGroupsCount: boolean | null | undefined, targetResource: string | null | undefined, targetResourceType: string | null | undefined, targetResourceGroup: string | null | undefined, monitorService: Alerts_GetSummaryMonitorService | null | undefined, monitorCondition: EssentialsMonitorCondition | null | undefined, severity: EssentialsSeverity | null | undefined, alertState: EssentialsAlertState | null | undefined, alertRule: string | null | undefined, timeRange: Alerts_GetSummaryTimeRange | null | undefined, customTimeRange: string | null | undefined, api_version: Alerts_GetSummaryApi_version): Observable<AlertsSummary> {
	...
	export enum Operations_ListApi_version { _2018_05_05 = 0 }

	export enum SmartGroups_GetAllMonitorService { 'Application Insights' = 0, 'ActivityLog Administrative' = 1, 'ActivityLog Security' = 2, 'ActivityLog Recommendation' = 3, 'ActivityLog Policy' = 4, 'ActivityLog Autoscale' = 5, 'Log Analytics' = 6, Nagios = 7, Platform = 8, SCOM = 9, ServiceHealth = 10, SmartDetector = 11, 'VM Insights' = 12, Zabbix = 13, 'Resource Health' = 14 }

	export enum SmartGroups_GetAllTimeRange { _1h = 0, _1d = 1, _7d = 2, _30d = 3 }
	...
	export enum SmartGroups_GetAllApi_version { _2018_05_05 = 0 }

	export enum SmartGroups_GetByIdApi_version { _2018_05_05 = 0 }

	export enum SmartGroups_ChangeStateApi_version { _2018_05_05 = 0 }

	export enum SmartGroups_GetHistoryApi_version { _2018_05_05 = 0 }

	export enum Alerts_GetAllMonitorService { 'Application Insights' = 0, 'ActivityLog Administrative' = 1, 'ActivityLog Security' = 2, 'ActivityLog Recommendation' = 3, 'ActivityLog Policy' = 4, 'ActivityLog Autoscale' = 5, 'Log Analytics' = 6, Nagios = 7, Platform = 8, SCOM = 9, ServiceHealth = 10, SmartDetector = 11, 'VM Insights' = 12, Zabbix = 13, 'Resource Health' = 14 }
	...
	export enum Alerts_GetAllTimeRange { _1h = 0, _1d = 1, _7d = 2, _30d = 3 }

	export enum Alerts_GetAllApi_version { _2018_05_05 = 0 }

	export enum Alerts_GetByIdApi_version { _2018_05_05 = 0 }

	export enum Alerts_ChangeStateApi_version { _2018_05_05 = 0 }

	export enum Alerts_GetHistoryApi_version { _2018_05_05 = 0 }
	...
	export enum Alerts_GetSummaryMonitorService { 'Application Insights' = 0, 'ActivityLog Administrative' = 1, 'ActivityLog Security' = 2, 'ActivityLog Recommendation' = 3, 'ActivityLog Policy' = 4, 'ActivityLog Autoscale' = 5, 'Log Analytics' = 6, Nagios = 7, Platform = 8, SCOM = 9, ServiceHealth = 10, SmartDetector = 11, 'VM Insights' = 12, Zabbix = 13, 'Resource Health' = 14 }

	export enum Alerts_GetSummaryTimeRange { _1h = 0, _1d = 1, _7d = 2, _30d = 3 }

	export enum Alerts_GetSummaryApi_version { _2018_05_05 = 0 }
