...
export namespace MyNS {
	...
	export interface DatafeedFetchScheduleFormProperties {
		...
		/** The minute of the hour the feed file should be fetched (0-59). Read-only. */
		minuteOfHour: FormControl<string | null | undefined>,
	...
	export function CreateDatafeedFetchScheduleFormGroup() {
		return new FormGroup<DatafeedFetchScheduleFormProperties>({
			...
			hour: new FormControl<string | null | undefined>(undefined),
			minuteOfHour: new FormControl<string | null | undefined>(undefined),
	...
	export interface DeliveryTimeFormProperties {
		...
		/** Maximum number of business days spent before an order is shipped. 0 means same day shipped, 1 means next day shipped. Must be greater than or equal to `minHandlingTimeInDays`. */
		maxHandlingTimeInDays: FormControl<string | null | undefined>,

		/** Maximum number of business days that is spent in transit. 0 means same day delivery, 1 means next day delivery. Must be greater than or equal to `minTransitTimeInDays`. */
		maxTransitTimeInDays: FormControl<string | null | undefined>,

		/** Minimum number of business days spent before an order is shipped. 0 means same day shipped, 1 means next day shipped. */
		minHandlingTimeInDays: FormControl<string | null | undefined>,

		/** Minimum number of business days that is spent in transit. 0 means same day delivery, 1 means next day delivery. Either `{min,max}TransitTimeInDays` or `transitTimeTable` must be set, but not both. */
		minTransitTimeInDays: FormControl<string | null | undefined>,
	}
	export function CreateDeliveryTimeFormGroup() {
		return new FormGroup<DeliveryTimeFormProperties>({
			maxHandlingTimeInDays: new FormControl<string | null | undefined>(undefined),
			maxTransitTimeInDays: new FormControl<string | null | undefined>(undefined),
			minHandlingTimeInDays: new FormControl<string | null | undefined>(undefined),
			minTransitTimeInDays: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface HolidayCutoffFormProperties {
		...
		/** Hour of the day on the deadline date until which the order has to be placed to qualify for the delivery guarantee. Possible values are: 0 (midnight), 1, ..., 12 (noon), 13, ..., 23. Required. */
		deadlineHour: FormControl<string | null | undefined>,
	...
	export function CreateHolidayCutoffFormGroup() {
		return new FormGroup<HolidayCutoffFormProperties>({
			...
			deadlineHour: new FormControl<string | null | undefined>(undefined),
	...
	export interface InventoryPickupFormProperties {
	...
	export function CreateInventoryPickupFormGroup() {
		return new FormGroup<InventoryPickupFormProperties>({
	...
	export interface InventoryCustomBatchRequestFormProperties {
	}
	export function CreateInventoryCustomBatchRequestFormGroup() {
		return new FormGroup<InventoryCustomBatchRequestFormProperties>({
		});
	...
	/** A batch entry encoding a single non-batch inventory request. */
	export interface InventoryCustomBatchRequestEntryFormProperties {
	...
	export function CreateInventoryCustomBatchRequestEntryFormGroup() {
		return new FormGroup<InventoryCustomBatchRequestEntryFormProperties>({
			batchId: new FormControl<string | null | undefined>(undefined),
			merchantId: new FormControl<string | null | undefined>(undefined),
	...
	export interface InventoryCustomBatchResponseFormProperties {

		/** Identifies what kind of resource this is. Value: the fixed string "content#inventoryCustomBatchResponse". */
		kind: FormControl<string | null | undefined>,
	}
	export function CreateInventoryCustomBatchResponseFormGroup() {
		return new FormGroup<InventoryCustomBatchResponseFormProperties>({
			kind: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A batch entry encoding a single non-batch inventory response. */
	export interface InventoryCustomBatchResponseEntryFormProperties {
	...
	export function CreateInventoryCustomBatchResponseEntryFormGroup() {
		return new FormGroup<InventoryCustomBatchResponseEntryFormProperties>({
			batchId: new FormControl<string | null | undefined>(undefined),
			kind: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface InventorySetRequestFormProperties {
	...
	export function CreateInventorySetRequestFormGroup() {
		return new FormGroup<InventorySetRequestFormProperties>({
			availability: new FormControl<string | null | undefined>(undefined),
			customLabel0: new FormControl<string | null | undefined>(undefined),
			customLabel1: new FormControl<string | null | undefined>(undefined),
			customLabel2: new FormControl<string | null | undefined>(undefined),
	...
	export interface InventorySetResponseFormProperties {

		/** Identifies what kind of resource this is. Value: the fixed string "content#inventorySetResponse". */
		kind: FormControl<string | null | undefined>,
	}
	export function CreateInventorySetResponseFormGroup() {
		return new FormGroup<InventorySetResponseFormProperties>({
			kind: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface OrderLineItemFormProperties {
		...
		/** Number of items canceled. */
		quantityCanceled: FormControl<string | null | undefined>,

		/** Number of items delivered. */
		quantityDelivered: FormControl<string | null | undefined>,

		/** Number of items ordered. */
		quantityOrdered: FormControl<string | null | undefined>,

		/** Number of items pending. */
		quantityPending: FormControl<string | null | undefined>,

		/** Number of items ready for pickup. */
		quantityReadyForPickup: FormControl<string | null | undefined>,

		/** Number of items returned. */
		quantityReturned: FormControl<string | null | undefined>,

		/** Number of items shipped. */
		quantityShipped: FormControl<string | null | undefined>,
	}
	export function CreateOrderLineItemFormGroup() {
		return new FormGroup<OrderLineItemFormProperties>({
			id: new FormControl<string | null | undefined>(undefined),
			quantityCanceled: new FormControl<string | null | undefined>(undefined),
			quantityDelivered: new FormControl<string | null | undefined>(undefined),
			quantityOrdered: new FormControl<string | null | undefined>(undefined),
			quantityPending: new FormControl<string | null | undefined>(undefined),
			quantityReadyForPickup: new FormControl<string | null | undefined>(undefined),
			quantityReturned: new FormControl<string | null | undefined>(undefined),
			quantityShipped: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface OrderLineItemShippingDetailsMethodFormProperties {
		...
		/** Required. Maximum transit time. */
		maxDaysInTransit: FormControl<string | null | undefined>,

		/** Required. The name of the shipping method. */
		methodName: FormControl<string | null | undefined>,

		/** Required. Minimum transit time. */
		minDaysInTransit: FormControl<string | null | undefined>,
	}
	export function CreateOrderLineItemShippingDetailsMethodFormGroup() {
		return new FormGroup<OrderLineItemShippingDetailsMethodFormProperties>({
			carrier: new FormControl<string | null | undefined>(undefined),
			maxDaysInTransit: new FormControl<string | null | undefined>(undefined),
			methodName: new FormControl<string | null | undefined>(undefined),
			minDaysInTransit: new FormControl<string | null | undefined>(undefined),
		});
