...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {void} Successful response
		 */
		Storage_objects_patch(bucket: string, _object: string, generation: string | null | undefined, ifGenerationMatch: string | null | undefined, ifGenerationNotMatch: string | null | undefined, ifMetagenerationMatch: string | null | undefined, ifMetagenerationNotMatch: string | null | undefined, predefinedAcl: Storage_buckets_insertPredefinedDefaultObjectAcl | null | undefined, projection: Storage_buckets_listProjection | null | undefined, provisionalUserProject: string | null | undefined, userProject: string | null | undefined, requestBody: Object): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Successful response
		 */
		Storage_objects_update(bucket: string, _object: string, generation: string | null | undefined, ifGenerationMatch: string | null | undefined, ifGenerationNotMatch: string | null | undefined, ifMetagenerationMatch: string | null | undefined, ifMetagenerationNotMatch: string | null | undefined, predefinedAcl: Storage_buckets_insertPredefinedDefaultObjectAcl | null | undefined, projection: Storage_buckets_listProjection | null | undefined, provisionalUserProject: string | null | undefined, userProject: string | null | undefined, requestBody: Object): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'b/' + (bucket == null ? '' : encodeURIComponent(bucket)) + '/o/' + (_object == null ? '' : encodeURIComponent(_object)) + '&generation=' + (generation == null ? '' : encodeURIComponent(generation)) + '&ifGenerationMatch=' + (ifGenerationMatch == null ? '' : encodeURIComponent(ifGenerationMatch)) + '&ifGenerationNotMatch=' + (ifGenerationNotMatch == null ? '' : encodeURIComponent(ifGenerationNotMatch)) + '&ifMetagenerationMatch=' + (ifMetagenerationMatch == null ? '' : encodeURIComponent(ifMetagenerationMatch)) + '&ifMetagenerationNotMatch=' + (ifMetagenerationNotMatch == null ? '' : encodeURIComponent(ifMetagenerationNotMatch)) + '&predefinedAcl=' + predefinedAcl + '&projection=' + projection + '&provisionalUserProject=' + (provisionalUserProject == null ? '' : encodeURIComponent(provisionalUserProject)) + '&userProject=' + (userProject == null ? '' : encodeURIComponent(userProject)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		...
		Storage_objectAccessControls_delete(bucket: string, _object: string, entity: string, generation: string | null | undefined, provisionalUserProject: string | null | undefined, userProject: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'b/' + (bucket == null ? '' : encodeURIComponent(bucket)) + '/o/' + (_object == null ? '' : encodeURIComponent(_object)) + '/acl/' + (entity == null ? '' : encodeURIComponent(entity)) + '&generation=' + (generation == null ? '' : encodeURIComponent(generation)) + '&provisionalUserProject=' + (provisionalUserProject == null ? '' : encodeURIComponent(provisionalUserProject)) + '&userProject=' + (userProject == null ? '' : encodeURIComponent(userProject)), { observe: 'response', responseType: 'text' });
		}
		...
		Storage_objects_getIamPolicy(bucket: string, _object: string, generation: string | null | undefined, provisionalUserProject: string | null | undefined, userProject: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'b/' + (bucket == null ? '' : encodeURIComponent(bucket)) + '/o/' + (_object == null ? '' : encodeURIComponent(_object)) + '/iam&generation=' + (generation == null ? '' : encodeURIComponent(generation)) + '&provisionalUserProject=' + (provisionalUserProject == null ? '' : encodeURIComponent(provisionalUserProject)) + '&userProject=' + (userProject == null ? '' : encodeURIComponent(userProject)), { observe: 'response', responseType: 'text' });
		}
		...
		Storage_objects_testIamPermissions(bucket: string, _object: string, permissions: Array<string>, generation: string | null | undefined, provisionalUserProject: string | null | undefined, userProject: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'b/' + (bucket == null ? '' : encodeURIComponent(bucket)) + '/o/' + (_object == null ? '' : encodeURIComponent(_object)) + '/iam/testPermissions&' + permissions.map(z => `permissions=${encodeURIComponent(z)}`).join('&') + '&generation=' + (generation == null ? '' : encodeURIComponent(generation)) + '&provisionalUserProject=' + (provisionalUserProject == null ? '' : encodeURIComponent(provisionalUserProject)) + '&userProject=' + (userProject == null ? '' : encodeURIComponent(userProject)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Successful response
		 */
		Storage_objects_compose(destinationBucket: string, destinationObject: string, destinationPredefinedAcl: Storage_buckets_insertPredefinedDefaultObjectAcl | null | undefined, ifGenerationMatch: string | null | undefined, ifMetagenerationMatch: string | null | undefined, kmsKeyName: string | null | undefined, provisionalUserProject: string | null | undefined, userProject: string | null | undefined, requestBody: ComposeRequest): Observable<HttpResponse<string>> {
