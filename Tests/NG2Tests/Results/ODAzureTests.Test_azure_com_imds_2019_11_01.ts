...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * Get identity/info
		 * @param {Identity_GetInfoApi_version} api_version This is the API version to use.
		 * @return {IdentityInfoResponse} Successful operation
		 */
		Identity_GetInfo(api_version: Identity_GetInfoApi_version): Observable<IdentityInfoResponse> {
		 ...
		 * @param {Identity_GetTokenApi_version} api_version This is the API version to use.
		 ...
		 */
		Identity_GetToken(resource: string, api_version: Identity_GetTokenApi_version, client_id: string | null | undefined, object_id: string | null | undefined, msi_res_id: string | null | undefined, authority: string | null | undefined, bypass_cache: Attested_GetDocumentMetadata | null | undefined): Observable<IdentityTokenResponse> {
		 ...
		 * Get instance
		 * @param {Instances_GetMetadataApi_version} api_version This is the API version to use.
		 * @return {Instance} OK
		 */
		Instances_GetMetadata(api_version: Instances_GetMetadataApi_version): Observable<Instance> {
			return this.http.get<Instance>(this.baseUri + 'instance?api_version=' + api_version, {});
		}
	}

	export enum Attested_GetDocumentApi_version { _2018_10_01 = 0 }

	export enum Attested_GetDocumentMetadata { true = 0 }

	export enum Identity_GetInfoApi_version { _2018_10_01 = 0 }

	export enum Identity_GetTokenApi_version { _2018_10_01 = 0 }

	export enum Instances_GetMetadataApi_version { _2018_10_01 = 0 }
