...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {DatabaseSchemaListResult} Successfully retrieved database schemas.
		 */
		DatabaseSchemas_ListByDatabase(resourceGroupName: string, serverName: string, databaseName: string, filter: string | null | undefined, subscriptionId: string, api_version: string): Observable<DatabaseSchemaListResult> {
		 ...
		 * @param {string} subscriptionId The subscription ID that identifies an Azure subscription.
		 * @param {string} api_version The API version to use for the request.
		 * @return {DatabaseSchema} Successfully retrieved database schema.
		 */
		DatabaseSchemas_Get(resourceGroupName: string, serverName: string, databaseName: string, schemaName: string, subscriptionId: string, api_version: string): Observable<DatabaseSchema> {
		 ...
		 * @param {string} subscriptionId The subscription ID that identifies an Azure subscription.
		 * @param {string} api_version The API version to use for the request.
		 * @return {DatabaseTableListResult} Successfully retrieved database tables.
		 */
		DatabaseTables_ListBySchema(resourceGroupName: string, serverName: string, databaseName: string, schemaName: string, filter: string | null | undefined, subscriptionId: string, api_version: string): Observable<DatabaseTableListResult> {
		 ...
		 * @param {string} subscriptionId The subscription ID that identifies an Azure subscription.
		 * @param {string} api_version The API version to use for the request.
		 * @return {DatabaseTable} Successfully retrieved database table.
		 */
		DatabaseTables_Get(resourceGroupName: string, serverName: string, databaseName: string, schemaName: string, tableName: string, subscriptionId: string, api_version: string): Observable<DatabaseTable> {
		 ...
		 * @param {string} subscriptionId The subscription ID that identifies an Azure subscription.
		 * @param {string} api_version The API version to use for the request.
		 * @return {DatabaseColumnListResult} Successfully retrieved database columns.
		 */
		DatabaseColumns_ListByTable(resourceGroupName: string, serverName: string, databaseName: string, schemaName: string, tableName: string, filter: string | null | undefined, subscriptionId: string, api_version: string): Observable<DatabaseColumnListResult> {
		 ...
		 * @param {string} subscriptionId The subscription ID that identifies an Azure subscription.
		 * @param {string} api_version The API version to use for the request.
		 * @return {DatabaseColumn} Successfully retrieved database column.
		 */
		DatabaseColumns_Get(resourceGroupName: string, serverName: string, databaseName: string, schemaName: string, tableName: string, columnName: string, subscriptionId: string, api_version: string): Observable<DatabaseColumn> {
