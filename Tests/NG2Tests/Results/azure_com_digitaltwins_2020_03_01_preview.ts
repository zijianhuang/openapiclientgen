...
export namespace MyNS {
	...
	/** IoTHub integration resource. */
	export interface IntegrationResourceInfo {
	...
	/** IoTHub integration resource. */
	export interface IntegrationResourceInfoFormProperties {
	}
	export function CreateIntegrationResourceInfoFormGroup() {
		return new FormGroup<IntegrationResourceInfoFormProperties>({
		});
	...
	export class MyClient {
		 ...
		 */
		DigitalTwins_List(api_version: Operations_ListApi_version, subscriptionId: string): Observable<DigitalTwinsDescriptionListResult> {
		 ...
		 */
		DigitalTwins_CheckNameAvailability(api_version: Operations_ListApi_version, subscriptionId: string, location: string, requestBody: CheckNameRequest): Observable<CheckNameResult> {
		 ...
		 */
		DigitalTwins_CreateOrUpdate(api_version: Operations_ListApi_version, subscriptionId: string, resourceGroupName: string, resourceName: string, requestBody: DigitalTwinsDescription): Observable<DigitalTwinsDescription> {
		 ...
		 * @return {DigitalTwinsDescription} This is returned as a response to the status polling request for the create or update operation. The body contains the resource representation that indicates a transitional provisioning state.
		 */
		DigitalTwins_Update(api_version: Operations_ListApi_version, subscriptionId: string, resourceGroupName: string, resourceName: string, requestBody: DigitalTwinsPatchDescription): Observable<DigitalTwinsDescription> {
		 ...
		 */
		DigitalTwinsEndpoint_CreateOrUpdate(api_version: Operations_ListApi_version, subscriptionId: string, resourceGroupName: string, resourceName: string, endpointName: string, requestBody: DigitalTwinsEndpointResource): Observable<DigitalTwinsEndpointResource> {
