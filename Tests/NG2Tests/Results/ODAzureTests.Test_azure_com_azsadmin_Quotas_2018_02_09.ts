...
export namespace MyNS {
	...
	export interface QuotaListValue {
		...
		/** Properties for a Compute Quota */
		properties?: QuotaListProperties;
	}
	...
	export interface QuotaListProperties {
	...
	export interface QuotaListPropertiesFormProperties {
	...
	export function CreateQuotaListPropertiesFormGroup() {
		return new FormGroup<QuotaListPropertiesFormProperties>({
			availabilitySetCount: new FormControl<number | null | undefined>(undefined, [Validators.min(0)]),
			coresLimit: new FormControl<number | null | undefined>(undefined, [Validators.min(0)]),
			maxAllocationPremiumManagedDisksAndSnapshots: new FormControl<number | null | undefined>(undefined, [Validators.min(0)]),
			maxAllocationStandardManagedDisksAndSnapshots: new FormControl<number | null | undefined>(undefined, [Validators.min(0)]),
	...
	export interface Quotas_ListReturnValue {
		...
		/** Properties for a Compute Quota */
		properties?: Quotas_ListReturnProperties;
	}
	...
	export interface Quotas_ListReturnProperties {
	...
	export interface Quotas_ListReturnPropertiesFormProperties {
	...
	export function CreateQuotas_ListReturnPropertiesFormGroup() {
		return new FormGroup<Quotas_ListReturnPropertiesFormProperties>({
			availabilitySetCount: new FormControl<number | null | undefined>(undefined, [Validators.min(0)]),
			coresLimit: new FormControl<number | null | undefined>(undefined, [Validators.min(0)]),
			maxAllocationPremiumManagedDisksAndSnapshots: new FormControl<number | null | undefined>(undefined, [Validators.min(0)]),
			maxAllocationStandardManagedDisksAndSnapshots: new FormControl<number | null | undefined>(undefined, [Validators.min(0)]),
