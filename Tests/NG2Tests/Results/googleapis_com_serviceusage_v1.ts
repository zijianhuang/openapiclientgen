...
export namespace MyNS {
	...
	/** Response message for BatchCreateAdminOverrides */
	export interface BatchCreateAdminOverridesResponseFormProperties {
	}
	export function CreateBatchCreateAdminOverridesResponseFormGroup() {
		return new FormGroup<BatchCreateAdminOverridesResponseFormProperties>({
		});
	...
	/** A quota override */
	export interface QuotaOverrideFormProperties {
	...
	export function CreateQuotaOverrideFormGroup() {
		return new FormGroup<QuotaOverrideFormProperties>({
	...
	/** Response message for BatchCreateConsumerOverrides */
	export interface BatchCreateConsumerOverridesResponseFormProperties {
	}
	export function CreateBatchCreateConsumerOverridesResponseFormGroup() {
		return new FormGroup<BatchCreateConsumerOverridesResponseFormProperties>({
		});
	...
	/** Request message for the `BatchEnableServices` method. */
	export interface BatchEnableServicesRequestFormProperties {
	}
	export function CreateBatchEnableServicesRequestFormGroup() {
		return new FormGroup<BatchEnableServicesRequestFormProperties>({
		});
	 ...
	 * Operation when that operation is done.
	 */
	export interface BatchEnableServicesResponseFormProperties {
	}
	export function CreateBatchEnableServicesResponseFormGroup() {
		return new FormGroup<BatchEnableServicesResponseFormProperties>({
		});
	...
	/** Provides error messages for the failing services. */
	export interface EnableFailureFormProperties {
	...
	export function CreateEnableFailureFormGroup() {
		return new FormGroup<EnableFailureFormProperties>({
	...
	export interface GoogleApiServiceusageV1Service {
		...
		state?: GoogleApiServiceusageV1ServiceState | null;
	}

	/** A service that is available for use by the consumer. */
	export interface GoogleApiServiceusageV1ServiceFormProperties {
		...
		/** Whether or not the service has been enabled for use by the consumer. */
		state: FormControl<GoogleApiServiceusageV1ServiceState | null | undefined>,
	}
	export function CreateGoogleApiServiceusageV1ServiceFormGroup() {
		return new FormGroup<GoogleApiServiceusageV1ServiceFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
			parent: new FormControl<string | null | undefined>(undefined),
			state: new FormControl<GoogleApiServiceusageV1ServiceState | null | undefined>(undefined),
		});
	...
	/** The configuration of the service. */
	export interface GoogleApiServiceusageV1ServiceConfigFormProperties {
	...
	export function CreateGoogleApiServiceusageV1ServiceConfigFormGroup() {
		return new FormGroup<GoogleApiServiceusageV1ServiceConfigFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
	 ...
	 *         description: "Used as the identity of Cloud XXX to access resources"
	 */
	export interface GoogleApiServiceIdentityFormProperties {
	...
	export function CreateGoogleApiServiceIdentityFormGroup() {
		return new FormGroup<GoogleApiServiceIdentityFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
	...
	/** Response message for the `BatchGetServices` method. */
	export interface BatchGetServicesResponseFormProperties {
	}
	export function CreateBatchGetServicesResponseFormGroup() {
		return new FormGroup<BatchGetServicesResponseFormProperties>({
		});
	...
	export interface DisableServiceRequestFormProperties {
		 ...
		 * together.
		 */
		disableDependentServices: FormControl<boolean | null | undefined>,
	}
	export function CreateDisableServiceRequestFormGroup() {
		return new FormGroup<DisableServiceRequestFormProperties>({
			disableDependentServices: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	export interface GetServiceIdentityResponse {
		...
		state?: GetServiceIdentityResponseState | null;
	}

	/** Response message for getting service identity. */
	export interface GetServiceIdentityResponseFormProperties {

		/** Service identity state. */
		state: FormControl<GetServiceIdentityResponseState | null | undefined>,
	}
	export function CreateGetServiceIdentityResponseFormGroup() {
		return new FormGroup<GetServiceIdentityResponseFormProperties>({
			state: new FormControl<GetServiceIdentityResponseState | null | undefined>(undefined),
		});
	...
	export function CreateGoogleApiServiceFormGroup() {
		return new FormGroup<GoogleApiServiceFormProperties>({
	...
	/** The operation metadata returned for the batchend services operation. */
	export interface GoogleApiServiceusageV1OperationMetadataFormProperties {
	}
	export function CreateGoogleApiServiceusageV1OperationMetadataFormGroup() {
		return new FormGroup<GoogleApiServiceusageV1OperationMetadataFormProperties>({
		});
	...
	/** Response message for getting service identity. */
	export interface GoogleApiServiceusageV1beta1GetServiceIdentityResponseFormProperties {

		/** Service identity state. */
		state: FormControl<GetServiceIdentityResponseState | null | undefined>,
	}
	export function CreateGoogleApiServiceusageV1beta1GetServiceIdentityResponseFormGroup() {
		return new FormGroup<GoogleApiServiceusageV1beta1GetServiceIdentityResponseFormProperties>({
			state: new FormControl<GetServiceIdentityResponseState | null | undefined>(undefined),
		});
	 ...
	 * should use to access consumer resources.
	 */
	export interface GoogleApiServiceusageV1beta1ServiceIdentityFormProperties {
	...
	export function CreateGoogleApiServiceusageV1beta1ServiceIdentityFormGroup() {
		return new FormGroup<GoogleApiServiceusageV1beta1ServiceIdentityFormProperties>({
			email: new FormControl<string | null | undefined>(undefined),
			uniqueId: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for ImportAdminOverrides */
	export interface ImportAdminOverridesResponseFormProperties {
	}
	export function CreateImportAdminOverridesResponseFormGroup() {
		return new FormGroup<ImportAdminOverridesResponseFormProperties>({
		});
	...
	/** Response message for ImportConsumerOverrides */
	export interface ImportConsumerOverridesResponseFormProperties {
	}
	export function CreateImportConsumerOverridesResponseFormGroup() {
		return new FormGroup<ImportConsumerOverridesResponseFormProperties>({
		});
