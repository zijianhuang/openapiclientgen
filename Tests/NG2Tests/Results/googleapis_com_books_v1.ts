...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {void} Successful response
		 */
		Books_personalizedstream_get(locale: string | null | undefined, maxAllowedMaturityRating: Books_onboarding_listCategoryVolumesMaxAllowedMaturityRating | null | undefined, source: string | null | undefined): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Successful response
		 */
		Books_volumes_recommended_list(locale: string | null | undefined, maxAllowedMaturityRating: Books_onboarding_listCategoryVolumesMaxAllowedMaturityRating | null | undefined, source: string | null | undefined): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Successful response
		 */
		Books_volumes_associated_list(volumeId: string, association: Books_volumes_associated_listAssociation | null | undefined, locale: string | null | undefined, maxAllowedMaturityRating: Books_onboarding_listCategoryVolumesMaxAllowedMaturityRating | null | undefined, source: string | null | undefined): Observable<HttpResponse<string>> {
