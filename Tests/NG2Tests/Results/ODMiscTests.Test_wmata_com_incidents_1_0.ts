...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * </table>
		 * Get BusIncidents
		 * @param {BusIncidentsGetByRouteRoute} Route Bus route.  Use full route code, i.e.: C2 instead of C2v1, C2v2, etc.
		 * @return {void} Default response code.
		 */
		BusIncidentsGetByRoute(Route: BusIncidentsGetByRouteRoute | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'BusIncidents?Route=' + Route, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {ElevatorIncidentsGetByStationCodeStationCode} StationCode Two-letter station code.  Use the Station List method to return a list of all station codes.
		 * @return {void} Default response code.
		 */
		ElevatorIncidentsGetByStationCode(StationCode: ElevatorIncidentsGetByStationCodeStationCode | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'ElevatorIncidents?StationCode=' + StationCode, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Default response code.
		 */
		IncidentsGet(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'Incidents', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {JsonBusIncidentsGetByRouteRoute} Route Base bus route; variations are not recognized (i.e.: C2 instead of C2v1, C2v2, etc.).
		 * @return {void} Default response code.
		 */
		JsonBusIncidentsGetByRoute(Route: JsonBusIncidentsGetByRouteRoute | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'json/BusIncidents?Route=' + Route, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {ElevatorIncidentsGetByStationCodeStationCode} StationCode Station code.  Use the Station List method to return a list of all station codes.
		 * @return {void} Default response code.
		 */
		JsonElevatorIncidentsGetByStationCode(StationCode: ElevatorIncidentsGetByStationCodeStationCode | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'json/ElevatorIncidents?StationCode=' + StationCode, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Default response code.
		 */
		JsonIncidentsGet(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'json/Incidents', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
	}

	export enum BusIncidentsGetByRouteRoute { _90 = 0, X1 = 1 }

	export enum ElevatorIncidentsGetByStationCodeStationCode { A03 = 0, E09 = 1 }

	export enum JsonBusIncidentsGetByRouteRoute { _90 = 0, X1 = 1 }
