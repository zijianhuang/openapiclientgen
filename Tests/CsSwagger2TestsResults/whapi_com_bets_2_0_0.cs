...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<BetPlaced[]> PlaceComplexBetAsync(string[] fields, string[] include, string[] exclude, ComplexBetRequestBody requestBody)
		{
		...
		/// <returns>Success</returns>
		public async Task<BetPlaced[]> PlaceSingleBetAsync(string[] fields, string[] include, string[] exclude, SingleBetRequestBody requestBody)
		{
		...
		public async Task<BetSlipResponse> ValidateBetslipAsync(string expanded, BetSlipRequest requestBody)
		{
		...
		/// <param name="exclude">Specify fields from the default to exclude (Comma Separated List)</param>
		/// <returns>Success</returns>
		public async Task<FreeBetDetail[]> GetFreeBetsAsync(string[] fields, string[] include, string[] exclude)
		{
		...
		/// <returns>Success</returns>
		public async Task<BetHistoryResponse> GetBetHistoryAsync(string dateFrom, string dateTo, string[] fields, string[] include, string[] exclude, double page, double pageSize, string sort, bool settled)
		{
		...
		/// <returns>Success</returns>
		public async Task<CashInResponse> CashinAsync(string betId, double cashInValue, string cashinBetDelayId)
		{
