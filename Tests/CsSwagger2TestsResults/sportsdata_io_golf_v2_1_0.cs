...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<DfsSlate[]> DfsSlatesAsync(DfsSlatesFormat format, string tournamentid)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Injury[]> InjuriesAsync(DfsSlatesFormat format)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Injury[]> InjuriesHistoricalAsync(DfsSlatesFormat format)
		{
		...
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="tournamentid">The TournamentID of a tournament.  TournamentIDs can be found in the Tournaments API.  Valid entries are <code>58</code>, <code>61</code>, etc.</param>
		public async Task<Leaderboard> LeaderboardAsync(DfsSlatesFormat format, string tournamentid)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<News[]> NewsAsync(DfsSlatesFormat format)
		{
		...
		public async Task<News[]> NewsByDateAsync(DfsSlatesFormat format, string date)
		{
		...
		public async Task<News[]> NewsByPlayerAsync(DfsSlatesFormat format, string playerid)
		{
		...
		/// <param name="playerid">Unique FantasyData Player ID.
		///Example:<code>40000019</code>.</param>
		public async Task<Player> PlayerAsync(DfsSlatesFormat format, string playerid)
		{
		...
		public async Task<PlayerSeason[]> PlayerSeasonStatsWWorldGolfRankingsAsync(DfsSlatesFormat format, string season)
		{
		...
		public async Task<PlayerTournamentProjection[]> PlayerTournamentProjectedStatsWDraftkingsSalariesAsync(DfsSlatesFormat format, string tournamentid)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PlayerTournamentProjection[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="playerid">Unique FantasyData Player ID.
		///Example:<code>40000019</code>.</param>
		public async Task<PlayerTournament> PlayerTournamentStatsByPlayerAsync(DfsSlatesFormat format, string tournamentid, string playerid)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PlayerTournament>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Player[]> PlayersAsync(DfsSlatesFormat format)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Tournament[]> ScheduleAsync(DfsSlatesFormat format)
		{
		...
		/// <param name="season">Year of the season.
		///<br>Examples: <code>2016</code>, <code>2017</code>.</param>
		public async Task<Tournament[]> ScheduleBySeasonAsync(DfsSlatesFormat format, string season)
		{
