...
namespace MyNS
{
	...
	public class ImageAction
	{
		...
		public System.Nullable<ImageAction_type> _type { get; set; }
	...
	public enum ImageAction_type
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		ImageRecipesAction = 2,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		ImageRelatedSearchesAction = 3,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		ImageShoppingSourcesAction = 4,
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public class ImageEntityAction
	{
	}
	...
	public class ImageInfo
	{
		...
		/// A JSON object consisting of coordinates specifying the four corners of a cropped rectangle within the input image.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="cropArea")]
	...
	public class ImageTag
	{
		...
		public ImageTagRegion BoundingBox { get; set; }
	...
	public class ImageTagRegion
	{
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="displayRectangle")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="queryRectangle")]
	...
	public class NormalizedQuadrilateral
	{
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="bottomLeft")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="bottomRight")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="topLeft")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="topRight")]
	...
	public class ImageModuleAction
	{
		...
		public ImagesModule Data { get; set; }
	}
	...
	public class ImageRecipesAction
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="data")]
		public RecipesModule Data { get; set; }
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public class ImageRelatedSearchesAction
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="data")]
		public RelatedSearchesModule Data { get; set; }
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public class ImageShoppingSourcesAction
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="data")]
		public AggregateOffer Data { get; set; }
	}
	...
	public class VisualSearchRequest
	{
		...
		/// A JSON object that identities the image to get insights of . It also includes the optional crop area that you use to identify the region of interest in the image.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="imageInfo")]
		public ImageInfo ImageInfo { get; set; }
		
		/// <summary>
		/// A JSON object containing information about the request, such as filters for the resulting actions.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="knowledgeRequest")]
	...
	public partial class Misc
	{
		...
		/// Images_VisualSearch images/visualsearch
		/// </summary>
		...
		/// <param name="safeSearch">Filter the image results in actions with type 'VisualSearch' for adult content. The following are the possible filter values. Off: May return images with adult content. Moderate: Do not return images with adult content. Strict: Do not return images with adult content. The default is Moderate. If the request comes from a market that Bing's adult policy requires that safeSearch is set to Strict, Bing ignores the safeSearch value and uses Strict. If you use the site: filter in the knowledge request, there is the chance that the response may contain adult content regardless of what the safeSearch query parameter is set to. Use site: only if you are aware of the content on the site and your scenario supports the possibility of adult content.</param>
		...
		public async Task<ImageKnowledge> Images_VisualSearchAsync(string mkt, Images_VisualSearchSafeSearch safeSearch, string setLang, Images_VisualSearchPostBody requestBody)
		{
			var requestUri = "images/visualsearch?mkt=" + (mkt==null? "" : System.Uri.EscapeDataString(mkt))+"&safeSearch=" + safeSearch+"&setLang=" + (setLang==null? "" : System.Uri.EscapeDataString(setLang));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<ImageKnowledge>(streamContent, jsonSerializerSettings);
			}
			finally
			{
	...
	public enum Images_VisualSearchX_BingApis_SDK
	{
	...
	public enum Images_VisualSearchSafeSearch
	{
	...
	public class Images_VisualSearchPostBody
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="knowledgeRequest")]
		public string KnowledgeRequest { get; set; }
