	...
	public partial class Misc
	{
		...
		public async Task<DiagnosticSettingsResourceCollection> DiagnosticSettings_ListAsync(string api_version)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<DiagnosticSettingsResourceCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		public async Task<DiagnosticSettingsResource> DiagnosticSettings_GetAsync(string api_version, string name)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DiagnosticSettingsResource>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<DiagnosticSettingsCategoryResourceCollection> DiagnosticSettingsCategory_ListAsync(string api_version)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DiagnosticSettingsCategoryResourceCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<OperationsDiscoveryCollection> Operations_ListAsync(string api_version)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<OperationsDiscoveryCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
