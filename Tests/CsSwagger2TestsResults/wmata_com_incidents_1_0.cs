...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </tbody>
		/// </table>
		/// BusIncidentsGetByRoute BusIncidents
		/// </summary>
		/// <param name="Route">Bus route.  Use full route code, i.e.: C2 instead of C2v1, C2v2, etc.</param>
		/// <returns>Default response code.</returns>
		public async Task BusIncidentsGetByRouteAsync(BusIncidentsGetByRouteRoute Route, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "BusIncidents?Route=" + Route;
		...
		/// </tbody>
		/// </table>
		/// ElevatorIncidentsGetByStationCode ElevatorIncidents
		/// </summary>
		/// <param name="StationCode">Two-letter station code.  Use the Station List method to return a list of all station codes.</param>
		/// <returns>Default response code.</returns>
		public async Task ElevatorIncidentsGetByStationCodeAsync(ElevatorIncidentsGetByStationCodeStationCode StationCode, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ElevatorIncidents?StationCode=" + StationCode;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </tbody>
		/// </table>
		/// IncidentsGet Incidents
		/// </summary>
		/// <returns>Default response code.</returns>
		public async Task IncidentsGetAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "Incidents";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </tbody>
		/// </table>
		/// JsonBusIncidentsGetByRoute json/BusIncidents
		/// </summary>
		/// <param name="Route">Base bus route; variations are not recognized (i.e.: C2 instead of C2v1, C2v2, etc.).</param>
		/// <returns>Default response code.</returns>
		public async Task JsonBusIncidentsGetByRouteAsync(JsonBusIncidentsGetByRouteRoute Route, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "json/BusIncidents?Route=" + Route;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </tbody>
		/// </table>
		/// JsonElevatorIncidentsGetByStationCode json/ElevatorIncidents
		/// </summary>
		/// <param name="StationCode">Station code.  Use the Station List method to return a list of all station codes.</param>
		/// <returns>Default response code.</returns>
		public async Task JsonElevatorIncidentsGetByStationCodeAsync(ElevatorIncidentsGetByStationCodeStationCode StationCode, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "json/ElevatorIncidents?StationCode=" + StationCode;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </tbody>
		/// </table>
		/// JsonIncidentsGet json/Incidents
		/// </summary>
		/// <returns>Default response code.</returns>
		public async Task JsonIncidentsGetAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "json/Incidents";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
	...
	public enum BusIncidentsGetByRouteRoute
	{
	...
	public enum ElevatorIncidentsGetByStationCodeStationCode
	{
	...
	public enum JsonBusIncidentsGetByRouteRoute
	{
