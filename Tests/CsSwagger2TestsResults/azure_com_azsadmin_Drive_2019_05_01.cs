...
namespace MyNS
{
	...
	public class Drive
	{
		...
		public DriveModel Properties { get; set; }
	}
	...
	public class DriveModel
	{
		...
		public System.Nullable<System.Int32> CapacityGB { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="isIndicationEnabled")]
		public System.Nullable<System.Boolean> IsIndicationEnabled { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="storageNode")]
	...
	public partial class Misc
	{
		...
		/// Drives_List subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/scaleUnits/{scaleUnit}/storageSubSystems/{storageSubSystem}/drives
		/// </summary>
		...
		/// Drives_Get subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/scaleUnits/{scaleUnit}/storageSubSystems/{storageSubSystem}/drives/{drive}
		/// </summary>
		/// <param name="subscriptionId">Subscription credentials that uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
		/// <param name="resourceGroupName">Name of the resource group.</param>
		/// <param name="location">Location of the resource.</param>
		...
		/// <param name="api_version">Client API Version.</param>
		/// <returns>OK</returns>
		public async Task<Drive> Drives_GetAsync(string subscriptionId, string resourceGroupName, string location, string scaleUnit, string storageSubSystem, string drive, string api_version)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.Fabric.Admin/fabricLocations/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/scaleUnits/"+ (scaleUnit==null? "" : System.Uri.EscapeDataString(scaleUnit))+"/storageSubSystems/"+ (storageSubSystem==null? "" : System.Uri.EscapeDataString(storageSubSystem))+"/drives/"+ (drive==null? "" : System.Uri.EscapeDataString(drive))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
