...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<PlayerGameProjection[]> ProjectedPlayerGameStatsByDateWInjuriesDfsSalariesAsync(DfsSlatesByDateFormat format, string date)
		{
		...
		public async Task<PlayerGameProjection> ProjectedPlayerGameStatsByPlayerWInjuriesDfsSalariesAsync(DfsSlatesByDateFormat format, string date, string playerid)
		{
		...
		public async Task<PlayerSeasonProjection[]> ProjectedPlayerSeasonStatsAsync(DfsSlatesByDateFormat format, string season)
		{
		...
		/// <param name="season">Year of the season (with optional season type).<br>Examples: <code>2018</code>, <code>2019</code>, etc.</param>
		/// <param name="playerid">Unique FantasyData Player ID. Example:<code>20000571</code>.</param>
		public async Task<PlayerSeasonProjection> ProjectedPlayerSeasonStatsByPlayerAsync(DfsSlatesByDateFormat format, string season, string playerid)
		{
		...
		public async Task<PlayerSeasonProjection[]> ProjectedPlayerSeasonStatsByTeamAsync(DfsSlatesByDateFormat format, string season, string team)
		{
