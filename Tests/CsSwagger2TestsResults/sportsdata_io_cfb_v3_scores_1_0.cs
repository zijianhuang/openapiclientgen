...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<bool> AreGamesInProgressAsync(AreGamesInProgressFormat format)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>xml</code> or <code>json</code>.</param>
		public async Task<int> CurrentSeasonAsync(AreGamesInProgressFormat format)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>xml</code> or <code>json</code>.</param>
		public async Task<Season> CurrentSeasonDetailsAsync(AreGamesInProgressFormat format)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>xml</code> or <code>json</code>.</param>
		public async Task<string> CurrentSeasontypeAsync(AreGamesInProgressFormat format)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>xml</code> or <code>json</code>.</param>
		public async Task<int> CurrentWeekAsync(AreGamesInProgressFormat format)
		{
		...
		public async Task<Game[]> SchedulesAsync(AreGamesInProgressFormat format, string season)
		{
		...
		///        </param>
		public async Task<Game[]> GamesByDateAsync(AreGamesInProgressFormat format, string date)
		{
		...
		///        </param>
		public async Task<Game[]> GamesByWeekAsync(AreGamesInProgressFormat format, string season, string week)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>xml</code> or <code>json</code>.</param>
		public async Task<Conference[]> ConferenceHierarchyWithTeamsAsync(AreGamesInProgressFormat format)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>xml</code> or <code>json</code>.</param>
		public async Task<Stadium[]> StadiumsAsync(AreGamesInProgressFormat format)
		{
		...
		///          <br>Examples: <code>1</code>, <code>2</code>, <code>3</code>, etc.
		///        </param>
		public async Task<TeamGame[]> TeamGameStatsByWeekAsync(AreGamesInProgressFormat format, string season, string week)
		{
		...
		public async Task<TeamSeason[]> TeamSeasonStatsStandingsAsync(AreGamesInProgressFormat format, string season)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>xml</code> or <code>json</code>.</param>
		public async Task<Team[]> TeamsAsync(AreGamesInProgressFormat format)
		{
