...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<DriverRaceProjection[]> DriverRaceProjectionsEntryListAsync(DriverRaceProjectionsEntryListFormat format, string raceid)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<DriverRaceProjection[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		public async Task<Driver> DriverDetailsAsync(DriverRaceProjectionsEntryListFormat format, string driverid)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Driver[]> DriversAsync(DriverRaceProjectionsEntryListFormat format)
		{
		...
		/// <param name="raceid">Unique FantasyData Race ID.
		///Example:<code>1</code>, <code>2</code>, etc.</param>
		public async Task<RaceResult> RaceResultsAsync(DriverRaceProjectionsEntryListFormat format, string raceid)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<RaceResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<Race[]> RacesScheduleAsync(DriverRaceProjectionsEntryListFormat format, string season)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Race[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Series[]> SeriesAsync(DriverRaceProjectionsEntryListFormat format)
		{
