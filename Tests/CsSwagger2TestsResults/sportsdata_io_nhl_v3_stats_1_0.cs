...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Player[]> PlayerDetailsByFreeAgentAsync(TeamsAllFormat format)
		{
		...
		/// LineCombinationsBySeason {format}/LinesBySeason/{season}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season.
		/// <br>Examples: <code>2016</code>, <code>2017</code>.
		/// </param>
		public async Task<TeamLine[]> LineCombinationsBySeasonAsync(TeamsAllFormat format, string season)
		{
			var requestUri = ""+format+"/LinesBySeason/"+ (season==null? "" : System.Uri.EscapeDataString(season));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TeamLine[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <br>Examples: <code>2016</code>, <code>2017</code>.
		/// </param>
		public async Task<TeamSeason[]> TeamStatsAllowedByPositionAsync(TeamsAllFormat format, string season)
		{
