...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// <param name="date">The date of the game(s).
		///<br>Examples: <code>2017-02-27</code>, <code>2017-09-01</code>.</param>
		public async Task<BoxScore[]> BoxScoresByDateByCompetitionAsync(MembershipsActiveFormat format, string competition, string date)
		{
		...
		public async Task<BoxScore[]> BoxScoresByDateDeltaAsync(MembershipsActiveFormat format, string date, string minutes)
		{
		...
		/// <param name="minutes">Only returns player statistics that have changed in the last X minutes.  You specify how many minutes in time to go back. Valid entries are:
		///<code>1</code>, <code>2</code> ... <code>all</code>.</param>
		public async Task<BoxScore[]> BoxScoresDeltaByDateByCompetitionAsync(MembershipsActiveFormat format, string competition, string date, string minutes)
		{
		...
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="competition">An indication of a soccer competition/league. This value can be the CompetitionId or the Competition Key. Possible values include: <code>EPL</code>, <code>1</code>, <code>MLS</code>, <code>8</code>, etc.</param>
		public async Task<CompetitionDetail> CompetitionFixturesLeagueDetailsAsync(MembershipsActiveFormat format, string competition)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Area[]> CompetitionHierarchyLeagueHierarchyAsync(MembershipsActiveFormat format)
		{
		...
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="competition">An indication of a soccer competition/league. This value can be the CompetitionId or the Competition Key. Possible values include: <code>EPL</code>, <code>1</code>, <code>MLS</code>, <code>8</code>, etc.</param>
		public async Task<Membership[]> MembershipsByCompetitionHistoricalAsync(MembershipsActiveFormat format, string competition)
		{
		...
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="competition">An indication of a soccer competition/league. This value can be the CompetitionId or the Competition Key. Possible values include: <code>EPL</code>, <code>1</code>, <code>MLS</code>, <code>8</code>, etc.</param>
		public async Task<Membership[]> MembershipsByCompetitionActiveAsync(MembershipsActiveFormat format, string competition)
		{
		...
		/// <param name="date">The date of the game(s).
		///<br>Examples: <code>2017-02-27</code>, <code>2017-09-01</code>.</param>
		public async Task<PlayerGame[]> PlayerGameStatsByDateAsync(MembershipsActiveFormat format, string date)
		{
		...
		/// <param name="playerid">Unique FantasyData Player ID.
		///Example:<code>90026231</code>.</param>
		public async Task<PlayerGame[]> PlayerGameStatsByPlayerAsync(MembershipsActiveFormat format, string date, string playerid)
		{
		...
		public async Task<PlayerSeason[]> PlayerSeasonStatsAsync(MembershipsActiveFormat format, string roundid)
		{
		...
		/// <param name="playerid">Unique FantasyData Player ID.
		///Example:<code>90026231</code>.</param>
		public async Task<PlayerSeason[]> PlayerSeasonStatsByPlayerAsync(MembershipsActiveFormat format, string roundid, string playerid)
		{
		...
		///Example:<code>516</code>.</param>
		public async Task<PlayerSeason[]> PlayerSeasonStatsByTeamAsync(MembershipsActiveFormat format, string roundid, string team)
		{
		...
		public async Task<Membership[]> MembershipsRecentlyChangedAsync(MembershipsActiveFormat format, string days)
		{
		...
		/// <param name="date">The date of the game(s).
		///<br>Examples: <code>2017-02-27</code>, <code>2017-09-01</code>.</param>
		public async Task<TeamGame[]> TeamGameStatsByDateAsync(MembershipsActiveFormat format, string date)
		{
		...
		/// <param name="roundid">Unique FantasyData Round ID. RoundIDs can be found in the Competition Hierarchy (League Hierarchy). 
		///Examples: <code>1</code>, <code>2</code>, <code>3</code>, etc</param>
		public async Task<TeamSeason[]> TeamSeasonStatsAsync(MembershipsActiveFormat format, string roundid)
		{
		...
		/// <param name="playerid">Unique FantasyData Player ID.
		///Example:<code>90026231</code>.</param>
		public async Task<Game[]> UpcomingScheduleByPlayerAsync(MembershipsActiveFormat format, string playerid)
		{
