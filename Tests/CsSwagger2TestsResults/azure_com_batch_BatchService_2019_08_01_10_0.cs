...
namespace MyNS
{
	...
	public class ImageInformation
	{
		...
		[System.Runtime.Serialization.DataMember(Name="batchSupportEndOfLife")]
		public System.Nullable<System.DateTimeOffset> BatchSupportEndOfLife { get; set; }
		...
		public ImageInformationOsType OsType { get; set; }
		...
		public ImageInformationVerificationType VerificationType { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum ImageInformationOsType
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum ImageInformationVerificationType
	{
	...
	public class SubtaskInformation
	{
		...
		[System.Runtime.Serialization.DataMember(Name="containerInfo")]
	...
	public class ComputeNode
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nodeAgentInfo")]
	...
	public class DataDisk
	{
		...
		public System.Nullable<DataDiskCaching> Caching { get; set; }
	...
	public class MultiInstanceSettings
	{
		...
		public System.Nullable<System.Int32> NumberOfInstances { get; set; }
	}
	...
	public class NetworkConfiguration
	{
		...
		[System.Runtime.Serialization.DataMember(Name="dynamicVNetAssignmentScope")]
		public System.Nullable<NetworkConfigurationDynamicVNetAssignmentScope> DynamicVNetAssignmentScope { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum NetworkConfigurationDynamicVNetAssignmentScope
	{
	...
	public class NodeCounts
	{
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="leavingPool")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="preempted")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="rebooting")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="reimaging")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="startTaskFailed")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="unusable")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="waitingForStartTask")]
	...
	public class PoolNodeCounts
	{
		...
		[System.Runtime.Serialization.DataMember(Name="dedicated")]
		public NodeCounts Dedicated { get; set; }
		
		[System.Runtime.Serialization.DataMember(Name="lowPriority")]
	...
	public class PoolNodeCountsListResult
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="value")]
		public PoolNodeCounts[] Value { get; set; }
	}
	...
	public class UploadBatchServiceLogsResult
	{
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="numberOfFilesUploaded")]
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="virtualDirectoryName")]
	...
	public partial class Misc
	{
		...
		public async Task<TaskCounts> Job_GetTaskCountsAsync(string jobId, int timeout, string api_version)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TaskCounts>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Account_ListPoolNodeCounts nodecounts
		/// </summary>
		...
		/// <param name="timeout">The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds.</param>
		/// <param name="api_version">Client API Version.</param>
		/// <returns>The response contains the number of Compute Nodes in each Compute Node state, grouped by Pool.</returns>
		public async Task<PoolNodeCountsListResult> Account_ListPoolNodeCountsAsync(string filter, int maxresults, int timeout, string api_version)
		{
			var requestUri = "nodecounts?$filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxresults="+maxresults+"&timeout="+timeout+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PoolNodeCountsListResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="select">An OData $select clause.</param>
		/// <param name="maxresults">The maximum number of items to return in the response. A maximum of 1000 Compute Nodes can be returned.
		/// Minimum: 1
		/// Maximum: 1000
		// </param>
		/// <param name="timeout">The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds.</param>
		/// <param name="api_version">Client API Version.</param>
		/// <returns>A response containing the list of Compute Nodes.</returns>
		...
		public async Task<PoolListUsageMetricsResult> Pool_ListUsageMetricsAsync(System.DateTimeOffset starttime, System.DateTimeOffset endtime, string filter, int maxresults, int timeout, string api_version)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PoolListUsageMetricsResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Account_ListSupportedImages supportedimages
		/// </summary>
		...
		/// <param name="timeout">The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds.</param>
		/// <param name="api_version">Client API Version.</param>
		/// <returns>A response containing the list of supported Virtual Machine Images.</returns>
		public async Task<AccountListSupportedImagesResult> Account_ListSupportedImagesAsync(string filter, int maxresults, int timeout, string api_version)
		{
			var requestUri = "supportedimages?$filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxresults="+maxresults+"&timeout="+timeout+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AccountListSupportedImagesResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
