...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="api_version">The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01-preview" for this specification.</param>
		...
		public async Task<ClusterCodeVersionsListResult> ClusterVersions_ListAsync(string location, ClusterVersions_ListApi_version api_version, string subscriptionId)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ClusterCodeVersionsListResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Clusters_Create subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/clusters/{clusterName}
		/// </summary>
		/// <param name="resourceGroupName">The name of the resource group.</param>
		/// <param name="clusterName">The name of the cluster resource.</param>
		/// <param name="api_version">The version of the Service Fabric resource provider API. This is a required parameter and it's value must be "2019-03-01-preview" for this specification.</param>
		...
		/// <returns>The operation completed successfully.</returns>
		public async Task<Cluster> Clusters_CreateAsync(string resourceGroupName, string clusterName, Clusters_CreateApi_version api_version, string subscriptionId, Cluster requestBody)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.ServiceFabric/clusters/"+ (clusterName==null? "" : System.Uri.EscapeDataString(clusterName))+"&api-version=" + api_version;
	...
	public enum Clusters_ListApi_version
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute(Value="2019-03-01-preview")]
		_2019Minus03Minus01Minuspreview = 0,
	}
	...
	public enum Clusters_CreateApi_version
	{
