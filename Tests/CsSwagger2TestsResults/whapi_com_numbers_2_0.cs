...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// <param name="highest">Highest possible value to be returned.
		/// Minimum: 1
		/// Maximum: 9999999999
		// </param>
		/// <param name="lowest">Lowest possible value to be returned.
		/// Minimum: 1
		/// Maximum: 9999999999
		// </param>
		/// <param name="count">Number of values to be returned.
		/// Minimum: 1
		/// Maximum: 99
		// </param>
		...
		public async Task<Success> GetRandomNumbersAsync(string gameCode, int highest, int lowest, int count, bool unique)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<Success>(streamContent, jsonSerializerSettings);
			}
			finally
			{
