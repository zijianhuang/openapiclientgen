...
namespace MyNS
{
	...
	public class RoleAssignmentFilter
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="canDelegate")]
		public System.Nullable<System.Boolean> CanDelegate { get; set; }
	...
	public class RoleAssignmentProperties
	{
		...
		public System.Nullable<RoleAssignmentPropertiesPrincipalType> PrincipalType { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum RoleAssignmentPropertiesPrincipalType
	{
	...
	public class RoleAssignmentPropertiesWithScope
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="principalType")]
		public RoleAssignmentPropertiesPrincipalType PrincipalType { get; set; }
	...
	public partial class Misc
	{
		...
		/// RoleAssignments_GetById {roleId}
		/// </summary>
		/// <param name="roleId">The ID of the role assignment to get.</param>
		/// <param name="api_version">The API version to use for this operation.</param>
		/// <returns>OK - Returns the role assignment.</returns>
		public async Task<RoleAssignment> RoleAssignments_GetByIdAsync(string roleId, string api_version)
		{
			var requestUri = ""+ (roleId==null? "" : System.Uri.EscapeDataString(roleId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		/// RoleAssignments_CreateById {roleId}
		/// </summary>
		...
		public async Task RoleAssignments_CreateByIdAsync(string roleId, string api_version, RoleAssignmentCreateParameters requestBody)
		{
			var requestUri = ""+ (roleId==null? "" : System.Uri.EscapeDataString(roleId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		/// RoleAssignments_DeleteById {roleId}
		/// </summary>
		...
		public async Task<RoleAssignment> RoleAssignments_DeleteByIdAsync(string roleId, string api_version)
		{
			var requestUri = ""+ (roleId==null? "" : System.Uri.EscapeDataString(roleId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
