...
namespace MyNS
{
	...
	public class ContainerProperties
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="containerStatus")]
		public System.Nullable<ContainerPropertiesContainerStatus> ContainerStatus { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum ContainerPropertiesContainerStatus
	{
	...
	public enum SkuName
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		TEA_1Node_UPS_Heater = 5,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		TEA_4Node_Heater = 6,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		TEA_4Node_UPS_Heater = 7,
	...
	public class IoTDeviceInfo
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="ioTHostHubId")]
	...
	public class JobProperties
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="refreshedEntityId")]
	...
	public class NodeProperties
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nodeChassisSerialNumber")]
		public string NodeChassisSerialNumber { get; set; }
		
		/// <summary>
		/// Display Name of the individual node
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nodeDisplayName")]
		public string NodeDisplayName { get; set; }
		
		/// <summary>
		/// Friendly software version name that is currently installed on the node
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nodeFriendlySoftwareVersion")]
		public string NodeFriendlySoftwareVersion { get; set; }
		
		/// <summary>
		/// HCS version that is currently installed on the node
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nodeHcsVersion")]
		public string NodeHcsVersion { get; set; }
		
		/// <summary>
		/// Guid instance id of the node
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nodeInstanceId")]
		public string NodeInstanceId { get; set; }
		
		/// <summary>
		/// Serial number of the individual node
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nodeSerialNumber")]
		public string NodeSerialNumber { get; set; }
		
		/// <summary>
		/// The current status of the individual node
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nodeStatus")]
		public System.Nullable<NodePropertiesNodeStatus> NodeStatus { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum NodePropertiesNodeStatus
	{
	...
	public class OrderStatus
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="additionalOrderDetails")]
		public System.Collections.Generic.Dictionary<string, string> AdditionalOrderDetails { get; set; }
	...
	public class ResourceTypeSku
	{
		...
		public SkuRestriction[] Restrictions { get; set; }
	...
	public class SkuRestriction
	{
		...
		public System.Nullable<SkuRestrictionReasonCode> ReasonCode { get; set; }
		
		/// <summary>
		/// The restriction info with locations and zones.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="restrictionInfo")]
		public SkuRestrictionInfo RestrictionInfo { get; set; }
	...
	public class StorageAccountProperties
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="containerCount")]
		public System.Nullable<System.Int32> ContainerCount { get; set; }
		
		/// <summary>
		/// Data policy of the storage Account.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="dataPolicy")]
		public SharePropertiesDataPolicy DataPolicy { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="storageAccountStatus")]
		public ContainerPropertiesContainerStatus StorageAccountStatus { get; set; }
	}
	...
	public class UploadCertificateResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="aadAudience")]
	...
	public class UserProperties
	{
		...
		public UserPropertiesUserType UserType { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum UserPropertiesUserType
	{
	...
	public partial class Misc
	{
		...
		/// <returns>The collection of Data Box Edge/Data Box Gateway devices.</returns>
		...
		/// Skus_List subscriptions/{subscriptionId}/providers/Microsoft.DataBoxEdge/skus
		/// </summary>
		/// <param name="subscriptionId">The subscription ID.</param>
		/// <param name="api_version">The API version.</param>
		/// <param name="filter">Specify $filter='location eq <location>' to filter on location.</param>
		/// <returns>Lists the available Skus and information related to them.</returns>
		public async Task<SkuInformationList> Skus_ListAsync(string subscriptionId, string api_version, string filter)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/providers/Microsoft.DataBoxEdge/skus&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version))+"&$filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SkuInformationList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <returns>The Data Box Edge/Data Box Gateway device.</returns>
		...
		/// Nodes_ListByDataBoxEdgeDevice subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/nodes
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		/// <param name="subscriptionId">The subscription ID.</param>
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <returns>The collection of all nodes on the device.</returns>
		public async Task<NodeList> Nodes_ListByDataBoxEdgeDeviceAsync(string deviceName, string subscriptionId, string resourceGroupName, string api_version)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/nodes&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<NodeList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// StorageAccounts_ListByDataBoxEdgeDevice subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		/// <param name="subscriptionId">The subscription ID.</param>
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <returns>The collection of all the StorageAccounts on the device.</returns>
		public async Task<StorageAccountList> StorageAccounts_ListByDataBoxEdgeDeviceAsync(string deviceName, string subscriptionId, string resourceGroupName, string api_version)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/storageAccounts&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<StorageAccountList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// StorageAccounts_Get subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		...
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <returns>The storage account details.</returns>
		public async Task<StorageAccount> StorageAccounts_GetAsync(string deviceName, string storageAccountName, string subscriptionId, string resourceGroupName, string api_version)
		{
		...
		/// StorageAccounts_CreateOrUpdate subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		...
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <param name="requestBody">The StorageAccount properties.</param>
		/// <returns>Successfully created or updated the StorageAccount.</returns>
		public async Task<StorageAccount> StorageAccounts_CreateOrUpdateAsync(string deviceName, string storageAccountName, string subscriptionId, string resourceGroupName, string api_version, StorageAccount requestBody)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/storageAccounts/"+ (storageAccountName==null? "" : System.Uri.EscapeDataString(storageAccountName))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
		...
		/// StorageAccounts_Delete subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		/// <param name="storageAccountName">The StorageAccount name.</param>
		/// <param name="subscriptionId">The subscription ID.</param>
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		public async Task StorageAccounts_DeleteAsync(string deviceName, string storageAccountName, string subscriptionId, string resourceGroupName, string api_version)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/storageAccounts/"+ (storageAccountName==null? "" : System.Uri.EscapeDataString(storageAccountName))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		/// Containers_ListByStorageAccount subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}/containers
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		/// <param name="storageAccountName">The storage Account name.</param>
		/// <param name="subscriptionId">The subscription ID.</param>
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <returns>The collection of all the containers on the device.</returns>
		public async Task<ContainerList> Containers_ListByStorageAccountAsync(string deviceName, string storageAccountName, string subscriptionId, string resourceGroupName, string api_version)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ContainerList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Containers_Get subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}/containers/{containerName}
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		/// <param name="storageAccountName">The Storage Account Name</param>
		...
		public async Task<Container> Containers_GetAsync(string deviceName, string storageAccountName, string containerName, string subscriptionId, string resourceGroupName, string api_version)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Container>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Containers_CreateOrUpdate subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}/containers/{containerName}
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		/// <param name="storageAccountName">The Storage Account Name</param>
		/// <param name="containerName">The container name.</param>
		...
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <param name="requestBody">The container properties.</param>
		/// <returns>Successfully created or updated the container.</returns>
		public async Task<Container> Containers_CreateOrUpdateAsync(string deviceName, string storageAccountName, string containerName, string subscriptionId, string resourceGroupName, string api_version, Container requestBody)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/storageAccounts/"+ (storageAccountName==null? "" : System.Uri.EscapeDataString(storageAccountName))+"/containers/"+ (containerName==null? "" : System.Uri.EscapeDataString(containerName))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
		...
		/// Containers_Delete subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}/containers/{containerName}
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		/// <param name="storageAccountName">The Storage Account Name</param>
		/// <param name="containerName">The container name.</param>
		...
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		public async Task Containers_DeleteAsync(string deviceName, string storageAccountName, string containerName, string subscriptionId, string resourceGroupName, string api_version)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/storageAccounts/"+ (storageAccountName==null? "" : System.Uri.EscapeDataString(storageAccountName))+"/containers/"+ (containerName==null? "" : System.Uri.EscapeDataString(containerName))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		/// Containers_Refresh subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}/containers/{containerName}/refresh
		/// </summary>
		/// <param name="deviceName">The device name.</param>
		/// <param name="storageAccountName">The Storage Account Name</param>
		/// <param name="containerName">The container name.</param>
		...
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <returns>Successfully refreshed the container on the device.</returns>
		public async Task Containers_RefreshAsync(string deviceName, string storageAccountName, string containerName, string subscriptionId, string resourceGroupName, string api_version)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/storageAccounts/"+ (storageAccountName==null? "" : System.Uri.EscapeDataString(storageAccountName))+"/containers/"+ (containerName==null? "" : System.Uri.EscapeDataString(containerName))+"/refresh&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		public async Task<TriggerList> Triggers_ListByDataBoxEdgeDeviceAsync(string deviceName, string subscriptionId, string resourceGroupName, string api_version, string filter)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/triggers&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version))+"&$filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		/// <param name="resourceGroupName">The resource group name.</param>
		/// <param name="api_version">The API version.</param>
		/// <param name="filter">Specify $filter='UserType eq <type>' to filter on user type property</param>
		/// <returns>The collection of all users on the device.</returns>
		public async Task<UserList> Users_ListByDataBoxEdgeDeviceAsync(string deviceName, string subscriptionId, string resourceGroupName, string api_version, string filter)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/resourceGroups/"+ (resourceGroupName==null? "" : System.Uri.EscapeDataString(resourceGroupName))+"/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/"+ (deviceName==null? "" : System.Uri.EscapeDataString(deviceName))+"/users&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version))+"&$filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
