...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="filter">An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-node-agent-skus.</param>
		...
		/// <param name="timeout">The maximum time that the server can spend processing the request, in seconds. The default is 30 seconds.</param>
		/// <param name="api_version">Client API Version.</param>
		/// <returns>The response contains the number of nodes in each node state, grouped by pool.</returns>
