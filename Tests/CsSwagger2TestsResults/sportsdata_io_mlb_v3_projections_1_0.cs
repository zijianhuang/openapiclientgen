...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// ProjectedPlayerGameStatsByDateWInjuriesLineupsDfsSalaries {format}/PlayerGameProjectionStatsByDate/{date}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="date">The date of the game(s).
		///<br>Examples: <code>2017-JUL-31</code>, <code>2017-SEP-01</code>.</param>
		public async Task<PlayerGameProjection[]> ProjectedPlayerGameStatsByDateWInjuriesLineupsDfsSalariesAsync(DfsSlatesByDateFormat format, string date)
		{
		...
		/// ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalaries {format}/PlayerGameProjectionStatsByPlayer/{date}/{playerid}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="date">The date of the game(s).
		///<br>Examples: <code>2017-JUL-31</code>, <code>2017-SEP-01</code>.</param>
		...
		public async Task<PlayerGameProjection[]> ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesAsync(DfsSlatesByDateFormat format, string date, string playerid)
		{
		...
		public async Task<PlayerSeasonProjection[]> ProjectedPlayerSeasonStatsWithAdpAsync(DfsSlatesByDateFormat format, string season)
		{
