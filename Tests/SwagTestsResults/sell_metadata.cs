...
namespace MyNS
{
	...
	public class ProductAdoptionPolicy
	{
		...
		/// </summary>
		public System.Nullable<System.Boolean> ProductRequired { get; set; }
	}
	...
	public partial class MyClient
	{
		...
		public async Task<SalesTaxJurisdictions> GetSalesTaxJurisdictionsAsync(string countryCode)
		{
		...
		/// <returns>Success</returns>
		public async Task<AutomotivePartsCompatibilityPolicyResponse> GetAutomotivePartsCompatibilityPoliciesAsync(string filter, string marketplace_id)
		{
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. &gt;Note: Only the following eBay marketplaces support automotive parts compatibility: EBAY_US EBAY_AU EBAY_CA EBAY_DE EBAY_ES EBAY_FR EBAY_GB EBAY_IT</param>
		/// <returns>Success</returns>
		public AutomotivePartsCompatibilityPolicyResponse GetAutomotivePartsCompatibilityPolicies(string filter, string marketplace_id)
		{
			var requestUri = "marketplace/"+ (marketplace_id==null? "" : System.Uri.EscapeDataString(marketplace_id))+"/get_automotive_parts_compatibility_policies?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// <returns>Success</returns>
		public async Task<ItemConditionPolicyResponse> GetItemConditionPoliciesAsync(string filter, string marketplace_id)
		{
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public ItemConditionPolicyResponse GetItemConditionPolicies(string filter, string marketplace_id)
		{
			var requestUri = "marketplace/"+ (marketplace_id==null? "" : System.Uri.EscapeDataString(marketplace_id))+"/get_item_condition_policies?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public async Task<ListingStructurePolicyResponse> GetListingStructurePoliciesAsync(string filter, string marketplace_id)
		{
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public ListingStructurePolicyResponse GetListingStructurePolicies(string filter, string marketplace_id)
		{
			var requestUri = "marketplace/"+ (marketplace_id==null? "" : System.Uri.EscapeDataString(marketplace_id))+"/get_listing_structure_policies?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public async Task<NegotiatedPricePolicyResponse> GetNegotiatedPricePoliciesAsync(string filter, string marketplace_id)
		{
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public NegotiatedPricePolicyResponse GetNegotiatedPricePolicies(string filter, string marketplace_id)
		{
			var requestUri = "marketplace/"+ (marketplace_id==null? "" : System.Uri.EscapeDataString(marketplace_id))+"/get_negotiated_price_policies?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// GetProductAdoptionPolicies marketplace/{marketplace_id}/get_product_adoption_policies
		/// </summary>
		/// <param name="filter">This query parameter limits the response by returning eBay policy information for only the leaf categories specified by this parameter. Set filter to a list of categoryId values. You can specify up to 50 category IDs by separating each with a pipe character ('|'). If you specify more than 50 categoryId values, eBay returns a warning along with the results for the first 50 IDs. If you specify a category ID that has child nodes, eBay returns policy information for all the leaf categories of that parent node. Example: filter=categoryIds:{100|101|102} Note that you must URL-encode the list of category ID values, which results in the following filter for the above example: &nbsp;&nbsp;filter=categoryIds%3A%7B100%7C101%7C102%7D</param>
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public async Task<ProductAdoptionPolicyResponse> GetProductAdoptionPoliciesAsync(string filter, string marketplace_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ProductAdoptionPolicyResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public ProductAdoptionPolicyResponse GetProductAdoptionPolicies(string filter, string marketplace_id)
		{
			var requestUri = "marketplace/"+ (marketplace_id==null? "" : System.Uri.EscapeDataString(marketplace_id))+"/get_product_adoption_policies?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public async Task<ReturnPolicyResponse> GetReturnPoliciesAsync(string filter, string marketplace_id)
		{
		...
		/// <param name="marketplace_id">This path parameter specifies the eBay marketplace for which policy information is retrieved. See the following page for a list of valid eBay marketplace IDs: Request components.</param>
		/// <returns>Success</returns>
		public ReturnPolicyResponse GetReturnPolicies(string filter, string marketplace_id)
		{
			var requestUri = "marketplace/"+ (marketplace_id==null? "" : System.Uri.EscapeDataString(marketplace_id))+"/get_return_policies?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
