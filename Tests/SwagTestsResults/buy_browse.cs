...
namespace MyNS
{
	...
	public class RemoteShopcartResponse
	{
		...
		/// </summary>
		public CartItem[] UnavailableCartItems { get; set; }
	...
	public partial class MyClient
	{
		...
		/// <returns>OK</returns>
		public async Task<SearchPagedCollection> SearchAsync(string aspect_filter, string category_ids, string charity_ids, string compatibility_filter, string epid, string fieldgroups, string filter, string gtin, string limit, string offset, string q, string sort)
		{
		...
		/// <returns>OK</returns>
		public async Task<SearchPagedCollection> SearchByImageAsync(string aspect_filter, string category_ids, string epid, string filter, string limit, string offset, string sort, SearchByImageRequest requestBody)
		{
			var requestUri = "item_summary/search_by_image?aspect_filter=" + (aspect_filter==null? "" : System.Uri.EscapeDataString(aspect_filter))+"&category_ids=" + (category_ids==null? "" : System.Uri.EscapeDataString(category_ids))+"&epid=" + (epid==null? "" : System.Uri.EscapeDataString(epid))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&sort=" + (sort==null? "" : System.Uri.EscapeDataString(sort));
		...
		/// <param name="requestBody">The container for the image information fields.</param>
		/// <returns>OK</returns>
		public SearchPagedCollection SearchByImage(string aspect_filter, string category_ids, string epid, string filter, string limit, string offset, string sort, SearchByImageRequest requestBody)
		{
			var requestUri = "item_summary/search_by_image?aspect_filter=" + (aspect_filter==null? "" : System.Uri.EscapeDataString(aspect_filter))+"&category_ids=" + (category_ids==null? "" : System.Uri.EscapeDataString(category_ids))+"&epid=" + (epid==null? "" : System.Uri.EscapeDataString(epid))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&sort=" + (sort==null? "" : System.Uri.EscapeDataString(sort));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		public async Task<Item> GetItemAsync(string fieldgroups, string item_id)
		{
		...
		/// <returns>OK</returns>
		public async Task<Item> GetItemByLegacyIdAsync(string fieldgroups, string legacy_item_id, string legacy_variation_id, string legacy_variation_sku)
		{
		...
		/// <returns>OK</returns>
		public async Task<Items> GetItemsByItemGroupAsync(string item_group_id)
		{
		...
		/// <returns>OK</returns>
		public async Task<CompatibilityResponse> CheckCompatibilityAsync(string item_id, CompatibilityPayload requestBody)
		{
		...
		/// <param name="item_id">The eBay RESTful identifier of an item (such as a part you want to check). This ID is returned by the Browse and Feed API methods. RESTful Item ID Format: v1|#|# For example: v1|272394640372|0 or v1|162846450672|461882996982 For more information about item ID for RESTful APIs, see the Legacy API compatibility section of the Buy APIs Overview.</param>
		/// <returns>OK</returns>
		public CompatibilityResponse CheckCompatibility(string item_id, CompatibilityPayload requestBody)
		{
			var requestUri = "item/"+ (item_id==null? "" : System.Uri.EscapeDataString(item_id))+"/check_compatibility";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// AddItem shopping_cart/add_item
		/// </summary>
		/// <returns>OK</returns>
		public async Task<RemoteShopcartResponse> AddItemAsync(AddCartItemInput requestBody)
		{
			var requestUri = "shopping_cart/add_item";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<RemoteShopcartResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <returns>OK</returns>
		public RemoteShopcartResponse AddItem(AddCartItemInput requestBody)
		{
			var requestUri = "shopping_cart/add_item";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// GetShoppingCart shopping_cart/
		/// </summary>
		/// <returns>OK</returns>
		public async Task<RemoteShopcartResponse> GetShoppingCartAsync()
		{
		...
		/// RemoveItem shopping_cart/remove_item
		/// </summary>
		/// <returns>OK</returns>
		public async Task<RemoteShopcartResponse> RemoveItemAsync(RemoveCartItemInput requestBody)
		{
			var requestUri = "shopping_cart/remove_item";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// </summary>
		/// <returns>OK</returns>
		public RemoteShopcartResponse RemoveItem(RemoveCartItemInput requestBody)
		{
			var requestUri = "shopping_cart/remove_item";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// UpdateQuantity shopping_cart/update_quantity
		/// </summary>
		/// <returns>OK</returns>
		public async Task<RemoteShopcartResponse> UpdateQuantityAsync(UpdateCartItemInput requestBody)
		{
			var requestUri = "shopping_cart/update_quantity";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// </summary>
		/// <returns>OK</returns>
		public RemoteShopcartResponse UpdateQuantity(UpdateCartItemInput requestBody)
		{
			var requestUri = "shopping_cart/update_quantity";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
