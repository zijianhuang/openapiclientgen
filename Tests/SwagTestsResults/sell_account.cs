...
namespace MyNS
{
	...
	public partial class MyClient
	{
		...
		public async Task<FulfillmentPolicyResponse> GetFulfillmentPoliciesAsync(string marketplace_id)
		{
			...
			try
			{
				...
				return serializer.Deserialize<FulfillmentPolicyResponse>(jsonReader);
			}
			finally
			{
		...
		public async Task CreateFulfillmentPolicyAsync(FulfillmentPolicyRequest requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">Request to create a seller account fulfillment policy.</param>
		public void CreateFulfillmentPolicy(FulfillmentPolicyRequest requestBody)
		{
			var requestUri = "fulfillment_policy/";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<FulfillmentPolicy> GetFulfillmentPolicyAsync(string fulfillmentPolicyId)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<FulfillmentPolicy>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>OK</returns>
		public async Task<SetFulfillmentPolicyResponse> UpdateFulfillmentPolicyAsync(string fulfillmentPolicyId, FulfillmentPolicyRequest requestBody)
		{
			var requestUri = "fulfillment_policy/"+ (fulfillmentPolicyId==null? "" : System.Uri.EscapeDataString(fulfillmentPolicyId));
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<SetFulfillmentPolicyResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">Fulfillment policy request</param>
		/// <returns>OK</returns>
		public SetFulfillmentPolicyResponse UpdateFulfillmentPolicy(string fulfillmentPolicyId, FulfillmentPolicyRequest requestBody)
		{
			var requestUri = "fulfillment_policy/"+ (fulfillmentPolicyId==null? "" : System.Uri.EscapeDataString(fulfillmentPolicyId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		public async Task DeleteFulfillmentPolicyAsync(string fulfillmentPolicyId)
		{
			var requestUri = "fulfillment_policy/"+ (fulfillmentPolicyId==null? "" : System.Uri.EscapeDataString(fulfillmentPolicyId));
		...
		/// <returns>Success</returns>
		public async Task<FulfillmentPolicy> GetFulfillmentPolicyByNameAsync(string marketplace_id, string name)
		{
		...
		/// <param name="marketplace_id">This query parameter specifies the eBay marketplace of the policies you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/account/types/MarketplaceIdEnum.html</param>
		/// <returns>Success</returns>
		public async Task<PaymentPolicyResponse> GetPaymentPoliciesAsync(string marketplace_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<PaymentPolicyResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task CreatePaymentPolicyAsync(PaymentPolicyRequest requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">Payment policy request</param>
		public void CreatePaymentPolicy(PaymentPolicyRequest requestBody)
		{
			var requestUri = "payment_policy/";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<PaymentPolicy> GetPaymentPolicyAsync(string payment_policy_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<PaymentPolicy>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">Payment policy request</param>
		/// <returns>OK</returns>
		public async Task<SetPaymentPolicyResponse> UpdatePaymentPolicyAsync(string payment_policy_id, PaymentPolicyRequest requestBody)
		{
			var requestUri = "payment_policy/"+ (payment_policy_id==null? "" : System.Uri.EscapeDataString(payment_policy_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<SetPaymentPolicyResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">Payment policy request</param>
		/// <returns>OK</returns>
		public SetPaymentPolicyResponse UpdatePaymentPolicy(string payment_policy_id, PaymentPolicyRequest requestBody)
		{
			var requestUri = "payment_policy/"+ (payment_policy_id==null? "" : System.Uri.EscapeDataString(payment_policy_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		public async Task DeletePaymentPolicyAsync(string payment_policy_id)
		{
			var requestUri = "payment_policy/"+ (payment_policy_id==null? "" : System.Uri.EscapeDataString(payment_policy_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		/// <returns>Success</returns>
		public async Task<PaymentPolicy> GetPaymentPolicyByNameAsync(string marketplace_id, string name)
		{
		...
		/// <returns>Success</returns>
		public async Task<PaymentsProgramResponse> GetPaymentsProgramAsync(string marketplace_id, string payments_program_type)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<PaymentsProgramResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task<SellingPrivileges> GetPrivilegesAsync()
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<SellingPrivileges>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task<Programs> GetOptedInProgramsAsync()
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<Programs>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>Success</returns>
		public async Task<string> OptInToProgramAsync(Program requestBody)
		{
		...
		/// <param name="requestBody">Program being opted-in to.</param>
		/// <returns>Success</returns>
		public string OptInToProgram(Program requestBody)
		{
			var requestUri = "program/opt_in";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<string> OptOutOfProgramAsync(Program requestBody)
		{
		...
		/// <param name="requestBody">Program being opted-out of.</param>
		/// <returns>Success</returns>
		public string OptOutOfProgram(Program requestBody)
		{
			var requestUri = "program/opt_out";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<RateTableResponse> GetRateTablesAsync(string country_code)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<RateTableResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="country_code">This query parameter specifies the two-letter ISO 3166-1 Alpha-2 code of country for which you want shipping-rate table information. If you do not specify a county code, the request returns all the seller-defined rate tables. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/account/types/CountryCodeEnum.html</param>
		/// <returns>Success</returns>
		public RateTableResponse GetRateTables(string country_code)
		{
			var requestUri = "rate_table/?country_code=" + (country_code==null? "" : System.Uri.EscapeDataString(country_code));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.SendAsync(httpRequestMessage).Result;
		...
		/// <returns>Success</returns>
		public async Task<ReturnPolicyResponse> GetReturnPoliciesAsync(string marketplace_id)
		{
		...
		public async Task CreateReturnPolicyAsync(ReturnPolicyRequest requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">Return policy request</param>
		public void CreateReturnPolicy(ReturnPolicyRequest requestBody)
		{
			var requestUri = "return_policy/";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<ReturnPolicy> GetReturnPolicyAsync(string return_policy_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ReturnPolicy>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>OK</returns>
		public async Task<SetReturnPolicyResponse> UpdateReturnPolicyAsync(string return_policy_id, ReturnPolicyRequest requestBody)
		{
			var requestUri = "return_policy/"+ (return_policy_id==null? "" : System.Uri.EscapeDataString(return_policy_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<SetReturnPolicyResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">Container for a return policy request.</param>
		/// <returns>OK</returns>
		public SetReturnPolicyResponse UpdateReturnPolicy(string return_policy_id, ReturnPolicyRequest requestBody)
		{
			var requestUri = "return_policy/"+ (return_policy_id==null? "" : System.Uri.EscapeDataString(return_policy_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		public async Task DeleteReturnPolicyAsync(string return_policy_id)
		{
			var requestUri = "return_policy/"+ (return_policy_id==null? "" : System.Uri.EscapeDataString(return_policy_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		/// <returns>Success</returns>
		public async Task<ReturnPolicy> GetReturnPolicyByNameAsync(string marketplace_id, string name)
		{
		...
		/// <returns>Success</returns>
		public async Task<SalesTax> GetSalesTaxAsync(string countryCode, string jurisdictionId)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<SalesTax>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task CreateOrReplaceSalesTaxAsync(string countryCode, string jurisdictionId, SalesTaxBase requestBody)
		{
			var requestUri = "sales_tax/"+ (countryCode==null? "" : System.Uri.EscapeDataString(countryCode))+"/"+ (jurisdictionId==null? "" : System.Uri.EscapeDataString(jurisdictionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="jurisdictionId">This path parameter specifies the ID of the sales-tax jurisdiction for the table entry you want to create.</param>
		/// <param name="requestBody">A container that describes the how the sales tax is calculated.</param>
		public void CreateOrReplaceSalesTax(string countryCode, string jurisdictionId, SalesTaxBase requestBody)
		{
			var requestUri = "sales_tax/"+ (countryCode==null? "" : System.Uri.EscapeDataString(countryCode))+"/"+ (jurisdictionId==null? "" : System.Uri.EscapeDataString(jurisdictionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		public async Task DeleteSalesTaxAsync(string countryCode, string jurisdictionId)
		{
			var requestUri = "sales_tax/"+ (countryCode==null? "" : System.Uri.EscapeDataString(countryCode))+"/"+ (jurisdictionId==null? "" : System.Uri.EscapeDataString(jurisdictionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		/// <returns>Success</returns>
		public async Task<SalesTaxes> GetSalesTaxesAsync(string country_code)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<SalesTaxes>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
