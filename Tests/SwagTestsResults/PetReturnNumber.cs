...
namespace MyNS
{
	...
	public partial class MyClient
	{
		...
		/// </summary>
		/// <param name="username">The user name for loginKKK</param>
		/// <param name="password">The password for login in clear textPPP</param>
		public async Task<long> LoginUserAsync(string username, string password)
		{
