...
namespace MyNS
{
	...
	public class CloneOperationCommonResponse
	{
		...
		/// </summary>
		public System.Nullable<CloneOperationCommonResponseState> State { get; set; }
	}
	...
	public class LibraryWorkItemsData
	{
		...
		/// </summary>
		public System.Nullable<LibraryWorkItemsDataReturnCode> ReturnCode { get; set; }
	...
	public class LibraryWorkItemsDataProviderRequest
	{
		...
		/// </summary>
		public System.Nullable<LibraryWorkItemsDataProviderRequestLibraryQueryType> LibraryQueryType { get; set; }
	...
	public class TestPlansLibraryWorkItemFilter
	{
		...
		/// Mode of the filter.
		/// </summary>
		public System.Nullable<TestPlansLibraryWorkItemFilterFilterMode> FilterMode { get; set; }
	}
	...
	public class Results
	{
		...
		/// </summary>
		public System.Nullable<ResultsOutcome> Outcome { get; set; }
	}
	...
	public class SuiteEntryUpdateParams
	{
		...
		/// </summary>
		public System.Nullable<SuiteEntryUpdateParamsSuiteEntryType> SuiteEntryType { get; set; }
	}
	...
	public class TestCaseAssociatedResult
	{
		...
		public System.Nullable<TestCaseAssociatedResultOutcome> Outcome { get; set; }
	...
	public class TestConfigurationCreateUpdateParameters
	{
		...
		/// </summary>
		public System.Nullable<TestConfigurationCreateUpdateParametersState> State { get; set; }
	...
	public class TestPointResults
	{
		...
		/// </summary>
		public System.Nullable<TestPointResultsFailureType> FailureType { get; set; }
		
		/// <summary>
		/// Last Resolution State Id for the Test Point
		/// </summary>
		public System.Nullable<TestPointResultsLastResolutionState> LastResolutionState { get; set; }
		...
		/// </summary>
		public System.Nullable<TestPointResultsLastResultState> LastResultState { get; set; }
		...
		/// Outcome of the Test Point
		/// </summary>
		public System.Nullable<TestPointResultsOutcome> Outcome { get; set; }
		
		/// <summary>
		/// State of the Test Point
		/// </summary>
		public System.Nullable<TestPointResultsState> State { get; set; }
	}
	...
	public class TestSuiteCreateParams
	{
		...
		/// Test suite type.
		/// </summary>
		public System.Nullable<TestSuiteCreateParamsSuiteType> SuiteType { get; set; }
	}
	...
	public partial class MyClient
	{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/configurations&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		/// Configurations_Update {organization}/{project}/_apis/testplan/configurations
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="project">Project ID or project name</param>
		...
		/// <param name="requestBody">TestConfigurationCreateUpdateParameters</param>
		/// <returns>successful operation</returns>
		public async Task<TestConfiguration> Configurations_UpdateAsync(string organization, string project, int testConfiguartionId, string api_version, TestConfigurationCreateUpdateParameters requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/configurations&testConfiguartionId="+testConfiguartionId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		/// <param name="requestBody">TestConfigurationCreateUpdateParameters</param>
		/// <returns>successful operation</returns>
		public TestConfiguration Configurations_Update(string organization, string project, int testConfiguartionId, string api_version, TestConfigurationCreateUpdateParameters requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/configurations&testConfiguartionId="+testConfiguartionId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/plans&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// <summary>
		/// Update a test plan.
		/// Test__Plans_Update {organization}/{project}/_apis/testplan/plans/{planId}
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="project">Project ID or project name</param>
		/// <param name="planId">ID of the test plan to be updated.</param>
		/// <param name="api_version">Version of the API to use.  This should be set to '6.0-preview.1' to use this version of the api.</param>
		/// <param name="requestBody">A testPlanUpdateParams object.TestPlanUpdateParams</param>
		/// <returns>successful operation</returns>
		public async Task<TestPlan> Test__Plans_UpdateAsync(string organization, string project, int planId, string api_version, TestPlanUpdateParams requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/plans/"+planId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="requestBody">A testPlanUpdateParams object.TestPlanUpdateParams</param>
		/// <returns>successful operation</returns>
		public TestPlan Test__Plans_Update(string organization, string project, int planId, string api_version, TestPlanUpdateParams requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/plans/"+planId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/"+planId+"/suites&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// <summary>
		/// Update test suite.
		/// Test__Suites_Update {organization}/{project}/_apis/testplan/Plans/{planId}/suites/{suiteId}
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="project">Project ID or project name</param>
		/// <param name="planId">ID of the test plan that contains the suites.</param>
		...
		/// <param name="api_version">Version of the API to use.  This should be set to '6.0-preview.1' to use this version of the api.</param>
		/// <param name="requestBody">Parameters for suite updation</param>
		/// <returns>successful operation</returns>
		public async Task<TestSuite> Test__Suites_UpdateAsync(string organization, string project, int planId, int suiteId, string api_version, TestSuiteUpdateParams requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/"+planId+"/suites/"+suiteId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="requestBody">Parameters for suite updation</param>
		/// <returns>successful operation</returns>
		public TestSuite Test__Suites_Update(string organization, string project, int planId, int suiteId, string api_version, TestSuiteUpdateParams requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/"+planId+"/suites/"+suiteId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/"+planId+"/Suites/"+suiteId+"/TestCase&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// Suite_Test_Case_Update {organization}/{project}/_apis/testplan/Plans/{planId}/Suites/{suiteId}/TestCase
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="project">Project ID or project name</param>
		...
		/// <param name="api_version">Version of the API to use.  This should be set to '6.0-preview.2' to use this version of the api.</param>
		/// <param name="requestBody">A SuiteTestCaseCreateUpdateParameters object.</param>
		/// <returns>successful operation</returns>
		public async Task<TestCase[]> Suite_Test_Case_UpdateAsync(string organization, string project, int planId, int suiteId, string api_version, SuiteTestCaseCreateUpdateParameters[] requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/"+planId+"/Suites/"+suiteId+"/TestCase&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="requestBody">A SuiteTestCaseCreateUpdateParameters object.</param>
		/// <returns>successful operation</returns>
		public TestCase[] Suite_Test_Case_Update(string organization, string project, int planId, int suiteId, string api_version, SuiteTestCaseCreateUpdateParameters[] requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/"+planId+"/Suites/"+suiteId+"/TestCase&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// Test_Point_Update {organization}/{project}/_apis/testplan/Plans/{planId}/Suites/{suiteId}/TestPoint
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="project">Project ID or project name</param>
		/// <param name="planId">ID of the test plan for which test points are requested.</param>
		...
		/// <param name="returnIdentityRef">If set to true, returns the AssignedTo field in TestCaseReference as IdentityRef object.</param>
		/// <param name="api_version">Version of the API to use.  This should be set to '6.0-preview.2' to use this version of the api.</param>
		/// <param name="requestBody">A TestPointUpdateParams Object.</param>
		/// <returns>successful operation</returns>
		public async Task<TestPoint[]> Test_Point_UpdateAsync(string organization, string project, int planId, int suiteId, bool includePointDetails, bool returnIdentityRef, string api_version, TestPointUpdateParams[] requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/"+planId+"/Suites/"+suiteId+"/TestPoint&includePointDetails="+includePointDetails+"&returnIdentityRef="+returnIdentityRef+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// <param name="requestBody">A TestPointUpdateParams Object.</param>
		/// <returns>successful operation</returns>
		public TestPoint[] Test_Point_Update(string organization, string project, int planId, int suiteId, bool includePointDetails, bool returnIdentityRef, string api_version, TestPointUpdateParams[] requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/"+planId+"/Suites/"+suiteId+"/TestPoint&includePointDetails="+includePointDetails+"&returnIdentityRef="+returnIdentityRef+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Plans/CloneOperation&deepClone="+deepClone+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// Test__Suite__Entry_Reorder_Suite_Entries {organization}/{project}/_apis/testplan/suiteentry/{suiteId}
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="project">Project ID or project name</param>
		/// <param name="suiteId">Id of the parent test suite.</param>
		/// <param name="api_version">Version of the API to use.  This should be set to '6.0-preview.1' to use this version of the api.</param>
		/// <param name="requestBody">List of SuiteEntry to reorder.</param>
		/// <returns>successful operation</returns>
		public async Task<SuiteEntry[]> Test__Suite__Entry_Reorder_Suite_EntriesAsync(string organization, string project, int suiteId, string api_version, SuiteEntryUpdateParams[] requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/suiteentry/"+suiteId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// <param name="requestBody">List of SuiteEntry to reorder.</param>
		/// <returns>successful operation</returns>
		public SuiteEntry[] Test__Suite__Entry_Reorder_Suite_Entries(string organization, string project, int suiteId, string api_version, SuiteEntryUpdateParams[] requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/suiteentry/"+suiteId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/Suites/CloneOperation&deepClone="+deepClone+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/variables&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// Variables_Update {organization}/{project}/_apis/testplan/variables/{testVariableId}
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="project">Project ID or project name</param>
		...
		/// <param name="requestBody">TestVariableCreateUpdateParameters</param>
		/// <returns>successful operation</returns>
		public async Task<TestVariable> Variables_UpdateAsync(string organization, string project, int testVariableId, string api_version, TestVariableCreateUpdateParameters requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/variables/"+testVariableId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="requestBody">TestVariableCreateUpdateParameters</param>
		/// <returns>successful operation</returns>
		public TestVariable Variables_Update(string organization, string project, int testVariableId, string api_version, TestVariableCreateUpdateParameters requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/_apis/testplan/variables/"+testVariableId+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
