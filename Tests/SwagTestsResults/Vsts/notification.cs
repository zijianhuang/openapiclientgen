...
namespace MyNS
{
	...
	public class BatchNotificationOperation
	{
		...
		public System.Nullable<BatchNotificationOperationNotificationOperation> NotificationOperation { get; set; }
	...
	public class EventBatch
	{
		...
		public System.Collections.Generic.Dictionary<string, int> EventCounts { get; set; }
		
		public string EventIds { get; set; }
		
		public System.Collections.Generic.Dictionary<string, int> NotificationCounts { get; set; }
		...
		public System.Collections.Generic.Dictionary<string, int> SubscriptionCounts { get; set; }
	}
	...
	public class EventTransformRequest
	{
		...
		/// System inputs.
		/// </summary>
		public System.Collections.Generic.Dictionary<string, string> SystemInputs { get; set; }
	}
	...
	public class NotificationAdminSettings
	{
		...
		/// </summary>
		public System.Nullable<NotificationAdminSettingsDefaultGroupDeliveryPreference> DefaultGroupDeliveryPreference { get; set; }
	}
	...
	public class NotificationAdminSettingsUpdateParameters
	{
		...
		public System.Nullable<NotificationAdminSettingsUpdateParametersDefaultGroupDeliveryPreference> DefaultGroupDeliveryPreference { get; set; }
	}
	...
	public class NotificationEventFieldType
	{
		...
		public System.Nullable<NotificationEventFieldTypeSubscriptionFieldType> SubscriptionFieldType { get; set; }
	...
	public class NotificationReason
	{
		...
		public System.Nullable<NotificationReasonNotificationReasonType> NotificationReasonType { get; set; }
	...
	public class NotificationStatistic
	{
		...
		public System.Nullable<NotificationStatisticType> Type { get; set; }
	...
	public class NotificationStatisticsQueryConditions
	{
		...
		public System.Nullable<NotificationStatisticsQueryConditionsType> Type { get; set; }
	...
	public class NotificationSubscriber
	{
		...
		/// </summary>
		public System.Nullable<NotificationSubscriberDeliveryPreference> DeliveryPreference { get; set; }
		
		public System.Nullable<NotificationSubscriberFlags> Flags { get; set; }
	...
	public class NotificationSubscriberUpdateParameters
	{
		...
		/// </summary>
		public System.Nullable<NotificationSubscriberUpdateParametersDeliveryPreference> DeliveryPreference { get; set; }
	...
	public class NotificationSubscription
	{
		...
		/// </summary>
		public System.Nullable<NotificationSubscriptionFlags> Flags { get; set; }
		...
		/// </summary>
		public System.Nullable<NotificationSubscriptionPermissions> Permissions { get; set; }
		...
		/// </summary>
		public System.Nullable<NotificationSubscriptionStatus> Status { get; set; }
	...
	public class NotificationSubscriptionTemplate
	{
		...
		public System.Nullable<NotificationSubscriptionTemplateType> Type { get; set; }
	}
	...
	public class NotificationSubscriptionUpdateParameters
	{
		...
		/// </summary>
		public System.Nullable<NotificationSubscriptionUpdateParametersStatus> Status { get; set; }
	...
	public class SubscriptionEvaluationResult
	{
		...
		/// </summary>
		public System.Nullable<SubscriptionEvaluationResultEvaluationJobStatus> EvaluationJobStatus { get; set; }
	...
	public class SubscriptionQuery
	{
		...
		/// </summary>
		public System.Nullable<SubscriptionQueryQueryFlags> QueryFlags { get; set; }
	}
	...
	public class SubscriptionQueryCondition
	{
		...
		/// </summary>
		public System.Nullable<SubscriptionQueryConditionFlags> Flags { get; set; }
	...
	public partial class MyClient
	{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/diagnosticlogs/"+ (source==null? "" : System.Uri.EscapeDataString(source))+"/entries/"+ (entryId==null? "" : System.Uri.EscapeDataString(entryId))+"&startTime=" + startTime.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss.fffffffZ")+"&endTime=" + endTime.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss.fffffffZ")+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/eventtypes&publisherId=" + (publisherId==null? "" : System.Uri.EscapeDataString(publisherId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/eventtypes/"+ (eventType==null? "" : System.Uri.EscapeDataString(eventType))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/settings&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/subscribers/"+ (subscriberId==null? "" : System.Uri.EscapeDataString(subscriberId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/subscriptionquery&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/subscriptions&targetId=" + (targetId==null? "" : System.Uri.EscapeDataString(targetId))+"&ids=" + (ids==null? "" : System.Uri.EscapeDataString(ids))+"&queryFlags=" + queryFlags+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/subscriptions&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"&queryFlags=" + queryFlags+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/diagnostics&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/Subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/usersettings/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/notification/subscriptiontemplates&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
