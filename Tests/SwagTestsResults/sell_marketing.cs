...
namespace MyNS
{
	...
	public partial class MyClient
	{
		...
		/// <param name="requestBody">This type defines the fields for the bulkCreateAdsByInventoryReference request.</param>
		/// <returns>Success</returns>
		public async Task<BulkCreateAdsByInventoryReferenceResponse> BulkCreateAdsByInventoryReferenceAsync(string campaign_id, BulkCreateAdsByInventoryReferenceRequest requestBody)
		{
			...
			try
			{
				...
				return serializer.Deserialize<BulkCreateAdsByInventoryReferenceResponse>(jsonReader);
			}
			finally
			{
		...
		/// <param name="requestBody">This type defines the fields for the bulkCreateAdsByInventoryReference request.</param>
		/// <returns>Success</returns>
		public BulkCreateAdsByInventoryReferenceResponse BulkCreateAdsByInventoryReference(string campaign_id, BulkCreateAdsByInventoryReferenceRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/bulk_create_ads_by_inventory_reference";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<BulkAdResponse> BulkCreateAdsByListingIdAsync(string campaign_id, BulkCreateAdRequest requestBody)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<BulkAdResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">The container for the bulk request to create ads for eBay listing IDs. eBay listing IDs are generated when the listing is created on eBay. Note: This request accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).</param>
		/// <returns>Success</returns>
		public BulkAdResponse BulkCreateAdsByListingId(string campaign_id, BulkCreateAdRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/bulk_create_ads_by_listing_id";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for a bulkDeleteAdsByInventoryReference request.</param>
		/// <returns>Success</returns>
		public async Task<BulkDeleteAdsByInventoryReferenceResponse> BulkDeleteAdsByInventoryReferenceAsync(string campaign_id, BulkDeleteAdsByInventoryReferenceRequest requestBody)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<BulkDeleteAdsByInventoryReferenceResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">This type defines the fields for a bulkDeleteAdsByInventoryReference request.</param>
		/// <returns>Success</returns>
		public BulkDeleteAdsByInventoryReferenceResponse BulkDeleteAdsByInventoryReference(string campaign_id, BulkDeleteAdsByInventoryReferenceRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/bulk_delete_ads_by_inventory_reference";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for the bulkDeleteAdsByListingId request.</param>
		/// <returns>Success</returns>
		public async Task<BulkDeleteAdResponse> BulkDeleteAdsByListingIdAsync(string campaign_id, BulkDeleteAdRequest requestBody)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<BulkDeleteAdResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">This type defines the fields for the bulkDeleteAdsByListingId request.</param>
		/// <returns>Success</returns>
		public BulkDeleteAdResponse BulkDeleteAdsByListingId(string campaign_id, BulkDeleteAdRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/bulk_delete_ads_by_listing_id";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="requestBody">This type defines the fields for the BulkCreateAdsByInventoryReference request.</param>
		/// <returns>Success</returns>
		public async Task<BulkCreateAdsByInventoryReferenceResponse> BulkUpdateAdsBidByInventoryReferenceAsync(string campaign_id, BulkCreateAdsByInventoryReferenceRequest requestBody)
		{
		...
		/// <param name="requestBody">This type defines the fields for the BulkCreateAdsByInventoryReference request.</param>
		/// <returns>Success</returns>
		public BulkCreateAdsByInventoryReferenceResponse BulkUpdateAdsBidByInventoryReference(string campaign_id, BulkCreateAdsByInventoryReferenceRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/bulk_update_ads_bid_by_inventory_reference";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">Container for the bulk request to update ads.</param>
		/// <returns>Success</returns>
		public async Task<BulkAdResponse> BulkUpdateAdsBidByListingIdAsync(string campaign_id, BulkCreateAdRequest requestBody)
		{
		...
		/// <param name="requestBody">Container for the bulk request to update ads.</param>
		/// <returns>Success</returns>
		public BulkAdResponse BulkUpdateAdsBidByListingId(string campaign_id, BulkCreateAdRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/bulk_update_ads_bid_by_listing_id";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<AdPagedCollection> GetAdsAsync(string campaign_id, string limit, string listing_ids, string offset)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/ad&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&listing_ids=" + (listing_ids==null? "" : System.Uri.EscapeDataString(listing_ids))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset));
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<AdPagedCollection>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="offset">Specifies the number of ads to skip in the result set before returning the first ad in the paginated response. Combine offset with the limit query parameter to control the items returned in the response. For example, if you supply an offset of 0 and a limit of 10, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If offset is 10 and limit is 20, the first page of the response contains items 11-30 from the complete result set. Default: 0</param>
		/// <returns>Success</returns>
		public AdPagedCollection GetAds(string campaign_id, string limit, string listing_ids, string offset)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/ad&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&listing_ids=" + (listing_ids==null? "" : System.Uri.EscapeDataString(listing_ids))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for the createAd request.</param>
		public async Task CreateAdByListingIdAsync(string campaign_id, CreateAdRequest requestBody)
		{
		...
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for the createAd request.</param>
		public void CreateAdByListingId(string campaign_id, CreateAdRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/ad";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for the createAdsByInventoryReference request.</param>
		public async Task CreateAdsByInventoryReferenceAsync(string campaign_id, CreateAdsByInventoryReferenceRequest requestBody)
		{
		...
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for the createAdsByInventoryReference request.</param>
		public void CreateAdsByInventoryReference(string campaign_id, CreateAdsByInventoryReferenceRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/create_ads_by_inventory_reference";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <returns>Success</returns>
		public async Task<Ad> GetAdAsync(string ad_id, string campaign_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<Ad>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="ad_id">Identifier of an ad. This ID was generated when the ad was created.</param>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		public async Task DeleteAdAsync(string ad_id, string campaign_id)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/ad/"+ (ad_id==null? "" : System.Uri.EscapeDataString(ad_id));
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for the deleteAdsByInventoryReference request.</param>
		/// <returns>Success</returns>
		public async Task<AdIds> DeleteAdsByInventoryReferenceAsync(string campaign_id, DeleteAdsByInventoryReferenceRequest requestBody)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<AdIds>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">This type defines the fields for the deleteAdsByInventoryReference request.</param>
		/// <returns>Success</returns>
		public AdIds DeleteAdsByInventoryReference(string campaign_id, DeleteAdsByInventoryReferenceRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/delete_ads_by_inventory_reference";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<Ads> GetAdsByInventoryReferenceAsync(string campaign_id, string inventory_reference_id, string inventory_reference_type)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<Ads>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for the updateBid request.</param>
		public async Task UpdateBidAsync(string ad_id, string campaign_id, UpdateBidPercentageRequest requestBody)
		{
		...
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for the updateBid request.</param>
		public void UpdateBid(string ad_id, string campaign_id, UpdateBidPercentageRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/ad/"+ (ad_id==null? "" : System.Uri.EscapeDataString(ad_id))+"/update_bid";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		public async Task CloneCampaignAsync(string campaign_id, CloneCampaignRequest requestBody)
		{
		...
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields for a clone campaign request.</param>
		public void CloneCampaign(string campaign_id, CloneCampaignRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/clone";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<CampaignPagedCollection> GetCampaignsAsync(string campaign_name, string campaign_status, string end_date_range, string limit, string offset, string start_date_range)
		{
			var requestUri = "ad_campaign?campaign_name=" + (campaign_name==null? "" : System.Uri.EscapeDataString(campaign_name))+"&campaign_status=" + (campaign_status==null? "" : System.Uri.EscapeDataString(campaign_status))+"&end_date_range=" + (end_date_range==null? "" : System.Uri.EscapeDataString(end_date_range))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&start_date_range=" + (start_date_range==null? "" : System.Uri.EscapeDataString(start_date_range));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<CampaignPagedCollection>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="start_date_range">Specifies the range of a campaign's start date in which to filter the results. The results are filtered to include only campaigns with a start date that is equal to this date or is within specified range. Valid format (UTC): &nbsp;&nbsp;&nbsp;&nbsp;yyyy-MM-ddThh:mm:ssZ..yyyy-MM-ddThh:mm:ssZ&nbsp;&nbsp; (starts within this range) &nbsp;&nbsp;&nbsp;&nbsp;yyyy-MM-ddThh:mm:ssZ..&nbsp;&nbsp;(campaign starts on or after this date) &nbsp;&nbsp;&nbsp;&nbsp;..yyyy-MM-ddThh:mm:ssZ&nbsp;&nbsp; (campaign starts on or before this date) &nbsp;&nbsp;&nbsp;&nbsp;2016-09-08T00:00.00.000Z..2016-09-09T00:00:00Z&nbsp;&nbsp; (campaign starts on September 8, 2016) Note: The results might not include all the campaigns with this start date if other filters exclude them.</param>
		/// <returns>Success</returns>
		public CampaignPagedCollection GetCampaigns(string campaign_name, string campaign_status, string end_date_range, string limit, string offset, string start_date_range)
		{
			var requestUri = "ad_campaign?campaign_name=" + (campaign_name==null? "" : System.Uri.EscapeDataString(campaign_name))+"&campaign_status=" + (campaign_status==null? "" : System.Uri.EscapeDataString(campaign_status))+"&end_date_range=" + (end_date_range==null? "" : System.Uri.EscapeDataString(end_date_range))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&start_date_range=" + (start_date_range==null? "" : System.Uri.EscapeDataString(start_date_range));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		public async Task CreateCampaignAsync(CreateCampaignRequest requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">This type defines the fields for the create campaign request.</param>
		public void CreateCampaign(CreateCampaignRequest requestBody)
		{
			var requestUri = "ad_campaign";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <returns>Success</returns>
		public async Task<Campaign> GetCampaignAsync(string campaign_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<Campaign>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		public async Task DeleteCampaignAsync(string campaign_id)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		public async Task EndCampaignAsync(string campaign_id)
		{
		...
		/// <returns>Success</returns>
		public async Task<Campaigns> FindCampaignByAdReferenceAsync(string inventory_reference_id, string inventory_reference_type, string listing_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<Campaigns>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="listing_id">Identifier of the eBay listing associated with the ad.</param>
		/// <returns>Success</returns>
		public Campaigns FindCampaignByAdReference(string inventory_reference_id, string inventory_reference_type, string listing_id)
		{
			var requestUri = "ad_campaign/find_campaign_by_ad_reference?inventory_reference_id=" + (inventory_reference_id==null? "" : System.Uri.EscapeDataString(inventory_reference_id))+"&inventory_reference_type=" + (inventory_reference_type==null? "" : System.Uri.EscapeDataString(inventory_reference_type))+"&listing_id=" + (listing_id==null? "" : System.Uri.EscapeDataString(listing_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// <returns>Success</returns>
		public async Task<Campaign> GetCampaignByNameAsync(string campaign_name)
		{
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		public async Task PauseCampaignAsync(string campaign_id)
		{
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		public async Task ResumeCampaignAsync(string campaign_id)
		{
		...
		/// </summary>
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields to updated the campaign name and start and end dates.</param>
		public async Task UpdateCampaignIdentificationAsync(string campaign_id, UpdateCampaignIdentificationRequest requestBody)
		{
		...
		/// <param name="campaign_id">A unique eBay-assigned ID for an ad campaign that's generated when a campaign is created. Get a seller's campaign IDs by calling getCampaigns.</param>
		/// <param name="requestBody">This type defines the fields to updated the campaign name and start and end dates.</param>
		public void UpdateCampaignIdentification(string campaign_id, UpdateCampaignIdentificationRequest requestBody)
		{
			var requestUri = "ad_campaign/"+ (campaign_id==null? "" : System.Uri.EscapeDataString(campaign_id))+"/update_campaign_identification";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task GetReportAsync(string report_id)
		{
		...
		/// <param name="report_id">The unique ID of the Promoted Listings report you want to get. This ID is generated by eBay when you run a report task with a call to createReportTask. Get all the seller's report IDs by calling getReportTasks.</param>
		/// <returns>Success</returns>
		public void GetReport(string report_id)
		{
			var requestUri = "ad_report/"+ (report_id==null? "" : System.Uri.EscapeDataString(report_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task<ReportMetadatas> GetReportMetadataAsync()
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ReportMetadatas>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>Success</returns>
		public async Task<ReportMetadata> GetReportMetadataForReportTypeAsync(string report_type)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ReportMetadata>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>Success</returns>
		public async Task<ReportTaskPagedCollection> GetReportTasksAsync(string limit, string offset, string report_task_statuses)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ReportTaskPagedCollection>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="report_task_statuses">This parameter filters the returned report tasks by their status. Supply a comma-separated list of the report statuses you want returned. The results are filtered to include only the report statuses you specify. Note: The results might not include some report tasks if other search conditions exclude them. Valid values: &nbsp;&nbsp;&nbsp;PENDING &nbsp;&nbsp;&nbsp;SUCCESS &nbsp;&nbsp;&nbsp;FAILED</param>
		/// <returns>Success</returns>
		public ReportTaskPagedCollection GetReportTasks(string limit, string offset, string report_task_statuses)
		{
			var requestUri = "ad_report_task?limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&report_task_statuses=" + (report_task_statuses==null? "" : System.Uri.EscapeDataString(report_task_statuses));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		public async Task CreateReportTaskAsync(CreateReportTask requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">The container for the fields that define the report task.</param>
		public void CreateReportTask(CreateReportTask requestBody)
		{
			var requestUri = "ad_report_task";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<ReportTask> GetReportTaskAsync(string report_task_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ReportTask>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="report_task_id">A unique eBay-assigned ID for the report task that's generated when the report task is created by a call to createReportTask.</param>
		public async Task DeleteReportTaskAsync(string report_task_id)
		{
			var requestUri = "ad_report_task/"+ (report_task_id==null? "" : System.Uri.EscapeDataString(report_task_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		public async Task CreateItemPriceMarkdownPromotionAsync(ItemPriceMarkdown requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">This type defines the fields that describe an item price markdown promotion.</param>
		public void CreateItemPriceMarkdownPromotion(ItemPriceMarkdown requestBody)
		{
			var requestUri = "item_price_markdown";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<ItemPriceMarkdown> GetItemPriceMarkdownPromotionAsync(string promotion_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ItemPriceMarkdown>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">This type defines the fields that describe an item price markdown promotion.</param>
		/// <returns>Success</returns>
		public async Task<string> UpdateItemPriceMarkdownPromotionAsync(string promotion_id, ItemPriceMarkdown requestBody)
		{
			var requestUri = "item_price_markdown/"+ (promotion_id==null? "" : System.Uri.EscapeDataString(promotion_id));
		...
		/// <param name="requestBody">This type defines the fields that describe an item price markdown promotion.</param>
		/// <returns>Success</returns>
		public string UpdateItemPriceMarkdownPromotion(string promotion_id, ItemPriceMarkdown requestBody)
		{
			var requestUri = "item_price_markdown/"+ (promotion_id==null? "" : System.Uri.EscapeDataString(promotion_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		public async Task DeleteItemPriceMarkdownPromotionAsync(string promotion_id)
		{
			var requestUri = "item_price_markdown/"+ (promotion_id==null? "" : System.Uri.EscapeDataString(promotion_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		public async Task CreateItemPromotionAsync(ItemPromotion requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">This type defines the fields that describe an item promotion.</param>
		public void CreateItemPromotion(ItemPromotion requestBody)
		{
			var requestUri = "item_promotion";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="promotion_id">The ID of the promotion you want to retrieve. The promotion ID is a unique eBay-assigned value that's generated when the promotion is created.</param>
		/// <returns>Success</returns>
		public async Task<ItemPromotionResponse> GetItemPromotionAsync(string promotion_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ItemPromotionResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="requestBody">This type defines the fields that describe an item promotion.</param>
		/// <returns>Success</returns>
		public async Task<BaseResponse> UpdateItemPromotionAsync(string promotion_id, ItemPromotion requestBody)
		{
			var requestUri = "item_promotion/"+ (promotion_id==null? "" : System.Uri.EscapeDataString(promotion_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="requestBody">This type defines the fields that describe an item promotion.</param>
		/// <returns>Success</returns>
		public BaseResponse UpdateItemPromotion(string promotion_id, ItemPromotion requestBody)
		{
			var requestUri = "item_promotion/"+ (promotion_id==null? "" : System.Uri.EscapeDataString(promotion_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// </summary>
		/// <param name="promotion_id">The ID of the promotion you want to delete. The promotion ID is a unique eBay-assigned value that's generated when the promotion is created.</param>
		public async Task DeleteItemPromotionAsync(string promotion_id)
		{
			var requestUri = "item_promotion/"+ (promotion_id==null? "" : System.Uri.EscapeDataString(promotion_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
		...
		public async Task GetListingSetAsync(string limit, string offset, string promotion_id, string q, string sort, string status)
		{
		...
		/// <param name="sort">Specifies the order in which to sort the associated listings in the response. If you precede the supplied value with a dash, the response is sorted in reverse order. Example: &nbsp;&nbsp;&nbsp;sort=PRICE - Sorts the associated listings by their current price in ascending order &nbsp;&nbsp;&nbsp;sort=-TITLE - Sorts the associated listings by their title in descending alphabetical order (Z-Az-a) Valid values: AVAILABLE PRICE TITLE For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/marketing/types/SortField.html</param>
		/// <param name="status">This query parameter applies only to markdown promotions. It filters the response based on the indicated status of the promotion. Currently, the only supported value for this parameter is MARKED_DOWN, which indicates active markdown promotions. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/marketing/types/ItemMarkdownStatusEnum.html</param>
		public void GetListingSet(string limit, string offset, string promotion_id, string q, string sort, string status)
		{
			var requestUri = "promotion/"+ (promotion_id==null? "" : System.Uri.EscapeDataString(promotion_id))+"/get_listing_set?limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&q=" + (q==null? "" : System.Uri.EscapeDataString(q))+"&sort=" + (sort==null? "" : System.Uri.EscapeDataString(sort))+"&status=" + (status==null? "" : System.Uri.EscapeDataString(status));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// <returns>Success</returns>
		public async Task<PromotionsPagedCollection> GetPromotionsAsync(string limit, string marketplace_id, string offset, string promotion_status, string promotion_type, string q, string sort)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<PromotionsPagedCollection>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="sort">Specifies the order for how to sort the response. If you precede the supplied value with a dash, the response is sorted in reverse order. Example: &nbsp;&nbsp;&nbsp;sort=END_DATE &nbsp; Sorts the promotions in the response by their end dates in ascending order &nbsp;&nbsp;&nbsp;sort=-PROMOTION_NAME &nbsp; Sorts the promotions by their promotion name in descending alphabetical order (Z-Az-a) Valid values: START_DATE END_DATE PROMOTION_NAME For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/marketing/types/SortField.html</param>
		/// <returns>Success</returns>
		public PromotionsPagedCollection GetPromotions(string limit, string marketplace_id, string offset, string promotion_status, string promotion_type, string q, string sort)
		{
			var requestUri = "promotion?limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&marketplace_id=" + (marketplace_id==null? "" : System.Uri.EscapeDataString(marketplace_id))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&promotion_status=" + (promotion_status==null? "" : System.Uri.EscapeDataString(promotion_status))+"&promotion_type=" + (promotion_type==null? "" : System.Uri.EscapeDataString(promotion_type))+"&q=" + (q==null? "" : System.Uri.EscapeDataString(q))+"&sort=" + (sort==null? "" : System.Uri.EscapeDataString(sort));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		public async Task PausePromotionAsync(string promotion_id)
		{
		...
		public async Task ResumePromotionAsync(string promotion_id)
		{
		...
		/// <param name="q">A string consisting of one or more keywords. eBay filters the response by returning only the promotions that contain the supplied keywords in the promotion title. Example: &quot;iPhone&quot; or &quot;Harry Potter.&quot; Commas that separate keywords are ignored. For example, a keyword string of &quot;iPhone, iPad&quot; equals &quot;iPhone iPad&quot;, and each results in a response that contains promotions with both &quot;iPhone&quot; and &quot;iPad&quot; in the title.</param>
		/// <returns>Success</returns>
		public async Task<PromotionsReportPagedCollection> GetPromotionReportsAsync(string limit, string marketplace_id, string offset, string promotion_status, string promotion_type, string q)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<PromotionsReportPagedCollection>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="q">A string consisting of one or more keywords. eBay filters the response by returning only the promotions that contain the supplied keywords in the promotion title. Example: &quot;iPhone&quot; or &quot;Harry Potter.&quot; Commas that separate keywords are ignored. For example, a keyword string of &quot;iPhone, iPad&quot; equals &quot;iPhone iPad&quot;, and each results in a response that contains promotions with both &quot;iPhone&quot; and &quot;iPad&quot; in the title.</param>
		/// <returns>Success</returns>
		public PromotionsReportPagedCollection GetPromotionReports(string limit, string marketplace_id, string offset, string promotion_status, string promotion_type, string q)
		{
			var requestUri = "promotion_report?limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&marketplace_id=" + (marketplace_id==null? "" : System.Uri.EscapeDataString(marketplace_id))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&promotion_status=" + (promotion_status==null? "" : System.Uri.EscapeDataString(promotion_status))+"&promotion_type=" + (promotion_type==null? "" : System.Uri.EscapeDataString(promotion_type))+"&q=" + (q==null? "" : System.Uri.EscapeDataString(q));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// <returns>Success</returns>
		public async Task<SummaryReportResponse> GetPromotionSummaryReportAsync(string marketplace_id)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<SummaryReportResponse>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
