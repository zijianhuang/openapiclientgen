...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<PlayByPlay> PlayByPlayAsync(PlayByPlayFormat format, string season, string week, string hometeam)
		{
		...
		///        </param>
		public async Task<PlayByPlay[]> PlayByPlayDeltaAsync(PlayByPlayFormat format, string season, string week, string minutes)
		{
		...
		public async Task<PlayByPlay[]> PlayByPlaySimulationAsync(PlayByPlayFormat format, string numberofplays)
		{
