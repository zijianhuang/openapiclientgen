...
namespace MyNS
{
	...
	public class AvailabilityStatusProperties
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="occurredTime")]
		public System.Nullable<System.DateTimeOffset> OccurredTime { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="recentlyResolved")]
		public AvailabilityStatusPropertiesRecentlyResolved RecentlyResolved { get; set; }
	...
	public class event_
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="properties")]
		public event_Properties Properties { get; set; }
	}
	...
	public class event_Properties
	{
		...
		public event_PropertiesArticle Article { get; set; }
		
		/// <summary>
		/// Tells if we want to enable or disable Microsoft Support for this event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="enableChatWithUs")]
		public System.Nullable<System.Boolean> EnableChatWithUs { get; set; }
		
		/// <summary>
		/// Tells if we want to enable or disable Microsoft Support for this event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="enableMicrosoftSupport")]
		public System.Nullable<System.Boolean> EnableMicrosoftSupport { get; set; }
		
		/// <summary>
		/// Level of event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="eventLevel")]
		public System.Nullable<event_PropertiesEventLevel> EventLevel { get; set; }
		
		/// <summary>
		/// Source of event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="eventSource")]
		public System.Nullable<event_PropertiesEventSource> EventSource { get; set; }
		
		/// <summary>
		/// Type of event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="eventType")]
		public System.Nullable<event_PropertiesEventType> EventType { get; set; }
		
		/// <summary>
		/// Frequently asked questions for the service health event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="faqs")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="hirStage")]
		public string HirStage { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="impactMitigationTime")]
		public System.Nullable<System.DateTimeOffset> ImpactMitigationTime { get; set; }
		
		/// <summary>
		/// It provides the Timestamp for when the health impacting event started.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="impactStartTime")]
		public System.Nullable<System.DateTimeOffset> ImpactStartTime { get; set; }
		
		/// <summary>
		/// It provides information if the event is High incident rate event or not.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="isHIR")]
		public System.Nullable<System.Boolean> IsHIR { get; set; }
		...
		public System.Nullable<event_PropertiesLevel> Level { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="recommendedActions")]
		public event_PropertiesRecommendedActions RecommendedActions { get; set; }
		
		/// <summary>
		/// Current status of event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public ImpactedServiceRegionStatus Status { get; set; }
	...
	public class event_PropertiesArticle
	{
		
		/// <summary>
		/// Article content of event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="articleContent")]
		public string ArticleContent { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum event_PropertiesEventLevel
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum event_PropertiesEventSource
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum event_PropertiesEventType
	{
	...
	public class Faq
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="localeCode")]
	...
	public class Impact
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="impactedRegions")]
		public ImpactedServiceRegion[] ImpactedRegions { get; set; }
		
		/// <summary>
		/// Impacted service name.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="impactedService")]
	...
	public class ImpactedServiceRegion
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="impactedRegion")]
		public string ImpactedRegion { get; set; }
		
		/// <summary>
		/// List subscription impacted by the service health event.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="impactedSubscriptions")]
		public string[] ImpactedSubscriptions { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public System.Nullable<ImpactedServiceRegionStatus> Status { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum ImpactedServiceRegionStatus
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/01")]
	public enum event_PropertiesLevel
	{
	...
	public class Link
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="bladeName")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="extensionName")]
	...
	public class event_PropertiesRecommendedActions
	{
		...
		public event_PropertiesRecommendedActionsActions[] event_PropertiesRecommendedActionsActions { get; set; }
	...
	public class event_PropertiesRecommendedActionsActions
	{
	...
	public partial class Misc
	{
		...
		public async Task<EmergingIssueListResult> EmergingIssues_ListAsync(string api_version)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<EmergingIssueListResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		public async Task<EmergingIssuesGetResult> EmergingIssues_GetAsync(EmergingIssues_GetIssueName issueName, string api_version)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<EmergingIssuesGetResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="api_version">Client Api Version.</param>
		/// <returns>The list of available operations for the resourcehealth resource provider</returns>
		...
		/// <returns>The list of current availability status for all the resources in the subscription</returns>
		public async Task<AvailabilityStatusListResult> AvailabilityStatuses_ListBySubscriptionIdAsync(string api_version, string filter, string subscriptionId, string expand)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AvailabilityStatusListResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Events_ListBySubscriptionId subscriptions/{subscriptionId}/providers/Microsoft.ResourceHealth/events
		/// </summary>
		/// <param name="api_version">Client Api Version.</param>
		/// <param name="filter">The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN</param>
		/// <param name="subscriptionId">Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
		/// <param name="view">setting view=full expands the article parameters</param>
		/// <returns>The list of current service health events in the subscription</returns>
		public async Task<Events> Events_ListBySubscriptionIdAsync(string api_version, string filter, string subscriptionId, string view)
		{
			var requestUri = "subscriptions/"+ (subscriptionId==null? "" : System.Uri.EscapeDataString(subscriptionId))+"/providers/Microsoft.ResourceHealth/events?api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version))+"&$filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&view=" + (view==null? "" : System.Uri.EscapeDataString(view));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Events>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="filter">The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN</param>
		/// <param name="expand">Setting $expand=recommendedactions in url query expands the recommendedactions in the response.</param>
		/// <returns>The list of current availability status for all the resources in the resource group</returns>
		...
		/// <param name="filter">The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN</param>
		/// <param name="expand">Setting $expand=recommendedactions in url query expands the recommendedactions in the response.</param>
		/// <returns>The list of historical availability statuses for a single resource</returns>
		...
		/// <param name="filter">The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN</param>
		/// <param name="expand">Setting $expand=recommendedactions in url query expands the recommendedactions in the response.</param>
		/// <returns>The current availability status for a single resource</returns>
		public async Task<AvailabilityStatus> AvailabilityStatuses_GetByResourceAsync(string resourceUri, string api_version, string filter, string expand)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AvailabilityStatus>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Events_ListBySingleResource {resourceUri}/providers/Microsoft.ResourceHealth/events
		/// </summary>
		/// <param name="resourceUri">The fully qualified ID of the resource, including the resource name and resource type. Currently the API support not nested and one nesting level resource types : /subscriptions/{subscriptionId}/resourceGroups/{resource-group-name}/providers/{resource-provider-name}/{resource-type}/{resource-name} and /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resource-provider-name}/{parentResourceType}/{parentResourceName}/{resourceType}/{resourceName}</param>
		/// <param name="api_version">Client Api Version.</param>
		/// <param name="filter">The filter to apply on the operation. For more information please see https://docs.microsoft.com/en-us/rest/api/apimanagement/apis?redirectedfrom=MSDN</param>
		/// <param name="view">setting view=full expands the article parameters</param>
		/// <returns>The list of current service health events for given resource</returns>
		public async Task<Events> Events_ListBySingleResourceAsync(string resourceUri, string api_version, string filter, string view)
		{
			var requestUri = ""+ (resourceUri==null? "" : System.Uri.EscapeDataString(resourceUri))+"/providers/Microsoft.ResourceHealth/events&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version))+"&$filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&view=" + (view==null? "" : System.Uri.EscapeDataString(view));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
