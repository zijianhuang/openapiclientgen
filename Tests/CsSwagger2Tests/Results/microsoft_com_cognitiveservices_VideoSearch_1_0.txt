...
namespace MyNS
{
	...
	public class TrendingVideos
	{
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="bannerTiles")]
		public TrendingVideosTile[] BannerTiles { get; set; }
		...
		public TrendingVideosCategory[] Categories { get; set; }
	}
	...
	public class TrendingVideosCategory
	{
		...
		public TrendingVideosSubcategory[] Subcategories { get; set; }
	...
	public class TrendingVideosSubcategory
	{
		...
		public TrendingVideosTile[] Tiles { get; set; }
	...
	public class VideoDetails
	{
		...
		[System.Runtime.Serialization.DataMember(Name="relatedVideos")]
		public VideosModule RelatedVideos { get; set; }
		
		/// <summary>
		/// Defines a video object that is relevant to the query.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="videoResult")]
		public VideoObject VideoResult { get; set; }
	}
	...
	public class Videos
	{
		...
		public System.Nullable<VideosScenario> Scenario { get; set; }
	...
	public partial class Misc
	{
		...
		public async Task<VideoDetails> Videos_DetailsAsync(string cc, string id, string[] modules, string mkt, string q, Videos_DetailsResolution resolution, Videos_DetailsSafeSearch safeSearch, string setLang, bool textDecorations, Videos_DetailsTextFormat textFormat)
		{
			var requestUri = "videos/details?cc=" + (cc==null? "" : System.Uri.EscapeDataString(cc))+"&id=" + (id==null? "" : System.Uri.EscapeDataString(id))+"&"+string.Join("&", modules.Select(z => $"modules={System.Uri.EscapeDataString(z.ToString())}"))+"&mkt=" + (mkt==null? "" : System.Uri.EscapeDataString(mkt))+"&q=" + (q==null? "" : System.Uri.EscapeDataString(q))+"&resolution=" + resolution+"&safeSearch=" + safeSearch+"&setLang=" + (setLang==null? "" : System.Uri.EscapeDataString(setLang))+"&textDecorations="+textDecorations+"&textFormat=" + textFormat;
			...
			try
			{
				...
				return JsonSerializer.Deserialize<VideoDetails>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// <param name="textFormat">The type of markers to use for text decorations (see the textDecorations query parameter). Possible values are Raw—Use Unicode characters to mark content that needs special formatting. The Unicode characters are in the range E000 through E019. For example, Bing uses E000 and E001 to mark the beginning and end of query terms for hit highlighting. HTML—Use HTML tags to mark content that needs special formatting. For example, use <b> tags to highlight query terms in display strings. The default is Raw. For display strings that contain escapable HTML characters such as <, >, and &, if textFormat is set to HTML, Bing escapes the characters as appropriate (for example, < is escaped to &lt;).</param>
		/// <returns>Success.</returns>
		public async Task<Videos> Videos_SearchAsync(string cc, int count, Videos_SearchFreshness freshness, string id, Videos_SearchLength length, string mkt, int offset, Videos_SearchPricing pricing, string q, Videos_DetailsResolution resolution, Videos_DetailsSafeSearch safeSearch, string setLang, bool textDecorations, Videos_DetailsTextFormat textFormat)
		{
			var requestUri = "videos/search?cc=" + (cc==null? "" : System.Uri.EscapeDataString(cc))+"&count="+count+"&freshness=" + freshness+"&id=" + (id==null? "" : System.Uri.EscapeDataString(id))+"&length=" + length+"&mkt=" + (mkt==null? "" : System.Uri.EscapeDataString(mkt))+"&offset="+offset+"&pricing=" + pricing+"&q=" + (q==null? "" : System.Uri.EscapeDataString(q))+"&resolution=" + resolution+"&safeSearch=" + safeSearch+"&setLang=" + (setLang==null? "" : System.Uri.EscapeDataString(setLang))+"&textDecorations="+textDecorations+"&textFormat=" + textFormat;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Videos>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="textFormat">The type of markers to use for text decorations (see the textDecorations query parameter). Possible values are Raw—Use Unicode characters to mark content that needs special formatting. The Unicode characters are in the range E000 through E019. For example, Bing uses E000 and E001 to mark the beginning and end of query terms for hit highlighting. HTML—Use HTML tags to mark content that needs special formatting. For example, use <b> tags to highlight query terms in display strings. The default is Raw. For display strings that contain escapable HTML characters such as <, >, and &, if textFormat is set to HTML, Bing escapes the characters as appropriate (for example, < is escaped to &lt;).</param>
		/// <returns>Success.</returns>
		public async Task<TrendingVideos> Videos_TrendingAsync(string cc, string mkt, Videos_DetailsSafeSearch safeSearch, string setLang, bool textDecorations, Videos_DetailsTextFormat textFormat)
		{
			var requestUri = "videos/trending?cc=" + (cc==null? "" : System.Uri.EscapeDataString(cc))+"&mkt=" + (mkt==null? "" : System.Uri.EscapeDataString(mkt))+"&safeSearch=" + safeSearch+"&setLang=" + (setLang==null? "" : System.Uri.EscapeDataString(setLang))+"&textDecorations="+textDecorations+"&textFormat=" + textFormat;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TrendingVideos>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
	...
	public enum Videos_DetailsX_BingApis_SDK
	{
	...
	public enum Videos_DetailsResolution
	{
	...
	public enum Videos_DetailsSafeSearch
	{
	...
	public enum Videos_DetailsTextFormat
	{
	...
	public enum Videos_SearchX_BingApis_SDK
	{
	...
	public enum Videos_SearchFreshness
	{
	...
	public enum Videos_SearchLength
	{
	...
	public enum Videos_SearchPricing
	{
	...
	public enum Videos_TrendingX_BingApis_SDK
	{
