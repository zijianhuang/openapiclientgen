...
namespace MyNS
{
	...
	public class NodeCounts
	{
		...
		public NodeCount[] Value { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// NodeCountInformation_Get subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/nodecounts/{countType}
		/// </summary>
		...
		public async Task<NodeCounts> NodeCountInformation_GetAsync(string resourceGroupName, string automationAccountName, NodeCountInformation_GetCountType countType, string subscriptionId, string api_version)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<NodeCounts>(streamContent, jsonSerializerSettings);
			}
			finally
			{
	...
	public enum NodeCountInformation_GetCountType
	{
