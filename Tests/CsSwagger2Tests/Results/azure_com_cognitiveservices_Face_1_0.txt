	...
	public partial class Misc
	{
		...
		public async Task<DetectedFace[]> Face_DetectWithUrlAsync(bool returnFaceId, bool returnFaceLandmarks, string[] returnFaceAttributes, DetectedFaceRecognitionModel recognitionModel, bool returnRecognitionModel, Face_DetectWithUrlDetectionModel detectionModel, Face_DetectWithUrlPostBody requestBody)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<DetectedFace[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		public async Task<FaceList[]> FaceList_ListAsync(bool returnRecognitionModel)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<FaceList[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="faceListId">Id referencing a particular face list.
		/// Max length: 64
		// </param>
		/// <param name="returnRecognitionModel">A value indicating whether the operation should return 'recognitionModel' in response.</param>
		...
		/// Max length: 64
		// </param>
		/// <param name="userData">User-specified data about the face for any purpose. The maximum length is 1KB.
		/// Max length: 1024
		// </param>
		...
		public async Task<PersistedFace> FaceList_AddFaceFromUrlAsync(string faceListId, string userData, int[] targetFace, Face_DetectWithUrlDetectionModel detectionModel, FaceList_AddFaceFromUrlPostBody requestBody)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PersistedFace>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<SimilarFace[]> Face_FindSimilarAsync(FindSimilarRequest requestBody)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SimilarFace[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GroupResult> Face_GroupAsync(GroupRequest requestBody)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GroupResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<IdentifyResult[]> Face_IdentifyAsync(IdentifyRequest requestBody)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<IdentifyResult[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<LargeFaceList[]> LargeFaceList_ListAsync(bool returnRecognitionModel)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<LargeFaceList[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="largeFaceListId">Id referencing a particular large face list.
		/// Max length: 64
		// </param>
		/// <param name="returnRecognitionModel">A value indicating whether the operation should return 'recognitionModel' in response.</param>
		...
		/// <param name="top">Number of faces to return starting with the face id indicated by the 'start' parameter.
		/// Minimum: 1
		/// Maximum: 1000
		// </param>
		...
		public async Task<TrainingStatus> LargeFaceList_GetTrainingStatusAsync(string largeFaceListId)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TrainingStatus>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="start">List large person groups from the least largePersonGroupId greater than the "start".
		/// Max length: 64
		// </param>
		/// <param name="top">The number of large person groups to list.
		/// Minimum: 1
		/// Maximum: 1000
		// </param>
		/// <param name="returnRecognitionModel">A value indicating whether the operation should return 'recognitionModel' in response.</param>
		...
		public async Task<LargePersonGroup[]> LargePersonGroup_ListAsync(string start, int top, bool returnRecognitionModel)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<LargePersonGroup[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="largePersonGroupId">Id referencing a particular large person group.
		/// Max length: 64
		// </param>
		/// <param name="returnRecognitionModel">A value indicating whether the operation should return 'recognitionModel' in response.</param>
		...
		/// <param name="top">Number of persons to return starting with the person id indicated by the 'start' parameter.
		/// Minimum: 1
		/// Maximum: 1000
		// </param>
		...
		public async Task<Person[]> LargePersonGroupPerson_ListAsync(string largePersonGroupId, string start, int top)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Person[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="start">List person groups from the least personGroupId greater than the "start".
		/// Max length: 64
		// </param>
		/// <param name="top">The number of person groups to list.
		/// Minimum: 1
		/// Maximum: 1000
		// </param>
		/// <param name="returnRecognitionModel">A value indicating whether the operation should return 'recognitionModel' in response.</param>
		...
		public async Task<PersonGroup[]> PersonGroup_ListAsync(string start, int top, bool returnRecognitionModel)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PersonGroup[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="personGroupId">Id referencing a particular person group.
		/// Max length: 64
		// </param>
		/// <param name="returnRecognitionModel">A value indicating whether the operation should return 'recognitionModel' in response.</param>
		...
		public async Task<VerifyResult> Face_VerifyFaceToFaceAsync(VerifyFaceToFaceRequest requestBody)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<VerifyResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
