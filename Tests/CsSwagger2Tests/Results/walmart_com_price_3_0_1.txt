...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// GetFeedsStatus v3/feeds/{feedId}
		/// </summary>
		/// <param name="feedId">The feed ID which status you want to retrieve.</param>
		...
		/// <param name="limit">The number of entities to be returned. It cannot be more than 50 entities. Only used when includeDetails is set to true.</param>
		public async Task GetFeedsStatusAsync(string feedId, string includeDetails, string offset, string limit)
		{
	...
	public enum UpdatePriceFeedType
	{
	...
	public enum UpdatePriceWM_CONSUMER_CHANNEL_TYPE
	{
