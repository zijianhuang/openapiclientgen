...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Metastore_projects_locations_services_backups_delete v1/{name}
		/// </summary>
		...
		/// Metastore_projects_locations_services_metadataImports_get v1/{name}
		/// </summary>
		...
		/// Metastore_projects_locations_services_metadataImports_patch v1/{name}
		/// </summary>
		...
		/// Metastore_projects_locations_list v1/{name}/locations
		/// </summary>
		...
		/// Metastore_projects_locations_operations_list v1/{name}/operations
		/// </summary>
		...
		/// Metastore_projects_locations_operations_cancel v1/{name}:cancel
		/// </summary>
		...
		/// Metastore_projects_locations_services_backups_list v1/{parent}/backups
		/// </summary>
		...
		/// Metastore_projects_locations_services_backups_create v1/{parent}/backups
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/backups&backupId=" + (backupId==null? "" : System.Uri.EscapeDataString(backupId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_federations_list v1/{parent}/federations
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/federations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Metastore_projects_locations_federations_create v1/{parent}/federations
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/federations&federationId=" + (federationId==null? "" : System.Uri.EscapeDataString(federationId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_metadataImports_list v1/{parent}/metadataImports
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/metadataImports&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Metastore_projects_locations_services_metadataImports_create v1/{parent}/metadataImports
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/metadataImports&metadataImportId=" + (metadataImportId==null? "" : System.Uri.EscapeDataString(metadataImportId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_list v1/{parent}/services
		/// </summary>
		...
		/// Metastore_projects_locations_services_create v1/{parent}/services
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/services&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&serviceId=" + (serviceId==null? "" : System.Uri.EscapeDataString(serviceId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_backups_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Metastore_projects_locations_services_backups_getIamPolicyAsync(string resource, int options_requestedPolicyVersion, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Metastore_projects_locations_services_backups_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Metastore_projects_locations_services_backups_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Metastore_projects_locations_services_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Metastore_projects_locations_services_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Metastore_projects_locations_services_alterLocation v1/{service}:alterLocation
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":alterLocation";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_alterTableProperties v1/{service}:alterTableProperties
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":alterTableProperties";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_exportMetadata v1/{service}:exportMetadata
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":exportMetadata";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_moveTableToDatabase v1/{service}:moveTableToDatabase
		/// </summary>
		/// <param name="service">Required. The relative resource name of the metastore service to mutate metadata, in the following format:projects/{project_id}/locations/{location_id}/services/{service_id}.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":moveTableToDatabase";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Query DPMS metadata.
		/// Metastore_projects_locations_services_queryMetadata v1/{service}:queryMetadata
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":queryMetadata";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_restore v1/{service}:restore
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":restore";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
