...
namespace MyNS
{
	...
	public class GoogleCloudFunctionsV2betaStateMessage
	{
		...
		public System.Nullable<GoogleCloudFunctionsV2betaStateMessageSeverity> Severity { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleCloudFunctionsV2betaStateMessageSeverity
	{
	...
	public class GoogleCloudFunctionsV2StateMessage
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="severity")]
		public GoogleCloudFunctionsV2betaStateMessageSeverity Severity { get; set; }
	...
	public partial class Misc
	{
		...
		/// Cloudfunctions_projects_locations_functions_delete v2beta/{name}
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_operations_get v2beta/{name}
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_functions_patch v2beta/{name}
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_list v2beta/{name}/locations
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/locations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudfunctions_projects_locations_operations_list v2beta/{name}/operations
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_functions_generateDownloadUrl v2beta/{name}:generateDownloadUrl
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":generateDownloadUrl";
		...
		/// Cloudfunctions_projects_locations_functions_list v2beta/{parent}/functions
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/functions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudfunctions_projects_locations_functions_create v2beta/{parent}/functions
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/functions&functionId=" + (functionId==null? "" : System.Uri.EscapeDataString(functionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudfunctions_projects_locations_functions_generateUploadUrl v2beta/{parent}/functions:generateUploadUrl
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/functions:generateUploadUrl";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudfunctions_projects_locations_runtimes_list v2beta/{parent}/runtimes
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/runtimes&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudfunctions_projects_locations_functions_getIamPolicy v2beta/{resource}:getIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":getIamPolicy&options.requestedPolicyVersion="+options_requestedPolicyVersion;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudfunctions_projects_locations_functions_setIamPolicy v2beta/{resource}:setIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":setIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudfunctions_projects_locations_functions_testIamPermissions v2beta/{resource}:testIamPermissions
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":testIamPermissions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
