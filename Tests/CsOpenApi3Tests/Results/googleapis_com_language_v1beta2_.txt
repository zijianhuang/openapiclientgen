...
namespace MyNS
{
	...
	public class Document
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="boilerplateHandling")]
		public System.Nullable<DocumentBoilerplateHandling> BoilerplateHandling { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="referenceWebUri")]
		public string ReferenceWebUri { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum DocumentBoilerplateHandling
	{
	...
	public partial class Misc
	{
		...
		/// Language_documents_analyzeEntities v1beta2/documents:analyzeEntities
		/// </summary>
		...
		{
			var requestUri = "v1beta2/documents:analyzeEntities";
		...
		/// Language_documents_analyzeEntitySentiment v1beta2/documents:analyzeEntitySentiment
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta2/documents:analyzeEntitySentiment";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AnalyzeEntitySentimentResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Language_documents_analyzeSentiment v1beta2/documents:analyzeSentiment
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta2/documents:analyzeSentiment";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AnalyzeSentimentResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Language_documents_analyzeSyntax v1beta2/documents:analyzeSyntax
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta2/documents:analyzeSyntax";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AnalyzeSyntaxResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Language_documents_annotateText v1beta2/documents:annotateText
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta2/documents:annotateText";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AnnotateTextResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Language_documents_classifyText v1beta2/documents:classifyText
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta2/documents:classifyText";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ClassifyTextResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Language_documents_moderateText v1beta2/documents:moderateText
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta2/documents:moderateText";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ModerateTextResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
