...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Cloudfunctions_projects_locations_functions_delete v2/{name}
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_operations_get v2/{name}
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_functions_patch v2/{name}
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_list v2/{name}/locations
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_operations_list v2/{name}/operations
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_functions_generateDownloadUrl v2/{name}:generateDownloadUrl
		/// </summary>
		...
		{
			var requestUri = "v2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":generateDownloadUrl";
		...
		/// Cloudfunctions_projects_locations_functions_list v2/{parent}/functions
		/// </summary>
		...
		{
			var requestUri = "v2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/functions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudfunctions_projects_locations_functions_create v2/{parent}/functions
		/// </summary>
		...
		{
			var requestUri = "v2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/functions&functionId=" + (functionId==null? "" : System.Uri.EscapeDataString(functionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudfunctions_projects_locations_functions_generateUploadUrl v2/{parent}/functions:generateUploadUrl
		/// </summary>
		...
		{
			var requestUri = "v2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/functions:generateUploadUrl";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudfunctions_projects_locations_runtimes_list v2/{parent}/runtimes
		/// </summary>
		...
		{
			var requestUri = "v2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/runtimes&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudfunctions_projects_locations_functions_getIamPolicy v2/{resource}:getIamPolicy
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_functions_setIamPolicy v2/{resource}:setIamPolicy
		/// </summary>
		...
		/// Cloudfunctions_projects_locations_functions_testIamPermissions v2/{resource}:testIamPermissions
		/// </summary>
