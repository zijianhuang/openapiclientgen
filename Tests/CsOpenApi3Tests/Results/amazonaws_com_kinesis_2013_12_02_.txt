...
namespace MyNS
{
	...
	public class DescribeLimitsOutput
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public int OnDemandStreamCount { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public int OnDemandStreamCountLimit { get; set; }
	}
	...
	public class GetRecordsOutput
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public ChildShard[] ChildShards { get; set; }
	}
	...
	public class Record
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.DateTimeOffset ApproximateArrivalTimestamp { get; set; }
	...
	public class ChildShard
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public string[] ParentShards { get; set; }
	...
	public class ListShardsInput
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public ShardFilter ShardFilter { get; set; }
	...
	public class ShardFilter
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public ShardFilterType Type { get; set; }
	...
	public class ListStreamsOutput
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public StreamSummary[] StreamSummaries { get; set; }
	}
	...
	public partial class Misc
	{
		...
		public async Task<DescribeLimitsOutput> DescribeLimitsAsync(DescribeLimitsInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<DescribeLimitsOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		{
			var requestUri = "#X-Amz-Target=Kinesis_20131202.DescribeStream?Limit=" + (Limit==null? "" : System.Uri.EscapeDataString(Limit))+"&ExclusiveStartShardId=" + (ExclusiveStartShardId==null? "" : System.Uri.EscapeDataString(ExclusiveStartShardId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DescribeStreamOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<DescribeStreamConsumerOutput> DescribeStreamConsumerAsync(DescribeStreamConsumerInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DescribeStreamConsumerOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<DescribeStreamSummaryOutput> DescribeStreamSummaryAsync(DescribeStreamSummaryInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DescribeStreamSummaryOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<EnhancedMonitoringOutput> DisableEnhancedMonitoringAsync(DisableEnhancedMonitoringInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<EnhancedMonitoringOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetRecordsOutput> GetRecordsAsync(GetRecordsInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetRecordsOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetShardIteratorOutput> GetShardIteratorAsync(GetShardIteratorInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetShardIteratorOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListShardsOutput> ListShardsAsync(ListShardsInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListShardsOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		{
			var requestUri = "#X-Amz-Target=Kinesis_20131202.ListStreamConsumers?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListStreamConsumersOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		public async Task<ListStreamsOutput> ListStreamsAsync(string Limit, string NextToken, ListStreamsInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=Kinesis_20131202.ListStreams?Limit=" + (Limit==null? "" : System.Uri.EscapeDataString(Limit))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListStreamsOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListTagsForStreamOutput> ListTagsForStreamAsync(ListTagsForStreamInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListTagsForStreamOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<PutRecordOutput> PutRecordAsync(PutRecordInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PutRecordOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<PutRecordsOutput> PutRecordsAsync(PutRecordsInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PutRecordsOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<RegisterStreamConsumerOutput> RegisterStreamConsumerAsync(RegisterStreamConsumerInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<RegisterStreamConsumerOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateShardCountOutput> UpdateShardCountAsync(UpdateShardCountInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateShardCountOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// UpdateStreamMode #X-Amz-Target=Kinesis_20131202.UpdateStreamMode
		/// </summary>
		/// <returns>Success</returns>
		public async Task UpdateStreamModeAsync(UpdateStreamModeInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=Kinesis_20131202.UpdateStreamMode";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public enum AddTagsToStreamX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.AddTagsToStream")]
		Kinesis_20131202_AddTagsToStream = 0,
	}
	
	public enum CreateStreamX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.CreateStream")]
		Kinesis_20131202_CreateStream = 0,
	}
	
	public enum DecreaseStreamRetentionPeriodX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.DecreaseStreamRetentionPeriod")]
		Kinesis_20131202_DecreaseStreamRetentionPeriod = 0,
	}
	
	public enum DeleteStreamX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.DeleteStream")]
		Kinesis_20131202_DeleteStream = 0,
	}
	
	public enum DeregisterStreamConsumerX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.DeregisterStreamConsumer")]
		Kinesis_20131202_DeregisterStreamConsumer = 0,
	}
	
	public enum DescribeLimitsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.DescribeLimits")]
		Kinesis_20131202_DescribeLimits = 0,
	}
	
	public enum DescribeStreamX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.DescribeStream")]
		Kinesis_20131202_DescribeStream = 0,
	}
	
	public enum DescribeStreamConsumerX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.DescribeStreamConsumer")]
		Kinesis_20131202_DescribeStreamConsumer = 0,
	}
	
	public enum DescribeStreamSummaryX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.DescribeStreamSummary")]
		Kinesis_20131202_DescribeStreamSummary = 0,
	}
	
	public enum DisableEnhancedMonitoringX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.DisableEnhancedMonitoring")]
		Kinesis_20131202_DisableEnhancedMonitoring = 0,
	}
	
	public enum EnableEnhancedMonitoringX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.EnableEnhancedMonitoring")]
		Kinesis_20131202_EnableEnhancedMonitoring = 0,
	}
	
	public enum GetRecordsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.GetRecords")]
		Kinesis_20131202_GetRecords = 0,
	}
	
	public enum GetShardIteratorX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.GetShardIterator")]
		Kinesis_20131202_GetShardIterator = 0,
	}
	
	public enum IncreaseStreamRetentionPeriodX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.IncreaseStreamRetentionPeriod")]
		Kinesis_20131202_IncreaseStreamRetentionPeriod = 0,
	}
	
	public enum ListShardsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.ListShards")]
		Kinesis_20131202_ListShards = 0,
	}
	
	public enum ListStreamConsumersX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.ListStreamConsumers")]
		Kinesis_20131202_ListStreamConsumers = 0,
	}
	
	public enum ListStreamsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.ListStreams")]
		Kinesis_20131202_ListStreams = 0,
	}
	
	public enum ListTagsForStreamX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.ListTagsForStream")]
		Kinesis_20131202_ListTagsForStream = 0,
	}
	
	public enum MergeShardsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.MergeShards")]
		Kinesis_20131202_MergeShards = 0,
	}
	
	public enum PutRecordX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.PutRecord")]
		Kinesis_20131202_PutRecord = 0,
	}
	
	public enum PutRecordsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.PutRecords")]
		Kinesis_20131202_PutRecords = 0,
	}
	
	public enum RegisterStreamConsumerX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.RegisterStreamConsumer")]
		Kinesis_20131202_RegisterStreamConsumer = 0,
	}
	
	public enum RemoveTagsFromStreamX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.RemoveTagsFromStream")]
		Kinesis_20131202_RemoveTagsFromStream = 0,
	}
	
	public enum SplitShardX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.SplitShard")]
		Kinesis_20131202_SplitShard = 0,
	}
	
	public enum StartStreamEncryptionX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.StartStreamEncryption")]
		Kinesis_20131202_StartStreamEncryption = 0,
	}
	
	public enum StopStreamEncryptionX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.StopStreamEncryption")]
		Kinesis_20131202_StopStreamEncryption = 0,
	}
	
	public enum UpdateShardCountX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.UpdateShardCount")]
		Kinesis_20131202_UpdateShardCount = 0,
	}
	
	public enum UpdateStreamModeX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="Kinesis_20131202.UpdateStreamMode")]
		Kinesis_20131202_UpdateStreamMode = 0,
	}
}
