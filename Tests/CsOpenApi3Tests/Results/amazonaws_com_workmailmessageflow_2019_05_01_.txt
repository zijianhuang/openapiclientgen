...
namespace MyNS
{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class InvalidContentLocation
	{
	}
	...
	public class RawMessageContent
	{
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="s3Reference")]
		public S3Reference S3Reference { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="messageId">The identifier of the email message to retrieve.
		/// Min length: 1
		/// Max length: 120
		// </param>
		...
		public async Task<GetRawMessageContentResponse> GetRawMessageContentAsync(string messageId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GetRawMessageContentResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// PutRawMessageContent messages/{messageId}
		/// </summary>
		/// <param name="messageId">The identifier of the email message being updated.
		/// Min length: 1
		/// Max length: 120
		// </param>
		/// <returns>Success</returns>
		public async Task<PutRawMessageContentResponse> PutRawMessageContentAsync(string messageId, PutRawMessageContentPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "messages/"+ (messageId==null? "" : System.Uri.EscapeDataString(messageId));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PutRawMessageContentResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
	...
	public class PutRawMessageContentPostBody
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="content")]
		public PutRawMessageContentPostBodyContent Content { get; set; }
	}
	
	public class PutRawMessageContentPostBodyContent
	{
