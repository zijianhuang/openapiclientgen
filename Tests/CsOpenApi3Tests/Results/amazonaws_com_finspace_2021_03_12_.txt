...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="nextToken">A token generated by FinSpace that specifies where to continue pagination if a previous request was truncated. To get the next set of pages, pass in the <code>nextToken</code>nextToken value from the response object of the previous page call.
		/// Min length: 1
		/// Max length: 1000
		// </param>
		...
		/// </summary>
		/// <param name="environmentId">A unique identifier of the kdb environment.
		/// Min length: 1
		/// Max length: 32
		// </param>
		/// <param name="databaseName">The name of the kdb database.
		/// Min length: 3
		/// Max length: 63
		// </param>
		/// <returns>Success</returns>
		public async Task<CreateKxChangesetResponse> CreateKxChangesetAsync(string environmentId, string databaseName, CreateKxChangesetPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateKxChangesetResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="environmentId">A unique identifier for the kdb environment.
		/// Min length: 1
		/// Max length: 32
		// </param>
		/// <param name="databaseName">The name of the kdb database.
		...
		/// Max length: 63
		// </param>
		/// <param name="nextToken">A token that indicates where a results page should begin.
		/// Min length: 1
		/// Max length: 1000
		// </param>
		/// <param name="maxResults">The maximum number of results to return in this request.
		...
		public async Task<ListKxChangesetsResponse> ListKxChangesetsAsync(string environmentId, string databaseName, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListKxChangesetsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CreateKxClusterResponse> CreateKxClusterAsync(string environmentId, CreateKxClusterPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateKxClusterResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListKxClustersResponse> ListKxClustersAsync(string environmentId, KxClusterType clusterType, int maxResults, string nextToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListKxClustersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CreateKxDatabaseResponse> CreateKxDatabaseAsync(string environmentId, CreateKxDatabasePostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateKxDatabaseResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListKxDatabasesResponse> ListKxDatabasesAsync(string environmentId, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListKxDatabasesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CreateKxEnvironmentResponse> CreateKxEnvironmentAsync(CreateKxEnvironmentPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateKxEnvironmentResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListKxEnvironmentsResponse> ListKxEnvironmentsAsync(string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListKxEnvironmentsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="environmentId">A unique identifier for the kdb environment where you want to create a user.
		/// Min length: 1
		/// Max length: 26
		// </param>
		/// <returns>Success</returns>
		public async Task<CreateKxUserResponse> CreateKxUserAsync(string environmentId, CreateKxUserPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateKxUserResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListKxUsersResponse> ListKxUsersAsync(string environmentId, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListKxUsersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="environmentId">The identifier for the FinSpace environment.
		/// Min length: 1
		/// Max length: 26
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="environmentId">The identifier of the FinSpace environment.
		/// Min length: 1
		/// Max length: 26
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 32
		// </param>
		/// <param name="clusterName">The name of the cluster that you want to delete.
		/// Min length: 3
		/// Max length: 63
		// </param>
		...
		public async Task<DeleteKxClusterResponse> DeleteKxClusterAsync(string environmentId, string clusterName, string clientToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteKxClusterResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 32
		// </param>
		/// <param name="clusterName">The name of the cluster that you want to retrieve.
		/// Min length: 3
		/// Max length: 63
		// </param>
		/// <returns>Success</returns>
		public async Task<GetKxClusterResponse> GetKxClusterAsync(string environmentId, string clusterName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetKxClusterResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 32
		// </param>
		/// <param name="databaseName">The name of the kdb database that you want to delete.
		/// Min length: 3
		/// Max length: 63
		// </param>
		/// <param name="clientToken">A token that ensures idempotency. This token expires in 10 minutes.
		...
		public async Task<DeleteKxDatabaseResponse> DeleteKxDatabaseAsync(string environmentId, string databaseName, string clientToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteKxDatabaseResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<DeleteKxEnvironmentResponse> DeleteKxEnvironmentAsync(string environmentId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteKxEnvironmentResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetKxEnvironmentResponse> GetKxEnvironmentAsync(string environmentId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetKxEnvironmentResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateKxEnvironmentResponse> UpdateKxEnvironmentAsync(string environmentId, UpdateKxEnvironmentPutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateKxEnvironmentResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="userName">A unique identifier for the user that you want to delete.
		/// Min length: 1
		/// Max length: 50
		// </param>
		/// <param name="environmentId">A unique identifier for the kdb environment.
		...
		public async Task<DeleteKxUserResponse> DeleteKxUserAsync(string userName, string environmentId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteKxUserResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="userName">A unique identifier for the user.
		/// Min length: 1
		/// Max length: 50
		// </param>
		/// <param name="environmentId">A unique identifier for the kdb environment.
		...
		public async Task<GetKxUserResponse> GetKxUserAsync(string userName, string environmentId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetKxUserResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateKxUserResponse> UpdateKxUserAsync(string environmentId, string userName, UpdateKxUserPutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateKxUserResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 63
		// </param>
		/// <param name="changesetId">A unique identifier of the changeset for which you want to retrieve data.
		/// Min length: 1
		/// Max length: 26
		// </param>
		/// <returns>Success</returns>
		public async Task<GetKxChangesetResponse> GetKxChangesetAsync(string environmentId, string databaseName, string changesetId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetKxChangesetResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="userArn"> The Amazon Resource Name (ARN) that identifies the user. For more information about ARNs and how to use ARNs in policies, see <a href="IAM/latest/UserGuide/reference_identifiers.html">IAM Identifiers</a> in the <i>IAM User Guide</i>. 
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <param name="environmentId">A unique identifier for the kdb environment.
		...
		/// Max length: 26
		// </param>
		/// <param name="clusterName">A name of the kdb cluster.
		/// Min length: 3
		/// Max length: 63
		// </param>
		/// <returns>Success</returns>
		public async Task<GetKxConnectionStringResponse> GetKxConnectionStringAsync(string userArn, string environmentId, string clusterName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetKxConnectionStringResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetKxDatabaseResponse> GetKxDatabaseAsync(string environmentId, string databaseName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetKxDatabaseResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateKxDatabaseResponse> UpdateKxDatabaseAsync(string environmentId, string databaseName, UpdateKxDatabasePutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateKxDatabaseResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 32
		// </param>
		/// <param name="clusterName">A unique name for the cluster.
		/// Min length: 3
		/// Max length: 63
		// </param>
		/// <param name="nextToken">A token that indicates where a results page should begin.
		...
		public async Task<ListKxClusterNodesResponse> ListKxClusterNodesAsync(string environmentId, string clusterName, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListKxClusterNodesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="resourceArn">The Amazon Resource Name of the resource.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="resourceArn">The Amazon Resource Name (ARN) for the resource.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="resourceArn">A FinSpace resource from which you want to remove a tag or tags. The value for this parameter is an Amazon Resource Name (ARN).
		/// Min length: 20
		/// Max length: 2048
		// </param>
		...
		/// </summary>
		/// <param name="environmentId">The unique identifier of a kdb environment.
		/// Min length: 1
		/// Max length: 32
		// </param>
		/// <param name="clusterName">A unique name for the cluster that you want to modify.
		/// Min length: 3
		/// Max length: 63
		// </param>
		/// <returns>Success</returns>
		public async Task<UpdateKxClusterDatabasesResponse> UpdateKxClusterDatabasesAsync(string environmentId, string clusterName, UpdateKxClusterDatabasesPutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateKxClusterDatabasesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateKxEnvironmentNetworkResponse> UpdateKxEnvironmentNetworkAsync(string environmentId, UpdateKxEnvironmentNetworkPutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateKxEnvironmentNetworkResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
