...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task JoinStorageSessionAsync(JoinStorageSessionPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "joinStorageSession";
	...
	public class JoinStorageSessionPostBody
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="channelArn")]
		[System.ComponentModel.DataAnnotations.RegularExpressionAttribute(@"^arn:(aws[a-zA-Z-]*):kinesisvideo:[a-z0-9-]+:[0-9]+:[a-z]+/[a-zA-Z0-9_.-]+/[0-9]+$")]
		public string ChannelArn { get; set; }
	}
}
