...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Datafusion_projects_locations_operations_delete v1beta1/{name}
		/// </summary>
		...
		/// Datafusion_projects_locations_operations_get v1beta1/{name}
		/// </summary>
		...
		/// Datafusion_projects_locations_instances_patch v1beta1/{name}
		/// </summary>
		...
		/// <param name="updateMask">Field mask is used to specify the fields that the update will overwrite in an instance resource. The fields specified in the update_mask are relative to the resource, not the full request. A field will be overwritten if it is in the mask. If the user does not provide a mask, all the supported fields (labels and options currently) will be overwritten.</param>
		/// <returns>Successful response</returns>
		...
		/// Datafusion_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// Datafusion_projects_locations_operations_list v1beta1/{name}/operations
		/// </summary>
		...
		/// Datafusion_projects_locations_operations_cancel v1beta1/{name}:cancel
		/// </summary>
		...
		/// Datafusion_projects_locations_instances_restart v1beta1/{name}:restart
		/// </summary>
		...
		/// Datafusion_projects_locations_instances_upgrade v1beta1/{name}:upgrade
		/// </summary>
		/// <param name="name">Required. Name of the Data Fusion instance which need to be upgraded in the form of projects/{project}/locations/{location}/instances/{instance} Instance will be upgraded with the latest stable version of the Data Fusion.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Datafusion_projects_locations_instances_upgradeAsync(string name, UpgradeInstanceRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":upgrade";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Datafusion_projects_locations_instances_dnsPeerings_list v1beta1/{parent}/dnsPeerings
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/dnsPeerings&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListDnsPeeringsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datafusion_projects_locations_instances_dnsPeerings_create v1beta1/{parent}/dnsPeerings
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/dnsPeerings&dnsPeeringId=" + (dnsPeeringId==null? "" : System.Uri.EscapeDataString(dnsPeeringId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DnsPeering>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datafusion_projects_locations_instances_list v1beta1/{parent}/instances
		/// </summary>
		...
		/// Datafusion_projects_locations_instances_create v1beta1/{parent}/instances
		/// </summary>
		...
		/// Datafusion_projects_locations_instances_namespaces_list v1beta1/{parent}/namespaces
		/// </summary>
		/// <param name="parent">Required. The instance to list its namespaces.</param>
		/// <param name="pageSize">The maximum number of items to return.</param>
		/// <param name="pageToken">The next_page_token value to use if there are additional results to retrieve for this list request.</param>
		/// <param name="view">By default, only basic information about a namespace is returned (e.g. name). When `NAMESPACE_VIEW_FULL` is specified, additional information associated with a namespace gets returned (e.g. IAM policy set on the namespace)</param>
		/// <returns>Successful response</returns>
		public async Task<ListNamespacesResponse> Datafusion_projects_locations_instances_namespaces_listAsync(string parent, int pageSize, string pageToken, Datafusion_projects_locations_instances_namespaces_listView view, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/namespaces&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Datafusion_projects_locations_versions_list v1beta1/{parent}/versions
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/versions&latestPatchOnly="+latestPatchOnly+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAvailableVersionsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datafusion_projects_locations_instances_namespaces_getIamPolicy v1beta1/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Datafusion_projects_locations_instances_namespaces_getIamPolicyAsync(string resource, int options_requestedPolicyVersion, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Datafusion_projects_locations_removeIamPolicy v1beta1/{resource}:removeIamPolicy
		/// </summary>
		/// <param name="resource">Required. The resource on which IAM policy to be removed is attached to.</param>
		/// <returns>Successful response</returns>
		public async Task<RemoveIamPolicyResponse> Datafusion_projects_locations_removeIamPolicyAsync(string resource, RemoveIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":removeIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<RemoveIamPolicyResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datafusion_projects_locations_instances_namespaces_setIamPolicy v1beta1/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Datafusion_projects_locations_instances_namespaces_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Datafusion_projects_locations_instances_namespaces_testIamPermissions v1beta1/{resource}:testIamPermissions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Datafusion_projects_locations_instances_namespaces_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
	...
	public enum Datafusion_projects_locations_instances_namespaces_listView
	{
