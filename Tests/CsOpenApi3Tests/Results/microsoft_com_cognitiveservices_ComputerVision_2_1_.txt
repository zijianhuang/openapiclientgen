...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<ImageAnalysis> AnalyzeImageAsync(string[] visualFeatures, string[] details, AnalyzeImageLanguage language, string[] descriptionExclude, ImageUrl requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<ImageDescription> DescribeImageAsync(int maxCandidates, AnalyzeImageLanguage language, string[] descriptionExclude, ImageUrl requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
