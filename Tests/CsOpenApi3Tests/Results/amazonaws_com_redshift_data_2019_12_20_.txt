...
namespace MyNS
{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class ActiveStatementsExceededException
	{
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class BatchExecuteStatementException
	{
	}
	...
	public class DescribeStatementResponse
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Boolean> HasResultSet { get; set; }
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> RedshiftPid { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> RedshiftQueryId { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> ResultRows { get; set; }
		...
		[System.Runtime.Serialization.DataMember()]
		public StatusString Status { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public SubStatementData[] SubStatements { get; set; }
	...
	public class SubStatementData
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public StatementStatusString Status { get; set; }
	...
	public class DescribeTableResponse
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public ColumnMetadata[] ColumnList { get; set; }
	...
	public class ColumnMetadata
	{
		...
		[System.Runtime.Serialization.DataMember(Name="columnDefault")]
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class ExecuteStatementException
	{
	}
	...
	public class GetStatementResultResponse
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> TotalNumRows { get; set; }
	}
	...
	public class ListStatementsResponse
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public StatementData[] Statements { get; set; }
	}
	...
	public class StatementData
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Boolean> IsBatchStatement { get; set; }
	...
	public class ListStatementsRequest
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Boolean> RoleLevel { get; set; }
	...
	public class ListTablesResponse
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public TableMember[] Tables { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// BatchExecuteStatement #X-Amz-Target=RedshiftData.BatchExecuteStatement
		/// </summary>
		...
		{
			var requestUri = "#X-Amz-Target=RedshiftData.BatchExecuteStatement";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<BatchExecuteStatementOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// CancelStatement #X-Amz-Target=RedshiftData.CancelStatement
		/// </summary>
		/// <returns>Success</returns>
		...
		{
			var requestUri = "#X-Amz-Target=RedshiftData.CancelStatement";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// DescribeStatement #X-Amz-Target=RedshiftData.DescribeStatement
		/// </summary>
		/// <returns>Success</returns>
		public async Task<DescribeStatementResponse> DescribeStatementAsync(DescribeStatementRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=RedshiftData.DescribeStatement";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DescribeStatementResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// DescribeTable #X-Amz-Target=RedshiftData.DescribeTable
		/// </summary>
		/// <param name="MaxResults">Pagination limit</param>
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		public async Task<DescribeTableResponse> DescribeTableAsync(string MaxResults, string NextToken, DescribeTableRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=RedshiftData.DescribeTable?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// ExecuteStatement #X-Amz-Target=RedshiftData.ExecuteStatement
		/// </summary>
		/// <returns>Success</returns>
		...
		{
			var requestUri = "#X-Amz-Target=RedshiftData.ExecuteStatement";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ExecuteStatementOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// GetStatementResult #X-Amz-Target=RedshiftData.GetStatementResult
		/// </summary>
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		public async Task<GetStatementResultResponse> GetStatementResultAsync(string NextToken, GetStatementResultRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=RedshiftData.GetStatementResult?NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetStatementResultResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// ListDatabases #X-Amz-Target=RedshiftData.ListDatabases
		/// </summary>
		/// <param name="MaxResults">Pagination limit</param>
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		...
		{
			var requestUri = "#X-Amz-Target=RedshiftData.ListDatabases?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// ListSchemas #X-Amz-Target=RedshiftData.ListSchemas
		/// </summary>
		/// <param name="MaxResults">Pagination limit</param>
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		...
		{
			var requestUri = "#X-Amz-Target=RedshiftData.ListSchemas?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// ListStatements #X-Amz-Target=RedshiftData.ListStatements
		/// </summary>
		/// <param name="MaxResults">Pagination limit</param>
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		public async Task<ListStatementsResponse> ListStatementsAsync(string MaxResults, string NextToken, ListStatementsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=RedshiftData.ListStatements?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// ListTables #X-Amz-Target=RedshiftData.ListTables
		/// </summary>
		/// <param name="MaxResults">Pagination limit</param>
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		...
		{
			var requestUri = "#X-Amz-Target=RedshiftData.ListTables?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public enum BatchExecuteStatementX_Amz_Target
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.BatchExecuteStatement")]
		RedshiftData_BatchExecuteStatement = 0,
	}
	
	public enum CancelStatementX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.CancelStatement")]
		RedshiftData_CancelStatement = 0,
	}
	
	public enum DescribeStatementX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.DescribeStatement")]
		RedshiftData_DescribeStatement = 0,
	}
	
	public enum DescribeTableX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.DescribeTable")]
		RedshiftData_DescribeTable = 0,
	}
	
	public enum ExecuteStatementX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.ExecuteStatement")]
		RedshiftData_ExecuteStatement = 0,
	}
	
	public enum GetStatementResultX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.GetStatementResult")]
		RedshiftData_GetStatementResult = 0,
	}
	
	public enum ListDatabasesX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.ListDatabases")]
		RedshiftData_ListDatabases = 0,
	}
	
	public enum ListSchemasX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.ListSchemas")]
		RedshiftData_ListSchemas = 0,
	}
	
	public enum ListStatementsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.ListStatements")]
		RedshiftData_ListStatements = 0,
	}
	
	public enum ListTablesX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="RedshiftData.ListTables")]
		RedshiftData_ListTables = 0,
	}
}
