...
namespace MyNS
{
	...
	public class DfsSlatePlayerOwnershipProjection
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> FantasyDefensePlayerID { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Boolean> IsCaptain { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> PlayerID { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Double> ProjectedOwnershipPercentage { get; set; }
	...
	public partial class Misc
	{
		...
		/// DfsSlateOwnershipProjectionsBySlateid {format}/DfsSlateOwnershipProjectionsBySlateID/{slateId}
		/// </summary>
		...
		public async Task<DfsSlateWithOwnershipProjection> DfsSlateOwnershipProjectionsBySlateidAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string slateId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/DfsSlateOwnershipProjectionsBySlateID/"+ (slateId==null? "" : System.Uri.EscapeDataString(slateId));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<DfsSlateWithOwnershipProjection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		public async Task<DfsSlate[]> DfsSlatesByDateAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string date, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<DfsSlate[]> DfsSlatesByWeekAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string week, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		///          Example: <code>1</code>
		///        </param>
		public async Task<FantasyDefenseGameProjection[]> ProjectedFantasyDefenseGameStatsWDfsSalariesAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string week, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// ProjectedFantasyDefenseSeasonStatsWAdp {format}/FantasyDefenseProjectionsBySeason/{season}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season and the season type. If no season type is provided, then the default is regular season.
		///          <br>Examples: <code>2015REG</code>, <code>2015PRE</code>, <code>2015POST</code>.
		///        </param>
		public async Task<FantasyDefenseSeasonProjection[]> ProjectedFantasyDefenseSeasonStatsWAdpAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<PlayerGameProjection> IdpProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string week, string playerid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<PlayerGameProjection[]> IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string week, string team, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		///          Example: <code>1</code>
		///        </param>
		public async Task<PlayerGameProjection[]> IdpProjectedPlayerGameStatsByWeekWInjuriesLineupsDfsSalariesAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string week, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Player[]> InjuredPlayersAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		///        </param>
		/// <param name="playerid">Each NFL player has a unique ID assigned by FantasyData. Player IDs can be determined by pulling player related data. Example:<code>14257</code>.</param>
		public async Task<PlayerGameProjection> ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string week, string playerid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		///        </param>
		/// <param name="team">Abbreviation of the team. Example: <code>WAS</code>.</param>
		public async Task<PlayerGameProjection[]> ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string week, string team, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		///          Example: <code>1</code>
		///        </param>
		public async Task<PlayerGameProjection[]> ProjectedPlayerGameStatsByWeekWInjuriesLineupsDfsSalariesAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string week, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// ProjectedPlayerSeasonStatsWAdp {format}/PlayerSeasonProjectionStats/{season}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season and the season type. If no season type is provided, then the default is regular season.
		///          <br>Examples: <code>2015REG</code>, <code>2015PRE</code>, <code>2015POST</code>.
		///        </param>
		public async Task<PlayerSeasonProjection[]> ProjectedPlayerSeasonStatsWAdpAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// ProjectedPlayerSeasonStatsByPlayerWAdp {format}/PlayerSeasonProjectionStatsByPlayerID/{season}/{playerid}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season and the season type. If no season type is provided, then the default is regular season.
		///          <br>Examples: <code>2015REG</code>, <code>2015PRE</code>, <code>2015POST</code>.
		///        </param>
		/// <param name="playerid">Each NFL player has a unique ID assigned by FantasyData. Player IDs can be determined by pulling player related data. Example:<code>14257</code>.</param>
		public async Task<PlayerSeasonProjection> ProjectedPlayerSeasonStatsByPlayerWAdpAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string playerid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// ProjectedPlayerSeasonStatsByTeamWAdp {format}/PlayerSeasonProjectionStatsByTeam/{season}/{team}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season and the season type. If no season type is provided, then the default is regular season.
		///          <br>Examples: <code>2015REG</code>, <code>2015PRE</code>, <code>2015POST</code>.
		///        </param>
		/// <param name="team">Abbreviation of the team. Example: <code>WAS</code>.</param>
		public async Task<PlayerSeasonProjection[]> ProjectedPlayerSeasonStatsByTeamWAdpAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, string season, string team, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// UpcomingDfsSlateOwnershipProjections {format}/UpcomingDfsSlateOwnershipProjections
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<DfsSlateWithOwnershipProjection[]> UpcomingDfsSlateOwnershipProjectionsAsync(DfsSlateOwnershipProjectionsBySlateidFormat format, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/UpcomingDfsSlateOwnershipProjections";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
	...
	public enum DfsSlateOwnershipProjectionsBySlateidFormat
	{
