...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Dncer dncer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task DncerAsync(DncerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "dncer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Fslcs fslcs/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task FslcsAsync(FslcsPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "fslcs/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Grred grred/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task GrredAsync(GrredPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "grred/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Isoal isoal/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task IsoalAsync(IsoalPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "isoal/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Lvcer lvcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task LvcerAsync(LvcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "lvcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Malcs malcs/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task MalcsAsync(MalcsPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "malcs/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Mpkby mpkby/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task MpkbyAsync(MpkbyPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "mpkby/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Ritin ritin/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task RitinAsync(RitinPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ritin/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Smcer smcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task SmcerAsync(SmcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "smcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Sslcs sslcs/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task SslcsAsync(SslcsPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "sslcs/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Vrwmi vrwmi/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task VrwmiAsync(VrwmiPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "vrwmi/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public class ChcerPostBody
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public ChcerPostBodyFormat Format { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum ChcerPostBodyFormat
	{
	...
	public class DncerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public DncerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class DncerPostBodyCertificateParameters
	{
	...
	public class FslcsPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public FslcsPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class FslcsPostBodyCertificateParameters
	{
	...
	public class GrredPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public GrredPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class GrredPostBodyCertificateParameters
	{
	...
	public class IsoalPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public IsoalPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class IsoalPostBodyCertificateParameters
	{
	...
	public class LvcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public LvcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class LvcerPostBodyCertificateParameters
	{
	...
	public class MalcsPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public MalcsPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class MalcsPostBodyCertificateParameters
	{
	...
	public class MpkbyPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public MpkbyPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class MpkbyPostBodyCertificateParameters
	{
	...
	public class RitinPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public RitinPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class RitinPostBodyCertificateParameters
	{
	...
	public class SmcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public SmcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class SmcerPostBodyCertificateParameters
	{
	...
	public class SslcsPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public SslcsPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class SslcsPostBodyCertificateParameters
	{
	...
	public class VrwmiPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public VrwmiPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class VrwmiPostBodyCertificateParameters
	{
