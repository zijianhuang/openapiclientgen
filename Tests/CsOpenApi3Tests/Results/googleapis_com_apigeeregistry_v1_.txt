...
namespace MyNS
{
	...
	public class ApiVersion
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="primarySpec")]
	...
	public partial class Misc
	{
		...
		/// Apigeeregistry_projects_locations_operations_delete v1/{name}
		/// </summary>
		...
		public async Task<Empty> Apigeeregistry_projects_locations_operations_deleteAsync(string name, bool force, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_operations_get v1/{name}
		/// </summary>
		/// <param name="name">The name of the operation resource.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Apigeeregistry_projects_locations_operations_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_apis_versions_specs_patch v1/{name}
		/// </summary>
		...
		/// <param name="updateMask">The list of fields to be updated. If omitted, all fields are updated that are set in the request message (fields set to default values are ignored). If an asterisk "*" is specified, all fields are updated, including fields that are unspecified/default in the request.</param>
		/// <returns>Successful response</returns>
		public async Task<ApiSpec> Apigeeregistry_projects_locations_apis_versions_specs_patchAsync(string name, bool allowMissing, string updateMask, ApiSpec requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_artifacts_replaceArtifact v1/{name}
		/// </summary>
		/// <param name="name">Resource name.</param>
		/// <returns>Successful response</returns>
		public async Task<Artifact> Apigeeregistry_projects_locations_artifacts_replaceArtifactAsync(string name, Artifact requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// Apigeeregistry_projects_locations_list v1/{name}/locations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListLocationsResponse> Apigeeregistry_projects_locations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_operations_list v1/{name}/operations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Apigeeregistry_projects_locations_operations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_operations_cancel v1/{name}:cancel
		/// </summary>
		/// <param name="name">The name of the operation resource to be cancelled.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Apigeeregistry_projects_locations_operations_cancelAsync(string name, CancelOperationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_apis_versions_specs_deleteRevision v1/{name}:deleteRevision
		/// </summary>
		/// <param name="name">Required. The name of the spec revision to be deleted, with a revision ID explicitly included. Example: `projects/sample/locations/global/apis/petstore/versions/1.0.0/specs/openapi.yaml@c7cfa2a8`</param>
		/// <returns>Successful response</returns>
		public async Task<ApiSpec> Apigeeregistry_projects_locations_apis_versions_specs_deleteRevisionAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_artifacts_getContents v1/{name}:getContents
		/// </summary>
		/// <param name="name">Required. The name of the artifact whose contents should be retrieved. Format: `{parent}/artifacts/*`</param>
		/// <returns>Successful response</returns>
		public async Task<HttpBody> Apigeeregistry_projects_locations_artifacts_getContentsAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":getContents";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Apigeeregistry_projects_locations_apis_versions_specs_listRevisions v1/{name}:listRevisions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListApiSpecRevisionsResponse> Apigeeregistry_projects_locations_apis_versions_specs_listRevisionsAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_apis_versions_specs_rollback v1/{name}:rollback
		/// </summary>
		/// <param name="name">Required. The spec being rolled back.</param>
		/// <returns>Successful response</returns>
		public async Task<ApiSpec> Apigeeregistry_projects_locations_apis_versions_specs_rollbackAsync(string name, RollbackApiSpecRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_apis_versions_specs_tagRevision v1/{name}:tagRevision
		/// </summary>
		/// <param name="name">Required. The name of the spec to be tagged, including the revision ID is optional. If a revision is not specified, it will tag the latest revision.</param>
		/// <returns>Successful response</returns>
		public async Task<ApiSpec> Apigeeregistry_projects_locations_apis_versions_specs_tagRevisionAsync(string name, TagApiSpecRevisionRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":tagRevision";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Apigeeregistry_projects_locations_apis_list v1/{parent}/apis
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of APIs. Format: `projects/*/locations/*`</param>
		/// <param name="filter">An expression that can be used to filter the list. Filters use the Common Expression Language and can refer to all message fields.</param>
		/// <param name="orderBy">A comma-separated list of fields, e.g. "foo,bar" Fields can be sorted in descending order using the "desc" identifier, e.g. "foo desc,bar"</param>
		...
		/// <returns>Successful response</returns>
		public async Task<ListApisResponse> Apigeeregistry_projects_locations_apis_listAsync(string parent, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/apis&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Apigeeregistry_projects_locations_apis_create v1/{parent}/apis
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of APIs. Format: `projects/*/locations/*`</param>
		/// <param name="apiId">Required. The ID to use for the API, which will become the final component of the API's resource name. This value should be 4-63 characters, and valid characters are /a-z-/. Following AIP-162, IDs must not have the form of a UUID.</param>
		/// <returns>Successful response</returns>
		public async Task<Api> Apigeeregistry_projects_locations_apis_createAsync(string parent, string apiId, Api requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/apis&apiId=" + (apiId==null? "" : System.Uri.EscapeDataString(apiId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Apigeeregistry_projects_locations_artifacts_list v1/{parent}/artifacts
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of artifacts. Format: `{parent}`</param>
		...
		/// <returns>Successful response</returns>
		public async Task<ListArtifactsResponse> Apigeeregistry_projects_locations_artifacts_listAsync(string parent, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_artifacts_create v1/{parent}/artifacts
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of artifacts. Format: `{parent}`</param>
		/// <param name="artifactId">Required. The ID to use for the artifact, which will become the final component of the artifact's resource name. This value should be 4-63 characters, and valid characters are /a-z-/. Following AIP-162, IDs must not have the form of a UUID.</param>
		/// <returns>Successful response</returns>
		public async Task<Artifact> Apigeeregistry_projects_locations_artifacts_createAsync(string parent, string artifactId, Artifact requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_apis_deployments_list v1/{parent}/deployments
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of deployments. Format: `projects/*/locations/*/apis/*`</param>
		/// <param name="filter">An expression that can be used to filter the list. Filters use the Common Expression Language and can refer to all message fields.</param>
		/// <param name="orderBy">A comma-separated list of fields, e.g. "foo,bar" Fields can be sorted in descending order using the "desc" identifier, e.g. "foo desc,bar"</param>
		...
		/// <returns>Successful response</returns>
		public async Task<ListApiDeploymentsResponse> Apigeeregistry_projects_locations_apis_deployments_listAsync(string parent, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/deployments&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Apigeeregistry_projects_locations_apis_deployments_create v1/{parent}/deployments
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of deployments. Format: `projects/*/locations/*/apis/*`</param>
		/// <param name="apiDeploymentId">Required. The ID to use for the deployment, which will become the final component of the deployment's resource name. This value should be 4-63 characters, and valid characters are /a-z-/. Following AIP-162, IDs must not have the form of a UUID.</param>
		/// <returns>Successful response</returns>
		public async Task<ApiDeployment> Apigeeregistry_projects_locations_apis_deployments_createAsync(string parent, string apiDeploymentId, ApiDeployment requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/deployments&apiDeploymentId=" + (apiDeploymentId==null? "" : System.Uri.EscapeDataString(apiDeploymentId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Apigeeregistry_projects_locations_instances_create v1/{parent}/instances
		/// </summary>
		/// <param name="parent">Required. Parent resource of the Instance, of the form: `projects/*/locations/*`</param>
		/// <param name="instanceId">Required. Identifier to assign to the Instance. Must be unique within scope of the parent resource.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Apigeeregistry_projects_locations_instances_createAsync(string parent, string instanceId, Instance requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_apis_versions_specs_list v1/{parent}/specs
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of specs. Format: `projects/*/locations/*/apis/*/versions/*`</param>
		/// <param name="filter">An expression that can be used to filter the list. Filters use the Common Expression Language and can refer to all message fields except contents.</param>
		/// <param name="orderBy">A comma-separated list of fields, e.g. "foo,bar" Fields can be sorted in descending order using the "desc" identifier, e.g. "foo desc,bar"</param>
		...
		/// <returns>Successful response</returns>
		public async Task<ListApiSpecsResponse> Apigeeregistry_projects_locations_apis_versions_specs_listAsync(string parent, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/specs&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Apigeeregistry_projects_locations_apis_versions_specs_create v1/{parent}/specs
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of specs. Format: `projects/*/locations/*/apis/*/versions/*`</param>
		/// <param name="apiSpecId">Required. The ID to use for the spec, which will become the final component of the spec's resource name. This value should be 4-63 characters, and valid characters are /a-z-/. Following AIP-162, IDs must not have the form of a UUID.</param>
		/// <returns>Successful response</returns>
		public async Task<ApiSpec> Apigeeregistry_projects_locations_apis_versions_specs_createAsync(string parent, string apiSpecId, ApiSpec requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/specs&apiSpecId=" + (apiSpecId==null? "" : System.Uri.EscapeDataString(apiSpecId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Apigeeregistry_projects_locations_apis_versions_list v1/{parent}/versions
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of versions. Format: `projects/*/locations/*/apis/*`</param>
		/// <param name="filter">An expression that can be used to filter the list. Filters use the Common Expression Language and can refer to all message fields.</param>
		/// <param name="orderBy">A comma-separated list of fields, e.g. "foo,bar" Fields can be sorted in descending order using the "desc" identifier, e.g. "foo desc,bar"</param>
		...
		/// <returns>Successful response</returns>
		public async Task<ListApiVersionsResponse> Apigeeregistry_projects_locations_apis_versions_listAsync(string parent, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_apis_versions_create v1/{parent}/versions
		/// </summary>
		/// <param name="parent">Required. The parent, which owns this collection of versions. Format: `projects/*/locations/*/apis/*`</param>
		/// <param name="apiVersionId">Required. The ID to use for the version, which will become the final component of the version's resource name. This value should be 1-63 characters, and valid characters are /a-z-/. Following AIP-162, IDs must not have the form of a UUID.</param>
		/// <returns>Successful response</returns>
		public async Task<ApiVersion> Apigeeregistry_projects_locations_apis_versions_createAsync(string parent, string apiVersionId, ApiVersion requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/versions&apiVersionId=" + (apiVersionId==null? "" : System.Uri.EscapeDataString(apiVersionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Apigeeregistry_projects_locations_runtime_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Apigeeregistry_projects_locations_runtime_getIamPolicyAsync(string resource, int options_requestedPolicyVersion, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_runtime_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Apigeeregistry_projects_locations_runtime_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Apigeeregistry_projects_locations_runtime_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Apigeeregistry_projects_locations_runtime_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
