...
namespace MyNS
{
	...
	public class Trust
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="lastKnownTrustConnectedHeartbeatTime")]
		public string LastKnownTrustConnectedHeartbeatTime { get; set; }
	...
	public class Domain
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="managedIdentitiesAdminName")]
		public string ManagedIdentitiesAdminName { get; set; }
	...
	public class EnableMigrationRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="enableDuration")]
		public string EnableDuration { get; set; }
	...
	public partial class Misc
	{
		...
		/// Managedidentities_projects_locations_global_domains_checkMigrationPermission v1alpha1/{domain}:checkMigrationPermission
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":checkMigrationPermission";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<CheckMigrationPermissionResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Managedidentities_projects_locations_global_domains_disableMigration v1alpha1/{domain}:disableMigration
		/// </summary>
		/// <param name="domain">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":disableMigration";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_domainJoinMachine v1alpha1/{domain}:domainJoinMachine
		/// </summary>
		/// <param name="domain">Required. The domain resource name using the form: projects/{project_id}/locations/global/domains/{domain_name}</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":domainJoinMachine";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DomainJoinMachineResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Managedidentities_projects_locations_global_domains_enableMigration v1alpha1/{domain}:enableMigration
		/// </summary>
		/// <param name="domain">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":enableMigration";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_extendSchema v1alpha1/{domain}:extendSchema
		/// </summary>
		/// <param name="domain">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":extendSchema";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_peerings_delete v1alpha1/{name}
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_peerings_get v1alpha1/{name}
		/// </summary>
		/// <param name="name">Required. Peering resource name using the form: `projects/{project_id}/locations/global/peerings/{peering_id}`</param>
		/// <returns>Successful response</returns>
		public async Task<Peering> Managedidentities_projects_locations_global_peerings_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Peering>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Managedidentities_projects_locations_global_peerings_patch v1alpha1/{name}
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_domains_getLdapssettings v1alpha1/{name}/ldapssettings
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/ldapssettings";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<LDAPSSettings>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Managedidentities_projects_locations_global_domains_updateLdapssettings v1alpha1/{name}/ldapssettings
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/ldapssettings&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_list v1alpha1/{name}/locations
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_operations_list v1alpha1/{name}/operations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Managedidentities_projects_locations_global_operations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Managedidentities_projects_locations_global_domains_attachTrust v1alpha1/{name}:attachTrust
		/// </summary>
		/// <param name="name">The resource domain name, project name and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":attachTrust";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_operations_cancel v1alpha1/{name}:cancel
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_domains_detachTrust v1alpha1/{name}:detachTrust
		/// </summary>
		/// <param name="name">The resource domain name, project name, and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":detachTrust";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_reconfigureTrust v1alpha1/{name}:reconfigureTrust
		/// </summary>
		/// <param name="name">The resource domain name, project name and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":reconfigureTrust";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_resetAdminPassword v1alpha1/{name}:resetAdminPassword
		/// </summary>
		/// <param name="name">The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":resetAdminPassword";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ResetAdminPasswordResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Managedidentities_projects_locations_global_domains_restore v1alpha1/{name}:restore
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":restore";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_validateTrust v1alpha1/{name}:validateTrust
		/// </summary>
		/// <param name="name">The resource domain name, project name, and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":validateTrust";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_backups_list v1alpha1/{parent}/backups
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/backups&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Managedidentities_projects_locations_global_domains_backups_create v1alpha1/{parent}/backups
		/// </summary>
		/// <param name="parent">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/backups&backupId=" + (backupId==null? "" : System.Uri.EscapeDataString(backupId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_list v1alpha1/{parent}/domains
		/// </summary>
		...
		/// <param name="filter">Optional. Filter specifying constraints of a list operation. For example, `Domain.fqdn="mydomain.myorginization"`.</param>
		/// <param name="orderBy">Optional. Specifies the ordering of results following syntax at https://cloud.google.com/apis/design/design_patterns#sorting_order.</param>
		/// <param name="pageSize">If not specified, a default value of 1000 will be used by the service. Regardless of the page_size value, the response may include a partial list and a caller should only rely on response's next_page_token to determine if there are more instances left to be queried.</param>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/domains&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListDomainsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Managedidentities_projects_locations_global_domains_create v1alpha1/{parent}/domains
		/// </summary>
		/// <param name="parent">Resource project name and location using the form: `projects/{project_id}/locations/global`</param>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/domains&domainName=" + (domainName==null? "" : System.Uri.EscapeDataString(domainName));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_peerings_list v1alpha1/{parent}/peerings
		/// </summary>
		/// <param name="parent">Required. The resource name of the domain location using the form: `projects/{project_id}/locations/global`</param>
		/// <param name="filter">Optional. Filter specifying constraints of a list operation. For example, `peering.authoized_network ="/projects/myprojectid"`.</param>
		/// <param name="orderBy">Optional. Specifies the ordering of results following syntax at https://cloud.google.com/apis/design/design_patterns#sorting_order.</param>
		/// <param name="pageSize">Optional. The maximum number of items to return. If not specified, a default value of 1000 will be used by the service. Regardless of the page_size value, the response may include a partial list and a caller should only rely on response's next_page_token to determine if there are more instances left to be queried.</param>
		/// <param name="pageToken">Optional. The next_page_token value returned from a previous List request, if any.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/peerings&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListPeeringsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Managedidentities_projects_locations_global_peerings_create v1alpha1/{parent}/peerings
		/// </summary>
		/// <param name="parent">Required. Resource project name and location using the form: `projects/{project_id}/locations/global`</param>
		/// <param name="peeringId">Required. Peering Id, unique name to identify peering.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/peerings&peeringId=" + (peeringId==null? "" : System.Uri.EscapeDataString(peeringId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_sqlIntegrations_list v1alpha1/{parent}/sqlIntegrations
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/sqlIntegrations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListSQLIntegrationsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Managedidentities_projects_locations_global_peerings_getIamPolicy v1alpha1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_peerings_setIamPolicy v1alpha1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_peerings_testIamPermissions v1alpha1/{resource}:testIamPermissions
		/// </summary>
