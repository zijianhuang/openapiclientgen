...
namespace MyNS
{
	...
	public class DirectoryServicesConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="managedActiveDirectory")]
		public ManagedActiveDirectoryConfig ManagedActiveDirectory { get; set; }
	}
	...
	public class NfsExportOptions
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="securityFlavors")]
		public string[] SecurityFlavors { get; set; }
	...
	public class Instance
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="capacityStepSizeGb")]
		public string CapacityStepSizeGb { get; set; }
		...
		/// Directory Services configuration for Kerberos-based authentication.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="directoryServices")]
		public DirectoryServicesConfig DirectoryServices { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maxCapacityGb")]
		public string MaxCapacityGb { get; set; }
		
		/// <summary>
		/// The max number of shares allowed.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maxShareCount")]
		public string MaxShareCount { get; set; }
		
		/// <summary>
		/// Indicates whether this instance uses a multi-share configuration with which it can have more than one file-share or none at all. File-shares are added, updated and removed through the separate file-share APIs.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="multiShareEnabled")]
		public System.Nullable<System.Boolean> MultiShareEnabled { get; set; }
		...
		public System.Nullable<InstanceProtocol> Protocol { get; set; }
	...
	public class Share
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="mountName")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="state")]
		public System.Nullable<ShareState> State { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// File_projects_locations_operations_delete v1beta1/{name}
		/// </summary>
		/// <param name="name">The name of the operation resource to be deleted.</param>
		/// <param name="force">If set to true, any snapshots of the instance will also be deleted. (Otherwise, the request will only work if the instance has no snapshots.)</param>
		...
		/// File_projects_locations_operations_get v1beta1/{name}
		/// </summary>
		...
		/// File_projects_locations_instances_snapshots_patch v1beta1/{name}
		/// </summary>
		...
		/// File_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/locations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&includeUnrevealedLocations="+includeUnrevealedLocations+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// File_projects_locations_operations_list v1beta1/{name}/operations
		/// </summary>
		...
		/// File_projects_locations_operations_cancel v1beta1/{name}:cancel
		/// </summary>
		...
		/// File_projects_locations_instances_restore v1beta1/{name}:restore
		/// </summary>
		/// <param name="name">Required. The resource name of the instance, in the format `projects/{project_id}/locations/{location_id}/instances/{instance_id}`.</param>
		/// <returns>Successful response</returns>
		...
		/// File_projects_locations_instances_revert v1beta1/{name}:revert
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":revert";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// File_projects_locations_backups_list v1beta1/{parent}/backups
		/// </summary>
		...
		/// <summary>
		/// Creates a backup.
		/// File_projects_locations_backups_create v1beta1/{parent}/backups
		/// </summary>
		/// <param name="parent">Required. The backup's project and location, in the format `projects/{project_id}/locations/{location}`. In Filestore, backup locations map to Google Cloud regions, for example **us-west1**.</param>
		/// <param name="backupId">Required. The ID to use for the backup. The ID must be unique within the specified project and location. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen.</param>
		/// <returns>Successful response</returns>
		...
		/// File_projects_locations_instances_list v1beta1/{parent}/instances
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/instances&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// File_projects_locations_instances_create v1beta1/{parent}/instances
		/// </summary>
		...
		/// <param name="instanceId">Required. The ID of the instance to create. The ID must be unique within the specified project and location. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/instances&instanceId=" + (instanceId==null? "" : System.Uri.EscapeDataString(instanceId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// File_projects_locations_instances_shares_list v1beta1/{parent}/shares
		/// </summary>
		/// <param name="parent">Required. The instance for which to retrieve share information, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}`.</param>
		/// <param name="filter">List filter.</param>
		/// <param name="orderBy">Sort results. Supported values are "name", "name desc" or "" (unsorted).</param>
		/// <param name="pageSize">The maximum number of items to return.</param>
		/// <param name="pageToken">The next_page_token value to use if there are additional results to retrieve for this list request.</param>
		/// <returns>Successful response</returns>
		public async Task<ListSharesResponse> File_projects_locations_instances_shares_listAsync(string parent, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/shares&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListSharesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <summary>
		/// Creates a share.
		/// File_projects_locations_instances_shares_create v1beta1/{parent}/shares
		/// </summary>
		/// <param name="parent">Required. The Filestore Instance to create the share for, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}`</param>
		/// <param name="shareId">Required. The ID to use for the share. The ID must be unique within the specified instance. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> File_projects_locations_instances_shares_createAsync(string parent, string shareId, Share requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/shares&shareId=" + (shareId==null? "" : System.Uri.EscapeDataString(shareId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// File_projects_locations_instances_snapshots_list v1beta1/{parent}/snapshots
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/snapshots&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Creates a snapshot.
		/// File_projects_locations_instances_snapshots_create v1beta1/{parent}/snapshots
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/snapshots&snapshotId=" + (snapshotId==null? "" : System.Uri.EscapeDataString(snapshotId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
