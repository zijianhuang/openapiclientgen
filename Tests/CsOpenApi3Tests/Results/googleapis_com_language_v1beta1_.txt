...
namespace MyNS
{
	...
	public class Sentiment
	{
		...
		public System.Nullable<System.Single> Polarity { get; set; }
	...
	public partial class Misc
	{
		...
		/// Language_documents_analyzeEntities v1beta1/documents:analyzeEntities
		/// </summary>
		...
		{
			var requestUri = "v1beta1/documents:analyzeEntities";
		...
		/// Language_documents_analyzeSentiment v1beta1/documents:analyzeSentiment
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/documents:analyzeSentiment";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Language_documents_analyzeSyntax v1beta1/documents:analyzeSyntax
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/documents:analyzeSyntax";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Language_documents_annotateText v1beta1/documents:annotateText
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/documents:annotateText";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
