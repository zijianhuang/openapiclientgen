...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Metastore_projects_locations_services_backups_delete v1beta/{name}
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
		...
		/// Metastore_projects_locations_services_metadataImports_get v1beta/{name}
		/// </summary>
		...
		public async Task<MetadataImport> Metastore_projects_locations_services_metadataImports_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<MetadataImport>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Metastore_projects_locations_services_metadataImports_patch v1beta/{name}
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
		...
		/// Metastore_projects_locations_list v1beta/{name}/locations
		/// </summary>
		...
		/// Metastore_projects_locations_operations_list v1beta/{name}/operations
		/// </summary>
		...
		/// Metastore_projects_locations_operations_cancel v1beta/{name}:cancel
		/// </summary>
		...
		/// Metastore_projects_locations_services_backups_list v1beta/{parent}/backups
		/// </summary>
		...
		/// Metastore_projects_locations_services_backups_create v1beta/{parent}/backups
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/backups&backupId=" + (backupId==null? "" : System.Uri.EscapeDataString(backupId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_federations_list v1beta/{parent}/federations
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/federations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListFederationsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Metastore_projects_locations_federations_create v1beta/{parent}/federations
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/federations&federationId=" + (federationId==null? "" : System.Uri.EscapeDataString(federationId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_metadataImports_list v1beta/{parent}/metadataImports
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/metadataImports&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListMetadataImportsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Metastore_projects_locations_services_metadataImports_create v1beta/{parent}/metadataImports
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/metadataImports&metadataImportId=" + (metadataImportId==null? "" : System.Uri.EscapeDataString(metadataImportId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_list v1beta/{parent}/services
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/services&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Metastore_projects_locations_services_create v1beta/{parent}/services
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/services&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&serviceId=" + (serviceId==null? "" : System.Uri.EscapeDataString(serviceId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_databases_tables_getIamPolicy v1beta/{resource}:getIamPolicy
		/// </summary>
		...
		/// Metastore_projects_locations_services_removeIamPolicy v1beta/{resource}:removeIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":removeIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_databases_tables_setIamPolicy v1beta/{resource}:setIamPolicy
		/// </summary>
		...
		/// Metastore_projects_locations_services_databases_tables_testIamPermissions v1beta/{resource}:testIamPermissions
		/// </summary>
		...
		/// Metastore_projects_locations_services_alterLocation v1beta/{service}:alterLocation
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":alterLocation";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_alterTableProperties v1beta/{service}:alterTableProperties
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":alterTableProperties";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_exportMetadata v1beta/{service}:exportMetadata
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":exportMetadata";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_moveTableToDatabase v1beta/{service}:moveTableToDatabase
		/// </summary>
		/// <param name="service">Required. The relative resource name of the metastore service to mutate metadata, in the following format:projects/{project_id}/locations/{location_id}/services/{service_id}.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":moveTableToDatabase";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Query DPMS metadata.
		/// Metastore_projects_locations_services_queryMetadata v1beta/{service}:queryMetadata
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":queryMetadata";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Metastore_projects_locations_services_restore v1beta/{service}:restore
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (service==null? "" : System.Uri.EscapeDataString(service))+":restore";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
