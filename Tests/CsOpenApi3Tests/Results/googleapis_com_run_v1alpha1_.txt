...
namespace MyNS
{
	...
	public class InstanceSpec
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="activeDeadlineSeconds")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="terminationGracePeriodSeconds")]
	...
	public class InstanceStatus
	{
		...
		public InstanceAttemptResult LastAttemptResult { get; set; }
		
		/// <summary>
		/// Optional. Last exit code seen for this instance. +optional
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="lastExitCode")]
		public System.Nullable<System.Int32> LastExitCode { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="restarted")]
		public System.Nullable<System.Int32> Restarted { get; set; }
	...
	public class JobSpec
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="backoffLimit")]
		public System.Nullable<System.Int32> BackoffLimit { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="completions")]
		public System.Nullable<System.Int32> Completions { get; set; }
		...
		public InstanceTemplateSpec Template { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="ttlSecondsAfterFinished")]
		public System.Nullable<System.Int32> TtlSecondsAfterFinished { get; set; }
	}
	...
	public class JobStatus
	{
		...
		public JobCondition[] Conditions { get; set; }
	...
	public partial class Misc
	{
		...
		/// <summary>
		/// Delete a job.
		/// Run_namespaces_jobs_delete apis/run.googleapis.com/v1alpha1/{name}
		/// </summary>
		/// <param name="name">Required. The name of the job to delete. For Cloud Run (fully managed), replace {namespace_id} with the project ID or number.</param>
		...
		public async Task<Empty> Run_namespaces_jobs_deleteAsync(string name, string apiVersion, string kind, string propagationPolicy, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "apis/run.googleapis.com/v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&apiVersion=" + (apiVersion==null? "" : System.Uri.EscapeDataString(apiVersion))+"&kind=" + (kind==null? "" : System.Uri.EscapeDataString(kind))+"&propagationPolicy=" + (propagationPolicy==null? "" : System.Uri.EscapeDataString(propagationPolicy));
		...
		/// Run_namespaces_jobs_get apis/run.googleapis.com/v1alpha1/{name}
		/// </summary>
		/// <param name="name">Required. The name of the job to retrieve. For Cloud Run (fully managed), replace {namespace_id} with the project ID or number.</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Run_namespaces_jobs_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "apis/run.googleapis.com/v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// <summary>
		/// List jobs.
		/// Run_namespaces_jobs_list apis/run.googleapis.com/v1alpha1/{parent}/jobs
		/// </summary>
		/// <param name="parent">Required. The namespace from which the jobs should be listed. Replace {namespace_id} with the project ID or number.</param>
		/// <param name="_continue">Optional. Optional encoded string to continue paging.</param>
		/// <param name="fieldSelector">Optional. Allows to filter resources based on a specific value for a field name. Send this in a query string format. i.e. 'metadata.name%3Dlorem'. Not currently used by Cloud Run.</param>
		/// <param name="includeUninitialized">Optional. Not currently used by Cloud Run.</param>
		...
		/// <param name="resourceVersion">Optional. The baseline resource version from which the list or watch operation should start. Not currently used by Cloud Run.</param>
		/// <param name="watch">Optional. Flag that indicates that the client expects to watch this resource as well. Not currently used by Cloud Run.</param>
		/// <returns>Successful response</returns>
		...
		/// <summary>
		/// Create a job.
		/// Run_namespaces_jobs_create apis/run.googleapis.com/v1alpha1/{parent}/jobs
		/// </summary>
		/// <param name="parent">Required. The namespace in which the job should be created. Replace {namespace_id} with the project ID or number.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "apis/run.googleapis.com/v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs";
