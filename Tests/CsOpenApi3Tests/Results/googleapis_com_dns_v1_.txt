...
namespace MyNS
{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class ResourceRecordSetsDeleteResponse
	{
	}
	...
	public partial class Misc
	{
		...
		/// Dns_projects_get dns/v1/projects/{project}
		/// </summary>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
		...
		/// Dns_managedZones_list dns/v1/projects/{project}/managedZones
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones&dnsName=" + (dnsName==null? "" : System.Uri.EscapeDataString(dnsName))+"&maxResults="+maxResults+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_managedZones_create dns/v1/projects/{project}/managedZones
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
		...
		/// Dns_managedZones_delete dns/v1/projects/{project}/managedZones/{managedZone}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
		...
		/// Dns_managedZones_get dns/v1/projects/{project}/managedZones/{managedZone}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_managedZones_patch dns/v1/projects/{project}/managedZones/{managedZone}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_managedZones_update dns/v1/projects/{project}/managedZones/{managedZone}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_changes_list dns/v1/projects/{project}/managedZones/{managedZone}/changes
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="maxResults">Optional. Maximum number of results to be returned. If unspecified, the server decides how many results to return.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/changes&maxResults="+maxResults+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&sortBy=" + sortBy+"&sortOrder=" + (sortOrder==null? "" : System.Uri.EscapeDataString(sortOrder));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_changes_create dns/v1/projects/{project}/managedZones/{managedZone}/changes
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/changes&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dns_changes_get dns/v1/projects/{project}/managedZones/{managedZone}/changes/{changeId}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/changes/"+ (changeId==null? "" : System.Uri.EscapeDataString(changeId))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_dnsKeys_list dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/dnsKeys&digestType=" + (digestType==null? "" : System.Uri.EscapeDataString(digestType))+"&maxResults="+maxResults+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_dnsKeys_get dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/dnsKeys/"+ (dnsKeyId==null? "" : System.Uri.EscapeDataString(dnsKeyId))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId))+"&digestType=" + (digestType==null? "" : System.Uri.EscapeDataString(digestType));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_managedZoneOperations_list dns/v1/projects/{project}/managedZones/{managedZone}/operations
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/operations&maxResults="+maxResults+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&sortBy=" + sortBy;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_managedZoneOperations_get dns/v1/projects/{project}/managedZones/{managedZone}/operations/{operation}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/operations/"+ (operation==null? "" : System.Uri.EscapeDataString(operation))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_resourceRecordSets_list dns/v1/projects/{project}/managedZones/{managedZone}/rrsets
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="maxResults">Optional. Maximum number of results to be returned. If unspecified, the server decides how many results to return.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/rrsets&maxResults="+maxResults+"&name=" + (name==null? "" : System.Uri.EscapeDataString(name))+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&type=" + (type==null? "" : System.Uri.EscapeDataString(type));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_resourceRecordSets_create dns/v1/projects/{project}/managedZones/{managedZone}/rrsets
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/rrsets&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dns_resourceRecordSets_delete dns/v1/projects/{project}/managedZones/{managedZone}/rrsets/{name}/{type}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		...
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		/// <returns>Successful response</returns>
		public async Task<ResourceRecordSetsDeleteResponse> Dns_resourceRecordSets_deleteAsync(string project, string managedZone, string name, string type, string clientOperationId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/managedZones/"+ (managedZone==null? "" : System.Uri.EscapeDataString(managedZone))+"/rrsets/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/"+ (type==null? "" : System.Uri.EscapeDataString(type))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ResourceRecordSetsDeleteResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Dns_resourceRecordSets_get dns/v1/projects/{project}/managedZones/{managedZone}/rrsets/{name}/{type}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="name">Fully qualified domain name.</param>
		...
		/// Dns_resourceRecordSets_patch dns/v1/projects/{project}/managedZones/{managedZone}/rrsets/{name}/{type}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="managedZone">Identifies the managed zone addressed by this request. Can be the managed zone name or ID.</param>
		/// <param name="name">Fully qualified domain name.</param>
		...
		/// Dns_policies_list dns/v1/projects/{project}/policies
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="maxResults">Optional. Maximum number of results to be returned. If unspecified, the server decides how many results to return.</param>
		/// <param name="pageToken">Optional. A tag returned by a previous list request that was truncated. Use this parameter to continue a previous list request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/policies&maxResults="+maxResults+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_policies_create dns/v1/projects/{project}/policies
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/policies&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dns_policies_delete dns/v1/projects/{project}/policies/{policy}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/policies/"+ (policy==null? "" : System.Uri.EscapeDataString(policy))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_policies_get dns/v1/projects/{project}/policies/{policy}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="policy">User given friendly name of the policy addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_policies_patch dns/v1/projects/{project}/policies/{policy}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="policy">User given friendly name of the policy addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_policies_update dns/v1/projects/{project}/policies/{policy}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="policy">User given friendly name of the policy addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_responsePolicies_list dns/v1/projects/{project}/responsePolicies
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="maxResults">Optional. Maximum number of results to be returned. If unspecified, the server decides how many results to return.</param>
		/// <param name="pageToken">Optional. A tag returned by a previous list request that was truncated. Use this parameter to continue a previous list request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/responsePolicies&maxResults="+maxResults+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_responsePolicies_create dns/v1/projects/{project}/responsePolicies
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/responsePolicies&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dns_responsePolicies_delete dns/v1/projects/{project}/responsePolicies/{responsePolicy}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/responsePolicies/"+ (responsePolicy==null? "" : System.Uri.EscapeDataString(responsePolicy))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_responsePolicies_get dns/v1/projects/{project}/responsePolicies/{responsePolicy}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="responsePolicy">User assigned name of the Response Policy addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_responsePolicies_patch dns/v1/projects/{project}/responsePolicies/{responsePolicy}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="responsePolicy">User assigned name of the response policy addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_responsePolicies_update dns/v1/projects/{project}/responsePolicies/{responsePolicy}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="responsePolicy">User assigned name of the Response Policy addressed by this request.</param>
		/// <param name="clientOperationId">For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.</param>
		...
		/// Dns_responsePolicyRules_list dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/responsePolicies/"+ (responsePolicy==null? "" : System.Uri.EscapeDataString(responsePolicy))+"/rules&maxResults="+maxResults+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_responsePolicyRules_create dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/responsePolicies/"+ (responsePolicy==null? "" : System.Uri.EscapeDataString(responsePolicy))+"/rules&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dns_responsePolicyRules_delete dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="responsePolicy">User assigned name of the Response Policy containing the Response Policy Rule.</param>
		...
		{
			var requestUri = "dns/v1/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/responsePolicies/"+ (responsePolicy==null? "" : System.Uri.EscapeDataString(responsePolicy))+"/rules/"+ (responsePolicyRule==null? "" : System.Uri.EscapeDataString(responsePolicyRule))+"&clientOperationId=" + (clientOperationId==null? "" : System.Uri.EscapeDataString(clientOperationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Dns_responsePolicyRules_get dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="responsePolicy">User assigned name of the Response Policy containing the Response Policy Rule.</param>
		/// <param name="responsePolicyRule">User assigned name of the Response Policy Rule addressed by this request.</param>
		...
		/// Dns_responsePolicyRules_patch dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="responsePolicy">User assigned name of the Response Policy containing the Response Policy Rule.</param>
		/// <param name="responsePolicyRule">User assigned name of the Response Policy Rule addressed by this request.</param>
		...
		/// Dns_responsePolicyRules_update dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}
		/// </summary>
		/// <param name="project">Identifies the project addressed by this request.</param>
		/// <param name="responsePolicy">User assigned name of the Response Policy containing the Response Policy Rule.</param>
		/// <param name="responsePolicyRule">User assigned name of the Response Policy Rule addressed by this request.</param>
		...
		/// Dns_managedZones_getIamPolicy dns/v1/{resource}:getIamPolicy
		/// </summary>
		...
		{
			var requestUri = "dns/v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":getIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dns_managedZones_setIamPolicy dns/v1/{resource}:setIamPolicy
		/// </summary>
		...
		{
			var requestUri = "dns/v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":setIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dns_managedZones_testIamPermissions dns/v1/{resource}:testIamPermissions
		/// </summary>
		...
		{
			var requestUri = "dns/v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":testIamPermissions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
