...
namespace MyNS
{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class IdentityPoolTagsType
	{
	}
	...
	public class DeleteIdentitiesInput
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public string[] IdentityIdsToDelete { get; set; }
	}
	...
	public class GetOpenIdTokenForDeveloperIdentityInput
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public PrincipalTags PrincipalTags { get; set; }
	...
	public class GetPrincipalTagAttributeMapResponse
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Boolean> UseDefaults { get; set; }
	...
	public class LookupDeveloperIdentityResponse
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public string[] DeveloperUserIdentifierList { get; set; }
	...
	public class UnlinkIdentityInput
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public string[] LoginsToRemove { get; set; }
	}
	...
	public class RoleMapping
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public AmbiguousRoleResolutionType AmbiguousRoleResolution { get; set; }
	...
	public partial class Misc
	{
		...
		public async Task<IdentityPool> CreateIdentityPoolAsync(CreateIdentityPoolInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<IdentityPool>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		public async Task<DeleteIdentitiesResponse> DeleteIdentitiesAsync(DeleteIdentitiesInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteIdentitiesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<IdentityDescription> DescribeIdentityAsync(DescribeIdentityInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<IdentityDescription>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetCredentialsForIdentityResponse> GetCredentialsForIdentityAsync(GetCredentialsForIdentityInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetCredentialsForIdentityResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetIdResponse> GetIdAsync(GetIdInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetIdResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetIdentityPoolRolesResponse> GetIdentityPoolRolesAsync(GetIdentityPoolRolesInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetIdentityPoolRolesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetOpenIdTokenResponse> GetOpenIdTokenAsync(GetOpenIdTokenInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetOpenIdTokenResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetOpenIdTokenForDeveloperIdentityResponse> GetOpenIdTokenForDeveloperIdentityAsync(GetOpenIdTokenForDeveloperIdentityInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetOpenIdTokenForDeveloperIdentityResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// GetPrincipalTagAttributeMap #X-Amz-Target=AWSCognitoIdentityService.GetPrincipalTagAttributeMap
		/// </summary>
		/// <returns>Success</returns>
		public async Task<GetPrincipalTagAttributeMapResponse> GetPrincipalTagAttributeMapAsync(GetPrincipalTagAttributeMapInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=AWSCognitoIdentityService.GetPrincipalTagAttributeMap";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetPrincipalTagAttributeMapResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListIdentitiesResponse> ListIdentitiesAsync(ListIdentitiesInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListIdentitiesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>Success</returns>
		public async Task<ListIdentityPoolsResponse> ListIdentityPoolsAsync(string MaxResults, string NextToken, ListIdentityPoolsInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=AWSCognitoIdentityService.ListIdentityPools?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListIdentityPoolsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<LookupDeveloperIdentityResponse> LookupDeveloperIdentityAsync(LookupDeveloperIdentityInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<LookupDeveloperIdentityResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<MergeDeveloperIdentitiesResponse> MergeDeveloperIdentitiesAsync(MergeDeveloperIdentitiesInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<MergeDeveloperIdentitiesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// SetPrincipalTagAttributeMap #X-Amz-Target=AWSCognitoIdentityService.SetPrincipalTagAttributeMap
		/// </summary>
		/// <returns>Success</returns>
		public async Task<SetPrincipalTagAttributeMapResponse> SetPrincipalTagAttributeMapAsync(SetPrincipalTagAttributeMapInput requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=AWSCognitoIdentityService.SetPrincipalTagAttributeMap";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SetPrincipalTagAttributeMapResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
	...
	public enum CreateIdentityPoolX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.CreateIdentityPool")]
		AWSCognitoIdentityService_CreateIdentityPool = 0,
	}
	
	public enum DeleteIdentitiesX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.DeleteIdentities")]
		AWSCognitoIdentityService_DeleteIdentities = 0,
	}
	
	public enum DeleteIdentityPoolX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.DeleteIdentityPool")]
		AWSCognitoIdentityService_DeleteIdentityPool = 0,
	}
	
	public enum DescribeIdentityX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.DescribeIdentity")]
		AWSCognitoIdentityService_DescribeIdentity = 0,
	}
	
	public enum DescribeIdentityPoolX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.DescribeIdentityPool")]
		AWSCognitoIdentityService_DescribeIdentityPool = 0,
	}
	
	public enum GetCredentialsForIdentityX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.GetCredentialsForIdentity")]
		AWSCognitoIdentityService_GetCredentialsForIdentity = 0,
	}
	
	public enum GetIdX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.GetId")]
		AWSCognitoIdentityService_GetId = 0,
	}
	
	public enum GetIdentityPoolRolesX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.GetIdentityPoolRoles")]
		AWSCognitoIdentityService_GetIdentityPoolRoles = 0,
	}
	
	public enum GetOpenIdTokenX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.GetOpenIdToken")]
		AWSCognitoIdentityService_GetOpenIdToken = 0,
	}
	
	public enum GetOpenIdTokenForDeveloperIdentityX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.GetOpenIdTokenForDeveloperIdentity")]
		AWSCognitoIdentityService_GetOpenIdTokenForDeveloperIdentity = 0,
	}
	
	public enum GetPrincipalTagAttributeMapX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.GetPrincipalTagAttributeMap")]
		AWSCognitoIdentityService_GetPrincipalTagAttributeMap = 0,
	}
	
	public enum ListIdentitiesX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.ListIdentities")]
		AWSCognitoIdentityService_ListIdentities = 0,
	}
	
	public enum ListIdentityPoolsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.ListIdentityPools")]
		AWSCognitoIdentityService_ListIdentityPools = 0,
	}
	
	public enum ListTagsForResourceX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.ListTagsForResource")]
		AWSCognitoIdentityService_ListTagsForResource = 0,
	}
	
	public enum LookupDeveloperIdentityX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.LookupDeveloperIdentity")]
		AWSCognitoIdentityService_LookupDeveloperIdentity = 0,
	}
	
	public enum MergeDeveloperIdentitiesX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.MergeDeveloperIdentities")]
		AWSCognitoIdentityService_MergeDeveloperIdentities = 0,
	}
	
	public enum SetIdentityPoolRolesX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.SetIdentityPoolRoles")]
		AWSCognitoIdentityService_SetIdentityPoolRoles = 0,
	}
	
	public enum SetPrincipalTagAttributeMapX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.SetPrincipalTagAttributeMap")]
		AWSCognitoIdentityService_SetPrincipalTagAttributeMap = 0,
	}
	
	public enum TagResourceX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.TagResource")]
		AWSCognitoIdentityService_TagResource = 0,
	}
	
	public enum UnlinkDeveloperIdentityX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.UnlinkDeveloperIdentity")]
		AWSCognitoIdentityService_UnlinkDeveloperIdentity = 0,
	}
	
	public enum UnlinkIdentityX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.UnlinkIdentity")]
		AWSCognitoIdentityService_UnlinkIdentity = 0,
	}
	
	public enum UntagResourceX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.UntagResource")]
		AWSCognitoIdentityService_UntagResource = 0,
	}
	
	public enum UpdateIdentityPoolX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AWSCognitoIdentityService.UpdateIdentityPool")]
		AWSCognitoIdentityService_UpdateIdentityPool = 0,
	}
}
