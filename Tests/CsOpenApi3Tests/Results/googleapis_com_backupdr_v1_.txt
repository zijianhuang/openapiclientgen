...
namespace MyNS
{
	...
	public class ListManagementServersResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="managementServers")]
		public ManagementServer[] ManagementServers { get; set; }
	...
	public class ManagementServer
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="managementUri")]
		...
		public System.Nullable<ManagementServerState> State { get; set; }
		
		/// <summary>
		/// Optional. The type of the ManagementServer resource.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="type")]
		public System.Nullable<ManagementServerType> Type { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="workforceIdentityBasedManagementUri")]
		public WorkforceIdentityBasedManagementURI WorkforceIdentityBasedManagementUri { get; set; }
		
		/// <summary>
		/// OAuth Client ID depending on the Workforce Identity i.e. either 1p or 3p,
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="workforceIdentityBasedOauth2ClientId")]
	...
	public class ManagementURI
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="webUi")]
	...
	public class NetworkConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="peeringMode")]
		public System.Nullable<NetworkConfigPeeringMode> PeeringMode { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum NetworkConfigPeeringMode
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum ManagementServerType
	{
	...
	public class WorkforceIdentityBasedManagementURI
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="firstPartyManagementUri")]
		public string FirstPartyManagementUri { get; set; }
		
		/// <summary>
		/// Output only. Third party Management URI for External Identity Providers.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="thirdPartyManagementUri")]
	...
	public class WorkforceIdentityBasedOAuth2ClientID
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="firstPartyOauth2ClientId")]
		public string FirstPartyOauth2ClientId { get; set; }
		
		/// <summary>
		/// Output only. Third party OAuth Client ID for External Identity Providers.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="thirdPartyOauth2ClientId")]
	...
	public partial class Misc
	{
		...
		/// Backupdr_projects_locations_operations_delete v1/{name}
		/// </summary>
		...
		public async Task<Empty> Backupdr_projects_locations_operations_deleteAsync(string name, string requestId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Backupdr_projects_locations_operations_get v1/{name}
		/// </summary>
		/// <param name="name">The name of the operation resource.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Backupdr_projects_locations_operations_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Backupdr_projects_locations_list v1/{name}/locations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListLocationsResponse> Backupdr_projects_locations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Backupdr_projects_locations_operations_list v1/{name}/operations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Backupdr_projects_locations_operations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Backupdr_projects_locations_operations_cancel v1/{name}:cancel
		/// </summary>
		/// <param name="name">The name of the operation resource to be cancelled.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Backupdr_projects_locations_operations_cancelAsync(string name, CancelOperationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Backupdr_projects_locations_managementServers_list v1/{parent}/managementServers
		/// </summary>
		/// <param name="parent">Required. The project and location for which to retrieve management servers information, in the format `projects/{project_id}/locations/{location}`. In Cloud BackupDR, locations map to GCP regions, for example **us-central1**. To retrieve management servers for all locations, use "-" for the `{location}` value.</param>
		...
		/// <returns>Successful response</returns>
		public async Task<ListManagementServersResponse> Backupdr_projects_locations_managementServers_listAsync(string parent, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/managementServers&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListManagementServersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Backupdr_projects_locations_managementServers_create v1/{parent}/managementServers
		/// </summary>
		/// <param name="parent">Required. The management server project and location in the format `projects/{project_id}/locations/{location}`. In Cloud Backup and DR locations map to GCP regions, for example **us-central1**.</param>
		/// <param name="managementServerId">Required. The name of the management server to create. The name must be unique for the specified project and location.</param>
		/// <param name="requestId">Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Backupdr_projects_locations_managementServers_createAsync(string parent, string managementServerId, string requestId, ManagementServer requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/managementServers&managementServerId=" + (managementServerId==null? "" : System.Uri.EscapeDataString(managementServerId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Backupdr_projects_locations_managementServers_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Backupdr_projects_locations_managementServers_getIamPolicyAsync(string resource, int options_requestedPolicyVersion, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Backupdr_projects_locations_managementServers_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Backupdr_projects_locations_managementServers_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Backupdr_projects_locations_managementServers_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Backupdr_projects_locations_managementServers_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
