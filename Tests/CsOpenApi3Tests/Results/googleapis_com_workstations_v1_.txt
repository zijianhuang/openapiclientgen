...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_delete v1/{name}
		/// </summary>
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_get v1/{name}
		/// </summary>
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_patch v1/{name}
		/// </summary>
		...
		/// Workstations_projects_locations_list v1/{name}/locations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListLocationsResponse> Workstations_projects_locations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Workstations_projects_locations_operations_list v1/{name}/operations
		/// </summary>
		...
		/// Workstations_projects_locations_operations_cancel v1/{name}:cancel
		/// </summary>
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_start v1/{name}:start
		/// </summary>
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_stop v1/{name}:stop
		/// </summary>
		...
		/// Workstations_projects_locations_workstationClusters_list v1/{parent}/workstationClusters
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/workstationClusters&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Workstations_projects_locations_workstationClusters_create v1/{parent}/workstationClusters
		/// </summary>
		/// <param name="parent">Required. Parent resource name.</param>
		/// <param name="validateOnly">Optional. If set, validate the request and preview the review, but do not actually apply it.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/workstationClusters&validateOnly="+validateOnly+"&workstationClusterId=" + (workstationClusterId==null? "" : System.Uri.EscapeDataString(workstationClusterId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_list v1/{parent}/workstationConfigs
		/// </summary>
		/// <param name="parent">Required. Parent resource name.</param>
		/// <param name="pageSize">Optional. Maximum number of items to return.</param>
		/// <param name="pageToken">Optional. next_page_token value returned from a previous List request, if any.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/workstationConfigs&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_create v1/{parent}/workstationConfigs
		/// </summary>
		/// <param name="parent">Required. Parent resource name.</param>
		/// <param name="validateOnly">Optional. If set, validate the request and preview the review, but do not actually apply it.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/workstationConfigs&validateOnly="+validateOnly+"&workstationConfigId=" + (workstationConfigId==null? "" : System.Uri.EscapeDataString(workstationConfigId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_listUsable v1/{parent}/workstationConfigs:listUsable
		/// </summary>
		/// <param name="parent">Required. Parent resource name.</param>
		/// <param name="pageSize">Optional. Maximum number of items to return.</param>
		/// <param name="pageToken">Optional. next_page_token value returned from a previous List request, if any.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/workstationConfigs:listUsable&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_list v1/{parent}/workstations
		/// </summary>
		/// <param name="parent">Required. Parent resource name.</param>
		/// <param name="pageSize">Optional. Maximum number of items to return.</param>
		/// <param name="pageToken">Optional. next_page_token value returned from a previous List request, if any.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/workstations&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_create v1/{parent}/workstations
		/// </summary>
		/// <param name="parent">Required. Parent resource name.</param>
		/// <param name="validateOnly">Optional. If set, validate the request and preview the review, but do not actually apply it.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/workstations&validateOnly="+validateOnly+"&workstationId=" + (workstationId==null? "" : System.Uri.EscapeDataString(workstationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_listUsable v1/{parent}/workstations:listUsable
		/// </summary>
		/// <param name="parent">Required. Parent resource name.</param>
		/// <param name="pageSize">Optional. Maximum number of items to return.</param>
		/// <param name="pageToken">Optional. next_page_token value returned from a previous List request, if any.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/workstations:listUsable&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
		...
		/// Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_generateAccessToken v1/{workstation}:generateAccessToken
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (workstation==null? "" : System.Uri.EscapeDataString(workstation))+":generateAccessToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
