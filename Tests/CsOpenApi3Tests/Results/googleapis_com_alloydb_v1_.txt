...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Alloydb_projects_locations_operations_delete v1/{name}
		/// </summary>
		...
		/// Alloydb_projects_locations_operations_get v1/{name}
		/// </summary>
		...
		/// Alloydb_projects_locations_clusters_users_patch v1/{name}
		/// </summary>
		...
		/// Alloydb_projects_locations_list v1/{name}/locations
		/// </summary>
		...
		/// Alloydb_projects_locations_operations_list v1/{name}/operations
		/// </summary>
		...
		/// Alloydb_projects_locations_operations_cancel v1/{name}:cancel
		/// </summary>
		...
		/// Alloydb_projects_locations_clusters_instances_failover v1/{name}:failover
		/// </summary>
		...
		/// Alloydb_projects_locations_clusters_instances_injectFault v1/{name}:injectFault
		/// </summary>
		/// <param name="name">Required. The name of the resource. For the required format, see the comment on the Instance.name field.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":injectFault";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Alloydb_projects_locations_clusters_promote v1/{name}:promote
		/// </summary>
		...
		/// Alloydb_projects_locations_clusters_instances_restart v1/{name}:restart
		/// </summary>
		/// <param name="name">Required. The name of the resource. For the required format, see the comment on the Instance.name field.</param>
		/// <returns>Successful response</returns>
		...
		/// Alloydb_projects_locations_backups_list v1/{parent}/backups
		/// </summary>
		...
		/// Alloydb_projects_locations_backups_create v1/{parent}/backups
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/backups&backupId=" + (backupId==null? "" : System.Uri.EscapeDataString(backupId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&validateOnly="+validateOnly;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Alloydb_projects_locations_clusters_list v1/{parent}/clusters
		/// </summary>
		...
		/// Alloydb_projects_locations_clusters_create v1/{parent}/clusters
		/// </summary>
		...
		/// Alloydb_projects_locations_clusters_createsecondary v1/{parent}/clusters:createsecondary
		/// </summary>
		/// <param name="parent">Required. The location of the new cluster. For the required format, see the comment on the Cluster.name field.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/clusters:createsecondary&clusterId=" + (clusterId==null? "" : System.Uri.EscapeDataString(clusterId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&validateOnly="+validateOnly;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Alloydb_projects_locations_clusters_restore v1/{parent}/clusters:restore
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/clusters:restore";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Alloydb_projects_locations_clusters_instances_getConnectionInfo v1/{parent}/connectionInfo
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/connectionInfo&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Alloydb_projects_locations_clusters_instances_list v1/{parent}/instances
		/// </summary>
		...
		/// Alloydb_projects_locations_clusters_instances_create v1/{parent}/instances
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/instances&instanceId=" + (instanceId==null? "" : System.Uri.EscapeDataString(instanceId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&validateOnly="+validateOnly;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Alloydb_projects_locations_clusters_instances_createsecondary v1/{parent}/instances:createsecondary
		/// </summary>
		/// <param name="parent">Required. The name of the parent resource. For the required format, see the comment on the Instance.name field.</param>
		/// <param name="instanceId">Required. ID of the requesting object.</param>
		/// <param name="requestId">Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/instances:createsecondary&instanceId=" + (instanceId==null? "" : System.Uri.EscapeDataString(instanceId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&validateOnly="+validateOnly;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Alloydb_projects_locations_supportedDatabaseFlags_list v1/{parent}/supportedDatabaseFlags
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/supportedDatabaseFlags&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Alloydb_projects_locations_clusters_users_list v1/{parent}/users
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/users&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Alloydb_projects_locations_clusters_users_create v1/{parent}/users
		/// </summary>
		/// <param name="parent">Required. Value for parent.</param>
		/// <param name="requestId">Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/users&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&userId=" + (userId==null? "" : System.Uri.EscapeDataString(userId))+"&validateOnly="+validateOnly;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Alloydb_projects_locations_clusters_generateClientCertificate v1/{parent}:generateClientCertificate
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":generateClientCertificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
