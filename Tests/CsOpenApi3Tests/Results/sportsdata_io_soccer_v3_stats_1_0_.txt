...
namespace MyNS
{
	...
	public class Booking
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> BookingId { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> GameId { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> GameMinute { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> GameMinuteExtra { get; set; }
	...
	public class Lineup
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> LineupId { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public string Name { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> PitchPositionHorizontal { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> PitchPositionVertical { get; set; }
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> ReplacedPlayerId { get; set; }
	...
	public class PenaltyShootout
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> PenaltyShootoutId { get; set; }
	...
	public class Coach
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> CoachId { get; set; }
	...
	public partial class Misc
	{
		...
		public async Task<Area[]> AreasCountriesAsync(MembershipsActiveFormat format, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Area[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<BoxScore> BoxScoreAsync(MembershipsActiveFormat format, string gameid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<BoxScore[]> BoxScoresByDateAsync(MembershipsActiveFormat format, string date, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// BoxScoresByDateByCompetition {format}/BoxScoresByCompetition/{competition}/{date}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="competition">An indication of a soccer competition/league. This value can be the CompetitionId or the Competition Key. Possible values include: <code>EPL</code>, <code>1</code>, <code>MLS</code>, <code>8</code>, etc.</param>
		/// <param name="date">The date of the game(s).
		///<br>Examples: <code>2017-02-27</code>, <code>2017-09-01</code>.</param>
		public async Task<BoxScore[]> BoxScoresByDateByCompetitionAsync(MembershipsActiveFormat format, string competition, string date, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/BoxScoresByCompetition/"+ (competition==null? "" : System.Uri.EscapeDataString(competition))+"/"+ (date==null? "" : System.Uri.EscapeDataString(date));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		public async Task<BoxScore[]> BoxScoresByDateDeltaAsync(MembershipsActiveFormat format, string date, string minutes, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// BoxScoresDeltaByDateByCompetition {format}/BoxScoresDeltaByCompetition/{competition}/{date}/{minutes}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="competition">An indication of a soccer competition/league. This value can be the CompetitionId or the Competition Key. Possible values include: <code>EPL</code>, <code>1</code>, <code>MLS</code>, <code>8</code>, etc.</param>
		/// <param name="date">The date of the game(s).
		...
		/// <param name="minutes">Only returns player statistics that have changed in the last X minutes.  You specify how many minutes in time to go back. Valid entries are:
		///<code>1</code>, <code>2</code> ... <code>all</code>.</param>
		public async Task<BoxScore[]> BoxScoresDeltaByDateByCompetitionAsync(MembershipsActiveFormat format, string competition, string date, string minutes, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/BoxScoresDeltaByCompetition/"+ (competition==null? "" : System.Uri.EscapeDataString(competition))+"/"+ (date==null? "" : System.Uri.EscapeDataString(date))+"/"+ (minutes==null? "" : System.Uri.EscapeDataString(minutes));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		public async Task<CompetitionDetail> CompetitionFixturesLeagueDetailsAsync(MembershipsActiveFormat format, string competition, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CompetitionDetail>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<Competition[]> CompetitionsLeaguesAsync(MembershipsActiveFormat format, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Competition[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="date">The date of the game(s).
		///<br>Examples: <code>2020-02-18</code>.</param>
		...
		/// <param name="date">The date of the game(s).
		///<br>Examples: <code>2017-02-27</code>, <code>2017-09-01</code>.</param>
		public async Task<PlayerGame[]> PlayerGameStatsByDateAsync(MembershipsActiveFormat format, string date, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <param name="playerid">Unique FantasyData Player ID.
		///Example:<code>90026231</code>.</param>
		public async Task<PlayerGame[]> PlayerGameStatsByPlayerAsync(MembershipsActiveFormat format, string date, string playerid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// Player Season Stats
		/// PlayerSeasonStats {format}/PlayerSeasonStats/{roundid}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		...
		public async Task<PlayerSeason[]> PlayerSeasonStatsAsync(MembershipsActiveFormat format, string roundid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/PlayerSeasonStats/"+ (roundid==null? "" : System.Uri.EscapeDataString(roundid));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// PlayerSeasonStatsByPlayer {format}/PlayerSeasonStatsByPlayer/{roundid}/{playerid}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="roundid">Unique FantasyData Round ID. RoundIDs can be found in the Competition Hierarchy (League Hierarchy). 
		///Examples: <code>1</code>, <code>2</code>, <code>3</code>, etc</param>
		/// <param name="playerid">Unique FantasyData Player ID.
		///Example:<code>90026231</code>.</param>
		public async Task<PlayerSeason[]> PlayerSeasonStatsByPlayerAsync(MembershipsActiveFormat format, string roundid, string playerid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/PlayerSeasonStatsByPlayer/"+ (roundid==null? "" : System.Uri.EscapeDataString(roundid))+"/"+ (playerid==null? "" : System.Uri.EscapeDataString(playerid));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// PlayerSeasonStatsByTeam {format}/PlayerSeasonStatsByTeam/{roundid}/{team}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="roundid">Unique FantasyData Round ID. RoundIDs can be found in the Competition Hierarchy (League Hierarchy). 
		///Examples: <code>1</code>, <code>2</code>, <code>3</code>, etc</param>
		/// <param name="team">Unique FantasyData Team ID. 
		///Example:<code>516</code>.</param>
		public async Task<PlayerSeason[]> PlayerSeasonStatsByTeamAsync(MembershipsActiveFormat format, string roundid, string team, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/PlayerSeasonStatsByTeam/"+ (roundid==null? "" : System.Uri.EscapeDataString(roundid))+"/"+ (team==null? "" : System.Uri.EscapeDataString(team));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		public async Task<SeasonTeam[]> SeasonTeamsAsync(MembershipsActiveFormat format, string seasonid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SeasonTeam[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="competitionId">The id of the competition.
