...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// <param name="maxResults">Maximum number of buckets to return.
		/// Minimum: 0
		// </param>
		...
		/// <param name="maxResults">Maximum number of items plus prefixes to return. As duplicate prefixes are omitted, fewer total results may be returned than requested.
		/// Minimum: 0
		// </param>
		/// <param name="pageToken">A previously-returned page token representing part of the larger set of results to view.</param>
