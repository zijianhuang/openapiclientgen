...
namespace MyNS
{
	...
	public class V1Beta1ConsumerQuotaLimit
	{
		...
		public V1Beta1QuotaBucket[] QuotaBuckets { get; set; }
	...
	public class V1Beta1QuotaBucket
	{
		...
		public V1Beta1QuotaOverride AdminOverride { get; set; }
		
		/// <summary>
		/// A quota override
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="consumerOverride")]
		public V1Beta1QuotaOverride ConsumerOverride { get; set; }
		...
		public V1Beta1QuotaOverride ProducerOverride { get; set; }
		
		/// <summary>
		/// Quota policy created by service producer.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="producerQuotaPolicy")]
		public V1Beta1ProducerQuotaPolicy ProducerQuotaPolicy { get; set; }
	}
	...
	public class V1Beta1ConsumerQuotaMetric
	{
		...
		public V1Beta1ConsumerQuotaLimit[] ConsumerQuotaLimits { get; set; }
		...
		public V1Beta1ConsumerQuotaLimit[] DescendantConsumerQuotaLimits { get; set; }
	...
	public class V1Beta1ImportProducerOverridesRequest
	{
		...
		public V1Beta1OverrideInlineSource InlineSource { get; set; }
	}
	...
	public class V1Beta1ListConsumerQuotaMetricsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="metrics")]
		public V1Beta1ConsumerQuotaMetric[] Metrics { get; set; }
	...
	public class V1beta1GenerateDefaultIdentityResponse
	{
		...
		public System.Nullable<V1beta1GenerateDefaultIdentityResponseAttachStatus> AttachStatus { get; set; }
		
		/// <summary>
		/// A default identity in the Identity and Access Management API.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="identity")]
		public V1beta1DefaultIdentity Identity { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum V1beta1GenerateDefaultIdentityResponseAttachStatus
	{
	...
	public class V1beta1GenerateServiceAccountResponse
	{
		...
		public V1beta1ServiceAccount Account { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_delete v1beta1/{name}
		/// </summary>
		/// <param name="name">The resource name of the override to delete. An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerOverrides/4a3f2c1d`</param>
		...
		public async Task<Operation> Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_deleteAsync(string name, bool force, string[] forceOnly, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Serviceconsumermanagement_services_consumerQuotaMetrics_limits_get v1beta1/{name}
		/// </summary>
		/// <param name="name">The resource name of the quota limit, returned by a ListConsumerQuotaMetrics or GetConsumerQuotaMetric call. An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</param>
		/// <param name="view">Specifies the level of detail for quota information in the response.</param>
		/// <returns>Successful response</returns>
		public async Task<V1Beta1ConsumerQuotaLimit> Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getAsync(string name, Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView view, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<V1Beta1ConsumerQuotaLimit>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_patch v1beta1/{name}
		/// </summary>
		/// <param name="name">The resource name of the override to update. An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerOverrides/4a3f2c1d`</param>
		...
		/// <param name="forceOnly">The list of quota safety checks to ignore before the override mutation. Unlike 'force' field that ignores all the quota safety checks, the 'force_only' field ignores only the specified checks; other checks are still enforced. The 'force' and 'force_only' fields cannot both be set.</param>
		/// <param name="updateMask">Update only the specified fields. If unset, all modifiable fields will be updated.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_patchAsync(string name, bool force, string[] forceOnly, string updateMask, V1Beta1QuotaOverride requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Serviceconsumermanagement_services_consumerQuotaMetrics_list v1beta1/{parent}/consumerQuotaMetrics
		/// </summary>
		/// <param name="parent">Parent of the quotas resource. An example parent would be: `services/serviceconsumermanagement.googleapis.com/projects/123`</param>
		...
		/// <param name="view">Specifies the level of detail for quota information in the response.</param>
		/// <returns>Successful response</returns>
		public async Task<V1Beta1ListConsumerQuotaMetricsResponse> Serviceconsumermanagement_services_consumerQuotaMetrics_listAsync(string parent, int pageSize, string pageToken, Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView view, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<V1Beta1ListConsumerQuotaMetricsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Serviceconsumermanagement_services_consumerQuotaMetrics_importProducerOverrides v1beta1/{parent}/consumerQuotaMetrics:importProducerOverrides
		/// </summary>
		/// <param name="parent">The resource name of the consumer. An example name would be: `services/compute.googleapis.com/projects/123`</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Serviceconsumermanagement_services_consumerQuotaMetrics_importProducerOverridesAsync(string parent, V1Beta1ImportProducerOverridesRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/consumerQuotaMetrics:importProducerOverrides";
		...
		/// Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_list v1beta1/{parent}/producerOverrides
		/// </summary>
		/// <param name="parent">The resource name of the parent quota limit, returned by a ListConsumerQuotaMetrics or GetConsumerQuotaMetric call. An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</param>
		/// <param name="pageSize">Requested size of the next page of data.</param>
		/// <param name="pageToken">Token identifying which result to start with; returned by a previous list call.</param>
		/// <returns>Successful response</returns>
		public async Task<V1Beta1ListProducerOverridesResponse> Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/producerOverrides&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<V1Beta1ListProducerOverridesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_create v1beta1/{parent}/producerOverrides
		/// </summary>
		/// <param name="parent">The resource name of the parent quota limit, returned by a ListConsumerQuotaMetrics or GetConsumerQuotaMetric call. An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`</param>
		...
		/// <param name="forceOnly">The list of quota safety checks to ignore before the override mutation. Unlike 'force' field that ignores all the quota safety checks, the 'force_only' field ignores only the specified checks; other checks are still enforced. The 'force' and 'force_only' fields cannot both be set.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_createAsync(string parent, bool force, string[] forceOnly, V1Beta1QuotaOverride requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/producerOverrides&force="+force+"&"+string.Join("&", forceOnly.Select(z => $"forceOnly={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public enum Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView
	{
