...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task LlcerAsync(LlcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "llcer/certificate";
	...
	public class LlcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public LlcerPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public LlcerPostBodyFormat Format { get; set; }
	...
	public class LlcerPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum LlcerPostBodyFormat
	{
