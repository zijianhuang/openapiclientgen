...
namespace MyNS
{
	...
	public class ProvidedContext
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public string ContextAssertion { get; set; }
	}
	...
	public class AssumeRoleRequest
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public ProvidedContext[] ProvidedContexts { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="RoleArn">The Amazon Resource Name (ARN) of the role to assume.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		...
		/// Max length: 6
		// </param>
		/// <param name="SourceIdentity"><p>The source identity specified by the principal that is calling the <code>AssumeRole</code> operation.</p> <p>You can require users to specify a source identity when they assume a role. You do this by using the <code>sts:SourceIdentity</code> condition key in a role trust policy. You can use source identity information in CloudTrail logs to determine who took actions with a role. You can use the <code>aws:SourceIdentity</code> condition key to further control access to Amazon Web Services resources based on the value of source identity. For more information about using source identity, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.html">Monitor and control actions taken with assumed roles</a> in the <i>IAM User Guide</i>.</p> <p>The regex used to validate this parameter is a string of characters consisting of upper- and lower-case alphanumeric characters with no spaces. You can also include underscores or any of the following characters: =,.@-. You cannot use a value that begins with the text <code>aws:</code>. This prefix is reserved for Amazon Web Services internal use.</p>
		/// Min length: 2
		/// Max length: 64
		// </param>
		/// <param name="ProvidedContexts">Reserved for future use.
		/// Maximum items: 5
		// </param>
		/// <returns>Success</returns>
		public async Task GET_AssumeRoleAsync(string RoleArn, string RoleSessionName, PolicyDescriptorType[] PolicyArns, string Policy, int DurationSeconds, Tag[] Tags, string[] TransitiveTagKeys, string ExternalId, string SerialNumber, string TokenCode, string SourceIdentity, ProvidedContext[] ProvidedContexts, GET_AssumeRoleAction Action, GET_AssumeRoleVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=AssumeRole?RoleArn=" + (RoleArn==null? "" : System.Uri.EscapeDataString(RoleArn))+"&RoleSessionName=" + (RoleSessionName==null? "" : System.Uri.EscapeDataString(RoleSessionName))+"&"+string.Join("&", PolicyArns.Select(z => $"PolicyArns={z}"))+"&Policy=" + (Policy==null? "" : System.Uri.EscapeDataString(Policy))+"&DurationSeconds="+DurationSeconds+"&"+string.Join("&", Tags.Select(z => $"Tags={z}"))+"&"+string.Join("&", TransitiveTagKeys.Select(z => $"TransitiveTagKeys={System.Uri.EscapeDataString(z.ToString())}"))+"&ExternalId=" + (ExternalId==null? "" : System.Uri.EscapeDataString(ExternalId))+"&SerialNumber=" + (SerialNumber==null? "" : System.Uri.EscapeDataString(SerialNumber))+"&TokenCode=" + (TokenCode==null? "" : System.Uri.EscapeDataString(TokenCode))+"&SourceIdentity=" + (SourceIdentity==null? "" : System.Uri.EscapeDataString(SourceIdentity))+"&"+string.Join("&", ProvidedContexts.Select(z => $"ProvidedContexts={z}"))+"&Action=" + Action+"&Version=" + Version;
		...
		/// </summary>
		/// <param name="RoleArn">The Amazon Resource Name (ARN) of the role that the caller is assuming.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <param name="PrincipalArn">The Amazon Resource Name (ARN) of the SAML provider in IAM that describes the IdP.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <param name="SAMLAssertion"><p>The base64 encoded SAML authentication response provided by the IdP.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/create-role-saml-IdP-tasks.html">Configuring a Relying Party and Adding Claims</a> in the <i>IAM User Guide</i>. </p>
		/// Min length: 4
		/// Max length: 100000
		// </param>
		/// <param name="PolicyArns"><p>The Amazon Resource Names (ARNs) of the IAM managed policies that you want to use as managed session policies. The policies must exist in the same account as the role.</p> <p>This parameter is optional. You can provide up to 10 managed policy ARNs. However, the plaintext that you use for both inline and managed session policies can't exceed 2,048 characters. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces</a> in the Amazon Web Services General Reference.</p> <note> <p>An Amazon Web Services conversion compresses the passed inline session policy, managed policy ARNs, and session tags into a packed binary format that has a separate limit. Your request can fail for this limit even if your plaintext meets the other requirements. The <code>PackedPolicySize</code> response element indicates by percentage how close the policies and tags for your request are to the upper size limit.</p> </note> <p>Passing policies to this operation returns new temporary credentials. The resulting session's permissions are the intersection of the role's identity-based policy and the session policies. You can use the role's temporary credentials in subsequent Amazon Web Services API calls to access resources in the account that owns the role. You cannot use session policies to grant more permissions than those allowed by the identity-based policy of the role that is being assumed. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#policies_session">Session Policies</a> in the <i>IAM User Guide</i>.</p></param>
		...
		// </param>
		/// <returns>Success</returns>
		public async Task GET_AssumeRoleWithSAMLAsync(string RoleArn, string PrincipalArn, string SAMLAssertion, PolicyDescriptorType[] PolicyArns, string Policy, int DurationSeconds, GET_AssumeRoleWithSAMLAction Action, GET_AssumeRoleWithSAMLVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=AssumeRoleWithSAML?RoleArn=" + (RoleArn==null? "" : System.Uri.EscapeDataString(RoleArn))+"&PrincipalArn=" + (PrincipalArn==null? "" : System.Uri.EscapeDataString(PrincipalArn))+"&SAMLAssertion=" + (SAMLAssertion==null? "" : System.Uri.EscapeDataString(SAMLAssertion))+"&"+string.Join("&", PolicyArns.Select(z => $"PolicyArns={z}"))+"&Policy=" + (Policy==null? "" : System.Uri.EscapeDataString(Policy))+"&DurationSeconds="+DurationSeconds+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Max length: 64
		// </param>
		/// <param name="WebIdentityToken">The OAuth 2.0 access token or OpenID Connect ID token that is provided by the identity provider. Your application must get this token by authenticating the user who is using your application with a web identity provider before the application makes an <code>AssumeRoleWithWebIdentity</code> call. Only tokens with RSA algorithms (RS256) are supported.
		/// Min length: 4
		/// Max length: 20000
		// </param>
		/// <param name="ProviderId"><p>The fully qualified host component of the domain name of the OAuth 2.0 identity provider. Do not specify this value for an OpenID Connect identity provider.</p> <p>Currently <code>www.amazon.com</code> and <code>graph.facebook.com</code> are the only supported identity providers for OAuth 2.0 access tokens. Do not include URL schemes and port numbers.</p> <p>Do not specify this value for OpenID Connect ID tokens.</p>
		/// Min length: 4
		/// Max length: 2048
		// </param>
		/// <param name="PolicyArns"><p>The Amazon Resource Names (ARNs) of the IAM managed policies that you want to use as managed session policies. The policies must exist in the same account as the role.</p> <p>This parameter is optional. You can provide up to 10 managed policy ARNs. However, the plaintext that you use for both inline and managed session policies can't exceed 2,048 characters. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces</a> in the Amazon Web Services General Reference.</p> <note> <p>An Amazon Web Services conversion compresses the passed inline session policy, managed policy ARNs, and session tags into a packed binary format that has a separate limit. Your request can fail for this limit even if your plaintext meets the other requirements. The <code>PackedPolicySize</code> response element indicates by percentage how close the policies and tags for your request are to the upper size limit.</p> </note> <p>Passing policies to this operation returns new temporary credentials. The resulting session's permissions are the intersection of the role's identity-based policy and the session policies. You can use the role's temporary credentials in subsequent Amazon Web Services API calls to access resources in the account that owns the role. You cannot use session policies to grant more permissions than those allowed by the identity-based policy of the role that is being assumed. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#policies_session">Session Policies</a> in the <i>IAM User Guide</i>.</p></param>
		...
		// </param>
		/// <returns>Success</returns>
		public async Task GET_AssumeRoleWithWebIdentityAsync(string RoleArn, string RoleSessionName, string WebIdentityToken, string ProviderId, PolicyDescriptorType[] PolicyArns, string Policy, int DurationSeconds, GET_AssumeRoleWithWebIdentityAction Action, GET_AssumeRoleWithWebIdentityVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=AssumeRoleWithWebIdentity?RoleArn=" + (RoleArn==null? "" : System.Uri.EscapeDataString(RoleArn))+"&RoleSessionName=" + (RoleSessionName==null? "" : System.Uri.EscapeDataString(RoleSessionName))+"&WebIdentityToken=" + (WebIdentityToken==null? "" : System.Uri.EscapeDataString(WebIdentityToken))+"&ProviderId=" + (ProviderId==null? "" : System.Uri.EscapeDataString(ProviderId))+"&"+string.Join("&", PolicyArns.Select(z => $"PolicyArns={z}"))+"&Policy=" + (Policy==null? "" : System.Uri.EscapeDataString(Policy))+"&DurationSeconds="+DurationSeconds+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <param name="EncodedMessage">The encoded message that was returned with the response.
		/// Min length: 1
		/// Max length: 10240
		// </param>
		/// <returns>Success</returns>
		public async Task GET_DecodeAuthorizationMessageAsync(string EncodedMessage, GET_DecodeAuthorizationMessageAction Action, GET_DecodeAuthorizationMessageVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DecodeAuthorizationMessage?EncodedMessage=" + (EncodedMessage==null? "" : System.Uri.EscapeDataString(EncodedMessage))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <param name="AccessKeyId"><p>The identifier of an access key.</p> <p>This parameter allows (through its regex pattern) a string of characters that can consist of any upper- or lowercase letter or digit.</p>
		/// Min length: 16
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		public async Task GET_GetAccessKeyInfoAsync(string AccessKeyId, GET_GetAccessKeyInfoAction Action, GET_GetAccessKeyInfoVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=GetAccessKeyInfo?AccessKeyId=" + (AccessKeyId==null? "" : System.Uri.EscapeDataString(AccessKeyId))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_GetCallerIdentityAsync(GET_GetCallerIdentityAction Action, GET_GetCallerIdentityVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=GetCallerIdentity?Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		// </param>
		/// <returns>Success</returns>
		public async Task GET_GetFederationTokenAsync(string Name, string Policy, PolicyDescriptorType[] PolicyArns, int DurationSeconds, Tag[] Tags, GET_GetFederationTokenAction Action, GET_GetFederationTokenVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=GetFederationToken?Name=" + (Name==null? "" : System.Uri.EscapeDataString(Name))+"&Policy=" + (Policy==null? "" : System.Uri.EscapeDataString(Policy))+"&"+string.Join("&", PolicyArns.Select(z => $"PolicyArns={z}"))+"&DurationSeconds="+DurationSeconds+"&"+string.Join("&", Tags.Select(z => $"Tags={z}"))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		// </param>
		/// <returns>Success</returns>
		public async Task GET_GetSessionTokenAsync(int DurationSeconds, string SerialNumber, string TokenCode, GET_GetSessionTokenAction Action, GET_GetSessionTokenVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=GetSessionToken?DurationSeconds="+DurationSeconds+"&SerialNumber=" + (SerialNumber==null? "" : System.Uri.EscapeDataString(SerialNumber))+"&TokenCode=" + (TokenCode==null? "" : System.Uri.EscapeDataString(TokenCode))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
	...
	public enum GET_AssumeRoleAction
	{
	...
	public enum GET_AssumeRoleVersion
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="2011-06-15")]
		_2011Minus06Minus15 = 0,
	}
	
	public enum POST_AssumeRoleVersion
	{
	...
	public enum GET_AssumeRoleWithSAMLAction
	{
	...
	public enum GET_AssumeRoleWithSAMLVersion
	{
	...
	public enum POST_AssumeRoleWithSAMLVersion
	{
	...
	public enum GET_AssumeRoleWithWebIdentityAction
	{
	...
	public enum GET_AssumeRoleWithWebIdentityVersion
	{
	...
	public enum POST_AssumeRoleWithWebIdentityVersion
	{
	...
	public enum GET_DecodeAuthorizationMessageAction
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		DecodeAuthorizationMessage = 0,
	}
	
	public enum GET_DecodeAuthorizationMessageVersion
	{
	...
	public enum POST_DecodeAuthorizationMessageVersion
	{
	...
	public enum GET_GetAccessKeyInfoAction
	{
	...
	public enum GET_GetAccessKeyInfoVersion
	{
	...
	public enum POST_GetAccessKeyInfoVersion
	{
	...
	public enum GET_GetCallerIdentityAction
	{
	...
	public enum GET_GetCallerIdentityVersion
	{
	...
	public enum POST_GetCallerIdentityVersion
	{
	...
	public enum GET_GetFederationTokenAction
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		GetFederationToken = 0,
	}
	
	public enum GET_GetFederationTokenVersion
	{
	...
	public enum POST_GetFederationTokenVersion
	{
	...
	public enum GET_GetSessionTokenAction
	{
	...
	public enum GET_GetSessionTokenVersion
	{
	...
	public enum POST_GetSessionTokenVersion
	{
