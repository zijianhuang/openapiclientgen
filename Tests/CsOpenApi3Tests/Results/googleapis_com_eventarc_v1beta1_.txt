...
namespace MyNS
{
	...
	public class Destination
	{
		...
		/// Represents a Cloud Run service destination.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="cloudRunService")]
		public CloudRunService CloudRunService { get; set; }
	}
	...
	public class Trigger
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="matchingCriteria")]
	...
	public partial class Misc
	{
		...
		/// Eventarc_projects_locations_triggers_delete v1beta1/{name}
		/// </summary>
		...
		/// <param name="validateOnly">Required. If set, validate the request and preview the review, but do not actually post it.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Eventarc_projects_locations_triggers_deleteAsync(string name, bool allowMissing, string etag, bool validateOnly, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Eventarc_projects_locations_triggers_get v1beta1/{name}
		/// </summary>
		...
		/// Eventarc_projects_locations_triggers_patch v1beta1/{name}
		/// </summary>
		/// <param name="name">Required. The resource name of the trigger. Must be unique within the location on the project and must in `projects/{project}/locations/{location}/triggers/{trigger}` format.</param>
		...
		/// <param name="updateMask">The fields to be updated; only fields explicitly provided will be updated. If no field mask is provided, all provided fields in the request will be updated. To update all fields, provide a field mask of "*".</param>
		/// <param name="validateOnly">Required. If set, validate the request and preview the review, but do not actually post it.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Eventarc_projects_locations_triggers_patchAsync(string name, bool allowMissing, string updateMask, bool validateOnly, Trigger requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&allowMissing="+allowMissing+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask))+"&validateOnly="+validateOnly;
		...
		/// Eventarc_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// Eventarc_projects_locations_operations_list v1beta1/{name}/operations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Eventarc_projects_locations_operations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Eventarc_projects_locations_operations_cancel v1beta1/{name}:cancel
		/// </summary>
		/// <param name="name">The name of the operation resource to be cancelled.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Eventarc_projects_locations_operations_cancelAsync(string name, CancelOperationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// List triggers.
		/// Eventarc_projects_locations_triggers_list v1beta1/{parent}/triggers
		/// </summary>
		/// <param name="parent">Required. The parent collection to list triggers on.</param>
		/// <param name="orderBy">The sorting order of the resources returned. Value should be a comma separated list of fields. The default sorting oder is ascending. To specify descending order for a field, append a ` desc` suffix; for example: `name desc, trigger_id`.</param>
		...
		/// <returns>Successful response</returns>
		public async Task<ListTriggersResponse> Eventarc_projects_locations_triggers_listAsync(string parent, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/triggers&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Eventarc_projects_locations_triggers_create v1beta1/{parent}/triggers
		/// </summary>
		...
		/// <param name="validateOnly">Required. If set, validate the request and preview the review, but do not actually post it.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Eventarc_projects_locations_triggers_createAsync(string parent, string triggerId, bool validateOnly, Trigger requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/triggers&triggerId=" + (triggerId==null? "" : System.Uri.EscapeDataString(triggerId))+"&validateOnly="+validateOnly;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Eventarc_projects_locations_triggers_getIamPolicy v1beta1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Eventarc_projects_locations_triggers_setIamPolicy v1beta1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Eventarc_projects_locations_triggers_testIamPermissions v1beta1/{resource}:testIamPermissions
		/// </summary>
