...
namespace MyNS
{
	...
	public class AdditionalOption
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="additionalCost")]
	...
	public class CreateShipmentFromQuoteRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="labelCustomMessage")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="labelSize")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="rateId")]
		public string RateId { get; set; }
		
		/// <summary>
		/// This complex type contains contact information for an individual buyer or seller.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="returnTo")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="shippingQuoteId")]
	...
	public class PickupSlot
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pickupSlotEndTime")]
		public string PickupSlotEndTime { get; set; }
		
		/// <summary>
		/// Seller-defined name for the pickup slot. <!-- Max characters? -->
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pickupSlotId")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pickupSlotStartTime")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pickupSlotTimeZone")]
	...
	public class PurchasedRate
	{
		...
		/// A complex type that describes the value of a monetary amount as represented by a global currency.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="baseShippingCost")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="destinationTimeZone")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pickupNetworks")]
		public string[] PickupNetworks { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="shippingCarrierName")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="shippingServiceName")]
		public string ShippingServiceName { get; set; }
		
		/// <summary>
		/// A complex type that describes the value of a monetary amount as represented by a global currency.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="totalShippingCost")]
	...
	public class Rate
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pickupSlots")]
		public PickupSlot[] PickupSlots { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="rateRecommendation")]
		public string[] RateRecommendation { get; set; }
	...
	public class Shipment
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="labelDownloadUrl")]
		...
		/// This complex type specifies the dimensions and weight of a package.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="packageSpecification")]
		...
		/// This complex type contains contact information for an individual buyer or seller.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="shipFrom")]
	...
	public class ShipmentCancellation
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="cancellationRequestedDate")]
	...
	public partial class Misc
	{
		...
		/// CreateFromShippingQuote shipment/create_from_shipping_quote
		/// </summary>
		/// <param name="requestBody">The create shipment from quote request.</param>
		public async Task CreateFromShippingQuoteAsync(CreateShipmentFromQuoteRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "shipment/create_from_shipping_quote";
		...
		/// GetShipment shipment/{shipmentId}
		/// </summary>
		/// <param name="shipmentId">This path parameter specifies the unique eBay-assigned ID of the shipment you want to retrieve. The <b>shipmentId</b> value is generated and returned by a call to <b>createFromShippingQuote</b>.</param>
		/// <returns>Success</returns>
		public async Task<Shipment> GetShipmentAsync(string shipmentId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<Shipment>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// CancelShipment shipment/{shipmentId}/cancel
		/// </summary>
		/// <param name="shipmentId">This path parameter specifies the unique eBay-assigned ID of the shipment to be canceled. The <b>shipmentId</b> value is generated and returned by a call to <b>createFromShippingQuote</b>.</param>
		/// <returns>Success</returns>
		public async Task<Shipment> CancelShipmentAsync(string shipmentId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// DownloadLabelFile shipment/{shipmentId}/download_label_file
		/// </summary>
		/// <param name="shipmentId">This path parameter specifies the unique eBay-assigned ID of the shipment associated with the shipping label you want to download. The <b>shipmentId</b> value is generated and returned by a call to <b>createFromShippingQuote</b>.</param>
		/// <returns>Success</returns>
		public async Task DownloadLabelFileAsync(string shipmentId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// CreateShippingQuote shipping_quote
		/// </summary>
		/// <param name="requestBody">The request object for <b>createShippingQuote</b>.</param>
		public async Task CreateShippingQuoteAsync(ShippingQuoteRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "shipping_quote";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// GetShippingQuote shipping_quote/{shippingQuoteId}
		/// </summary>
		/// <param name="shippingQuoteId">This path parameter specifies the unique eBay-assigned ID of the shipping quote you want to retrieve. The <b>shippingQuoteId</b> value is generated and returned by a call to <b>createShippingQuote</b>.</param>
		/// <returns>Success</returns>
		public async Task<ShippingQuote> GetShippingQuoteAsync(string shippingQuoteId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ShippingQuote>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
