...
namespace MyNS
{
	...
	public class GoogleFirestoreAdminV1beta1ExportDocumentsMetadata
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="operationState")]
		public System.Nullable<GoogleFirestoreAdminV1beta1ExportDocumentsMetadataOperationState> OperationState { get; set; }
		...
		public GoogleFirestoreAdminV1beta1Progress ProgressBytes { get; set; }
		
		/// <summary>
		/// Measures the progress of a particular metric.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="progressDocuments")]
		public GoogleFirestoreAdminV1beta1Progress ProgressDocuments { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleFirestoreAdminV1beta1ExportDocumentsMetadataOperationState
	{
	...
	public class GoogleFirestoreAdminV1beta1ImportDocumentsMetadata
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="operationState")]
		public GoogleFirestoreAdminV1beta1ExportDocumentsMetadataOperationState OperationState { get; set; }
	...
	public class GoogleFirestoreAdminV1beta1Index
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="fields")]
		public GoogleFirestoreAdminV1beta1IndexField[] Fields { get; set; }
		...
		public System.Nullable<GoogleFirestoreAdminV1beta1IndexState> State { get; set; }
	}
	...
	public class GoogleFirestoreAdminV1beta1IndexField
	{
		...
		public System.Nullable<GoogleFirestoreAdminV1beta1IndexFieldMode> Mode { get; set; }
	}
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleFirestoreAdminV1beta1IndexState
	{
	...
	public class GoogleFirestoreAdminV1beta1IndexOperationMetadata
	{
		...
		public GoogleFirestoreAdminV1beta1Progress DocumentProgress { get; set; }
		...
		public System.Nullable<GoogleFirestoreAdminV1beta1IndexOperationMetadataOperationType> OperationType { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleFirestoreAdminV1beta1IndexOperationMetadataOperationType
	{
	...
	public class GoogleFirestoreAdminV1beta1ListIndexesResponse
	{
		...
		public GoogleFirestoreAdminV1beta1Index[] Indexes { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleFirestoreAdminV1beta1LocationMetadata
	{
	}
	...
	public partial class Misc
	{
		...
		/// Firestore_projects_databases_documents_batchGet v1beta1/{database}/documents:batchGet
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (database==null? "" : System.Uri.EscapeDataString(database))+"/documents:batchGet";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<BatchGetDocumentsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Firestore_projects_databases_documents_batchWrite v1beta1/{database}/documents:batchWrite
		/// </summary>
		/// <param name="database">Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (database==null? "" : System.Uri.EscapeDataString(database))+"/documents:batchWrite";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firestore_projects_databases_documents_beginTransaction v1beta1/{database}/documents:beginTransaction
		/// </summary>
		/// <param name="database">Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (database==null? "" : System.Uri.EscapeDataString(database))+"/documents:beginTransaction";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firestore_projects_databases_documents_commit v1beta1/{database}/documents:commit
		/// </summary>
		/// <param name="database">Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (database==null? "" : System.Uri.EscapeDataString(database))+"/documents:commit";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firestore_projects_databases_documents_listen v1beta1/{database}/documents:listen
		/// </summary>
		/// <param name="database">Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (database==null? "" : System.Uri.EscapeDataString(database))+"/documents:listen";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListenResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firestore_projects_databases_documents_rollback v1beta1/{database}/documents:rollback
		/// </summary>
		/// <param name="database">Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (database==null? "" : System.Uri.EscapeDataString(database))+"/documents:rollback";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firestore_projects_databases_documents_write v1beta1/{database}/documents:write
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (database==null? "" : System.Uri.EscapeDataString(database))+"/documents:write";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<WriteResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <summary>
		/// Deletes an index.
		/// Firestore_projects_databases_indexes_delete v1beta1/{name}
		/// </summary>
		/// <param name="name">The index name. For example: `projects/{project_id}/databases/{database_id}/indexes/{index_id}`</param>
		...
		/// <returns>Successful response</returns>
		public async Task<Empty> Firestore_projects_databases_indexes_deleteAsync(string name, bool currentDocument_exists, string currentDocument_updateTime, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&currentDocument.exists="+currentDocument_exists+"&currentDocument.updateTime=" + (currentDocument_updateTime==null? "" : System.Uri.EscapeDataString(currentDocument_updateTime));
		...
		/// <summary>
		/// Gets an index.
		/// Firestore_projects_databases_indexes_get v1beta1/{name}
		/// </summary>
		/// <param name="name">The name of the index. For example: `projects/{project_id}/databases/{database_id}/indexes/{index_id}`</param>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirestoreAdminV1beta1Index> Firestore_projects_databases_indexes_getAsync(string name, string[] mask_fieldPaths, string readTime, string transaction, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&"+string.Join("&", mask_fieldPaths.Select(z => $"mask.fieldPaths={System.Uri.EscapeDataString(z.ToString())}"))+"&readTime=" + (readTime==null? "" : System.Uri.EscapeDataString(readTime))+"&transaction=" + (transaction==null? "" : System.Uri.EscapeDataString(transaction));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirestoreAdminV1beta1Index>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firestore_projects_databases_documents_patch v1beta1/{name}
		/// </summary>
		...
		/// Firestore_projects_databases_exportDocuments v1beta1/{name}:exportDocuments
		/// </summary>
		/// <param name="name">Database to export. Should be of the form: `projects/{project_id}/databases/{database_id}`.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleLongrunningOperation> Firestore_projects_databases_exportDocumentsAsync(string name, GoogleFirestoreAdminV1beta1ExportDocumentsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":exportDocuments";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firestore_projects_databases_importDocuments v1beta1/{name}:importDocuments
		/// </summary>
		/// <param name="name">Database to import into. Should be of the form: `projects/{project_id}/databases/{database_id}`.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleLongrunningOperation> Firestore_projects_databases_importDocumentsAsync(string name, GoogleFirestoreAdminV1beta1ImportDocumentsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":importDocuments";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firestore_projects_databases_indexes_list v1beta1/{parent}/indexes
		/// </summary>
		/// <param name="parent">The database name. For example: `projects/{project_id}/databases/{database_id}`</param>
		/// <param name="pageSize">The standard List page size.</param>
		/// <param name="pageToken">The standard List page token.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirestoreAdminV1beta1ListIndexesResponse> Firestore_projects_databases_indexes_listAsync(string parent, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/indexes&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirestoreAdminV1beta1ListIndexesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firestore_projects_databases_indexes_create v1beta1/{parent}/indexes
		/// </summary>
		/// <param name="parent">The name of the database this index will apply to. For example: `projects/{project_id}/databases/{database_id}`</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleLongrunningOperation> Firestore_projects_databases_indexes_createAsync(string parent, GoogleFirestoreAdminV1beta1Index requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/indexes";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Lists documents.
		/// Firestore_projects_databases_documents_listDocuments v1beta1/{parent}/{collectionId}
		/// </summary>
		...
		public async Task<ListDocumentsResponse> Firestore_projects_databases_documents_listDocumentsAsync(string parent, string collectionId, string[] mask_fieldPaths, string orderBy, int pageSize, string pageToken, string readTime, bool showMissing, string transaction, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListDocumentsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firestore_projects_databases_documents_createDocument v1beta1/{parent}/{collectionId}
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/"+ (collectionId==null? "" : System.Uri.EscapeDataString(collectionId))+"&documentId=" + (documentId==null? "" : System.Uri.EscapeDataString(documentId))+"&"+string.Join("&", mask_fieldPaths.Select(z => $"mask.fieldPaths={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firestore_projects_databases_documents_listCollectionIds v1beta1/{parent}:listCollectionIds
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":listCollectionIds";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListCollectionIdsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firestore_projects_databases_documents_partitionQuery v1beta1/{parent}:partitionQuery
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":partitionQuery";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PartitionQueryResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firestore_projects_databases_documents_runAggregationQuery v1beta1/{parent}:runAggregationQuery
		/// </summary>
		/// <param name="parent">Required. The parent resource name. In the format: `projects/{project_id}/databases/{database_id}/documents` or `projects/{project_id}/databases/{database_id}/documents/{document_path}`. For example: `projects/my-project/databases/my-database/documents` or `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":runAggregationQuery";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Runs a query.
		/// Firestore_projects_databases_documents_runQuery v1beta1/{parent}:runQuery
		/// </summary>
		/// <param name="parent">Required. The parent resource name. In the format: `projects/{project_id}/databases/{database_id}/documents` or `projects/{project_id}/databases/{database_id}/documents/{document_path}`. For example: `projects/my-project/databases/my-database/documents` or `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":runQuery";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
