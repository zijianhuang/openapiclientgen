...
namespace MyNS
{
	...
	public class BulkListAdGroupAssignedTargetingOptionsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="youtubeAdGroupAssignedTargetingOptions")]
		public YoutubeAdGroupAssignedTargetingOption[] YoutubeAdGroupAssignedTargetingOptions { get; set; }
	}
	...
	public class YoutubeAdGroupAssignedTargetingOption
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="youtubeAdGroupId")]
		public string YoutubeAdGroupId { get; set; }
	}
	...
	public class YoutubeAndPartnersSettings
	{
		...
		public YoutubeAndPartnersBiddingStrategy BiddingStrategy { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="thirdPartyMeasurementSettings")]
		public YoutubeAndPartnersThirdPartyMeasurementSettings ThirdPartyMeasurementSettings { get; set; }
	...
	public class YoutubeAndPartnersInventorySourceConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="includeYoutubeSearch")]
		public System.Nullable<System.Boolean> IncludeYoutubeSearch { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="includeYoutubeVideos")]
		public System.Nullable<System.Boolean> IncludeYoutubeVideos { get; set; }
	}
	...
	public class ListYoutubeAdGroupAdsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="youtubeAdGroupAds")]
		public YoutubeAdGroupAd[] YoutubeAdGroupAds { get; set; }
	}
	...
	public class ListYoutubeAdGroupsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="youtubeAdGroups")]
		public YoutubeAdGroup[] YoutubeAdGroups { get; set; }
	}
	...
	public class YoutubeAdGroup
	{
		...
		public System.Nullable<YoutubeAdGroupAdGroupFormat> AdGroupFormat { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="youtubeAdIds")]
		public string[] YoutubeAdIds { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum YoutubeAdGroupAdGroupFormat
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_UNSPECIFIED = 0,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM = 1,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_VIDEO_DISCOVERY = 2,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_BUMPER = 3,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM = 4,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_AUDIO = 5,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_ACTION = 6,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_REACH = 7,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_MASTHEAD = 8,
	}
	...
	public partial class Misc
	{
		...
		/// Displayvideo_advertisers_list v2/advertisers
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_create v2/advertisers
		/// </summary>
		/// <returns>Successful response</returns>
		...
		/// Displayvideo_advertisers_delete v2/advertisers/{advertiserId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId));
		...
		/// <summary>
		/// Gets an advertiser.
		/// Displayvideo_advertisers_get v2/advertisers/{advertiserId}
		/// </summary>
		...
		/// Displayvideo_advertisers_patch v2/advertisers/{advertiserId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
		...
		/// Displayvideo_advertisers_campaigns_list v2/advertisers/{advertiserId}/campaigns
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/campaigns&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_campaigns_create v2/advertisers/{advertiserId}/campaigns
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/campaigns";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_campaigns_delete v2/advertisers/{advertiserId}/campaigns/{campaignId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/campaigns/"+ (campaignId==null? "" : System.Uri.EscapeDataString(campaignId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Gets a campaign.
		/// Displayvideo_advertisers_campaigns_get v2/advertisers/{advertiserId}/campaigns/{campaignId}
		/// </summary>
		...
		/// Displayvideo_advertisers_campaigns_patch v2/advertisers/{advertiserId}/campaigns/{campaignId}
		/// </summary>
		/// <param name="advertiserId">Output only. The unique ID of the advertiser the campaign belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/campaigns/"+ (campaignId==null? "" : System.Uri.EscapeDataString(campaignId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_campaigns_targetingTypes_assignedTargetingOptions_list v2/advertisers/{advertiserId}/campaigns/{campaignId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		...
		/// Displayvideo_advertisers_campaigns_targetingTypes_assignedTargetingOptions_get v2/advertisers/{advertiserId}/campaigns/{campaignId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the campaign belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/campaigns/"+ (campaignId==null? "" : System.Uri.EscapeDataString(campaignId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions/"+ (assignedTargetingOptionId==null? "" : System.Uri.EscapeDataString(assignedTargetingOptionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_campaigns_listAssignedTargetingOptions v2/advertisers/{advertiserId}/campaigns/{campaignId}:listAssignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the campaign belongs to.</param>
		/// <param name="campaignId">Required. The ID of the campaign to list assigned targeting options for.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/campaigns/"+ (campaignId==null? "" : System.Uri.EscapeDataString(campaignId))+":listAssignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_channels_list v2/advertisers/{advertiserId}/channels
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/channels&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_channels_create v2/advertisers/{advertiserId}/channels
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/channels&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_channels_patch v2/advertisers/{advertiserId}/channels/{channelId}
		/// </summary>
		/// <param name="advertiserId">The ID of the advertiser that owns the created channel.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_channels_sites_list v2/advertisers/{advertiserId}/channels/{channelId}/sites
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"/sites&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_channels_sites_delete v2/advertisers/{advertiserId}/channels/{channelId}/sites/{urlOrAppId}
		/// </summary>
		/// <param name="advertiserId">The ID of the advertiser that owns the parent channel.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"/sites/"+ (urlOrAppId==null? "" : System.Uri.EscapeDataString(urlOrAppId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_channels_sites_bulkEdit v2/advertisers/{advertiserId}/channels/{channelId}/sites:bulkEdit
		/// </summary>
		/// <param name="advertiserId">The ID of the advertiser that owns the parent channel.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"/sites:bulkEdit";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_channels_sites_replace v2/advertisers/{advertiserId}/channels/{channelId}/sites:replace
		/// </summary>
		/// <param name="advertiserId">The ID of the advertiser that owns the parent channel.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"/sites:replace";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_creatives_list v2/advertisers/{advertiserId}/creatives
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/creatives&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_creatives_create v2/advertisers/{advertiserId}/creatives
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/creatives";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_creatives_delete v2/advertisers/{advertiserId}/creatives/{creativeId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/creatives/"+ (creativeId==null? "" : System.Uri.EscapeDataString(creativeId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Gets a creative.
		/// Displayvideo_advertisers_creatives_get v2/advertisers/{advertiserId}/creatives/{creativeId}
		/// </summary>
		...
		/// Displayvideo_advertisers_creatives_patch v2/advertisers/{advertiserId}/creatives/{creativeId}
		/// </summary>
		/// <param name="advertiserId">Output only. The unique ID of the advertiser the creative belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/creatives/"+ (creativeId==null? "" : System.Uri.EscapeDataString(creativeId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_insertionOrders_list v2/advertisers/{advertiserId}/insertionOrders
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/insertionOrders&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_insertionOrders_create v2/advertisers/{advertiserId}/insertionOrders
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/insertionOrders";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_insertionOrders_delete v2/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/insertionOrders/"+ (insertionOrderId==null? "" : System.Uri.EscapeDataString(insertionOrderId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_insertionOrders_get v2/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}
		/// </summary>
		...
		/// Displayvideo_advertisers_insertionOrders_patch v2/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}
		/// </summary>
		/// <param name="advertiserId">Output only. The unique ID of the advertiser the insertion order belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/insertionOrders/"+ (insertionOrderId==null? "" : System.Uri.EscapeDataString(insertionOrderId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_insertionOrders_targetingTypes_assignedTargetingOptions_list v2/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/insertionOrders/"+ (insertionOrderId==null? "" : System.Uri.EscapeDataString(insertionOrderId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_insertionOrders_targetingTypes_assignedTargetingOptions_create v2/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the insertion order belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/insertionOrders/"+ (insertionOrderId==null? "" : System.Uri.EscapeDataString(insertionOrderId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_insertionOrders_targetingTypes_assignedTargetingOptions_delete v2/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the insertion order belongs to.</param>
		...
		/// Displayvideo_advertisers_insertionOrders_targetingTypes_assignedTargetingOptions_get v2/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the insertion order belongs to.</param>
		/// <param name="insertionOrderId">Required. The ID of the insertion order the assigned targeting option belongs to.</param>
		...
		/// Displayvideo_advertisers_insertionOrders_listAssignedTargetingOptions v2/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}:listAssignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the insertion order belongs to.</param>
		/// <param name="insertionOrderId">Required. The ID of the insertion order to list assigned targeting options for.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/insertionOrders/"+ (insertionOrderId==null? "" : System.Uri.EscapeDataString(insertionOrderId))+":listAssignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_invoices_list v2/advertisers/{advertiserId}/invoices
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/invoices&issueMonth=" + (issueMonth==null? "" : System.Uri.EscapeDataString(issueMonth))+"&loiSapinInvoiceType=" + loiSapinInvoiceType+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_invoices_lookupInvoiceCurrency v2/advertisers/{advertiserId}/invoices:lookupInvoiceCurrency
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/invoices:lookupInvoiceCurrency&invoiceMonth=" + (invoiceMonth==null? "" : System.Uri.EscapeDataString(invoiceMonth));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_lineItems_list v2/advertisers/{advertiserId}/lineItems
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_lineItems_create v2/advertisers/{advertiserId}/lineItems
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_lineItems_delete v2/advertisers/{advertiserId}/lineItems/{lineItemId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems/"+ (lineItemId==null? "" : System.Uri.EscapeDataString(lineItemId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Gets a line item.
		/// Displayvideo_advertisers_lineItems_get v2/advertisers/{advertiserId}/lineItems/{lineItemId}
		/// </summary>
		...
		/// Displayvideo_advertisers_lineItems_patch v2/advertisers/{advertiserId}/lineItems/{lineItemId}
		/// </summary>
		/// <param name="advertiserId">Output only. The unique ID of the advertiser the line item belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems/"+ (lineItemId==null? "" : System.Uri.EscapeDataString(lineItemId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_lineItems_targetingTypes_assignedTargetingOptions_list v2/advertisers/{advertiserId}/lineItems/{lineItemId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems/"+ (lineItemId==null? "" : System.Uri.EscapeDataString(lineItemId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_lineItems_targetingTypes_assignedTargetingOptions_create v2/advertisers/{advertiserId}/lineItems/{lineItemId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the line item belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems/"+ (lineItemId==null? "" : System.Uri.EscapeDataString(lineItemId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_lineItems_targetingTypes_assignedTargetingOptions_delete v2/advertisers/{advertiserId}/lineItems/{lineItemId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the line item belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems/"+ (lineItemId==null? "" : System.Uri.EscapeDataString(lineItemId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions/"+ (assignedTargetingOptionId==null? "" : System.Uri.EscapeDataString(assignedTargetingOptionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_lineItems_targetingTypes_assignedTargetingOptions_get v2/advertisers/{advertiserId}/lineItems/{lineItemId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the line item belongs to.</param>
		/// <param name="lineItemId">Required. The ID of the line item the assigned targeting option belongs to.</param>
		/// <param name="targetingType">Required. Identifies the type of this assigned targeting option. Supported targeting types include: * `TARGETING_TYPE_AGE_RANGE` * `TARGETING_TYPE_APP` * `TARGETING_TYPE_APP_CATEGORY` * `TARGETING_TYPE_AUDIENCE_GROUP` * `TARGETING_TYPE_AUDIO_CONTENT_TYPE` * `TARGETING_TYPE_AUTHORIZED_SELLER_STATUS` * `TARGETING_TYPE_BROWSER` * `TARGETING_TYPE_BUSINESS_CHAIN` * `TARGETING_TYPE_CARRIER_AND_ISP` * `TARGETING_TYPE_CATEGORY` * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_CONTENT_DURATION` * `TARGETING_TYPE_CONTENT_GENRE` * `TARGETING_TYPE_CONTENT_INSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION` * `TARGETING_TYPE_CONTENT_STREAM_TYPE` * `TARGETING_TYPE_DAY_AND_TIME` * `TARGETING_TYPE_DEVICE_MAKE_MODEL` * `TARGETING_TYPE_DEVICE_TYPE` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_ENVIRONMENT` * `TARGETING_TYPE_EXCHANGE` * `TARGETING_TYPE_GENDER` * `TARGETING_TYPE_GEO_REGION` * `TARGETING_TYPE_HOUSEHOLD_INCOME` * `TARGETING_TYPE_INVENTORY_SOURCE` * `TARGETING_TYPE_INVENTORY_SOURCE_GROUP` * `TARGETING_TYPE_KEYWORD` * `TARGETING_TYPE_LANGUAGE` * `TARGETING_TYPE_NATIVE_CONTENT_POSITION` * `TARGETING_TYPE_NEGATIVE_KEYWORD_LIST` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_ON_SCREEN_POSITION` * `TARGETING_TYPE_OPERATING_SYSTEM` * `TARGETING_TYPE_PARENTAL_STATUS` * `TARGETING_TYPE_POI` * `TARGETING_TYPE_PROXIMITY_LOCATION_LIST` * `TARGETING_TYPE_REGIONAL_LOCATION_LIST` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_SUB_EXCHANGE` * `TARGETING_TYPE_THIRD_PARTY_VERIFIER` * `TARGETING_TYPE_URL` * `TARGETING_TYPE_USER_REWARDED_CONTENT` * `TARGETING_TYPE_VIDEO_PLAYER_SIZE` * `TARGETING_TYPE_VIEWABILITY` * `TARGETING_TYPE_YOUTUBE_CHANNEL` (only for `LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_VIDEO_SEQUENCE` line items) * `TARGETING_TYPE_YOUTUBE_VIDEO` (only for `LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_VIDEO_SEQUENCE` line items)</param>
		...
		/// Displayvideo_advertisers_lineItems_duplicate v2/advertisers/{advertiserId}/lineItems/{lineItemId}:duplicate
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser this line item belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems/"+ (lineItemId==null? "" : System.Uri.EscapeDataString(lineItemId))+":duplicate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_lineItems_bulkEditAssignedTargetingOptions v2/advertisers/{advertiserId}/lineItems:bulkEditAssignedTargetingOptions
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems:bulkEditAssignedTargetingOptions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_lineItems_bulkListAssignedTargetingOptions v2/advertisers/{advertiserId}/lineItems:bulkListAssignedTargetingOptions
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems:bulkListAssignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&"+string.Join("&", lineItemIds.Select(z => $"lineItemIds={System.Uri.EscapeDataString(z.ToString())}"))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_lineItems_bulkUpdate v2/advertisers/{advertiserId}/lineItems:bulkUpdate
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser this line item belongs to.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems:bulkUpdate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_lineItems_generateDefault v2/advertisers/{advertiserId}/lineItems:generateDefault
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser this line item belongs to.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/lineItems:generateDefault";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_locationLists_list v2/advertisers/{advertiserId}/locationLists
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/locationLists&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_locationLists_create v2/advertisers/{advertiserId}/locationLists
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/locationLists";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_locationLists_patch v2/advertisers/{advertiserId}/locationLists/{locationListId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/locationLists/"+ (locationListId==null? "" : System.Uri.EscapeDataString(locationListId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_locationLists_assignedLocations_list v2/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the DV360 advertiser to which the location list belongs.</param>
		...
		/// Displayvideo_advertisers_locationLists_assignedLocations_create v2/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the DV360 advertiser to which the location list belongs.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/locationLists/"+ (locationListId==null? "" : System.Uri.EscapeDataString(locationListId))+"/assignedLocations";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_locationLists_assignedLocations_delete v2/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations/{assignedLocationId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the DV360 advertiser to which the location list belongs.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/locationLists/"+ (locationListId==null? "" : System.Uri.EscapeDataString(locationListId))+"/assignedLocations/"+ (assignedLocationId==null? "" : System.Uri.EscapeDataString(assignedLocationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_locationLists_assignedLocations_bulkEdit v2/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations:bulkEdit
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the DV360 advertiser to which the location list belongs.</param>
		/// <param name="locationListId">Required. The ID of the location list to which these assignments are assigned.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/locationLists/"+ (locationListId==null? "" : System.Uri.EscapeDataString(locationListId))+"/assignedLocations:bulkEdit";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_manualTriggers_list v2/advertisers/{advertiserId}/manualTriggers
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/manualTriggers&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListManualTriggersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Displayvideo_advertisers_manualTriggers_create v2/advertisers/{advertiserId}/manualTriggers
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/manualTriggers";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ManualTrigger>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Displayvideo_advertisers_manualTriggers_get v2/advertisers/{advertiserId}/manualTriggers/{triggerId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/manualTriggers/"+ (triggerId==null? "" : System.Uri.EscapeDataString(triggerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_manualTriggers_patch v2/advertisers/{advertiserId}/manualTriggers/{triggerId}
		/// </summary>
		/// <param name="advertiserId">Required. Immutable. The unique ID of the advertiser that the manual trigger belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/manualTriggers/"+ (triggerId==null? "" : System.Uri.EscapeDataString(triggerId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_manualTriggers_activate v2/advertisers/{advertiserId}/manualTriggers/{triggerId}:activate
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/manualTriggers/"+ (triggerId==null? "" : System.Uri.EscapeDataString(triggerId))+":activate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_manualTriggers_deactivate v2/advertisers/{advertiserId}/manualTriggers/{triggerId}:deactivate
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser that the manual trigger belongs.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/manualTriggers/"+ (triggerId==null? "" : System.Uri.EscapeDataString(triggerId))+":deactivate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_negativeKeywordLists_list v2/advertisers/{advertiserId}/negativeKeywordLists
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/negativeKeywordLists&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_negativeKeywordLists_create v2/advertisers/{advertiserId}/negativeKeywordLists
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/negativeKeywordLists";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_negativeKeywordLists_patch v2/advertisers/{advertiserId}/negativeKeywordLists/{negativeKeywordListId}
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/negativeKeywordLists/"+ (negativeKeywordListId==null? "" : System.Uri.EscapeDataString(negativeKeywordListId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_list v2/advertisers/{advertiserId}/negativeKeywordLists/{negativeKeywordListId}/negativeKeywords
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/negativeKeywordLists/"+ (negativeKeywordListId==null? "" : System.Uri.EscapeDataString(negativeKeywordListId))+"/negativeKeywords&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_delete v2/advertisers/{advertiserId}/negativeKeywordLists/{negativeKeywordListId}/negativeKeywords/{keywordValue}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the DV360 advertiser to which the parent negative keyword list belongs.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/negativeKeywordLists/"+ (negativeKeywordListId==null? "" : System.Uri.EscapeDataString(negativeKeywordListId))+"/negativeKeywords/"+ (keywordValue==null? "" : System.Uri.EscapeDataString(keywordValue));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_bulkEdit v2/advertisers/{advertiserId}/negativeKeywordLists/{negativeKeywordListId}/negativeKeywords:bulkEdit
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the DV360 advertiser to which the parent negative keyword list belongs.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/negativeKeywordLists/"+ (negativeKeywordListId==null? "" : System.Uri.EscapeDataString(negativeKeywordListId))+"/negativeKeywords:bulkEdit";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_replace v2/advertisers/{advertiserId}/negativeKeywordLists/{negativeKeywordListId}/negativeKeywords:replace
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the DV360 advertiser to which the parent negative keyword list belongs.</param>
		/// <param name="negativeKeywordListId">Required. The ID of the parent negative keyword list to which the negative keywords belong.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/negativeKeywordLists/"+ (negativeKeywordListId==null? "" : System.Uri.EscapeDataString(negativeKeywordListId))+"/negativeKeywords:replace";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_list v2/advertisers/{advertiserId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_create v2/advertisers/{advertiserId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_delete v2/advertisers/{advertiserId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser.</param>
		/// <param name="targetingType">Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION`</param>
		/// <param name="assignedTargetingOptionId">Required. The ID of the assigned targeting option to delete.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions/"+ (assignedTargetingOptionId==null? "" : System.Uri.EscapeDataString(assignedTargetingOptionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_get v2/advertisers/{advertiserId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser.</param>
		...
		/// Displayvideo_advertisers_youtubeAdGroupAds_list v2/advertisers/{advertiserId}/youtubeAdGroupAds
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the ad groups belongs to.</param>
		/// <param name="filter">Allows filtering by custom YouTube ad group ad fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` and `OR`. A sequence of restrictions implicitly uses `AND`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: * `adGroupId` * `displayName` * `entityStatus` * `adGroupAdId` Examples: * All ad group ads under an ad group: `adGroupId="1234"` * All ad group ads under an ad group with an entityStatus of `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED`: `(entityStatus="ENTITY_STATUS_ACTIVE" OR entityStatus="ENTITY_STATUS_PAUSED") AND adGroupId="12345"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.</param>
		/// <param name="orderBy">Field by which to sort the list. Acceptable values are: * `displayName` (default) * `entityStatus` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.</param>
		/// <param name="pageSize">Requested page size. Must be between `1` and `100`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.</param>
		/// <param name="pageToken">A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAdGroupAds` method. If not specified, the first page of results will be returned.</param>
		/// <returns>Successful response</returns>
		public async Task<ListYoutubeAdGroupAdsResponse> Displayvideo_advertisers_youtubeAdGroupAds_listAsync(string advertiserId, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/youtubeAdGroupAds&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListYoutubeAdGroupAdsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Displayvideo_advertisers_youtubeAdGroupAds_get v2/advertisers/{advertiserId}/youtubeAdGroupAds/{youtubeAdGroupAdId}
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<YoutubeAdGroupAd> Displayvideo_advertisers_youtubeAdGroupAds_getAsync(string advertiserId, string youtubeAdGroupAdId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/youtubeAdGroupAds/"+ (youtubeAdGroupAdId==null? "" : System.Uri.EscapeDataString(youtubeAdGroupAdId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<YoutubeAdGroupAd>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Displayvideo_advertisers_youtubeAdGroups_list v2/advertisers/{advertiserId}/youtubeAdGroups
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the ad groups belongs to.</param>
		/// <param name="filter">Allows filtering by custom YouTube ad group fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by `AND` and `OR`. A sequence of restrictions implicitly uses `AND`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported properties: * `adGroupId` * `displayName` * `entityStatus` * `lineItemId` * `adGroupFormat` Examples: * All ad groups under an line item: `lineItemId="1234"` * All `ENTITY_STATUS_ACTIVE` or `ENTITY_STATUS_PAUSED` `YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM` ad groups under an advertiser: `(entityStatus="ENTITY_STATUS_ACTIVE" OR entityStatus="ENTITY_STATUS_PAUSED") AND adGroupFormat="YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.</param>
		/// <param name="orderBy">Field by which to sort the list. Acceptable values are: * `displayName` (default) * `entityStatus` The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `displayName desc`.</param>
		/// <param name="pageSize">Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.</param>
		/// <param name="pageToken">A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAdGroups` method. If not specified, the first page of results will be returned.</param>
		/// <returns>Successful response</returns>
		public async Task<ListYoutubeAdGroupsResponse> Displayvideo_advertisers_youtubeAdGroups_listAsync(string advertiserId, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/youtubeAdGroups&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListYoutubeAdGroupsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Displayvideo_advertisers_youtubeAdGroups_get v2/advertisers/{advertiserId}/youtubeAdGroups/{youtubeAdGroupId}
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<YoutubeAdGroup> Displayvideo_advertisers_youtubeAdGroups_getAsync(string advertiserId, string youtubeAdGroupId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/youtubeAdGroups/"+ (youtubeAdGroupId==null? "" : System.Uri.EscapeDataString(youtubeAdGroupId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<YoutubeAdGroup>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Displayvideo_advertisers_youtubeAdGroups_targetingTypes_assignedTargetingOptions_list v2/advertisers/{advertiserId}/youtubeAdGroups/{youtubeAdGroupId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the ad group belongs to.</param>
		/// <param name="youtubeAdGroupId">Required. The ID of the ad group to list assigned targeting options for.</param>
		...
		/// <param name="orderBy">Field by which to sort the list. Acceptable values are: * `assignedTargetingOptionId` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `assignedTargetingOptionId desc`.</param>
		/// <param name="pageSize">Requested page size. Must be between `1` and `5000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.</param>
		/// <param name="pageToken">A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAdGroupAssignedTargetingOptions` method. If not specified, the first page of results will be returned.</param>
		/// <returns>Successful response</returns>
		public async Task<ListYoutubeAdGroupAssignedTargetingOptionsResponse> Displayvideo_advertisers_youtubeAdGroups_targetingTypes_assignedTargetingOptions_listAsync(string advertiserId, string youtubeAdGroupId, AssignedTargetingOptionTargetingType targetingType, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/youtubeAdGroups/"+ (youtubeAdGroupId==null? "" : System.Uri.EscapeDataString(youtubeAdGroupId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListYoutubeAdGroupAssignedTargetingOptionsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Displayvideo_advertisers_youtubeAdGroups_targetingTypes_assignedTargetingOptions_get v2/advertisers/{advertiserId}/youtubeAdGroups/{youtubeAdGroupId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the ad group belongs to.</param>
		/// <param name="youtubeAdGroupId">Required. The ID of the ad group the assigned targeting option belongs to.</param>
		...
		/// <param name="assignedTargetingOptionId">Required. An identifier unique to the targeting type in this line item that identifies the assigned targeting option being requested.</param>
		/// <returns>Successful response</returns>
		public async Task<AssignedTargetingOption> Displayvideo_advertisers_youtubeAdGroups_targetingTypes_assignedTargetingOptions_getAsync(string advertiserId, string youtubeAdGroupId, AssignedTargetingOptionTargetingType targetingType, string assignedTargetingOptionId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/youtubeAdGroups/"+ (youtubeAdGroupId==null? "" : System.Uri.EscapeDataString(youtubeAdGroupId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions/"+ (assignedTargetingOptionId==null? "" : System.Uri.EscapeDataString(assignedTargetingOptionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_youtubeAdGroups_bulkListAdGroupAssignedTargetingOptions v2/advertisers/{advertiserId}/youtubeAdGroups:bulkListAdGroupAssignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the line items belongs to.</param>
		...
		/// <param name="youtubeAdGroupIds">Required. The IDs of the youtube ad groups to list assigned targeting options for.</param>
		/// <returns>Successful response</returns>
		public async Task<BulkListAdGroupAssignedTargetingOptionsResponse> Displayvideo_advertisers_youtubeAdGroups_bulkListAdGroupAssignedTargetingOptionsAsync(string advertiserId, string filter, string orderBy, int pageSize, string pageToken, string[] youtubeAdGroupIds, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"/youtubeAdGroups:bulkListAdGroupAssignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&"+string.Join("&", youtubeAdGroupIds.Select(z => $"youtubeAdGroupIds={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_audit v2/advertisers/{advertiserId}:audit
		/// </summary>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+":audit&readMask=" + (readMask==null? "" : System.Uri.EscapeDataString(readMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_advertisers_editAssignedTargetingOptions v2/advertisers/{advertiserId}:editAssignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+":editAssignedTargetingOptions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_advertisers_listAssignedTargetingOptions v2/advertisers/{advertiserId}:listAssignedTargetingOptions
		/// </summary>
		/// <param name="advertiserId">Required. The ID of the advertiser the line item belongs to.</param>
		...
		{
			var requestUri = "v2/advertisers/"+ (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+":listAssignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_combinedAudiences_list v2/combinedAudiences
		/// </summary>
		...
		{
			var requestUri = "v2/combinedAudiences?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_combinedAudiences_get v2/combinedAudiences/{combinedAudienceId}
		/// </summary>
		...
		{
			var requestUri = "v2/combinedAudiences/"+ (combinedAudienceId==null? "" : System.Uri.EscapeDataString(combinedAudienceId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_customBiddingAlgorithms_list v2/customBiddingAlgorithms
		/// </summary>
		...
		/// Displayvideo_customBiddingAlgorithms_create v2/customBiddingAlgorithms
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/customBiddingAlgorithms";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_customBiddingAlgorithms_get v2/customBiddingAlgorithms/{customBiddingAlgorithmId}
		/// </summary>
		...
		{
			var requestUri = "v2/customBiddingAlgorithms/"+ (customBiddingAlgorithmId==null? "" : System.Uri.EscapeDataString(customBiddingAlgorithmId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_customBiddingAlgorithms_patch v2/customBiddingAlgorithms/{customBiddingAlgorithmId}
		/// </summary>
		...
		{
			var requestUri = "v2/customBiddingAlgorithms/"+ (customBiddingAlgorithmId==null? "" : System.Uri.EscapeDataString(customBiddingAlgorithmId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_customBiddingAlgorithms_scripts_list v2/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts
		/// </summary>
		...
		{
			var requestUri = "v2/customBiddingAlgorithms/"+ (customBiddingAlgorithmId==null? "" : System.Uri.EscapeDataString(customBiddingAlgorithmId))+"/scripts&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_customBiddingAlgorithms_scripts_create v2/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts
		/// </summary>
		...
		{
			var requestUri = "v2/customBiddingAlgorithms/"+ (customBiddingAlgorithmId==null? "" : System.Uri.EscapeDataString(customBiddingAlgorithmId))+"/scripts&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_customBiddingAlgorithms_scripts_get v2/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts/{customBiddingScriptId}
		/// </summary>
		/// <param name="customBiddingAlgorithmId">Required. The ID of the custom bidding algorithm owns the script.</param>
		...
		{
			var requestUri = "v2/customBiddingAlgorithms/"+ (customBiddingAlgorithmId==null? "" : System.Uri.EscapeDataString(customBiddingAlgorithmId))+"/scripts/"+ (customBiddingScriptId==null? "" : System.Uri.EscapeDataString(customBiddingScriptId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_customBiddingAlgorithms_uploadScript v2/customBiddingAlgorithms/{customBiddingAlgorithmId}:uploadScript
		/// </summary>
		/// <param name="customBiddingAlgorithmId">Required. The ID of the custom bidding algorithm owns the script.</param>
		/// <param name="advertiserId">The ID of the advertiser that owns the parent custom bidding algorithm.</param>
		/// <param name="partnerId">The ID of the partner that owns the parent custom bidding algorithm. Only this partner will have write access to this custom bidding script.</param>
		...
		{
			var requestUri = "v2/customBiddingAlgorithms/"+ (customBiddingAlgorithmId==null? "" : System.Uri.EscapeDataString(customBiddingAlgorithmId))+":uploadScript&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_customLists_list v2/customLists
		/// </summary>
		...
		{
			var requestUri = "v2/customLists?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Gets a custom list.
		/// Displayvideo_customLists_get v2/customLists/{customListId}
		/// </summary>
		...
		{
			var requestUri = "v2/customLists/"+ (customListId==null? "" : System.Uri.EscapeDataString(customListId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_firstAndThirdPartyAudiences_list v2/firstAndThirdPartyAudiences
		/// </summary>
		...
		/// Displayvideo_firstAndThirdPartyAudiences_create v2/firstAndThirdPartyAudiences
		/// </summary>
		...
		{
			var requestUri = "v2/firstAndThirdPartyAudiences?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_firstAndThirdPartyAudiences_get v2/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}
		/// </summary>
		...
		{
			var requestUri = "v2/firstAndThirdPartyAudiences/"+ (firstAndThirdPartyAudienceId==null? "" : System.Uri.EscapeDataString(firstAndThirdPartyAudienceId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_firstAndThirdPartyAudiences_patch v2/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}
		/// </summary>
		...
		{
			var requestUri = "v2/firstAndThirdPartyAudiences/"+ (firstAndThirdPartyAudienceId==null? "" : System.Uri.EscapeDataString(firstAndThirdPartyAudienceId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_firstAndThirdPartyAudiences_editCustomerMatchMembers v2/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}:editCustomerMatchMembers
		/// </summary>
		...
		{
			var requestUri = "v2/firstAndThirdPartyAudiences/"+ (firstAndThirdPartyAudienceId==null? "" : System.Uri.EscapeDataString(firstAndThirdPartyAudienceId))+":editCustomerMatchMembers";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_floodlightGroups_get v2/floodlightGroups/{floodlightGroupId}
		/// </summary>
		...
		{
			var requestUri = "v2/floodlightGroups/"+ (floodlightGroupId==null? "" : System.Uri.EscapeDataString(floodlightGroupId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_googleAudiences_list v2/googleAudiences
		/// </summary>
		...
		{
			var requestUri = "v2/googleAudiences?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_googleAudiences_get v2/googleAudiences/{googleAudienceId}
		/// </summary>
		...
		{
			var requestUri = "v2/googleAudiences/"+ (googleAudienceId==null? "" : System.Uri.EscapeDataString(googleAudienceId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_guaranteedOrders_list v2/guaranteedOrders
		/// </summary>
		...
		{
			var requestUri = "v2/guaranteedOrders?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_guaranteedOrders_create v2/guaranteedOrders
		/// </summary>
		...
		{
			var requestUri = "v2/guaranteedOrders?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_guaranteedOrders_get v2/guaranteedOrders/{guaranteedOrderId}
		/// </summary>
		...
		{
			var requestUri = "v2/guaranteedOrders/"+ (guaranteedOrderId==null? "" : System.Uri.EscapeDataString(guaranteedOrderId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_guaranteedOrders_patch v2/guaranteedOrders/{guaranteedOrderId}
		/// </summary>
		...
		/// Displayvideo_guaranteedOrders_editGuaranteedOrderReadAccessors v2/guaranteedOrders/{guaranteedOrderId}:editGuaranteedOrderReadAccessors
		/// </summary>
		...
		{
			var requestUri = "v2/guaranteedOrders/"+ (guaranteedOrderId==null? "" : System.Uri.EscapeDataString(guaranteedOrderId))+":editGuaranteedOrderReadAccessors";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_inventorySourceGroups_list v2/inventorySourceGroups
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySourceGroups?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_inventorySourceGroups_create v2/inventorySourceGroups
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySourceGroups?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_inventorySourceGroups_delete v2/inventorySourceGroups/{inventorySourceGroupId}
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySourceGroups/"+ (inventorySourceGroupId==null? "" : System.Uri.EscapeDataString(inventorySourceGroupId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_inventorySourceGroups_get v2/inventorySourceGroups/{inventorySourceGroupId}
		/// </summary>
		...
		/// Displayvideo_inventorySourceGroups_assignedInventorySources_list v2/inventorySourceGroups/{inventorySourceGroupId}/assignedInventorySources
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySourceGroups/"+ (inventorySourceGroupId==null? "" : System.Uri.EscapeDataString(inventorySourceGroupId))+"/assignedInventorySources&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_inventorySourceGroups_assignedInventorySources_create v2/inventorySourceGroups/{inventorySourceGroupId}/assignedInventorySources
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySourceGroups/"+ (inventorySourceGroupId==null? "" : System.Uri.EscapeDataString(inventorySourceGroupId))+"/assignedInventorySources&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_inventorySourceGroups_assignedInventorySources_delete v2/inventorySourceGroups/{inventorySourceGroupId}/assignedInventorySources/{assignedInventorySourceId}
		/// </summary>
		...
		/// Displayvideo_inventorySourceGroups_assignedInventorySources_bulkEdit v2/inventorySourceGroups/{inventorySourceGroupId}/assignedInventorySources:bulkEdit
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySourceGroups/"+ (inventorySourceGroupId==null? "" : System.Uri.EscapeDataString(inventorySourceGroupId))+"/assignedInventorySources:bulkEdit";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_inventorySources_list v2/inventorySources
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySources?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_inventorySources_create v2/inventorySources
		/// </summary>
		/// <param name="advertiserId">The ID of the advertiser that the request is being made within.</param>
		/// <param name="partnerId">The ID of the partner that the request is being made within.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/inventorySources?advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_inventorySources_get v2/inventorySources/{inventorySourceId}
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySources/"+ (inventorySourceId==null? "" : System.Uri.EscapeDataString(inventorySourceId))+"&partnerId=" + (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_inventorySources_patch v2/inventorySources/{inventorySourceId}
		/// </summary>
		...
		/// Displayvideo_inventorySources_editInventorySourceReadWriteAccessors v2/inventorySources/{inventorySourceId}:editInventorySourceReadWriteAccessors
		/// </summary>
		...
		{
			var requestUri = "v2/inventorySources/"+ (inventorySourceId==null? "" : System.Uri.EscapeDataString(inventorySourceId))+":editInventorySourceReadWriteAccessors";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_partners_list v2/partners
		/// </summary>
		...
		{
			var requestUri = "v2/partners?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Gets a partner.
		/// Displayvideo_partners_get v2/partners/{partnerId}
		/// </summary>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Lists channels for a partner or advertiser.
		/// Displayvideo_partners_channels_list v2/partners/{partnerId}/channels
		/// </summary>
		/// <param name="partnerId">The ID of the partner that owns the channels.</param>
		/// <param name="advertiserId">The ID of the advertiser that owns the channels.</param>
		/// <param name="filter">Allows filtering by channel fields. Supported syntax: * Filter expressions for channel can only contain at most one restriction. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `HAS (:)` operator. Supported fields: * `displayName` Examples: * All channels for which the display name contains "google": `displayName : "google"`. The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.</param>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/channels&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Creates a new channel. Returns the newly created channel if successful.
		/// Displayvideo_partners_channels_create v2/partners/{partnerId}/channels
		/// </summary>
		/// <param name="partnerId">The ID of the partner that owns the created channel.</param>
		/// <param name="advertiserId">The ID of the advertiser that owns the created channel.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/channels&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Updates a channel. Returns the updated channel if successful.
		/// Displayvideo_partners_channels_patch v2/partners/{partnerId}/channels/{channelId}
		/// </summary>
		/// <param name="partnerId">The ID of the partner that owns the created channel.</param>
		/// <param name="channelId">Output only. The unique ID of the channel. Assigned by the system.</param>
		/// <param name="advertiserId">The ID of the advertiser that owns the created channel.</param>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Lists sites in a channel.
		/// Displayvideo_partners_channels_sites_list v2/partners/{partnerId}/channels/{channelId}/sites
		/// </summary>
		/// <param name="partnerId">The ID of the partner that owns the parent channel.</param>
		/// <param name="channelId">Required. The ID of the parent channel to which the requested sites belong.</param>
		/// <param name="advertiserId">The ID of the advertiser that owns the parent channel.</param>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"/sites&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Deletes a site from a channel.
		/// Displayvideo_partners_channels_sites_delete v2/partners/{partnerId}/channels/{channelId}/sites/{urlOrAppId}
		/// </summary>
		/// <param name="partnerId">The ID of the partner that owns the parent channel.</param>
		/// <param name="channelId">Required. The ID of the parent channel to which the site belongs.</param>
		/// <param name="urlOrAppId">Required. The URL or app ID of the site to delete.</param>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"/sites/"+ (urlOrAppId==null? "" : System.Uri.EscapeDataString(urlOrAppId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Bulk edits sites under a single channel. The operation will delete the sites provided in BulkEditSitesRequest.deleted_sites and then create the sites provided in BulkEditSitesRequest.created_sites.
		/// Displayvideo_partners_channels_sites_bulkEdit v2/partners/{partnerId}/channels/{channelId}/sites:bulkEdit
		/// </summary>
		/// <param name="partnerId">The ID of the partner that owns the parent channel.</param>
		/// <param name="channelId">Required. The ID of the parent channel to which the sites belong.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"/sites:bulkEdit";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Replaces all of the sites under a single channel. The operation will replace the sites under a channel with the sites provided in ReplaceSitesRequest.new_sites.
		/// Displayvideo_partners_channels_sites_replace v2/partners/{partnerId}/channels/{channelId}/sites:replace
		/// </summary>
		/// <param name="partnerId">The ID of the partner that owns the parent channel.</param>
		/// <param name="channelId">Required. The ID of the parent channel whose sites will be replaced.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/channels/"+ (channelId==null? "" : System.Uri.EscapeDataString(channelId))+"/sites:replace";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_partners_targetingTypes_assignedTargetingOptions_list v2/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_partners_targetingTypes_assignedTargetingOptions_create v2/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions
		/// </summary>
		/// <param name="partnerId">Required. The ID of the partner.</param>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_partners_targetingTypes_assignedTargetingOptions_delete v2/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="partnerId">Required. The ID of the partner.</param>
		/// <param name="targetingType">Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL`</param>
		/// <param name="assignedTargetingOptionId">Required. The ID of the assigned targeting option to delete.</param>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+"/targetingTypes/"+targetingType+"/assignedTargetingOptions/"+ (assignedTargetingOptionId==null? "" : System.Uri.EscapeDataString(assignedTargetingOptionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_partners_targetingTypes_assignedTargetingOptions_get v2/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}
		/// </summary>
		/// <param name="partnerId">Required. The ID of the partner.</param>
		/// <param name="targetingType">Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL`</param>
		...
		/// Displayvideo_partners_editAssignedTargetingOptions v2/partners/{partnerId}:editAssignedTargetingOptions
		/// </summary>
		/// <param name="partnerId">Required. The ID of the partner.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/partners/"+ (partnerId==null? "" : System.Uri.EscapeDataString(partnerId))+":editAssignedTargetingOptions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_sdfdownloadtasks_create v2/sdfdownloadtasks
		/// </summary>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2/sdfdownloadtasks";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_targetingTypes_targetingOptions_list v2/targetingTypes/{targetingType}/targetingOptions
		/// </summary>
		...
		/// Displayvideo_targetingTypes_targetingOptions_get v2/targetingTypes/{targetingType}/targetingOptions/{targetingOptionId}
		/// </summary>
		...
		{
			var requestUri = "v2/targetingTypes/"+targetingType+"/targetingOptions/"+ (targetingOptionId==null? "" : System.Uri.EscapeDataString(targetingOptionId))+"&advertiserId=" + (advertiserId==null? "" : System.Uri.EscapeDataString(advertiserId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_targetingTypes_targetingOptions_search v2/targetingTypes/{targetingType}/targetingOptions:search
		/// </summary>
		...
		{
			var requestUri = "v2/targetingTypes/"+targetingType+"/targetingOptions:search";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_users_list v2/users
		/// </summary>
		...
		{
			var requestUri = "v2/users?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Displayvideo_users_create v2/users
		/// </summary>
		/// <returns>Successful response</returns>
		...
		/// Displayvideo_users_delete v2/users/{userId}
		/// </summary>
		...
		/// Displayvideo_users_get v2/users/{userId}
		/// </summary>
		...
		/// Displayvideo_users_patch v2/users/{userId}
		/// </summary>
		...
		{
			var requestUri = "v2/users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_users_bulkEditAssignedUserRoles v2/users/{userId}:bulkEditAssignedUserRoles
		/// </summary>
		...
		{
			var requestUri = "v2/users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+":bulkEditAssignedUserRoles";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Displayvideo_sdfdownloadtasks_operations_get v2/{name}
		/// </summary>
