...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Texttospeech_text_synthesize v1/text:synthesize
		/// </summary>
		...
		{
			var requestUri = "v1/text:synthesize";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<SynthesizeSpeechResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Texttospeech_voices_list v1/voices
		/// </summary>
		...
		{
			var requestUri = "v1/voices?languageCode=" + (languageCode==null? "" : System.Uri.EscapeDataString(languageCode));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListVoicesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Texttospeech_operations_delete v1/{name}
		/// </summary>
		/// <param name="name">The name of the operation resource to be deleted.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Texttospeech_operations_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Texttospeech_projects_locations_operations_get v1/{name}
		/// </summary>
		...
		/// Texttospeech_projects_locations_operations_list v1/{name}/operations
		/// </summary>
		...
		/// Texttospeech_operations_cancel v1/{name}:cancel
		/// </summary>
		/// <param name="name">The name of the operation resource to be cancelled.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Texttospeech_operations_cancelAsync(string name, CancelOperationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Texttospeech_projects_locations_synthesizeLongAudio v1/{parent}:synthesizeLongAudio
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":synthesizeLongAudio";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
