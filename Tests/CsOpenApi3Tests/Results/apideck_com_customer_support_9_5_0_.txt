...
namespace MyNS
{
	...
	public class CustomerSupportCustomer
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public System.Nullable<CustomerSupportCustomerStatus> Status { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum CustomerSupportCustomerStatus
	{
		...
		gdprMinuserasureMinusrequest = 2,
	...
	public partial class Misc
	{
		...
		/// List Customer Support Customers
		/// CustomersAll customer-support/customers
		/// </summary>
		...
		/// <returns>CustomerSupportCustomers</returns>
		public async Task<GetCustomerSupportCustomersResponse> CustomersAllAsync(bool raw, string cursor, int limit, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "customer-support/customers?raw="+raw+"&cursor=" + (cursor==null? "" : System.Uri.EscapeDataString(cursor))+"&limit="+limit+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GetCustomerSupportCustomersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Create Customer Support Customer
		/// CustomersAdd customer-support/customers
		/// </summary>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		public async Task CustomersAddAsync(bool raw, CustomerSupportCustomer requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "customer-support/customers?raw="+raw;
		...
		/// Delete Customer Support Customer
		/// CustomersDelete customer-support/customers/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <returns>CustomerSupportCustomers</returns>
		public async Task<DeleteCustomerSupportCustomerResponse> CustomersDeleteAsync(string id, bool raw, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "customer-support/customers/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw;
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteCustomerSupportCustomerResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Get Customer Support Customer
		/// CustomersOne customer-support/customers/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <param name="fields">The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields "name", "email" and "addresses.city". If any other fields are available, they will be excluded.</param>
		/// <returns>CustomerSupportCustomers</returns>
		public async Task<GetCustomerSupportCustomerResponse> CustomersOneAsync(string id, bool raw, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "customer-support/customers/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetCustomerSupportCustomerResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Update Customer Support Customer
		/// CustomersUpdate customer-support/customers/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <returns>CustomerSupportCustomers</returns>
		public async Task<UpdateCustomerSupportCustomerResponse> CustomersUpdateAsync(string id, bool raw, CustomerSupportCustomer requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "customer-support/customers/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw;
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateCustomerSupportCustomerResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
