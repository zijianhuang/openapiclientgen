...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Securitycenter_organizations_operations_delete v1p1alpha1/{name}
		/// </summary>
		...
		{
			var requestUri = "v1p1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// Securitycenter_organizations_operations_list v1p1alpha1/{name}
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Securitycenter_organizations_operations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1p1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
		...
		/// Securitycenter_organizations_operations_cancel v1p1alpha1/{name}:cancel
		/// </summary>
		...
		{
			var requestUri = "v1p1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":cancel";
