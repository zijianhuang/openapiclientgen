...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Domains_projects_locations_registrations_retrieveImportableDomains v1beta1/{location}/registrations:retrieveImportableDomains
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/registrations:retrieveImportableDomains&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
		...
		/// Domains_projects_locations_registrations_retrieveRegisterParameters v1beta1/{location}/registrations:retrieveRegisterParameters
		/// </summary>
		/// <param name="location">Required. The location. Must be in the format `projects/*/locations/*`.</param>
		...
		{
			var requestUri = "v1beta1/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/registrations:retrieveRegisterParameters&domainName=" + (domainName==null? "" : System.Uri.EscapeDataString(domainName));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Domains_projects_locations_registrations_retrieveTransferParameters v1beta1/{location}/registrations:retrieveTransferParameters
		/// </summary>
		/// <param name="location">Required. The location. Must be in the format `projects/*/locations/*`.</param>
		/// <param name="domainName">Required. The domain name. Unicode domain names must be expressed in Punycode format.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/registrations:retrieveTransferParameters&domainName=" + (domainName==null? "" : System.Uri.EscapeDataString(domainName));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Domains_projects_locations_registrations_searchDomains v1beta1/{location}/registrations:searchDomains
		/// </summary>
		/// <param name="location">Required. The location. Must be in the format `projects/*/locations/*`.</param>
		...
		{
			var requestUri = "v1beta1/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/registrations:searchDomains&query=" + (query==null? "" : System.Uri.EscapeDataString(query));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Domains_projects_locations_registrations_delete v1beta1/{name}
		/// </summary>
		...
		/// Domains_projects_locations_registrations_get v1beta1/{name}
		/// </summary>
		...
		/// Domains_projects_locations_registrations_patch v1beta1/{name}
		/// </summary>
		...
		/// Domains_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// Domains_projects_locations_operations_list v1beta1/{name}/operations
		/// </summary>
		...
		/// Domains_projects_locations_registrations_export v1beta1/{name}:export
		/// </summary>
		...
		/// Domains_projects_locations_registrations_list v1beta1/{parent}/registrations
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/registrations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Domains_projects_locations_registrations_import v1beta1/{parent}/registrations:import
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/registrations:import";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_register v1beta1/{parent}/registrations:register
		/// </summary>
		/// <param name="parent">Required. The parent resource of the `Registration`. Must be in the format `projects/*/locations/*`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/registrations:register";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_transfer v1beta1/{parent}/registrations:transfer
		/// </summary>
		/// <param name="parent">Required. The parent resource of the `Registration`. Must be in the format `projects/*/locations/*`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/registrations:transfer";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_configureContactSettings v1beta1/{registration}:configureContactSettings
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":configureContactSettings";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_configureDnsSettings v1beta1/{registration}:configureDnsSettings
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":configureDnsSettings";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_configureManagementSettings v1beta1/{registration}:configureManagementSettings
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":configureManagementSettings";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_resetAuthorizationCode v1beta1/{registration}:resetAuthorizationCode
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":resetAuthorizationCode";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_retrieveAuthorizationCode v1beta1/{registration}:retrieveAuthorizationCode
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":retrieveAuthorizationCode";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Domains_projects_locations_registrations_getIamPolicy v1beta1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Domains_projects_locations_registrations_setIamPolicy v1beta1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Domains_projects_locations_registrations_testIamPermissions v1beta1/{resource}:testIamPermissions
		/// </summary>
