...
namespace MyNS
{
	...
	public class Cycle
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="evaluationDate")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="evaluationMonth")]
	...
	public class Metric
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="benchmark")]
		public MetricBenchmark Benchmark { get; set; }
		...
		public MetricDistribution[] Distributions { get; set; }
	...
	public class MetricBenchmark
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="basis")]
	...
	public class EvaluationCycle
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="evaluationType")]
	...
	public class FindSellerStandardsProfilesResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="standardsProfiles")]
	...
	public class StandardsProfile
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="defaultProgram")]
		public System.Nullable<System.Boolean> DefaultProgram { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="evaluationReason")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="standardsLevel")]
	...
	public class GetCustomerServiceMetricResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="dimensionMetrics")]
		public DimensionMetric[] DimensionMetrics { get; set; }
		
		/// <summary>
		/// This complex type describes the start and end dates of the of the time period over which the associated benchmark is computed. All timestamps are based on Mountain Standard Time (MST). The timestamp is formatted as an ISO 8601 string, which is based on the 24-hour Coordinated Universal Time (UTC) clock.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="evaluationCycle")]
	...
	public class Header
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="dimensionKeys")]
		public Definition[] DimensionKeys { get; set; }
		
		/// <summary>
		/// The list of metrics returned in the report. The values for each are is returned in the associated key fields.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="metrics")]
		public Definition[] Metrics { get; set; }
	}
	...
	public class Metadata
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="metadataHeader")]
		public MetadataHeader MetadataHeader { get; set; }
		
		/// <summary>
		/// A list of the individual report records.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="metadataRecords")]
	...
	public class MetadataHeader
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="metadataKeys")]
		public Definition[] MetadataKeys { get; set; }
	}
	...
	public class MetadataRecord
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="metadataValues")]
		public Value[] MetadataValues { get; set; }
	...
	public class Value
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="applicable")]
		public System.Nullable<System.Boolean> Applicable { get; set; }
	...
	public class Report
	{
		...
		public Metadata[] DimensionMetadata { get; set; }
	...
	public partial class Misc
	{
		...
		/// GetCustomerServiceMetric customer_service_metric/{customer_service_metric_type}/{evaluation_type}
		/// </summary>
		/// <param name="customer_service_metric_type">Use this path parameter to specify the type of customer service metrics and benchmark data you want returned for the seller. Supported types are: ITEM_NOT_AS_DESCRIBED ITEM_NOT_RECEIVED</param>
		/// <param name="evaluation_marketplace_id">Use this query parameter to specify the Marketplace ID to evaluate for the customer service metrics and benchmark data. For the list of supported marketplaces, see Analytics API requirements and restrictions. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/analytics/types/MarketplaceIdEnum.html</param>
		/// <param name="evaluation_type">Use this path parameter to specify the type of the seller evaluation you want returned, either: CURRENT &ndash; A monthly evaluation that occurs on the 20th of every month. PROJECTED &ndash; A daily evaluation that provides a projection of how the seller is currently performing with regards to the upcoming evaluation period.</param>
		/// <returns>Success</returns>
		public async Task<GetCustomerServiceMetricResponse> GetCustomerServiceMetricAsync(string customer_service_metric_type, string evaluation_marketplace_id, string evaluation_type, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GetCustomerServiceMetricResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// FindSellerStandardsProfiles seller_standards_profile
		/// </summary>
		/// <returns>Success</returns>
		public async Task<FindSellerStandardsProfilesResponse> FindSellerStandardsProfilesAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<FindSellerStandardsProfilesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// GetSellerStandardsProfile seller_standards_profile/{program}/{cycle}
		/// </summary>
		/// <param name="cycle">The period covered by the returned standards profile evaluation. Supply one of two values, CURRENT means the response reflects eBay's most recent monthly standards evaluation and PROJECTED means the response reflect the seller's projected monthly evaluation, as calculated at the time of the request.</param>
		/// <param name="program">This input value specifies the region used to determine the seller's standards profile. Supply one of the four following values, PROGRAM_DE, PROGRAM_UK, PROGRAM_US, or PROGRAM_GLOBAL.</param>
		/// <returns>Success</returns>
		public async Task<StandardsProfile> GetSellerStandardsProfileAsync(string cycle, string program, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<StandardsProfile>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>Success</returns>
		public async Task<Report> GetTrafficReportAsync(string dimension, string filter, string metric, string sort, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
