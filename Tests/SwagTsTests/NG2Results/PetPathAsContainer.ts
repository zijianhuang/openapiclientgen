...
export namespace MyNS {
	...
	export class PetClient {
		 ...
		 * @return {void} 
		 */
		Post(requestBody: Pet): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		Put(requestBody: Pet): Observable<HttpResponse<string>> {
	...
	export class Pet_petIdClient {
		 ...
		 */
		GetByPetId(petId: string): Observable<Pet> {
		 ...
		 * @return {void} 
		 */
		DeleteByPetId(petId: string): Observable<HttpResponse<string>> {
	...
	export class PetFindByStatusClient {
		 ...
		 */
		GetByStatus(status: Array<PetStatus>): Observable<Array<Pet>> {
	...
	export class PetFindByTagsClient {
		 ...
		 * @return {Array<Pet>} successful operation
		 */
		GetByTags(tags: Array<string>): Observable<Array<Pet>> {
	...
	export class StoreInventoryClient {
		 ...
		 */
		Get(): Observable<{[id: string]: number }> {
	...
	export class StoreOrderClient {
		 ...
		 */
		Post(requestBody: Order): Observable<Order> {
	...
	export class StoreOrder_orderIdClient {
		 ...
		 * @return {void} 
		 */
		DeleteByOrderId(orderId: string): Observable<HttpResponse<string>> {
	...
	export class UserClient {
		 ...
		 * @return {void} 
		 */
		Post(requestBody: User): Observable<HttpResponse<string>> {
	...
	export class User_usernameClient {
		 ...
		 * @return {void} 
		 */
		PutByUsername(username: string, requestBody: User): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteByUsername(username: string): Observable<HttpResponse<string>> {
	...
	export class UserCreateWithArrayClient {
		 ...
		 * @return {void} 
		 */
		Post(requestBody: Array<User>): Observable<HttpResponse<string>> {
	...
	export class UserLoginClient {
		 ...
		 */
		GetByUsernameAndPassword(username: string, password: string): Observable<string> {
