...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		UpdatePet(requestBody: Pet): Observable<Pet> {
			return this.http.put<Pet>(this.baseUri + 'pet', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Pet} Successful operation
		 */
		AddPet(requestBody: Pet): Observable<Pet> {
			return this.http.post<Pet>(this.baseUri + 'pet', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		FindPetsByStatus(status: PetStatus | null | undefined): Observable<Array<Pet>> {
			return this.http.get<Array<Pet>>(this.baseUri + 'pet/findByStatus?status=' + status, {});
		}
		 ...
		 * @return {Array<Pet>} successful operation
		 */
		FindPetsByTags(tags: Array<string> | null | undefined): Observable<Array<Pet>> {
		 ...
		 * @return {void} 
		 */
		UpdatePetWithForm(petId: string, name: string | null | undefined, status: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'pet/' + petId + '?name=' + (name == null ? '' : encodeURIComponent(name)) + '&status=' + (status == null ? '' : encodeURIComponent(status)), null, { observe: 'response', responseType: 'text' });
		}
		...
		DeleteOrder(orderId: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'store/order/' + orderId, { observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		CreateUsersWithListInput(requestBody: Array<User>): Observable<User> {
			return this.http.post<User>(this.baseUri + 'user/createWithList', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		LoginUser(username: string | null | undefined, password: string | null | undefined): Observable<string> {
