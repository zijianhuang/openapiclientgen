...
export namespace MyNS {
	...
	export function CreateEarningsLineFormGroup() {
		return new FormGroup<EarningsLineFormProperties>({
			...
			CalculationType: new FormControl<EarningsLineCalculationType | null | undefined>(undefined, [Validators.required]),
	...
	export function CreateTaxDeclarationFormGroup() {
		return new FormGroup<TaxDeclarationFormProperties>({
			...
			EmploymentBasis: new FormControl<TaxDeclarationEmploymentBasis | null | undefined>(undefined, [Validators.required]),
