...
export namespace MyNS {
	...
	export function CreateAddressFormGroup() {
		return new FormGroup<AddressFormProperties>({
			...
			Region: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(255)]),
	...
	export function CreateAccountFormGroup() {
		return new FormGroup<AccountFormProperties>({
			Code: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(10)]),
			Name: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(150)]),
	...
	export enum AccountBankAccountType { BANK = 0, CREDITCARD = 1, PAYPAL = 2, NONE = 3, '' = 4 }
	...
	export interface Contact {
		...
		/** 3 letter alpha code for the currency � see list of currency codes */
		DefaultCurrency?: AccountCurrencyCode | null;
	...
	export interface ContactFormProperties {
		...
		/** 3 letter alpha code for the currency � see list of currency codes */
		DefaultCurrency: FormControl<AccountCurrencyCode | null | undefined>,
	...
	export function CreateContactFormGroup() {
		return new FormGroup<ContactFormProperties>({
			...
			ContactNumber: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(50)]),
			...
			DefaultCurrency: new FormControl<AccountCurrencyCode | null | undefined>(undefined),
	...
	export function CreateBatchPaymentFormGroup() {
		return new FormGroup<BatchPaymentFormProperties>({
			Reference: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(12)]),
			Particulars: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(12)]),
			Code: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(12)]),
			Details: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(18)]),
			Narrative: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(18)]),
	...
	export function CreateInvoiceFormGroup() {
		return new FormGroup<InvoiceFormProperties>({
			...
			Date: CreateDateOnlyFormControl(),
			DueDate: CreateDateOnlyFormControl(),
			LineAmountTypes: new FormControl<BankTransactionLineAmountTypes | null | undefined>(undefined),
			InvoiceNumber: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(255)]),
			Reference: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(255)]),
			BrandingThemeID: new FormControl<string | null | undefined>(undefined),
			Url: new FormControl<string | null | undefined>(undefined),
			CurrencyCode: new FormControl<AccountCurrencyCode | null | undefined>(undefined),
			CurrencyRate: new FormControl<number | null | undefined>(undefined),
			...
			ExpectedPaymentDate: CreateDateOnlyFormControl(),
			PlannedPaymentDate: CreateDateOnlyFormControl(),
			...
			FullyPaidOnDate: CreateDateOnlyFormControl(),
	...
	export enum PrepaymentType { 'RECEIVE-PREPAYMENT' = 0, 'SPEND-PREPAYMENT' = 1, ARPREPAYMENT = 2, APPREPAYMENT = 3 }
	...
	export enum OverpaymentType { 'RECEIVE-OVERPAYMENT' = 0, 'SPEND-OVERPAYMENT' = 1, AROVERPAYMENT = 2 }
	...
	export interface CurrencyFormProperties {
		...
		/** 3 letter alpha code for the currency � see list of currency codes */
		Code: FormControl<AccountCurrencyCode | null | undefined>,
	...
	export function CreateCurrencyFormGroup() {
		return new FormGroup<CurrencyFormProperties>({
			Code: new FormControl<AccountCurrencyCode | null | undefined>(undefined),
			Description: new FormControl<string | null | undefined>(undefined),
		});
	...
	export function CreateExpenseClaimFormGroup() {
		return new FormGroup<ExpenseClaimFormProperties>({
			...
			AmountDue: new FormControl<number | null | undefined>(undefined),
			AmountPaid: new FormControl<number | null | undefined>(undefined),
			PaymentDueDate: CreateDateOnlyFormControl(),
			ReportingDate: CreateDateOnlyFormControl(),
	...
	export function CreateJournalFormGroup() {
		return new FormGroup<JournalFormProperties>({
			...
			JournalDate: CreateDateOnlyFormControl(),
	...
	export function CreateTrackingCategoryFormGroup() {
		return new FormGroup<TrackingCategoryFormProperties>({
			...
			TrackingOptionID: new FormControl<string | null | undefined>(undefined),
			Name: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(100)]),
			Option: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(100)]),
			Status: new FormControl<AccountStatus | null | undefined>(undefined),
		});
	...
	export interface Organisation {
		...
		/** 3 letter alpha code for the currency � see list of currency codes */
		BaseCurrency?: AccountCurrencyCode | null;
	...
	export interface OrganisationFormProperties {
		...
		/** 3 letter alpha code for the currency � see list of currency codes */
		BaseCurrency: FormControl<AccountCurrencyCode | null | undefined>,
	...
	export function CreateOrganisationFormGroup() {
		return new FormGroup<OrganisationFormProperties>({
			...
			BaseCurrency: new FormControl<AccountCurrencyCode | null | undefined>(undefined),
			...
			PeriodLockDate: CreateDateOnlyFormControl(),
			EndOfYearLockDate: CreateDateOnlyFormControl(),
			CreatedDateUTC: new FormControl<Date | null | undefined>(undefined),
	...
	export enum OrganisationSalesTaxPeriod { MONTHLY = 0, QUARTERLY1 = 1, QUARTERLY2 = 2, QUARTERLY3 = 3, ANNUALLY = 4, ONEMONTHS = 5, TWOMONTHS = 6, SIXMONTHS = 7, '1MONTHLY' = 8, '2MONTHLY' = 9, '3MONTHLY' = 10, '6MONTHLY' = 11, QUARTERLY = 12, YEARLY = 13, NONE = 14 }
	...
	export function CreatePurchaseOrderFormGroup() {
		return new FormGroup<PurchaseOrderFormProperties>({
			Date: CreateDateOnlyFormControl(),
			DeliveryDate: CreateDateOnlyFormControl(),
			LineAmountTypes: new FormControl<BankTransactionLineAmountTypes | null | undefined>(undefined),
			...
			ExpectedArrivalDate: CreateDateOnlyFormControl(),
	...
	export function CreateQuoteFormGroup() {
		return new FormGroup<QuoteFormProperties>({
			...
			QuoteNumber: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(255)]),
			Reference: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(4000)]),
			Terms: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(4000)]),
			Date: CreateDateOnlyFormControl(),
			DateString: new FormControl<string | null | undefined>(undefined),
			ExpiryDate: CreateDateOnlyFormControl(),
			...
			Summary: new FormControl<string | null | undefined>(undefined, [Validators.maxLength(3000)]),
			BrandingThemeID: new FormControl<string | null | undefined>(undefined),
			UpdatedDateUTC: new FormControl<Date | null | undefined>(undefined),
	...
	export function CreateScheduleFormGroup() {
		return new FormGroup<ScheduleFormProperties>({
			...
			StartDate: CreateDateOnlyFormControl(),
			NextScheduledDate: CreateDateOnlyFormControl(),
			EndDate: CreateDateOnlyFormControl(),
		});
	...
	export class MyClient {
		 ...
		 */
		GetAccounts(where: string | null | undefined, order: string | null | undefined): Observable<Accounts> {
		 ...
		 */
		GetBatchPayments(where: string | null | undefined, order: string | null | undefined): Observable<BatchPayments> {
		 ...
		 * @return {BatchPayments} Success - return response of type BatchPayments array of BatchPayment objects
		 */
		CreateBatchPayment(summarizeErrors: boolean | null | undefined, requestBody: BatchPayments): Observable<BatchPayments> {
		 ...
		 */
		GetBankTransactions(where: string | null | undefined, order: string | null | undefined, page: number | null | undefined, unitdp: number | null | undefined): Observable<BankTransactions> {
		 ...
		 */
		CreateBankTransactions(summarizeErrors: boolean | null | undefined, unitdp: number | null | undefined, requestBody: BankTransactions): Observable<BankTransactions> {
		 ...
		 * @return {BankTransactions} Success - return response of type BankTransactions array with new BankTransaction
		 */
		UpdateOrCreateBankTransactions(summarizeErrors: boolean | null | undefined, unitdp: number | null | undefined, requestBody: BankTransactions): Observable<BankTransactions> {
		 ...
		 */
		GetBankTransaction(BankTransactionID: string, unitdp: number | null | undefined): Observable<BankTransactions> {
		 ...
		 */
		UpdateBankTransaction(BankTransactionID: string, unitdp: number | null | undefined, requestBody: BankTransactions): Observable<BankTransactions> {
		 ...
		 */
		GetBankTransfers(where: string | null | undefined, order: string | null | undefined): Observable<BankTransfers> {
		 ...
		 */
		CreateContacts(summarizeErrors: boolean | null | undefined, requestBody: Contacts): Observable<Contacts> {
		 ...
		 * @return {Contacts} Success - return response of type Contacts array with newly created Contact
		 */
		UpdateOrCreateContacts(summarizeErrors: boolean | null | undefined, requestBody: Contacts): Observable<Contacts> {
		 ...
		 */
		GetContactGroups(where: string | null | undefined, order: string | null | undefined): Observable<ContactGroups> {
		 ...
		 */
		GetCreditNotes(where: string | null | undefined, order: string | null | undefined, page: number | null | undefined, unitdp: number | null | undefined): Observable<CreditNotes> {
		 ...
		 */
		CreateCreditNotes(summarizeErrors: boolean | null | undefined, unitdp: number | null | undefined, requestBody: CreditNotes): Observable<CreditNotes> {
		 ...
		 * @return {CreditNotes} Success - return response of type Credit Notes array of newly created CreditNote
		 */
		UpdateOrCreateCreditNotes(summarizeErrors: boolean | null | undefined, unitdp: number | null | undefined, requestBody: CreditNotes): Observable<CreditNotes> {
		 ...
		 */
		GetCreditNote(CreditNoteID: string, unitdp: number | null | undefined): Observable<CreditNotes> {
		 ...
		 */
		UpdateCreditNote(CreditNoteID: string, unitdp: number | null | undefined, requestBody: CreditNotes): Observable<CreditNotes> {
		 ...
		 */
		CreateCreditNoteAllocation(CreditNoteID: string, summarizeErrors: boolean | null | undefined, requestBody: Allocations): Observable<Allocations> {
		 ...
		 */
		GetCurrencies(where: string | null | undefined, order: string | null | undefined): Observable<Currencies> {
		 ...
		 */
		GetEmployees(where: string | null | undefined, order: string | null | undefined): Observable<Employees> {
		 ...
		 */
		CreateEmployees(summarizeErrors: boolean | null | undefined, requestBody: Employees): Observable<Employees> {
		 ...
		 * @return {Employees} Success - return response of type Employees array with new Employee
		 */
		UpdateOrCreateEmployees(summarizeErrors: boolean | null | undefined, requestBody: Employees): Observable<Employees> {
		 ...
		 */
		GetExpenseClaims(where: string | null | undefined, order: string | null | undefined): Observable<ExpenseClaims> {
		 ...
		 */
		CreateInvoices(summarizeErrors: boolean | null | undefined, unitdp: number | null | undefined, requestBody: Invoices): Observable<Invoices> {
		 ...
		 * @return {Invoices} Success - return response of type Invoices array with newly created Invoice
		 */
		UpdateOrCreateInvoices(summarizeErrors: boolean | null | undefined, unitdp: number | null | undefined, requestBody: Invoices): Observable<Invoices> {
		 ...
		 */
		GetInvoice(InvoiceID: string, unitdp: number | null | undefined): Observable<Invoices> {
		 ...
		 */
		UpdateInvoice(InvoiceID: string, unitdp: number | null | undefined, requestBody: Invoices): Observable<Invoices> {
		 ...
		 */
		GetItems(where: string | null | undefined, order: string | null | undefined, unitdp: number | null | undefined): Observable<Items> {
		 ...
		 */
		CreateItems(summarizeErrors: boolean | null | undefined, unitdp: number | null | undefined, requestBody: Items): Observable<Items> {
		 ...
		 * @return {Items} Success - return response of type Items array with newly created Item
		 */
		UpdateOrCreateItems(summarizeErrors: boolean | null | undefined, unitdp: number | null | undefined, requestBody: Items): Observable<Items> {
		 ...
		 */
		GetItem(ItemID: string, unitdp: number | null | undefined): Observable<Items> {
		 ...
		 */
		UpdateItem(ItemID: string, unitdp: number | null | undefined, requestBody: Items): Observable<Items> {
		 ...
		 */
		GetJournals(offset: number | null | undefined, paymentsOnly: boolean | null | undefined): Observable<Journals> {
		 ...
		 */
		GetLinkedTransactions(page: number | null | undefined, LinkedTransactionID: string | null | undefined, SourceTransactionID: string | null | undefined, ContactID: string | null | undefined, Status: string | null | undefined, TargetTransactionID: string | null | undefined): Observable<LinkedTransactions> {
		 ...
		 */
		GetManualJournals(where: string | null | undefined, order: string | null | undefined, page: number | null | undefined): Observable<ManualJournals> {
		 ...
		 */
		CreateManualJournals(summarizeErrors: boolean | null | undefined, requestBody: ManualJournals): Observable<ManualJournals> {
		 ...
		 * @return {ManualJournals} Success - return response of type ManualJournals array with newly created ManualJournal
		 */
		UpdateOrCreateManualJournals(summarizeErrors: boolean | null | undefined, requestBody: ManualJournals): Observable<ManualJournals> {
		 ...
		 */
		GetOverpayments(where: string | null | undefined, order: string | null | undefined, page: number | null | undefined, unitdp: number | null | undefined): Observable<Overpayments> {
		 ...
		 */
		CreateOverpaymentAllocations(OverpaymentID: string, summarizeErrors: boolean | null | undefined, requestBody: Allocations): Observable<Allocations> {
		 ...
		 */
		GetPayments(where: string | null | undefined, order: string | null | undefined, page: number | null | undefined): Observable<Payments> {
		 ...
		 */
		CreatePayments(summarizeErrors: boolean | null | undefined, requestBody: Payments): Observable<Payments> {
		 ...
		 */
		GetPrepayments(where: string | null | undefined, order: string | null | undefined, page: number | null | undefined, unitdp: number | null | undefined): Observable<Prepayments> {
		 ...
		 */
		CreatePrepaymentAllocations(PrepaymentID: string, summarizeErrors: boolean | null | undefined, requestBody: Allocations): Observable<Allocations> {
		 ...
		 */
		GetPurchaseOrders(Status: PurchaseOrderStatus | null | undefined, DateFrom: string | null | undefined, DateTo: string | null | undefined, order: string | null | undefined, page: number | null | undefined): Observable<PurchaseOrders> {
		 ...
		 */
		CreatePurchaseOrders(summarizeErrors: boolean | null | undefined, requestBody: PurchaseOrders): Observable<PurchaseOrders> {
		 ...
		 * @return {PurchaseOrders} Success - return response of type PurchaseOrder array for specified PurchaseOrder
		 */
		UpdateOrCreatePurchaseOrders(summarizeErrors: boolean | null | undefined, requestBody: PurchaseOrders): Observable<PurchaseOrders> {
		 ...
		 */
		CreateQuotes(summarizeErrors: boolean | null | undefined, requestBody: Quotes): Observable<Quotes> {
		 ...
		 */
		UpdateOrCreateQuotes(summarizeErrors: boolean | null | undefined, requestBody: Quotes): Observable<Quotes> {
		 ...
		 */
		GetReceipts(where: string | null | undefined, order: string | null | undefined, unitdp: number | null | undefined): Observable<Receipts> {
		 ...
		 */
		CreateReceipt(unitdp: number | null | undefined, requestBody: Receipts): Observable<Receipts> {
		 ...
		 */
		GetReceipt(ReceiptID: string, unitdp: number | null | undefined): Observable<Receipts> {
		 ...
		 */
		UpdateReceipt(ReceiptID: string, unitdp: number | null | undefined, requestBody: Receipts): Observable<Receipts> {
		 ...
		 */
		GetRepeatingInvoices(where: string | null | undefined, order: string | null | undefined): Observable<RepeatingInvoices> {
		 ...
		 */
		GetReportTenNinetyNine(reportYear: string | null | undefined): Observable<Reports> {
		 ...
		 * @return {ReportWithRows} Success - return response of type ReportWithRows
		 */
		GetReportBalanceSheet(date: string | null | undefined, periods: number | null | undefined, timeframe: GetReportBalanceSheetTimeframe | null | undefined, trackingOptionID1: string | null | undefined, trackingOptionID2: string | null | undefined, standardLayout: boolean | null | undefined, paymentsOnly: boolean | null | undefined): Observable<ReportWithRows> {
		 ...
		 */
		GetTaxRates(where: string | null | undefined, order: string | null | undefined, TaxType: string | null | undefined): Observable<TaxRates> {
		 ...
		 */
		GetTrackingCategories(where: string | null | undefined, order: string | null | undefined, includeArchived: boolean | null | undefined): Observable<TrackingCategories> {
		 ...
		 */
		GetUsers(where: string | null | undefined, order: string | null | undefined): Observable<Users> {
