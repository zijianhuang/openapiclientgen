...
export namespace MyNS {
	...
	export class Misc {
		 ...
		 * @return {void} 
		 */
		PetPost(requestBody: Pet): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PetPut(requestBody: Pet): Observable<HttpResponse<string>> {
		 ...
		 */
		Pet_petIdGet(petId: string): Observable<Pet> {
		 ...
		 * @return {void} 
		 */
		Pet_petIdDelete(petId: string): Observable<HttpResponse<string>> {
		 ...
		 */
		PetFindByStatusGetByStatus(status: Array<PetStatus>): Observable<Array<Pet>> {
		 ...
		 * @return {Array<Pet>} successful operation
		 */
		PetFindByTagsGetByTags(tags: Array<string>): Observable<Array<Pet>> {
		 ...
		 */
		StoreInventoryGet(): Observable<{[id: string]: number }> {
		 ...
		 */
		StoreOrderPost(requestBody: Order): Observable<Order> {
		 ...
		 * @return {Order} successful operation
		 */
		StoreOrder_orderIdGet(orderId: string): Observable<Order> {
		 ...
		 * @return {void} 
		 */
		StoreOrder_orderIdDelete(orderId: string): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		UserPost(requestBody: User): Observable<HttpResponse<string>> {
		 ...
		 */
		User_usernameGet(username: string): Observable<User> {
		 ...
		 * @return {void} 
		 */
		User_usernamePut(username: string, requestBody: User): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		User_usernameDelete(username: string): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		UserCreateWithArrayPost(requestBody: Array<User>): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		UserCreateWithListPost(requestBody: Array<User>): Observable<HttpResponse<string>> {
		 ...
		 */
		UserLoginGetByUsernameAndPassword(username: string, password: string): Observable<string> {
		 ...
		 * @return {void} 
		 */
		UserLogoutGet(): Observable<HttpResponse<string>> {
