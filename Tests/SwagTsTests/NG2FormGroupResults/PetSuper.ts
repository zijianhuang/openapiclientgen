...
export namespace MyNS {
	...
	/** A representation of a dog */
	export interface SuperDog extends Dog {

		/**
		 * How super
		 * Minimum: 1
		 */
		superIndex?: number | null;
	}

	/** A representation of a dog */
	export interface SuperDogFormProperties extends DogFormProperties {

		/**
		 * How super
		 * Minimum: 1
		 */
		superIndex: FormControl<number | null | undefined>,
	}
	export function CreateSuperDogFormGroup() {
		return new FormGroup<SuperDogFormProperties>({
			id: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			status: new FormControl<PetStatus | null | undefined>(undefined),
			petType: new FormControl<string | null | undefined>(undefined),
			packSize: new FormControl<number | null | undefined>(undefined, [Validators.required, Validators.min(1)]),
			superIndex: new FormControl<number | null | undefined>(undefined, [Validators.min(1)]),
		});
