...
export namespace MyNS {
	...
	export class CountryClient {
		...
		GetSalesTaxJurisdictions(countryCode: string): Promise<SalesTaxJurisdictions> {
			return this.http.get('country/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/sales_tax_jurisdiction', {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class MarketplaceClient {
		...
		GetAutomotivePartsCompatibilityPolicies(filter: string | null | undefined, marketplace_id: string): Promise<AutomotivePartsCompatibilityPolicyResponse> {
			return this.http.get('marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_automotive_parts_compatibility_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetItemConditionPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ItemConditionPolicyResponse> {
			return this.http.get('marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_item_condition_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetListingStructurePolicies(filter: string | null | undefined, marketplace_id: string): Promise<ListingStructurePolicyResponse> {
			return this.http.get('marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_listing_structure_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetNegotiatedPricePolicies(filter: string | null | undefined, marketplace_id: string): Promise<NegotiatedPricePolicyResponse> {
			return this.http.get('marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_negotiated_price_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetProductAdoptionPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ProductAdoptionPolicyResponse> {
			return this.http.get('marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_product_adoption_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetReturnPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ReturnPolicyResponse> {
			return this.http.get('marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_return_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
