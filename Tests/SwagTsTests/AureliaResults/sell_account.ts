...
export namespace MyNS {
	...
	export class Fulfillment_policyClient {
		...
		GetFulfillmentPolicies(marketplace_id: string): Promise<FulfillmentPolicyResponse> {
			return this.http.get('fulfillment_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateFulfillmentPolicy(requestBody: FulfillmentPolicyRequest): Promise<Response> {
			return this.http.post('fulfillment_policy/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetFulfillmentPolicy(fulfillmentPolicyId: string): Promise<FulfillmentPolicy> {
			return this.http.get('fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		UpdateFulfillmentPolicy(fulfillmentPolicyId: string, requestBody: FulfillmentPolicyRequest): Promise<SetFulfillmentPolicyResponse> {
			return this.http.put('fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteFulfillmentPolicy(fulfillmentPolicyId: string): Promise<Response> {
			return this.http.delete('fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), {});
		}
		...
		GetFulfillmentPolicyByName(marketplace_id: string, name: string): Promise<FulfillmentPolicy> {
			return this.http.get('fulfillment_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Payment_policyClient {
		...
		GetPaymentPolicies(marketplace_id: string): Promise<PaymentPolicyResponse> {
			return this.http.get('payment_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreatePaymentPolicy(requestBody: PaymentPolicyRequest): Promise<Response> {
			return this.http.post('payment_policy/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetPaymentPolicy(payment_policy_id: string): Promise<PaymentPolicy> {
			return this.http.get('payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		UpdatePaymentPolicy(payment_policy_id: string, requestBody: PaymentPolicyRequest): Promise<SetPaymentPolicyResponse> {
			return this.http.put('payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeletePaymentPolicy(payment_policy_id: string): Promise<Response> {
			return this.http.delete('payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), {});
		}
		...
		GetPaymentPolicyByName(marketplace_id: string, name: string): Promise<PaymentPolicy> {
			return this.http.get('payment_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Payments_programClient {
		...
		GetPaymentsProgram(marketplace_id: string, payments_program_type: string): Promise<PaymentsProgramResponse> {
			return this.http.get('payments_program/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/' + (payments_program_type == null ? '' : encodeURIComponent(payments_program_type)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class PrivilegeClient {
		...
		GetPrivileges(): Promise<SellingPrivileges> {
			return this.http.get('privilege/', {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class ProgramClient {
		...
		GetOptedInPrograms(): Promise<Programs> {
			return this.http.get('program/get_opted_in_programs', {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		OptInToProgram(requestBody: Program): Promise<string> {
			return this.http.post('program/opt_in', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.text(); throw d;});
		}
		...
		OptOutOfProgram(requestBody: Program): Promise<string> {
			return this.http.post('program/opt_out', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.text(); throw d;});
		}
	}
	...
	export class Rate_tableClient {
		...
		GetRateTables(country_code: string | null | undefined): Promise<RateTableResponse> {
			return this.http.get('rate_table/?country_code=' + (country_code == null ? '' : encodeURIComponent(country_code)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Return_policyClient {
		...
		GetReturnPolicies(marketplace_id: string): Promise<ReturnPolicyResponse> {
			return this.http.get('return_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateReturnPolicy(requestBody: ReturnPolicyRequest): Promise<Response> {
			return this.http.post('return_policy/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetReturnPolicy(return_policy_id: string): Promise<ReturnPolicy> {
			return this.http.get('return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		UpdateReturnPolicy(return_policy_id: string, requestBody: ReturnPolicyRequest): Promise<SetReturnPolicyResponse> {
			return this.http.put('return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteReturnPolicy(return_policy_id: string): Promise<Response> {
			return this.http.delete('return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), {});
		}
		...
		GetReturnPolicyByName(marketplace_id: string, name: string): Promise<ReturnPolicy> {
			return this.http.get('return_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Sales_taxClient {
		...
		GetSalesTax(countryCode: string, jurisdictionId: string): Promise<SalesTax> {
			return this.http.get('sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateOrReplaceSalesTax(countryCode: string, jurisdictionId: string, requestBody: SalesTaxBase): Promise<Response> {
			return this.http.put('sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteSalesTax(countryCode: string, jurisdictionId: string): Promise<Response> {
			return this.http.delete('sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), {});
		}
		...
		GetSalesTaxes(country_code: string): Promise<SalesTaxes> {
			return this.http.get('sales_tax/?country_code=' + (country_code == null ? '' : encodeURIComponent(country_code)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
