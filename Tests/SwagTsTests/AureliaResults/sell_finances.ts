...
export namespace MyNS {
	...
	export class PayoutClient {
		...
		GetPayout(payout_Id: string): Promise<Payout> {
			return this.http.get('payout/' + (payout_Id == null ? '' : encodeURIComponent(payout_Id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetPayouts(filter: string | null | undefined, sort: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Payouts> {
			return this.http.get('payout?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetPayoutSummary(filter: string | null | undefined): Promise<PayoutSummaryResponse> {
			return this.http.get('payout_summary?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class TransactionClient {
		...
		GetTransactions(filter: string | null | undefined, sort: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Transactions> {
			return this.http.get('transaction?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetTransactionSummary(filter: string | null | undefined): Promise<TransactionSummaryResponse> {
			return this.http.get('transaction_summary?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Seller_funds_summaryClient {
		...
		GetSellerFundsSummary(): Promise<SellerFundsSummaryResponse> {
			return this.http.get('seller_funds_summary', {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
