...
export namespace MyNS {
	...
	export class AdClient {
		...
		BulkCreateAdsByInventoryReference(campaign_id: string, requestBody: BulkCreateAdsByInventoryReferenceRequest): Promise<BulkCreateAdsByInventoryReferenceResponse> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_create_ads_by_inventory_reference', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkCreateAdsByListingId(campaign_id: string, requestBody: BulkCreateAdRequest): Promise<BulkAdResponse> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_create_ads_by_listing_id', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkDeleteAdsByInventoryReference(campaign_id: string, requestBody: BulkDeleteAdsByInventoryReferenceRequest): Promise<BulkDeleteAdsByInventoryReferenceResponse> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_delete_ads_by_inventory_reference', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkDeleteAdsByListingId(campaign_id: string, requestBody: BulkDeleteAdRequest): Promise<BulkDeleteAdResponse> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_delete_ads_by_listing_id', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkUpdateAdsBidByInventoryReference(campaign_id: string, requestBody: BulkCreateAdsByInventoryReferenceRequest): Promise<BulkCreateAdsByInventoryReferenceResponse> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_update_ads_bid_by_inventory_reference', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkUpdateAdsBidByListingId(campaign_id: string, requestBody: BulkCreateAdRequest): Promise<BulkAdResponse> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_update_ads_bid_by_listing_id', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetAds(campaign_id: string, limit: string | null | undefined, listing_ids: string, offset: string | null | undefined): Promise<AdPagedCollection> {
			return this.http.get('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&listing_ids=' + (listing_ids == null ? '' : encodeURIComponent(listing_ids)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateAdByListingId(campaign_id: string, requestBody: CreateAdRequest): Promise<Response> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateAdsByInventoryReference(campaign_id: string, requestBody: CreateAdsByInventoryReferenceRequest): Promise<Response> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/create_ads_by_inventory_reference', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetAd(ad_id: string, campaign_id: string): Promise<Ad> {
			return this.http.get('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad/' + (ad_id == null ? '' : encodeURIComponent(ad_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteAd(ad_id: string, campaign_id: string): Promise<Response> {
			return this.http.delete('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad/' + (ad_id == null ? '' : encodeURIComponent(ad_id)), {});
		}
		...
		DeleteAdsByInventoryReference(campaign_id: string, requestBody: DeleteAdsByInventoryReferenceRequest): Promise<AdIds> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/delete_ads_by_inventory_reference', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetAdsByInventoryReference(campaign_id: string, inventory_reference_id: string, inventory_reference_type: string): Promise<Ads> {
			return this.http.get('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/get_ads_by_inventory_reference&inventory_reference_id=' + (inventory_reference_id == null ? '' : encodeURIComponent(inventory_reference_id)) + '&inventory_reference_type=' + (inventory_reference_type == null ? '' : encodeURIComponent(inventory_reference_type)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		UpdateBid(ad_id: string, campaign_id: string, requestBody: UpdateBidPercentageRequest): Promise<Response> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad/' + (ad_id == null ? '' : encodeURIComponent(ad_id)) + '/update_bid', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
	...
	export class CampaignClient {
		...
		CloneCampaign(campaign_id: string, requestBody: CloneCampaignRequest): Promise<Response> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/clone', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetCampaigns(campaign_name: string | null | undefined, campaign_status: string | null | undefined, end_date_range: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined, start_date_range: string | null | undefined): Promise<CampaignPagedCollection> {
			return this.http.get('ad_campaign?campaign_name=' + (campaign_name == null ? '' : encodeURIComponent(campaign_name)) + '&campaign_status=' + (campaign_status == null ? '' : encodeURIComponent(campaign_status)) + '&end_date_range=' + (end_date_range == null ? '' : encodeURIComponent(end_date_range)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&start_date_range=' + (start_date_range == null ? '' : encodeURIComponent(start_date_range)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateCampaign(requestBody: CreateCampaignRequest): Promise<Response> {
			return this.http.post('ad_campaign', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetCampaign(campaign_id: string): Promise<Campaign> {
			return this.http.get('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteCampaign(campaign_id: string): Promise<Response> {
			return this.http.delete('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), {});
		}
		...
		EndCampaign(campaign_id: string): Promise<Response> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/end', null, {});
		}
		...
		FindCampaignByAdReference(inventory_reference_id: string | null | undefined, inventory_reference_type: string | null | undefined, listing_id: string | null | undefined): Promise<Campaigns> {
			return this.http.get('ad_campaign/find_campaign_by_ad_reference?inventory_reference_id=' + (inventory_reference_id == null ? '' : encodeURIComponent(inventory_reference_id)) + '&inventory_reference_type=' + (inventory_reference_type == null ? '' : encodeURIComponent(inventory_reference_type)) + '&listing_id=' + (listing_id == null ? '' : encodeURIComponent(listing_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetCampaignByName(campaign_name: string): Promise<Campaign> {
			return this.http.get('ad_campaign/get_campaign_by_name?campaign_name=' + (campaign_name == null ? '' : encodeURIComponent(campaign_name)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		PauseCampaign(campaign_id: string): Promise<Response> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/pause', null, {});
		}
		...
		ResumeCampaign(campaign_id: string): Promise<Response> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/resume', null, {});
		}
		...
		UpdateCampaignIdentification(campaign_id: string, requestBody: UpdateCampaignIdentificationRequest): Promise<Response> {
			return this.http.post('ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/update_campaign_identification', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
	...
	export class Ad_reportClient {
		...
		GetReport(report_id: string): Promise<Response> {
			return this.http.get('ad_report/' + (report_id == null ? '' : encodeURIComponent(report_id)), {});
		}
	}
	...
	export class Ad_report_metadataClient {
		...
		GetReportMetadata(): Promise<ReportMetadatas> {
			return this.http.get('ad_report_metadata', {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		GetReportMetadataForReportType(report_type: string): Promise<ReportMetadata> {
			return this.http.get('ad_report_metadata/' + (report_type == null ? '' : encodeURIComponent(report_type)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Ad_report_taskClient {
		...
		GetReportTasks(limit: string | null | undefined, offset: string | null | undefined, report_task_statuses: string | null | undefined): Promise<ReportTaskPagedCollection> {
			return this.http.get('ad_report_task?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&report_task_statuses=' + (report_task_statuses == null ? '' : encodeURIComponent(report_task_statuses)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateReportTask(requestBody: CreateReportTask): Promise<Response> {
			return this.http.post('ad_report_task', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetReportTask(report_task_id: string): Promise<ReportTask> {
			return this.http.get('ad_report_task/' + (report_task_id == null ? '' : encodeURIComponent(report_task_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteReportTask(report_task_id: string): Promise<Response> {
			return this.http.delete('ad_report_task/' + (report_task_id == null ? '' : encodeURIComponent(report_task_id)), {});
		}
	}
	...
	export class Item_price_markdownClient {
		...
		CreateItemPriceMarkdownPromotion(requestBody: ItemPriceMarkdown): Promise<Response> {
			return this.http.post('item_price_markdown', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetItemPriceMarkdownPromotion(promotion_id: string): Promise<ItemPriceMarkdown> {
			return this.http.get('item_price_markdown/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		UpdateItemPriceMarkdownPromotion(promotion_id: string, requestBody: ItemPriceMarkdown): Promise<string> {
			return this.http.put('item_price_markdown/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.text(); throw d;});
		}
		...
		DeleteItemPriceMarkdownPromotion(promotion_id: string): Promise<Response> {
			return this.http.delete('item_price_markdown/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), {});
		}
	}
	...
	export class Item_promotionClient {
		...
		CreateItemPromotion(requestBody: ItemPromotion): Promise<Response> {
			return this.http.post('item_promotion', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetItemPromotion(promotion_id: string): Promise<ItemPromotionResponse> {
			return this.http.get('item_promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		UpdateItemPromotion(promotion_id: string, requestBody: ItemPromotion): Promise<BaseResponse> {
			return this.http.put('item_promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteItemPromotion(promotion_id: string): Promise<Response> {
			return this.http.delete('item_promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), {});
		}
	}
	...
	export class PromotionClient {
		...
		GetListingSet(limit: string | null | undefined, offset: string | null | undefined, promotion_id: string, q: string | null | undefined, sort: string | null | undefined, status: string | null | undefined): Promise<Response> {
			return this.http.get('promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)) + '/get_listing_set?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&q=' + (q == null ? '' : encodeURIComponent(q)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&status=' + (status == null ? '' : encodeURIComponent(status)), {});
		}
		...
		GetPromotions(limit: string | null | undefined, marketplace_id: string, offset: string | null | undefined, promotion_status: string | null | undefined, promotion_type: string | null | undefined, q: string | null | undefined, sort: string | null | undefined): Promise<PromotionsPagedCollection> {
			return this.http.get('promotion?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&promotion_status=' + (promotion_status == null ? '' : encodeURIComponent(promotion_status)) + '&promotion_type=' + (promotion_type == null ? '' : encodeURIComponent(promotion_type)) + '&q=' + (q == null ? '' : encodeURIComponent(q)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		PausePromotion(promotion_id: string): Promise<Response> {
			return this.http.post('promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)) + '/pause', null, {});
		}
		...
		ResumePromotion(promotion_id: string): Promise<Response> {
			return this.http.post('promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)) + '/resume', null, {});
		}
	}
	...
	export class Promotion_reportClient {
		...
		GetPromotionReports(limit: string | null | undefined, marketplace_id: string, offset: string | null | undefined, promotion_status: string | null | undefined, promotion_type: string | null | undefined, q: string | null | undefined): Promise<PromotionsReportPagedCollection> {
			return this.http.get('promotion_report?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&promotion_status=' + (promotion_status == null ? '' : encodeURIComponent(promotion_status)) + '&promotion_type=' + (promotion_type == null ? '' : encodeURIComponent(promotion_type)) + '&q=' + (q == null ? '' : encodeURIComponent(q)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Promotion_summary_reportClient {
		...
		GetPromotionSummaryReport(marketplace_id: string): Promise<SummaryReportResponse> {
			return this.http.get('promotion_summary_report?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
