...
export namespace MyNS {
	...
	export class LocationClient {
		...
		GetInventoryLocation(merchantLocationKey: string): Promise<InventoryLocationResponse> {
			return this.http.get('location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateInventoryLocation(merchantLocationKey: string, requestBody: InventoryLocationFull): Promise<Response> {
			return this.http.post('location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteInventoryLocation(merchantLocationKey: string): Promise<Response> {
			return this.http.delete('location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), {});
		}
		...
		DisableInventoryLocation(merchantLocationKey: string): Promise<string> {
			return this.http.post('location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/disable', null, {}).then(d => {if (d.status<=204) return d.text(); throw d;});
		}
		...
		EnableInventoryLocation(merchantLocationKey: string): Promise<string> {
			return this.http.post('location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/enable', null, {}).then(d => {if (d.status<=204) return d.text(); throw d;});
		}
		...
		GetInventoryLocations(limit: string | null | undefined, offset: string | null | undefined): Promise<LocationResponse> {
			return this.http.get('location?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		UpdateInventoryLocation(merchantLocationKey: string, requestBody: InventoryLocation): Promise<Response> {
			return this.http.post('location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/update_location_details', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
	...
	export class Inventory_itemClient {
		...
		GetInventoryItem(sku: string): Promise<InventoryItemWithSkuLocaleGroupid> {
			return this.http.get('inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateOrReplaceInventoryItem(sku: string, requestBody: InventoryItem): Promise<BaseResponse> {
			return this.http.put('inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteInventoryItem(sku: string): Promise<Response> {
			return this.http.delete('inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), {});
		}
		...
		GetInventoryItems(limit: string | null | undefined, offset: string | null | undefined): Promise<InventoryItems> {
			return this.http.get('inventory_item?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkUpdatePriceQuantity(requestBody: BulkPriceQuantity): Promise<BulkPriceQuantityResponse> {
			return this.http.post('bulk_update_price_quantity', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkCreateOrReplaceInventoryItem(requestBody: BulkInventoryItem): Promise<BulkInventoryItemResponse> {
			return this.http.post('bulk_create_or_replace_inventory_item', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkGetInventoryItem(requestBody: BulkGetInventoryItem): Promise<BulkGetInventoryItemResponse> {
			return this.http.post('bulk_get_inventory_item', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Product_compatibilityClient {
		...
		GetProductCompatibility(sku: string): Promise<Compatibility> {
			return this.http.get('inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateOrReplaceProductCompatibility(sku: string, requestBody: Compatibility): Promise<BaseResponse> {
			return this.http.put('inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteProductCompatibility(sku: string): Promise<Response> {
			return this.http.delete('inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', {});
		}
	}
	...
	export class OfferClient {
		...
		GetOffers(sku: string | null | undefined, marketplace_id: string | null | undefined, format: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Offers> {
			return this.http.get('offer?sku=' + (sku == null ? '' : encodeURIComponent(sku)) + '&marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&format=' + (format == null ? '' : encodeURIComponent(format)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateOffer(requestBody: EbayOfferDetailsWithKeys): Promise<Response> {
			return this.http.post('offer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetOffer(offerId: string): Promise<EbayOfferDetailsWithAll> {
			return this.http.get('offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		UpdateOffer(offerId: string, requestBody: EbayOfferDetailsWithId): Promise<OfferResponse> {
			return this.http.put('offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteOffer(offerId: string): Promise<Response> {
			return this.http.delete('offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), {});
		}
		...
		PublishOffer(offerId: string): Promise<PublishResponse> {
			return this.http.post('offer/' + (offerId == null ? '' : encodeURIComponent(offerId)) + '/publish/', null, {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		PublishOfferByInventoryItemGroup(requestBody: PublishByInventoryItemGroupRequest): Promise<PublishResponse> {
			return this.http.post('offer/publish_by_inventory_item_group/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		WithdrawOfferByInventoryItemGroup(requestBody: WithdrawByInventoryItemGroupRequest): Promise<Response> {
			return this.http.post('offer/withdraw_by_inventory_item_group', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetListingFees(requestBody: OfferKeysWithId): Promise<FeesSummaryResponse> {
			return this.http.post('offer/get_listing_fees', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkCreateOffer(requestBody: BulkEbayOfferDetailsWithKeys): Promise<BulkOfferResponse> {
			return this.http.post('bulk_create_offer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		BulkPublishOffer(requestBody: BulkOffer): Promise<BulkPublishResponse> {
			return this.http.post('bulk_publish_offer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		WithdrawOffer(offerId: string): Promise<WithdrawResponse> {
			return this.http.post('offer/' + (offerId == null ? '' : encodeURIComponent(offerId)) + '/withdraw', null, {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
	...
	export class Inventory_item_groupClient {
		...
		GetInventoryItemGroup(inventoryItemGroupKey: string): Promise<InventoryItemGroup> {
			return this.http.get('inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), {}).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		CreateOrReplaceInventoryItemGroup(inventoryItemGroupKey: string, requestBody: InventoryItemGroup): Promise<BaseResponse> {
			return this.http.put('inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
		...
		DeleteInventoryItemGroup(inventoryItemGroupKey: string): Promise<Response> {
			return this.http.delete('inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), {});
		}
	}
	...
	export class ListingClient {
		...
		BulkMigrateListing(requestBody: BulkMigrateListing): Promise<BulkMigrateListingResponse> {
			return this.http.post('bulk_migrate_listing', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.json(); throw d;});
		}
	}
