...
export namespace MyNS {
	...
	export class Listing_violation_summaryClient {
		...
		GetListingViolationsSummary(compliance_type: string | null | undefined): Promise<Response> {
			return this.http.get('listing_violation_summary?compliance_type=' + (compliance_type == null ? '' : encodeURIComponent(compliance_type)), {});
		}
	}
	...
	export class Listing_violationClient {
		...
		GetListingViolations(compliance_type: string | null | undefined, offset: string | null | undefined, listing_id: string | null | undefined, limit: string | null | undefined, filter: string | null | undefined): Promise<Response> {
			return this.http.get('listing_violation?compliance_type=' + (compliance_type == null ? '' : encodeURIComponent(compliance_type)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&listing_id=' + (listing_id == null ? '' : encodeURIComponent(listing_id)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), {});
		}
		...
		SuppressViolation(requestBody: SuppressViolationRequest): Promise<Response> {
			return this.http.post('suppress_listing_violation', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
