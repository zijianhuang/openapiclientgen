...
export namespace MyNS {
	...
	export class LocationClient {
		 ...
		 */
		GetInventoryLocation(merchantLocationKey: string, callback: (data : InventoryLocationResponse) => any) {
			this.httpClient.get(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreateInventoryLocation(merchantLocationKey: string, callback: (data : void) => any, requestBody: InventoryLocationFull) {
			this.httpClient.post(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryLocation(merchantLocationKey: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		DisableInventoryLocation(merchantLocationKey: string, callback: (data : string) => any) {
			this.httpClient.post(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/disable', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {string} Success
		 */
		EnableInventoryLocation(merchantLocationKey: string, callback: (data : string) => any) {
			this.httpClient.post(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/enable', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetInventoryLocations(limit: string | null | undefined, offset: string | null | undefined, callback: (data : LocationResponse) => any) {
			this.httpClient.get(this.baseUri + 'location?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		UpdateInventoryLocation(merchantLocationKey: string, callback: (data : void) => any, requestBody: InventoryLocation) {
			this.httpClient.post(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/update_location_details', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
	...
	export class Inventory_itemClient {
		 ...
		 */
		GetInventoryItem(sku: string, callback: (data : InventoryItemWithSkuLocaleGroupid) => any) {
			this.httpClient.get(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		CreateOrReplaceInventoryItem(sku: string, callback: (data : BaseResponse) => any, requestBody: InventoryItem) {
			this.httpClient.put(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryItem(sku: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetInventoryItems(limit: string | null | undefined, offset: string | null | undefined, callback: (data : InventoryItems) => any) {
			this.httpClient.get(this.baseUri + 'inventory_item?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		BulkUpdatePriceQuantity(callback: (data : BulkPriceQuantityResponse) => any, requestBody: BulkPriceQuantity) {
			this.httpClient.post(this.baseUri + 'bulk_update_price_quantity', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		BulkCreateOrReplaceInventoryItem(callback: (data : BulkInventoryItemResponse) => any, requestBody: BulkInventoryItem) {
			this.httpClient.post(this.baseUri + 'bulk_create_or_replace_inventory_item', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		BulkGetInventoryItem(callback: (data : BulkGetInventoryItemResponse) => any, requestBody: BulkGetInventoryItem) {
			this.httpClient.post(this.baseUri + 'bulk_get_inventory_item', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
	...
	export class Product_compatibilityClient {
		 ...
		 */
		GetProductCompatibility(sku: string, callback: (data : Compatibility) => any) {
			this.httpClient.get(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', callback, this.error, this.statusCode);
		}
		 ...
		 * @return {BaseResponse} Success
		 */
		CreateOrReplaceProductCompatibility(sku: string, callback: (data : BaseResponse) => any, requestBody: Compatibility) {
			this.httpClient.put(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteProductCompatibility(sku: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', callback, this.error, this.statusCode);
		}
	}
	...
	export class OfferClient {
		 ...
		 */
		GetOffers(sku: string | null | undefined, marketplace_id: string | null | undefined, format: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined, callback: (data : Offers) => any) {
			this.httpClient.get(this.baseUri + 'offer?sku=' + (sku == null ? '' : encodeURIComponent(sku)) + '&marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&format=' + (format == null ? '' : encodeURIComponent(format)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreateOffer(callback: (data : void) => any, requestBody: EbayOfferDetailsWithKeys) {
			this.httpClient.post(this.baseUri + 'offer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetOffer(offerId: string, callback: (data : EbayOfferDetailsWithAll) => any) {
			this.httpClient.get(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		UpdateOffer(offerId: string, callback: (data : OfferResponse) => any, requestBody: EbayOfferDetailsWithId) {
			this.httpClient.put(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteOffer(offerId: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		PublishOffer(offerId: string, callback: (data : PublishResponse) => any) {
			this.httpClient.post(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)) + '/publish/', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {PublishResponse} Success
		 */
		PublishOfferByInventoryItemGroup(callback: (data : PublishResponse) => any, requestBody: PublishByInventoryItemGroupRequest) {
			this.httpClient.post(this.baseUri + 'offer/publish_by_inventory_item_group/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		WithdrawOfferByInventoryItemGroup(callback: (data : void) => any, requestBody: WithdrawByInventoryItemGroupRequest) {
			this.httpClient.post(this.baseUri + 'offer/withdraw_by_inventory_item_group', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetListingFees(callback: (data : FeesSummaryResponse) => any, requestBody: OfferKeysWithId) {
			this.httpClient.post(this.baseUri + 'offer/get_listing_fees', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		BulkCreateOffer(callback: (data : BulkOfferResponse) => any, requestBody: BulkEbayOfferDetailsWithKeys) {
			this.httpClient.post(this.baseUri + 'bulk_create_offer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		BulkPublishOffer(callback: (data : BulkPublishResponse) => any, requestBody: BulkOffer) {
			this.httpClient.post(this.baseUri + 'bulk_publish_offer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		WithdrawOffer(offerId: string, callback: (data : WithdrawResponse) => any) {
			this.httpClient.post(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)) + '/withdraw', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
	...
	export class Inventory_item_groupClient {
		 ...
		 */
		GetInventoryItemGroup(inventoryItemGroupKey: string, callback: (data : InventoryItemGroup) => any) {
			this.httpClient.get(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {BaseResponse} Success
		 */
		CreateOrReplaceInventoryItemGroup(inventoryItemGroupKey: string, callback: (data : BaseResponse) => any, requestBody: InventoryItemGroup) {
			this.httpClient.put(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryItemGroup(inventoryItemGroupKey: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), callback, this.error, this.statusCode);
		}
	}
	...
	export class ListingClient {
		 ...
		 */
		BulkMigrateListing(callback: (data : BulkMigrateListingResponse) => any, requestBody: BulkMigrateListing) {
			this.httpClient.post(this.baseUri + 'bulk_migrate_listing', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
