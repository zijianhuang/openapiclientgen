...
export namespace MyNS {
	...
	export class PayoutClient {
		 ...
		 */
		GetPayout(payout_Id: string, callback: (data : Payout) => any) {
			this.httpClient.get(this.baseUri + 'payout/' + (payout_Id == null ? '' : encodeURIComponent(payout_Id)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetPayouts(filter: string | null | undefined, sort: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined, callback: (data : Payouts) => any) {
			this.httpClient.get(this.baseUri + 'payout?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetPayoutSummary(filter: string | null | undefined, callback: (data : PayoutSummaryResponse) => any) {
			this.httpClient.get(this.baseUri + 'payout_summary?filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
	}
	...
	export class TransactionClient {
		 ...
		 */
		GetTransactions(filter: string | null | undefined, sort: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined, callback: (data : Transactions) => any) {
			this.httpClient.get(this.baseUri + 'transaction?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetTransactionSummary(filter: string | null | undefined, callback: (data : TransactionSummaryResponse) => any) {
			this.httpClient.get(this.baseUri + 'transaction_summary?filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Seller_funds_summaryClient {
		 ...
		 */
		GetSellerFundsSummary(callback: (data : SellerFundsSummaryResponse) => any) {
			this.httpClient.get(this.baseUri + 'seller_funds_summary', callback, this.error, this.statusCode);
		}
	}
