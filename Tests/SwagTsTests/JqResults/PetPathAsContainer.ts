...
export namespace MyNS {
	...
	export class PetClient {
		 ...
		 * @return {void} 
		 */
		Post(callback: (data : void) => any, requestBody: Pet) {
		 ...
		 * @return {void} 
		 */
		Put(callback: (data : void) => any, requestBody: Pet) {
	...
	export class Pet_petIdClient {
		 ...
		 */
		GetByPetId(petId: string, callback: (data : Pet) => any) {
		 ...
		 * @return {void} 
		 */
		DeleteByPetId(petId: string, callback: (data : void) => any) {
	...
	export class PetFindByStatusClient {
		 ...
		 */
		GetByStatus(status: Array<PetStatus>, callback: (data : Array<Pet>) => any) {
	...
	export class PetFindByTagsClient {
		 ...
		 * @return {Array<Pet>} successful operation
		 */
		GetByTags(tags: Array<string>, callback: (data : Array<Pet>) => any) {
	...
	export class StoreInventoryClient {
		 ...
		 */
		Get(callback: (data : {[id: string]: number }) => any) {
	...
	export class StoreOrderClient {
		 ...
		 */
		Post(callback: (data : Order) => any, requestBody: Order) {
	...
	export class StoreOrder_orderIdClient {
		 ...
		 * @return {Order} successful operation
		 */
		GetByOrderId(orderId: string, callback: (data : Order) => any) {
		 ...
		 * @return {void} 
		 */
		DeleteByOrderId(orderId: string, callback: (data : void) => any) {
	...
	export class UserClient {
		 ...
		 * @return {void} 
		 */
		Post(callback: (data : void) => any, requestBody: User) {
	...
	export class User_usernameClient {
		 ...
		 */
		GetByUsername(username: string, callback: (data : User) => any) {
		 ...
		 * @return {void} 
		 */
		PutByUsername(username: string, callback: (data : void) => any, requestBody: User) {
		 ...
		 * @return {void} 
		 */
		DeleteByUsername(username: string, callback: (data : void) => any) {
	...
	export class UserCreateWithArrayClient {
		 ...
		 * @return {void} 
		 */
		Post(callback: (data : void) => any, requestBody: Array<User>) {
	...
	export class UserLoginClient {
		 ...
		 */
		GetByUsernameAndPassword(username: string, password: string, callback: (data : string) => any) {
