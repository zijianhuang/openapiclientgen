...
export namespace MyNS {
	...
	/** This type is used to provide a name-value pair, including the identifying aspects of a product variation through the variationAspectscontainer. */
	...
	export interface ComplianceSummaryInfo {
		...
		/** This enumeration value indicates the type of compliance. See ComplianceTypeEnum for more information on each compliance type. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/compliance/types/ComplianceTypeEnum.html'>eBay API documentation</a> */
		complianceType?: string | null;

		/** This enumeration value indicates the eBay marketplace where the listing violations exist. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/compliance/types/MarketplaceIdEnum.html'>eBay API documentation</a> */
	...
	export class Listing_violation_summaryClient {
		 ...
		 * @return {void} Success
		 */
		GetListingViolationsSummary(compliance_type: string | null | undefined, callback: (data : void) => any) {
			this.httpClient.get(this.baseUri + 'listing_violation_summary?compliance_type=' + (compliance_type == null ? '' : encodeURIComponent(compliance_type)), callback, this.error, this.statusCode);
		}
	}

	export class Listing_violationClient {
		constructor(private baseUri: string = HttpClient.locationOrigin, private httpClient: HttpClientBase = new HttpClient(), private error?: (xhr: JQueryXHR, ajaxOptions: string, thrown: string) => any, private statusCode?: { [key: string]: any; }) {
		}
		 ...
		 * @return {void} Success
		 */
		GetListingViolations(compliance_type: string | null | undefined, offset: string | null | undefined, listing_id: string | null | undefined, limit: string | null | undefined, filter: string | null | undefined, callback: (data : void) => any) {
			this.httpClient.get(this.baseUri + 'listing_violation?compliance_type=' + (compliance_type == null ? '' : encodeURIComponent(compliance_type)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&listing_id=' + (listing_id == null ? '' : encodeURIComponent(listing_id)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		SuppressViolation(callback: (data : void) => any, requestBody: SuppressViolationRequest) {
			this.httpClient.post(this.baseUri + 'suppress_listing_violation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
