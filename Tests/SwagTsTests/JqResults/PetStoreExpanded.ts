...
export namespace MyNS {
	...
	export class Misc {
		 ...
		 */
		FindPets(tags: Array<string> | null | undefined, limit: number | null | undefined, callback: (data : Array<Pet>) => any) {
		 ...
		 * @return {Pet} pet response
		 */
		FindPetById(id: string, callback: (data : Pet) => any) {
		 ...
		 * @return {void} 
		 */
		DeletePet(id: string, callback: (data : void) => any) {
