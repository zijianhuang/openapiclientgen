...
export namespace MyNS {
	...
	export class CountryClient {
		 ...
		 */
		GetSalesTaxJurisdictions(countryCode: string, callback: (data : SalesTaxJurisdictions) => any) {
			this.httpClient.get(this.baseUri + 'country/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/sales_tax_jurisdiction', callback, this.error, this.statusCode);
		}
	}
	...
	export class MarketplaceClient {
		 ...
		 */
		GetAutomotivePartsCompatibilityPolicies(filter: string | null | undefined, marketplace_id: string, callback: (data : AutomotivePartsCompatibilityPolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_automotive_parts_compatibility_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetItemConditionPolicies(filter: string | null | undefined, marketplace_id: string, callback: (data : ItemConditionPolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_item_condition_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetListingStructurePolicies(filter: string | null | undefined, marketplace_id: string, callback: (data : ListingStructurePolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_listing_structure_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetNegotiatedPricePolicies(filter: string | null | undefined, marketplace_id: string, callback: (data : NegotiatedPricePolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_negotiated_price_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetProductAdoptionPolicies(filter: string | null | undefined, marketplace_id: string, callback: (data : ProductAdoptionPolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_product_adoption_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetReturnPolicies(filter: string | null | undefined, marketplace_id: string, callback: (data : ReturnPolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_return_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode);
		}
	}
