...
export namespace MyNS {
	...
	export class Item_draftClient {
		 ...
		 * @return {void} 
		 */
		CreateItemDraft(callback: (data : void) => any, requestBody: ItemDraft) {
			this.httpClient.post(this.baseUri + 'item_draft/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
