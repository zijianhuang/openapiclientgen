...
export namespace MyNS {
	...
	export class PetClient {
		 ...
		 * @return {void} 
		 */
		AddPet(callback: (data : void) => any, requestBody: Pet) {
		 ...
		 * @return {void} 
		 */
		UpdatePet(callback: (data : void) => any, requestBody: Pet) {
	...
	export class UserClient {
		 ...
		 * @return {void} 
		 */
		CreateUsersWithArrayInput(callback: (data : void) => any, requestBody: Array<User>) {
		 ...
		 * @return {void} 
		 */
		CreateUsersWithListInput(callback: (data : void) => any, requestBody: Array<User>) {
