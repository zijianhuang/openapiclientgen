...
export namespace MyNS {
	...
	export class Customer_service_metricClient {
		 ...
		 */
		GetCustomerServiceMetric(customer_service_metric_type: string, evaluation_marketplace_id: string, evaluation_type: string, callback: (data : GetCustomerServiceMetricResponse) => any) {
			this.httpClient.get(this.baseUri + 'customer_service_metric/' + (customer_service_metric_type == null ? '' : encodeURIComponent(customer_service_metric_type)) + '/' + (evaluation_type == null ? '' : encodeURIComponent(evaluation_type)) + '&evaluation_marketplace_id=' + (evaluation_marketplace_id == null ? '' : encodeURIComponent(evaluation_marketplace_id)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Seller_standards_profileClient {
		 ...
		 */
		FindSellerStandardsProfiles(callback: (data : FindSellerStandardsProfilesResponse) => any) {
			this.httpClient.get(this.baseUri + 'seller_standards_profile', callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetSellerStandardsProfile(cycle: string, program: string, callback: (data : StandardsProfile) => any) {
			this.httpClient.get(this.baseUri + 'seller_standards_profile/' + (program == null ? '' : encodeURIComponent(program)) + '/' + (cycle == null ? '' : encodeURIComponent(cycle)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Traffic_reportClient {
		 ...
		 */
		GetTrafficReport(dimension: string | null | undefined, filter: string | null | undefined, metric: string | null | undefined, sort: string | null | undefined, callback: (data : Report) => any) {
			this.httpClient.get(this.baseUri + 'traffic_report?dimension=' + (dimension == null ? '' : encodeURIComponent(dimension)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&metric=' + (metric == null ? '' : encodeURIComponent(metric)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)), callback, this.error, this.statusCode);
		}
	}
