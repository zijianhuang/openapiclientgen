...
export namespace MyNS {
	...
	export class Fulfillment_policyClient {
		 ...
		 */
		GetFulfillmentPolicies(marketplace_id: string, callback: (data : FulfillmentPolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'fulfillment_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreateFulfillmentPolicy(callback: (data : void) => any, requestBody: FulfillmentPolicyRequest) {
			this.httpClient.post(this.baseUri + 'fulfillment_policy/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetFulfillmentPolicy(fulfillmentPolicyId: string, callback: (data : FulfillmentPolicy) => any) {
			this.httpClient.get(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		UpdateFulfillmentPolicy(fulfillmentPolicyId: string, callback: (data : SetFulfillmentPolicyResponse) => any, requestBody: FulfillmentPolicyRequest) {
			this.httpClient.put(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteFulfillmentPolicy(fulfillmentPolicyId: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {FulfillmentPolicy} Success
		 */
		GetFulfillmentPolicyByName(marketplace_id: string, name: string, callback: (data : FulfillmentPolicy) => any) {
			this.httpClient.get(this.baseUri + 'fulfillment_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Payment_policyClient {
		 ...
		 */
		GetPaymentPolicies(marketplace_id: string, callback: (data : PaymentPolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'payment_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreatePaymentPolicy(callback: (data : void) => any, requestBody: PaymentPolicyRequest) {
			this.httpClient.post(this.baseUri + 'payment_policy/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetPaymentPolicy(payment_policy_id: string, callback: (data : PaymentPolicy) => any) {
			this.httpClient.get(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		UpdatePaymentPolicy(payment_policy_id: string, callback: (data : SetPaymentPolicyResponse) => any, requestBody: PaymentPolicyRequest) {
			this.httpClient.put(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeletePaymentPolicy(payment_policy_id: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {PaymentPolicy} Success
		 */
		GetPaymentPolicyByName(marketplace_id: string, name: string, callback: (data : PaymentPolicy) => any) {
			this.httpClient.get(this.baseUri + 'payment_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Payments_programClient {
		 ...
		 */
		GetPaymentsProgram(marketplace_id: string, payments_program_type: string, callback: (data : PaymentsProgramResponse) => any) {
			this.httpClient.get(this.baseUri + 'payments_program/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/' + (payments_program_type == null ? '' : encodeURIComponent(payments_program_type)), callback, this.error, this.statusCode);
		}
	}
	...
	export class PrivilegeClient {
		 ...
		 */
		GetPrivileges(callback: (data : SellingPrivileges) => any) {
			this.httpClient.get(this.baseUri + 'privilege/', callback, this.error, this.statusCode);
		}
	}
	...
	export class ProgramClient {
		 ...
		 */
		GetOptedInPrograms(callback: (data : Programs) => any) {
			this.httpClient.get(this.baseUri + 'program/get_opted_in_programs', callback, this.error, this.statusCode);
		}
		 ...
		 */
		OptInToProgram(callback: (data : string) => any, requestBody: Program) {
			this.httpClient.post(this.baseUri + 'program/opt_in', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {string} Success
		 */
		OptOutOfProgram(callback: (data : string) => any, requestBody: Program) {
			this.httpClient.post(this.baseUri + 'program/opt_out', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
	...
	export class Rate_tableClient {
		 ...
		 */
		GetRateTables(country_code: string | null | undefined, callback: (data : RateTableResponse) => any) {
			this.httpClient.get(this.baseUri + 'rate_table/?country_code=' + (country_code == null ? '' : encodeURIComponent(country_code)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Return_policyClient {
		 ...
		 */
		GetReturnPolicies(marketplace_id: string, callback: (data : ReturnPolicyResponse) => any) {
			this.httpClient.get(this.baseUri + 'return_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreateReturnPolicy(callback: (data : void) => any, requestBody: ReturnPolicyRequest) {
			this.httpClient.post(this.baseUri + 'return_policy/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetReturnPolicy(return_policy_id: string, callback: (data : ReturnPolicy) => any) {
			this.httpClient.get(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		UpdateReturnPolicy(return_policy_id: string, callback: (data : SetReturnPolicyResponse) => any, requestBody: ReturnPolicyRequest) {
			this.httpClient.put(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteReturnPolicy(return_policy_id: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {ReturnPolicy} Success
		 */
		GetReturnPolicyByName(marketplace_id: string, name: string, callback: (data : ReturnPolicy) => any) {
			this.httpClient.get(this.baseUri + 'return_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Sales_taxClient {
		 ...
		 */
		GetSalesTax(countryCode: string, jurisdictionId: string, callback: (data : SalesTax) => any) {
			this.httpClient.get(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreateOrReplaceSalesTax(countryCode: string, jurisdictionId: string, callback: (data : void) => any, requestBody: SalesTaxBase) {
			this.httpClient.put(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteSalesTax(countryCode: string, jurisdictionId: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetSalesTaxes(country_code: string, callback: (data : SalesTaxes) => any) {
			this.httpClient.get(this.baseUri + 'sales_tax/?country_code=' + (country_code == null ? '' : encodeURIComponent(country_code)), callback, this.error, this.statusCode);
		}
	}
