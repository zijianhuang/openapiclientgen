...
export namespace MyNS {
	...
	export class AdClient {
		 ...
		 */
		BulkCreateAdsByInventoryReference(campaign_id: string, callback: (data : BulkCreateAdsByInventoryReferenceResponse) => any, requestBody: BulkCreateAdsByInventoryReferenceRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_create_ads_by_inventory_reference', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		BulkCreateAdsByListingId(campaign_id: string, callback: (data : BulkAdResponse) => any, requestBody: BulkCreateAdRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_create_ads_by_listing_id', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		BulkDeleteAdsByInventoryReference(campaign_id: string, callback: (data : BulkDeleteAdsByInventoryReferenceResponse) => any, requestBody: BulkDeleteAdsByInventoryReferenceRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_delete_ads_by_inventory_reference', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		BulkDeleteAdsByListingId(campaign_id: string, callback: (data : BulkDeleteAdResponse) => any, requestBody: BulkDeleteAdRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_delete_ads_by_listing_id', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {BulkCreateAdsByInventoryReferenceResponse} Success
		 */
		BulkUpdateAdsBidByInventoryReference(campaign_id: string, callback: (data : BulkCreateAdsByInventoryReferenceResponse) => any, requestBody: BulkCreateAdsByInventoryReferenceRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_update_ads_bid_by_inventory_reference', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {BulkAdResponse} Success
		 */
		BulkUpdateAdsBidByListingId(campaign_id: string, callback: (data : BulkAdResponse) => any, requestBody: BulkCreateAdRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/bulk_update_ads_bid_by_listing_id', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetAds(campaign_id: string, limit: string | null | undefined, listing_ids: string, offset: string | null | undefined, callback: (data : AdPagedCollection) => any) {
			this.httpClient.get(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&listing_ids=' + (listing_ids == null ? '' : encodeURIComponent(listing_ids)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreateAdByListingId(campaign_id: string, callback: (data : void) => any, requestBody: CreateAdRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		CreateAdsByInventoryReference(campaign_id: string, callback: (data : void) => any, requestBody: CreateAdsByInventoryReferenceRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/create_ads_by_inventory_reference', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {Ad} Success
		 */
		GetAd(ad_id: string, campaign_id: string, callback: (data : Ad) => any) {
			this.httpClient.get(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad/' + (ad_id == null ? '' : encodeURIComponent(ad_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		DeleteAd(ad_id: string, campaign_id: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad/' + (ad_id == null ? '' : encodeURIComponent(ad_id)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		DeleteAdsByInventoryReference(campaign_id: string, callback: (data : AdIds) => any, requestBody: DeleteAdsByInventoryReferenceRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/delete_ads_by_inventory_reference', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {Ads} Success
		 */
		GetAdsByInventoryReference(campaign_id: string, inventory_reference_id: string, inventory_reference_type: string, callback: (data : Ads) => any) {
			this.httpClient.get(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/get_ads_by_inventory_reference&inventory_reference_id=' + (inventory_reference_id == null ? '' : encodeURIComponent(inventory_reference_id)) + '&inventory_reference_type=' + (inventory_reference_type == null ? '' : encodeURIComponent(inventory_reference_type)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		UpdateBid(ad_id: string, campaign_id: string, callback: (data : void) => any, requestBody: UpdateBidPercentageRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/ad/' + (ad_id == null ? '' : encodeURIComponent(ad_id)) + '/update_bid', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
	...
	export class CampaignClient {
		 ...
		 * @return {void} 
		 */
		CloneCampaign(campaign_id: string, callback: (data : void) => any, requestBody: CloneCampaignRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/clone', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetCampaigns(campaign_name: string | null | undefined, campaign_status: string | null | undefined, end_date_range: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined, start_date_range: string | null | undefined, callback: (data : CampaignPagedCollection) => any) {
			this.httpClient.get(this.baseUri + 'ad_campaign?campaign_name=' + (campaign_name == null ? '' : encodeURIComponent(campaign_name)) + '&campaign_status=' + (campaign_status == null ? '' : encodeURIComponent(campaign_status)) + '&end_date_range=' + (end_date_range == null ? '' : encodeURIComponent(end_date_range)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&start_date_range=' + (start_date_range == null ? '' : encodeURIComponent(start_date_range)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreateCampaign(callback: (data : void) => any, requestBody: CreateCampaignRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetCampaign(campaign_id: string, callback: (data : Campaign) => any) {
			this.httpClient.get(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		DeleteCampaign(campaign_id: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		EndCampaign(campaign_id: string, callback: (data : void) => any) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/end', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		FindCampaignByAdReference(inventory_reference_id: string | null | undefined, inventory_reference_type: string | null | undefined, listing_id: string | null | undefined, callback: (data : Campaigns) => any) {
			this.httpClient.get(this.baseUri + 'ad_campaign/find_campaign_by_ad_reference?inventory_reference_id=' + (inventory_reference_id == null ? '' : encodeURIComponent(inventory_reference_id)) + '&inventory_reference_type=' + (inventory_reference_type == null ? '' : encodeURIComponent(inventory_reference_type)) + '&listing_id=' + (listing_id == null ? '' : encodeURIComponent(listing_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {Campaign} Success
		 */
		GetCampaignByName(campaign_name: string, callback: (data : Campaign) => any) {
			this.httpClient.get(this.baseUri + 'ad_campaign/get_campaign_by_name?campaign_name=' + (campaign_name == null ? '' : encodeURIComponent(campaign_name)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		PauseCampaign(campaign_id: string, callback: (data : void) => any) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/pause', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		ResumeCampaign(campaign_id: string, callback: (data : void) => any) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/resume', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		UpdateCampaignIdentification(campaign_id: string, callback: (data : void) => any, requestBody: UpdateCampaignIdentificationRequest) {
			this.httpClient.post(this.baseUri + 'ad_campaign/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/update_campaign_identification', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
	...
	export class Ad_reportClient {
		 ...
		 * @return {void} Success
		 */
		GetReport(report_id: string, callback: (data : void) => any) {
			this.httpClient.get(this.baseUri + 'ad_report/' + (report_id == null ? '' : encodeURIComponent(report_id)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Ad_report_metadataClient {
		 ...
		 */
		GetReportMetadata(callback: (data : ReportMetadatas) => any) {
			this.httpClient.get(this.baseUri + 'ad_report_metadata', callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetReportMetadataForReportType(report_type: string, callback: (data : ReportMetadata) => any) {
			this.httpClient.get(this.baseUri + 'ad_report_metadata/' + (report_type == null ? '' : encodeURIComponent(report_type)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Ad_report_taskClient {
		 ...
		 */
		GetReportTasks(limit: string | null | undefined, offset: string | null | undefined, report_task_statuses: string | null | undefined, callback: (data : ReportTaskPagedCollection) => any) {
			this.httpClient.get(this.baseUri + 'ad_report_task?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&report_task_statuses=' + (report_task_statuses == null ? '' : encodeURIComponent(report_task_statuses)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		CreateReportTask(callback: (data : void) => any, requestBody: CreateReportTask) {
			this.httpClient.post(this.baseUri + 'ad_report_task', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetReportTask(report_task_id: string, callback: (data : ReportTask) => any) {
			this.httpClient.get(this.baseUri + 'ad_report_task/' + (report_task_id == null ? '' : encodeURIComponent(report_task_id)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		DeleteReportTask(report_task_id: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'ad_report_task/' + (report_task_id == null ? '' : encodeURIComponent(report_task_id)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Item_price_markdownClient {
		 ...
		 * @return {void} 
		 */
		CreateItemPriceMarkdownPromotion(callback: (data : void) => any, requestBody: ItemPriceMarkdown) {
			this.httpClient.post(this.baseUri + 'item_price_markdown', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetItemPriceMarkdownPromotion(promotion_id: string, callback: (data : ItemPriceMarkdown) => any) {
			this.httpClient.get(this.baseUri + 'item_price_markdown/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		UpdateItemPriceMarkdownPromotion(promotion_id: string, callback: (data : string) => any, requestBody: ItemPriceMarkdown) {
			this.httpClient.put(this.baseUri + 'item_price_markdown/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteItemPriceMarkdownPromotion(promotion_id: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'item_price_markdown/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Item_promotionClient {
		 ...
		 * @return {void} 
		 */
		CreateItemPromotion(callback: (data : void) => any, requestBody: ItemPromotion) {
			this.httpClient.post(this.baseUri + 'item_promotion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 */
		GetItemPromotion(promotion_id: string, callback: (data : ItemPromotionResponse) => any) {
			this.httpClient.get(this.baseUri + 'item_promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		UpdateItemPromotion(promotion_id: string, callback: (data : BaseResponse) => any, requestBody: ItemPromotion) {
			this.httpClient.put(this.baseUri + 'item_promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		DeleteItemPromotion(promotion_id: string, callback: (data : void) => any) {
			this.httpClient.delete(this.baseUri + 'item_promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)), callback, this.error, this.statusCode);
		}
	}
	...
	export class PromotionClient {
		 ...
		 * @return {void} 
		 */
		GetListingSet(limit: string | null | undefined, offset: string | null | undefined, promotion_id: string, q: string | null | undefined, sort: string | null | undefined, status: string | null | undefined, callback: (data : void) => any) {
			this.httpClient.get(this.baseUri + 'promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)) + '/get_listing_set?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&q=' + (q == null ? '' : encodeURIComponent(q)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&status=' + (status == null ? '' : encodeURIComponent(status)), callback, this.error, this.statusCode);
		}
		 ...
		 */
		GetPromotions(limit: string | null | undefined, marketplace_id: string, offset: string | null | undefined, promotion_status: string | null | undefined, promotion_type: string | null | undefined, q: string | null | undefined, sort: string | null | undefined, callback: (data : PromotionsPagedCollection) => any) {
			this.httpClient.get(this.baseUri + 'promotion?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&promotion_status=' + (promotion_status == null ? '' : encodeURIComponent(promotion_status)) + '&promotion_type=' + (promotion_type == null ? '' : encodeURIComponent(promotion_type)) + '&q=' + (q == null ? '' : encodeURIComponent(q)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)), callback, this.error, this.statusCode);
		}
		 ...
		 * @return {void} 
		 */
		PausePromotion(promotion_id: string, callback: (data : void) => any) {
			this.httpClient.post(this.baseUri + 'promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)) + '/pause', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
		 ...
		 * @return {void} 
		 */
		ResumePromotion(promotion_id: string, callback: (data : void) => any) {
			this.httpClient.post(this.baseUri + 'promotion/' + (promotion_id == null ? '' : encodeURIComponent(promotion_id)) + '/resume', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8');
		}
	}
	...
	export class Promotion_reportClient {
		 ...
		 */
		GetPromotionReports(limit: string | null | undefined, marketplace_id: string, offset: string | null | undefined, promotion_status: string | null | undefined, promotion_type: string | null | undefined, q: string | null | undefined, callback: (data : PromotionsReportPagedCollection) => any) {
			this.httpClient.get(this.baseUri + 'promotion_report?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)) + '&promotion_status=' + (promotion_status == null ? '' : encodeURIComponent(promotion_status)) + '&promotion_type=' + (promotion_type == null ? '' : encodeURIComponent(promotion_type)) + '&q=' + (q == null ? '' : encodeURIComponent(q)), callback, this.error, this.statusCode);
		}
	}
	...
	export class Promotion_summary_reportClient {
		 ...
		 */
		GetPromotionSummaryReport(marketplace_id: string, callback: (data : SummaryReportResponse) => any) {
			this.httpClient.get(this.baseUri + 'promotion_summary_report?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), callback, this.error, this.statusCode);
		}
	}
