export namespace MyNS {
	...
	export class Item_draftClient {
		 ...
		 * @return {void} 
		 */
		CreateItemDraft(requestBody: ItemDraft): Promise<Response> {
			return fetch(this.baseUri + 'item_draft/', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
