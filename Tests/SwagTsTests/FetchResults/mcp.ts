export namespace MyNS {
	...
	export class McpClient {
		...
		McpBulkBillPaymentReport1Eigw(requestBody: BBSReportRequestType): Promise<BBSPaymentReportResponseType> {
			return fetch(this.baseUri + 'mcp/bulkbillpaymentreport/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpBulkBillProcessingReport1Eigw(requestBody: BBSReportRequestType): Promise<BBSProcessingReportResponseType> {
			return fetch(this.baseUri + 'mcp/bulkbillprocessingreport/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpBulkBillStoreForwardGeneral1Eigw(requestBody: BulkBillStoreForwardRequestType): Promise<BulkBillStoreForwardResponseType> {
			return fetch(this.baseUri + 'mcp/bulkbillstoreforward/general/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpBulkBillStoreForwardPathology1Eigw(requestBody: BulkBillStoreForwardRequestType): Promise<BulkBillStoreForwardResponseType> {
			return fetch(this.baseUri + 'mcp/bulkbillstoreforward/pathology/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpBulkBillStoreForwardSpecialist1Eigw(requestBody: BulkBillStoreForwardRequestType): Promise<BulkBillStoreForwardResponseType> {
			return fetch(this.baseUri + 'mcp/bulkbillstoreforward/specialist/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaAlliedHealthAllied1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaalliedhealth/allied/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaAlliedHealthCommunityNursing1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaalliedhealth/communitynursing/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaAlliedHealthDental1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaalliedhealth/dental/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaAlliedHealthOptical1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaalliedhealth/optical/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaAlliedHealthPsych1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaalliedhealth/psych/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaAlliedHealthSpeechPathology1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaalliedhealth/speechpathology/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaClaimGeneral1Eigw(requestBody: DVAClaimRequestType): Promise<DVAClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaclaim/general/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaClaimPathology1Eigw(requestBody: DVAClaimRequestType): Promise<DVAClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaclaim/pathology/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaClaimSpecialist1Eigw(requestBody: DVAClaimRequestType): Promise<DVAClaimResponseType> {
			return fetch(this.baseUri + 'mcp/dvaclaim/specialist/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaPaymentReport1Eigw(requestBody: DVAReportRequestType): Promise<DVAPaymentReportResponseType> {
			return fetch(this.baseUri + 'mcp/dvapaymentreport/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpDvaProcessingReport1Eigw(requestBody: DVAReportRequestType): Promise<DVAProcessingReportResponseType> {
			return fetch(this.baseUri + 'mcp/dvaprocessingreport/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpEnterpriseConcessionVerification1Eigw(requestBody: EnterpriseConcessionVerificationRequestType): Promise<EnterpriseConcessionVerificationResponseType> {
			return fetch(this.baseUri + 'mcp/enterpriseconcessionverification/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpEnterprisePatientVerification1Eigw(requestBody: EnterprisePatientVerificationRequestType): Promise<EnterprisePatientVerificationResponseType> {
			return fetch(this.baseUri + 'mcp/enterprisepatientverification/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpEnterpriseVeteranVerification1Eigw(requestBody: EnterpriseVeteranVerificationRequestType): Promise<EnterpriseVeteranVerificationResponseType> {
			return fetch(this.baseUri + 'mcp/enterpriseveteranverification/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpPatientClaimInteractiveGeneral1Eigw(requestBody: PatientClaimInteractiveRequestType): Promise<PatientClaimInteractiveResponseType> {
			return fetch(this.baseUri + 'mcp/patientclaiminteractive/general/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpPatientClaimInteractivePathology1Eigw(requestBody: PatientClaimInteractiveRequestType): Promise<PatientClaimInteractiveResponseType> {
			return fetch(this.baseUri + 'mcp/patientclaiminteractive/pathology/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpPatientClaimInteractiveSpecialist1Eigw(requestBody: PatientClaimInteractiveRequestType): Promise<PatientClaimInteractiveResponseType> {
			return fetch(this.baseUri + 'mcp/patientclaiminteractive/specialist/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpPatientVerification1Eigw(requestBody: PatientVerificationRequestType): Promise<PatientVerificationResponseType> {
			return fetch(this.baseUri + 'mcp/patientverification/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpPatientVerificationHf1Eigw(requestBody: PatientVerificationRequestType): Promise<PatientVerificationResponseType> {
			return fetch(this.baseUri + 'mcp/patientverification/hf/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpPatientVerificationMedicare1Eigw(requestBody: PatientVerificationRequestType): Promise<PatientVerificationResponseType> {
			return fetch(this.baseUri + 'mcp/patientverification/medicare/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpRetrieveReportEcv1Eigw(requestBody: RetrieveReportRequestType): Promise<RetrieveReportResponseType> {
			return fetch(this.baseUri + 'mcp/enterpriseconcessionverification/retrievereport/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpRetrieveReportEpv1Eigw(requestBody: RetrieveReportRequestType): Promise<RetrieveReportResponseType> {
			return fetch(this.baseUri + 'mcp/enterprisepatientverification/retrievereport/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpRetrieveReportEvv1Eigw(requestBody: RetrieveReportRequestType): Promise<RetrieveReportResponseType> {
			return fetch(this.baseUri + 'mcp/enterpriseveteranverification/retrievereport/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpSameDayDelete1Eigw(requestBody: SameDayDeleteRequestType): Promise<SameDayDeleteResponseType> {
			return fetch(this.baseUri + 'mcp/samedaydelete/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpStatusReport1Eigw(requestBody: StatusReportRequestType): Promise<StatusReportResponseType> {
			return fetch(this.baseUri + 'mcp/statusreport/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		McpVeteranVerification1Eigw(requestBody: VeteranVerificationRequestType): Promise<VeteranVerificationResponseType> {
			return fetch(this.baseUri + 'mcp/veteranverification/v1', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
