export namespace MyNS {
	...
	export class LocationClient {
		 ...
		 */
		GetInventoryLocation(merchantLocationKey: string): Promise<InventoryLocationResponse> {
			return fetch(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateInventoryLocation(merchantLocationKey: string, requestBody: InventoryLocationFull): Promise<Response> {
			return fetch(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryLocation(merchantLocationKey: string): Promise<Response> {
			return fetch(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), { method: 'delete' });
		}
		 ...
		 */
		DisableInventoryLocation(merchantLocationKey: string): Promise<string> {
			return fetch(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/disable', { method: 'post' }).then(d => {if (d.status<=204) return d.status == 204 ? null : d.text(); throw d;});
		}
		 ...
		 * @return {string} Success
		 */
		EnableInventoryLocation(merchantLocationKey: string): Promise<string> {
			return fetch(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/enable', { method: 'post' }).then(d => {if (d.status<=204) return d.status == 204 ? null : d.text(); throw d;});
		}
		 ...
		 */
		GetInventoryLocations(limit: string | null | undefined, offset: string | null | undefined): Promise<LocationResponse> {
			return fetch(this.baseUri + 'location?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		UpdateInventoryLocation(merchantLocationKey: string, requestBody: InventoryLocation): Promise<Response> {
			return fetch(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/update_location_details', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}

	export class Inventory_itemClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		 ...
		 */
		GetInventoryItem(sku: string): Promise<InventoryItemWithSkuLocaleGroupid> {
			return fetch(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		CreateOrReplaceInventoryItem(sku: string, requestBody: InventoryItem): Promise<BaseResponse> {
			return fetch(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), { method: 'put', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryItem(sku: string): Promise<Response> {
			return fetch(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), { method: 'delete' });
		}
		 ...
		 */
		GetInventoryItems(limit: string | null | undefined, offset: string | null | undefined): Promise<InventoryItems> {
			return fetch(this.baseUri + 'inventory_item?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		BulkUpdatePriceQuantity(requestBody: BulkPriceQuantity): Promise<BulkPriceQuantityResponse> {
			return fetch(this.baseUri + 'bulk_update_price_quantity', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		BulkCreateOrReplaceInventoryItem(requestBody: BulkInventoryItem): Promise<BulkInventoryItemResponse> {
			return fetch(this.baseUri + 'bulk_create_or_replace_inventory_item', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		BulkGetInventoryItem(requestBody: BulkGetInventoryItem): Promise<BulkGetInventoryItemResponse> {
			return fetch(this.baseUri + 'bulk_get_inventory_item', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}

	export class Product_compatibilityClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		 ...
		 */
		GetProductCompatibility(sku: string): Promise<Compatibility> {
			return fetch(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {BaseResponse} Success
		 */
		CreateOrReplaceProductCompatibility(sku: string, requestBody: Compatibility): Promise<BaseResponse> {
			return fetch(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', { method: 'put', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteProductCompatibility(sku: string): Promise<Response> {
			return fetch(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', { method: 'delete' });
		}
	}
	...
	export class OfferClient {
		 ...
		 */
		GetOffers(sku: string | null | undefined, marketplace_id: string | null | undefined, format: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Offers> {
			return fetch(this.baseUri + 'offer?sku=' + (sku == null ? '' : encodeURIComponent(sku)) + '&marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&format=' + (format == null ? '' : encodeURIComponent(format)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateOffer(requestBody: EbayOfferDetailsWithKeys): Promise<Response> {
			return fetch(this.baseUri + 'offer', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		GetOffer(offerId: string): Promise<EbayOfferDetailsWithAll> {
			return fetch(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		UpdateOffer(offerId: string, requestBody: EbayOfferDetailsWithId): Promise<OfferResponse> {
			return fetch(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), { method: 'put', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteOffer(offerId: string): Promise<Response> {
			return fetch(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), { method: 'delete' });
		}
		...
		PublishOffer(offerId: string): Promise<PublishResponse> {
			return fetch(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)) + '/publish/', { method: 'post' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {PublishResponse} Success
		 */
		PublishOfferByInventoryItemGroup(requestBody: PublishByInventoryItemGroupRequest): Promise<PublishResponse> {
			return fetch(this.baseUri + 'offer/publish_by_inventory_item_group/', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		WithdrawOfferByInventoryItemGroup(requestBody: WithdrawByInventoryItemGroupRequest): Promise<Response> {
			return fetch(this.baseUri + 'offer/withdraw_by_inventory_item_group', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		GetListingFees(requestBody: OfferKeysWithId): Promise<FeesSummaryResponse> {
			return fetch(this.baseUri + 'offer/get_listing_fees', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		BulkCreateOffer(requestBody: BulkEbayOfferDetailsWithKeys): Promise<BulkOfferResponse> {
			return fetch(this.baseUri + 'bulk_create_offer', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		BulkPublishOffer(requestBody: BulkOffer): Promise<BulkPublishResponse> {
			return fetch(this.baseUri + 'bulk_publish_offer', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		WithdrawOffer(offerId: string): Promise<WithdrawResponse> {
			return fetch(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)) + '/withdraw', { method: 'post' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}

	export class Inventory_item_groupClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		 ...
		 */
		GetInventoryItemGroup(inventoryItemGroupKey: string): Promise<InventoryItemGroup> {
			return fetch(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {BaseResponse} Success
		 */
		CreateOrReplaceInventoryItemGroup(inventoryItemGroupKey: string, requestBody: InventoryItemGroup): Promise<BaseResponse> {
			return fetch(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), { method: 'put', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryItemGroup(inventoryItemGroupKey: string): Promise<Response> {
			return fetch(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), { method: 'delete' });
		}
	}
	...
	export class ListingClient {
		 ...
		 */
		BulkMigrateListing(requestBody: BulkMigrateListing): Promise<BulkMigrateListingResponse> {
			return fetch(this.baseUri + 'bulk_migrate_listing', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
