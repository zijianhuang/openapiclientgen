export namespace MyNS {
	...
	export class Fulfillment_policyClient {
		 ...
		 * @param {string} marketplace_id This query parameter specifies the eBay marketplace of the policies you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/account/types/MarketplaceIdEnum.html
		 * @return {FulfillmentPolicyResponse} Success
		 */
		GetFulfillmentPolicies(marketplace_id: string): Promise<FulfillmentPolicyResponse> {
			return fetch(this.baseUri + 'fulfillment_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateFulfillmentPolicy(requestBody: FulfillmentPolicyRequest): Promise<Response> {
			return fetch(this.baseUri + 'fulfillment_policy/', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetFulfillmentPolicy(fulfillmentPolicyId: string): Promise<FulfillmentPolicy> {
			return fetch(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		UpdateFulfillmentPolicy(fulfillmentPolicyId: string, requestBody: FulfillmentPolicyRequest): Promise<SetFulfillmentPolicyResponse> {
			return fetch(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), { method: 'put', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteFulfillmentPolicy(fulfillmentPolicyId: string): Promise<Response> {
			return fetch(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), { method: 'delete' });
		}
		 ...
		 * @param {string} marketplace_id This query parameter specifies the eBay marketplace of the policy you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/account/types/MarketplaceIdEnum.html
		 * @param {string} name This query parameter specifies the user-defined name of the fulfillment policy you want to retrieve.
		 * @return {FulfillmentPolicy} Success
		 */
		GetFulfillmentPolicyByName(marketplace_id: string, name: string): Promise<FulfillmentPolicy> {
			return fetch(this.baseUri + 'fulfillment_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}

	export class Payment_policyClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		 ...
		 */
		GetPaymentPolicies(marketplace_id: string): Promise<PaymentPolicyResponse> {
			return fetch(this.baseUri + 'payment_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreatePaymentPolicy(requestBody: PaymentPolicyRequest): Promise<Response> {
			return fetch(this.baseUri + 'payment_policy/', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		GetPaymentPolicy(payment_policy_id: string): Promise<PaymentPolicy> {
			return fetch(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		UpdatePaymentPolicy(payment_policy_id: string, requestBody: PaymentPolicyRequest): Promise<SetPaymentPolicyResponse> {
			return fetch(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), { method: 'put', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeletePaymentPolicy(payment_policy_id: string): Promise<Response> {
			return fetch(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), { method: 'delete' });
		}
		 ...
		 * @param {string} marketplace_id This query parameter specifies the eBay marketplace of the policy you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/account/types/MarketplaceIdEnum.html
		 * @param {string} name This query parameter specifies the user-defined name of the payment policy you want to retrieve.
		 * @return {PaymentPolicy} Success
		 */
		GetPaymentPolicyByName(marketplace_id: string, name: string): Promise<PaymentPolicy> {
			return fetch(this.baseUri + 'payment_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}

	export class Payments_programClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		 ...
		 * @param {string} marketplace_id This path parameter specifies the eBay marketplace of the payment program for which you want to retrieve the seller's status.
		 * @param {string} payments_program_type This path parameter specifies the payments program whose status is returned by the call. Currently the only supported payments program is EBAY_PAYMENTS. For details on the program, see Payments Terms of Use.
		 * @return {PaymentsProgramResponse} Success
		 */
		GetPaymentsProgram(marketplace_id: string, payments_program_type: string): Promise<PaymentsProgramResponse> {
			return fetch(this.baseUri + 'payments_program/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/' + (payments_program_type == null ? '' : encodeURIComponent(payments_program_type)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
	...
	export class PrivilegeClient {
		...
		GetPrivileges(): Promise<SellingPrivileges> {
			return fetch(this.baseUri + 'privilege/', { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
	...
	export class ProgramClient {
		...
		GetOptedInPrograms(): Promise<Programs> {
			return fetch(this.baseUri + 'program/get_opted_in_programs', { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		OptInToProgram(requestBody: Program): Promise<string> {
			return fetch(this.baseUri + 'program/opt_in', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=204) return d.status == 204 ? null : d.text(); throw d;});
		}
		 ...
		 * @return {string} Success
		 */
		OptOutOfProgram(requestBody: Program): Promise<string> {
			return fetch(this.baseUri + 'program/opt_out', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=204) return d.status == 204 ? null : d.text(); throw d;});
		}
	}

	export class Rate_tableClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		 ...
		 */
		GetRateTables(country_code: string | null | undefined): Promise<RateTableResponse> {
			return fetch(this.baseUri + 'rate_table/?country_code=' + (country_code == null ? '' : encodeURIComponent(country_code)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}

	export class Return_policyClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		 ...
		 * Get return_policy/
		 * @param {string} marketplace_id This query parameter specifies the ID of the eBay marketplace of the policy you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/account/types/MarketplaceIdEnum.html
		 * @return {ReturnPolicyResponse} Success
		 */
		GetReturnPolicies(marketplace_id: string): Promise<ReturnPolicyResponse> {
			return fetch(this.baseUri + 'return_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateReturnPolicy(requestBody: ReturnPolicyRequest): Promise<Response> {
			return fetch(this.baseUri + 'return_policy/', { method: 'post', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		GetReturnPolicy(return_policy_id: string): Promise<ReturnPolicy> {
			return fetch(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		UpdateReturnPolicy(return_policy_id: string, requestBody: ReturnPolicyRequest): Promise<SetReturnPolicyResponse> {
			return fetch(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), { method: 'put', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteReturnPolicy(return_policy_id: string): Promise<Response> {
			return fetch(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), { method: 'delete' });
		}
		 ...
		 * @param {string} marketplace_id This query parameter specifies the ID of the eBay marketplace of the policy you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/account/types/MarketplaceIdEnum.html
		 * @param {string} name This query parameter specifies the user-defined name of the return policy you want to retrieve.
		 * @return {ReturnPolicy} Success
		 */
		GetReturnPolicyByName(marketplace_id: string, name: string): Promise<ReturnPolicy> {
			return fetch(this.baseUri + 'return_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}

	export class Sales_taxClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		 ...
		 * @param {string} countryCode This path parameter specifies the two-letter ISO 3166-1 Alpha-2 code for the country whose tax table you want to retrieve.
		 * @param {string} jurisdictionId This path parameter specifies the ID of the sales tax jurisdiction for the tax table entry you want to retrieve.
		 * @return {SalesTax} Success
		 */
		GetSalesTax(countryCode: string, jurisdictionId: string): Promise<SalesTax> {
			return fetch(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 * @param {string} countryCode This path parameter specifies the two-letter ISO 3166-1 Alpha-2 code for the country for which you want to create tax table entry.
		 * @param {string} jurisdictionId This path parameter specifies the ID of the sales-tax jurisdiction for the table entry you want to create.
		 * @param {SalesTaxBase} requestBody A container that describes the how the sales tax is calculated.
		 * @return {void} 
		 */
		CreateOrReplaceSalesTax(countryCode: string, jurisdictionId: string, requestBody: SalesTaxBase): Promise<Response> {
			return fetch(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), { method: 'put', headers: { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @param {string} countryCode This path parameter specifies the two-letter ISO 3166-1 Alpha-2 code for the country whose tax table entry you want to delete.
		 * @param {string} jurisdictionId This path parameter specifies the ID of the sales tax jurisdiction whose table entry you want to delete.
		 * @return {void} 
		 */
		DeleteSalesTax(countryCode: string, jurisdictionId: string): Promise<Response> {
			return fetch(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), { method: 'delete' });
		}
		 ...
		 * Get sales_tax/
		 * @param {string} country_code This path parameter specifies the two-letter ISO 3166-1 Alpha-2 code for the country whose tax table you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/devzone/rest/api-ref/account/types/CountryCodeEnum.html
		 * @return {SalesTaxes} Success
		 */
		GetSalesTaxes(country_code: string): Promise<SalesTaxes> {
			return fetch(this.baseUri + 'sales_tax/?country_code=' + (country_code == null ? '' : encodeURIComponent(country_code)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
