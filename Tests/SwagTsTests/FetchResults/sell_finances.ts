export namespace MyNS {
	...
	export class PayoutClient {
		 ...
		 * @param {string} payout_Id The unique identfier of the payout is passed in as a path parameter at the end of the call URI. The getPayouts method can be used to retrieve the unique identifier of a payout, or the user can check Seller Hub to get the payout ID.
		 * @return {Payout} Success
		 */
		GetPayout(payout_Id: string): Promise<Payout> {
			return fetch(this.baseUri + 'payout/' + (payout_Id == null ? '' : encodeURIComponent(payout_Id)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		GetPayouts(filter: string | null | undefined, sort: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Payouts> {
			return fetch(this.baseUri + 'payout?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		GetPayoutSummary(filter: string | null | undefined): Promise<PayoutSummaryResponse> {
			return fetch(this.baseUri + 'payout_summary?filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
	...
	export class TransactionClient {
		 ...
		 */
		GetTransactions(filter: string | null | undefined, sort: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Transactions> {
			return fetch(this.baseUri + 'transaction?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		 ...
		 */
		GetTransactionSummary(filter: string | null | undefined): Promise<TransactionSummaryResponse> {
			return fetch(this.baseUri + 'transaction_summary?filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}

	export class Seller_funds_summaryClient {
		constructor(private baseUri: string = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + '/') {
		}
		...
		GetSellerFundsSummary(): Promise<SellerFundsSummaryResponse> {
			return fetch(this.baseUri + 'seller_funds_summary', { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
