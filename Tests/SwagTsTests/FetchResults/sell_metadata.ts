export namespace MyNS {
	...
	export class CountryClient {
		...
		GetSalesTaxJurisdictions(countryCode: string): Promise<SalesTaxJurisdictions> {
			return fetch(this.baseUri + 'country/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/sales_tax_jurisdiction', { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
	...
	export class MarketplaceClient {
		...
		GetAutomotivePartsCompatibilityPolicies(filter: string | null | undefined, marketplace_id: string): Promise<AutomotivePartsCompatibilityPolicyResponse> {
			return fetch(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_automotive_parts_compatibility_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		GetItemConditionPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ItemConditionPolicyResponse> {
			return fetch(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_item_condition_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		GetListingStructurePolicies(filter: string | null | undefined, marketplace_id: string): Promise<ListingStructurePolicyResponse> {
			return fetch(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_listing_structure_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		GetNegotiatedPricePolicies(filter: string | null | undefined, marketplace_id: string): Promise<NegotiatedPricePolicyResponse> {
			return fetch(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_negotiated_price_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		GetProductAdoptionPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ProductAdoptionPolicyResponse> {
			return fetch(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_product_adoption_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
		...
		GetReturnPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ReturnPolicyResponse> {
			return fetch(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_return_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get' }).then(d => {if (d.status<=202) return d.json(); else if (d.status==204) return null; throw d;});
		}
	}
