...
export namespace MyNS {
	...
	export class PetClient {
		 ...
		 * @return {void} 
		 */
		Post(requestBody: Pet): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		Put(requestBody: Pet): Promise<AxiosResponse<string>> {
	...
	export class Pet_petIdClient {
		 ...
		 * @return {void} 
		 */
		DeleteByPetId(petId: string): Promise<AxiosResponse<string>> {
	...
	export class StoreOrder_orderIdClient {
		 ...
		 * @return {void} 
		 */
		DeleteByOrderId(orderId: string): Promise<AxiosResponse<string>> {
	...
	export class UserClient {
		 ...
		 * @return {void} 
		 */
		Post(requestBody: User): Promise<AxiosResponse<string>> {
	...
	export class User_usernameClient {
		 ...
		 * @return {void} 
		 */
		PutByUsername(username: string, requestBody: User): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteByUsername(username: string): Promise<AxiosResponse<string>> {
	...
	export class UserCreateWithArrayClient {
		 ...
		 * @return {void} 
		 */
		Post(requestBody: Array<User>): Promise<AxiosResponse<string>> {
