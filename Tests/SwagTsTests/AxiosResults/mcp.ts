...
export namespace MyNS {
	...
	export class McpClient {
		...
		McpBulkBillPaymentReport1Eigw(requestBody: BBSReportRequestType): Promise<BBSPaymentReportResponseType> {
			return Axios.post<BBSPaymentReportResponseType>(this.baseUri + 'mcp/bulkbillpaymentreport/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpBulkBillProcessingReport1Eigw(requestBody: BBSReportRequestType): Promise<BBSProcessingReportResponseType> {
			return Axios.post<BBSProcessingReportResponseType>(this.baseUri + 'mcp/bulkbillprocessingreport/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpBulkBillStoreForwardGeneral1Eigw(requestBody: BulkBillStoreForwardRequestType): Promise<BulkBillStoreForwardResponseType> {
			return Axios.post<BulkBillStoreForwardResponseType>(this.baseUri + 'mcp/bulkbillstoreforward/general/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpBulkBillStoreForwardPathology1Eigw(requestBody: BulkBillStoreForwardRequestType): Promise<BulkBillStoreForwardResponseType> {
			return Axios.post<BulkBillStoreForwardResponseType>(this.baseUri + 'mcp/bulkbillstoreforward/pathology/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpBulkBillStoreForwardSpecialist1Eigw(requestBody: BulkBillStoreForwardRequestType): Promise<BulkBillStoreForwardResponseType> {
			return Axios.post<BulkBillStoreForwardResponseType>(this.baseUri + 'mcp/bulkbillstoreforward/specialist/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaAlliedHealthAllied1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return Axios.post<AlliedHealthClaimResponseType>(this.baseUri + 'mcp/dvaalliedhealth/allied/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaAlliedHealthCommunityNursing1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return Axios.post<AlliedHealthClaimResponseType>(this.baseUri + 'mcp/dvaalliedhealth/communitynursing/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaAlliedHealthDental1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return Axios.post<AlliedHealthClaimResponseType>(this.baseUri + 'mcp/dvaalliedhealth/dental/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaAlliedHealthOptical1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return Axios.post<AlliedHealthClaimResponseType>(this.baseUri + 'mcp/dvaalliedhealth/optical/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaAlliedHealthPsych1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return Axios.post<AlliedHealthClaimResponseType>(this.baseUri + 'mcp/dvaalliedhealth/psych/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaAlliedHealthSpeechPathology1Eigw(requestBody: AlliedHealthClaimRequestType): Promise<AlliedHealthClaimResponseType> {
			return Axios.post<AlliedHealthClaimResponseType>(this.baseUri + 'mcp/dvaalliedhealth/speechpathology/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaClaimGeneral1Eigw(requestBody: DVAClaimRequestType): Promise<DVAClaimResponseType> {
			return Axios.post<DVAClaimResponseType>(this.baseUri + 'mcp/dvaclaim/general/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaClaimPathology1Eigw(requestBody: DVAClaimRequestType): Promise<DVAClaimResponseType> {
			return Axios.post<DVAClaimResponseType>(this.baseUri + 'mcp/dvaclaim/pathology/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaClaimSpecialist1Eigw(requestBody: DVAClaimRequestType): Promise<DVAClaimResponseType> {
			return Axios.post<DVAClaimResponseType>(this.baseUri + 'mcp/dvaclaim/specialist/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaPaymentReport1Eigw(requestBody: DVAReportRequestType): Promise<DVAPaymentReportResponseType> {
			return Axios.post<DVAPaymentReportResponseType>(this.baseUri + 'mcp/dvapaymentreport/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpDvaProcessingReport1Eigw(requestBody: DVAReportRequestType): Promise<DVAProcessingReportResponseType> {
			return Axios.post<DVAProcessingReportResponseType>(this.baseUri + 'mcp/dvaprocessingreport/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpEnterpriseConcessionVerification1Eigw(requestBody: EnterpriseConcessionVerificationRequestType): Promise<EnterpriseConcessionVerificationResponseType> {
			return Axios.post<EnterpriseConcessionVerificationResponseType>(this.baseUri + 'mcp/enterpriseconcessionverification/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpEnterprisePatientVerification1Eigw(requestBody: EnterprisePatientVerificationRequestType): Promise<EnterprisePatientVerificationResponseType> {
			return Axios.post<EnterprisePatientVerificationResponseType>(this.baseUri + 'mcp/enterprisepatientverification/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpEnterpriseVeteranVerification1Eigw(requestBody: EnterpriseVeteranVerificationRequestType): Promise<EnterpriseVeteranVerificationResponseType> {
			return Axios.post<EnterpriseVeteranVerificationResponseType>(this.baseUri + 'mcp/enterpriseveteranverification/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpPatientClaimInteractiveGeneral1Eigw(requestBody: PatientClaimInteractiveRequestType): Promise<PatientClaimInteractiveResponseType> {
			return Axios.post<PatientClaimInteractiveResponseType>(this.baseUri + 'mcp/patientclaiminteractive/general/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpPatientClaimInteractivePathology1Eigw(requestBody: PatientClaimInteractiveRequestType): Promise<PatientClaimInteractiveResponseType> {
			return Axios.post<PatientClaimInteractiveResponseType>(this.baseUri + 'mcp/patientclaiminteractive/pathology/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpPatientClaimInteractiveSpecialist1Eigw(requestBody: PatientClaimInteractiveRequestType): Promise<PatientClaimInteractiveResponseType> {
			return Axios.post<PatientClaimInteractiveResponseType>(this.baseUri + 'mcp/patientclaiminteractive/specialist/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpPatientVerification1Eigw(requestBody: PatientVerificationRequestType): Promise<PatientVerificationResponseType> {
			return Axios.post<PatientVerificationResponseType>(this.baseUri + 'mcp/patientverification/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpPatientVerificationHf1Eigw(requestBody: PatientVerificationRequestType): Promise<PatientVerificationResponseType> {
			return Axios.post<PatientVerificationResponseType>(this.baseUri + 'mcp/patientverification/hf/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpPatientVerificationMedicare1Eigw(requestBody: PatientVerificationRequestType): Promise<PatientVerificationResponseType> {
			return Axios.post<PatientVerificationResponseType>(this.baseUri + 'mcp/patientverification/medicare/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpRetrieveReportEcv1Eigw(requestBody: RetrieveReportRequestType): Promise<RetrieveReportResponseType> {
			return Axios.post<RetrieveReportResponseType>(this.baseUri + 'mcp/enterpriseconcessionverification/retrievereport/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpRetrieveReportEpv1Eigw(requestBody: RetrieveReportRequestType): Promise<RetrieveReportResponseType> {
			return Axios.post<RetrieveReportResponseType>(this.baseUri + 'mcp/enterprisepatientverification/retrievereport/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpRetrieveReportEvv1Eigw(requestBody: RetrieveReportRequestType): Promise<RetrieveReportResponseType> {
			return Axios.post<RetrieveReportResponseType>(this.baseUri + 'mcp/enterpriseveteranverification/retrievereport/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpSameDayDelete1Eigw(requestBody: SameDayDeleteRequestType): Promise<SameDayDeleteResponseType> {
			return Axios.post<SameDayDeleteResponseType>(this.baseUri + 'mcp/samedaydelete/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpStatusReport1Eigw(requestBody: StatusReportRequestType): Promise<StatusReportResponseType> {
			return Axios.post<StatusReportResponseType>(this.baseUri + 'mcp/statusreport/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		McpVeteranVerification1Eigw(requestBody: VeteranVerificationRequestType): Promise<VeteranVerificationResponseType> {
			return Axios.post<VeteranVerificationResponseType>(this.baseUri + 'mcp/veteranverification/v1', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
