...
export namespace MyNS {
	...
	export class PayoutClient {
		...
		GetPayout(payout_Id: string): Promise<Payout> {
			return Axios.get<Payout>(this.baseUri + 'payout/' + (payout_Id == null ? '' : encodeURIComponent(payout_Id)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetPayouts(filter: string | null | undefined, sort: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Payouts> {
			return Axios.get<Payouts>(this.baseUri + 'payout?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetPayoutSummary(filter: string | null | undefined): Promise<PayoutSummaryResponse> {
			return Axios.get<PayoutSummaryResponse>(this.baseUri + 'payout_summary?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class TransactionClient {
		...
		GetTransactions(filter: string | null | undefined, sort: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Transactions> {
			return Axios.get<Transactions>(this.baseUri + 'transaction?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetTransactionSummary(filter: string | null | undefined): Promise<TransactionSummaryResponse> {
			return Axios.get<TransactionSummaryResponse>(this.baseUri + 'transaction_summary?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class Seller_funds_summaryClient {
		...
		GetSellerFundsSummary(): Promise<SellerFundsSummaryResponse> {
			return Axios.get<SellerFundsSummaryResponse>(this.baseUri + 'seller_funds_summary', {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
