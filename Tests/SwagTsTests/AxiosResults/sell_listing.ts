...
export namespace MyNS {
	...
	export class Item_draftClient {
		 ...
		 * @return {void} 
		 */
		CreateItemDraft(requestBody: ItemDraft): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'item_draft/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
