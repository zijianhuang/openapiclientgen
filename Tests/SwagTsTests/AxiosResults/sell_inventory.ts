...
export namespace MyNS {
	...
	export class LocationClient {
		...
		GetInventoryLocation(merchantLocationKey: string): Promise<InventoryLocationResponse> {
			return Axios.get<InventoryLocationResponse>(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateInventoryLocation(merchantLocationKey: string, requestBody: InventoryLocationFull): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryLocation(merchantLocationKey: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)), { responseType: 'text' });
		}
		...
		DisableInventoryLocation(merchantLocationKey: string): Promise<string> {
			return Axios.post(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/disable', null, { responseType: 'text' }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		EnableInventoryLocation(merchantLocationKey: string): Promise<string> {
			return Axios.post(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/enable', null, { responseType: 'text' }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetInventoryLocations(limit: string | null | undefined, offset: string | null | undefined): Promise<LocationResponse> {
			return Axios.get<LocationResponse>(this.baseUri + 'location?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		UpdateInventoryLocation(merchantLocationKey: string, requestBody: InventoryLocation): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'location/' + (merchantLocationKey == null ? '' : encodeURIComponent(merchantLocationKey)) + '/update_location_details', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
	...
	export class Inventory_itemClient {
		...
		GetInventoryItem(sku: string): Promise<InventoryItemWithSkuLocaleGroupid> {
			return Axios.get<InventoryItemWithSkuLocaleGroupid>(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		CreateOrReplaceInventoryItem(sku: string, requestBody: InventoryItem): Promise<BaseResponse> {
			return Axios.put<BaseResponse>(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryItem(sku: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)), { responseType: 'text' });
		}
		...
		GetInventoryItems(limit: string | null | undefined, offset: string | null | undefined): Promise<InventoryItems> {
			return Axios.get<InventoryItems>(this.baseUri + 'inventory_item?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		BulkUpdatePriceQuantity(requestBody: BulkPriceQuantity): Promise<BulkPriceQuantityResponse> {
			return Axios.post<BulkPriceQuantityResponse>(this.baseUri + 'bulk_update_price_quantity', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		BulkCreateOrReplaceInventoryItem(requestBody: BulkInventoryItem): Promise<BulkInventoryItemResponse> {
			return Axios.post<BulkInventoryItemResponse>(this.baseUri + 'bulk_create_or_replace_inventory_item', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		BulkGetInventoryItem(requestBody: BulkGetInventoryItem): Promise<BulkGetInventoryItemResponse> {
			return Axios.post<BulkGetInventoryItemResponse>(this.baseUri + 'bulk_get_inventory_item', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class Product_compatibilityClient {
		...
		GetProductCompatibility(sku: string): Promise<Compatibility> {
			return Axios.get<Compatibility>(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		CreateOrReplaceProductCompatibility(sku: string, requestBody: Compatibility): Promise<BaseResponse> {
			return Axios.put<BaseResponse>(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteProductCompatibility(sku: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'inventory_item/' + (sku == null ? '' : encodeURIComponent(sku)) + '/product_compatibility', { responseType: 'text' });
		}
	}
	...
	export class OfferClient {
		...
		GetOffers(sku: string | null | undefined, marketplace_id: string | null | undefined, format: string | null | undefined, limit: string | null | undefined, offset: string | null | undefined): Promise<Offers> {
			return Axios.get<Offers>(this.baseUri + 'offer?sku=' + (sku == null ? '' : encodeURIComponent(sku)) + '&marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&format=' + (format == null ? '' : encodeURIComponent(format)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&offset=' + (offset == null ? '' : encodeURIComponent(offset)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateOffer(requestBody: EbayOfferDetailsWithKeys): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'offer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetOffer(offerId: string): Promise<EbayOfferDetailsWithAll> {
			return Axios.get<EbayOfferDetailsWithAll>(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		UpdateOffer(offerId: string, requestBody: EbayOfferDetailsWithId): Promise<OfferResponse> {
			return Axios.put<OfferResponse>(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteOffer(offerId: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)), { responseType: 'text' });
		}
		...
		PublishOffer(offerId: string): Promise<PublishResponse> {
			return Axios.post<PublishResponse>(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)) + '/publish/', null, {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		PublishOfferByInventoryItemGroup(requestBody: PublishByInventoryItemGroupRequest): Promise<PublishResponse> {
			return Axios.post<PublishResponse>(this.baseUri + 'offer/publish_by_inventory_item_group/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		WithdrawOfferByInventoryItemGroup(requestBody: WithdrawByInventoryItemGroupRequest): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'offer/withdraw_by_inventory_item_group', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetListingFees(requestBody: OfferKeysWithId): Promise<FeesSummaryResponse> {
			return Axios.post<FeesSummaryResponse>(this.baseUri + 'offer/get_listing_fees', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		BulkCreateOffer(requestBody: BulkEbayOfferDetailsWithKeys): Promise<BulkOfferResponse> {
			return Axios.post<BulkOfferResponse>(this.baseUri + 'bulk_create_offer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		BulkPublishOffer(requestBody: BulkOffer): Promise<BulkPublishResponse> {
			return Axios.post<BulkPublishResponse>(this.baseUri + 'bulk_publish_offer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		WithdrawOffer(offerId: string): Promise<WithdrawResponse> {
			return Axios.post<WithdrawResponse>(this.baseUri + 'offer/' + (offerId == null ? '' : encodeURIComponent(offerId)) + '/withdraw', null, {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class Inventory_item_groupClient {
		...
		GetInventoryItemGroup(inventoryItemGroupKey: string): Promise<InventoryItemGroup> {
			return Axios.get<InventoryItemGroup>(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		CreateOrReplaceInventoryItemGroup(inventoryItemGroupKey: string, requestBody: InventoryItemGroup): Promise<BaseResponse> {
			return Axios.put<BaseResponse>(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteInventoryItemGroup(inventoryItemGroupKey: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'inventory_item_group/' + (inventoryItemGroupKey == null ? '' : encodeURIComponent(inventoryItemGroupKey)), { responseType: 'text' });
		}
	}
	...
	export class ListingClient {
		...
		BulkMigrateListing(requestBody: BulkMigrateListing): Promise<BulkMigrateListingResponse> {
			return Axios.post<BulkMigrateListingResponse>(this.baseUri + 'bulk_migrate_listing', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
