...
export namespace MyNS {
	...
	export class CountryClient {
		...
		GetSalesTaxJurisdictions(countryCode: string): Promise<SalesTaxJurisdictions> {
			return Axios.get<SalesTaxJurisdictions>(this.baseUri + 'country/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/sales_tax_jurisdiction', {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class MarketplaceClient {
		...
		GetAutomotivePartsCompatibilityPolicies(filter: string | null | undefined, marketplace_id: string): Promise<AutomotivePartsCompatibilityPolicyResponse> {
			return Axios.get<AutomotivePartsCompatibilityPolicyResponse>(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_automotive_parts_compatibility_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetItemConditionPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ItemConditionPolicyResponse> {
			return Axios.get<ItemConditionPolicyResponse>(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_item_condition_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetListingStructurePolicies(filter: string | null | undefined, marketplace_id: string): Promise<ListingStructurePolicyResponse> {
			return Axios.get<ListingStructurePolicyResponse>(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_listing_structure_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetNegotiatedPricePolicies(filter: string | null | undefined, marketplace_id: string): Promise<NegotiatedPricePolicyResponse> {
			return Axios.get<NegotiatedPricePolicyResponse>(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_negotiated_price_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetProductAdoptionPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ProductAdoptionPolicyResponse> {
			return Axios.get<ProductAdoptionPolicyResponse>(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_product_adoption_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		GetReturnPolicies(filter: string | null | undefined, marketplace_id: string): Promise<ReturnPolicyResponse> {
			return Axios.get<ReturnPolicyResponse>(this.baseUri + 'marketplace/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/get_return_policies?filter=' + (filter == null ? '' : encodeURIComponent(filter)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
