...
export namespace MyNS {
	...
	export class PetClient {
		 ...
		 * @return {void} 
		 */
		AddPet(): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'pet', null, { responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdatePet(): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'pet', null, { responseType: 'text' });
		}
	...
	export class StoreClient {
		 ...
		 * @return {void} 
		 */
		Subscribe(requestBody: SubscribePostBody): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'store/subscribe', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
	...
	export class UserClient {
		 ...
		 * @return {void} 
		 */
		CreateUsersWithArrayInput(): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'user/createWithArray', null, { responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateUsersWithListInput(): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'user/createWithList', null, { responseType: 'text' });
		}
