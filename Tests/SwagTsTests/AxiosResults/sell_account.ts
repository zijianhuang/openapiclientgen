...
export namespace MyNS {
	...
	export class Fulfillment_policyClient {
		...
		GetFulfillmentPolicies(marketplace_id: string): Promise<FulfillmentPolicyResponse> {
			return Axios.get<FulfillmentPolicyResponse>(this.baseUri + 'fulfillment_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateFulfillmentPolicy(requestBody: FulfillmentPolicyRequest): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'fulfillment_policy/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetFulfillmentPolicy(fulfillmentPolicyId: string): Promise<FulfillmentPolicy> {
			return Axios.get<FulfillmentPolicy>(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		UpdateFulfillmentPolicy(fulfillmentPolicyId: string, requestBody: FulfillmentPolicyRequest): Promise<SetFulfillmentPolicyResponse> {
			return Axios.put<SetFulfillmentPolicyResponse>(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteFulfillmentPolicy(fulfillmentPolicyId: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'fulfillment_policy/' + (fulfillmentPolicyId == null ? '' : encodeURIComponent(fulfillmentPolicyId)), { responseType: 'text' });
		}
		...
		GetFulfillmentPolicyByName(marketplace_id: string, name: string): Promise<FulfillmentPolicy> {
			return Axios.get<FulfillmentPolicy>(this.baseUri + 'fulfillment_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class Payment_policyClient {
		...
		GetPaymentPolicies(marketplace_id: string): Promise<PaymentPolicyResponse> {
			return Axios.get<PaymentPolicyResponse>(this.baseUri + 'payment_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreatePaymentPolicy(requestBody: PaymentPolicyRequest): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'payment_policy/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetPaymentPolicy(payment_policy_id: string): Promise<PaymentPolicy> {
			return Axios.get<PaymentPolicy>(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		UpdatePaymentPolicy(payment_policy_id: string, requestBody: PaymentPolicyRequest): Promise<SetPaymentPolicyResponse> {
			return Axios.put<SetPaymentPolicyResponse>(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeletePaymentPolicy(payment_policy_id: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'payment_policy/' + (payment_policy_id == null ? '' : encodeURIComponent(payment_policy_id)), { responseType: 'text' });
		}
		...
		GetPaymentPolicyByName(marketplace_id: string, name: string): Promise<PaymentPolicy> {
			return Axios.get<PaymentPolicy>(this.baseUri + 'payment_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class Payments_programClient {
		...
		GetPaymentsProgram(marketplace_id: string, payments_program_type: string): Promise<PaymentsProgramResponse> {
			return Axios.get<PaymentsProgramResponse>(this.baseUri + 'payments_program/' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '/' + (payments_program_type == null ? '' : encodeURIComponent(payments_program_type)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class PrivilegeClient {
		...
		GetPrivileges(): Promise<SellingPrivileges> {
			return Axios.get<SellingPrivileges>(this.baseUri + 'privilege/', {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class ProgramClient {
		...
		GetOptedInPrograms(): Promise<Programs> {
			return Axios.get<Programs>(this.baseUri + 'program/get_opted_in_programs', {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		OptInToProgram(requestBody: Program): Promise<string> {
			return Axios.post(this.baseUri + 'program/opt_in', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		OptOutOfProgram(requestBody: Program): Promise<string> {
			return Axios.post(this.baseUri + 'program/opt_out', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class Rate_tableClient {
		...
		GetRateTables(country_code: string | null | undefined): Promise<RateTableResponse> {
			return Axios.get<RateTableResponse>(this.baseUri + 'rate_table/?country_code=' + (country_code == null ? '' : encodeURIComponent(country_code)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class Return_policyClient {
		...
		GetReturnPolicies(marketplace_id: string): Promise<ReturnPolicyResponse> {
			return Axios.get<ReturnPolicyResponse>(this.baseUri + 'return_policy/?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateReturnPolicy(requestBody: ReturnPolicyRequest): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'return_policy/', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetReturnPolicy(return_policy_id: string): Promise<ReturnPolicy> {
			return Axios.get<ReturnPolicy>(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		...
		UpdateReturnPolicy(return_policy_id: string, requestBody: ReturnPolicyRequest): Promise<SetReturnPolicyResponse> {
			return Axios.put<SetReturnPolicyResponse>(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		DeleteReturnPolicy(return_policy_id: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'return_policy/' + (return_policy_id == null ? '' : encodeURIComponent(return_policy_id)), { responseType: 'text' });
		}
		...
		GetReturnPolicyByName(marketplace_id: string, name: string): Promise<ReturnPolicy> {
			return Axios.get<ReturnPolicy>(this.baseUri + 'return_policy/get_by_policy_name?marketplace_id=' + (marketplace_id == null ? '' : encodeURIComponent(marketplace_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
	...
	export class Sales_taxClient {
		...
		GetSalesTax(countryCode: string, jurisdictionId: string): Promise<SalesTax> {
			return Axios.get<SalesTax>(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
		 ...
		 * @return {void} 
		 */
		CreateOrReplaceSalesTax(countryCode: string, jurisdictionId: string, requestBody: SalesTaxBase): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteSalesTax(countryCode: string, jurisdictionId: string): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'sales_tax/' + (countryCode == null ? '' : encodeURIComponent(countryCode)) + '/' + (jurisdictionId == null ? '' : encodeURIComponent(jurisdictionId)), { responseType: 'text' });
		}
		...
		GetSalesTaxes(country_code: string): Promise<SalesTaxes> {
			return Axios.get<SalesTaxes>(this.baseUri + 'sales_tax/?country_code=' + (country_code == null ? '' : encodeURIComponent(country_code)), {}).then(d => {if (d.status<=204) return d.data; throw d;});
		}
	}
