...
export namespace MyNS {
	...
	export enum BasicChartSeriesTargetAxis { BASIC_CHART_AXIS_POSITION_UNSPECIFIED = 0, BOTTOM_AXIS = 1, LEFT_AXIS = 2, RIGHT_AXIS = 3 }

	export enum BasicChartSeriesType { BASIC_CHART_TYPE_UNSPECIFIED = 0, BAR = 1, LINE = 2, AREA = 3, COLUMN = 4, SCATTER = 5, COMBO = 6, STEPPED_AREA = 7 }
	...
	export interface CellFormat {
		...
		horizontalAlignment?: CellFormatHorizontalAlignment;
	...
	export enum CellFormatHorizontalAlignment { HORIZONTAL_ALIGN_UNSPECIFIED = 0, LEFT = 1, CENTER = 2, RIGHT = 3 }
	...
	export interface SlicerSpec {
		 ...
		 */
		horizontalAlignment?: SlicerSpecHorizontalAlignment;
	...
	export enum SlicerSpecHorizontalAlignment { HORIZONTAL_ALIGN_UNSPECIFIED = 0, LEFT = 1, CENTER = 2, RIGHT = 3 }
	...
	export enum PivotGroupSortOrder { SORT_ORDER_UNSPECIFIED = 0, ASCENDING = 1, DESCENDING = 2 }
	...
	export interface AppendDimensionRequest {
		...
		dimension?: AppendDimensionRequestDimension;
	...
	export enum AppendDimensionRequestDimension { DIMENSION_UNSPECIFIED = 0, ROWS = 1, COLUMNS = 2 }
	...
	export interface ValueRange {
		 ...
		 */
		majorDimension?: ValueRangeMajorDimension;
	...
	export enum ValueRangeMajorDimension { DIMENSION_UNSPECIFIED = 0, ROWS = 1, COLUMNS = 2 }
	...
	export interface SourceAndDestination {
		...
		dimension?: SourceAndDestinationDimension;
	...
	export enum SourceAndDestinationDimension { DIMENSION_UNSPECIFIED = 0, ROWS = 1, COLUMNS = 2 }
	...
	export interface DeveloperMetadataLocation {
		...
		locationType?: DeveloperMetadataLocationLocationType;
	...
	export enum DeveloperMetadataLocationLocationType { DEVELOPER_METADATA_LOCATION_TYPE_UNSPECIFIED = 0, ROW = 1, COLUMN = 2, SHEET = 3, SPREADSHEET = 4 }
	...
	export interface BatchGetValuesByDataFilterRequest {
		 ...
		 */
		majorDimension?: BatchGetValuesByDataFilterRequestMajorDimension;
	...
	export enum BatchGetValuesByDataFilterRequestMajorDimension { DIMENSION_UNSPECIFIED = 0, ROWS = 1, COLUMNS = 2 }
	...
	export enum DeveloperMetadataVisibility { DEVELOPER_METADATA_VISIBILITY_UNSPECIFIED = 0, DOCUMENT = 1, PROJECT = 2 }
	...
	export interface CutPasteRequest {
		 ...
		 * of what is pasted.
		 */
		pasteType?: CutPasteRequestPasteType;
	...
	export enum CutPasteRequestPasteType { PASTE_NORMAL = 0, PASTE_VALUES = 1, PASTE_FORMAT = 2, PASTE_NO_BORDERS = 3, PASTE_FORMULA = 4, PASTE_DATA_VALIDATION = 5, PASTE_CONDITIONAL_FORMATTING = 6 }
	...
	export interface DeleteRangeRequest {
		 ...
		 */
		shiftDimension?: DeleteRangeRequestShiftDimension;
	}

	export enum DeleteRangeRequestShiftDimension { DIMENSION_UNSPECIFIED = 0, ROWS = 1, COLUMNS = 2 }
	...
	export interface InsertRangeRequest {
		 ...
		 */
		shiftDimension?: InsertRangeRequestShiftDimension;
	}

	export enum InsertRangeRequestShiftDimension { DIMENSION_UNSPECIFIED = 0, ROWS = 1, COLUMNS = 2 }
	...
	export interface PasteDataRequest {
		...
		type?: PasteDataRequestType;
	}

	export enum PasteDataRequestType { PASTE_NORMAL = 0, PASTE_VALUES = 1, PASTE_FORMAT = 2, PASTE_NO_BORDERS = 3, PASTE_FORMULA = 4, PASTE_DATA_VALIDATION = 5, PASTE_CONDITIONAL_FORMATTING = 6 }
	...
	export interface ThemeColorPair {
		...
		colorType?: ThemeColorPairColorType;
	}

	export enum ThemeColorPairColorType { THEME_COLOR_TYPE_UNSPECIFIED = 0, TEXT = 1, BACKGROUND = 2, ACCENT1 = 3, ACCENT2 = 4, ACCENT3 = 5, ACCENT4 = 6, ACCENT5 = 7, ACCENT6 = 8, LINK = 9 }
	...
	export interface BatchUpdateValuesByDataFilterRequest {
		 ...
		 */
		responseDateTimeRenderOption?: BatchUpdateValuesByDataFilterRequestResponseDateTimeRenderOption;

		/**
		 * Determines how values in the response should be rendered.
		 * The default render option is ValueRenderOption.FORMATTED_VALUE.
		 */
		responseValueRenderOption?: BatchUpdateValuesByDataFilterRequestResponseValueRenderOption;
	...
	export interface DataFilterValueRange {
		...
		/** The major dimension of the values. */
		majorDimension?: DataFilterValueRangeMajorDimension;
	...
	export enum DataFilterValueRangeMajorDimension { DIMENSION_UNSPECIFIED = 0, ROWS = 1, COLUMNS = 2 }

	export enum BatchUpdateValuesByDataFilterRequestResponseDateTimeRenderOption { SERIAL_NUMBER = 0, FORMATTED_STRING = 1 }

	export enum BatchUpdateValuesByDataFilterRequestResponseValueRenderOption { FORMATTED_VALUE = 0, UNFORMATTED_VALUE = 1, FORMULA = 2 }
	...
	export interface BatchUpdateValuesRequest {
		 ...
		 * DateTimeRenderOption.SERIAL_NUMBER.
		 */
		responseDateTimeRenderOption?: BatchUpdateValuesRequestResponseDateTimeRenderOption;

		/**
		 * Determines how values in the response should be rendered.
		 * The default render option is ValueRenderOption.FORMATTED_VALUE.
		 */
		responseValueRenderOption?: BatchUpdateValuesRequestResponseValueRenderOption;

		/** How the input data should be interpreted. */
		valueInputOption?: BatchUpdateValuesRequestValueInputOption;
	}

	export enum BatchUpdateValuesRequestResponseDateTimeRenderOption { SERIAL_NUMBER = 0, FORMATTED_STRING = 1 }

	export enum BatchUpdateValuesRequestResponseValueRenderOption { FORMATTED_VALUE = 0, UNFORMATTED_VALUE = 1, FORMULA = 2 }

	export enum BatchUpdateValuesRequestValueInputOption { INPUT_VALUE_OPTION_UNSPECIFIED = 0, RAW = 1, USER_ENTERED = 2 }
	...
	export class MyClient {
		...
		/**
		 * Creates a spreadsheet, returning the newly created spreadsheet.Post v4/spreadsheets
		...
		/**
		 * Returns the developer metadata with the specified ID.The caller must specify the spreadsheet ID and the developer metadata'sunique metadataId.Get v4/spreadsheets/{spreadsheetId}/developerMetadata/{metadataId}
		...
		/**
		 * Returns all developer metadata matching the specified DataFilter.If the provided DataFilter represents a DeveloperMetadataLookup object,this will return all DeveloperMetadata entries selected by it. If theDataFilter represents a location in a spreadsheet, this will return alldeveloper metadata associated with locations intersecting that region.Post v4/spreadsheets/{spreadsheetId}/developerMetadata:search
		 * @param {string} spreadsheetId The ID of the spreadsheet to retrieve metadata from.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Copies a single sheet from a spreadsheet to another spreadsheet.Returns the properties of the newly created sheet.Post v4/spreadsheets/{spreadsheetId}/sheets/{sheetId}:copyTo
		...
		/**
		 * Returns a range of values from a spreadsheet.The caller must specify the spreadsheet ID and a range.Get v4/spreadsheets/{spreadsheetId}/values/{range}
		...
		/**
		 * Sets values in a range of a spreadsheet.The caller must specify the spreadsheet ID, range, anda valueInputOption.Put v4/spreadsheets/{spreadsheetId}/values/{range}
		...
		Sheets_spreadsheets_values_append(spreadsheetId: string, range: string, includeValuesInResponse: boolean, insertDataOption: string, responseDateTimeRenderOption: BatchGetValuesByDataFilterRequestDateTimeRenderOption, responseValueRenderOption: BatchGetValuesByDataFilterRequestValueRenderOption, valueInputOption: BatchUpdateValuesByDataFilterRequestValueInputOption, requestBody: ValueRange): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v4/spreadsheets/' + (spreadsheetId == null ? '' : encodeURIComponent(spreadsheetId)) + '/values/' + (range == null ? '' : encodeURIComponent(range)) + ':append&includeValuesInResponse=' + includeValuesInResponse + '&insertDataOption=' + (insertDataOption == null ? '' : encodeURIComponent(insertDataOption)) + '&responseDateTimeRenderOption=' + responseDateTimeRenderOption + '&responseValueRenderOption=' + responseValueRenderOption + '&valueInputOption=' + valueInputOption, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}

		/**
		 * Clears values from a spreadsheet.The caller must specify the spreadsheet ID and range.Only values are cleared -- all other properties of the cell (such asformatting, data validation, etc..) are kept.Post v4/spreadsheets/{spreadsheetId}/values/{range}:clear
		 * @param {string} spreadsheetId The ID of the spreadsheet to update.
		...
		/**
		 * Clears one or more ranges of values from a spreadsheet.The caller must specify the spreadsheet ID and one or more ranges.Only values are cleared -- all other properties of the cell (such asformatting, data validation, etc..) are kept.Post v4/spreadsheets/{spreadsheetId}/values:batchClear
		 * @param {string} spreadsheetId The ID of the spreadsheet to update.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Clears one or more ranges of values from a spreadsheet.The caller must specify the spreadsheet ID and one or moreDataFilters. Ranges matching any of the specified datafilters will be cleared.  Only values are cleared -- all other propertiesof the cell (such as formatting, data validation, etc..) are kept.Post v4/spreadsheets/{spreadsheetId}/values:batchClearByDataFilter
		 * @param {string} spreadsheetId The ID of the spreadsheet to update.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Returns one or more ranges of values from a spreadsheet.The caller must specify the spreadsheet ID and one or more ranges.Get v4/spreadsheets/{spreadsheetId}/values:batchGet
		 * @param {string} spreadsheetId The ID of the spreadsheet to retrieve data from.
		 * @param {BatchGetValuesByDataFilterRequestDateTimeRenderOption} dateTimeRenderOption How dates, times, and durations should be represented in the output.
		 * This is ignored if value_render_option is
		 * FORMATTED_VALUE.
		...
		/**
		 * Returns one or more ranges of values that match the specified data filters.The caller must specify the spreadsheet ID and one or moreDataFilters.  Ranges that match any of the data filters inthe request will be returned.Post v4/spreadsheets/{spreadsheetId}/values:batchGetByDataFilter
		 * @param {string} spreadsheetId The ID of the spreadsheet to retrieve data from.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Sets values in one or more ranges of a spreadsheet.The caller must specify the spreadsheet ID,a valueInputOption, and one or moreValueRanges.Post v4/spreadsheets/{spreadsheetId}/values:batchUpdate
		 * @param {string} spreadsheetId The ID of the spreadsheet to update.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Sets values in one or more ranges of a spreadsheet.The caller must specify the spreadsheet ID,a valueInputOption, and one or moreDataFilterValueRanges.Post v4/spreadsheets/{spreadsheetId}/values:batchUpdateByDataFilter
		 * @param {string} spreadsheetId The ID of the spreadsheet to update.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Returns the spreadsheet at the given ID.The caller must specify the spreadsheet ID.This method differs from GetSpreadsheet in that it allows selectingwhich subsets of spreadsheet data to return by specifying adataFilters parameter.Multiple DataFilters can be specified.  Specifying one ormore data filters will return the portions of the spreadsheet thatintersect ranges matched by any of the filters.By default, data within grids will not be returned.You can include grid data one of two ways:* Specify a field mask listing your desired fields using the `fields` URLparameter in HTTP* Set the includeGridDataparameter to true.  If a field mask is set, the `includeGridData`parameter is ignoredFor large spreadsheets, it is recommended to retrieve only the specificfields of the spreadsheet that you want.Post v4/spreadsheets/{spreadsheetId}:getByDataFilter
		 * @param {string} spreadsheetId The spreadsheet to request.
		 * @return {void} Successful response
		 */
