...
export namespace MyNS {
	...
	export interface GoogleDatastoreAdminV1beta1CommonMetadata {
		...
		/**The current state of the Operation. */
		state?: GoogleDatastoreAdminV1beta1CommonMetadataState;
	}
	...
	export enum GoogleDatastoreAdminV1beta1CommonMetadataState { STATE_UNSPECIFIED = 0, INITIALIZING = 1, PROCESSING = 2, CANCELLING = 3, FINALIZING = 4, SUCCESSFUL = 5, FAILED = 6, CANCELLED = 7 }
	...
	export interface PropertyOrder {
		...
		direction?: PropertyOrderDirection;
	...
	export class MyClient {
		...
		/**
		 * Lists the indexes that match the specified filters.  Datastore uses aneventually consistent query to fetch the list of indexes and mayoccasionally return stale results.Get v1/projects/{projectId}/indexes
		 ...
		 */
		Datastore_projects_indexes_list(projectId: string, filter: string, pageSize: number, pageToken: string): Observable<HttpResponse<string>> {
		...
		/**
		 * Creates the specified index.A newly created index's initial state is `CREATING`. On completion of thereturned google.longrunning.Operation, the state will be `READY`.If the index already exists, the call will return an `ALREADY_EXISTS`status.During index creation, the process could result in an error, in whichcase the index will move to the `ERROR` state. The process can be recoveredby fixing the data that caused the error, removing the index withdelete, thenre-creating the index with create.Indexes with a single property cannot be created.Post v1/projects/{projectId}/indexes
		 * @param {string} projectId Project ID against which to make the request.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Deletes an existing index.An index can only be deleted if it is in a `READY` or `ERROR` state. Onsuccessful execution of the request, the index will be in a `DELETING`state. And on completion of thereturned google.longrunning.Operation, the index will be removed.During index deletion, the process could result in an error, in whichcase the index will move to the `ERROR` state. The process can be recoveredby fixing the data that caused the error, followed by callingdelete again.Delete v1/projects/{projectId}/indexes/{indexId}
		 * @param {string} projectId Project ID against which to make the request.
		...
		/**
		 * Gets an index.Get v1/projects/{projectId}/indexes/{indexId}
		 * @param {string} projectId Project ID against which to make the request.
		...
		/**
		 * Allocates IDs for the given keys, which is useful for referencing an entitybefore it is inserted.Post v1/projects/{projectId}:allocateIds
		...
		/**
		 * Begins a new transaction.Post v1/projects/{projectId}:beginTransaction
		 * @param {string} projectId Required. The ID of the project against which to make the request.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Commits a transaction, optionally creating, deleting or modifying someentities.Post v1/projects/{projectId}:commit
		 * @param {string} projectId Required. The ID of the project against which to make the request.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Looks up entities by key.Post v1/projects/{projectId}:lookup
		 * @param {string} projectId Required. The ID of the project against which to make the request.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Prevents the supplied keys' IDs from being auto-allocated by CloudDatastore.Post v1/projects/{projectId}:reserveIds
		 * @param {string} projectId Required. The ID of the project against which to make the request.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Rolls back a transaction.Post v1/projects/{projectId}:rollback
		 * @param {string} projectId Required. The ID of the project against which to make the request.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Queries for entities.Post v1/projects/{projectId}:runQuery
		 * @param {string} projectId Required. The ID of the project against which to make the request.
		 * @return {void} Successful response
		 */
		...
		/**
		 * Deletes a long-running operation. This method indicates that the client isno longer interested in the operation result. It does not cancel theoperation. If the server doesn't support this method, it returns`google.rpc.Code.UNIMPLEMENTED`.Delete v1/{name}
		...
		/**
		 * Gets the latest state of a long-running operation.  Clients can use thismethod to poll the operation result at intervals as recommended by the APIservice.Get v1/{name}
		 ...
		 * @return {void} Successful response
		 */
		Datastore_projects_operations_list(name: string, filter: string, pageSize: number, pageToken: string): Observable<HttpResponse<string>> {
