...
export namespace MyNS {
	...
	export class MyClient {
		...
		/**
		 * Auto-EmojifyReturns text of the post with emoji addedGet v1/emoji/auto-emojify
		...
		/**
		 * Emoji SuggestionsReturns list of emoji suggestions for a given text of the postGet v1/emoji/suggestions
		 * @param {string} text Text of the post
		 * @return {void} OK
		 */
		...
		/**
		 * Animate ImageReturns URL of an animated GIF.Get v1/images/animate
		...
		/**
		 * Company LogoReturns a company logo based on website domain. If the logo is not in our database yet, it will be extracted from the site on the fly. White logo background is automatically removed to make the logo look better on color backgrounds.Note: It is not possible to access our company logo API publicly without authentication. If you wish to do so, you have to create proxy on your own server that calls our API from the server side.Get v1/images/logo
		...
		/**
		 * Text to ImageReturns URL of an image created from text according to given style parametersGet v1/images/quote
		...
		/**
		 * List of CTAsReturns list of available CTA for current user. Requires each user to authenticate with RiteKitGet v1/link/cta
		 * @return {void} OK
		 */
		...
		/**
		 * Shorten LinkReturns a shorten link with a given CTA.Get v1/link/short-link
		...
		/**
		 * Trending HashtagsReturns list of hashtags currently trending on TwitterGet v1/search/trending
		...
		/**
		 * Auto-HashtagReturns auto-hashtagged text of the post.Get v1/stats/auto-hashtag
		...
		/**
		 * Hashtag SuggestionsReturns list of hashtag suggestions for a single-word topic or a shorter text up to 1000 characters. Takes into account both semantic relevancy and real-time hashtag popularity.Get v1/stats/hashtag-suggestions
		...
		/**
		 * Hashtag HistoryReturns historical stats for a given hashtag from the last 30 daysGet v1/stats/history/{hashtag}
		 * @param {string} hashtag Hashtag without # mark
		 * @return {void} OK
		 */
		V1StatsHistoryGetByHashtag(hashtag: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		...
		/**
		 * Hashtag StatsReturns real-time stats for up to 100 hashtags (updated hourly).Get v1/stats/multiple-hashtags
		...
		/**
		 * Hashtags cleanerRemove banned hashtags before posting to InstagramGet v2/instagram/hashtags-cleaner
