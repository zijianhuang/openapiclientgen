...
namespace SwagTests
{
	public partial class ODAzureTests2
	{
		...
		[Fact(Skip = "Swagger definition error")]
		public void Test_azure_com_mariadb_2018_06_01()
		{
			helper.GenerateFromOpenApiAndBuild(@"..\..\..\..\openapi-directory\APIs\azure.com\mariadb\2018-06-01"); //the def has heeor.
																													//LogFile inherited from ProxyResource declares name again.
		}
		...
		[Fact(Skip ="def redeclares name in type LogFile")]
		...
		[Fact(Skip ="yaml has repeated field names in inheritance")]
