...
namespace MyNS
{
	...
	public partial class AdClient
	{
		...
		public AdClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/bulk_create_ads_by_inventory_reference";
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/bulk_create_ads_by_listing_id";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/bulk_delete_ads_by_inventory_reference";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/bulk_delete_ads_by_listing_id";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/bulk_update_ads_bid_by_inventory_reference";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/bulk_update_ads_bid_by_listing_id";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/ad?limit=" + Uri.EscapeDataString(limit)+"&listing_ids=" + Uri.EscapeDataString(listing_ids)+"&offset=" + Uri.EscapeDataString(offset);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/ad";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/create_ads_by_inventory_reference";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/ad/"+Uri.EscapeDataString(ad_id);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/delete_ads_by_inventory_reference";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/get_ads_by_inventory_reference?inventory_reference_id=" + Uri.EscapeDataString(inventory_reference_id)+"&inventory_reference_type=" + Uri.EscapeDataString(inventory_reference_type);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/ad/"+Uri.EscapeDataString(ad_id)+"/update_bid";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
	...
	public partial class CampaignClient
	{
		...
		public CampaignClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/clone";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = "ad_campaign?campaign_name=" + Uri.EscapeDataString(campaign_name)+"&campaign_status=" + Uri.EscapeDataString(campaign_status)+"&end_date_range=" + Uri.EscapeDataString(end_date_range)+"&limit=" + Uri.EscapeDataString(limit)+"&offset=" + Uri.EscapeDataString(offset)+"&start_date_range=" + Uri.EscapeDataString(start_date_range);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/end";
		...
		{
			var requestUri = "ad_campaign/find_campaign_by_ad_reference?inventory_reference_id=" + Uri.EscapeDataString(inventory_reference_id)+"&inventory_reference_type=" + Uri.EscapeDataString(inventory_reference_type)+"&listing_id=" + Uri.EscapeDataString(listing_id);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_campaign/get_campaign_by_name?campaign_name=" + Uri.EscapeDataString(campaign_name);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/pause";
			var responseMessage = await client.PostAsync(requestUri, new StringContent(String.Empty));
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/resume";
			var responseMessage = await client.PostAsync(requestUri, new StringContent(String.Empty));
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_campaign/"+Uri.EscapeDataString(campaign_id)+"/update_campaign_identification";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
	...
	public partial class Ad_reportClient
	{
		...
		public Ad_reportClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "ad_report/"+Uri.EscapeDataString(report_id);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
	...
	public partial class Ad_report_metadataClient
	{
		...
		public Ad_report_metadataClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "ad_report_metadata/"+Uri.EscapeDataString(report_type);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
	...
	public partial class Ad_report_taskClient
	{
		...
		public Ad_report_taskClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "ad_report_task?limit=" + Uri.EscapeDataString(limit)+"&offset=" + Uri.EscapeDataString(offset)+"&report_task_statuses=" + Uri.EscapeDataString(report_task_statuses);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "ad_report_task/"+Uri.EscapeDataString(report_task_id);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
	...
	public partial class Item_price_markdownClient
	{
		...
		public Item_price_markdownClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "item_price_markdown/"+Uri.EscapeDataString(promotion_id);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
	...
	public partial class Item_promotionClient
	{
		...
		public Item_promotionClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "item_promotion/"+Uri.EscapeDataString(promotion_id);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
	...
	public partial class PromotionClient
	{
		...
		public PromotionClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "promotion/"+Uri.EscapeDataString(promotion_id)+"/get_listing_set?limit=" + Uri.EscapeDataString(limit)+"&offset=" + Uri.EscapeDataString(offset)+"&q=" + Uri.EscapeDataString(q)+"&sort=" + Uri.EscapeDataString(sort)+"&status=" + Uri.EscapeDataString(status);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "promotion?limit=" + Uri.EscapeDataString(limit)+"&marketplace_id=" + Uri.EscapeDataString(marketplace_id)+"&offset=" + Uri.EscapeDataString(offset)+"&promotion_status=" + Uri.EscapeDataString(promotion_status)+"&promotion_type=" + Uri.EscapeDataString(promotion_type)+"&q=" + Uri.EscapeDataString(q)+"&sort=" + Uri.EscapeDataString(sort);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "promotion/"+Uri.EscapeDataString(promotion_id)+"/pause";
			var responseMessage = await client.PostAsync(requestUri, new StringContent(String.Empty));
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
		...
		{
			var requestUri = "promotion/"+Uri.EscapeDataString(promotion_id)+"/resume";
			var responseMessage = await client.PostAsync(requestUri, new StringContent(String.Empty));
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
	...
	public partial class Promotion_reportClient
	{
		...
		public Promotion_reportClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "promotion_report?limit=" + Uri.EscapeDataString(limit)+"&marketplace_id=" + Uri.EscapeDataString(marketplace_id)+"&offset=" + Uri.EscapeDataString(offset)+"&promotion_status=" + Uri.EscapeDataString(promotion_status)+"&promotion_type=" + Uri.EscapeDataString(promotion_type)+"&q=" + Uri.EscapeDataString(q);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
	...
	public partial class Promotion_summary_reportClient
	{
		...
		public Promotion_summary_reportClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		{
			var requestUri = "promotion_summary_report?marketplace_id=" + Uri.EscapeDataString(marketplace_id);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
