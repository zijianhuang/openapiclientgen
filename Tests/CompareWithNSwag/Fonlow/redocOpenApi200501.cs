...
namespace MyNS
{
	...
	public partial class StoreClient
	{
		...
		public StoreClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
		...
		/// </summary>
		public async Task SubscribeAsync(SubscribeBody requestBody)
		{
			var requestUri = "store/subscribe";
			using (var requestWriter = new System.IO.StringWriter())
			{
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		/// Subscribe store/subscribe
		/// </summary>
		public void Subscribe(SubscribeBody requestBody)
		{
			var requestUri = "store/subscribe";
			using (var requestWriter = new System.IO.StringWriter())
			{
	...
	public partial class UserClient
	{
		...
		public UserClient(System.Net.Http.HttpClient client, JsonSerializerSettings jsonSerializerSettings=null)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
	...
	public class SubscribeBody
	{
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		public SubscribeBodyEventName EventName { get; set; }
	}
	
	public enum SubscribeBodyEventName
	{
