...
namespace MyNS
{
	...
	public partial class MyClient
	{
		...
		/// </summary>
		public async Task SubscribeAsync(SubscribePostBody requestBody)
		{
		...
		/// Subscribe store/subscribe
		/// </summary>
		public void Subscribe(SubscribePostBody requestBody)
		{
			var requestUri = "store/subscribe";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
	...
	public class SubscribePostBody
	{
		...
		/// </summary>
		[System.ComponentModel.DataAnnotations.Required()]
		public SubscribePostBodyEventName EventName { get; set; }
	}
	
	public enum SubscribePostBodyEventName
	{
