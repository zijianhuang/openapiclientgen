...
namespace MyNS
{
	...
	public class DebugEntry
	{
		...
		/// </summary>
		public System.Nullable<DebugEntryInformationLevel> InformationLevel { get; set; }
		...
		/// </summary>
		public System.Nullable<DebugEntryStatus> Status { get; set; }
	}
	...
	public class DebugEntryCreateBatch
	{
		...
		/// </summary>
		public System.Nullable<DebugEntryCreateBatchCreateBehavior> CreateBehavior { get; set; }
	...
	public class Request
	{
		...
		/// </summary>
		public System.Nullable<RequestStatus> Status { get; set; }
	}
	...
	public partial class MyClient
	{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/availability&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/client/"+ (clientType==null? "" : System.Uri.EscapeDataString(clientType))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests&requestName=" + (requestName==null? "" : System.Uri.EscapeDataString(requestName))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests&requestName=" + (requestName==null? "" : System.Uri.EscapeDataString(requestName))+"&synchronous="+synchronous+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		/// Requests_Update_Requests_Request_Name {organization}/_apis/symbol/requests
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="requestName">The symbol request name.</param>
		/// <param name="api_version">Version of the API to use.  This should be set to '6.0-preview.1' to use this version of the api.</param>
		/// <param name="requestBody">The symbol request.</param>
		/// <returns>Successfully updated the symbol request as specified by the request name.</returns>
		public async Task<Request> Requests_Update_Requests_Request_NameAsync(string organization, string requestName, string api_version, Request requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests&requestName=" + (requestName==null? "" : System.Uri.EscapeDataString(requestName))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
		...
		/// <param name="requestBody">The symbol request.</param>
		/// <returns>Successfully updated the symbol request as specified by the request name.</returns>
		public Request Requests_Update_Requests_Request_Name(string organization, string requestName, string api_version, Request requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests&requestName=" + (requestName==null? "" : System.Uri.EscapeDataString(requestName))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests/"+ (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests/"+ (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&collection=" + (collection==null? "" : System.Uri.EscapeDataString(collection))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
			var requestSerializer = JsonSerializer.Create(jsonSerializerSettings);
			requestSerializer.Serialize(requestWriter, requestBody);
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests/"+ (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&synchronous="+synchronous+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		/// Requests_Update_Requests_Request_Id {organization}/_apis/symbol/requests/{requestId}
		/// </summary>
		/// <param name="organization">The name of the Azure DevOps organization.</param>
		/// <param name="requestId">The symbol request identifier.</param>
		/// <param name="api_version">Version of the API to use.  This should be set to '6.0-preview.1' to use this version of the api.</param>
		/// <param name="requestBody">The symbol request.</param>
		/// <returns>Successfully updated the symbol request as specified by the request identifier.</returns>
		public async Task<Request> Requests_Update_Requests_Request_IdAsync(string organization, string requestId, string api_version, Request requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests/"+ (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <param name="requestBody">The symbol request.</param>
		/// <returns>Successfully updated the symbol request as specified by the request identifier.</returns>
		public Request Requests_Update_Requests_Request_Id(string organization, string requestId, string api_version, Request requestBody)
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/requests/"+ (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		{
			var requestUri = ""+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/_apis/symbol/symsrv/"+ (debugEntryClientKey==null? "" : System.Uri.EscapeDataString(debugEntryClientKey))+"&api-version=" + (api_version==null? "" : System.Uri.EscapeDataString(api_version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
