...
namespace MyNS
{
	...
	public partial class MyClient
	{
		...
		/// </summary>
		/// <returns>OK</returns>
		public async Task<TranslateResponse> TranslateAsync(TranslateRequest requestBody)
		{
			...
			try
			{
				...
				return serializer.Deserialize<TranslateResponse>(jsonReader);
			}
			finally
			{
		...
		/// </summary>
		/// <returns>OK</returns>
		public TranslateResponse Translate(TranslateRequest requestBody)
		{
			var requestUri = "translate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
