...
namespace MyNS
{
	...
	public partial class MyClient
	{
		...
		public async Task CreateFromShippingQuoteAsync(CreateShipmentFromQuoteRequest requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">The create shipment from quote request.</param>
		public void CreateFromShippingQuote(CreateShipmentFromQuoteRequest requestBody)
		{
			var requestUri = "shipment/create_from_shipping_quote";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		public async Task<Shipment> GetShipmentAsync(string shipmentId)
		{
			...
			try
			{
				...
				return serializer.Deserialize<Shipment>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>Success</returns>
		public async Task DownloadLabelFileAsync(string shipmentId)
		{
		...
		/// <param name="shipmentId">This path parameter specifies the unique eBay-assigned ID of the shipment associated with the shipping label you want to download. The shipmentId value is generated and returned by a call to createFromShippingQuote.</param>
		/// <returns>Success</returns>
		public void DownloadLabelFile(string shipmentId)
		{
			var requestUri = "shipment/"+ (shipmentId==null? "" : System.Uri.EscapeDataString(shipmentId))+"/download_label_file";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			var responseMessage = httpClient.Send(httpRequestMessage);
		...
		/// <returns>Success</returns>
		public async Task<Shipment> CancelShipmentAsync(string shipmentId)
		{
		...
		/// </summary>
		/// <param name="requestBody">The request object for createShippingQuote.</param>
		public async Task CreateShippingQuoteAsync(ShippingQuoteRequest requestBody)
		{
		...
		/// </summary>
		/// <param name="requestBody">The request object for createShippingQuote.</param>
		public void CreateShippingQuote(ShippingQuoteRequest requestBody)
		{
			var requestUri = "shipping_quote";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			using var requestWriter = new System.IO.StringWriter();
		...
		/// <returns>Success</returns>
		public async Task<ShippingQuote> GetShippingQuoteAsync(string shippingQuoteId)
		{
			...
			try
			{
				...
				using JsonReader jsonReader = new JsonTextReader(new System.IO.StreamReader(streamContent));
				var serializer = JsonSerializer.Create(jsonSerializerSettings);
				return serializer.Deserialize<ShippingQuote>(jsonReader);
			}
			finally
			{
				responseMessage.Dispose();
