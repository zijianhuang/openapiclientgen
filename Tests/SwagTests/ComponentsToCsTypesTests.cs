...
";
		...
		[Fact]
		public void TestSimplePetWithInnerObjectShouldNotPrefixWithTypeName()
		{
			string expected = @"//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool.
...
";
		...
		[Fact]
		public void TestSimplePetWithInnerObjectPrefixWithTypeNameByDefault()
		{
			string expected = @"//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool.
...
";
			string s = TranslateJsonToCode("SwagMock" + Path.DirectorySeparatorChar + "SimplePetCat.json");
			Assert.Equal(expected, s);
		}
...
";
			string s = TranslateJsonToCode("SwagMock" + Path.DirectorySeparatorChar + "Enum.json");
			Assert.Equal(expected, s);
		}   
...
";
			string s = TranslateJsonToCode("SwagMock" + Path.DirectorySeparatorChar + "IntEnum.json");
			Assert.Equal(expected, s);
		}
...
";
			string s = TranslateJsonToCode("SwagMock" + Path.DirectorySeparatorChar + "CasualEnum.json");
            Assert.Equal(expected, s);
        }
...
";
			string s = TranslateJsonToCode("SwagMock" + Path.DirectorySeparatorChar + "StringArray.json");
			Assert.Equal(expected, s);
		}
...
";
			string s = TranslateJsonToCode("SwagMock" + Path.DirectorySeparatorChar + "CustomTypeArray.json");
			Assert.Equal(expected, s);
		}
...
";
			string s = TranslateJsonToCode("SwagMock" + Path.DirectorySeparatorChar + "SimpleOrder.json");
			Assert.Equal(expected, s);
		}
