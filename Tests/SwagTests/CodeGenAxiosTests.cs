...
";
		...
		{
			GenerateAndAssert("SwagMock\\ValuesPaths.json", "AxiosResults\\ValuesPaths.txt");
		}
		...
		{
			GenerateAndAssert("SwagMock\\PetDelete.json", "AxiosResults\\PetDelete.txt");
		}

		[Fact]
		public void TestPet()
		{
			GenerateAndAssert("SwagMock\\pet.yaml", "AxiosResults\\Pet.txt");
		}

		[Fact]
		public void TestPetWithPathAsContainerName()
		{
			GenerateAndAssert("SwagMock\\pet.yaml", "AxiosResults\\PetPathAsContainer.txt", new Settings()
			{
				ClientNamespace = "MyNS",
				ContainerClassName = "Misc",
		...
		{
			GenerateAndAssert("SwagMock\\pet.yaml" , "AxiosResults\\PetGodClass.txt", new Settings()
			{
				ClientNamespace = "MyNS",
		...
		{
			GenerateAndAssert("SwagMock\\petByStatus.yaml", "AxiosResults\\PetFindByStatus.txt", new Settings()
			{
				ClientNamespace = "MyNS",
				PathPrefixToRemove = "/api",
				ContainerClassName = "Misc",
		...
		{
			GenerateAndAssert("SwagMock\\petStore.yaml", "AxiosResults\\PetStore.txt");
		}

		[Fact]
		public void TestPetStoreExpanded()
		{
			GenerateAndAssert("SwagMock\\petStoreExpanded.yaml" , "AxiosResults\\PetStoreExpanded.txt", new Settings()
			{
				ClientNamespace = "MyNS",
		...
		{
			GenerateAndAssert("SwagMock\\uspto.yaml" , "AxiosResults\\Uspto.txt", new Settings()
			{
				ClientNamespace = "MyNS",
				ActionNameStrategy = ActionNameStrategy.NormalizedOperationId,
				ContainerNameStrategy = ContainerNameStrategy.Tags,
		...
		public void TestMcp()
		{
			GenerateAndAssert("SwagMock\\mcp.yaml", "AxiosResults\\mcp.txt", new Settings()
			{
				ClientNamespace = "MyNS",
		...
		{
			GenerateAndAssert("SwagMock\\sell_account_v1_oas3.json", "AxiosResults\\sell_account.txt");
		}

		[Fact]
		public void TestEBay_sell_analytics()
		{
			GenerateAndAssert("SwagMock\\sell_analytics_v1_oas3.yaml", "AxiosResults\\sell_analytics.txt");
		}

		[Fact]
		public void TestEBay_sell_compliance()
		{
			GenerateAndAssert("SwagMock\\sell_compliance_v1_oas3.yaml", "AxiosResults\\sell_compliance.txt");
		}

		[Fact]
		public void TestEBay_sell_finances()
		{
			GenerateAndAssert("SwagMock\\sell_finances_v1_oas3.yaml", "AxiosResults\\sell_finances.txt");
		}

		[Fact]
		public void TestEBay_sell_inventory()
		{
			GenerateAndAssert("SwagMock\\sell_inventory_v1_oas3.yaml", "AxiosResults\\sell_inventory.txt");
		}

		[Fact]
		public void TestEBay_sell_listing()
		{
			GenerateAndAssert("SwagMock\\sell_listing_v1_beta_oas3.yaml", "AxiosResults\\sell_listing.txt");
		}

		[Fact]
		public void TestEBay_sell_logistics()
		{
			GenerateAndAssert("SwagMock\\sell_logistics_v1_oas3.json", "AxiosResults\\sell_logistics.txt");
		}

		[Fact]
		public void TestEBay_sell_negotiation()
		{
			GenerateAndAssert("SwagMock\\sell_negotiation_v1_oas3.yaml", "AxiosResults\\sell_negotiation.txt");
		}

		[Fact]
		public void TestEBay_sell_marketing()
		{
			GenerateAndAssert("SwagMock\\sell_marketing_v1_oas3.json", "AxiosResults\\sell_marketing.txt");
		}

		[Fact]
		public void TestEBay_sell_metadata()
		{
			GenerateAndAssert("SwagMock\\sell_metadata_v1_oas3.json", "AxiosResults\\sell_metadata.txt");
		}

		[Fact]
		public void TestEBay_sell_recommendation()
		{
			GenerateAndAssert("SwagMock\\sell_recommendation_v1_oas3.yaml", "AxiosResults\\sell_recommendation.txt");
		}

		[Fact]
		public void TestRedocOpenApi()
		{
			GenerateAndAssert("SwagMock\\redocOpenApi200501.json", "AxiosResults\\redocOpenApi200501.txt");
		}
	}
