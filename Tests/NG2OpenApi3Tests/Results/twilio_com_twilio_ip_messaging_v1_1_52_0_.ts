...
export namespace MyNS {
	...
	export enum Ip_messagingv1serviceroleType { channel = 0, deployment = 1 }
	...
	export enum Ip_messagingv1serviceuseruser_channelStatus { joined = 0, invited = 1, not_participating = 2 }
