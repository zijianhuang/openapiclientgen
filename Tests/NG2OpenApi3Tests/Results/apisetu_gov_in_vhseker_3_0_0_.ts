...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {VochsePostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Vochse(requestBody: VochsePostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'vochse/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface VochsePostBody {
		certificateParameters?: VochsePostBodyCertificateParameters;
	...
	export interface VochsePostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<VochsePostBodyFormat | null | undefined>,
	...
	export function CreateVochsePostBodyFormGroup() {
		return new FormGroup<VochsePostBodyFormProperties>({
			format: new FormControl<VochsePostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface VochsePostBodyCertificateParameters {
	...
	export interface VochsePostBodyCertificateParametersFormProperties {
	...
	export function CreateVochsePostBodyCertificateParametersFormGroup() {
		return new FormGroup<VochsePostBodyCertificateParametersFormProperties>({
