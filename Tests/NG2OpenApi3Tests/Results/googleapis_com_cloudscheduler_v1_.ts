...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Cloudscheduler_projects_locations_jobs_delete(name: string): Observable<Empty> {
		...
		Cloudscheduler_projects_locations_jobs_get(name: string): Observable<Job> {
			return this.http.get<Job>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Cloudscheduler_projects_locations_jobs_patch(name: string, updateMask: string | null | undefined, requestBody: Job): Observable<Job> {
			return this.http.patch<Job>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudscheduler_projects_locations_jobs_pause(name: string, requestBody: PauseJobRequest): Observable<Job> {
			return this.http.post<Job>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':pause', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudscheduler_projects_locations_jobs_resume(name: string, requestBody: ResumeJobRequest): Observable<Job> {
			return this.http.post<Job>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':resume', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudscheduler_projects_locations_jobs_run(name: string, requestBody: RunJobRequest): Observable<Job> {
			return this.http.post<Job>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':run', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Cloudscheduler_projects_locations_jobs_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListJobsResponse> {
			return this.http.get<ListJobsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/jobs&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
