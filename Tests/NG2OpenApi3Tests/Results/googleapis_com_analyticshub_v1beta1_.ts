...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Analyticshub_projects_locations_dataExchanges_listings_delete(name: string): Observable<Empty> {
		 ...
		 */
		Analyticshub_projects_locations_dataExchanges_listings_get(name: string): Observable<Listing> {
			return this.http.get<Listing>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Analyticshub_projects_locations_dataExchanges_listings_patch(name: string, updateMask: string | null | undefined, requestBody: Listing): Observable<Listing> {
			return this.http.patch<Listing>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Subscribes to a listing. Currently, with Analytics Hub, you can create listings that reference only BigQuery datasets. Upon subscription to a listing for a BigQuery dataset, Analytics Hub creates a linked dataset in the subscriber's project.
		 * Post v1beta1/{name}:subscribe
		...
		Analyticshub_projects_locations_dataExchanges_listings_subscribe(name: string, requestBody: SubscribeListingRequest): Observable<SubscribeListingResponse> {
			return this.http.post<SubscribeListingResponse>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':subscribe', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all data exchanges from projects in a given organization and location.
		 * Get v1beta1/{organization}/dataExchanges
		...
		Analyticshub_organizations_locations_dataExchanges_list(organization: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListOrgDataExchangesResponse> {
			return this.http.get<ListOrgDataExchangesResponse>(this.baseUri + 'v1beta1/' + (organization == null ? '' : encodeURIComponent(organization)) + '/dataExchanges&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Lists all data exchanges in a given project and location.
		 * Get v1beta1/{parent}/dataExchanges
		...
		Analyticshub_projects_locations_dataExchanges_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDataExchangesResponse> {
			return this.http.get<ListDataExchangesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dataExchanges&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new data exchange.
		 * Post v1beta1/{parent}/dataExchanges
		...
		Analyticshub_projects_locations_dataExchanges_create(parent: string, dataExchangeId: string | null | undefined, requestBody: DataExchange): Observable<DataExchange> {
			return this.http.post<DataExchange>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dataExchanges&dataExchangeId=' + (dataExchangeId == null ? '' : encodeURIComponent(dataExchangeId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all listings in a given project and location.
		 * Get v1beta1/{parent}/listings
		...
		Analyticshub_projects_locations_dataExchanges_listings_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListListingsResponse> {
			return this.http.get<ListListingsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/listings&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new listing.
		 * Post v1beta1/{parent}/listings
		 * @param {string} parent Required. The parent resource path of the listing. e.g. `projects/myproject/locations/US/dataExchanges/123`.
		...
		Analyticshub_projects_locations_dataExchanges_listings_create(parent: string, listingId: string | null | undefined, requestBody: Listing): Observable<Listing> {
			return this.http.post<Listing>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/listings&listingId=' + (listingId == null ? '' : encodeURIComponent(listingId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Analyticshub_projects_locations_dataExchanges_listings_getIamPolicy(resource: string, requestBody: GetIamPolicyRequest): Observable<Policy> {
		 ...
		 * @return {Policy} Successful response
		 */
		Analyticshub_projects_locations_dataExchanges_listings_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
