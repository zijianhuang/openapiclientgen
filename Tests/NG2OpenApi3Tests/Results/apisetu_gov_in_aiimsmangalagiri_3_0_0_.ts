...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {LabrpPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Labrp(requestBody: LabrpPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'labrp/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface LabrpPostBody {
		certificateParameters?: LabrpPostBodyCertificateParameters;
	...
	export interface LabrpPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<LabrpPostBodyFormat | null | undefined>,
	...
	export function CreateLabrpPostBodyFormGroup() {
		return new FormGroup<LabrpPostBodyFormProperties>({
			format: new FormControl<LabrpPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface LabrpPostBodyCertificateParameters {
	...
	export interface LabrpPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		MobileNoRQ: FormControl<string | null | undefined>,
	}
	export function CreateLabrpPostBodyCertificateParametersFormGroup() {
		return new FormGroup<LabrpPostBodyCertificateParametersFormProperties>({
			...
			GENDER: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			MobileNoRQ: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
