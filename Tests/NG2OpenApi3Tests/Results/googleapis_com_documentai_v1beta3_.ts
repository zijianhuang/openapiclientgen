...
export namespace MyNS {
	...
	/** Encodes the detailed information of a barcode. */
	export interface GoogleCloudDocumentaiV1beta3BarcodeFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3BarcodeFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BarcodeFormProperties>({
			format: new FormControl<string | null | undefined>(undefined),
			rawValue: new FormControl<string | null | undefined>(undefined),
			valueFormat: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Dataset documents that the batch operation will be applied to. */
	export interface GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsFormProperties {

		/** A filter matching the documents. Follows the same format and restriction as [google.cloud.documentai.master.ListDocumentsRequest.filter]. */
		filter: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3BatchDatasetDocumentsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsFormProperties>({
	...
	/** List of individual DocumentIds. */
	export interface GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsIndividualDocumentIdsFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3BatchDatasetDocumentsIndividualDocumentIdsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BatchDatasetDocumentsIndividualDocumentIdsFormProperties>({
		});
	...
	export interface GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequestFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequestFormProperties>({
		});
	...
	/** The common config to specify a set of documents used as input. */
	export interface GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfigFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3BatchDocumentsInputConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BatchDocumentsInputConfigFormProperties>({
		});
	...
	/** Specifies a set of documents on Cloud Storage. */
	export interface GoogleCloudDocumentaiV1beta3GcsDocumentsFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3GcsDocumentsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3GcsDocumentsFormProperties>({
		});
	...
	/** Specifies a document stored on Cloud Storage. */
	export interface GoogleCloudDocumentaiV1beta3GcsDocumentFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3GcsDocumentFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3GcsDocumentFormProperties>({
			gcsUri: new FormControl<string | null | undefined>(undefined),
			mimeType: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message for BatchProcessDocuments. */
	export interface GoogleCloudDocumentaiV1beta3BatchProcessRequestFormProperties {

		/** Whether human review should be skipped for this request. Default to `false`. */
		skipHumanReview: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3BatchProcessRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BatchProcessRequestFormProperties>({
	...
	/** Config that controls the output of documents. All documents will be written as a JSON file. */
	export interface GoogleCloudDocumentaiV1beta3DocumentOutputConfigFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentOutputConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentOutputConfigFormProperties>({
		});
	...
	/** The configuration used when outputting documents. */
	export interface GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigFormProperties>({
	...
	/** The sharding config for the output document. */
	export interface GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigShardingConfigFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigShardingConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentOutputConfigGcsOutputConfigShardingConfigFormProperties>({
	...
	/** The message for input config in batch process. */
	export interface GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfigFormProperties {

		/** The Cloud Storage location as the source of the document. */
		gcsSource: FormControl<string | null | undefined>,

		/** An IANA published [media type (MIME type)](https://www.iana.org/assignments/media-types/media-types.xhtml) of the input. If the input is a raw document, refer to [supported file types](https://cloud.google.com/document-ai/docs/file-types) for the list of media types. If the input is a Document, the type should be `application/json`. */
		mimeType: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchInputConfigFormProperties>({
			gcsSource: new FormControl<string | null | undefined>(undefined),
			mimeType: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The output configuration in the BatchProcessDocuments method. */
	export interface GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchOutputConfigFormProperties {

		/** The output Cloud Storage directory to put the processed documents. */
		gcsDestination: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3BatchProcessRequestBatchOutputConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BatchProcessRequestBatchOutputConfigFormProperties>({
			gcsDestination: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Options for Process API */
	export interface GoogleCloudDocumentaiV1beta3ProcessOptionsFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3ProcessOptionsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessOptionsFormProperties>({
	...
	/** A list of individual page numbers. */
	export interface GoogleCloudDocumentaiV1beta3ProcessOptionsIndividualPageSelectorFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3ProcessOptionsIndividualPageSelectorFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessOptionsIndividualPageSelectorFormProperties>({
		});
	...
	/** Config for Document OCR. */
	export interface GoogleCloudDocumentaiV1beta3OcrConfigFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3OcrConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3OcrConfigFormProperties>({
	...
	/** Hints for OCR Engine */
	export interface GoogleCloudDocumentaiV1beta3OcrConfigHintsFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3OcrConfigHintsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3OcrConfigHintsFormProperties>({
		});
	...
	/** Configurations for premium OCR features. */
	export interface GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeaturesFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3OcrConfigPremiumFeaturesFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3OcrConfigPremiumFeaturesFormProperties>({
			computeStyleInfo: new FormControl<boolean | null | undefined>(undefined),
	...
	/** The schema defines the output of the processed document by a processor. */
	export interface GoogleCloudDocumentaiV1beta3DocumentSchemaFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentSchemaFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentSchemaFormProperties>({
	...
	/** EntityType is the wrapper of a label of the corresponding model with detailed attributes and limitations for entity-based processors. Multiple types can also compose a dependency tree to represent nested types. */
	export interface GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeFormProperties>({
			displayName: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Metadata about an entity type. */
	export interface GoogleCloudDocumentaiV1beta3EntityTypeMetadataFormProperties {

		/** Whether the entity type should be considered inactive. */
		inactive: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3EntityTypeMetadataFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EntityTypeMetadataFormProperties>({
	...
	/** Defines the a list of enum values. */
	export interface GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeEnumValuesFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeEnumValuesFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeEnumValuesFormProperties>({
		});
	...
	export interface GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeProperty {
		...
		occurrenceType?: GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypePropertyOccurrenceType | null;
	...
	/** Defines properties that can be part of the entity type. */
	export interface GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypePropertyFormProperties {

		/** The name of the property. Follows the same guidelines as the EntityType name. */
		name: FormControl<string | null | undefined>,

		/** Occurrence type limits the number of instances an entity type appears in the document. */
		occurrenceType: FormControl<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypePropertyOccurrenceType | null | undefined>,

		/** A reference to the value type of the property. This type is subject to the same conventions as the `Entity.base_types` field. */
		valueType: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypePropertyFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypePropertyFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
			occurrenceType: new FormControl<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypePropertyOccurrenceType | null | undefined>(undefined),
			valueType: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Metadata about a property. */
	export interface GoogleCloudDocumentaiV1beta3PropertyMetadataFormProperties {

		/** Whether the property should be considered as "inactive". */
		inactive: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3PropertyMetadataFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3PropertyMetadataFormProperties>({
			inactive: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Metadata for how this field value is extracted. */
	export interface GoogleCloudDocumentaiV1beta3FieldExtractionMetadataFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3FieldExtractionMetadataFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3FieldExtractionMetadataFormProperties>({
		});
	...
	export interface GoogleCloudDocumentaiV1beta3SummaryOptions {
		...
		format?: GoogleCloudDocumentaiV1beta3SummaryOptionsFormat | null;

		/** How long the summary should be. */
		length?: GoogleCloudDocumentaiV1beta3SummaryOptionsLength | null;
	}

	/** Metadata for document summarization. */
	export interface GoogleCloudDocumentaiV1beta3SummaryOptionsFormProperties {

		/** The format the summary should be in. */
		format: FormControl<GoogleCloudDocumentaiV1beta3SummaryOptionsFormat | null | undefined>,

		/** How long the summary should be. */
		length: FormControl<GoogleCloudDocumentaiV1beta3SummaryOptionsLength | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3SummaryOptionsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3SummaryOptionsFormProperties>({
			format: new FormControl<GoogleCloudDocumentaiV1beta3SummaryOptionsFormat | null | undefined>(undefined),
			length: new FormControl<GoogleCloudDocumentaiV1beta3SummaryOptionsLength | null | undefined>(undefined),
		});
	...
	/** Metadata for global schema behavior. */
	export interface GoogleCloudDocumentaiV1beta3DocumentSchemaMetadataFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentSchemaMetadataFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentSchemaMetadataFormProperties>({
	...
	/** A bounding polygon for the detected image annotation. */
	export interface GoogleCloudDocumentaiV1beta3BoundingPolyFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3BoundingPolyFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3BoundingPolyFormProperties>({
		});
	...
	/** A vertex represents a 2D point in the image. NOTE: the normalized vertex coordinates are relative to the original image and range from 0 to 1. */
	export interface GoogleCloudDocumentaiV1beta3NormalizedVertexFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3NormalizedVertexFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3NormalizedVertexFormProperties>({
			x: new FormControl<number | null | undefined>(undefined),
			y: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** A vertex represents a 2D point in the image. NOTE: the vertex coordinates are in the same scale as the original image. */
	export interface GoogleCloudDocumentaiV1beta3VertexFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3VertexFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3VertexFormProperties>({
			x: new FormControl<number | null | undefined>(undefined),
			y: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** Dataset Schema. */
	export interface GoogleCloudDocumentaiV1beta3DatasetSchemaFormProperties {

		/** Dataset schema resource name. Format: `projects/{project}/locations/{location}/processors/{processor}/dataset/datasetSchema` */
		name: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DatasetSchemaFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DatasetSchemaFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message for the DeployProcessorVersion method. */
	export interface GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequestFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DeployProcessorVersionRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequestFormProperties>({
		});
	...
	/** Request message for the DisableProcessor method. */
	export interface GoogleCloudDocumentaiV1beta3DisableProcessorRequestFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DisableProcessorRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DisableProcessorRequestFormProperties>({
		});
	...
	/** Document represents the canonical document resource in Document AI. It is an interchange format that provides insights into documents and allows for collaboration between users and Document AI to iterate and optimize for quality. */
	export interface GoogleCloudDocumentaiV1beta3DocumentFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentFormProperties>({
			content: new FormControl<string | null | undefined>(undefined),
			mimeType: new FormControl<string | null | undefined>(undefined),
			text: new FormControl<string | null | undefined>(undefined),
			uri: new FormControl<string | null | undefined>(undefined),
	...
	/** An entity that could be a phrase in the text or a property that belongs to the document. It is a known entity type, such as a person, an organization, or location. */
	export interface GoogleCloudDocumentaiV1beta3DocumentEntityFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentEntityFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentEntityFormProperties>({
			confidence: new FormControl<number | null | undefined>(undefined),
			id: new FormControl<string | null | undefined>(undefined),
			mentionId: new FormControl<string | null | undefined>(undefined),
			mentionText: new FormControl<string | null | undefined>(undefined),
	...
	/** Parsed and normalized entity value. */
	export interface GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValueFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValueFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValueFormProperties>({
			booleanValue: new FormControl<boolean | null | undefined>(undefined),
			floatValue: new FormControl<number | null | undefined>(undefined),
			integerValue: new FormControl<number | null | undefined>(undefined),
			text: new FormControl<string | null | undefined>(undefined),
	...
	/** Referencing the visual context of the entity in the Document.pages. Page anchors can be cross-page, consist of multiple bounding polygons and optionally reference specific layout element types. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageAnchorFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageAnchorFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageAnchorFormProperties>({
		});
	...
	/** Represents a weak reference to a page element within a document. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRefFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRefFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRefFormProperties>({
			confidence: new FormControl<number | null | undefined>(undefined),
			layoutId: new FormControl<string | null | undefined>(undefined),
			layoutType: new FormControl<GoogleCloudDocumentaiV1beta1DocumentPageAnchorPageRefLayoutType | null | undefined>(undefined),
			page: new FormControl<string | null | undefined>(undefined),
	...
	/** Structure to identify provenance relationships between annotations in different revisions. */
	export interface GoogleCloudDocumentaiV1beta3DocumentProvenanceFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentProvenanceFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentProvenanceFormProperties>({
			id: new FormControl<number | null | undefined>(undefined),
			revision: new FormControl<number | null | undefined>(undefined),
			type: new FormControl<GoogleCloudDocumentaiV1beta1DocumentProvenanceType | null | undefined>(undefined),
		});
	...
	/** The parent element the current element is based on. Used for referencing/aligning, removal and replacement operations. */
	export interface GoogleCloudDocumentaiV1beta3DocumentProvenanceParentFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentProvenanceParentFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentProvenanceParentFormProperties>({
			id: new FormControl<number | null | undefined>(undefined),
			index: new FormControl<number | null | undefined>(undefined),
			revision: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** Text reference indexing into the Document.text. */
	export interface GoogleCloudDocumentaiV1beta3DocumentTextAnchorFormProperties {

		/** Contains the content of the text span so that users do not have to look it up in the text_segments. It is always populated for formFields. */
		content: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentTextAnchorFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentTextAnchorFormProperties>({
			content: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A text segment in the Document.text. The indices may be out of bounds which indicate that the text extends into another document shard for large sharded documents. See ShardInfo.text_offset */
	export interface GoogleCloudDocumentaiV1beta3DocumentTextAnchorTextSegmentFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentTextAnchorTextSegmentFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentTextAnchorTextSegmentFormProperties>({
			endIndex: new FormControl<string | null | undefined>(undefined),
			startIndex: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Relationship between Entities. */
	export interface GoogleCloudDocumentaiV1beta3DocumentEntityRelationFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentEntityRelationFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentEntityRelationFormProperties>({
			objectId: new FormControl<string | null | undefined>(undefined),
			relation: new FormControl<string | null | undefined>(undefined),
			subjectId: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A page in a Document. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageFormProperties {

		/** 1-based index for current Page in a parent Document. Useful when a page is taken out of a Document for individual processing. */
		pageNumber: FormControl<number | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageFormProperties>({
			pageNumber: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** A block has a set of lines (collected into paragraphs) that have a common line-spacing and orientation. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageBlockFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageBlockFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageBlockFormProperties>({
		});
	...
	/** Detected language for a structural component. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguageFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguageFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguageFormProperties>({
			confidence: new FormControl<number | null | undefined>(undefined),
			languageCode: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Visual element describing a layout unit on a page. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageLayoutFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageLayoutFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageLayoutFormProperties>({
			confidence: new FormControl<number | null | undefined>(undefined),
			orientation: new FormControl<GoogleCloudDocumentaiV1beta1DocumentPageLayoutOrientation | null | undefined>(undefined),
		});
	...
	/** A detected barcode. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcodeFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcodeFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageDetectedBarcodeFormProperties>({
		});
	...
	/** Dimension for the page. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageDimensionFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageDimensionFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageDimensionFormProperties>({
			height: new FormControl<number | null | undefined>(undefined),
			unit: new FormControl<string | null | undefined>(undefined),
			width: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** A form field detected on the page. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageFormFieldFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageFormFieldFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageFormFieldFormProperties>({
			correctedKeyText: new FormControl<string | null | undefined>(undefined),
			correctedValueText: new FormControl<string | null | undefined>(undefined),
			valueType: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Rendered image contents for this page. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageImageFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageImageFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageImageFormProperties>({
			content: new FormControl<string | null | undefined>(undefined),
			height: new FormControl<number | null | undefined>(undefined),
			mimeType: new FormControl<string | null | undefined>(undefined),
			width: new FormControl<number | null | undefined>(undefined),
	...
	/** Image quality scores for the page image. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresFormProperties {

		/** The overall quality score. Range `[0, 1]` where `1` is perfect quality. */
		qualityScore: FormControl<number | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresFormProperties>({
			qualityScore: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** Image Quality Defects */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefectFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefectFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefectFormProperties>({
			confidence: new FormControl<number | null | undefined>(undefined),
			type: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A collection of tokens that a human would perceive as a line. Does not cross column boundaries, can be horizontal, vertical, etc. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageLineFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageLineFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageLineFormProperties>({
		});
	...
	/** A collection of lines that a human would perceive as a paragraph. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageParagraphFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageParagraphFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageParagraphFormProperties>({
		});
	...
	/** A detected symbol. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageSymbolFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageSymbolFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageSymbolFormProperties>({
		});
	...
	/** A table representation similar to HTML table structure. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageTableFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageTableFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageTableFormProperties>({
		});
	...
	/** A row of table cells. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageTableTableRowFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageTableTableRowFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageTableTableRowFormProperties>({
		});
	...
	/** A cell representation inside the table. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageTableTableCellFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageTableTableCellFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageTableTableCellFormProperties>({
			colSpan: new FormControl<number | null | undefined>(undefined),
			rowSpan: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** A detected token. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageTokenFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageTokenFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageTokenFormProperties>({
		});
	...
	/** Detected break at the end of a Token. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreakFormProperties {

		/** Detected break type. */
		type: FormControl<GoogleCloudDocumentaiV1beta1DocumentPageTokenDetectedBreakType | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreakFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreakFormProperties>({
			type: new FormControl<GoogleCloudDocumentaiV1beta1DocumentPageTokenDetectedBreakType | null | undefined>(undefined),
		});
	...
	/** Font and other text style attributes. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageTokenStyleInfoFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageTokenStyleInfoFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageTokenStyleInfoFormProperties>({
			bold: new FormControl<boolean | null | undefined>(undefined),
			fontSize: new FormControl<number | null | undefined>(undefined),
			fontType: new FormControl<string | null | undefined>(undefined),
			fontWeight: new FormControl<number | null | undefined>(undefined),
	...
	/** Representation for transformation matrix, intended to be compatible and used with OpenCV format for image manipulation. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageMatrixFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageMatrixFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageMatrixFormProperties>({
			cols: new FormControl<number | null | undefined>(undefined),
			data: new FormControl<string | null | undefined>(undefined),
			rows: new FormControl<number | null | undefined>(undefined),
			type: new FormControl<number | null | undefined>(undefined),
	...
	/** Detected non-text visual elements e.g. checkbox, signature etc. on the page. */
	export interface GoogleCloudDocumentaiV1beta3DocumentPageVisualElementFormProperties {

		/** Type of the VisualElement. */
		type: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentPageVisualElementFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentPageVisualElementFormProperties>({
			type: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Contains past or forward revisions of this document. */
	export interface GoogleCloudDocumentaiV1beta3DocumentRevisionFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentRevisionFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentRevisionFormProperties>({
			agent: new FormControl<string | null | undefined>(undefined),
			createTime: new FormControl<string | null | undefined>(undefined),
			id: new FormControl<string | null | undefined>(undefined),
			processor: new FormControl<string | null | undefined>(undefined),
	...
	/** Human Review information of the document. */
	export interface GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReviewFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentRevisionHumanReviewFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReviewFormProperties>({
			state: new FormControl<string | null | undefined>(undefined),
			stateMessage: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** For a large document, sharding may be performed to produce several document shards. Each document shard contains this field to detail which shard it is. */
	export interface GoogleCloudDocumentaiV1beta3DocumentShardInfoFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentShardInfoFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentShardInfoFormProperties>({
			shardCount: new FormControl<string | null | undefined>(undefined),
			shardIndex: new FormControl<string | null | undefined>(undefined),
			textOffset: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** This message is used for text changes aka. OCR corrections. */
	export interface GoogleCloudDocumentaiV1beta3DocumentTextChangeFormProperties {

		/** The text that replaces the text identified in the `text_anchor`. */
		changedText: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentTextChangeFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentTextChangeFormProperties>({
			changedText: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Annotation for common text style attributes. This adheres to CSS conventions as much as possible. */
	export interface GoogleCloudDocumentaiV1beta3DocumentStyleFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentStyleFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentStyleFormProperties>({
			fontFamily: new FormControl<string | null | undefined>(undefined),
			fontWeight: new FormControl<string | null | undefined>(undefined),
			textDecoration: new FormControl<string | null | undefined>(undefined),
			textStyle: new FormControl<string | null | undefined>(undefined),
	...
	/** Font size with unit. */
	export interface GoogleCloudDocumentaiV1beta3DocumentStyleFontSizeFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3DocumentStyleFontSizeFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentStyleFontSizeFormProperties>({
			size: new FormControl<number | null | undefined>(undefined),
			unit: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDocumentaiV1beta3DocumentMetadata {
		...
		datasetType?: GoogleCloudDocumentaiUiv1beta3BatchMoveDocumentsMetadataDestDatasetType | null;
		...
		labelingState?: GoogleCloudDocumentaiV1beta3DocumentMetadataLabelingState | null;
	...
	/** Metadata about a document. */
	export interface GoogleCloudDocumentaiV1beta3DocumentMetadataFormProperties {

		/** Type of the dataset split to which the document belongs. */
		datasetType: FormControl<GoogleCloudDocumentaiUiv1beta3BatchMoveDocumentsMetadataDestDatasetType | null | undefined>,

		/** The display name of the document. */
		displayName: FormControl<string | null | undefined>,

		/** Labeling state of the document. */
		labelingState: FormControl<GoogleCloudDocumentaiV1beta3DocumentMetadataLabelingState | null | undefined>,

		/** Number of pages in the document. */
		pageCount: FormControl<number | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3DocumentMetadataFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3DocumentMetadataFormProperties>({
			datasetType: new FormControl<GoogleCloudDocumentaiUiv1beta3BatchMoveDocumentsMetadataDestDatasetType | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			labelingState: new FormControl<GoogleCloudDocumentaiV1beta3DocumentMetadataLabelingState | null | undefined>(undefined),
	...
	/** Request message for the EnableProcessor method. */
	export interface GoogleCloudDocumentaiV1beta3EnableProcessorRequestFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3EnableProcessorRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EnableProcessorRequestFormProperties>({
		});
	...
	/** Evaluates the given ProcessorVersion against the supplied documents. */
	export interface GoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequestFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequestFormProperties>({
		});
	...
	export interface GoogleCloudDocumentaiV1beta3Evaluation {
		...
		entityMetrics?: {[id: string]: GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics };
	...
	/** An evaluation of a ProcessorVersion's performance. */
	export interface GoogleCloudDocumentaiV1beta3EvaluationFormProperties {

		/** The time that the evaluation was created. */
		createTime: FormControl<string | null | undefined>,

		/** Metrics across confidence levels, for different entities. */
		entityMetrics: FormControl<{[id: string]: GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics } | null | undefined>,
	...
	export function CreateGoogleCloudDocumentaiV1beta3EvaluationFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EvaluationFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			entityMetrics: new FormControl<{[id: string]: GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics } | null | undefined>(undefined),
	...
	export interface GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetrics {
		...
		metricsType?: GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetricsMetricsType | null;
	}

	/** Metrics across multiple confidence levels. */
	export interface GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetricsFormProperties {
		...
		/** The metrics type for the label. */
		metricsType: FormControl<GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetricsMetricsType | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetricsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetricsFormProperties>({
			...
			metricsType: new FormControl<GoogleCloudDocumentaiV1beta3EvaluationMultiConfidenceMetricsMetricsType | null | undefined>(undefined),
		});
	...
	/** Evaluations metrics, at a specific confidence level. */
	export interface GoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetricsFormProperties {

		/** The confidence level. */
		confidenceLevel: FormControl<number | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetricsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EvaluationConfidenceLevelMetricsFormProperties>({
	...
	/** Evaluation metrics, either in aggregate or about a specific entity. */
	export interface GoogleCloudDocumentaiV1beta3EvaluationMetricsFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3EvaluationMetricsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EvaluationMetricsFormProperties>({
	...
	/** Evaluation counters for the documents that were used. */
	export interface GoogleCloudDocumentaiV1beta3EvaluationCountersFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3EvaluationCountersFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EvaluationCountersFormProperties>({
	...
	/** Gives a short summary of an evaluation, and links to the evaluation itself. */
	export interface GoogleCloudDocumentaiV1beta3EvaluationReferenceFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3EvaluationReferenceFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3EvaluationReferenceFormProperties>({
			evaluation: new FormControl<string | null | undefined>(undefined),
	...
	/** Response message for the FetchProcessorTypes method. */
	export interface GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponseFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponseFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponseFormProperties>({
		});
	...
	export interface GoogleCloudDocumentaiV1beta3ProcessorType {
		...
		launchStage?: GoogleCloudDocumentaiV1beta3ProcessorTypeLaunchStage | null;
	...
	/** A processor type is responsible for performing a certain document understanding task on a certain type of document. */
	export interface GoogleCloudDocumentaiV1beta3ProcessorTypeFormProperties {
		...
		/** Launch stage of the processor type */
		launchStage: FormControl<GoogleCloudDocumentaiV1beta3ProcessorTypeLaunchStage | null | undefined>,
	...
	export function CreateGoogleCloudDocumentaiV1beta3ProcessorTypeFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessorTypeFormProperties>({
			allowCreation: new FormControl<boolean | null | undefined>(undefined),
			category: new FormControl<string | null | undefined>(undefined),
			launchStage: new FormControl<GoogleCloudDocumentaiV1beta3ProcessorTypeLaunchStage | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			type: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The location information about where the processor is available. */
	export interface GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfoFormProperties {

		/** The location ID. For supported locations, refer to [regional and multi-regional support](/document-ai/docs/regions). */
		locationId: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfoFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfoFormProperties>({
	...
	export interface GoogleCloudDocumentaiV1beta3GetDocumentResponseFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3GetDocumentResponseFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3GetDocumentResponseFormProperties>({
		});
	...
	export interface GoogleCloudDocumentaiV1beta3ImportDocumentsRequestFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3ImportDocumentsRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ImportDocumentsRequestFormProperties>({
		});
	...
	export interface GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfig {
		...
		datasetSplit?: GoogleCloudDocumentaiUiv1beta3BatchMoveDocumentsMetadataDestDatasetType | null;
	}

	/** Config for importing documents. Each batch can have its own dataset split type. */
	export interface GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigFormProperties {

		/** Target dataset split where the documents must be stored. */
		datasetSplit: FormControl<GoogleCloudDocumentaiUiv1beta3BatchMoveDocumentsMetadataDestDatasetType | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigFormProperties>({
			datasetSplit: new FormControl<GoogleCloudDocumentaiUiv1beta3BatchMoveDocumentsMetadataDestDatasetType | null | undefined>(undefined),
		});
	...
	/** The config for auto-split. */
	export interface GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigAutoSplitConfigFormProperties {

		/** Ratio of training dataset split. */
		trainingSplitRatio: FormControl<number | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigAutoSplitConfigFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ImportDocumentsRequestBatchDocumentsImportConfigAutoSplitConfigFormProperties>({
			trainingSplitRatio: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** The request message for the ImportProcessorVersion method. The Document AI [Service Agent](https://cloud.google.com/iam/docs/service-agents) of the destination project must have [Document AI Editor role](https://cloud.google.com/document-ai/docs/access-control/iam-roles) on the source project. The destination project is specified as part of the parent field. The source project is specified as part of the source or external_processor_version_source field. */
	export interface GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestFormProperties {

		/** The source processor version to import from. The source processor version and destination processor need to be in the same environment and region. */
		processorVersionSource: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestFormProperties>({
			processorVersionSource: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The external source processor version. */
	export interface GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestExternalProcessorVersionSourceFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestExternalProcessorVersionSourceFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequestExternalProcessorVersionSourceFormProperties>({
			processorVersion: new FormControl<string | null | undefined>(undefined),
	...
	export interface GoogleCloudDocumentaiV1beta3ListDocumentsRequestFormProperties {
		...
		/** Optional. Controls if the request requires a total size of matched documents. See ListDocumentsResponse.total_size. Enabling this flag may adversely impact performance. Defaults to false. */
		returnTotalSize: FormControl<boolean | null | undefined>,

		/** Optional. Number of results to skip beginning from the `page_token` if provided. https://google.aip.dev/158#skipping-results. It must be a non-negative integer. Negative values will be rejected. Note that this is not the number of pages to skip. If this value causes the cursor to move past the end of results, ListDocumentsResponse.document_metadata and ListDocumentsResponse.next_page_token will be empty. */
		skip: FormControl<number | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ListDocumentsRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ListDocumentsRequestFormProperties>({
			filter: new FormControl<string | null | undefined>(undefined),
			pageSize: new FormControl<number | null | undefined>(undefined),
			pageToken: new FormControl<string | null | undefined>(undefined),
			returnTotalSize: new FormControl<boolean | null | undefined>(undefined),
	...
	export interface GoogleCloudDocumentaiV1beta3ListDocumentsResponseFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3ListDocumentsResponseFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ListDocumentsResponseFormProperties>({
	...
	/** The response from `ListEvaluations`. */
	export interface GoogleCloudDocumentaiV1beta3ListEvaluationsResponseFormProperties {

		/** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ListEvaluationsResponseFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ListEvaluationsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for the ListProcessorTypes method. */
	export interface GoogleCloudDocumentaiV1beta3ListProcessorTypesResponseFormProperties {

		/** Points to the next page, otherwise empty. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ListProcessorTypesResponseFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ListProcessorTypesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for the ListProcessorVersions method. */
	export interface GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponseFormProperties {

		/** Points to the next processor, otherwise empty. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ListProcessorVersionsResponseFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDocumentaiV1beta3ProcessorVersion {
		...
		state?: GoogleCloudDocumentaiV1beta3ProcessorVersionState | null;
	}

	/** A processor version is an implementation of a processor. Each processor can have multiple versions, pretrained by Google internally or uptrained by the customer. A processor can only have one default version at a time. Its document-processing behavior is defined by that version. */
	export interface GoogleCloudDocumentaiV1beta3ProcessorVersionFormProperties {
		...
		/** The state of the processor version. */
		state: FormControl<GoogleCloudDocumentaiV1beta3ProcessorVersionState | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ProcessorVersionFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessorVersionFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			...
			kmsKeyVersionName: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			state: new FormControl<GoogleCloudDocumentaiV1beta3ProcessorVersionState | null | undefined>(undefined),
		});
	...
	/** Information about the upcoming deprecation of this processor version. */
	export interface GoogleCloudDocumentaiV1beta3ProcessorVersionDeprecationInfoFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3ProcessorVersionDeprecationInfoFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessorVersionDeprecationInfoFormProperties>({
	...
	/** Response message for the ListProcessors method. */
	export interface GoogleCloudDocumentaiV1beta3ListProcessorsResponseFormProperties {

		/** Points to the next processor, otherwise empty. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ListProcessorsResponseFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ListProcessorsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDocumentaiV1beta3Processor {
		...
		state?: GoogleCloudDocumentaiV1beta3ProcessorState | null;
	...
	/** The first-class citizen for Document AI. Each processor defines how to extract structural information from a document. */
	export interface GoogleCloudDocumentaiV1beta3ProcessorFormProperties {
		...
		/** Output only. The state of the processor. */
		state: FormControl<GoogleCloudDocumentaiV1beta3ProcessorState | null | undefined>,

		/** The processor type, such as: `OCR_PROCESSOR`, `INVOICE_PROCESSOR`. To get a list of processor types, see FetchProcessorTypes. */
		type: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ProcessorFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessorFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			...
			state: new FormControl<GoogleCloudDocumentaiV1beta3ProcessorState | null | undefined>(undefined),
			type: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Contains the alias and the aliased resource name of processor version. */
	export interface GoogleCloudDocumentaiV1beta3ProcessorVersionAliasFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3ProcessorVersionAliasFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessorVersionAliasFormProperties>({
	...
	/** Request message for the ProcessDocument method. */
	export interface GoogleCloudDocumentaiV1beta3ProcessRequestFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3ProcessRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessRequestFormProperties>({
			fieldMask: new FormControl<string | null | undefined>(undefined),
			skipHumanReview: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Payload message of raw document content (bytes). */
	export interface GoogleCloudDocumentaiV1beta3RawDocumentFormProperties {
	...
	export function CreateGoogleCloudDocumentaiV1beta3RawDocumentFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3RawDocumentFormProperties>({
			content: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			mimeType: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for the ProcessDocument method. */
	export interface GoogleCloudDocumentaiV1beta3ProcessResponseFormProperties {

		/** The name of the operation triggered by the processed document. If the human review process isn't triggered, this field is empty. It has the same response type and metadata as the long-running operation returned by ReviewDocument. */
		humanReviewOperation: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ProcessResponseFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ProcessResponseFormProperties>({
			humanReviewOperation: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDocumentaiV1beta3ReviewDocumentRequest {
		...
		priority?: GoogleCloudDocumentaiV1beta3ReviewDocumentRequestPriority | null;
	}

	/** Request message for the ReviewDocument method. */
	export interface GoogleCloudDocumentaiV1beta3ReviewDocumentRequestFormProperties {

		/** Whether the validation should be performed on the ad-hoc review request. */
		enableSchemaValidation: FormControl<boolean | null | undefined>,

		/** The priority of the human review task. */
		priority: FormControl<GoogleCloudDocumentaiV1beta3ReviewDocumentRequestPriority | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3ReviewDocumentRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3ReviewDocumentRequestFormProperties>({
			enableSchemaValidation: new FormControl<boolean | null | undefined>(undefined),
			priority: new FormControl<GoogleCloudDocumentaiV1beta3ReviewDocumentRequestPriority | null | undefined>(undefined),
		});
	...
	/** Request message for the SetDefaultProcessorVersion method. */
	export interface GoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequestFormProperties {

		/** Required. The resource name of child ProcessorVersion to use as default. Format: `projects/{project}/locations/{location}/processors/{processor}/processorVersions/{version}` */
		defaultProcessorVersion: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequestFormProperties>({
			defaultProcessorVersion: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message for the TrainProcessorVersion method. */
	export interface GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFormProperties {

		/** Optional. The processor version to use as a base for training. This processor version must be a child of `parent`. Format: `projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processorVersion}`. */
		baseProcessorVersion: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFormProperties>({
	...
	export interface GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptions {
		...
		trainingMethod?: GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptionsTrainingMethod | null;
	}

	/** Options to control the training of the Custom Document Extraction (CDE) Processor. */
	export interface GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptionsFormProperties {

		/** Training method to use for CDE training. */
		trainingMethod: FormControl<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptionsTrainingMethod | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptionsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptionsFormProperties>({
			trainingMethod: new FormControl<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestCustomDocumentExtractionOptionsTrainingMethod | null | undefined>(undefined),
		});
	...
	/** Options to control foundation model tuning of the processor. */
	export interface GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptionsFormProperties {

		/** Optional. The multiplier to apply to the recommended learning rate. Valid values are between [0.1, 10]. If not provided, recommended learning rate will be used. */
		learningRateMultiplier: FormControl<number | null | undefined>,

		/** Optional. The number of steps to run for model tuning. Valid values are between [1, 400]. If not provided, recommended steps will be used. */
		trainSteps: FormControl<number | null | undefined>,
	}
	export function CreateGoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptionsFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestFoundationModelTuningOptionsFormProperties>({
			learningRateMultiplier: new FormControl<number | null | undefined>(undefined),
			trainSteps: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** The input data used to train a new ProcessorVersion. */
	export interface GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputDataFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputDataFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequestInputDataFormProperties>({
		});
	...
	/** Request message for the UndeployProcessorVersion method. */
	export interface GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequestFormProperties {
	}
	export function CreateGoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequestFormGroup() {
		return new FormGroup<GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequestFormProperties>({
		});
	...
	export class MyClient {
		 ...
		 */
		Documentai_projects_locations_processors_dataset_batchDeleteDocuments(dataset: string, requestBody: GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (dataset == null ? '' : encodeURIComponent(dataset)) + ':batchDeleteDocuments', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} documentId_gcsManagedDocId_cwDocId Id of the document (indexed) managed by Content Warehouse.
		 * @param {string} documentId_gcsManagedDocId_gcsUri Required. The Cloud Storage URI where the actual document is stored.
		 * @param {string} documentId_revisionRef_latestProcessorVersion Reads the revision generated by the processor version. The format takes the full resource name of processor version. `projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processorVersion}`
		 * @param {GoogleCloudDocumentaiUiv1beta3RevisionRefRevisionCase} documentId_revisionRef_revisionCase Reads the revision by the predefined case.
		 * @param {string} documentId_revisionRef_revisionId Reads the revision given by the id.
		 * @param {string} documentId_unmanagedDocId_docId Required. The id of the document.
		 * @param {number} pageRange_end Last page number (one-based index) to be returned.
		 * @param {number} pageRange_start First page number (one-based index) to be returned.
		 * @param {string} readMask If set, only fields listed here will be returned. Otherwise, all fields will be returned by default.
		 * @return {GoogleCloudDocumentaiV1beta3GetDocumentResponse} Successful response
		 */
		Documentai_projects_locations_processors_dataset_getDocument(dataset: string, documentId_gcsManagedDocId_cwDocId: string | null | undefined, documentId_gcsManagedDocId_gcsUri: string | null | undefined, documentId_revisionRef_latestProcessorVersion: string | null | undefined, documentId_revisionRef_revisionCase: GoogleCloudDocumentaiUiv1beta3RevisionRefRevisionCase | null | undefined, documentId_revisionRef_revisionId: string | null | undefined, documentId_unmanagedDocId_docId: string | null | undefined, pageRange_end: number | null | undefined, pageRange_start: number | null | undefined, readMask: string | null | undefined): Observable<GoogleCloudDocumentaiV1beta3GetDocumentResponse> {
			return this.http.get<GoogleCloudDocumentaiV1beta3GetDocumentResponse>(this.baseUri + 'v1beta3/' + (dataset == null ? '' : encodeURIComponent(dataset)) + ':getDocument&documentId_gcsManagedDocId_cwDocId=' + (documentId_gcsManagedDocId_cwDocId == null ? '' : encodeURIComponent(documentId_gcsManagedDocId_cwDocId)) + '&documentId_gcsManagedDocId_gcsUri=' + (documentId_gcsManagedDocId_gcsUri == null ? '' : encodeURIComponent(documentId_gcsManagedDocId_gcsUri)) + '&documentId_revisionRef_latestProcessorVersion=' + (documentId_revisionRef_latestProcessorVersion == null ? '' : encodeURIComponent(documentId_revisionRef_latestProcessorVersion)) + '&documentId_revisionRef_revisionCase=' + documentId_revisionRef_revisionCase + '&documentId_revisionRef_revisionId=' + (documentId_revisionRef_revisionId == null ? '' : encodeURIComponent(documentId_revisionRef_revisionId)) + '&documentId_unmanagedDocId_docId=' + (documentId_unmanagedDocId_docId == null ? '' : encodeURIComponent(documentId_unmanagedDocId_docId)) + '&pageRange_end=' + pageRange_end + '&pageRange_start=' + pageRange_start + '&readMask=' + (readMask == null ? '' : encodeURIComponent(readMask)), {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_dataset_importDocuments(dataset: string, requestBody: GoogleCloudDocumentaiV1beta3ImportDocumentsRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (dataset == null ? '' : encodeURIComponent(dataset)) + ':importDocuments', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3ListDocumentsResponse} Successful response
		 */
		Documentai_projects_locations_processors_dataset_listDocuments(dataset: string, requestBody: GoogleCloudDocumentaiV1beta3ListDocumentsRequest): Observable<GoogleCloudDocumentaiV1beta3ListDocumentsResponse> {
			return this.http.post<GoogleCloudDocumentaiV1beta3ListDocumentsResponse>(this.baseUri + 'v1beta3/' + (dataset == null ? '' : encodeURIComponent(dataset)) + ':listDocuments', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_humanReviewConfig_reviewDocument(humanReviewConfig: string, requestBody: GoogleCloudDocumentaiV1beta3ReviewDocumentRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (humanReviewConfig == null ? '' : encodeURIComponent(humanReviewConfig)) + ':reviewDocument', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Documentai_projects_locations_processors_processorVersions_delete(name: string): Observable<GoogleLongrunningOperation> {
			return this.http.delete<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3ProcessorType} Successful response
		 */
		Documentai_projects_locations_processorTypes_get(name: string, visibleFieldsOnly: boolean | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDocumentaiV1beta3ProcessorType> {
			return this.http.get<GoogleCloudDocumentaiV1beta3ProcessorType>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + '&visibleFieldsOnly=' + visibleFieldsOnly + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3DatasetSchema} Successful response
		 */
		Documentai_projects_locations_processors_dataset_updateDatasetSchema(name: string, updateMask: string | null | undefined, requestBody: GoogleCloudDocumentaiV1beta3DatasetSchema): Observable<GoogleCloudDocumentaiV1beta3DatasetSchema> {
			return this.http.patch<GoogleCloudDocumentaiV1beta3DatasetSchema>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Documentai_projects_locations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudLocationListLocationsResponse> {
			return this.http.get<GoogleCloudLocationListLocationsResponse>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + '/locations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_batchProcess(name: string, requestBody: GoogleCloudDocumentaiV1beta3BatchProcessRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':batchProcess', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Documentai_projects_locations_operations_cancel(name: string): Observable<GoogleProtobufEmpty> {
			return this.http.post<GoogleProtobufEmpty>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':cancel', null, {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_deploy(name: string, requestBody: GoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':deploy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_disable(name: string, requestBody: GoogleCloudDocumentaiV1beta3DisableProcessorRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':disable', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_enable(name: string, requestBody: GoogleCloudDocumentaiV1beta3EnableProcessorRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':enable', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3ProcessResponse} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_process(name: string, requestBody: GoogleCloudDocumentaiV1beta3ProcessRequest): Observable<GoogleCloudDocumentaiV1beta3ProcessResponse> {
			return this.http.post<GoogleCloudDocumentaiV1beta3ProcessResponse>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':process', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_undeploy(name: string, requestBody: GoogleCloudDocumentaiV1beta3UndeployProcessorVersionRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':undeploy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3ListEvaluationsResponse} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_evaluations_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDocumentaiV1beta3ListEvaluationsResponse> {
			return this.http.get<GoogleCloudDocumentaiV1beta3ListEvaluationsResponse>(this.baseUri + 'v1beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/evaluations&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse} Successful response
		 */
		Documentai_projects_locations_processorTypes_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse> {
			return this.http.get<GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse>(this.baseUri + 'v1beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/processorTypes&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse> {
			return this.http.get<GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse>(this.baseUri + 'v1beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/processorVersions&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_importProcessorVersion(parent: string, requestBody: GoogleCloudDocumentaiV1beta3ImportProcessorVersionRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/processorVersions:importProcessorVersion', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_train(parent: string, requestBody: GoogleCloudDocumentaiV1beta3TrainProcessorVersionRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/processorVersions:train', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3ListProcessorsResponse} Successful response
		 */
		Documentai_projects_locations_processors_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDocumentaiV1beta3ListProcessorsResponse> {
			return this.http.get<GoogleCloudDocumentaiV1beta3ListProcessorsResponse>(this.baseUri + 'v1beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/processors&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDocumentaiV1beta3Processor} Successful response
		 */
		Documentai_projects_locations_processors_create(parent: string, requestBody: GoogleCloudDocumentaiV1beta3Processor): Observable<GoogleCloudDocumentaiV1beta3Processor> {
			return this.http.post<GoogleCloudDocumentaiV1beta3Processor>(this.baseUri + 'v1beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/processors', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} parent Required. The location of processor types to list. Format: `projects/{project}/locations/{location}`.
		 * @return {GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse} Successful response
		 */
		Documentai_projects_locations_fetchProcessorTypes(parent: string): Observable<GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse> {
			return this.http.get<GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse>(this.baseUri + 'v1beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + ':fetchProcessorTypes', {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_processorVersions_evaluateProcessorVersion(processorVersion: string, requestBody: GoogleCloudDocumentaiV1beta3EvaluateProcessorVersionRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (processorVersion == null ? '' : encodeURIComponent(processorVersion)) + ':evaluateProcessorVersion', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Documentai_projects_locations_processors_setDefaultProcessorVersion(processor: string, requestBody: GoogleCloudDocumentaiV1beta3SetDefaultProcessorVersionRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta3/' + (processor == null ? '' : encodeURIComponent(processor)) + ':setDefaultProcessorVersion', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
