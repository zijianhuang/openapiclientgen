...
export namespace MyNS {
	...
	export enum FindingFindingType { FINDING_TYPE_UNSPECIFIED = 0, MIXED_CONTENT = 1, OUTDATED_LIBRARY = 2, ROSETTA_FLASH = 3, XSS_CALLBACK = 4, XSS_ERROR = 5, CLEAR_TEXT_PASSWORD = 6, INVALID_CONTENT_TYPE = 7, XSS_ANGULAR_CALLBACK = 8, INVALID_HEADER = 9, MISSPELLED_SECURITY_HEADER_NAME = 10, MISMATCHING_SECURITY_HEADER_VALUES = 11, ACCESSIBLE_GIT_REPOSITORY = 12, ACCESSIBLE_SVN_REPOSITORY = 13, ACCESSIBLE_ENV_FILE = 14 }
