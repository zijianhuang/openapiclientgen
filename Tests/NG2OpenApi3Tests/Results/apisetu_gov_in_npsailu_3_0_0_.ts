...
export namespace MyNS {
	...
	export interface NdcerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<NdcerPostBodyFormat | null | undefined>,
	...
	export function CreateNdcerPostBodyFormGroup() {
		return new FormGroup<NdcerPostBodyFormProperties>({
			format: new FormControl<NdcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export enum NdcerPostBodyFormat { pdf = 'pdf' }
