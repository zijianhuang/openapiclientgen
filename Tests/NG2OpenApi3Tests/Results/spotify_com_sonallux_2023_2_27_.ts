...
export namespace MyNS {
	...
	export interface SimplifiedArtistObject {
		 ...
		 * The object type.
		 */
		type?: SimplifiedArtistObjectType | null;
	...
	export interface SimplifiedArtistObjectFormProperties {
		 ...
		 * The object type.
		 */
		type: FormControl<SimplifiedArtistObjectType | null | undefined>,
	...
	export function CreateSimplifiedArtistObjectFormGroup() {
		return new FormGroup<SimplifiedArtistObjectFormProperties>({
			...
			type: new FormControl<SimplifiedArtistObjectType | null | undefined>(undefined),
			uri: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum SimplifiedArtistObjectType { artist = 'artist' }
	...
	export interface PagingSavedAudiobookObjectFormProperties {
	}
	export function CreatePagingSavedAudiobookObjectFormGroup() {
		return new FormGroup<PagingSavedAudiobookObjectFormProperties>({
		});
	...
	export interface SavedAudiobookObjectFormProperties {
	...
	export function CreateSavedAudiobookObjectFormGroup() {
		return new FormGroup<SavedAudiobookObjectFormProperties>({
			added_at: new FormControl<Date | null | undefined>(undefined),
		});
	...
	export interface SimplifiedAudiobookObjectFormProperties {
	}
	...
	export interface SimplifiedShowObjectFormProperties {
	}
	...
	export class MyClient {
		 ...
		 * Get me/audiobooks
		 * @return {PagingSavedAudiobookObject} Pages of saved audiobooks
		 */
		Get_users_saved_audiobooks(limit: number | null | undefined, offset: number | null | undefined): Observable<PagingSavedAudiobookObject> {
			return this.http.get<PagingSavedAudiobookObject>(this.baseUri + 'me/audiobooks?limit=' + limit + '&offset=' + offset, {});
		}
		 ...
		 */
		Get_followed(type: SimplifiedArtistObjectType, after: string | null | undefined, limit: number | null | undefined): Observable<Get_followedReturn> {
		 ...
		 * @return {CurrentlyPlayingObject} Information about the currently playing track
		 */
		Get_the_users_currently_playing_track(market: string | null | undefined, additional_types: string | null | undefined): Observable<CurrentlyPlayingObject> {
			return this.http.get<CurrentlyPlayingObject>(this.baseUri + 'me/player/currently-playing?market=' + (market == null ? '' : encodeURIComponent(market)) + '&additional_types=' + (additional_types == null ? '' : encodeURIComponent(additional_types)), {});
		}
		 ...
		 * @return {DevicesObject} A set of devices
		 */
		Get_a_users_available_devices(): Observable<DevicesObject> {
			return this.http.get<DevicesObject>(this.baseUri + 'me/player/devices', {});
		}
		 ...
		 */
		Save_shows_user(ids: string, requestBody: Save_shows_userPutBody): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'me/shows?ids=' + (ids == null ? '' : encodeURIComponent(ids)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * Get me/top/artists
		 * @return {PagingArtistObject} Pages of artists
		 */
		Get_users_top_artists(time_range: string | null | undefined, limit: number | null | undefined, offset: number | null | undefined): Observable<PagingArtistObject> {
			return this.http.get<PagingArtistObject>(this.baseUri + 'me/top/artists?time_range=' + (time_range == null ? '' : encodeURIComponent(time_range)) + '&limit=' + limit + '&offset=' + offset, {});
		}
		 ...
		 * Get me/top/tracks
		 * @return {PagingTrackObject} Pages of tracks
		 */
		Get_users_top_tracks(time_range: string | null | undefined, limit: number | null | undefined, offset: number | null | undefined): Observable<PagingTrackObject> {
			return this.http.get<PagingTrackObject>(this.baseUri + 'me/top/tracks?time_range=' + (time_range == null ? '' : encodeURIComponent(time_range)) + '&limit=' + limit + '&offset=' + offset, {});
		}
	...
	export interface Save_shows_userPutBody {
	...
	export interface Save_shows_userPutBodyFormProperties {
	}
	export function CreateSave_shows_userPutBodyFormGroup() {
		return new FormGroup<Save_shows_userPutBodyFormProperties>({
		});
