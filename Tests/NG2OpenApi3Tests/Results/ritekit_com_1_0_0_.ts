...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {void} OK
		 */
		Auto_Emojify(text: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/emoji/auto-emojify?text=' + (text == null ? '' : encodeURIComponent(text)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Emoji_Suggestions(text: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/emoji/suggestions?text=' + (text == null ? '' : encodeURIComponent(text)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Animate_Image(url: string, type: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/images/animate?url=' + (url == null ? '' : encodeURIComponent(url)) + '&type=' + (type == null ? '' : encodeURIComponent(type)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Company_Logo(domain: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/images/logo?domain=' + (domain == null ? '' : encodeURIComponent(domain)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		List_of_CTAs(): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/link/cta', { observe: 'response', responseType: 'text' });
		}
		...
		Shorten_Link(url: string, cta: number): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/link/short-link?url=' + (url == null ? '' : encodeURIComponent(url)) + '&cta=' + cta, { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Trending_Hashtags(green: boolean | null | undefined, latin: boolean | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/search/trending?green=' + green + '&latin=' + latin, { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Auto_Hashtag(post: string, maxHashtags: number | null | undefined, hashtagPosition: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/stats/auto-hashtag?post=' + (post == null ? '' : encodeURIComponent(post)) + '&maxHashtags=' + maxHashtags + '&hashtagPosition=' + (hashtagPosition == null ? '' : encodeURIComponent(hashtagPosition)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Hashtag_Suggestions(text: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/stats/hashtag-suggestions?text=' + (text == null ? '' : encodeURIComponent(text)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Hashtag_History(hashtag: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/stats/history/' + (hashtag == null ? '' : encodeURIComponent(hashtag)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Hashtag_Stats(tags: Array<string>): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1/stats/multiple-hashtags?' + tags.map(z => `tags=${encodeURIComponent(z)}`).join('&'), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Hashtags_cleaner(post: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v2/instagram/hashtags-cleaner?post=' + (post == null ? '' : encodeURIComponent(post)), { observe: 'response', responseType: 'text' });
		}
	}
