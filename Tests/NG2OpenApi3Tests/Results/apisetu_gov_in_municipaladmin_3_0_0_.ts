...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {KecerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Kecer(requestBody: KecerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'kecer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {TapcnPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Tapcn(requestBody: TapcnPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'tapcn/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {TdlcsPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Tdlcs(requestBody: TdlcsPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'tdlcs/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {UgdcnPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Ugdcn(requestBody: UgdcnPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'ugdcn/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface KecerPostBody {
		certificateParameters?: KecerPostBodyCertificateParameters;
	...
	export interface KecerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<KecerPostBodyFormat | null | undefined>,
	...
	export function CreateKecerPostBodyFormGroup() {
		return new FormGroup<KecerPostBodyFormProperties>({
			format: new FormControl<KecerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface KecerPostBodyCertificateParameters {
	...
	export interface KecerPostBodyCertificateParametersFormProperties {
	...
	export function CreateKecerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<KecerPostBodyCertificateParametersFormProperties>({
			DocumentNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface TapcnPostBodyFormProperties {
	...
	export function CreateTapcnPostBodyFormGroup() {
		return new FormGroup<TapcnPostBodyFormProperties>({
			format: new FormControl<KecerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface TapcnPostBodyCertificateParameters {
	...
	export interface TapcnPostBodyCertificateParametersFormProperties {
	...
	export function CreateTapcnPostBodyCertificateParametersFormGroup() {
		return new FormGroup<TapcnPostBodyCertificateParametersFormProperties>({
			DocumentNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface TdlcsPostBody {
		certificateParameters?: TdlcsPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface TdlcsPostBodyFormProperties {
	...
	export function CreateTdlcsPostBodyFormGroup() {
		return new FormGroup<TdlcsPostBodyFormProperties>({
			format: new FormControl<KecerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface TdlcsPostBodyCertificateParameters {
	...
	export interface TdlcsPostBodyCertificateParametersFormProperties {
	...
	export function CreateTdlcsPostBodyCertificateParametersFormGroup() {
		return new FormGroup<TdlcsPostBodyCertificateParametersFormProperties>({
			DocumentNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface UgdcnPostBody {
		certificateParameters?: UgdcnPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface UgdcnPostBodyFormProperties {
	...
	export function CreateUgdcnPostBodyFormGroup() {
		return new FormGroup<UgdcnPostBodyFormProperties>({
			format: new FormControl<KecerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface UgdcnPostBodyCertificateParameters {
	...
	export interface UgdcnPostBodyCertificateParametersFormProperties {
	...
	export function CreateUgdcnPostBodyCertificateParametersFormGroup() {
		return new FormGroup<UgdcnPostBodyCertificateParametersFormProperties>({
			DocumentNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
