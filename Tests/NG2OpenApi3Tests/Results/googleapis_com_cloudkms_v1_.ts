...
export namespace MyNS {
	...
	export enum AsymmetricDecryptResponseProtectionLevel { PROTECTION_LEVEL_UNSPECIFIED = 0, SOFTWARE = 1, HSM = 2, EXTERNAL = 3, EXTERNAL_VPC = 4 }
	...
	export enum CryptoKeyVersionState { CRYPTO_KEY_VERSION_STATE_UNSPECIFIED = 0, PENDING_GENERATION = 1, ENABLED = 2, DISABLED = 3, DESTROYED = 4, DESTROY_SCHEDULED = 5, PENDING_IMPORT = 6, IMPORT_FAILED = 7, GENERATION_FAILED = 8, PENDING_EXTERNAL_DESTRUCTION = 9, EXTERNAL_DESTRUCTION_FAILED = 10 }

	export enum CryptoKeyPurpose { CRYPTO_KEY_PURPOSE_UNSPECIFIED = 0, ENCRYPT_DECRYPT = 1, ASYMMETRIC_SIGN = 2, ASYMMETRIC_DECRYPT = 3, RAW_ENCRYPT_DECRYPT = 4, MAC = 5 }
	...
	export enum EkmConnectionKeyManagementMode { KEY_MANAGEMENT_MODE_UNSPECIFIED = 0, MANUAL = 1, CLOUD_KMS = 2 }
	...
	export enum ImportJobImportMethod { IMPORT_METHOD_UNSPECIFIED = 0, RSA_OAEP_3072_SHA1_AES_256 = 1, RSA_OAEP_4096_SHA1_AES_256 = 2, RSA_OAEP_3072_SHA256_AES_256 = 3, RSA_OAEP_4096_SHA256_AES_256 = 4, RSA_OAEP_3072_SHA256 = 5, RSA_OAEP_4096_SHA256 = 6 }
