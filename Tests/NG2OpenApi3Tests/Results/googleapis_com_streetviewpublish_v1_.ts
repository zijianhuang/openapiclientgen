...
export namespace MyNS {
	...
	export enum PhotoSequenceFailureReason { PROCESSING_FAILURE_REASON_UNSPECIFIED = 0, LOW_RESOLUTION = 1, DUPLICATE = 2, INSUFFICIENT_GPS = 3, NO_OVERLAP_GPS = 4, INVALID_GPS = 5, FAILED_TO_REFINE_POSITIONS = 6, TAKEDOWN = 7, CORRUPT_VIDEO = 8, INTERNAL = 9, INVALID_VIDEO_FORMAT = 10, INVALID_VIDEO_DIMENSIONS = 11, INVALID_CAPTURE_TIME = 12, GPS_DATA_GAP = 13, JUMPY_GPS = 14, INVALID_IMU = 15, INSUFFICIENT_IMU = 16, INSUFFICIENT_OVERLAP_TIME_SERIES = 17, IMU_DATA_GAP = 18, UNSUPPORTED_CAMERA = 19, NOT_OUTDOORS = 20, INSUFFICIENT_VIDEO_FRAMES = 21, INSUFFICIENT_MOVEMENT = 22, MAST_DOWN = 23 }

	export enum PhotoSequenceGpsSource { PHOTO_SEQUENCE = 0, CAMERA_MOTION_METADATA_TRACK = 1 }

	export enum PhotoSequenceProcessingState { PROCESSING_STATE_UNSPECIFIED = 0, PENDING = 1, PROCESSING = 2, PROCESSED = 3, FAILED = 4 }
	...
	export enum Streetviewpublish_photoSequence_createInputType { INPUT_TYPE_UNSPECIFIED = 0, VIDEO = 1, XDM = 2 }
