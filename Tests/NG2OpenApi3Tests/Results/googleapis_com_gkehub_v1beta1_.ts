...
export namespace MyNS {
	...
	/** The response of the exclusivity artifacts manifests for the client to apply. */
	export interface GenerateExclusivityManifestResponseFormProperties {

		/** The YAML manifest of the membership CR to apply if a new version of the CR is available. Empty if no update needs to be applied. */
		crManifest: FormControl<string | null | undefined>,

		/** The YAML manifest of the membership CRD to apply if a newer version of the CRD is available. Empty if no update needs to be applied. */
		crdManifest: FormControl<string | null | undefined>,
	}
	export function CreateGenerateExclusivityManifestResponseFormGroup() {
		return new FormGroup<GenerateExclusivityManifestResponseFormProperties>({
			crManifest: new FormControl<string | null | undefined>(undefined),
			crdManifest: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response of exclusivity artifacts validation result status. */
	export interface ValidateExclusivityResponseFormProperties {
	}
	export function CreateValidateExclusivityResponseFormGroup() {
		return new FormGroup<ValidateExclusivityResponseFormProperties>({
		});
	...
	export class MyClient {
		 ...
		 */
		Gkehub_projects_locations_operations_delete(name: string, force: boolean | null | undefined, requestId: string | null | undefined): Observable<Empty> {
		 ...
		 * @return {Operation} Successful response
		 */
		Gkehub_projects_locations_memberships_patch(name: string, requestId: string | null | undefined, updateMask: string | null | undefined, requestBody: Membership): Observable<Operation> {
		 ...
		 * @param {string} connectAgent_name Do not set.
		 * @param {string} connectAgent_namespace Optional. Namespace for GKE Connect agent resources. Defaults to `gke-connect`. The Connect Agent is authorized automatically when run in the default namespace. Otherwise, explicit authorization must be granted with an additional IAM binding.
		 * @param {string} connectAgent_proxy Optional. URI of a proxy if connectivity from the agent to gkeconnect.googleapis.com requires the use of a proxy. Format must be in the form `http(s)://{proxy_address}`, depending on the HTTP/HTTPS protocol supported by the proxy. This will direct the connect agent's outbound traffic through a HTTP(S) proxy.
		 ...
		 */
		Gkehub_projects_locations_memberships_generateConnectManifest(name: string, connectAgent_name: string | null | undefined, connectAgent_namespace: string | null | undefined, connectAgent_proxy: string | null | undefined, imagePullSecretContent: string | null | undefined, isUpgrade: boolean | null | undefined, registry: string | null | undefined, version: string | null | undefined): Observable<GenerateConnectManifestResponse> {
			return this.http.get<GenerateConnectManifestResponse>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':generateConnectManifest&connectAgent_name=' + (connectAgent_name == null ? '' : encodeURIComponent(connectAgent_name)) + '&connectAgent_namespace=' + (connectAgent_namespace == null ? '' : encodeURIComponent(connectAgent_namespace)) + '&connectAgent_proxy=' + (connectAgent_proxy == null ? '' : encodeURIComponent(connectAgent_proxy)) + '&imagePullSecretContent=' + (imagePullSecretContent == null ? '' : encodeURIComponent(imagePullSecretContent)) + '&isUpgrade=' + isUpgrade + '&registry=' + (registry == null ? '' : encodeURIComponent(registry)) + '&version=' + (version == null ? '' : encodeURIComponent(version)), {});
		}
		 ...
		 * @return {GenerateExclusivityManifestResponse} Successful response
		 */
		Gkehub_projects_locations_memberships_generateExclusivityManifest(name: string, crManifest: string | null | undefined, crdManifest: string | null | undefined): Observable<GenerateExclusivityManifestResponse> {
			return this.http.get<GenerateExclusivityManifestResponse>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':generateExclusivityManifest&crManifest=' + (crManifest == null ? '' : encodeURIComponent(crManifest)) + '&crdManifest=' + (crdManifest == null ? '' : encodeURIComponent(crdManifest)), {});
		}
		...
		Gkehub_projects_locations_memberships_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListMembershipsResponse> {
			return this.http.get<ListMembershipsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Gkehub_projects_locations_memberships_create(parent: string, membershipId: string | null | undefined, requestId: string | null | undefined, requestBody: Membership): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships&membershipId=' + (membershipId == null ? '' : encodeURIComponent(membershipId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ValidateExclusivityResponse} Successful response
		 */
		Gkehub_projects_locations_memberships_validateExclusivity(parent: string, crManifest: string | null | undefined, intendedMembership: string | null | undefined): Observable<ValidateExclusivityResponse> {
			return this.http.get<ValidateExclusivityResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:validateExclusivity&crManifest=' + (crManifest == null ? '' : encodeURIComponent(crManifest)) + '&intendedMembership=' + (intendedMembership == null ? '' : encodeURIComponent(intendedMembership)), {});
		}
