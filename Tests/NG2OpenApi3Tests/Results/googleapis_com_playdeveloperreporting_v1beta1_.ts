...
export namespace MyNS {
	...
	export enum GooglePlayDeveloperReportingV1beta1TimelineSpecAggregationPeriod { AGGREGATION_PERIOD_UNSPECIFIED = 0, HOURLY = 1, DAILY = 2, FULL_RANGE = 3 }
	...
	export enum GooglePlayDeveloperReportingV1beta1ErrorIssueType { ERROR_TYPE_UNSPECIFIED = 0, APPLICATION_NOT_RESPONDING = 1, CRASH = 2 }
	...
	export enum GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequestUserCohort { USER_COHORT_UNSPECIFIED = 0, OS_PUBLIC = 1, OS_BETA = 2, APP_TESTERS = 3 }
