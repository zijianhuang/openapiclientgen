...
export namespace MyNS {
	...
	/** Configuration for encrypting secret payloads using customer-managed encryption keys (CMEK). */
	export interface CustomerManagedEncryptionFormProperties {

		/** Required. The resource name of the Cloud KMS CryptoKey used to encrypt secret payloads. For secrets using the UserManaged replication policy type, Cloud KMS CryptoKeys must reside in the same location as the replica location. For secrets using the Automatic replication policy type, Cloud KMS CryptoKeys must reside in `global`. The expected format is `projects/locations/keyRings/cryptoKeys/*`. */
		kmsKeyName: FormControl<string | null | undefined>,
	}
	export function CreateCustomerManagedEncryptionFormGroup() {
		return new FormGroup<CustomerManagedEncryptionFormProperties>({
	...
	/** The replication status of a SecretVersion using automatic replication. Only populated if the parent Secret has an automatic replication policy. */
	export interface AutomaticStatusFormProperties {
	}
	export function CreateAutomaticStatusFormGroup() {
		return new FormGroup<AutomaticStatusFormProperties>({
		});
	...
	/** Describes the status of customer-managed encryption. */
	export interface CustomerManagedEncryptionStatusFormProperties {

		/** Required. The resource name of the Cloud KMS CryptoKeyVersion used to encrypt the secret payload, in the following format: `projects/locations/keyRings/cryptoKeys/versions/*`. */
		kmsKeyVersionName: FormControl<string | null | undefined>,
	}
	export function CreateCustomerManagedEncryptionStatusFormGroup() {
		return new FormGroup<CustomerManagedEncryptionStatusFormProperties>({
	...
	export interface SecretVersionFormProperties {
		...
		/** Output only. True if payload checksum specified in SecretPayload object has been received by SecretManagerService on SecretManagerService.AddSecretVersion. */
		clientSpecifiedPayloadChecksum: FormControl<boolean | null | undefined>,
	...
	export function CreateSecretVersionFormGroup() {
		return new FormGroup<SecretVersionFormProperties>({
			clientSpecifiedPayloadChecksum: new FormControl<boolean | null | undefined>(undefined),
	...
	/** The replication status of a SecretVersion using user-managed replication. Only populated if the parent Secret has a user-managed replication policy. */
	export interface UserManagedStatusFormProperties {
	}
	export function CreateUserManagedStatusFormGroup() {
		return new FormGroup<UserManagedStatusFormProperties>({
		});
	...
	export interface Secret {
		...
		versionAliases?: {[id: string]: string };
	}
	...
	export interface SecretFormProperties {
		...
		/** Optional. Mapping from version alias to version name. A version alias is a string with a maximum length of 63 characters and can contain uppercase and lowercase letters, numerals, and the hyphen (`-`) and underscore ('_') characters. An alias string must start with a letter and cannot be the string 'latest' or 'NEW'. No more than 50 aliases can be assigned to a given secret. Version-Alias pairs will be viewable via GetSecret and modifiable via UpdateSecret. At launch Access by Allias will only be supported on GetSecretVersion and AccessSecretVersion. */
		versionAliases: FormControl<{[id: string]: string } | null | undefined>,
	}
	export function CreateSecretFormGroup() {
		return new FormGroup<SecretFormProperties>({
			...
			versionAliases: new FormControl<{[id: string]: string } | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 * @param {string} etag Optional. Etag of the Secret. The request succeeds if it matches the etag of the currently stored secret object. If the etag is omitted, the request succeeds.
		 * @return {Empty} Successful response
		 */
		Secretmanager_projects_secrets_delete(name: string, etag: string | null | undefined): Observable<Empty> {
		 ...
		 * Get v1/{name}
		 * @param {string} name Required. The resource name of the SecretVersion in the format `projects/secrets/versions/*`. `projects/secrets/versions/latest` is an alias to the most recently created SecretVersion.
		 * @return {SecretVersion} Successful response
		 */
		Secretmanager_projects_secrets_versions_get(name: string): Observable<SecretVersion> {
			return this.http.get<SecretVersion>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Secretmanager_projects_secrets_patch(name: string, updateMask: string | null | undefined, requestBody: Secret): Observable<Secret> {
			return this.http.patch<Secret>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Secretmanager_projects_secrets_versions_access(name: string): Observable<AccessSecretVersionResponse> {
			return this.http.get<AccessSecretVersionResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':access', {});
		}
		...
		Secretmanager_projects_secrets_versions_destroy(name: string, requestBody: DestroySecretVersionRequest): Observable<SecretVersion> {
			return this.http.post<SecretVersion>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':destroy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Secretmanager_projects_secrets_versions_disable(name: string, requestBody: DisableSecretVersionRequest): Observable<SecretVersion> {
			return this.http.post<SecretVersion>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':disable', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Secretmanager_projects_secrets_versions_enable(name: string, requestBody: EnableSecretVersionRequest): Observable<SecretVersion> {
			return this.http.post<SecretVersion>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':enable', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} filter Optional. Filter string, adhering to the rules in [List-operation filtering](https://cloud.google.com/secret-manager/docs/filtering). List only secrets matching the filter. If filter is empty, all secrets are listed.
		 ...
		 */
		Secretmanager_projects_secrets_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSecretsResponse> {
			return this.http.get<ListSecretsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/secrets&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Secretmanager_projects_secrets_create(parent: string, secretId: string | null | undefined, requestBody: Secret): Observable<Secret> {
			return this.http.post<Secret>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/secrets&secretId=' + (secretId == null ? '' : encodeURIComponent(secretId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} filter Optional. Filter string, adhering to the rules in [List-operation filtering](https://cloud.google.com/secret-manager/docs/filtering). List only secret versions matching the filter. If filter is empty, all secret versions are listed.
		 * @param {number} pageSize Optional. The maximum number of results to be returned in a single page. If set to 0, the server decides the number of results to return. If the number is greater than 25000, it is capped at 25000.
		 ...
		 */
		Secretmanager_projects_secrets_versions_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSecretVersionsResponse> {
			return this.http.get<ListSecretVersionsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/versions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Secretmanager_projects_secrets_addVersion(parent: string, requestBody: AddSecretVersionRequest): Observable<SecretVersion> {
			return this.http.post<SecretVersion>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':addVersion', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
