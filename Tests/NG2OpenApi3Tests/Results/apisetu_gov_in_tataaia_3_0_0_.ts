...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {LicerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Licer(requestBody: LicerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'licer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {PrcptPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Prcpt(requestBody: PrcptPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'prcpt/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface LicerPostBody {
		certificateParameters?: LicerPostBodyCertificateParameters;
	...
	export interface LicerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<LicerPostBodyFormat | null | undefined>,
	...
	export function CreateLicerPostBodyFormGroup() {
		return new FormGroup<LicerPostBodyFormProperties>({
			format: new FormControl<LicerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface LicerPostBodyCertificateParameters {
	...
	export interface LicerPostBodyCertificateParametersFormProperties {
	...
	export function CreateLicerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<LicerPostBodyCertificateParametersFormProperties>({
	...
	export interface PrcptPostBodyFormProperties {
	...
	export function CreatePrcptPostBodyFormGroup() {
		return new FormGroup<PrcptPostBodyFormProperties>({
			format: new FormControl<LicerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PrcptPostBodyCertificateParameters {
	...
	export interface PrcptPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		PI_DOB: FormControl<string | null | undefined>,

		/**
		 * Financial Year
		 * Required
		 */
		PI_FIN_YEAR: FormControl<string | null | undefined>,

		/**
		 * Policy No
		 * Required
		 */
		PI_POLICYNBR: FormControl<string | null | undefined>,
	}
	export function CreatePrcptPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PrcptPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			PI_DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			PI_FIN_YEAR: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			PI_POLICYNBR: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
