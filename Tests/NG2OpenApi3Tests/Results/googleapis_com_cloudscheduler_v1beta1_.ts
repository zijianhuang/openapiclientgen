...
export namespace MyNS {
	...
	export interface JobFormProperties {
		...
		/** Immutable. This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the job will be considered a legacy job. Note that App Engine Cron jobs have fewer features than Cloud Scheduler jobs, e.g., are only limited to App Engine targets. */
		legacyAppEngineCron: FormControl<boolean | null | undefined>,
	...
	export function CreateJobFormGroup() {
		return new FormGroup<JobFormProperties>({
			...
			legacyAppEngineCron: new FormControl<boolean | null | undefined>(undefined),
	...
	export class MyClient {
		 ...
		 */
		Cloudscheduler_projects_locations_jobs_delete(name: string, legacyAppEngineCron: boolean | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&legacyAppEngineCron=' + legacyAppEngineCron, {});
		}
		 ...
		 */
		Cloudscheduler_projects_locations_jobs_get(name: string): Observable<Job> {
			return this.http.get<Job>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * @return {Job} Successful response
		 */
		Cloudscheduler_projects_locations_jobs_patch(name: string, updateMask: string | null | undefined, requestBody: Job): Observable<Job> {
			return this.http.patch<Job>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Cloudscheduler_projects_locations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationsResponse> {
		 ...
		 * @return {Job} Successful response
		 */
		Cloudscheduler_projects_locations_jobs_pause(name: string, requestBody: PauseJobRequest): Observable<Job> {
			return this.http.post<Job>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':pause', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Job} Successful response
		 */
		Cloudscheduler_projects_locations_jobs_resume(name: string, requestBody: ResumeJobRequest): Observable<Job> {
			return this.http.post<Job>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':resume', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Job} Successful response
		 */
		Cloudscheduler_projects_locations_jobs_run(name: string, requestBody: RunJobRequest): Observable<Job> {
			return this.http.post<Job>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':run', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Cloudscheduler_projects_locations_jobs_list(parent: string, filter: string | null | undefined, legacyAppEngineCron: boolean | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListJobsResponse> {
			return this.http.get<ListJobsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/jobs&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&legacyAppEngineCron=' + legacyAppEngineCron + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {Job} Successful response
		 */
		Cloudscheduler_projects_locations_jobs_create(parent: string, requestBody: Job): Observable<Job> {
