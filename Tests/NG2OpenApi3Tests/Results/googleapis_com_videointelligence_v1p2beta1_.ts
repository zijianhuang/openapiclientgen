...
export namespace MyNS {
	...
	export enum GoogleCloudVideointelligenceV1p2beta1_LabelDetectionConfigLabelDetectionMode { LABEL_DETECTION_MODE_UNSPECIFIED = 'LABEL_DETECTION_MODE_UNSPECIFIED', SHOT_MODE = 'SHOT_MODE', FRAME_MODE = 'FRAME_MODE', SHOT_AND_FRAME_MODE = 'SHOT_AND_FRAME_MODE' }
