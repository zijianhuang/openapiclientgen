...
export namespace MyNS {
	...
	export enum ClientLibrarySettingsLaunchStage { LAUNCH_STAGE_UNSPECIFIED = 0, UNIMPLEMENTED = 1, PRELAUNCH = 2, EARLY_ACCESS = 3, ALPHA = 4, BETA = 5, GA = 6, DEPRECATED = 7 }
	...
	/** Consumer quota settings for a quota limit. */
	export interface V1Beta1ConsumerQuotaLimitFormProperties {

		/** Whether this limit is precise or imprecise. */
		isPrecise: FormControl<boolean | null | undefined>,
	...
	export function CreateV1Beta1ConsumerQuotaLimitFormGroup() {
		return new FormGroup<V1Beta1ConsumerQuotaLimitFormProperties>({
			isPrecise: new FormControl<boolean | null | undefined>(undefined),
			metric: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			unit: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A quota bucket is a quota provisioning unit for a specific set of dimensions. */
	export interface V1Beta1QuotaBucketFormProperties {
		...
		/** The effective limit of this quota bucket. Equal to default_limit if there are no overrides. */
		effectiveLimit: FormControl<string | null | undefined>,
	}
	export function CreateV1Beta1QuotaBucketFormGroup() {
		return new FormGroup<V1Beta1QuotaBucketFormProperties>({
			defaultLimit: new FormControl<string | null | undefined>(undefined),
			dimensions: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			effectiveLimit: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Consumer quota settings for a quota metric. */
	export interface V1Beta1ConsumerQuotaMetricFormProperties {
	...
	export function CreateV1Beta1ConsumerQuotaMetricFormGroup() {
		return new FormGroup<V1Beta1ConsumerQuotaMetricFormProperties>({
			displayName: new FormControl<string | null | undefined>(undefined),
			metric: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			unit: new FormControl<string | null | undefined>(undefined),
	...
	/** Request message for ImportProducerOverrides */
	export interface V1Beta1ImportProducerOverridesRequestFormProperties {

		/** Whether to force the creation of the quota overrides. Setting the force parameter to 'true' ignores all quota safety checks that would fail the request. QuotaSafetyCheck lists all such validations. */
		force: FormControl<boolean | null | undefined>,
	}
	export function CreateV1Beta1ImportProducerOverridesRequestFormGroup() {
		return new FormGroup<V1Beta1ImportProducerOverridesRequestFormProperties>({
	...
	/** Import data embedded in the request message */
	export interface V1Beta1OverrideInlineSourceFormProperties {
	}
	export function CreateV1Beta1OverrideInlineSourceFormGroup() {
		return new FormGroup<V1Beta1OverrideInlineSourceFormProperties>({
		});
	...
	/** Response message for ListConsumerQuotaMetrics. */
	export interface V1Beta1ListConsumerQuotaMetricsResponseFormProperties {

		/** Token identifying which result to start with; returned by a previous list call. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateV1Beta1ListConsumerQuotaMetricsResponseFormGroup() {
		return new FormGroup<V1Beta1ListConsumerQuotaMetricsResponseFormProperties>({
	...
	/** Response message for ListProducerOverrides. */
	export interface V1Beta1ListProducerOverridesResponseFormProperties {

		/** Token identifying which result to start with; returned by a previous list call. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateV1Beta1ListProducerOverridesResponseFormGroup() {
		return new FormGroup<V1Beta1ListProducerOverridesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for the `AddVisibilityLabels` method. This response message is assigned to the `response` field of the returned Operation when that operation is done. */
	export interface V1beta1AddVisibilityLabelsResponseFormProperties {
	}
	export function CreateV1beta1AddVisibilityLabelsResponseFormGroup() {
		return new FormGroup<V1beta1AddVisibilityLabelsResponseFormProperties>({
		});
	...
	/** A default identity in the Identity and Access Management API. */
	export interface V1beta1DefaultIdentityFormProperties {
	...
	export function CreateV1beta1DefaultIdentityFormGroup() {
		return new FormGroup<V1beta1DefaultIdentityFormProperties>({
			email: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			tag: new FormControl<string | null | undefined>(undefined),
			uniqueId: new FormControl<string | null | undefined>(undefined),
	...
	export interface V1beta1GenerateDefaultIdentityResponse {
		...
		attachStatus?: V1beta1GenerateDefaultIdentityResponseAttachStatus | null;
	...
	/** Response message for the `GenerateDefaultIdentity` method. This response message is assigned to the `response` field of the returned Operation when that operation is done. */
	export interface V1beta1GenerateDefaultIdentityResponseFormProperties {

		/** Status of the role attachment. Under development (go/si-attach-role), currently always return ATTACH_STATUS_UNSPECIFIED) */
		attachStatus: FormControl<V1beta1GenerateDefaultIdentityResponseAttachStatus | null | undefined>,

		/** Role attached to consumer project. Empty if not attached in this request. (Under development, currently always return empty.) */
		role: FormControl<string | null | undefined>,
	}
	export function CreateV1beta1GenerateDefaultIdentityResponseFormGroup() {
		return new FormGroup<V1beta1GenerateDefaultIdentityResponseFormProperties>({
			attachStatus: new FormControl<V1beta1GenerateDefaultIdentityResponseAttachStatus | null | undefined>(undefined),
			role: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum V1beta1GenerateDefaultIdentityResponseAttachStatus { ATTACH_STATUS_UNSPECIFIED = 0, ATTACHED = 1, ATTACH_SKIPPED = 2, PREVIOUSLY_ATTACHED = 3, ATTACH_DENIED_BY_ORG_POLICY = 4 }
	...
	/** Response message for the `GenerateServiceAccount` method. This response message is assigned to the `response` field of the returned Operation when that operation is done. */
	export interface V1beta1GenerateServiceAccountResponseFormProperties {
	}
	export function CreateV1beta1GenerateServiceAccountResponseFormGroup() {
		return new FormGroup<V1beta1GenerateServiceAccountResponseFormProperties>({
		});
	...
	/** A service account in the Identity and Access Management API. */
	export interface V1beta1ServiceAccountFormProperties {
	...
	export function CreateV1beta1ServiceAccountFormGroup() {
		return new FormGroup<V1beta1ServiceAccountFormProperties>({
			email: new FormControl<string | null | undefined>(undefined),
	...
	/** Response message for the `RemoveVisibilityLabels` method. This response message is assigned to the `response` field of the returned Operation when that operation is done. */
	export interface V1beta1RemoveVisibilityLabelsResponseFormProperties {
	}
	export function CreateV1beta1RemoveVisibilityLabelsResponseFormGroup() {
		return new FormGroup<V1beta1RemoveVisibilityLabelsResponseFormProperties>({
		});
	...
	export class MyClient {
		 ...
		 * @param {Array<string>} forceOnly The list of quota safety checks to ignore before the override mutation. Unlike 'force' field that ignores all the quota safety checks, the 'force_only' field ignores only the specified checks; other checks are still enforced. The 'force' and 'force_only' fields cannot both be set.
		 * @return {Operation} Successful response
		 */
		Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_delete(name: string, force: boolean | null | undefined, forceOnly: Array<string> | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&force=' + force + '&' + forceOnly?.map(z => `forceOnly=${encodeURIComponent(z)}`).join('&'), {});
		}
		 ...
		 * @param {Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView} view Specifies the level of detail for quota information in the response.
		 * @return {V1Beta1ConsumerQuotaLimit} Successful response
		 */
		Serviceconsumermanagement_services_consumerQuotaMetrics_limits_get(name: string, view: Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView | null | undefined): Observable<V1Beta1ConsumerQuotaLimit> {
			return this.http.get<V1Beta1ConsumerQuotaLimit>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&view=' + view, {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_patch(name: string, force: boolean | null | undefined, forceOnly: Array<string> | null | undefined, updateMask: string | null | undefined, requestBody: V1Beta1QuotaOverride): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&force=' + force + '&' + forceOnly?.map(z => `forceOnly=${encodeURIComponent(z)}`).join('&') + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView} view Specifies the level of detail for quota information in the response.
		 * @return {V1Beta1ListConsumerQuotaMetricsResponse} Successful response
		 */
		Serviceconsumermanagement_services_consumerQuotaMetrics_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView | null | undefined): Observable<V1Beta1ListConsumerQuotaMetricsResponse> {
			return this.http.get<V1Beta1ListConsumerQuotaMetricsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/consumerQuotaMetrics&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Serviceconsumermanagement_services_consumerQuotaMetrics_importProducerOverrides(parent: string, requestBody: V1Beta1ImportProducerOverridesRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/consumerQuotaMetrics:importProducerOverrides', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {number} pageSize Requested size of the next page of data.
		 * @param {string} pageToken Token identifying which result to start with; returned by a previous list call.
		 * @return {V1Beta1ListProducerOverridesResponse} Successful response
		 */
		Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<V1Beta1ListProducerOverridesResponse> {
			return this.http.get<V1Beta1ListProducerOverridesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/producerOverrides&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Serviceconsumermanagement_services_consumerQuotaMetrics_limits_producerOverrides_create(parent: string, force: boolean | null | undefined, forceOnly: Array<string> | null | undefined, requestBody: V1Beta1QuotaOverride): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/producerOverrides&force=' + force + '&' + forceOnly?.map(z => `forceOnly=${encodeURIComponent(z)}`).join('&'), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}

	export enum Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView { QUOTA_VIEW_UNSPECIFIED = 0, BASIC = 1, FULL = 2 }
