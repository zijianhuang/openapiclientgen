...
export namespace MyNS {
	...
	export enum V1beta1GenerateDefaultIdentityResponseAttachStatus { ATTACH_STATUS_UNSPECIFIED = 'ATTACH_STATUS_UNSPECIFIED', ATTACHED = 'ATTACHED', ATTACH_SKIPPED = 'ATTACH_SKIPPED', PREVIOUSLY_ATTACHED = 'PREVIOUSLY_ATTACHED', ATTACH_DENIED_BY_ORG_POLICY = 'ATTACH_DENIED_BY_ORG_POLICY' }
	...
	export enum Serviceconsumermanagement_services_consumerQuotaMetrics_limits_getView { QUOTA_VIEW_UNSPECIFIED = 'QUOTA_VIEW_UNSPECIFIED', BASIC = 'BASIC', FULL = 'FULL' }
