...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {ListActivitiesResponse} Successful response
		 */
		Appsactivity_activities_list(drive_ancestorId: string | null | undefined, drive_fileId: string | null | undefined, groupingStrategy: Appsactivity_activities_listGroupingStrategy | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, source: string | null | undefined, userId: string | null | undefined): Observable<ListActivitiesResponse> {
			return this.http.get<ListActivitiesResponse>(this.baseUri + 'activities?drive_ancestorId=' + (drive_ancestorId == null ? '' : encodeURIComponent(drive_ancestorId)) + '&drive_fileId=' + (drive_fileId == null ? '' : encodeURIComponent(drive_fileId)) + '&groupingStrategy=' + groupingStrategy + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&source=' + (source == null ? '' : encodeURIComponent(source)) + '&userId=' + (userId == null ? '' : encodeURIComponent(userId)), {});
		}
	}
