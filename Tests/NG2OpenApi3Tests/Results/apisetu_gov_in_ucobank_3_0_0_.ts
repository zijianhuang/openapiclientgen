...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {TdcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Tdcer(requestBody: TdcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'tdcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface TdcerPostBody {
		certificateParameters?: TdcerPostBodyCertificateParameters;
	...
	export interface TdcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<TdcerPostBodyFormat | null | undefined>,
	...
	export function CreateTdcerPostBodyFormGroup() {
		return new FormGroup<TdcerPostBodyFormProperties>({
			format: new FormControl<TdcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface TdcerPostBodyCertificateParameters {
	...
	export interface TdcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		finYr: FormControl<string | null | undefined>,
	}
	export function CreateTdcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<TdcerPostBodyCertificateParametersFormProperties>({
			CustID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			finYr: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum TdcerPostBodyFormat { pdf = 'pdf' }
