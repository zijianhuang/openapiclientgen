...
export namespace MyNS {
	...
	/** Parameters for text detections. This is used to control TEXT_DETECTION and DOCUMENT_TEXT_DETECTION features. */
	export interface TextDetectionParamsFormProperties {

		/** By default, Cloud Vision API only includes confidence score for DOCUMENT_TEXT_DETECTION result. Set the flag to true to include confidence score for TEXT_DETECTION as well. */
		enableTextDetectionConfidenceScore: FormControl<boolean | null | undefined>,
	}
	export function CreateTextDetectionParamsFormGroup() {
		return new FormGroup<TextDetectionParamsFormProperties>({
	...
	export class MyClient {
		 ...
		 * @return {BatchAnnotateFilesResponse} Successful response
		 */
		Vision_files_annotate(requestBody: BatchAnnotateFilesRequest): Observable<BatchAnnotateFilesResponse> {
			return this.http.post<BatchAnnotateFilesResponse>(this.baseUri + 'v1/files:annotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Vision_files_asyncBatchAnnotate(requestBody: AsyncBatchAnnotateFilesRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/files:asyncBatchAnnotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Run image detection and annotation for a batch of images.
		 * Post v1/images:annotate
		 * @return {BatchAnnotateImagesResponse} Successful response
		 */
		Vision_images_annotate(requestBody: BatchAnnotateImagesRequest): Observable<BatchAnnotateImagesResponse> {
			return this.http.post<BatchAnnotateImagesResponse>(this.baseUri + 'v1/images:annotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Vision_images_asyncBatchAnnotate(requestBody: AsyncBatchAnnotateImagesRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/images:asyncBatchAnnotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Vision_projects_locations_productSets_delete(name: string): Observable<Empty> {
		 ...
		 * @return {Operation} Successful response
		 */
		Vision_projects_operations_get(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Vision_projects_locations_productSets_patch(name: string, updateMask: string | null | undefined, requestBody: ProductSet): Observable<ProductSet> {
			return this.http.patch<ProductSet>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Vision_projects_locations_productSets_products_list(name: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListProductsInProductSetResponse> {
			return this.http.get<ListProductsInProductSetResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/products&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Vision_projects_locations_productSets_addProduct(name: string, requestBody: AddProductToProductSetRequest): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':addProduct', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Vision_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<Empty> {
		 ...
		 * @return {Empty} Successful response
		 */
		Vision_projects_locations_productSets_removeProduct(name: string, requestBody: RemoveProductFromProductSetRequest): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':removeProduct', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {BatchAnnotateFilesResponse} Successful response
		 */
		Vision_projects_locations_files_annotate(parent: string, requestBody: BatchAnnotateFilesRequest): Observable<BatchAnnotateFilesResponse> {
			return this.http.post<BatchAnnotateFilesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/files:annotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Vision_projects_locations_files_asyncBatchAnnotate(parent: string, requestBody: AsyncBatchAnnotateFilesRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/files:asyncBatchAnnotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {BatchAnnotateImagesResponse} Successful response
		 */
		Vision_projects_locations_images_annotate(parent: string, requestBody: BatchAnnotateImagesRequest): Observable<BatchAnnotateImagesResponse> {
			return this.http.post<BatchAnnotateImagesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/images:annotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Vision_projects_locations_images_asyncBatchAnnotate(parent: string, requestBody: AsyncBatchAnnotateImagesRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/images:asyncBatchAnnotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Vision_projects_locations_productSets_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListProductSetsResponse> {
			return this.http.get<ListProductSetsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/productSets&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {ProductSet} Successful response
		 */
		Vision_projects_locations_productSets_create(parent: string, productSetId: string | null | undefined, requestBody: ProductSet): Observable<ProductSet> {
			return this.http.post<ProductSet>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/productSets&productSetId=' + (productSetId == null ? '' : encodeURIComponent(productSetId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Vision_projects_locations_productSets_import(parent: string, requestBody: ImportProductSetsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/productSets:import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Vision_projects_locations_products_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListProductsResponse> {
			return this.http.get<ListProductsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/products&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Vision_projects_locations_products_create(parent: string, productId: string | null | undefined, requestBody: Product): Observable<Product> {
			return this.http.post<Product>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/products&productId=' + (productId == null ? '' : encodeURIComponent(productId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Vision_projects_locations_products_purge(parent: string, requestBody: PurgeProductsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/products:purge', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Vision_projects_locations_products_referenceImages_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListReferenceImagesResponse> {
			return this.http.get<ListReferenceImagesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/referenceImages&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {ReferenceImage} Successful response
		 */
		Vision_projects_locations_products_referenceImages_create(parent: string, referenceImageId: string | null | undefined, requestBody: ReferenceImage): Observable<ReferenceImage> {
			return this.http.post<ReferenceImage>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/referenceImages&referenceImageId=' + (referenceImageId == null ? '' : encodeURIComponent(referenceImageId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
