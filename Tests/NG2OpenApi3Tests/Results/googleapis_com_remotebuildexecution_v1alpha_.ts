...
export namespace MyNS {
	...
	export enum GoogleDevtoolsRemotebuildbotCommandEventsCmUsage { CONFIG_NONE = 0, CONFIG_MATCH = 1, CONFIG_MISMATCH = 2 }

	export enum GoogleDevtoolsRemotebuildbotCommandEventsOutputLocation { LOCATION_UNDEFINED = 0, LOCATION_NONE = 1, LOCATION_EXEC_ROOT_RELATIVE = 2, LOCATION_WORKING_DIR_RELATIVE = 3, LOCATION_EXEC_ROOT_AND_WORKING_DIR_RELATIVE = 4, LOCATION_EXEC_ROOT_RELATIVE_OUTPUT_OUTSIDE_WORKING_DIR = 5, LOCATION_EXEC_ROOT_AND_WORKING_DIR_RELATIVE_OUTPUT_OUTSIDE_WORKING_DIR = 6 }
	...
	export enum GoogleDevtoolsRemotebuildbotCommandStatusCode { OK = 0, INVALID_ARGUMENT = 1, DEADLINE_EXCEEDED = 2, NOT_FOUND = 3, PERMISSION_DENIED = 4, INTERNAL = 5, ABORTED = 6, FAILED_PRECONDITION = 7, CLEANUP_ERROR = 8, DOWNLOAD_INPUTS_ERROR = 9, UNKNOWN = 10, UPLOAD_OUTPUTS_ERROR = 11, UPLOAD_OUTPUTS_BYTES_LIMIT_EXCEEDED = 12, DOCKER_LOGIN_ERROR = 13, DOCKER_IMAGE_PULL_ERROR = 14, DOCKER_IMAGE_EXIST_ERROR = 15, DUPLICATE_INPUTS = 16, DOCKER_IMAGE_PERMISSION_DENIED = 17, DOCKER_IMAGE_NOT_FOUND = 18, WORKING_DIR_NOT_FOUND = 19, WORKING_DIR_NOT_IN_BASE_DIR = 20, DOCKER_UNAVAILABLE = 21, NO_CUDA_CAPABLE_DEVICE = 22, REMOTE_CAS_DOWNLOAD_ERROR = 23, REMOTE_CAS_UPLOAD_ERROR = 24, LOCAL_CASPROXY_NOT_RUNNING = 25, DOCKER_CREATE_CONTAINER_ERROR = 26, DOCKER_INVALID_ULIMIT = 27, DOCKER_UNKNOWN_RUNTIME = 28, DOCKER_UNKNOWN_CAPABILITY = 29, DOCKER_UNKNOWN_ERROR = 30, DOCKER_CREATE_COMPUTE_SYSTEM_ERROR = 31, DOCKER_PREPARELAYER_ERROR = 32, DOCKER_INCOMPATIBLE_OS_ERROR = 33, DOCKER_CREATE_RUNTIME_FILE_NOT_FOUND = 34, DOCKER_CREATE_RUNTIME_PERMISSION_DENIED = 35, DOCKER_CREATE_PROCESS_FILE_NOT_FOUND = 36, DOCKER_CREATE_COMPUTE_SYSTEM_INCORRECT_PARAMETER_ERROR = 37, DOCKER_TOO_MANY_SYMBOLIC_LINK_LEVELS = 38, LOCAL_CONTAINER_MANAGER_NOT_RUNNING = 39, DOCKER_IMAGE_VPCSC_PERMISSION_DENIED = 40, WORKING_DIR_NOT_RELATIVE = 41, DOCKER_MISSING_CONTAINER = 42, DOCKER_MISSING_BLOB_IN_IMAGE = 43, DOCKER_INVALID_VOLUME = 44, DOCKER_CREATE_RUNTIME_CANNOT_MOUNT_TO_PROC = 45, DOCKER_START_RUNTIME_FILE_NOT_FOUND = 46, DOCKER_CREATE_INVALID_LAYERCHAIN_JSON = 47, INCOMPATIBLE_CUDA_VERSION = 48, LOCAL_WORKER_MANAGER_NOT_RUNNING = 49, DOCKER_START_RUNTIME_FILE_FORMAT_ERROR = 50 }
	...
	export enum GoogleDevtoolsRemotebuildbotResourceUsageBotState { UNSPECIFIED = 0, IDLE = 1, BUSY = 2 }
	...
	export enum GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyActionHermeticity { ACTION_HERMETICITY_UNSPECIFIED = 0, ACTION_HERMETICITY_OFF = 1, ACTION_HERMETICITY_ENFORCED = 2, ACTION_HERMETICITY_BEST_EFFORT = 3 }

	export enum GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyActionIsolation { ACTION_ISOLATION_UNSPECIFIED = 0, ACTION_ISOLATION_OFF = 1, ACTION_ISOLATION_ENFORCED = 2 }
	...
	export enum GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeaturePolicy { POLICY_UNSPECIFIED = 0, ALLOWED = 1, FORBIDDEN = 2, RESTRICTED = 3 }

	export enum GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyLinuxExecution { LINUX_EXECUTION_UNSPECIFIED = 0, LINUX_EXECUTION_FORBIDDEN = 1, LINUX_EXECUTION_UNRESTRICTED = 2, LINUX_EXECUTION_HARDENED_GVISOR = 3, LINUX_EXECUTION_HARDENED_GVISOR_OR_TERMINAL = 4 }

	export enum GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyLinuxIsolation { LINUX_ISOLATION_UNSPECIFIED = 0, GVISOR = 1, OFF = 2 }

	export enum GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyMacExecution { MAC_EXECUTION_UNSPECIFIED = 0, MAC_EXECUTION_FORBIDDEN = 1 }

	export enum GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyVmVerification { VM_VERIFICATION_UNSPECIFIED = 0, VM_VERIFICATION_GCP_TOKEN = 1, VM_VERIFICATION_OFF = 2 }

	export enum GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyWindowsExecution { WINDOWS_EXECUTION_UNSPECIFIED = 0, WINDOWS_EXECUTION_FORBIDDEN = 1, WINDOWS_EXECUTION_UNRESTRICTED = 2, WINDOWS_EXECUTION_TERMINAL = 3 }
