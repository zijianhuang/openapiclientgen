...
export namespace MyNS {
	...
	export enum InstanceState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', CREATING = 'CREATING', RUNNING = 'RUNNING', FAILED = 'FAILED', DELETING = 'DELETING', UPGRADING = 'UPGRADING', RESTARTING = 'RESTARTING', UPDATING = 'UPDATING', AUTO_UPDATING = 'AUTO_UPDATING', AUTO_UPGRADING = 'AUTO_UPGRADING', DISABLED = 'DISABLED' }
	...
	export class MyClient {
		 ...
		 * @return {Operation} Successful response
		 */
		Datafusion_projects_locations_instances_upgrade(name: string, requestBody: UpgradeInstanceRequest): Observable<Operation> {
		...
		Datafusion_projects_locations_instances_dnsPeerings_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDnsPeeringsResponse> {
			return this.http.get<ListDnsPeeringsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsPeerings&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Datafusion_projects_locations_instances_dnsPeerings_create(parent: string, dnsPeeringId: string | null | undefined, requestBody: DnsPeering): Observable<DnsPeering> {
			return this.http.post<DnsPeering>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsPeerings&dnsPeeringId=' + (dnsPeeringId == null ? '' : encodeURIComponent(dnsPeeringId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {number} pageSize The maximum number of items to return.
		 * @param {string} pageToken The next_page_token value to use if there are additional results to retrieve for this list request.
		 * @param {Datafusion_projects_locations_instances_namespaces_listView} view By default, only basic information about a namespace is returned (e.g. name). When `NAMESPACE_VIEW_FULL` is specified, additional information associated with a namespace gets returned (e.g. IAM policy set on the namespace)
		 * @return {ListNamespacesResponse} Successful response
		 */
		Datafusion_projects_locations_instances_namespaces_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Datafusion_projects_locations_instances_namespaces_listView | null | undefined): Observable<ListNamespacesResponse> {
			return this.http.get<ListNamespacesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/namespaces&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Datafusion_projects_locations_versions_list(parent: string, latestPatchOnly: boolean | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAvailableVersionsResponse> {
			return this.http.get<ListAvailableVersionsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/versions&latestPatchOnly=' + latestPatchOnly + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Datafusion_projects_locations_instances_namespaces_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<Policy> {
		 ...
		 */
		Datafusion_projects_locations_removeIamPolicy(resource: string, requestBody: RemoveIamPolicyRequest): Observable<RemoveIamPolicyResponse> {
			return this.http.post<RemoveIamPolicyResponse>(this.baseUri + 'v1beta1/' + (resource == null ? '' : encodeURIComponent(resource)) + ':removeIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Policy} Successful response
		 */
		Datafusion_projects_locations_instances_namespaces_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
		 ...
		 */
		Datafusion_projects_locations_instances_namespaces_testIamPermissions(resource: string, requestBody: TestIamPermissionsRequest): Observable<TestIamPermissionsResponse> {
	...
	export enum Datafusion_projects_locations_instances_namespaces_listView { NAMESPACE_VIEW_UNSPECIFIED = 'NAMESPACE_VIEW_UNSPECIFIED', NAMESPACE_VIEW_BASIC = 'NAMESPACE_VIEW_BASIC', NAMESPACE_VIEW_FULL = 'NAMESPACE_VIEW_FULL' }
