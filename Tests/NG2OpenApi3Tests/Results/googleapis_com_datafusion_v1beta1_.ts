...
export namespace MyNS {
	...
	export enum InstanceState { STATE_UNSPECIFIED = 0, CREATING = 1, RUNNING = 2, FAILED = 3, DELETING = 4, UPGRADING = 5, RESTARTING = 6, UPDATING = 7, AUTO_UPDATING = 8, AUTO_UPGRADING = 9, DISABLED = 10 }
	...
	export enum Datafusion_projects_locations_instances_namespaces_listView { NAMESPACE_VIEW_UNSPECIFIED = 0, NAMESPACE_VIEW_BASIC = 1, NAMESPACE_VIEW_FULL = 2 }
