...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {SocerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Socer(requestBody: SocerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'socer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface SocerPostBody {
		certificateParameters?: SocerPostBodyCertificateParameters;
	...
	export interface SocerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<SocerPostBodyFormat | null | undefined>,
	...
	export function CreateSocerPostBodyFormGroup() {
		return new FormGroup<SocerPostBodyFormProperties>({
			format: new FormControl<SocerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface SocerPostBodyCertificateParameters {
	...
	export interface SocerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		TypOfCert: FormControl<string | null | undefined>,
	}
	export function CreateSocerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SocerPostBodyCertificateParametersFormProperties>({
			...
			TypOfCert: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum SocerPostBodyFormat { pdf = 'pdf' }
