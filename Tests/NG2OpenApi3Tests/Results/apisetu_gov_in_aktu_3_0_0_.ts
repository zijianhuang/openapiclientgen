...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {DgcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Dgcer(requestBody: DgcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'dgcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {DgmstPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Dgmst(requestBody: DgmstPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'dgmst/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface DgcerPostBody {
		certificateParameters?: DgcerPostBodyCertificateParameters;
	...
	export interface DgcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<DgcerPostBodyFormat | null | undefined>,
	...
	export function CreateDgcerPostBodyFormGroup() {
		return new FormGroup<DgcerPostBodyFormProperties>({
			format: new FormControl<DgcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface DgcerPostBodyCertificateParameters {
	...
	export interface DgcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		EnrollmentNo: FormControl<string | null | undefined>,
	...
	export function CreateDgcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<DgcerPostBodyCertificateParametersFormProperties>({
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			EnrollmentNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export interface DgmstPostBodyFormProperties {
	...
	export function CreateDgmstPostBodyFormGroup() {
		return new FormGroup<DgmstPostBodyFormProperties>({
			format: new FormControl<DgcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface DgmstPostBodyCertificateParameters {
	...
	export interface DgmstPostBodyCertificateParametersFormProperties {
	...
	export function CreateDgmstPostBodyCertificateParametersFormGroup() {
		return new FormGroup<DgmstPostBodyCertificateParametersFormProperties>({
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			EnrollmentNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			RollNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
