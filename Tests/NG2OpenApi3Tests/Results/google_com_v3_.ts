...
export namespace MyNS {
	...
	export enum AccountLinkStatus { ACCOUNT_LINK_STATUS_UNSPECIFIED = 0, ACCOUNT_LINK_STATUS_UNKNOWN = 1, REQUESTED_FROM_HOTEL_CENTER = 2, REQUESTED_FROM_GOOGLE_ADS = 3, APPROVED = 4 }
	...
	export enum DisplayNameDisapprovalReasonDisapprovalReason { DISAPPROVAL_REASON_UNSPECIFIED = 0, PUNCTUATION = 1, MARKETING_LANGUAGE = 2, LANDING_PAGE_NOT_MATCHED = 3 }

	export enum BrandDisplayNameState { REVIEW_STATE_UNSPECIFIED = 0, REVIEW_STATE_NEW = 1, APPROVED = 2, REJECTED = 3 }
	...
	export enum DataIssueDetailDataIssueSeverity { DATA_ISSUE_SEVERITY_UNSPECIFIED = 0, ERROR = 1, WARNING = 2, INFO = 3 }

	export enum DataIssueDetailDataIssueType { FEED_DATA_ISSUE_UNSPECIFIED = 0, FEED_DATA_ISSUE_UNKNOWN = 1, NO_DATA_ISSUE = 2, DUPLICATE_ADDRESS = 3, MISSING_PHYSICAL_STREET_ADDRESS = 4, MISSING_STREET_NAME = 5, MISSING_STREET_NUMBER = 6, MISSING_ADDRESS = 7, MISSING_COUNTRY = 8, INVALID_POSTAL_CODE = 9, INVALID_POSTAL_CODE_SUFFIX = 10, UNEXPECTED_POSTAL_CODE_SUFFIX = 11, UNEXPECTED_POSTAL_CODE = 12, INVALID_AMENITIES = 13, INVALID_EMAIL_ADDRESS = 14, DUPLICATE_LATLONG = 15, LATLONG_INCONSISTENT_WITH_ADDRESS = 16, MISSING_LATLONG = 17, COULD_NOT_GEOCODE = 18, MISSING_HOTEL_NAME = 19, HOTEL_NAME_EMPTY = 20, INVALID_HOTEL_NAME = 21, HOTEL_NAME_TOO_LONG = 22, PARSE_ERROR_IN_XML = 23, UNEXPECTED_ATTRIBUTE_IN_XML = 24, DUPLICATE_PHONE_NUMBER = 25, MISSING_PHONE_NUMBER = 26, MISSING_VOICE_PHONE_NUMBER = 27, INVALID_PHONE_NUMBER_FORMAT = 28, INVALID_PHONE_NUMBER = 29, INVALID_PHONE_NUMBER_COUNTRY_CODE = 30, PHONE_NUMBER_TOO_LONG = 31, PHONE_NUMBER_TOO_SHORT = 32, INVALID_WEBSITE_URL = 33, ADWORDS_ATTRIBUTE_TOO_LONG = 34, BRAND_NOT_ALLOWED = 35, FLAGGED_DUE_TO_SUSPICIOUS_METADATA = 36, NOT_ENOUGH_IMAGES_PROVIDED = 37, IMAGE_PROCESSING_IN_PROGRESS = 38, CANNOT_FETCH_IMAGES = 39, INCOMPATIBLE_IMAGE_SIZE_OR_LOW_QUALITY = 40, MISSING_LANG_IN_RAW_LISTING = 41, IS_HOTEL = 42, MISSING_REQ_ATTR = 43, MISSING_NAME = 44, MISSING_LANG_IN_NAME = 45, VR_NAME_TOO_LONG = 46, TEST_PROPERTY = 47, NON_VR_ACCOMMODATION_TYPE_BASED_ON_LISTING_NAME = 48, BRAND_NAME_TOO_LONG = 49, MISSING_BRAND_NAME = 50, INVALID_REVIEW_RATING = 51, INVALID_CHECKIN_FORMAT = 52, INVALID_CHECKOUT_FORMAT = 53 }
	...
	export enum FreeBookingLinksResultDeviceType { DEVICE_UNSPECIFIED = 0, DEVICE_UNKNOWN = 1, DESKTOP = 2, MOBILE = 3, TABLET = 4 }
	...
	export enum HotelViewMatchStatus { MATCH_STATUS_UNSPECIFIED = 0, MATCH_STATUS_UNKNOWN = 1, NOT_MATCHED = 2, MATCHED = 3, MAP_OVERLAP = 4 }
	...
	export enum IconState { STATE_UNSPECIFIED = 0, NEW = 1, APPROVED = 2, REJECTED = 3 }
	...
	export enum PriceAccuracyRowMismatchReason { MISMATCH_REASON_UNSPECIFIED = 0, MISMATCH_REASON_UNKNOWN = 1, TAX_MISMATCH = 2, ROOM_UNAVAILABLE = 3, SITE_ERROR = 4, PRICE_FEED_DELAYED = 5, DISCOUNT_MISSING = 6, INCORRECT_DISCOUNT_VALUE = 7, WRONG_ITINERARY = 8 }

	export enum PriceAccuracyRowSignalSource { SIGNAL_SOURCE_UNSPECIFIED = 0, SIGNAL_SOURCE_UNKNOWN = 1, FETCHED = 2, PIXEL = 3 }
	...
	export enum PriceCoverageBucketAdvanceBookingWindowRange { ADVANCE_BOOKING_WINDOW_RANGE_UNSPECIFIED = 0, ADVANCE_BOOKING_WINDOW_RANGE_UNKNOWN = 1, DAYS_0_TO_30 = 2, DAYS_31_TO_60 = 3, DAYS_61_TO_90 = 4, DAYS_91_TO_120 = 5, DAYS_121_TO_150 = 6, DAYS_151_TO_180 = 7, DAYS_181_TO_210 = 8, DAYS_211_TO_240 = 9, DAYS_241_TO_270 = 10, DAYS_271_TO_300 = 11, DAYS_301_TO_330 = 12 }

	export enum PriceCoverageBucketLengthOfStayRange { LENGTH_OF_STAY_RANGE_UNSPECIFIED = 0, LENGTH_OF_STAY_RANGE_UNKNOWN = 1, LENGTH_OF_STAY_1_TO_7 = 2, LENGTH_OF_STAY_8_TO_14 = 3, LENGTH_OF_STAY_15_TO_30 = 4 }
	...
	export enum RatingType { TYPE_UNSPECIFIED = 0, OVERALL = 1 }

	export enum ReviewType { UNKNOWN = 0, EDITORIAL = 1, USER = 2 }
	...
	export enum PropertyPerformanceResultAdvanceBookingWindow { ADVANCE_BOOKING_WINDOW_UNSPECIFIED = 0, ADVANCE_BOOKING_WINDOW_SAME_DAY = 1, ADVANCE_BOOKING_WINDOW_NEXT_DAY = 2, ADVANCE_BOOKING_WINDOW_DAYS_2_TO_7 = 3, ADVANCE_BOOKING_WINDOW_DAYS_8_TO_14 = 4, ADVANCE_BOOKING_WINDOW_DAYS_15_TO_30 = 5, ADVANCE_BOOKING_WINDOW_DAYS_31_TO_60 = 6, ADVANCE_BOOKING_WINDOW_DAYS_61_TO_90 = 7, ADVANCE_BOOKING_WINDOW_DAYS_91_TO_120 = 8, ADVANCE_BOOKING_WINDOW_DAYS_121_TO_150 = 9, ADVANCE_BOOKING_WINDOW_DAYS_151_TO_180 = 10, ADVANCE_BOOKING_WINDOW_DAYS_OVER_180 = 11 }

	export enum PropertyPerformanceResultLengthOfStay { LENGTH_OF_STAY_UNSPECIFIED = 0, LENGTH_OF_STAY_NIGHTS_1 = 1, LENGTH_OF_STAY_NIGHTS_2 = 2, LENGTH_OF_STAY_NIGHTS_3 = 3, LENGTH_OF_STAY_NIGHTS_4_TO_7 = 4, LENGTH_OF_STAY_NIGHTS_8_TO_14 = 5, LENGTH_OF_STAY_NIGHTS_15_TO_21 = 6, LENGTH_OF_STAY_NIGHTS_22_TO_30 = 7, LENGTH_OF_STAY_NIGHTS_OVER_30 = 8 }

	export enum PropertyPerformanceResultOccupancy { OCCUPANCY_UNSPECIFIED = 0, OCCUPANCY_1 = 1, OCCUPANCY_2 = 2, OCCUPANCY_3 = 3, OCCUPANCY_4 = 4, OCCUPANCY_OVER_4 = 5 }
	...
	export enum SummarizePriceAccuracyResponseCurrentBookOnGoogleScore { PRICE_ACCURACY_STATE_UNSPECIFIED = 0, PRICE_ACCURACY_STATE_UNKNOWN = 1, EXCELLENT = 2, GOOD = 3, POOR = 4, AT_RISK = 5, FAILED = 6 }
