...
export namespace MyNS {
	...
	export enum YoutubeAdGroupAdGroupFormat { YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_UNSPECIFIED = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_UNSPECIFIED', YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM', YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_VIDEO_DISCOVERY = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_VIDEO_DISCOVERY', YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_BUMPER = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_BUMPER', YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM', YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_AUDIO = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_AUDIO', YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_ACTION = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_ACTION', YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_REACH = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_REACH', YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_MASTHEAD = 'YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_MASTHEAD' }
