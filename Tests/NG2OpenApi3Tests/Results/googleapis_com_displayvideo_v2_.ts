...
export namespace MyNS {
	...
	/** Request message for ManualTriggerService.ActivateManualTrigger. */
	export interface ActivateManualTriggerRequestFormProperties {
	}
	export function CreateActivateManualTriggerRequestFormGroup() {
		return new FormGroup<ActivateManualTriggerRequestFormProperties>({
		});
	...
	export enum ActiveViewVideoViewabilityMetricConfigMinimumDuration { VIDEO_DURATION_UNSPECIFIED = 0, VIDEO_DURATION_SECONDS_NONE = 1, VIDEO_DURATION_SECONDS_0 = 2, VIDEO_DURATION_SECONDS_1 = 3, VIDEO_DURATION_SECONDS_2 = 4, VIDEO_DURATION_SECONDS_3 = 5, VIDEO_DURATION_SECONDS_4 = 6, VIDEO_DURATION_SECONDS_5 = 7, VIDEO_DURATION_SECONDS_6 = 8, VIDEO_DURATION_SECONDS_7 = 9, VIDEO_DURATION_SECONDS_8 = 10, VIDEO_DURATION_SECONDS_9 = 11, VIDEO_DURATION_SECONDS_10 = 12, VIDEO_DURATION_SECONDS_11 = 13, VIDEO_DURATION_SECONDS_12 = 14, VIDEO_DURATION_SECONDS_13 = 15, VIDEO_DURATION_SECONDS_14 = 16, VIDEO_DURATION_SECONDS_15 = 17, VIDEO_DURATION_SECONDS_30 = 18, VIDEO_DURATION_SECONDS_45 = 19, VIDEO_DURATION_SECONDS_60 = 20 }

	export enum ActiveViewVideoViewabilityMetricConfigMinimumQuartile { VIDEO_DURATION_QUARTILE_UNSPECIFIED = 0, VIDEO_DURATION_QUARTILE_NONE = 1, VIDEO_DURATION_QUARTILE_FIRST = 2, VIDEO_DURATION_QUARTILE_SECOND = 3, VIDEO_DURATION_QUARTILE_THIRD = 4, VIDEO_DURATION_QUARTILE_FOURTH = 5 }

	export enum ActiveViewVideoViewabilityMetricConfigMinimumViewability { VIEWABILITY_PERCENT_UNSPECIFIED = 0, VIEWABILITY_PERCENT_0 = 1, VIEWABILITY_PERCENT_25 = 2, VIEWABILITY_PERCENT_50 = 3, VIEWABILITY_PERCENT_75 = 4, VIEWABILITY_PERCENT_100 = 5 }

	export enum ActiveViewVideoViewabilityMetricConfigMinimumVolume { VIDEO_VOLUME_PERCENT_UNSPECIFIED = 0, VIDEO_VOLUME_PERCENT_0 = 1, VIDEO_VOLUME_PERCENT_10 = 2 }
	...
	export enum AdUrlType { AD_URL_TYPE_UNSPECIFIED = 0, AD_URL_TYPE_BEACON_IMPRESSION = 1, AD_URL_TYPE_BEACON_EXPANDABLE_DCM_IMPRESSION = 2, AD_URL_TYPE_BEACON_CLICK = 3, AD_URL_TYPE_BEACON_SKIP = 4 }
	...
	export interface Advertiser {
		...
		entityStatus?: AdvertiserEntityStatus | null;
	...
	export interface AdvertiserFormProperties {
		...
		/** Required. Controls whether or not insertion orders and line items of the advertiser can spend their budgets and bid on inventory. * Accepted values are `ENTITY_STATUS_ACTIVE`, `ENTITY_STATUS_PAUSED` and `ENTITY_STATUS_SCHEDULED_FOR_DELETION`. * If set to `ENTITY_STATUS_SCHEDULED_FOR_DELETION`, the advertiser will be deleted 30 days from when it was first scheduled for deletion. */
		entityStatus: FormControl<AdvertiserEntityStatus | null | undefined>,
	...
	export function CreateAdvertiserFormGroup() {
		return new FormGroup<AdvertiserFormProperties>({
			...
			displayName: new FormControl<string | null | undefined>(undefined),
			entityStatus: new FormControl<AdvertiserEntityStatus | null | undefined>(undefined),
	...
	export enum SdfConfigVersion { SDF_VERSION_UNSPECIFIED = 0, SDF_VERSION_3_1 = 1, SDF_VERSION_4 = 2, SDF_VERSION_4_1 = 3, SDF_VERSION_4_2 = 4, SDF_VERSION_5 = 5, SDF_VERSION_5_1 = 6, SDF_VERSION_5_2 = 7, SDF_VERSION_5_3 = 8, SDF_VERSION_5_4 = 9, SDF_VERSION_5_5 = 10, SDF_VERSION_6 = 11, SDF_VERSION_7 = 12 }

	export enum AdvertiserEntityStatus { ENTITY_STATUS_UNSPECIFIED = 0, ENTITY_STATUS_ACTIVE = 1, ENTITY_STATUS_ARCHIVED = 2, ENTITY_STATUS_DRAFT = 3, ENTITY_STATUS_PAUSED = 4, ENTITY_STATUS_SCHEDULED_FOR_DELETION = 5 }
	...
	export enum AgeRangeAssignedTargetingOptionDetailsAgeRange { AGE_RANGE_UNSPECIFIED = 0, AGE_RANGE_18_24 = 1, AGE_RANGE_25_34 = 2, AGE_RANGE_35_44 = 3, AGE_RANGE_45_54 = 4, AGE_RANGE_55_64 = 5, AGE_RANGE_65_PLUS = 6, AGE_RANGE_UNKNOWN = 7, AGE_RANGE_18_20 = 8, AGE_RANGE_21_24 = 9, AGE_RANGE_25_29 = 10, AGE_RANGE_30_34 = 11, AGE_RANGE_35_39 = 12, AGE_RANGE_40_44 = 13, AGE_RANGE_45_49 = 14, AGE_RANGE_50_54 = 15, AGE_RANGE_55_59 = 16, AGE_RANGE_60_64 = 17 }
	...
	export enum AppAssignedTargetingOptionDetailsAppPlatform { APP_PLATFORM_UNSPECIFIED = 0, APP_PLATFORM_IOS = 1, APP_PLATFORM_ANDROID = 2, APP_PLATFORM_ROKU = 3, APP_PLATFORM_AMAZON_FIRETV = 4, APP_PLATFORM_PLAYSTATION = 5, APP_PLATFORM_APPLE_TV = 6, APP_PLATFORM_XBOX = 7, APP_PLATFORM_SAMSUNG_TV = 8, APP_PLATFORM_ANDROID_TV = 9, APP_PLATFORM_GENERIC_CTV = 10 }
	...
	export enum AssetAssociationRole { ASSET_ROLE_UNSPECIFIED = 0, ASSET_ROLE_MAIN = 1, ASSET_ROLE_BACKUP = 2, ASSET_ROLE_POLITE_LOAD = 3, ASSET_ROLE_HEADLINE = 4, ASSET_ROLE_LONG_HEADLINE = 5, ASSET_ROLE_BODY = 6, ASSET_ROLE_LONG_BODY = 7, ASSET_ROLE_CAPTION_URL = 8, ASSET_ROLE_CALL_TO_ACTION = 9, ASSET_ROLE_ADVERTISER_NAME = 10, ASSET_ROLE_PRICE = 11, ASSET_ROLE_ANDROID_APP_ID = 12, ASSET_ROLE_IOS_APP_ID = 13, ASSET_ROLE_RATING = 14, ASSET_ROLE_ICON = 15, ASSET_ROLE_COVER_IMAGE = 16 }
	...
	export enum FirstAndThirdPartyAudienceTargetingSettingRecency { RECENCY_NO_LIMIT = 0, RECENCY_1_MINUTE = 1, RECENCY_5_MINUTES = 2, RECENCY_10_MINUTES = 3, RECENCY_15_MINUTES = 4, RECENCY_30_MINUTES = 5, RECENCY_1_HOUR = 6, RECENCY_2_HOURS = 7, RECENCY_3_HOURS = 8, RECENCY_6_HOURS = 9, RECENCY_12_HOURS = 10, RECENCY_1_DAY = 11, RECENCY_2_DAYS = 12, RECENCY_3_DAYS = 13, RECENCY_5_DAYS = 14, RECENCY_7_DAYS = 15, RECENCY_10_DAYS = 16, RECENCY_14_DAYS = 17, RECENCY_15_DAYS = 18, RECENCY_21_DAYS = 19, RECENCY_28_DAYS = 20, RECENCY_30_DAYS = 21, RECENCY_40_DAYS = 22, RECENCY_45_DAYS = 23, RECENCY_60_DAYS = 24, RECENCY_90_DAYS = 25, RECENCY_120_DAYS = 26, RECENCY_180_DAYS = 27, RECENCY_270_DAYS = 28, RECENCY_365_DAYS = 29 }
	...
	export enum AudioContentTypeAssignedTargetingOptionDetailsAudioContentType { AUDIO_CONTENT_TYPE_UNSPECIFIED = 0, AUDIO_CONTENT_TYPE_UNKNOWN = 1, AUDIO_CONTENT_TYPE_MUSIC = 2, AUDIO_CONTENT_TYPE_BROADCAST = 3, AUDIO_CONTENT_TYPE_PODCAST = 4 }
	...
	export enum AuthorizedSellerStatusAssignedTargetingOptionDetailsAuthorizedSellerStatus { AUTHORIZED_SELLER_STATUS_UNSPECIFIED = 0, AUTHORIZED_SELLER_STATUS_AUTHORIZED_DIRECT_SELLERS_ONLY = 1, AUTHORIZED_SELLER_STATUS_AUTHORIZED_AND_NON_PARTICIPATING_PUBLISHERS = 2 }
	...
	export enum BusinessChainAssignedTargetingOptionDetailsProximityRadiusUnit { DISTANCE_UNIT_UNSPECIFIED = 0, DISTANCE_UNIT_MILES = 1, DISTANCE_UNIT_KILOMETERS = 2 }
	...
	export enum ContentDurationAssignedTargetingOptionDetailsContentDuration { CONTENT_DURATION_UNSPECIFIED = 0, CONTENT_DURATION_UNKNOWN = 1, CONTENT_DURATION_0_TO_1_MIN = 2, CONTENT_DURATION_1_TO_5_MIN = 3, CONTENT_DURATION_5_TO_15_MIN = 4, CONTENT_DURATION_15_TO_30_MIN = 5, CONTENT_DURATION_30_TO_60_MIN = 6, CONTENT_DURATION_OVER_60_MIN = 7 }
	...
	export enum ContentInstreamPositionAssignedTargetingOptionDetailsAdType { AD_TYPE_UNSPECIFIED = 0, AD_TYPE_DISPLAY = 1, AD_TYPE_VIDEO = 2, AD_TYPE_AUDIO = 3 }

	export enum ContentInstreamPositionAssignedTargetingOptionDetailsContentInstreamPosition { CONTENT_INSTREAM_POSITION_UNSPECIFIED = 0, CONTENT_INSTREAM_POSITION_PRE_ROLL = 1, CONTENT_INSTREAM_POSITION_MID_ROLL = 2, CONTENT_INSTREAM_POSITION_POST_ROLL = 3, CONTENT_INSTREAM_POSITION_UNKNOWN = 4 }
	...
	export enum ContentOutstreamPositionAssignedTargetingOptionDetailsContentOutstreamPosition { CONTENT_OUTSTREAM_POSITION_UNSPECIFIED = 0, CONTENT_OUTSTREAM_POSITION_UNKNOWN = 1, CONTENT_OUTSTREAM_POSITION_IN_ARTICLE = 2, CONTENT_OUTSTREAM_POSITION_IN_BANNER = 3, CONTENT_OUTSTREAM_POSITION_IN_FEED = 4, CONTENT_OUTSTREAM_POSITION_INTERSTITIAL = 5 }
	...
	export enum ContentStreamTypeAssignedTargetingOptionDetailsContentStreamType { CONTENT_STREAM_TYPE_UNSPECIFIED = 0, CONTENT_LIVE_STREAM = 1, CONTENT_ON_DEMAND = 2 }
	...
	export enum DayAndTimeAssignedTargetingOptionDetailsDayOfWeek { DAY_OF_WEEK_UNSPECIFIED = 0, MONDAY = 1, TUESDAY = 2, WEDNESDAY = 3, THURSDAY = 4, FRIDAY = 5, SATURDAY = 6, SUNDAY = 7 }

	export enum DayAndTimeAssignedTargetingOptionDetailsTimeZoneResolution { TIME_ZONE_RESOLUTION_UNSPECIFIED = 0, TIME_ZONE_RESOLUTION_END_USER = 1, TIME_ZONE_RESOLUTION_ADVERTISER = 2 }
	...
	export enum DeviceTypeAssignedTargetingOptionDetailsDeviceType { DEVICE_TYPE_UNSPECIFIED = 0, DEVICE_TYPE_COMPUTER = 1, DEVICE_TYPE_CONNECTED_TV = 2, DEVICE_TYPE_SMART_PHONE = 3, DEVICE_TYPE_TABLET = 4 }
	...
	export enum DigitalContentLabelAssignedTargetingOptionDetailsExcludedContentRatingTier { CONTENT_RATING_TIER_UNSPECIFIED = 0, CONTENT_RATING_TIER_UNRATED = 1, CONTENT_RATING_TIER_GENERAL = 2, CONTENT_RATING_TIER_PARENTAL_GUIDANCE = 3, CONTENT_RATING_TIER_TEENS = 4, CONTENT_RATING_TIER_MATURE = 5, CONTENT_RATING_TIER_FAMILIES = 6 }
	...
	export enum EnvironmentAssignedTargetingOptionDetailsEnvironment { ENVIRONMENT_UNSPECIFIED = 0, ENVIRONMENT_WEB_OPTIMIZED = 1, ENVIRONMENT_WEB_NOT_OPTIMIZED = 2, ENVIRONMENT_APP = 3 }
	...
	export enum ExchangeAssignedTargetingOptionDetailsExchange { EXCHANGE_UNSPECIFIED = 0, EXCHANGE_GOOGLE_AD_MANAGER = 1, EXCHANGE_APPNEXUS = 2, EXCHANGE_BRIGHTROLL = 3, EXCHANGE_ADFORM = 4, EXCHANGE_ADMETA = 5, EXCHANGE_ADMIXER = 6, EXCHANGE_ADSMOGO = 7, EXCHANGE_ADSWIZZ = 8, EXCHANGE_BIDSWITCH = 9, EXCHANGE_BRIGHTROLL_DISPLAY = 10, EXCHANGE_CADREON = 11, EXCHANGE_DAILYMOTION = 12, EXCHANGE_FIVE = 13, EXCHANGE_FLUCT = 14, EXCHANGE_FREEWHEEL = 15, EXCHANGE_GENIEE = 16, EXCHANGE_GUMGUM = 17, EXCHANGE_IMOBILE = 18, EXCHANGE_IBILLBOARD = 19, EXCHANGE_IMPROVE_DIGITAL = 20, EXCHANGE_INDEX = 21, EXCHANGE_KARGO = 22, EXCHANGE_MICROAD = 23, EXCHANGE_MOPUB = 24, EXCHANGE_NEND = 25, EXCHANGE_ONE_BY_AOL_DISPLAY = 26, EXCHANGE_ONE_BY_AOL_MOBILE = 27, EXCHANGE_ONE_BY_AOL_VIDEO = 28, EXCHANGE_OOYALA = 29, EXCHANGE_OPENX = 30, EXCHANGE_PERMODO = 31, EXCHANGE_PLATFORMONE = 32, EXCHANGE_PLATFORMID = 33, EXCHANGE_PUBMATIC = 34, EXCHANGE_PULSEPOINT = 35, EXCHANGE_REVENUEMAX = 36, EXCHANGE_RUBICON = 37, EXCHANGE_SMARTCLIP = 38, EXCHANGE_SMARTRTB = 39, EXCHANGE_SMARTSTREAMTV = 40, EXCHANGE_SOVRN = 41, EXCHANGE_SPOTXCHANGE = 42, EXCHANGE_STROER = 43, EXCHANGE_TEADSTV = 44, EXCHANGE_TELARIA = 45, EXCHANGE_TVN = 46, EXCHANGE_UNITED = 47, EXCHANGE_YIELDLAB = 48, EXCHANGE_YIELDMO = 49, EXCHANGE_UNRULYX = 50, EXCHANGE_OPEN8 = 51, EXCHANGE_TRITON = 52, EXCHANGE_TRIPLELIFT = 53, EXCHANGE_TABOOLA = 54, EXCHANGE_INMOBI = 55, EXCHANGE_SMAATO = 56, EXCHANGE_AJA = 57, EXCHANGE_SUPERSHIP = 58, EXCHANGE_NEXSTAR_DIGITAL = 59, EXCHANGE_WAZE = 60, EXCHANGE_SOUNDCAST = 61, EXCHANGE_SHARETHROUGH = 62, EXCHANGE_FYBER = 63, EXCHANGE_RED_FOR_PUBLISHERS = 64, EXCHANGE_MEDIANET = 65, EXCHANGE_TAPJOY = 66, EXCHANGE_VISTAR = 67, EXCHANGE_DAX = 68, EXCHANGE_JCD = 69, EXCHANGE_PLACE_EXCHANGE = 70, EXCHANGE_APPLOVIN = 71, EXCHANGE_CONNATIX = 72, EXCHANGE_RESET_DIGITAL = 73, EXCHANGE_HIVESTACK = 74 }
	...
	export enum GenderAssignedTargetingOptionDetailsGender { GENDER_UNSPECIFIED = 0, GENDER_MALE = 1, GENDER_FEMALE = 2, GENDER_UNKNOWN = 3 }
	...
	export enum GeoRegionAssignedTargetingOptionDetailsGeoRegionType { GEO_REGION_TYPE_UNKNOWN = 0, GEO_REGION_TYPE_OTHER = 1, GEO_REGION_TYPE_COUNTRY = 2, GEO_REGION_TYPE_REGION = 3, GEO_REGION_TYPE_TERRITORY = 4, GEO_REGION_TYPE_PROVINCE = 5, GEO_REGION_TYPE_STATE = 6, GEO_REGION_TYPE_PREFECTURE = 7, GEO_REGION_TYPE_GOVERNORATE = 8, GEO_REGION_TYPE_CANTON = 9, GEO_REGION_TYPE_UNION_TERRITORY = 10, GEO_REGION_TYPE_AUTONOMOUS_COMMUNITY = 11, GEO_REGION_TYPE_DMA_REGION = 12, GEO_REGION_TYPE_METRO = 13, GEO_REGION_TYPE_CONGRESSIONAL_DISTRICT = 14, GEO_REGION_TYPE_COUNTY = 15, GEO_REGION_TYPE_MUNICIPALITY = 16, GEO_REGION_TYPE_CITY = 17, GEO_REGION_TYPE_POSTAL_CODE = 18, GEO_REGION_TYPE_DEPARTMENT = 19, GEO_REGION_TYPE_AIRPORT = 20, GEO_REGION_TYPE_TV_REGION = 21, GEO_REGION_TYPE_OKRUG = 22, GEO_REGION_TYPE_BOROUGH = 23, GEO_REGION_TYPE_CITY_REGION = 24, GEO_REGION_TYPE_ARRONDISSEMENT = 25, GEO_REGION_TYPE_NEIGHBORHOOD = 26, GEO_REGION_TYPE_UNIVERSITY = 27, GEO_REGION_TYPE_DISTRICT = 28 }
	...
	export enum HouseholdIncomeAssignedTargetingOptionDetailsHouseholdIncome { HOUSEHOLD_INCOME_UNSPECIFIED = 0, HOUSEHOLD_INCOME_UNKNOWN = 1, HOUSEHOLD_INCOME_LOWER_50_PERCENT = 2, HOUSEHOLD_INCOME_TOP_41_TO_50_PERCENT = 3, HOUSEHOLD_INCOME_TOP_31_TO_40_PERCENT = 4, HOUSEHOLD_INCOME_TOP_21_TO_30_PERCENT = 5, HOUSEHOLD_INCOME_TOP_11_TO_20_PERCENT = 6, HOUSEHOLD_INCOME_TOP_10_PERCENT = 7 }

	export enum AssignedTargetingOptionInheritance { INHERITANCE_UNSPECIFIED = 0, NOT_INHERITED = 1, INHERITED_FROM_PARTNER = 2, INHERITED_FROM_ADVERTISER = 3 }
	...
	export enum NativeContentPositionAssignedTargetingOptionDetailsContentPosition { NATIVE_CONTENT_POSITION_UNSPECIFIED = 0, NATIVE_CONTENT_POSITION_UNKNOWN = 1, NATIVE_CONTENT_POSITION_IN_ARTICLE = 2, NATIVE_CONTENT_POSITION_IN_FEED = 3, NATIVE_CONTENT_POSITION_PERIPHERAL = 4, NATIVE_CONTENT_POSITION_RECOMMENDATION = 5 }
	...
	export enum OmidAssignedTargetingOptionDetailsOmid { OMID_UNSPECIFIED = 0, OMID_FOR_MOBILE_DISPLAY_ADS = 1 }
	...
	export enum OnScreenPositionAssignedTargetingOptionDetailsOnScreenPosition { ON_SCREEN_POSITION_UNSPECIFIED = 0, ON_SCREEN_POSITION_UNKNOWN = 1, ON_SCREEN_POSITION_ABOVE_THE_FOLD = 2, ON_SCREEN_POSITION_BELOW_THE_FOLD = 3 }
	...
	export enum ParentalStatusAssignedTargetingOptionDetailsParentalStatus { PARENTAL_STATUS_UNSPECIFIED = 0, PARENTAL_STATUS_PARENT = 1, PARENTAL_STATUS_NOT_A_PARENT = 2, PARENTAL_STATUS_UNKNOWN = 3 }
	...
	export enum ProximityLocationListAssignedTargetingOptionDetailsProximityRadiusUnit { PROXIMITY_RADIUS_UNIT_UNSPECIFIED = 0, PROXIMITY_RADIUS_UNIT_MILES = 1, PROXIMITY_RADIUS_UNIT_KILOMETERS = 2 }
	...
	export enum SensitiveCategoryAssignedTargetingOptionDetailsExcludedSensitiveCategory { SENSITIVE_CATEGORY_UNSPECIFIED = 0, SENSITIVE_CATEGORY_ADULT = 1, SENSITIVE_CATEGORY_DEROGATORY = 2, SENSITIVE_CATEGORY_DOWNLOADS_SHARING = 3, SENSITIVE_CATEGORY_WEAPONS = 4, SENSITIVE_CATEGORY_GAMBLING = 5, SENSITIVE_CATEGORY_VIOLENCE = 6, SENSITIVE_CATEGORY_SUGGESTIVE = 7, SENSITIVE_CATEGORY_PROFANITY = 8, SENSITIVE_CATEGORY_ALCOHOL = 9, SENSITIVE_CATEGORY_DRUGS = 10, SENSITIVE_CATEGORY_TOBACCO = 11, SENSITIVE_CATEGORY_POLITICS = 12, SENSITIVE_CATEGORY_RELIGION = 13, SENSITIVE_CATEGORY_TRAGEDY = 14, SENSITIVE_CATEGORY_TRANSPORTATION_ACCIDENTS = 15, SENSITIVE_CATEGORY_SENSITIVE_SOCIAL_ISSUES = 16, SENSITIVE_CATEGORY_SHOCKING = 17, SENSITIVE_CATEGORY_EMBEDDED_VIDEO = 18, SENSITIVE_CATEGORY_LIVE_STREAMING_VIDEO = 19 }
	...
	export enum SessionPositionAssignedTargetingOptionDetailsSessionPosition { SESSION_POSITION_UNSPECIFIED = 0, SESSION_POSITION_FIRST_IMPRESSION = 1 }
	...
	export enum AssignedTargetingOptionTargetingType { TARGETING_TYPE_UNSPECIFIED = 0, TARGETING_TYPE_CHANNEL = 1, TARGETING_TYPE_APP_CATEGORY = 2, TARGETING_TYPE_APP = 3, TARGETING_TYPE_URL = 4, TARGETING_TYPE_DAY_AND_TIME = 5, TARGETING_TYPE_AGE_RANGE = 6, TARGETING_TYPE_REGIONAL_LOCATION_LIST = 7, TARGETING_TYPE_PROXIMITY_LOCATION_LIST = 8, TARGETING_TYPE_GENDER = 9, TARGETING_TYPE_VIDEO_PLAYER_SIZE = 10, TARGETING_TYPE_USER_REWARDED_CONTENT = 11, TARGETING_TYPE_PARENTAL_STATUS = 12, TARGETING_TYPE_CONTENT_INSTREAM_POSITION = 13, TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION = 14, TARGETING_TYPE_DEVICE_TYPE = 15, TARGETING_TYPE_AUDIENCE_GROUP = 16, TARGETING_TYPE_BROWSER = 17, TARGETING_TYPE_HOUSEHOLD_INCOME = 18, TARGETING_TYPE_ON_SCREEN_POSITION = 19, TARGETING_TYPE_THIRD_PARTY_VERIFIER = 20, TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION = 21, TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION = 22, TARGETING_TYPE_ENVIRONMENT = 23, TARGETING_TYPE_CARRIER_AND_ISP = 24, TARGETING_TYPE_OPERATING_SYSTEM = 25, TARGETING_TYPE_DEVICE_MAKE_MODEL = 26, TARGETING_TYPE_KEYWORD = 27, TARGETING_TYPE_NEGATIVE_KEYWORD_LIST = 28, TARGETING_TYPE_VIEWABILITY = 29, TARGETING_TYPE_CATEGORY = 30, TARGETING_TYPE_INVENTORY_SOURCE = 31, TARGETING_TYPE_LANGUAGE = 32, TARGETING_TYPE_AUTHORIZED_SELLER_STATUS = 33, TARGETING_TYPE_GEO_REGION = 34, TARGETING_TYPE_INVENTORY_SOURCE_GROUP = 35, TARGETING_TYPE_EXCHANGE = 36, TARGETING_TYPE_SUB_EXCHANGE = 37, TARGETING_TYPE_POI = 38, TARGETING_TYPE_BUSINESS_CHAIN = 39, TARGETING_TYPE_CONTENT_DURATION = 40, TARGETING_TYPE_CONTENT_STREAM_TYPE = 41, TARGETING_TYPE_NATIVE_CONTENT_POSITION = 42, TARGETING_TYPE_OMID = 43, TARGETING_TYPE_AUDIO_CONTENT_TYPE = 44, TARGETING_TYPE_CONTENT_GENRE = 45, TARGETING_TYPE_YOUTUBE_VIDEO = 46, TARGETING_TYPE_YOUTUBE_CHANNEL = 47, TARGETING_TYPE_SESSION_POSITION = 48 }
	...
	export enum DoubleVerifyAppStarRatingAvoidedStarRating { APP_STAR_RATE_UNSPECIFIED = 0, APP_STAR_RATE_1_POINT_5_LESS = 1, APP_STAR_RATE_2_LESS = 2, APP_STAR_RATE_2_POINT_5_LESS = 3, APP_STAR_RATE_3_LESS = 4, APP_STAR_RATE_3_POINT_5_LESS = 5, APP_STAR_RATE_4_LESS = 6, APP_STAR_RATE_4_POINT_5_LESS = 7 }
	...
	export enum DoubleVerifyDisplayViewabilityIab { IAB_VIEWED_RATE_UNSPECIFIED = 0, IAB_VIEWED_RATE_80_PERCENT_HIGHER = 1, IAB_VIEWED_RATE_75_PERCENT_HIGHER = 2, IAB_VIEWED_RATE_70_PERCENT_HIGHER = 3, IAB_VIEWED_RATE_65_PERCENT_HIGHER = 4, IAB_VIEWED_RATE_60_PERCENT_HIGHER = 5, IAB_VIEWED_RATE_55_PERCENT_HIGHER = 6, IAB_VIEWED_RATE_50_PERCENT_HIGHER = 7, IAB_VIEWED_RATE_40_PERCENT_HIGHER = 8, IAB_VIEWED_RATE_30_PERCENT_HIGHER = 9 }

	export enum DoubleVerifyDisplayViewabilityViewableDuring { AVERAGE_VIEW_DURATION_UNSPECIFIED = 0, AVERAGE_VIEW_DURATION_5_SEC = 1, AVERAGE_VIEW_DURATION_10_SEC = 2, AVERAGE_VIEW_DURATION_15_SEC = 3 }
	...
	export enum DoubleVerifyFraudInvalidTrafficAvoidedFraudOption { FRAUD_UNSPECIFIED = 0, AD_IMPRESSION_FRAUD_100 = 1, AD_IMPRESSION_FRAUD_50 = 2, AD_IMPRESSION_FRAUD_25 = 3, AD_IMPRESSION_FRAUD_10 = 4, AD_IMPRESSION_FRAUD_8 = 5, AD_IMPRESSION_FRAUD_6 = 6, AD_IMPRESSION_FRAUD_4 = 7, AD_IMPRESSION_FRAUD_2 = 8 }
	...
	export enum DoubleVerifyVideoViewabilityPlayerImpressionRate { PLAYER_SIZE_400X300_UNSPECIFIED = 0, PLAYER_SIZE_400X300_95 = 1, PLAYER_SIZE_400X300_70 = 2, PLAYER_SIZE_400X300_25 = 3, PLAYER_SIZE_400X300_5 = 4 }

	export enum DoubleVerifyVideoViewabilityVideoIab { VIDEO_IAB_UNSPECIFIED = 0, IAB_VIEWABILITY_80_PERCENT_HIGHER = 1, IAB_VIEWABILITY_75_PERCENT_HIGHER = 2, IAB_VIEWABILITY_70_PERCENT_HIGHER = 3, IAB_VIEWABILITY_65_PERCENT_HIHGER = 4, IAB_VIEWABILITY_60_PERCENT_HIGHER = 5, IAB_VIEWABILITY_55_PERCENT_HIHGER = 6, IAB_VIEWABILITY_50_PERCENT_HIGHER = 7, IAB_VIEWABILITY_40_PERCENT_HIHGER = 8, IAB_VIEWABILITY_30_PERCENT_HIHGER = 9 }

	export enum DoubleVerifyVideoViewabilityVideoViewableRate { VIDEO_VIEWABLE_RATE_UNSPECIFIED = 0, VIEWED_PERFORMANCE_40_PERCENT_HIGHER = 1, VIEWED_PERFORMANCE_35_PERCENT_HIGHER = 2, VIEWED_PERFORMANCE_30_PERCENT_HIGHER = 3, VIEWED_PERFORMANCE_25_PERCENT_HIGHER = 4, VIEWED_PERFORMANCE_20_PERCENT_HIGHER = 5, VIEWED_PERFORMANCE_10_PERCENT_HIGHER = 6 }
	...
	export enum IntegralAdScienceDisplayViewability { PERFORMANCE_VIEWABILITY_UNSPECIFIED = 0, PERFORMANCE_VIEWABILITY_40 = 1, PERFORMANCE_VIEWABILITY_50 = 2, PERFORMANCE_VIEWABILITY_60 = 3, PERFORMANCE_VIEWABILITY_70 = 4 }

	export enum IntegralAdScienceExcludedAdFraudRisk { SUSPICIOUS_ACTIVITY_UNSPECIFIED = 0, SUSPICIOUS_ACTIVITY_HR = 1, SUSPICIOUS_ACTIVITY_HMR = 2 }

	export enum IntegralAdScienceExcludedAdultRisk { ADULT_UNSPECIFIED = 0, ADULT_HR = 1, ADULT_HMR = 2 }

	export enum IntegralAdScienceExcludedAlcoholRisk { ALCOHOL_UNSPECIFIED = 0, ALCOHOL_HR = 1, ALCOHOL_HMR = 2 }

	export enum IntegralAdScienceExcludedDrugsRisk { DRUGS_UNSPECIFIED = 0, DRUGS_HR = 1, DRUGS_HMR = 2 }

	export enum IntegralAdScienceExcludedGamblingRisk { GAMBLING_UNSPECIFIED = 0, GAMBLING_HR = 1, GAMBLING_HMR = 2 }

	export enum IntegralAdScienceExcludedHateSpeechRisk { HATE_SPEECH_UNSPECIFIED = 0, HATE_SPEECH_HR = 1, HATE_SPEECH_HMR = 2 }

	export enum IntegralAdScienceExcludedIllegalDownloadsRisk { ILLEGAL_DOWNLOADS_UNSPECIFIED = 0, ILLEGAL_DOWNLOADS_HR = 1, ILLEGAL_DOWNLOADS_HMR = 2 }

	export enum IntegralAdScienceExcludedOffensiveLanguageRisk { OFFENSIVE_LANGUAGE_UNSPECIFIED = 0, OFFENSIVE_LANGUAGE_HR = 1, OFFENSIVE_LANGUAGE_HMR = 2 }

	export enum IntegralAdScienceExcludedViolenceRisk { VIOLENCE_UNSPECIFIED = 0, VIOLENCE_HR = 1, VIOLENCE_HMR = 2 }

	export enum IntegralAdScienceTraqScoreOption { TRAQ_UNSPECIFIED = 0, TRAQ_250 = 1, TRAQ_500 = 2, TRAQ_600 = 3, TRAQ_700 = 4, TRAQ_750 = 5, TRAQ_875 = 6, TRAQ_1000 = 7 }

	export enum IntegralAdScienceVideoViewability { VIDEO_VIEWABILITY_UNSPECIFIED = 0, VIDEO_VIEWABILITY_40 = 1, VIDEO_VIEWABILITY_50 = 2, VIDEO_VIEWABILITY_60 = 3, VIDEO_VIEWABILITY_70 = 4 }
	...
	export enum UserRewardedContentAssignedTargetingOptionDetailsUserRewardedContent { USER_REWARDED_CONTENT_UNSPECIFIED = 0, USER_REWARDED_CONTENT_USER_REWARDED = 1, USER_REWARDED_CONTENT_NOT_USER_REWARDED = 2 }
	...
	export enum VideoPlayerSizeAssignedTargetingOptionDetailsVideoPlayerSize { VIDEO_PLAYER_SIZE_UNSPECIFIED = 0, VIDEO_PLAYER_SIZE_SMALL = 1, VIDEO_PLAYER_SIZE_LARGE = 2, VIDEO_PLAYER_SIZE_HD = 3, VIDEO_PLAYER_SIZE_UNKNOWN = 4 }
	...
	export enum ViewabilityAssignedTargetingOptionDetailsViewability { VIEWABILITY_UNSPECIFIED = 0, VIEWABILITY_10_PERCENT_OR_MORE = 1, VIEWABILITY_20_PERCENT_OR_MORE = 2, VIEWABILITY_30_PERCENT_OR_MORE = 3, VIEWABILITY_40_PERCENT_OR_MORE = 4, VIEWABILITY_50_PERCENT_OR_MORE = 5, VIEWABILITY_60_PERCENT_OR_MORE = 6, VIEWABILITY_70_PERCENT_OR_MORE = 7, VIEWABILITY_80_PERCENT_OR_MORE = 8, VIEWABILITY_90_PERCENT_OR_MORE = 9 }
	...
	export enum AssignedUserRoleUserRole { USER_ROLE_UNSPECIFIED = 0, ADMIN = 1, ADMIN_PARTNER_CLIENT = 2, STANDARD = 3, STANDARD_PLANNER = 4, STANDARD_PLANNER_LIMITED = 5, STANDARD_PARTNER_CLIENT = 6, READ_ONLY = 7, REPORTING_ONLY = 8, LIMITED_REPORTING_ONLY = 9, CREATIVE = 10, CREATIVE_ADMIN = 11 }
	...
	export enum YoutubeVideoDetailsUnavailableReason { VIDEO_UNAVAILABLE_REASON_UNSPECIFIED = 0, VIDEO_UNAVAILABLE_REASON_PRIVATE = 1, VIDEO_UNAVAILABLE_REASON_DELETED = 2 }
	...
	export enum MaximizeSpendBidStrategyPerformanceGoalType { BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_UNSPECIFIED = 0, BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_CPA = 1, BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_CPC = 2, BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_VIEWABLE_CPM = 3, BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_CUSTOM_ALGO = 4, BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_CIVA = 5, BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_IVO_TEN = 6, BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_AV_VIEWED = 7 }
	...
	/** Wrapper object associating an AssignedTargetingOption resource and the youtube ad group it is assigned to. */
	export interface YoutubeAdGroupAssignedTargetingOptionFormProperties {

		/** The ID of the youtube ad group the assigned targeting option is assigned to. */
		youtubeAdGroupId: FormControl<string | null | undefined>,
	}
	export function CreateYoutubeAdGroupAssignedTargetingOptionFormGroup() {
		return new FormGroup<YoutubeAdGroupAssignedTargetingOptionFormProperties>({
			youtubeAdGroupId: new FormControl<string | null | undefined>(undefined),
		});
	...
	export enum LineItemBudgetBudgetAllocationType { LINE_ITEM_BUDGET_ALLOCATION_TYPE_UNSPECIFIED = 0, LINE_ITEM_BUDGET_ALLOCATION_TYPE_AUTOMATIC = 1, LINE_ITEM_BUDGET_ALLOCATION_TYPE_FIXED = 2, LINE_ITEM_BUDGET_ALLOCATION_TYPE_UNLIMITED = 3 }

	export enum LineItemBudgetBudgetUnit { BUDGET_UNIT_UNSPECIFIED = 0, BUDGET_UNIT_CURRENCY = 1, BUDGET_UNIT_IMPRESSIONS = 2 }
	...
	export enum LineItemFlightFlightDateType { LINE_ITEM_FLIGHT_DATE_TYPE_UNSPECIFIED = 0, LINE_ITEM_FLIGHT_DATE_TYPE_INHERITED = 1, LINE_ITEM_FLIGHT_DATE_TYPE_CUSTOM = 2 }
	...
	export enum FrequencyCapTimeUnit { TIME_UNIT_UNSPECIFIED = 0, TIME_UNIT_LIFETIME = 1, TIME_UNIT_MONTHS = 2, TIME_UNIT_WEEKS = 3, TIME_UNIT_DAYS = 4, TIME_UNIT_HOURS = 5, TIME_UNIT_MINUTES = 6 }

	export enum LineItemLineItemType { LINE_ITEM_TYPE_UNSPECIFIED = 0, LINE_ITEM_TYPE_DISPLAY_DEFAULT = 1, LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INSTALL = 2, LINE_ITEM_TYPE_VIDEO_DEFAULT = 3, LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INSTALL = 4, LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INVENTORY = 5, LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INVENTORY = 6, LINE_ITEM_TYPE_AUDIO_DEFAULT = 7, LINE_ITEM_TYPE_VIDEO_OVER_THE_TOP = 8, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_ACTION = 9, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_NON_SKIPPABLE = 10, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_VIDEO_SEQUENCE = 11, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_AUDIO = 12, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_REACH = 13, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_SIMPLE = 14, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_NON_SKIPPABLE_OVER_THE_TOP = 15, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_REACH_OVER_THE_TOP = 16, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_SIMPLE_OVER_THE_TOP = 17, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_TARGET_FREQUENCY = 18, LINE_ITEM_TYPE_YOUTUBE_AND_PARTNERS_VIEW = 19, LINE_ITEM_TYPE_DISPLAY_OUT_OF_HOME = 20, LINE_ITEM_TYPE_VIDEO_OUT_OF_HOME = 21 }
	...
	export enum MobileAppPlatform { PLATFORM_UNSPECIFIED = 0, IOS = 1, ANDROID = 2 }
	...
	export enum PacingPacingPeriod { PACING_PERIOD_UNSPECIFIED = 0, PACING_PERIOD_DAILY = 1, PACING_PERIOD_FLIGHT = 2 }

	export enum PacingPacingType { PACING_TYPE_UNSPECIFIED = 0, PACING_TYPE_AHEAD = 1, PACING_TYPE_ASAP = 2, PACING_TYPE_EVEN = 3 }
	...
	export enum PartnerCostCostType { PARTNER_COST_TYPE_UNSPECIFIED = 0, PARTNER_COST_TYPE_ADLOOX = 1, PARTNER_COST_TYPE_ADLOOX_PREBID = 2, PARTNER_COST_TYPE_ADSAFE = 3, PARTNER_COST_TYPE_ADXPOSE = 4, PARTNER_COST_TYPE_AGGREGATE_KNOWLEDGE = 5, PARTNER_COST_TYPE_AGENCY_TRADING_DESK = 6, PARTNER_COST_TYPE_DV360_FEE = 7, PARTNER_COST_TYPE_COMSCORE_VCE = 8, PARTNER_COST_TYPE_DATA_MANAGEMENT_PLATFORM = 9, PARTNER_COST_TYPE_DEFAULT = 10, PARTNER_COST_TYPE_DOUBLE_VERIFY = 11, PARTNER_COST_TYPE_DOUBLE_VERIFY_PREBID = 12, PARTNER_COST_TYPE_EVIDON = 13, PARTNER_COST_TYPE_INTEGRAL_AD_SCIENCE_VIDEO = 14, PARTNER_COST_TYPE_INTEGRAL_AD_SCIENCE_PREBID = 15, PARTNER_COST_TYPE_MEDIA_COST_DATA = 16, PARTNER_COST_TYPE_MOAT_VIDEO = 17, PARTNER_COST_TYPE_NIELSEN_DAR = 18, PARTNER_COST_TYPE_SHOP_LOCAL = 19, PARTNER_COST_TYPE_TERACENT = 20, PARTNER_COST_TYPE_THIRD_PARTY_AD_SERVER = 21, PARTNER_COST_TYPE_TRUST_METRICS = 22, PARTNER_COST_TYPE_VIZU = 23, PARTNER_COST_TYPE_ADLINGO_FEE = 24, PARTNER_COST_TYPE_CUSTOM_FEE_1 = 25, PARTNER_COST_TYPE_CUSTOM_FEE_2 = 26, PARTNER_COST_TYPE_CUSTOM_FEE_3 = 27, PARTNER_COST_TYPE_CUSTOM_FEE_4 = 28, PARTNER_COST_TYPE_CUSTOM_FEE_5 = 29, PARTNER_COST_TYPE_SCIBIDS_FEE = 30 }

	export enum PartnerCostFeeType { PARTNER_COST_FEE_TYPE_UNSPECIFIED = 0, PARTNER_COST_FEE_TYPE_CPM_FEE = 1, PARTNER_COST_FEE_TYPE_MEDIA_FEE = 2 }

	export enum PartnerCostInvoiceType { PARTNER_COST_INVOICE_TYPE_UNSPECIFIED = 0, PARTNER_COST_INVOICE_TYPE_DV360 = 1, PARTNER_COST_INVOICE_TYPE_PARTNER = 2 }
	...
	export enum PartnerRevenueModelMarkupType { PARTNER_REVENUE_MODEL_MARKUP_TYPE_UNSPECIFIED = 0, PARTNER_REVENUE_MODEL_MARKUP_TYPE_CPM = 1, PARTNER_REVENUE_MODEL_MARKUP_TYPE_MEDIA_COST_MARKUP = 2, PARTNER_REVENUE_MODEL_MARKUP_TYPE_TOTAL_MEDIA_COST_MARKUP = 3 }

	export enum LineItemReservationType { RESERVATION_TYPE_UNSPECIFIED = 0, RESERVATION_TYPE_NOT_GUARANTEED = 1, RESERVATION_TYPE_PROGRAMMATIC_GUARANTEED = 2, RESERVATION_TYPE_TAG_GUARANTEED = 3, RESERVATION_TYPE_PETRA_VIRAL = 4, RESERVATION_TYPE_INSTANT_RESERVE = 5 }
	...
	export interface TargetingExpansionConfig {
		...
		targetingExpansionLevel?: TargetingExpansionConfigTargetingExpansionLevel | null;
	}
	...
	export interface TargetingExpansionConfigFormProperties {
		...
		/** Whether to exclude first-party audiences from use in targeting expansion. This field was deprecated with the launch of [optimized targeting](//support.google.com/displayvideo/answer/12060859). This field will be set to `false`. If this field is set to `true` when deprecated, all positive first-party audience targeting assigned to this line item will be replaced with negative targeting of the same first-party audiences to ensure the continued exclusion of those audiences. */
		excludeFirstPartyAudience: FormControl<boolean | null | undefined>,

		/** Required. Whether optimized targeting is turned on. This field supports the following values: * `NO_EXPANSION`: optimized targeting is turned off * `LEAST_EXPANSION`: optimized targeting is turned on If this field is set to any other value, it will automatically be set to `LEAST_EXPANSION`. `NO_EXPANSION` will be the default value for the field and will be automatically assigned if you do not set the field. */
		targetingExpansionLevel: FormControl<TargetingExpansionConfigTargetingExpansionLevel | null | undefined>,
	}
	export function CreateTargetingExpansionConfigFormGroup() {
		return new FormGroup<TargetingExpansionConfigFormProperties>({
			excludeFirstPartyAudience: new FormControl<boolean | null | undefined>(undefined),
			targetingExpansionLevel: new FormControl<TargetingExpansionConfigTargetingExpansionLevel | null | undefined>(undefined),
		});

	}

	export enum TargetingExpansionConfigTargetingExpansionLevel { TARGETING_EXPANSION_LEVEL_UNSPECIFIED = 0, NO_EXPANSION = 1, LEAST_EXPANSION = 2, SOME_EXPANSION = 3, BALANCED_EXPANSION = 4, MORE_EXPANSION = 5, MOST_EXPANSION = 6 }
	...
	export enum YoutubeAndPartnersBiddingStrategyAdGroupEffectiveTargetCpaSource { BIDDING_SOURCE_UNSPECIFIED = 0, BIDDING_SOURCE_LINE_ITEM = 1, BIDDING_SOURCE_AD_GROUP = 2 }

	export enum YoutubeAndPartnersBiddingStrategyType { YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_UNSPECIFIED = 0, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_MANUAL_CPV = 1, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_MANUAL_CPM = 2, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_TARGET_CPA = 3, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_TARGET_CPM = 4, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_MAXIMIZE_LIFT = 5, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_MAXIMIZE_CONVERSIONS = 6, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_TARGET_CPV = 7, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_TARGET_ROAS = 8, YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_MAXIMIZE_CONVERSION_VALUE = 9 }

	export enum YoutubeAndPartnersSettingsContentCategory { YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_UNSPECIFIED = 0, YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_STANDARD = 1, YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_EXPANDED = 2, YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_LIMITED = 3 }
	...
	export interface YoutubeAndPartnersInventorySourceConfigFormProperties {
		...
		/** Whether to target inventory on the YouTube search results page. */
		includeYoutubeSearch: FormControl<boolean | null | undefined>,

		/** Whether to target inventory on a collection of partner sites and apps that follow the same brand safety standards as YouTube. */
		includeYoutubeVideoPartners: FormControl<boolean | null | undefined>,

		/** Whether to target inventory of channels and videos on YouTube and YouTube videos embedded on other sites. */
		includeYoutubeVideos: FormControl<boolean | null | undefined>,
	}
	export function CreateYoutubeAndPartnersInventorySourceConfigFormGroup() {
		return new FormGroup<YoutubeAndPartnersInventorySourceConfigFormProperties>({
			includeYoutubeSearch: new FormControl<boolean | null | undefined>(undefined),
			includeYoutubeVideoPartners: new FormControl<boolean | null | undefined>(undefined),
			includeYoutubeVideos: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Settings that control what third-party vendors are measuring specific line item metrics. */
	export interface YoutubeAndPartnersThirdPartyMeasurementSettingsFormProperties {
	}
	export function CreateYoutubeAndPartnersThirdPartyMeasurementSettingsFormGroup() {
		return new FormGroup<YoutubeAndPartnersThirdPartyMeasurementSettingsFormProperties>({
		});
	...
	export enum ThirdPartyVendorConfigVendor { THIRD_PARTY_VENDOR_UNSPECIFIED = 0, THIRD_PARTY_VENDOR_MOAT = 1, THIRD_PARTY_VENDOR_DOUBLE_VERIFY = 2, THIRD_PARTY_VENDOR_INTEGRAL_AD_SCIENCE = 3, THIRD_PARTY_VENDOR_COMSCORE = 4, THIRD_PARTY_VENDOR_TELEMETRY = 5, THIRD_PARTY_VENDOR_MEETRICS = 6, THIRD_PARTY_VENDOR_ZEFR = 7, THIRD_PARTY_VENDOR_NIELSEN = 8, THIRD_PARTY_VENDOR_KANTAR = 9, THIRD_PARTY_VENDOR_DYNATA = 10 }
	...
	export enum VideoAdSequenceSettingsMinimumDuration { VIDEO_AD_SEQUENCE_MINIMUM_DURATION_UNSPECIFIED = 0, VIDEO_AD_SEQUENCE_MINIMUM_DURATION_WEEK = 1, VIDEO_AD_SEQUENCE_MINIMUM_DURATION_MONTH = 2 }
	...
	export enum VideoAdSequenceStepInteractionType { INTERACTION_TYPE_UNSPECIFIED = 0, INTERACTION_TYPE_PAID_VIEW = 1, INTERACTION_TYPE_SKIP = 2, INTERACTION_TYPE_IMPRESSION = 3, INTERACTION_TYPE_ENGAGED_IMPRESSION = 4 }
	...
	export enum CampaignBudgetExternalBudgetSource { EXTERNAL_BUDGET_SOURCE_UNSPECIFIED = 0, EXTERNAL_BUDGET_SOURCE_NONE = 1, EXTERNAL_BUDGET_SOURCE_MEDIA_OCEAN = 2 }
	...
	export enum PrismaConfigPrismaType { PRISMA_TYPE_UNSPECIFIED = 0, PRISMA_TYPE_DISPLAY = 1, PRISMA_TYPE_SEARCH = 2, PRISMA_TYPE_VIDEO = 3, PRISMA_TYPE_AUDIO = 4, PRISMA_TYPE_SOCIAL = 5, PRISMA_TYPE_FEE = 6 }
	...
	export enum CampaignGoalCampaignGoalType { CAMPAIGN_GOAL_TYPE_UNSPECIFIED = 0, CAMPAIGN_GOAL_TYPE_APP_INSTALL = 1, CAMPAIGN_GOAL_TYPE_BRAND_AWARENESS = 2, CAMPAIGN_GOAL_TYPE_OFFLINE_ACTION = 3, CAMPAIGN_GOAL_TYPE_ONLINE_ACTION = 4 }
	...
	export enum PerformanceGoalPerformanceGoalType { PERFORMANCE_GOAL_TYPE_UNSPECIFIED = 0, PERFORMANCE_GOAL_TYPE_CPM = 1, PERFORMANCE_GOAL_TYPE_CPC = 2, PERFORMANCE_GOAL_TYPE_CPA = 3, PERFORMANCE_GOAL_TYPE_CTR = 4, PERFORMANCE_GOAL_TYPE_VIEWABILITY = 5, PERFORMANCE_GOAL_TYPE_CPIAVC = 6, PERFORMANCE_GOAL_TYPE_CPE = 7, PERFORMANCE_GOAL_TYPE_CLICK_CVR = 8, PERFORMANCE_GOAL_TYPE_IMPRESSION_CVR = 9, PERFORMANCE_GOAL_TYPE_VCPM = 10, PERFORMANCE_GOAL_TYPE_VTR = 11, PERFORMANCE_GOAL_TYPE_AUDIO_COMPLETION_RATE = 12, PERFORMANCE_GOAL_TYPE_VIDEO_COMPLETION_RATE = 13, PERFORMANCE_GOAL_TYPE_OTHER = 14 }
	...
	export enum CarrierAndIspTargetingOptionDetailsType { CARRIER_AND_ISP_TYPE_UNSPECIFIED = 0, CARRIER_AND_ISP_TYPE_ISP = 1, CARRIER_AND_ISP_TYPE_CARRIER = 2 }
	...
	export enum ConsentAdPersonalization { CONSENT_STATUS_UNSPECIFIED = 0, CONSENT_STATUS_GRANTED = 1, CONSENT_STATUS_DENIED = 2 }
	...
	export enum ParentEntityFilterFilterType { FILTER_TYPE_UNSPECIFIED = 0, FILTER_TYPE_NONE = 1, FILTER_TYPE_ADVERTISER_ID = 2, FILTER_TYPE_CAMPAIGN_ID = 3, FILTER_TYPE_MEDIA_PRODUCT_ID = 4, FILTER_TYPE_INSERTION_ORDER_ID = 5, FILTER_TYPE_LINE_ITEM_ID = 6 }
	...
	export enum CreativeCreativeType { CREATIVE_TYPE_UNSPECIFIED = 0, CREATIVE_TYPE_STANDARD = 1, CREATIVE_TYPE_EXPANDABLE = 2, CREATIVE_TYPE_VIDEO = 3, CREATIVE_TYPE_NATIVE = 4, CREATIVE_TYPE_TEMPLATED_APP_INSTALL = 5, CREATIVE_TYPE_NATIVE_SITE_SQUARE = 6, CREATIVE_TYPE_TEMPLATED_APP_INSTALL_INTERSTITIAL = 7, CREATIVE_TYPE_LIGHTBOX = 8, CREATIVE_TYPE_NATIVE_APP_INSTALL = 9, CREATIVE_TYPE_NATIVE_APP_INSTALL_SQUARE = 10, CREATIVE_TYPE_AUDIO = 11, CREATIVE_TYPE_PUBLISHER_HOSTED = 12, CREATIVE_TYPE_NATIVE_VIDEO = 13, CREATIVE_TYPE_TEMPLATED_APP_INSTALL_VIDEO = 14 }
	...
	export enum ExitEventType { EXIT_EVENT_TYPE_UNSPECIFIED = 0, EXIT_EVENT_TYPE_DEFAULT = 1, EXIT_EVENT_TYPE_BACKUP = 2 }

	export enum CreativeExpandingDirection { EXPANDING_DIRECTION_UNSPECIFIED = 0, EXPANDING_DIRECTION_NONE = 1, EXPANDING_DIRECTION_UP = 2, EXPANDING_DIRECTION_DOWN = 3, EXPANDING_DIRECTION_LEFT = 4, EXPANDING_DIRECTION_RIGHT = 5, EXPANDING_DIRECTION_UP_AND_LEFT = 6, EXPANDING_DIRECTION_UP_AND_RIGHT = 7, EXPANDING_DIRECTION_DOWN_AND_LEFT = 8, EXPANDING_DIRECTION_DOWN_AND_RIGHT = 9, EXPANDING_DIRECTION_UP_OR_DOWN = 10, EXPANDING_DIRECTION_LEFT_OR_RIGHT = 11, EXPANDING_DIRECTION_ANY_DIAGONAL = 12 }

	export enum CreativeHostingSource { HOSTING_SOURCE_UNSPECIFIED = 0, HOSTING_SOURCE_CM = 1, HOSTING_SOURCE_THIRD_PARTY = 2, HOSTING_SOURCE_HOSTED = 3, HOSTING_SOURCE_RICH_MEDIA = 4 }
	...
	export enum ObaIconPosition { OBA_ICON_POSITION_UNSPECIFIED = 0, OBA_ICON_POSITION_UPPER_RIGHT = 1, OBA_ICON_POSITION_UPPER_LEFT = 2, OBA_ICON_POSITION_LOWER_RIGHT = 3, OBA_ICON_POSITION_LOWER_LEFT = 4 }
	...
	export enum ReviewStatusInfoApprovalStatus { APPROVAL_STATUS_UNSPECIFIED = 0, APPROVAL_STATUS_PENDING_NOT_SERVABLE = 1, APPROVAL_STATUS_PENDING_SERVABLE = 2, APPROVAL_STATUS_APPROVED_SERVABLE = 3, APPROVAL_STATUS_REJECTED_NOT_SERVABLE = 4 }

	export enum ReviewStatusInfoContentAndPolicyReviewStatus { REVIEW_STATUS_UNSPECIFIED = 0, REVIEW_STATUS_APPROVED = 1, REVIEW_STATUS_REJECTED = 2, REVIEW_STATUS_PENDING = 3 }
	...
	export enum ThirdPartyUrlType { THIRD_PARTY_URL_TYPE_UNSPECIFIED = 0, THIRD_PARTY_URL_TYPE_IMPRESSION = 1, THIRD_PARTY_URL_TYPE_CLICK_TRACKING = 2, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_START = 3, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_FIRST_QUARTILE = 4, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_MIDPOINT = 5, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_THIRD_QUARTILE = 6, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_COMPLETE = 7, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_MUTE = 8, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_PAUSE = 9, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_REWIND = 10, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_FULLSCREEN = 11, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_STOP = 12, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_CUSTOM = 13, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_SKIP = 14, THIRD_PARTY_URL_TYPE_AUDIO_VIDEO_PROGRESS = 15 }
	...
	export enum UniversalAdIdRegistry { UNIVERSAL_AD_REGISTRY_UNSPECIFIED = 0, UNIVERSAL_AD_REGISTRY_OTHER = 1, UNIVERSAL_AD_REGISTRY_AD_ID = 2, UNIVERSAL_AD_REGISTRY_CLEARCAST = 3, UNIVERSAL_AD_REGISTRY_DV360 = 4, UNIVERSAL_AD_REGISTRY_CM = 5 }
	...
	export enum CustomBiddingAlgorithmCustomBiddingAlgorithmType { CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED = 0, SCRIPT_BASED = 1, ADS_DATA_HUB_BASED = 2, GOAL_BUILDER_BASED = 3 }
	...
	export enum CustomBiddingModelDetailsReadinessState { READINESS_STATE_UNSPECIFIED = 0, READINESS_STATE_ACTIVE = 1, READINESS_STATE_INSUFFICIENT_DATA = 2, READINESS_STATE_TRAINING = 3, READINESS_STATE_NO_VALID_SCRIPT = 4 }

	export enum CustomBiddingModelDetailsSuspensionState { SUSPENSION_STATE_UNSPECIFIED = 0, SUSPENSION_STATE_ENABLED = 1, SUSPENSION_STATE_DORMANT = 2, SUSPENSION_STATE_SUSPENDED = 3 }
	...
	export enum ScriptErrorErrorCode { ERROR_CODE_UNSPECIFIED = 0, SYNTAX_ERROR = 1, DEPRECATED_SYNTAX = 2, INTERNAL_ERROR = 3 }
	...
	export enum CustomBiddingScriptState { STATE_UNSPECIFIED = 0, ACCEPTED = 1, REJECTED = 2, PENDING = 3 }
	...
	export enum CustomLabelKey { CUSTOM_LABEL_KEY_UNSPECIFIED = 0, CUSTOM_LABEL_KEY_0 = 1, CUSTOM_LABEL_KEY_1 = 2, CUSTOM_LABEL_KEY_2 = 3, CUSTOM_LABEL_KEY_3 = 4, CUSTOM_LABEL_KEY_4 = 5 }
	...
	/** Request message for ManualTriggerService.DeactivateManualTrigger. */
	export interface DeactivateManualTriggerRequestFormProperties {
	}
	export function CreateDeactivateManualTriggerRequestFormGroup() {
		return new FormGroup<DeactivateManualTriggerRequestFormProperties>({
		});
	...
	export enum FirstAndThirdPartyAudienceAudienceSource { AUDIENCE_SOURCE_UNSPECIFIED = 0, DISPLAY_VIDEO_360 = 1, CAMPAIGN_MANAGER = 2, AD_MANAGER = 3, SEARCH_ADS_360 = 4, YOUTUBE = 5, ADS_DATA_HUB = 6 }

	export enum FirstAndThirdPartyAudienceAudienceType { AUDIENCE_TYPE_UNSPECIFIED = 0, CUSTOMER_MATCH_CONTACT_INFO = 1, CUSTOMER_MATCH_DEVICE_ID = 2, CUSTOMER_MATCH_USER_ID = 3, ACTIVITY_BASED = 4, FREQUENCY_CAP = 5, TAG_BASED = 6, YOUTUBE_USERS = 7, LICENSED = 8 }

	export enum FirstAndThirdPartyAudienceFirstAndThirdPartyAudienceType { FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_UNSPECIFIED = 0, FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_FIRST_PARTY = 1, FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_THIRD_PARTY = 2 }
	...
	export enum FloodlightGroupWebTagType { WEB_TAG_TYPE_UNSPECIFIED = 0, WEB_TAG_TYPE_NONE = 1, WEB_TAG_TYPE_IMAGE = 2, WEB_TAG_TYPE_DYNAMIC = 3 }
	...
	export enum GoogleAudienceGoogleAudienceType { GOOGLE_AUDIENCE_TYPE_UNSPECIFIED = 0, GOOGLE_AUDIENCE_TYPE_AFFINITY = 1, GOOGLE_AUDIENCE_TYPE_IN_MARKET = 2, GOOGLE_AUDIENCE_TYPE_INSTALLED_APPS = 3, GOOGLE_AUDIENCE_TYPE_NEW_MOBILE_DEVICES = 4, GOOGLE_AUDIENCE_TYPE_LIFE_EVENT = 5, GOOGLE_AUDIENCE_TYPE_EXTENDED_DEMOGRAPHIC = 6 }
	...
	export enum GuaranteedOrderStatusConfigStatus { GUARANTEED_ORDER_CONFIG_STATUS_UNSPECIFIED = 0, PENDING = 1, COMPLETED = 2 }
	...
	export interface InsertionOrder {
		...
		billableOutcome?: InsertionOrderBillableOutcome | null;
	...
	export interface InsertionOrderFormProperties {
		...
		/** Immutable. The billable outcome of the insertion order. Outcome based buying is deprecated. `BILLABLE_OUTCOME_PAY_PER_IMPRESSION` is the only valid value. */
		billableOutcome: FormControl<InsertionOrderBillableOutcome | null | undefined>,
	...
	export function CreateInsertionOrderFormGroup() {
		return new FormGroup<InsertionOrderFormProperties>({
			advertiserId: new FormControl<string | null | undefined>(undefined),
			billableOutcome: new FormControl<InsertionOrderBillableOutcome | null | undefined>(undefined),
			campaignId: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			entityStatus: new FormControl<AdvertiserEntityStatus | null | undefined>(undefined),
			insertionOrderId: new FormControl<string | null | undefined>(undefined),
	...
	export enum InsertionOrderBillableOutcome { BILLABLE_OUTCOME_UNSPECIFIED = 0, BILLABLE_OUTCOME_PAY_PER_IMPRESSION = 1, BILLABLE_OUTCOME_PAY_PER_CLICK = 2, BILLABLE_OUTCOME_PAY_PER_VIEWABLE_IMPRESSION = 3 }
	...
	export enum InsertionOrderBudgetAutomationType { INSERTION_ORDER_AUTOMATION_TYPE_UNSPECIFIED = 0, INSERTION_ORDER_AUTOMATION_TYPE_BUDGET = 1, INSERTION_ORDER_AUTOMATION_TYPE_NONE = 2, INSERTION_ORDER_AUTOMATION_TYPE_BID_BUDGET = 3 }
	...
	export enum InsertionOrderInsertionOrderType { INSERTION_ORDER_TYPE_UNSPECIFIED = 0, RTB = 1, OVER_THE_TOP = 2 }
	...
	export enum InventorySourceCommitment { INVENTORY_SOURCE_COMMITMENT_UNSPECIFIED = 0, INVENTORY_SOURCE_COMMITMENT_GUARANTEED = 1, INVENTORY_SOURCE_COMMITMENT_NON_GUARANTEED = 2 }

	export enum InventorySourceDeliveryMethod { INVENTORY_SOURCE_DELIVERY_METHOD_UNSPECIFIED = 0, INVENTORY_SOURCE_DELIVERY_METHOD_PROGRAMMATIC = 1, INVENTORY_SOURCE_DELIVERY_METHOD_TAG = 2 }

	export enum InventorySourceInventorySourceProductType { INVENTORY_SOURCE_PRODUCT_TYPE_UNSPECIFIED = 0, PREFERRED_DEAL = 1, PRIVATE_AUCTION = 2, PROGRAMMATIC_GUARANTEED = 3, TAG_GUARANTEED = 4, YOUTUBE_RESERVE = 5, INSTANT_RESERVE = 6, GUARANTEED_PACKAGE = 7, PROGRAMMATIC_TV = 8, AUCTION_PACKAGE = 9 }

	export enum InventorySourceInventorySourceType { INVENTORY_SOURCE_TYPE_UNSPECIFIED = 0, INVENTORY_SOURCE_TYPE_PRIVATE = 1, INVENTORY_SOURCE_TYPE_AUCTION_PACKAGE = 2 }
	...
	export enum RateDetailsInventorySourceRateType { INVENTORY_SOURCE_RATE_TYPE_UNSPECIFIED = 0, INVENTORY_SOURCE_RATE_TYPE_CPM_FIXED = 1, INVENTORY_SOURCE_RATE_TYPE_CPM_FLOOR = 2, INVENTORY_SOURCE_RATE_TYPE_CPD = 3, INVENTORY_SOURCE_RATE_TYPE_FLAT = 4 }
	...
	export interface InventorySourceStatus {
		...
		sellerStatus?: AdvertiserEntityStatus | null;
	}
	...
	export interface InventorySourceStatusFormProperties {
		...
		/** Output only. The status set by the seller for the inventory source. Only applicable for inventory sources synced directly from the publishers. Acceptable values are `ENTITY_STATUS_ACTIVE` and `ENTITY_STATUS_PAUSED`. */
		sellerStatus: FormControl<AdvertiserEntityStatus | null | undefined>,
	}
	export function CreateInventorySourceStatusFormGroup() {
		return new FormGroup<InventorySourceStatusFormProperties>({
			...
			sellerStatus: new FormControl<AdvertiserEntityStatus | null | undefined>(undefined),
		});

	}

	export enum InventorySourceStatusConfigStatus { INVENTORY_SOURCE_CONFIG_STATUS_UNSPECIFIED = 0, INVENTORY_SOURCE_CONFIG_STATUS_PENDING = 1, INVENTORY_SOURCE_CONFIG_STATUS_COMPLETED = 2 }
	...
	export enum LocationListLocationType { TARGETING_LOCATION_TYPE_UNSPECIFIED = 0, TARGETING_LOCATION_TYPE_PROXIMITY = 1, TARGETING_LOCATION_TYPE_REGIONAL = 2 }
	...
	export interface ListManualTriggersResponseFormProperties {

		/** A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListManualTriggers` method to retrieve the next page of results. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListManualTriggersResponseFormGroup() {
		return new FormGroup<ListManualTriggersResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A single manual trigger in Display & Video 360. **Warning:** Line Items using manual triggers no longer serve in Display & Video 360. This resource will sunset on August 1, 2023. Read our [feature deprecation announcement](/display-video/api/deprecations#features.manual_triggers) for more information. */
	export interface ManualTriggerFormProperties {

		/** Required. The maximum duration of each activation in minutes. Must be between 1 and 360 inclusive. After this duration, the trigger will be automatically deactivated. */
		activationDurationMinutes: FormControl<string | null | undefined>,
		...
		/** Output only. The timestamp of the trigger's latest activation. */
		latestActivationTime: FormControl<string | null | undefined>,

		/** Output only. The resource name of the manual trigger. */
		name: FormControl<string | null | undefined>,

		/** Output only. The state of the manual trigger. Will be set to the `INACTIVE` state upon creation. */
		state: FormControl<ManualTriggerState | null | undefined>,

		/** Output only. The unique ID of the manual trigger. */
		triggerId: FormControl<string | null | undefined>,
	}
	export function CreateManualTriggerFormGroup() {
		return new FormGroup<ManualTriggerFormProperties>({
			activationDurationMinutes: new FormControl<string | null | undefined>(undefined),
			advertiserId: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			latestActivationTime: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			state: new FormControl<ManualTriggerState | null | undefined>(undefined),
			triggerId: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum ManualTriggerState { STATE_UNSPECIFIED = 0, INACTIVE = 1, ACTIVE = 2 }
	...
	export interface ListYoutubeAdGroupAdsResponseFormProperties {

		/** A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListYoutubeAdGroupAds` method to retrieve the next page of results. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListYoutubeAdGroupAdsResponseFormGroup() {
		return new FormGroup<ListYoutubeAdGroupAdsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A single ad associated with a YouTube ad group. */
	export interface YoutubeAdGroupAdFormProperties {
	...
	export function CreateYoutubeAdGroupAdFormGroup() {
		return new FormGroup<YoutubeAdGroupAdFormProperties>({
	...
	export enum MastheadAdVideoAspectRatio { VIDEO_ASPECT_RATIO_UNSPECIFIED = 0, VIDEO_ASPECT_RATIO_WIDESCREEN = 1, VIDEO_ASPECT_RATIO_FIXED_16_9 = 2 }
	...
	export enum VideoDiscoveryAdThumbnail { THUMBNAIL_UNSPECIFIED = 0, THUMBNAIL_DEFAULT = 1, THUMBNAIL_1 = 2, THUMBNAIL_2 = 3, THUMBNAIL_3 = 4 }
	...
	/** Response message for ListYoutubeAdGroupAssignedTargetingOptions. */
	export interface ListYoutubeAdGroupAssignedTargetingOptionsResponseFormProperties {

		/** A token identifying the next page of results. This value should be specified as the pageToken in a subsequent ListYoutubeAdGroupAssignedTargetingOptionsRequest to fetch the next page of results. This token will be absent if there are no more assigned_targeting_options to return. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListYoutubeAdGroupAssignedTargetingOptionsResponseFormGroup() {
		return new FormGroup<ListYoutubeAdGroupAssignedTargetingOptionsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface ListYoutubeAdGroupsResponseFormProperties {

		/** A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListYoutubeAdGroups` method to retrieve the next page of results. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListYoutubeAdGroupsResponseFormGroup() {
		return new FormGroup<ListYoutubeAdGroupsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface YoutubeAdGroup {
		...
		adGroupFormat?: YoutubeAdGroupAdGroupFormat | null;
	...
	/** A single YouTube ad group associated with a YouTube and Partners line item. */
	export interface YoutubeAdGroupFormProperties {

		/** The format of the ads in the ad group. */
		adGroupFormat: FormControl<YoutubeAdGroupAdGroupFormat | null | undefined>,
	...
	export function CreateYoutubeAdGroupFormGroup() {
		return new FormGroup<YoutubeAdGroupFormProperties>({
			adGroupFormat: new FormControl<YoutubeAdGroupAdGroupFormat | null | undefined>(undefined),
			adGroupId: new FormControl<string | null | undefined>(undefined),
			advertiserId: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			entityStatus: new FormControl<AdvertiserEntityStatus | null | undefined>(undefined),
	...
	export enum YoutubeAdGroupAdGroupFormat { YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_UNSPECIFIED = 0, YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_IN_STREAM = 1, YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_VIDEO_DISCOVERY = 2, YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_BUMPER = 3, YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM = 4, YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_AUDIO = 5, YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_ACTION = 6, YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_REACH = 7, YOUTUBE_AND_PARTNERS_AD_GROUP_FORMAT_MASTHEAD = 8 }
	...
	export enum ProductFeedDataProductMatchType { PRODUCT_MATCH_TYPE_UNSPECIFIED = 0, PRODUCT_MATCH_TYPE_ALL_PRODUCTS = 1, PRODUCT_MATCH_TYPE_SPECIFIC_PRODUCTS = 2, PRODUCT_MATCH_TYPE_CUSTOM_LABEL = 3 }
	...
	export class MyClient {
		...
		Displayvideo_advertisers_list(filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListAdvertisersResponse> {
			return this.http.get<ListAdvertisersResponse>(this.baseUri + 'v2/advertisers?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_advertisers_create(requestBody: Advertiser): Observable<Advertiser> {
			return this.http.post<Advertiser>(this.baseUri + 'v2/advertisers', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_delete(advertiserId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_advertisers_get(advertiserId: string): Observable<Advertiser> {
			return this.http.get<Advertiser>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_advertisers_patch(advertiserId: string, updateMask: string | null | undefined, requestBody: Advertiser): Observable<Advertiser> {
			return this.http.patch<Advertiser>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_campaigns_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCampaignsResponse> {
			return this.http.get<ListCampaignsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_campaigns_create(advertiserId: string, requestBody: Campaign): Observable<Campaign> {
			return this.http.post<Campaign>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_campaigns_delete(advertiserId: string, campaignId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns/' + (campaignId == null ? '' : encodeURIComponent(campaignId)), {});
		}
		...
		Displayvideo_advertisers_campaigns_get(advertiserId: string, campaignId: string): Observable<Campaign> {
			return this.http.get<Campaign>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns/' + (campaignId == null ? '' : encodeURIComponent(campaignId)), {});
		}
		...
		Displayvideo_advertisers_campaigns_listAssignedTargetingOptions(advertiserId: string, campaignId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<BulkListCampaignAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListCampaignAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns/' + (campaignId == null ? '' : encodeURIComponent(campaignId)) + ':listAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_channels_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListChannelsResponse> {
			return this.http.get<ListChannelsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_advertisers_channels_create(advertiserId: string, partnerId: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.post<Channel>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_channels_patch(advertiserId: string, channelId: string, partnerId: string | null | undefined, updateMask: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.patch<Channel>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_channels_sites_list(advertiserId: string, channelId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListSitesResponse> {
			return this.http.get<ListSitesResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_advertisers_channels_sites_delete(advertiserId: string, channelId: string, urlOrAppId: string, partnerId: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites/' + (urlOrAppId == null ? '' : encodeURIComponent(urlOrAppId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_advertisers_channels_sites_bulkEdit(advertiserId: string, channelId: string, requestBody: BulkEditSitesRequest): Observable<BulkEditSitesResponse> {
			return this.http.post<BulkEditSitesResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites:bulkEdit', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_channels_sites_replace(advertiserId: string, channelId: string, requestBody: ReplaceSitesRequest): Observable<ReplaceSitesResponse> {
			return this.http.post<ReplaceSitesResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites:replace', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_creatives_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCreativesResponse> {
			return this.http.get<ListCreativesResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_creatives_create(advertiserId: string, requestBody: Creative): Observable<Creative> {
			return this.http.post<Creative>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_creatives_delete(advertiserId: string, creativeId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives/' + (creativeId == null ? '' : encodeURIComponent(creativeId)), {});
		}
		...
		Displayvideo_advertisers_creatives_get(advertiserId: string, creativeId: string): Observable<Creative> {
			return this.http.get<Creative>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives/' + (creativeId == null ? '' : encodeURIComponent(creativeId)), {});
		}
		...
		Displayvideo_advertisers_creatives_patch(advertiserId: string, creativeId: string, updateMask: string | null | undefined, requestBody: Creative): Observable<Creative> {
			return this.http.patch<Creative>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives/' + (creativeId == null ? '' : encodeURIComponent(creativeId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_insertionOrders_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInsertionOrdersResponse> {
			return this.http.get<ListInsertionOrdersResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_insertionOrders_create(advertiserId: string, requestBody: InsertionOrder): Observable<InsertionOrder> {
			return this.http.post<InsertionOrder>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_insertionOrders_delete(advertiserId: string, insertionOrderId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)), {});
		}
		...
		Displayvideo_advertisers_insertionOrders_get(advertiserId: string, insertionOrderId: string): Observable<InsertionOrder> {
			return this.http.get<InsertionOrder>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)), {});
		}
		...
		Displayvideo_advertisers_insertionOrders_patch(advertiserId: string, insertionOrderId: string, updateMask: string | null | undefined, requestBody: InsertionOrder): Observable<InsertionOrder> {
			return this.http.patch<InsertionOrder>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_insertionOrders_targetingTypes_assignedTargetingOptions_list(advertiserId: string, insertionOrderId: string, targetingType: AssignedTargetingOptionTargetingType, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInsertionOrderAssignedTargetingOptionsResponse> {
			return this.http.get<ListInsertionOrderAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_insertionOrders_listAssignedTargetingOptions(advertiserId: string, insertionOrderId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<BulkListInsertionOrderAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListInsertionOrderAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)) + ':listAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_invoices_list(advertiserId: string, issueMonth: string | null | undefined, loiSapinInvoiceType: Displayvideo_advertisers_invoices_listLoiSapinInvoiceType | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInvoicesResponse> {
			return this.http.get<ListInvoicesResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/invoices&issueMonth=' + (issueMonth == null ? '' : encodeURIComponent(issueMonth)) + '&loiSapinInvoiceType=' + loiSapinInvoiceType + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_invoices_lookupInvoiceCurrency(advertiserId: string, invoiceMonth: string | null | undefined): Observable<LookupInvoiceCurrencyResponse> {
			return this.http.get<LookupInvoiceCurrencyResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/invoices:lookupInvoiceCurrency&invoiceMonth=' + (invoiceMonth == null ? '' : encodeURIComponent(invoiceMonth)), {});
		}
		...
		Displayvideo_advertisers_lineItems_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLineItemsResponse> {
			return this.http.get<ListLineItemsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_lineItems_create(advertiserId: string, requestBody: LineItem): Observable<LineItem> {
			return this.http.post<LineItem>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_lineItems_delete(advertiserId: string, lineItemId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)), {});
		}
		...
		Displayvideo_advertisers_lineItems_get(advertiserId: string, lineItemId: string): Observable<LineItem> {
			return this.http.get<LineItem>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)), {});
		}
		...
		Displayvideo_advertisers_lineItems_patch(advertiserId: string, lineItemId: string, updateMask: string | null | undefined, requestBody: LineItem): Observable<LineItem> {
			return this.http.patch<LineItem>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_lineItems_targetingTypes_assignedTargetingOptions_list(advertiserId: string, lineItemId: string, targetingType: AssignedTargetingOptionTargetingType, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLineItemAssignedTargetingOptionsResponse> {
			return this.http.get<ListLineItemAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_lineItems_targetingTypes_assignedTargetingOptions_delete(advertiserId: string, lineItemId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		...
		Displayvideo_advertisers_lineItems_duplicate(advertiserId: string, lineItemId: string, requestBody: DuplicateLineItemRequest): Observable<DuplicateLineItemResponse> {
			return this.http.post<DuplicateLineItemResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + ':duplicate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_lineItems_bulkEditAssignedTargetingOptions(advertiserId: string, requestBody: BulkEditAssignedTargetingOptionsRequest): Observable<BulkEditAssignedTargetingOptionsResponse> {
			return this.http.post<BulkEditAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems:bulkEditAssignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_lineItems_bulkListAssignedTargetingOptions(advertiserId: string, filter: string | null | undefined, lineItemIds: Array<string> | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<BulkListAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems:bulkListAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&' + lineItemIds?.map(z => `lineItemIds=${encodeURIComponent(z)}`).join('&') + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_lineItems_bulkUpdate(advertiserId: string, requestBody: BulkUpdateLineItemsRequest): Observable<BulkUpdateLineItemsResponse> {
			return this.http.post<BulkUpdateLineItemsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems:bulkUpdate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_lineItems_generateDefault(advertiserId: string, requestBody: GenerateDefaultLineItemRequest): Observable<LineItem> {
			return this.http.post<LineItem>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems:generateDefault', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_locationLists_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationListsResponse> {
			return this.http.get<ListLocationListsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/locationLists&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_locationLists_create(advertiserId: string, requestBody: LocationList): Observable<LocationList> {
			return this.http.post<LocationList>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/locationLists', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_locationLists_assignedLocations_create(advertiserId: string, locationListId: string, requestBody: AssignedLocation): Observable<AssignedLocation> {
			return this.http.post<AssignedLocation>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/locationLists/' + (locationListId == null ? '' : encodeURIComponent(locationListId)) + '/assignedLocations', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_locationLists_assignedLocations_delete(advertiserId: string, locationListId: string, assignedLocationId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/locationLists/' + (locationListId == null ? '' : encodeURIComponent(locationListId)) + '/assignedLocations/' + (assignedLocationId == null ? '' : encodeURIComponent(assignedLocationId)), {});
		}
		 ...
		 * @return {ListManualTriggersResponse} Successful response
		 */
		Displayvideo_advertisers_manualTriggers_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListManualTriggersResponse> {
			return this.http.get<ListManualTriggersResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {ManualTrigger} Successful response
		 */
		Displayvideo_advertisers_manualTriggers_create(advertiserId: string, requestBody: ManualTrigger): Observable<ManualTrigger> {
			return this.http.post<ManualTrigger>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ManualTrigger} Successful response
		 */
		Displayvideo_advertisers_manualTriggers_get(advertiserId: string, triggerId: string): Observable<ManualTrigger> {
			return this.http.get<ManualTrigger>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers/' + (triggerId == null ? '' : encodeURIComponent(triggerId)), {});
		}
		 ...
		 * @return {ManualTrigger} Successful response
		 */
		Displayvideo_advertisers_manualTriggers_patch(advertiserId: string, triggerId: string, updateMask: string | null | undefined, requestBody: ManualTrigger): Observable<ManualTrigger> {
			return this.http.patch<ManualTrigger>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers/' + (triggerId == null ? '' : encodeURIComponent(triggerId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ManualTrigger} Successful response
		 */
		Displayvideo_advertisers_manualTriggers_activate(advertiserId: string, triggerId: string, requestBody: ActivateManualTriggerRequest): Observable<ManualTrigger> {
			return this.http.post<ManualTrigger>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers/' + (triggerId == null ? '' : encodeURIComponent(triggerId)) + ':activate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ManualTrigger} Successful response
		 */
		Displayvideo_advertisers_manualTriggers_deactivate(advertiserId: string, triggerId: string, requestBody: DeactivateManualTriggerRequest): Observable<ManualTrigger> {
			return this.http.post<ManualTrigger>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers/' + (triggerId == null ? '' : encodeURIComponent(triggerId)) + ':deactivate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_list(advertiserId: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListNegativeKeywordListsResponse> {
			return this.http.get<ListNegativeKeywordListsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_create(advertiserId: string, requestBody: NegativeKeywordList): Observable<NegativeKeywordList> {
			return this.http.post<NegativeKeywordList>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_patch(advertiserId: string, negativeKeywordListId: string, updateMask: string | null | undefined, requestBody: NegativeKeywordList): Observable<NegativeKeywordList> {
			return this.http.patch<NegativeKeywordList>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_list(advertiserId: string, negativeKeywordListId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListNegativeKeywordsResponse> {
			return this.http.get<ListNegativeKeywordsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '/negativeKeywords&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_delete(advertiserId: string, negativeKeywordListId: string, keywordValue: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '/negativeKeywords/' + (keywordValue == null ? '' : encodeURIComponent(keywordValue)), {});
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_bulkEdit(advertiserId: string, negativeKeywordListId: string, requestBody: BulkEditNegativeKeywordsRequest): Observable<BulkEditNegativeKeywordsResponse> {
			return this.http.post<BulkEditNegativeKeywordsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '/negativeKeywords:bulkEdit', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_replace(advertiserId: string, negativeKeywordListId: string, requestBody: ReplaceNegativeKeywordsRequest): Observable<ReplaceNegativeKeywordsResponse> {
			return this.http.post<ReplaceNegativeKeywordsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '/negativeKeywords:replace', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_list(advertiserId: string, targetingType: AssignedTargetingOptionTargetingType, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAdvertiserAssignedTargetingOptionsResponse> {
			return this.http.get<ListAdvertiserAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_create(advertiserId: string, targetingType: AssignedTargetingOptionTargetingType, requestBody: AssignedTargetingOption): Observable<AssignedTargetingOption> {
			return this.http.post<AssignedTargetingOption>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_delete(advertiserId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		...
		Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_get(advertiserId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<AssignedTargetingOption> {
			return this.http.get<AssignedTargetingOption>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		 ...
		 * @return {ListYoutubeAdGroupAdsResponse} Successful response
		 */
		Displayvideo_advertisers_youtubeAdGroupAds_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListYoutubeAdGroupAdsResponse> {
			return this.http.get<ListYoutubeAdGroupAdsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/youtubeAdGroupAds&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {YoutubeAdGroupAd} Successful response
		 */
		Displayvideo_advertisers_youtubeAdGroupAds_get(advertiserId: string, youtubeAdGroupAdId: string): Observable<YoutubeAdGroupAd> {
			return this.http.get<YoutubeAdGroupAd>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/youtubeAdGroupAds/' + (youtubeAdGroupAdId == null ? '' : encodeURIComponent(youtubeAdGroupAdId)), {});
		}
		 ...
		 * @return {ListYoutubeAdGroupsResponse} Successful response
		 */
		Displayvideo_advertisers_youtubeAdGroups_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListYoutubeAdGroupsResponse> {
			return this.http.get<ListYoutubeAdGroupsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/youtubeAdGroups&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {YoutubeAdGroup} Successful response
		 */
		Displayvideo_advertisers_youtubeAdGroups_get(advertiserId: string, youtubeAdGroupId: string): Observable<YoutubeAdGroup> {
			return this.http.get<YoutubeAdGroup>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/youtubeAdGroups/' + (youtubeAdGroupId == null ? '' : encodeURIComponent(youtubeAdGroupId)), {});
		}
		 ...
		 * @return {ListYoutubeAdGroupAssignedTargetingOptionsResponse} Successful response
		 */
		Displayvideo_advertisers_youtubeAdGroups_targetingTypes_assignedTargetingOptions_list(advertiserId: string, youtubeAdGroupId: string, targetingType: AssignedTargetingOptionTargetingType, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListYoutubeAdGroupAssignedTargetingOptionsResponse> {
			return this.http.get<ListYoutubeAdGroupAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/youtubeAdGroups/' + (youtubeAdGroupId == null ? '' : encodeURIComponent(youtubeAdGroupId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {AssignedTargetingOption} Successful response
		 */
		Displayvideo_advertisers_youtubeAdGroups_targetingTypes_assignedTargetingOptions_get(advertiserId: string, youtubeAdGroupId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<AssignedTargetingOption> {
			return this.http.get<AssignedTargetingOption>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/youtubeAdGroups/' + (youtubeAdGroupId == null ? '' : encodeURIComponent(youtubeAdGroupId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		 ...
		 */
		Displayvideo_advertisers_youtubeAdGroups_bulkListAdGroupAssignedTargetingOptions(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, youtubeAdGroupIds: Array<string> | null | undefined): Observable<BulkListAdGroupAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListAdGroupAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/youtubeAdGroups:bulkListAdGroupAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&' + youtubeAdGroupIds?.map(z => `youtubeAdGroupIds=${encodeURIComponent(z)}`).join('&'), {});
		}
		...
		Displayvideo_advertisers_audit(advertiserId: string, readMask: string | null | undefined): Observable<AuditAdvertiserResponse> {
			return this.http.get<AuditAdvertiserResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + ':audit&readMask=' + (readMask == null ? '' : encodeURIComponent(readMask)), {});
		}
		...
		Displayvideo_advertisers_editAssignedTargetingOptions(advertiserId: string, requestBody: BulkEditAdvertiserAssignedTargetingOptionsRequest): Observable<BulkEditAdvertiserAssignedTargetingOptionsResponse> {
			return this.http.post<BulkEditAdvertiserAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + ':editAssignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_listAssignedTargetingOptions(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<BulkListAdvertiserAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListAdvertiserAssignedTargetingOptionsResponse>(this.baseUri + 'v2/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + ':listAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_combinedAudiences_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListCombinedAudiencesResponse> {
			return this.http.get<ListCombinedAudiencesResponse>(this.baseUri + 'v2/combinedAudiences?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_combinedAudiences_get(combinedAudienceId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<CombinedAudience> {
			return this.http.get<CombinedAudience>(this.baseUri + 'v2/combinedAudiences/' + (combinedAudienceId == null ? '' : encodeURIComponent(combinedAudienceId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_customBiddingAlgorithms_create(requestBody: CustomBiddingAlgorithm): Observable<CustomBiddingAlgorithm> {
			return this.http.post<CustomBiddingAlgorithm>(this.baseUri + 'v2/customBiddingAlgorithms', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_customBiddingAlgorithms_get(customBiddingAlgorithmId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<CustomBiddingAlgorithm> {
			return this.http.get<CustomBiddingAlgorithm>(this.baseUri + 'v2/customBiddingAlgorithms/' + (customBiddingAlgorithmId == null ? '' : encodeURIComponent(customBiddingAlgorithmId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_customBiddingAlgorithms_patch(customBiddingAlgorithmId: string, updateMask: string | null | undefined, requestBody: CustomBiddingAlgorithm): Observable<CustomBiddingAlgorithm> {
			return this.http.patch<CustomBiddingAlgorithm>(this.baseUri + 'v2/customBiddingAlgorithms/' + (customBiddingAlgorithmId == null ? '' : encodeURIComponent(customBiddingAlgorithmId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_customBiddingAlgorithms_uploadScript(customBiddingAlgorithmId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<CustomBiddingScriptRef> {
			return this.http.get<CustomBiddingScriptRef>(this.baseUri + 'v2/customBiddingAlgorithms/' + (customBiddingAlgorithmId == null ? '' : encodeURIComponent(customBiddingAlgorithmId)) + ':uploadScript&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_customLists_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCustomListsResponse> {
			return this.http.get<ListCustomListsResponse>(this.baseUri + 'v2/customLists?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_customLists_get(customListId: string, advertiserId: string | null | undefined): Observable<CustomList> {
			return this.http.get<CustomList>(this.baseUri + 'v2/customLists/' + (customListId == null ? '' : encodeURIComponent(customListId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_firstAndThirdPartyAudiences_create(advertiserId: string | null | undefined, requestBody: FirstAndThirdPartyAudience): Observable<FirstAndThirdPartyAudience> {
			return this.http.post<FirstAndThirdPartyAudience>(this.baseUri + 'v2/firstAndThirdPartyAudiences?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_firstAndThirdPartyAudiences_get(firstAndThirdPartyAudienceId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<FirstAndThirdPartyAudience> {
			return this.http.get<FirstAndThirdPartyAudience>(this.baseUri + 'v2/firstAndThirdPartyAudiences/' + (firstAndThirdPartyAudienceId == null ? '' : encodeURIComponent(firstAndThirdPartyAudienceId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_firstAndThirdPartyAudiences_editCustomerMatchMembers(firstAndThirdPartyAudienceId: string, requestBody: EditCustomerMatchMembersRequest): Observable<EditCustomerMatchMembersResponse> {
			return this.http.post<EditCustomerMatchMembersResponse>(this.baseUri + 'v2/firstAndThirdPartyAudiences/' + (firstAndThirdPartyAudienceId == null ? '' : encodeURIComponent(firstAndThirdPartyAudienceId)) + ':editCustomerMatchMembers', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_floodlightGroups_get(floodlightGroupId: string, partnerId: string | null | undefined): Observable<FloodlightGroup> {
			return this.http.get<FloodlightGroup>(this.baseUri + 'v2/floodlightGroups/' + (floodlightGroupId == null ? '' : encodeURIComponent(floodlightGroupId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_googleAudiences_get(googleAudienceId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<GoogleAudience> {
			return this.http.get<GoogleAudience>(this.baseUri + 'v2/googleAudiences/' + (googleAudienceId == null ? '' : encodeURIComponent(googleAudienceId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_guaranteedOrders_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListGuaranteedOrdersResponse> {
			return this.http.get<ListGuaranteedOrdersResponse>(this.baseUri + 'v2/guaranteedOrders?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_guaranteedOrders_create(advertiserId: string | null | undefined, partnerId: string | null | undefined, requestBody: GuaranteedOrder): Observable<GuaranteedOrder> {
			return this.http.post<GuaranteedOrder>(this.baseUri + 'v2/guaranteedOrders?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_guaranteedOrders_get(guaranteedOrderId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<GuaranteedOrder> {
			return this.http.get<GuaranteedOrder>(this.baseUri + 'v2/guaranteedOrders/' + (guaranteedOrderId == null ? '' : encodeURIComponent(guaranteedOrderId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_guaranteedOrders_editGuaranteedOrderReadAccessors(guaranteedOrderId: string, requestBody: EditGuaranteedOrderReadAccessorsRequest): Observable<EditGuaranteedOrderReadAccessorsResponse> {
			return this.http.post<EditGuaranteedOrderReadAccessorsResponse>(this.baseUri + 'v2/guaranteedOrders/' + (guaranteedOrderId == null ? '' : encodeURIComponent(guaranteedOrderId)) + ':editGuaranteedOrderReadAccessors', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_inventorySourceGroups_create(advertiserId: string | null | undefined, partnerId: string | null | undefined, requestBody: InventorySourceGroup): Observable<InventorySourceGroup> {
			return this.http.post<InventorySourceGroup>(this.baseUri + 'v2/inventorySourceGroups?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_inventorySourceGroups_delete(inventorySourceGroupId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/inventorySourceGroups/' + (inventorySourceGroupId == null ? '' : encodeURIComponent(inventorySourceGroupId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_inventorySourceGroups_get(inventorySourceGroupId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<InventorySourceGroup> {
			return this.http.get<InventorySourceGroup>(this.baseUri + 'v2/inventorySourceGroups/' + (inventorySourceGroupId == null ? '' : encodeURIComponent(inventorySourceGroupId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_inventorySourceGroups_assignedInventorySources_bulkEdit(inventorySourceGroupId: string, requestBody: BulkEditAssignedInventorySourcesRequest): Observable<BulkEditAssignedInventorySourcesResponse> {
			return this.http.post<BulkEditAssignedInventorySourcesResponse>(this.baseUri + 'v2/inventorySourceGroups/' + (inventorySourceGroupId == null ? '' : encodeURIComponent(inventorySourceGroupId)) + '/assignedInventorySources:bulkEdit', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_inventorySources_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListInventorySourcesResponse> {
			return this.http.get<ListInventorySourcesResponse>(this.baseUri + 'v2/inventorySources?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_inventorySources_create(advertiserId: string | null | undefined, partnerId: string | null | undefined, requestBody: InventorySource): Observable<InventorySource> {
			return this.http.post<InventorySource>(this.baseUri + 'v2/inventorySources?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {InventorySource} Successful response
		 */
		Displayvideo_inventorySources_get(inventorySourceId: string, partnerId: string | null | undefined): Observable<InventorySource> {
			return this.http.get<InventorySource>(this.baseUri + 'v2/inventorySources/' + (inventorySourceId == null ? '' : encodeURIComponent(inventorySourceId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_inventorySources_patch(inventorySourceId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined, updateMask: string | null | undefined, requestBody: InventorySource): Observable<InventorySource> {
			return this.http.patch<InventorySource>(this.baseUri + 'v2/inventorySources/' + (inventorySourceId == null ? '' : encodeURIComponent(inventorySourceId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_inventorySources_editInventorySourceReadWriteAccessors(inventorySourceId: string, requestBody: EditInventorySourceReadWriteAccessorsRequest): Observable<InventorySourceAccessors> {
			return this.http.post<InventorySourceAccessors>(this.baseUri + 'v2/inventorySources/' + (inventorySourceId == null ? '' : encodeURIComponent(inventorySourceId)) + ':editInventorySourceReadWriteAccessors', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_list(filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPartnersResponse> {
			return this.http.get<ListPartnersResponse>(this.baseUri + 'v2/partners?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_partners_get(partnerId: string): Observable<Partner> {
			return this.http.get<Partner>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_partners_channels_list(partnerId: string, advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListChannelsResponse> {
			return this.http.get<ListChannelsResponse>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_partners_channels_create(partnerId: string, advertiserId: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.post<Channel>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_channels_patch(partnerId: string, channelId: string, advertiserId: string | null | undefined, updateMask: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.patch<Channel>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_channels_sites_list(partnerId: string, channelId: string, advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSitesResponse> {
			return this.http.get<ListSitesResponse>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_partners_channels_sites_delete(partnerId: string, channelId: string, urlOrAppId: string, advertiserId: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites/' + (urlOrAppId == null ? '' : encodeURIComponent(urlOrAppId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_partners_channels_sites_bulkEdit(partnerId: string, channelId: string, requestBody: BulkEditSitesRequest): Observable<BulkEditSitesResponse> {
			return this.http.post<BulkEditSitesResponse>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites:bulkEdit', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_channels_sites_replace(partnerId: string, channelId: string, requestBody: ReplaceSitesRequest): Observable<ReplaceSitesResponse> {
			return this.http.post<ReplaceSitesResponse>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites:replace', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_targetingTypes_assignedTargetingOptions_list(partnerId: string, targetingType: AssignedTargetingOptionTargetingType, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPartnerAssignedTargetingOptionsResponse> {
			return this.http.get<ListPartnerAssignedTargetingOptionsResponse>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_partners_targetingTypes_assignedTargetingOptions_create(partnerId: string, targetingType: AssignedTargetingOptionTargetingType, requestBody: AssignedTargetingOption): Observable<AssignedTargetingOption> {
			return this.http.post<AssignedTargetingOption>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_targetingTypes_assignedTargetingOptions_delete(partnerId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		...
		Displayvideo_partners_targetingTypes_assignedTargetingOptions_get(partnerId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<AssignedTargetingOption> {
			return this.http.get<AssignedTargetingOption>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		...
		Displayvideo_partners_editAssignedTargetingOptions(partnerId: string, requestBody: BulkEditPartnerAssignedTargetingOptionsRequest): Observable<BulkEditPartnerAssignedTargetingOptionsResponse> {
			return this.http.post<BulkEditPartnerAssignedTargetingOptionsResponse>(this.baseUri + 'v2/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + ':editAssignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_sdfdownloadtasks_create(requestBody: CreateSdfDownloadTaskRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v2/sdfdownloadtasks', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_targetingTypes_targetingOptions_get(targetingType: AssignedTargetingOptionTargetingType, targetingOptionId: string, advertiserId: string | null | undefined): Observable<TargetingOption> {
			return this.http.get<TargetingOption>(this.baseUri + 'v2/targetingTypes/' + targetingType + '/targetingOptions/' + (targetingOptionId == null ? '' : encodeURIComponent(targetingOptionId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_targetingTypes_targetingOptions_search(targetingType: AssignedTargetingOptionTargetingType, requestBody: SearchTargetingOptionsRequest): Observable<SearchTargetingOptionsResponse> {
			return this.http.post<SearchTargetingOptionsResponse>(this.baseUri + 'v2/targetingTypes/' + targetingType + '/targetingOptions:search', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_users_list(filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListUsersResponse> {
			return this.http.get<ListUsersResponse>(this.baseUri + 'v2/users?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_users_create(requestBody: User): Observable<User> {
			return this.http.post<User>(this.baseUri + 'v2/users', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_users_delete(userId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/users/' + (userId == null ? '' : encodeURIComponent(userId)), {});
		}
		...
		Displayvideo_users_patch(userId: string, updateMask: string | null | undefined, requestBody: User): Observable<User> {
			return this.http.patch<User>(this.baseUri + 'v2/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_users_bulkEditAssignedUserRoles(userId: string, requestBody: BulkEditAssignedUserRolesRequest): Observable<BulkEditAssignedUserRolesResponse> {
			return this.http.post<BulkEditAssignedUserRolesResponse>(this.baseUri + 'v2/users/' + (userId == null ? '' : encodeURIComponent(userId)) + ':bulkEditAssignedUserRoles', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	...
	export enum Displayvideo_advertisers_invoices_listLoiSapinInvoiceType { LOI_SAPIN_INVOICE_TYPE_UNSPECIFIED = 0, LOI_SAPIN_INVOICE_TYPE_MEDIA = 1, LOI_SAPIN_INVOICE_TYPE_PLATFORM = 2 }
