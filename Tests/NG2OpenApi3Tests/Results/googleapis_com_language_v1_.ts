...
export namespace MyNS {
	...
	export enum V2ModelContentCategoriesVersion { CONTENT_CATEGORIES_VERSION_UNSPECIFIED = 0, V1 = 1, V2 = 2 }
	...
	export class MyClient {
		...
		Language_documents_analyzeEntities(requestBody: AnalyzeEntitiesRequest): Observable<AnalyzeEntitiesResponse> {
			return this.http.post<AnalyzeEntitiesResponse>(this.baseUri + 'v1/documents:analyzeEntities', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_analyzeEntitySentiment(requestBody: AnalyzeEntitySentimentRequest): Observable<AnalyzeEntitySentimentResponse> {
			return this.http.post<AnalyzeEntitySentimentResponse>(this.baseUri + 'v1/documents:analyzeEntitySentiment', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_analyzeSentiment(requestBody: AnalyzeSentimentRequest): Observable<AnalyzeSentimentResponse> {
			return this.http.post<AnalyzeSentimentResponse>(this.baseUri + 'v1/documents:analyzeSentiment', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_analyzeSyntax(requestBody: AnalyzeSyntaxRequest): Observable<AnalyzeSyntaxResponse> {
			return this.http.post<AnalyzeSyntaxResponse>(this.baseUri + 'v1/documents:analyzeSyntax', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_annotateText(requestBody: AnnotateTextRequest): Observable<AnnotateTextResponse> {
			return this.http.post<AnnotateTextResponse>(this.baseUri + 'v1/documents:annotateText', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_classifyText(requestBody: ClassifyTextRequest): Observable<ClassifyTextResponse> {
			return this.http.post<ClassifyTextResponse>(this.baseUri + 'v1/documents:classifyText', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_moderateText(requestBody: ModerateTextRequest): Observable<ModerateTextResponse> {
			return this.http.post<ModerateTextResponse>(this.baseUri + 'v1/documents:moderateText', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
