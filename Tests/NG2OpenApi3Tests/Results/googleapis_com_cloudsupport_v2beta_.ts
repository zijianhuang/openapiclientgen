...
export namespace MyNS {
	...
	export interface CaseFormProperties {
		...
		/** REMOVED. The severity of this case. Use priority instead. */
		severity: FormControl<CaseSeverity | null | undefined>,
	...
	export function CreateCaseFormGroup() {
		return new FormGroup<CaseFormProperties>({
			...
			severity: new FormControl<CaseSeverity | null | undefined>(undefined),
	...
	export enum CasePriority { PRIORITY_UNSPECIFIED = 'PRIORITY_UNSPECIFIED', P0 = 'P0', P1 = 'P1', P2 = 'P2', P3 = 'P3', P4 = 'P4' }

	export enum CaseSeverity { SEVERITY_UNSPECIFIED = 'SEVERITY_UNSPECIFIED', S0 = 'S0', S1 = 'S1', S2 = 'S2', S3 = 'S3', S4 = 'S4' }

	export enum CaseState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', NEW = 'NEW', IN_PROGRESS_GOOGLE_SUPPORT = 'IN_PROGRESS_GOOGLE_SUPPORT', ACTION_REQUIRED = 'ACTION_REQUIRED', SOLUTION_PROVIDED = 'SOLUTION_PROVIDED', CLOSED = 'CLOSED' }
	...
	export enum EscalationReason { REASON_UNSPECIFIED = 'REASON_UNSPECIFIED', RESOLUTION_TIME = 'RESOLUTION_TIME', TECHNICAL_EXPERTISE = 'TECHNICAL_EXPERTISE', BUSINESS_IMPACT = 'BUSINESS_IMPACT' }
	...
	export enum WorkflowOperationMetadataOperationAction { OPERATION_ACTION_UNSPECIFIED = 'OPERATION_ACTION_UNSPECIFIED', CREATE_SUPPORT_ACCOUNT = 'CREATE_SUPPORT_ACCOUNT', UPDATE_SUPPORT_ACCOUNT = 'UPDATE_SUPPORT_ACCOUNT', PURCHASE_SUPPORT_ACCOUNT = 'PURCHASE_SUPPORT_ACCOUNT' }
	...
	export class MyClient {
		...
		Cloudsupport_caseClassifications_search(pageSize: number | null | undefined, pageToken: string | null | undefined, query: string | null | undefined): Observable<SearchCaseClassificationsResponse> {
			return this.http.get<SearchCaseClassificationsResponse>(this.baseUri + 'v2beta/caseClassifications:search?pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		 ...
		 */
		Cloudsupport_cases_search(pageSize: number | null | undefined, pageToken: string | null | undefined, parent: string | null | undefined, query: string | null | undefined): Observable<SearchCasesResponse> {
			return this.http.get<SearchCasesResponse>(this.baseUri + 'v2beta/cases:search?pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&parent=' + (parent == null ? '' : encodeURIComponent(parent)) + '&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		...
		Cloudsupport_cases_get(name: string): Observable<Case> {
			return this.http.get<Case>(this.baseUri + 'v2beta/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Cloudsupport_cases_patch(name: string, updateMask: string | null | undefined, requestBody: Case): Observable<Case> {
			return this.http.patch<Case>(this.baseUri + 'v2beta/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudsupport_cases_close(name: string, requestBody: CloseCaseRequest): Observable<Case> {
			return this.http.post<Case>(this.baseUri + 'v2beta/' + (name == null ? '' : encodeURIComponent(name)) + ':close', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudsupport_media_download(name: string): Observable<Media> {
			return this.http.get<Media>(this.baseUri + 'v2beta/' + (name == null ? '' : encodeURIComponent(name)) + ':download', {});
		}
		...
		Cloudsupport_cases_escalate(name: string, requestBody: EscalateCaseRequest): Observable<Case> {
			return this.http.post<Case>(this.baseUri + 'v2beta/' + (name == null ? '' : encodeURIComponent(name)) + ':escalate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudsupport_cases_attachments_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAttachmentsResponse> {
			return this.http.get<ListAttachmentsResponse>(this.baseUri + 'v2beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/attachments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudsupport_cases_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCasesResponse> {
			return this.http.get<ListCasesResponse>(this.baseUri + 'v2beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/cases&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudsupport_cases_create(parent: string, requestBody: Case): Observable<Case> {
			return this.http.post<Case>(this.baseUri + 'v2beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/cases', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudsupport_cases_comments_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCommentsResponse> {
			return this.http.get<ListCommentsResponse>(this.baseUri + 'v2beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/comments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudsupport_cases_comments_create(parent: string, requestBody: Comment): Observable<Comment> {
			return this.http.post<Comment>(this.baseUri + 'v2beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/comments', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
