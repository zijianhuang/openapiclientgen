...
export namespace MyNS {
	...
	export enum FolderState { STATE_UNSPECIFIED = 0, ACTIVE = 1, DELETE_REQUESTED = 2 }
	...
	export enum TagKeyPurpose { PURPOSE_UNSPECIFIED = 0, GCE_FIREWALL = 1, DATA_GOVERNANCE = 2 }
