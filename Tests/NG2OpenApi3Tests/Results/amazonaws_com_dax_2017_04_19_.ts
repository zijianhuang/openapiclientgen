...
export namespace MyNS {
	...
	export interface ClusterFormProperties {
		...
		ClusterEndpointEncryptionType: FormControl<ClusterEndpointEncryptionType | null | undefined>,
	}
	export function CreateClusterFormGroup() {
		return new FormGroup<ClusterFormProperties>({
			...
			ClusterEndpointEncryptionType: new FormControl<ClusterEndpointEncryptionType | null | undefined>(undefined),
		});
	...
	export function CreateParameterFormGroup() {
		return new FormGroup<ParameterFormProperties>({
			...
			ParameterType: new FormControl<ParameterType | null | undefined>(undefined),
			...
			IsModifiable: new FormControl<IsModifiable | null | undefined>(undefined),
