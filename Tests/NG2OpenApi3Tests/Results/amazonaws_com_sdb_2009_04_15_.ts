...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {Array<string>} Items A list of items on which to perform the operation.
		 * @return {void} Success
		 */
		GET_BatchDeleteAttributes(DomainName: string, Items: Array<string>, Action: GET_BatchDeleteAttributesAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '#Action=BatchDeleteAttributes?DomainName=' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '&' + Items.map(z => `Items=${encodeURIComponent(z)}`).join('&') + '&Action=' + Action + '&Version=' + Version, { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_BatchPutAttributes(DomainName: string, Items: Array<string>, Action: GET_BatchPutAttributesAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '#Action=BatchPutAttributes?DomainName=' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '&' + Items.map(z => `Items=${encodeURIComponent(z)}`).join('&') + '&Action=' + Action + '&Version=' + Version, { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateDomain(DomainName: string, Action: GET_CreateDomainAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @param {Array<string>} Attributes A list of Attributes. Similar to columns on a spreadsheet, attributes represent categories of data that can be assigned to items.
		 ...
		 * @return {void} Success
		 */
		GET_DeleteAttributes(DomainName: string, ItemName: string, Attributes: Array<string> | null | undefined, Expected: GET_DeleteAttributesExpected | null | undefined, Action: GET_DeleteAttributesAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '#Action=DeleteAttributes?DomainName=' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '&ItemName=' + (ItemName == null ? '' : encodeURIComponent(ItemName)) + '&' + Attributes?.map(z => `Attributes=${encodeURIComponent(z)}`).join('&') + '&Expected=' + Expected + '&Action=' + Action + '&Version=' + Version, { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteDomain(DomainName: string, Action: GET_DeleteDomainAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DomainMetadata(DomainName: string, Action: GET_DomainMetadataAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_GetAttributes(DomainName: string, ItemName: string, AttributeNames: Array<string> | null | undefined, ConsistentRead: boolean | null | undefined, Action: GET_GetAttributesAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_ListDomains(MaxNumberOfDomains: number | null | undefined, NextToken: string | null | undefined, Action: GET_ListDomainsAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
		 ...
		 * @param {string} DomainName The name of the domain in which to perform the operation.
		 * @param {string} ItemName The name of the item.
		 * @param {Array<string>} Attributes The list of attributes.
		 ...
		 * @return {void} Success
		 */
		GET_PutAttributes(DomainName: string, ItemName: string, Attributes: Array<string>, Expected: GET_PutAttributesExpected | null | undefined, Action: GET_PutAttributesAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '#Action=PutAttributes?DomainName=' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '&ItemName=' + (ItemName == null ? '' : encodeURIComponent(ItemName)) + '&' + Attributes.map(z => `Attributes=${encodeURIComponent(z)}`).join('&') + '&Expected=' + Expected + '&Action=' + Action + '&Version=' + Version, { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_Select(SelectExpression: string, NextToken: string | null | undefined, ConsistentRead: boolean | null | undefined, Action: GET_SelectAction, Version: GET_BatchDeleteAttributesVersion): Observable<HttpResponse<string>> {
