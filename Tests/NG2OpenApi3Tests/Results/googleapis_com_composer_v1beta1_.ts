...
export namespace MyNS {
	...
	export enum SoftwareConfigWebServerPluginsMode { WEB_SERVER_PLUGINS_MODE_UNSPECIFIED = 'WEB_SERVER_PLUGINS_MODE_UNSPECIFIED', PLUGINS_DISABLED = 'PLUGINS_DISABLED', PLUGINS_ENABLED = 'PLUGINS_ENABLED' }
	...
	export enum OperationMetadataState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', PENDING = 'PENDING', RUNNING = 'RUNNING', SUCCESSFUL = 'SUCCESSFUL', FAILED = 'FAILED' }
