...
export namespace MyNS {
	...
	export enum CustomEventEventType { UNKNOWN = 0, INSERT = 1, ANNOTATE = 2 }
	...
	export enum CustomEventInsertInsertEventType { UNKNOWN = 0, IMPRESSION = 1, CLICK = 2 }
	...
	export enum CustomEventErrorCode { UNKNOWN = 0, INVALID_ARGUMENT = 1, INTERNAL = 2, PERMISSION_DENIED = 3, NOT_FOUND = 4 }
	...
	export enum EventTagSiteFilterType { WHITELIST = 0, BLACKLIST = 1 }
	...
	export enum FileStatus { PROCESSING = 0, REPORT_AVAILABLE = 1, FAILED = 2, CANCELLED = 3 }
	...
	export enum OrderDocumentType { PLANNING_ORDER_TYPE_INSERTION_ORDER = 0, PLANNING_ORDER_TYPE_CHANGE_ORDER = 1 }
