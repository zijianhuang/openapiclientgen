...
export namespace MyNS {
	...
	export enum AccountAccountProfile { ACCOUNT_PROFILE_BASIC = 'ACCOUNT_PROFILE_BASIC', ACCOUNT_PROFILE_STANDARD = 'ACCOUNT_PROFILE_STANDARD' }

	export enum AccountActiveAdsLimitTier { ACTIVE_ADS_TIER_40K = 'ACTIVE_ADS_TIER_40K', ACTIVE_ADS_TIER_75K = 'ACTIVE_ADS_TIER_75K', ACTIVE_ADS_TIER_100K = 'ACTIVE_ADS_TIER_100K', ACTIVE_ADS_TIER_200K = 'ACTIVE_ADS_TIER_200K', ACTIVE_ADS_TIER_300K = 'ACTIVE_ADS_TIER_300K', ACTIVE_ADS_TIER_500K = 'ACTIVE_ADS_TIER_500K', ACTIVE_ADS_TIER_750K = 'ACTIVE_ADS_TIER_750K', ACTIVE_ADS_TIER_1M = 'ACTIVE_ADS_TIER_1M' }
	...
	export enum AccountPermissionLevel { USER = 'USER', ADMINISTRATOR = 'ADMINISTRATOR' }
	...
	export enum ObjectFilterStatus { NONE = 'NONE', ASSIGNED = 'ASSIGNED', ALL = 'ALL' }

	export enum AccountUserProfileTraffickerType { INTERNAL_NON_TRAFFICKER = 'INTERNAL_NON_TRAFFICKER', INTERNAL_TRAFFICKER = 'INTERNAL_TRAFFICKER', EXTERNAL_TRAFFICKER = 'EXTERNAL_TRAFFICKER' }

	export enum AccountUserProfileUserAccessType { NORMAL_USER = 'NORMAL_USER', SUPER_USER = 'SUPER_USER', INTERNAL_ADMINISTRATOR = 'INTERNAL_ADMINISTRATOR', READ_ONLY_SUPER_USER = 'READ_ONLY_SUPER_USER' }
	...
	export enum AdCompatibility { DISPLAY = 'DISPLAY', DISPLAY_INTERSTITIAL = 'DISPLAY_INTERSTITIAL', APP = 'APP', APP_INTERSTITIAL = 'APP_INTERSTITIAL', IN_STREAM_VIDEO = 'IN_STREAM_VIDEO', IN_STREAM_AUDIO = 'IN_STREAM_AUDIO' }
	...
	export enum CreativeGroupAssignmentCreativeGroupNumber { CREATIVE_GROUP_ONE = 'CREATIVE_GROUP_ONE', CREATIVE_GROUP_TWO = 'CREATIVE_GROUP_TWO' }
	...
	export enum CreativeRotationType { CREATIVE_ROTATION_TYPE_SEQUENTIAL = 'CREATIVE_ROTATION_TYPE_SEQUENTIAL', CREATIVE_ROTATION_TYPE_RANDOM = 'CREATIVE_ROTATION_TYPE_RANDOM' }

	export enum CreativeRotationWeightCalculationStrategy { WEIGHT_STRATEGY_EQUAL = 'WEIGHT_STRATEGY_EQUAL', WEIGHT_STRATEGY_CUSTOM = 'WEIGHT_STRATEGY_CUSTOM', WEIGHT_STRATEGY_HIGHEST_CTR = 'WEIGHT_STRATEGY_HIGHEST_CTR', WEIGHT_STRATEGY_OPTIMIZED = 'WEIGHT_STRATEGY_OPTIMIZED' }
	...
	export enum DeliverySchedulePriority { AD_PRIORITY_01 = 'AD_PRIORITY_01', AD_PRIORITY_02 = 'AD_PRIORITY_02', AD_PRIORITY_03 = 'AD_PRIORITY_03', AD_PRIORITY_04 = 'AD_PRIORITY_04', AD_PRIORITY_05 = 'AD_PRIORITY_05', AD_PRIORITY_06 = 'AD_PRIORITY_06', AD_PRIORITY_07 = 'AD_PRIORITY_07', AD_PRIORITY_08 = 'AD_PRIORITY_08', AD_PRIORITY_09 = 'AD_PRIORITY_09', AD_PRIORITY_10 = 'AD_PRIORITY_10', AD_PRIORITY_11 = 'AD_PRIORITY_11', AD_PRIORITY_12 = 'AD_PRIORITY_12', AD_PRIORITY_13 = 'AD_PRIORITY_13', AD_PRIORITY_14 = 'AD_PRIORITY_14', AD_PRIORITY_15 = 'AD_PRIORITY_15', AD_PRIORITY_16 = 'AD_PRIORITY_16' }
	...
	export enum AdType { AD_SERVING_STANDARD_AD = 'AD_SERVING_STANDARD_AD', AD_SERVING_DEFAULT_AD = 'AD_SERVING_DEFAULT_AD', AD_SERVING_CLICK_TRACKER = 'AD_SERVING_CLICK_TRACKER', AD_SERVING_TRACKING = 'AD_SERVING_TRACKING', AD_SERVING_BRAND_SAFE_AD = 'AD_SERVING_BRAND_SAFE_AD' }
	...
	export enum AdSlotPaymentSourceType { PLANNING_PAYMENT_SOURCE_TYPE_AGENCY_PAID = 'PLANNING_PAYMENT_SOURCE_TYPE_AGENCY_PAID', PLANNING_PAYMENT_SOURCE_TYPE_PUBLISHER_PAID = 'PLANNING_PAYMENT_SOURCE_TYPE_PUBLISHER_PAID' }
	...
	export enum AdvertiserStatus { APPROVED = 'APPROVED', ON_HOLD = 'ON_HOLD' }
	...
	export enum MobileAppDirectory { UNKNOWN = 'UNKNOWN', APPLE_APP_STORE = 'APPLE_APP_STORE', GOOGLE_PLAY_STORE = 'GOOGLE_PLAY_STORE', ROKU_APP_STORE = 'ROKU_APP_STORE', AMAZON_FIRETV_APP_STORE = 'AMAZON_FIRETV_APP_STORE', PLAYSTATION_APP_STORE = 'PLAYSTATION_APP_STORE', APPLE_TV_APP_STORE = 'APPLE_TV_APP_STORE', XBOX_APP_STORE = 'XBOX_APP_STORE', SAMSUNG_TV_APP_STORE = 'SAMSUNG_TV_APP_STORE', ANDROID_TV_APP_STORE = 'ANDROID_TV_APP_STORE', GENERIC_CTV_APP_STORE = 'GENERIC_CTV_APP_STORE' }
	...
	export enum CreativeOptimizationConfigurationOptimizationModel { CLICK = 'CLICK', POST_CLICK = 'POST_CLICK', POST_IMPRESSION = 'POST_IMPRESSION', POST_CLICK_AND_IMPRESSION = 'POST_CLICK_AND_IMPRESSION', VIDEO_COMPLETION = 'VIDEO_COMPLETION' }
	...
	export interface CampaignManagerIds {
	...
	/** Campaign Manager IDs related to the custom event. */
	export interface CampaignManagerIdsFormProperties {
	...
	export function CreateCampaignManagerIdsFormGroup() {
		return new FormGroup<CampaignManagerIdsFormProperties>({
	...
	export enum ConversionErrorCode { INVALID_ARGUMENT = 'INVALID_ARGUMENT', INTERNAL = 'INTERNAL', PERMISSION_DENIED = 'PERMISSION_DENIED', NOT_FOUND = 'NOT_FOUND' }
	...
	export enum EncryptionInfoEncryptionEntityType { ENCRYPTION_ENTITY_TYPE_UNKNOWN = 'ENCRYPTION_ENTITY_TYPE_UNKNOWN', DCM_ACCOUNT = 'DCM_ACCOUNT', DCM_ADVERTISER = 'DCM_ADVERTISER', DBM_PARTNER = 'DBM_PARTNER', DBM_ADVERTISER = 'DBM_ADVERTISER', ADWORDS_CUSTOMER = 'ADWORDS_CUSTOMER', DFP_NETWORK_CODE = 'DFP_NETWORK_CODE' }

	export enum EncryptionInfoEncryptionSource { ENCRYPTION_SCOPE_UNKNOWN = 'ENCRYPTION_SCOPE_UNKNOWN', AD_SERVING = 'AD_SERVING', DATA_TRANSFER = 'DATA_TRANSFER' }
	...
	export enum CreativeArtworkType { ARTWORK_TYPE_FLASH = 'ARTWORK_TYPE_FLASH', ARTWORK_TYPE_HTML5 = 'ARTWORK_TYPE_HTML5', ARTWORK_TYPE_MIXED = 'ARTWORK_TYPE_MIXED', ARTWORK_TYPE_IMAGE = 'ARTWORK_TYPE_IMAGE' }

	export enum CreativeAuthoringSource { CREATIVE_AUTHORING_SOURCE_DCM = 'CREATIVE_AUTHORING_SOURCE_DCM', CREATIVE_AUTHORING_SOURCE_DBM = 'CREATIVE_AUTHORING_SOURCE_DBM', CREATIVE_AUTHORING_SOURCE_STUDIO = 'CREATIVE_AUTHORING_SOURCE_STUDIO', CREATIVE_AUTHORING_SOURCE_GWD = 'CREATIVE_AUTHORING_SOURCE_GWD', CREATIVE_AUTHORING_SOURCE_ACS = 'CREATIVE_AUTHORING_SOURCE_ACS' }

	export enum CreativeAuthoringTool { NINJA = 'NINJA', SWIFFY = 'SWIFFY' }
	...
	export enum TargetWindowTargetWindowOption { NEW_WINDOW = 'NEW_WINDOW', CURRENT_WINDOW = 'CURRENT_WINDOW', CUSTOM = 'CUSTOM' }
	...
	export enum CreativeAssetAlignment { ALIGNMENT_TOP = 'ALIGNMENT_TOP', ALIGNMENT_RIGHT = 'ALIGNMENT_RIGHT', ALIGNMENT_BOTTOM = 'ALIGNMENT_BOTTOM', ALIGNMENT_LEFT = 'ALIGNMENT_LEFT' }
	...
	export enum CreativeAssetChildAssetType { CHILD_ASSET_TYPE_FLASH = 'CHILD_ASSET_TYPE_FLASH', CHILD_ASSET_TYPE_VIDEO = 'CHILD_ASSET_TYPE_VIDEO', CHILD_ASSET_TYPE_IMAGE = 'CHILD_ASSET_TYPE_IMAGE', CHILD_ASSET_TYPE_DATA = 'CHILD_ASSET_TYPE_DATA' }

	export enum CreativeAssetDisplayType { ASSET_DISPLAY_TYPE_INPAGE = 'ASSET_DISPLAY_TYPE_INPAGE', ASSET_DISPLAY_TYPE_FLOATING = 'ASSET_DISPLAY_TYPE_FLOATING', ASSET_DISPLAY_TYPE_OVERLAY = 'ASSET_DISPLAY_TYPE_OVERLAY', ASSET_DISPLAY_TYPE_EXPANDING = 'ASSET_DISPLAY_TYPE_EXPANDING', ASSET_DISPLAY_TYPE_FLASH_IN_FLASH = 'ASSET_DISPLAY_TYPE_FLASH_IN_FLASH', ASSET_DISPLAY_TYPE_FLASH_IN_FLASH_EXPANDING = 'ASSET_DISPLAY_TYPE_FLASH_IN_FLASH_EXPANDING', ASSET_DISPLAY_TYPE_PEEL_DOWN = 'ASSET_DISPLAY_TYPE_PEEL_DOWN', ASSET_DISPLAY_TYPE_VPAID_LINEAR = 'ASSET_DISPLAY_TYPE_VPAID_LINEAR', ASSET_DISPLAY_TYPE_VPAID_NON_LINEAR = 'ASSET_DISPLAY_TYPE_VPAID_NON_LINEAR', ASSET_DISPLAY_TYPE_BACKDROP = 'ASSET_DISPLAY_TYPE_BACKDROP' }

	export enum CreativeAssetDurationType { ASSET_DURATION_TYPE_AUTO = 'ASSET_DURATION_TYPE_AUTO', ASSET_DURATION_TYPE_NONE = 'ASSET_DURATION_TYPE_NONE', ASSET_DURATION_TYPE_CUSTOM = 'ASSET_DURATION_TYPE_CUSTOM' }

	export enum CreativeAssetOrientation { LANDSCAPE = 'LANDSCAPE', PORTRAIT = 'PORTRAIT', SQUARE = 'SQUARE' }

	export enum CreativeAssetPositionLeftUnit { OFFSET_UNIT_PIXEL = 'OFFSET_UNIT_PIXEL', OFFSET_UNIT_PERCENT = 'OFFSET_UNIT_PERCENT', OFFSET_UNIT_PIXEL_FROM_CENTER = 'OFFSET_UNIT_PIXEL_FROM_CENTER' }

	export enum CreativeAssetRole { PRIMARY = 'PRIMARY', BACKUP_IMAGE = 'BACKUP_IMAGE', ADDITIONAL_IMAGE = 'ADDITIONAL_IMAGE', ADDITIONAL_FLASH = 'ADDITIONAL_FLASH', PARENT_VIDEO = 'PARENT_VIDEO', TRANSCODED_VIDEO = 'TRANSCODED_VIDEO', OTHER = 'OTHER', ALTERNATE_VIDEO = 'ALTERNATE_VIDEO', PARENT_AUDIO = 'PARENT_AUDIO', TRANSCODED_AUDIO = 'TRANSCODED_AUDIO' }

	export enum CreativeAssetStartTimeType { ASSET_START_TIME_TYPE_NONE = 'ASSET_START_TIME_TYPE_NONE', ASSET_START_TIME_TYPE_CUSTOM = 'ASSET_START_TIME_TYPE_CUSTOM' }

	export enum CreativeAssetWindowMode { OPAQUE = 'OPAQUE', WINDOW = 'WINDOW', TRANSPARENT = 'TRANSPARENT' }
	...
	export enum FsCommandPositionOption { CENTERED = 'CENTERED', DISTANCE_FROM_TOP_LEFT_CORNER = 'DISTANCE_FROM_TOP_LEFT_CORNER' }
	...
	export enum ThirdPartyTrackingUrlThirdPartyUrlType { IMPRESSION = 'IMPRESSION', CLICK_TRACKING = 'CLICK_TRACKING', VIDEO_START = 'VIDEO_START', VIDEO_FIRST_QUARTILE = 'VIDEO_FIRST_QUARTILE', VIDEO_MIDPOINT = 'VIDEO_MIDPOINT', VIDEO_THIRD_QUARTILE = 'VIDEO_THIRD_QUARTILE', VIDEO_COMPLETE = 'VIDEO_COMPLETE', VIDEO_MUTE = 'VIDEO_MUTE', VIDEO_PAUSE = 'VIDEO_PAUSE', VIDEO_REWIND = 'VIDEO_REWIND', VIDEO_FULLSCREEN = 'VIDEO_FULLSCREEN', VIDEO_STOP = 'VIDEO_STOP', VIDEO_CUSTOM = 'VIDEO_CUSTOM', SURVEY = 'SURVEY', RICH_MEDIA_IMPRESSION = 'RICH_MEDIA_IMPRESSION', RICH_MEDIA_RM_IMPRESSION = 'RICH_MEDIA_RM_IMPRESSION', RICH_MEDIA_BACKUP_IMPRESSION = 'RICH_MEDIA_BACKUP_IMPRESSION', VIDEO_SKIP = 'VIDEO_SKIP', VIDEO_PROGRESS = 'VIDEO_PROGRESS' }

	export enum CreativeType { IMAGE = 'IMAGE', DISPLAY_REDIRECT = 'DISPLAY_REDIRECT', CUSTOM_DISPLAY = 'CUSTOM_DISPLAY', INTERNAL_REDIRECT = 'INTERNAL_REDIRECT', CUSTOM_DISPLAY_INTERSTITIAL = 'CUSTOM_DISPLAY_INTERSTITIAL', INTERSTITIAL_INTERNAL_REDIRECT = 'INTERSTITIAL_INTERNAL_REDIRECT', TRACKING_TEXT = 'TRACKING_TEXT', RICH_MEDIA_DISPLAY_BANNER = 'RICH_MEDIA_DISPLAY_BANNER', RICH_MEDIA_INPAGE_FLOATING = 'RICH_MEDIA_INPAGE_FLOATING', RICH_MEDIA_IM_EXPAND = 'RICH_MEDIA_IM_EXPAND', RICH_MEDIA_DISPLAY_EXPANDING = 'RICH_MEDIA_DISPLAY_EXPANDING', RICH_MEDIA_DISPLAY_INTERSTITIAL = 'RICH_MEDIA_DISPLAY_INTERSTITIAL', RICH_MEDIA_DISPLAY_MULTI_FLOATING_INTERSTITIAL = 'RICH_MEDIA_DISPLAY_MULTI_FLOATING_INTERSTITIAL', RICH_MEDIA_MOBILE_IN_APP = 'RICH_MEDIA_MOBILE_IN_APP', FLASH_INPAGE = 'FLASH_INPAGE', INSTREAM_VIDEO = 'INSTREAM_VIDEO', VPAID_LINEAR_VIDEO = 'VPAID_LINEAR_VIDEO', VPAID_NON_LINEAR_VIDEO = 'VPAID_NON_LINEAR_VIDEO', INSTREAM_VIDEO_REDIRECT = 'INSTREAM_VIDEO_REDIRECT', RICH_MEDIA_PEEL_DOWN = 'RICH_MEDIA_PEEL_DOWN', HTML5_BANNER = 'HTML5_BANNER', DISPLAY = 'DISPLAY', DISPLAY_IMAGE_GALLERY = 'DISPLAY_IMAGE_GALLERY', BRAND_SAFE_DEFAULT_INSTREAM_VIDEO = 'BRAND_SAFE_DEFAULT_INSTREAM_VIDEO', INSTREAM_AUDIO = 'INSTREAM_AUDIO' }
	...
	export enum UniversalAdIdRegistry { OTHER = 'OTHER', AD_ID_OFFICIAL = 'AD_ID_OFFICIAL', CLEARCAST = 'CLEARCAST', DCM = 'DCM' }
	...
	export interface CustomEvent {
		...
		eventType?: CustomEventEventType | null;
	...
	/** Experimental feature (no support provided) A custom event represents a third party impression, a third party click, an annotation on a first party impression, or an annotation on a first party click. */
	export interface CustomEventFormProperties {

		/** The type of event. If INSERT, the fields in insertEvent need to be populated. If ANNOTATE, the fields in either annotateClickEvent or annotateImpressionEvent need to be populated. */
		eventType: FormControl<CustomEventEventType | null | undefined>,
	...
	export function CreateCustomEventFormGroup() {
		return new FormGroup<CustomEventFormProperties>({
			eventType: new FormControl<CustomEventEventType | null | undefined>(undefined),
			floodlightConfigurationId: new FormControl<string | null | undefined>(undefined),
			kind: new FormControl<string | null | undefined>(undefined),
			ordinal: new FormControl<string | null | undefined>(undefined),
			timestampMicros: new FormControl<string | null | undefined>(undefined),
	...
	/** Annotate a click event. */
	export interface CustomEventClickAnnotation {
	...
	/** Annotate a click event. */
	export interface CustomEventClickAnnotationFormProperties {
	...
	export function CreateCustomEventClickAnnotationFormGroup() {
		return new FormGroup<CustomEventClickAnnotationFormProperties>({
			gclid: new FormControl<string | null | undefined>(undefined),
			kind: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Annotate an impression. */
	export interface CustomEventImpressionAnnotation {
	...
	/** Annotate an impression. */
	export interface CustomEventImpressionAnnotationFormProperties {

		/** Identifies what kind of resource this is. Value: the fixed string "dfareporting#customEventImpressionAnnotation". */
		kind: FormControl<string | null | undefined>,

		/** The path impression ID. Use this field to annotate the impression associated with the pathImpressionId. */
		pathImpressionId: FormControl<string | null | undefined>,
	}
	export function CreateCustomEventImpressionAnnotationFormGroup() {
		return new FormGroup<CustomEventImpressionAnnotationFormProperties>({
			kind: new FormControl<string | null | undefined>(undefined),
			pathImpressionId: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Custom variable. */
	export interface CustomVariableFormProperties {
	...
	export function CreateCustomVariableFormGroup() {
		return new FormGroup<CustomVariableFormProperties>({
	...
	export enum CustomEventEventType { UNKNOWN = 'UNKNOWN', INSERT = 'INSERT', ANNOTATE = 'ANNOTATE' }
	...
	export interface CustomEventInsert {
		...
		insertEventType?: CustomEventInsertInsertEventType | null;
	...
	/** Custom event to be inserted. */
	export interface CustomEventInsertFormProperties {

		/** The type of event to insert. */
		insertEventType: FormControl<CustomEventInsertInsertEventType | null | undefined>,
	...
	export function CreateCustomEventInsertFormGroup() {
		return new FormGroup<CustomEventInsertFormProperties>({
			insertEventType: new FormControl<CustomEventInsertInsertEventType | null | undefined>(undefined),
			kind: new FormControl<string | null | undefined>(undefined),
			matchId: new FormControl<string | null | undefined>(undefined),
			mobileDeviceId: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** DV360 IDs related to the custom event. */
	export interface DV3IdsFormProperties {

		/** Campaign ID for DV360. */
		dvCampaignId: FormControl<string | null | undefined>,

		/** Creative ID for DV360. */
		dvCreativeId: FormControl<string | null | undefined>,

		/** Insertion Order ID for DV360. */
		dvInsertionOrderId: FormControl<string | null | undefined>,

		/** Line Item ID for DV360. */
		dvLineItemId: FormControl<string | null | undefined>,

		/** Site ID for DV360. */
		dvSiteId: FormControl<string | null | undefined>,

		/** Identifies what kind of resource this is. Value: the fixed string "dfareporting#dV3Ids". */
		kind: FormControl<string | null | undefined>,
	}
	export function CreateDV3IdsFormGroup() {
		return new FormGroup<DV3IdsFormProperties>({
			dvCampaignId: new FormControl<string | null | undefined>(undefined),
			dvCreativeId: new FormControl<string | null | undefined>(undefined),
			dvInsertionOrderId: new FormControl<string | null | undefined>(undefined),
			dvLineItemId: new FormControl<string | null | undefined>(undefined),
			dvSiteId: new FormControl<string | null | undefined>(undefined),
			kind: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum CustomEventInsertInsertEventType { UNKNOWN = 'UNKNOWN', IMPRESSION = 'IMPRESSION', CLICK = 'CLICK' }
	...
	export interface CustomEventError {
		...
		/** The error code. */
		code?: CustomEventErrorCode | null;
	...
	/** The error code and description for a custom event that failed to insert. */
	export interface CustomEventErrorFormProperties {

		/** The error code. */
		code: FormControl<CustomEventErrorCode | null | undefined>,
	...
	export function CreateCustomEventErrorFormGroup() {
		return new FormGroup<CustomEventErrorFormProperties>({
			code: new FormControl<CustomEventErrorCode | null | undefined>(undefined),
			kind: new FormControl<string | null | undefined>(undefined),
			message: new FormControl<string | null | undefined>(undefined),
		});
	...
	export enum CustomEventErrorCode { UNKNOWN = 'UNKNOWN', INVALID_ARGUMENT = 'INVALID_ARGUMENT', INTERNAL = 'INTERNAL', PERMISSION_DENIED = 'PERMISSION_DENIED', NOT_FOUND = 'NOT_FOUND' }


	/** The original custom event that was inserted and whether there were any errors. */
	export interface CustomEventStatus {

		/** Experimental feature (no support provided) A custom event represents a third party impression, a third party click, an annotation on a first party impression, or an annotation on a first party click. */
		customEvent?: CustomEvent;

		/** A list of errors related to this custom event. */
		errors?: Array<CustomEventError>;
	...
	/** The original custom event that was inserted and whether there were any errors. */
	export interface CustomEventStatusFormProperties {

		/** Identifies what kind of resource this is. Value: the fixed string "dfareporting#customEventStatus". */
		kind: FormControl<string | null | undefined>,
	}
	export function CreateCustomEventStatusFormGroup() {
		return new FormGroup<CustomEventStatusFormProperties>({
			kind: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface CustomEventsBatchInsertRequest {
	...
	/** Insert Custom Events Request. */
	export interface CustomEventsBatchInsertRequestFormProperties {

		/** Identifies what kind of resource this is. Value: the fixed string "dfareporting#customEventsBatchInsertRequest". */
		kind: FormControl<string | null | undefined>,
	}
	export function CreateCustomEventsBatchInsertRequestFormGroup() {
		return new FormGroup<CustomEventsBatchInsertRequestFormProperties>({
			kind: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface CustomEventsBatchInsertResponse {
		...
		status?: Array<CustomEventStatus>;
	}

	/** Insert Custom Events Response. */
	export interface CustomEventsBatchInsertResponseFormProperties {
	...
	export function CreateCustomEventsBatchInsertResponseFormGroup() {
		return new FormGroup<CustomEventsBatchInsertResponseFormProperties>({
			hasFailures: new FormControl<boolean | null | undefined>(undefined),
			kind: new FormControl<string | null | undefined>(undefined),
		});
	...
	export enum DateRangeRelativeDateRange { TODAY = 'TODAY', YESTERDAY = 'YESTERDAY', WEEK_TO_DATE = 'WEEK_TO_DATE', MONTH_TO_DATE = 'MONTH_TO_DATE', QUARTER_TO_DATE = 'QUARTER_TO_DATE', YEAR_TO_DATE = 'YEAR_TO_DATE', PREVIOUS_WEEK = 'PREVIOUS_WEEK', PREVIOUS_MONTH = 'PREVIOUS_MONTH', PREVIOUS_QUARTER = 'PREVIOUS_QUARTER', PREVIOUS_YEAR = 'PREVIOUS_YEAR', LAST_7_DAYS = 'LAST_7_DAYS', LAST_30_DAYS = 'LAST_30_DAYS', LAST_90_DAYS = 'LAST_90_DAYS', LAST_365_DAYS = 'LAST_365_DAYS', LAST_24_MONTHS = 'LAST_24_MONTHS', LAST_14_DAYS = 'LAST_14_DAYS', LAST_60_DAYS = 'LAST_60_DAYS' }
	...
	export enum DynamicTargetingKeyObjectType { OBJECT_ADVERTISER = 'OBJECT_ADVERTISER', OBJECT_AD = 'OBJECT_AD', OBJECT_CREATIVE = 'OBJECT_CREATIVE', OBJECT_PLACEMENT = 'OBJECT_PLACEMENT' }
	...
	export enum EventTagSiteFilterType { WHITELIST = 'WHITELIST', BLACKLIST = 'BLACKLIST' }

	export enum EventTagStatus { ENABLED = 'ENABLED', DISABLED = 'DISABLED' }

	export enum EventTagType { IMPRESSION_IMAGE_EVENT_TAG = 'IMPRESSION_IMAGE_EVENT_TAG', IMPRESSION_JAVASCRIPT_EVENT_TAG = 'IMPRESSION_JAVASCRIPT_EVENT_TAG', CLICK_THROUGH_EVENT_TAG = 'CLICK_THROUGH_EVENT_TAG' }
	...
	export enum FileFormat { CSV = 'CSV', EXCEL = 'EXCEL' }

	export enum FileStatus { PROCESSING = 'PROCESSING', REPORT_AVAILABLE = 'REPORT_AVAILABLE', FAILED = 'FAILED', CANCELLED = 'CANCELLED' }
	...
	export enum FloodlightActivityCacheBustingType { JAVASCRIPT = 'JAVASCRIPT', ACTIVE_SERVER_PAGE = 'ACTIVE_SERVER_PAGE', JSP = 'JSP', PHP = 'PHP', COLD_FUSION = 'COLD_FUSION' }

	export enum FloodlightActivityCountingMethod { STANDARD_COUNTING = 'STANDARD_COUNTING', UNIQUE_COUNTING = 'UNIQUE_COUNTING', SESSION_COUNTING = 'SESSION_COUNTING', TRANSACTIONS_COUNTING = 'TRANSACTIONS_COUNTING', ITEMS_SOLD_COUNTING = 'ITEMS_SOLD_COUNTING' }
	...
	export enum FloodlightActivityFloodlightActivityGroupType { COUNTER = 'COUNTER', SALE = 'SALE' }

	export enum FloodlightActivityFloodlightTagType { IFRAME = 'IFRAME', IMAGE = 'IMAGE', GLOBAL_SITE_TAG = 'GLOBAL_SITE_TAG' }
	...
	export enum FloodlightActivityStatus { ACTIVE = 'ACTIVE', ARCHIVED_AND_DISABLED = 'ARCHIVED_AND_DISABLED', ARCHIVED = 'ARCHIVED', DISABLED_POLICY = 'DISABLED_POLICY' }

	export enum FloodlightActivityTagFormat { HTML = 'HTML', XHTML = 'XHTML' }
	...
	export enum FloodlightConfigurationFirstDayOfWeek { MONDAY = 'MONDAY', SUNDAY = 'SUNDAY' }

	export enum FloodlightConfigurationNaturalSearchConversionAttributionOption { EXCLUDE_NATURAL_SEARCH_CONVERSION_ATTRIBUTION = 'EXCLUDE_NATURAL_SEARCH_CONVERSION_ATTRIBUTION', INCLUDE_NATURAL_SEARCH_CONVERSION_ATTRIBUTION = 'INCLUDE_NATURAL_SEARCH_CONVERSION_ATTRIBUTION', INCLUDE_NATURAL_SEARCH_TIERED_CONVERSION_ATTRIBUTION = 'INCLUDE_NATURAL_SEARCH_TIERED_CONVERSION_ATTRIBUTION' }
	...
	export enum UserDefinedVariableConfigurationDataType { STRING = 'STRING', NUMBER = 'NUMBER' }
	...
	export enum PricingCapCostType { PLANNING_PLACEMENT_CAP_COST_TYPE_NONE = 'PLANNING_PLACEMENT_CAP_COST_TYPE_NONE', PLANNING_PLACEMENT_CAP_COST_TYPE_MONTHLY = 'PLANNING_PLACEMENT_CAP_COST_TYPE_MONTHLY', PLANNING_PLACEMENT_CAP_COST_TYPE_CUMULATIVE = 'PLANNING_PLACEMENT_CAP_COST_TYPE_CUMULATIVE' }

	export enum PricingGroupType { PLANNING_PLACEMENT_GROUP_TYPE_PACKAGE = 'PLANNING_PLACEMENT_GROUP_TYPE_PACKAGE', PLANNING_PLACEMENT_GROUP_TYPE_ROADBLOCK = 'PLANNING_PLACEMENT_GROUP_TYPE_ROADBLOCK' }

	export enum PricingPricingType { PLANNING_PLACEMENT_PRICING_TYPE_IMPRESSIONS = 'PLANNING_PLACEMENT_PRICING_TYPE_IMPRESSIONS', PLANNING_PLACEMENT_PRICING_TYPE_CPM = 'PLANNING_PLACEMENT_PRICING_TYPE_CPM', PLANNING_PLACEMENT_PRICING_TYPE_CLICKS = 'PLANNING_PLACEMENT_PRICING_TYPE_CLICKS', PLANNING_PLACEMENT_PRICING_TYPE_CPC = 'PLANNING_PLACEMENT_PRICING_TYPE_CPC', PLANNING_PLACEMENT_PRICING_TYPE_CPA = 'PLANNING_PLACEMENT_PRICING_TYPE_CPA', PLANNING_PLACEMENT_PRICING_TYPE_FLAT_RATE_IMPRESSIONS = 'PLANNING_PLACEMENT_PRICING_TYPE_FLAT_RATE_IMPRESSIONS', PLANNING_PLACEMENT_PRICING_TYPE_FLAT_RATE_CLICKS = 'PLANNING_PLACEMENT_PRICING_TYPE_FLAT_RATE_CLICKS', PLANNING_PLACEMENT_PRICING_TYPE_CPM_ACTIVEVIEW = 'PLANNING_PLACEMENT_PRICING_TYPE_CPM_ACTIVEVIEW' }

	export enum InventoryItemType { PLANNING_PLACEMENT_TYPE_REGULAR = 'PLANNING_PLACEMENT_TYPE_REGULAR', PLANNING_PLACEMENT_TYPE_CREDIT = 'PLANNING_PLACEMENT_TYPE_CREDIT' }
	...
	export enum ListPopulationTermOperator { NUM_EQUALS = 'NUM_EQUALS', NUM_LESS_THAN = 'NUM_LESS_THAN', NUM_LESS_THAN_EQUAL = 'NUM_LESS_THAN_EQUAL', NUM_GREATER_THAN = 'NUM_GREATER_THAN', NUM_GREATER_THAN_EQUAL = 'NUM_GREATER_THAN_EQUAL', STRING_EQUALS = 'STRING_EQUALS', STRING_CONTAINS = 'STRING_CONTAINS' }

	export enum ListPopulationTermType { CUSTOM_VARIABLE_TERM = 'CUSTOM_VARIABLE_TERM', LIST_MEMBERSHIP_TERM = 'LIST_MEMBERSHIP_TERM', REFERRER_TERM = 'REFERRER_TERM' }
	...
	export enum OrderContactContactType { PLANNING_ORDER_CONTACT_BUYER_CONTACT = 'PLANNING_ORDER_CONTACT_BUYER_CONTACT', PLANNING_ORDER_CONTACT_BUYER_BILLING_CONTACT = 'PLANNING_ORDER_CONTACT_BUYER_BILLING_CONTACT', PLANNING_ORDER_CONTACT_SELLER_CONTACT = 'PLANNING_ORDER_CONTACT_SELLER_CONTACT' }
	...
	export enum OrderDocumentType { PLANNING_ORDER_TYPE_INSERTION_ORDER = 'PLANNING_ORDER_TYPE_INSERTION_ORDER', PLANNING_ORDER_TYPE_CHANGE_ORDER = 'PLANNING_ORDER_TYPE_CHANGE_ORDER' }
	...
	export enum PathFilterPathMatchPosition { PATH_MATCH_POSITION_UNSPECIFIED = 'PATH_MATCH_POSITION_UNSPECIFIED', ANY = 'ANY', FIRST = 'FIRST', LAST = 'LAST' }
	...
	export enum PlacementPaymentSource { PLACEMENT_AGENCY_PAID = 'PLACEMENT_AGENCY_PAID', PLACEMENT_PUBLISHER_PAID = 'PLACEMENT_PUBLISHER_PAID' }
	...
	export enum PricingScheduleCapCostOption { CAP_COST_NONE = 'CAP_COST_NONE', CAP_COST_MONTHLY = 'CAP_COST_MONTHLY', CAP_COST_CUMULATIVE = 'CAP_COST_CUMULATIVE' }
	...
	export enum PricingSchedulePricingType { PRICING_TYPE_CPM = 'PRICING_TYPE_CPM', PRICING_TYPE_CPC = 'PRICING_TYPE_CPC', PRICING_TYPE_CPA = 'PRICING_TYPE_CPA', PRICING_TYPE_FLAT_RATE_IMPRESSIONS = 'PRICING_TYPE_FLAT_RATE_IMPRESSIONS', PRICING_TYPE_FLAT_RATE_CLICKS = 'PRICING_TYPE_FLAT_RATE_CLICKS', PRICING_TYPE_CPM_ACTIVEVIEW = 'PRICING_TYPE_CPM_ACTIVEVIEW' }

	export enum PlacementStatus { PENDING_REVIEW = 'PENDING_REVIEW', PAYMENT_ACCEPTED = 'PAYMENT_ACCEPTED', PAYMENT_REJECTED = 'PAYMENT_REJECTED', ACKNOWLEDGE_REJECTION = 'ACKNOWLEDGE_REJECTION', ACKNOWLEDGE_ACCEPTANCE = 'ACKNOWLEDGE_ACCEPTANCE', DRAFT = 'DRAFT' }
	...
	export enum TagSettingKeywordOption { PLACEHOLDER_WITH_LIST_OF_KEYWORDS = 'PLACEHOLDER_WITH_LIST_OF_KEYWORDS', IGNORE = 'IGNORE', GENERATE_SEPARATE_TAG_FOR_EACH_KEYWORD = 'GENERATE_SEPARATE_TAG_FOR_EACH_KEYWORD' }
	...
	export enum VideoSettingsOrientation { ANY = 'ANY', LANDSCAPE = 'LANDSCAPE', PORTRAIT = 'PORTRAIT' }
	...
	export enum PlacementVpaidAdapterChoice { DEFAULT = 'DEFAULT', FLASH = 'FLASH', HTML5 = 'HTML5', BOTH = 'BOTH' }
	...
	export enum PlacementGroupPlacementGroupType { PLACEMENT_PACKAGE = 'PLACEMENT_PACKAGE', PLACEMENT_ROADBLOCK = 'PLACEMENT_ROADBLOCK' }
	...
	export enum TagDataFormat { PLACEMENT_TAG_STANDARD = 'PLACEMENT_TAG_STANDARD', PLACEMENT_TAG_IFRAME_JAVASCRIPT = 'PLACEMENT_TAG_IFRAME_JAVASCRIPT', PLACEMENT_TAG_IFRAME_ILAYER = 'PLACEMENT_TAG_IFRAME_ILAYER', PLACEMENT_TAG_INTERNAL_REDIRECT = 'PLACEMENT_TAG_INTERNAL_REDIRECT', PLACEMENT_TAG_JAVASCRIPT = 'PLACEMENT_TAG_JAVASCRIPT', PLACEMENT_TAG_INTERSTITIAL_IFRAME_JAVASCRIPT = 'PLACEMENT_TAG_INTERSTITIAL_IFRAME_JAVASCRIPT', PLACEMENT_TAG_INTERSTITIAL_INTERNAL_REDIRECT = 'PLACEMENT_TAG_INTERSTITIAL_INTERNAL_REDIRECT', PLACEMENT_TAG_INTERSTITIAL_JAVASCRIPT = 'PLACEMENT_TAG_INTERSTITIAL_JAVASCRIPT', PLACEMENT_TAG_CLICK_COMMANDS = 'PLACEMENT_TAG_CLICK_COMMANDS', PLACEMENT_TAG_INSTREAM_VIDEO_PREFETCH = 'PLACEMENT_TAG_INSTREAM_VIDEO_PREFETCH', PLACEMENT_TAG_TRACKING = 'PLACEMENT_TAG_TRACKING', PLACEMENT_TAG_TRACKING_IFRAME = 'PLACEMENT_TAG_TRACKING_IFRAME', PLACEMENT_TAG_TRACKING_JAVASCRIPT = 'PLACEMENT_TAG_TRACKING_JAVASCRIPT', PLACEMENT_TAG_INSTREAM_VIDEO_PREFETCH_VAST_3 = 'PLACEMENT_TAG_INSTREAM_VIDEO_PREFETCH_VAST_3', PLACEMENT_TAG_IFRAME_JAVASCRIPT_LEGACY = 'PLACEMENT_TAG_IFRAME_JAVASCRIPT_LEGACY', PLACEMENT_TAG_JAVASCRIPT_LEGACY = 'PLACEMENT_TAG_JAVASCRIPT_LEGACY', PLACEMENT_TAG_INTERSTITIAL_IFRAME_JAVASCRIPT_LEGACY = 'PLACEMENT_TAG_INTERSTITIAL_IFRAME_JAVASCRIPT_LEGACY', PLACEMENT_TAG_INTERSTITIAL_JAVASCRIPT_LEGACY = 'PLACEMENT_TAG_INTERSTITIAL_JAVASCRIPT_LEGACY', PLACEMENT_TAG_INSTREAM_VIDEO_PREFETCH_VAST_4 = 'PLACEMENT_TAG_INSTREAM_VIDEO_PREFETCH_VAST_4', PLACEMENT_TAG_TRACKING_THIRD_PARTY_MEASUREMENT = 'PLACEMENT_TAG_TRACKING_THIRD_PARTY_MEASUREMENT' }
	...
	export enum ProjectAudienceAgeGroup { PLANNING_AUDIENCE_AGE_18_24 = 'PLANNING_AUDIENCE_AGE_18_24', PLANNING_AUDIENCE_AGE_25_34 = 'PLANNING_AUDIENCE_AGE_25_34', PLANNING_AUDIENCE_AGE_35_44 = 'PLANNING_AUDIENCE_AGE_35_44', PLANNING_AUDIENCE_AGE_45_54 = 'PLANNING_AUDIENCE_AGE_45_54', PLANNING_AUDIENCE_AGE_55_64 = 'PLANNING_AUDIENCE_AGE_55_64', PLANNING_AUDIENCE_AGE_65_OR_MORE = 'PLANNING_AUDIENCE_AGE_65_OR_MORE', PLANNING_AUDIENCE_AGE_UNKNOWN = 'PLANNING_AUDIENCE_AGE_UNKNOWN' }

	export enum ProjectAudienceGender { PLANNING_AUDIENCE_GENDER_MALE = 'PLANNING_AUDIENCE_GENDER_MALE', PLANNING_AUDIENCE_GENDER_FEMALE = 'PLANNING_AUDIENCE_GENDER_FEMALE' }
	...
	export enum RecipientDeliveryType { LINK = 'LINK', ATTACHMENT = 'ATTACHMENT' }
	...
	export enum RemarketingListListSource { REMARKETING_LIST_SOURCE_OTHER = 'REMARKETING_LIST_SOURCE_OTHER', REMARKETING_LIST_SOURCE_ADX = 'REMARKETING_LIST_SOURCE_ADX', REMARKETING_LIST_SOURCE_DFP = 'REMARKETING_LIST_SOURCE_DFP', REMARKETING_LIST_SOURCE_XFP = 'REMARKETING_LIST_SOURCE_XFP', REMARKETING_LIST_SOURCE_DFA = 'REMARKETING_LIST_SOURCE_DFA', REMARKETING_LIST_SOURCE_GA = 'REMARKETING_LIST_SOURCE_GA', REMARKETING_LIST_SOURCE_YOUTUBE = 'REMARKETING_LIST_SOURCE_YOUTUBE', REMARKETING_LIST_SOURCE_DBM = 'REMARKETING_LIST_SOURCE_DBM', REMARKETING_LIST_SOURCE_GPLUS = 'REMARKETING_LIST_SOURCE_GPLUS', REMARKETING_LIST_SOURCE_DMP = 'REMARKETING_LIST_SOURCE_DMP', REMARKETING_LIST_SOURCE_PLAY_STORE = 'REMARKETING_LIST_SOURCE_PLAY_STORE' }
	...
	export enum SortedDimensionSortOrder { ASCENDING = 'ASCENDING', DESCENDING = 'DESCENDING' }
	...
	export enum ReportCrossDimensionReachCriteriaDimension { ADVERTISER = 'ADVERTISER', CAMPAIGN = 'CAMPAIGN', SITE_BY_ADVERTISER = 'SITE_BY_ADVERTISER', SITE_BY_CAMPAIGN = 'SITE_BY_CAMPAIGN' }
	...
	export enum ReportScheduleRunsOnDayOfMonth { DAY_OF_MONTH = 'DAY_OF_MONTH', WEEK_OF_MONTH = 'WEEK_OF_MONTH' }

	export enum ReportType { STANDARD = 'STANDARD', REACH = 'REACH', PATH_TO_CONVERSION = 'PATH_TO_CONVERSION', CROSS_DIMENSION_REACH = 'CROSS_DIMENSION_REACH', FLOODLIGHT = 'FLOODLIGHT', PATH = 'PATH', PATH_ATTRIBUTION = 'PATH_ATTRIBUTION' }
	...
	export enum SiteContactContactType { SALES_PERSON = 'SALES_PERSON', TRAFFICKER = 'TRAFFICKER' }
	...
	export enum UserRolePermissionAvailability { NOT_AVAILABLE_BY_DEFAULT = 'NOT_AVAILABLE_BY_DEFAULT', ACCOUNT_BY_DEFAULT = 'ACCOUNT_BY_DEFAULT', SUBACCOUNT_AND_ACCOUNT_BY_DEFAULT = 'SUBACCOUNT_AND_ACCOUNT_BY_DEFAULT', ACCOUNT_ALWAYS = 'ACCOUNT_ALWAYS', SUBACCOUNT_AND_ACCOUNT_ALWAYS = 'SUBACCOUNT_AND_ACCOUNT_ALWAYS', USER_PROFILE_ONLY = 'USER_PROFILE_ONLY' }
	...
	export enum VideoFormatFileType { FLV = 'FLV', THREEGPP = 'THREEGPP', MP4 = 'MP4', WEBM = 'WEBM', M3U8 = 'M3U8' }
	...
	export class MyClient {
		 ...
		 * @param {string} profileId User profile ID associated with this request.
		 * @return {CustomEventsBatchInsertResponse} Successful response
		 */
		Dfareporting_customEvents_batchinsert(profileId: string, requestBody: CustomEventsBatchInsertRequest): Observable<CustomEventsBatchInsertResponse> {
			return this.http.post<CustomEventsBatchInsertResponse>(this.baseUri + 'userprofiles/' + (profileId == null ? '' : encodeURIComponent(profileId)) + '/customEvents/batchinsert', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {OrderDocument} Successful response
		 */
		Dfareporting_orderDocuments_get(profileId: string, projectId: string, id: string): Observable<OrderDocument> {
			return this.http.get<OrderDocument>(this.baseUri + 'userprofiles/' + (profileId == null ? '' : encodeURIComponent(profileId)) + '/projects/' + (projectId == null ? '' : encodeURIComponent(projectId)) + '/orderDocuments/' + (id == null ? '' : encodeURIComponent(id)), {});
		}
	...
	export enum Dfareporting_accountUserProfiles_listSortField { ID = 'ID', NAME = 'NAME' }

	export enum Dfareporting_changeLogs_listAction { ACTION_CREATE = 'ACTION_CREATE', ACTION_UPDATE = 'ACTION_UPDATE', ACTION_DELETE = 'ACTION_DELETE', ACTION_ENABLE = 'ACTION_ENABLE', ACTION_DISABLE = 'ACTION_DISABLE', ACTION_ADD = 'ACTION_ADD', ACTION_REMOVE = 'ACTION_REMOVE', ACTION_MARK_AS_DEFAULT = 'ACTION_MARK_AS_DEFAULT', ACTION_ASSOCIATE = 'ACTION_ASSOCIATE', ACTION_ASSIGN = 'ACTION_ASSIGN', ACTION_UNASSIGN = 'ACTION_UNASSIGN', ACTION_SEND = 'ACTION_SEND', ACTION_LINK = 'ACTION_LINK', ACTION_UNLINK = 'ACTION_UNLINK', ACTION_PUSH = 'ACTION_PUSH', ACTION_EMAIL_TAGS = 'ACTION_EMAIL_TAGS', ACTION_SHARE = 'ACTION_SHARE' }

	export enum Dfareporting_changeLogs_listObjectType { OBJECT_ADVERTISER = 'OBJECT_ADVERTISER', OBJECT_FLOODLIGHT_CONFIGURATION = 'OBJECT_FLOODLIGHT_CONFIGURATION', OBJECT_AD = 'OBJECT_AD', OBJECT_FLOODLIGHT_ACTVITY = 'OBJECT_FLOODLIGHT_ACTVITY', OBJECT_CAMPAIGN = 'OBJECT_CAMPAIGN', OBJECT_FLOODLIGHT_ACTIVITY_GROUP = 'OBJECT_FLOODLIGHT_ACTIVITY_GROUP', OBJECT_CREATIVE = 'OBJECT_CREATIVE', OBJECT_PLACEMENT = 'OBJECT_PLACEMENT', OBJECT_DFA_SITE = 'OBJECT_DFA_SITE', OBJECT_USER_ROLE = 'OBJECT_USER_ROLE', OBJECT_USER_PROFILE = 'OBJECT_USER_PROFILE', OBJECT_ADVERTISER_GROUP = 'OBJECT_ADVERTISER_GROUP', OBJECT_ACCOUNT = 'OBJECT_ACCOUNT', OBJECT_SUBACCOUNT = 'OBJECT_SUBACCOUNT', OBJECT_RICHMEDIA_CREATIVE = 'OBJECT_RICHMEDIA_CREATIVE', OBJECT_INSTREAM_CREATIVE = 'OBJECT_INSTREAM_CREATIVE', OBJECT_MEDIA_ORDER = 'OBJECT_MEDIA_ORDER', OBJECT_CONTENT_CATEGORY = 'OBJECT_CONTENT_CATEGORY', OBJECT_PLACEMENT_STRATEGY = 'OBJECT_PLACEMENT_STRATEGY', OBJECT_SD_SITE = 'OBJECT_SD_SITE', OBJECT_SIZE = 'OBJECT_SIZE', OBJECT_CREATIVE_GROUP = 'OBJECT_CREATIVE_GROUP', OBJECT_CREATIVE_ASSET = 'OBJECT_CREATIVE_ASSET', OBJECT_USER_PROFILE_FILTER = 'OBJECT_USER_PROFILE_FILTER', OBJECT_LANDING_PAGE = 'OBJECT_LANDING_PAGE', OBJECT_CREATIVE_FIELD = 'OBJECT_CREATIVE_FIELD', OBJECT_REMARKETING_LIST = 'OBJECT_REMARKETING_LIST', OBJECT_PROVIDED_LIST_CLIENT = 'OBJECT_PROVIDED_LIST_CLIENT', OBJECT_EVENT_TAG = 'OBJECT_EVENT_TAG', OBJECT_CREATIVE_BUNDLE = 'OBJECT_CREATIVE_BUNDLE', OBJECT_BILLING_ACCOUNT_GROUP = 'OBJECT_BILLING_ACCOUNT_GROUP', OBJECT_BILLING_FEATURE = 'OBJECT_BILLING_FEATURE', OBJECT_RATE_CARD = 'OBJECT_RATE_CARD', OBJECT_ACCOUNT_BILLING_FEATURE = 'OBJECT_ACCOUNT_BILLING_FEATURE', OBJECT_BILLING_MINIMUM_FEE = 'OBJECT_BILLING_MINIMUM_FEE', OBJECT_BILLING_PROFILE = 'OBJECT_BILLING_PROFILE', OBJECT_PLAYSTORE_LINK = 'OBJECT_PLAYSTORE_LINK', OBJECT_TARGETING_TEMPLATE = 'OBJECT_TARGETING_TEMPLATE', OBJECT_SEARCH_LIFT_STUDY = 'OBJECT_SEARCH_LIFT_STUDY', OBJECT_FLOODLIGHT_DV360_LINK = 'OBJECT_FLOODLIGHT_DV360_LINK', OBJECT_ADVERTISER_CUSTOMER_LINK = 'OBJECT_ADVERTISER_CUSTOMER_LINK' }

	export enum Dfareporting_creativeFieldValues_listSortField { ID = 'ID', VALUE = 'VALUE' }

	export enum Dfareporting_files_listScope { ALL = 'ALL', MINE = 'MINE', SHARED_WITH_ME = 'SHARED_WITH_ME' }

	export enum Dfareporting_files_listSortField { ID = 'ID', LAST_MODIFIED_TIME = 'LAST_MODIFIED_TIME' }

	export enum Dfareporting_reports_listScope { ALL = 'ALL', MINE = 'MINE' }

	export enum Dfareporting_reports_listSortField { ID = 'ID', LAST_MODIFIED_TIME = 'LAST_MODIFIED_TIME', NAME = 'NAME' }
