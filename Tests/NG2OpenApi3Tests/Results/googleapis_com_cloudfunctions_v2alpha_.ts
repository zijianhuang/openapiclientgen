...
export namespace MyNS {
	...
	export interface GoogleCloudFunctionsV2alphaStateMessage {
		...
		severity?: GoogleCloudFunctionsV2alphaStateMessageSeverity | null;
	...
	export interface GoogleCloudFunctionsV2alphaStateMessageFormProperties {
		...
		/** Severity of the state message. */
		severity: FormControl<GoogleCloudFunctionsV2alphaStateMessageSeverity | null | undefined>,
	...
	export function CreateGoogleCloudFunctionsV2alphaStateMessageFormGroup() {
		return new FormGroup<GoogleCloudFunctionsV2alphaStateMessageFormProperties>({
			...
			severity: new FormControl<GoogleCloudFunctionsV2alphaStateMessageSeverity | null | undefined>(undefined),
			type: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudFunctionsV2alphaStateMessageSeverity { SEVERITY_UNSPECIFIED = 'SEVERITY_UNSPECIFIED', ERROR = 'ERROR', WARNING = 'WARNING', INFO = 'INFO' }
	...
	export class MyClient {
		...
		Cloudfunctions_projects_locations_functions_delete(name: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v2alpha/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Cloudfunctions_projects_locations_functions_patch(name: string, updateMask: string | null | undefined, requestBody: Function): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v2alpha/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudfunctions_projects_locations_functions_generateDownloadUrl(name: string, requestBody: GenerateDownloadUrlRequest): Observable<GenerateDownloadUrlResponse> {
			return this.http.post<GenerateDownloadUrlResponse>(this.baseUri + 'v2alpha/' + (name == null ? '' : encodeURIComponent(name)) + ':generateDownloadUrl', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudfunctions_projects_locations_functions_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListFunctionsResponse> {
			return this.http.get<ListFunctionsResponse>(this.baseUri + 'v2alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/functions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudfunctions_projects_locations_functions_create(parent: string, functionId: string | null | undefined, requestBody: Function): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v2alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/functions&functionId=' + (functionId == null ? '' : encodeURIComponent(functionId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudfunctions_projects_locations_functions_generateUploadUrl(parent: string, requestBody: GenerateUploadUrlRequest): Observable<GenerateUploadUrlResponse> {
			return this.http.post<GenerateUploadUrlResponse>(this.baseUri + 'v2alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/functions:generateUploadUrl', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudfunctions_projects_locations_runtimes_list(parent: string, filter: string | null | undefined): Observable<ListRuntimesResponse> {
			return this.http.get<ListRuntimesResponse>(this.baseUri + 'v2alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/runtimes&filter=' + (filter == null ? '' : encodeURIComponent(filter)), {});
		}
		...
		Cloudfunctions_projects_locations_functions_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<Policy> {
			return this.http.get<Policy>(this.baseUri + 'v2alpha/' + (resource == null ? '' : encodeURIComponent(resource)) + ':getIamPolicy&options_requestedPolicyVersion=' + options_requestedPolicyVersion, {});
		}
		...
		Cloudfunctions_projects_locations_functions_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
			return this.http.post<Policy>(this.baseUri + 'v2alpha/' + (resource == null ? '' : encodeURIComponent(resource)) + ':setIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudfunctions_projects_locations_functions_testIamPermissions(resource: string, requestBody: TestIamPermissionsRequest): Observable<TestIamPermissionsResponse> {
			return this.http.post<TestIamPermissionsResponse>(this.baseUri + 'v2alpha/' + (resource == null ? '' : encodeURIComponent(resource)) + ':testIamPermissions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
