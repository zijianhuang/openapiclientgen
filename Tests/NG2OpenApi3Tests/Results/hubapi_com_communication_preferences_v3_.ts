...
export namespace MyNS {
	...
	export enum PublicSubscriptionStatusLegalBasis { LEGITIMATE_INTEREST_PQL = 0, LEGITIMATE_INTEREST_CLIENT = 1, PERFORMANCE_OF_CONTRACT = 2, CONSENT_WITH_NOTICE = 3, NON_GDPR = 4, PROCESS_AND_STORE = 5, LEGITIMATE_INTEREST_OTHER = 6 }

	export enum PublicSubscriptionStatusSourceOfStatus { PORTAL_WIDE_STATUS = 0, BRAND_WIDE_STATUS = 1, SUBSCRIPTION_STATUS = 2 }

	export enum PublicSubscriptionStatusStatus { SUBSCRIBED = 0, NOT_SUBSCRIBED = 1 }
