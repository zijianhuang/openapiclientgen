...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * Post v1alpha1/{parent}/externalAccountKeys
		...
		Publicca_projects_locations_externalAccountKeys_create(parent: string, requestBody: ExternalAccountKey): Observable<ExternalAccountKey> {
			return this.http.post<ExternalAccountKey>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/externalAccountKeys', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
