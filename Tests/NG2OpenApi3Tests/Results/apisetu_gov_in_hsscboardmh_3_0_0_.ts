...
export namespace MyNS {
	...
	export interface HpcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		exsession: FormControl<string | null | undefined>,
		 ...
		 * Required
		 */
		totalmarks: FormControl<string | null | undefined>,
	...
	export function CreateHpcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<HpcerPostBodyCertificateParametersFormProperties>({
			...
			exsession: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollnumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			totalmarks: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum HpcerPostBodyFormat { xml = 'xml', pdf = 'pdf' }
