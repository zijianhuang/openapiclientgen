...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {PmjayPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Pmjay(requestBody: PmjayPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'pmjay/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface PmjayPostBody {
		certificateParameters?: PmjayPostBodyCertificateParameters;
	...
	export interface PmjayPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<PmjayPostBodyFormat | null | undefined>,
	...
	export function CreatePmjayPostBodyFormGroup() {
		return new FormGroup<PmjayPostBodyFormProperties>({
			format: new FormControl<PmjayPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface PmjayPostBodyCertificateParameters {
	...
	export interface PmjayPostBodyCertificateParametersFormProperties {
	...
	export function CreatePmjayPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PmjayPostBodyCertificateParametersFormProperties>({
	...
	export enum PmjayPostBodyFormat { pdf = 'pdf' }
