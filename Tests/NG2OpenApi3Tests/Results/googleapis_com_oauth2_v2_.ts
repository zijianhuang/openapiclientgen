...
export namespace MyNS {
	...
	export class MyClient {
		...
		Oauth2_tokeninfo(access_token: string | null | undefined, id_token: string | null | undefined): Observable<Tokeninfo> {
			return this.http.post<Tokeninfo>(this.baseUri + 'oauth2/v2/tokeninfo?access_token=' + (access_token == null ? '' : encodeURIComponent(access_token)) + '&id_token=' + (id_token == null ? '' : encodeURIComponent(id_token)), null, {});
		}
		...
		Oauth2_userinfo_get(): Observable<Userinfo> {
			return this.http.get<Userinfo>(this.baseUri + 'oauth2/v2/userinfo', {});
		}
