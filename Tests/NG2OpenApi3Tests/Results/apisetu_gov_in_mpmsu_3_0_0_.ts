...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {PvcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Pvcer(requestBody: PvcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'pvcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface MicerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<MicerPostBodyFormat | null | undefined>,
	...
	export function CreateMicerPostBodyFormGroup() {
		return new FormGroup<MicerPostBodyFormProperties>({
			format: new FormControl<MicerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface MicerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		APPNO: FormControl<string | null | undefined>,
		 ...
		 * Required
		 */
		ENROLNO: FormControl<string | null | undefined>,
	...
	export function CreateMicerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<MicerPostBodyCertificateParametersFormProperties>({
			APPNO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Date_Of_Birth: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			ENROLNO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export interface PvcerPostBodyFormProperties {
	...
	export function CreatePvcerPostBodyFormGroup() {
		return new FormGroup<PvcerPostBodyFormProperties>({
			format: new FormControl<MicerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PvcerPostBodyCertificateParameters {
	...
	export interface PvcerPostBodyCertificateParametersFormProperties {
	...
	export function CreatePvcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PvcerPostBodyCertificateParametersFormProperties>({
			APPNO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Date_Of_Birth: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			ENROLNO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			ROLLNO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
