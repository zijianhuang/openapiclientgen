...
export namespace MyNS {
	...
	export enum Auth { PLAIN_TEXT = 0, SECRET_ARN = 1 }

	export enum Status { CREATING = 0, ACTIVE = 1, DELETING = 2, UPDATING = 3, VPC_ENDPOINT_LIMIT_EXCEEDED = 4, IP_ADDRESS_LIMIT_EXCEEDED = 5, INVALID_SECURITY_GROUP_ID = 6, INVALID_SUBNET_ID = 7, INACCESSIBLE_ENCRYPTION_CREDS = 8 }
