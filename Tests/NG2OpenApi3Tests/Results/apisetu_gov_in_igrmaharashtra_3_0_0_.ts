...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {LlcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Llcer(requestBody: LlcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'llcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface LlcerPostBody {
		certificateParameters?: LlcerPostBodyCertificateParameters;
	...
	export interface LlcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<LlcerPostBodyFormat | null | undefined>,
	...
	export function CreateLlcerPostBodyFormGroup() {
		return new FormGroup<LlcerPostBodyFormProperties>({
			format: new FormControl<LlcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface LlcerPostBodyCertificateParameters {
	...
	export interface LlcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateLlcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<LlcerPostBodyCertificateParametersFormProperties>({
	...
	export enum LlcerPostBodyFormat { pdf = 'pdf' }
