...
export namespace MyNS {
	...
	export interface AlsfcPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<AlsfcPostBodyFormat | null | undefined>,
	...
	export function CreateAlsfcPostBodyFormGroup() {
		return new FormGroup<AlsfcPostBodyFormProperties>({
			format: new FormControl<AlsfcPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface AlsfcPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		lino: FormControl<string | null | undefined>,
	}
	export function CreateAlsfcPostBodyCertificateParametersFormGroup() {
		return new FormGroup<AlsfcPostBodyCertificateParametersFormProperties>({
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			lino: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
