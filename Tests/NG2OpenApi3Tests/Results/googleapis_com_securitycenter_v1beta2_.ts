...
export namespace MyNS {
	...
	export enum ConfigModuleEnablementState { ENABLEMENT_STATE_UNSPECIFIED = 0, INHERITED = 1, ENABLED = 2, DISABLED = 3 }
	...
	export enum DetailsType { TYPE_UNSPECIFIED = 0, STANDARD = 1, TRIAL = 2, ALPHA = 3, DEMO = 4, PAY_AS_YOU_GO = 5 }
	...
	export enum SubscriptionTier { TIER_UNSPECIFIED = 0, STANDARD = 1, PREMIUM = 2, ENTERPRISE = 3 }
