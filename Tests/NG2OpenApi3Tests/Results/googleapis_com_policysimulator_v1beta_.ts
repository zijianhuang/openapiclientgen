...
export namespace MyNS {
	...
	export interface GoogleCloudPolicysimulatorV1betaAccessStateDiff {
		...
		accessChange?: GoogleCloudPolicysimulatorV1betaAccessStateDiffAccessChange | null;
	...
	/** A summary and comparison of the principal's access under the current (baseline) policies and the proposed (simulated) policies for a single access tuple. */
	export interface GoogleCloudPolicysimulatorV1betaAccessStateDiffFormProperties {

		/** How the principal's access, specified in the AccessState field, changed between the current (baseline) policies and proposed (simulated) policies. */
		accessChange: FormControl<GoogleCloudPolicysimulatorV1betaAccessStateDiffAccessChange | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaAccessStateDiffFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaAccessStateDiffFormProperties>({
			accessChange: new FormControl<GoogleCloudPolicysimulatorV1betaAccessStateDiffAccessChange | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudPolicysimulatorV1betaAccessStateDiffAccessChange { ACCESS_CHANGE_TYPE_UNSPECIFIED = 'ACCESS_CHANGE_TYPE_UNSPECIFIED', NO_CHANGE = 'NO_CHANGE', UNKNOWN_CHANGE = 'UNKNOWN_CHANGE', ACCESS_REVOKED = 'ACCESS_REVOKED', ACCESS_GAINED = 'ACCESS_GAINED', ACCESS_MAYBE_REVOKED = 'ACCESS_MAYBE_REVOKED', ACCESS_MAYBE_GAINED = 'ACCESS_MAYBE_GAINED' }
	...
	export interface GoogleCloudPolicysimulatorV1betaExplainedAccess {
		...
		accessState?: GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState | null;
	...
	/** Details about how a set of policies, listed in ExplainedPolicy, resulted in a certain AccessState when replaying an access tuple. */
	export interface GoogleCloudPolicysimulatorV1betaExplainedAccessFormProperties {

		/** Whether the principal in the access tuple has permission to access the resource in the access tuple under the given policies. */
		accessState: FormControl<GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaExplainedAccessFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaExplainedAccessFormProperties>({
			accessState: new FormControl<GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState { ACCESS_STATE_UNSPECIFIED = 'ACCESS_STATE_UNSPECIFIED', GRANTED = 'GRANTED', NOT_GRANTED = 'NOT_GRANTED', UNKNOWN_CONDITIONAL = 'UNKNOWN_CONDITIONAL', UNKNOWN_INFO_DENIED = 'UNKNOWN_INFO_DENIED' }
	...
	export interface GoogleCloudPolicysimulatorV1betaExplainedPolicy {
		...
		access?: GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState | null;
		...
		relevance?: GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null;
	}

	/** Details about how a specific IAM Policy contributed to the access check. */
	export interface GoogleCloudPolicysimulatorV1betaExplainedPolicyFormProperties {

		/** Indicates whether _this policy_ provides the specified permission to the specified principal for the specified resource. This field does _not_ indicate whether the principal actually has the permission for the resource. There might be another policy that overrides this policy. To determine whether the principal actually has the permission, use the `access` field in the TroubleshootIamPolicyResponse. */
		access: FormControl<GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState | null | undefined>,

		/** The full resource name that identifies the resource. For example, `//compute.googleapis.com/projects/my-project/zones/us-central1-a/instances/my-instance`. If the user who created the Replay does not have access to the policy, this field is omitted. For examples of full resource names for Google Cloud services, see https://cloud.google.com/iam/help/troubleshooter/full-resource-names. */
		fullResourceName: FormControl<string | null | undefined>,

		/** The relevance of this policy to the overall determination in the TroubleshootIamPolicyResponse. If the user who created the Replay does not have access to the policy, this field is omitted. */
		relevance: FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaExplainedPolicyFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaExplainedPolicyFormProperties>({
			access: new FormControl<GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState | null | undefined>(undefined),
			fullResourceName: new FormControl<string | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudPolicysimulatorV1betaBindingExplanation {
		...
		memberships?: {[id: string]: GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership };
		...
		rolePermission?: GoogleCloudPolicysimulatorV1betaBindingExplanationRolePermission | null;

		/** The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy. */
		rolePermissionRelevance?: GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null;
	}

	/** Details about how a binding in a policy affects a principal's ability to use a permission. */
	export interface GoogleCloudPolicysimulatorV1betaBindingExplanationFormProperties {

		/** Required. Indicates whether _this binding_ provides the specified permission to the specified principal for the specified resource. This field does _not_ indicate whether the principal actually has the permission for the resource. There might be another binding that overrides this binding. To determine whether the principal actually has the permission, use the `access` field in the TroubleshootIamPolicyResponse. */
		access: FormControl<GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState | null | undefined>,

		/** Indicates whether each principal in the binding includes the principal specified in the request, either directly or indirectly. Each key identifies a principal in the binding, and each value indicates whether the principal in the binding includes the principal in the request. For example, suppose that a binding includes the following principals: * `user:alice@example.com` * `group:product-eng@example.com` The principal in the replayed access tuple is `user:bob@example.com`. This user is a principal of the group `group:product-eng@example.com`. For the first principal in the binding, the key is `user:alice@example.com`, and the `membership` field in the value is set to `MEMBERSHIP_NOT_INCLUDED`. For the second principal in the binding, the key is `group:product-eng@example.com`, and the `membership` field in the value is set to `MEMBERSHIP_INCLUDED`. */
		memberships: FormControl<{[id: string]: GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership } | null | undefined>,
		...
		/** Indicates whether the role granted by this binding contains the specified permission. */
		rolePermission: FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationRolePermission | null | undefined>,

		/** The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy. */
		rolePermissionRelevance: FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaBindingExplanationFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaBindingExplanationFormProperties>({
			access: new FormControl<GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState | null | undefined>(undefined),
			memberships: new FormControl<{[id: string]: GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership } | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
			role: new FormControl<string | null | undefined>(undefined),
			rolePermission: new FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationRolePermission | null | undefined>(undefined),
			rolePermissionRelevance: new FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership {
		...
		membership?: GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipMembership | null;
	...
	/** Details about whether the binding includes the principal. */
	export interface GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipFormProperties {

		/** Indicates whether the binding includes the principal. */
		membership: FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipMembership | null | undefined>,

		/** The relevance of the principal's status to the overall determination for the binding. */
		relevance: FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipFormProperties>({
			membership: new FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipMembership | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipMembership { MEMBERSHIP_UNSPECIFIED = 'MEMBERSHIP_UNSPECIFIED', MEMBERSHIP_INCLUDED = 'MEMBERSHIP_INCLUDED', MEMBERSHIP_NOT_INCLUDED = 'MEMBERSHIP_NOT_INCLUDED', MEMBERSHIP_UNKNOWN_INFO_DENIED = 'MEMBERSHIP_UNKNOWN_INFO_DENIED', MEMBERSHIP_UNKNOWN_UNSUPPORTED = 'MEMBERSHIP_UNKNOWN_UNSUPPORTED' }

	export enum GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance { HEURISTIC_RELEVANCE_UNSPECIFIED = 'HEURISTIC_RELEVANCE_UNSPECIFIED', NORMAL = 'NORMAL', HIGH = 'HIGH' }

	export enum GoogleCloudPolicysimulatorV1betaBindingExplanationRolePermission { ROLE_PERMISSION_UNSPECIFIED = 'ROLE_PERMISSION_UNSPECIFIED', ROLE_PERMISSION_INCLUDED = 'ROLE_PERMISSION_INCLUDED', ROLE_PERMISSION_NOT_INCLUDED = 'ROLE_PERMISSION_NOT_INCLUDED', ROLE_PERMISSION_UNKNOWN_INFO_DENIED = 'ROLE_PERMISSION_UNKNOWN_INFO_DENIED' }
	...
	/** Information about the principal, resource, and permission to check. */
	export interface GoogleCloudPolicysimulatorV1betaAccessTupleFormProperties {
	...
	export function CreateGoogleCloudPolicysimulatorV1betaAccessTupleFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaAccessTupleFormProperties>({
			fullResourceName: new FormControl<string | null | undefined>(undefined),
	...
	/** ListOrgPolicyViolationsPreviewsResponse is the response message for OrgPolicyViolationsPreviewService.ListOrgPolicyViolationsPreviews. */
	export interface GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponseFormProperties {

		/** A token that you can use to retrieve the next page of results. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponseFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponseFormProperties>({
	...
	/** ListOrgPolicyViolationsResponse is the response message for OrgPolicyViolationsPreviewService.ListOrgPolicyViolations */
	export interface GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponseFormProperties {

		/** A token that you can use to retrieve the next page of results. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponseFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** OrgPolicyViolation is a resource representing a single resource violating a single OrgPolicy constraint. */
	export interface GoogleCloudPolicysimulatorV1betaOrgPolicyViolationFormProperties {

		/** The name of the `OrgPolicyViolation`. Example: organizations/my-example-org/locations/global/orgPolicyViolationsPreviews/506a5f7f/orgPolicyViolations/38ce` */
		name: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaOrgPolicyViolationFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaOrgPolicyViolationFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** ResourceContext provides the context we know about a resource. It is similar in concept to google.cloud.asset.v1.Resource, but focuses on the information specifically used by Simulator. */
	export interface GoogleCloudPolicysimulatorV1betaResourceContextFormProperties {
	...
	export function CreateGoogleCloudPolicysimulatorV1betaResourceContextFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaResourceContextFormProperties>({
	...
	/** Response message for Simulator.ListReplayResults. */
	export interface GoogleCloudPolicysimulatorV1betaListReplayResultsResponseFormProperties {

		/** A token that you can use to retrieve the next page of ReplayResult objects. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaListReplayResultsResponseFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaListReplayResultsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The result of replaying a single access tuple against a simulated state. */
	export interface GoogleCloudPolicysimulatorV1betaReplayResultFormProperties {
	...
	export function CreateGoogleCloudPolicysimulatorV1betaReplayResultFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaReplayResultFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
	...
	/** The difference between the results of evaluating an access tuple under the current (baseline) policies and under the proposed (simulated) policies. This difference explains how a principal's access could change if the proposed policies were applied. */
	export interface GoogleCloudPolicysimulatorV1betaReplayDiffFormProperties {
	}
	export function CreateGoogleCloudPolicysimulatorV1betaReplayDiffFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaReplayDiffFormProperties>({
		});
	...
	/** Response message for Simulator.ListReplays. */
	export interface GoogleCloudPolicysimulatorV1betaListReplaysResponseFormProperties {

		/** A token that you can use to retrieve the next page of results. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1betaListReplaysResponseFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaListReplaysResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A resource describing a `Replay`, or simulation. */
	export interface GoogleCloudPolicysimulatorV1betaReplayFormProperties {
	...
	export function CreateGoogleCloudPolicysimulatorV1betaReplayFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaReplayFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
			state: new FormControl<GoogleCloudPolicysimulatorV1ReplayState | null | undefined>(undefined),
		});
	...
	/** The configuration used for a Replay. */
	export interface GoogleCloudPolicysimulatorV1betaReplayConfigFormProperties {
	...
	export function CreateGoogleCloudPolicysimulatorV1betaReplayConfigFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaReplayConfigFormProperties>({
			logSource: new FormControl<GoogleCloudPolicysimulatorV1ReplayConfigLogSource | null | undefined>(undefined),
			policyOverlay: new FormControl<{[id: string]: GoogleIamV1Policy } | null | undefined>(undefined),
		});
	...
	/** Summary statistics about the replayed log entries. */
	export interface GoogleCloudPolicysimulatorV1betaReplayResultsSummaryFormProperties {
	...
	export function CreateGoogleCloudPolicysimulatorV1betaReplayResultsSummaryFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1betaReplayResultsSummaryFormProperties>({
			differenceCount: new FormControl<number | null | undefined>(undefined),
			errorCount: new FormControl<number | null | undefined>(undefined),
			logCount: new FormControl<number | null | undefined>(undefined),
			unchangedCount: new FormControl<number | null | undefined>(undefined),
	...
	export class MyClient {
		...
		Policysimulator_projects_locations_replays_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleLongrunningListOperationsResponse> {
			return this.http.get<GoogleLongrunningListOperationsResponse>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * ListOrgPolicyViolations lists the OrgPolicyViolations that are present in an OrgPolicyViolationsPreview.
		 * Get v1beta/{parent}/orgPolicyViolations
		 ...
		 * @return {GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse} Successful response
		 */
		Policysimulator_organizations_locations_orgPolicyViolationsPreviews_orgPolicyViolations_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse> {
			return this.http.get<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/orgPolicyViolations&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * Get v1beta/{parent}/orgPolicyViolationsPreviews
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken A page token, received from a previous call. Provide this to retrieve the subsequent page. When paginating, all other parameters must match the call that provided the page token.
		 * @return {GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse} Successful response
		 */
		Policysimulator_organizations_locations_orgPolicyViolationsPreviews_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse> {
			return this.http.get<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/orgPolicyViolationsPreviews&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * Post v1beta/{parent}/orgPolicyViolationsPreviews
		 ...
		 */
		Policysimulator_organizations_locations_orgPolicyViolationsPreviews(parent: string, requestBody: GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/orgPolicyViolationsPreviews', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists each Replay in a project, folder, or organization. Each `Replay` is available for at least 7 days.
		 * Get v1beta/{parent}/replays
		 ...
		 * @return {GoogleCloudPolicysimulatorV1betaListReplaysResponse} Successful response
		 */
		Policysimulator_projects_locations_replays_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudPolicysimulatorV1betaListReplaysResponse> {
			return this.http.get<GoogleCloudPolicysimulatorV1betaListReplaysResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/replays&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates and starts a Replay using the given ReplayConfig.
		 * Post v1beta/{parent}/replays
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Policysimulator_projects_locations_replays_create(parent: string, requestBody: GoogleCloudPolicysimulatorV1betaReplay): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/replays', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists the results of running a Replay.
		 * Get v1beta/{parent}/results
		 ...
		 * @return {GoogleCloudPolicysimulatorV1betaListReplayResultsResponse} Successful response
		 */
		Policysimulator_projects_locations_replays_results_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudPolicysimulatorV1betaListReplayResultsResponse> {
			return this.http.get<GoogleCloudPolicysimulatorV1betaListReplayResultsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/results&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
	}
