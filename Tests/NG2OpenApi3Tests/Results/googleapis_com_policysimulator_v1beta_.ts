...
export namespace MyNS {
	...
	export enum GoogleCloudPolicysimulatorV1betaAccessStateDiffAccessChange { ACCESS_CHANGE_TYPE_UNSPECIFIED = 0, NO_CHANGE = 1, UNKNOWN_CHANGE = 2, ACCESS_REVOKED = 3, ACCESS_GAINED = 4, ACCESS_MAYBE_REVOKED = 5, ACCESS_MAYBE_GAINED = 6 }
	...
	export enum GoogleCloudPolicysimulatorV1betaExplainedAccessAccessState { ACCESS_STATE_UNSPECIFIED = 0, GRANTED = 1, NOT_GRANTED = 2, UNKNOWN_CONDITIONAL = 3, UNKNOWN_INFO_DENIED = 4 }
	...
	export enum GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipMembership { MEMBERSHIP_UNSPECIFIED = 0, MEMBERSHIP_INCLUDED = 1, MEMBERSHIP_NOT_INCLUDED = 2, MEMBERSHIP_UNKNOWN_INFO_DENIED = 3, MEMBERSHIP_UNKNOWN_UNSUPPORTED = 4 }

	export enum GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembershipRelevance { HEURISTIC_RELEVANCE_UNSPECIFIED = 0, NORMAL = 1, HIGH = 2 }

	export enum GoogleCloudPolicysimulatorV1betaBindingExplanationRolePermission { ROLE_PERMISSION_UNSPECIFIED = 0, ROLE_PERMISSION_INCLUDED = 1, ROLE_PERMISSION_NOT_INCLUDED = 2, ROLE_PERMISSION_UNKNOWN_INFO_DENIED = 3 }
