...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * Get dns/v1beta2/projects/{project}
		...
		Dns_projects_get(project: string, clientOperationId: string | null | undefined): Observable<Project> {
			return this.http.get<Project>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}
		...
		Dns_managedZones_list(project: string, dnsName: string | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<ManagedZonesListResponse> {
			return this.http.get<ManagedZonesListResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones&dnsName=' + (dnsName == null ? '' : encodeURIComponent(dnsName)) + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Dns_managedZones_create(project: string, clientOperationId: string | null | undefined, requestBody: ManagedZone): Observable<ManagedZone> {
			return this.http.post<ManagedZone>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Deletes a previously created ManagedZone.
		 * Delete dns/v1beta2/projects/{project}/managedZones/{managedZone}
		 * @param {string} project Identifies the project addressed by this request.
		...
		Dns_managedZones_delete(project: string, managedZone: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Fetches the representation of an existing ManagedZone.
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		 * @return {ManagedZone} Successful response
		...
		Dns_managedZones_get(project: string, managedZone: string, clientOperationId: string | null | undefined): Observable<ManagedZone> {
			return this.http.get<ManagedZone>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}

		/**
		 * Applies a partial update to an existing ManagedZone.
		 * Patch dns/v1beta2/projects/{project}/managedZones/{managedZone}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		...
		Dns_managedZones_patch(project: string, managedZone: string, clientOperationId: string | null | undefined, requestBody: ManagedZone): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates an existing ManagedZone.
		 * Put dns/v1beta2/projects/{project}/managedZones/{managedZone}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		 * @return {Operation} Successful response
		 ...
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}/changes
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {number} maxResults Optional. Maximum number of results to be returned. If unspecified, the server decides how many results to return.
		 * @param {string} pageToken Optional. A tag returned by a previous list request that was truncated. Use this parameter to continue a previous list request.
		...
		Dns_changes_list(project: string, managedZone: string, maxResults: number | null | undefined, pageToken: string | null | undefined, sortBy: Dns_changes_listSortBy | null | undefined, sortOrder: string | null | undefined): Observable<ChangesListResponse> {
			return this.http.get<ChangesListResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/changes&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&sortBy=' + sortBy + '&sortOrder=' + (sortOrder == null ? '' : encodeURIComponent(sortOrder)), {});
		}

		/**
		 * Atomically updates the ResourceRecordSet collection.
		 * Post dns/v1beta2/projects/{project}/managedZones/{managedZone}/changes
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		...
		Dns_changes_create(project: string, managedZone: string, clientOperationId: string | null | undefined, requestBody: Change): Observable<Change> {
			return this.http.post<Change>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/changes&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Fetches the representation of an existing Change.
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}/changes/{changeId}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		...
		Dns_changes_get(project: string, managedZone: string, changeId: string, clientOperationId: string | null | undefined): Observable<Change> {
			return this.http.get<Change>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/changes/' + (changeId == null ? '' : encodeURIComponent(changeId)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}

		/**
		 * Enumerates DnsKeys to a ResourceRecordSet collection.
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}/dnsKeys
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		...
		Dns_dnsKeys_list(project: string, managedZone: string, digestType: string | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<DnsKeysListResponse> {
			return this.http.get<DnsKeysListResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/dnsKeys&digestType=' + (digestType == null ? '' : encodeURIComponent(digestType)) + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Fetches the representation of an existing DnsKey.
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		...
		Dns_dnsKeys_get(project: string, managedZone: string, dnsKeyId: string, clientOperationId: string | null | undefined, digestType: string | null | undefined): Observable<DnsKey> {
			return this.http.get<DnsKey>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/dnsKeys/' + (dnsKeyId == null ? '' : encodeURIComponent(dnsKeyId)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)) + '&digestType=' + (digestType == null ? '' : encodeURIComponent(digestType)), {});
		}

		/**
		 * Enumerates Operations for the given ManagedZone.
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}/operations
		 * @param {string} project Identifies the project addressed by this request.
		...
		Dns_managedZoneOperations_list(project: string, managedZone: string, maxResults: number | null | undefined, pageToken: string | null | undefined, sortBy: Dns_managedZoneOperations_listSortBy | null | undefined): Observable<ManagedZoneOperationsListResponse> {
			return this.http.get<ManagedZoneOperationsListResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/operations&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&sortBy=' + sortBy, {});
		}

		/**
		 * Fetches the representation of an existing Operation.
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}/operations/{operation}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request.
		...
		Dns_managedZoneOperations_get(project: string, managedZone: string, operation: string, clientOperationId: string | null | undefined): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/operations/' + (operation == null ? '' : encodeURIComponent(operation)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}

		/**
		 * Enumerates ResourceRecordSets that you have created but not yet deleted.
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}/rrsets
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {number} maxResults Optional. Maximum number of results to be returned. If unspecified, the server decides how many results to return.
		...
		Dns_resourceRecordSets_list(project: string, managedZone: string, maxResults: number | null | undefined, name: string | null | undefined, pageToken: string | null | undefined, type: string | null | undefined): Observable<ResourceRecordSetsListResponse> {
			return this.http.get<ResourceRecordSetsListResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/rrsets&maxResults=' + maxResults + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&type=' + (type == null ? '' : encodeURIComponent(type)), {});
		}

		/**
		 * Creates a new ResourceRecordSet.
		 * Post dns/v1beta2/projects/{project}/managedZones/{managedZone}/rrsets
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		...
		Dns_resourceRecordSets_create(project: string, managedZone: string, clientOperationId: string | null | undefined, requestBody: ResourceRecordSet): Observable<ResourceRecordSet> {
			return this.http.post<ResourceRecordSet>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/rrsets&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Deletes a previously created ResourceRecordSet.
		 * Delete dns/v1beta2/projects/{project}/managedZones/{managedZone}/rrsets/{name}/{type}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 ...
		 * @return {void} Successful response
		 */
		Dns_resourceRecordSets_delete(project: string, managedZone: string, name: string, type: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/rrsets/' + (name == null ? '' : encodeURIComponent(name)) + '/' + (type == null ? '' : encodeURIComponent(type)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Fetches the representation of an existing ResourceRecordSet.
		 * Get dns/v1beta2/projects/{project}/managedZones/{managedZone}/rrsets/{name}/{type}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {string} name Fully qualified domain name.
		 * @param {string} type RRSet type.
		 ...
		 * Patch dns/v1beta2/projects/{project}/managedZones/{managedZone}/rrsets/{name}/{type}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} managedZone Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
		 * @param {string} name Fully qualified domain name.
		 * @param {string} type RRSet type.
		...
		Dns_policies_list(project: string, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<PoliciesListResponse> {
			return this.http.get<PoliciesListResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/policies&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Dns_policies_create(project: string, clientOperationId: string | null | undefined, requestBody: Policy): Observable<Policy> {
			return this.http.post<Policy>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/policies&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Deletes a previously created Policy. Fails if the policy is still being referenced by a network.
		 * Delete dns/v1beta2/projects/{project}/policies/{policy}
		 * @param {string} project Identifies the project addressed by this request.
		...
		Dns_policies_delete(project: string, policy: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/policies/' + (policy == null ? '' : encodeURIComponent(policy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Fetches the representation of an existing Policy.
		 * Get dns/v1beta2/projects/{project}/policies/{policy}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} policy User given friendly name of the policy addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		 * @return {Policy} Successful response
		...
		Dns_policies_get(project: string, policy: string, clientOperationId: string | null | undefined): Observable<Policy> {
			return this.http.get<Policy>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/policies/' + (policy == null ? '' : encodeURIComponent(policy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}

		/**
		 * Applies a partial update to an existing Policy.
		 * Patch dns/v1beta2/projects/{project}/policies/{policy}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} policy User given friendly name of the policy addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		...
		Dns_policies_patch(project: string, policy: string, clientOperationId: string | null | undefined, requestBody: Policy): Observable<PoliciesPatchResponse> {
			return this.http.patch<PoliciesPatchResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/policies/' + (policy == null ? '' : encodeURIComponent(policy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates an existing Policy.
		 * Put dns/v1beta2/projects/{project}/policies/{policy}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} policy User given friendly name of the policy addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		...
		Dns_responsePolicies_list(project: string, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<ResponsePoliciesListResponse> {
			return this.http.get<ResponsePoliciesListResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Dns_responsePolicies_create(project: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicy): Observable<ResponsePolicy> {
			return this.http.post<ResponsePolicy>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Deletes a previously created Response Policy. Fails if the response policy is non-empty or still being referenced by a network.
		 * Delete dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}
		 * @param {string} project Identifies the project addressed by this request.
		...
		Dns_responsePolicies_delete(project: string, responsePolicy: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Fetches the representation of an existing Response Policy.
		 * Get dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} responsePolicy User assigned name of the Response Policy addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		 * @return {ResponsePolicy} Successful response
		...
		Dns_responsePolicies_get(project: string, responsePolicy: string, clientOperationId: string | null | undefined): Observable<ResponsePolicy> {
			return this.http.get<ResponsePolicy>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}

		/**
		 * Applies a partial update to an existing Response Policy.
		 * Patch dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} responsePolicy User assigned name of the response policy addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		...
		Dns_responsePolicies_patch(project: string, responsePolicy: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicy): Observable<ResponsePoliciesPatchResponse> {
			return this.http.patch<ResponsePoliciesPatchResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates an existing Response Policy.
		 * Put dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} responsePolicy User assigned name of the Response Policy addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		 ...
		 * Get dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules
		 * @param {string} project Identifies the project addressed by this request.
		...
		Dns_responsePolicyRules_list(project: string, responsePolicy: string, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<ResponsePolicyRulesListResponse> {
			return this.http.get<ResponsePolicyRulesListResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new Response Policy Rule.
		 * Post dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules
		 * @param {string} project Identifies the project addressed by this request.
		...
		Dns_responsePolicyRules_create(project: string, responsePolicy: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicyRule): Observable<ResponsePolicyRule> {
			return this.http.post<ResponsePolicyRule>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Deletes a previously created Response Policy Rule.
		 * Delete dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} responsePolicy User assigned name of the Response Policy containing the Response Policy Rule.
		...
		Dns_responsePolicyRules_delete(project: string, responsePolicy: string, responsePolicyRule: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules/' + (responsePolicyRule == null ? '' : encodeURIComponent(responsePolicyRule)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Fetches the representation of an existing Response Policy Rule.
		 * Get dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} responsePolicy User assigned name of the Response Policy containing the Response Policy Rule.
		 * @param {string} responsePolicyRule User assigned name of the Response Policy Rule addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		...
		Dns_responsePolicyRules_get(project: string, responsePolicy: string, responsePolicyRule: string, clientOperationId: string | null | undefined): Observable<ResponsePolicyRule> {
			return this.http.get<ResponsePolicyRule>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules/' + (responsePolicyRule == null ? '' : encodeURIComponent(responsePolicyRule)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}

		/**
		 * Applies a partial update to an existing Response Policy Rule.
		 * Patch dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} responsePolicy User assigned name of the Response Policy containing the Response Policy Rule.
		 * @param {string} responsePolicyRule User assigned name of the Response Policy Rule addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		...
		Dns_responsePolicyRules_patch(project: string, responsePolicy: string, responsePolicyRule: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicyRule): Observable<ResponsePolicyRulesPatchResponse> {
			return this.http.patch<ResponsePolicyRulesPatchResponse>(this.baseUri + 'dns/v1beta2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules/' + (responsePolicyRule == null ? '' : encodeURIComponent(responsePolicyRule)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates an existing Response Policy Rule.
		 * Put dns/v1beta2/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}
		 * @param {string} project Identifies the project addressed by this request.
		 * @param {string} responsePolicy User assigned name of the Response Policy containing the Response Policy Rule.
		 * @param {string} responsePolicyRule User assigned name of the Response Policy Rule addressed by this request.
		 * @param {string} clientOperationId For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
		 ...
		 * Post dns/v1beta2/{resource}:getIamPolicy
		...
		Dns_managedZones_getIamPolicy(resource: string, requestBody: GoogleIamV1GetIamPolicyRequest): Observable<GoogleIamV1Policy> {
			return this.http.post<GoogleIamV1Policy>(this.baseUri + 'dns/v1beta2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':getIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Sets the access control policy on the specified resource. Replaces any existing policy. Can return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
		 * Post dns/v1beta2/{resource}:setIamPolicy
		...
		Dns_managedZones_setIamPolicy(resource: string, requestBody: GoogleIamV1SetIamPolicyRequest): Observable<GoogleIamV1Policy> {
			return this.http.post<GoogleIamV1Policy>(this.baseUri + 'dns/v1beta2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':setIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Returns permissions that a caller has on the specified resource. If the resource does not exist, this returns an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.
		 * Post dns/v1beta2/{resource}:testIamPermissions
		...
		Dns_managedZones_testIamPermissions(resource: string, requestBody: GoogleIamV1TestIamPermissionsRequest): Observable<GoogleIamV1TestIamPermissionsResponse> {
			return this.http.post<GoogleIamV1TestIamPermissionsResponse>(this.baseUri + 'dns/v1beta2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':testIamPermissions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
