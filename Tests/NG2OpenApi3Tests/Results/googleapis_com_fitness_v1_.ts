...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Fitness_users_dataSources_list(userId: string, dataTypeName: Array<string> | null | undefined): Observable<ListDataSourcesResponse> {
			return this.http.get<ListDataSourcesResponse>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources&' + dataTypeName?.map(z => `dataTypeName=${encodeURIComponent(z)}`).join('&') + '', {});
		}
		 ...
		 * @return {DataSource} Successful response
		 */
		Fitness_users_dataSources_create(userId: string, requestBody: DataSource): Observable<DataSource> {
			return this.http.post<DataSource>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {DataSource} Successful response
		 */
		Fitness_users_dataSources_delete(userId: string, dataSourceId: string): Observable<DataSource> {
			return this.http.delete<DataSource>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources/' + (dataSourceId == null ? '' : encodeURIComponent(dataSourceId)) + '', {});
		}
		 ...
		 * @return {DataSource} Successful response
		 */
		Fitness_users_dataSources_get(userId: string, dataSourceId: string): Observable<DataSource> {
			return this.http.get<DataSource>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources/' + (dataSourceId == null ? '' : encodeURIComponent(dataSourceId)) + '', {});
		}
		 ...
		 * @return {DataSource} Successful response
		 */
		Fitness_users_dataSources_update(userId: string, dataSourceId: string, requestBody: DataSource): Observable<DataSource> {
			return this.http.put<DataSource>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources/' + (dataSourceId == null ? '' : encodeURIComponent(dataSourceId)) + '', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Fitness_users_dataSources_dataPointChanges_list(userId: string, dataSourceId: string, limit: number | null | undefined, pageToken: string | null | undefined): Observable<ListDataPointChangesResponse> {
			return this.http.get<ListDataPointChangesResponse>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources/' + (dataSourceId == null ? '' : encodeURIComponent(dataSourceId)) + '/dataPointChanges&limit=' + limit + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '', {});
		}
		 ...
		 */
		Fitness_users_dataSources_datasets_delete(userId: string, dataSourceId: string, datasetId: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources/' + (dataSourceId == null ? '' : encodeURIComponent(dataSourceId)) + '/datasets/' + (datasetId == null ? '' : encodeURIComponent(datasetId)) + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Fitness_users_dataSources_datasets_get(userId: string, dataSourceId: string, datasetId: string, limit: number | null | undefined, pageToken: string | null | undefined): Observable<Dataset> {
			return this.http.get<Dataset>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources/' + (dataSourceId == null ? '' : encodeURIComponent(dataSourceId)) + '/datasets/' + (datasetId == null ? '' : encodeURIComponent(datasetId)) + '&limit=' + limit + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '', {});
		}
		 ...
		 * @return {Dataset} Successful response
		 */
		Fitness_users_dataSources_datasets_patch(userId: string, dataSourceId: string, datasetId: string, requestBody: Dataset): Observable<Dataset> {
			return this.http.patch<Dataset>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataSources/' + (dataSourceId == null ? '' : encodeURIComponent(dataSourceId)) + '/datasets/' + (datasetId == null ? '' : encodeURIComponent(datasetId)) + '', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {AggregateResponse} Successful response
		 */
		Fitness_users_dataset_aggregate(userId: string, requestBody: AggregateRequest): Observable<AggregateResponse> {
			return this.http.post<AggregateResponse>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/dataset:aggregate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Fitness_users_sessions_list(userId: string, activityType: Array<number> | null | undefined, endTime: string | null | undefined, includeDeleted: boolean | null | undefined, pageToken: string | null | undefined, startTime: string | null | undefined): Observable<ListSessionsResponse> {
			return this.http.get<ListSessionsResponse>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/sessions&' + activityType?.map(z => `activityType=${z}`).join('&') + '&endTime=' + (endTime == null ? '' : encodeURIComponent(endTime)) + '&includeDeleted=' + includeDeleted + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&startTime=' + (startTime == null ? '' : encodeURIComponent(startTime)) + '', {});
		}
		 ...
		 * @return {void} Successful response
		 */
		Fitness_users_sessions_delete(userId: string, sessionId: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/sessions/' + (sessionId == null ? '' : encodeURIComponent(sessionId)) + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Fitness_users_sessions_update(userId: string, sessionId: string, requestBody: Session): Observable<Session> {
			return this.http.put<Session>(this.baseUri + (userId == null ? '' : encodeURIComponent(userId)) + '/sessions/' + (sessionId == null ? '' : encodeURIComponent(sessionId)) + '', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
