...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {EmptyResponse} Successful response
		 */
		YoutubeAnalytics_groupItems_delete(id: string | null | undefined, onBehalfOfContentOwner: string | null | undefined): Observable<EmptyResponse> {
			return this.http.delete<EmptyResponse>(this.baseUri + 'v2/groupItems?id=' + (id == null ? '' : encodeURIComponent(id)) + '&onBehalfOfContentOwner=' + (onBehalfOfContentOwner == null ? '' : encodeURIComponent(onBehalfOfContentOwner)), {});
		}
		 ...
		 * @param {string} onBehalfOfContentOwner This parameter can only be used in a properly authorized request. **Note:** This parameter is intended exclusively for YouTube content partners that own and manage many different YouTube channels. The `onBehalfOfContentOwner` parameter indicates that the request's authorization credentials identify a YouTube user who is acting on behalf of the content owner specified in the parameter value. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The account that the user authenticates with must be linked to the specified YouTube content owner.
		 * @return {ListGroupItemsResponse} Successful response
		 */
		YoutubeAnalytics_groupItems_list(groupId: string | null | undefined, onBehalfOfContentOwner: string | null | undefined): Observable<ListGroupItemsResponse> {
			return this.http.get<ListGroupItemsResponse>(this.baseUri + 'v2/groupItems?groupId=' + (groupId == null ? '' : encodeURIComponent(groupId)) + '&onBehalfOfContentOwner=' + (onBehalfOfContentOwner == null ? '' : encodeURIComponent(onBehalfOfContentOwner)), {});
		}
		 ...
		 * Post v2/groupItems
		 * @param {string} onBehalfOfContentOwner This parameter can only be used in a properly authorized request. **Note:** This parameter is intended exclusively for YouTube content partners that own and manage many different YouTube channels. The `onBehalfOfContentOwner` parameter indicates that the request's authorization credentials identify a YouTube user who is acting on behalf of the content owner specified in the parameter value. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The account that the user authenticates with must be linked to the specified YouTube content owner.
		 * @return {GroupItem} Successful response
		 */
		YoutubeAnalytics_groupItems_insert(onBehalfOfContentOwner: string | null | undefined, requestBody: GroupItem): Observable<GroupItem> {
			return this.http.post<GroupItem>(this.baseUri + 'v2/groupItems?onBehalfOfContentOwner=' + (onBehalfOfContentOwner == null ? '' : encodeURIComponent(onBehalfOfContentOwner)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {EmptyResponse} Successful response
		 */
		YoutubeAnalytics_groups_delete(id: string | null | undefined, onBehalfOfContentOwner: string | null | undefined): Observable<EmptyResponse> {
			return this.http.delete<EmptyResponse>(this.baseUri + 'v2/groups?id=' + (id == null ? '' : encodeURIComponent(id)) + '&onBehalfOfContentOwner=' + (onBehalfOfContentOwner == null ? '' : encodeURIComponent(onBehalfOfContentOwner)), {});
		}
		 ...
		 */
		YoutubeAnalytics_groups_list(id: string | null | undefined, mine: boolean | null | undefined, onBehalfOfContentOwner: string | null | undefined, pageToken: string | null | undefined): Observable<ListGroupsResponse> {
			return this.http.get<ListGroupsResponse>(this.baseUri + 'v2/groups?id=' + (id == null ? '' : encodeURIComponent(id)) + '&mine=' + mine + '&onBehalfOfContentOwner=' + (onBehalfOfContentOwner == null ? '' : encodeURIComponent(onBehalfOfContentOwner)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		YoutubeAnalytics_groups_insert(onBehalfOfContentOwner: string | null | undefined, requestBody: Group): Observable<Group> {
			return this.http.post<Group>(this.baseUri + 'v2/groups?onBehalfOfContentOwner=' + (onBehalfOfContentOwner == null ? '' : encodeURIComponent(onBehalfOfContentOwner)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Group} Successful response
		 */
		YoutubeAnalytics_groups_update(onBehalfOfContentOwner: string | null | undefined, requestBody: Group): Observable<Group> {
			return this.http.put<Group>(this.baseUri + 'v2/groups?onBehalfOfContentOwner=' + (onBehalfOfContentOwner == null ? '' : encodeURIComponent(onBehalfOfContentOwner)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
