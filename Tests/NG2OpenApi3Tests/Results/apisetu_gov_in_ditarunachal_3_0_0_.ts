...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {IlpmtPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Ilpmt(requestBody: IlpmtPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'ilpmt/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface IlpmtPostBody {
		certificateParameters?: IlpmtPostBodyCertificateParameters;
	...
	export interface IlpmtPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<IlpmtPostBodyFormat | null | undefined>,
	...
	export function CreateIlpmtPostBodyFormGroup() {
		return new FormGroup<IlpmtPostBodyFormProperties>({
			format: new FormControl<IlpmtPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface IlpmtPostBodyCertificateParameters {
	...
	export interface IlpmtPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		eILPAppId: FormControl<string | null | undefined>,

		/**
		 * Contact Number
		 * Required
		 */
		eILPContactNumber: FormControl<string | null | undefined>,
	}
	export function CreateIlpmtPostBodyCertificateParametersFormGroup() {
		return new FormGroup<IlpmtPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			eILPAppId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			eILPContactNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
