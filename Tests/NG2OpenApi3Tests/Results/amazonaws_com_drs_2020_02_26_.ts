...
export namespace MyNS {
	...
	export enum InitiatedBy { START_RECOVERY = 'START_RECOVERY', START_DRILL = 'START_DRILL', FAILBACK = 'FAILBACK', DIAGNOSTIC = 'DIAGNOSTIC', TERMINATE_RECOVERY_INSTANCES = 'TERMINATE_RECOVERY_INSTANCES', TARGET_ACCOUNT = 'TARGET_ACCOUNT', CREATE_NETWORK_RECOVERY = 'CREATE_NETWORK_RECOVERY', UPDATE_NETWORK_RECOVERY = 'UPDATE_NETWORK_RECOVERY', ASSOCIATE_NETWORK_RECOVERY = 'ASSOCIATE_NETWORK_RECOVERY' }
	...
	export enum JobType { LAUNCH = 'LAUNCH', TERMINATE = 'TERMINATE', CREATE_CONVERTED_SNAPSHOT = 'CREATE_CONVERTED_SNAPSHOT' }
	...
	export enum DataReplicationState { STOPPED = 'STOPPED', INITIATING = 'INITIATING', INITIAL_SYNC = 'INITIAL_SYNC', BACKLOG = 'BACKLOG', CREATING_SNAPSHOT = 'CREATING_SNAPSHOT', CONTINUOUS = 'CONTINUOUS', PAUSED = 'PAUSED', RESCAN = 'RESCAN', STALLED = 'STALLED', DISCONNECTED = 'DISCONNECTED' }
	...
	export enum LastLaunchResult { NOT_STARTED = 'NOT_STARTED', PENDING = 'PENDING', SUCCEEDED = 'SUCCEEDED', FAILED = 'FAILED' }
	...
	export enum LastLaunchType { RECOVERY = 'RECOVERY', DRILL = 'DRILL' }
	...
	export enum ReplicationDirection { FAILOVER = 'FAILOVER', FAILBACK = 'FAILBACK' }
	...
	export enum ExtensionStatus { EXTENDED = 'EXTENDED', EXTENSION_ERROR = 'EXTENSION_ERROR', NOT_EXTENDED = 'NOT_EXTENDED' }
	...
	export enum TargetInstanceTypeRightSizingMethod { NONE = 'NONE', BASIC = 'BASIC', IN_AWS = 'IN_AWS' }
	...
	export enum ReplicationConfigurationDefaultLargeStagingDiskType { GP2 = 'GP2', GP3 = 'GP3', ST1 = 'ST1', AUTO = 'AUTO' }

	export enum ReplicationConfigurationEbsEncryption { DEFAULT = 'DEFAULT', CUSTOM = 'CUSTOM', NONE = 'NONE' }
	...
	export enum PITPolicyRuleUnits { MINUTE = 'MINUTE', HOUR = 'HOUR', DAY = 'DAY' }
	...
	export enum JobLogEvent { JOB_START = 'JOB_START', SERVER_SKIPPED = 'SERVER_SKIPPED', CLEANUP_START = 'CLEANUP_START', CLEANUP_END = 'CLEANUP_END', CLEANUP_FAIL = 'CLEANUP_FAIL', SNAPSHOT_START = 'SNAPSHOT_START', SNAPSHOT_END = 'SNAPSHOT_END', SNAPSHOT_FAIL = 'SNAPSHOT_FAIL', USING_PREVIOUS_SNAPSHOT = 'USING_PREVIOUS_SNAPSHOT', USING_PREVIOUS_SNAPSHOT_FAILED = 'USING_PREVIOUS_SNAPSHOT_FAILED', CONVERSION_START = 'CONVERSION_START', CONVERSION_END = 'CONVERSION_END', CONVERSION_FAIL = 'CONVERSION_FAIL', LAUNCH_START = 'LAUNCH_START', LAUNCH_FAILED = 'LAUNCH_FAILED', JOB_CANCEL = 'JOB_CANCEL', JOB_END = 'JOB_END', DEPLOY_NETWORK_CONFIGURATION_START = 'DEPLOY_NETWORK_CONFIGURATION_START', DEPLOY_NETWORK_CONFIGURATION_END = 'DEPLOY_NETWORK_CONFIGURATION_END', DEPLOY_NETWORK_CONFIGURATION_FAILED = 'DEPLOY_NETWORK_CONFIGURATION_FAILED', UPDATE_NETWORK_CONFIGURATION_START = 'UPDATE_NETWORK_CONFIGURATION_START', UPDATE_NETWORK_CONFIGURATION_END = 'UPDATE_NETWORK_CONFIGURATION_END', UPDATE_NETWORK_CONFIGURATION_FAILED = 'UPDATE_NETWORK_CONFIGURATION_FAILED', UPDATE_LAUNCH_TEMPLATE_START = 'UPDATE_LAUNCH_TEMPLATE_START', UPDATE_LAUNCH_TEMPLATE_END = 'UPDATE_LAUNCH_TEMPLATE_END', UPDATE_LAUNCH_TEMPLATE_FAILED = 'UPDATE_LAUNCH_TEMPLATE_FAILED', NETWORK_RECOVERY_FAIL = 'NETWORK_RECOVERY_FAIL' }
	...
	export enum FailbackReplicationError { AGENT_NOT_SEEN = 'AGENT_NOT_SEEN', FAILBACK_CLIENT_NOT_SEEN = 'FAILBACK_CLIENT_NOT_SEEN', NOT_CONVERGING = 'NOT_CONVERGING', UNSTABLE_NETWORK = 'UNSTABLE_NETWORK', FAILED_TO_ESTABLISH_RECOVERY_INSTANCE_COMMUNICATION = 'FAILED_TO_ESTABLISH_RECOVERY_INSTANCE_COMMUNICATION', FAILED_TO_DOWNLOAD_REPLICATION_SOFTWARE_TO_FAILBACK_CLIENT = 'FAILED_TO_DOWNLOAD_REPLICATION_SOFTWARE_TO_FAILBACK_CLIENT', FAILED_TO_CONFIGURE_REPLICATION_SOFTWARE = 'FAILED_TO_CONFIGURE_REPLICATION_SOFTWARE', FAILED_TO_PAIR_AGENT_WITH_REPLICATION_SOFTWARE = 'FAILED_TO_PAIR_AGENT_WITH_REPLICATION_SOFTWARE', FAILED_TO_ESTABLISH_AGENT_REPLICATOR_SOFTWARE_COMMUNICATION = 'FAILED_TO_ESTABLISH_AGENT_REPLICATOR_SOFTWARE_COMMUNICATION', FAILED_GETTING_REPLICATION_STATE = 'FAILED_GETTING_REPLICATION_STATE', SNAPSHOTS_FAILURE = 'SNAPSHOTS_FAILURE', FAILED_TO_CREATE_SECURITY_GROUP = 'FAILED_TO_CREATE_SECURITY_GROUP', FAILED_TO_LAUNCH_REPLICATION_SERVER = 'FAILED_TO_LAUNCH_REPLICATION_SERVER', FAILED_TO_BOOT_REPLICATION_SERVER = 'FAILED_TO_BOOT_REPLICATION_SERVER', FAILED_TO_AUTHENTICATE_WITH_SERVICE = 'FAILED_TO_AUTHENTICATE_WITH_SERVICE', FAILED_TO_DOWNLOAD_REPLICATION_SOFTWARE = 'FAILED_TO_DOWNLOAD_REPLICATION_SOFTWARE', FAILED_TO_CREATE_STAGING_DISKS = 'FAILED_TO_CREATE_STAGING_DISKS', FAILED_TO_ATTACH_STAGING_DISKS = 'FAILED_TO_ATTACH_STAGING_DISKS', FAILED_TO_PAIR_REPLICATION_SERVER_WITH_AGENT = 'FAILED_TO_PAIR_REPLICATION_SERVER_WITH_AGENT', FAILED_TO_CONNECT_AGENT_TO_REPLICATION_SERVER = 'FAILED_TO_CONNECT_AGENT_TO_REPLICATION_SERVER', FAILED_TO_START_DATA_TRANSFER = 'FAILED_TO_START_DATA_TRANSFER' }
	...
	export enum RecoveryInstanceDataReplicationInitiationStepName { LINK_FAILBACK_CLIENT_WITH_RECOVERY_INSTANCE = 'LINK_FAILBACK_CLIENT_WITH_RECOVERY_INSTANCE', COMPLETE_VOLUME_MAPPING = 'COMPLETE_VOLUME_MAPPING', ESTABLISH_RECOVERY_INSTANCE_COMMUNICATION = 'ESTABLISH_RECOVERY_INSTANCE_COMMUNICATION', DOWNLOAD_REPLICATION_SOFTWARE_TO_FAILBACK_CLIENT = 'DOWNLOAD_REPLICATION_SOFTWARE_TO_FAILBACK_CLIENT', CONFIGURE_REPLICATION_SOFTWARE = 'CONFIGURE_REPLICATION_SOFTWARE', PAIR_AGENT_WITH_REPLICATION_SOFTWARE = 'PAIR_AGENT_WITH_REPLICATION_SOFTWARE', ESTABLISH_AGENT_REPLICATOR_SOFTWARE_COMMUNICATION = 'ESTABLISH_AGENT_REPLICATOR_SOFTWARE_COMMUNICATION', WAIT = 'WAIT', CREATE_SECURITY_GROUP = 'CREATE_SECURITY_GROUP', LAUNCH_REPLICATION_SERVER = 'LAUNCH_REPLICATION_SERVER', BOOT_REPLICATION_SERVER = 'BOOT_REPLICATION_SERVER', AUTHENTICATE_WITH_SERVICE = 'AUTHENTICATE_WITH_SERVICE', DOWNLOAD_REPLICATION_SOFTWARE = 'DOWNLOAD_REPLICATION_SOFTWARE', CREATE_STAGING_DISKS = 'CREATE_STAGING_DISKS', ATTACH_STAGING_DISKS = 'ATTACH_STAGING_DISKS', PAIR_REPLICATION_SERVER_WITH_AGENT = 'PAIR_REPLICATION_SERVER_WITH_AGENT', CONNECT_AGENT_TO_REPLICATION_SERVER = 'CONNECT_AGENT_TO_REPLICATION_SERVER', START_DATA_TRANSFER = 'START_DATA_TRANSFER' }

	export enum RecoveryInstanceDataReplicationState { STOPPED = 'STOPPED', INITIATING = 'INITIATING', INITIAL_SYNC = 'INITIAL_SYNC', BACKLOG = 'BACKLOG', CREATING_SNAPSHOT = 'CREATING_SNAPSHOT', CONTINUOUS = 'CONTINUOUS', PAUSED = 'PAUSED', RESCAN = 'RESCAN', STALLED = 'STALLED', DISCONNECTED = 'DISCONNECTED', REPLICATION_STATE_NOT_AVAILABLE = 'REPLICATION_STATE_NOT_AVAILABLE', NOT_STARTED = 'NOT_STARTED' }
	...
	export enum EC2InstanceState { PENDING = 'PENDING', RUNNING = 'RUNNING', STOPPING = 'STOPPING', STOPPED = 'STOPPED', 'SHUTTING-DOWN' = 'SHUTTING-DOWN', TERMINATED = 'TERMINATED', NOT_FOUND = 'NOT_FOUND' }
	...
	export enum FailbackState { FAILBACK_NOT_STARTED = 'FAILBACK_NOT_STARTED', FAILBACK_IN_PROGRESS = 'FAILBACK_IN_PROGRESS', FAILBACK_READY_FOR_LAUNCH = 'FAILBACK_READY_FOR_LAUNCH', FAILBACK_COMPLETED = 'FAILBACK_COMPLETED', FAILBACK_ERROR = 'FAILBACK_ERROR', FAILBACK_NOT_READY_FOR_LAUNCH = 'FAILBACK_NOT_READY_FOR_LAUNCH', FAILBACK_LAUNCH_STATE_NOT_AVAILABLE = 'FAILBACK_LAUNCH_STATE_NOT_AVAILABLE' }

	export enum OriginEnvironment { ON_PREMISES = 'ON_PREMISES', AWS = 'AWS' }
	...
	export enum RecoveryResult { NOT_STARTED = 'NOT_STARTED', IN_PROGRESS = 'IN_PROGRESS', SUCCESS = 'SUCCESS', FAIL = 'FAIL', PARTIAL_SUCCESS = 'PARTIAL_SUCCESS', ASSOCIATE_SUCCESS = 'ASSOCIATE_SUCCESS', ASSOCIATE_FAIL = 'ASSOCIATE_FAIL' }

	export enum ReplicationStatus { STOPPED = 'STOPPED', IN_PROGRESS = 'IN_PROGRESS', PROTECTED = 'PROTECTED', ERROR = 'ERROR' }
	...
	export enum ReplicationConfigurationReplicatedDiskStagingDiskType { AUTO = 'AUTO', GP2 = 'GP2', GP3 = 'GP3', IO1 = 'IO1', SC1 = 'SC1', ST1 = 'ST1', STANDARD = 'STANDARD' }
	...
	export enum RecoverySnapshotsOrder { ASC = 'ASC', DESC = 'DESC' }
	...
	export enum FailbackLaunchType { RECOVERY = 'RECOVERY', DRILL = 'DRILL' }
	...
	export enum RecoveryInstanceDataReplicationInitiationStepStatus { NOT_STARTED = 'NOT_STARTED', IN_PROGRESS = 'IN_PROGRESS', SUCCEEDED = 'SUCCEEDED', FAILED = 'FAILED', SKIPPED = 'SKIPPED' }
