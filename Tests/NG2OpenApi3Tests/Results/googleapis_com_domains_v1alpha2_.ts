...
export namespace MyNS {
	...
	export enum ContactSettingsPrivacy { CONTACT_PRIVACY_UNSPECIFIED = 'CONTACT_PRIVACY_UNSPECIFIED', PUBLIC_CONTACT_DATA = 'PUBLIC_CONTACT_DATA', PRIVATE_CONTACT_DATA = 'PRIVATE_CONTACT_DATA', REDACTED_CONTACT_DATA = 'REDACTED_CONTACT_DATA' }
	...
	export enum DsRecordAlgorithm { ALGORITHM_UNSPECIFIED = 'ALGORITHM_UNSPECIFIED', RSAMD5 = 'RSAMD5', DH = 'DH', DSA = 'DSA', ECC = 'ECC', RSASHA1 = 'RSASHA1', DSANSEC3SHA1 = 'DSANSEC3SHA1', RSASHA1NSEC3SHA1 = 'RSASHA1NSEC3SHA1', RSASHA256 = 'RSASHA256', RSASHA512 = 'RSASHA512', ECCGOST = 'ECCGOST', ECDSAP256SHA256 = 'ECDSAP256SHA256', ECDSAP384SHA384 = 'ECDSAP384SHA384', ED25519 = 'ED25519', ED448 = 'ED448', INDIRECT = 'INDIRECT', PRIVATEDNS = 'PRIVATEDNS', PRIVATEOID = 'PRIVATEOID' }

	export enum DsRecordDigestType { DIGEST_TYPE_UNSPECIFIED = 'DIGEST_TYPE_UNSPECIFIED', SHA1 = 'SHA1', SHA256 = 'SHA256', GOST3411 = 'GOST3411', SHA384 = 'SHA384' }
	...
	export enum GoogleDomainsDnsDsState { DS_STATE_UNSPECIFIED = 'DS_STATE_UNSPECIFIED', DS_RECORDS_UNPUBLISHED = 'DS_RECORDS_UNPUBLISHED', DS_RECORDS_PUBLISHED = 'DS_RECORDS_PUBLISHED' }
	...
	export enum ManagementSettingsPreferredRenewalMethod { RENEWAL_METHOD_UNSPECIFIED = 'RENEWAL_METHOD_UNSPECIFIED', AUTOMATIC_RENEWAL = 'AUTOMATIC_RENEWAL', MANUAL_RENEWAL = 'MANUAL_RENEWAL', RENEWAL_DISABLED = 'RENEWAL_DISABLED' }

	export enum ManagementSettingsTransferLockState { TRANSFER_LOCK_STATE_UNSPECIFIED = 'TRANSFER_LOCK_STATE_UNSPECIFIED', UNLOCKED = 'UNLOCKED', LOCKED = 'LOCKED' }
	...
	export enum DomainResourceState { RESOURCE_STATE_UNSPECIFIED = 'RESOURCE_STATE_UNSPECIFIED', IMPORTABLE = 'IMPORTABLE', UNSUPPORTED = 'UNSUPPORTED', SUSPENDED = 'SUSPENDED', EXPIRED = 'EXPIRED', DELETED = 'DELETED' }
	...
	export enum RegistrationRegisterFailureReason { REGISTER_FAILURE_REASON_UNSPECIFIED = 'REGISTER_FAILURE_REASON_UNSPECIFIED', REGISTER_FAILURE_REASON_UNKNOWN = 'REGISTER_FAILURE_REASON_UNKNOWN', DOMAIN_NOT_AVAILABLE = 'DOMAIN_NOT_AVAILABLE', INVALID_CONTACTS = 'INVALID_CONTACTS' }

	export enum RegistrationState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', REGISTRATION_PENDING = 'REGISTRATION_PENDING', REGISTRATION_FAILED = 'REGISTRATION_FAILED', TRANSFER_PENDING = 'TRANSFER_PENDING', TRANSFER_FAILED = 'TRANSFER_FAILED', IMPORT_PENDING = 'IMPORT_PENDING', ACTIVE = 'ACTIVE', SUSPENDED = 'SUSPENDED', EXPORTED = 'EXPORTED', EXPIRED = 'EXPIRED' }

	export enum RegistrationTransferFailureReason { TRANSFER_FAILURE_REASON_UNSPECIFIED = 'TRANSFER_FAILURE_REASON_UNSPECIFIED', TRANSFER_FAILURE_REASON_UNKNOWN = 'TRANSFER_FAILURE_REASON_UNKNOWN', EMAIL_CONFIRMATION_FAILURE = 'EMAIL_CONFIRMATION_FAILURE', DOMAIN_NOT_REGISTERED = 'DOMAIN_NOT_REGISTERED', DOMAIN_HAS_TRANSFER_LOCK = 'DOMAIN_HAS_TRANSFER_LOCK', INVALID_AUTHORIZATION_CODE = 'INVALID_AUTHORIZATION_CODE', TRANSFER_CANCELLED = 'TRANSFER_CANCELLED', TRANSFER_REJECTED = 'TRANSFER_REJECTED', INVALID_REGISTRANT_EMAIL_ADDRESS = 'INVALID_REGISTRANT_EMAIL_ADDRESS', DOMAIN_NOT_ELIGIBLE_FOR_TRANSFER = 'DOMAIN_NOT_ELIGIBLE_FOR_TRANSFER', TRANSFER_ALREADY_PENDING = 'TRANSFER_ALREADY_PENDING' }
	...
	export enum RegisterParametersAvailability { AVAILABILITY_UNSPECIFIED = 'AVAILABILITY_UNSPECIFIED', AVAILABLE = 'AVAILABLE', UNAVAILABLE = 'UNAVAILABLE', UNSUPPORTED = 'UNSUPPORTED', UNKNOWN = 'UNKNOWN' }
	...
	export class MyClient {
		 ...
		 * Get v1alpha2/{location}/registrations:retrieveImportableDomains
		...
		Domains_projects_locations_registrations_retrieveImportableDomains(location: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<RetrieveImportableDomainsResponse> {
			return this.http.get<RetrieveImportableDomainsResponse>(this.baseUri + 'v1alpha2/' + (location == null ? '' : encodeURIComponent(location)) + '/registrations:retrieveImportableDomains&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Gets parameters needed to register a new domain name, including price and up-to-date availability. Use the returned values to call `RegisterDomain`.
		 * Get v1alpha2/{location}/registrations:retrieveRegisterParameters
		 * @param {string} location Required. The location. Must be in the format `projects/locations/*`.
		...
		Domains_projects_locations_registrations_retrieveRegisterParameters(location: string, domainName: string | null | undefined): Observable<RetrieveRegisterParametersResponse> {
			return this.http.get<RetrieveRegisterParametersResponse>(this.baseUri + 'v1alpha2/' + (location == null ? '' : encodeURIComponent(location)) + '/registrations:retrieveRegisterParameters&domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), {});
		}
		 ...
		 * Get v1alpha2/{location}/registrations:retrieveTransferParameters
		 * @param {string} location Required. The location. Must be in the format `projects/locations/*`.
		 * @param {string} domainName Required. The domain name. Unicode domain names must be expressed in Punycode format.
		...
		Domains_projects_locations_registrations_retrieveTransferParameters(location: string, domainName: string | null | undefined): Observable<RetrieveTransferParametersResponse> {
			return this.http.get<RetrieveTransferParametersResponse>(this.baseUri + 'v1alpha2/' + (location == null ? '' : encodeURIComponent(location)) + '/registrations:retrieveTransferParameters&domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), {});
		}
		 ...
		 * Get v1alpha2/{location}/registrations:searchDomains
		 * @param {string} location Required. The location. Must be in the format `projects/locations/*`.
		...
		Domains_projects_locations_registrations_searchDomains(location: string, query: string | null | undefined): Observable<SearchDomainsResponse> {
			return this.http.get<SearchDomainsResponse>(this.baseUri + 'v1alpha2/' + (location == null ? '' : encodeURIComponent(location)) + '/registrations:searchDomains&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		...
		Domains_projects_locations_registrations_delete(name: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Domains_projects_locations_registrations_get(name: string): Observable<Registration> {
			return this.http.get<Registration>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Domains_projects_locations_registrations_export(name: string, requestBody: ExportRegistrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)) + ':export', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists the `Registration` resources in a project.
		 * Get v1alpha2/{parent}/registrations
		...
		Domains_projects_locations_registrations_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListRegistrationsResponse> {
			return this.http.get<ListRegistrationsResponse>(this.baseUri + 'v1alpha2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registrations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * Post v1alpha2/{parent}/registrations:import
		...
		Domains_projects_locations_registrations_import(parent: string, requestBody: ImportDomainRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registrations:import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Registers a new domain name and creates a corresponding `Registration` resource. Call `RetrieveRegisterParameters` first to check availability of the domain name and determine parameters like price that are needed to build a call to this method. A successful call creates a `Registration` resource in state `REGISTRATION_PENDING`, which resolves to `ACTIVE` within 1-2 minutes, indicating that the domain was successfully registered. If the resource ends up in state `REGISTRATION_FAILED`, it indicates that the domain was not registered successfully, and you can safely delete the resource and retry registration.
		 * Post v1alpha2/{parent}/registrations:register
		 * @param {string} parent Required. The parent resource of the `Registration`. Must be in the format `projects/locations/*`.
		 * @return {Operation} Successful response
		 */
		Domains_projects_locations_registrations_register(parent: string, requestBody: RegisterDomainRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registrations:register', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Post v1alpha2/{parent}/registrations:transfer
		 * @param {string} parent Required. The parent resource of the `Registration`. Must be in the format `projects/locations/*`.
		 * @return {Operation} Successful response
		 */
		Domains_projects_locations_registrations_transfer(parent: string, requestBody: TransferDomainRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registrations:transfer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates a `Registration`'s contact settings. Some changes require confirmation by the domain's registrant contact .
		 * Post v1alpha2/{registration}:configureContactSettings
		...
		Domains_projects_locations_registrations_configureContactSettings(registration: string, requestBody: ConfigureContactSettingsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha2/' + (registration == null ? '' : encodeURIComponent(registration)) + ':configureContactSettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates a `Registration`'s DNS settings.
		 * Post v1alpha2/{registration}:configureDnsSettings
		...
		Domains_projects_locations_registrations_configureDnsSettings(registration: string, requestBody: ConfigureDnsSettingsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha2/' + (registration == null ? '' : encodeURIComponent(registration)) + ':configureDnsSettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates a `Registration`'s management settings.
		 * Post v1alpha2/{registration}:configureManagementSettings
		...
		Domains_projects_locations_registrations_configureManagementSettings(registration: string, requestBody: ConfigureManagementSettingsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha2/' + (registration == null ? '' : encodeURIComponent(registration)) + ':configureManagementSettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Post v1alpha2/{registration}:resetAuthorizationCode
		...
		Domains_projects_locations_registrations_resetAuthorizationCode(registration: string, requestBody: ResetAuthorizationCodeRequest): Observable<AuthorizationCode> {
			return this.http.post<AuthorizationCode>(this.baseUri + 'v1alpha2/' + (registration == null ? '' : encodeURIComponent(registration)) + ':resetAuthorizationCode', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Get v1alpha2/{registration}:retrieveAuthorizationCode
		...
		Domains_projects_locations_registrations_retrieveAuthorizationCode(registration: string): Observable<AuthorizationCode> {
			return this.http.get<AuthorizationCode>(this.baseUri + 'v1alpha2/' + (registration == null ? '' : encodeURIComponent(registration)) + ':retrieveAuthorizationCode', {});
		}
