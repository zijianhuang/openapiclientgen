...
export namespace MyNS {
	...
	export enum QuotaOperationQuotaMode { UNSPECIFIED = 0, NORMAL = 1, BEST_EFFORT = 2, CHECK_ONLY = 3, ADJUST_ONLY = 4 }
	...
	export enum OperationImportance { LOW = 0, HIGH = 1, DEBUG = 2, PROMOTED = 3 }
	...
	export enum QuotaPropertiesQuotaMode { ACQUIRE = 0, ACQUIRE_BEST_EFFORT = 1, CHECK = 2 }
