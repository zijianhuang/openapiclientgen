...
export namespace MyNS {
	...
	export interface AutoscaleFormProperties {
		...
		/** Output only. The slot capacity added to this reservation when autoscale happens. Will be between [0, max_slots]. */
		currentSlots: FormControl<string | null | undefined>,

		/** Number of slots to be scaled when needed. */
		maxSlots: FormControl<string | null | undefined>,
	}
	export function CreateAutoscaleFormGroup() {
		return new FormGroup<AutoscaleFormProperties>({
			currentSlots: new FormControl<string | null | undefined>(undefined),
			maxSlots: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface CapacityCommitment {
		...
		edition?: CapacityCommitmentEdition | null;
	...
	export interface CapacityCommitmentFormProperties {
		...
		/** Edition of the capacity commitment. */
		edition: FormControl<CapacityCommitmentEdition | null | undefined>,

		/** Output only. If true, the commitment is a flat-rate commitment, otherwise, it's an edition commitment. */
		isFlatRate: FormControl<boolean | null | undefined>,
	...
	export function CreateCapacityCommitmentFormGroup() {
		return new FormGroup<CapacityCommitmentFormProperties>({
			...
			edition: new FormControl<CapacityCommitmentEdition | null | undefined>(undefined),
			isFlatRate: new FormControl<boolean | null | undefined>(undefined),
	...
	/** The response for ReservationService.SearchAllAssignments. */
	export interface SearchAllAssignmentsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateSearchAllAssignmentsResponseFormGroup() {
		return new FormGroup<SearchAllAssignmentsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		...
		Bigqueryreservation_projects_locations_reservations_get(name: string): Observable<Reservation> {
			return this.http.get<Reservation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Bigqueryreservation_projects_locations_reservations_assignments_patch(name: string, updateMask: string | null | undefined, requestBody: Assignment): Observable<Assignment> {
			return this.http.patch<Assignment>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Bigqueryreservation_projects_locations_reservations_assignments_move(name: string, requestBody: MoveAssignmentRequest): Observable<Assignment> {
			return this.http.post<Assignment>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':move', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Bigqueryreservation_projects_locations_capacityCommitments_split(name: string, requestBody: SplitCapacityCommitmentRequest): Observable<SplitCapacityCommitmentResponse> {
			return this.http.post<SplitCapacityCommitmentResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':split', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Bigqueryreservation_projects_locations_reservations_assignments_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAssignmentsResponse> {
			return this.http.get<ListAssignmentsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assignments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Bigqueryreservation_projects_locations_reservations_assignments_create(parent: string, assignmentId: string | null | undefined, requestBody: Assignment): Observable<Assignment> {
			return this.http.post<Assignment>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assignments&assignmentId=' + (assignmentId == null ? '' : encodeURIComponent(assignmentId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Bigqueryreservation_projects_locations_capacityCommitments_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCapacityCommitmentsResponse> {
			return this.http.get<ListCapacityCommitmentsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/capacityCommitments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Bigqueryreservation_projects_locations_capacityCommitments_merge(parent: string, requestBody: MergeCapacityCommitmentsRequest): Observable<CapacityCommitment> {
			return this.http.post<CapacityCommitment>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/capacityCommitments:merge', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Bigqueryreservation_projects_locations_reservations_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListReservationsResponse> {
			return this.http.get<ListReservationsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/reservations&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Bigqueryreservation_projects_locations_reservations_create(parent: string, reservationId: string | null | undefined, requestBody: Reservation): Observable<Reservation> {
			return this.http.post<Reservation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/reservations&reservationId=' + (reservationId == null ? '' : encodeURIComponent(reservationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Bigqueryreservation_projects_locations_searchAllAssignments(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, query: string | null | undefined): Observable<SearchAllAssignmentsResponse> {
			return this.http.get<SearchAllAssignmentsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':searchAllAssignments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		...
		Bigqueryreservation_projects_locations_searchAssignments(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, query: string | null | undefined): Observable<SearchAssignmentsResponse> {
			return this.http.get<SearchAssignmentsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':searchAssignments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
	}
