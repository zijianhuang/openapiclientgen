...
export namespace MyNS {
	...
	/** Metadata for CreateMembership LRO. */
	export interface CreateMembershipMetadataFormProperties {
	}
	export function CreateCreateMembershipMetadataFormGroup() {
		return new FormGroup<CreateMembershipMetadataFormProperties>({
		});
	...
	/** Metadata for DeleteGroup LRO. */
	export interface DeleteGroupMetadataFormProperties {
	}
	export function CreateDeleteGroupMetadataFormGroup() {
		return new FormGroup<DeleteGroupMetadataFormProperties>({
		});
	...
	/** Metadata for DeleteMembership LRO. */
	export interface DeleteMembershipMetadataFormProperties {
	}
	export function CreateDeleteMembershipMetadataFormGroup() {
		return new FormGroup<DeleteMembershipMetadataFormProperties>({
		});
	...
	/** Metadata of GetMembershipGraphResponse LRO. This is currently empty to permit future extensibility. */
	export interface GetMembershipGraphMetadataFormProperties {
	}
	export function CreateGetMembershipGraphMetadataFormGroup() {
		return new FormGroup<GetMembershipGraphMetadataFormProperties>({
		});
	...
	export interface GoogleAppsCloudidentityDevicesV1AndroidAttributes {
		...
		ownershipPrivilege?: GoogleAppsCloudidentityDevicesV1AndroidAttributesOwnershipPrivilege | null;
	...
	export interface GoogleAppsCloudidentityDevicesV1AndroidAttributesFormProperties {
		...
		/** Ownership privileges on device. */
		ownershipPrivilege: FormControl<GoogleAppsCloudidentityDevicesV1AndroidAttributesOwnershipPrivilege | null | undefined>,
	...
	export function CreateGoogleAppsCloudidentityDevicesV1AndroidAttributesFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1AndroidAttributesFormProperties>({
			...
			ownershipPrivilege: new FormControl<GoogleAppsCloudidentityDevicesV1AndroidAttributesOwnershipPrivilege | null | undefined>(undefined),
	...
	/** Request message for approving the device to access user data. */
	export interface GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequestFormProperties {

		/** Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer. If you're using this API for your own organization, use `customers/my_customer` If you're using this API to manage another organization, use `customers/{customer}`, where customer is the customer to whom the device belongs. */
		customer: FormControl<string | null | undefined>,
	}
	export function CreateGoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequestFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequestFormProperties>({
	...
	export interface GoogleAppsCloudidentityDevicesV1DeviceUser {
		...
		compromisedState?: GoogleAppsCloudidentityDevicesV1DeviceUserCompromisedState | null;
		...
		managementState?: GoogleAppsCloudidentityDevicesV1DeviceUserManagementState | null;
		...
		passwordState?: GoogleAppsCloudidentityDevicesV1DeviceUserPasswordState | null;
	...
	export interface GoogleAppsCloudidentityDevicesV1DeviceUserFormProperties {
		...
		/** Compromised State of the DeviceUser object */
		compromisedState: FormControl<GoogleAppsCloudidentityDevicesV1DeviceUserCompromisedState | null | undefined>,
		...
		/** Output only. Management state of the user on the device. */
		managementState: FormControl<GoogleAppsCloudidentityDevicesV1DeviceUserManagementState | null | undefined>,

		/** Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the DeviceUser in format: `devices/{device}/deviceUsers/{device_user}`, where `device_user` uniquely identifies a user's use of a device. */
		name: FormControl<string | null | undefined>,

		/** Password state of the DeviceUser object */
		passwordState: FormControl<GoogleAppsCloudidentityDevicesV1DeviceUserPasswordState | null | undefined>,
	...
	export function CreateGoogleAppsCloudidentityDevicesV1DeviceUserFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1DeviceUserFormProperties>({
			compromisedState: new FormControl<GoogleAppsCloudidentityDevicesV1DeviceUserCompromisedState | null | undefined>(undefined),
			createTime: new FormControl<string | null | undefined>(undefined),
			...
			managementState: new FormControl<GoogleAppsCloudidentityDevicesV1DeviceUserManagementState | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			passwordState: new FormControl<GoogleAppsCloudidentityDevicesV1DeviceUserPasswordState | null | undefined>(undefined),
	...
	/** Request message for blocking account on device. */
	export interface GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequestFormProperties {

		/** Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer. If you're using this API for your own organization, use `customers/my_customer` If you're using this API to manage another organization, use `customers/{customer}`, where customer is the customer to whom the device belongs. */
		customer: FormControl<string | null | undefined>,
	}
	export function CreateGoogleAppsCloudidentityDevicesV1BlockDeviceUserRequestFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequestFormProperties>({
			customer: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message for cancelling an unfinished device wipe. */
	export interface GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequestFormProperties {

		/** Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer. If you're using this API for your own organization, use `customers/my_customer` If you're using this API to manage another organization, use `customers/{customer}`, where customer is the customer to whom the device belongs. */
		customer: FormControl<string | null | undefined>,
	}
	export function CreateGoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequestFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1CancelWipeDeviceRequestFormProperties>({
			customer: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleAppsCloudidentityDevicesV1Device {
		...
		compromisedState?: GoogleAppsCloudidentityDevicesV1DeviceCompromisedState | null;
		...
		deviceType?: GoogleAppsCloudidentityDevicesV1DeviceDeviceType | null;
		...
		encryptionState?: GoogleAppsCloudidentityDevicesV1DeviceEncryptionState | null;
		...
		managementState?: GoogleAppsCloudidentityDevicesV1DeviceManagementState | null;
		...
		ownerType?: GoogleAppsCloudidentityDevicesV1DeviceOwnerType | null;
	...
	export interface GoogleAppsCloudidentityDevicesV1DeviceFormProperties {
		...
		/** Output only. Represents whether the Device is compromised. */
		compromisedState: FormControl<GoogleAppsCloudidentityDevicesV1DeviceCompromisedState | null | undefined>,
		...
		/** Output only. Type of device. */
		deviceType: FormControl<GoogleAppsCloudidentityDevicesV1DeviceDeviceType | null | undefined>,
		...
		/** Output only. Device encryption state. */
		encryptionState: FormControl<GoogleAppsCloudidentityDevicesV1DeviceEncryptionState | null | undefined>,
		...
		/** Output only. Management state of the device */
		managementState: FormControl<GoogleAppsCloudidentityDevicesV1DeviceManagementState | null | undefined>,
		...
		/** Output only. Whether the device is owned by the company or an individual */
		ownerType: FormControl<GoogleAppsCloudidentityDevicesV1DeviceOwnerType | null | undefined>,
	...
	export function CreateGoogleAppsCloudidentityDevicesV1DeviceFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1DeviceFormProperties>({
			...
			compromisedState: new FormControl<GoogleAppsCloudidentityDevicesV1DeviceCompromisedState | null | undefined>(undefined),
			createTime: new FormControl<string | null | undefined>(undefined),
			deviceId: new FormControl<string | null | undefined>(undefined),
			deviceType: new FormControl<GoogleAppsCloudidentityDevicesV1DeviceDeviceType | null | undefined>(undefined),
			...
			encryptionState: new FormControl<GoogleAppsCloudidentityDevicesV1DeviceEncryptionState | null | undefined>(undefined),
			...
			lastSyncTime: new FormControl<string | null | undefined>(undefined),
			managementState: new FormControl<GoogleAppsCloudidentityDevicesV1DeviceManagementState | null | undefined>(undefined),
			...
			ownerType: new FormControl<GoogleAppsCloudidentityDevicesV1DeviceOwnerType | null | undefined>(undefined),
	...
	/** Request message for cancelling an unfinished user account wipe. */
	export interface GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequestFormProperties {

		/** Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer. If you're using this API for your own organization, use `customers/my_customer` If you're using this API to manage another organization, use `customers/{customer}`, where customer is the customer to whom the device belongs. */
		customer: FormControl<string | null | undefined>,
	}
	export function CreateGoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequestFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequestFormProperties>({
			customer: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleAppsCloudidentityDevicesV1ClientState {
		...
		complianceState?: GoogleAppsCloudidentityDevicesV1ClientStateComplianceState | null;
		...
		healthScore?: GoogleAppsCloudidentityDevicesV1ClientStateHealthScore | null;
		...
		managed?: GoogleAppsCloudidentityDevicesV1ClientStateManaged | null;
		...
		ownerType?: GoogleAppsCloudidentityDevicesV1ClientStateOwnerType | null;
	...
	export interface GoogleAppsCloudidentityDevicesV1ClientStateFormProperties {
		...
		/** The compliance state of the resource as specified by the API client. */
		complianceState: FormControl<GoogleAppsCloudidentityDevicesV1ClientStateComplianceState | null | undefined>,
		...
		/** The Health score of the resource. The Health score is the callers specification of the condition of the device from a usability point of view. For example, a third-party device management provider may specify a health score based on its compliance with organizational policies. */
		healthScore: FormControl<GoogleAppsCloudidentityDevicesV1ClientStateHealthScore | null | undefined>,
		...
		/** The management state of the resource as specified by the API client. */
		managed: FormControl<GoogleAppsCloudidentityDevicesV1ClientStateManaged | null | undefined>,

		/** Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the ClientState in format: `devices/{device}/deviceUsers/{device_user}/clientState/{partner}`, where partner corresponds to the partner storing the data. For partners belonging to the "BeyondCorp Alliance", this is the partner ID specified to you by Google. For all other callers, this is a string of the form: `{customer}-suffix`, where `customer` is your customer ID. The *suffix* is any string the caller specifies. This string will be displayed verbatim in the administration console. This suffix is used in setting up Custom Access Levels in Context-Aware Access. Your organization's customer ID can be obtained from the URL: `GET https://www.googleapis.com/admin/directory/v1/customers/my_customer` The `id` field in the response contains the customer ID starting with the letter 'C'. The customer ID to be used in this API is the string after the letter 'C' (not including 'C') */
		name: FormControl<string | null | undefined>,

		/** Output only. The owner of the ClientState */
		ownerType: FormControl<GoogleAppsCloudidentityDevicesV1ClientStateOwnerType | null | undefined>,
	...
	export function CreateGoogleAppsCloudidentityDevicesV1ClientStateFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1ClientStateFormProperties>({
			complianceState: new FormControl<GoogleAppsCloudidentityDevicesV1ClientStateComplianceState | null | undefined>(undefined),
			createTime: new FormControl<string | null | undefined>(undefined),
			customId: new FormControl<string | null | undefined>(undefined),
			etag: new FormControl<string | null | undefined>(undefined),
			healthScore: new FormControl<GoogleAppsCloudidentityDevicesV1ClientStateHealthScore | null | undefined>(undefined),
			...
			managed: new FormControl<GoogleAppsCloudidentityDevicesV1ClientStateManaged | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			ownerType: new FormControl<GoogleAppsCloudidentityDevicesV1ClientStateOwnerType | null | undefined>(undefined),
	...
	/** Response message that is returned in ListClientStates. */
	export interface GoogleAppsCloudidentityDevicesV1ListClientStatesResponseFormProperties {

		/** Token to retrieve the next page of results. Empty if there are no more results. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleAppsCloudidentityDevicesV1ListClientStatesResponseFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1ListClientStatesResponseFormProperties>({
	...
	/** Response message that is returned from the ListDeviceUsers method. */
	export interface GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponseFormProperties {

		/** Token to retrieve the next page of results. Empty if there are no more results. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleAppsCloudidentityDevicesV1ListDeviceUsersResponseFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message that is returned from the ListDevices method. */
	export interface GoogleAppsCloudidentityDevicesV1ListDevicesResponseFormProperties {

		/** Token to retrieve the next page of results. Empty if there are no more results. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleAppsCloudidentityDevicesV1ListDevicesResponseFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1ListDevicesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response containing resource names of the DeviceUsers associated with the caller's credentials. */
	export interface GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponseFormProperties {
	...
	export function CreateGoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponseFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponseFormProperties>({
			customer: new FormControl<string | null | undefined>(undefined),
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message for wiping all data on the device. */
	export interface GoogleAppsCloudidentityDevicesV1WipeDeviceRequestFormProperties {
	...
	export function CreateGoogleAppsCloudidentityDevicesV1WipeDeviceRequestFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1WipeDeviceRequestFormProperties>({
			customer: new FormControl<string | null | undefined>(undefined),
	...
	/** Request message for starting an account wipe on device. */
	export interface GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequestFormProperties {

		/** Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer. If you're using this API for your own organization, use `customers/my_customer` If you're using this API to manage another organization, use `customers/{customer}`, where customer is the customer to whom the device belongs. */
		customer: FormControl<string | null | undefined>,
	}
	export function CreateGoogleAppsCloudidentityDevicesV1WipeDeviceUserRequestFormGroup() {
		return new FormGroup<GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequestFormProperties>({
			customer: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Metadata for UpdateGroup LRO. */
	export interface UpdateGroupMetadataFormProperties {
	}
	export function CreateUpdateGroupMetadataFormGroup() {
		return new FormGroup<UpdateGroupMetadataFormProperties>({
		});
	...
	/** Metadata for UpdateMembership LRO. */
	export interface UpdateMembershipMetadataFormProperties {
	}
	export function CreateUpdateMembershipMetadataFormGroup() {
		return new FormGroup<UpdateMembershipMetadataFormProperties>({
		});
	...
	export class MyClient {
		 ...
		 * @return {GoogleAppsCloudidentityDevicesV1ListDevicesResponse} Successful response
		 */
		Cloudidentity_devices_list(customer: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Cloudidentity_devices_listView | null | undefined): Observable<GoogleAppsCloudidentityDevicesV1ListDevicesResponse> {
			return this.http.get<GoogleAppsCloudidentityDevicesV1ListDevicesResponse>(this.baseUri + 'v1/devices?customer=' + (customer == null ? '' : encodeURIComponent(customer)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		 ...
		 */
		Cloudidentity_devices_create(customer: string | null | undefined, requestBody: GoogleAppsCloudidentityDevicesV1Device): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/devices?customer=' + (customer == null ? '' : encodeURIComponent(customer)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudidentity_groups_list(pageSize: number | null | undefined, pageToken: string | null | undefined, parent: string | null | undefined, view: Cloudidentity_groups_listView | null | undefined): Observable<ListGroupsResponse> {
			return this.http.get<ListGroupsResponse>(this.baseUri + 'v1/groups?pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&parent=' + (parent == null ? '' : encodeURIComponent(parent)) + '&view=' + view, {});
		}

		/**
		 * Creates a Group.
		 * Post v1/groups
		 * @param {Cloudidentity_groups_createInitialGroupConfig} initialGroupConfig Optional. The initial configuration option for the `Group`.
		 * @return {Operation} Successful response
		 */
		Cloudidentity_groups_create(initialGroupConfig: Cloudidentity_groups_createInitialGroupConfig | null | undefined, requestBody: Group): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/groups?initialGroupConfig=' + initialGroupConfig, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Looks up the [resource name](https://cloud.google.com/apis/design/resource_names) of a `Group` by its `EntityKey`.
		 * Get v1/groups:lookup
		 * @param {string} groupKey_id The ID of the entity. For Google-managed entities, the `id` should be the email address of an existing group or user. Email addresses need to adhere to [name guidelines for users and groups](https://support.google.com/a/answer/9193374). For external-identity-mapped entities, the `id` must be a string conforming to the Identity Source's requirements. Must be unique within a `namespace`.
		...
		Cloudidentity_groups_lookup(groupKey_id: string | null | undefined, groupKey_namespace: string | null | undefined): Observable<LookupGroupNameResponse> {
			return this.http.get<LookupGroupNameResponse>(this.baseUri + 'v1/groups:lookup?groupKey_id=' + (groupKey_id == null ? '' : encodeURIComponent(groupKey_id)) + '&groupKey_namespace=' + (groupKey_namespace == null ? '' : encodeURIComponent(groupKey_namespace)), {});
		}
		 ...
		 */
		Cloudidentity_groups_search(pageSize: number | null | undefined, pageToken: string | null | undefined, query: string | null | undefined, view: Cloudidentity_groups_listView | null | undefined): Observable<SearchGroupsResponse> {
			return this.http.get<SearchGroupsResponse>(this.baseUri + 'v1/groups:search?pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&view=' + view, {});
		}
		...
		Cloudidentity_inboundSamlSsoProfiles_list(filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInboundSamlSsoProfilesResponse> {
			return this.http.get<ListInboundSamlSsoProfilesResponse>(this.baseUri + 'v1/inboundSamlSsoProfiles?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudidentity_inboundSamlSsoProfiles_create(requestBody: InboundSamlSsoProfile): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/inboundSamlSsoProfiles', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudidentity_inboundSsoAssignments_list(filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInboundSsoAssignmentsResponse> {
			return this.http.get<ListInboundSsoAssignmentsResponse>(this.baseUri + 'v1/inboundSsoAssignments?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudidentity_inboundSsoAssignments_create(requestBody: InboundSsoAssignment): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/inboundSsoAssignments', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudidentity_inboundSsoAssignments_delete(name: string, customer: string | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&customer=' + (customer == null ? '' : encodeURIComponent(customer)), {});
		}
		...
		Cloudidentity_inboundSsoAssignments_get(name: string, readMask: string | null | undefined): Observable<InboundSsoAssignment> {
			return this.http.get<InboundSsoAssignment>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&readMask=' + (readMask == null ? '' : encodeURIComponent(readMask)), {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Cloudidentity_devices_deviceUsers_approve(name: string, requestBody: GoogleAppsCloudidentityDevicesV1ApproveDeviceUserRequest): Observable<Operation> {
		 ...
		 * @return {Operation} Successful response
		 */
		Cloudidentity_devices_deviceUsers_block(name: string, requestBody: GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':block', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Cloudidentity_devices_deviceUsers_cancelWipe(name: string, requestBody: GoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':cancelWipe', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudidentity_customers_userinvitations_isInvitableUser(name: string): Observable<IsInvitableUserResponse> {
			return this.http.get<IsInvitableUserResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':isInvitableUser', {});
		}
		...
		Cloudidentity_groups_memberships_modifyMembershipRoles(name: string, requestBody: ModifyMembershipRolesRequest): Observable<ModifyMembershipRolesResponse> {
			return this.http.post<ModifyMembershipRolesResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':modifyMembershipRoles', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudidentity_customers_userinvitations_send(name: string, requestBody: SendUserInvitationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':send', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Cloudidentity_devices_deviceUsers_wipe(name: string, requestBody: GoogleAppsCloudidentityDevicesV1WipeDeviceUserRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':wipe', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleAppsCloudidentityDevicesV1ListClientStatesResponse} Successful response
		 */
		Cloudidentity_devices_deviceUsers_clientStates_list(parent: string, customer: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageToken: string | null | undefined): Observable<GoogleAppsCloudidentityDevicesV1ListClientStatesResponse> {
			return this.http.get<GoogleAppsCloudidentityDevicesV1ListClientStatesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clientStates&customer=' + (customer == null ? '' : encodeURIComponent(customer)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse} Successful response
		 */
		Cloudidentity_devices_deviceUsers_list(parent: string, customer: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse> {
			return this.http.get<GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/deviceUsers&customer=' + (customer == null ? '' : encodeURIComponent(customer)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudidentity_inboundSamlSsoProfiles_idpCredentials_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListIdpCredentialsResponse> {
			return this.http.get<ListIdpCredentialsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/idpCredentials&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudidentity_inboundSamlSsoProfiles_idpCredentials_add(parent: string, requestBody: AddIdpCredentialRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/idpCredentials:add', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Cloudidentity_groups_memberships_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Cloudidentity_groups_listView | null | undefined): Observable<ListMembershipsResponse> {
			return this.http.get<ListMembershipsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Cloudidentity_groups_memberships_create(parent: string, requestBody: Membership): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudidentity_groups_memberships_checkTransitiveMembership(parent: string, query: string | null | undefined): Observable<CheckTransitiveMembershipResponse> {
			return this.http.get<CheckTransitiveMembershipResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:checkTransitiveMembership&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		...
		Cloudidentity_groups_memberships_getMembershipGraph(parent: string, query: string | null | undefined): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:getMembershipGraph&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		...
		Cloudidentity_groups_memberships_lookup(parent: string, memberKey_id: string | null | undefined, memberKey_namespace: string | null | undefined): Observable<LookupMembershipNameResponse> {
			return this.http.get<LookupMembershipNameResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:lookup&memberKey_id=' + (memberKey_id == null ? '' : encodeURIComponent(memberKey_id)) + '&memberKey_namespace=' + (memberKey_namespace == null ? '' : encodeURIComponent(memberKey_namespace)), {});
		}
		...
		Cloudidentity_groups_memberships_searchDirectGroups(parent: string, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, query: string | null | undefined): Observable<SearchDirectGroupsResponse> {
			return this.http.get<SearchDirectGroupsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:searchDirectGroups&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		...
		Cloudidentity_groups_memberships_searchTransitiveGroups(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, query: string | null | undefined): Observable<SearchTransitiveGroupsResponse> {
			return this.http.get<SearchTransitiveGroupsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:searchTransitiveGroups&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		...
		Cloudidentity_groups_memberships_searchTransitiveMemberships(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<SearchTransitiveMembershipsResponse> {
			return this.http.get<SearchTransitiveMembershipsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:searchTransitiveMemberships&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudidentity_customers_userinvitations_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListUserInvitationsResponse> {
			return this.http.get<ListUserInvitationsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/userinvitations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse} Successful response
		 */
		Cloudidentity_devices_deviceUsers_lookup(parent: string, androidId: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, rawResourceId: string | null | undefined, userId: string | null | undefined): Observable<GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse> {
			return this.http.get<GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':lookup&androidId=' + (androidId == null ? '' : encodeURIComponent(androidId)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&rawResourceId=' + (rawResourceId == null ? '' : encodeURIComponent(rawResourceId)) + '&userId=' + (userId == null ? '' : encodeURIComponent(userId)), {});
		}
	}
