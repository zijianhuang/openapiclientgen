...
export namespace MyNS {
	...
	export interface GoogleCloudMemcacheV1LocationMetadata {
		...
		availableZones?: {[id: string]: GoogleCloudMemcacheV1ZoneMetadata };
	}

	/** Metadata for the given google.cloud.location.Location. */
	export interface GoogleCloudMemcacheV1LocationMetadataFormProperties {

		/** Output only. The set of available zones in the location. The map is keyed by the lowercase ID of each zone, as defined by GCE. These keys can be specified in the `zones` field when creating a Memcached instance. */
		availableZones: FormControl<{[id: string]: GoogleCloudMemcacheV1ZoneMetadata } | null | undefined>,
	}
	export function CreateGoogleCloudMemcacheV1LocationMetadataFormGroup() {
		return new FormGroup<GoogleCloudMemcacheV1LocationMetadataFormProperties>({
			availableZones: new FormControl<{[id: string]: GoogleCloudMemcacheV1ZoneMetadata } | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudMemcacheV1ZoneMetadataFormProperties {
	}
	export function CreateGoogleCloudMemcacheV1ZoneMetadataFormGroup() {
		return new FormGroup<GoogleCloudMemcacheV1ZoneMetadataFormProperties>({
		});
	...
	/** Maintenance policy per instance. */
	export interface GoogleCloudMemcacheV1MaintenancePolicyFormProperties {
	...
	export function CreateGoogleCloudMemcacheV1MaintenancePolicyFormGroup() {
		return new FormGroup<GoogleCloudMemcacheV1MaintenancePolicyFormProperties>({
	...
	/** Represents the metadata of a long-running operation. */
	export interface GoogleCloudMemcacheV1OperationMetadataFormProperties {
	...
	export function CreateGoogleCloudMemcacheV1OperationMetadataFormGroup() {
		return new FormGroup<GoogleCloudMemcacheV1OperationMetadataFormProperties>({
	...
	export interface GoogleCloudMemcacheV1UpgradeInstanceRequest {
		...
		memcacheVersion?: GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersion | null;
	}

	/** Request for UpgradeInstance. */
	export interface GoogleCloudMemcacheV1UpgradeInstanceRequestFormProperties {

		/** Required. Specifies the target version of memcached engine to upgrade to. */
		memcacheVersion: FormControl<GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersion | null | undefined>,
	}
	export function CreateGoogleCloudMemcacheV1UpgradeInstanceRequestFormGroup() {
		return new FormGroup<GoogleCloudMemcacheV1UpgradeInstanceRequestFormProperties>({
			memcacheVersion: new FormControl<GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersion | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersion { MEMCACHE_VERSION_UNSPECIFIED = 'MEMCACHE_VERSION_UNSPECIFIED', MEMCACHE_1_5 = 'MEMCACHE_1_5', MEMCACHE_1_6_15 = 'MEMCACHE_1_6_15' }
	...
	export class MyClient {
		...
		Memcache_projects_locations_instances_rescheduleMaintenance(instance: string, requestBody: RescheduleMaintenanceRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (instance == null ? '' : encodeURIComponent(instance)) + ':rescheduleMaintenance', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Memcache_projects_locations_instances_applyParameters(name: string, requestBody: ApplyParametersRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':applyParameters', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Memcache_projects_locations_instances_updateParameters(name: string, requestBody: UpdateParametersRequest): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':updateParameters', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Memcache_projects_locations_instances_upgrade(name: string, requestBody: GoogleCloudMemcacheV1UpgradeInstanceRequest): Observable<Operation> {
