...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Workflows_projects_locations_workflows_get(name: string): Observable<Workflow> {
			return this.http.get<Workflow>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Workflows_projects_locations_workflows_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListWorkflowsResponse> {
			return this.http.get<ListWorkflowsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workflows&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Workflows_projects_locations_workflows_create(parent: string, workflowId: string | null | undefined, requestBody: Workflow): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workflows&workflowId=' + (workflowId == null ? '' : encodeURIComponent(workflowId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
