...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {EscerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Escer(requestBody: EscerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'escer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {SkcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Skcer(requestBody: SkcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'skcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface EscerPostBody {
		certificateParameters?: EscerPostBodyCertificateParameters;
	...
	export interface EscerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<EscerPostBodyFormat | null | undefined>,
	...
	export function CreateEscerPostBodyFormGroup() {
		return new FormGroup<EscerPostBodyFormProperties>({
			format: new FormControl<EscerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface EscerPostBodyCertificateParameters {
	...
	export interface EscerPostBodyCertificateParametersFormProperties {
	...
	export function CreateEscerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<EscerPostBodyCertificateParametersFormProperties>({
	...
	export enum EscerPostBodyFormat { pdf = 'pdf' }

	export interface SkcerPostBody {
		certificateParameters?: SkcerPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface SkcerPostBodyFormProperties {
	...
	export function CreateSkcerPostBodyFormGroup() {
		return new FormGroup<SkcerPostBodyFormProperties>({
			format: new FormControl<EscerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SkcerPostBodyCertificateParameters {
	...
	export interface SkcerPostBodyCertificateParametersFormProperties {

		/**
		 * Centre Candidate ID
		 * Required
		 */
		CentCID: FormControl<string | null | undefined>,

		/**
		 * Unique Certificate Number
		 * Required
		 */
		CertID: FormControl<string | null | undefined>,
	...
	export function CreateSkcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SkcerPostBodyCertificateParametersFormProperties>({
			CentCID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			CertID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
