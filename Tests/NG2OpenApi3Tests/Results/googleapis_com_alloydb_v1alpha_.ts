...
export namespace MyNS {
	...
	export enum BackupDatabaseVersion { DATABASE_VERSION_UNSPECIFIED = 0, POSTGRES_13 = 1, POSTGRES_14 = 2, POSTGRES_15 = 3 }
	...
	export enum BackupState { STATE_UNSPECIFIED = 0, READY = 1, CREATING = 2, FAILED = 3, DELETING = 4 }

	export enum BackupType { TYPE_UNSPECIFIED = 0, ON_DEMAND = 1, AUTOMATED = 2, CONTINUOUS = 3 }
	...
	export enum SslConfigCaSource { CA_SOURCE_UNSPECIFIED = 0, CA_SOURCE_MANAGED = 1 }

	export enum SslConfigSslMode { SSL_MODE_UNSPECIFIED = 0, SSL_MODE_ALLOW = 1, SSL_MODE_REQUIRE = 2, SSL_MODE_VERIFY_CA = 3, ALLOW_UNENCRYPTED_AND_ENCRYPTED = 4, ENCRYPTED_ONLY = 5 }
	...
	export enum CloudControl2SharedOperationsReconciliationOperationMetadataExclusiveAction { UNKNOWN_REPAIR_ACTION = 0, DELETE = 1, RETRY = 2 }
	...
	export enum ClusterClusterType { CLUSTER_TYPE_UNSPECIFIED = 0, PRIMARY = 1, SECONDARY = 2 }
	...
	export enum MigrationSourceSourceType { MIGRATION_SOURCE_TYPE_UNSPECIFIED = 0, DMS = 1 }
	...
	export enum ClusterState { STATE_UNSPECIFIED = 0, READY = 1, STOPPED = 2, EMPTY = 3, CREATING = 4, DELETING = 5, FAILED = 6, BOOTSTRAPPING = 7, MAINTENANCE = 8, PROMOTING = 9 }
	...
	export enum InjectFaultRequestFaultType { FAULT_TYPE_UNSPECIFIED = 0, STOP_VM = 1 }
	...
	export enum InstanceAvailabilityType { AVAILABILITY_TYPE_UNSPECIFIED = 0, ZONAL = 1, REGIONAL = 2 }

	export enum InstanceInstanceType { INSTANCE_TYPE_UNSPECIFIED = 0, PRIMARY = 1, READ_POOL = 2, SECONDARY = 3 }
	...
	export interface PscInstanceConfig {
		...
		allowedConsumerNetworks?: Array<string>;
		...
		outgoingServiceAttachmentLinks?: Array<string>;
	...
	/** PscInstanceConfig contains PSC related configuration at an instance level. NEXT ID: 7 */
	export interface PscInstanceConfigFormProperties {

		/** Optional. Whether PSC connectivity is enabled for this instance. This is populated by referencing the value from the parent cluster. */
		pscEnabled: FormControl<boolean | null | undefined>,

		/** Output only. The service attachment created when Private Service Connect (PSC) is enabled for the instance. The name of the resource will be in the format of projects//regions//serviceAttachments/ */
		serviceAttachmentLink: FormControl<string | null | undefined>,
	}
	export function CreatePscInstanceConfigFormGroup() {
		return new FormGroup<PscInstanceConfigFormProperties>({
			pscEnabled: new FormControl<boolean | null | undefined>(undefined),
			serviceAttachmentLink: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface PscInterfaceConfig {
		...
		consumerEndpointIps?: Array<string>;
	...
	/** Configuration for setting up a PSC interface. This information needs to be provided by the customer. PSC interfaces will be created and added to VMs via SLM (adding a network interface will require recreating the VM). For HA instances this will be done via LDTM. */
	export interface PscInterfaceConfigFormProperties {

		/** The NetworkAttachment resource created in the consumer VPC to which the PSC interface will be linked, in the form of: "projects/${CONSUMER_PROJECT}/regions/${REGION}/networkAttachments/${NETWORK_ATTACHMENT_NAME}". NetworkAttachment has to be provided when the PSC interface is created. */
		networkAttachment: FormControl<string | null | undefined>,
	}
	export function CreatePscInterfaceConfigFormGroup() {
		return new FormGroup<PscInterfaceConfigFormProperties>({
	...
	export enum InstanceState { STATE_UNSPECIFIED = 0, READY = 1, STOPPED = 2, CREATING = 3, DELETING = 4, MAINTENANCE = 5, FAILED = 6, BOOTSTRAPPING = 7, PROMOTING = 8 }
	...
	export enum UpdatePolicyMode { MODE_UNSPECIFIED = 0, DEFAULT = 1, FORCE_APPLY = 2 }
	...
	export enum SupportedDatabaseFlagValueType { VALUE_TYPE_UNSPECIFIED = 0, STRING = 1, INTEGER = 2, FLOAT = 3, NONE = 4 }
	...
	export enum UserUserType { USER_TYPE_UNSPECIFIED = 0, ALLOYDB_BUILT_IN = 1, ALLOYDB_IAM_USER = 2 }
	...
	export enum StorageDatabasecenterPartnerapiV1mainAvailabilityConfigurationAvailabilityType { AVAILABILITY_TYPE_UNSPECIFIED = 0, ZONAL = 1, REGIONAL = 2, MULTI_REGIONAL = 3, AVAILABILITY_TYPE_OTHER = 4 }
	...
	export enum StorageDatabasecenterPartnerapiV1mainRetentionSettingsRetentionUnit { RETENTION_UNIT_UNSPECIFIED = 0, COUNT = 1, TIME = 2, RETENTION_UNIT_OTHER = 3 }
	...
	export enum StorageDatabasecenterPartnerapiV1mainBackupRunStatus { STATUS_UNSPECIFIED = 0, SUCCESSFUL = 1, FAILED = 2 }
	...
	export enum StorageDatabasecenterPartnerapiV1mainDatabaseResourceFeedFeedType { FEEDTYPE_UNSPECIFIED = 0, RESOURCE_METADATA = 1, OBSERVABILITY_DATA = 2, SECURITY_FINDING_DATA = 3 }
	...
	export enum StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalDataProvider { PROVIDER_UNSPECIFIED = 0, GCP = 1, AWS = 2, AZURE = 3, ONPREM = 4, SELFMANAGED = 5, PROVIDER_OTHER = 6 }

	export enum StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalDataSignalClass { CLASS_UNSPECIFIED = 0, THREAT = 1, VULNERABILITY = 2, MISCONFIGURATION = 3, OBSERVATION = 4, ERROR = 5 }

	export enum StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalDataSignalType { SIGNAL_TYPE_UNSPECIFIED = 0, SIGNAL_TYPE_NOT_PROTECTED_BY_AUTOMATIC_FAILOVER = 1, SIGNAL_TYPE_GROUP_NOT_REPLICATING_ACROSS_REGIONS = 2, SIGNAL_TYPE_NOT_AVAILABLE_IN_MULTIPLE_ZONES = 3, SIGNAL_TYPE_NOT_AVAILABLE_IN_MULTIPLE_REGIONS = 4, SIGNAL_TYPE_NO_PROMOTABLE_REPLICA = 5, SIGNAL_TYPE_NO_AUTOMATED_BACKUP_POLICY = 6, SIGNAL_TYPE_SHORT_BACKUP_RETENTION = 7, SIGNAL_TYPE_LAST_BACKUP_FAILED = 8, SIGNAL_TYPE_LAST_BACKUP_OLD = 9, SIGNAL_TYPE_VIOLATES_CIS_GCP_FOUNDATION_2_0 = 10, SIGNAL_TYPE_VIOLATES_CIS_GCP_FOUNDATION_1_3 = 11, SIGNAL_TYPE_VIOLATES_CIS_GCP_FOUNDATION_1_2 = 12, SIGNAL_TYPE_VIOLATES_CIS_GCP_FOUNDATION_1_1 = 13, SIGNAL_TYPE_VIOLATES_CIS_GCP_FOUNDATION_1_0 = 14, SIGNAL_TYPE_VIOLATES_NIST_800_53 = 15, SIGNAL_TYPE_VIOLATES_ISO_27001 = 16, SIGNAL_TYPE_VIOLATES_PCI_DSS_V3_2_1 = 17, SIGNAL_TYPE_LOGS_NOT_OPTIMIZED_FOR_TROUBLESHOOTING = 18, SIGNAL_TYPE_QUERY_DURATIONS_NOT_LOGGED = 19, SIGNAL_TYPE_VERBOSE_ERROR_LOGGING = 20, SIGNAL_TYPE_QUERY_LOCK_WAITS_NOT_LOGGED = 21, SIGNAL_TYPE_LOGGING_MOST_ERRORS = 22, SIGNAL_TYPE_LOGGING_ONLY_CRITICAL_ERRORS = 23, SIGNAL_TYPE_MINIMAL_ERROR_LOGGING = 24, SIGNAL_TYPE_QUERY_STATISTICS_LOGGED = 25, SIGNAL_TYPE_EXCESSIVE_LOGGING_OF_CLIENT_HOSTNAME = 26, SIGNAL_TYPE_EXCESSIVE_LOGGING_OF_PARSER_STATISTICS = 27, SIGNAL_TYPE_EXCESSIVE_LOGGING_OF_PLANNER_STATISTICS = 28, SIGNAL_TYPE_NOT_LOGGING_ONLY_DDL_STATEMENTS = 29, SIGNAL_TYPE_LOGGING_QUERY_STATISTICS = 30, SIGNAL_TYPE_NOT_LOGGING_TEMPORARY_FILES = 31, SIGNAL_TYPE_CONNECTION_MAX_NOT_CONFIGURED = 32, SIGNAL_TYPE_USER_OPTIONS_CONFIGURED = 33, SIGNAL_TYPE_EXPOSED_TO_PUBLIC_ACCESS = 34, SIGNAL_TYPE_UNENCRYPTED_CONNECTIONS = 35, SIGNAL_TYPE_NO_ROOT_PASSWORD = 36, SIGNAL_TYPE_WEAK_ROOT_PASSWORD = 37, SIGNAL_TYPE_ENCRYPTION_KEY_NOT_CUSTOMER_MANAGED = 38, SIGNAL_TYPE_SERVER_AUTHENTICATION_NOT_REQUIRED = 39, SIGNAL_TYPE_EXPOSED_BY_OWNERSHIP_CHAINING = 40, SIGNAL_TYPE_EXPOSED_TO_EXTERNAL_SCRIPTS = 41, SIGNAL_TYPE_EXPOSED_TO_LOCAL_DATA_LOADS = 42, SIGNAL_TYPE_CONNECTION_ATTEMPTS_NOT_LOGGED = 43, SIGNAL_TYPE_DISCONNECTIONS_NOT_LOGGED = 44, SIGNAL_TYPE_LOGGING_EXCESSIVE_STATEMENT_INFO = 45, SIGNAL_TYPE_EXPOSED_TO_REMOTE_ACCESS = 46, SIGNAL_TYPE_DATABASE_NAMES_EXPOSED = 47, SIGNAL_TYPE_SENSITIVE_TRACE_INFO_NOT_MASKED = 48, SIGNAL_TYPE_PUBLIC_IP_ENABLED = 49 }

	export enum StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalDataState { STATE_UNSPECIFIED = 0, ACTIVE = 1, RESOLVED = 2, MUTED = 3 }
	...
	export enum StorageDatabasecenterPartnerapiV1mainDatabaseResourceMetadataCurrentState { STATE_UNSPECIFIED = 0, HEALTHY = 1, UNHEALTHY = 2, SUSPENDED = 3, DELETED = 4, STATE_OTHER = 5 }

	export enum StorageDatabasecenterPartnerapiV1mainDatabaseResourceMetadataInstanceType { INSTANCE_TYPE_UNSPECIFIED = 0, SUB_RESOURCE_TYPE_UNSPECIFIED = 1, PRIMARY = 2, SECONDARY = 3, READ_REPLICA = 4, OTHER = 5, SUB_RESOURCE_TYPE_PRIMARY = 6, SUB_RESOURCE_TYPE_SECONDARY = 7, SUB_RESOURCE_TYPE_READ_REPLICA = 8, SUB_RESOURCE_TYPE_OTHER = 9 }
	...
	export enum StorageDatabasecenterProtoCommonProductEngine { ENGINE_UNSPECIFIED = 0, ENGINE_MYSQL = 1, MYSQL = 2, ENGINE_POSTGRES = 3, POSTGRES = 4, ENGINE_SQL_SERVER = 5, SQL_SERVER = 6, ENGINE_NATIVE = 7, NATIVE = 8, ENGINE_CLOUD_SPANNER_WITH_POSTGRES_DIALECT = 9, SPANGRES = 10, ENGINE_OTHER = 11 }

	export enum StorageDatabasecenterProtoCommonProductType { PRODUCT_TYPE_UNSPECIFIED = 0, PRODUCT_TYPE_CLOUD_SQL = 1, CLOUD_SQL = 2, PRODUCT_TYPE_ALLOYDB = 3, ALLOYDB = 4, PRODUCT_TYPE_SPANNER = 5, SPANNER = 6, PRODUCT_TYPE_ON_PREM = 7, ON_PREM = 8, PRODUCT_TYPE_OTHER = 9 }
	...
	export class MyClient {
		...
		Alloydb_projects_locations_clusters_users_patch(name: string, allowMissing: boolean | null | undefined, requestId: string | null | undefined, updateMask: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: User): Observable<User> {
			return this.http.patch<User>(this.baseUri + 'v1alpha/' + (name == null ? '' : encodeURIComponent(name)) + '&allowMissing=' + allowMissing + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Alloydb_projects_locations_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<Empty> {
		...
		Alloydb_projects_locations_clusters_instances_failover(name: string, requestBody: FailoverInstanceRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (name == null ? '' : encodeURIComponent(name)) + ':failover', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Injects fault in an instance. Imperative only.
		 * Post v1alpha/{name}:injectFault
		 * @param {string} name Required. The name of the resource. For the required format, see the comment on the Instance.name field.
		 * @return {Operation} Successful response
		 */
		Alloydb_projects_locations_clusters_instances_injectFault(name: string, requestBody: InjectFaultRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (name == null ? '' : encodeURIComponent(name)) + ':injectFault', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Promotes a SECONDARY cluster. This turns down replication from the PRIMARY cluster and promotes a secondary cluster into its own standalone cluster. Imperative only.
		 * Post v1alpha/{name}:promote
		...
		Alloydb_projects_locations_clusters_promote(name: string, requestBody: PromoteClusterRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (name == null ? '' : encodeURIComponent(name)) + ':promote', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Restart an Instance in a cluster. Imperative only.
		 * Post v1alpha/{name}:restart
		 * @param {string} name Required. The name of the resource. For the required format, see the comment on the Instance.name field.
		 * @return {Operation} Successful response
		 */
		Alloydb_projects_locations_clusters_instances_restart(name: string, requestBody: RestartInstanceRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (name == null ? '' : encodeURIComponent(name)) + ':restart', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Alloydb_projects_locations_backups_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListBackupsResponse> {
			return this.http.get<ListBackupsResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/backups&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Alloydb_projects_locations_backups_create(parent: string, backupId: string | null | undefined, requestId: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: Backup): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/backups&backupId=' + (backupId == null ? '' : encodeURIComponent(backupId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Clusters in a given project and location.
		 * Get v1alpha/{parent}/clusters
		...
		Alloydb_projects_locations_clusters_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListClustersResponse> {
			return this.http.get<ListClustersResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clusters&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new Cluster in a given project and location.
		 * Post v1alpha/{parent}/clusters
		...
		Alloydb_projects_locations_clusters_create(parent: string, clusterId: string | null | undefined, requestId: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: Cluster): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clusters&clusterId=' + (clusterId == null ? '' : encodeURIComponent(clusterId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Creates a cluster of type SECONDARY in the given location using the primary cluster as the source.
		 * Post v1alpha/{parent}/clusters:createsecondary
		 * @param {string} parent Required. The location of the new cluster. For the required format, see the comment on the Cluster.name field.
		...
		Alloydb_projects_locations_clusters_restore(parent: string, requestBody: RestoreClusterRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clusters:restore', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Get instance metadata used for a connection.
		 * Get v1alpha/{parent}/connectionInfo
		...
		Alloydb_projects_locations_clusters_instances_getConnectionInfo(parent: string, requestId: string | null | undefined): Observable<ConnectionInfo> {
			return this.http.get<ConnectionInfo>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/connectionInfo&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), {});
		}
		...
		Alloydb_projects_locations_clusters_instances_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInstancesResponse> {
			return this.http.get<ListInstancesResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/instances&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Alloydb_projects_locations_clusters_instances_create(parent: string, instanceId: string | null | undefined, requestId: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: Instance): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/instances&instanceId=' + (instanceId == null ? '' : encodeURIComponent(instanceId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Creates a new SECONDARY Instance in a given project and location.
		 * Post v1alpha/{parent}/instances:createsecondary
		 * @param {string} parent Required. The name of the parent resource. For the required format, see the comment on the Instance.name field.
		 * @param {string} instanceId Required. ID of the requesting object.
		 * @param {string} requestId Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
		 * @param {boolean} validateOnly Optional. If set, performs request validation (e.g. permission checks and any other type of validation), but do not actually execute the create request.
		...
		Alloydb_projects_locations_clusters_instances_createsecondary(parent: string, instanceId: string | null | undefined, requestId: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: Instance): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/instances:createsecondary&instanceId=' + (instanceId == null ? '' : encodeURIComponent(instanceId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists SupportedDatabaseFlags for a given project and location.
		 * Get v1alpha/{parent}/supportedDatabaseFlags
		...
		Alloydb_projects_locations_supportedDatabaseFlags_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSupportedDatabaseFlagsResponse> {
			return this.http.get<ListSupportedDatabaseFlagsResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/supportedDatabaseFlags&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Lists Users in a given project and location.
		 * Get v1alpha/{parent}/users
		...
		Alloydb_projects_locations_clusters_users_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListUsersResponse> {
			return this.http.get<ListUsersResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/users&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new User in a given project, location, and cluster.
		 * Post v1alpha/{parent}/users
		 * @param {string} parent Required. Value for parent.
		 * @param {string} requestId Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
		...
		Alloydb_projects_locations_clusters_users_create(parent: string, requestId: string | null | undefined, userId: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: User): Observable<User> {
			return this.http.post<User>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/users&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&userId=' + (userId == null ? '' : encodeURIComponent(userId)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Post v1alpha/{parent}:generateClientCertificate
		...
		Alloydb_projects_locations_clusters_generateClientCertificate(parent: string, requestBody: GenerateClientCertificateRequest): Observable<GenerateClientCertificateResponse> {
			return this.http.post<GenerateClientCertificateResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + ':generateClientCertificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}

	export enum Alloydb_projects_locations_operations_getView { INSTANCE_VIEW_UNSPECIFIED = 0, INSTANCE_VIEW_BASIC = 1, INSTANCE_VIEW_FULL = 2 }
