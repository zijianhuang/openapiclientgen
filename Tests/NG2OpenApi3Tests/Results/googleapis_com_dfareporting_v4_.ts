...
export namespace MyNS {
	...
	export enum MeasurementPartnerAdvertiserLinkLinkStatus { MEASUREMENT_PARTNER_UNLINKED = 'MEASUREMENT_PARTNER_UNLINKED', MEASUREMENT_PARTNER_LINKED = 'MEASUREMENT_PARTNER_LINKED', MEASUREMENT_PARTNER_LINK_PENDING = 'MEASUREMENT_PARTNER_LINK_PENDING', MEASUREMENT_PARTNER_LINK_FAILURE = 'MEASUREMENT_PARTNER_LINK_FAILURE', MEASUREMENT_PARTNER_LINK_OPT_OUT = 'MEASUREMENT_PARTNER_LINK_OPT_OUT', MEASUREMENT_PARTNER_LINK_OPT_OUT_PENDING = 'MEASUREMENT_PARTNER_LINK_OPT_OUT_PENDING', MEASUREMENT_PARTNER_LINK_WRAPPING_PENDING = 'MEASUREMENT_PARTNER_LINK_WRAPPING_PENDING', MEASUREMENT_PARTNER_MODE_CHANGE_PENDING = 'MEASUREMENT_PARTNER_MODE_CHANGE_PENDING' }

	export enum MeasurementPartnerAdvertiserLinkMeasurementPartner { NONE = 'NONE', INTEGRAL_AD_SCIENCE = 'INTEGRAL_AD_SCIENCE', DOUBLE_VERIFY = 'DOUBLE_VERIFY' }
	...
	export enum BillingProfileInvoiceLevel { ACCOUNT_LEVEL = 'ACCOUNT_LEVEL', ADVERTISER_LEVEL = 'ADVERTISER_LEVEL', CAMPAIGN_LEVEL = 'CAMPAIGN_LEVEL' }

	export enum BillingProfileStatus { UNDER_REVIEW = 'UNDER_REVIEW', ACTIVE = 'ACTIVE', ARCHIVED = 'ARCHIVED' }
	...
	export enum BillingRateType { AD_SERVING = 'AD_SERVING', CLICKS = 'CLICKS', MINIMUM_SERVICE = 'MINIMUM_SERVICE', PATH_TO_CONVERSION = 'PATH_TO_CONVERSION', RICH_MEDIA_INPAGE = 'RICH_MEDIA_INPAGE', RICH_MEDIA_EXPANDING = 'RICH_MEDIA_EXPANDING', RICH_MEDIA_FLOATING = 'RICH_MEDIA_FLOATING', RICH_MEDIA_VIDEO = 'RICH_MEDIA_VIDEO', RICH_MEDIA_TEASER = 'RICH_MEDIA_TEASER', RICH_MEDIA_VPAID = 'RICH_MEDIA_VPAID', INSTREAM_VIDEO = 'INSTREAM_VIDEO', PIXEL = 'PIXEL', TRACKING = 'TRACKING', TRAFFICKING_FEATURE = 'TRAFFICKING_FEATURE', CUSTOM_REPORTS = 'CUSTOM_REPORTS', EXPOSURE_TO_CONVERSION = 'EXPOSURE_TO_CONVERSION', DATA_TRANSFER = 'DATA_TRANSFER', DATA_TRANSFER_SETUP = 'DATA_TRANSFER_SETUP', STARTUP = 'STARTUP', STATEMENT_OF_WORK = 'STATEMENT_OF_WORK', PROVIDED_LIST = 'PROVIDED_LIST', PROVIDED_LIST_SETUP = 'PROVIDED_LIST_SETUP', ENHANCED_FORMATS = 'ENHANCED_FORMATS', TRACKING_AD_IMPRESSIONS = 'TRACKING_AD_IMPRESSIONS', TRACKING_AD_CLICKS = 'TRACKING_AD_CLICKS', NIELSEN_DIGITAL_AD_RATINGS_FEE = 'NIELSEN_DIGITAL_AD_RATINGS_FEE', INSTREAM_VIDEO_REDIRECT = 'INSTREAM_VIDEO_REDIRECT', INSTREAM_VIDEO_VPAID = 'INSTREAM_VIDEO_VPAID', DISPLAY_AD_SERVING = 'DISPLAY_AD_SERVING', VIDEO_AD_SERVING = 'VIDEO_AD_SERVING', AUDIO_AD_SERVING = 'AUDIO_AD_SERVING', ADVANCED_DISPLAY_AD_SERVING = 'ADVANCED_DISPLAY_AD_SERVING' }

	export enum BillingRateUnitOfMeasure { CPM = 'CPM', CPC = 'CPC', EA = 'EA', P2C = 'P2C' }
	...
	export enum UvarFilterMatch { UNSPECIFIED = 'UNSPECIFIED', EXACT = 'EXACT', CONTAINS = 'CONTAINS' }
	...
	export enum EventTagSiteFilterType { ALLOWLIST = 'ALLOWLIST', BLOCKLIST = 'BLOCKLIST' }
	...
	export enum FileStatus { PROCESSING = 'PROCESSING', REPORT_AVAILABLE = 'REPORT_AVAILABLE', FAILED = 'FAILED', CANCELLED = 'CANCELLED', QUEUED = 'QUEUED' }
	...
	export enum FloodlightConfigurationFirstDayOfWeek { SUNDAY = 'SUNDAY', MONDAY = 'MONDAY' }
	...
	export enum MeasurementPartnerWrappingDataTagWrappingMode { NONE = 'NONE', BLOCKING = 'BLOCKING', MONITORING = 'MONITORING', MONITORING_READ_ONLY = 'MONITORING_READ_ONLY', VIDEO_PIXEL_MONITORING = 'VIDEO_PIXEL_MONITORING', TRACKING = 'TRACKING', VPAID_MONITORING = 'VPAID_MONITORING', VPAID_BLOCKING = 'VPAID_BLOCKING', NON_VPAID_MONITORING = 'NON_VPAID_MONITORING', VPAID_ONLY_MONITORING = 'VPAID_ONLY_MONITORING', VPAID_ONLY_BLOCKING = 'VPAID_ONLY_BLOCKING', VPAID_ONLY_FILTERING = 'VPAID_ONLY_FILTERING', VPAID_FILTERING = 'VPAID_FILTERING', NON_VPAID_FILTERING = 'NON_VPAID_FILTERING' }
	...
	export enum PlacementActiveStatus { PLACEMENT_STATUS_UNKNOWN = 'PLACEMENT_STATUS_UNKNOWN', PLACEMENT_STATUS_ACTIVE = 'PLACEMENT_STATUS_ACTIVE', PLACEMENT_STATUS_INACTIVE = 'PLACEMENT_STATUS_INACTIVE', PLACEMENT_STATUS_ARCHIVED = 'PLACEMENT_STATUS_ARCHIVED', PLACEMENT_STATUS_PERMANENTLY_ARCHIVED = 'PLACEMENT_STATUS_PERMANENTLY_ARCHIVED' }
