...
export namespace MyNS {
	...
	export enum EnrolledServiceEnrollmentLevel { ENROLLMENT_LEVEL_UNSPECIFIED = 'ENROLLMENT_LEVEL_UNSPECIFIED', BLOCK_ALL = 'BLOCK_ALL' }
	...
	export enum AccessReasonType { TYPE_UNSPECIFIED = 'TYPE_UNSPECIFIED', CUSTOMER_INITIATED_SUPPORT = 'CUSTOMER_INITIATED_SUPPORT', GOOGLE_INITIATED_SERVICE = 'GOOGLE_INITIATED_SERVICE', GOOGLE_INITIATED_REVIEW = 'GOOGLE_INITIATED_REVIEW', THIRD_PARTY_DATA_REQUEST = 'THIRD_PARTY_DATA_REQUEST', GOOGLE_RESPONSE_TO_PRODUCTION_ALERT = 'GOOGLE_RESPONSE_TO_PRODUCTION_ALERT', CLOUD_INITIATED_ACCESS = 'CLOUD_INITIATED_ACCESS' }
