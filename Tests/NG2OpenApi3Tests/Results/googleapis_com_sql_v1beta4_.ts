...
export namespace MyNS {
	...
	export enum ApiWarningCode { SQL_API_WARNING_CODE_UNSPECIFIED = 0, REGION_UNREACHABLE = 1, MAX_RESULTS_EXCEEDS_LIMIT = 2, COMPROMISED_CREDENTIALS = 3, INTERNAL_STATE_FAILURE = 4 }
	...
	export enum BackupRetentionSettingsRetentionUnit { RETENTION_UNIT_UNSPECIFIED = 0, COUNT = 1 }
	...
	export enum BackupReencryptionConfigBackupType { BACKUP_TYPE_UNSPECIFIED = 0, AUTOMATED = 1, ON_DEMAND = 2 }
	...
	export enum BackupRunBackupKind { SQL_BACKUP_KIND_UNSPECIFIED = 0, SNAPSHOT = 1, PHYSICAL = 2 }
	...
	export enum ConnectSettingsBackendType { SQL_BACKEND_TYPE_UNSPECIFIED = 0, FIRST_GEN = 1, SECOND_GEN = 2, EXTERNAL = 3 }

	export enum ConnectSettingsDatabaseVersion { SQL_DATABASE_VERSION_UNSPECIFIED = 0, MYSQL_5_1 = 1, MYSQL_5_5 = 2, MYSQL_5_6 = 3, MYSQL_5_7 = 4, SQLSERVER_2017_STANDARD = 5, SQLSERVER_2017_ENTERPRISE = 6, SQLSERVER_2017_EXPRESS = 7, SQLSERVER_2017_WEB = 8, POSTGRES_9_6 = 9, POSTGRES_10 = 10, POSTGRES_11 = 11, POSTGRES_12 = 12, POSTGRES_13 = 13, POSTGRES_14 = 14, POSTGRES_15 = 15, MYSQL_8_0 = 16, MYSQL_8_0_18 = 17, MYSQL_8_0_26 = 18, MYSQL_8_0_27 = 19, MYSQL_8_0_28 = 20, MYSQL_8_0_29 = 21, MYSQL_8_0_30 = 22, MYSQL_8_0_31 = 23, MYSQL_8_0_32 = 24, MYSQL_8_0_33 = 25, MYSQL_8_0_34 = 26, MYSQL_8_0_35 = 27, MYSQL_8_0_36 = 28, SQLSERVER_2019_STANDARD = 29, SQLSERVER_2019_ENTERPRISE = 30, SQLSERVER_2019_EXPRESS = 31, SQLSERVER_2019_WEB = 32, SQLSERVER_2022_STANDARD = 33, SQLSERVER_2022_ENTERPRISE = 34, SQLSERVER_2022_EXPRESS = 35, SQLSERVER_2022_WEB = 36 }
	...
	export enum SqlOutOfDiskReportSqlOutOfDiskState { SQL_OUT_OF_DISK_STATE_UNSPECIFIED = 0, NORMAL = 1, SOFT_SHUTDOWN = 2 }
	...
	export enum SettingsConnectorEnforcement { CONNECTOR_ENFORCEMENT_UNSPECIFIED = 0, NOT_REQUIRED = 1, REQUIRED = 2 }
	...
	export enum SettingsEdition { EDITION_UNSPECIFIED = 0, ENTERPRISE = 1, ENTERPRISE_PLUS = 2 }
	...
	export enum IpConfigurationSslMode { SSL_MODE_UNSPECIFIED = 0, ALLOW_UNENCRYPTED_AND_ENCRYPTED = 1, ENCRYPTED_ONLY = 2, TRUSTED_CLIENT_CERTIFICATE_REQUIRED = 3 }
	...
	export enum MaintenanceWindowUpdateTrack { SQL_UPDATE_TRACK_UNSPECIFIED = 0, canary = 1, stable = 2, week5 = 3 }
	...
	export enum PasswordValidationPolicyComplexity { COMPLEXITY_UNSPECIFIED = 0, COMPLEXITY_DEFAULT = 1 }
	...
	export enum DatabaseInstanceSqlNetworkArchitecture { SQL_NETWORK_ARCHITECTURE_UNSPECIFIED = 0, NEW_NETWORK_ARCHITECTURE = 1, OLD_NETWORK_ARCHITECTURE = 2 }

	export enum DatabaseInstanceState { SQL_INSTANCE_STATE_UNSPECIFIED = 0, RUNNABLE = 1, SUSPENDED = 2, PENDING_DELETE = 3, PENDING_CREATE = 4, MAINTENANCE = 5, FAILED = 6, ONLINE_MAINTENANCE = 7 }
	...
	export enum ExportContextBakExportOptionsBakType { BAK_TYPE_UNSPECIFIED = 0, FULL = 1, DIFF = 2, TLOG = 3 }
	...
	export enum SqlInstancesStartExternalSyncRequestSyncMode { EXTERNAL_SYNC_MODE_UNSPECIFIED = 0, ONLINE = 1, OFFLINE = 2 }

	export enum SqlInstancesStartExternalSyncRequestSyncParallelLevel { EXTERNAL_SYNC_PARALLEL_LEVEL_UNSPECIFIED = 0, MIN = 1, OPTIMAL = 2, MAX = 3 }
	...
	export enum UserDualPasswordType { DUAL_PASSWORD_TYPE_UNSPECIFIED = 0, NO_MODIFY_DUAL_PASSWORD = 1, NO_DUAL_PASSWORD = 2, DUAL_PASSWORD = 3 }
	...
	export enum UserType { BUILT_IN = 0, CLOUD_IAM_USER = 1, CLOUD_IAM_SERVICE_ACCOUNT = 2, CLOUD_IAM_GROUP = 3, CLOUD_IAM_GROUP_USER = 4, CLOUD_IAM_GROUP_SERVICE_ACCOUNT = 5 }
	...
	export class MyClient {
		...
		Sql_flags_list(databaseVersion: string | null | undefined): Observable<FlagsListResponse> {
			return this.http.get<FlagsListResponse>(this.baseUri + 'sql/v1beta4/flags?databaseVersion=' + (databaseVersion == null ? '' : encodeURIComponent(databaseVersion)), {});
		}
		...
		Sql_instances_list(project: string, filter: string | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<InstancesListResponse> {
			return this.http.get<InstancesListResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Sql_instances_insert(project: string, requestBody: DatabaseInstance): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_delete(project: string, instance: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)), {});
		}
		...
		Sql_instances_get(project: string, instance: string): Observable<DatabaseInstance> {
			return this.http.get<DatabaseInstance>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)), {});
		}
		...
		Sql_instances_patch(project: string, instance: string, requestBody: DatabaseInstance): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_update(project: string, instance: string, requestBody: DatabaseInstance): Observable<Operation> {
			return this.http.put<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_addServerCa(project: string, instance: string): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/addServerCa', null, {});
		}
		...
		Sql_backupRuns_list(project: string, instance: string, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<BackupRunsListResponse> {
			return this.http.get<BackupRunsListResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/backupRuns&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Sql_backupRuns_insert(project: string, instance: string, requestBody: BackupRun): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/backupRuns', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_backupRuns_delete(project: string, instance: string, id: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/backupRuns/' + (id == null ? '' : encodeURIComponent(id)), {});
		}
		...
		Sql_backupRuns_get(project: string, instance: string, id: string): Observable<BackupRun> {
			return this.http.get<BackupRun>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/backupRuns/' + (id == null ? '' : encodeURIComponent(id)), {});
		}
		...
		Sql_instances_clone(project: string, instance: string, requestBody: InstancesCloneRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/clone', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_connect_get(project: string, instance: string, readTime: string | null | undefined): Observable<ConnectSettings> {
			return this.http.get<ConnectSettings>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/connectSettings&readTime=' + (readTime == null ? '' : encodeURIComponent(readTime)), {});
		}
		...
		Sql_sslCerts_createEphemeral(project: string, instance: string, requestBody: SslCertsCreateEphemeralRequest): Observable<SslCert> {
			return this.http.post<SslCert>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/createEphemeral', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_databases_list(project: string, instance: string): Observable<DatabasesListResponse> {
			return this.http.get<DatabasesListResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/databases', {});
		}
		...
		Sql_databases_insert(project: string, instance: string, requestBody: Database): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/databases', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_databases_delete(project: string, instance: string, database: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/databases/' + (database == null ? '' : encodeURIComponent(database)), {});
		}
		...
		Sql_databases_get(project: string, instance: string, database: string): Observable<Database> {
			return this.http.get<Database>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/databases/' + (database == null ? '' : encodeURIComponent(database)), {});
		}
		...
		Sql_databases_patch(project: string, instance: string, database: string, requestBody: Database): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/databases/' + (database == null ? '' : encodeURIComponent(database)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_databases_update(project: string, instance: string, database: string, requestBody: Database): Observable<Operation> {
			return this.http.put<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/databases/' + (database == null ? '' : encodeURIComponent(database)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_demote(project: string, instance: string, requestBody: InstancesDemoteRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/demote', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_demoteMaster(project: string, instance: string, requestBody: InstancesDemoteMasterRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/demoteMaster', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_export(project: string, instance: string, requestBody: InstancesExportRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/export', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_failover(project: string, instance: string, requestBody: InstancesFailoverRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/failover', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_projects_instances_getDiskShrinkConfig(project: string, instance: string): Observable<SqlInstancesGetDiskShrinkConfigResponse> {
			return this.http.get<SqlInstancesGetDiskShrinkConfigResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/getDiskShrinkConfig', {});
		}
		...
		Sql_projects_instances_getLatestRecoveryTime(project: string, instance: string): Observable<SqlInstancesGetLatestRecoveryTimeResponse> {
			return this.http.get<SqlInstancesGetLatestRecoveryTimeResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/getLatestRecoveryTime', {});
		}
		...
		Sql_instances_import(project: string, instance: string, requestBody: InstancesImportRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_listServerCas(project: string, instance: string): Observable<InstancesListServerCasResponse> {
			return this.http.get<InstancesListServerCasResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/listServerCas', {});
		}
		...
		Sql_projects_instances_performDiskShrink(project: string, instance: string, requestBody: PerformDiskShrinkContext): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/performDiskShrink', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_promoteReplica(project: string, instance: string, failover: boolean | null | undefined): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/promoteReplica&failover=' + failover, null, {});
		}
		...
		Sql_instances_reencrypt(project: string, instance: string, requestBody: InstancesReencryptRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/reencrypt', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_projects_instances_rescheduleMaintenance(project: string, instance: string, requestBody: SqlInstancesRescheduleMaintenanceRequestBody): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/rescheduleMaintenance', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_projects_instances_resetReplicaSize(project: string, instance: string, requestBody: SqlInstancesResetReplicaSizeRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/resetReplicaSize', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_resetSslConfig(project: string, instance: string): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/resetSslConfig', null, {});
		}
		...
		Sql_instances_restart(project: string, instance: string): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/restart', null, {});
		}
		...
		Sql_instances_restoreBackup(project: string, instance: string, requestBody: InstancesRestoreBackupRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/restoreBackup', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_rotateServerCa(project: string, instance: string, requestBody: InstancesRotateServerCaRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/rotateServerCa', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_sslCerts_list(project: string, instance: string): Observable<SslCertsListResponse> {
			return this.http.get<SslCertsListResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/sslCerts', {});
		}
		...
		Sql_sslCerts_insert(project: string, instance: string, requestBody: SslCertsInsertRequest): Observable<SslCertsInsertResponse> {
			return this.http.post<SslCertsInsertResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/sslCerts', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_sslCerts_delete(project: string, instance: string, sha1Fingerprint: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/sslCerts/' + (sha1Fingerprint == null ? '' : encodeURIComponent(sha1Fingerprint)), {});
		}
		...
		Sql_sslCerts_get(project: string, instance: string, sha1Fingerprint: string): Observable<SslCert> {
			return this.http.get<SslCert>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/sslCerts/' + (sha1Fingerprint == null ? '' : encodeURIComponent(sha1Fingerprint)), {});
		}
		...
		Sql_projects_instances_startExternalSync(project: string, instance: string, requestBody: SqlInstancesStartExternalSyncRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/startExternalSync', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_instances_startReplica(project: string, instance: string): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/startReplica', null, {});
		}
		...
		Sql_instances_stopReplica(project: string, instance: string): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/stopReplica', null, {});
		}
		...
		Sql_instances_switchover(project: string, instance: string, dbTimeout: string | null | undefined): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/switchover&dbTimeout=' + (dbTimeout == null ? '' : encodeURIComponent(dbTimeout)), null, {});
		}
		...
		Sql_instances_truncateLog(project: string, instance: string, requestBody: InstancesTruncateLogRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/truncateLog', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_users_delete(project: string, instance: string, host: string | null | undefined, name: string | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/users&host=' + (host == null ? '' : encodeURIComponent(host)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Sql_users_list(project: string, instance: string): Observable<UsersListResponse> {
			return this.http.get<UsersListResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/users', {});
		}
		...
		Sql_users_insert(project: string, instance: string, requestBody: User): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/users', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_users_update(project: string, instance: string, host: string | null | undefined, name: string | null | undefined, requestBody: User): Observable<Operation> {
			return this.http.put<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/users&host=' + (host == null ? '' : encodeURIComponent(host)) + '&name=' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_users_get(project: string, instance: string, name: string, host: string | null | undefined): Observable<User> {
			return this.http.get<User>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/users/' + (name == null ? '' : encodeURIComponent(name)) + '&host=' + (host == null ? '' : encodeURIComponent(host)), {});
		}
		...
		Sql_projects_instances_verifyExternalSyncSettings(project: string, instance: string, requestBody: SqlInstancesVerifyExternalSyncSettingsRequest): Observable<SqlInstancesVerifyExternalSyncSettingsResponse> {
			return this.http.post<SqlInstancesVerifyExternalSyncSettingsResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + '/verifyExternalSyncSettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_connect_generateEphemeral(project: string, instance: string, requestBody: GenerateEphemeralCertRequest): Observable<GenerateEphemeralCertResponse> {
			return this.http.post<GenerateEphemeralCertResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/instances/' + (instance == null ? '' : encodeURIComponent(instance)) + ':generateEphemeralCert', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sql_operations_list(project: string, instance: string | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<OperationsListResponse> {
			return this.http.get<OperationsListResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/operations&instance=' + (instance == null ? '' : encodeURIComponent(instance)) + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Sql_operations_get(project: string, operation: string): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/operations/' + (operation == null ? '' : encodeURIComponent(operation)), {});
		}
		...
		Sql_operations_cancel(project: string, operation: string): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/operations/' + (operation == null ? '' : encodeURIComponent(operation)) + '/cancel', null, {});
		}
		...
		Sql_tiers_list(project: string): Observable<TiersListResponse> {
			return this.http.get<TiersListResponse>(this.baseUri + 'sql/v1beta4/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/tiers', {});
		}
	}
