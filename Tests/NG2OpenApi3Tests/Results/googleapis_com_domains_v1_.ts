...
export namespace MyNS {
	...
	export class MyClient {
		...
		Domains_projects_locations_registrations_retrieveImportableDomains(location: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<RetrieveImportableDomainsResponse> {
			return this.http.get<RetrieveImportableDomainsResponse>(this.baseUri + 'v1/' + (location == null ? '' : encodeURIComponent(location)) + '/registrations:retrieveImportableDomains&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Domains_projects_locations_registrations_retrieveRegisterParameters(location: string, domainName: string | null | undefined): Observable<RetrieveRegisterParametersResponse> {
			return this.http.get<RetrieveRegisterParametersResponse>(this.baseUri + 'v1/' + (location == null ? '' : encodeURIComponent(location)) + '/registrations:retrieveRegisterParameters&domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), {});
		}
		...
		Domains_projects_locations_registrations_retrieveTransferParameters(location: string, domainName: string | null | undefined): Observable<RetrieveTransferParametersResponse> {
			return this.http.get<RetrieveTransferParametersResponse>(this.baseUri + 'v1/' + (location == null ? '' : encodeURIComponent(location)) + '/registrations:retrieveTransferParameters&domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), {});
		}
		...
		Domains_projects_locations_registrations_searchDomains(location: string, query: string | null | undefined): Observable<SearchDomainsResponse> {
			return this.http.get<SearchDomainsResponse>(this.baseUri + 'v1/' + (location == null ? '' : encodeURIComponent(location)) + '/registrations:searchDomains&query=' + (query == null ? '' : encodeURIComponent(query)), {});
		}
		...
		Domains_projects_locations_registrations_get(name: string): Observable<Registration> {
			return this.http.get<Registration>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Domains_projects_locations_registrations_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListRegistrationsResponse> {
			return this.http.get<ListRegistrationsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registrations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Domains_projects_locations_registrations_import(parent: string, requestBody: ImportDomainRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registrations:import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Domains_projects_locations_registrations_register(parent: string, requestBody: RegisterDomainRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registrations:register', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Domains_projects_locations_registrations_transfer(parent: string, requestBody: TransferDomainRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registrations:transfer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Domains_projects_locations_registrations_configureContactSettings(registration: string, requestBody: ConfigureContactSettingsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (registration == null ? '' : encodeURIComponent(registration)) + ':configureContactSettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Domains_projects_locations_registrations_configureDnsSettings(registration: string, requestBody: ConfigureDnsSettingsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (registration == null ? '' : encodeURIComponent(registration)) + ':configureDnsSettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Domains_projects_locations_registrations_configureManagementSettings(registration: string, requestBody: ConfigureManagementSettingsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (registration == null ? '' : encodeURIComponent(registration)) + ':configureManagementSettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Domains_projects_locations_registrations_resetAuthorizationCode(registration: string, requestBody: ResetAuthorizationCodeRequest): Observable<AuthorizationCode> {
			return this.http.post<AuthorizationCode>(this.baseUri + 'v1/' + (registration == null ? '' : encodeURIComponent(registration)) + ':resetAuthorizationCode', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Domains_projects_locations_registrations_retrieveAuthorizationCode(registration: string): Observable<AuthorizationCode> {
			return this.http.get<AuthorizationCode>(this.baseUri + 'v1/' + (registration == null ? '' : encodeURIComponent(registration)) + ':retrieveAuthorizationCode', {});
		}
