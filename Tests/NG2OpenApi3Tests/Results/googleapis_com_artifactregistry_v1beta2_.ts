...
export namespace MyNS {
	...
	/** Files store content that is potentially associated with Packages or Versions. */
	export interface GoogleDevtoolsArtifactregistryV1beta2FileFormProperties {
	...
	export function CreateGoogleDevtoolsArtifactregistryV1beta2FileFormGroup() {
		return new FormGroup<GoogleDevtoolsArtifactregistryV1beta2FileFormProperties>({
	...
	export class MyClient {
		...
		Artifactregistry_projects_locations_repositories_packages_versions_delete(name: string, force: boolean | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta2/' + (name == null ? '' : encodeURIComponent(name)) + '&force=' + force, {});
		}
		...
		Artifactregistry_projects_locations_repositories_packages_versions_get(name: string, view: Artifactregistry_projects_locations_repositories_packages_versions_getView | null | undefined): Observable<Version> {
			return this.http.get<Version>(this.baseUri + 'v1beta2/' + (name == null ? '' : encodeURIComponent(name)) + '&view=' + view, {});
		}
		...
		Artifactregistry_projects_locations_repositories_packages_tags_patch(name: string, updateMask: string | null | undefined, requestBody: Tag): Observable<Tag> {
			return this.http.patch<Tag>(this.baseUri + 'v1beta2/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Artifactregistry_projects_locations_repositories_aptArtifacts_import(parent: string, requestBody: ImportAptArtifactsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/aptArtifacts:import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Artifactregistry_projects_locations_repositories_files_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListFilesResponse> {
			return this.http.get<ListFilesResponse>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/files&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Artifactregistry_projects_locations_repositories_packages_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPackagesResponse> {
			return this.http.get<ListPackagesResponse>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/packages&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Artifactregistry_projects_locations_repositories_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListRepositoriesResponse> {
			return this.http.get<ListRepositoriesResponse>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/repositories&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Artifactregistry_projects_locations_repositories_create(parent: string, repositoryId: string | null | undefined, requestBody: Repository): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/repositories&repositoryId=' + (repositoryId == null ? '' : encodeURIComponent(repositoryId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Artifactregistry_projects_locations_repositories_packages_tags_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListTagsResponse> {
			return this.http.get<ListTagsResponse>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/tags&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Artifactregistry_projects_locations_repositories_packages_tags_create(parent: string, tagId: string | null | undefined, requestBody: Tag): Observable<Tag> {
			return this.http.post<Tag>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/tags&tagId=' + (tagId == null ? '' : encodeURIComponent(tagId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Artifactregistry_projects_locations_repositories_packages_versions_list(parent: string, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Artifactregistry_projects_locations_repositories_packages_versions_getView | null | undefined): Observable<ListVersionsResponse> {
			return this.http.get<ListVersionsResponse>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/versions&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Artifactregistry_projects_locations_repositories_yumArtifacts_import(parent: string, requestBody: ImportYumArtifactsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/yumArtifacts:import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
