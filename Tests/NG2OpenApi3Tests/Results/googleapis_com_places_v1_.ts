...
export namespace MyNS {
	...
	export enum GoogleMapsPlacesV1EVChargeOptionsConnectorAggregationType { EV_CONNECTOR_TYPE_UNSPECIFIED = 0, EV_CONNECTOR_TYPE_OTHER = 1, EV_CONNECTOR_TYPE_J1772 = 2, EV_CONNECTOR_TYPE_TYPE_2 = 3, EV_CONNECTOR_TYPE_CHADEMO = 4, EV_CONNECTOR_TYPE_CCS_COMBO_1 = 5, EV_CONNECTOR_TYPE_CCS_COMBO_2 = 6, EV_CONNECTOR_TYPE_TESLA = 7, EV_CONNECTOR_TYPE_UNSPECIFIED_GB_T = 8, EV_CONNECTOR_TYPE_UNSPECIFIED_WALL_OUTLET = 9 }
	...
	export enum GoogleMapsPlacesV1FuelOptionsFuelPriceType { FUEL_TYPE_UNSPECIFIED = 0, DIESEL = 1, REGULAR_UNLEADED = 2, MIDGRADE = 3, PREMIUM = 4, SP91 = 5, SP91_E10 = 6, SP92 = 7, SP95 = 8, SP95_E10 = 9, SP98 = 10, SP99 = 11, SP100 = 12, LPG = 13, E80 = 14, E85 = 15, METHANE = 16, BIO_DIESEL = 17, TRUCK_DIESEL = 18 }
	...
	export enum GoogleMapsPlacesV1PlaceBusinessStatus { BUSINESS_STATUS_UNSPECIFIED = 0, OPERATIONAL = 1, CLOSED_TEMPORARILY = 2, CLOSED_PERMANENTLY = 3 }
	...
	export enum GoogleMapsPlacesV1PlaceOpeningHoursSecondaryHoursType { SECONDARY_HOURS_TYPE_UNSPECIFIED = 0, DRIVE_THROUGH = 1, HAPPY_HOUR = 2, DELIVERY = 3, TAKEOUT = 4, KITCHEN = 5, BREAKFAST = 6, LUNCH = 7, DINNER = 8, BRUNCH = 9, PICKUP = 10, ACCESS = 11, SENIOR_HOURS = 12, ONLINE_SERVICE_HOURS = 13 }
	...
	export enum GoogleMapsPlacesV1PlacePriceLevel { PRICE_LEVEL_UNSPECIFIED = 0, PRICE_LEVEL_FREE = 1, PRICE_LEVEL_INEXPENSIVE = 2, PRICE_LEVEL_MODERATE = 3, PRICE_LEVEL_EXPENSIVE = 4, PRICE_LEVEL_VERY_EXPENSIVE = 5 }
	...
	export enum GoogleMapsPlacesV1SearchNearbyRequestRankPreference { RANK_PREFERENCE_UNSPECIFIED = 0, DISTANCE = 1, POPULARITY = 2 }
	...
	export enum GoogleMapsPlacesV1SearchTextRequestRankPreference { RANK_PREFERENCE_UNSPECIFIED = 0, DISTANCE = 1, RELEVANCE = 2 }
