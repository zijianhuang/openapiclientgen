...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {CvcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Cvcer(requestBody: CvcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'cvcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface CvcerPostBody {
		certificateParameters?: CvcerPostBodyCertificateParameters;
	...
	export interface CvcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<CvcerPostBodyFormat | null | undefined>,
	...
	export function CreateCvcerPostBodyFormGroup() {
		return new FormGroup<CvcerPostBodyFormProperties>({
			format: new FormControl<CvcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface CvcerPostBodyCertificateParameters {
	...
	export interface CvcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		VCNo: FormControl<string | null | undefined>,
	}
	export function CreateCvcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<CvcerPostBodyCertificateParametersFormProperties>({
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			VCNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum CvcerPostBodyFormat { pdf = 'pdf' }
