...
export namespace MyNS {
	...
	export interface Conversion {
		...
		adUserDataConsent?: ConversionAdUserDataConsent | null;
	...
	export interface ConversionFormProperties {
		...
		/** Ad user data consent for this conversion. */
		adUserDataConsent: FormControl<ConversionAdUserDataConsent | null | undefined>,
	...
	export function CreateConversionFormGroup() {
		return new FormGroup<ConversionFormProperties>({
			...
			adUserDataConsent: new FormControl<ConversionAdUserDataConsent | null | undefined>(undefined),
			advertiserId: new FormControl<string | null | undefined>(undefined),
			agencyId: new FormControl<string | null | undefined>(undefined),
	...
	/** File returned to https://developers.google.com/search-ads/v2/reference/reports/getIdMappingFile. */
	export interface IdMappingFileFormProperties {
	}
	export function CreateIdMappingFileFormGroup() {
		return new FormGroup<IdMappingFileFormProperties>({
		});
	...
	export interface ReportRequestTimeRangeFormProperties {
		...
		/** Inclusive UTC timestamp in RFC format, e.g., `2013-07-16T10:16:23.555Z`. See additional references on how changed attribute reports work. */
		changedAttributesSinceTimestamp: FormControl<string | null | undefined>,

		/** Inclusive UTC timestamp in RFC format, e.g., `2013-07-16T10:16:23.555Z`. See additional references on how changed metrics reports work. */
		changedMetricsSinceTimestamp: FormControl<string | null | undefined>,
	...
	export function CreateReportRequestTimeRangeFormGroup() {
		return new FormGroup<ReportRequestTimeRangeFormProperties>({
			changedAttributesSinceTimestamp: new FormControl<string | null | undefined>(undefined),
			changedMetricsSinceTimestamp: new FormControl<string | null | undefined>(undefined),
			endDate: new FormControl<string | null | undefined>(undefined),
			startDate: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 * @return {ConversionList} Successful response
		 */
		Doubleclicksearch_conversion_get(agencyId: string, advertiserId: string, engineAccountId: string, endDate: number, rowCount: number, startDate: number, startRow: number, adGroupId: string | null | undefined, adId: string | null | undefined, campaignId: string | null | undefined, criterionId: string | null | undefined, customerId: string | null | undefined): Observable<ConversionList> {
			return this.http.get<ConversionList>(this.baseUri + 'doubleclicksearch/v2/agency/' + (agencyId == null ? '' : encodeURIComponent(agencyId)) + '/advertiser/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/engine/' + (engineAccountId == null ? '' : encodeURIComponent(engineAccountId)) + '/conversion&endDate=' + endDate + '&rowCount=' + rowCount + '&startDate=' + startDate + '&startRow=' + startRow + '&adGroupId=' + (adGroupId == null ? '' : encodeURIComponent(adGroupId)) + '&adId=' + (adId == null ? '' : encodeURIComponent(adId)) + '&campaignId=' + (campaignId == null ? '' : encodeURIComponent(campaignId)) + '&criterionId=' + (criterionId == null ? '' : encodeURIComponent(criterionId)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)), {});
		}
		 ...
		 * @return {IdMappingFile} Successful response
		 */
		Doubleclicksearch_reports_getIdMappingFile(agencyId: string, advertiserId: string): Observable<IdMappingFile> {
			return this.http.get<IdMappingFile>(this.baseUri + 'doubleclicksearch/v2/agency/' + (agencyId == null ? '' : encodeURIComponent(agencyId)) + '/advertiser/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/idmapping', {});
		}
		 ...
		 * @return {SavedColumnList} Successful response
		 */
		Doubleclicksearch_savedColumns_list(agencyId: string, advertiserId: string): Observable<SavedColumnList> {
			return this.http.get<SavedColumnList>(this.baseUri + 'doubleclicksearch/v2/agency/' + (agencyId == null ? '' : encodeURIComponent(agencyId)) + '/advertiser/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/savedcolumns', {});
		}
		 ...
		 * @return {ConversionList} Successful response
		 */
		Doubleclicksearch_conversion_insert(requestBody: ConversionList): Observable<ConversionList> {
			return this.http.post<ConversionList>(this.baseUri + 'doubleclicksearch/v2/conversion', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ConversionList} Successful response
		 */
		Doubleclicksearch_conversion_update(requestBody: ConversionList): Observable<ConversionList> {
			return this.http.put<ConversionList>(this.baseUri + 'doubleclicksearch/v2/conversion', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates the availabilities of a batch of floodlight activities in DoubleClick Search.
		 * Post doubleclicksearch/v2/conversion/updateAvailability
		 * @return {UpdateAvailabilityResponse} Successful response
		 */
		Doubleclicksearch_conversion_updateAvailability(requestBody: UpdateAvailabilityRequest): Observable<UpdateAvailabilityResponse> {
			return this.http.post<UpdateAvailabilityResponse>(this.baseUri + 'doubleclicksearch/v2/conversion/updateAvailability', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ConversionList} Successful response
		 */
		Doubleclicksearch_conversion_getByCustomerId(customerId: string, endDate: number, rowCount: number, startDate: number, startRow: number, adGroupId: string | null | undefined, adId: string | null | undefined, advertiserId: string | null | undefined, agencyId: string | null | undefined, campaignId: string | null | undefined, criterionId: string | null | undefined, engineAccountId: string | null | undefined): Observable<ConversionList> {
			return this.http.get<ConversionList>(this.baseUri + 'doubleclicksearch/v2/customer/' + (customerId == null ? '' : encodeURIComponent(customerId)) + '/conversion&endDate=' + endDate + '&rowCount=' + rowCount + '&startDate=' + startDate + '&startRow=' + startRow + '&adGroupId=' + (adGroupId == null ? '' : encodeURIComponent(adGroupId)) + '&adId=' + (adId == null ? '' : encodeURIComponent(adId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&agencyId=' + (agencyId == null ? '' : encodeURIComponent(agencyId)) + '&campaignId=' + (campaignId == null ? '' : encodeURIComponent(campaignId)) + '&criterionId=' + (criterionId == null ? '' : encodeURIComponent(criterionId)) + '&engineAccountId=' + (engineAccountId == null ? '' : encodeURIComponent(engineAccountId)), {});
		}
		 ...
		 */
		Doubleclicksearch_reports_request(requestBody: ReportRequest): Observable<Report> {
			return this.http.post<Report>(this.baseUri + 'doubleclicksearch/v2/reports', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Report} Successful response
		 */
		Doubleclicksearch_reports_generate(requestBody: ReportRequest): Observable<Report> {
			return this.http.post<Report>(this.baseUri + 'doubleclicksearch/v2/reports/generate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Report} Successful response
		 */
		Doubleclicksearch_reports_get(reportId: string): Observable<Report> {
			return this.http.get<Report>(this.baseUri + 'doubleclicksearch/v2/reports/' + (reportId == null ? '' : encodeURIComponent(reportId)), {});
		}
		...
		Doubleclicksearch_reports_getFile(reportId: string, reportFragment: number): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'doubleclicksearch/v2/reports/' + (reportId == null ? '' : encodeURIComponent(reportId)) + '/files/' + reportFragment, { observe: 'response', responseType: 'text' });
		}
	}
