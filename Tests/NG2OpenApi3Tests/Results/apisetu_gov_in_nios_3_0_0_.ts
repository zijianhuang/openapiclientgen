...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {HvcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Hvcer(requestBody: HvcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'hvcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {SvcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Svcer(requestBody: SvcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'svcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface HscerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		RROLL: FormControl<string | null | undefined>,
	...
	export function CreateHscerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<HscerPostBodyCertificateParametersFormProperties>({
			...
			RROLL: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export interface HvcerPostBody {
		certificateParameters?: HvcerPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface HvcerPostBodyFormProperties {
	...
	export function CreateHvcerPostBodyFormGroup() {
		return new FormGroup<HvcerPostBodyFormProperties>({
			format: new FormControl<HscerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface HvcerPostBodyCertificateParameters {
	...
	export interface HvcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateHvcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<HvcerPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			RROLL: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			YEAR: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SvcerPostBody {
		certificateParameters?: SvcerPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface SvcerPostBodyFormProperties {
	...
	export function CreateSvcerPostBodyFormGroup() {
		return new FormGroup<SvcerPostBodyFormProperties>({
			format: new FormControl<HscerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SvcerPostBodyCertificateParameters {
	...
	export interface SvcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateSvcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SvcerPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			RROLL: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			YEAR: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
