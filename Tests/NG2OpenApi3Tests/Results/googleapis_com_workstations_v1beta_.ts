...
export namespace MyNS {
	...
	/** An ephemeral directory which won't persist across workstation sessions. It is freshly created on every workstation start operation. */
	export interface EphemeralDirectoryFormProperties {

		/** Required. Location of this directory in the running workstation. */
		mountPath: FormControl<string | null | undefined>,
	}
	export function CreateEphemeralDirectoryFormGroup() {
		return new FormGroup<EphemeralDirectoryFormProperties>({
	...
	/** An EphemeralDirectory is backed by a Compute Engine persistent disk. */
	export interface GcePersistentDiskFormProperties {
	...
	export function CreateGcePersistentDiskFormGroup() {
		return new FormGroup<GcePersistentDiskFormProperties>({
	...
	export interface WorkstationConfigFormProperties {
		...
		/** Optional. Disables support for plain TCP connections in the workstation. By default the service supports TCP connections via a websocket relay. Setting this option to true disables that relay, which prevents the usage of services that require plain tcp connections, such as ssh. When enabled, all communication must occur over https or wss. */
		disableTcpConnections: FormControl<boolean | null | undefined>,

		/** Optional. Human-readable name for this workstation configuration. */
		displayName: FormControl<string | null | undefined>,

		/** Optional. Whether to enable Linux `auditd` logging on the workstation. When enabled, a service account must also be specified that has `logging.buckets.write` permission on the project. Operating system audit logging is distinct from [Cloud Audit Logs](https://cloud.google.com/workstations/docs/audit-logging). */
		enableAuditAgent: FormControl<boolean | null | undefined>,
	...
	export function CreateWorkstationConfigFormGroup() {
		return new FormGroup<WorkstationConfigFormProperties>({
			...
			disableTcpConnections: new FormControl<boolean | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			enableAuditAgent: new FormControl<boolean | null | undefined>(undefined),
	...
	export class MyClient {
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_delete(name: string, etag: string | null | undefined, validateOnly: boolean | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + '&etag=' + (etag == null ? '' : encodeURIComponent(etag)) + '&validateOnly=' + validateOnly, {});
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_get(name: string): Observable<Workstation> {
			return this.http.get<Workstation>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_patch(name: string, allowMissing: boolean | null | undefined, updateMask: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: Workstation): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + '&allowMissing=' + allowMissing + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Workstations_projects_locations_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<GoogleProtobufEmpty> {
			return this.http.post<GoogleProtobufEmpty>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + ':cancel', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_start(name: string, requestBody: StartWorkstationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + ':start', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_stop(name: string, requestBody: StopWorkstationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + ':stop', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Workstations_projects_locations_workstationClusters_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListWorkstationClustersResponse> {
			return this.http.get<ListWorkstationClustersResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workstationClusters&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Workstations_projects_locations_workstationClusters_create(parent: string, validateOnly: boolean | null | undefined, workstationClusterId: string | null | undefined, requestBody: WorkstationCluster): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workstationClusters&validateOnly=' + validateOnly + '&workstationClusterId=' + (workstationClusterId == null ? '' : encodeURIComponent(workstationClusterId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListWorkstationConfigsResponse> {
			return this.http.get<ListWorkstationConfigsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workstationConfigs&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_create(parent: string, validateOnly: boolean | null | undefined, workstationConfigId: string | null | undefined, requestBody: WorkstationConfig): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workstationConfigs&validateOnly=' + validateOnly + '&workstationConfigId=' + (workstationConfigId == null ? '' : encodeURIComponent(workstationConfigId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_listUsable(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListUsableWorkstationConfigsResponse> {
			return this.http.get<ListUsableWorkstationConfigsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workstationConfigs:listUsable&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListWorkstationsResponse> {
			return this.http.get<ListWorkstationsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workstations&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_create(parent: string, validateOnly: boolean | null | undefined, workstationId: string | null | undefined, requestBody: Workstation): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workstations&validateOnly=' + validateOnly + '&workstationId=' + (workstationId == null ? '' : encodeURIComponent(workstationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_listUsable(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListUsableWorkstationsResponse> {
			return this.http.get<ListUsableWorkstationsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workstations:listUsable&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Workstations_projects_locations_workstationClusters_workstationConfigs_workstations_generateAccessToken(workstation: string, requestBody: GenerateAccessTokenRequest): Observable<GenerateAccessTokenResponse> {
			return this.http.post<GenerateAccessTokenResponse>(this.baseUri + 'v1beta/' + (workstation == null ? '' : encodeURIComponent(workstation)) + ':generateAccessToken', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
