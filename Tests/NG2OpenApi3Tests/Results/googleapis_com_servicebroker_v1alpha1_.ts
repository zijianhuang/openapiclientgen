...
export namespace MyNS {
	...
	export interface GoogleCloudServicebrokerV1alpha1__Binding {
	...
	/** Describes the binding. */
	export interface GoogleCloudServicebrokerV1alpha1__BindingFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__BindingFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__BindingFormProperties>({
	...
	export interface GoogleCloudServicebrokerV1alpha1__CreateBindingResponse {
	...
	/** Response for the `CreateBinding()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__CreateBindingResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__CreateBindingResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__CreateBindingResponseFormProperties>({
	...
	export interface GoogleCloudServicebrokerV1alpha1__CreateServiceInstanceResponse {
	...
	/** Response for the `CreateServiceInstance()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__CreateServiceInstanceResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__CreateServiceInstanceResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__CreateServiceInstanceResponseFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			operation: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudServicebrokerV1alpha1__DashboardClient {
	...
	/** Message containing information required to activate Dashboard SSO feature. */
	export interface GoogleCloudServicebrokerV1alpha1__DashboardClientFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__DashboardClientFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__DashboardClientFormProperties>({
	...
	export interface GoogleCloudServicebrokerV1alpha1__DeleteBindingResponse {
	...
	/** Response for the `DeleteBinding()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__DeleteBindingResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__DeleteBindingResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__DeleteBindingResponseFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			operation: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudServicebrokerV1alpha1__DeleteServiceInstanceResponse {
	...
	/** Response for the `DeleteServiceInstance()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__DeleteServiceInstanceResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__DeleteServiceInstanceResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__DeleteServiceInstanceResponseFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			operation: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudServicebrokerV1alpha1__GetBindingResponse {
	...
	/** Response for the `GetBinding()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__GetBindingResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__GetBindingResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__GetBindingResponseFormProperties>({
			credentials: new FormControl<{[id: string]: any } | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			route_service_url: new FormControl<string | null | undefined>(undefined),
			syslog_drain_url: new FormControl<string | null | undefined>(undefined),
	...
	export interface GoogleCloudServicebrokerV1alpha1__ListBindingsResponse {

		/** The list of the bindings in the instance. */
		bindings?: Array<GoogleCloudServicebrokerV1alpha1__Binding>;
	...
	/** The response for the `ListBindings()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__ListBindingsResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__ListBindingsResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__ListBindingsResponseFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
	...
	export interface GoogleCloudServicebrokerV1alpha1__ListCatalogResponse {
		...
		services?: Array<GoogleCloudServicebrokerV1alpha1__Service>;
	}

	/** Response message for the `ListCatalog()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__ListCatalogResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__ListCatalogResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__ListCatalogResponseFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	 ...
	 */
	export interface GoogleCloudServicebrokerV1alpha1__Service {
		...
		/** Message containing information required to activate Dashboard SSO feature. */
		dashboard_client?: GoogleCloudServicebrokerV1alpha1__DashboardClient;
		 ...
		 */
		plans?: Array<GoogleCloudServicebrokerV1alpha1__Plan>;
	 ...
	 * Though due to Google Specifics it has additional optional fields.
	 */
	export interface GoogleCloudServicebrokerV1alpha1__ServiceFormProperties {
		...
		/** Whether the service provides an endpoint to get service instances. */
		instance_retrievable: FormControl<boolean | null | undefined>,
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__ServiceFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__ServiceFormProperties>({
			...
			description: new FormControl<string | null | undefined>(undefined),
			id: new FormControl<string | null | undefined>(undefined),
			instance_retrievable: new FormControl<boolean | null | undefined>(undefined),
	...
	export interface GoogleCloudServicebrokerV1alpha1__Plan {
	...
	/** Plan message describes a Service Plan. */
	export interface GoogleCloudServicebrokerV1alpha1__PlanFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__PlanFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__PlanFormProperties>({
			bindable: new FormControl<boolean | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
	...
	export interface GoogleCloudServicebrokerV1alpha1__ListServiceInstancesResponse {
		...
		instances?: Array<GoogleCloudServicebrokerV1alpha1__ServiceInstance>;
	...
	/** The response for the `ListServiceInstances()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__ListServiceInstancesResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__ListServiceInstancesResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__ListServiceInstancesResponseFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudServicebrokerV1alpha1__ServiceInstance {
	...
	/** Message describing inputs to Provision and Update Service instance requests. */
	export interface GoogleCloudServicebrokerV1alpha1__ServiceInstanceFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__ServiceInstanceFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__ServiceInstanceFormProperties>({
	...
	export interface GoogleCloudServicebrokerV1alpha1__Operation {
	...
	/** Describes a long running operation, which conforms to OpenService API. */
	export interface GoogleCloudServicebrokerV1alpha1__OperationFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__OperationFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__OperationFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
	...
	export interface GoogleCloudServicebrokerV1alpha1__UpdateServiceInstanceResponse {
	...
	/** Response for the `UpdateServiceInstance()` method. */
	export interface GoogleCloudServicebrokerV1alpha1__UpdateServiceInstanceResponseFormProperties {
	...
	export function CreateGoogleCloudServicebrokerV1alpha1__UpdateServiceInstanceResponseFormGroup() {
		return new FormGroup<GoogleCloudServicebrokerV1alpha1__UpdateServiceInstanceResponseFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			operation: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 */
		Servicebroker_projects_brokers_v2_service_instances_get(name: string): Observable<HttpResponse<string>> {
		 ...
		 * Get v1alpha1/{parent}/service_bindings
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_instances_service_bindings_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/service_bindings&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * This API is an extension and not part of the OSB spec.
		 * Hence the path is a standard Google API URL.
		 * Get v1alpha1/{parent}/service_instances
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_service_instances_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/service_instances&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * Get v1alpha1/{parent}/v2/catalog
		 * @param {string} parent Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.
		 * @param {number} pageSize Specifies the number of results to return per page. If there are fewer
		 * elements than the specified number, returns all elements.
		 * Optional. If unset or 0, all the results will be returned.
		...
		Servicebroker_projects_brokers_v2_catalog_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/v2/catalog&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * Delete v1alpha1/{parent}/v2/service_instances/{instanceId}
		 * @param {string} parent Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_v2_service_instances_delete(parent: string, instanceId: string, acceptsIncomplete: boolean | null | undefined, planId: string | null | undefined, serviceId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/v2/service_instances/' + (instanceId == null ? '' : encodeURIComponent(instanceId)) + '&acceptsIncomplete=' + acceptsIncomplete + '&planId=' + (planId == null ? '' : encodeURIComponent(planId)) + '&serviceId=' + (serviceId == null ? '' : encodeURIComponent(serviceId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Returns the state of the last operation for the service instance.
		 * Only last (or current) operation can be polled.
		 * Get v1alpha1/{parent}/v2/service_instances/{instanceId}/last_operation
		 * @param {string} parent Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_v2_service_instances_getLast_operation(parent: string, instanceId: string, operation: string | null | undefined, planId: string | null | undefined, serviceId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/v2/service_instances/' + (instanceId == null ? '' : encodeURIComponent(instanceId)) + '/last_operation&operation=' + (operation == null ? '' : encodeURIComponent(operation)) + '&planId=' + (planId == null ? '' : encodeURIComponent(planId)) + '&serviceId=' + (serviceId == null ? '' : encodeURIComponent(serviceId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * GetBinding returns the binding information.
		 * Get v1alpha1/{parent}/v2/service_instances/{instanceId}/service_bindings/{bindingId}
		 * @param {string} parent Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_v2_service_instances_service_bindings_get(parent: string, instanceId: string, bindingId: string, planId: string | null | undefined, serviceId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/v2/service_instances/' + (instanceId == null ? '' : encodeURIComponent(instanceId)) + '/service_bindings/' + (bindingId == null ? '' : encodeURIComponent(bindingId)) + '&planId=' + (planId == null ? '' : encodeURIComponent(planId)) + '&serviceId=' + (serviceId == null ? '' : encodeURIComponent(serviceId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Returns the state of the last operation for the binding.
		 * Only last (or current) operation can be polled.
		 * Get v1alpha1/{parent}/v2/service_instances/{instanceId}/service_bindings/{bindingId}/last_operation
		 * @param {string} parent Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_v2_service_instances_service_bindings_getLast_operation(parent: string, instanceId: string, bindingId: string, operation: string | null | undefined, planId: string | null | undefined, serviceId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/v2/service_instances/' + (instanceId == null ? '' : encodeURIComponent(instanceId)) + '/service_bindings/' + (bindingId == null ? '' : encodeURIComponent(bindingId)) + '/last_operation&operation=' + (operation == null ? '' : encodeURIComponent(operation)) + '&planId=' + (planId == null ? '' : encodeURIComponent(planId)) + '&serviceId=' + (serviceId == null ? '' : encodeURIComponent(serviceId)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * CreateBinding generates a service binding to an existing service instance.
		 * See ProviServiceInstance for async operation details.
		 * Put v1alpha1/{parent}/v2/service_instances/{instanceId}/service_bindings/{binding_id}
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_v2_service_instances_service_bindings_create(parent: string, instanceId: string, binding_id: string, acceptsIncomplete: boolean | null | undefined, requestBody: GoogleCloudServicebrokerV1alpha1__Binding): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/v2/service_instances/' + (instanceId == null ? '' : encodeURIComponent(instanceId)) + '/service_bindings/' + (binding_id == null ? '' : encodeURIComponent(binding_id)) + '&acceptsIncomplete=' + acceptsIncomplete, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}

		/**
		 * Updates an existing service instance.
		 * See CreateServiceInstance for possible response codes.
		 * Patch v1alpha1/{parent}/v2/service_instances/{instance_id}
		 * @param {string} parent Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_v2_service_instances_patch(parent: string, instance_id: string, acceptsIncomplete: boolean | null | undefined, requestBody: GoogleCloudServicebrokerV1alpha1__ServiceInstance): Observable<HttpResponse<string>> {
			return this.http.patch(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/v2/service_instances/' + (instance_id == null ? '' : encodeURIComponent(instance_id)) + '&acceptsIncomplete=' + acceptsIncomplete, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * Put v1alpha1/{parent}/v2/service_instances/{instance_id}
		 * @param {string} parent Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.
		 * @param {string} instance_id The id of the service instance. Must be unique within GCP project.
		 * Maximum length is 64, GUID recommended.
		 * Required.
		 ...
		 * @return {void} Successful response
		 */
		Servicebroker_projects_brokers_v2_service_instances_create(parent: string, instance_id: string, acceptsIncomplete: boolean | null | undefined, requestBody: GoogleCloudServicebrokerV1alpha1__ServiceInstance): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/v2/service_instances/' + (instance_id == null ? '' : encodeURIComponent(instance_id)) + '&acceptsIncomplete=' + acceptsIncomplete, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		...
		Servicebroker_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'v1alpha1/' + (resource == null ? '' : encodeURIComponent(resource)) + ':getIamPolicy&options_requestedPolicyVersion=' + options_requestedPolicyVersion, { observe: 'response', responseType: 'text' });
		}
		...
		Servicebroker_setIamPolicy(resource: string, requestBody: GoogleIamV1__SetIamPolicyRequest): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v1alpha1/' + (resource == null ? '' : encodeURIComponent(resource)) + ':setIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		...
		Servicebroker_testIamPermissions(resource: string, requestBody: GoogleIamV1__TestIamPermissionsRequest): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'v1alpha1/' + (resource == null ? '' : encodeURIComponent(resource)) + ':testIamPermissions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
