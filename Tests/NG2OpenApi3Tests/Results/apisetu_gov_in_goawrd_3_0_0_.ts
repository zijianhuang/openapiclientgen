...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {PfdawPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Pfdaw(requestBody: PfdawPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'pfdaw/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {TpcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Tpcer(requestBody: TpcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'tpcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface ErcerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<ErcerPostBodyFormat | null | undefined>,
	...
	export function CreateErcerPostBodyFormGroup() {
		return new FormGroup<ErcerPostBodyFormProperties>({
			format: new FormControl<ErcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface ErcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		Registration: FormControl<string | null | undefined>,
	}
	export function CreateErcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<ErcerPostBodyCertificateParametersFormProperties>({
			...
			Registration: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PfdawPostBodyFormProperties {
	...
	export function CreatePfdawPostBodyFormGroup() {
		return new FormGroup<PfdawPostBodyFormProperties>({
			format: new FormControl<ErcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PfdawPostBodyCertificateParameters {
	...
	export interface PfdawPostBodyCertificateParametersFormProperties {
	...
	export function CreatePfdawPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PfdawPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Registration: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface TpcerPostBody {
		certificateParameters?: TpcerPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface TpcerPostBodyFormProperties {
	...
	export function CreateTpcerPostBodyFormGroup() {
		return new FormGroup<TpcerPostBodyFormProperties>({
			format: new FormControl<ErcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface TpcerPostBodyCertificateParameters {
	...
	export interface TpcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateTpcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<TpcerPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Registration: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
