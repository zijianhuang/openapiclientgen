...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {Ror1bPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Ror1b(requestBody: Ror1bPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'ror1b/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface RdcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		REGDNO: FormControl<string | null | undefined>,
	...
	export function CreateRdcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<RdcerPostBodyCertificateParametersFormProperties>({
			...
			REGDNO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface Ror1bPostBodyFormProperties {
	...
	export function CreateRor1bPostBodyFormGroup() {
		return new FormGroup<Ror1bPostBodyFormProperties>({
			format: new FormControl<RdcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface Ror1bPostBodyCertificateParameters {
	...
	export interface Ror1bPostBodyCertificateParametersFormProperties {

		/**
		 * Khata No.
		 * Required
		 */
		khatano: FormControl<string | null | undefined>,
	...
	export function CreateRor1bPostBodyCertificateParametersFormGroup() {
		return new FormGroup<Ror1bPostBodyCertificateParametersFormProperties>({
			khatano: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			level1: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			level2: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			level3: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
