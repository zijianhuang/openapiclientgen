...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {void} OK
		 */
		BulkLookupGetByKeyAndIpsAndParamsAndLangAndFormat(key: string, ips: string, params: string | null | undefined, lang: string | null | undefined, format: string | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'BulkLookup?key=' + (key == null ? '' : encodeURIComponent(key)) + '&ips=' + (ips == null ? '' : encodeURIComponent(ips)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&lang=' + (lang == null ? '' : encodeURIComponent(lang)) + '&format=' + (format == null ? '' : encodeURIComponent(format)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		CountryGetByKeyAndCountryCodeAndParamsAndLangAndFormat(key: string, CountryCode: string, params: string | null | undefined, lang: string | null | undefined, format: string | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'Country?key=' + (key == null ? '' : encodeURIComponent(key)) + '&CountryCode=' + (CountryCode == null ? '' : encodeURIComponent(CountryCode)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&lang=' + (lang == null ? '' : encodeURIComponent(lang)) + '&format=' + (format == null ? '' : encodeURIComponent(format)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		GeoIPGetByKeyAndParamsAndLangAndFormat(key: string, params: string | null | undefined, lang: string | null | undefined, format: string | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'GeoIP?key=' + (key == null ? '' : encodeURIComponent(key)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&lang=' + (lang == null ? '' : encodeURIComponent(lang)) + '&format=' + (format == null ? '' : encodeURIComponent(format)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		IPLookupGetByKeyAndIpAndParamsAndLangAndFormat(key: string, ip: string, params: string | null | undefined, lang: string | null | undefined, format: string | null | undefined, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'IPLookup?key=' + (key == null ? '' : encodeURIComponent(key)) + '&ip=' + (ip == null ? '' : encodeURIComponent(ip)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&lang=' + (lang == null ? '' : encodeURIComponent(lang)) + '&format=' + (format == null ? '' : encodeURIComponent(format)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
