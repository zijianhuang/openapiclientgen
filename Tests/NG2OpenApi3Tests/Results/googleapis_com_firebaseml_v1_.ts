...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Firebaseml_operations_delete(name: string): Observable<Empty> {
		 ...
		 */
		Firebaseml_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListOperationsResponse> {
		 ...
		 * @return {Empty} Successful response
		 */
		Firebaseml_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<Empty> {
