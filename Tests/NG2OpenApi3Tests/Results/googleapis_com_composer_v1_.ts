...
export namespace MyNS {
	...
	export class MyClient {
		...
		Composer_projects_locations_environments_databaseFailover(environment: string, requestBody: DatabaseFailoverRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (environment == null ? '' : encodeURIComponent(environment)) + ':databaseFailover', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Composer_projects_locations_environments_executeAirflowCommand(environment: string, requestBody: ExecuteAirflowCommandRequest): Observable<ExecuteAirflowCommandResponse> {
			return this.http.post<ExecuteAirflowCommandResponse>(this.baseUri + 'v1/' + (environment == null ? '' : encodeURIComponent(environment)) + ':executeAirflowCommand', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Composer_projects_locations_environments_fetchDatabaseProperties(environment: string): Observable<FetchDatabasePropertiesResponse> {
			return this.http.get<FetchDatabasePropertiesResponse>(this.baseUri + 'v1/' + (environment == null ? '' : encodeURIComponent(environment)) + ':fetchDatabaseProperties', {});
		}
		...
		Composer_projects_locations_environments_loadSnapshot(environment: string, requestBody: LoadSnapshotRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (environment == null ? '' : encodeURIComponent(environment)) + ':loadSnapshot', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Composer_projects_locations_environments_pollAirflowCommand(environment: string, requestBody: PollAirflowCommandRequest): Observable<PollAirflowCommandResponse> {
			return this.http.post<PollAirflowCommandResponse>(this.baseUri + 'v1/' + (environment == null ? '' : encodeURIComponent(environment)) + ':pollAirflowCommand', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Composer_projects_locations_environments_saveSnapshot(environment: string, requestBody: SaveSnapshotRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (environment == null ? '' : encodeURIComponent(environment)) + ':saveSnapshot', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Composer_projects_locations_environments_stopAirflowCommand(environment: string, requestBody: StopAirflowCommandRequest): Observable<StopAirflowCommandResponse> {
			return this.http.post<StopAirflowCommandResponse>(this.baseUri + 'v1/' + (environment == null ? '' : encodeURIComponent(environment)) + ':stopAirflowCommand', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Composer_projects_locations_environments_create(parent: string, requestBody: Environment): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/environments', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Composer_projects_locations_imageVersions_list(parent: string, includePastReleases: boolean | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListImageVersionsResponse> {
			return this.http.get<ListImageVersionsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/imageVersions&includePastReleases=' + includePastReleases + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
	}
