...
export namespace MyNS {
	...
	export enum GcsDestinationConfigGcsFileFormat { GCS_FILE_FORMAT_UNSPECIFIED = 'GCS_FILE_FORMAT_UNSPECIFIED', AVRO = 'AVRO' }
	...
	export enum StreamState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', CREATED = 'CREATED', RUNNING = 'RUNNING', PAUSED = 'PAUSED', MAINTENANCE = 'MAINTENANCE', FAILED = 'FAILED', FAILED_PERMANENTLY = 'FAILED_PERMANENTLY', STARTING = 'STARTING', DRAINING = 'DRAINING' }
	...
	export enum ValidationStatus { STATUS_UNSPECIFIED = 'STATUS_UNSPECIFIED', NOT_EXECUTED = 'NOT_EXECUTED', FAILED = 'FAILED', PASSED = 'PASSED' }
