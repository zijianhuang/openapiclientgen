...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {EtcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Etcer(requestBody: EtcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'etcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {GovidPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Govid(requestBody: GovidPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'govid/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {SicerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Sicer(requestBody: SicerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'sicer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface EtcerPostBody {
		certificateParameters?: EtcerPostBodyCertificateParameters;
	...
	export interface EtcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<EtcerPostBodyFormat | null | undefined>,
	...
	export function CreateEtcerPostBodyFormGroup() {
		return new FormGroup<EtcerPostBodyFormProperties>({
			format: new FormControl<EtcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface EtcerPostBodyCertificateParameters {
	...
	export interface EtcerPostBodyCertificateParametersFormProperties {

		/**
		 * Unique Code
		 * Required
		 */
		_unique_code: FormControl<string | null | undefined>,
	}
	export function CreateEtcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<EtcerPostBodyCertificateParametersFormProperties>({
			_unique_code: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum EtcerPostBodyFormat { pdf = 'pdf' }
	...
	export interface GovidPostBodyFormProperties {
	...
	export function CreateGovidPostBodyFormGroup() {
		return new FormGroup<GovidPostBodyFormProperties>({
			format: new FormControl<EtcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface GovidPostBodyCertificateParameters {
	...
	export interface GovidPostBodyCertificateParametersFormProperties {

		/**
		 * Unique Code
		 * Required
		 */
		_uniqueid: FormControl<string | null | undefined>,
	}
	export function CreateGovidPostBodyCertificateParametersFormGroup() {
		return new FormGroup<GovidPostBodyCertificateParametersFormProperties>({
			_uniqueid: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface SicerPostBody {
		certificateParameters?: SicerPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface SicerPostBodyFormProperties {
	...
	export function CreateSicerPostBodyFormGroup() {
		return new FormGroup<SicerPostBodyFormProperties>({
			format: new FormControl<EtcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SicerPostBodyCertificateParameters {
	...
	export interface SicerPostBodyCertificateParametersFormProperties {

		/**
		 * Name
		 * Required
		 */
		_name: FormControl<string | null | undefined>,
	...
	export function CreateSicerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SicerPostBodyCertificateParametersFormProperties>({
			_name: new FormControl<string | null | undefined>(undefined, [Validators.required]),
