...
export namespace MyNS {
	...
	/** Metadata for response returned by the `SynthesizeLongAudio` method. */
	export interface GoogleCloudTexttospeechV1beta1SynthesizeLongAudioMetadataFormProperties {
	...
	export function CreateGoogleCloudTexttospeechV1beta1SynthesizeLongAudioMetadataFormGroup() {
		return new FormGroup<GoogleCloudTexttospeechV1beta1SynthesizeLongAudioMetadataFormProperties>({
	...
	export interface SynthesizeSpeechRequest {
		...
		enableTimePointing?: Array<string>;
	...
	/** This contains a mapping between a certain point in the input text and a corresponding time in the output audio. */
	export interface TimepointFormProperties {

		/** Timepoint name as received from the client within `` tag. */
		markName: FormControl<string | null | undefined>,

		/**
		 * Time offset in seconds from the start of the synthesized audio.
		 * Type: double
		 */
		timeSeconds: FormControl<number | null | undefined>,
	}
	export function CreateTimepointFormGroup() {
		return new FormGroup<TimepointFormProperties>({
			markName: new FormControl<string | null | undefined>(undefined),
			timeSeconds: new FormControl<number | null | undefined>(undefined),
		});
	...
	export class MyClient {
		...
		Texttospeech_text_synthesize(requestBody: SynthesizeSpeechRequest): Observable<SynthesizeSpeechResponse> {
			return this.http.post<SynthesizeSpeechResponse>(this.baseUri + 'v1beta1/text:synthesize', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Texttospeech_voices_list(languageCode: string | null | undefined): Observable<ListVoicesResponse> {
			return this.http.get<ListVoicesResponse>(this.baseUri + 'v1beta1/voices?languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)), {});
		}
		...
		Texttospeech_projects_locations_synthesizeLongAudio(parent: string, requestBody: SynthesizeLongAudioRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':synthesizeLongAudio', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
