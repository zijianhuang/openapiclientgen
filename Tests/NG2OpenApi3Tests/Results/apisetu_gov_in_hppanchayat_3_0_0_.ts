...
export namespace MyNS {
	...
	export interface FmcerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<FmcerPostBodyFormat | null | undefined>,
	...
	export function CreateFmcerPostBodyFormGroup() {
		return new FormGroup<FmcerPostBodyFormProperties>({
			format: new FormControl<FmcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export enum FmcerPostBodyFormat { pdf = 'pdf' }
