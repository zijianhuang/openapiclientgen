...
export namespace MyNS {
	...
	export interface CanceledMembership {
		CanceledMembershipId?: number | null;
		Created?: string | null;
		MembershipId?: number | null;
		PlayerID?: number | null;
		TeamId?: number | null;
	}
	export interface CanceledMembershipFormProperties {
		CanceledMembershipId: FormControl<number | null | undefined>,
		Created: FormControl<string | null | undefined>,
		MembershipId: FormControl<number | null | undefined>,
		PlayerID: FormControl<number | null | undefined>,
		TeamId: FormControl<number | null | undefined>,
	}
	export function CreateCanceledMembershipFormGroup() {
		return new FormGroup<CanceledMembershipFormProperties>({
			CanceledMembershipId: new FormControl<number | null | undefined>(undefined),
	...
	export class MyClient {
		 ...
		 */
		CanceledMemberships(format: MembershipsActiveFormat): Observable<CanceledMembership> {
			return this.http.get<CanceledMembership>(this.baseUri + format + '/CanceledMemberships', {});
		}
