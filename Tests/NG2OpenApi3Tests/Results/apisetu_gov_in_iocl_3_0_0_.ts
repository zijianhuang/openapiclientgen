...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {LpgsvPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Lpgsv(requestBody: LpgsvPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'lpgsv/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {LpgtvPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Lpgtv(requestBody: LpgtvPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'lpgtv/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface LpgsvPostBody {
		certificateParameters?: LpgsvPostBodyCertificateParameters;
	...
	export interface LpgsvPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<LpgsvPostBodyFormat | null | undefined>,
	...
	export function CreateLpgsvPostBodyFormGroup() {
		return new FormGroup<LpgsvPostBodyFormProperties>({
			format: new FormControl<LpgsvPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface LpgsvPostBodyCertificateParameters {
	...
	export interface LpgsvPostBodyCertificateParametersFormProperties {
	...
	export function CreateLpgsvPostBodyCertificateParametersFormGroup() {
		return new FormGroup<LpgsvPostBodyCertificateParametersFormProperties>({
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface LpgtvPostBodyFormProperties {
	...
	export function CreateLpgtvPostBodyFormGroup() {
		return new FormGroup<LpgtvPostBodyFormProperties>({
			format: new FormControl<LpgsvPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface LpgtvPostBodyCertificateParameters {
	...
	export interface LpgtvPostBodyCertificateParametersFormProperties {
	...
	export function CreateLpgtvPostBodyCertificateParametersFormGroup() {
		return new FormGroup<LpgtvPostBodyCertificateParametersFormProperties>({
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
