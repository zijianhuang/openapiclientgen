...
export namespace MyNS {
	...
	export enum ApplicantWebsitesType { primary = 'primary', secondary = 'secondary', work = 'work', personal = 'personal', other = 'other' }
	...
	export enum ApplicationStatus { open = 'open', rejected = 'rejected', hired = 'hired', converted = 'converted', other = 'other' }
	...
	export enum AtsEventType { '*' = '*', 'ats.job.created' = 'ats.job.created', 'ats.job.updated' = 'ats.job.updated', 'ats.job.deleted' = 'ats.job.deleted', 'ats.applicant.created' = 'ats.applicant.created', 'ats.applicant.updated' = 'ats.applicant.updated', 'ats.applicant.deleted' = 'ats.applicant.deleted', 'ats.application.created' = 'ats.application.created', 'ats.application.updated' = 'ats.application.updated', 'ats.application.deleted' = 'ats.application.deleted' }
	...
	export enum JobEmployment_terms { 'full-time' = 'full-time', 'part-time' = 'part-time', internship = 'internship', contractor = 'contractor', employee = 'employee', freelance = 'freelance', temp = 'temp', seasonal = 'seasonal', volunteer = 'volunteer', other = 'other' }
	...
	export enum JobLinksType { job_portal = 'job_portal', job_description = 'job_description' }
	...
	export enum JobStatus { draft = 'draft', internal = 'internal', published = 'published', completed = 'completed', 'on-hold' = 'on-hold', private = 'private' }

	export enum JobVisibility { draft = 'draft', public = 'public', internal = 'internal' }
