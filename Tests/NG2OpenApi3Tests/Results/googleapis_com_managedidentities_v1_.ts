...
export namespace MyNS {
	...
	export class MyClient {
		...
		Managedidentities_projects_locations_global_domains_checkMigrationPermission(domain: string, requestBody: CheckMigrationPermissionRequest): Observable<CheckMigrationPermissionResponse> {
			return this.http.post<CheckMigrationPermissionResponse>(this.baseUri + 'v1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':checkMigrationPermission', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_disableMigration(domain: string, requestBody: DisableMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':disableMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_domainJoinMachine(domain: string, requestBody: DomainJoinMachineRequest): Observable<DomainJoinMachineResponse> {
			return this.http.post<DomainJoinMachineResponse>(this.baseUri + 'v1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':domainJoinMachine', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_enableMigration(domain: string, requestBody: EnableMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':enableMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_extendSchema(domain: string, requestBody: ExtendSchemaRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':extendSchema', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_peerings_get(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<Peering> {
			return this.http.get<Peering>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Managedidentities_projects_locations_global_domains_getLdapssettings(name: string): Observable<LDAPSSettings> {
			return this.http.get<LDAPSSettings>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/ldapssettings', {});
		}
		...
		Managedidentities_projects_locations_global_domains_updateLdapssettings(name: string, updateMask: string | null | undefined, requestBody: LDAPSSettings): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/ldapssettings&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_attachTrust(name: string, requestBody: AttachTrustRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':attachTrust', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_detachTrust(name: string, requestBody: DetachTrustRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':detachTrust', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_reconfigureTrust(name: string, requestBody: ReconfigureTrustRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':reconfigureTrust', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_resetAdminPassword(name: string, requestBody: ResetAdminPasswordRequest): Observable<ResetAdminPasswordResponse> {
			return this.http.post<ResetAdminPasswordResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':resetAdminPassword', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_validateTrust(name: string, requestBody: ValidateTrustRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':validateTrust', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} pageToken Optional. The `next_page_token` value returned from a previous ListDomainsRequest request, if any.
		...
		Managedidentities_projects_locations_global_domains_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDomainsResponse> {
			return this.http.get<ListDomainsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/domains&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Managedidentities_projects_locations_global_domains_create(parent: string, domainName: string | null | undefined, requestBody: Domain): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/domains&domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Peerings in a given project.
		 * Get v1/{parent}/peerings
		 * @param {string} parent Required. The resource name of the peering location using the form: `projects/{project_id}/locations/global`
		 * @param {string} filter Optional. Filter specifying constraints of a list operation. For example, `peering.authorized_network="projects/myprojectid/global/networks/mynetwork"`.
		 * @param {string} orderBy Optional. Specifies the ordering of results following syntax at https://cloud.google.com/apis/design/design_patterns#sorting_order.
		 * @param {number} pageSize Optional. The maximum number of items to return. If not specified, a default value of 1000 will be used by the service. Regardless of the page_size value, the response may include a partial list and a caller should only rely on response's next_page_token to determine if there are more instances left to be queried.
		 * @param {string} pageToken Optional. The next_page_token value returned from a previous List request, if any.
		...
		Managedidentities_projects_locations_global_peerings_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPeeringsResponse> {
			return this.http.get<ListPeeringsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/peerings&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @param {string} peeringId Required. Peering Id, unique name to identify peering. It should follow the regex format "^(?:[a-z](?:[-a-z0-9]{0,61}[a-z0-9])?)$"
		 * @return {Operation} Successful response
		 */
		Managedidentities_projects_locations_global_peerings_create(parent: string, peeringId: string | null | undefined, requestBody: Peering): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/peerings&peeringId=' + (peeringId == null ? '' : encodeURIComponent(peeringId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_sqlIntegrations_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSqlIntegrationsResponse> {
			return this.http.get<ListSqlIntegrationsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sqlIntegrations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
