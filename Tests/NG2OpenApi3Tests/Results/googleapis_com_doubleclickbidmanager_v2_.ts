...
export namespace MyNS {
	...
	export enum QueryMetadataFormat { FORMAT_UNSPECIFIED = 'FORMAT_UNSPECIFIED', CSV = 'CSV', XLSX = 'XLSX' }
	...
	export enum ParametersType { REPORT_TYPE_UNSPECIFIED = 'REPORT_TYPE_UNSPECIFIED', STANDARD = 'STANDARD', INVENTORY_AVAILABILITY = 'INVENTORY_AVAILABILITY', AUDIENCE_COMPOSITION = 'AUDIENCE_COMPOSITION', FLOODLIGHT = 'FLOODLIGHT', YOUTUBE = 'YOUTUBE', GRP = 'GRP', YOUTUBE_PROGRAMMATIC_GUARANTEED = 'YOUTUBE_PROGRAMMATIC_GUARANTEED', REACH = 'REACH', UNIQUE_REACH_AUDIENCE = 'UNIQUE_REACH_AUDIENCE', FULL_PATH = 'FULL_PATH', PATH_ATTRIBUTION = 'PATH_ATTRIBUTION' }
	...
	export enum QueryScheduleFrequency { FREQUENCY_UNSPECIFIED = 'FREQUENCY_UNSPECIFIED', ONE_TIME = 'ONE_TIME', DAILY = 'DAILY', WEEKLY = 'WEEKLY', SEMI_MONTHLY = 'SEMI_MONTHLY', MONTHLY = 'MONTHLY', QUARTERLY = 'QUARTERLY', YEARLY = 'YEARLY' }
	...
	export enum ReportStatusState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', QUEUED = 'QUEUED', RUNNING = 'RUNNING', DONE = 'DONE', FAILED = 'FAILED' }
