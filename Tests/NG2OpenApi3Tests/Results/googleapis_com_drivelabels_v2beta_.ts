...
export namespace MyNS {
	...
	export enum GoogleAppsDriveLabelsV2betaLabelPermissionRole { LABEL_ROLE_UNSPECIFIED = 0, READER = 1, APPLIER = 2, ORGANIZER = 3, EDITOR = 4 }
	...
	export enum GoogleAppsDriveLabelsV2betaFieldDateOptionsDateFormatType { DATE_FORMAT_UNSPECIFIED = 0, LONG_DATE = 1, SHORT_DATE = 2 }
	...
	export enum GoogleAppsDriveLabelsV2betaLifecycleState { STATE_UNSPECIFIED = 0, UNPUBLISHED_DRAFT = 1, PUBLISHED = 2, DISABLED = 3, DELETED = 4 }
	...
	export enum GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestView { LABEL_VIEW_BASIC = 0, LABEL_VIEW_FULL = 1 }
	...
	export enum GoogleAppsDriveLabelsV2betaLabelAppliedLabelPolicyCopyMode { COPY_MODE_UNSPECIFIED = 0, DO_NOT_COPY = 1, ALWAYS_COPY = 2, COPY_APPLIABLE = 3 }
	...
	export enum GoogleAppsDriveLabelsV2betaLabelLabelType { LABEL_TYPE_UNSPECIFIED = 0, SHARED = 1, ADMIN = 2, GOOGLE_APP = 3 }
	...
	export enum GoogleAppsDriveLabelsV2betaLabelLockState { STATE_UNSPECIFIED = 0, ACTIVE = 1, DELETING = 2 }
