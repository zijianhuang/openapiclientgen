...
export namespace MyNS {
	...
	export interface TargetVMDetails {
		...
		/** The disk type to use in the VM. */
		diskType?: TargetVMDetailsDiskType | null;
		...
		/** The license type to use in OS adaptation. */
		licenseType?: TargetVMDetailsLicenseType | null;
	...
	/** TargetVMDetails is a collection of details for creating a VM in a target Compute Engine project. */
	export interface TargetVMDetailsFormProperties {

		/** Output only. The VM Boot Option, as set in the source VM. */
		bootOption: FormControl<AwsVmDetailsBootOption | null | undefined>,

		/** The disk type to use in the VM. */
		diskType: FormControl<TargetVMDetailsDiskType | null | undefined>,
		...
		/** The license type to use in OS adaptation. */
		licenseType: FormControl<TargetVMDetailsLicenseType | null | undefined>,
	...
	export function CreateTargetVMDetailsFormGroup() {
		return new FormGroup<TargetVMDetailsFormProperties>({
			bootOption: new FormControl<AwsVmDetailsBootOption | null | undefined>(undefined),
			diskType: new FormControl<TargetVMDetailsDiskType | null | undefined>(undefined),
			externalIp: new FormControl<string | null | undefined>(undefined),
			internalIp: new FormControl<string | null | undefined>(undefined),
			labels: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			licenseType: new FormControl<TargetVMDetailsLicenseType | null | undefined>(undefined),
			machineType: new FormControl<string | null | undefined>(undefined),
			machineTypeSeries: new FormControl<string | null | undefined>(undefined),
			metadata: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
	...
	export interface VmwareVmDetailsFormProperties {
		...
		/** The total size of the storage allocated to the VM in MB. */
		committedStorage: FormControl<string | null | undefined>,
	...
	export function CreateVmwareVmDetailsFormGroup() {
		return new FormGroup<VmwareVmDetailsFormProperties>({
			bootOption: new FormControl<AwsVmDetailsBootOption | null | undefined>(undefined),
			committedStorage: new FormControl<string | null | undefined>(undefined),
			committedStorageMb: new FormControl<string | null | undefined>(undefined),
			cpuCount: new FormControl<number | null | undefined>(undefined),
	...
	export function CreateUtilizationReportFormGroup() {
		return new FormGroup<UtilizationReportFormProperties>({
			...
			vmsCount: new FormControl<number | null | undefined>(undefined),
		});
	...
	export interface VmUtilizationMetricsFormProperties {
		...
		/** Average disk IO rate, in kilobytes per second. */
		diskIoRateAverage: FormControl<string | null | undefined>,

		/** Average disk IO rate, in kilobytes per second. */
		diskIoRateAverageKbps: FormControl<string | null | undefined>,

		/** Max disk IO rate, in kilobytes per second. */
		diskIoRateMax: FormControl<string | null | undefined>,
		...
		/** Average network throughput (combined transmit-rates and receive-rates), in kilobytes per second. */
		networkThroughputAverage: FormControl<string | null | undefined>,

		/** Average network throughput (combined transmit-rates and receive-rates), in kilobytes per second. */
		networkThroughputAverageKbps: FormControl<string | null | undefined>,

		/** Max network throughput (combined transmit-rates and receive-rates), in kilobytes per second. */
		networkThroughputMax: FormControl<string | null | undefined>,
	...
	export function CreateVmUtilizationMetricsFormGroup() {
		return new FormGroup<VmUtilizationMetricsFormProperties>({
			cpuAverage: new FormControl<number | null | undefined>(undefined),
			cpuAveragePercent: new FormControl<number | null | undefined>(undefined),
			cpuMax: new FormControl<number | null | undefined>(undefined),
			cpuMaxPercent: new FormControl<number | null | undefined>(undefined),
			diskIoRateAverage: new FormControl<string | null | undefined>(undefined),
			diskIoRateAverageKbps: new FormControl<string | null | undefined>(undefined),
			diskIoRateMax: new FormControl<string | null | undefined>(undefined),
			diskIoRateMaxKbps: new FormControl<string | null | undefined>(undefined),
			memoryAverage: new FormControl<number | null | undefined>(undefined),
			memoryAveragePercent: new FormControl<number | null | undefined>(undefined),
			memoryMax: new FormControl<number | null | undefined>(undefined),
			memoryMaxPercent: new FormControl<number | null | undefined>(undefined),
			networkThroughputAverage: new FormControl<string | null | undefined>(undefined),
			networkThroughputAverageKbps: new FormControl<string | null | undefined>(undefined),
			networkThroughputMax: new FormControl<string | null | undefined>(undefined),
	...
	export class MyClient {
		...
		Vmmigration_projects_locations_sources_datacenterConnectors_upgradeAppliance(datacenterConnector: string, requestBody: UpgradeApplianceRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (datacenterConnector == null ? '' : encodeURIComponent(datacenterConnector)) + ':upgradeAppliance', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_groups_addGroupMigration(group: string, requestBody: AddGroupMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (group == null ? '' : encodeURIComponent(group)) + ':addGroupMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_groups_removeGroupMigration(group: string, requestBody: RemoveGroupMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (group == null ? '' : encodeURIComponent(group)) + ':removeGroupMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_finalizeMigration(migratingVm: string, requestBody: FinalizeMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (migratingVm == null ? '' : encodeURIComponent(migratingVm)) + ':finalizeMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_pauseMigration(migratingVm: string, requestBody: PauseMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (migratingVm == null ? '' : encodeURIComponent(migratingVm)) + ':pauseMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_resumeMigration(migratingVm: string, requestBody: ResumeMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (migratingVm == null ? '' : encodeURIComponent(migratingVm)) + ':resumeMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_startMigration(migratingVm: string, requestBody: StartMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (migratingVm == null ? '' : encodeURIComponent(migratingVm)) + ':startMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_targetProjects_get(name: string, view: Vmmigration_projects_locations_targetProjects_getView | null | undefined): Observable<TargetProject> {
			return this.http.get<TargetProject>(this.baseUri + 'v1alpha1/' + (name == null ? '' : encodeURIComponent(name)) + '&view=' + view, {});
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_cutoverJobs_cancel(name: string, requestBody: CancelCutoverJobRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (name == null ? '' : encodeURIComponent(name)) + ':cancel', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_cloneJobs_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCloneJobsResponse> {
			return this.http.get<ListCloneJobsResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/cloneJobs&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_cloneJobs_create(parent: string, cloneJobId: string | null | undefined, requestId: string | null | undefined, requestBody: CloneJob): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/cloneJobs&cloneJobId=' + (cloneJobId == null ? '' : encodeURIComponent(cloneJobId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_cutoverJobs_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCutoverJobsResponse> {
			return this.http.get<ListCutoverJobsResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/cutoverJobs&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_cutoverJobs_create(parent: string, cutoverJobId: string | null | undefined, requestId: string | null | undefined, requestBody: CutoverJob): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/cutoverJobs&cutoverJobId=' + (cutoverJobId == null ? '' : encodeURIComponent(cutoverJobId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_datacenterConnectors_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDatacenterConnectorsResponse> {
			return this.http.get<ListDatacenterConnectorsResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/datacenterConnectors&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Vmmigration_projects_locations_sources_datacenterConnectors_create(parent: string, datacenterConnectorId: string | null | undefined, requestId: string | null | undefined, requestBody: DatacenterConnector): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/datacenterConnectors&datacenterConnectorId=' + (datacenterConnectorId == null ? '' : encodeURIComponent(datacenterConnectorId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Vmmigration_projects_locations_sources_migratingVms_listView | null | undefined): Observable<ListMigratingVmsResponse> {
			return this.http.get<ListMigratingVmsResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/migratingVms&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_create(parent: string, migratingVmId: string | null | undefined, requestId: string | null | undefined, requestBody: MigratingVm): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/migratingVms&migratingVmId=' + (migratingVmId == null ? '' : encodeURIComponent(migratingVmId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_migratingVms_replicationCycles_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListReplicationCyclesResponse> {
			return this.http.get<ListReplicationCyclesResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/replicationCycles&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Vmmigration_projects_locations_targetProjects_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListTargetProjectsResponse> {
			return this.http.get<ListTargetProjectsResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/targetProjects&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Vmmigration_projects_locations_targetProjects_create(parent: string, requestId: string | null | undefined, targetProjectId: string | null | undefined, requestBody: TargetProject): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/targetProjects&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&targetProjectId=' + (targetProjectId == null ? '' : encodeURIComponent(targetProjectId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vmmigration_projects_locations_sources_utilizationReports_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Vmmigration_projects_locations_targetProjects_getView | null | undefined): Observable<ListUtilizationReportsResponse> {
			return this.http.get<ListUtilizationReportsResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/utilizationReports&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Vmmigration_projects_locations_sources_fetchInventory(source: string, forceRefresh: boolean | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<FetchInventoryResponse> {
			return this.http.get<FetchInventoryResponse>(this.baseUri + 'v1alpha1/' + (source == null ? '' : encodeURIComponent(source)) + ':fetchInventory&forceRefresh=' + forceRefresh + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
	}
