...
export namespace MyNS {
	...
	export enum NodeHealth { HEALTH_UNSPECIFIED = 'HEALTH_UNSPECIFIED', HEALTHY = 'HEALTHY', DEPRECATED_UNHEALTHY = 'DEPRECATED_UNHEALTHY', TIMEOUT = 'TIMEOUT', UNHEALTHY_TENSORFLOW = 'UNHEALTHY_TENSORFLOW', UNHEALTHY_MAINTENANCE = 'UNHEALTHY_MAINTENANCE' }
	...
	export class MyClient {
		 ...
		 */
		Tpu_projects_locations_operations_delete(name: string, requestId: string | null | undefined): Observable<Empty> {
		...
		Tpu_projects_locations_tensorflowVersions_get(name: string): Observable<TensorFlowVersion> {
			return this.http.get<TensorFlowVersion>(this.baseUri + 'v1alpha1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Tpu_projects_locations_operations_cancel(name: string): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'v1alpha1/' + (name == null ? '' : encodeURIComponent(name)) + ':cancel', null, {});
		}

		/**
		 * Reimages a node's OS.
		 * Post v1alpha1/{name}:reimage
		 * @param {string} name The resource name.
		 * @return {Operation} Successful response
		 */
		Tpu_projects_locations_nodes_reimage(name: string, requestBody: ReimageNodeRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (name == null ? '' : encodeURIComponent(name)) + ':reimage', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Starts a node.
		 * Post v1alpha1/{name}:start
		 * @param {string} name The resource name.
		 * @return {Operation} Successful response
		 */
		Tpu_projects_locations_nodes_start(name: string, requestBody: StartNodeRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (name == null ? '' : encodeURIComponent(name)) + ':start', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Stops a node. This operation is only available with single TPU nodes.
		 * Post v1alpha1/{name}:stop
		 * @param {string} name The resource name.
		 * @return {Operation} Successful response
		 */
		Tpu_projects_locations_nodes_stop(name: string, requestBody: StopNodeRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (name == null ? '' : encodeURIComponent(name)) + ':stop', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists accelerator types supported by this API.
		 * Get v1alpha1/{parent}/acceleratorTypes
		...
		Tpu_projects_locations_acceleratorTypes_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAcceleratorTypesResponse> {
			return this.http.get<ListAcceleratorTypesResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/acceleratorTypes&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Tpu_projects_locations_nodes_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListNodesResponse> {
			return this.http.get<ListNodesResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/nodes&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Tpu_projects_locations_nodes_create(parent: string, nodeId: string | null | undefined, requestId: string | null | undefined, requestBody: Node): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/nodes&nodeId=' + (nodeId == null ? '' : encodeURIComponent(nodeId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists TensorFlow versions supported by this API.
		 * Get v1alpha1/{parent}/tensorflowVersions
		 * @param {string} parent Required. The parent resource name.
		 * @param {string} filter List filter.
		 * @param {string} orderBy Sort results.
		 * @param {number} pageSize The maximum number of items to return.
		...
		Tpu_projects_locations_tensorflowVersions_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListTensorFlowVersionsResponse> {
			return this.http.get<ListTensorFlowVersionsResponse>(this.baseUri + 'v1alpha1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/tensorflowVersions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
	}
