...
export namespace MyNS {
	...
	export enum AnnotationType { TYPE_UNSPECIFIED = 0, TYPE_LEGACY_EXPORT_CONSENT = 1, TYPE_QWIKLAB = 2 }
	...
	export enum CollectorState { STATE_UNSPECIFIED = 0, STATE_INITIALIZING = 1, STATE_READY_TO_USE = 2, STATE_REGISTERED = 3, STATE_ACTIVE = 4, STATE_PAUSED = 5, STATE_DELETING = 6, STATE_DECOMMISSIONED = 7, STATE_ERROR = 8 }
