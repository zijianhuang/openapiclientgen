...
export namespace MyNS {
	...
	/** Request to add a record set to a private managed DNS zone in the shared producer host project. */
	export interface AddDnsRecordSetRequestFormProperties {
	...
	export function CreateAddDnsRecordSetRequestFormGroup() {
		return new FormGroup<AddDnsRecordSetRequestFormProperties>({
	...
	/** Request to add a private managed DNS zone in the shared producer host project and a matching DNS peering zone in the consumer project. */
	export interface AddDnsZoneRequestFormProperties {
	...
	export function CreateAddDnsZoneRequestFormGroup() {
		return new FormGroup<AddDnsZoneRequestFormProperties>({
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
	...
	/** Request for AddRoles to allow Service Producers to add roles in the shared VPC host project for them to use. */
	export interface AddRolesRequestFormProperties {

		/** Required. The network that the consumer is using to connect with services. Must be in the form of projects/{project}/global/networks/{network} {project} is a project number, as in '12345' {network} is a network name. */
		consumerNetwork: FormControl<string | null | undefined>,
	}
	export function CreateAddRolesRequestFormGroup() {
		return new FormGroup<AddRolesRequestFormProperties>({
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface AddSubnetworkRequestFormProperties {
		...
		/** Optional. Defines the allowSubnetCidrRoutesOverlap field of the subnet, e.g. Available in alpha and beta according to [Compute API documentation](https://cloud.google.com/compute/docs/reference/rest/beta/subnetworks/insert) */
		allowSubnetCidrRoutesOverlap: FormControl<boolean | null | undefined>,

		/** Optional. The IAM permission check determines whether the consumer project has 'servicenetworking.services.use' permission or not. */
		checkServiceNetworkingUsePermission: FormControl<boolean | null | undefined>,

		/** Optional. Specifies a custom time bucket for Arcus subnetwork request idempotency. If two equivalent concurrent requests are made, Arcus will know to ignore the request if it has already been completed or is in progress. Only requests with matching compute_idempotency_window have guaranteed idempotency. Changing this time window between requests results in undefined behavior. Zero (or empty) value with custom_compute_idempotency_window=true specifies no idempotency (i.e. no request ID is provided to Arcus). Maximum value of 14 days (enforced by Arcus limit). For more information on how to use, see: go/revisit-sn-idempotency-window */
		computeIdempotencyWindow: FormControl<string | null | undefined>,
		...
		/** Optional. The url of an Internal Range. Eg: `projects//locations/global/internalRanges/`. If specified, it means that the subnetwork cidr will be created using the combination of requested_address/ip_prefix_length. Note that the subnet cidr has to be within the cidr range of this Internal Range. */
		internalRange: FormControl<string | null | undefined>,
		...
		/** Optional. Enable outside allocation using public IP addresses. Any public IP range may be specified. If this field is provided, we will not use customer reserved ranges for this primary IP range. */
		outsideAllocationPublicIpRange: FormControl<string | null | undefined>,

		/** Optional. The private IPv6 google access type for the VMs in this subnet. For information about the access types that can be set using this field, see [subnetwork](https://cloud.google.com/compute/docs/reference/rest/v1/subnetworks) in the Compute API documentation. */
		privateIpv6GoogleAccess: FormControl<string | null | undefined>,
		...
		/** Optional. Specifies if Service Networking should use a custom time bucket for Arcus idempotency. If false, Service Networking uses a 300 second (5 minute) Arcus idempotency window. If true, Service Networking uses a custom idempotency window provided by the user in field compute_idempotency_window. For more information on how to use, see: go/revisit-sn-idempotency-window */
		useCustomComputeIdempotencyWindow: FormControl<boolean | null | undefined>,
	}
	export function CreateAddSubnetworkRequestFormGroup() {
		return new FormGroup<AddSubnetworkRequestFormProperties>({
			allowSubnetCidrRoutesOverlap: new FormControl<boolean | null | undefined>(undefined),
			checkServiceNetworkingUsePermission: new FormControl<boolean | null | undefined>(undefined),
			computeIdempotencyWindow: new FormControl<string | null | undefined>(undefined),
			consumer: new FormControl<string | null | undefined>(undefined),
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			internalRange: new FormControl<string | null | undefined>(undefined),
			ipPrefixLength: new FormControl<number | null | undefined>(undefined),
			outsideAllocationPublicIpRange: new FormControl<string | null | undefined>(undefined),
			privateIpv6GoogleAccess: new FormControl<string | null | undefined>(undefined),
			...
			useCustomComputeIdempotencyWindow: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	export interface SecondaryIpRangeSpecFormProperties {
	...
	export function CreateSecondaryIpRangeSpecFormGroup() {
		return new FormGroup<SecondaryIpRangeSpecFormProperties>({
			ipPrefixLength: new FormControl<number | null | undefined>(undefined),
			outsideAllocationPublicIpRange: new FormControl<string | null | undefined>(undefined),
	...
	/** Represents a consumer project. */
	export interface ConsumerProjectFormProperties {

		/** Required. Project number of the consumer that is launching the service instance. It can own the network that is peered with Google or, be a service project in an XPN where the host project has the network. */
		projectNum: FormControl<string | null | undefined>,
	}
	export function CreateConsumerProjectFormGroup() {
		return new FormGroup<ConsumerProjectFormProperties>({
			projectNum: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request to disable VPC service controls. */
	export interface DisableVpcServiceControlsRequestFormProperties {

		/** Required. The network that the consumer is using to connect with services. Must be in the form of projects/{project}/global/networks/{network} {project} is a project number, as in '12345' {network} is network name. */
		consumerNetwork: FormControl<string | null | undefined>,
	}
	export function CreateDisableVpcServiceControlsRequestFormGroup() {
		return new FormGroup<DisableVpcServiceControlsRequestFormProperties>({
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** * Represents a pair of private and peering DNS zone resources. * */
	export interface DnsZonePairFormProperties {
	}
	export function CreateDnsZonePairFormGroup() {
		return new FormGroup<DnsZonePairFormProperties>({
		});
	...
	/** Request to enable VPC service controls. */
	export interface EnableVpcServiceControlsRequestFormProperties {

		/** Required. The network that the consumer is using to connect with services. Must be in the form of projects/{project}/global/networks/{network} {project} is a project number, as in '12345' {network} is network name. */
		consumerNetwork: FormControl<string | null | undefined>,
	}
	export function CreateEnableVpcServiceControlsRequestFormGroup() {
		return new FormGroup<EnableVpcServiceControlsRequestFormProperties>({
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Represents managed DNS zones created in the shared Producer host and consumer projects. */
	export interface GetDnsZoneResponseFormProperties {
	}
	export function CreateGetDnsZoneResponseFormGroup() {
		return new FormGroup<GetDnsZoneResponseFormProperties>({
		});
	...
	/** Represents all DNS RecordSets associated with the producer network */
	export interface ListDnsRecordSetsResponseFormProperties {
	}
	export function CreateListDnsRecordSetsResponseFormGroup() {
		return new FormGroup<ListDnsRecordSetsResponseFormProperties>({
		});
	...
	/** Represents all DNS zones in the shared producer host project and the matching peering zones in the consumer project. */
	export interface ListDnsZonesResponseFormProperties {
	}
	export function CreateListDnsZonesResponseFormGroup() {
		return new FormGroup<ListDnsZonesResponseFormProperties>({
		});
	...
	/** Response to list peered DNS domains for a given connection. */
	export interface ListPeeredDnsDomainsResponseFormProperties {
	}
	export function CreateListPeeredDnsDomainsResponseFormGroup() {
		return new FormGroup<ListPeeredDnsDomainsResponseFormProperties>({
		});
	...
	/** Represents a range reservation. */
	export interface RangeReservationFormProperties {
	...
	export function CreateRangeReservationFormGroup() {
		return new FormGroup<RangeReservationFormProperties>({
			ipPrefixLength: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** Request to remove a record set from a private managed DNS zone in the shared producer host project. The name, type, ttl, and data values must all exactly match an existing record set in the specified zone. */
	export interface RemoveDnsRecordSetRequestFormProperties {
	...
	export function CreateRemoveDnsRecordSetRequestFormGroup() {
		return new FormGroup<RemoveDnsRecordSetRequestFormProperties>({
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
			zone: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request to remove a private managed DNS zone in the shared producer host project and a matching DNS peering zone in the consumer project. */
	export interface RemoveDnsZoneRequestFormProperties {
	...
	export function CreateRemoveDnsZoneRequestFormGroup() {
		return new FormGroup<RemoveDnsZoneRequestFormProperties>({
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request to update the configuration of a service networking connection including the import/export of custom routes and subnetwork routes with public IP. */
	export interface UpdateConsumerConfigRequestFormProperties {
	}
	export function CreateUpdateConsumerConfigRequestFormGroup() {
		return new FormGroup<UpdateConsumerConfigRequestFormProperties>({
		});
	...
	/** Request to update a record set from a private managed DNS zone in the shared producer host project. The name, type, ttl, and data values of the existing record set must all exactly match an existing record set in the specified zone. */
	export interface UpdateDnsRecordSetRequestFormProperties {
	...
	export function CreateUpdateDnsRecordSetRequestFormGroup() {
		return new FormGroup<UpdateDnsRecordSetRequestFormProperties>({
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
			zone: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface ValidateConsumerConfigRequestFormProperties {
		...
		/** The validations will be performed in the order listed in the ValidationError enum. The first failure will return. If a validation is not requested, then the next one will be performed. SERVICE_NETWORKING_NOT_ENABLED and NETWORK_NOT_PEERED checks are performed for all requests where validation is requested. NETWORK_NOT_FOUND and NETWORK_DISCONNECTED checks are done for requests that have validate_network set to true. */
		validateNetwork: FormControl<boolean | null | undefined>,
	}
	export function CreateValidateConsumerConfigRequestFormGroup() {
		return new FormGroup<ValidateConsumerConfigRequestFormProperties>({
			checkServiceNetworkingUsePermission: new FormControl<boolean | null | undefined>(undefined),
			consumerNetwork: new FormControl<string | null | undefined>(undefined),
			validateNetwork: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	export interface ValidateConsumerConfigResponse {
		...
		validationError?: ValidateConsumerConfigResponseValidationError | null;
	}
	export interface ValidateConsumerConfigResponseFormProperties {

		/** Indicates whether all the requested validations passed. */
		isValid: FormControl<boolean | null | undefined>,

		/** The first validation which failed. */
		validationError: FormControl<ValidateConsumerConfigResponseValidationError | null | undefined>,
	}
	export function CreateValidateConsumerConfigResponseFormGroup() {
		return new FormGroup<ValidateConsumerConfigResponseFormProperties>({
			isValid: new FormControl<boolean | null | undefined>(undefined),
			validationError: new FormControl<ValidateConsumerConfigResponseValidationError | null | undefined>(undefined),
		});

	}

	export enum ValidateConsumerConfigResponseValidationError { VALIDATION_ERROR_UNSPECIFIED = 'VALIDATION_ERROR_UNSPECIFIED', VALIDATION_NOT_REQUESTED = 'VALIDATION_NOT_REQUESTED', SERVICE_NETWORKING_NOT_ENABLED = 'SERVICE_NETWORKING_NOT_ENABLED', NETWORK_NOT_FOUND = 'NETWORK_NOT_FOUND', NETWORK_NOT_PEERED = 'NETWORK_NOT_PEERED', NETWORK_PEERING_DELETED = 'NETWORK_PEERING_DELETED', NETWORK_NOT_IN_CONSUMERS_PROJECT = 'NETWORK_NOT_IN_CONSUMERS_PROJECT', NETWORK_NOT_IN_CONSUMERS_HOST_PROJECT = 'NETWORK_NOT_IN_CONSUMERS_HOST_PROJECT', HOST_PROJECT_NOT_FOUND = 'HOST_PROJECT_NOT_FOUND', CONSUMER_PROJECT_NOT_SERVICE_PROJECT = 'CONSUMER_PROJECT_NOT_SERVICE_PROJECT', RANGES_EXHAUSTED = 'RANGES_EXHAUSTED', RANGES_NOT_RESERVED = 'RANGES_NOT_RESERVED', RANGES_DELETED_LATER = 'RANGES_DELETED_LATER', COMPUTE_API_NOT_ENABLED = 'COMPUTE_API_NOT_ENABLED', USE_PERMISSION_NOT_FOUND = 'USE_PERMISSION_NOT_FOUND' }
	...
	export class MyClient {
		 ...
		 */
		Servicenetworking_services_projects_global_networks_peeredDnsDomains_delete(name: string): Observable<Operation> {
		 ...
		 * @return {GetDnsZoneResponse} Successful response
		 */
		Servicenetworking_services_projects_global_networks_dnsZones_get(name: string, includeUsedIpRanges: boolean | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GetDnsZoneResponse> {
			return this.http.get<GetDnsZoneResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&includeUsedIpRanges=' + includeUsedIpRanges + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_connections_patch(name: string, force: boolean | null | undefined, updateMask: string | null | undefined, requestBody: Connection): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&force=' + force + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_connections_deleteConnection(name: string, requestBody: DeleteConnectionRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {VpcServiceControls} Successful response
		 */
		Servicenetworking_services_projects_global_networks_getVpcServiceControls(name: string): Observable<VpcServiceControls> {
			return this.http.get<VpcServiceControls>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/vpcServiceControls', {});
		}
		 ...
		 */
		Servicenetworking_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<Empty> {
		...
		Servicenetworking_services_connections_list(parent: string, network: string | null | undefined): Observable<ListConnectionsResponse> {
			return this.http.get<ListConnectionsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/connections&network=' + (network == null ? '' : encodeURIComponent(network)), {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_connections_create(parent: string, requestBody: Connection): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/connections', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_dnsRecordSets_add(parent: string, requestBody: AddDnsRecordSetRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsRecordSets:add', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {DnsRecordSet} Successful response
		 */
		Servicenetworking_services_dnsRecordSets_get(parent: string, consumerNetwork: string | null | undefined, domain: string | null | undefined, type: string | null | undefined, zone: string | null | undefined): Observable<DnsRecordSet> {
			return this.http.get<DnsRecordSet>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsRecordSets:get&consumerNetwork=' + (consumerNetwork == null ? '' : encodeURIComponent(consumerNetwork)) + '&domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&zone=' + (zone == null ? '' : encodeURIComponent(zone)), {});
		}
		 ...
		 * @return {ListDnsRecordSetsResponse} Successful response
		 */
		Servicenetworking_services_dnsRecordSets_list(parent: string, consumerNetwork: string | null | undefined, zone: string | null | undefined): Observable<ListDnsRecordSetsResponse> {
			return this.http.get<ListDnsRecordSetsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsRecordSets:list&consumerNetwork=' + (consumerNetwork == null ? '' : encodeURIComponent(consumerNetwork)) + '&zone=' + (zone == null ? '' : encodeURIComponent(zone)), {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_dnsRecordSets_remove(parent: string, requestBody: RemoveDnsRecordSetRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsRecordSets:remove', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_dnsRecordSets_update(parent: string, requestBody: UpdateDnsRecordSetRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsRecordSets:update', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_dnsZones_add(parent: string, requestBody: AddDnsZoneRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsZones:add', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ListDnsZonesResponse} Successful response
		 */
		Servicenetworking_services_projects_global_networks_dnsZones_list(parent: string): Observable<ListDnsZonesResponse> {
			return this.http.get<ListDnsZonesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsZones:list', {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_dnsZones_remove(parent: string, requestBody: RemoveDnsZoneRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dnsZones:remove', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ListPeeredDnsDomainsResponse} Successful response
		 */
		Servicenetworking_services_projects_global_networks_peeredDnsDomains_list(parent: string): Observable<ListPeeredDnsDomainsResponse> {
			return this.http.get<ListPeeredDnsDomainsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/peeredDnsDomains', {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_projects_global_networks_peeredDnsDomains_create(parent: string, requestBody: PeeredDnsDomain): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/peeredDnsDomains', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_roles_add(parent: string, requestBody: AddRolesRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/roles:add', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Servicenetworking_services_addSubnetwork(parent: string, requestBody: AddSubnetworkRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':addSubnetwork', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_disableVpcServiceControls(parent: string, requestBody: DisableVpcServiceControlsRequest): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':disableVpcServiceControls', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_enableVpcServiceControls(parent: string, requestBody: EnableVpcServiceControlsRequest): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':enableVpcServiceControls', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Servicenetworking_services_searchRange(parent: string, requestBody: SearchRangeRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':searchRange', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Servicenetworking_services_projects_global_networks_updateConsumerConfig(parent: string, requestBody: UpdateConsumerConfigRequest): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':updateConsumerConfig', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} parent Required. This is in a form services/{service} where {service} is the name of the private access management service. For example 'service-peering.example.com'.
		 * @return {ValidateConsumerConfigResponse} Successful response
		 */
		Servicenetworking_services_validate(parent: string, requestBody: ValidateConsumerConfigRequest): Observable<ValidateConsumerConfigResponse> {
			return this.http.post<ValidateConsumerConfigResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':validate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
