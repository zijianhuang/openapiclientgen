...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {RdcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Rdcer(requestBody: RdcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'rdcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {RegriiPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Regrii(requestBody: RegriiPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'regrii/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	...
	export interface RdcerPostBody {
		certificateParameters?: RdcerPostBodyCertificateParameters;
	...
	export interface RdcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<RdcerPostBodyFormat | null | undefined>,
	...
	export function CreateRdcerPostBodyFormGroup() {
		return new FormGroup<RdcerPostBodyFormProperties>({
			format: new FormControl<RdcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface RdcerPostBodyCertificateParameters {
		 ...
		 * Required
		 */
		final_doc_reg_no: string;
	}
	export interface RdcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		final_doc_reg_no: FormControl<string | null | undefined>,
	}
	export function CreateRdcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<RdcerPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			final_doc_reg_no: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface RegriiPostBodyFormProperties {
	...
	export function CreateRegriiPostBodyFormGroup() {
		return new FormGroup<RegriiPostBodyFormProperties>({
			format: new FormControl<RdcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface RegriiPostBodyCertificateParameters {
	...
	export interface RegriiPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		regno: FormControl<string | null | undefined>,

		/**
		 * SRO Name
		 * Required
		 */
		sro_id: FormControl<string | null | undefined>,

		/**
		 * Year
		 * Required
		 */
		yr: FormControl<string | null | undefined>,
	}
	export function CreateRegriiPostBodyCertificateParametersFormGroup() {
		return new FormGroup<RegriiPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			regno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			sro_id: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			yr: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
