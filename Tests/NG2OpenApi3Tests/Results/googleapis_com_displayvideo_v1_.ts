...
export namespace MyNS {
	...
	export enum AgeRangeAssignedTargetingOptionDetailsAgeRange { AGE_RANGE_UNSPECIFIED = 0, AGE_RANGE_18_24 = 1, AGE_RANGE_25_34 = 2, AGE_RANGE_35_44 = 3, AGE_RANGE_45_54 = 4, AGE_RANGE_55_64 = 5, AGE_RANGE_65_PLUS = 6, AGE_RANGE_UNKNOWN = 7 }
	...
	export interface DigitalContentLabelAssignedTargetingOptionDetails {
		...
		contentRatingTier?: DigitalContentLabelAssignedTargetingOptionDetailsContentRatingTier | null;
	...
	export interface DigitalContentLabelAssignedTargetingOptionDetailsFormProperties {
		...
		/** Output only. The display name of the digital content label rating tier. */
		contentRatingTier: FormControl<DigitalContentLabelAssignedTargetingOptionDetailsContentRatingTier | null | undefined>,

		/** Required. ID of the digital content label to be EXCLUDED. */
		excludedTargetingOptionId: FormControl<string | null | undefined>,
	}
	export function CreateDigitalContentLabelAssignedTargetingOptionDetailsFormGroup() {
		return new FormGroup<DigitalContentLabelAssignedTargetingOptionDetailsFormProperties>({
			contentRatingTier: new FormControl<DigitalContentLabelAssignedTargetingOptionDetailsContentRatingTier | null | undefined>(undefined),
			excludedTargetingOptionId: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum DigitalContentLabelAssignedTargetingOptionDetailsContentRatingTier { CONTENT_RATING_TIER_UNSPECIFIED = 0, CONTENT_RATING_TIER_UNRATED = 1, CONTENT_RATING_TIER_GENERAL = 2, CONTENT_RATING_TIER_PARENTAL_GUIDANCE = 3, CONTENT_RATING_TIER_TEENS = 4, CONTENT_RATING_TIER_MATURE = 5 }
	...
	export interface ProximityLocationListAssignedTargetingOptionDetails {
		...
		proximityRadiusRange?: ProximityLocationListAssignedTargetingOptionDetailsProximityRadiusRange | null;
	}
	...
	export interface ProximityLocationListAssignedTargetingOptionDetailsFormProperties {
		...
		/** Required. Radius range for proximity location list. This represents the size of the area around a chosen location that will be targeted. `All` proximity location targeting under a single resource must have the same radius range value. Set this value to match any existing targeting. If updated, this field will change the radius range for all proximity targeting under the resource. */
		proximityRadiusRange: FormControl<ProximityLocationListAssignedTargetingOptionDetailsProximityRadiusRange | null | undefined>,
	}
	export function CreateProximityLocationListAssignedTargetingOptionDetailsFormGroup() {
		return new FormGroup<ProximityLocationListAssignedTargetingOptionDetailsFormProperties>({
			...
			proximityRadiusRange: new FormControl<ProximityLocationListAssignedTargetingOptionDetailsProximityRadiusRange | null | undefined>(undefined),
		});

	}

	export enum ProximityLocationListAssignedTargetingOptionDetailsProximityRadiusRange { PROXIMITY_RADIUS_RANGE_UNSPECIFIED = 0, PROXIMITY_RADIUS_RANGE_SMALL = 1, PROXIMITY_RADIUS_RANGE_MEDIUM = 2, PROXIMITY_RADIUS_RANGE_LARGE = 3 }
	...
	export interface SensitiveCategoryAssignedTargetingOptionDetails {
		...
		sensitiveCategory?: SensitiveCategoryAssignedTargetingOptionDetailsSensitiveCategory | null;
	}
	...
	export interface SensitiveCategoryAssignedTargetingOptionDetailsFormProperties {
		...
		/** Output only. An enum for the DV360 Sensitive category content classifier. */
		sensitiveCategory: FormControl<SensitiveCategoryAssignedTargetingOptionDetailsSensitiveCategory | null | undefined>,
	}
	export function CreateSensitiveCategoryAssignedTargetingOptionDetailsFormGroup() {
		return new FormGroup<SensitiveCategoryAssignedTargetingOptionDetailsFormProperties>({
			excludedTargetingOptionId: new FormControl<string | null | undefined>(undefined),
			sensitiveCategory: new FormControl<SensitiveCategoryAssignedTargetingOptionDetailsSensitiveCategory | null | undefined>(undefined),
		});

	}

	export enum SensitiveCategoryAssignedTargetingOptionDetailsSensitiveCategory { SENSITIVE_CATEGORY_UNSPECIFIED = 0, SENSITIVE_CATEGORY_ADULT = 1, SENSITIVE_CATEGORY_DEROGATORY = 2, SENSITIVE_CATEGORY_DOWNLOADS_SHARING = 3, SENSITIVE_CATEGORY_WEAPONS = 4, SENSITIVE_CATEGORY_GAMBLING = 5, SENSITIVE_CATEGORY_VIOLENCE = 6, SENSITIVE_CATEGORY_SUGGESTIVE = 7, SENSITIVE_CATEGORY_PROFANITY = 8, SENSITIVE_CATEGORY_ALCOHOL = 9, SENSITIVE_CATEGORY_DRUGS = 10, SENSITIVE_CATEGORY_TOBACCO = 11, SENSITIVE_CATEGORY_POLITICS = 12, SENSITIVE_CATEGORY_RELIGION = 13, SENSITIVE_CATEGORY_TRAGEDY = 14, SENSITIVE_CATEGORY_TRANSPORTATION_ACCIDENTS = 15, SENSITIVE_CATEGORY_SENSITIVE_SOCIAL_ISSUES = 16, SENSITIVE_CATEGORY_SHOCKING = 17 }
	...
	export interface BulkEditLineItemAssignedTargetingOptionsRequest {
	...
	/** Request message for BulkEditLineItemAssignedTargetingOptions. */
	export interface BulkEditLineItemAssignedTargetingOptionsRequestFormProperties {
	}
	export function CreateBulkEditLineItemAssignedTargetingOptionsRequestFormGroup() {
		return new FormGroup<BulkEditLineItemAssignedTargetingOptionsRequestFormProperties>({
		});

	}

	export interface BulkEditLineItemAssignedTargetingOptionsResponse {

		/** The list of assigned targeting options that have been successfully created. This list will be absent if empty. */
		createdAssignedTargetingOptions?: Array<AssignedTargetingOption>;
	}
	export interface BulkEditLineItemAssignedTargetingOptionsResponseFormProperties {
	}
	export function CreateBulkEditLineItemAssignedTargetingOptionsResponseFormGroup() {
		return new FormGroup<BulkEditLineItemAssignedTargetingOptionsResponseFormProperties>({
		});
	...
	export interface BulkListLineItemAssignedTargetingOptionsResponse {
	...
	export interface BulkListLineItemAssignedTargetingOptionsResponseFormProperties {

		/** A token identifying the next page of results. This value should be specified as the pageToken in a subsequent BulkListLineItemAssignedTargetingOptionsRequest to fetch the next page of results. This token will be absent if there are no more assigned_targeting_options to return. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateBulkListLineItemAssignedTargetingOptionsResponseFormGroup() {
		return new FormGroup<BulkListLineItemAssignedTargetingOptionsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface CampaignBudget {
		...
		budgetUnit?: CampaignBudgetBudgetUnit | null;
	...
	export interface CampaignBudgetFormProperties {
		...
		/** Required. Immutable. Specifies whether the budget is measured in currency or impressions. */
		budgetUnit: FormControl<CampaignBudgetBudgetUnit | null | undefined>,
	...
	export function CreateCampaignBudgetFormGroup() {
		return new FormGroup<CampaignBudgetFormProperties>({
			...
			budgetUnit: new FormControl<CampaignBudgetBudgetUnit | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			externalBudgetId: new FormControl<string | null | undefined>(undefined),
	...
	export enum CampaignBudgetBudgetUnit { BUDGET_UNIT_UNSPECIFIED = 0, BUDGET_UNIT_CURRENCY = 1, BUDGET_UNIT_IMPRESSIONS = 2 }
	...
	export interface ExchangeReviewStatus {
		...
		exchange?: ExchangeReviewStatusExchange | null;
	...
	export interface ExchangeReviewStatusFormProperties {
		...
		/** The exchange reviewing the creative. */
		exchange: FormControl<ExchangeReviewStatusExchange | null | undefined>,
	...
	export interface CustomBiddingAlgorithm {
		...
		customBiddingAlgorithmState?: CustomBiddingAlgorithmCustomBiddingAlgorithmState | null;
		...
		modelReadiness?: Array<CustomBiddingModelReadinessState>;
	...
	export interface CustomBiddingAlgorithmFormProperties {
		...
		/** Output only. The status of custom bidding algorithm. */
		customBiddingAlgorithmState: FormControl<CustomBiddingAlgorithmCustomBiddingAlgorithmState | null | undefined>,
	...
	export function CreateCustomBiddingAlgorithmFormGroup() {
		return new FormGroup<CustomBiddingAlgorithmFormProperties>({
			advertiserId: new FormControl<string | null | undefined>(undefined),
			customBiddingAlgorithmId: new FormControl<string | null | undefined>(undefined),
			customBiddingAlgorithmState: new FormControl<CustomBiddingAlgorithmCustomBiddingAlgorithmState | null | undefined>(undefined),
	...
	export enum CustomBiddingAlgorithmCustomBiddingAlgorithmState { STATE_UNSPECIFIED = 0, ENABLED = 1, DORMANT = 2, SUSPENDED = 3 }
	...
	export interface CustomBiddingModelReadinessState {

		/** The unique ID of the relevant advertiser. */
		advertiserId?: string | null;

		/** The readiness state of custom bidding model. */
		readinessState?: CustomBiddingModelReadinessStateReadinessState | null;
	}

	/** The custom bidding algorithm model readiness state for a single shared advertiser. */
	export interface CustomBiddingModelReadinessStateFormProperties {

		/** The unique ID of the relevant advertiser. */
		advertiserId: FormControl<string | null | undefined>,

		/** The readiness state of custom bidding model. */
		readinessState: FormControl<CustomBiddingModelReadinessStateReadinessState | null | undefined>,
	}
	export function CreateCustomBiddingModelReadinessStateFormGroup() {
		return new FormGroup<CustomBiddingModelReadinessStateFormProperties>({
			advertiserId: new FormControl<string | null | undefined>(undefined),
			readinessState: new FormControl<CustomBiddingModelReadinessStateReadinessState | null | undefined>(undefined),
		});

	}

	export enum CustomBiddingModelReadinessStateReadinessState { READINESS_STATE_UNSPECIFIED = 0, READINESS_STATE_ACTIVE = 1, READINESS_STATE_INSUFFICIENT_DATA = 2, READINESS_STATE_TRAINING = 3, READINESS_STATE_NO_VALID_SCRIPT = 4 }
	...
	export interface GenerateDefaultLineItemRequest {
		...
		lineItemType?: GenerateDefaultLineItemRequestLineItemType | null;
	...
	export interface GenerateDefaultLineItemRequestFormProperties {
		...
		/** Required. The type of the line item. */
		lineItemType: FormControl<GenerateDefaultLineItemRequestLineItemType | null | undefined>,
	}
	export function CreateGenerateDefaultLineItemRequestFormGroup() {
		return new FormGroup<GenerateDefaultLineItemRequestFormProperties>({
			...
			lineItemType: new FormControl<GenerateDefaultLineItemRequestLineItemType | null | undefined>(undefined),
		});

	}

	export enum GenerateDefaultLineItemRequestLineItemType { LINE_ITEM_TYPE_UNSPECIFIED = 0, LINE_ITEM_TYPE_DISPLAY_DEFAULT = 1, LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INSTALL = 2, LINE_ITEM_TYPE_VIDEO_DEFAULT = 3, LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INSTALL = 4, LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INVENTORY = 5, LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INVENTORY = 6, LINE_ITEM_TYPE_AUDIO_DEFAULT = 7, LINE_ITEM_TYPE_VIDEO_OVER_THE_TOP = 8, LINE_ITEM_TYPE_DISPLAY_OUT_OF_HOME = 9, LINE_ITEM_TYPE_VIDEO_OUT_OF_HOME = 10 }
	...
	export interface InsertionOrder {
		...
		reservationType?: InsertionOrderReservationType | null;
	...
	export interface InsertionOrderFormProperties {
		...
		/** Output only. The reservation type of the insertion order. */
		reservationType: FormControl<InsertionOrderReservationType | null | undefined>,
	...
	export function CreateInsertionOrderFormGroup() {
		return new FormGroup<InsertionOrderFormProperties>({
			...
			name: new FormControl<string | null | undefined>(undefined),
			reservationType: new FormControl<InsertionOrderReservationType | null | undefined>(undefined),
			updateTime: new FormControl<string | null | undefined>(undefined),
		});
	...
	export enum InsertionOrderReservationType { RESERVATION_TYPE_UNSPECIFIED = 0, RESERVATION_TYPE_NOT_GUARANTEED = 1, RESERVATION_TYPE_PROGRAMMATIC_GUARANTEED = 2, RESERVATION_TYPE_TAG_GUARANTEED = 3 }
	...
	export enum LineItemFlightFlightDateType { LINE_ITEM_FLIGHT_DATE_TYPE_UNSPECIFIED = 0, LINE_ITEM_FLIGHT_DATE_TYPE_INHERITED = 1, LINE_ITEM_FLIGHT_DATE_TYPE_CUSTOM = 2, LINE_ITEM_FLIGHT_DATE_TYPE_TRIGGER = 3 }
	...
	export class MyClient {
		...
		Displayvideo_advertisers_list(filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListAdvertisersResponse> {
			return this.http.get<ListAdvertisersResponse>(this.baseUri + 'v1/advertisers?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_advertisers_create(requestBody: Advertiser): Observable<Advertiser> {
			return this.http.post<Advertiser>(this.baseUri + 'v1/advertisers', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_delete(advertiserId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_advertisers_get(advertiserId: string): Observable<Advertiser> {
			return this.http.get<Advertiser>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_advertisers_patch(advertiserId: string, updateMask: string | null | undefined, requestBody: Advertiser): Observable<Advertiser> {
			return this.http.patch<Advertiser>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_campaigns_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCampaignsResponse> {
			return this.http.get<ListCampaignsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_campaigns_create(advertiserId: string, requestBody: Campaign): Observable<Campaign> {
			return this.http.post<Campaign>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_campaigns_delete(advertiserId: string, campaignId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns/' + (campaignId == null ? '' : encodeURIComponent(campaignId)), {});
		}
		...
		Displayvideo_advertisers_campaigns_get(advertiserId: string, campaignId: string): Observable<Campaign> {
			return this.http.get<Campaign>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns/' + (campaignId == null ? '' : encodeURIComponent(campaignId)), {});
		}
		 ...
		 * Get v1/advertisers/{advertiserId}/campaigns/{campaignId}:bulkListCampaignAssignedTargetingOptions
		 * @param {string} advertiserId Required. The ID of the advertiser the campaign belongs to.
		 * @param {string} campaignId Required. The ID of the campaign to list assigned targeting options for.
		 ...
		 */
		Displayvideo_advertisers_campaigns_bulkListCampaignAssignedTargetingOptions(advertiserId: string, campaignId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<BulkListCampaignAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListCampaignAssignedTargetingOptionsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/campaigns/' + (campaignId == null ? '' : encodeURIComponent(campaignId)) + ':bulkListCampaignAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_channels_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListChannelsResponse> {
			return this.http.get<ListChannelsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_advertisers_channels_create(advertiserId: string, partnerId: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.post<Channel>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_channels_patch(advertiserId: string, channelId: string, partnerId: string | null | undefined, updateMask: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.patch<Channel>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_channels_sites_list(advertiserId: string, channelId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListSitesResponse> {
			return this.http.get<ListSitesResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_advertisers_channels_sites_delete(advertiserId: string, channelId: string, urlOrAppId: string, partnerId: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites/' + (urlOrAppId == null ? '' : encodeURIComponent(urlOrAppId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_advertisers_channels_sites_bulkEdit(advertiserId: string, channelId: string, requestBody: BulkEditSitesRequest): Observable<BulkEditSitesResponse> {
			return this.http.post<BulkEditSitesResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites:bulkEdit', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_channels_sites_replace(advertiserId: string, channelId: string, requestBody: ReplaceSitesRequest): Observable<ReplaceSitesResponse> {
			return this.http.post<ReplaceSitesResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites:replace', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_creatives_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCreativesResponse> {
			return this.http.get<ListCreativesResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_creatives_create(advertiserId: string, requestBody: Creative): Observable<Creative> {
			return this.http.post<Creative>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_creatives_delete(advertiserId: string, creativeId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives/' + (creativeId == null ? '' : encodeURIComponent(creativeId)), {});
		}
		...
		Displayvideo_advertisers_creatives_get(advertiserId: string, creativeId: string): Observable<Creative> {
			return this.http.get<Creative>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives/' + (creativeId == null ? '' : encodeURIComponent(creativeId)), {});
		}
		...
		Displayvideo_advertisers_creatives_patch(advertiserId: string, creativeId: string, updateMask: string | null | undefined, requestBody: Creative): Observable<Creative> {
			return this.http.patch<Creative>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/creatives/' + (creativeId == null ? '' : encodeURIComponent(creativeId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_insertionOrders_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInsertionOrdersResponse> {
			return this.http.get<ListInsertionOrdersResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_insertionOrders_create(advertiserId: string, requestBody: InsertionOrder): Observable<InsertionOrder> {
			return this.http.post<InsertionOrder>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_insertionOrders_delete(advertiserId: string, insertionOrderId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)), {});
		}
		...
		Displayvideo_advertisers_insertionOrders_get(advertiserId: string, insertionOrderId: string): Observable<InsertionOrder> {
			return this.http.get<InsertionOrder>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)), {});
		}
		...
		Displayvideo_advertisers_insertionOrders_patch(advertiserId: string, insertionOrderId: string, updateMask: string | null | undefined, requestBody: InsertionOrder): Observable<InsertionOrder> {
			return this.http.patch<InsertionOrder>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_insertionOrders_targetingTypes_assignedTargetingOptions_list(advertiserId: string, insertionOrderId: string, targetingType: AssignedTargetingOptionTargetingType, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInsertionOrderAssignedTargetingOptionsResponse> {
			return this.http.get<ListInsertionOrderAssignedTargetingOptionsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * Get v1/advertisers/{advertiserId}/insertionOrders/{insertionOrderId}:bulkListInsertionOrderAssignedTargetingOptions
		 * @param {string} advertiserId Required. The ID of the advertiser the insertion order belongs to.
		 * @param {string} insertionOrderId Required. The ID of the insertion order to list assigned targeting options for.
		 ...
		 */
		Displayvideo_advertisers_insertionOrders_bulkListInsertionOrderAssignedTargetingOptions(advertiserId: string, insertionOrderId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<BulkListInsertionOrderAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListInsertionOrderAssignedTargetingOptionsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/insertionOrders/' + (insertionOrderId == null ? '' : encodeURIComponent(insertionOrderId)) + ':bulkListInsertionOrderAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_invoices_list(advertiserId: string, issueMonth: string | null | undefined, loiSapinInvoiceType: Displayvideo_advertisers_invoices_listLoiSapinInvoiceType | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInvoicesResponse> {
			return this.http.get<ListInvoicesResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/invoices&issueMonth=' + (issueMonth == null ? '' : encodeURIComponent(issueMonth)) + '&loiSapinInvoiceType=' + loiSapinInvoiceType + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_invoices_lookupInvoiceCurrency(advertiserId: string, invoiceMonth: string | null | undefined): Observable<LookupInvoiceCurrencyResponse> {
			return this.http.get<LookupInvoiceCurrencyResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/invoices:lookupInvoiceCurrency&invoiceMonth=' + (invoiceMonth == null ? '' : encodeURIComponent(invoiceMonth)), {});
		}
		...
		Displayvideo_advertisers_lineItems_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLineItemsResponse> {
			return this.http.get<ListLineItemsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_lineItems_create(advertiserId: string, requestBody: LineItem): Observable<LineItem> {
			return this.http.post<LineItem>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_lineItems_delete(advertiserId: string, lineItemId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)), {});
		}
		...
		Displayvideo_advertisers_lineItems_get(advertiserId: string, lineItemId: string): Observable<LineItem> {
			return this.http.get<LineItem>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)), {});
		}
		...
		Displayvideo_advertisers_lineItems_patch(advertiserId: string, lineItemId: string, updateMask: string | null | undefined, requestBody: LineItem): Observable<LineItem> {
			return this.http.patch<LineItem>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_lineItems_targetingTypes_assignedTargetingOptions_list(advertiserId: string, lineItemId: string, targetingType: AssignedTargetingOptionTargetingType, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLineItemAssignedTargetingOptionsResponse> {
			return this.http.get<ListLineItemAssignedTargetingOptionsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_lineItems_targetingTypes_assignedTargetingOptions_delete(advertiserId: string, lineItemId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		 ...
		 * Post v1/advertisers/{advertiserId}/lineItems/{lineItemId}:bulkEditLineItemAssignedTargetingOptions
		 * @param {string} advertiserId Required. The ID of the advertiser the line item belongs to.
		 * @param {string} lineItemId Required. The ID of the line item the assigned targeting option will belong to.
		 * @return {BulkEditLineItemAssignedTargetingOptionsResponse} Successful response
		 */
		Displayvideo_advertisers_lineItems_bulkEditLineItemAssignedTargetingOptions(advertiserId: string, lineItemId: string, requestBody: BulkEditLineItemAssignedTargetingOptionsRequest): Observable<BulkEditLineItemAssignedTargetingOptionsResponse> {
			return this.http.post<BulkEditLineItemAssignedTargetingOptionsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + ':bulkEditLineItemAssignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists assigned targeting options of a line item across targeting types.
		 * Get v1/advertisers/{advertiserId}/lineItems/{lineItemId}:bulkListLineItemAssignedTargetingOptions
		 * @param {string} advertiserId Required. The ID of the advertiser the line item belongs to.
		 * @param {string} lineItemId Required. The ID of the line item to list assigned targeting options for.
		 * @param {string} filter Allows filtering by assigned targeting option fields. Supported syntax: * Filter expressions are made up of one or more restrictions. * Restrictions can be combined by the logical operator `OR`. * A restriction has the form of `{field} {operator} {value}`. * All fields must use the `EQUALS (=)` operator. Supported fields: * `targetingType` * `inheritance` Examples: * `AssignedTargetingOption` resources of targeting type `TARGETING_TYPE_PROXIMITY_LOCATION_LIST` or `TARGETING_TYPE_CHANNEL`: `targetingType="TARGETING_TYPE_PROXIMITY_LOCATION_LIST" OR targetingType="TARGETING_TYPE_CHANNEL"` * `AssignedTargetingOption` resources with inheritance status of `NOT_INHERITED` or `INHERITED_FROM_PARTNER`: `inheritance="NOT_INHERITED" OR inheritance="INHERITED_FROM_PARTNER"` The length of this field should be no more than 500 characters. Reference our [filter `LIST` requests](/display-video/api/guides/how-tos/filters) guide for more information.
		 * @param {string} orderBy Field by which to sort the list. Acceptable values are: * `targetingType` (default) The default sorting order is ascending. To specify descending order for a field, a suffix "desc" should be added to the field name. Example: `targetingType desc`.
		 ...
		 * @return {BulkListLineItemAssignedTargetingOptionsResponse} Successful response
		 */
		Displayvideo_advertisers_lineItems_bulkListLineItemAssignedTargetingOptions(advertiserId: string, lineItemId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<BulkListLineItemAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListLineItemAssignedTargetingOptionsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems/' + (lineItemId == null ? '' : encodeURIComponent(lineItemId)) + ':bulkListLineItemAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_lineItems_generateDefault(advertiserId: string, requestBody: GenerateDefaultLineItemRequest): Observable<LineItem> {
			return this.http.post<LineItem>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/lineItems:generateDefault', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_locationLists_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationListsResponse> {
			return this.http.get<ListLocationListsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/locationLists&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_locationLists_create(advertiserId: string, requestBody: LocationList): Observable<LocationList> {
			return this.http.post<LocationList>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/locationLists', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_locationLists_assignedLocations_create(advertiserId: string, locationListId: string, requestBody: AssignedLocation): Observable<AssignedLocation> {
			return this.http.post<AssignedLocation>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/locationLists/' + (locationListId == null ? '' : encodeURIComponent(locationListId)) + '/assignedLocations', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_locationLists_assignedLocations_delete(advertiserId: string, locationListId: string, assignedLocationId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/locationLists/' + (locationListId == null ? '' : encodeURIComponent(locationListId)) + '/assignedLocations/' + (assignedLocationId == null ? '' : encodeURIComponent(assignedLocationId)), {});
		}
		...
		Displayvideo_advertisers_manualTriggers_list(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListManualTriggersResponse> {
			return this.http.get<ListManualTriggersResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_manualTriggers_create(advertiserId: string, requestBody: ManualTrigger): Observable<ManualTrigger> {
			return this.http.post<ManualTrigger>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_manualTriggers_get(advertiserId: string, triggerId: string): Observable<ManualTrigger> {
			return this.http.get<ManualTrigger>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers/' + (triggerId == null ? '' : encodeURIComponent(triggerId)), {});
		}
		...
		Displayvideo_advertisers_manualTriggers_patch(advertiserId: string, triggerId: string, updateMask: string | null | undefined, requestBody: ManualTrigger): Observable<ManualTrigger> {
			return this.http.patch<ManualTrigger>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers/' + (triggerId == null ? '' : encodeURIComponent(triggerId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Post v1/advertisers/{advertiserId}/manualTriggers/{triggerId}:activate
		...
		Displayvideo_advertisers_manualTriggers_activate(advertiserId: string, triggerId: string, requestBody: ActivateManualTriggerRequest): Observable<ManualTrigger> {
			return this.http.post<ManualTrigger>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers/' + (triggerId == null ? '' : encodeURIComponent(triggerId)) + ':activate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Post v1/advertisers/{advertiserId}/manualTriggers/{triggerId}:deactivate
		 * @param {string} advertiserId Required. The ID of the advertiser that the manual trigger belongs.
		...
		Displayvideo_advertisers_manualTriggers_deactivate(advertiserId: string, triggerId: string, requestBody: DeactivateManualTriggerRequest): Observable<ManualTrigger> {
			return this.http.post<ManualTrigger>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/manualTriggers/' + (triggerId == null ? '' : encodeURIComponent(triggerId)) + ':deactivate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_list(advertiserId: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListNegativeKeywordListsResponse> {
			return this.http.get<ListNegativeKeywordListsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_create(advertiserId: string, requestBody: NegativeKeywordList): Observable<NegativeKeywordList> {
			return this.http.post<NegativeKeywordList>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_patch(advertiserId: string, negativeKeywordListId: string, updateMask: string | null | undefined, requestBody: NegativeKeywordList): Observable<NegativeKeywordList> {
			return this.http.patch<NegativeKeywordList>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_list(advertiserId: string, negativeKeywordListId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListNegativeKeywordsResponse> {
			return this.http.get<ListNegativeKeywordsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '/negativeKeywords&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_delete(advertiserId: string, negativeKeywordListId: string, keywordValue: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '/negativeKeywords/' + (keywordValue == null ? '' : encodeURIComponent(keywordValue)), {});
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_bulkEdit(advertiserId: string, negativeKeywordListId: string, requestBody: BulkEditNegativeKeywordsRequest): Observable<BulkEditNegativeKeywordsResponse> {
			return this.http.post<BulkEditNegativeKeywordsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '/negativeKeywords:bulkEdit', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_negativeKeywordLists_negativeKeywords_replace(advertiserId: string, negativeKeywordListId: string, requestBody: ReplaceNegativeKeywordsRequest): Observable<ReplaceNegativeKeywordsResponse> {
			return this.http.post<ReplaceNegativeKeywordsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/negativeKeywordLists/' + (negativeKeywordListId == null ? '' : encodeURIComponent(negativeKeywordListId)) + '/negativeKeywords:replace', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_create(advertiserId: string, targetingType: AssignedTargetingOptionTargetingType, requestBody: AssignedTargetingOption): Observable<AssignedTargetingOption> {
			return this.http.post<AssignedTargetingOption>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_delete(advertiserId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		...
		Displayvideo_advertisers_targetingTypes_assignedTargetingOptions_get(advertiserId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<AssignedTargetingOption> {
			return this.http.get<AssignedTargetingOption>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}

		/**
		 * Audits an advertiser. Returns the counts of used entities per resource type under the advertiser provided. Used entities count towards their respective resource limit. See https://support.google.com/displayvideo/answer/6071450.
		 * Get v1/advertisers/{advertiserId}:audit
		...
		Displayvideo_advertisers_audit(advertiserId: string, readMask: string | null | undefined): Observable<AuditAdvertiserResponse> {
			return this.http.get<AuditAdvertiserResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + ':audit&readMask=' + (readMask == null ? '' : encodeURIComponent(readMask)), {});
		}
		 ...
		 * Post v1/advertisers/{advertiserId}:bulkEditAdvertiserAssignedTargetingOptions
		 * @param {string} advertiserId Required. The ID of the advertiser.
		 * @return {BulkEditAdvertiserAssignedTargetingOptionsResponse} Successful response
		 */
		Displayvideo_advertisers_bulkEditAdvertiserAssignedTargetingOptions(advertiserId: string, requestBody: BulkEditAdvertiserAssignedTargetingOptionsRequest): Observable<BulkEditAdvertiserAssignedTargetingOptionsResponse> {
			return this.http.post<BulkEditAdvertiserAssignedTargetingOptionsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + ':bulkEditAdvertiserAssignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists assigned targeting options of an advertiser across targeting types.
		 * Get v1/advertisers/{advertiserId}:bulkListAdvertiserAssignedTargetingOptions
		 * @param {string} advertiserId Required. The ID of the advertiser the line item belongs to.
		 ...
		 */
		Displayvideo_advertisers_bulkListAdvertiserAssignedTargetingOptions(advertiserId: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<BulkListAdvertiserAssignedTargetingOptionsResponse> {
			return this.http.get<BulkListAdvertiserAssignedTargetingOptionsResponse>(this.baseUri + 'v1/advertisers/' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + ':bulkListAdvertiserAssignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_combinedAudiences_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListCombinedAudiencesResponse> {
			return this.http.get<ListCombinedAudiencesResponse>(this.baseUri + 'v1/combinedAudiences?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_combinedAudiences_get(combinedAudienceId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<CombinedAudience> {
			return this.http.get<CombinedAudience>(this.baseUri + 'v1/combinedAudiences/' + (combinedAudienceId == null ? '' : encodeURIComponent(combinedAudienceId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_customBiddingAlgorithms_create(requestBody: CustomBiddingAlgorithm): Observable<CustomBiddingAlgorithm> {
			return this.http.post<CustomBiddingAlgorithm>(this.baseUri + 'v1/customBiddingAlgorithms', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_customBiddingAlgorithms_get(customBiddingAlgorithmId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<CustomBiddingAlgorithm> {
			return this.http.get<CustomBiddingAlgorithm>(this.baseUri + 'v1/customBiddingAlgorithms/' + (customBiddingAlgorithmId == null ? '' : encodeURIComponent(customBiddingAlgorithmId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}

		/**
		 * Updates an existing custom bidding algorithm. Returns the updated custom bidding algorithm if successful.
		 * Patch v1/customBiddingAlgorithms/{customBiddingAlgorithmId}
		...
		Displayvideo_customBiddingAlgorithms_patch(customBiddingAlgorithmId: string, updateMask: string | null | undefined, requestBody: CustomBiddingAlgorithm): Observable<CustomBiddingAlgorithm> {
			return this.http.patch<CustomBiddingAlgorithm>(this.baseUri + 'v1/customBiddingAlgorithms/' + (customBiddingAlgorithmId == null ? '' : encodeURIComponent(customBiddingAlgorithmId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists custom bidding scripts that belong to the given algorithm. The order is defined by the order_by parameter.
		 * Get v1/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts
		 ...
		 * Get v1/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts/{customBiddingScriptId}
		 * @param {string} customBiddingAlgorithmId Required. The ID of the custom bidding algorithm owns the script.
		 ...
		 * Get v1/customBiddingAlgorithms/{customBiddingAlgorithmId}:uploadScript
		 * @param {string} customBiddingAlgorithmId Required. The ID of the custom bidding algorithm owns the script.
		 * @param {string} advertiserId The ID of the advertiser that owns the parent custom bidding algorithm.
		 * @param {string} partnerId The ID of the partner that owns the parent custom bidding algorithm. Only this partner will have write access to this custom bidding script.
		...
		Displayvideo_customBiddingAlgorithms_uploadScript(customBiddingAlgorithmId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<CustomBiddingScriptRef> {
			return this.http.get<CustomBiddingScriptRef>(this.baseUri + 'v1/customBiddingAlgorithms/' + (customBiddingAlgorithmId == null ? '' : encodeURIComponent(customBiddingAlgorithmId)) + ':uploadScript&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_customLists_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCustomListsResponse> {
			return this.http.get<ListCustomListsResponse>(this.baseUri + 'v1/customLists?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_customLists_get(customListId: string, advertiserId: string | null | undefined): Observable<CustomList> {
			return this.http.get<CustomList>(this.baseUri + 'v1/customLists/' + (customListId == null ? '' : encodeURIComponent(customListId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_firstAndThirdPartyAudiences_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListFirstAndThirdPartyAudiencesResponse> {
			return this.http.get<ListFirstAndThirdPartyAudiencesResponse>(this.baseUri + 'v1/firstAndThirdPartyAudiences?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		 ...
		 * Post v1/firstAndThirdPartyAudiences
		...
		Displayvideo_firstAndThirdPartyAudiences_create(advertiserId: string | null | undefined, requestBody: FirstAndThirdPartyAudience): Observable<FirstAndThirdPartyAudience> {
			return this.http.post<FirstAndThirdPartyAudience>(this.baseUri + 'v1/firstAndThirdPartyAudiences?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_firstAndThirdPartyAudiences_get(firstAndThirdPartyAudienceId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<FirstAndThirdPartyAudience> {
			return this.http.get<FirstAndThirdPartyAudience>(this.baseUri + 'v1/firstAndThirdPartyAudiences/' + (firstAndThirdPartyAudienceId == null ? '' : encodeURIComponent(firstAndThirdPartyAudienceId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		 ...
		 * Patch v1/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}
		 ...
		 * Post v1/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}:editCustomerMatchMembers
		...
		Displayvideo_firstAndThirdPartyAudiences_editCustomerMatchMembers(firstAndThirdPartyAudienceId: string, requestBody: EditCustomerMatchMembersRequest): Observable<EditCustomerMatchMembersResponse> {
			return this.http.post<EditCustomerMatchMembersResponse>(this.baseUri + 'v1/firstAndThirdPartyAudiences/' + (firstAndThirdPartyAudienceId == null ? '' : encodeURIComponent(firstAndThirdPartyAudienceId)) + ':editCustomerMatchMembers', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_floodlightGroups_get(floodlightGroupId: string, partnerId: string | null | undefined): Observable<FloodlightGroup> {
			return this.http.get<FloodlightGroup>(this.baseUri + 'v1/floodlightGroups/' + (floodlightGroupId == null ? '' : encodeURIComponent(floodlightGroupId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_googleAudiences_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListGoogleAudiencesResponse> {
			return this.http.get<ListGoogleAudiencesResponse>(this.baseUri + 'v1/googleAudiences?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_googleAudiences_get(googleAudienceId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<GoogleAudience> {
			return this.http.get<GoogleAudience>(this.baseUri + 'v1/googleAudiences/' + (googleAudienceId == null ? '' : encodeURIComponent(googleAudienceId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}

		/**
		 * Lists guaranteed orders that are accessible to the current user. The order is defined by the order_by parameter. If a filter by entity_status is not specified, guaranteed orders with entity status `ENTITY_STATUS_ARCHIVED` will not be included in the results.
		 * Get v1/guaranteedOrders
		...
		Displayvideo_guaranteedOrders_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListGuaranteedOrdersResponse> {
			return this.http.get<ListGuaranteedOrdersResponse>(this.baseUri + 'v1/guaranteedOrders?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}

		/**
		 * Creates a new guaranteed order. Returns the newly created guaranteed order if successful.
		 * Post v1/guaranteedOrders
		...
		Displayvideo_guaranteedOrders_create(advertiserId: string | null | undefined, partnerId: string | null | undefined, requestBody: GuaranteedOrder): Observable<GuaranteedOrder> {
			return this.http.post<GuaranteedOrder>(this.baseUri + 'v1/guaranteedOrders?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Gets a guaranteed order.
		 * Get v1/guaranteedOrders/{guaranteedOrderId}
		...
		Displayvideo_guaranteedOrders_get(guaranteedOrderId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<GuaranteedOrder> {
			return this.http.get<GuaranteedOrder>(this.baseUri + 'v1/guaranteedOrders/' + (guaranteedOrderId == null ? '' : encodeURIComponent(guaranteedOrderId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}

		/**
		 * Updates an existing guaranteed order. Returns the updated guaranteed order if successful.
		 * Patch v1/guaranteedOrders/{guaranteedOrderId}
		...
		Displayvideo_guaranteedOrders_editGuaranteedOrderReadAccessors(guaranteedOrderId: string, requestBody: EditGuaranteedOrderReadAccessorsRequest): Observable<EditGuaranteedOrderReadAccessorsResponse> {
			return this.http.post<EditGuaranteedOrderReadAccessorsResponse>(this.baseUri + 'v1/guaranteedOrders/' + (guaranteedOrderId == null ? '' : encodeURIComponent(guaranteedOrderId)) + ':editGuaranteedOrderReadAccessors', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_inventorySourceGroups_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListInventorySourceGroupsResponse> {
			return this.http.get<ListInventorySourceGroupsResponse>(this.baseUri + 'v1/inventorySourceGroups?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_inventorySourceGroups_create(advertiserId: string | null | undefined, partnerId: string | null | undefined, requestBody: InventorySourceGroup): Observable<InventorySourceGroup> {
			return this.http.post<InventorySourceGroup>(this.baseUri + 'v1/inventorySourceGroups?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_inventorySourceGroups_delete(inventorySourceGroupId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/inventorySourceGroups/' + (inventorySourceGroupId == null ? '' : encodeURIComponent(inventorySourceGroupId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_inventorySourceGroups_get(inventorySourceGroupId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined): Observable<InventorySourceGroup> {
			return this.http.get<InventorySourceGroup>(this.baseUri + 'v1/inventorySourceGroups/' + (inventorySourceGroupId == null ? '' : encodeURIComponent(inventorySourceGroupId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_inventorySourceGroups_assignedInventorySources_bulkEdit(inventorySourceGroupId: string, requestBody: BulkEditAssignedInventorySourcesRequest): Observable<BulkEditAssignedInventorySourcesResponse> {
			return this.http.post<BulkEditAssignedInventorySourcesResponse>(this.baseUri + 'v1/inventorySourceGroups/' + (inventorySourceGroupId == null ? '' : encodeURIComponent(inventorySourceGroupId)) + '/assignedInventorySources:bulkEdit', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_inventorySources_list(advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, partnerId: string | null | undefined): Observable<ListInventorySourcesResponse> {
			return this.http.get<ListInventorySourcesResponse>(this.baseUri + 'v1/inventorySources?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}

		/**
		 * Creates a new inventory source. Returns the newly created inventory source if successful.
		 * Post v1/inventorySources
		 * @param {string} advertiserId The ID of the advertiser that the request is being made within.
		 * @param {string} partnerId The ID of the partner that the request is being made within.
		...
		Displayvideo_inventorySources_create(advertiserId: string | null | undefined, partnerId: string | null | undefined, requestBody: InventorySource): Observable<InventorySource> {
			return this.http.post<InventorySource>(this.baseUri + 'v1/inventorySources?advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_inventorySources_get(inventorySourceId: string, partnerId: string | null | undefined): Observable<InventorySource> {
			return this.http.get<InventorySource>(this.baseUri + 'v1/inventorySources/' + (inventorySourceId == null ? '' : encodeURIComponent(inventorySourceId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}

		/**
		 * Updates an existing inventory source. Returns the updated inventory source if successful.
		 * Patch v1/inventorySources/{inventorySourceId}
		...
		Displayvideo_inventorySources_patch(inventorySourceId: string, advertiserId: string | null | undefined, partnerId: string | null | undefined, updateMask: string | null | undefined, requestBody: InventorySource): Observable<InventorySource> {
			return this.http.patch<InventorySource>(this.baseUri + 'v1/inventorySources/' + (inventorySourceId == null ? '' : encodeURIComponent(inventorySourceId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&partnerId=' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Edits read/write accessors of an inventory source. Returns the updated read_write_accessors for the inventory source.
		 * Post v1/inventorySources/{inventorySourceId}:editInventorySourceReadWriteAccessors
		...
		Displayvideo_inventorySources_editInventorySourceReadWriteAccessors(inventorySourceId: string, requestBody: EditInventorySourceReadWriteAccessorsRequest): Observable<InventorySourceAccessors> {
			return this.http.post<InventorySourceAccessors>(this.baseUri + 'v1/inventorySources/' + (inventorySourceId == null ? '' : encodeURIComponent(inventorySourceId)) + ':editInventorySourceReadWriteAccessors', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_list(filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPartnersResponse> {
			return this.http.get<ListPartnersResponse>(this.baseUri + 'v1/partners?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_partners_get(partnerId: string): Observable<Partner> {
			return this.http.get<Partner>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)), {});
		}
		...
		Displayvideo_partners_channels_list(partnerId: string, advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListChannelsResponse> {
			return this.http.get<ListChannelsResponse>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_partners_channels_create(partnerId: string, advertiserId: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.post<Channel>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_channels_patch(partnerId: string, channelId: string, advertiserId: string | null | undefined, updateMask: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.patch<Channel>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_channels_sites_list(partnerId: string, channelId: string, advertiserId: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSitesResponse> {
			return this.http.get<ListSitesResponse>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_partners_channels_sites_delete(partnerId: string, channelId: string, urlOrAppId: string, advertiserId: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites/' + (urlOrAppId == null ? '' : encodeURIComponent(urlOrAppId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_partners_channels_sites_bulkEdit(partnerId: string, channelId: string, requestBody: BulkEditSitesRequest): Observable<BulkEditSitesResponse> {
			return this.http.post<BulkEditSitesResponse>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites:bulkEdit', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_channels_sites_replace(partnerId: string, channelId: string, requestBody: ReplaceSitesRequest): Observable<ReplaceSitesResponse> {
			return this.http.post<ReplaceSitesResponse>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/sites:replace', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_targetingTypes_assignedTargetingOptions_list(partnerId: string, targetingType: AssignedTargetingOptionTargetingType, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPartnerAssignedTargetingOptionsResponse> {
			return this.http.get<ListPartnerAssignedTargetingOptionsResponse>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_partners_targetingTypes_assignedTargetingOptions_create(partnerId: string, targetingType: AssignedTargetingOptionTargetingType, requestBody: AssignedTargetingOption): Observable<AssignedTargetingOption> {
			return this.http.post<AssignedTargetingOption>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_partners_targetingTypes_assignedTargetingOptions_delete(partnerId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		...
		Displayvideo_partners_targetingTypes_assignedTargetingOptions_get(partnerId: string, targetingType: AssignedTargetingOptionTargetingType, assignedTargetingOptionId: string): Observable<AssignedTargetingOption> {
			return this.http.get<AssignedTargetingOption>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + '/targetingTypes/' + targetingType + '/assignedTargetingOptions/' + (assignedTargetingOptionId == null ? '' : encodeURIComponent(assignedTargetingOptionId)), {});
		}
		 ...
		 * Post v1/partners/{partnerId}:bulkEditPartnerAssignedTargetingOptions
		 * @param {string} partnerId Required. The ID of the partner.
		 * @return {BulkEditPartnerAssignedTargetingOptionsResponse} Successful response
		 */
		Displayvideo_partners_bulkEditPartnerAssignedTargetingOptions(partnerId: string, requestBody: BulkEditPartnerAssignedTargetingOptionsRequest): Observable<BulkEditPartnerAssignedTargetingOptionsResponse> {
			return this.http.post<BulkEditPartnerAssignedTargetingOptionsResponse>(this.baseUri + 'v1/partners/' + (partnerId == null ? '' : encodeURIComponent(partnerId)) + ':bulkEditPartnerAssignedTargetingOptions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_sdfdownloadtasks_create(requestBody: CreateSdfDownloadTaskRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/sdfdownloadtasks', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_targetingTypes_targetingOptions_get(targetingType: AssignedTargetingOptionTargetingType, targetingOptionId: string, advertiserId: string | null | undefined): Observable<TargetingOption> {
			return this.http.get<TargetingOption>(this.baseUri + 'v1/targetingTypes/' + targetingType + '/targetingOptions/' + (targetingOptionId == null ? '' : encodeURIComponent(targetingOptionId)) + '&advertiserId=' + (advertiserId == null ? '' : encodeURIComponent(advertiserId)), {});
		}
		...
		Displayvideo_targetingTypes_targetingOptions_search(targetingType: AssignedTargetingOptionTargetingType, requestBody: SearchTargetingOptionsRequest): Observable<SearchTargetingOptionsResponse> {
			return this.http.post<SearchTargetingOptionsResponse>(this.baseUri + 'v1/targetingTypes/' + targetingType + '/targetingOptions:search', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_users_list(filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListUsersResponse> {
			return this.http.get<ListUsersResponse>(this.baseUri + 'v1/users?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Displayvideo_users_create(requestBody: User): Observable<User> {
			return this.http.post<User>(this.baseUri + 'v1/users', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Displayvideo_users_delete(userId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1/users/' + (userId == null ? '' : encodeURIComponent(userId)), {});
		}
		...
		Displayvideo_users_get(userId: string): Observable<User> {
			return this.http.get<User>(this.baseUri + 'v1/users/' + (userId == null ? '' : encodeURIComponent(userId)), {});
		}
		...
		Displayvideo_users_patch(userId: string, updateMask: string | null | undefined, requestBody: User): Observable<User> {
			return this.http.patch<User>(this.baseUri + 'v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Bulk edits user roles for a user. The operation will delete the assigned user roles provided in BulkEditAssignedUserRolesRequest.deletedAssignedUserRoles and then assign the user roles provided in BulkEditAssignedUserRolesRequest.createdAssignedUserRoles. This method has unique authentication requirements. Read the prerequisites in our [Managing Users guide](/display-video/api/guides/users/overview#prerequisites) before using this method. The "Try this method" feature does not work for this method.
		 * Post v1/users/{userId}:bulkEditAssignedUserRoles
		...
		Displayvideo_users_bulkEditAssignedUserRoles(userId: string, requestBody: BulkEditAssignedUserRolesRequest): Observable<BulkEditAssignedUserRolesResponse> {
			return this.http.post<BulkEditAssignedUserRolesResponse>(this.baseUri + 'v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + ':bulkEditAssignedUserRoles', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
