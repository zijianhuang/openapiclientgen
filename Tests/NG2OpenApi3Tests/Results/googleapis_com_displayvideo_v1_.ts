...
export namespace MyNS {
	...
	export enum AdvertiserEntityStatus { ENTITY_STATUS_UNSPECIFIED = 'ENTITY_STATUS_UNSPECIFIED', ENTITY_STATUS_ACTIVE = 'ENTITY_STATUS_ACTIVE', ENTITY_STATUS_ARCHIVED = 'ENTITY_STATUS_ARCHIVED', ENTITY_STATUS_DRAFT = 'ENTITY_STATUS_DRAFT', ENTITY_STATUS_PAUSED = 'ENTITY_STATUS_PAUSED', ENTITY_STATUS_SCHEDULED_FOR_DELETION = 'ENTITY_STATUS_SCHEDULED_FOR_DELETION' }
	...
	export enum ProximityLocationListAssignedTargetingOptionDetailsProximityRadiusRange { PROXIMITY_RADIUS_RANGE_UNSPECIFIED = 'PROXIMITY_RADIUS_RANGE_UNSPECIFIED', PROXIMITY_RADIUS_RANGE_SMALL = 'PROXIMITY_RADIUS_RANGE_SMALL', PROXIMITY_RADIUS_RANGE_MEDIUM = 'PROXIMITY_RADIUS_RANGE_MEDIUM', PROXIMITY_RADIUS_RANGE_LARGE = 'PROXIMITY_RADIUS_RANGE_LARGE' }
	...
	export enum CampaignBudgetBudgetUnit { BUDGET_UNIT_UNSPECIFIED = 'BUDGET_UNIT_UNSPECIFIED', BUDGET_UNIT_CURRENCY = 'BUDGET_UNIT_CURRENCY', BUDGET_UNIT_IMPRESSIONS = 'BUDGET_UNIT_IMPRESSIONS' }
	...
	export enum CustomBiddingAlgorithmCustomBiddingAlgorithmState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', ENABLED = 'ENABLED', DORMANT = 'DORMANT', SUSPENDED = 'SUSPENDED' }

	export enum CustomBiddingAlgorithmCustomBiddingAlgorithmType { CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED = 'CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED', SCRIPT_BASED = 'SCRIPT_BASED', ADS_DATA_HUB_BASED = 'ADS_DATA_HUB_BASED', GOAL_BUILDER_BASED = 'GOAL_BUILDER_BASED' }
	...
	export enum GenerateDefaultLineItemRequestLineItemType { LINE_ITEM_TYPE_UNSPECIFIED = 'LINE_ITEM_TYPE_UNSPECIFIED', LINE_ITEM_TYPE_DISPLAY_DEFAULT = 'LINE_ITEM_TYPE_DISPLAY_DEFAULT', LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INSTALL = 'LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INSTALL', LINE_ITEM_TYPE_VIDEO_DEFAULT = 'LINE_ITEM_TYPE_VIDEO_DEFAULT', LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INSTALL = 'LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INSTALL', LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INVENTORY = 'LINE_ITEM_TYPE_DISPLAY_MOBILE_APP_INVENTORY', LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INVENTORY = 'LINE_ITEM_TYPE_VIDEO_MOBILE_APP_INVENTORY', LINE_ITEM_TYPE_AUDIO_DEFAULT = 'LINE_ITEM_TYPE_AUDIO_DEFAULT', LINE_ITEM_TYPE_VIDEO_OVER_THE_TOP = 'LINE_ITEM_TYPE_VIDEO_OVER_THE_TOP', LINE_ITEM_TYPE_DISPLAY_OUT_OF_HOME = 'LINE_ITEM_TYPE_DISPLAY_OUT_OF_HOME', LINE_ITEM_TYPE_VIDEO_OUT_OF_HOME = 'LINE_ITEM_TYPE_VIDEO_OUT_OF_HOME' }
	...
	export enum InsertionOrderBillableOutcome { BILLABLE_OUTCOME_UNSPECIFIED = 'BILLABLE_OUTCOME_UNSPECIFIED', BILLABLE_OUTCOME_PAY_PER_IMPRESSION = 'BILLABLE_OUTCOME_PAY_PER_IMPRESSION', BILLABLE_OUTCOME_PAY_PER_CLICK = 'BILLABLE_OUTCOME_PAY_PER_CLICK', BILLABLE_OUTCOME_PAY_PER_VIEWABLE_IMPRESSION = 'BILLABLE_OUTCOME_PAY_PER_VIEWABLE_IMPRESSION' }
	...
	export enum TargetingExpansionConfigTargetingExpansionLevel { TARGETING_EXPANSION_LEVEL_UNSPECIFIED = 'TARGETING_EXPANSION_LEVEL_UNSPECIFIED', NO_EXPANSION = 'NO_EXPANSION', LEAST_EXPANSION = 'LEAST_EXPANSION', SOME_EXPANSION = 'SOME_EXPANSION', BALANCED_EXPANSION = 'BALANCED_EXPANSION', MORE_EXPANSION = 'MORE_EXPANSION', MOST_EXPANSION = 'MOST_EXPANSION' }
	...
	export enum ManualTriggerState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', INACTIVE = 'INACTIVE', ACTIVE = 'ACTIVE' }
