...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {CocerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Cocer(requestBody: CocerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'cocer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {RfcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Rfcer(requestBody: RfcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'rfcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface CocerPostBody {
		certificateParameters?: CocerPostBodyCertificateParameters;
	...
	export interface CocerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<CocerPostBodyFormat | null | undefined>,
	...
	export function CreateCocerPostBodyFormGroup() {
		return new FormGroup<CocerPostBodyFormProperties>({
			format: new FormControl<CocerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface CocerPostBodyCertificateParameters {
	...
	export interface CocerPostBodyCertificateParametersFormProperties {

		/**
		 * cert_type
		 * Required
		 */
		cert_type: FormControl<string | null | undefined>,
	...
	export function CreateCocerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<CocerPostBodyCertificateParametersFormProperties>({
			cert_type: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			...
			sector: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface RfcerPostBodyFormProperties {
	...
	export function CreateRfcerPostBodyFormGroup() {
		return new FormGroup<RfcerPostBodyFormProperties>({
			format: new FormControl<CocerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface RfcerPostBodyCertificateParameters {
	...
	export interface RfcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateRfcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<RfcerPostBodyCertificateParametersFormProperties>({
			cert_type: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			company_name: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			reg_no: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			sector: new FormControl<string | null | undefined>(undefined, [Validators.required]),
