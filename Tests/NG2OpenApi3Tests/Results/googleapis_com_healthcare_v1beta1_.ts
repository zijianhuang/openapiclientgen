...
export namespace MyNS {
	...
	export enum AccessDeterminationLogConfigLogLevel { LOG_LEVEL_UNSPECIFIED = 0, DISABLED = 1, MINIMUM = 2, VERBOSE = 3 }
	...
	export enum ImageConfigTextRedactionMode { TEXT_REDACTION_MODE_UNSPECIFIED = 0, REDACT_ALL_TEXT = 1, REDACT_SENSITIVE_TEXT = 2, REDACT_NO_TEXT = 3, REDACT_SENSITIVE_TEXT_CLEAN_DESCRIPTORS = 4 }
	...
	export enum BlobStorageInfoStorageClass { BLOB_STORAGE_CLASS_UNSPECIFIED = 0, STANDARD = 1, NEARLINE = 2, COLDLINE = 3, ARCHIVE = 4 }
	...
	export enum ConsentHeaderHandlingProfile { SCOPE_PROFILE_UNSPECIFIED = 0, PERMIT_EMPTY_SCOPE = 1, REQUIRED_ON_READ = 2 }

	export enum ConsentConfigVersion { CONSENT_ENFORCEMENT_VERSION_UNSPECIFIED = 0, V1 = 1 }
	...
	export enum OptionsPrimaryIds { PRIMARY_IDS_OPTION_UNSPECIFIED = 0, KEEP = 1, REGEN = 2 }

	export enum DicomTagConfigProfileType { PROFILE_TYPE_UNSPECIFIED = 0, MINIMAL_KEEP_LIST_PROFILE = 1, ATTRIBUTE_CONFIDENTIALITY_BASIC_PROFILE = 2, KEEP_ALL_PROFILE = 3, DEIDENTIFY_TAG_CONTENTS = 4 }
	...
	export enum FhirFieldConfigProfileType { PROFILE_TYPE_UNSPECIFIED = 0, KEEP_ALL = 1, BASIC = 2, CLEAN_ALL = 3 }
	...
	export enum TextConfigProfileType { PROFILE_TYPE_UNSPECIFIED = 0, EMPTY = 1, BASIC = 2 }
	...
	export enum GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition { WRITE_DISPOSITION_UNSPECIFIED = 0, WRITE_EMPTY = 1, WRITE_TRUNCATE = 2, WRITE_APPEND = 3 }
	...
	export enum GoogleCloudHealthcareV1beta1AnnotationBigQueryDestinationSchemaType { SCHEMA_TYPE_UNSPECIFIED = 0, SIMPLE = 1 }
	...
	export enum SchemaConfigSchemaType { SCHEMA_TYPE_UNSPECIFIED = 0, LOSSLESS = 1, ANALYTICS = 2, ANALYTICS_V2 = 3 }
	...
	export enum RollbackFhirResourcesRequestChangeType { CHANGE_TYPE_UNSPECIFIED = 0, ALL = 1, CREATE = 2, UPDATE = 3, DELETE = 4 }
	...
	export enum Healthcare_projects_locations_datasets_annotationStores_annotations_listView { ANNOTATION_VIEW_UNSPECIFIED = 0, ANNOTATION_VIEW_BASIC = 1, ANNOTATION_VIEW_FULL = 2 }
