...
export namespace MyNS {
	...
	export interface AccessDeterminationLogConfig {
		...
		logLevel?: AccessDeterminationLogConfigLogLevel | null;
	}

	/** Configures consent audit log config for FHIR create, read, update, and delete (CRUD) operations. Cloud audit log for healthcare API must be [enabled](https://cloud.google.com/logging/docs/audit/configure-data-access#config-console-enable). The consent-related logs are included as part of `protoPayload.metadata`. */
	export interface AccessDeterminationLogConfigFormProperties {

		/** Optional. Controls the amount of detail to include as part of the audit logs. */
		logLevel: FormControl<AccessDeterminationLogConfigLogLevel | null | undefined>,
	}
	export function CreateAccessDeterminationLogConfigFormGroup() {
		return new FormGroup<AccessDeterminationLogConfigFormProperties>({
			logLevel: new FormControl<AccessDeterminationLogConfigLogLevel | null | undefined>(undefined),
		});

	}

	export enum AccessDeterminationLogConfigLogLevel { LOG_LEVEL_UNSPECIFIED = 'LOG_LEVEL_UNSPECIFIED', DISABLED = 'DISABLED', MINIMUM = 'MINIMUM', VERBOSE = 'VERBOSE' }
	...
	export enum ImageConfigTextRedactionMode { TEXT_REDACTION_MODE_UNSPECIFIED = 'TEXT_REDACTION_MODE_UNSPECIFIED', REDACT_ALL_TEXT = 'REDACT_ALL_TEXT', REDACT_SENSITIVE_TEXT = 'REDACT_SENSITIVE_TEXT', REDACT_NO_TEXT = 'REDACT_NO_TEXT', REDACT_SENSITIVE_TEXT_CLEAN_DESCRIPTORS = 'REDACT_SENSITIVE_TEXT_CLEAN_DESCRIPTORS' }
	...
	/** Inspect text and transform sensitive text. Configurable using TextConfig. Supported [Value Representations] (http://dicom.nema.org/medical/dicom/2018e/output/chtml/part05/sect_6.2.html#table_6.2-1): AE, LO, LT, PN, SH, ST, UC, UT, DA, DT, AS */
	export interface CleanTextTagFormProperties {
	}
	export function CreateCleanTextTagFormGroup() {
		return new FormGroup<CleanTextTagFormProperties>({
		});
	...
	/** Delete tag. */
	export interface DeleteTagFormProperties {
	}
	export function CreateDeleteTagFormGroup() {
		return new FormGroup<DeleteTagFormProperties>({
		});
	...
	/** Keep tag unchanged. */
	export interface KeepTagFormProperties {
	}
	export function CreateKeepTagFormGroup() {
		return new FormGroup<KeepTagFormProperties>({
		});
	...
	/** Recursively apply DICOM de-id to tags nested in a sequence. Supported [Value Representation] (http://dicom.nema.org/medical/dicom/2018e/output/chtml/part05/sect_6.2.html#table_6.2-1): SQ */
	export interface RecurseTagFormProperties {
	}
	export function CreateRecurseTagFormGroup() {
		return new FormGroup<RecurseTagFormProperties>({
		});
	...
	/** Replace UID with a new generated UID. Supported [Value Representation] (http://dicom.nema.org/medical/dicom/2018e/output/chtml/part05/sect_6.2.html#table_6.2-1): UI */
	export interface RegenUidTagFormProperties {
	}
	export function CreateRegenUidTagFormGroup() {
		return new FormGroup<RegenUidTagFormProperties>({
		});
	...
	/** Replace with empty tag. */
	export interface RemoveTagFormProperties {
	}
	export function CreateRemoveTagFormGroup() {
		return new FormGroup<RemoveTagFormProperties>({
		});
	...
	/** Reset tag to a placeholder value. */
	export interface ResetTagFormProperties {
	}
	export function CreateResetTagFormGroup() {
		return new FormGroup<ResetTagFormProperties>({
		});
	...
	/** List of admin Consent resources to be applied. */
	export interface AdminConsentsFormProperties {
	}
	export function CreateAdminConsentsFormGroup() {
		return new FormGroup<AdminConsentsFormProperties>({
		});
	...
	export interface AnnotationFormProperties {
		...
		/** Additional information for this annotation record, such as annotator and verifier information or study campaign. */
		customData: FormControl<{[id: string]: string } | null | undefined>,
	...
	export function CreateAnnotationFormGroup() {
		return new FormGroup<AnnotationFormProperties>({
			customData: new FormControl<{[id: string]: string } | null | undefined>(undefined),
	...
	/** AnnotationSource holds the source information of the annotation. */
	export interface AnnotationSourceFormProperties {
	}
	export function CreateAnnotationSourceFormGroup() {
		return new FormGroup<AnnotationSourceFormProperties>({
		});
	...
	/** Cloud Healthcare API resource. */
	export interface CloudHealthcareSource {
	...
	/** Cloud Healthcare API resource. */
	export interface CloudHealthcareSourceFormProperties {

		/** Full path of a Cloud Healthcare API resource. */
		name: FormControl<string | null | undefined>,
	}
	export function CreateCloudHealthcareSourceFormGroup() {
		return new FormGroup<CloudHealthcareSourceFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	export function CreateImageAnnotationFormGroup() {
		return new FormGroup<ImageAnnotationFormProperties>({
			frameIndex: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** Resource level annotation. */
	export interface ResourceAnnotationFormProperties {

		/** A description of the annotation record. */
		label: FormControl<string | null | undefined>,
	}
	export function CreateResourceAnnotationFormGroup() {
		return new FormGroup<ResourceAnnotationFormProperties>({
			label: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A TextAnnotation specifies a text range that includes sensitive information. */
	export interface SensitiveTextAnnotation {
	...
	/** A TextAnnotation specifies a text range that includes sensitive information. */
	export interface SensitiveTextAnnotationFormProperties {

		/** Maps from a resource slice. For example, FHIR resource field path to a set of sensitive text findings. For example, Appointment.Narrative text1 --> {findings_1, findings_2, findings_3} */
		details: FormControl<{[id: string]: Detail } | null | undefined>,
	}
	export function CreateSensitiveTextAnnotationFormGroup() {
		return new FormGroup<SensitiveTextAnnotationFormProperties>({
			details: new FormControl<{[id: string]: Detail } | null | undefined>(undefined),
		});
	...
	/** Specifies how to store annotations during de-identification operation. */
	export interface AnnotationConfigFormProperties {

		/** The name of the annotation store, in the form `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/annotationStores/{annotation_store_id}`). * The destination annotation store must be in the same project as the source data. De-identifying data across multiple projects is not supported. * The destination annotation store must exist when using DeidentifyDicomStore or DeidentifyFhirStore. DeidentifyDataset automatically creates the destination annotation store. */
		annotationStoreName: FormControl<string | null | undefined>,

		/** If set to true, the sensitive texts are included in SensitiveTextAnnotation of Annotation. */
		storeQuote: FormControl<boolean | null | undefined>,
	}
	export function CreateAnnotationConfigFormGroup() {
		return new FormGroup<AnnotationConfigFormProperties>({
			annotationStoreName: new FormControl<string | null | undefined>(undefined),
			storeQuote: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** An Annotation store that can store annotation resources such as labels and tags for text, image and audio. */
	export interface AnnotationStoreFormProperties {
	...
	export function CreateAnnotationStoreFormGroup() {
		return new FormGroup<AnnotationStoreFormProperties>({
	...
	/** Request to apply the admin Consent resources for the specified FHIR store. */
	export interface ApplyAdminConsentsRequestFormProperties {

		/** If true, the method only validates Consent resources to make sure they are supported. Otherwise, the method applies the aggregate consent information to update the enforcement model and reindex the FHIR resources. If all Consent resources can be applied successfully, the ApplyAdminConsentsResponse is returned containing the following fields: * `consent_apply_success` to indicate the number of Consent resources applied. * `affected_resources` to indicate the number of resources that might have had their consent access changed. If, however, one or more Consent resources are unsupported or cannot be applied, the method fails and ApplyAdminConsentsErrorDetail is is returned with details about the unsupported Consent resources. */
		validateOnly: FormControl<boolean | null | undefined>,
	}
	export function CreateApplyAdminConsentsRequestFormGroup() {
		return new FormGroup<ApplyAdminConsentsRequestFormProperties>({
	...
	/** Response when all admin Consent resources in scope were processed and all affected resources were reindexed successfully. This structure will be included in the response when the operation finishes successfully. */
	export interface ApplyAdminConsentsResponseFormProperties {

		/** The number of resources (including the Consent resources) that may have consent access change. */
		affectedResources: FormControl<string | null | undefined>,

		/** If `validate_only=false` in ApplyAdminConsentsRequest, this counter contains the number of Consent resources that were successfully applied. Otherwise, it is the number of Consent resources that are supported. */
		consentApplySuccess: FormControl<string | null | undefined>,

		/** The number of resources (including the Consent resources) that ApplyAdminConsents failed to re-index. */
		failedResources: FormControl<string | null | undefined>,
	}
	export function CreateApplyAdminConsentsResponseFormGroup() {
		return new FormGroup<ApplyAdminConsentsResponseFormProperties>({
			affectedResources: new FormControl<string | null | undefined>(undefined),
			consentApplySuccess: new FormControl<string | null | undefined>(undefined),
			failedResources: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request to apply the Consent resources for the specified FHIR store. */
	export interface ApplyConsentsRequestFormProperties {

		/** Optional. If true, the method only validates Consent resources to make sure they are supported. When the operation completes, ApplyConsentsResponse is returned where `consent_apply_success` and `consent_apply_failure` indicate supported and unsupported (or invalid) Consent resources, respectively. Otherwise, the method propagates the aggregate consensual information to the patient's resources. Upon success, `affected_resources` in the ApplyConsentsResponse indicates the number of resources that may have consensual access changed. */
		validateOnly: FormControl<boolean | null | undefined>,
	}
	export function CreateApplyConsentsRequestFormGroup() {
		return new FormGroup<ApplyConsentsRequestFormProperties>({
			validateOnly: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Apply consents given by a list of patients. */
	export interface PatientScopeFormProperties {
	}
	export function CreatePatientScopeFormGroup() {
		return new FormGroup<PatientScopeFormProperties>({
		});
	...
	/** Response when all Consent resources in scope were processed and all affected resources were reindexed successfully. This structure is included in the response when the operation finishes successfully. */
	export interface ApplyConsentsResponseFormProperties {

		/** The number of resources (including the Consent resources) that may have consensual access change. */
		affectedResources: FormControl<string | null | undefined>,

		/** If `validate_only = false` in ApplyConsentsRequest, this counter is the number of Consent resources that were failed to apply. Otherwise, it is the number of Consent resources that are not supported or invalid. */
		consentApplyFailure: FormControl<string | null | undefined>,
	...
	export function CreateApplyConsentsResponseFormGroup() {
		return new FormGroup<ApplyConsentsResponseFormProperties>({
			affectedResources: new FormControl<string | null | undefined>(undefined),
			consentApplyFailure: new FormControl<string | null | undefined>(undefined),
			consentApplySuccess: new FormControl<string | null | undefined>(undefined),
			failedResources: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Gets multiple messages in a specified HL7v2 store. */
	export interface BatchGetMessagesResponseFormProperties {
	}
	export function CreateBatchGetMessagesResponseFormGroup() {
		return new FormGroup<BatchGetMessagesResponseFormProperties>({
		});
	...
	export interface BlobStorageInfo {
		...
		storageClass?: BlobStorageInfoStorageClass | null;
	...
	/** BlobStorageInfo contains details about the data stored in Blob Storage for the referenced resource. Note: Storage class is only valid for DICOM and hence will only be populated for DICOM resources. */
	export interface BlobStorageInfoFormProperties {

		/** Size in bytes of data stored in Blob Storage. */
		sizeBytes: FormControl<string | null | undefined>,

		/** The storage class in which the Blob data is stored. */
		storageClass: FormControl<BlobStorageInfoStorageClass | null | undefined>,

		/** The time at which the storage class was updated. This is used to compute early deletion fees of the resource. */
		storageClassUpdateTime: FormControl<string | null | undefined>,
	}
	export function CreateBlobStorageInfoFormGroup() {
		return new FormGroup<BlobStorageInfoFormProperties>({
			sizeBytes: new FormControl<string | null | undefined>(undefined),
			storageClass: new FormControl<BlobStorageInfoStorageClass | null | undefined>(undefined),
			storageClassUpdateTime: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum BlobStorageInfoStorageClass { BLOB_STORAGE_CLASS_UNSPECIFIED = 'BLOB_STORAGE_CLASS_UNSPECIFIED', STANDARD = 'STANDARD', NEARLINE = 'NEARLINE', COLDLINE = 'COLDLINE', ARCHIVE = 'ARCHIVE' }
	...
	export interface BlobStorageSettings {
		...
		/** The Storage class in which the Blob data is stored. */
		blobStorageClass?: BlobStorageInfoStorageClass | null;
	}

	/** Settings for data stored in Blob storage. */
	export interface BlobStorageSettingsFormProperties {

		/** The Storage class in which the Blob data is stored. */
		blobStorageClass: FormControl<BlobStorageInfoStorageClass | null | undefined>,
	}
	export function CreateBlobStorageSettingsFormGroup() {
		return new FormGroup<BlobStorageSettingsFormProperties>({
			blobStorageClass: new FormControl<BlobStorageInfoStorageClass | null | undefined>(undefined),
		});
	...
	/** Replace field value with masking character. Supported [types](https://www.hl7.org/fhir/datatypes.html): Code, Decimal, HumanName, Id, LanguageCode, Markdown, Oid, String, Uri, Uuid, Xhtml. */
	export interface CharacterMaskFieldFormProperties {
	}
	export function CreateCharacterMaskFieldFormGroup() {
		return new FormGroup<CharacterMaskFieldFormProperties>({
		});
	...
	/** This option is based on the DICOM Standard's [Clean Descriptors Option](http://dicom.nema.org/medical/dicom/2018e/output/chtml/part15/sect_E.3.5.html), and the `CleanText` `Action` is applied to all the specified fields. When cleaning text, the process attempts to transform phrases matching any of the tags marked for removal (action codes D, Z, X, and U) in the [Basic Profile](http://dicom.nema.org/medical/dicom/2018e/output/chtml/part15/chapter_E.html). These contextual phrases are replaced with the token "[CTX]". This option uses an additional infoType during inspection. */
	export interface CleanDescriptorsOptionFormProperties {
	}
	export function CreateCleanDescriptorsOptionFormGroup() {
		return new FormGroup<CleanDescriptorsOptionFormProperties>({
		});
	...
	/** Inspect text and transform sensitive text. Configure using TextConfig. Supported [types](https://www.hl7.org/fhir/datatypes.html): Code, Date, DateTime, Decimal, HumanName, Id, LanguageCode, Markdown, Oid, String, Uri, Uuid, Xhtml. */
	export interface CleanTextFieldFormProperties {
	}
	export function CreateCleanTextFieldFormGroup() {
		return new FormGroup<CleanTextFieldFormProperties>({
		});
	...
	/** Request to configure the search parameters for the specified FHIR store. */
	export interface ConfigureSearchRequestFormProperties {

		/** If `validate_only` is set to true, the method will compile all the search parameters without actually setting the search config for the store and triggering the reindex. */
		validateOnly: FormControl<boolean | null | undefined>,
	}
	export function CreateConfigureSearchRequestFormGroup() {
		return new FormGroup<ConfigureSearchRequestFormProperties>({
			validateOnly: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Represents a user's consent in terms of the resources that can be accessed and under what conditions. */
	export interface GoogleCloudHealthcareV1beta1ConsentPolicyFormProperties {
	}
	export function CreateGoogleCloudHealthcareV1beta1ConsentPolicyFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1ConsentPolicyFormProperties>({
		});
	...
	export interface ConsentConfig {
		...
		version?: ConsentConfigVersion | null;
	}

	/** Configures whether to enforce consent for the FHIR store and which consent enforcement version is being used. */
	export interface ConsentConfigFormProperties {

		/** Optional. If set to true, when accessing FHIR resources, the consent headers will be verified against consents given by patients. See the ConsentEnforcementVersion for the supported consent headers. */
		accessEnforced: FormControl<boolean | null | undefined>,

		/** Required. Specifies which consent enforcement version is being used for this FHIR store. This field can only be set once by either CreateFhirStore or UpdateFhirStore. After that, you must call ApplyConsents to change the version. */
		version: FormControl<ConsentConfigVersion | null | undefined>,
	}
	export function CreateConsentConfigFormGroup() {
		return new FormGroup<ConsentConfigFormProperties>({
			accessEnforced: new FormControl<boolean | null | undefined>(undefined),
			version: new FormControl<ConsentConfigVersion | null | undefined>(undefined),
		});
	...
	export interface ConsentHeaderHandling {
		...
		profile?: ConsentHeaderHandlingProfile | null;
	}

	/** How the server handles the consent header. */
	export interface ConsentHeaderHandlingFormProperties {

		/** Optional. Specifies the default server behavior when the header is empty. If not specified, the `ScopeProfile.PERMIT_EMPTY_SCOPE` option is used. */
		profile: FormControl<ConsentHeaderHandlingProfile | null | undefined>,
	}
	export function CreateConsentHeaderHandlingFormGroup() {
		return new FormGroup<ConsentHeaderHandlingFormProperties>({
			profile: new FormControl<ConsentHeaderHandlingProfile | null | undefined>(undefined),
		});

	}

	export enum ConsentHeaderHandlingProfile { SCOPE_PROFILE_UNSPECIFIED = 'SCOPE_PROFILE_UNSPECIFIED', PERMIT_EMPTY_SCOPE = 'PERMIT_EMPTY_SCOPE', REQUIRED_ON_READ = 'REQUIRED_ON_READ' }

	export enum ConsentConfigVersion { CONSENT_ENFORCEMENT_VERSION_UNSPECIFIED = 'CONSENT_ENFORCEMENT_VERSION_UNSPECIFIED', V1 = 'V1' }
	...
	/** Fields that don't match a KeepField or CleanTextField `action` in the BASIC profile are collected into a contextual phrase list. For fields that match a CleanTextField `action` in FieldMetadata or ProfileType, the process attempts to transform phrases matching these contextual entries. These contextual phrases are replaced with the token "[CTX]". This feature uses an additional InfoType during inspection. */
	export interface ContextualDeidConfigFormProperties {
	}
	export function CreateContextualDeidConfigFormGroup() {
		return new FormGroup<ContextualDeidConfigFormProperties>({
		});
	...
	/** Replace field value with a hash of that value. Supported [types](https://www.hl7.org/fhir/datatypes.html): Code, Decimal, HumanName, Id, LanguageCode, Markdown, Oid, String, Uri, Uuid, Xhtml. */
	export interface CryptoHashFieldFormProperties {
	}
	export function CreateCryptoHashFieldFormGroup() {
		return new FormGroup<CryptoHashFieldFormProperties>({
		});
	...
	/** Shift the date by a randomized number of days. See [date shifting](https://cloud.google.com/dlp/docs/concepts-date-shifting) for more information. Supported [types](https://www.hl7.org/fhir/datatypes.html): Date, DateTime. */
	export interface DateShiftFieldFormProperties {
	}
	export function CreateDateShiftFieldFormGroup() {
		return new FormGroup<DateShiftFieldFormProperties>({
		});
	...
	export interface DicomTagConfig {
		...
		profileType?: DicomTagConfigProfileType | null;
	}

	/** Specifies the parameters needed for the de-identification of DICOM stores. */
	export interface DicomTagConfigFormProperties {

		/** Base profile type for handling DICOM tags. */
		profileType: FormControl<DicomTagConfigProfileType | null | undefined>,
	}
	export function CreateDicomTagConfigFormGroup() {
		return new FormGroup<DicomTagConfigFormProperties>({
			profileType: new FormControl<DicomTagConfigProfileType | null | undefined>(undefined),
		});
	...
	export interface Options {
		...
		primaryIds?: OptionsPrimaryIds | null;
	}
	...
	export interface OptionsFormProperties {
		...
		/** Set `Action` for [`StudyInstanceUID`, `SeriesInstanceUID`, `SOPInstanceUID`, and `MediaStorageSOPInstanceUID`](http://dicom.nema.org/medical/dicom/2018e/output/chtml/part06/chapter_6.html). */
		primaryIds: FormControl<OptionsPrimaryIds | null | undefined>,
	}
	export function CreateOptionsFormGroup() {
		return new FormGroup<OptionsFormProperties>({
			primaryIds: new FormControl<OptionsPrimaryIds | null | undefined>(undefined),
		});

	}

	export enum OptionsPrimaryIds { PRIMARY_IDS_OPTION_UNSPECIFIED = 'PRIMARY_IDS_OPTION_UNSPECIFIED', KEEP = 'KEEP', REGEN = 'REGEN' }

	export enum DicomTagConfigProfileType { PROFILE_TYPE_UNSPECIFIED = 'PROFILE_TYPE_UNSPECIFIED', MINIMAL_KEEP_LIST_PROFILE = 'MINIMAL_KEEP_LIST_PROFILE', ATTRIBUTE_CONFIDENTIALITY_BASIC_PROFILE = 'ATTRIBUTE_CONFIDENTIALITY_BASIC_PROFILE', KEEP_ALL_PROFILE = 'KEEP_ALL_PROFILE', DEIDENTIFY_TAG_CONTENTS = 'DEIDENTIFY_TAG_CONTENTS' }
	...
	export interface FhirFieldConfig {
		...
		profileType?: FhirFieldConfigProfileType | null;
	}

	/** Specifies how to handle the de-identification of a FHIR store. */
	export interface FhirFieldConfigFormProperties {

		/** Base profile type for handling FHIR fields. */
		profileType: FormControl<FhirFieldConfigProfileType | null | undefined>,
	}
	export function CreateFhirFieldConfigFormGroup() {
		return new FormGroup<FhirFieldConfigFormProperties>({
			profileType: new FormControl<FhirFieldConfigProfileType | null | undefined>(undefined),
		});
	...
	/** Specifies the FHIR paths to match and how to handle the de-identification of matching fields. */
	export interface GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataFormProperties {
	}
	export function CreateGoogleCloudHealthcareV1beta1DeidentifyFieldMetadataFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1DeidentifyFieldMetadataFormProperties>({
		});
	...
	/** Keep field unchanged. */
	export interface KeepFieldFormProperties {
	}
	export function CreateKeepFieldFormGroup() {
		return new FormGroup<KeepFieldFormProperties>({
		});
	...
	/** Remove field. */
	export interface RemoveFieldFormProperties {
	}
	export function CreateRemoveFieldFormGroup() {
		return new FormGroup<RemoveFieldFormProperties>({
		});
	...
	/** Specifies additional options to apply to the base ProfileType. */
	export interface GoogleCloudHealthcareV1beta1DeidentifyOptionsFormProperties {
	}
	export function CreateGoogleCloudHealthcareV1beta1DeidentifyOptionsFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1DeidentifyOptionsFormProperties>({
		});
	...
	/** The behavior for handling FHIR extensions that aren't otherwise specified for de-identification. If provided, all extensions are preserved during de-identification by default. If unspecified, all extensions are removed during de-identification by default. */
	export interface KeepExtensionsConfigFormProperties {
	}
	export function CreateKeepExtensionsConfigFormGroup() {
		return new FormGroup<KeepExtensionsConfigFormProperties>({
		});

	}

	export enum FhirFieldConfigProfileType { PROFILE_TYPE_UNSPECIFIED = 'PROFILE_TYPE_UNSPECIFIED', KEEP_ALL = 'KEEP_ALL', BASIC = 'BASIC', CLEAN_ALL = 'CLEAN_ALL' }
	...
	/** Details about the work the de-identify operation performed. */
	export interface DeidentifyOperationMetadataFormProperties {
	}
	export function CreateDeidentifyOperationMetadataFormGroup() {
		return new FormGroup<DeidentifyOperationMetadataFormProperties>({
		});
	...
	/** Details about the FHIR store to write the output to. */
	export interface FhirOutputFormProperties {

		/** Name of the output FHIR store, which must already exist. You must grant the healthcare.fhirResources.update permission on the destination store to your project's **Cloud Healthcare Service Agent** [service account](https://cloud.google.com/healthcare/docs/how-tos/permissions-healthcare-api-gcp-products#the_cloud_healthcare_service_agent). The destination store must set enableUpdateCreate to true. The destination store must use FHIR version R4. Writing these resources will consume FHIR operations quota from the project containing the source data. De-identify operation metadata is only generated for DICOM de-identification operations. */
		fhirStore: FormControl<string | null | undefined>,
	}
	export function CreateFhirOutputFormGroup() {
		return new FormGroup<FhirOutputFormProperties>({
			fhirStore: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface TextConfig {
		...
		profileType?: TextConfigProfileType | null;
	...
	export interface TextConfigFormProperties {
		...
		/** Base profile type for text transformation. */
		profileType: FormControl<TextConfigProfileType | null | undefined>,
	}
	export function CreateTextConfigFormGroup() {
		return new FormGroup<TextConfigFormProperties>({
			profileType: new FormControl<TextConfigProfileType | null | undefined>(undefined),
		});
	...
	export enum TextConfigProfileType { PROFILE_TYPE_UNSPECIFIED = 'PROFILE_TYPE_UNSPECIFIED', EMPTY = 'EMPTY', BASIC = 'BASIC' }
	...
	/** StreamConfig specifies configuration for a streaming DICOM export. */
	export interface GoogleCloudHealthcareV1beta1DicomStreamConfigFormProperties {
	}
	export function CreateGoogleCloudHealthcareV1beta1DicomStreamConfigFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1DicomStreamConfigFormProperties>({
		});
	...
	export interface GoogleCloudHealthcareV1beta1DicomBigQueryDestination {
		...
		writeDisposition?: GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition | null;
	}

	/** The BigQuery table where the server writes output. */
	export interface GoogleCloudHealthcareV1beta1DicomBigQueryDestinationFormProperties {
		...
		/** Determines whether the existing table in the destination is to be overwritten or appended to. If a write_disposition is specified, the `force` parameter is ignored. */
		writeDisposition: FormControl<GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition | null | undefined>,
	}
	export function CreateGoogleCloudHealthcareV1beta1DicomBigQueryDestinationFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1DicomBigQueryDestinationFormProperties>({
			force: new FormControl<boolean | null | undefined>(undefined),
			tableUri: new FormControl<string | null | undefined>(undefined),
			writeDisposition: new FormControl<GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition { WRITE_DISPOSITION_UNSPECIFIED = 'WRITE_DISPOSITION_UNSPECIFIED', WRITE_EMPTY = 'WRITE_EMPTY', WRITE_TRUNCATE = 'WRITE_TRUNCATE', WRITE_APPEND = 'WRITE_APPEND' }
	...
	export interface EvaluateAnnotationStoreRequest {
	...
	/** Request to evaluate an Annotation store against a ground truth [Annotation store]. */
	export interface EvaluateAnnotationStoreRequestFormProperties {

		/** Optional. InfoType mapping for `eval_store`. Different resources can map to the same infoType. For example, `PERSON_NAME`, `PERSON`, `NAME`, and `HUMAN` are different. To map all of these into a single infoType (such as `PERSON_NAME`), specify the following mapping: ``` info_type_mapping["PERSON"] = "PERSON_NAME" info_type_mapping["NAME"] = "PERSON_NAME" info_type_mapping["HUMAN"] = "PERSON_NAME" ``` Unmentioned infoTypes, such as `DATE`, are treated as identity mapping. For example: ``` info_type_mapping["DATE"] = "DATE" ``` InfoTypes are case-insensitive. */
		evalInfoTypeMapping: FormControl<{[id: string]: string } | null | undefined>,

		/** Optional. Similar to `eval_info_type_mapping`, infoType mapping for `golden_store`. */
		goldenInfoTypeMapping: FormControl<{[id: string]: string } | null | undefined>,

		/** The Annotation store to use as ground truth, in the format of `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/annotationStores/{annotation_store_id}`. */
		goldenStore: FormControl<string | null | undefined>,
	}
	export function CreateEvaluateAnnotationStoreRequestFormGroup() {
		return new FormGroup<EvaluateAnnotationStoreRequestFormProperties>({
			evalInfoTypeMapping: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			goldenInfoTypeMapping: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			goldenStore: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The BigQuery table for export. */
	export interface GoogleCloudHealthcareV1beta1AnnotationBigQueryDestination {

		/** Use `write_disposition` instead. If `write_disposition` is specified, this parameter is ignored. force=false is equivalent to write_disposition=WRITE_EMPTY and force=true is equivalent to write_disposition=WRITE_TRUNCATE. */
		force?: boolean | null;

		/** Specifies the schema format to export. */
		schemaType?: GoogleCloudHealthcareV1beta1AnnotationBigQueryDestinationSchemaType | null;
	...
	/** The BigQuery table for export. */
	export interface GoogleCloudHealthcareV1beta1AnnotationBigQueryDestinationFormProperties {

		/** Use `write_disposition` instead. If `write_disposition` is specified, this parameter is ignored. force=false is equivalent to write_disposition=WRITE_EMPTY and force=true is equivalent to write_disposition=WRITE_TRUNCATE. */
		force: FormControl<boolean | null | undefined>,

		/** Specifies the schema format to export. */
		schemaType: FormControl<GoogleCloudHealthcareV1beta1AnnotationBigQueryDestinationSchemaType | null | undefined>,
	...
	export function CreateGoogleCloudHealthcareV1beta1AnnotationBigQueryDestinationFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1AnnotationBigQueryDestinationFormProperties>({
			force: new FormControl<boolean | null | undefined>(undefined),
			schemaType: new FormControl<GoogleCloudHealthcareV1beta1AnnotationBigQueryDestinationSchemaType | null | undefined>(undefined),
			tableUri: new FormControl<string | null | undefined>(undefined),
			writeDisposition: new FormControl<GoogleCloudHealthcareV1beta1DicomBigQueryDestinationWriteDisposition | null | undefined>(undefined),
		});
	...
	export enum GoogleCloudHealthcareV1beta1AnnotationBigQueryDestinationSchemaType { SCHEMA_TYPE_UNSPECIFIED = 'SCHEMA_TYPE_UNSPECIFIED', SIMPLE = 'SIMPLE' }
	...
	/** Specifies how to use infoTypes for evaluation. For example, a user might only want to evaluate `PERSON`, `LOCATION`, and `AGE`. */
	export interface InfoTypeConfigFormProperties {

		/** If `TRUE`, infoTypes described by `filter` are used for evaluation. Otherwise, infoTypes are not considered for evaluation. For example: * Annotated text: "Toronto is a location" * Finding 1: `{"infoType": "PERSON", "quote": "Toronto", "start": 0, "end": 7}` * Finding 2: `{"infoType": "CITY", "quote": "Toronto", "start": 0, "end": 7}` * Finding 3: `{}` * Ground truth: `{"infoType": "LOCATION", "quote": "Toronto", "start": 0, "end": 7}` When `strict_matching` is `TRUE`: * Finding 1: 1 false positive * Finding 2: 1 false positive * Finding 3: 1 false negative When `strict_matching` is `FALSE`: * Finding 1: 1 true positive * Finding 2: 1 true positive * Finding 3: 1 false negative */
		strictMatching: FormControl<boolean | null | undefined>,
	}
	export function CreateInfoTypeConfigFormGroup() {
		return new FormGroup<InfoTypeConfigFormProperties>({
			strictMatching: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** List of infoTypes to be filtered. */
	export interface FilterListFormProperties {
	}
	export function CreateFilterListFormGroup() {
		return new FormGroup<FilterListFormProperties>({
		});
	...
	export interface EvaluateAnnotationStoreResponse {
	}

	/** Response for successful Annotation store evaluation operations. This structure is included in the response upon operation completion. */
	export interface EvaluateAnnotationStoreResponseFormProperties {
	}
	export function CreateEvaluateAnnotationStoreResponseFormGroup() {
		return new FormGroup<EvaluateAnnotationStoreResponseFormProperties>({
		});
	...
	/** Request to export Annotations. The export operation is not atomic. If a failure occurs, any annotations already exported are not removed. */
	export interface ExportAnnotationsRequestFormProperties {
	}
	export function CreateExportAnnotationsRequestFormGroup() {
		return new FormGroup<ExportAnnotationsRequestFormProperties>({
		});
	...
	/** The Cloud Storage location for export. */
	export interface GoogleCloudHealthcareV1beta1AnnotationGcsDestination {
	...
	/** The Cloud Storage location for export. */
	export interface GoogleCloudHealthcareV1beta1AnnotationGcsDestinationFormProperties {

		/** The Cloud Storage destination to export to. URI for a Cloud Storage directory where the server writes result files, in the format `gs://{bucket-id}/{path/to/destination/dir}`. If there is no trailing slash, the service appends one when composing the object path. The user is responsible for creating the Cloud Storage bucket referenced in `uri_prefix`. */
		uriPrefix: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudHealthcareV1beta1AnnotationGcsDestinationFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1AnnotationGcsDestinationFormProperties>({
	...
	/** Response for successful annotation export operations. This structure is included in response upon operation completion. */
	export interface ExportAnnotationsResponseFormProperties {
	}
	export function CreateExportAnnotationsResponseFormGroup() {
		return new FormGroup<ExportAnnotationsResponseFormProperties>({
		});
	...
	/** The Cloud Storage location where the server writes the output and the export configuration. */
	export interface GoogleCloudHealthcareV1beta1DicomGcsDestinationFormProperties {
	...
	export function CreateGoogleCloudHealthcareV1beta1DicomGcsDestinationFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1DicomGcsDestinationFormProperties>({
	...
	/** The configuration for exporting to BigQuery. */
	export interface GoogleCloudHealthcareV1beta1FhirBigQueryDestinationFormProperties {
	...
	export function CreateGoogleCloudHealthcareV1beta1FhirBigQueryDestinationFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirBigQueryDestinationFormProperties>({
	...
	export enum SchemaConfigSchemaType { SCHEMA_TYPE_UNSPECIFIED = 'SCHEMA_TYPE_UNSPECIFIED', LOSSLESS = 'LOSSLESS', ANALYTICS = 'ANALYTICS', ANALYTICS_V2 = 'ANALYTICS_V2' }
	...
	/** The configuration for exporting to Cloud Storage. */
	export interface GoogleCloudHealthcareV1beta1FhirGcsDestinationFormProperties {

		/** URI for a Cloud Storage directory where result files should be written (in the format `gs://{bucket-id}/{path/to/destination/dir}`). If there is no trailing slash, the service appends one when composing the object path. The Cloud Storage bucket referenced in `uri_prefix` must exist or an error occurs. */
		uriPrefix: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudHealthcareV1beta1FhirGcsDestinationFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirGcsDestinationFormProperties>({
			uriPrefix: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface FhirStoreFormProperties {
		...
		/** Optional. Whether to allow the [ImportResourcesHistory] and [ExecuteBundle] APIs to accept history bundles, and directly insert and overwrite historical resource versions into the FHIR store. Importing resource histories creates resource interactions that have occurred in the past that clients might not allow. If set to false, using history bundles fail with an error. */
		enableHistoryModifications: FormControl<boolean | null | undefined>,
	...
	export function CreateFhirStoreFormGroup() {
		return new FormGroup<FhirStoreFormProperties>({
			...
			enableHistoryModifications: new FormControl<boolean | null | undefined>(undefined),
	...
	/** Contains the configuration for FHIR search. */
	export interface SearchConfigFormProperties {
	}
	export function CreateSearchConfigFormGroup() {
		return new FormGroup<SearchConfigFormProperties>({
		});
	...
	/** Contains the versioned name and the URL for one SearchParameter. */
	export interface SearchParameterFormProperties {
	...
	export function CreateSearchParameterFormGroup() {
		return new FormGroup<SearchParameterFormProperties>({
	...
	/** Specifies the configuration for importing data from Cloud Storage. */
	export interface GoogleCloudHealthcareV1beta1AnnotationGcsSource {
	...
	/** Specifies the configuration for importing data from Cloud Storage. */
	export interface GoogleCloudHealthcareV1beta1AnnotationGcsSourceFormProperties {

		/** Points to a Cloud Storage URI containing file(s) with content only. The URI must be in the following format: `gs://{bucket_id}/{object_id}`. The URI can include wildcards in `object_id` and thus identify multiple files. Supported wildcards: '*' to match 0 or more non-separator characters '**' to match 0 or more characters (including separators). Must be used at the end of a path and with no other wildcards in the path. Can also be used with a file extension (such as .dcm), which imports all files with the extension in the specified directory and its sub-directories. For example, `gs://my-bucket/my-directory/**.json` imports all files with .json extensions in `my-directory/` and its sub-directories. '?' to match 1 character All other URI formats are invalid. Files matching the wildcard are expected to contain content only, no metadata. */
		uri: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudHealthcareV1beta1AnnotationGcsSourceFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1AnnotationGcsSourceFormProperties>({
			uri: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The Cloud Storage location for export. */
	export interface GoogleCloudHealthcareV1beta1ConsentGcsDestinationFormProperties {

		/** URI for a Cloud Storage directory where the server writes result files, in the format `gs://{bucket-id}/{path/to/destination/dir}`. If there is no trailing slash, the service appends one when composing the object path. The user is responsible for creating the Cloud Storage bucket and directory referenced in `uri_prefix`. */
		uriPrefix: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudHealthcareV1beta1ConsentGcsDestinationFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1ConsentGcsDestinationFormProperties>({
			uriPrefix: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Contains a summary of the DeidentifyDicomStore operation. */
	export interface GoogleCloudHealthcareV1beta1DeidentifyDeidentifyDicomStoreSummaryFormProperties {
	}
	export function CreateGoogleCloudHealthcareV1beta1DeidentifyDeidentifyDicomStoreSummaryFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1DeidentifyDeidentifyDicomStoreSummaryFormProperties>({
		});
	...
	/** Contains a summary of the DeidentifyFhirStore operation. */
	export interface GoogleCloudHealthcareV1beta1DeidentifyDeidentifyFhirStoreSummaryFormProperties {
	}
	export function CreateGoogleCloudHealthcareV1beta1DeidentifyDeidentifyFhirStoreSummaryFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1DeidentifyDeidentifyFhirStoreSummaryFormProperties>({
		});
	...
	/** Specifies the configuration for importing data from Cloud Storage. */
	export interface GoogleCloudHealthcareV1beta1DicomGcsSourceFormProperties {

		/** Points to a Cloud Storage URI containing file(s) with content only. The URI must be in the following format: `gs://{bucket_id}/{object_id}`. The URI can include wildcards in `object_id` and thus identify multiple files. Supported wildcards: * '*' to match 0 or more non-separator characters * '**' to match 0 or more characters (including separators). Must be used at the end of a path and with no other wildcards in the path. Can also be used with a file extension (such as .dcm), which imports all files with the extension in the specified directory and its sub-directories. For example, `gs://my-bucket/my-directory/**.dcm` imports all files with .dcm extensions in `my-directory/` and its sub-directories. * '?' to match 1 character. All other URI formats are invalid. Files matching the wildcard are expected to contain content only, no metadata. */
		uri: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudHealthcareV1beta1DicomGcsSourceFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1DicomGcsSourceFormProperties>({
			uri: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response when all resources export successfully. This structure is included in the response to describe the detailed outcome after the operation finishes successfully. */
	export interface GoogleCloudHealthcareV1beta1FhirExportResourcesResponseFormProperties {
	}
	export function CreateGoogleCloudHealthcareV1beta1FhirExportResourcesResponseFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirExportResourcesResponseFormProperties>({
		});
	...
	/** Specifies the configuration for importing data from Cloud Storage. */
	export interface GoogleCloudHealthcareV1beta1FhirGcsSourceFormProperties {

		/** Points to a Cloud Storage URI containing file(s) to import. The URI must be in the following format: `gs://{bucket_id}/{object_id}`. The URI can include wildcards in `object_id` and thus identify multiple files. Supported wildcards: * `*` to match 0 or more non-separator characters * `**` to match 0 or more characters (including separators). Must be used at the end of a path and with no other wildcards in the path. Can also be used with a file extension (such as .ndjson), which imports all files with the extension in the specified directory and its sub-directories. For example, `gs://my-bucket/my-directory/**.ndjson` imports all files with `.ndjson` extensions in `my-directory/` and its sub-directories. * `?` to match 1 character Files matching the wildcard are expected to contain content only, no metadata. */
		uri: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudHealthcareV1beta1FhirGcsSourceFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirGcsSourceFormProperties>({
			uri: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Final response of importing resources. This structure is included in the response to describe the detailed outcome after the operation finishes successfully. */
	export interface GoogleCloudHealthcareV1beta1FhirImportResourcesResponseFormProperties {
	}
	export function CreateGoogleCloudHealthcareV1beta1FhirImportResourcesResponseFormGroup() {
		return new FormGroup<GoogleCloudHealthcareV1beta1FhirImportResourcesResponseFormProperties>({
		});
	...
	export interface ImportAnnotationsRequest {
	...
	/** Request to import Annotations. The Annotations to be imported must have client-supplied resource names which indicate the annotation resource. The import operation is not atomic. If a failure occurs, any annotations already imported are not removed. */
	export interface ImportAnnotationsRequestFormProperties {
	}
	export function CreateImportAnnotationsRequestFormGroup() {
		return new FormGroup<ImportAnnotationsRequestFormProperties>({
		});
	...
	/** Final response of importing Annotations in successful case. This structure is included in the response. It is only included when the operation finishes. */
	export interface ImportAnnotationsResponseFormProperties {
	}
	export function CreateImportAnnotationsResponseFormGroup() {
		return new FormGroup<ImportAnnotationsResponseFormProperties>({
		});
	...
	export interface ListAnnotationStoresResponse {
		...
		annotationStores?: Array<AnnotationStore>;
	...
	/** Lists the Annotations in the specified Annotation store. */
	export interface ListAnnotationsResponseFormProperties {

		/** Token to retrieve the next page of results or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListAnnotationsResponseFormGroup() {
		return new FormGroup<ListAnnotationsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface ProgressCounterFormProperties {
		...
		/** The number of secondary units that failed in the operation. */
		secondaryFailure: FormControl<string | null | undefined>,

		/** The number of secondary units that succeeded in the operation. */
		secondarySuccess: FormControl<string | null | undefined>,
	...
	export function CreateProgressCounterFormGroup() {
		return new FormGroup<ProgressCounterFormProperties>({
			...
			secondaryFailure: new FormControl<string | null | undefined>(undefined),
			secondarySuccess: new FormControl<string | null | undefined>(undefined),
	...
	/** Filters to select resources that need to be rolled back. */
	export interface RollbackFhirResourceFilteringFieldsFormProperties {

		/** Optional. A filter expression that matches data in the `Resource.meta` element. Supports all filters in [AIP-160](https://google.aip.dev/160) except the "has" (`:`) operator. Supports the following custom functions: * `tag("") = ""` for tag filtering. * `extension_value_ts("") = ` for filtering extensions with a timestamp, where `` is a Unix timestamp. Supports the `>`, `<`, `<=`, `>=`, and `!=` comparison operators. */
		metadataFilter: FormControl<string | null | undefined>,
	}
	export function CreateRollbackFhirResourceFilteringFieldsFormGroup() {
		return new FormGroup<RollbackFhirResourceFilteringFieldsFormProperties>({
	...
	export interface RollbackFhirResourcesRequest {
		...
		changeType?: RollbackFhirResourcesRequestChangeType | null;
	...
	/** Request to roll back resources. */
	export interface RollbackFhirResourcesRequestFormProperties {

		/** Optional. CREATE/UPDATE/DELETE/ALL for reverting all txns of a certain type. */
		changeType: FormControl<RollbackFhirResourcesRequestChangeType | null | undefined>,

		/** Optional. Specifies whether to exclude earlier rollbacks. */
		excludeRollbacks: FormControl<boolean | null | undefined>,

		/** Optional. When enabled, changes will be reverted without explicit confirmation */
		force: FormControl<boolean | null | undefined>,

		/** Optional. Cloud Storage object containing list of {resourceType}/{resourceId} lines, identifying resources to be reverted */
		inputGcsObject: FormControl<string | null | undefined>,

		/** Required. Bucket to deposit result */
		resultGcsBucket: FormControl<string | null | undefined>,

		/** Required. Time point to rollback to. */
		rollbackTime: FormControl<string | null | undefined>,
	}
	export function CreateRollbackFhirResourcesRequestFormGroup() {
		return new FormGroup<RollbackFhirResourcesRequestFormProperties>({
			changeType: new FormControl<RollbackFhirResourcesRequestChangeType | null | undefined>(undefined),
			excludeRollbacks: new FormControl<boolean | null | undefined>(undefined),
			force: new FormControl<boolean | null | undefined>(undefined),
			inputGcsObject: new FormControl<string | null | undefined>(undefined),
			resultGcsBucket: new FormControl<string | null | undefined>(undefined),
			rollbackTime: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum RollbackFhirResourcesRequestChangeType { CHANGE_TYPE_UNSPECIFIED = 'CHANGE_TYPE_UNSPECIFIED', ALL = 'ALL', CREATE = 'CREATE', UPDATE = 'UPDATE', DELETE = 'DELETE' }
	...
	/** Final response of rollback FIHR resources request. */
	export interface RollbackFhirResourcesResponseFormProperties {

		/** The name of the FHIR store to rollback, in the format of "projects/{project_id}/locations/{location_id}/datasets/{dataset_id} /fhirStores/{fhir_store_id}". */
		fhirStore: FormControl<string | null | undefined>,
	}
	export function CreateRollbackFhirResourcesResponseFormGroup() {
		return new FormGroup<RollbackFhirResourcesResponseFormProperties>({
			fhirStore: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message for `SetBlobStorageSettings` method. */
	export interface SetBlobStorageSettingsRequestFormProperties {
	}
	export function CreateSetBlobStorageSettingsRequestFormGroup() {
		return new FormGroup<SetBlobStorageSettingsRequestFormProperties>({
		});
	...
	/** Returns additional info in regards to a completed set blob storage settings API. */
	export interface SetBlobStorageSettingsResponseFormProperties {
	}
	export function CreateSetBlobStorageSettingsResponseFormGroup() {
		return new FormGroup<SetBlobStorageSettingsResponseFormProperties>({
		});
	...
	export interface StorageInfoFormProperties {
		...
		/** The resource whose storage info is returned. For example, to specify the resource path of a DICOM Instance: `projects/{projectid}/datasets/{datasetid}/dicomStores/{dicom_store_id}/dicomWeb/studi/{study_uid}/series/{series_uid}/instances/{instance_uid}` */
		referencedResource: FormControl<string | null | undefined>,
	}
	export function CreateStorageInfoFormGroup() {
		return new FormGroup<StorageInfoFormProperties>({
			referencedResource: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** StructuredStorageInfo contains details about the data stored in Structured Storage for the referenced resource. */
	export interface StructuredStorageInfoFormProperties {

		/** Size in bytes of data stored in structured storage. */
		sizeBytes: FormControl<string | null | undefined>,
	}
	export function CreateStructuredStorageInfoFormGroup() {
		return new FormGroup<StructuredStorageInfoFormProperties>({
			sizeBytes: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		...
		Healthcare_projects_locations_datasets_consentStores_checkDataAccess(consentStore: string, requestBody: CheckDataAccessRequest): Observable<CheckDataAccessResponse> {
			return this.http.post<CheckDataAccessResponse>(this.baseUri + 'v1beta1/' + (consentStore == null ? '' : encodeURIComponent(consentStore)) + ':checkDataAccess', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_evaluateUserConsents(consentStore: string, requestBody: EvaluateUserConsentsRequest): Observable<EvaluateUserConsentsResponse> {
			return this.http.post<EvaluateUserConsentsResponse>(this.baseUri + 'v1beta1/' + (consentStore == null ? '' : encodeURIComponent(consentStore)) + ':evaluateUserConsents', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_queryAccessibleData(consentStore: string, requestBody: QueryAccessibleDataRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (consentStore == null ? '' : encodeURIComponent(consentStore)) + ':queryAccessibleData', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_operations_get(name: string, view: GcsDestinationMessageView | null | undefined): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&view=' + view, {});
		}
		...
		Healthcare_projects_locations_datasets_hl7V2Stores_messages_patch(name: string, updateMask: string | null | undefined, requestBody: Message): Observable<Message> {
			return this.http.patch<Message>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_update(name: string, requestBody: HttpBody): Observable<HttpBody> {
			return this.http.put<HttpBody>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {HttpBody} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_fhir_Patient_consent_enforcement_status(name: string, _count: number | null | undefined, _page_token: string | null | undefined): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/$consent-enforcement-status&_count=' + _count + '&_page_token=' + (_page_token == null ? '' : encodeURIComponent(_page_token)), {});
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_Patient_everything(name: string, _count: number | null | undefined, _page_token: string | null | undefined, _since: string | null | undefined, _type: string | null | undefined, end: string | null | undefined, start: string | null | undefined): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/$everything&_count=' + _count + '&_page_token=' + (_page_token == null ? '' : encodeURIComponent(_page_token)) + '&_since=' + (_since == null ? '' : encodeURIComponent(_since)) + '&_type=' + (_type == null ? '' : encodeURIComponent(_type)) + '&end=' + (end == null ? '' : encodeURIComponent(end)) + '&start=' + (start == null ? '' : encodeURIComponent(start)), {});
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_Resource_purge(name: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/$purge', {});
		}
		 ...
		 * @param {string} name The URL for the concept map to use for the translation.
		 ...
		 * @param {string} system The system for the code to be translated.
		 * @return {HttpBody} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_fhir_ConceptMap_translate(name: string, code: string | null | undefined, conceptMapVersion: string | null | undefined, system: string | null | undefined): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/$translate&code=' + (code == null ? '' : encodeURIComponent(code)) + '&conceptMapVersion=' + (conceptMapVersion == null ? '' : encodeURIComponent(conceptMapVersion)) + '&system=' + (system == null ? '' : encodeURIComponent(system)), {});
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_history(name: string, _at: string | null | undefined, _count: number | null | undefined, _page_token: string | null | undefined, _since: string | null | undefined): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/_history&_at=' + (_at == null ? '' : encodeURIComponent(_at)) + '&_count=' + _count + '&_page_token=' + (_page_token == null ? '' : encodeURIComponent(_page_token)) + '&_since=' + (_since == null ? '' : encodeURIComponent(_since)), {});
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_capabilities(name: string): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/fhir/metadata', {});
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consents_activate(name: string, requestBody: ActivateConsentRequest): Observable<Consent> {
			return this.http.post<Consent>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':activate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Post v1beta1/{name}:applyAdminConsents
		 * @param {string} name The name of the FHIR store to enforce, in the format `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}`.
		 * @return {Operation} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_applyAdminConsents(name: string, requestBody: ApplyAdminConsentsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':applyAdminConsents', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Post v1beta1/{name}:applyConsents
		 ...
		 * @return {Operation} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_applyConsents(name: string, requestBody: ApplyConsentsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':applyConsents', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_userDataMappings_archive(name: string, requestBody: ArchiveUserDataMappingRequest): Observable<ArchiveUserDataMappingResponse> {
			return this.http.post<ArchiveUserDataMappingResponse>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':archive', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} name The name of the FHIR store to configure, in the format `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}`.
		 * @return {Operation} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_configureSearch(name: string, requestBody: ConfigureSearchRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':configureSearch', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consents_deleteRevision(name: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':deleteRevision', {});
		}
		 ...
		 * @param {string} name The Annotation store to compare against `golden_store`, in the format of `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/annotationStores/{annotation_store_id}`.
		 * @return {Operation} Successful response
		 */
		Healthcare_projects_locations_datasets_annotationStores_evaluate(name: string, requestBody: EvaluateAnnotationStoreRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':evaluate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Get v1beta1/{name}:getDICOMStoreMetrics
		...
		Healthcare_projects_locations_datasets_dicomStores_getDICOMStoreMetrics(name: string): Observable<DicomStoreMetrics> {
			return this.http.get<DicomStoreMetrics>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':getDICOMStoreMetrics', {});
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_getFHIRStoreMetrics(name: string): Observable<FhirStoreMetrics> {
			return this.http.get<FhirStoreMetrics>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':getFHIRStoreMetrics', {});
		}

		/**
		 * Gets metrics associated with the HL7v2 store.
		 * Get v1beta1/{name}:getHL7v2StoreMetrics
		...
		Healthcare_projects_locations_datasets_hl7V2Stores_getHL7v2StoreMetrics(name: string): Observable<Hl7V2StoreMetrics> {
			return this.http.get<Hl7V2StoreMetrics>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':getHL7v2StoreMetrics', {});
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consents_listRevisions(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListConsentRevisionsResponse> {
			return this.http.get<ListConsentRevisionsResponse>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':listRevisions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consents_reject(name: string, requestBody: RejectConsentRequest): Observable<Consent> {
			return this.http.post<Consent>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':reject', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consents_revoke(name: string, requestBody: RevokeConsentRequest): Observable<Consent> {
			return this.http.post<Consent>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':revoke', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_rollback(name: string, requestBody: RollbackFhirResourcesRequest): Observable<Operation> {
		...
		Healthcare_projects_locations_services_nlp_analyzeEntities(nlpService: string, requestBody: AnalyzeEntitiesRequest): Observable<AnalyzeEntitiesResponse> {
			return this.http.post<AnalyzeEntitiesResponse>(this.baseUri + 'v1beta1/' + (nlpService == null ? '' : encodeURIComponent(nlpService)) + ':analyzeEntities', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Healthcare_projects_locations_datasets_annotationStores_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAnnotationStoresResponse> {
			return this.http.get<ListAnnotationStoresResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/annotationStores&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new Annotation store within the parent dataset.
		 * Post v1beta1/{parent}/annotationStores
		 * @param {string} parent The name of the dataset this Annotation store belongs to.
		 * @param {string} annotationStoreId The ID of the Annotation store that is being created. The string must match the following regex: `[\p{L}\p{N}_\-\.]{1,256}`.
		 * @return {AnnotationStore} Successful response
		 */
		Healthcare_projects_locations_datasets_annotationStores_create(parent: string, annotationStoreId: string | null | undefined, requestBody: AnnotationStore): Observable<AnnotationStore> {
			return this.http.post<AnnotationStore>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/annotationStores&annotationStoreId=' + (annotationStoreId == null ? '' : encodeURIComponent(annotationStoreId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Healthcare_projects_locations_datasets_annotationStores_annotations_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Healthcare_projects_locations_datasets_annotationStores_annotations_listView | null | undefined): Observable<ListAnnotationsResponse> {
			return this.http.get<ListAnnotationsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/annotations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		 ...
		 * @param {string} parent The name of the Annotation store this annotation belongs to. For example, `projects/my-project/locations/us-central1/datasets/mydataset/annotationStores/myannotationstore`.
		 * @return {Annotation} Successful response
		 */
		Healthcare_projects_locations_datasets_annotationStores_annotations_create(parent: string, requestBody: Annotation): Observable<Annotation> {
			return this.http.post<Annotation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/annotations', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_attributeDefinitions_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAttributeDefinitionsResponse> {
			return this.http.get<ListAttributeDefinitionsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/attributeDefinitions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_consentStores_attributeDefinitions_create(parent: string, attributeDefinitionId: string | null | undefined, requestBody: AttributeDefinition): Observable<AttributeDefinition> {
			return this.http.post<AttributeDefinition>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/attributeDefinitions&attributeDefinitionId=' + (attributeDefinitionId == null ? '' : encodeURIComponent(attributeDefinitionId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consentArtifacts_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListConsentArtifactsResponse> {
			return this.http.get<ListConsentArtifactsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/consentArtifacts&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consentArtifacts_create(parent: string, requestBody: ConsentArtifact): Observable<ConsentArtifact> {
			return this.http.post<ConsentArtifact>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/consentArtifacts', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListConsentStoresResponse> {
			return this.http.get<ListConsentStoresResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/consentStores&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_consentStores_create(parent: string, consentStoreId: string | null | undefined, requestBody: ConsentStore): Observable<ConsentStore> {
			return this.http.post<ConsentStore>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/consentStores&consentStoreId=' + (consentStoreId == null ? '' : encodeURIComponent(consentStoreId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consents_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListConsentsResponse> {
			return this.http.get<ListConsentsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/consents&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_consentStores_consents_create(parent: string, requestBody: Consent): Observable<Consent> {
			return this.http.post<Consent>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/consents', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDatasetsResponse> {
			return this.http.get<ListDatasetsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/datasets&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_create(parent: string, datasetId: string | null | undefined, requestBody: Dataset): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/datasets&datasetId=' + (datasetId == null ? '' : encodeURIComponent(datasetId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_dicomStores_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDicomStoresResponse> {
			return this.http.get<ListDicomStoresResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dicomStores&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_dicomStores_create(parent: string, dicomStoreId: string | null | undefined, requestBody: DicomStore): Observable<DicomStore> {
			return this.http.post<DicomStore>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dicomStores&dicomStoreId=' + (dicomStoreId == null ? '' : encodeURIComponent(dicomStoreId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_dicomStores_studies_series_instances_delete(parent: string, dicomWebPath: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dicomWeb/' + (dicomWebPath == null ? '' : encodeURIComponent(dicomWebPath)), {});
		}
		...
		Healthcare_projects_locations_datasets_dicomStores_studies_series_instances_frames_retrieveRendered(parent: string, dicomWebPath: string): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dicomWeb/' + (dicomWebPath == null ? '' : encodeURIComponent(dicomWebPath)), {});
		}
		...
		Healthcare_projects_locations_datasets_dicomStores_studies_storeInstances(parent: string, dicomWebPath: string, requestBody: HttpBody): Observable<HttpBody> {
			return this.http.post<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/dicomWeb/' + (dicomWebPath == null ? '' : encodeURIComponent(dicomWebPath)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_executeBundle(parent: string, requestBody: HttpBody): Observable<HttpBody> {
			return this.http.post<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {HttpBody} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_fhir_Resource_incoming_references(parent: string, _count: number | null | undefined, _page_token: string | null | undefined, _summary: string | null | undefined, _type: string | null | undefined, target: string | null | undefined): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/$references&_count=' + _count + '&_page_token=' + (_page_token == null ? '' : encodeURIComponent(_page_token)) + '&_summary=' + (_summary == null ? '' : encodeURIComponent(_summary)) + '&_type=' + (_type == null ? '' : encodeURIComponent(_type)) + '&target=' + (target == null ? '' : encodeURIComponent(target)), {});
		}
		 ...
		 * @param {string} parent The name for the FHIR store containing the concept map(s) to use for the translation.
		 * @param {string} code The code to translate.
		 * @param {string} conceptMapVersion The version of the concept map to use. If unset, the most current version is used.
		 ...
		 * @return {HttpBody} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_fhir_ConceptMap_search_translate(parent: string, code: string | null | undefined, conceptMapVersion: string | null | undefined, source: string | null | undefined, system: string | null | undefined, target: string | null | undefined, url: string | null | undefined): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/ConceptMap/$translate&code=' + (code == null ? '' : encodeURIComponent(code)) + '&conceptMapVersion=' + (conceptMapVersion == null ? '' : encodeURIComponent(conceptMapVersion)) + '&source=' + (source == null ? '' : encodeURIComponent(source)) + '&system=' + (system == null ? '' : encodeURIComponent(system)) + '&target=' + (target == null ? '' : encodeURIComponent(target)) + '&url=' + (url == null ? '' : encodeURIComponent(url)), {});
		}
		 ...
		 * @return {HttpBody} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_fhir_Observation_lastn(parent: string): Observable<HttpBody> {
			return this.http.get<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/Observation/$lastn', {});
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_search(parent: string, requestBody: SearchResourcesRequest): Observable<HttpBody> {
			return this.http.post<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/_search', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} parent Name of the FHIR store to retrieve resources from.
		 * @param {string} resourceType The FHIR resource type to search, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/implement/standards/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/implement/standards/fhir/STU3/resourcelist.html), [R4](https://hl7.org/implement/standards/fhir/R4/resourcelist.html)).
		 * @return {HttpBody} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_fhir_search_type(parent: string, resourceType: string, requestBody: SearchResourcesRequest): Observable<HttpBody> {
			return this.http.post<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/' + (resourceType == null ? '' : encodeURIComponent(resourceType)) + '/_search', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_conditionalDelete(parent: string, type: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/' + (type == null ? '' : encodeURIComponent(type)), {});
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_conditionalPatch(parent: string, type: string, requestBody: HttpBody): Observable<HttpBody> {
			return this.http.patch<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/' + (type == null ? '' : encodeURIComponent(type)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} parent The name of the FHIR store this resource belongs to.
		 * @param {string} type The FHIR resource type to create, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/implement/standards/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/implement/standards/fhir/STU3/resourcelist.html), [R4](https://hl7.org/implement/standards/fhir/R4/resourcelist.html)). Must match the resource type in the provided content.
		 * @return {HttpBody} Successful response
		 */
		Healthcare_projects_locations_datasets_fhirStores_fhir_create(parent: string, type: string, requestBody: HttpBody): Observable<HttpBody> {
			return this.http.post<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/' + (type == null ? '' : encodeURIComponent(type)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_conditionalUpdate(parent: string, type: string, requestBody: HttpBody): Observable<HttpBody> {
			return this.http.put<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/' + (type == null ? '' : encodeURIComponent(type)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_fhir_Resource_validate(parent: string, type: string, profile: string | null | undefined, requestBody: HttpBody): Observable<HttpBody> {
			return this.http.post<HttpBody>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhir/' + (type == null ? '' : encodeURIComponent(type)) + '/$validate&profile=' + (profile == null ? '' : encodeURIComponent(profile)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListFhirStoresResponse> {
			return this.http.get<ListFhirStoresResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhirStores&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_create(parent: string, fhirStoreId: string | null | undefined, requestBody: FhirStore): Observable<FhirStore> {
			return this.http.post<FhirStore>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fhirStores&fhirStoreId=' + (fhirStoreId == null ? '' : encodeURIComponent(fhirStoreId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_hl7V2Stores_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListHl7V2StoresResponse> {
			return this.http.get<ListHl7V2StoresResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/hl7V2Stores&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_hl7V2Stores_create(parent: string, hl7V2StoreId: string | null | undefined, requestBody: Hl7V2Store): Observable<Hl7V2Store> {
			return this.http.post<Hl7V2Store>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/hl7V2Stores&hl7V2StoreId=' + (hl7V2StoreId == null ? '' : encodeURIComponent(hl7V2StoreId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_hl7V2Stores_messages_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: GcsDestinationMessageView | null | undefined): Observable<ListMessagesResponse> {
			return this.http.get<ListMessagesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/messages&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Healthcare_projects_locations_datasets_hl7V2Stores_messages_create(parent: string, requestBody: CreateMessageRequest): Observable<Message> {
			return this.http.post<Message>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/messages', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Gets multiple messages in the given HL7v2 store.
		 * Get v1beta1/{parent}/messages:batchGet
		 * @param {string} parent Name of the HL7v2 store to retrieve messages from, in the format: `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/hl7v2Stores/{hl7v2_store_id}`.
		 ...
		 * @param {GcsDestinationMessageView} view Specifies the parts of the Messages resource to return in the response. When unspecified, equivalent to BASIC.
		 * @return {BatchGetMessagesResponse} Successful response
		 */
		Healthcare_projects_locations_datasets_hl7V2Stores_messages_batchGet(parent: string, ids: Array<string> | null | undefined, view: GcsDestinationMessageView | null | undefined): Observable<BatchGetMessagesResponse> {
			return this.http.get<BatchGetMessagesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/messages:batchGet&' + ids?.map(z => `ids=${encodeURIComponent(z)}`).join('&') + '&view=' + view, {});
		}
		...
		Healthcare_projects_locations_datasets_hl7V2Stores_messages_ingest(parent: string, requestBody: IngestMessageRequest): Observable<IngestMessageResponse> {
			return this.http.post<IngestMessageResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/messages:ingest', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_consentStores_userDataMappings_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListUserDataMappingsResponse> {
			return this.http.get<ListUserDataMappingsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/userDataMappings&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Healthcare_projects_locations_datasets_consentStores_userDataMappings_create(parent: string, requestBody: UserDataMapping): Observable<UserDataMapping> {
			return this.http.post<UserDataMapping>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/userDataMappings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Get v1beta1/{resource}:getStorageInfo
		 ...
		 * @return {StorageInfo} Successful response
		 */
		Healthcare_projects_locations_datasets_dicomStores_dicomWeb_studies_series_instances_getStorageInfo(resource: string): Observable<StorageInfo> {
			return this.http.get<StorageInfo>(this.baseUri + 'v1beta1/' + (resource == null ? '' : encodeURIComponent(resource)) + ':getStorageInfo', {});
		}

		/**
		 * SetBlobStorageSettings sets the blob storage settings of the specified resources.
		 * Post v1beta1/{resource}:setBlobStorageSettings
		 ...
		 * @return {Operation} Successful response
		 */
		Healthcare_projects_locations_datasets_dicomStores_dicomWeb_studies_setBlobStorageSettings(resource: string, requestBody: SetBlobStorageSettingsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (resource == null ? '' : encodeURIComponent(resource)) + ':setBlobStorageSettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Get v1beta1/{series}:getSeriesMetrics
		...
		Healthcare_projects_locations_datasets_dicomStores_dicomWeb_studies_series_getSeriesMetrics(series: string): Observable<SeriesMetrics> {
			return this.http.get<SeriesMetrics>(this.baseUri + 'v1beta1/' + (series == null ? '' : encodeURIComponent(series)) + ':getSeriesMetrics', {});
		}
		...
		Healthcare_projects_locations_datasets_deidentify(sourceDataset: string, requestBody: DeidentifyDatasetRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (sourceDataset == null ? '' : encodeURIComponent(sourceDataset)) + ':deidentify', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Healthcare_projects_locations_datasets_fhirStores_deidentify(sourceStore: string, requestBody: DeidentifyFhirStoreRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (sourceStore == null ? '' : encodeURIComponent(sourceStore)) + ':deidentify', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * GetStudyMetrics returns metrics for a study.
		 * Get v1beta1/{study}:getStudyMetrics
		...
		Healthcare_projects_locations_datasets_dicomStores_dicomWeb_studies_getStudyMetrics(study: string): Observable<StudyMetrics> {
			return this.http.get<StudyMetrics>(this.baseUri + 'v1beta1/' + (study == null ? '' : encodeURIComponent(study)) + ':getStudyMetrics', {});
		}
	}

	export enum Healthcare_projects_locations_datasets_annotationStores_annotations_listView { ANNOTATION_VIEW_UNSPECIFIED = 'ANNOTATION_VIEW_UNSPECIFIED', ANNOTATION_VIEW_BASIC = 'ANNOTATION_VIEW_BASIC', ANNOTATION_VIEW_FULL = 'ANNOTATION_VIEW_FULL' }
