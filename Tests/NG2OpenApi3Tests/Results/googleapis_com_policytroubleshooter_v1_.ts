...
export namespace MyNS {
	...
	/** Information about the principal, resource, and permission to check. */
	export interface GoogleCloudPolicytroubleshooterV1AccessTupleFormProperties {
	...
	export function CreateGoogleCloudPolicytroubleshooterV1AccessTupleFormGroup() {
		return new FormGroup<GoogleCloudPolicytroubleshooterV1AccessTupleFormProperties>({
	...
	export interface GoogleCloudPolicytroubleshooterV1BindingExplanation {
		...
		access?: GoogleCloudPolicytroubleshooterV1BindingExplanationAccess | null;
		...
		memberships?: {[id: string]: GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership };

		/** The relevance of this binding to the overall determination for the entire policy. */
		relevance?: GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null;
		...
		rolePermission?: GoogleCloudPolicytroubleshooterV1BindingExplanationRolePermission | null;

		/** The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy. */
		rolePermissionRelevance?: GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null;
	}

	/** Details about how a binding in a policy affects a principal's ability to use a permission. */
	export interface GoogleCloudPolicytroubleshooterV1BindingExplanationFormProperties {

		/** Required. Indicates whether _this binding_ provides the specified permission to the specified principal for the specified resource. This field does _not_ indicate whether the principal actually has the permission for the resource. There might be another binding that overrides this binding. To determine whether the principal actually has the permission, use the `access` field in the TroubleshootIamPolicyResponse. */
		access: FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAccess | null | undefined>,

		/** Indicates whether each principal in the binding includes the principal specified in the request, either directly or indirectly. Each key identifies a principal in the binding, and each value indicates whether the principal in the binding includes the principal in the request. For example, suppose that a binding includes the following principals: * `user:alice@example.com` * `group:product-eng@example.com` You want to troubleshoot access for `user:bob@example.com`. This user is a principal of the group `group:product-eng@example.com`. For the first principal in the binding, the key is `user:alice@example.com`, and the `membership` field in the value is set to `MEMBERSHIP_NOT_INCLUDED`. For the second principal in the binding, the key is `group:product-eng@example.com`, and the `membership` field in the value is set to `MEMBERSHIP_INCLUDED`. */
		memberships: FormControl<{[id: string]: GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership } | null | undefined>,

		/** The relevance of this binding to the overall determination for the entire policy. */
		relevance: FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>,

		/** The role that this binding grants. For example, `roles/compute.serviceAgent`. For a complete list of predefined IAM roles, as well as the permissions in each role, see https://cloud.google.com/iam/help/roles/reference. */
		role: FormControl<string | null | undefined>,

		/** Indicates whether the role granted by this binding contains the specified permission. */
		rolePermission: FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationRolePermission | null | undefined>,

		/** The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy. */
		rolePermissionRelevance: FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>,
	}
	export function CreateGoogleCloudPolicytroubleshooterV1BindingExplanationFormGroup() {
		return new FormGroup<GoogleCloudPolicytroubleshooterV1BindingExplanationFormProperties>({
			access: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAccess | null | undefined>(undefined),
			memberships: new FormControl<{[id: string]: GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership } | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
			role: new FormControl<string | null | undefined>(undefined),
			rolePermission: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationRolePermission | null | undefined>(undefined),
			rolePermissionRelevance: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudPolicytroubleshooterV1BindingExplanationAccess { ACCESS_STATE_UNSPECIFIED = 'ACCESS_STATE_UNSPECIFIED', GRANTED = 'GRANTED', NOT_GRANTED = 'NOT_GRANTED', UNKNOWN_CONDITIONAL = 'UNKNOWN_CONDITIONAL', UNKNOWN_INFO_DENIED = 'UNKNOWN_INFO_DENIED' }
	...
	export interface GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership {
		...
		membership?: GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipMembership | null;
	...
	/** Details about whether the binding includes the principal. */
	export interface GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipFormProperties {

		/** Indicates whether the binding includes the principal. */
		membership: FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipMembership | null | undefined>,

		/** The relevance of the principal's status to the overall determination for the binding. */
		relevance: FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>,
	}
	export function CreateGoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipFormGroup() {
		return new FormGroup<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipFormProperties>({
			membership: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipMembership | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipMembership { MEMBERSHIP_UNSPECIFIED = 'MEMBERSHIP_UNSPECIFIED', MEMBERSHIP_INCLUDED = 'MEMBERSHIP_INCLUDED', MEMBERSHIP_NOT_INCLUDED = 'MEMBERSHIP_NOT_INCLUDED', MEMBERSHIP_UNKNOWN_INFO_DENIED = 'MEMBERSHIP_UNKNOWN_INFO_DENIED', MEMBERSHIP_UNKNOWN_UNSUPPORTED = 'MEMBERSHIP_UNKNOWN_UNSUPPORTED' }

	export enum GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance { HEURISTIC_RELEVANCE_UNSPECIFIED = 'HEURISTIC_RELEVANCE_UNSPECIFIED', NORMAL = 'NORMAL', HIGH = 'HIGH' }

	export enum GoogleCloudPolicytroubleshooterV1BindingExplanationRolePermission { ROLE_PERMISSION_UNSPECIFIED = 'ROLE_PERMISSION_UNSPECIFIED', ROLE_PERMISSION_INCLUDED = 'ROLE_PERMISSION_INCLUDED', ROLE_PERMISSION_NOT_INCLUDED = 'ROLE_PERMISSION_NOT_INCLUDED', ROLE_PERMISSION_UNKNOWN_INFO_DENIED = 'ROLE_PERMISSION_UNKNOWN_INFO_DENIED' }
	...
	/** Details about how a specific IAM Policy contributed to the access check. */
	export interface GoogleCloudPolicytroubleshooterV1ExplainedPolicyFormProperties {
	...
	export function CreateGoogleCloudPolicytroubleshooterV1ExplainedPolicyFormGroup() {
		return new FormGroup<GoogleCloudPolicytroubleshooterV1ExplainedPolicyFormProperties>({
			access: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAccess | null | undefined>(undefined),
			fullResourceName: new FormControl<string | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});
	...
	/** Request for TroubleshootIamPolicy. */
	export interface GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequestFormProperties {
	}
	export function CreateGoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequestFormGroup() {
		return new FormGroup<GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequestFormProperties>({
		});
	...
	/** Response for TroubleshootIamPolicy. */
	export interface GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponseFormProperties {

		/** Indicates whether the principal has the specified permission for the specified resource, based on evaluating all of the applicable IAM policies. */
		access: FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAccess | null | undefined>,
	}
	export function CreateGoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponseFormGroup() {
		return new FormGroup<GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponseFormProperties>({
			access: new FormControl<GoogleCloudPolicytroubleshooterV1BindingExplanationAccess | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 * @return {GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse} Successful response
		 */
		Policytroubleshooter_iam_troubleshoot(requestBody: GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest): Observable<GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse> {
			return this.http.post<GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse>(this.baseUri + 'v1/iam:troubleshoot', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
