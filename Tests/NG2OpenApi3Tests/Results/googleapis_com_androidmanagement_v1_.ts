...
export namespace MyNS {
	...
	export enum AdvancedSecurityOverridesCommonCriteriaMode { COMMON_CRITERIA_MODE_UNSPECIFIED = 0, COMMON_CRITERIA_MODE_DISABLED = 1, COMMON_CRITERIA_MODE_ENABLED = 2 }

	export enum AdvancedSecurityOverridesDeveloperSettings { DEVELOPER_SETTINGS_UNSPECIFIED = 0, DEVELOPER_SETTINGS_DISABLED = 1, DEVELOPER_SETTINGS_ALLOWED = 2 }

	export enum AdvancedSecurityOverridesGooglePlayProtectVerifyApps { GOOGLE_PLAY_PROTECT_VERIFY_APPS_UNSPECIFIED = 0, VERIFY_APPS_ENFORCED = 1, VERIFY_APPS_USER_CHOICE = 2 }
	...
	export enum ApplicationAppPricing { APP_PRICING_UNSPECIFIED = 0, FREE = 1, FREE_WITH_IN_APP_PURCHASE = 2, PAID = 3 }

	export enum ApplicationContentRating { CONTENT_RATING_UNSPECIFIED = 0, THREE_YEARS = 1, SEVEN_YEARS = 2, TWELVE_YEARS = 3, SIXTEEN_YEARS = 4, EIGHTEEN_YEARS = 5 }

	export enum ApplicationDistributionChannel { DISTRIBUTION_CHANNEL_UNSPECIFIED = 0, PUBLIC_GOOGLE_HOSTED = 1, PRIVATE_GOOGLE_HOSTED = 2, PRIVATE_SELF_HOSTED = 3 }
	...
	export enum ApplicationPolicyAlwaysOnVpnLockdownExemption { ALWAYS_ON_VPN_LOCKDOWN_EXEMPTION_UNSPECIFIED = 0, VPN_LOCKDOWN_ENFORCED = 1, VPN_LOCKDOWN_EXEMPTION = 2 }

	export enum ApplicationPolicyAutoUpdateMode { AUTO_UPDATE_MODE_UNSPECIFIED = 0, AUTO_UPDATE_DEFAULT = 1, AUTO_UPDATE_POSTPONED = 2, AUTO_UPDATE_HIGH_PRIORITY = 3 }

	export enum ApplicationPolicyConnectedWorkAndPersonalApp { CONNECTED_WORK_AND_PERSONAL_APP_UNSPECIFIED = 0, CONNECTED_WORK_AND_PERSONAL_APP_DISALLOWED = 1, CONNECTED_WORK_AND_PERSONAL_APP_ALLOWED = 2 }
	...
	export enum ApplicationPolicyWorkProfileWidgets { WORK_PROFILE_WIDGETS_UNSPECIFIED = 0, WORK_PROFILE_WIDGETS_ALLOWED = 1, WORK_PROFILE_WIDGETS_DISALLOWED = 2 }
	...
	export enum ApplicationReportUserFacingType { USER_FACING_TYPE_UNSPECIFIED = 0, NOT_USER_FACING = 1, USER_FACING = 2 }
	...
	export enum UsageLogEventEventType { EVENT_TYPE_UNSPECIFIED = 0, ADB_SHELL_COMMAND = 1, ADB_SHELL_INTERACTIVE = 2, APP_PROCESS_START = 3, KEYGUARD_DISMISSED = 4, KEYGUARD_DISMISS_AUTH_ATTEMPT = 5, KEYGUARD_SECURED = 6, FILE_PULLED = 7, FILE_PUSHED = 8, CERT_AUTHORITY_INSTALLED = 9, CERT_AUTHORITY_REMOVED = 10, CERT_VALIDATION_FAILURE = 11, CRYPTO_SELF_TEST_COMPLETED = 12, KEY_DESTRUCTION = 13, KEY_GENERATED = 14, KEY_IMPORT = 15, KEY_INTEGRITY_VIOLATION = 16, LOGGING_STARTED = 17, LOGGING_STOPPED = 18, LOG_BUFFER_SIZE_CRITICAL = 19, MEDIA_MOUNT = 20, MEDIA_UNMOUNT = 21, OS_SHUTDOWN = 22, OS_STARTUP = 23, REMOTE_LOCK = 24, WIPE_FAILURE = 25, CONNECT = 26, DNS = 27, STOP_LOST_MODE_USER_ATTEMPT = 28, LOST_MODE_OUTGOING_PHONE_CALL = 29, LOST_MODE_LOCATION = 30, ENROLLMENT_COMPLETE = 31 }
	...
	export enum OsStartupEventVerifiedBootState { VERIFIED_BOOT_STATE_UNSPECIFIED = 0, GREEN = 1, YELLOW = 2, ORANGE = 3 }

	export enum OsStartupEventVerityMode { DM_VERITY_MODE_UNSPECIFIED = 0, ENFORCING = 1, IO_ERROR = 2, DISABLED = 3 }
	...
	export enum StopLostModeUserAttemptEventStatus { STATUS_UNSPECIFIED = 0, ATTEMPT_SUCCEEDED = 1, ATTEMPT_FAILED = 2 }
	...
	export enum BlockActionBlockScope { BLOCK_SCOPE_UNSPECIFIED = 0, BLOCK_SCOPE_WORK_PROFILE = 1, BLOCK_SCOPE_DEVICE = 2 }
	...
	export enum PerAppResultClearingResult { CLEARING_RESULT_UNSPECIFIED = 0, SUCCESS = 1, APP_NOT_FOUND = 2, APP_PROTECTED = 3, API_LEVEL = 4 }
	...
	export enum StartLostModeStatusStatus { STATUS_UNSPECIFIED = 0, SUCCESS = 1, RESET_PASSWORD_RECENTLY = 2, USER_EXIT_LOST_MODE_RECENTLY = 3, ALREADY_IN_LOST_MODE = 4 }
	...
	export enum StopLostModeStatusStatus { STATUS_UNSPECIFIED = 0, SUCCESS = 1, NOT_IN_LOST_MODE = 2 }

	export enum CommandType { COMMAND_TYPE_UNSPECIFIED = 0, LOCK = 1, RESET_PASSWORD = 2, REBOOT = 3, RELINQUISH_OWNERSHIP = 4, CLEAR_APP_DATA = 5, START_LOST_MODE = 6, STOP_LOST_MODE = 7 }
	...
	export enum CommonCriteriaModeInfoCommonCriteriaModeStatus { COMMON_CRITERIA_MODE_STATUS_UNKNOWN = 0, COMMON_CRITERIA_MODE_DISABLED = 1, COMMON_CRITERIA_MODE_ENABLED = 2 }
	...
	export enum NonComplianceDetailConditionNonComplianceReason { NON_COMPLIANCE_REASON_UNSPECIFIED = 0, API_LEVEL = 1, MANAGEMENT_MODE = 2, USER_ACTION = 3, INVALID_VALUE = 4, APP_NOT_INSTALLED = 5, UNSUPPORTED = 6, APP_INSTALLED = 7, PENDING = 8, APP_INCOMPATIBLE = 9, APP_NOT_UPDATED = 10, DEVICE_INCOMPATIBLE = 11 }
	...
	export enum CrossProfilePoliciesCrossProfileCopyPaste { CROSS_PROFILE_COPY_PASTE_UNSPECIFIED = 0, COPY_FROM_WORK_TO_PERSONAL_DISALLOWED = 1, CROSS_PROFILE_COPY_PASTE_ALLOWED = 2 }

	export enum CrossProfilePoliciesCrossProfileDataSharing { CROSS_PROFILE_DATA_SHARING_UNSPECIFIED = 0, CROSS_PROFILE_DATA_SHARING_DISALLOWED = 1, DATA_SHARING_FROM_WORK_TO_PERSONAL_DISALLOWED = 2, CROSS_PROFILE_DATA_SHARING_ALLOWED = 3 }
	...
	export enum CrossProfilePoliciesShowWorkContactsInPersonalProfile { SHOW_WORK_CONTACTS_IN_PERSONAL_PROFILE_UNSPECIFIED = 0, SHOW_WORK_CONTACTS_IN_PERSONAL_PROFILE_DISALLOWED = 1, SHOW_WORK_CONTACTS_IN_PERSONAL_PROFILE_ALLOWED = 2, SHOW_WORK_CONTACTS_IN_PERSONAL_PROFILE_DISALLOWED_EXCEPT_SYSTEM = 3 }

	export enum CrossProfilePoliciesWorkProfileWidgetsDefault { WORK_PROFILE_WIDGETS_DEFAULT_UNSPECIFIED = 0, WORK_PROFILE_WIDGETS_DEFAULT_ALLOWED = 1, WORK_PROFILE_WIDGETS_DEFAULT_DISALLOWED = 2 }
	...
	export enum PasswordRequirementsPasswordQuality { PASSWORD_QUALITY_UNSPECIFIED = 0, BIOMETRIC_WEAK = 1, SOMETHING = 2, NUMERIC = 3, NUMERIC_COMPLEX = 4, ALPHABETIC = 5, ALPHANUMERIC = 6, COMPLEX = 7, COMPLEXITY_LOW = 8, COMPLEXITY_MEDIUM = 9, COMPLEXITY_HIGH = 10 }
	...
	export enum PasswordRequirementsUnifiedLockSettings { UNIFIED_LOCK_SETTINGS_UNSPECIFIED = 0, ALLOW_UNIFIED_WORK_AND_PERSONAL_LOCK = 1, REQUIRE_SEPARATE_WORK_LOCK = 2 }

	export enum DeviceAppliedState { DEVICE_STATE_UNSPECIFIED = 0, ACTIVE = 1, DISABLED = 2, DELETED = 3, PROVISIONING = 4, LOST = 5 }
	...
	export enum NonComplianceDetailSpecificNonComplianceReason { SPECIFIC_NON_COMPLIANCE_REASON_UNSPECIFIED = 0, PASSWORD_POLICIES_USER_CREDENTIALS_CONFIRMATION_REQUIRED = 1, PASSWORD_POLICIES_PASSWORD_EXPIRED = 2, PASSWORD_POLICIES_PASSWORD_NOT_SUFFICIENT = 3, ONC_WIFI_INVALID_VALUE = 4, ONC_WIFI_API_LEVEL = 5, ONC_WIFI_INVALID_ENTERPRISE_CONFIG = 6 }

	export enum DeviceOwnership { OWNERSHIP_UNSPECIFIED = 0, COMPANY_OWNED = 1, PERSONALLY_OWNED = 2 }
	...
	export enum PostureDetailSecurityRisk { SECURITY_RISK_UNSPECIFIED = 0, UNKNOWN_OS = 1, COMPROMISED_OS = 2, HARDWARE_BACKED_EVALUATION_FAILED = 3 }
	...
	export enum SystemUpdateInfoUpdateStatus { UPDATE_STATUS_UNKNOWN = 0, UP_TO_DATE = 1, UNKNOWN_UPDATE_AVAILABLE = 2, SECURITY_UPDATE_AVAILABLE = 3, OS_UPDATE_AVAILABLE = 4 }
	...
	export enum DeviceConnectivityManagementConfigureWifi { CONFIGURE_WIFI_UNSPECIFIED = 0, ALLOW_CONFIGURING_WIFI = 1, DISALLOW_ADD_WIFI_CONFIG = 2, DISALLOW_CONFIGURING_WIFI = 3 }

	export enum DeviceConnectivityManagementTetheringSettings { TETHERING_SETTINGS_UNSPECIFIED = 0, ALLOW_ALL_TETHERING = 1, DISALLOW_WIFI_TETHERING = 2, DISALLOW_ALL_TETHERING = 3 }

	export enum DeviceConnectivityManagementUsbDataAccess { USB_DATA_ACCESS_UNSPECIFIED = 0, ALLOW_USB_DATA_TRANSFER = 1, DISALLOW_USB_FILE_TRANSFER = 2, DISALLOW_USB_DATA_TRANSFER = 3 }

	export enum DeviceConnectivityManagementWifiDirectSettings { WIFI_DIRECT_SETTINGS_UNSPECIFIED = 0, ALLOW_WIFI_DIRECT = 1, DISALLOW_WIFI_DIRECT = 2 }
	...
	export enum DeviceRadioStateAirplaneModeState { AIRPLANE_MODE_STATE_UNSPECIFIED = 0, AIRPLANE_MODE_USER_CHOICE = 1, AIRPLANE_MODE_DISABLED = 2 }

	export enum DeviceRadioStateCellularTwoGState { CELLULAR_TWO_G_STATE_UNSPECIFIED = 0, CELLULAR_TWO_G_USER_CHOICE = 1, CELLULAR_TWO_G_DISABLED = 2 }

	export enum DeviceRadioStateMinimumWifiSecurityLevel { MINIMUM_WIFI_SECURITY_LEVEL_UNSPECIFIED = 0, OPEN_NETWORK_SECURITY = 1, PERSONAL_NETWORK_SECURITY = 2, ENTERPRISE_NETWORK_SECURITY = 3 }

	export enum DeviceRadioStateUltraWidebandState { ULTRA_WIDEBAND_STATE_UNSPECIFIED = 0, ULTRA_WIDEBAND_USER_CHOICE = 1, ULTRA_WIDEBAND_DISABLED = 2 }

	export enum DeviceRadioStateWifiState { WIFI_STATE_UNSPECIFIED = 0, WIFI_STATE_USER_CHOICE = 1, WIFI_ENABLED = 2, WIFI_DISABLED = 3 }
	...
	export enum EnrollmentTokenAllowPersonalUsage { ALLOW_PERSONAL_USAGE_UNSPECIFIED = 0, PERSONAL_USAGE_ALLOWED = 1, PERSONAL_USAGE_DISALLOWED = 2 }
	...
	export enum PolicyAutoDateAndTimeZone { AUTO_DATE_AND_TIME_ZONE_UNSPECIFIED = 0, AUTO_DATE_AND_TIME_ZONE_USER_CHOICE = 1, AUTO_DATE_AND_TIME_ZONE_ENFORCED = 2 }

	export enum PolicyCameraAccess { CAMERA_ACCESS_UNSPECIFIED = 0, CAMERA_ACCESS_USER_CHOICE = 1, CAMERA_ACCESS_DISABLED = 2, CAMERA_ACCESS_ENFORCED = 3 }

	export enum PolicyEncryptionPolicy { ENCRYPTION_POLICY_UNSPECIFIED = 0, ENABLED_WITHOUT_PASSWORD = 1, ENABLED_WITH_PASSWORD = 2 }

	export enum PolicyLocationMode { LOCATION_MODE_UNSPECIFIED = 0, HIGH_ACCURACY = 1, SENSORS_ONLY = 2, BATTERY_SAVING = 3, OFF = 4, LOCATION_USER_CHOICE = 5, LOCATION_ENFORCED = 6, LOCATION_DISABLED = 7 }

	export enum PolicyMicrophoneAccess { MICROPHONE_ACCESS_UNSPECIFIED = 0, MICROPHONE_ACCESS_USER_CHOICE = 1, MICROPHONE_ACCESS_DISABLED = 2, MICROPHONE_ACCESS_ENFORCED = 3 }
	...
	export enum PersonalApplicationPolicyInstallType { INSTALL_TYPE_UNSPECIFIED = 0, BLOCKED = 1, AVAILABLE = 2 }

	export enum PersonalUsagePoliciesPersonalPlayStoreMode { PLAY_STORE_MODE_UNSPECIFIED = 0, BLACKLIST = 1, BLOCKLIST = 2, ALLOWLIST = 3 }
	...
	export enum PolicyPreferentialNetworkService { PREFERENTIAL_NETWORK_SERVICE_UNSPECIFIED = 0, PREFERENTIAL_NETWORK_SERVICE_DISABLED = 1, PREFERENTIAL_NETWORK_SERVICE_ENABLED = 2 }
	...
	export enum Androidmanagement_enterprises_listView { ENTERPRISE_VIEW_UNSPECIFIED = 0, BASIC = 1 }
