...
export namespace MyNS {
	...
	export enum GoogleCloudAdvisorynotificationsV1TextLocalizationState { LOCALIZATION_STATE_UNSPECIFIED = 'LOCALIZATION_STATE_UNSPECIFIED', LOCALIZATION_STATE_NOT_APPLICABLE = 'LOCALIZATION_STATE_NOT_APPLICABLE', LOCALIZATION_STATE_PENDING = 'LOCALIZATION_STATE_PENDING', LOCALIZATION_STATE_COMPLETED = 'LOCALIZATION_STATE_COMPLETED' }

	export enum GoogleCloudAdvisorynotificationsV1NotificationNotificationType { NOTIFICATION_TYPE_UNSPECIFIED = 'NOTIFICATION_TYPE_UNSPECIFIED', NOTIFICATION_TYPE_SECURITY_PRIVACY_ADVISORY = 'NOTIFICATION_TYPE_SECURITY_PRIVACY_ADVISORY', NOTIFICATION_TYPE_SENSITIVE_ACTIONS = 'NOTIFICATION_TYPE_SENSITIVE_ACTIONS', NOTIFICATION_TYPE_SECURITY_MSA = 'NOTIFICATION_TYPE_SECURITY_MSA', NOTIFICATION_TYPE_THREAT_HORIZONS = 'NOTIFICATION_TYPE_THREAT_HORIZONS' }
	...
	export enum Advisorynotifications_projects_locations_notifications_listView { NOTIFICATION_VIEW_UNSPECIFIED = 'NOTIFICATION_VIEW_UNSPECIFIED', BASIC = 'BASIC', FULL = 'FULL' }
