...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {CemstPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Cemst(requestBody: CemstPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'cemst/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {CfmstPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Cfmst(requestBody: CfmstPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'cfmst/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {MicerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Micer(requestBody: MicerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'micer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	...
	export interface CemstPostBody {
		certificateParameters?: CemstPostBodyCertificateParameters;
	...
	export interface CemstPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<CemstPostBodyFormat | null | undefined>,
	...
	export function CreateCemstPostBodyFormGroup() {
		return new FormGroup<CemstPostBodyFormProperties>({
			format: new FormControl<CemstPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface CemstPostBodyCertificateParameters {
	...
	export interface CemstPostBodyCertificateParametersFormProperties {
	...
	export function CreateCemstPostBodyCertificateParametersFormGroup() {
		return new FormGroup<CemstPostBodyCertificateParametersFormProperties>({
	...
	export interface CfmstPostBodyFormProperties {
	...
	export function CreateCfmstPostBodyFormGroup() {
		return new FormGroup<CfmstPostBodyFormProperties>({
			format: new FormControl<CemstPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface CfmstPostBodyCertificateParameters {
	...
	export interface CfmstPostBodyCertificateParametersFormProperties {
	...
	export function CreateCfmstPostBodyCertificateParametersFormGroup() {
		return new FormGroup<CfmstPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export interface MicerPostBody {
		certificateParameters?: MicerPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface MicerPostBodyFormProperties {
	...
	export function CreateMicerPostBodyFormGroup() {
		return new FormGroup<MicerPostBodyFormProperties>({
			format: new FormControl<CemstPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface MicerPostBodyCertificateParameters {
	...
	export interface MicerPostBodyCertificateParametersFormProperties {
	...
	export function CreateMicerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<MicerPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
