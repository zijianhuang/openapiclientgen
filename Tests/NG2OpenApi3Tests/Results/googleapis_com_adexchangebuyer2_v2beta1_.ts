...
export namespace MyNS {
	...
	export enum AdSizeSizeType { SIZE_TYPE_UNSPECIFIED = 'SIZE_TYPE_UNSPECIFIED', PIXEL = 'PIXEL', INTERSTITIAL = 'INTERSTITIAL', NATIVE = 'NATIVE', FLUID = 'FLUID' }
	...
	export enum BidResponseWithoutBidsStatusRowStatus { STATUS_UNSPECIFIED = 'STATUS_UNSPECIFIED', RESPONSES_WITHOUT_BIDS = 'RESPONSES_WITHOUT_BIDS', RESPONSES_WITHOUT_BIDS_FOR_ACCOUNT = 'RESPONSES_WITHOUT_BIDS_FOR_ACCOUNT', RESPONSES_WITHOUT_BIDS_FOR_DEAL = 'RESPONSES_WITHOUT_BIDS_FOR_DEAL' }
	...
	export enum ClientEntityType { ENTITY_TYPE_UNSPECIFIED = 'ENTITY_TYPE_UNSPECIFIED', ADVERTISER = 'ADVERTISER', BRAND = 'BRAND', AGENCY = 'AGENCY', ENTITY_TYPE_UNCLASSIFIED = 'ENTITY_TYPE_UNCLASSIFIED' }
	...
	export enum ClientStatus { CLIENT_STATUS_UNSPECIFIED = 'CLIENT_STATUS_UNSPECIFIED', DISABLED = 'DISABLED', ACTIVE = 'ACTIVE' }
	...
	export enum ClientUserStatus { USER_STATUS_UNSPECIFIED = 'USER_STATUS_UNSPECIFIED', PENDING = 'PENDING', ACTIVE = 'ACTIVE', DISABLED = 'DISABLED' }
	...
	export enum ServingContextAll { SIMPLE_CONTEXT = 'SIMPLE_CONTEXT' }
	...
	export enum CorrectionType { CORRECTION_TYPE_UNSPECIFIED = 'CORRECTION_TYPE_UNSPECIFIED', VENDOR_IDS_ADDED = 'VENDOR_IDS_ADDED', SSL_ATTRIBUTE_REMOVED = 'SSL_ATTRIBUTE_REMOVED', FLASH_FREE_ATTRIBUTE_REMOVED = 'FLASH_FREE_ATTRIBUTE_REMOVED', FLASH_FREE_ATTRIBUTE_ADDED = 'FLASH_FREE_ATTRIBUTE_ADDED', REQUIRED_ATTRIBUTE_ADDED = 'REQUIRED_ATTRIBUTE_ADDED', REQUIRED_VENDOR_ADDED = 'REQUIRED_VENDOR_ADDED', SSL_ATTRIBUTE_ADDED = 'SSL_ATTRIBUTE_ADDED', IN_BANNER_VIDEO_ATTRIBUTE_ADDED = 'IN_BANNER_VIDEO_ATTRIBUTE_ADDED', MRAID_ATTRIBUTE_ADDED = 'MRAID_ATTRIBUTE_ADDED', FLASH_ATTRIBUTE_REMOVED = 'FLASH_ATTRIBUTE_REMOVED', VIDEO_IN_SNIPPET_ATTRIBUTE_ADDED = 'VIDEO_IN_SNIPPET_ATTRIBUTE_ADDED' }
	...
	export enum CreativeDealsStatus { STATUS_UNSPECIFIED = 'STATUS_UNSPECIFIED', NOT_CHECKED = 'NOT_CHECKED', CONDITIONALLY_APPROVED = 'CONDITIONALLY_APPROVED', APPROVED = 'APPROVED', DISAPPROVED = 'DISAPPROVED', PENDING_REVIEW = 'PENDING_REVIEW', STATUS_TYPE_UNSPECIFIED = 'STATUS_TYPE_UNSPECIFIED' }
	...
	export enum DisapprovalReason { LENGTH_OF_IMAGE_ANIMATION = 'LENGTH_OF_IMAGE_ANIMATION', BROKEN_URL = 'BROKEN_URL', MEDIA_NOT_FUNCTIONAL = 'MEDIA_NOT_FUNCTIONAL', INVALID_FOURTH_PARTY_CALL = 'INVALID_FOURTH_PARTY_CALL', INCORRECT_REMARKETING_DECLARATION = 'INCORRECT_REMARKETING_DECLARATION', LANDING_PAGE_ERROR = 'LANDING_PAGE_ERROR', AD_SIZE_DOES_NOT_MATCH_AD_SLOT = 'AD_SIZE_DOES_NOT_MATCH_AD_SLOT', NO_BORDER = 'NO_BORDER', FOURTH_PARTY_BROWSER_COOKIES = 'FOURTH_PARTY_BROWSER_COOKIES', LSO_OBJECTS = 'LSO_OBJECTS', BLANK_CREATIVE = 'BLANK_CREATIVE', DESTINATION_URLS_UNDECLARED = 'DESTINATION_URLS_UNDECLARED', PROBLEM_WITH_CLICK_MACRO = 'PROBLEM_WITH_CLICK_MACRO', INCORRECT_AD_TECHNOLOGY_DECLARATION = 'INCORRECT_AD_TECHNOLOGY_DECLARATION', INCORRECT_DESTINATION_URL_DECLARATION = 'INCORRECT_DESTINATION_URL_DECLARATION', EXPANDABLE_INCORRECT_DIRECTION = 'EXPANDABLE_INCORRECT_DIRECTION', EXPANDABLE_DIRECTION_NOT_SUPPORTED = 'EXPANDABLE_DIRECTION_NOT_SUPPORTED', EXPANDABLE_INVALID_VENDOR = 'EXPANDABLE_INVALID_VENDOR', EXPANDABLE_FUNCTIONALITY = 'EXPANDABLE_FUNCTIONALITY', VIDEO_INVALID_VENDOR = 'VIDEO_INVALID_VENDOR', VIDEO_UNSUPPORTED_LENGTH = 'VIDEO_UNSUPPORTED_LENGTH', VIDEO_UNSUPPORTED_FORMAT = 'VIDEO_UNSUPPORTED_FORMAT', VIDEO_FUNCTIONALITY = 'VIDEO_FUNCTIONALITY', LANDING_PAGE_DISABLED = 'LANDING_PAGE_DISABLED', MALWARE_SUSPECTED = 'MALWARE_SUSPECTED', ADULT_IMAGE_OR_VIDEO = 'ADULT_IMAGE_OR_VIDEO', INACCURATE_AD_TEXT = 'INACCURATE_AD_TEXT', COUNTERFEIT_DESIGNER_GOODS = 'COUNTERFEIT_DESIGNER_GOODS', POP_UP = 'POP_UP', INVALID_RTB_PROTOCOL_USAGE = 'INVALID_RTB_PROTOCOL_USAGE', RAW_IP_ADDRESS_IN_SNIPPET = 'RAW_IP_ADDRESS_IN_SNIPPET', UNACCEPTABLE_CONTENT_SOFTWARE = 'UNACCEPTABLE_CONTENT_SOFTWARE', UNAUTHORIZED_COOKIE_ON_GOOGLE_DOMAIN = 'UNAUTHORIZED_COOKIE_ON_GOOGLE_DOMAIN', UNDECLARED_FLASH_OBJECTS = 'UNDECLARED_FLASH_OBJECTS', INVALID_SSL_DECLARATION = 'INVALID_SSL_DECLARATION', DIRECT_DOWNLOAD_IN_AD = 'DIRECT_DOWNLOAD_IN_AD', MAXIMUM_DOWNLOAD_SIZE_EXCEEDED = 'MAXIMUM_DOWNLOAD_SIZE_EXCEEDED', DESTINATION_URL_SITE_NOT_CRAWLABLE = 'DESTINATION_URL_SITE_NOT_CRAWLABLE', BAD_URL_LEGAL_DISAPPROVAL = 'BAD_URL_LEGAL_DISAPPROVAL', PHARMA_GAMBLING_ALCOHOL_NOT_ALLOWED = 'PHARMA_GAMBLING_ALCOHOL_NOT_ALLOWED', DYNAMIC_DNS_AT_DESTINATION_URL = 'DYNAMIC_DNS_AT_DESTINATION_URL', POOR_IMAGE_OR_VIDEO_QUALITY = 'POOR_IMAGE_OR_VIDEO_QUALITY', UNACCEPTABLE_IMAGE_CONTENT = 'UNACCEPTABLE_IMAGE_CONTENT', INCORRECT_IMAGE_LAYOUT = 'INCORRECT_IMAGE_LAYOUT', IRRELEVANT_IMAGE_OR_VIDEO = 'IRRELEVANT_IMAGE_OR_VIDEO', DESTINATION_SITE_DOES_NOT_ALLOW_GOING_BACK = 'DESTINATION_SITE_DOES_NOT_ALLOW_GOING_BACK', MISLEADING_CLAIMS_IN_AD = 'MISLEADING_CLAIMS_IN_AD', RESTRICTED_PRODUCTS = 'RESTRICTED_PRODUCTS', UNACCEPTABLE_CONTENT = 'UNACCEPTABLE_CONTENT', AUTOMATED_AD_CLICKING = 'AUTOMATED_AD_CLICKING', INVALID_URL_PROTOCOL = 'INVALID_URL_PROTOCOL', UNDECLARED_RESTRICTED_CONTENT = 'UNDECLARED_RESTRICTED_CONTENT', INVALID_REMARKETING_LIST_USAGE = 'INVALID_REMARKETING_LIST_USAGE', DESTINATION_SITE_NOT_CRAWLABLE_ROBOTS_TXT = 'DESTINATION_SITE_NOT_CRAWLABLE_ROBOTS_TXT', CLICK_TO_DOWNLOAD_NOT_AN_APP = 'CLICK_TO_DOWNLOAD_NOT_AN_APP', INACCURATE_REVIEW_EXTENSION = 'INACCURATE_REVIEW_EXTENSION', SEXUALLY_EXPLICIT_CONTENT = 'SEXUALLY_EXPLICIT_CONTENT', GAINING_AN_UNFAIR_ADVANTAGE = 'GAINING_AN_UNFAIR_ADVANTAGE', GAMING_THE_GOOGLE_NETWORK = 'GAMING_THE_GOOGLE_NETWORK', DANGEROUS_PRODUCTS_KNIVES = 'DANGEROUS_PRODUCTS_KNIVES', DANGEROUS_PRODUCTS_EXPLOSIVES = 'DANGEROUS_PRODUCTS_EXPLOSIVES', DANGEROUS_PRODUCTS_GUNS = 'DANGEROUS_PRODUCTS_GUNS', DANGEROUS_PRODUCTS_DRUGS = 'DANGEROUS_PRODUCTS_DRUGS', DANGEROUS_PRODUCTS_TOBACCO = 'DANGEROUS_PRODUCTS_TOBACCO', DANGEROUS_PRODUCTS_WEAPONS = 'DANGEROUS_PRODUCTS_WEAPONS', UNCLEAR_OR_IRRELEVANT_AD = 'UNCLEAR_OR_IRRELEVANT_AD', PROFESSIONAL_STANDARDS = 'PROFESSIONAL_STANDARDS', DYSFUNCTIONAL_PROMOTION = 'DYSFUNCTIONAL_PROMOTION', INVALID_INTEREST_BASED_AD = 'INVALID_INTEREST_BASED_AD', MISUSE_OF_PERSONAL_INFORMATION = 'MISUSE_OF_PERSONAL_INFORMATION', OMISSION_OF_RELEVANT_INFORMATION = 'OMISSION_OF_RELEVANT_INFORMATION', UNAVAILABLE_PROMOTIONS = 'UNAVAILABLE_PROMOTIONS', MISLEADING_PROMOTIONS = 'MISLEADING_PROMOTIONS', INAPPROPRIATE_CONTENT = 'INAPPROPRIATE_CONTENT', SENSITIVE_EVENTS = 'SENSITIVE_EVENTS', SHOCKING_CONTENT = 'SHOCKING_CONTENT', ENABLING_DISHONEST_BEHAVIOR = 'ENABLING_DISHONEST_BEHAVIOR', TECHNICAL_REQUIREMENTS = 'TECHNICAL_REQUIREMENTS', RESTRICTED_POLITICAL_CONTENT = 'RESTRICTED_POLITICAL_CONTENT', UNSUPPORTED_CONTENT = 'UNSUPPORTED_CONTENT', INVALID_BIDDING_METHOD = 'INVALID_BIDDING_METHOD', VIDEO_TOO_LONG = 'VIDEO_TOO_LONG', VIOLATES_JAPANESE_PHARMACY_LAW = 'VIOLATES_JAPANESE_PHARMACY_LAW', UNACCREDITED_PET_PHARMACY = 'UNACCREDITED_PET_PHARMACY', ABORTION = 'ABORTION', CONTRACEPTIVES = 'CONTRACEPTIVES', NEED_CERTIFICATES_TO_ADVERTISE_IN_CHINA = 'NEED_CERTIFICATES_TO_ADVERTISE_IN_CHINA', KCDSP_REGISTRATION = 'KCDSP_REGISTRATION', NOT_FAMILY_SAFE = 'NOT_FAMILY_SAFE', CLINICAL_TRIAL_RECRUITMENT = 'CLINICAL_TRIAL_RECRUITMENT', MAXIMUM_NUMBER_OF_HTTP_CALLS_EXCEEDED = 'MAXIMUM_NUMBER_OF_HTTP_CALLS_EXCEEDED', MAXIMUM_NUMBER_OF_COOKIES_EXCEEDED = 'MAXIMUM_NUMBER_OF_COOKIES_EXCEEDED', PERSONAL_LOANS = 'PERSONAL_LOANS', UNSUPPORTED_FLASH_CONTENT = 'UNSUPPORTED_FLASH_CONTENT', MISUSE_BY_OMID_SCRIPT = 'MISUSE_BY_OMID_SCRIPT', NON_WHITELISTED_OMID_VENDOR = 'NON_WHITELISTED_OMID_VENDOR', DESTINATION_EXPERIENCE = 'DESTINATION_EXPERIENCE', UNSUPPORTED_LANGUAGE = 'UNSUPPORTED_LANGUAGE', NON_SSL_COMPLIANT = 'NON_SSL_COMPLIANT', TEMPORARY_PAUSE = 'TEMPORARY_PAUSE', BAIL_BONDS = 'BAIL_BONDS', EXPERIMENTAL_MEDICAL_TREATMENT = 'EXPERIMENTAL_MEDICAL_TREATMENT' }

	export enum ServingRestrictionStatus { STATUS_UNSPECIFIED = 'STATUS_UNSPECIFIED', DISAPPROVAL = 'DISAPPROVAL', PENDING_REVIEW = 'PENDING_REVIEW' }
	...
	export enum CreativeRestrictionsCreativeFormat { CREATIVE_FORMAT_UNSPECIFIED = 'CREATIVE_FORMAT_UNSPECIFIED', DISPLAY = 'DISPLAY', VIDEO = 'VIDEO' }
	...
	export enum CreativeRestrictionsSkippableAdType { SKIPPABLE_AD_TYPE_UNSPECIFIED = 'SKIPPABLE_AD_TYPE_UNSPECIFIED', SKIPPABLE = 'SKIPPABLE', INSTREAM_SELECT = 'INSTREAM_SELECT', NOT_SKIPPABLE = 'NOT_SKIPPABLE' }
	...
	export enum CreativeSizeCreativeSizeType { CREATIVE_SIZE_TYPE_UNSPECIFIED = 'CREATIVE_SIZE_TYPE_UNSPECIFIED', REGULAR = 'REGULAR', INTERSTITIAL = 'INTERSTITIAL', VIDEO = 'VIDEO', NATIVE = 'NATIVE' }

	export enum CreativeSizeNativeTemplate { UNKNOWN_NATIVE_TEMPLATE = 'UNKNOWN_NATIVE_TEMPLATE', NATIVE_CONTENT_AD = 'NATIVE_CONTENT_AD', NATIVE_APP_INSTALL_AD = 'NATIVE_APP_INSTALL_AD', NATIVE_VIDEO_CONTENT_AD = 'NATIVE_VIDEO_CONTENT_AD', NATIVE_VIDEO_APP_INSTALL_AD = 'NATIVE_VIDEO_APP_INSTALL_AD' }

	export enum CreativeSizeSkippableAdType { SKIPPABLE_AD_TYPE_UNSPECIFIED = 'SKIPPABLE_AD_TYPE_UNSPECIFIED', GENERIC = 'GENERIC', INSTREAM_SELECT = 'INSTREAM_SELECT', NOT_SKIPPABLE = 'NOT_SKIPPABLE' }
	...
	export enum DayPartTargetingTimeZoneType { TIME_ZONE_SOURCE_UNSPECIFIED = 'TIME_ZONE_SOURCE_UNSPECIFIED', PUBLISHER = 'PUBLISHER', USER = 'USER' }
	...
	export enum DealCreativePreApprovalPolicy { CREATIVE_PRE_APPROVAL_POLICY_UNSPECIFIED = 'CREATIVE_PRE_APPROVAL_POLICY_UNSPECIFIED', SELLER_PRE_APPROVAL_REQUIRED = 'SELLER_PRE_APPROVAL_REQUIRED', SELLER_PRE_APPROVAL_NOT_REQUIRED = 'SELLER_PRE_APPROVAL_NOT_REQUIRED' }

	export enum DealCreativeSafeFrameCompatibility { CREATIVE_SAFE_FRAME_COMPATIBILITY_UNSPECIFIED = 'CREATIVE_SAFE_FRAME_COMPATIBILITY_UNSPECIFIED', COMPATIBLE = 'COMPATIBLE', INCOMPATIBLE = 'INCOMPATIBLE' }
	...
	export enum DealTermsBrandingType { BRANDING_TYPE_UNSPECIFIED = 'BRANDING_TYPE_UNSPECIFIED', BRANDED = 'BRANDED', SEMI_TRANSPARENT = 'SEMI_TRANSPARENT' }
	...
	export enum PricePricingType { PRICING_TYPE_UNSPECIFIED = 'PRICING_TYPE_UNSPECIFIED', COST_PER_MILLE = 'COST_PER_MILLE', COST_PER_DAY = 'COST_PER_DAY' }
	...
	export enum GuaranteedFixedPriceTermsReservationType { RESERVATION_TYPE_UNSPECIFIED = 'RESERVATION_TYPE_UNSPECIFIED', STANDARD = 'STANDARD', SPONSORSHIP = 'SPONSORSHIP' }
	...
	export enum DeliveryControlCreativeBlockingLevel { CREATIVE_BLOCKING_LEVEL_UNSPECIFIED = 'CREATIVE_BLOCKING_LEVEL_UNSPECIFIED', PUBLISHER_BLOCKING_RULES = 'PUBLISHER_BLOCKING_RULES', ADX_POLICY_BLOCKING_ONLY = 'ADX_POLICY_BLOCKING_ONLY' }
	...
	export enum DealProgrammaticCreativeSource { PROGRAMMATIC_CREATIVE_SOURCE_UNSPECIFIED = 'PROGRAMMATIC_CREATIVE_SOURCE_UNSPECIFIED', ADVERTISER = 'ADVERTISER', PUBLISHER = 'PUBLISHER' }

	export enum DealSyndicationProduct { SYNDICATION_PRODUCT_UNSPECIFIED = 'SYNDICATION_PRODUCT_UNSPECIFIED', CONTENT = 'CONTENT', MOBILE = 'MOBILE', VIDEO = 'VIDEO', GAMES = 'GAMES' }
	...
	export enum FilterSetEnvironment { ENVIRONMENT_UNSPECIFIED = 'ENVIRONMENT_UNSPECIFIED', WEB = 'WEB', APP = 'APP' }

	export enum FilterSetFormat { FORMAT_UNSPECIFIED = 'FORMAT_UNSPECIFIED', NATIVE_DISPLAY = 'NATIVE_DISPLAY', NATIVE_VIDEO = 'NATIVE_VIDEO', NON_NATIVE_DISPLAY = 'NON_NATIVE_DISPLAY', NON_NATIVE_VIDEO = 'NON_NATIVE_VIDEO' }
	...
	export enum FilterSetTimeSeriesGranularity { TIME_SERIES_GRANULARITY_UNSPECIFIED = 'TIME_SERIES_GRANULARITY_UNSPECIFIED', HOURLY = 'HOURLY', DAILY = 'DAILY' }
	...
	export enum ListCreativeStatusBreakdownByDetailResponseDetailType { DETAIL_TYPE_UNSPECIFIED = 'DETAIL_TYPE_UNSPECIFIED', CREATIVE_ATTRIBUTE = 'CREATIVE_ATTRIBUTE', VENDOR = 'VENDOR', SENSITIVE_CATEGORY = 'SENSITIVE_CATEGORY', PRODUCT_CATEGORY = 'PRODUCT_CATEGORY', DISAPPROVAL_REASON = 'DISAPPROVAL_REASON', POLICY_TOPIC = 'POLICY_TOPIC', ATP_VENDOR = 'ATP_VENDOR', VENDOR_DOMAIN = 'VENDOR_DOMAIN', GVL_ID = 'GVL_ID' }
	...
	export enum NonBillableWinningBidStatusRowStatus { STATUS_UNSPECIFIED = 'STATUS_UNSPECIFIED', AD_NOT_RENDERED = 'AD_NOT_RENDERED', INVALID_IMPRESSION = 'INVALID_IMPRESSION', FATAL_VAST_ERROR = 'FATAL_VAST_ERROR', LOST_IN_MEDIATION = 'LOST_IN_MEDIATION' }
	...
	export enum ProposalProposalState { PROPOSAL_STATE_UNSPECIFIED = 'PROPOSAL_STATE_UNSPECIFIED', PROPOSED = 'PROPOSED', BUYER_ACCEPTED = 'BUYER_ACCEPTED', SELLER_ACCEPTED = 'SELLER_ACCEPTED', CANCELED = 'CANCELED', FINALIZED = 'FINALIZED' }
	...
	export enum Adexchangebuyer2_accounts_creatives_createDuplicateIdMode { NO_DUPLICATES = 'NO_DUPLICATES', FORCE_ENABLE_DUPLICATE_IDS = 'FORCE_ENABLE_DUPLICATE_IDS' }

	export enum Adexchangebuyer2_accounts_finalizedProposals_listFilterSyntax { FILTER_SYNTAX_UNSPECIFIED = 'FILTER_SYNTAX_UNSPECIFIED', PQL = 'PQL', LIST_FILTER = 'LIST_FILTER' }
