...
export namespace MyNS {
	...
	/** **Cloud Audit Logging**: Spec for Audit Logging Allowlisting. */
	export interface CloudAuditLoggingFeatureSpecFormProperties {
	}
	export function CreateCloudAuditLoggingFeatureSpecFormGroup() {
		return new FormGroup<CloudAuditLoggingFeatureSpecFormProperties>({
		});
	...
	export interface CloudBuildMembershipSpec {
		...
		securityPolicy?: CloudBuildMembershipSpecSecurityPolicy | null;
	...
	/** **Cloud Build**: Configurations for each Cloud Build enabled cluster. */
	export interface CloudBuildMembershipSpecFormProperties {

		/** Whether it is allowed to run the privileged builds on the cluster or not. */
		securityPolicy: FormControl<CloudBuildMembershipSpecSecurityPolicy | null | undefined>,

		/** Version of the cloud build software on the cluster. */
		version: FormControl<string | null | undefined>,
	}
	export function CreateCloudBuildMembershipSpecFormGroup() {
		return new FormGroup<CloudBuildMembershipSpecFormProperties>({
			securityPolicy: new FormControl<CloudBuildMembershipSpecSecurityPolicy | null | undefined>(undefined),
			version: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** **ClusterUpgrade**: The configuration for the scope-level ClusterUpgrade feature. */
	export interface ClusterUpgradeScopeSpecFormProperties {
	}
	export function CreateClusterUpgradeScopeSpecFormGroup() {
		return new FormGroup<ClusterUpgradeScopeSpecFormProperties>({
		});
	...
	/** **ClusterUpgrade**: The state for the scope-level ClusterUpgrade feature. */
	export interface ClusterUpgradeScopeStateFormProperties {

		/** A list of memberships ignored by the feature. For example, manually upgraded clusters can be ignored if they are newer than the default versions of its release channel. The membership resource is in the format: `projects/{p}/locations/{l}/membership/{m}`. */
		ignored: FormControl<{[id: string]: ClusterUpgradeIgnoredMembership } | null | undefined>,
	}
	export function CreateClusterUpgradeScopeStateFormGroup() {
		return new FormGroup<ClusterUpgradeScopeStateFormProperties>({
			ignored: new FormControl<{[id: string]: ClusterUpgradeIgnoredMembership } | null | undefined>(undefined),
		});
	...
	export interface NamespaceActuationFeatureSpec {
		...
		actuationMode?: NamespaceActuationFeatureSpecActuationMode | null;
	}

	/** An empty spec for actuation feature. This is required since Feature proto requires a spec. */
	export interface NamespaceActuationFeatureSpecFormProperties {

		/** actuation_mode controls the behavior of the controller */
		actuationMode: FormControl<NamespaceActuationFeatureSpecActuationMode | null | undefined>,
	}
	export function CreateNamespaceActuationFeatureSpecFormGroup() {
		return new FormGroup<NamespaceActuationFeatureSpecFormProperties>({
			actuationMode: new FormControl<NamespaceActuationFeatureSpecActuationMode | null | undefined>(undefined),
		});
	...
	export interface FeatureSpec {
		...
		provisionGoogleCa?: FeatureSpecProvisionGoogleCa | null;
	}

	/** **Workload Certificate**: The Hub-wide input for the WorkloadCertificate feature. */
	export interface FeatureSpecFormProperties {

		/** Immutable. Specifies CA configuration. */
		provisionGoogleCa: FormControl<FeatureSpecProvisionGoogleCa | null | undefined>,
	}
	export function CreateFeatureSpecFormGroup() {
		return new FormGroup<FeatureSpecFormProperties>({
			provisionGoogleCa: new FormControl<FeatureSpecProvisionGoogleCa | null | undefined>(undefined),
		});
	...
	export interface MembershipSpec {
		...
		certificateManagement?: MembershipSpecCertificateManagement | null;
	}
	...
	export interface MembershipSpecFormProperties {
		...
		/** Specifies workload certificate management. */
		certificateManagement: FormControl<MembershipSpecCertificateManagement | null | undefined>,
	}
	export function CreateMembershipSpecFormGroup() {
		return new FormGroup<MembershipSpecFormProperties>({
			certificateManagement: new FormControl<MembershipSpecCertificateManagement | null | undefined>(undefined),
		});
	...
	/** NamespaceActuation Feature State. */
	export interface NamespaceActuationFeatureStateFormProperties {
	}
	export function CreateNamespaceActuationFeatureStateFormGroup() {
		return new FormGroup<NamespaceActuationFeatureStateFormProperties>({
		});
	...
	/** **Service Mesh**: State for the whole Hub, as analyzed by the Service Mesh Hub Controller. */
	export interface ServiceMeshFeatureStateFormProperties {
	}
	export function CreateServiceMeshFeatureStateFormGroup() {
		return new FormGroup<ServiceMeshFeatureStateFormProperties>({
		});
	...
	/** AnalysisMessage is a single message produced by an analyzer, and it used to communicate to the end user about the state of their Service Mesh configuration. */
	export interface ServiceMeshAnalysisMessageFormProperties {
	...
	export function CreateServiceMeshAnalysisMessageFormGroup() {
		return new FormGroup<ServiceMeshAnalysisMessageFormProperties>({
	...
	export interface ServiceMeshAnalysisMessageBase {
		...
		level?: ServiceMeshAnalysisMessageBaseLevel | null;
	...
	/** AnalysisMessageBase describes some common information that is needed for all messages. */
	export interface ServiceMeshAnalysisMessageBaseFormProperties {

		/** A url pointing to the Service Mesh or Istio documentation for this specific error type. */
		documentationUrl: FormControl<string | null | undefined>,

		/** Represents how severe a message is. */
		level: FormControl<ServiceMeshAnalysisMessageBaseLevel | null | undefined>,
	}
	export function CreateServiceMeshAnalysisMessageBaseFormGroup() {
		return new FormGroup<ServiceMeshAnalysisMessageBaseFormProperties>({
			documentationUrl: new FormControl<string | null | undefined>(undefined),
			level: new FormControl<ServiceMeshAnalysisMessageBaseLevel | null | undefined>(undefined),
		});
	...
	/** A unique identifier for the type of message. Display_name is intended to be human-readable, code is intended to be machine readable. There should be a one-to-one mapping between display_name and code. (i.e. do not re-use display_names or codes between message types.) See istio.analysis.v1alpha1.AnalysisMessageBase.Type */
	export interface ServiceMeshTypeFormProperties {
	...
	export function CreateServiceMeshTypeFormGroup() {
		return new FormGroup<ServiceMeshTypeFormProperties>({
			code: new FormControl<string | null | undefined>(undefined),
	...
	export interface ServiceMeshMembershipSpec {
		...
		defaultChannel?: ServiceMeshMembershipSpecDefaultChannel | null;
	...
	export interface ServiceMeshMembershipSpecFormProperties {
		...
		/** Determines which release channel to use for default injection and service mesh APIs. */
		defaultChannel: FormControl<ServiceMeshMembershipSpecDefaultChannel | null | undefined>,
	...
	export function CreateServiceMeshMembershipSpecFormGroup() {
		return new FormGroup<ServiceMeshMembershipSpecFormProperties>({
			...
			defaultChannel: new FormControl<ServiceMeshMembershipSpecDefaultChannel | null | undefined>(undefined),
	...
	/** **Namespace Actuation**: The membership-specific input for NamespaceActuation feature. */
	export interface NamespaceActuationMembershipSpecFormProperties {
	}
	export function CreateNamespaceActuationMembershipSpecFormGroup() {
		return new FormGroup<NamespaceActuationMembershipSpecFormProperties>({
		});
	...
	/** **Namespace Actuation**: An empty state left as an example membership-specific Feature state. */
	export interface NamespaceActuationMembershipStateFormProperties {
	}
	export function CreateNamespaceActuationMembershipStateFormGroup() {
		return new FormGroup<NamespaceActuationMembershipStateFormProperties>({
		});
	...
	/** Response message for the `GkeHub.ListAdminClusterMemberships` method. */
	export interface ListAdminClusterMembershipsResponseFormProperties {

		/** A token to request the next page of resources from the `ListAdminClusterMemberships` method. The value of an empty string means that there are no more resources to return. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListAdminClusterMembershipsResponseFormGroup() {
		return new FormGroup<ListAdminClusterMembershipsResponseFormProperties>({
	...
	/** Request message for the `GkeHub.ValidateCreateMembership` method. */
	export interface ValidateCreateMembershipRequestFormProperties {

		/** Required. Client chosen membership id. */
		membershipId: FormControl<string | null | undefined>,
	}
	export function CreateValidateCreateMembershipRequestFormGroup() {
		return new FormGroup<ValidateCreateMembershipRequestFormProperties>({
	...
	/** Response message for the `GkeHub.ValidateCreateMembership` method. */
	export interface ValidateCreateMembershipResponseFormProperties {
	}
	export function CreateValidateCreateMembershipResponseFormGroup() {
		return new FormGroup<ValidateCreateMembershipResponseFormProperties>({
		});
	...
	export interface ValidationResult {
		...
		validator?: ValidationResultValidator | null;
	}
	...
	export interface ValidationResultFormProperties {
		...
		/** Validator type to validate membership with. */
		validator: FormControl<ValidationResultValidator | null | undefined>,
	}
	export function CreateValidationResultFormGroup() {
		return new FormGroup<ValidationResultFormProperties>({
			...
			validator: new FormControl<ValidationResultValidator | null | undefined>(undefined),
		});
	...
	export class MyClient {
		...
		Gkehub_projects_locations_scopes_rbacrolebindings_delete(name: string, force: boolean | null | undefined, requestId: string | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1alpha/' + (name == null ? '' : encodeURIComponent(name)) + '&force=' + force + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), {});
		}
		...
		Gkehub_projects_locations_scopes_rbacrolebindings_get(name: string): Observable<RBACRoleBinding> {
			return this.http.get<RBACRoleBinding>(this.baseUri + 'v1alpha/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * Get v1alpha/{name}:generateConnectManifest
		...
		Gkehub_projects_locations_memberships_bindings_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListMembershipBindingsResponse> {
			return this.http.get<ListMembershipBindingsResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/bindings&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Gkehub_projects_locations_memberships_bindings_create(parent: string, membershipBindingId: string | null | undefined, requestBody: MembershipBinding): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/bindings&membershipBindingId=' + (membershipBindingId == null ? '' : encodeURIComponent(membershipBindingId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Features in a given project and location.
		 * Get v1alpha/{parent}/features
		...
		Gkehub_projects_locations_features_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListFeaturesResponse> {
			return this.http.get<ListFeaturesResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/features&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Adds a new Feature.
		 * Post v1alpha/{parent}/features
		...
		Gkehub_projects_locations_features_create(parent: string, featureId: string | null | undefined, requestId: string | null | undefined, requestBody: Feature): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/features&featureId=' + (featureId == null ? '' : encodeURIComponent(featureId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Returns all fleets within an organization or a project that the caller has access to.
		 * Get v1alpha/{parent}/fleets
		...
		Gkehub_projects_locations_fleets_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListFleetsResponse> {
			return this.http.get<ListFleetsResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fleets&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a fleet.
		 * Post v1alpha/{parent}/fleets
		...
		Gkehub_projects_locations_fleets_create(parent: string, requestBody: Fleet): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/fleets', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Memberships in a given project and location.
		 * Get v1alpha/{parent}/memberships
		...
		Gkehub_projects_locations_memberships_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListMembershipsResponse> {
			return this.http.get<ListMembershipsResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new Membership. **This is currently only supported for GKE clusters on Google Cloud**. To register other clusters, follow the instructions at https://cloud.google.com/anthos/multicluster-management/connect/registering-a-cluster.
		 * Post v1alpha/{parent}/memberships
		...
		Gkehub_projects_locations_memberships_create(parent: string, membershipId: string | null | undefined, requestId: string | null | undefined, requestBody: Membership): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships&membershipId=' + (membershipId == null ? '' : encodeURIComponent(membershipId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Memberships of admin clusters in a given project and location. **This method is only used internally**.
		 * Get v1alpha/{parent}/memberships:listAdmin
		 * @param {string} parent Required. The parent (project and location) where the Memberships of admin cluster will be listed. Specified in the format `projects/locations/*`.
		 ...
		 * @return {ListAdminClusterMembershipsResponse} Successful response
		 */
		Gkehub_projects_locations_memberships_listAdmin(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAdminClusterMembershipsResponse> {
			return this.http.get<ListAdminClusterMembershipsResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:listAdmin&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * Post v1alpha/{parent}/memberships:validateCreate
		 * @param {string} parent Required. The parent (project and location) where the Memberships will be created. Specified in the format `projects/locations/*`.
		 * @return {ValidateCreateMembershipResponse} Successful response
		 */
		Gkehub_projects_locations_memberships_validateCreate(parent: string, requestBody: ValidateCreateMembershipRequest): Observable<ValidateCreateMembershipResponse> {
			return this.http.post<ValidateCreateMembershipResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/memberships:validateCreate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists fleet namespaces.
		 * Get v1alpha/{parent}/namespaces
		...
		Gkehub_projects_locations_scopes_namespaces_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListScopeNamespacesResponse> {
			return this.http.get<ListScopeNamespacesResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/namespaces&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a fleet namespace.
		 * Post v1alpha/{parent}/namespaces
		...
		Gkehub_projects_locations_scopes_namespaces_create(parent: string, scopeNamespaceId: string | null | undefined, requestBody: Namespace): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/namespaces&scopeNamespaceId=' + (scopeNamespaceId == null ? '' : encodeURIComponent(scopeNamespaceId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all Scope RBACRoleBindings.
		 * Get v1alpha/{parent}/rbacrolebindings
		 * @param {string} parent Required. The parent (project and location) where the Features will be listed. Specified in the format `projects/locations/scopes/*`.
		 * @param {number} pageSize Optional. When requesting a 'page' of resources, `page_size` specifies number of resources to return. If unspecified or set to 0, all resources will be returned.
		...
		Gkehub_projects_locations_scopes_rbacrolebindings_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListScopeRBACRoleBindingsResponse> {
			return this.http.get<ListScopeRBACRoleBindingsResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/rbacrolebindings&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a Scope RBACRoleBinding.
		 * Post v1alpha/{parent}/rbacrolebindings
		...
		Gkehub_projects_locations_scopes_rbacrolebindings_create(parent: string, rbacrolebindingId: string | null | undefined, requestBody: RBACRoleBinding): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/rbacrolebindings&rbacrolebindingId=' + (rbacrolebindingId == null ? '' : encodeURIComponent(rbacrolebindingId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Generates a YAML of the RBAC policies for the specified RoleBinding and its associated impersonation resources.
		 * Post v1alpha/{parent}/rbacrolebindings:generateMembershipRBACRoleBindingYAML
		...
		Gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAML(parent: string, rbacrolebindingId: string | null | undefined, requestBody: RBACRoleBinding): Observable<GenerateMembershipRBACRoleBindingYAMLResponse> {
			return this.http.post<GenerateMembershipRBACRoleBindingYAMLResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/rbacrolebindings:generateMembershipRBACRoleBindingYAML&rbacrolebindingId=' + (rbacrolebindingId == null ? '' : encodeURIComponent(rbacrolebindingId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Scopes.
		 * Get v1alpha/{parent}/scopes
		...
		Gkehub_projects_locations_scopes_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListScopesResponse> {
			return this.http.get<ListScopesResponse>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/scopes&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a Scope.
		 * Post v1alpha/{parent}/scopes
		...
		Gkehub_projects_locations_scopes_create(parent: string, scopeId: string | null | undefined, requestBody: Scope): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1alpha/' + (parent == null ? '' : encodeURIComponent(parent)) + '/scopes&scopeId=' + (scopeId == null ? '' : encodeURIComponent(scopeId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
