...
export namespace MyNS {
	...
	export interface DpcerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<DpcerPostBodyFormat | null | undefined>,
	...
	export function CreateDpcerPostBodyFormGroup() {
		return new FormGroup<DpcerPostBodyFormProperties>({
			format: new FormControl<DpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export enum DpcerPostBodyFormat { pdf = 'pdf' }
