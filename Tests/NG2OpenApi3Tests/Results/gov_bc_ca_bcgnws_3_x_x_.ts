...
export namespace MyNS {
	...
	export enum FeatureCategoriesGetByOutputFormatOutputFormat { json = 'json', xml = 'xml' }

	export enum NamesChangesGetByOutputFormatAndFromDateAndToDateAndFeatureClassAndFeatureCategoryAndFeatureTypeAndSortByAndOutputSRSAndEmbedAndOutputStyleAndItemsPerPageAndStartIndexOutputFormat { json = 'json', xml = 'xml', kml = 'kml', csv = 'csv' }

	export enum NamesChangesGetByOutputFormatAndFromDateAndToDateAndFeatureClassAndFeatureCategoryAndFeatureTypeAndSortByAndOutputSRSAndEmbedAndOutputStyleAndItemsPerPageAndStartIndexSortBy { name = 'name', featureType = 'featureType', decisionDate = 'decisionDate' }
	...
	export enum NamesChangesGetByOutputFormatAndFromDateAndToDateAndFeatureClassAndFeatureCategoryAndFeatureTypeAndSortByAndOutputSRSAndEmbedAndOutputStyleAndItemsPerPageAndStartIndexOutputStyle { summary = 'summary', detail = 'detail' }
	...
	export enum NamesNotOfficialSearchGetByOutputFormatAndNameAndExactSpellingAndFeatureClassAndFeatureCategoryAndFeatureTypeAndSortByAndOutputSRSAndEmbedAndOutputStyleAndItemsPerPageAndStartIndexSortBy { relevance = 'relevance', name = 'name', featureType = 'featureType', decisionDate = 'decisionDate' }
	...
	export enum Names_nameId__outputFormatGetOutputFormat { json = 'json', xml = 'xml', kml = 'kml', csv = 'csv', html = 'html' }
