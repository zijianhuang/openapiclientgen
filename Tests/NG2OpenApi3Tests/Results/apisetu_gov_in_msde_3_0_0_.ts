...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {IticrPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Iticr(requestBody: IticrPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'iticr/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface IticrPostBody {
		certificateParameters?: IticrPostBodyCertificateParameters;
	...
	export interface IticrPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<IticrPostBodyFormat | null | undefined>,
	...
	export function CreateIticrPostBodyFormGroup() {
		return new FormGroup<IticrPostBodyFormProperties>({
			format: new FormControl<IticrPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface IticrPostBodyCertificateParameters {
	...
	export interface IticrPostBodyCertificateParametersFormProperties {
	...
	export function CreateIticrPostBodyCertificateParametersFormGroup() {
		return new FormGroup<IticrPostBodyCertificateParametersFormProperties>({
	...
	export enum IticrPostBodyFormat { pdf = 'pdf' }
