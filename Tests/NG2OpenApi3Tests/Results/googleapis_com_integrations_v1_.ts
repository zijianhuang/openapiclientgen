...
export namespace MyNS {
	...
	export interface GoogleCloudIntegrationsV1alphaClientConfig {
		...
		billingType?: GoogleCloudIntegrationsV1alphaClientConfigBillingType | null;

		/** Indicates the activity state the client */
		clientState?: GoogleCloudIntegrationsV1alphaClientConfigClientState | null;
	...
	/** The configuration information for the Client */
	export interface GoogleCloudIntegrationsV1alphaClientConfigFormProperties {

		/** Indicates the billing type of the client */
		billingType: FormControl<GoogleCloudIntegrationsV1alphaClientConfigBillingType | null | undefined>,

		/** Indicates the activity state the client */
		clientState: FormControl<GoogleCloudIntegrationsV1alphaClientConfigClientState | null | undefined>,
	...
	export function CreateGoogleCloudIntegrationsV1alphaClientConfigFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaClientConfigFormProperties>({
			billingType: new FormControl<GoogleCloudIntegrationsV1alphaClientConfigBillingType | null | undefined>(undefined),
			clientState: new FormControl<GoogleCloudIntegrationsV1alphaClientConfigClientState | null | undefined>(undefined),
			createTime: new FormControl<string | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
	...
	/** Configuration information for Client's Cloud KMS information */
	export interface GoogleCloudIntegrationsV1alphaCloudKmsConfigFormProperties {
		...
		/** Required. Location name of the key ring, e.g. "us-west1". */
		kmsLocation: FormControl<string | null | undefined>,

		/** Optional. The gcp project id of the project where the kms key stored. If empty, the kms key is stored at the same project as customer's project and ecrypted with CMEK, otherwise, the kms key is stored in the tenant project and encrypted with GMEK */
		kmsProjectId: FormControl<string | null | undefined>,

		/** Required. A key ring organizes keys in a specific Google Cloud location and allows you to manage access control on groups of keys. A key ring's name does not need to be unique across a Google Cloud project, but must be unique within a given location. */
		kmsRing: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudIntegrationsV1alphaCloudKmsConfigFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaCloudKmsConfigFormProperties>({
			key: new FormControl<string | null | undefined>(undefined),
			keyVersion: new FormControl<string | null | undefined>(undefined),
			kmsLocation: new FormControl<string | null | undefined>(undefined),
			kmsProjectId: new FormControl<string | null | undefined>(undefined),
			kmsRing: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Config info for Cloud Logging */
	export interface GoogleCloudIntegrationsV1alphaCloudLoggingConfig {
	...
	/** Config info for Cloud Logging */
	export interface GoogleCloudIntegrationsV1alphaCloudLoggingConfigFormProperties {

		/** Cloud bucket name for the project. */
		bucket: FormControl<string | null | undefined>,

		/** This field determines whether the logs should be sent to cloud logging api */
		enableCloudLogging: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudIntegrationsV1alphaCloudLoggingConfigFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaCloudLoggingConfigFormProperties>({
			bucket: new FormControl<string | null | undefined>(undefined),
			enableCloudLogging: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Request for Creating Cloud Function rpc call. */
	export interface GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequestFormProperties {
	...
	export function CreateGoogleCloudIntegrationsV1alphaCreateCloudFunctionRequestFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequestFormProperties>({
	...
	/** Response for Creating Cloud Function rpc call. */
	export interface GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponseFormProperties {

		/** The trigger url that will be returned */
		triggerUrl: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudIntegrationsV1alphaCreateCloudFunctionResponseFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponseFormProperties>({
			triggerUrl: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request for the Deprovision rpc */
	export interface GoogleCloudIntegrationsV1alphaDeprovisionClientRequestFormProperties {
	}
	export function CreateGoogleCloudIntegrationsV1alphaDeprovisionClientRequestFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaDeprovisionClientRequestFormProperties>({
		});
	...
	/** Response for downloading an execution. */
	export interface GoogleCloudIntegrationsV1alphaDownloadExecutionResponseFormProperties {

		/** The content of downloaded execution. */
		content: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudIntegrationsV1alphaDownloadExecutionResponseFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaDownloadExecutionResponseFormProperties>({
	...
	/** Response for the GetClientMetadata rpc */
	export interface GoogleCloudIntegrationsV1alphaGetClientMetadataResponseFormProperties {
	}
	export function CreateGoogleCloudIntegrationsV1alphaGetClientMetadataResponseFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaGetClientMetadataResponseFormProperties>({
		});
	...
	export interface GoogleCloudIntegrationsV1alphaProjectProperties {
		...
		ipEnablementState?: GoogleCloudIntegrationsV1alphaProjectPropertiesIpEnablementState | null;
	...
	/** Metadata information for the given project */
	export interface GoogleCloudIntegrationsV1alphaProjectPropertiesFormProperties {

		/** An enum value of what the enablement state is for the given project */
		ipEnablementState: FormControl<GoogleCloudIntegrationsV1alphaProjectPropertiesIpEnablementState | null | undefined>,
	}
	export function CreateGoogleCloudIntegrationsV1alphaProjectPropertiesFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaProjectPropertiesFormProperties>({
			ipEnablementState: new FormControl<GoogleCloudIntegrationsV1alphaProjectPropertiesIpEnablementState | null | undefined>(undefined),
		});
	...
	/** Response for the GetClient rpc */
	export interface GoogleCloudIntegrationsV1alphaGetClientResponseFormProperties {
	}
	export function CreateGoogleCloudIntegrationsV1alphaGetClientResponseFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaGetClientResponseFormProperties>({
		});
	...
	export interface GoogleCloudIntegrationsV1alphaIntegrationVersion {
		...
		databasePersistencePolicy?: GoogleCloudIntegrationsV1alphaIntegrationVersionDatabasePersistencePolicy | null;
		...
		status?: GoogleCloudIntegrationsV1alphaIntegrationVersionStatus | null;
	...
	export interface GoogleCloudIntegrationsV1alphaIntegrationVersionFormProperties {
		...
		/** Optional. Flag to disable database persistence for execution data, including event execution info, execution export info, execution metadata index and execution param index. */
		databasePersistencePolicy: FormControl<GoogleCloudIntegrationsV1alphaIntegrationVersionDatabasePersistencePolicy | null | undefined>,
		...
		/** Output only. Generated by eventbus. User should not set it as an input. */
		status: FormControl<GoogleCloudIntegrationsV1alphaIntegrationVersionStatus | null | undefined>,
	...
	export function CreateGoogleCloudIntegrationsV1alphaIntegrationVersionFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaIntegrationVersionFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			databasePersistencePolicy: new FormControl<GoogleCloudIntegrationsV1alphaIntegrationVersionDatabasePersistencePolicy | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			lastModifierEmail: new FormControl<string | null | undefined>(undefined),
			...
			status: new FormControl<GoogleCloudIntegrationsV1alphaIntegrationVersionStatus | null | undefined>(undefined),
			updateTime: new FormControl<string | null | undefined>(undefined),
	...
	export interface GoogleCloudIntegrationsV1alphaProvisionClientRequest {
		...
		provisionGmek?: boolean | null;
	}

	/** Request for the Provision rpc */
	export interface GoogleCloudIntegrationsV1alphaProvisionClientRequestFormProperties {

		/** Optional. Indicates if sample workflow should be created along with provisioning */
		createSampleWorkflows: FormControl<boolean | null | undefined>,

		/** Optional. Indicates provision with GMEK or CMEK */
		provisionGmek: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudIntegrationsV1alphaProvisionClientRequestFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaProvisionClientRequestFormProperties>({
			createSampleWorkflows: new FormControl<boolean | null | undefined>(undefined),
			provisionGmek: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Request for the SwitchEncryption rpc */
	export interface GoogleCloudIntegrationsV1alphaSwitchEncryptionRequestFormProperties {
	}
	export function CreateGoogleCloudIntegrationsV1alphaSwitchEncryptionRequestFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaSwitchEncryptionRequestFormProperties>({
		});
	...
	/** The request for testing an integration. */
	export interface GoogleCloudIntegrationsV1alphaTestIntegrationsRequestFormProperties {

		/** Required. This is used to identify the client on whose behalf the event will be executed. */
		clientId: FormControl<string | null | undefined>,

		/** Optional. custom deadline of the rpc */
		deadlineSecondsTime: FormControl<string | null | undefined>,
	...
	export function CreateGoogleCloudIntegrationsV1alphaTestIntegrationsRequestFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaTestIntegrationsRequestFormProperties>({
			clientId: new FormControl<string | null | undefined>(undefined),
			deadlineSecondsTime: new FormControl<string | null | undefined>(undefined),
			inputParameters: new FormControl<{[id: string]: GoogleCloudIntegrationsV1alphaValueType } | null | undefined>(undefined),
			testMode: new FormControl<boolean | null | undefined>(undefined),
			triggerId: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudIntegrationsV1alphaTestIntegrationsResponse {
		...
		/** Optional. Parameters are a part of Event and can be used to communicate between different tasks that are part of the same integration execution. */
		parameters?: {[id: string]: GoogleCloudIntegrationsV1alphaValueType };
	}

	/** The response for testing an integration. */
	export interface GoogleCloudIntegrationsV1alphaTestIntegrationsResponseFormProperties {
		...
		/** Optional. Parameters are a part of Event and can be used to communicate between different tasks that are part of the same integration execution. */
		parameters: FormControl<{[id: string]: GoogleCloudIntegrationsV1alphaValueType } | null | undefined>,
	}
	export function CreateGoogleCloudIntegrationsV1alphaTestIntegrationsResponseFormGroup() {
		return new FormGroup<GoogleCloudIntegrationsV1alphaTestIntegrationsResponseFormProperties>({
			executionFailed: new FormControl<boolean | null | undefined>(undefined),
			executionId: new FormControl<string | null | undefined>(undefined),
			parameters: new FormControl<{[id: string]: GoogleCloudIntegrationsV1alphaValueType } | null | undefined>(undefined),
		});
	...
	export class MyClient {
		...
		Integrations_connectorPlatformRegions_enumerate(): Observable<GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse>(this.baseUri + 'v1/connectorPlatformRegions:enumerate', {});
		}
		...
		Integrations_projects_locations_products_integrations_versions_takeoverEditLock(integrationVersion: string, requestBody: GoogleCloudIntegrationsV1alphaTakeoverEditLockRequest): Observable<GoogleCloudIntegrationsV1alphaTakeoverEditLockResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaTakeoverEditLockResponse>(this.baseUri + 'v1/' + (integrationVersion == null ? '' : encodeURIComponent(integrationVersion)) + ':takeoverEditLock', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_sfdcInstances_sfdcChannels_get(name: string): Observable<GoogleCloudIntegrationsV1alphaSfdcChannel> {
			return this.http.get<GoogleCloudIntegrationsV1alphaSfdcChannel>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Integrations_projects_locations_products_integrations_executions_cancel(name: string, requestBody: GoogleCloudIntegrationsV1alphaCancelExecutionRequest): Observable<GoogleCloudIntegrationsV1alphaCancelExecutionResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaCancelExecutionResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':cancel', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_integrations_versions_download(name: string, fileFormat: GoogleCloudIntegrationsV1alphaUploadIntegrationVersionRequestFileFormat | null | undefined): Observable<GoogleCloudIntegrationsV1alphaDownloadIntegrationVersionResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaDownloadIntegrationVersionResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':download&fileFormat=' + fileFormat, {});
		}
		...
		Integrations_projects_locations_products_integrations_execute(name: string, requestBody: GoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest): Observable<GoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':execute', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_integrations_executions_suspensions_lift(name: string, requestBody: GoogleCloudIntegrationsV1alphaLiftSuspensionRequest): Observable<GoogleCloudIntegrationsV1alphaLiftSuspensionResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaLiftSuspensionResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':lift', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_integrations_versions_publish(name: string, requestBody: GoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest): Observable<GoogleCloudIntegrationsV1alphaPublishIntegrationVersionResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaPublishIntegrationVersionResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':publish', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_integrations_executions_suspensions_resolve(name: string, requestBody: GoogleCloudIntegrationsV1alphaResolveSuspensionRequest): Observable<GoogleCloudIntegrationsV1alphaResolveSuspensionResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaResolveSuspensionResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':resolve', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_integrations_schedule(name: string, requestBody: GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest): Observable<GoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':schedule', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudIntegrationsV1alphaTestIntegrationsResponse} Successful response
		 */
		Integrations_projects_locations_products_integrations_test(name: string, requestBody: GoogleCloudIntegrationsV1alphaTestIntegrationsRequest): Observable<GoogleCloudIntegrationsV1alphaTestIntegrationsResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaTestIntegrationsResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':test', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_integrations_versions_unpublish(name: string, requestBody: GoogleCloudIntegrationsV1alphaUnpublishIntegrationVersionRequest): Observable<GoogleProtobufEmpty> {
			return this.http.post<GoogleProtobufEmpty>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':unpublish', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_appsScriptProjects_create(parent: string, requestBody: GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest): Observable<GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/appsScriptProjects', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_appsScriptProjects_link(parent: string, requestBody: GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectRequest): Observable<GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/appsScriptProjects:link', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_certificates_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, readMask: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListCertificatesResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListCertificatesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/certificates&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&readMask=' + (readMask == null ? '' : encodeURIComponent(readMask)), {});
		}
		...
		Integrations_projects_locations_products_certificates_create(parent: string, requestBody: GoogleCloudIntegrationsV1alphaCertificate): Observable<GoogleCloudIntegrationsV1alphaCertificate> {
			return this.http.post<GoogleCloudIntegrationsV1alphaCertificate>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/certificates', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Gets the metadata info for the requested client
		 * Get v1/{parent}/clientmetadata
		 * @param {string} parent Required. Required: The ID of the GCP Project to be provisioned.
		 * @return {GoogleCloudIntegrationsV1alphaGetClientMetadataResponse} Successful response
		 */
		Integrations_projects_getClientmetadata(parent: string): Observable<GoogleCloudIntegrationsV1alphaGetClientMetadataResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaGetClientMetadataResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clientmetadata', {});
		}
		 ...
		 * @param {string} parent Required. Required: The ID of the GCP Project to be provisioned.
		 * @return {GoogleCloudIntegrationsV1alphaGetClientResponse} Successful response
		 */
		Integrations_projects_locations_getClients(parent: string): Observable<GoogleCloudIntegrationsV1alphaGetClientResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaGetClientResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clients', {});
		}
		 ...
		 * @param {string} parent Required. Required: The ID of the GCP Project to be deprovisioned.
		 * @return {GoogleProtobufEmpty} Successful response
		 */
		Integrations_projects_locations_clients_deprovision(parent: string, requestBody: GoogleCloudIntegrationsV1alphaDeprovisionClientRequest): Observable<GoogleProtobufEmpty> {
			return this.http.post<GoogleProtobufEmpty>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clients:deprovision', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleProtobufEmpty} Successful response
		 */
		Integrations_projects_locations_clients_provision(parent: string, requestBody: GoogleCloudIntegrationsV1alphaProvisionClientRequest): Observable<GoogleProtobufEmpty> {
			return this.http.post<GoogleProtobufEmpty>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clients:provision', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleProtobufEmpty} Successful response
		 */
		Integrations_projects_locations_clients_switch(parent: string, requestBody: GoogleCloudIntegrationsV1alphaSwitchEncryptionRequest): Observable<GoogleProtobufEmpty> {
			return this.http.post<GoogleProtobufEmpty>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clients:switch', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} parent Required. The project that the executed integration belongs to.
		 * @return {GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse} Successful response
		 */
		Integrations_projects_locations_products_cloudFunctions_create(parent: string, requestBody: GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest): Observable<GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/cloudFunctions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_connections_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListConnectionsResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListConnectionsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/connections&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Integrations_projects_locations_products_integrations_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListIntegrationsResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListIntegrationsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/integrations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Integrations_projects_locations_connections_runtimeActionSchemas_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/runtimeActionSchemas&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Integrations_projects_locations_connections_runtimeEntitySchemas_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/runtimeEntitySchemas&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Integrations_projects_locations_sfdcInstances_sfdcChannels_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, readMask: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sfdcChannels&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&readMask=' + (readMask == null ? '' : encodeURIComponent(readMask)), {});
		}
		...
		Integrations_projects_locations_sfdcInstances_sfdcChannels_create(parent: string, requestBody: GoogleCloudIntegrationsV1alphaSfdcChannel): Observable<GoogleCloudIntegrationsV1alphaSfdcChannel> {
			return this.http.post<GoogleCloudIntegrationsV1alphaSfdcChannel>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sfdcChannels', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_sfdcInstances_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, readMask: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sfdcInstances&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&readMask=' + (readMask == null ? '' : encodeURIComponent(readMask)), {});
		}
		...
		Integrations_projects_locations_sfdcInstances_create(parent: string, requestBody: GoogleCloudIntegrationsV1alphaSfdcInstance): Observable<GoogleCloudIntegrationsV1alphaSfdcInstance> {
			return this.http.post<GoogleCloudIntegrationsV1alphaSfdcInstance>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sfdcInstances', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_integrations_executions_suspensions_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListSuspensionsResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListSuspensionsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/suspensions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @param {string} fieldMask The field mask which specifies the particular data to be returned.
		 * @param {string} filter Filter on fields of IntegrationVersion. Fields can be compared with literal values by use of ":" (containment), "=" (equality), ">" (greater), "<" (less than), >=" (greater than or equal to), "<=" (less than or equal to), and "!=" (inequality) operators. Negation, conjunction, and disjunction are written using NOT, AND, and OR keywords. For example, organization_id=\"1\" AND state=ACTIVE AND description:"test". Filtering cannot be performed on repeated fields like `task_config`.
		 * @param {string} orderBy The results would be returned in order you specified here. Currently supported sort keys are: Descending sort order for "last_modified_time", "created_time", "snapshot_number" Ascending sort order for "name".
		 * @param {number} pageSize The maximum number of versions to return. The service may return fewer than this value. If unspecified, at most 50 versions will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.
		 * @param {string} pageToken A page token, received from a previous `ListIntegrationVersions` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListIntegrationVersions` must match the call that provided the page token.
		 * @return {GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse} Successful response
		 */
		Integrations_projects_locations_products_integrations_versions_list(parent: string, fieldMask: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse> {
			return this.http.get<GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/versions&fieldMask=' + (fieldMask == null ? '' : encodeURIComponent(fieldMask)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Create a integration with a draft version in the specified project.
		 * Post v1/{parent}/versions
		 * @param {string} parent Required. The parent resource where this version will be created. Format: projects/{project}/locations/{location}/integrations/{integration}
		 * @param {boolean} createSampleIntegrations Optional. Optional. Indicates if sample workflow should be created.
		 ...
		 * @return {GoogleCloudIntegrationsV1alphaIntegrationVersion} Successful response
		 */
		Integrations_projects_locations_products_integrations_versions_create(parent: string, createSampleIntegrations: boolean | null | undefined, newIntegration: boolean | null | undefined, requestBody: GoogleCloudIntegrationsV1alphaIntegrationVersion): Observable<GoogleCloudIntegrationsV1alphaIntegrationVersion> {
			return this.http.post<GoogleCloudIntegrationsV1alphaIntegrationVersion>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/versions&createSampleIntegrations=' + createSampleIntegrations + '&newIntegration=' + newIntegration, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Integrations_projects_locations_products_integrations_versions_upload(parent: string, requestBody: GoogleCloudIntegrationsV1alphaUploadIntegrationVersionRequest): Observable<GoogleCloudIntegrationsV1alphaUploadIntegrationVersionResponse> {
			return this.http.post<GoogleCloudIntegrationsV1alphaUploadIntegrationVersionResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/versions:upload', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
