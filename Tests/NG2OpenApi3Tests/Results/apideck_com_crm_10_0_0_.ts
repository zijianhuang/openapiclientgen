...
export namespace MyNS {
	...
	export enum ActivityAttendeeStatus { accepted = 0, tentative = 1, declined = 2 }
	...
	export enum ActivityShow_as { free = 0, busy = 1 }

	export enum ActivityType { call = 0, meeting = 1, email = 2, note = 3, task = 4, deadline = 5, 'send-letter' = 6, 'send-quote' = 7, other = 8 }
	...
	export enum CompaniesSortBy { created_at = 0, updated_at = 1, name = 2 }

	export enum CompaniesSortDirection { asc = 0, desc = 1 }
	...
	export enum ContactsSortBy { created_at = 0, updated_at = 1, name = 2, first_name = 3, last_name = 4, email = 5 }
	...
	export enum CrmEventType { '*' = 0, 'crm.activity.created' = 1, 'crm.activity.updated' = 2, 'crm.activity.deleted' = 3, 'crm.company.created' = 4, 'crm.company.updated' = 5, 'crm.company.deleted' = 6, 'crm.contact.created' = 7, 'crm.contact.updated' = 8, 'crm.contact.deleted' = 9, 'crm.lead.created' = 10, 'crm.lead.updated' = 11, 'crm.lead.deleted' = 12, 'crm.note.created' = 13, 'crm.note.updated' = 14, 'crm.note.deleted' = 15, 'crm.opportunity.created' = 16, 'crm.opportunity.updated' = 17, 'crm.opportunity.deleted' = 18 }
	...
	export enum OpportunitiesSortBy { created_at = 0, updated_at = 1, title = 2, win_probability = 3, monetary_amount = 4, status = 5 }
