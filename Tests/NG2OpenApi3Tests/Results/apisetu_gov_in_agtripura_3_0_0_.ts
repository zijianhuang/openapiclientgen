...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {PrfndPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Prfnd(requestBody: PrfndPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'prfnd/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface PecerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<PecerPostBodyFormat | null | undefined>,
	...
	export function CreatePecerPostBodyFormGroup() {
		return new FormGroup<PecerPostBodyFormProperties>({
			format: new FormControl<PecerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface PecerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		AC_NO: FormControl<string | null | undefined>,
	...
	export function CreatePecerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PecerPostBodyCertificateParametersFormProperties>({
			AC_NO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum PecerPostBodyFormat { pdf = 'pdf' }

	export interface PrfndPostBody {
		certificateParameters?: PrfndPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface PrfndPostBodyFormProperties {
	...
	export function CreatePrfndPostBodyFormGroup() {
		return new FormGroup<PrfndPostBodyFormProperties>({
			format: new FormControl<PecerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PrfndPostBodyCertificateParameters {
	...
	export interface PrfndPostBodyCertificateParametersFormProperties {
	...
	export function CreatePrfndPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PrfndPostBodyCertificateParametersFormProperties>({
			AC_NO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
