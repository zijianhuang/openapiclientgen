...
export namespace MyNS {
	...
	export enum DailyMetricTimeSeriesDailyMetric { DAILY_METRIC_UNKNOWN = 0, BUSINESS_IMPRESSIONS_DESKTOP_MAPS = 1, BUSINESS_IMPRESSIONS_DESKTOP_SEARCH = 2, BUSINESS_IMPRESSIONS_MOBILE_MAPS = 3, BUSINESS_IMPRESSIONS_MOBILE_SEARCH = 4, BUSINESS_CONVERSATIONS = 5, BUSINESS_DIRECTION_REQUESTS = 6, CALL_CLICKS = 7, WEBSITE_CLICKS = 8, BUSINESS_BOOKINGS = 9, BUSINESS_FOOD_ORDERS = 10, BUSINESS_FOOD_MENU_CLICKS = 11 }
	...
	export enum DailySubEntityTypeDayOfWeek { DAY_OF_WEEK_UNSPECIFIED = 0, MONDAY = 1, TUESDAY = 2, WEDNESDAY = 3, THURSDAY = 4, FRIDAY = 5, SATURDAY = 6, SUNDAY = 7 }
