...
export namespace MyNS {
	...
	export interface SkmstPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<SkmstPostBodyFormat | null | undefined>,
	...
	export function CreateSkmstPostBodyFormGroup() {
		return new FormGroup<SkmstPostBodyFormProperties>({
			format: new FormControl<SkmstPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface SkmstPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		txt10thRollNo: FormControl<string | null | undefined>,

		/**
		 * Registration Number
		 * Required
		 */
		txtCandidateAppSeq: FormControl<string | null | undefined>,

		/**
		 * ExamDate
		 * Required
		 */
		txtExamDate: FormControl<string | null | undefined>,
	}
	export function CreateSkmstPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SkmstPostBodyCertificateParametersFormProperties>({
			txt10thRollNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			txtCandidateAppSeq: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			txtExamDate: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum SkmstPostBodyFormat { pdf = 'pdf' }
