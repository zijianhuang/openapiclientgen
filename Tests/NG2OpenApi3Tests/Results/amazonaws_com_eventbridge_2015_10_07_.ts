...
export namespace MyNS {
	...
	export enum ReplicationState { ENABLED = 0, DISABLED = 1 }
	...
	export enum EndpointState { ACTIVE = 0, CREATING = 1, UPDATING = 2, DELETING = 3, CREATE_FAILED = 4, UPDATE_FAILED = 5, DELETE_FAILED = 6 }
	...
	export enum CreateEndpointX_Amz_Target { 'AWSEvents.CreateEndpoint' = 0 }
	...
	export enum DeleteEndpointX_Amz_Target { 'AWSEvents.DeleteEndpoint' = 0 }
	...
	export enum DescribeEndpointX_Amz_Target { 'AWSEvents.DescribeEndpoint' = 0 }
	...
	export enum ListEndpointsX_Amz_Target { 'AWSEvents.ListEndpoints' = 0 }
	...
	export enum UpdateEndpointX_Amz_Target { 'AWSEvents.UpdateEndpoint' = 0 }
