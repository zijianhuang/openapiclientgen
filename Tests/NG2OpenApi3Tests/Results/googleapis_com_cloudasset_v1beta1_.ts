...
export namespace MyNS {
	...
	export interface ExportAssetsRequest {
		...
		contentType?: ExportAssetsRequestContentType | null;
	...
	export interface ExportAssetsRequestFormProperties {
		...
		/** Asset content type. If not specified, no content but the asset name will be returned. */
		contentType: FormControl<ExportAssetsRequestContentType | null | undefined>,
	...
	export function CreateExportAssetsRequestFormGroup() {
		return new FormGroup<ExportAssetsRequestFormProperties>({
			contentType: new FormControl<ExportAssetsRequestContentType | null | undefined>(undefined),
	...
	export class MyClient {
		 ...
		 */
		Cloudasset_projects_operations_get(name: string): Observable<Operation> {
		 ...
		 * Get v1beta1/{parent}:batchGetAssetsHistory
		 ...
		 * @param {ExportAssetsRequestContentType} contentType Optional. The content type.
		 ...
		 */
		Cloudasset_projects_batchGetAssetsHistory(parent: string, assetNames: Array<string> | null | undefined, contentType: ExportAssetsRequestContentType | null | undefined, readTimeWindow_endTime: string | null | undefined, readTimeWindow_startTime: string | null | undefined): Observable<BatchGetAssetsHistoryResponse> {
			return this.http.get<BatchGetAssetsHistoryResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':batchGetAssetsHistory&' + assetNames?.map(z => `assetNames=${encodeURIComponent(z)}`).join('&') + '&contentType=' + contentType + '&readTimeWindow_endTime=' + (readTimeWindow_endTime == null ? '' : encodeURIComponent(readTimeWindow_endTime)) + '&readTimeWindow_startTime=' + (readTimeWindow_startTime == null ? '' : encodeURIComponent(readTimeWindow_startTime)), {});
		}
		 ...
		 * Post v1beta1/{parent}:exportAssets
		 ...
		 * @return {Operation} Successful response
		 */
		Cloudasset_projects_exportAssets(parent: string, requestBody: ExportAssetsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':exportAssets', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
