...
export namespace MyNS {
	...
	export interface HvcerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<HvcerPostBodyFormat | null | undefined>,
	...
	export function CreateHvcerPostBodyFormGroup() {
		return new FormGroup<HvcerPostBodyFormProperties>({
			format: new FormControl<HvcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface HvcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		ROLL: FormControl<string | null | undefined>,

		/**
		 * Year of Passing
		 * Required
		 */
		YOP: FormControl<string | null | undefined>,
	}
	export function CreateHvcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<HvcerPostBodyCertificateParametersFormProperties>({
			...
			ROLL: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			YOP: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum HvcerPostBodyFormat { pdf = 'pdf' }
