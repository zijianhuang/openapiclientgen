...
export namespace MyNS {
	...
	export enum GoogleCloudRunV2ConditionExecutionReason { EXECUTION_REASON_UNDEFINED = 'EXECUTION_REASON_UNDEFINED', JOB_STATUS_SERVICE_POLLING_ERROR = 'JOB_STATUS_SERVICE_POLLING_ERROR', NON_ZERO_EXIT_CODE = 'NON_ZERO_EXIT_CODE', CANCELLED = 'CANCELLED', CANCELLING = 'CANCELLING', DELETED = 'DELETED' }

	export enum GoogleCloudRunV2ConditionReason { COMMON_REASON_UNDEFINED = 'COMMON_REASON_UNDEFINED', UNKNOWN = 'UNKNOWN', REVISION_FAILED = 'REVISION_FAILED', PROGRESS_DEADLINE_EXCEEDED = 'PROGRESS_DEADLINE_EXCEEDED', CONTAINER_MISSING = 'CONTAINER_MISSING', CONTAINER_PERMISSION_DENIED = 'CONTAINER_PERMISSION_DENIED', CONTAINER_IMAGE_UNAUTHORIZED = 'CONTAINER_IMAGE_UNAUTHORIZED', CONTAINER_IMAGE_AUTHORIZATION_CHECK_FAILED = 'CONTAINER_IMAGE_AUTHORIZATION_CHECK_FAILED', ENCRYPTION_KEY_PERMISSION_DENIED = 'ENCRYPTION_KEY_PERMISSION_DENIED', ENCRYPTION_KEY_CHECK_FAILED = 'ENCRYPTION_KEY_CHECK_FAILED', SECRETS_ACCESS_CHECK_FAILED = 'SECRETS_ACCESS_CHECK_FAILED', WAITING_FOR_OPERATION = 'WAITING_FOR_OPERATION', IMMEDIATE_RETRY = 'IMMEDIATE_RETRY', POSTPONED_RETRY = 'POSTPONED_RETRY', INTERNAL = 'INTERNAL' }

	export enum GoogleCloudRunV2ConditionRevisionReason { REVISION_REASON_UNDEFINED = 'REVISION_REASON_UNDEFINED', PENDING = 'PENDING', RESERVE = 'RESERVE', RETIRED = 'RETIRED', RETIRING = 'RETIRING', RECREATING = 'RECREATING', HEALTH_CHECK_CONTAINER_ERROR = 'HEALTH_CHECK_CONTAINER_ERROR', CUSTOMIZED_PATH_RESPONSE_PENDING = 'CUSTOMIZED_PATH_RESPONSE_PENDING', MIN_INSTANCES_NOT_PROVISIONED = 'MIN_INSTANCES_NOT_PROVISIONED', ACTIVE_REVISION_LIMIT_REACHED = 'ACTIVE_REVISION_LIMIT_REACHED', NO_DEPLOYMENT = 'NO_DEPLOYMENT', HEALTH_CHECK_SKIPPED = 'HEALTH_CHECK_SKIPPED', MIN_INSTANCES_WARMING = 'MIN_INSTANCES_WARMING' }

	export enum GoogleCloudRunV2ConditionSeverity { SEVERITY_UNSPECIFIED = 'SEVERITY_UNSPECIFIED', ERROR = 'ERROR', WARNING = 'WARNING', INFO = 'INFO' }

	export enum GoogleCloudRunV2ConditionState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', CONDITION_PENDING = 'CONDITION_PENDING', CONDITION_RECONCILING = 'CONDITION_RECONCILING', CONDITION_FAILED = 'CONDITION_FAILED', CONDITION_SUCCEEDED = 'CONDITION_SUCCEEDED' }
	...
	export enum GoogleCloudRunV2EmptyDirVolumeSourceMedium { MEDIUM_UNSPECIFIED = 'MEDIUM_UNSPECIFIED', MEMORY = 'MEMORY' }
	...
	export enum GoogleCloudRunV2ExecutionLaunchStage { LAUNCH_STAGE_UNSPECIFIED = 'LAUNCH_STAGE_UNSPECIFIED', UNIMPLEMENTED = 'UNIMPLEMENTED', PRELAUNCH = 'PRELAUNCH', EARLY_ACCESS = 'EARLY_ACCESS', ALPHA = 'ALPHA', BETA = 'BETA', GA = 'GA', DEPRECATED = 'DEPRECATED' }
	...
	export enum GoogleCloudRunV2TaskTemplateExecutionEnvironment { EXECUTION_ENVIRONMENT_UNSPECIFIED = 'EXECUTION_ENVIRONMENT_UNSPECIFIED', EXECUTION_ENVIRONMENT_GEN1 = 'EXECUTION_ENVIRONMENT_GEN1', EXECUTION_ENVIRONMENT_GEN2 = 'EXECUTION_ENVIRONMENT_GEN2' }
	...
	export enum GoogleCloudRunV2VpcAccessEgress { VPC_EGRESS_UNSPECIFIED = 'VPC_EGRESS_UNSPECIFIED', ALL_TRAFFIC = 'ALL_TRAFFIC', PRIVATE_RANGES_ONLY = 'PRIVATE_RANGES_ONLY' }
	...
	export enum GoogleCloudRunV2RevisionEncryptionKeyRevocationAction { ENCRYPTION_KEY_REVOCATION_ACTION_UNSPECIFIED = 'ENCRYPTION_KEY_REVOCATION_ACTION_UNSPECIFIED', PREVENT_NEW = 'PREVENT_NEW', SHUTDOWN = 'SHUTDOWN' }
	...
	export enum GoogleCloudRunV2ServiceIngress { INGRESS_TRAFFIC_UNSPECIFIED = 'INGRESS_TRAFFIC_UNSPECIFIED', INGRESS_TRAFFIC_ALL = 'INGRESS_TRAFFIC_ALL', INGRESS_TRAFFIC_INTERNAL_ONLY = 'INGRESS_TRAFFIC_INTERNAL_ONLY', INGRESS_TRAFFIC_INTERNAL_LOAD_BALANCER = 'INGRESS_TRAFFIC_INTERNAL_LOAD_BALANCER' }
	...
	export enum GoogleCloudRunV2TrafficTargetType { TRAFFIC_TARGET_ALLOCATION_TYPE_UNSPECIFIED = 'TRAFFIC_TARGET_ALLOCATION_TYPE_UNSPECIFIED', TRAFFIC_TARGET_ALLOCATION_TYPE_LATEST = 'TRAFFIC_TARGET_ALLOCATION_TYPE_LATEST', TRAFFIC_TARGET_ALLOCATION_TYPE_REVISION = 'TRAFFIC_TARGET_ALLOCATION_TYPE_REVISION' }
