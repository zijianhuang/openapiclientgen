...
export namespace MyNS {
	...
	export enum JobEventType { JOB_EVENT_TYPE_UNSPECIFIED = 'JOB_EVENT_TYPE_UNSPECIFIED', IMPRESSION = 'IMPRESSION', VIEW = 'VIEW', VIEW_REDIRECT = 'VIEW_REDIRECT', APPLICATION_START = 'APPLICATION_START', APPLICATION_FINISH = 'APPLICATION_FINISH', APPLICATION_QUICK_SUBMISSION = 'APPLICATION_QUICK_SUBMISSION', APPLICATION_REDIRECT = 'APPLICATION_REDIRECT', APPLICATION_START_FROM_SEARCH = 'APPLICATION_START_FROM_SEARCH', APPLICATION_REDIRECT_FROM_SEARCH = 'APPLICATION_REDIRECT_FROM_SEARCH', APPLICATION_COMPANY_SUBMIT = 'APPLICATION_COMPANY_SUBMIT', BOOKMARK = 'BOOKMARK', NOTIFICATION = 'NOTIFICATION', HIRED = 'HIRED', SENT_CV = 'SENT_CV', INTERVIEW_GRANTED = 'INTERVIEW_GRANTED', NOT_INTERESTED = 'NOT_INTERESTED' }
	...
	export enum CommuteFilterCommuteMethod { COMMUTE_METHOD_UNSPECIFIED = 'COMMUTE_METHOD_UNSPECIFIED', DRIVING = 'DRIVING', TRANSIT = 'TRANSIT', WALKING = 'WALKING', CYCLING = 'CYCLING' }
	...
	export enum CompensationHistogramRequestType { COMPENSATION_HISTOGRAM_REQUEST_TYPE_UNSPECIFIED = 'COMPENSATION_HISTOGRAM_REQUEST_TYPE_UNSPECIFIED', BASE = 'BASE', ANNUALIZED_BASE = 'ANNUALIZED_BASE', ANNUALIZED_TOTAL = 'ANNUALIZED_TOTAL' }
	...
	export enum HistogramResultSearchType { SEARCH_TYPE_UNSPECIFIED = 'SEARCH_TYPE_UNSPECIFIED', COMPANY_ID = 'COMPANY_ID', EMPLOYMENT_TYPE = 'EMPLOYMENT_TYPE', COMPANY_SIZE = 'COMPANY_SIZE', DATE_PUBLISHED = 'DATE_PUBLISHED', EDUCATION_LEVEL = 'EDUCATION_LEVEL', EXPERIENCE_LEVEL = 'EXPERIENCE_LEVEL', ADMIN_1 = 'ADMIN_1', COUNTRY = 'COUNTRY', CITY = 'CITY', LOCALE = 'LOCALE', LANGUAGE = 'LANGUAGE', CATEGORY = 'CATEGORY', CITY_COORDINATE = 'CITY_COORDINATE', ADMIN_1_COUNTRY = 'ADMIN_1_COUNTRY', COMPANY_DISPLAY_NAME = 'COMPANY_DISPLAY_NAME', BASE_COMPENSATION_UNIT = 'BASE_COMPENSATION_UNIT' }
	...
	export enum SearchJobsRequestDiversificationLevel { DIVERSIFICATION_LEVEL_UNSPECIFIED = 'DIVERSIFICATION_LEVEL_UNSPECIFIED', DISABLED = 'DISABLED', SIMPLE = 'SIMPLE' }
	...
	export class MyClient {
		...
		Jobs_projects_jobs_delete(name: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v3p1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 */
		Jobs_projects_operations_get(name: string): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'v3p1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Jobs_projects_jobs_patch(name: string, requestBody: UpdateJobRequest): Observable<Job> {
			return this.http.patch<Job>(this.baseUri + 'v3p1beta1/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Jobs_projects_complete(name: string, companyName: string | null | undefined, languageCode: string | null | undefined, languageCodes: Array<string> | null | undefined, pageSize: number | null | undefined, query: string | null | undefined, scope: Jobs_projects_completeScope | null | undefined, type: CompletionResultType | null | undefined): Observable<CompleteQueryResponse> {
			return this.http.get<CompleteQueryResponse>(this.baseUri + 'v3p1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':complete&companyName=' + (companyName == null ? '' : encodeURIComponent(companyName)) + '&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)) + '&' + languageCodes?.map(z => `languageCodes=${encodeURIComponent(z)}`).join('&') + '&pageSize=' + pageSize + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&scope=' + scope + '&type=' + type, {});
		}
		...
		Jobs_projects_clientEvents_create(parent: string, requestBody: CreateClientEventRequest): Observable<ClientEvent> {
			return this.http.post<ClientEvent>(this.baseUri + 'v3p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clientEvents', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Jobs_projects_companies_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, requireOpenJobs: boolean | null | undefined): Observable<ListCompaniesResponse> {
			return this.http.get<ListCompaniesResponse>(this.baseUri + 'v3p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/companies&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&requireOpenJobs=' + requireOpenJobs, {});
		}
		...
		Jobs_projects_companies_create(parent: string, requestBody: CreateCompanyRequest): Observable<Company> {
			return this.http.post<Company>(this.baseUri + 'v3p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/companies', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Jobs_projects_jobs_list(parent: string, filter: string | null | undefined, jobView: SearchJobsRequestJobView | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListJobsResponse> {
			return this.http.get<ListJobsResponse>(this.baseUri + 'v3p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/jobs&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&jobView=' + jobView + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Jobs_projects_jobs_create(parent: string, requestBody: CreateJobRequest): Observable<Job> {
			return this.http.post<Job>(this.baseUri + 'v3p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/jobs', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Jobs_projects_jobs_batchDelete(parent: string, requestBody: BatchDeleteJobsRequest): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'v3p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/jobs:batchDelete', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Jobs_projects_jobs_search(parent: string, requestBody: SearchJobsRequest): Observable<SearchJobsResponse> {
			return this.http.post<SearchJobsResponse>(this.baseUri + 'v3p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/jobs:search', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Jobs_projects_jobs_searchForAlert(parent: string, requestBody: SearchJobsRequest): Observable<SearchJobsResponse> {
			return this.http.post<SearchJobsResponse>(this.baseUri + 'v3p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/jobs:searchForAlert', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}

	export enum Jobs_projects_completeScope { COMPLETION_SCOPE_UNSPECIFIED = 'COMPLETION_SCOPE_UNSPECIFIED', TENANT = 'TENANT', PUBLIC = 'PUBLIC' }
