...
export namespace MyNS {
	...
	/** A path that an attacker could take to reach an exposed resource. */
	export interface AttackPathFormProperties {

		/** The attack path name, for example, `organizations/12/simulation/34/valuedResources/56/attackPaths/78` */
		name: FormControl<string | null | undefined>,
	}
	export function CreateAttackPathFormGroup() {
		return new FormGroup<AttackPathFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Represents a connection between a source node and a destination node in this attack path. */
	export interface AttackPathEdgeFormProperties {
	...
	export function CreateAttackPathEdgeFormGroup() {
		return new FormGroup<AttackPathEdgeFormProperties>({
	...
	/** Represents one point that an attacker passes through in this attack path. */
	export interface AttackPathNodeFormProperties {
	...
	export function CreateAttackPathNodeFormGroup() {
		return new FormGroup<AttackPathNodeFormProperties>({
	...
	/** A finding that is associated with this node in the attack path. */
	export interface PathNodeAssociatedFindingFormProperties {

		/** Canonical name of the associated findings. Example: organizations/123/sources/456/findings/789 */
		canonicalFinding: FormControl<string | null | undefined>,

		/** The additional taxonomy group within findings from a given source. */
		findingCategory: FormControl<string | null | undefined>,

		/** Full resource name of the finding. */
		name: FormControl<string | null | undefined>,
	}
	export function CreatePathNodeAssociatedFindingFormGroup() {
		return new FormGroup<PathNodeAssociatedFindingFormProperties>({
			canonicalFinding: new FormControl<string | null | undefined>(undefined),
			findingCategory: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Detailed steps the attack can take between path nodes. */
	export interface AttackStepNodeFormProperties {
		...
		/** Attack step type. Can be either AND, OR or DEFENSE */
		type: FormControl<AttackStepNodeType | null | undefined>,

		/** Unique ID for one Node */
		uuid: FormControl<string | null | undefined>,
	}
	export function CreateAttackStepNodeFormGroup() {
		return new FormGroup<AttackStepNodeFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			labels: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			type: new FormControl<AttackStepNodeType | null | undefined>(undefined),
			uuid: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message to create multiple resource value configs */
	export interface BatchCreateResourceValueConfigsRequestFormProperties {
	}
	export function CreateBatchCreateResourceValueConfigsRequestFormGroup() {
		return new FormGroup<BatchCreateResourceValueConfigsRequestFormProperties>({
		});
	...
	/** Request message to create single resource value config */
	export interface CreateResourceValueConfigRequestFormProperties {

		/** Required. Resource name of the new ResourceValueConfig's parent. */
		parent: FormControl<string | null | undefined>,
	}
	export function CreateCreateResourceValueConfigRequestFormGroup() {
		return new FormGroup<CreateResourceValueConfigRequestFormProperties>({
	...
	/** Response message for BatchCreateResourceValueConfigs */
	export interface BatchCreateResourceValueConfigsResponseFormProperties {
	}
	export function CreateBatchCreateResourceValueConfigsResponseFormGroup() {
		return new FormGroup<BatchCreateResourceValueConfigsResponseFormProperties>({
		});
	...
	/** Request message for bulk findings update. Note: 1. If multiple bulk update requests match the same resource, the order in which they get executed is not defined. 2. Once a bulk operation is started, there is no way to stop it. */
	export interface BulkMuteFindingsRequestFormProperties {

		/** Expression that identifies findings that should be updated. The expression is a list of zero or more restrictions combined via logical operators `AND` and `OR`. Parentheses are supported, and `OR` has higher precedence than `AND`. Restrictions have the form ` ` and may have a `-` character in front of them to indicate negation. The fields map to those defined in the corresponding resource. The supported operators are: * `=` for all value types. * `>`, `<`, `>=`, `<=` for integer values. * `:`, meaning substring matching, for strings. The supported value types are: * string literals in quotes. * integer literals without quotes. * boolean literals `true` and `false` without quotes. */
		filter: FormControl<string | null | undefined>,

		/** This can be a mute configuration name or any identifier for mute/unmute of findings based on the filter. */
		muteAnnotation: FormControl<string | null | undefined>,
	}
	export function CreateBulkMuteFindingsRequestFormGroup() {
		return new FormGroup<BulkMuteFindingsRequestFormProperties>({
			filter: new FormControl<string | null | undefined>(undefined),
			muteAnnotation: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** An error encountered while validating the uploaded configuration of an Event Threat Detection Custom Module. */
	export interface CustomModuleValidationErrorFormProperties {
	...
	export function CreateCustomModuleValidationErrorFormGroup() {
		return new FormGroup<CustomModuleValidationErrorFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
	...
	/** A list of zero or more errors encountered while validating the uploaded configuration of an Event Threat Detection Custom Module. */
	export interface CustomModuleValidationErrorsFormProperties {
	}
	export function CreateCustomModuleValidationErrorsFormGroup() {
		return new FormGroup<CustomModuleValidationErrorsFormProperties>({
		});
	...
	export interface EffectiveEventThreatDetectionCustomModule {
		...
		enablementState?: EffectiveEventThreatDetectionCustomModuleEnablementState | null;
	...
	/** An EffectiveEventThreatDetectionCustomModule is the representation of an Event Threat Detection custom module at a specified level of the resource hierarchy: organization, folder, or project. If a custom module is inherited from a parent organization or folder, the value of the `enablement_state` property in EffectiveEventThreatDetectionCustomModule is set to the value that is effective in the parent, instead of `INHERITED`. For example, if the module is enabled in a parent organization or folder, the effective `enablement_state` for the module in all child folders or projects is also `enabled`. EffectiveEventThreatDetectionCustomModule is read-only. */
	export interface EffectiveEventThreatDetectionCustomModuleFormProperties {

		/** Output only. Config for the effective module. */
		config: FormControl<{[id: string]: any } | null | undefined>,
		...
		/** Output only. The effective state of enablement for the module at the given level of the hierarchy. */
		enablementState: FormControl<EffectiveEventThreatDetectionCustomModuleEnablementState | null | undefined>,
	...
	export function CreateEffectiveEventThreatDetectionCustomModuleFormGroup() {
		return new FormGroup<EffectiveEventThreatDetectionCustomModuleFormProperties>({
			config: new FormControl<{[id: string]: any } | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			enablementState: new FormControl<EffectiveEventThreatDetectionCustomModuleEnablementState | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
	...
	export interface EventThreatDetectionCustomModule {
		...
		enablementState?: EventThreatDetectionCustomModuleEnablementState | null;
	...
	/** Represents an instance of an Event Threat Detection custom module, including its full module name, display name, enablement state, and last updated time. You can create a custom module at the organization, folder, or project level. Custom modules that you create at the organization or folder level are inherited by child folders and projects. */
	export interface EventThreatDetectionCustomModuleFormProperties {
		...
		/** The state of enablement for the module at the given level of the hierarchy. */
		enablementState: FormControl<EventThreatDetectionCustomModuleEnablementState | null | undefined>,
	...
	export function CreateEventThreatDetectionCustomModuleFormGroup() {
		return new FormGroup<EventThreatDetectionCustomModuleFormProperties>({
			ancestorModule: new FormControl<string | null | undefined>(undefined),
			config: new FormControl<{[id: string]: any } | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			enablementState: new FormControl<EventThreatDetectionCustomModuleEnablementState | null | undefined>(undefined),
	...
	/** Response message for listing the attack paths for a given simulation or valued resource. */
	export interface ListAttackPathsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListAttackPathsResponseFormGroup() {
		return new FormGroup<ListAttackPathsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for listing BigQuery exports. */
	export interface ListBigQueryExportsResponseFormProperties {

		/** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListBigQueryExportsResponseFormGroup() {
		return new FormGroup<ListBigQueryExportsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response for listing current and descendant resident Event Threat Detection custom modules. */
	export interface ListDescendantEventThreatDetectionCustomModulesResponseFormProperties {

		/** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListDescendantEventThreatDetectionCustomModulesResponseFormGroup() {
		return new FormGroup<ListDescendantEventThreatDetectionCustomModulesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for listing descendant Security Health Analytics custom modules. */
	export interface ListDescendantSecurityHealthAnalyticsCustomModulesResponseFormProperties {

		/** If not empty, indicates that there may be more custom modules to be returned. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListDescendantSecurityHealthAnalyticsCustomModulesResponseFormGroup() {
		return new FormGroup<ListDescendantSecurityHealthAnalyticsCustomModulesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response for listing EffectiveEventThreatDetectionCustomModules. */
	export interface ListEffectiveEventThreatDetectionCustomModulesResponseFormProperties {

		/** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListEffectiveEventThreatDetectionCustomModulesResponseFormGroup() {
		return new FormGroup<ListEffectiveEventThreatDetectionCustomModulesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for listing effective Security Health Analytics custom modules. */
	export interface ListEffectiveSecurityHealthAnalyticsCustomModulesResponseFormProperties {

		/** If not empty, indicates that there may be more effective custom modules to be returned. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListEffectiveSecurityHealthAnalyticsCustomModulesResponseFormGroup() {
		return new FormGroup<ListEffectiveSecurityHealthAnalyticsCustomModulesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response for listing Event Threat Detection custom modules. */
	export interface ListEventThreatDetectionCustomModulesResponseFormProperties {

		/** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListEventThreatDetectionCustomModulesResponseFormGroup() {
		return new FormGroup<ListEventThreatDetectionCustomModulesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for listing mute configs. */
	export interface ListMuteConfigsResponseFormProperties {

		/** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListMuteConfigsResponseFormGroup() {
		return new FormGroup<ListMuteConfigsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message to list resource value configs */
	export interface ListResourceValueConfigsResponseFormProperties {

		/** A token, which can be sent as `page_token` to retrieve the next page. If this field is empty, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListResourceValueConfigsResponseFormGroup() {
		return new FormGroup<ListResourceValueConfigsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for listing Security Health Analytics custom modules. */
	export interface ListSecurityHealthAnalyticsCustomModulesResponseFormProperties {

		/** If not empty, indicates that there may be more custom modules to be returned. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListSecurityHealthAnalyticsCustomModulesResponseFormGroup() {
		return new FormGroup<ListSecurityHealthAnalyticsCustomModulesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for listing the valued resources for a given simulation. */
	export interface ListValuedResourcesResponseFormProperties {
	...
	export function CreateListValuedResourcesResponseFormGroup() {
		return new FormGroup<ListValuedResourcesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
			totalSize: new FormControl<number | null | undefined>(undefined),
		});
	...
	export interface ValuedResource {
		...
		resourceValue?: ValuedResourceResourceValue | null;
	...
	/** A resource that is determined to have value to a user's system */
	export interface ValuedResourceFormProperties {
		 ...
		 * Type: double
		 */
		exposedScore: FormControl<number | null | undefined>,
		...
		/** How valuable this resource is. */
		resourceValue: FormControl<ValuedResourceResourceValue | null | undefined>,
	}
	export function CreateValuedResourceFormGroup() {
		return new FormGroup<ValuedResourceFormProperties>({
			displayName: new FormControl<string | null | undefined>(undefined),
			exposedScore: new FormControl<number | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			resource: new FormControl<string | null | undefined>(undefined),
			resourceType: new FormControl<string | null | undefined>(undefined),
			resourceValue: new FormControl<ValuedResourceResourceValue | null | undefined>(undefined),
		});
	...
	/** Metadata about a ResourceValueConfig. For example, id and name. */
	export interface ResourceValueConfigMetadataFormProperties {

		/** Resource value config name */
		name: FormControl<string | null | undefined>,
	}
	export function CreateResourceValueConfigMetadataFormGroup() {
		return new FormGroup<ResourceValueConfigMetadataFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message for updating a finding's mute status. */
	export interface SetMuteRequestFormProperties {

		/** Required. The desired state of the Mute. */
		mute: FormControl<FindingMute | null | undefined>,
	}
	export function CreateSetMuteRequestFormGroup() {
		return new FormGroup<SetMuteRequestFormProperties>({
			mute: new FormControl<FindingMute | null | undefined>(undefined),
		});
	...
	/** Request message to simulate a CustomConfig against a given test resource. Maximum size of the request is 4 MB by default. */
	export interface SimulateSecurityHealthAnalyticsCustomModuleRequestFormProperties {
	}
	export function CreateSimulateSecurityHealthAnalyticsCustomModuleRequestFormGroup() {
		return new FormGroup<SimulateSecurityHealthAnalyticsCustomModuleRequestFormProperties>({
		});
	...
	/** Manually constructed resource name. If the custom module evaluates against only the resource data, you can omit the `iam_policy_data` field. If it evaluates only the `iam_policy_data` field, you can omit the resource data. */
	export interface SimulatedResourceFormProperties {

		/** Optional. A representation of the Google Cloud resource. Should match the Google Cloud resource JSON format. */
		resourceData: FormControl<{[id: string]: any } | null | undefined>,

		/** Required. The type of the resource, for example, `compute.googleapis.com/Disk`. */
		resourceType: FormControl<string | null | undefined>,
	}
	export function CreateSimulatedResourceFormGroup() {
		return new FormGroup<SimulatedResourceFormProperties>({
			resourceData: new FormControl<{[id: string]: any } | null | undefined>(undefined),
			resourceType: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response message for simulating a `SecurityHealthAnalyticsCustomModule` against a given resource. */
	export interface SimulateSecurityHealthAnalyticsCustomModuleResponseFormProperties {
	}
	export function CreateSimulateSecurityHealthAnalyticsCustomModuleResponseFormGroup() {
		return new FormGroup<SimulateSecurityHealthAnalyticsCustomModuleResponseFormProperties>({
		});
	...
	/** Possible test result. */
	export interface SimulatedResultFormProperties {
	}
	export function CreateSimulatedResultFormGroup() {
		return new FormGroup<SimulatedResultFormProperties>({
		});
	...
	/** Attack path simulation */
	export interface SimulationFormProperties {
	...
	export function CreateSimulationFormGroup() {
		return new FormGroup<SimulationFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request to validate an Event Threat Detection custom module. */
	export interface ValidateEventThreatDetectionCustomModuleRequestFormProperties {
	...
	export function CreateValidateEventThreatDetectionCustomModuleRequestFormGroup() {
		return new FormGroup<ValidateEventThreatDetectionCustomModuleRequestFormProperties>({
	...
	/** Response to validating an Event Threat Detection custom module. */
	export interface ValidateEventThreatDetectionCustomModuleResponseFormProperties {
	}
	export function CreateValidateEventThreatDetectionCustomModuleResponseFormGroup() {
		return new FormGroup<ValidateEventThreatDetectionCustomModuleResponseFormProperties>({
		});
	...
	export class MyClient {
		 ...
		 * Delete v1/{name}
		 * @param {string} name Required. Name of the custom module to delete. Its format is "organizations/{organization}/securityHealthAnalyticsSettings/customModules/{customModule}", "folders/{folder}/securityHealthAnalyticsSettings/customModules/{customModule}", or "projects/{project}/securityHealthAnalyticsSettings/customModules/{customModule}"
		 * @return {Empty} Successful response
		 */
		Securitycenter_projects_securityHealthAnalyticsSettings_customModules_delete(name: string): Observable<Empty> {
		 ...
		 * Get v1/{name}
		 * @param {string} name Required. Name of the effective custom module to get. Its format is "organizations/{organization}/securityHealthAnalyticsSettings/effectiveCustomModules/{customModule}", "folders/{folder}/securityHealthAnalyticsSettings/effectiveCustomModules/{customModule}", or "projects/{project}/securityHealthAnalyticsSettings/effectiveCustomModules/{customModule}"
		 * @param {string} filter The standard list filter.
		 * @param {number} pageSize The standard list page size.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The standard list page token.
		 * @return {GoogleCloudSecuritycenterV1EffectiveSecurityHealthAnalyticsCustomModule} Successful response
		 */
		Securitycenter_projects_securityHealthAnalyticsSettings_effectiveCustomModules_get(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudSecuritycenterV1EffectiveSecurityHealthAnalyticsCustomModule> {
			return this.http.get<GoogleCloudSecuritycenterV1EffectiveSecurityHealthAnalyticsCustomModule>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Updates external system. This is for a given finding.
		 * Patch v1/{name}
		 * @param {string} name Full resource name of the external system, for example: "organizations/1234/sources/5678/findings/123456/externalSystems/jira", "folders/1234/sources/5678/findings/123456/externalSystems/jira", "projects/1234/sources/5678/findings/123456/externalSystems/jira"
		 * @param {string} updateMask The FieldMask to use when updating the external system resource. If empty all mutable fields will be updated.
		 * @return {GoogleCloudSecuritycenterV1ExternalSystem} Successful response
		 */
		Securitycenter_projects_sources_findings_externalSystems_patch(name: string, updateMask: string | null | undefined, requestBody: GoogleCloudSecuritycenterV1ExternalSystem): Observable<GoogleCloudSecuritycenterV1ExternalSystem> {
			return this.http.patch<GoogleCloudSecuritycenterV1ExternalSystem>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Securitycenter_organizations_operations_cancel(name: string): Observable<Empty> {
		 ...
		 * @param {string} name Required. The [relative resource name](https://cloud.google.com/apis/design/resource_names#relative_resource_name) of the finding. Example: "organizations/{organization_id}/sources/{source_id}/findings/{finding_id}", "folders/{folder_id}/sources/{source_id}/findings/{finding_id}", "projects/{project_id}/sources/{source_id}/findings/{finding_id}".
		 * @return {Finding} Successful response
		 */
		Securitycenter_projects_sources_findings_setMute(name: string, requestBody: SetMuteRequest): Observable<Finding> {
			return this.http.post<Finding>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':setMute', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Finding} Successful response
		 */
		Securitycenter_projects_sources_findings_setState(name: string, requestBody: SetFindingStateRequest): Observable<Finding> {
			return this.http.post<Finding>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':setState', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists an organization's assets.
		 * Get v1/{parent}/assets
		 * @param {string} parent Required. The name of the parent resource that contains the assets. The value that you can specify on parent depends on the method in which you specify parent. You can specify one of the following values: "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
		 * @param {string} compareDuration When compare_duration is set, the ListAssetsResult's "state_change" attribute is updated to indicate whether the asset was added, removed, or remained present during the compare_duration period of time that precedes the read_time. This is the time between (read_time - compare_duration) and read_time. The state_change value is derived based on the presence of the asset at the two points in time. Intermediate state changes between the two times don't affect the result. For example, the results aren't affected if the asset is removed and re-created again. Possible "state_change" values when compare_duration is specified: * "ADDED": indicates that the asset was not present at the start of compare_duration, but present at read_time. * "REMOVED": indicates that the asset was present at the start of compare_duration, but not present at read_time. * "ACTIVE": indicates that the asset was present at both the start and the end of the time period defined by compare_duration and read_time. If compare_duration is not specified, then the only possible state_change is "UNUSED", which will be the state_change set for all assets present at read_time.
		 * @param {string} fieldMask A field mask to specify the ListAssetsResult fields to be listed in the response. An empty field mask will list all fields.
		 ...
		 */
		Securitycenter_projects_assets_list(parent: string, compareDuration: string | null | undefined, fieldMask: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, readTime: string | null | undefined): Observable<ListAssetsResponse> {
		 ...
		 * @param {string} parent Required. The name of the parent to group the assets by. Its format is "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
		 * @return {GroupAssetsResponse} Successful response
		 */
		Securitycenter_projects_assets_group(parent: string, requestBody: GroupAssetsRequest): Observable<GroupAssetsResponse> {
			return this.http.post<GroupAssetsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assets:group', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Securitycenter_organizations_assets_runDiscovery(parent: string, requestBody: RunAssetDiscoveryRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assets:runDiscovery', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists the attack paths for a set of simulation results or valued resources and filter.
		 * Get v1/{parent}/attackPaths
		 * @param {string} parent Required. Name of parent to list attack paths. Valid formats: "organizations/{organization}", "organizations/{organization}/simulations/{simulation}" "organizations/{organization}/simulations/{simulation}/attackExposureResults/{attack_exposure_result_v2}" "organizations/{organization}/simulations/{simulation}/valuedResources/{valued_resource}"
		 * @param {string} filter The filter expression that filters the attack path in the response. Supported fields: * `valued_resources` supports =
		 * @param {number} pageSize The maximum number of results to return in a single response. Default is 10, minimum is 1, maximum is 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The value returned by the last `ListAttackPathsResponse`; indicates that this is a continuation of a prior `ListAttackPaths` call, and that the system should return the next page of data.
		 * @return {ListAttackPathsResponse} Successful response
		 */
		Securitycenter_organizations_simulations_valuedResources_attackPaths_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAttackPathsResponse> {
			return this.http.get<ListAttackPathsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/attackPaths&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Lists BigQuery exports. Note that when requesting BigQuery exports at a given level all exports under that level are also returned e.g. if requesting BigQuery exports under a folder, then all BigQuery exports immediately under the folder plus the ones created under the projects within the folder are returned.
		 * Get v1/{parent}/bigQueryExports
		 * @param {string} parent Required. The parent, which owns the collection of BigQuery exports. Its format is "organizations/[organization_id]", "folders/[folder_id]", "projects/[project_id]".
		 * @param {number} pageSize The maximum number of configs to return. The service may return fewer than this value. If unspecified, at most 10 configs will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken A page token, received from a previous `ListBigQueryExports` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListBigQueryExports` must match the call that provided the page token.
		 * @return {ListBigQueryExportsResponse} Successful response
		 */
		Securitycenter_projects_bigQueryExports_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListBigQueryExportsResponse> {
			return this.http.get<ListBigQueryExportsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/bigQueryExports&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a BigQuery export.
		 * Post v1/{parent}/bigQueryExports
		 * @param {string} parent Required. The name of the parent resource of the new BigQuery export. Its format is "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
		 * @param {string} bigQueryExportId Required. Unique identifier provided by the client within the parent scope. It must consist of only lowercase letters, numbers, and hyphens, must start with a letter, must end with either a letter or a number, and must be 63 characters or less.
		 * @return {GoogleCloudSecuritycenterV1BigQueryExport} Successful response
		 */
		Securitycenter_projects_bigQueryExports_create(parent: string, bigQueryExportId: string | null | undefined, requestBody: GoogleCloudSecuritycenterV1BigQueryExport): Observable<GoogleCloudSecuritycenterV1BigQueryExport> {
			return this.http.post<GoogleCloudSecuritycenterV1BigQueryExport>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/bigQueryExports&bigQueryExportId=' + (bigQueryExportId == null ? '' : encodeURIComponent(bigQueryExportId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Returns a list of all SecurityHealthAnalyticsCustomModules for the given parent. This includes resident modules defined at the scope of the parent, and inherited modules, inherited from CRM ancestors.
		 * Get v1/{parent}/customModules
		 * @param {string} parent Required. Name of parent to list custom modules. Its format is "organizations/{organization}/securityHealthAnalyticsSettings", "folders/{folder}/securityHealthAnalyticsSettings", or "projects/{project}/securityHealthAnalyticsSettings"
		 * @param {number} pageSize The maximum number of results to return in a single response. Default is 10, minimum is 1, maximum is 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The value returned by the last call indicating a continuation
		 * @return {ListSecurityHealthAnalyticsCustomModulesResponse} Successful response
		 */
		Securitycenter_projects_securityHealthAnalyticsSettings_customModules_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSecurityHealthAnalyticsCustomModulesResponse> {
			return this.http.get<ListSecurityHealthAnalyticsCustomModulesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/customModules&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a resident SecurityHealthAnalyticsCustomModule at the scope of the given CRM parent, and also creates inherited SecurityHealthAnalyticsCustomModules for all CRM descendants of the given parent. These modules are enabled by default.
		 * Post v1/{parent}/customModules
		 * @param {string} parent Required. Resource name of the new custom module's parent. Its format is "organizations/{organization}/securityHealthAnalyticsSettings", "folders/{folder}/securityHealthAnalyticsSettings", or "projects/{project}/securityHealthAnalyticsSettings"
		 * @return {GoogleCloudSecuritycenterV1SecurityHealthAnalyticsCustomModule} Successful response
		 */
		Securitycenter_projects_securityHealthAnalyticsSettings_customModules_create(parent: string, requestBody: GoogleCloudSecuritycenterV1SecurityHealthAnalyticsCustomModule): Observable<GoogleCloudSecuritycenterV1SecurityHealthAnalyticsCustomModule> {
			return this.http.post<GoogleCloudSecuritycenterV1SecurityHealthAnalyticsCustomModule>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/customModules', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Returns a list of all resident SecurityHealthAnalyticsCustomModules under the given CRM parent and all of the parent’s CRM descendants.
		 * Get v1/{parent}/customModules:listDescendant
		 * @param {string} parent Required. Name of parent to list descendant custom modules. Its format is "organizations/{organization}/securityHealthAnalyticsSettings", "folders/{folder}/securityHealthAnalyticsSettings", or "projects/{project}/securityHealthAnalyticsSettings"
		 * @param {number} pageSize The maximum number of results to return in a single response. Default is 10, minimum is 1, maximum is 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The value returned by the last call indicating a continuation
		 * @return {ListDescendantSecurityHealthAnalyticsCustomModulesResponse} Successful response
		 */
		Securitycenter_projects_securityHealthAnalyticsSettings_customModules_listDescendant(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDescendantSecurityHealthAnalyticsCustomModulesResponse> {
			return this.http.get<ListDescendantSecurityHealthAnalyticsCustomModulesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/customModules:listDescendant&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Simulates a given SecurityHealthAnalyticsCustomModule and Resource.
		 * Post v1/{parent}/customModules:simulate
		 * @param {string} parent Required. The relative resource name of the organization, project, or folder. For more information about relative resource names, see [Relative Resource Name](https://cloud.google.com/apis/design/resource_names#relative_resource_name) Example: `organizations/{organization_id}`
		 * @return {SimulateSecurityHealthAnalyticsCustomModuleResponse} Successful response
		 */
		Securitycenter_projects_securityHealthAnalyticsSettings_customModules_simulate(parent: string, requestBody: SimulateSecurityHealthAnalyticsCustomModuleRequest): Observable<SimulateSecurityHealthAnalyticsCustomModuleResponse> {
			return this.http.post<SimulateSecurityHealthAnalyticsCustomModuleResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/customModules:simulate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Returns a list of all EffectiveSecurityHealthAnalyticsCustomModules for the given parent. This includes resident modules defined at the scope of the parent, and inherited modules, inherited from CRM ancestors.
		 * Get v1/{parent}/effectiveCustomModules
		 * @param {string} parent Required. Name of parent to list effective custom modules. Its format is "organizations/{organization}/securityHealthAnalyticsSettings", "folders/{folder}/securityHealthAnalyticsSettings", or "projects/{project}/securityHealthAnalyticsSettings"
		 * @param {number} pageSize The maximum number of results to return in a single response. Default is 10, minimum is 1, maximum is 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The value returned by the last call indicating a continuation
		 * @return {ListEffectiveSecurityHealthAnalyticsCustomModulesResponse} Successful response
		 */
		Securitycenter_projects_securityHealthAnalyticsSettings_effectiveCustomModules_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListEffectiveSecurityHealthAnalyticsCustomModulesResponse> {
			return this.http.get<ListEffectiveSecurityHealthAnalyticsCustomModulesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/effectiveCustomModules&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @param {string} fieldMask A field mask to specify the Finding fields to be listed in the response. An empty field mask will list all fields.
		 ...
		 */
		Securitycenter_projects_sources_findings_list(parent: string, compareDuration: string | null | undefined, fieldMask: string | null | undefined, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, readTime: string | null | undefined): Observable<ListFindingsResponse> {
		 ...
		 * @return {Finding} Successful response
		 */
		Securitycenter_organizations_sources_findings_create(parent: string, findingId: string | null | undefined, requestBody: Finding): Observable<Finding> {
			return this.http.post<Finding>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/findings&findingId=' + (findingId == null ? '' : encodeURIComponent(findingId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Kicks off an LRO to bulk mute findings for a parent based on a filter. The parent can be either an organization, folder or project. The findings matched by the filter will be muted after the LRO is done.
		 * Post v1/{parent}/findings:bulkMute
		 * @param {string} parent Required. The parent, at which bulk action needs to be applied. Its format is "organizations/[organization_id]", "folders/[folder_id]", "projects/[project_id]".
		 * @return {Operation} Successful response
		 */
		Securitycenter_projects_findings_bulkMute(parent: string, requestBody: BulkMuteFindingsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/findings:bulkMute', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Securitycenter_projects_sources_findings_group(parent: string, requestBody: GroupFindingsRequest): Observable<GroupFindingsResponse> {
			return this.http.post<GroupFindingsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/findings:group', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists mute configs.
		 * Get v1/{parent}/muteConfigs
		 * @param {string} parent Required. The parent, which owns the collection of mute configs. Its format is "organizations/[organization_id]", "folders/[folder_id]", "projects/[project_id]".
		 * @param {number} pageSize The maximum number of configs to return. The service may return fewer than this value. If unspecified, at most 10 configs will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken A page token, received from a previous `ListMuteConfigs` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListMuteConfigs` must match the call that provided the page token.
		 * @return {ListMuteConfigsResponse} Successful response
		 */
		Securitycenter_projects_muteConfigs_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListMuteConfigsResponse> {
			return this.http.get<ListMuteConfigsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/muteConfigs&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a mute config.
		 * Post v1/{parent}/muteConfigs
		 * @param {string} parent Required. Resource name of the new mute configs's parent. Its format is "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
		 * @param {string} muteConfigId Required. Unique identifier provided by the client within the parent scope. It must consist of only lowercase letters, numbers, and hyphens, must start with a letter, must end with either a letter or a number, and must be 63 characters or less.
		 * @return {GoogleCloudSecuritycenterV1MuteConfig} Successful response
		 */
		Securitycenter_projects_muteConfigs_create(parent: string, muteConfigId: string | null | undefined, requestBody: GoogleCloudSecuritycenterV1MuteConfig): Observable<GoogleCloudSecuritycenterV1MuteConfig> {
			return this.http.post<GoogleCloudSecuritycenterV1MuteConfig>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/muteConfigs&muteConfigId=' + (muteConfigId == null ? '' : encodeURIComponent(muteConfigId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists notification configs.
		 * Get v1/{parent}/notificationConfigs
		 * @param {string} parent Required. The name of the parent in which to list the notification configurations. Its format is "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
		 * @param {number} pageSize The maximum number of results to return in a single response. Default is 10, minimum is 1, maximum is 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The value returned by the last `ListNotificationConfigsResponse`; indicates that this is a continuation of a prior `ListNotificationConfigs` call, and that the system should return the next page of data.
		 * @return {ListNotificationConfigsResponse} Successful response
		 */
		Securitycenter_projects_notificationConfigs_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListNotificationConfigsResponse> {
			return this.http.get<ListNotificationConfigsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/notificationConfigs&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a notification config.
		 * Post v1/{parent}/notificationConfigs
		 * @param {string} parent Required. Resource name of the new notification config's parent. Its format is "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
		 * @param {string} configId Required. Unique identifier provided by the client within the parent scope. It must be between 1 and 128 characters and contain alphanumeric characters, underscores, or hyphens only.
		 * @return {NotificationConfig} Successful response
		 */
		Securitycenter_projects_notificationConfigs_create(parent: string, configId: string | null | undefined, requestBody: NotificationConfig): Observable<NotificationConfig> {
			return this.http.post<NotificationConfig>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/notificationConfigs&configId=' + (configId == null ? '' : encodeURIComponent(configId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all ResourceValueConfigs.
		 * Get v1/{parent}/resourceValueConfigs
		 * @param {string} parent Required. The parent, which owns the collection of resource value configs. Its format is "organizations/[organization_id]"
		 * @param {number} pageSize The number of results to return. The service may return fewer than this value. If unspecified, at most 10 configs will be returned. The maximum value is 1000; values above 1000 will be coerced to 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 ...
		 * @return {ListResourceValueConfigsResponse} Successful response
		 */
		Securitycenter_organizations_resourceValueConfigs_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListResourceValueConfigsResponse> {
			return this.http.get<ListResourceValueConfigsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/resourceValueConfigs&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a ResourceValueConfig for an organization. Maps user's tags to difference resource values for use by the attack path simulation.
		 * Post v1/{parent}/resourceValueConfigs:batchCreate
		 * @param {string} parent Required. Resource name of the new ResourceValueConfig's parent. The parent field in the CreateResourceValueConfigRequest messages must either be empty or match this field.
		 * @return {BatchCreateResourceValueConfigsResponse} Successful response
		 */
		Securitycenter_organizations_resourceValueConfigs_batchCreate(parent: string, requestBody: BatchCreateResourceValueConfigsRequest): Observable<BatchCreateResourceValueConfigsResponse> {
			return this.http.post<BatchCreateResourceValueConfigsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/resourceValueConfigs:batchCreate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all sources belonging to an organization.
		 * Get v1/{parent}/sources
		 * @param {string} parent Required. Resource name of the parent of sources to list. Its format should be "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
		 * @param {number} pageSize The maximum number of results to return in a single response. Default is 10, minimum is 1, maximum is 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 ...
		 */
		Securitycenter_projects_sources_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSourcesResponse> {
			return this.http.get<ListSourcesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sources&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Securitycenter_organizations_sources_create(parent: string, requestBody: Source): Observable<Source> {
			return this.http.post<Source>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sources', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists the valued resources for a set of simulation results and filter.
		 * Get v1/{parent}/valuedResources
		 * @param {string} parent Required. Name of parent to list valued resources. Valid formats: "organizations/{organization}", "organizations/{organization}/simulations/{simulation}" "organizations/{organization}/simulations/{simulation}/attackExposureResults/{attack_exposure_result_v2}"
		 * @param {string} filter The filter expression that filters the valued resources in the response. Supported fields: * `resource_value` supports = * `resource_type` supports =
		 * @param {number} pageSize The maximum number of results to return in a single response. Default is 10, minimum is 1, maximum is 1000.
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The value returned by the last `ListValuedResourcesResponse`; indicates that this is a continuation of a prior `ListValuedResources` call, and that the system should return the next page of data.
		 * @return {ListValuedResourcesResponse} Successful response
		 */
		Securitycenter_organizations_simulations_valuedResources_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListValuedResourcesResponse> {
			return this.http.get<ListValuedResourcesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/valuedResources&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Validates the given Event Threat Detection custom module.
		 * Post v1/{parent}:validateCustomModule
		 * @param {string} parent Required. Resource name of the parent to validate the Custom Module under. Its format is: * "organizations/{organization}/eventThreatDetectionSettings". * "folders/{folder}/eventThreatDetectionSettings". * "projects/{project}/eventThreatDetectionSettings".
		 * @return {ValidateEventThreatDetectionCustomModuleResponse} Successful response
		 */
		Securitycenter_projects_eventThreatDetectionSettings_validateCustomModule(parent: string, requestBody: ValidateEventThreatDetectionCustomModuleRequest): Observable<ValidateEventThreatDetectionCustomModuleResponse> {
			return this.http.post<ValidateEventThreatDetectionCustomModuleResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':validateCustomModule', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
