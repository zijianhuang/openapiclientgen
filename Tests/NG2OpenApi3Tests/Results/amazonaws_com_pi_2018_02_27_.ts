...
export namespace MyNS {
	...
	export enum ServiceType { RDS = 'RDS', DOCDB = 'DOCDB' }
	...
	export enum DetailStatus { AVAILABLE = 'AVAILABLE', PROCESSING = 'PROCESSING', UNAVAILABLE = 'UNAVAILABLE' }
	...
	export enum PeriodAlignment { END_TIME = 'END_TIME', START_TIME = 'START_TIME' }
	...
	export enum FeatureStatus { ENABLED = 'ENABLED', DISABLED = 'DISABLED', UNSUPPORTED = 'UNSUPPORTED', ENABLED_PENDING_REBOOT = 'ENABLED_PENDING_REBOOT', DISABLED_PENDING_REBOOT = 'DISABLED_PENDING_REBOOT', UNKNOWN = 'UNKNOWN' }
	...
	export enum DescribeDimensionKeysX_Amz_Target { 'PerformanceInsightsv20180227.DescribeDimensionKeys' = 'PerformanceInsightsv20180227.DescribeDimensionKeys' }

	export enum GetDimensionKeyDetailsX_Amz_Target { 'PerformanceInsightsv20180227.GetDimensionKeyDetails' = 'PerformanceInsightsv20180227.GetDimensionKeyDetails' }

	export enum GetResourceMetadataX_Amz_Target { 'PerformanceInsightsv20180227.GetResourceMetadata' = 'PerformanceInsightsv20180227.GetResourceMetadata' }

	export enum GetResourceMetricsX_Amz_Target { 'PerformanceInsightsv20180227.GetResourceMetrics' = 'PerformanceInsightsv20180227.GetResourceMetrics' }

	export enum ListAvailableResourceDimensionsX_Amz_Target { 'PerformanceInsightsv20180227.ListAvailableResourceDimensions' = 'PerformanceInsightsv20180227.ListAvailableResourceDimensions' }

	export enum ListAvailableResourceMetricsX_Amz_Target { 'PerformanceInsightsv20180227.ListAvailableResourceMetrics' = 'PerformanceInsightsv20180227.ListAvailableResourceMetrics' }
