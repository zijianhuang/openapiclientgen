...
export namespace MyNS {
	...
	export interface DisableServiceRequest {
		...
		checkIfServiceHasUsage?: DisableServiceRequestCheckIfServiceHasUsage | null;
	...
	export interface DisableServiceRequestFormProperties {
		...
		/** Defines the behavior for checking service usage when disabling a service. */
		checkIfServiceHasUsage: FormControl<DisableServiceRequestCheckIfServiceHasUsage | null | undefined>,
	...
	export function CreateDisableServiceRequestFormGroup() {
		return new FormGroup<DisableServiceRequestFormProperties>({
			checkIfServiceHasUsage: new FormControl<DisableServiceRequestCheckIfServiceHasUsage | null | undefined>(undefined),
			disableDependentServices: new FormControl<boolean | null | undefined>(undefined),
		});

	}

	export enum DisableServiceRequestCheckIfServiceHasUsage { CHECK_IF_SERVICE_HAS_USAGE_UNSPECIFIED = 'CHECK_IF_SERVICE_HAS_USAGE_UNSPECIFIED', SKIP = 'SKIP', CHECK = 'CHECK' }
	...
	export class MyClient {
		 ...
		 */
		Serviceusage_operations_delete(name: string): Observable<Empty> {
		 ...
		 * @return {GoogleApiServiceusageV1Service} Successful response
		 */
		Serviceusage_services_get(name: string): Observable<GoogleApiServiceusageV1Service> {
			return this.http.get<GoogleApiServiceusageV1Service>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Serviceusage_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<Empty> {
		...
		Serviceusage_services_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListServicesResponse> {
			return this.http.get<ListServicesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/services&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Serviceusage_services_batchEnable(parent: string, requestBody: BatchEnableServicesRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/services:batchEnable', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {BatchGetServicesResponse} Successful response
		 */
		Serviceusage_services_batchGet(parent: string, names: Array<string> | null | undefined): Observable<BatchGetServicesResponse> {
			return this.http.get<BatchGetServicesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/services:batchGet&' + names?.map(z => `names=${encodeURIComponent(z)}`).join('&'), {});
		}
	}
