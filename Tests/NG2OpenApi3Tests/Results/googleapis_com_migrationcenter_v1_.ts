...
export namespace MyNS {
	...
	export enum MachineArchitectureDetailsFirmwareType { FIRMWARE_TYPE_UNSPECIFIED = 'FIRMWARE_TYPE_UNSPECIFIED', BIOS = 'BIOS', EFI = 'EFI' }

	export enum MachineArchitectureDetailsHyperthreading { CPU_HYPER_THREADING_UNSPECIFIED = 'CPU_HYPER_THREADING_UNSPECIFIED', DISABLED = 'DISABLED', ENABLED = 'ENABLED' }
	...
	export enum DiskEntryInterfaceType { INTERFACE_TYPE_UNSPECIFIED = 'INTERFACE_TYPE_UNSPECIFIED', IDE = 'IDE', SATA = 'SATA', SAS = 'SAS', SCSI = 'SCSI', NVME = 'NVME', FC = 'FC', ISCSI = 'ISCSI' }
	...
	export enum VmwareDiskConfigRdmCompatibility { RDM_COMPATIBILITY_UNSPECIFIED = 'RDM_COMPATIBILITY_UNSPECIFIED', PHYSICAL_COMPATIBILITY = 'PHYSICAL_COMPATIBILITY', VIRTUAL_COMPATIBILITY = 'VIRTUAL_COMPATIBILITY' }

	export enum VmwareDiskConfigVmdkMode { VMDK_MODE_UNSPECIFIED = 'VMDK_MODE_UNSPECIFIED', DEPENDENT = 'DEPENDENT', INDEPENDENT_PERSISTENT = 'INDEPENDENT_PERSISTENT', INDEPENDENT_NONPERSISTENT = 'INDEPENDENT_NONPERSISTENT' }
	...
	export enum GuestConfigDetailsSelinuxMode { SE_LINUX_MODE_UNSPECIFIED = 'SE_LINUX_MODE_UNSPECIFIED', SE_LINUX_MODE_DISABLED = 'SE_LINUX_MODE_DISABLED', SE_LINUX_MODE_PERMISSIVE = 'SE_LINUX_MODE_PERMISSIVE', SE_LINUX_MODE_ENFORCING = 'SE_LINUX_MODE_ENFORCING' }

	export enum GuestOsDetailsFamily { OS_FAMILY_UNKNOWN = 'OS_FAMILY_UNKNOWN', OS_FAMILY_WINDOWS = 'OS_FAMILY_WINDOWS', OS_FAMILY_LINUX = 'OS_FAMILY_LINUX', OS_FAMILY_UNIX = 'OS_FAMILY_UNIX' }
	...
	export enum NetworkConnectionState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', OPENING = 'OPENING', OPEN = 'OPEN', LISTEN = 'LISTEN', CLOSING = 'CLOSING', CLOSED = 'CLOSED' }
	...
	export enum RunningServiceStartMode { START_MODE_UNSPECIFIED = 'START_MODE_UNSPECIFIED', BOOT = 'BOOT', SYSTEM = 'SYSTEM', AUTO = 'AUTO', MANUAL = 'MANUAL', DISABLED = 'DISABLED' }

	export enum RunningServiceState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', ACTIVE = 'ACTIVE', PAUSED = 'PAUSED', STOPPED = 'STOPPED' }
	...
	export enum MachineDetailsPowerState { POWER_STATE_UNSPECIFIED = 'POWER_STATE_UNSPECIFIED', PENDING = 'PENDING', ACTIVE = 'ACTIVE', SUSPENDING = 'SUSPENDING', SUSPENDED = 'SUSPENDED', DELETING = 'DELETING', DELETED = 'DELETED' }
	...
	export enum Migrationcenter_projects_locations_assets_listView { ASSET_VIEW_UNSPECIFIED = 'ASSET_VIEW_UNSPECIFIED', ASSET_VIEW_BASIC = 'ASSET_VIEW_BASIC', ASSET_VIEW_FULL = 'ASSET_VIEW_FULL' }
