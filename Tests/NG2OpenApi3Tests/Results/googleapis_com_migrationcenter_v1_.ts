...
export namespace MyNS {
	...
	export enum ComputeStorageDescriptorType { PERSISTENT_DISK_TYPE_UNSPECIFIED = 0, PERSISTENT_DISK_TYPE_STANDARD = 1, PERSISTENT_DISK_TYPE_BALANCED = 2, PERSISTENT_DISK_TYPE_SSD = 3 }
	...
	export enum FitDescriptorFitLevel { FIT_LEVEL_UNSPECIFIED = 0, FIT = 1, NO_FIT = 2, REQUIRES_EFFORT = 3 }
	...
	export interface MachineDetails {
		...
		powerState?: MachineDetailsPowerState | null;
	...
	export interface MachineDetailsFormProperties {
		...
		/** Power state of the machine. */
		powerState: FormControl<MachineDetailsPowerState | null | undefined>,

		/** Machine unique identifier. */
		uuid: FormControl<string | null | undefined>,
	}
	export function CreateMachineDetailsFormGroup() {
		return new FormGroup<MachineDetailsFormProperties>({
			coreCount: new FormControl<number | null | undefined>(undefined),
			createTime: new FormControl<string | null | undefined>(undefined),
			machineName: new FormControl<string | null | undefined>(undefined),
			memoryMb: new FormControl<number | null | undefined>(undefined),
			powerState: new FormControl<MachineDetailsPowerState | null | undefined>(undefined),
	...
	export interface MachineArchitectureDetails {
		...
		/** Firmware type. */
		firmwareType?: MachineArchitectureDetailsFirmwareType | null;

		/** CPU hyper-threading support. */
		hyperthreading?: MachineArchitectureDetailsHyperthreading | null;
	...
	/** Details of the machine architecture. */
	export interface MachineArchitectureDetailsFormProperties {
		...
		/** Firmware type. */
		firmwareType: FormControl<MachineArchitectureDetailsFirmwareType | null | undefined>,

		/** CPU hyper-threading support. */
		hyperthreading: FormControl<MachineArchitectureDetailsHyperthreading | null | undefined>,

		/** Hardware vendor. */
		vendor: FormControl<string | null | undefined>,
	}
	export function CreateMachineArchitectureDetailsFormGroup() {
		return new FormGroup<MachineArchitectureDetailsFormProperties>({
			...
			firmwareType: new FormControl<MachineArchitectureDetailsFirmwareType | null | undefined>(undefined),
			hyperthreading: new FormControl<MachineArchitectureDetailsHyperthreading | null | undefined>(undefined),
	...
	export enum MachineArchitectureDetailsFirmwareType { FIRMWARE_TYPE_UNSPECIFIED = 0, BIOS = 1, EFI = 2 }

	export enum MachineArchitectureDetailsHyperthreading { CPU_HYPER_THREADING_UNSPECIFIED = 0, DISABLED = 1, ENABLED = 2 }
	...
	/** Details of machine disks. */
	export interface MachineDiskDetailsFormProperties {
	...
	export function CreateMachineDiskDetailsFormGroup() {
		return new FormGroup<MachineDiskDetailsFormProperties>({
	...
	export interface DiskEntry {
		...
		interfaceType?: DiskEntryInterfaceType | null;
	...
	export interface DiskEntryFormProperties {
		...
		/** Disks interface type. */
		interfaceType: FormControl<DiskEntryInterfaceType | null | undefined>,
	}
	export function CreateDiskEntryFormGroup() {
		return new FormGroup<DiskEntryFormProperties>({
			...
			interfaceType: new FormControl<DiskEntryInterfaceType | null | undefined>(undefined),
		});

	}

	export enum DiskEntryInterfaceType { INTERFACE_TYPE_UNSPECIFIED = 0, IDE = 1, SATA = 2, SAS = 3, SCSI = 4, NVME = 5, FC = 6, ISCSI = 7 }
	...
	export interface VmwareDiskConfig {
		...
		rdmCompatibility?: VmwareDiskConfigRdmCompatibility | null;

		/** Is VMDK shared with other VMs. */
		shared?: boolean | null;

		/** VMDK disk mode. */
		vmdkMode?: VmwareDiskConfigVmdkMode | null;
	}
	...
	export interface VmwareDiskConfigFormProperties {
		...
		/** RDM compatibility mode. */
		rdmCompatibility: FormControl<VmwareDiskConfigRdmCompatibility | null | undefined>,

		/** Is VMDK shared with other VMs. */
		shared: FormControl<boolean | null | undefined>,

		/** VMDK disk mode. */
		vmdkMode: FormControl<VmwareDiskConfigVmdkMode | null | undefined>,
	}
	export function CreateVmwareDiskConfigFormGroup() {
		return new FormGroup<VmwareDiskConfigFormProperties>({
			...
			rdmCompatibility: new FormControl<VmwareDiskConfigRdmCompatibility | null | undefined>(undefined),
			shared: new FormControl<boolean | null | undefined>(undefined),
			vmdkMode: new FormControl<VmwareDiskConfigVmdkMode | null | undefined>(undefined),
		});

	}

	export enum VmwareDiskConfigBackingType { BACKING_TYPE_UNSPECIFIED = 0, BACKING_TYPE_FLAT_V1 = 1, BACKING_TYPE_FLAT_V2 = 2, BACKING_TYPE_PMEM = 3, BACKING_TYPE_RDM_V1 = 4, BACKING_TYPE_RDM_V2 = 5, BACKING_TYPE_SESPARSE = 6, BACKING_TYPE_SESPARSE_V1 = 7, BACKING_TYPE_SESPARSE_V2 = 8 }

	export enum VmwareDiskConfigRdmCompatibility { RDM_COMPATIBILITY_UNSPECIFIED = 0, PHYSICAL_COMPATIBILITY = 1, VIRTUAL_COMPATIBILITY = 2 }

	export enum VmwareDiskConfigVmdkMode { VMDK_MODE_UNSPECIFIED = 0, DEPENDENT = 1, INDEPENDENT_PERSISTENT = 2, INDEPENDENT_NONPERSISTENT = 3 }
	...
	export interface GuestOsDetails {
		...
		family?: GuestOsDetailsFamily | null;
	...
	export interface GuestOsDetailsFormProperties {
		...
		/** What family the OS belong to, if known. */
		family: FormControl<GuestOsDetailsFamily | null | undefined>,
	...
	export function CreateGuestOsDetailsFormGroup() {
		return new FormGroup<GuestOsDetailsFormProperties>({
			family: new FormControl<GuestOsDetailsFamily | null | undefined>(undefined),
	...
	export interface GuestConfigDetails {
		...
		selinuxMode?: GuestConfigDetailsSelinuxMode | null;
	}
	...
	export interface GuestConfigDetailsFormProperties {
		...
		/** Security-Enhanced Linux (SELinux) mode. */
		selinuxMode: FormControl<GuestConfigDetailsSelinuxMode | null | undefined>,
	}
	export function CreateGuestConfigDetailsFormGroup() {
		return new FormGroup<GuestConfigDetailsFormProperties>({
			...
			selinuxMode: new FormControl<GuestConfigDetailsSelinuxMode | null | undefined>(undefined),
		});
	...
	export enum GuestConfigDetailsSelinuxMode { SE_LINUX_MODE_UNSPECIFIED = 0, SE_LINUX_MODE_DISABLED = 1, SE_LINUX_MODE_PERMISSIVE = 2, SE_LINUX_MODE_ENFORCING = 3 }

	export enum GuestOsDetailsFamily { OS_FAMILY_UNKNOWN = 0, OS_FAMILY_WINDOWS = 1, OS_FAMILY_LINUX = 2, OS_FAMILY_UNIX = 3 }
	...
	export interface GuestRuntimeDetailsFormProperties {
		...
		/** Last time the OS was booted. */
		lastBootTime: FormControl<string | null | undefined>,
	...
	export function CreateGuestRuntimeDetailsFormGroup() {
		return new FormGroup<GuestRuntimeDetailsFormProperties>({
			...
			lastBootTime: new FormControl<string | null | undefined>(undefined),
			machineName: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface NetworkConnectionFormProperties {
		...
		/** Network connection state. */
		state: FormControl<NetworkConnectionState | null | undefined>,
	}
	export function CreateNetworkConnectionFormGroup() {
		return new FormGroup<NetworkConnectionFormProperties>({
			...
			state: new FormControl<NetworkConnectionState | null | undefined>(undefined),
		});

	}

	export enum NetworkConnectionState { STATE_UNSPECIFIED = 0, OPENING = 1, OPEN = 2, LISTEN = 3, CLOSING = 4, CLOSED = 5 }
	...
	export interface RunningService {
		...
		startMode?: RunningServiceStartMode | null;

		/** Service state (OS-agnostic). */
		state?: RunningServiceState | null;
	}
	...
	export interface RunningServiceFormProperties {
		...
		/** Service start mode (OS-agnostic). */
		startMode: FormControl<RunningServiceStartMode | null | undefined>,

		/** Service state (OS-agnostic). */
		state: FormControl<RunningServiceState | null | undefined>,
	}
	export function CreateRunningServiceFormGroup() {
		return new FormGroup<RunningServiceFormProperties>({
			...
			startMode: new FormControl<RunningServiceStartMode | null | undefined>(undefined),
			state: new FormControl<RunningServiceState | null | undefined>(undefined),
		});

	}

	export enum RunningServiceStartMode { START_MODE_UNSPECIFIED = 0, BOOT = 1, SYSTEM = 2, AUTO = 3, MANUAL = 4, DISABLED = 5 }

	export enum RunningServiceState { STATE_UNSPECIFIED = 0, ACTIVE = 1, PAUSED = 2, STOPPED = 3 }
	...
	/** Details of network adapters and settings. */
	export interface MachineNetworkDetailsFormProperties {
	...
	export function CreateMachineNetworkDetailsFormGroup() {
		return new FormGroup<MachineNetworkDetailsFormProperties>({
	...
	export enum NetworkAddressAssignment { ADDRESS_ASSIGNMENT_UNSPECIFIED = 0, ADDRESS_ASSIGNMENT_STATIC = 1, ADDRESS_ASSIGNMENT_DHCP = 2 }
	...
	export interface VmwarePlatformDetailsFormProperties {
		...
		/** vCenter URI used in collection. */
		vcenterUri: FormControl<string | null | undefined>,
	...
	export function CreateVmwarePlatformDetailsFormGroup() {
		return new FormGroup<VmwarePlatformDetailsFormProperties>({
			...
			vcenterUri: new FormControl<string | null | undefined>(undefined),
	...
	export enum MachineDetailsPowerState { POWER_STATE_UNSPECIFIED = 0, PENDING = 1, ACTIVE = 2, SUSPENDING = 3, SUSPENDED = 4, DELETING = 5, DELETED = 6 }
	...
	export enum ComputeEnginePreferencesLicenseType { LICENSE_TYPE_UNSPECIFIED = 0, LICENSE_TYPE_DEFAULT = 1, LICENSE_TYPE_BRING_YOUR_OWN_LICENSE = 2 }
	...
	export enum ImportErrorSeverity { SEVERITY_UNSPECIFIED = 0, ERROR = 1, WARNING = 2, INFO = 3 }
	...
	export interface ImportDataFile {
		...
		format?: ImportDataFileFormat | null;
	...
	export interface ImportDataFileFormProperties {
		...
		/** Required. The payload format. */
		format: FormControl<ImportDataFileFormat | null | undefined>,
	...
	export function CreateImportDataFileFormGroup() {
		return new FormGroup<ImportDataFileFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			format: new FormControl<ImportDataFileFormat | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
	...
	export enum ImportDataFileFormat { IMPORT_JOB_FORMAT_UNSPECIFIED = 0, IMPORT_JOB_FORMAT_RVTOOLS_XLSX = 1, IMPORT_JOB_FORMAT_RVTOOLS_CSV = 2, IMPORT_JOB_FORMAT_EXPORTED_AWS_CSV = 3, IMPORT_JOB_FORMAT_EXPORTED_AZURE_CSV = 4, IMPORT_JOB_FORMAT_STRATOZONE_CSV = 5 }

	export enum ImportDataFileState { STATE_UNSPECIFIED = 0, CREATING = 1, ACTIVE = 2 }
	...
	export enum ImportJobState { IMPORT_JOB_STATE_UNSPECIFIED = 0, IMPORT_JOB_STATE_PENDING = 1, IMPORT_JOB_STATE_RUNNING = 2, IMPORT_JOB_STATE_COMPLETED = 3, IMPORT_JOB_STATE_FAILED = 4, IMPORT_JOB_STATE_VALIDATING = 5, IMPORT_JOB_STATE_FAILED_VALIDATION = 6, IMPORT_JOB_STATE_READY = 7 }
	...
	export enum VirtualMachinePreferencesCommitmentPlan { COMMITMENT_PLAN_UNSPECIFIED = 0, COMMITMENT_PLAN_NONE = 1, COMMITMENT_PLAN_ONE_YEAR = 2, COMMITMENT_PLAN_THREE_YEARS = 3 }
	...
	export enum VirtualMachinePreferencesSizingOptimizationStrategy { SIZING_OPTIMIZATION_STRATEGY_UNSPECIFIED = 0, SIZING_OPTIMIZATION_STRATEGY_SAME_AS_SOURCE = 1, SIZING_OPTIMIZATION_STRATEGY_MODERATE = 2, SIZING_OPTIMIZATION_STRATEGY_AGGRESSIVE = 3 }
	...
	export enum SoleTenancyPreferencesCommitmentPlan { COMMITMENT_PLAN_UNSPECIFIED = 0, ON_DEMAND = 1, COMMITMENT_1_YEAR = 2, COMMITMENT_3_YEAR = 3 }

	export enum SoleTenancyPreferencesHostMaintenancePolicy { HOST_MAINTENANCE_POLICY_UNSPECIFIED = 0, HOST_MAINTENANCE_POLICY_DEFAULT = 1, HOST_MAINTENANCE_POLICY_RESTART_IN_PLACE = 2, HOST_MAINTENANCE_POLICY_MIGRATE_WITHIN_NODE_GROUP = 3 }
	...
	export enum VirtualMachinePreferencesTargetProduct { COMPUTE_MIGRATION_TARGET_PRODUCT_UNSPECIFIED = 0, COMPUTE_MIGRATION_TARGET_PRODUCT_COMPUTE_ENGINE = 1, COMPUTE_MIGRATION_TARGET_PRODUCT_VMWARE_ENGINE = 2, COMPUTE_MIGRATION_TARGET_PRODUCT_SOLE_TENANCY = 3 }
	...
	export enum VmwareEnginePreferencesCommitmentPlan { COMMITMENT_PLAN_UNSPECIFIED = 0, ON_DEMAND = 1, COMMITMENT_1_YEAR_MONTHLY_PAYMENTS = 2, COMMITMENT_3_YEAR_MONTHLY_PAYMENTS = 3, COMMITMENT_1_YEAR_UPFRONT_PAYMENT = 4, COMMITMENT_3_YEAR_UPFRONT_PAYMENT = 5 }
	...
	export enum ReportState { STATE_UNSPECIFIED = 0, PENDING = 1, SUCCEEDED = 2, FAILED = 3 }
	...
	/** A set of findings that applies to assets destined for Compute Engine. */
	export interface ReportSummaryComputeEngineFindingFormProperties {

		/** Count of assets which were allocated. */
		allocatedAssetCount: FormControl<string | null | undefined>,
	}
	export function CreateReportSummaryComputeEngineFindingFormGroup() {
		return new FormGroup<ReportSummaryComputeEngineFindingFormProperties>({
	...
	export enum ReportType { TYPE_UNSPECIFIED = 0, TOTAL_COST_OF_OWNERSHIP = 1 }
	...
	export enum SourceState { STATE_UNSPECIFIED = 0, ACTIVE = 1, DELETING = 2, INVALID = 3 }

	export enum SourceType { SOURCE_TYPE_UNKNOWN = 0, SOURCE_TYPE_UPLOAD = 1, SOURCE_TYPE_GUEST_OS_SCAN = 2, SOURCE_TYPE_INVENTORY_SCAN = 3, SOURCE_TYPE_CUSTOM = 4 }
	...
	export class MyClient {
		...
		Migrationcenter_projects_locations_groups_addAssets(group: string, requestBody: AddAssetsToGroupRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (group == null ? '' : encodeURIComponent(group)) + ':addAssets', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_groups_removeAssets(group: string, requestBody: RemoveAssetsFromGroupRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (group == null ? '' : encodeURIComponent(group)) + ':removeAssets', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_sources_errorFrames_get(name: string, view: Migrationcenter_projects_locations_sources_errorFrames_getView | null | undefined): Observable<ErrorFrame> {
			return this.http.get<ErrorFrame>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&view=' + view, {});
		}
		...
		Migrationcenter_projects_locations_importJobs_validate(name: string, requestBody: ValidateImportJobRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':validate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Migrationcenter_projects_locations_assets_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Migrationcenter_projects_locations_assets_listView | null | undefined): Observable<ListAssetsResponse> {
			return this.http.get<ListAssetsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assets&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Migrationcenter_projects_locations_assets_aggregateValues(parent: string, requestBody: AggregateAssetsValuesRequest): Observable<AggregateAssetsValuesResponse> {
			return this.http.post<AggregateAssetsValuesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assets:aggregateValues', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_assets_batchDelete(parent: string, requestBody: BatchDeleteAssetsRequest): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assets:batchDelete', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_assets_batchUpdate(parent: string, requestBody: BatchUpdateAssetsRequest): Observable<BatchUpdateAssetsResponse> {
			return this.http.post<BatchUpdateAssetsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assets:batchUpdate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_assets_reportAssetFrames(parent: string, source: string | null | undefined, requestBody: Frames): Observable<ReportAssetFramesResponse> {
			return this.http.post<ReportAssetFramesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/assets:reportAssetFrames&source=' + (source == null ? '' : encodeURIComponent(source)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_sources_errorFrames_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Migrationcenter_projects_locations_sources_errorFrames_listView | null | undefined): Observable<ListErrorFramesResponse> {
			return this.http.get<ListErrorFramesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/errorFrames&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Migrationcenter_projects_locations_importJobs_importDataFiles_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListImportDataFilesResponse> {
			return this.http.get<ListImportDataFilesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/importDataFiles&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Migrationcenter_projects_locations_importJobs_importDataFiles_create(parent: string, importDataFileId: string | null | undefined, requestId: string | null | undefined, requestBody: ImportDataFile): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/importDataFiles&importDataFileId=' + (importDataFileId == null ? '' : encodeURIComponent(importDataFileId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_importJobs_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Migrationcenter_projects_locations_importJobs_listView | null | undefined): Observable<ListImportJobsResponse> {
			return this.http.get<ListImportJobsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/importJobs&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Migrationcenter_projects_locations_importJobs_create(parent: string, importJobId: string | null | undefined, requestId: string | null | undefined, requestBody: ImportJob): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/importJobs&importJobId=' + (importJobId == null ? '' : encodeURIComponent(importJobId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_preferenceSets_list(parent: string, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPreferenceSetsResponse> {
			return this.http.get<ListPreferenceSetsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/preferenceSets&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Migrationcenter_projects_locations_reportConfigs_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListReportConfigsResponse> {
			return this.http.get<ListReportConfigsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/reportConfigs&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Migrationcenter_projects_locations_reportConfigs_create(parent: string, reportConfigId: string | null | undefined, requestId: string | null | undefined, requestBody: ReportConfig): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/reportConfigs&reportConfigId=' + (reportConfigId == null ? '' : encodeURIComponent(reportConfigId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Migrationcenter_projects_locations_reportConfigs_reports_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Migrationcenter_projects_locations_reportConfigs_reports_listView | null | undefined): Observable<ListReportsResponse> {
			return this.http.get<ListReportsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/reports&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Migrationcenter_projects_locations_reportConfigs_reports_create(parent: string, reportId: string | null | undefined, requestId: string | null | undefined, requestBody: Report): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/reports&reportId=' + (reportId == null ? '' : encodeURIComponent(reportId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	...
	export enum Migrationcenter_projects_locations_sources_errorFrames_getView { ERROR_FRAME_VIEW_UNSPECIFIED = 0, ERROR_FRAME_VIEW_BASIC = 1, ERROR_FRAME_VIEW_FULL = 2, REPORT_VIEW_STANDARD = 3 }

	export enum Migrationcenter_projects_locations_assets_listView { ASSET_VIEW_UNSPECIFIED = 0, ASSET_VIEW_BASIC = 1, ASSET_VIEW_FULL = 2 }

	export enum Migrationcenter_projects_locations_sources_errorFrames_listView { ERROR_FRAME_VIEW_UNSPECIFIED = 0, ERROR_FRAME_VIEW_BASIC = 1, ERROR_FRAME_VIEW_FULL = 2 }

	export enum Migrationcenter_projects_locations_importJobs_listView { IMPORT_JOB_VIEW_UNSPECIFIED = 0, IMPORT_JOB_VIEW_BASIC = 1, IMPORT_JOB_VIEW_FULL = 2 }

	export enum Migrationcenter_projects_locations_reportConfigs_reports_listView { REPORT_VIEW_UNSPECIFIED = 0, REPORT_VIEW_BASIC = 1, REPORT_VIEW_FULL = 2, REPORT_VIEW_STANDARD = 3 }
