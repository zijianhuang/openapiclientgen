...
export namespace MyNS {
	...
	export interface CripcPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		INSCODE: FormControl<string | null | undefined>,

		/**
		 * POLNO
		 * Required
		 */
		POLNO: FormControl<string | null | undefined>,

		/**
		 * STARTDT
		 * Required
		 */
		STARTDT: FormControl<string | null | undefined>,
	}
	export function CreateCripcPostBodyCertificateParametersFormGroup() {
		return new FormGroup<CripcPostBodyCertificateParametersFormProperties>({
			INSCODE: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			POLNO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			STARTDT: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
