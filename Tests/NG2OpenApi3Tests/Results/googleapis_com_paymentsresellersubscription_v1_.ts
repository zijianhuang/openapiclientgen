...
export namespace MyNS {
	...
	export enum GoogleCloudPaymentsResellerSubscriptionV1CancelSubscriptionRequestCancellationReason { CANCELLATION_REASON_UNSPECIFIED = 0, CANCELLATION_REASON_FRAUD = 1, CANCELLATION_REASON_REMORSE = 2, CANCELLATION_REASON_ACCIDENTAL_PURCHASE = 3, CANCELLATION_REASON_PAST_DUE = 4, CANCELLATION_REASON_ACCOUNT_CLOSED = 5, CANCELLATION_REASON_UPGRADE_DOWNGRADE = 6, CANCELLATION_REASON_USER_DELINQUENCY = 7, CANCELLATION_REASON_SYSTEM_ERROR = 8, CANCELLATION_REASON_SYSTEM_CANCEL = 9, CANCELLATION_REASON_OTHER = 10 }
	...
	export enum GoogleCloudPaymentsResellerSubscriptionV1DurationUnit { UNIT_UNSPECIFIED = 0, MONTH = 1, DAY = 2, HOUR = 3 }
	...
	export enum GoogleCloudPaymentsResellerSubscriptionV1SubscriptionPromotionSpecType { PROMOTION_TYPE_UNSPECIFIED = 0, PROMOTION_TYPE_FREE_TRIAL = 1, PROMOTION_TYPE_INTRODUCTORY_PRICING = 2 }
	...
	export enum GoogleCloudPaymentsResellerSubscriptionV1GoogleOnePayloadOffering { OFFERING_UNSPECIFIED = 0, OFFERING_VAS_BUNDLE = 1, OFFERING_VAS_STANDALONE = 2, OFFERING_HARD_BUNDLE = 3, OFFERING_SOFT_BUNDLE = 4 }

	export enum GoogleCloudPaymentsResellerSubscriptionV1GoogleOnePayloadSalesChannel { CHANNEL_UNSPECIFIED = 0, CHANNEL_RETAIL = 1, CHANNEL_ONLINE_WEB = 2, CHANNEL_ONLINE_ANDROID_APP = 3, CHANNEL_ONLINE_IOS_APP = 4 }
	...
	export enum GoogleCloudPaymentsResellerSubscriptionV1SubscriptionLineItemRecurrenceType { LINE_ITEM_RECURRENCE_TYPE_UNSPECIFIED = 0, LINE_ITEM_RECURRENCE_TYPE_PERIODIC = 1, LINE_ITEM_RECURRENCE_TYPE_ONE_TIME = 2 }

	export enum GoogleCloudPaymentsResellerSubscriptionV1SubscriptionLineItemState { LINE_ITEM_STATE_UNSPECIFIED = 0, LINE_ITEM_STATE_ACTIVE = 1, LINE_ITEM_STATE_INACTIVE = 2, LINE_ITEM_STATE_NEW = 3, LINE_ITEM_STATE_ACTIVATING = 4, LINE_ITEM_STATE_DEACTIVATING = 5, LINE_ITEM_STATE_WAITING_TO_DEACTIVATE = 6, LINE_ITEM_STATE_OFF_CYCLE_CHARGING = 7 }

	export enum GoogleCloudPaymentsResellerSubscriptionV1SubscriptionProcessingState { PROCESSING_STATE_UNSPECIFIED = 0, PROCESSING_STATE_CANCELLING = 1, PROCESSING_STATE_RECURRING = 2 }
	...
	export enum GoogleCloudPaymentsResellerSubscriptionV1SubscriptionState { STATE_UNSPECIFIED = 0, STATE_CREATED = 1, STATE_ACTIVE = 2, STATE_CANCELLED = 3, STATE_IN_GRACE_PERIOD = 4, STATE_CANCEL_AT_END_OF_CYCLE = 5, STATE_SUSPENDED = 6 }
	...
	export enum GoogleCloudPaymentsResellerSubscriptionV1SubscriptionUpgradeDowngradeDetailsBillingCycleSpec { BILLING_CYCLE_SPEC_UNSPECIFIED = 0, BILLING_CYCLE_SPEC_ALIGN_WITH_PREVIOUS_SUBSCRIPTION = 1, BILLING_CYCLE_SPEC_START_IMMEDIATELY = 2 }
	...
	export enum ProductBundleDetailsEntitlementMode { ENTITLEMENT_MODE_UNSPECIFIED = 0, ENTITLEMENT_MODE_FULL = 1, ENTITLEMENT_MODE_INCREMENTAL = 2 }
	...
	export enum GoogleCloudPaymentsResellerSubscriptionV1ProductProductType { PRODUCT_TYPE_UNSPECIFIED = 0, PRODUCT_TYPE_SUBSCRIPTION = 1, PRODUCT_TYPE_BUNDLE_SUBSCRIPTION = 2 }
