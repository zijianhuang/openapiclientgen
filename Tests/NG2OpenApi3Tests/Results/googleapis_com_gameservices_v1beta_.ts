...
export namespace MyNS {
	...
	/** Write a Cloud Audit log */
	export interface CloudAuditOptionsFormProperties {

		/** The log_name to populate in the Cloud Audit Record. */
		logName: FormControl<CloudAuditOptionsLogName | null | undefined>,
	}
	export function CreateCloudAuditOptionsFormGroup() {
		return new FormGroup<CloudAuditOptionsFormProperties>({
			logName: new FormControl<CloudAuditOptionsLogName | null | undefined>(undefined),
		});
	...
	/** Increment a streamz counter with the specified metric and field names. Metric names should start with a '/', generally be lowercase-only, and end in "_count". Field names should not contain an initial slash. The actual exported metric names will have "/iam/policy" prepended. Field names correspond to IAM request parameters and field values are their respective values. Supported field names: - "authority", which is "[token]" if IAMContext.token is present, otherwise the value of IAMContext.authority_selector if present, and otherwise a representation of IAMContext.principal; or - "iam_principal", a representation of IAMContext.principal even if a token or authority selector is present; or - "" (empty string), resulting in a counter with no fields. Examples: counter { metric: "/debug_access_count" field: "iam_principal" } ==> increment counter /iam/policy/debug_access_count {iam_principal=[value of IAMContext.principal]} */
	export interface CounterOptionsFormProperties {
	...
	export function CreateCounterOptionsFormGroup() {
		return new FormGroup<CounterOptionsFormProperties>({
	...
	/** Write a Data Access (Gin) log */
	export interface DataAccessOptionsFormProperties {
		logMode: FormControl<DataAccessOptionsLogMode | null | undefined>,
	}
	export function CreateDataAccessOptionsFormGroup() {
		return new FormGroup<DataAccessOptionsFormProperties>({
			logMode: new FormControl<DataAccessOptionsLogMode | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 */
		Gameservices_projects_locations_operations_delete(name: string): Observable<Empty> {
		 ...
		 */
		Gameservices_projects_locations_operations_get(name: string): Observable<Operation> {
		 ...
		 */
		Gameservices_projects_locations_list(name: string, filter: string | null | undefined, includeUnrevealedLocations: boolean | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationsResponse> {
			return this.http.get<ListLocationsResponse>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + '/locations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&includeUnrevealedLocations=' + includeUnrevealedLocations + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Gameservices_projects_locations_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListOperationsResponse> {
		 ...
		 * @return {Empty} Successful response
		 */
		Gameservices_projects_locations_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<Empty> {
		 ...
		 */
		Gameservices_projects_locations_gameServerDeployments_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<Policy> {
		 ...
		 * @return {Policy} Successful response
		 */
		Gameservices_projects_locations_gameServerDeployments_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
		 ...
		 */
		Gameservices_projects_locations_gameServerDeployments_testIamPermissions(resource: string, requestBody: TestIamPermissionsRequest): Observable<TestIamPermissionsResponse> {
