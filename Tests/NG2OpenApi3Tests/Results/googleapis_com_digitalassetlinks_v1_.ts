...
export namespace MyNS {
	...
	export enum BulkCheckResponseBulkErrorCode { ERROR_CODE_UNSPECIFIED = 0, ERROR_CODE_INVALID_QUERY = 1, ERROR_CODE_FETCH_ERROR = 2, ERROR_CODE_FAILED_SSL_VALIDATION = 3, ERROR_CODE_REDIRECT = 4, ERROR_CODE_TOO_LARGE = 5, ERROR_CODE_MALFORMED_HTTP_RESPONSE = 6, ERROR_CODE_WRONG_CONTENT_TYPE = 7, ERROR_CODE_MALFORMED_CONTENT = 8, ERROR_CODE_SECURE_ASSET_INCLUDES_INSECURE = 9, ERROR_CODE_FETCH_BUDGET_EXHAUSTED = 10 }
