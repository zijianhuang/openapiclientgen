...
export namespace MyNS {
	...
	export enum GoogleCloudDiscoveryengineV1alphaConversationState { STATE_UNSPECIFIED = 0, IN_PROGRESS = 1, COMPLETED = 2 }
	...
	export enum GoogleCloudDiscoveryengineV1alphaImportDocumentsRequestReconciliationMode { RECONCILIATION_MODE_UNSPECIFIED = 0, INCREMENTAL = 1, FULL = 2 }
	...
	export enum GoogleCloudDiscoveryengineV1alphaSuggestionDenyListEntryMatchOperator { MATCH_OPERATOR_UNSPECIFIED = 0, EXACT_MATCH = 1, CONTAINS = 2 }
	...
	export enum GoogleCloudDiscoveryengineV1alphaWidgetConfigDataStoreType { DATA_STORE_TYPE_UNSPECIFIED = 0, SITE_SEARCH = 1, STRUCTURED = 2, UNSTRUCTURED = 3, BLENDED = 4 }
	...
	export enum GoogleCloudDiscoveryengineV1alphaWidgetConfigResultDisplayType { RESULT_DISPLAY_TYPE_UNSPECIFIED = 0, SNIPPET = 1, EXTRACTIVE_ANSWER = 2 }
	...
	export enum GoogleCloudDiscoveryengineV1alphaSearchRequestQueryExpansionSpecCondition { CONDITION_UNSPECIFIED = 0, DISABLED = 1, AUTO = 2 }
	...
	export enum GoogleCloudDiscoveryengineV1alphaSearchRequestSpellCorrectionSpecMode { MODE_UNSPECIFIED = 0, SUGGESTION_ONLY = 1, AUTO = 2 }
