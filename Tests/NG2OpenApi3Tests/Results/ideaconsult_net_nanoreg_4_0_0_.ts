...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Solrquery_get(q: string | null | undefined, start: number | null | undefined, rows: number | null | undefined, wt: Solrquery_getWt | null | undefined): Observable<SolrResponse> {
			return this.http.get<SolrResponse>(this.baseUri + 'select?q=' + (q == null ? '' : encodeURIComponent(q)) + '&start=' + start + '&rows=' + rows + '&wt=' + wt, {});
		}
		 ...
		 * @return {SolrResponse} Query performed successfully
		 */
		Solrquery_post(wt: Solrquery_getWt | null | undefined, requestBody: QueryBody): Observable<SolrResponse> {
