...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {MutanPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Mutan(requestBody: MutanPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'mutan/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface CncerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<CncerPostBodyFormat | null | undefined>,
	...
	export function CreateCncerPostBodyFormGroup() {
		return new FormGroup<CncerPostBodyFormProperties>({
			format: new FormControl<CncerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface MutanPostBodyFormProperties {
	...
	export function CreateMutanPostBodyFormGroup() {
		return new FormGroup<MutanPostBodyFormProperties>({
			format: new FormControl<CncerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface MutanPostBodyCertificateParameters {
	...
	export interface MutanPostBodyCertificateParametersFormProperties {
	...
	export function CreateMutanPostBodyCertificateParametersFormGroup() {
		return new FormGroup<MutanPostBodyCertificateParametersFormProperties>({
			DocumentNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
