...
export namespace MyNS {
	...
	export interface SkcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		personalno: FormControl<string | null | undefined>,
	...
	export function CreateSkcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SkcerPostBodyCertificateParametersFormProperties>({
			coursename: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			personalno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
