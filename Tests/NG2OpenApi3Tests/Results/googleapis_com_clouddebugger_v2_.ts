...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {RegisterDebuggeeResponse} Successful response
		 */
		Clouddebugger_controller_debuggees_register(requestBody: RegisterDebuggeeRequest): Observable<RegisterDebuggeeResponse> {
			return this.http.post<RegisterDebuggeeResponse>(this.baseUri + 'v2/controller/debuggees/register', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} agentId Identifies the agent. This is the ID returned in the RegisterDebuggee response.
		 * @param {boolean} successOnTimeout If set to `true` (recommended), returns `google.rpc.Code.OK` status and sets the `wait_expired` response field to `true` when the server-selected timeout has expired. If set to `false` (deprecated), returns `google.rpc.Code.ABORTED` status when the server-selected timeout has expired.
		 * @param {string} waitToken A token that, if specified, blocks the method call until the list of active breakpoints has changed, or a server-selected timeout has expired. The value should be set from the `next_wait_token` field in the last response. The initial value should be set to `"init"`.
		 * @return {ListActiveBreakpointsResponse} Successful response
		 */
		Clouddebugger_controller_debuggees_breakpoints_list(debuggeeId: string, agentId: string | null | undefined, successOnTimeout: boolean | null | undefined, waitToken: string | null | undefined): Observable<ListActiveBreakpointsResponse> {
			return this.http.get<ListActiveBreakpointsResponse>(this.baseUri + 'v2/controller/debuggees/' + (debuggeeId == null ? '' : encodeURIComponent(debuggeeId)) + '/breakpoints&agentId=' + (agentId == null ? '' : encodeURIComponent(agentId)) + '&successOnTimeout=' + successOnTimeout + '&waitToken=' + (waitToken == null ? '' : encodeURIComponent(waitToken)), {});
		}
		 ...
		 * @return {UpdateActiveBreakpointResponse} Successful response
		 */
		Clouddebugger_controller_debuggees_breakpoints_update(debuggeeId: string, id: string, requestBody: UpdateActiveBreakpointRequest): Observable<UpdateActiveBreakpointResponse> {
			return this.http.put<UpdateActiveBreakpointResponse>(this.baseUri + 'v2/controller/debuggees/' + (debuggeeId == null ? '' : encodeURIComponent(debuggeeId)) + '/breakpoints/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all the debuggees that the user has access to.
		 * Get v2/debugger/debuggees
		 * @param {string} clientVersion Required. The client version making the call. Schema: `domain/type/version` (e.g., `google.com/intellij/v1`).
		 * @param {boolean} includeInactive When set to `true`, the result includes all debuggees. Otherwise, the result includes only debuggees that are active.
		 * @param {string} project Required. Project number of a Google Cloud project whose debuggees to list.
		 * @return {ListDebuggeesResponse} Successful response
		 */
		Clouddebugger_debugger_debuggees_list(clientVersion: string | null | undefined, includeInactive: boolean | null | undefined, project: string | null | undefined): Observable<ListDebuggeesResponse> {
			return this.http.get<ListDebuggeesResponse>(this.baseUri + 'v2/debugger/debuggees?clientVersion=' + (clientVersion == null ? '' : encodeURIComponent(clientVersion)) + '&includeInactive=' + includeInactive + '&project=' + (project == null ? '' : encodeURIComponent(project)), {});
		}
		 ...
		 * @param {string} clientVersion Required. The client version making the call. Schema: `domain/type/version` (e.g., `google.com/intellij/v1`).
		 * @param {boolean} includeAllUsers When set to `true`, the response includes the list of breakpoints set by any user. Otherwise, it includes only breakpoints set by the caller.
		 * @param {boolean} includeInactive When set to `true`, the response includes active and inactive breakpoints. Otherwise, it includes only active breakpoints.
		 * @param {boolean} stripResults This field is deprecated. The following fields are always stripped out of the result: `stack_frames`, `evaluated_expressions` and `variable_table`.
		 * @param {string} waitToken A wait token that, if specified, blocks the call until the breakpoints list has changed, or a server selected timeout has expired. The value should be set from the last response. The error code `google.rpc.Code.ABORTED` (RPC) is returned on wait timeout, which should be called again with the same `wait_token`.
		 * @return {ListBreakpointsResponse} Successful response
		 */
		Clouddebugger_debugger_debuggees_breakpoints_list(debuggeeId: string, action_value: BreakpointAction | null | undefined, clientVersion: string | null | undefined, includeAllUsers: boolean | null | undefined, includeInactive: boolean | null | undefined, stripResults: boolean | null | undefined, waitToken: string | null | undefined): Observable<ListBreakpointsResponse> {
			return this.http.get<ListBreakpointsResponse>(this.baseUri + 'v2/debugger/debuggees/' + (debuggeeId == null ? '' : encodeURIComponent(debuggeeId)) + '/breakpoints&action_value=' + action_value + '&clientVersion=' + (clientVersion == null ? '' : encodeURIComponent(clientVersion)) + '&includeAllUsers=' + includeAllUsers + '&includeInactive=' + includeInactive + '&stripResults=' + stripResults + '&waitToken=' + (waitToken == null ? '' : encodeURIComponent(waitToken)), {});
		}
		 ...
		 * @param {string} clientVersion Required. The client version making the call. Schema: `domain/type/version` (e.g., `google.com/intellij/v1`).
		 * @return {SetBreakpointResponse} Successful response
		 */
		Clouddebugger_debugger_debuggees_breakpoints_set(debuggeeId: string, canaryOption: Clouddebugger_debugger_debuggees_breakpoints_setCanaryOption | null | undefined, clientVersion: string | null | undefined, requestBody: Breakpoint): Observable<SetBreakpointResponse> {
			return this.http.post<SetBreakpointResponse>(this.baseUri + 'v2/debugger/debuggees/' + (debuggeeId == null ? '' : encodeURIComponent(debuggeeId)) + '/breakpoints/set&canaryOption=' + canaryOption + '&clientVersion=' + (clientVersion == null ? '' : encodeURIComponent(clientVersion)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Clouddebugger_debugger_debuggees_breakpoints_delete(debuggeeId: string, breakpointId: string, clientVersion: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2/debugger/debuggees/' + (debuggeeId == null ? '' : encodeURIComponent(debuggeeId)) + '/breakpoints/' + (breakpointId == null ? '' : encodeURIComponent(breakpointId)) + '&clientVersion=' + (clientVersion == null ? '' : encodeURIComponent(clientVersion)), {});
		}
		 ...
		 * @param {string} clientVersion Required. The client version making the call. Schema: `domain/type/version` (e.g., `google.com/intellij/v1`).
		 * @return {GetBreakpointResponse} Successful response
		 */
		Clouddebugger_debugger_debuggees_breakpoints_get(debuggeeId: string, breakpointId: string, clientVersion: string | null | undefined): Observable<GetBreakpointResponse> {
			return this.http.get<GetBreakpointResponse>(this.baseUri + 'v2/debugger/debuggees/' + (debuggeeId == null ? '' : encodeURIComponent(debuggeeId)) + '/breakpoints/' + (breakpointId == null ? '' : encodeURIComponent(breakpointId)) + '&clientVersion=' + (clientVersion == null ? '' : encodeURIComponent(clientVersion)), {});
		}
	}
