...
export namespace MyNS {
	...
	export enum EntityType { UNKNOWN = 'UNKNOWN', PERSON = 'PERSON', LOCATION = 'LOCATION', ORGANIZATION = 'ORGANIZATION', EVENT = 'EVENT', WORK_OF_ART = 'WORK_OF_ART', CONSUMER_GOOD = 'CONSUMER_GOOD', OTHER = 'OTHER' }
	...
	export class MyClient {
		...
		Language_documents_analyzeEntities(requestBody: AnalyzeEntitiesRequest): Observable<AnalyzeEntitiesResponse> {
			return this.http.post<AnalyzeEntitiesResponse>(this.baseUri + 'v1beta1/documents:analyzeEntities', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_analyzeSentiment(requestBody: AnalyzeSentimentRequest): Observable<AnalyzeSentimentResponse> {
			return this.http.post<AnalyzeSentimentResponse>(this.baseUri + 'v1beta1/documents:analyzeSentiment', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_analyzeSyntax(requestBody: AnalyzeSyntaxRequest): Observable<AnalyzeSyntaxResponse> {
			return this.http.post<AnalyzeSyntaxResponse>(this.baseUri + 'v1beta1/documents:analyzeSyntax', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Language_documents_annotateText(requestBody: AnnotateTextRequest): Observable<AnnotateTextResponse> {
			return this.http.post<AnnotateTextResponse>(this.baseUri + 'v1beta1/documents:annotateText', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
