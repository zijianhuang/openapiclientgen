...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {MbcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Mbcer(requestBody: MbcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'mbcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface GovidPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<GovidPostBodyFormat | null | undefined>,
	...
	export function CreateGovidPostBodyFormGroup() {
		return new FormGroup<GovidPostBodyFormProperties>({
			format: new FormControl<GovidPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface GovidPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		Membership_No: FormControl<string | null | undefined>,
	}
	export function CreateGovidPostBodyCertificateParametersFormGroup() {
		return new FormGroup<GovidPostBodyCertificateParametersFormProperties>({
			...
			Membership_No: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface MbcerPostBodyFormProperties {
	...
	export function CreateMbcerPostBodyFormGroup() {
		return new FormGroup<MbcerPostBodyFormProperties>({
			format: new FormControl<GovidPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface MbcerPostBodyCertificateParameters {
	...
	export interface MbcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateMbcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<MbcerPostBodyCertificateParametersFormProperties>({
			CertType: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Membership_No: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
