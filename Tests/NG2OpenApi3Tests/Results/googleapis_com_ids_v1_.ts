...
export namespace MyNS {
	...
	export interface Endpoint {
		...
		severity?: EndpointSeverity | null;
	...
	export interface EndpointFormProperties {
		...
		/** Output only. The fully qualified URL of the endpoint's ILB Forwarding Rule. */
		endpointForwardingRule: FormControl<string | null | undefined>,
		...
		/** Required. Lowest threat severity that this endpoint will alert on. */
		severity: FormControl<EndpointSeverity | null | undefined>,

		/** Output only. Current state of the endpoint. */
		state: FormControl<EndpointState | null | undefined>,

		/** Whether the endpoint should report traffic logs in addition to threat logs. */
		trafficLogs: FormControl<boolean | null | undefined>,
	...
	export function CreateEndpointFormGroup() {
		return new FormGroup<EndpointFormProperties>({
			...
			description: new FormControl<string | null | undefined>(undefined),
			endpointForwardingRule: new FormControl<string | null | undefined>(undefined),
			...
			severity: new FormControl<EndpointSeverity | null | undefined>(undefined),
			state: new FormControl<EndpointState | null | undefined>(undefined),
			trafficLogs: new FormControl<boolean | null | undefined>(undefined),
	...
	export class MyClient {
		 ...
		 */
		Ids_projects_locations_operations_delete(name: string, requestId: string | null | undefined): Observable<Empty> {
		 ...
		 */
		Ids_projects_locations_operations_get(name: string): Observable<Operation> {
		 ...
		 * @return {Operation} Successful response
		 */
		Ids_projects_locations_endpoints_patch(name: string, requestId: string | null | undefined, updateMask: string | null | undefined, requestBody: Endpoint): Observable<Operation> {
		 ...
		 */
		Ids_projects_locations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationsResponse> {
		 ...
		 */
		Ids_projects_locations_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListOperationsResponse> {
		 ...
		 * @return {Empty} Successful response
		 */
		Ids_projects_locations_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<Empty> {
		 ...
		 * @param {string} filter Optional. The filter expression, following the syntax outlined in https://google.aip.dev/160.
		 ...
		 * @param {number} pageSize Optional. The maximum number of endpoints to return. The service may return fewer than this value.
		 * @param {string} pageToken Optional. A page token, received from a previous `ListEndpoints` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListEndpoints` must match the call that provided the page token.
		 * @return {ListEndpointsResponse} Successful response
		 */
		Ids_projects_locations_endpoints_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListEndpointsResponse> {
		 ...
		 * @param {string} endpointId Required. The endpoint identifier. This will be part of the endpoint's resource name. This value must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and cannot end with a hyphen. Values that do not match this pattern will trigger an INVALID_ARGUMENT error.
		 * @param {string} requestId An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
		 * @return {Operation} Successful response
		 */
		Ids_projects_locations_endpoints_create(parent: string, endpointId: string | null | undefined, requestId: string | null | undefined, requestBody: Endpoint): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/endpoints&endpointId=' + (endpointId == null ? '' : encodeURIComponent(endpointId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Ids_projects_locations_endpoints_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<Policy> {
		 ...
		 * @return {Policy} Successful response
		 */
		Ids_projects_locations_endpoints_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
		 ...
		 */
		Ids_projects_locations_endpoints_testIamPermissions(resource: string, requestBody: TestIamPermissionsRequest): Observable<TestIamPermissionsResponse> {
