...
export namespace MyNS {
	...
	export enum GoogleFirebaseAppdistroV1alphaAppAabState { AAB_STATE_UNSPECIFIED = 0, ACTIVE = 1, PLAY_ACCOUNT_NOT_LINKED = 2, NO_APP_WITH_GIVEN_BUNDLE_ID_IN_PLAY_ACCOUNT = 3, APP_NOT_PUBLISHED = 4, AAB_STATE_UNAVAILABLE = 5, PLAY_IAS_TERMS_NOT_ACCEPTED = 6 }
	...
	export enum GoogleFirebaseAppdistroV1alphaDeviceExecutionFailedReason { FAILED_REASON_UNSPECIFIED = 0, CRASHED = 1, NOT_INSTALLED = 2, UNABLE_TO_CRAWL = 3, DEVICE_OUT_OF_MEMORY = 4 }

	export enum GoogleFirebaseAppdistroV1alphaDeviceExecutionInconclusiveReason { INCONCLUSIVE_REASON_UNSPECIFIED = 0, QUOTA_EXCEEDED = 1, INFRASTRUCTURE_FAILURE = 2, SERVICE_NOT_ACTIVATED = 3, NO_SIGNATURE = 4, NO_LAUNCHER_ACTIVITY = 5, FORBIDDEN_PERMISSIONS = 6, DEVICE_ADMIN_RECEIVER = 7, NO_CODE_APK = 8, INVALID_APK_PREVIEW_SDK = 9 }
	...
	export enum GoogleFirebaseAppdistroV1alphaDeviceExecutionState { TEST_STATE_UNSPECIFIED = 0, IN_PROGRESS = 1, PASSED = 2, FAILED = 3, INCONCLUSIVE = 4 }
	...
	export enum GoogleFirebaseAppdistroV1alphaGetUploadStatusResponseErrorCode { ERROR_UNSPECIFIED = 0, INVALID_ZIP = 1, MISSING_PLIST = 2, MISSING_PROFILE = 3, VERSION_TOO_LONG = 4, MISSING_UUIDS = 5, MISSING_RESOURCES = 6, MISSING_MANIFEST = 7, IOS_METADATA_ERROR = 8, ANDROID_METADATA_ERROR = 9, UNSUPPORTED_PLATFORM_TYPE = 10, BUNDLE_ID_MISMATCH = 11, APK_NOT_ZIP_ALIGNED = 12, INVALID_CERTIFICATE = 13, APK_TOO_LARGE = 14, AAB_NOT_PUBLISHED = 15, INVALID_PLIST_DEVICE_FAMILIES = 16, AAB_TOS_NOT_ACCEPTED = 17, APP_NAME_TOO_LONG = 18, AAB_DEVELOPER_ACCOUNT_NOT_LINKED = 19, AAB_NO_APP_WITH_GIVEN_PACKAGE_NAME_IN_ACCOUNT = 20, AAB_UPLOAD_ERROR = 21 }

	export enum GoogleFirebaseAppdistroV1alphaGetUploadStatusResponseStatus { STATUS_UNSPECIFIED = 0, IN_PROGRESS = 1, ALREADY_UPLOADED = 2, SUCCESS = 3, ERROR = 4 }
	...
	export enum Firebaseappdistribution_apps_getAppView { APP_VIEW_UNSPECIFIED = 0, BASIC = 1, FULL = 2 }
