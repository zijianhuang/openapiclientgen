...
export namespace MyNS {
	...
	export function CreatePinTableHeaderRowsRequestFormGroup() {
		return new FormGroup<PinTableHeaderRowsRequestFormProperties>({
			pinnedHeaderRowsCount: new FormControl<number | null | undefined>(undefined),
		});
	...
	export function CreateDocumentStyleFormGroup() {
		return new FormGroup<DocumentStyleFormProperties>({
			...
			flipPageOrientation: new FormControl<boolean | null | undefined>(undefined),
	...
	export interface ParagraphStyleFormProperties {
		...
		/** Whether the current paragraph should always start at the beginning of a page. If unset, the value is inherited from the parent. Attempting to update page_break_before for paragraphs in unsupported regions, including Table, Header, Footer and Footnote, can result in an invalid document state that returns a 400 bad request error. */
		pageBreakBefore: FormControl<boolean | null | undefined>,
	...
	export function CreateParagraphStyleFormGroup() {
		return new FormGroup<ParagraphStyleFormProperties>({
			...
			pageBreakBefore: new FormControl<boolean | null | undefined>(undefined),
	...
	export interface TableRowStyleFormProperties {
		...
		/** Whether the row cannot overflow across page or column boundaries. */
		preventOverflow: FormControl<boolean | null | undefined>,

		/** Whether the row is a table header. */
		tableHeader: FormControl<boolean | null | undefined>,
	}
	export function CreateTableRowStyleFormGroup() {
		return new FormGroup<TableRowStyleFormProperties>({
			preventOverflow: new FormControl<boolean | null | undefined>(undefined),
			tableHeader: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Properties specific to a linked Person. */
	export interface PersonPropertiesFormProperties {
	...
	export function CreatePersonPropertiesFormGroup() {
		return new FormGroup<PersonPropertiesFormProperties>({
	...
	/** A link to a Google resource (such as a file in Drive, a YouTube video, or a Calendar event). */
	export interface RichLinkFormProperties {

		/** Output only. The ID of this link. */
		richLinkId: FormControl<string | null | undefined>,

		/** The suggested text style changes to this RichLink, keyed by suggestion ID. */
		suggestedTextStyleChanges: FormControl<{[id: string]: SuggestedTextStyle } | null | undefined>,
	}
	export function CreateRichLinkFormGroup() {
		return new FormGroup<RichLinkFormProperties>({
			richLinkId: new FormControl<string | null | undefined>(undefined),
			suggestedTextStyleChanges: new FormControl<{[id: string]: SuggestedTextStyle } | null | undefined>(undefined),
		});
	...
	/** Properties specific to a RichLink. */
	export interface RichLinkPropertiesFormProperties {
	...
	export function CreateRichLinkPropertiesFormGroup() {
		return new FormGroup<RichLinkPropertiesFormProperties>({
	...
	export interface ParagraphStyleSuggestionStateFormProperties {
		...
		/** Indicates if there was a suggested change to page_break_before. */
		pageBreakBeforeSuggested: FormControl<boolean | null | undefined>,
	...
	export function CreateParagraphStyleSuggestionStateFormGroup() {
		return new FormGroup<ParagraphStyleSuggestionStateFormProperties>({
			...
			pageBreakBeforeSuggested: new FormControl<boolean | null | undefined>(undefined),
	...
	export interface DocumentStyleSuggestionStateFormProperties {
		...
		/** Optional. Indicates if there was a suggested change to flip_page_orientation. */
		flipPageOrientationSuggested: FormControl<boolean | null | undefined>,
	...
	export function CreateDocumentStyleSuggestionStateFormGroup() {
		return new FormGroup<DocumentStyleSuggestionStateFormProperties>({
			...
			flipPageOrientationSuggested: new FormControl<boolean | null | undefined>(undefined),
			marginBottomSuggested: new FormControl<boolean | null | undefined>(undefined),
	...
	export class MyClient {
		 ...
		 */
		Docs_documents_create(requestBody: Document): Observable<Document> {
			return this.http.post<Document>(this.baseUri + 'v1/documents', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {DocumentSuggestionsViewMode} suggestionsViewMode The suggestions view mode to apply to the document. This allows viewing the document with all suggestions inline, accepted or rejected. If one is not specified, DEFAULT_FOR_CURRENT_ACCESS is used.
		 * @return {Document} Successful response
		 */
		Docs_documents_get(documentId: string, suggestionsViewMode: DocumentSuggestionsViewMode | null | undefined): Observable<Document> {
			return this.http.get<Document>(this.baseUri + 'v1/documents/' + (documentId == null ? '' : encodeURIComponent(documentId)) + '&suggestionsViewMode=' + suggestionsViewMode, {});
		}
		 ...
		 * @return {BatchUpdateDocumentResponse} Successful response
		 */
		Docs_documents_batchUpdate(documentId: string, requestBody: BatchUpdateDocumentRequest): Observable<BatchUpdateDocumentResponse> {
			return this.http.post<BatchUpdateDocumentResponse>(this.baseUri + 'v1/documents/' + (documentId == null ? '' : encodeURIComponent(documentId)) + ':batchUpdate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
