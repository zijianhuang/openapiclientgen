...
export namespace MyNS {
	...
	export interface SscerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		Cent: FormControl<string | null | undefined>,

		/**
		 * Mother Name
		 * Required
		 */
		MName: FormControl<string | null | undefined>,
	...
	export function CreateSscerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SscerPostBodyCertificateParametersFormProperties>({
			Cent: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			MName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
