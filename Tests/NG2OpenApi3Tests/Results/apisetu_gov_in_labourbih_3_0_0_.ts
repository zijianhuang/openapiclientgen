...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {AlsblPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Alsbl(requestBody: AlsblPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'alsbl/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {AlsfcPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Alsfc(requestBody: AlsfcPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'alsfc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {ApptuPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Apptu(requestBody: ApptuPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'apptu/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {NooclPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Noocl(requestBody: NooclPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'noocl/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	...
	export interface AlimwPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<AlimwPostBodyFormat | null | undefined>,
	...
	export function CreateAlimwPostBodyFormGroup() {
		return new FormGroup<AlimwPostBodyFormProperties>({
			format: new FormControl<AlimwPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface AlsblPostBodyFormProperties {
	...
	export function CreateAlsblPostBodyFormGroup() {
		return new FormGroup<AlsblPostBodyFormProperties>({
			format: new FormControl<AlimwPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface AlsblPostBodyCertificateParameters {
	...
	export interface AlsblPostBodyCertificateParametersFormProperties {
	...
	export function CreateAlsblPostBodyCertificateParametersFormGroup() {
		return new FormGroup<AlsblPostBodyCertificateParametersFormProperties>({
			RefNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			TokenNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface AlsfcPostBody {
		certificateParameters?: AlsfcPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface AlsfcPostBodyFormProperties {
	...
	export function CreateAlsfcPostBodyFormGroup() {
		return new FormGroup<AlsfcPostBodyFormProperties>({
			format: new FormControl<AlimwPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface AlsfcPostBodyCertificateParameters {
	...
	export interface AlsfcPostBodyCertificateParametersFormProperties {
	...
	export function CreateAlsfcPostBodyCertificateParametersFormGroup() {
		return new FormGroup<AlsfcPostBodyCertificateParametersFormProperties>({
			RefNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			TokenNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface ApptuPostBody {
		certificateParameters?: ApptuPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface ApptuPostBodyFormProperties {
	...
	export function CreateApptuPostBodyFormGroup() {
		return new FormGroup<ApptuPostBodyFormProperties>({
			format: new FormControl<AlimwPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface ApptuPostBodyCertificateParameters {
	...
	export interface ApptuPostBodyCertificateParametersFormProperties {
	...
	export function CreateApptuPostBodyCertificateParametersFormGroup() {
		return new FormGroup<ApptuPostBodyCertificateParametersFormProperties>({
			RefNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			TokenNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NooclPostBody {
		certificateParameters?: NooclPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface NooclPostBodyFormProperties {
	...
	export function CreateNooclPostBodyFormGroup() {
		return new FormGroup<NooclPostBodyFormProperties>({
			format: new FormControl<AlimwPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NooclPostBodyCertificateParameters {
	...
	export interface NooclPostBodyCertificateParametersFormProperties {
	...
	export function CreateNooclPostBodyCertificateParametersFormGroup() {
		return new FormGroup<NooclPostBodyCertificateParametersFormProperties>({
			RefNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			TokenNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
