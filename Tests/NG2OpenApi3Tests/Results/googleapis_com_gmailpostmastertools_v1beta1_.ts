...
export namespace MyNS {
	...
	export enum DeliveryErrorErrorClass { DELIVERY_ERROR_CLASS_UNSPECIFIED = 0, PERMANENT_ERROR = 1, TEMPORARY_ERROR = 2 }

	export enum DeliveryErrorErrorType { DELIVERY_ERROR_TYPE_UNSPECIFIED = 0, RATE_LIMIT_EXCEEDED = 1, SUSPECTED_SPAM = 2, CONTENT_SPAMMY = 3, BAD_ATTACHMENT = 4, BAD_DMARC_POLICY = 5, LOW_IP_REPUTATION = 6, LOW_DOMAIN_REPUTATION = 7, IP_IN_RBL = 8, DOMAIN_IN_RBL = 9, BAD_PTR_RECORD = 10 }
	...
	export enum DomainPermission { PERMISSION_UNSPECIFIED = 0, OWNER = 1, READER = 2, NONE = 3 }
	...
	export interface IpReputationFormProperties {
		...
		/** Total number of unique IPs in this reputation category. This metric only pertains to traffic that passed [SPF](http://www.openspf.org/) or [DKIM](http://www.dkim.org/). Deprecated to be complied with ApiLinter for Quantities. Use ip_count instead. */
		numIps: FormControl<string | null | undefined>,
	...
	export function CreateIpReputationFormGroup() {
		return new FormGroup<IpReputationFormProperties>({
			...
			numIps: new FormControl<string | null | undefined>(undefined),
			reputation: new FormControl<IpReputationReputation | null | undefined>(undefined),
		});

	}

	export enum IpReputationReputation { REPUTATION_CATEGORY_UNSPECIFIED = 0, HIGH = 1, MEDIUM = 2, LOW = 3, BAD = 4 }
	...
	export class MyClient {
		...
		Gmailpostmastertools_domains_list(pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDomainsResponse> {
			return this.http.get<ListDomainsResponse>(this.baseUri + 'v1beta1/domains?pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Gmailpostmastertools_domains_trafficStats_get(name: string): Observable<TrafficStats> {
			return this.http.get<TrafficStats>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Gmailpostmastertools_domains_trafficStats_list(parent: string, endDate_day: number | null | undefined, endDate_month: number | null | undefined, endDate_year: number | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, startDate_day: number | null | undefined, startDate_month: number | null | undefined, startDate_year: number | null | undefined): Observable<ListTrafficStatsResponse> {
			return this.http.get<ListTrafficStatsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/trafficStats&endDate_day=' + endDate_day + '&endDate_month=' + endDate_month + '&endDate_year=' + endDate_year + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&startDate_day=' + startDate_day + '&startDate_month=' + startDate_month + '&startDate_year=' + startDate_year, {});
		}
	}
