...
export namespace MyNS {
	...
	export interface TrustFormProperties {
		...
		/** Output only. The last heartbeat time when the trust was known to be connected. */
		lastTrustHeartbeatTime: FormControl<string | null | undefined>,
	...
	export function CreateTrustFormGroup() {
		return new FormGroup<TrustFormProperties>({
			...
			lastTrustHeartbeatTime: new FormControl<string | null | undefined>(undefined),
	...
	export class MyClient {
		 ...
		 * Post v1beta1/{domain}:checkMigrationPermission
		...
		Managedidentities_projects_locations_global_domains_checkMigrationPermission(domain: string, requestBody: CheckMigrationPermissionRequest): Observable<CheckMigrationPermissionResponse> {
			return this.http.post<CheckMigrationPermissionResponse>(this.baseUri + 'v1beta1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':checkMigrationPermission', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Disable Domain Migration
		 * Post v1beta1/{domain}:disableMigration
		 * @param {string} domain Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
		...
		Managedidentities_projects_locations_global_domains_disableMigration(domain: string, requestBody: DisableMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':disableMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * DomainJoinMachine API joins a Compute Engine VM to the domain
		 * Post v1beta1/{domain}:domainJoinMachine
		 * @param {string} domain Required. The domain resource name using the form: projects/{project_id}/locations/global/domains/{domain_name}
		...
		Managedidentities_projects_locations_global_domains_domainJoinMachine(domain: string, requestBody: DomainJoinMachineRequest): Observable<DomainJoinMachineResponse> {
			return this.http.post<DomainJoinMachineResponse>(this.baseUri + 'v1beta1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':domainJoinMachine', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Enable Domain Migration
		 * Post v1beta1/{domain}:enableMigration
		 * @param {string} domain Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
		 * @return {Operation} Successful response
		 */
		Managedidentities_projects_locations_global_domains_enableMigration(domain: string, requestBody: EnableMigrationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':enableMigration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Extend Schema for Domain
		 * Post v1beta1/{domain}:extendSchema
		 * @param {string} domain Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
		 * @return {Operation} Successful response
		 */
		Managedidentities_projects_locations_global_domains_extendSchema(domain: string, requestBody: ExtendSchemaRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (domain == null ? '' : encodeURIComponent(domain)) + ':extendSchema', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Managedidentities_projects_locations_global_peerings_get(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<Peering> {
			return this.http.get<Peering>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * Get v1beta1/{name}/ldapssettings
		...
		Managedidentities_projects_locations_global_domains_getLdapssettings(name: string): Observable<LDAPSSettings> {
			return this.http.get<LDAPSSettings>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/ldapssettings', {});
		}

		/**
		 * Patches a single ldaps settings.
		 * Patch v1beta1/{name}/ldapssettings
		...
		Managedidentities_projects_locations_global_domains_updateLdapssettings(name: string, updateMask: string | null | undefined, requestBody: LDAPSSettings): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/ldapssettings&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * Post v1beta1/{name}:attachTrust
		 * @param {string} name Required. The resource domain name, project name and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
		 * @return {Operation} Successful response
		 */
		Managedidentities_projects_locations_global_domains_attachTrust(name: string, requestBody: AttachTrustRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':attachTrust', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Managedidentities_projects_locations_global_domains_detachTrust(name: string, requestBody: DetachTrustRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':detachTrust', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates the DNS conditional forwarder.
		 * Post v1beta1/{name}:reconfigureTrust
		 * @param {string} name Required. The resource domain name, project name and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
		 * @return {Operation} Successful response
		 */
		Managedidentities_projects_locations_global_domains_reconfigureTrust(name: string, requestBody: ReconfigureTrustRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':reconfigureTrust', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Resets a domain's administrator password.
		 * Post v1beta1/{name}:resetAdminPassword
		 * @param {string} name Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
		...
		Managedidentities_projects_locations_global_domains_resetAdminPassword(name: string, requestBody: ResetAdminPasswordRequest): Observable<ResetAdminPasswordResponse> {
			return this.http.post<ResetAdminPasswordResponse>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':resetAdminPassword', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * RestoreBackup restores domain mentioned in the RestoreBackupRequest
		 * Post v1beta1/{name}:restore
		...
		Managedidentities_projects_locations_global_domains_restore(name: string, requestBody: RestoreDomainRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':restore', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Validates a trust state, that the target domain is reachable, and that the target domain is able to accept incoming trust requests.
		 * Post v1beta1/{name}:validateTrust
		 * @param {string} name Required. The resource domain name, project name, and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
		 * @return {Operation} Successful response
		 */
		Managedidentities_projects_locations_global_domains_validateTrust(name: string, requestBody: ValidateTrustRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':validateTrust', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Backup in a given project.
		 * Get v1beta1/{parent}/backups
		...
		Managedidentities_projects_locations_global_domains_backups_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListBackupsResponse> {
			return this.http.get<ListBackupsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/backups&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a Backup for a domain.
		 * Post v1beta1/{parent}/backups
		 * @param {string} parent Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
		...
		Managedidentities_projects_locations_global_domains_backups_create(parent: string, backupId: string | null | undefined, requestBody: Backup): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/backups&backupId=' + (backupId == null ? '' : encodeURIComponent(backupId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} filter Optional. A filter specifying constraints of a list operation. For example, `Domain.fqdn="mydomain.myorginization"`.
		 ...
		 * @param {number} pageSize Optional. The maximum number of items to return. If not specified, a default value of 1000 will be used. Regardless of the page_size value, the response may include a partial list. Callers should rely on a response's next_page_token to determine if there are additional results to list.
		 * @param {string} pageToken The `next_page_token` value returned from a previous ListDomainsRequest request, if any.
		...
		Managedidentities_projects_locations_global_domains_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDomainsResponse> {
			return this.http.get<ListDomainsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/domains&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a Microsoft AD domain.
		 * Post v1beta1/{parent}/domains
		 * @param {string} parent Required. The resource project name and location using the form: `projects/{project_id}/locations/global`
		 * @param {string} domainName Required. A domain name, e.g. mydomain.myorg.com, with the following restrictions: * Must contain only lowercase letters, numbers, periods and hyphens. * Must start with a letter. * Must contain between 2-64 characters. * Must end with a number or a letter. * Must not start with period. * First segment length (mydomain form example above) shouldn't exceed 15 chars. * The last segment cannot be fully numeric. * Must be unique within the customer project.
		 * @return {Operation} Successful response
		 */
		Managedidentities_projects_locations_global_domains_create(parent: string, domainName: string | null | undefined, requestBody: Domain): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/domains&domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Peerings in a given project.
		 * Get v1beta1/{parent}/peerings
		 * @param {string} parent Required. The resource name of the domain location using the form: `projects/{project_id}/locations/global`
		...
		Managedidentities_projects_locations_global_peerings_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPeeringsResponse> {
			return this.http.get<ListPeeringsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/peerings&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a Peering for Managed AD instance.
		 * Post v1beta1/{parent}/peerings
		...
		Managedidentities_projects_locations_global_peerings_create(parent: string, peeringId: string | null | undefined, requestBody: Peering): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/peerings&peeringId=' + (peeringId == null ? '' : encodeURIComponent(peeringId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists SqlIntegrations in a given domain.
		 * Get v1beta1/{parent}/sqlIntegrations
		...
		Managedidentities_projects_locations_global_domains_sqlIntegrations_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSqlIntegrationsResponse> {
			return this.http.get<ListSqlIntegrationsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sqlIntegrations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
