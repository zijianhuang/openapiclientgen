...
export namespace MyNS {
	...
	export enum GoogleCloudVisionV1p2beta1FeatureType { TYPE_UNSPECIFIED = 0, FACE_DETECTION = 1, LANDMARK_DETECTION = 2, LOGO_DETECTION = 3, LABEL_DETECTION = 4, TEXT_DETECTION = 5, DOCUMENT_TEXT_DETECTION = 6, SAFE_SEARCH_DETECTION = 7, IMAGE_PROPERTIES = 8, CROP_HINTS = 9, WEB_DETECTION = 10, PRODUCT_SEARCH = 11, OBJECT_LOCALIZATION = 12 }
