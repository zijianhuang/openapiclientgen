...
export namespace MyNS {
	...
	export enum GoogleIamV1BindingDeltaAction { ACTION_UNSPECIFIED = 0, ADD = 1, REMOVE = 2 }
	...
	/** A deny rule in an IAM deny policy. */
	export interface GoogleIamV2DenyRuleFormProperties {
	}
	export function CreateGoogleIamV2DenyRuleFormGroup() {
		return new FormGroup<GoogleIamV2DenyRuleFormProperties>({
		});
	...
	/** Response message for `ListPolicies`. */
	export interface GoogleIamV2ListPoliciesResponseFormProperties {

		/** A page token that you can use in a ListPoliciesRequest to retrieve the next page. If this field is omitted, there are no additional pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleIamV2ListPoliciesResponseFormGroup() {
		return new FormGroup<GoogleIamV2ListPoliciesResponseFormProperties>({
	...
	/** Data for an IAM policy. */
	export interface GoogleIamV2PolicyFormProperties {
	...
	export function CreateGoogleIamV2PolicyFormGroup() {
		return new FormGroup<GoogleIamV2PolicyFormProperties>({
	...
	/** A single rule in a `Policy`. */
	export interface GoogleIamV2PolicyRuleFormProperties {

		/** A user-specified description of the rule. This value can be up to 256 characters. */
		description: FormControl<string | null | undefined>,
	}
	export function CreateGoogleIamV2PolicyRuleFormGroup() {
		return new FormGroup<GoogleIamV2PolicyRuleFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Metadata for long-running `Policy` operations. */
	export interface GoogleIamV2PolicyOperationMetadataFormProperties {

		/** Timestamp when the `google.longrunning.Operation` was created. */
		createTime: FormControl<string | null | undefined>,
	}
	export function CreateGoogleIamV2PolicyOperationMetadataFormGroup() {
		return new FormGroup<GoogleIamV2PolicyOperationMetadataFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		...
		Iam_policies_delete(name: string, etag: string | null | undefined): Observable<GoogleLongrunningOperation> {
			return this.http.delete<GoogleLongrunningOperation>(this.baseUri + 'v2/' + (name == null ? '' : encodeURIComponent(name)) + '&etag=' + (etag == null ? '' : encodeURIComponent(etag)), {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Iam_policies_update(name: string, requestBody: GoogleIamV2Policy): Observable<GoogleLongrunningOperation> {
			return this.http.put<GoogleLongrunningOperation>(this.baseUri + 'v2/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleIamV2ListPoliciesResponse} Successful response
		 */
		Iam_policies_listPolicies(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleIamV2ListPoliciesResponse> {
			return this.http.get<GoogleIamV2ListPoliciesResponse>(this.baseUri + 'v2/' + (parent == null ? '' : encodeURIComponent(parent)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Iam_policies_createPolicy(parent: string, policyId: string | null | undefined, requestBody: GoogleIamV2Policy): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v2/' + (parent == null ? '' : encodeURIComponent(parent)) + '&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
