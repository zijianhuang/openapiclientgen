...
export namespace MyNS {
	...
	export interface BtcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		DateofEvent: FormControl<string | null | undefined>,

		/**
		 * Registration Number
		 * Required
		 */
		RegisNumber: FormControl<string | null | undefined>,
	...
	export function CreateBtcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<BtcerPostBodyCertificateParametersFormProperties>({
			...
			DateofEvent: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			RegisNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
