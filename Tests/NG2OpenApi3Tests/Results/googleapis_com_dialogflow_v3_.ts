...
export namespace MyNS {
	...
	/** Agents are best described as Natural Language Understanding (NLU) modules that transform user requests into actionable data. You can include agents in your app, product, or service to determine user intent and respond to the user in a natural way. After you create an agent, you can add Intents, Entity Types, Flows, Fulfillments, Webhooks, TransitionRouteGroups and so on to manage the conversation flows. */
	export interface GoogleCloudDialogflowCxV3AgentFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3AgentFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3AgentFormProperties>({
	...
	/** Settings for answer feedback collection. */
	export interface GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsFormProperties {

		/** Optional. If enabled, end users will be able to provide answer feedback to Dialogflow responses. Feature works only if interaction logging is enabled in the Dialogflow agent. */
		enableAnswerFeedback: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3AgentAnswerFeedbackSettingsFormProperties>({
	...
	/** Settings for Gen App Builder. */
	export interface GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsFormProperties {

		/** Required. The full name of the Gen App Builder engine related to this agent if there is one. Format: `projects/{Project ID}/locations/{Location ID}/collections/{Collection ID}/engines/{Engine ID}` */
		engine: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3AgentGenAppBuilderSettingsFormProperties>({
	...
	/** Settings for connecting to Git repository for an agent. */
	export interface GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3AgentGitIntegrationSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsFormProperties>({
		});
	...
	/** Settings of integration with GitHub. */
	export interface GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsGithubSettingsFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3AgentGitIntegrationSettingsGithubSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3AgentGitIntegrationSettingsGithubSettingsFormProperties>({
	...
	/** Settings related to speech recognition. */
	export interface GoogleCloudDialogflowCxV3SpeechToTextSettingsFormProperties {

		/** Whether to use speech adaptation for speech recognition. */
		enableSpeechAdaptation: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3SpeechToTextSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SpeechToTextSettingsFormProperties>({
	...
	export interface GoogleCloudDialogflowCxV3TextToSpeechSettings {
		...
		synthesizeSpeechConfigs?: {[id: string]: GoogleCloudDialogflowCxV3SynthesizeSpeechConfig };
	}

	/** Settings related to speech synthesizing. */
	export interface GoogleCloudDialogflowCxV3TextToSpeechSettingsFormProperties {

		/** Configuration of how speech should be synthesized, mapping from language (https://cloud.google.com/dialogflow/cx/docs/reference/language) to SynthesizeSpeechConfig. These settings affect: - The [phone gateway](https://cloud.google.com/dialogflow/cx/docs/concept/integration/phone-gateway) synthesize configuration set via Agent.text_to_speech_settings. - How speech is synthesized when invoking session APIs. Agent.text_to_speech_settings only applies if OutputAudioConfig.synthesize_speech_config is not specified. */
		synthesizeSpeechConfigs: FormControl<{[id: string]: GoogleCloudDialogflowCxV3SynthesizeSpeechConfig } | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3TextToSpeechSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TextToSpeechSettingsFormProperties>({
			synthesizeSpeechConfigs: new FormControl<{[id: string]: GoogleCloudDialogflowCxV3SynthesizeSpeechConfig } | null | undefined>(undefined),
		});
	...
	/** Configuration of how speech should be synthesized. */
	export interface GoogleCloudDialogflowCxV3SynthesizeSpeechConfigFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3SynthesizeSpeechConfigFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SynthesizeSpeechConfigFormProperties>({
	...
	export interface GoogleCloudDialogflowCxV3VoiceSelectionParams {
		...
		ssmlGender?: GoogleCloudDialogflowCxV3VoiceSelectionParamsSsmlGender | null;
	}

	/** Description of which voice to use for speech synthesis. */
	export interface GoogleCloudDialogflowCxV3VoiceSelectionParamsFormProperties {

		/** Optional. The name of the voice. If not set, the service will choose a voice based on the other parameters such as language_code and ssml_gender. For the list of available voices, please refer to [Supported voices and languages](https://cloud.google.com/text-to-speech/docs/voices). */
		name: FormControl<string | null | undefined>,

		/** Optional. The preferred gender of the voice. If not set, the service will choose a voice based on the other parameters such as language_code and name. Note that this is only a preference, not requirement. If a voice of the appropriate gender is not available, the synthesizer substitutes a voice with a different gender rather than failing the request. */
		ssmlGender: FormControl<GoogleCloudDialogflowCxV3VoiceSelectionParamsSsmlGender | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3VoiceSelectionParamsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3VoiceSelectionParamsFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
			ssmlGender: new FormControl<GoogleCloudDialogflowCxV3VoiceSelectionParamsSsmlGender | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3VoiceSelectionParamsSsmlGender { SSML_VOICE_GENDER_UNSPECIFIED = 'SSML_VOICE_GENDER_UNSPECIFIED', SSML_VOICE_GENDER_MALE = 'SSML_VOICE_GENDER_MALE', SSML_VOICE_GENDER_FEMALE = 'SSML_VOICE_GENDER_FEMALE', SSML_VOICE_GENDER_NEUTRAL = 'SSML_VOICE_GENDER_NEUTRAL' }
	...
	/** The response message for Agents.GetAgentValidationResult. */
	export interface GoogleCloudDialogflowCxV3AgentValidationResultFormProperties {

		/** The unique identifier of the agent validation result. Format: `projects//locations//agents//validationResult`. */
		name: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3AgentValidationResultFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3AgentValidationResultFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Flows.GetFlowValidationResult. */
	export interface GoogleCloudDialogflowCxV3FlowValidationResultFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3FlowValidationResultFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3FlowValidationResultFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
	...
	export interface GoogleCloudDialogflowCxV3ValidationMessage {
		...
		resourceType?: GoogleCloudDialogflowCxV3ValidationMessageResourceType | null;

		/** The names of the resources where the message is found. */
		resources?: Array<string>;

		/** Indicates the severity of the message. */
		severity?: GoogleCloudDialogflowCxV3ValidationMessageSeverity | null;
	}

	/** Agent/flow validation message. */
	export interface GoogleCloudDialogflowCxV3ValidationMessageFormProperties {

		/** The message detail. */
		detail: FormControl<string | null | undefined>,

		/** The type of the resources where the message is found. */
		resourceType: FormControl<GoogleCloudDialogflowCxV3ValidationMessageResourceType | null | undefined>,

		/** Indicates the severity of the message. */
		severity: FormControl<GoogleCloudDialogflowCxV3ValidationMessageSeverity | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ValidationMessageFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ValidationMessageFormProperties>({
			detail: new FormControl<string | null | undefined>(undefined),
			resourceType: new FormControl<GoogleCloudDialogflowCxV3ValidationMessageResourceType | null | undefined>(undefined),
			severity: new FormControl<GoogleCloudDialogflowCxV3ValidationMessageSeverity | null | undefined>(undefined),
		});
	...
	/** Resource name and display name. */
	export interface GoogleCloudDialogflowCxV3ResourceNameFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3ResourceNameFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ResourceNameFormProperties>({
			displayName: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDialogflowCxV3AnswerFeedback {
		...
		rating?: GoogleCloudDialogflowCxV3AnswerFeedbackRating | null;
	...
	/** Stores information about feedback provided by users about a response. */
	export interface GoogleCloudDialogflowCxV3AnswerFeedbackFormProperties {

		/** Optional. Custom rating from the user about the provided answer, with maximum length of 1024 characters. For example, client could use a customized JSON object to indicate the rating. */
		customRating: FormControl<string | null | undefined>,

		/** Optional. Rating from user for the specific Dialogflow response. */
		rating: FormControl<GoogleCloudDialogflowCxV3AnswerFeedbackRating | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3AnswerFeedbackFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3AnswerFeedbackFormProperties>({
			customRating: new FormControl<string | null | undefined>(undefined),
			rating: new FormControl<GoogleCloudDialogflowCxV3AnswerFeedbackRating | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3AnswerFeedbackRating { RATING_UNSPECIFIED = 'RATING_UNSPECIFIED', THUMBS_UP = 'THUMBS_UP', THUMBS_DOWN = 'THUMBS_DOWN' }
	...
	/** Stores extra information about why users provided thumbs down rating. */
	export interface GoogleCloudDialogflowCxV3AnswerFeedbackRatingReasonFormProperties {

		/** Optional. Additional feedback about the rating. This field can be populated without choosing a predefined `reason`. */
		feedback: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3AnswerFeedbackRatingReasonFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3AnswerFeedbackRatingReasonFormProperties>({
	...
	/** The request message for TestCases.BatchDeleteTestCases. */
	export interface GoogleCloudDialogflowCxV3BatchDeleteTestCasesRequestFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3BatchDeleteTestCasesRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3BatchDeleteTestCasesRequestFormProperties>({
		});
	...
	/** The request message for TestCases.BatchRunTestCases. */
	export interface GoogleCloudDialogflowCxV3BatchRunTestCasesRequestFormProperties {

		/** Optional. If not set, draft environment is assumed. Format: `projects//locations//agents//environments/`. */
		environment: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3BatchRunTestCasesRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3BatchRunTestCasesRequestFormProperties>({
	...
	/** Boost specification to boost certain documents. A copy of google.cloud.discoveryengine.v1main.BoostSpec, field documentation is available at https://cloud.google.com/generative-ai-app-builder/docs/reference/rest/v1alpha/BoostSpec */
	export interface GoogleCloudDialogflowCxV3BoostSpecFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3BoostSpecFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3BoostSpecFormProperties>({
		});
	...
	/** Boost applies to documents which match a condition. */
	export interface GoogleCloudDialogflowCxV3BoostSpecConditionBoostSpecFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3BoostSpecConditionBoostSpecFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3BoostSpecConditionBoostSpecFormProperties>({
	...
	/** Boost specifications for data stores. */
	export interface GoogleCloudDialogflowCxV3BoostSpecsFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3BoostSpecsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3BoostSpecsFormProperties>({
		});
	...
	/** The response message for TestCases.CalculateCoverage. */
	export interface GoogleCloudDialogflowCxV3CalculateCoverageResponseFormProperties {

		/** The agent to calculate coverage for. Format: `projects//locations//agents/`. */
		agent: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3CalculateCoverageResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3CalculateCoverageResponseFormProperties>({
	...
	/** Intent coverage represents the percentage of all possible intents in the agent that are triggered in any of a parent's test cases. */
	export interface GoogleCloudDialogflowCxV3IntentCoverageFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3IntentCoverageFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3IntentCoverageFormProperties>({
	...
	/** The agent's intent. */
	export interface GoogleCloudDialogflowCxV3IntentCoverageIntentFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3IntentCoverageIntentFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3IntentCoverageIntentFormProperties>({
	...
	/** Transition route group coverage represents the percentage of all possible transition routes present within any of a parent's test cases. The results are grouped by the transition route group. */
	export interface GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageFormProperties>({
			coverageScore: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** Coverage result message for one transition route group. */
	export interface GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageFormProperties>({
			coverageScore: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** A TransitionRouteGroup represents a group of `TransitionRoutes` to be used by a Page. */
	export interface GoogleCloudDialogflowCxV3TransitionRouteGroupFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3TransitionRouteGroupFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TransitionRouteGroupFormProperties>({
			displayName: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A transition coverage in a transition route group. */
	export interface GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransitionFormProperties {

		/** Whether the transition route is covered by at least one of the agent's test cases. */
		covered: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransitionFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransitionFormProperties>({
			covered: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Transition coverage represents the percentage of all possible page transitions (page-level transition routes and event handlers, excluding transition route groups) present within any of a parent's test cases. */
	export interface GoogleCloudDialogflowCxV3TransitionCoverageFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3TransitionCoverageFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TransitionCoverageFormProperties>({
			coverageScore: new FormControl<number | null | undefined>(undefined),
		});
	...
	/** A transition in a page. */
	export interface GoogleCloudDialogflowCxV3TransitionCoverageTransitionFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3TransitionCoverageTransitionFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TransitionCoverageTransitionFormProperties>({
			covered: new FormControl<boolean | null | undefined>(undefined),
	...
	/** The source or target of a transition. */
	export interface GoogleCloudDialogflowCxV3TransitionCoverageTransitionNodeFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3TransitionCoverageTransitionNodeFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TransitionCoverageTransitionNodeFormProperties>({
		});
	...
	/** Flows represents the conversation flows when you build your chatbot agent. A flow consists of many pages connected by the transition routes. Conversations always start with the built-in Start Flow (with an all-0 ID). Transition routes can direct the conversation session from the current flow (parent flow) to another flow (sub flow). When the sub flow is finished, Dialogflow will bring the session back to the parent flow, where the sub flow is started. Usually, when a transition route is followed by a matched intent, the intent will be "consumed". This means the intent won't activate more transition routes. However, when the followed transition route moves the conversation session into a different flow, the matched intent can be carried over and to be consumed in the target flow. */
	export interface GoogleCloudDialogflowCxV3FlowFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3FlowFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3FlowFormProperties>({
			description: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDialogflowCxV3NluSettings {
		...
		modelTrainingMode?: GoogleCloudDialogflowCxV3NluSettingsModelTrainingMode | null;

		/** Indicates the type of NLU model. */
		modelType?: GoogleCloudDialogflowCxV3NluSettingsModelType | null;
	}

	/** Settings related to NLU. */
	export interface GoogleCloudDialogflowCxV3NluSettingsFormProperties {
		...
		/** Indicates NLU model training mode. */
		modelTrainingMode: FormControl<GoogleCloudDialogflowCxV3NluSettingsModelTrainingMode | null | undefined>,

		/** Indicates the type of NLU model. */
		modelType: FormControl<GoogleCloudDialogflowCxV3NluSettingsModelType | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3NluSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3NluSettingsFormProperties>({
			classificationThreshold: new FormControl<number | null | undefined>(undefined),
			modelTrainingMode: new FormControl<GoogleCloudDialogflowCxV3NluSettingsModelTrainingMode | null | undefined>(undefined),
			modelType: new FormControl<GoogleCloudDialogflowCxV3NluSettingsModelType | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3NluSettingsModelTrainingMode { MODEL_TRAINING_MODE_UNSPECIFIED = 'MODEL_TRAINING_MODE_UNSPECIFIED', MODEL_TRAINING_MODE_AUTOMATIC = 'MODEL_TRAINING_MODE_AUTOMATIC', MODEL_TRAINING_MODE_MANUAL = 'MODEL_TRAINING_MODE_MANUAL' }

	export enum GoogleCloudDialogflowCxV3NluSettingsModelType { MODEL_TYPE_UNSPECIFIED = 'MODEL_TYPE_UNSPECIFIED', MODEL_TYPE_STANDARD = 'MODEL_TYPE_STANDARD', MODEL_TYPE_ADVANCED = 'MODEL_TYPE_ADVANCED' }
	...
	/** Changelogs represents a change made to a given agent. */
	export interface GoogleCloudDialogflowCxV3ChangelogFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3ChangelogFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ChangelogFormProperties>({
	...
	/** The request message for Versions.CompareVersions. */
	export interface GoogleCloudDialogflowCxV3CompareVersionsRequestFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3CompareVersionsRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3CompareVersionsRequestFormProperties>({
			languageCode: new FormControl<string | null | undefined>(undefined),
	...
	/** The response message for Versions.CompareVersions. */
	export interface GoogleCloudDialogflowCxV3CompareVersionsResponseFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3CompareVersionsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3CompareVersionsResponseFormProperties>({
	...
	/** The request message for Environments.DeployFlow. */
	export interface GoogleCloudDialogflowCxV3DeployFlowRequestFormProperties {

		/** Required. The flow version to deploy. Format: `projects//locations//agents// flows//versions/`. */
		flowVersion: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3DeployFlowRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3DeployFlowRequestFormProperties>({
	...
	export interface GoogleCloudDialogflowCxV3Deployment {
		...
		state?: GoogleCloudDialogflowCxV3DeploymentState | null;
	}

	/** Represents a deployment in an environment. A deployment happens when a flow version configured to be active in the environment. You can configure running pre-deployment steps, e.g. running validation test cases, experiment auto-rollout, etc. */
	export interface GoogleCloudDialogflowCxV3DeploymentFormProperties {
		...
		/** The current state of the deployment. */
		state: FormControl<GoogleCloudDialogflowCxV3DeploymentState | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3DeploymentFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3DeploymentFormProperties>({
			endTime: new FormControl<string | null | undefined>(undefined),
			flowVersion: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			startTime: new FormControl<string | null | undefined>(undefined),
			state: new FormControl<GoogleCloudDialogflowCxV3DeploymentState | null | undefined>(undefined),
		});
	...
	/** Result of the deployment. */
	export interface GoogleCloudDialogflowCxV3DeploymentResultFormProperties {

		/** The name of the experiment triggered by this deployment. Format: projects//locations//agents//environments//experiments/. */
		experiment: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3DeploymentResultFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3DeploymentResultFormProperties>({
			experiment: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3DeploymentState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', RUNNING = 'RUNNING', SUCCEEDED = 'SUCCEEDED', FAILED = 'FAILED' }
	...
	/** The request to detect user's intent. */
	export interface GoogleCloudDialogflowCxV3DetectIntentRequestFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3DetectIntentRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3DetectIntentRequestFormProperties>({
		});
	...
	export interface GoogleCloudDialogflowCxV3OutputAudioConfig {
		...
		audioEncoding?: GoogleCloudDialogflowCxV3OutputAudioConfigAudioEncoding | null;
	...
	/** Instructs the speech synthesizer how to generate the output audio content. */
	export interface GoogleCloudDialogflowCxV3OutputAudioConfigFormProperties {

		/** Required. Audio encoding of the synthesized audio content. */
		audioEncoding: FormControl<GoogleCloudDialogflowCxV3OutputAudioConfigAudioEncoding | null | undefined>,
	...
	/** Represents the parameters of a conversational query. */
	export interface GoogleCloudDialogflowCxV3QueryParametersFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3QueryParametersFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3QueryParametersFormProperties>({
	...
	/** Search configuration for UCS search queries. */
	export interface GoogleCloudDialogflowCxV3SearchConfigFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3SearchConfigFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SearchConfigFormProperties>({
		});
	...
	/** Filter specifications for data stores. */
	export interface GoogleCloudDialogflowCxV3FilterSpecsFormProperties {

		/** Optional. The filter expression to be applied. Expression syntax is documented at https://cloud.google.com/generative-ai-app-builder/docs/filter-search-metadata#filter-expression-syntax */
		filter: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3FilterSpecsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3FilterSpecsFormProperties>({
	...
	export interface GoogleCloudDialogflowCxV3SessionEntityType {
		...
		entityOverrideMode?: GoogleCloudDialogflowCxV3SessionEntityTypeEntityOverrideMode | null;
	...
	/** Session entity types are referred to as **User** entity types and are entities that are built for an individual user such as favorites, preferences, playlists, and so on. You can redefine a session entity type at the session level to extend or replace a custom entity type at the user session level (we refer to the entity types defined at the agent level as "custom entity types"). Note: session entity types apply to all queries, regardless of the language. For more information about entity types, see the [Dialogflow documentation](https://cloud.google.com/dialogflow/docs/entities-overview). */
	export interface GoogleCloudDialogflowCxV3SessionEntityTypeFormProperties {

		/** Required. Indicates whether the additional data should override or supplement the custom entity type definition. */
		entityOverrideMode: FormControl<GoogleCloudDialogflowCxV3SessionEntityTypeEntityOverrideMode | null | undefined>,

		/** Required. The unique identifier of the session entity type. Format: `projects//locations//agents//sessions//entityTypes/` or `projects//locations//agents//environments//sessions//entityTypes/`. If `Environment ID` is not specified, we assume default 'draft' environment. */
		name: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3SessionEntityTypeFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SessionEntityTypeFormProperties>({
			entityOverrideMode: new FormControl<GoogleCloudDialogflowCxV3SessionEntityTypeEntityOverrideMode | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** An **entity entry** for an associated entity type. */
	export interface GoogleCloudDialogflowCxV3EntityTypeEntityFormProperties {

		/** Required. The primary value associated with this entity entry. For example, if the entity type is *vegetable*, the value could be *scallions*. For `KIND_MAP` entity types: * A canonical value to be used in place of synonyms. For `KIND_LIST` entity types: * A string that can contain references to other entity types (with or without aliases). */
		value: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3EntityTypeEntityFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3EntityTypeEntityFormProperties>({
			value: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3SessionEntityTypeEntityOverrideMode { ENTITY_OVERRIDE_MODE_UNSPECIFIED = 'ENTITY_OVERRIDE_MODE_UNSPECIFIED', ENTITY_OVERRIDE_MODE_OVERRIDE = 'ENTITY_OVERRIDE_MODE_OVERRIDE', ENTITY_OVERRIDE_MODE_SUPPLEMENT = 'ENTITY_OVERRIDE_MODE_SUPPLEMENT' }
	...
	export interface GoogleCloudDialogflowCxV3DetectIntentResponse {
		...
		/** Response type. */
		responseType?: GoogleCloudDialogflowCxV3DetectIntentResponseResponseType | null;
	}

	/** The message returned from the DetectIntent method. */
	export interface GoogleCloudDialogflowCxV3DetectIntentResponseFormProperties {
		...
		/** Response type. */
		responseType: FormControl<GoogleCloudDialogflowCxV3DetectIntentResponseResponseType | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3DetectIntentResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3DetectIntentResponseFormProperties>({
			...
			responseType: new FormControl<GoogleCloudDialogflowCxV3DetectIntentResponseResponseType | null | undefined>(undefined),
		});
	...
	/** Represents the result of a conversational query. */
	export interface GoogleCloudDialogflowCxV3QueryResultFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3QueryResultFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3QueryResultFormProperties>({
	...
	export interface GoogleCloudDialogflowCxV3Match {
		...
		/** Type of this Match. */
		matchType?: GoogleCloudDialogflowCxV3MatchMatchType | null;
	...
	/** Represents one match result of MatchIntent. */
	export interface GoogleCloudDialogflowCxV3MatchFormProperties {
		...
		/** Type of this Match. */
		matchType: FormControl<GoogleCloudDialogflowCxV3MatchMatchType | null | undefined>,
	...
	export function CreateGoogleCloudDialogflowCxV3MatchFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3MatchFormProperties>({
			confidence: new FormControl<number | null | undefined>(undefined),
			event: new FormControl<string | null | undefined>(undefined),
			matchType: new FormControl<GoogleCloudDialogflowCxV3MatchMatchType | null | undefined>(undefined),
			parameters: new FormControl<{[id: string]: any } | null | undefined>(undefined),
	...
	export enum GoogleCloudDialogflowCxV3MatchMatchType { MATCH_TYPE_UNSPECIFIED = 'MATCH_TYPE_UNSPECIFIED', INTENT = 'INTENT', DIRECT_INTENT = 'DIRECT_INTENT', PARAMETER_FILLING = 'PARAMETER_FILLING', NO_MATCH = 'NO_MATCH', NO_INPUT = 'NO_INPUT', EVENT = 'EVENT' }
	...
	/** The result of sentiment analysis. Sentiment analysis inspects user input and identifies the prevailing subjective opinion, especially to determine a user's attitude as positive, negative, or neutral. */
	export interface GoogleCloudDialogflowCxV3SentimentAnalysisResultFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3SentimentAnalysisResultFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SentimentAnalysisResultFormProperties>({
	...
	export enum GoogleCloudDialogflowCxV3DetectIntentResponseResponseType { RESPONSE_TYPE_UNSPECIFIED = 'RESPONSE_TYPE_UNSPECIFIED', PARTIAL = 'PARTIAL', FINAL = 'FINAL' }
	...
	export interface GoogleCloudDialogflowCxV3EntityType {
		...
		autoExpansionMode?: GoogleCloudDialogflowCxV3EntityTypeAutoExpansionMode | null;
		...
		kind?: GoogleCloudDialogflowCxV3EntityTypeKind | null;
	...
	/** Entities are extracted from user input and represent parameters that are meaningful to your application. For example, a date range, a proper name such as a geographic location or landmark, and so on. Entities represent actionable data for your application. When you define an entity, you can also include synonyms that all map to that entity. For example, "soft drink", "soda", "pop", and so on. There are three types of entities: * **System** - entities that are defined by the Dialogflow API for common data types such as date, time, currency, and so on. A system entity is represented by the `EntityType` type. * **Custom** - entities that are defined by you that represent actionable data that is meaningful to your application. For example, you could define a `pizza.sauce` entity for red or white pizza sauce, a `pizza.cheese` entity for the different types of cheese on a pizza, a `pizza.topping` entity for different toppings, and so on. A custom entity is represented by the `EntityType` type. * **User** - entities that are built for an individual user such as favorites, preferences, playlists, and so on. A user entity is represented by the SessionEntityType type. For more information about entity types, see the [Dialogflow documentation](https://cloud.google.com/dialogflow/docs/entities-overview). */
	export interface GoogleCloudDialogflowCxV3EntityTypeFormProperties {

		/** Indicates whether the entity type can be automatically expanded. */
		autoExpansionMode: FormControl<GoogleCloudDialogflowCxV3EntityTypeAutoExpansionMode | null | undefined>,
		...
		/** Required. Indicates the kind of entity type. */
		kind: FormControl<GoogleCloudDialogflowCxV3EntityTypeKind | null | undefined>,
	...
	export function CreateGoogleCloudDialogflowCxV3EntityTypeFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3EntityTypeFormProperties>({
			autoExpansionMode: new FormControl<GoogleCloudDialogflowCxV3EntityTypeAutoExpansionMode | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			enableFuzzyExtraction: new FormControl<boolean | null | undefined>(undefined),
			kind: new FormControl<GoogleCloudDialogflowCxV3EntityTypeKind | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			redact: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	export enum GoogleCloudDialogflowCxV3EntityTypeAutoExpansionMode { AUTO_EXPANSION_MODE_UNSPECIFIED = 'AUTO_EXPANSION_MODE_UNSPECIFIED', AUTO_EXPANSION_MODE_DEFAULT = 'AUTO_EXPANSION_MODE_DEFAULT' }
	...
	/** An excluded entity phrase that should not be matched. */
	export interface GoogleCloudDialogflowCxV3EntityTypeExcludedPhraseFormProperties {

		/** Required. The word or phrase to be excluded. */
		value: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3EntityTypeExcludedPhraseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3EntityTypeExcludedPhraseFormProperties>({
			value: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3EntityTypeKind { KIND_UNSPECIFIED = 'KIND_UNSPECIFIED', KIND_MAP = 'KIND_MAP', KIND_LIST = 'KIND_LIST', KIND_REGEXP = 'KIND_REGEXP' }
	...
	export interface GoogleCloudDialogflowCxV3Experiment {
		...
		state?: GoogleCloudDialogflowCxV3ExperimentState | null;
	...
	/** Represents an experiment in an environment. */
	export interface GoogleCloudDialogflowCxV3ExperimentFormProperties {
		...
		/** The current state of the experiment. Transition triggered by Experiments.StartExperiment: DRAFT->RUNNING. Transition triggered by Experiments.CancelExperiment: DRAFT->DONE or RUNNING->DONE. */
		state: FormControl<GoogleCloudDialogflowCxV3ExperimentState | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ExperimentFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExperimentFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			endTime: new FormControl<string | null | undefined>(undefined),
			...
			startTime: new FormControl<string | null | undefined>(undefined),
			state: new FormControl<GoogleCloudDialogflowCxV3ExperimentState | null | undefined>(undefined),
		});
	...
	/** Definition of the experiment. */
	export interface GoogleCloudDialogflowCxV3ExperimentDefinitionFormProperties {

		/** The condition defines which subset of sessions are selected for this experiment. If not specified, all sessions are eligible. E.g. "query_input.language_code=en" See the [conditions reference](https://cloud.google.com/dialogflow/cx/docs/reference/condition). */
		condition: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ExperimentDefinitionFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExperimentDefinitionFormProperties>({
			condition: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** A list of flow version variants. */
	export interface GoogleCloudDialogflowCxV3VersionVariantsFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3VersionVariantsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3VersionVariantsFormProperties>({
		});
	...
	/** A single flow version with specified traffic allocation. */
	export interface GoogleCloudDialogflowCxV3VersionVariantsVariantFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3VersionVariantsVariantFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3VersionVariantsVariantFormProperties>({
	...
	/** The inference result which includes an objective metric to optimize and the confidence interval. */
	export interface GoogleCloudDialogflowCxV3ExperimentResultFormProperties {

		/** The last time the experiment's stats data was updated. Will have default value if stats have never been computed for this experiment. */
		lastUpdateTime: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ExperimentResultFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExperimentResultFormProperties>({
			lastUpdateTime: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Version variant and associated metrics. */
	export interface GoogleCloudDialogflowCxV3ExperimentResultVersionMetricsFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3ExperimentResultVersionMetricsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExperimentResultVersionMetricsFormProperties>({
	...
	export interface GoogleCloudDialogflowCxV3ExperimentResultMetric {
		...
		countType?: GoogleCloudDialogflowCxV3ExperimentResultMetricCountType | null;
		...
		type?: GoogleCloudDialogflowCxV3ExperimentResultMetricType | null;
	}

	/** Metric and corresponding confidence intervals. */
	export interface GoogleCloudDialogflowCxV3ExperimentResultMetricFormProperties {
		...
		/** Count-based metric type. Only one of type or count_type is specified in each Metric. */
		countType: FormControl<GoogleCloudDialogflowCxV3ExperimentResultMetricCountType | null | undefined>,
		...
		/** Ratio-based metric type. Only one of type or count_type is specified in each Metric. */
		type: FormControl<GoogleCloudDialogflowCxV3ExperimentResultMetricType | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ExperimentResultMetricFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExperimentResultMetricFormProperties>({
			count: new FormControl<number | null | undefined>(undefined),
			countType: new FormControl<GoogleCloudDialogflowCxV3ExperimentResultMetricCountType | null | undefined>(undefined),
			ratio: new FormControl<number | null | undefined>(undefined),
			type: new FormControl<GoogleCloudDialogflowCxV3ExperimentResultMetricType | null | undefined>(undefined),
		});
	...
	/** A confidence interval is a range of possible values for the experiment objective you are trying to measure. */
	export interface GoogleCloudDialogflowCxV3ExperimentResultConfidenceIntervalFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3ExperimentResultConfidenceIntervalFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExperimentResultConfidenceIntervalFormProperties>({
	...
	export enum GoogleCloudDialogflowCxV3ExperimentResultMetricCountType { COUNT_TYPE_UNSPECIFIED = 'COUNT_TYPE_UNSPECIFIED', TOTAL_NO_MATCH_COUNT = 'TOTAL_NO_MATCH_COUNT', TOTAL_TURN_COUNT = 'TOTAL_TURN_COUNT', AVERAGE_TURN_COUNT = 'AVERAGE_TURN_COUNT' }

	export enum GoogleCloudDialogflowCxV3ExperimentResultMetricType { METRIC_UNSPECIFIED = 'METRIC_UNSPECIFIED', CONTAINED_SESSION_NO_CALLBACK_RATE = 'CONTAINED_SESSION_NO_CALLBACK_RATE', LIVE_AGENT_HANDOFF_RATE = 'LIVE_AGENT_HANDOFF_RATE', CALLBACK_SESSION_RATE = 'CALLBACK_SESSION_RATE', ABANDONED_SESSION_RATE = 'ABANDONED_SESSION_RATE', SESSION_END_RATE = 'SESSION_END_RATE' }
	...
	/** The configuration for auto rollout. */
	export interface GoogleCloudDialogflowCxV3RolloutConfigFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3RolloutConfigFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3RolloutConfigFormProperties>({
	...
	/** A single rollout step with specified traffic allocation. */
	export interface GoogleCloudDialogflowCxV3RolloutConfigRolloutStepFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3RolloutConfigRolloutStepFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3RolloutConfigRolloutStepFormProperties>({
			displayName: new FormControl<string | null | undefined>(undefined),
	...
	/** State of the auto-rollout process. */
	export interface GoogleCloudDialogflowCxV3RolloutStateFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3RolloutStateFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3RolloutStateFormProperties>({
			startTime: new FormControl<string | null | undefined>(undefined),
	...
	export enum GoogleCloudDialogflowCxV3ExperimentState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', DRAFT = 'DRAFT', RUNNING = 'RUNNING', DONE = 'DONE', ROLLOUT_FAILED = 'ROLLOUT_FAILED' }
	...
	/** The history of variants update. */
	export interface GoogleCloudDialogflowCxV3VariantsHistoryFormProperties {

		/** Update time of the variants. */
		updateTime: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3VariantsHistoryFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3VariantsHistoryFormProperties>({
			updateTime: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDialogflowCxV3ExportAgentRequest {
		...
		dataFormat?: GoogleCloudDialogflowCxV3ExportAgentRequestDataFormat | null;
	...
	/** The request message for Agents.ExportAgent. */
	export interface GoogleCloudDialogflowCxV3ExportAgentRequestFormProperties {

		/** Optional. The [Google Cloud Storage](https://cloud.google.com/storage/docs/) URI to export the agent to. The format of this URI must be `gs:///`. If left unspecified, the serialized agent is returned inline. Dialogflow performs a write operation for the Cloud Storage object on the caller's behalf, so your request authentication must have write permissions for the object. For more information, see [Dialogflow access control](https://cloud.google.com/dialogflow/cx/docs/concept/access-control#storage). */
		agentUri: FormControl<string | null | undefined>,

		/** Optional. The data format of the exported agent. If not specified, `BLOB` is assumed. */
		dataFormat: FormControl<GoogleCloudDialogflowCxV3ExportAgentRequestDataFormat | null | undefined>,
	...
	export function CreateGoogleCloudDialogflowCxV3ExportAgentRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExportAgentRequestFormProperties>({
			agentUri: new FormControl<string | null | undefined>(undefined),
			dataFormat: new FormControl<GoogleCloudDialogflowCxV3ExportAgentRequestDataFormat | null | undefined>(undefined),
			environment: new FormControl<string | null | undefined>(undefined),
	...
	export enum GoogleCloudDialogflowCxV3ExportAgentRequestDataFormat { DATA_FORMAT_UNSPECIFIED = 'DATA_FORMAT_UNSPECIFIED', BLOB = 'BLOB', JSON_PACKAGE = 'JSON_PACKAGE' }
	...
	/** Settings for exporting to a git branch. */
	export interface GoogleCloudDialogflowCxV3ExportAgentRequestGitDestinationFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3ExportAgentRequestGitDestinationFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExportAgentRequestGitDestinationFormProperties>({
	...
	/** The request message for Flows.ExportFlow. */
	export interface GoogleCloudDialogflowCxV3ExportFlowRequestFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3ExportFlowRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExportFlowRequestFormProperties>({
	...
	export interface GoogleCloudDialogflowCxV3ExportIntentsRequest {
		...
		dataFormat?: GoogleCloudDialogflowCxV3ExportIntentsRequestDataFormat | null;
	...
	/** The request message for Intents.ExportIntents. */
	export interface GoogleCloudDialogflowCxV3ExportIntentsRequestFormProperties {

		/** Optional. The data format of the exported intents. If not specified, `BLOB` is assumed. */
		dataFormat: FormControl<GoogleCloudDialogflowCxV3ExportIntentsRequestDataFormat | null | undefined>,
	...
	export function CreateGoogleCloudDialogflowCxV3ExportIntentsRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExportIntentsRequestFormProperties>({
			dataFormat: new FormControl<GoogleCloudDialogflowCxV3ExportIntentsRequestDataFormat | null | undefined>(undefined),
	...
	export enum GoogleCloudDialogflowCxV3ExportIntentsRequestDataFormat { DATA_FORMAT_UNSPECIFIED = 'DATA_FORMAT_UNSPECIFIED', BLOB = 'BLOB', JSON = 'JSON', CSV = 'CSV' }
	...
	export interface GoogleCloudDialogflowCxV3ExportTestCasesRequest {
		...
		dataFormat?: GoogleCloudDialogflowCxV3ExportTestCasesRequestDataFormat | null;
	...
	/** The request message for TestCases.ExportTestCases. */
	export interface GoogleCloudDialogflowCxV3ExportTestCasesRequestFormProperties {

		/** The data format of the exported test cases. If not specified, `BLOB` is assumed. */
		dataFormat: FormControl<GoogleCloudDialogflowCxV3ExportTestCasesRequestDataFormat | null | undefined>,
	...
	export function CreateGoogleCloudDialogflowCxV3ExportTestCasesRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ExportTestCasesRequestFormProperties>({
			dataFormat: new FormControl<GoogleCloudDialogflowCxV3ExportTestCasesRequestDataFormat | null | undefined>(undefined),
			filter: new FormControl<string | null | undefined>(undefined),
	...
	export enum GoogleCloudDialogflowCxV3ExportTestCasesRequestDataFormat { DATA_FORMAT_UNSPECIFIED = 'DATA_FORMAT_UNSPECIFIED', BLOB = 'BLOB', JSON = 'JSON' }
	...
	export interface GoogleCloudDialogflowCxV3FlowImportStrategy {
		...
		globalImportStrategy?: GoogleCloudDialogflowCxV3FlowImportStrategyGlobalImportStrategy | null;
	}

	/** The flow import strategy used for resource conflict resolution associated with an ImportFlowRequest. */
	export interface GoogleCloudDialogflowCxV3FlowImportStrategyFormProperties {

		/** Optional. Import strategy for resource conflict resolution, applied globally throughout the flow. It will be applied for all display name conflicts in the imported content. If not specified, 'CREATE_NEW' is assumed. */
		globalImportStrategy: FormControl<GoogleCloudDialogflowCxV3FlowImportStrategyGlobalImportStrategy | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3FlowImportStrategyFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3FlowImportStrategyFormProperties>({
			globalImportStrategy: new FormControl<GoogleCloudDialogflowCxV3FlowImportStrategyGlobalImportStrategy | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3FlowImportStrategyGlobalImportStrategy { IMPORT_STRATEGY_UNSPECIFIED = 'IMPORT_STRATEGY_UNSPECIFIED', IMPORT_STRATEGY_CREATE_NEW = 'IMPORT_STRATEGY_CREATE_NEW', IMPORT_STRATEGY_REPLACE = 'IMPORT_STRATEGY_REPLACE', IMPORT_STRATEGY_KEEP = 'IMPORT_STRATEGY_KEEP', IMPORT_STRATEGY_MERGE = 'IMPORT_STRATEGY_MERGE', IMPORT_STRATEGY_THROW_ERROR = 'IMPORT_STRATEGY_THROW_ERROR' }
	...
	/** Request of FulfillIntent */
	export interface GoogleCloudDialogflowCxV3FulfillIntentRequestFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3FulfillIntentRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3FulfillIntentRequestFormProperties>({
		});
	...
	/** Request of MatchIntent. */
	export interface GoogleCloudDialogflowCxV3MatchIntentRequestFormProperties {

		/** Persist session parameter changes from `query_params`. */
		persistParameterChanges: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3MatchIntentRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3MatchIntentRequestFormProperties>({
	...
	/** Response of FulfillIntent */
	export interface GoogleCloudDialogflowCxV3FulfillIntentResponseFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3FulfillIntentResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3FulfillIntentResponseFormProperties>({
			outputAudio: new FormControl<string | null | undefined>(undefined),
			responseId: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Settings for Generative AI. */
	export interface GoogleCloudDialogflowCxV3GenerativeSettingsFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3GenerativeSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3GenerativeSettingsFormProperties>({
			languageCode: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Settings for Generative Fallback. */
	export interface GoogleCloudDialogflowCxV3GenerativeSettingsFallbackSettingsFormProperties {

		/** Display name of the selected prompt. */
		selectedPrompt: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3GenerativeSettingsFallbackSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3GenerativeSettingsFallbackSettingsFormProperties>({
	...
	/** Prompt template. */
	export interface GoogleCloudDialogflowCxV3GenerativeSettingsFallbackSettingsPromptTemplateFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3GenerativeSettingsFallbackSettingsPromptTemplateFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3GenerativeSettingsFallbackSettingsPromptTemplateFormProperties>({
			displayName: new FormControl<string | null | undefined>(undefined),
	...
	/** Settings for Generative Safety. */
	export interface GoogleCloudDialogflowCxV3SafetySettingsFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3SafetySettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SafetySettingsFormProperties>({
		});
	...
	/** Text input which can be used for prompt or banned phrases. */
	export interface GoogleCloudDialogflowCxV3SafetySettingsPhraseFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3SafetySettingsPhraseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SafetySettingsPhraseFormProperties>({
			languageCode: new FormControl<string | null | undefined>(undefined),
			text: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Settings for knowledge connector. These parameters are used for LLM prompt like "You are . You are a helpful and verbose at , . Your task is to help humans on ". */
	export interface GoogleCloudDialogflowCxV3GenerativeSettingsKnowledgeConnectorSettingsFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3GenerativeSettingsKnowledgeConnectorSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3GenerativeSettingsKnowledgeConnectorSettingsFormProperties>({
			agent: new FormControl<string | null | undefined>(undefined),
	...
	/** Generators contain prompt to be sent to the LLM model to generate text. The prompt can contain parameters which will be resolved before calling the model. It can optionally contain banned phrases to ensure the model responses are safe. */
	export interface GoogleCloudDialogflowCxV3GeneratorFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3GeneratorFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3GeneratorFormProperties>({
			displayName: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Represents a custom placeholder in the prompt text. */
	export interface GoogleCloudDialogflowCxV3GeneratorPlaceholderFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3GeneratorPlaceholderFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3GeneratorPlaceholderFormProperties>({
			id: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Text input which can be used for prompt or banned phrases. */
	export interface GoogleCloudDialogflowCxV3PhraseFormProperties {

		/** Required. Text input which can be used for prompt or banned phrases. */
		text: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3PhraseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3PhraseFormProperties>({
			text: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDialogflowCxV3ImportFlowRequest {
		...
		importOption?: GoogleCloudDialogflowCxV3ImportFlowRequestImportOption | null;
	}

	/** The request message for Flows.ImportFlow. */
	export interface GoogleCloudDialogflowCxV3ImportFlowRequestFormProperties {
		...
		/** Flow import mode. If not specified, `KEEP` is assumed. */
		importOption: FormControl<GoogleCloudDialogflowCxV3ImportFlowRequestImportOption | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ImportFlowRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ImportFlowRequestFormProperties>({
			flowContent: new FormControl<string | null | undefined>(undefined),
			flowUri: new FormControl<string | null | undefined>(undefined),
			importOption: new FormControl<GoogleCloudDialogflowCxV3ImportFlowRequestImportOption | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3ImportFlowRequestImportOption { IMPORT_OPTION_UNSPECIFIED = 'IMPORT_OPTION_UNSPECIFIED', KEEP = 'KEEP', FALLBACK = 'FALLBACK' }
	...
	export interface GoogleCloudDialogflowCxV3ImportIntentsRequest {
		...
		mergeOption?: GoogleCloudDialogflowCxV3ImportIntentsRequestMergeOption | null;
	}

	/** The request message for Intents.ImportIntents. */
	export interface GoogleCloudDialogflowCxV3ImportIntentsRequestFormProperties {

		/** The [Google Cloud Storage](https://cloud.google.com/storage/docs/) URI to import intents from. The format of this URI must be `gs:///`. Dialogflow performs a read operation for the Cloud Storage object on the caller's behalf, so your request authentication must have read permissions for the object. For more information, see [Dialogflow access control](https://cloud.google.com/dialogflow/cx/docs/concept/access-control#storage). */
		intentsUri: FormControl<string | null | undefined>,

		/** Merge option for importing intents. If not specified, `REJECT` is assumed. */
		mergeOption: FormControl<GoogleCloudDialogflowCxV3ImportIntentsRequestMergeOption | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ImportIntentsRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ImportIntentsRequestFormProperties>({
			intentsUri: new FormControl<string | null | undefined>(undefined),
			mergeOption: new FormControl<GoogleCloudDialogflowCxV3ImportIntentsRequestMergeOption | null | undefined>(undefined),
		});
	...
	/** Inline source for a Dialogflow operation that reads or imports objects (e.g. intents) into Dialogflow. */
	export interface GoogleCloudDialogflowCxV3InlineSourceFormProperties {

		/** The uncompressed byte content for the objects. */
		content: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3InlineSourceFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3InlineSourceFormProperties>({
			content: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3ImportIntentsRequestMergeOption { MERGE_OPTION_UNSPECIFIED = 'MERGE_OPTION_UNSPECIFIED', REJECT = 'REJECT', REPLACE = 'REPLACE', MERGE = 'MERGE', RENAME = 'RENAME', REPORT_CONFLICT = 'REPORT_CONFLICT', KEEP = 'KEEP' }
	...
	/** The request message for TestCases.ImportTestCases. */
	export interface GoogleCloudDialogflowCxV3ImportTestCasesRequestFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3ImportTestCasesRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ImportTestCasesRequestFormProperties>({
			content: new FormControl<string | null | undefined>(undefined),
			gcsUri: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Agents.ListAgents. */
	export interface GoogleCloudDialogflowCxV3ListAgentsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListAgentsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListAgentsResponseFormProperties>({
	...
	/** The response message for Changelogs.ListChangelogs. */
	export interface GoogleCloudDialogflowCxV3ListChangelogsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListChangelogsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListChangelogsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Environments.ListTestCaseResults. */
	export interface GoogleCloudDialogflowCxV3ListContinuousTestResultsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListContinuousTestResultsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListContinuousTestResultsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Deployments.ListDeployments. */
	export interface GoogleCloudDialogflowCxV3ListDeploymentsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListDeploymentsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListDeploymentsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for EntityTypes.ListEntityTypes. */
	export interface GoogleCloudDialogflowCxV3ListEntityTypesResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListEntityTypesResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListEntityTypesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Environments.ListEnvironments. */
	export interface GoogleCloudDialogflowCxV3ListEnvironmentsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListEnvironmentsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListEnvironmentsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Experiments.ListExperiments. */
	export interface GoogleCloudDialogflowCxV3ListExperimentsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListExperimentsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListExperimentsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Flows.ListFlows. */
	export interface GoogleCloudDialogflowCxV3ListFlowsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListFlowsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListFlowsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Generators.ListGenerators. */
	export interface GoogleCloudDialogflowCxV3ListGeneratorsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListGeneratorsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListGeneratorsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Intents.ListIntents. */
	export interface GoogleCloudDialogflowCxV3ListIntentsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListIntentsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListIntentsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Pages.ListPages. */
	export interface GoogleCloudDialogflowCxV3ListPagesResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListPagesResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListPagesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for SecuritySettings.ListSecuritySettings. */
	export interface GoogleCloudDialogflowCxV3ListSecuritySettingsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListSecuritySettingsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListSecuritySettingsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudDialogflowCxV3SecuritySettings {
		...
		redactionScope?: GoogleCloudDialogflowCxV3SecuritySettingsRedactionScope | null;

		/** Strategy that defines how we do redaction. */
		redactionStrategy?: GoogleCloudDialogflowCxV3SecuritySettingsRedactionStrategy | null;

		/** Specifies the retention behavior defined by SecuritySettings.RetentionStrategy. */
		retentionStrategy?: GoogleCloudDialogflowCxV3SecuritySettingsRetentionStrategy | null;
	...
	/** Represents the settings related to security issues, such as data redaction and data retention. It may take hours for updates on the settings to propagate to all the related components and take effect. */
	export interface GoogleCloudDialogflowCxV3SecuritySettingsFormProperties {
		...
		/** Defines the data for which Dialogflow applies redaction. Dialogflow does not redact data that it does not have access to – for example, Cloud logging. */
		redactionScope: FormControl<GoogleCloudDialogflowCxV3SecuritySettingsRedactionScope | null | undefined>,

		/** Strategy that defines how we do redaction. */
		redactionStrategy: FormControl<GoogleCloudDialogflowCxV3SecuritySettingsRedactionStrategy | null | undefined>,

		/** Specifies the retention behavior defined by SecuritySettings.RetentionStrategy. */
		retentionStrategy: FormControl<GoogleCloudDialogflowCxV3SecuritySettingsRetentionStrategy | null | undefined>,
	...
	export function CreateGoogleCloudDialogflowCxV3SecuritySettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SecuritySettingsFormProperties>({
			...
			name: new FormControl<string | null | undefined>(undefined),
			redactionScope: new FormControl<GoogleCloudDialogflowCxV3SecuritySettingsRedactionScope | null | undefined>(undefined),
			redactionStrategy: new FormControl<GoogleCloudDialogflowCxV3SecuritySettingsRedactionStrategy | null | undefined>(undefined),
			retentionStrategy: new FormControl<GoogleCloudDialogflowCxV3SecuritySettingsRetentionStrategy | null | undefined>(undefined),
	...
	export interface GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettings {
		...
		audioFormat?: GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsAudioFormat | null;
	...
	/** Settings for exporting audio. */
	export interface GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsFormProperties {

		/** Filename pattern for exported audio. */
		audioExportPattern: FormControl<string | null | undefined>,

		/** File format for exported audio file. Currently only in telephony recordings. */
		audioFormat: FormControl<GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsAudioFormat | null | undefined>,
	...
	export function CreateGoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsFormProperties>({
			audioExportPattern: new FormControl<string | null | undefined>(undefined),
			audioFormat: new FormControl<GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsAudioFormat | null | undefined>(undefined),
	...
	export enum GoogleCloudDialogflowCxV3SecuritySettingsAudioExportSettingsAudioFormat { AUDIO_FORMAT_UNSPECIFIED = 'AUDIO_FORMAT_UNSPECIFIED', MULAW = 'MULAW', MP3 = 'MP3', OGG = 'OGG' }
	...
	/** Settings for exporting conversations to [Insights](https://cloud.google.com/contact-center/insights/docs). */
	export interface GoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettingsFormProperties {

		/** If enabled, we will automatically exports conversations to Insights and Insights runs its analyzers. */
		enableInsightsExport: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettingsFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SecuritySettingsInsightsExportSettingsFormProperties>({
			enableInsightsExport: new FormControl<boolean | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3SecuritySettingsRedactionScope { REDACTION_SCOPE_UNSPECIFIED = 'REDACTION_SCOPE_UNSPECIFIED', REDACT_DISK_STORAGE = 'REDACT_DISK_STORAGE' }

	export enum GoogleCloudDialogflowCxV3SecuritySettingsRedactionStrategy { REDACTION_STRATEGY_UNSPECIFIED = 'REDACTION_STRATEGY_UNSPECIFIED', REDACT_WITH_SERVICE = 'REDACT_WITH_SERVICE' }

	export enum GoogleCloudDialogflowCxV3SecuritySettingsRetentionStrategy { RETENTION_STRATEGY_UNSPECIFIED = 'RETENTION_STRATEGY_UNSPECIFIED', REMOVE_AFTER_CONVERSATION = 'REMOVE_AFTER_CONVERSATION' }
	...
	/** The response message for SessionEntityTypes.ListSessionEntityTypes. */
	export interface GoogleCloudDialogflowCxV3ListSessionEntityTypesResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListSessionEntityTypesResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListSessionEntityTypesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for TestCases.ListTestCaseResults. */
	export interface GoogleCloudDialogflowCxV3ListTestCaseResultsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListTestCaseResultsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListTestCaseResultsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for TestCases.ListTestCases. */
	export interface GoogleCloudDialogflowCxV3ListTestCasesResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListTestCasesResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListTestCasesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for TransitionRouteGroups.ListTransitionRouteGroups. */
	export interface GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The response message for Versions.ListVersions. */
	export interface GoogleCloudDialogflowCxV3ListVersionsResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListVersionsResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListVersionsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Represents a version of a flow. */
	export interface GoogleCloudDialogflowCxV3VersionFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3VersionFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3VersionFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			displayName: new FormControl<string | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
	...
	/** The response message for Webhooks.ListWebhooks. */
	export interface GoogleCloudDialogflowCxV3ListWebhooksResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ListWebhooksResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ListWebhooksResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The request message for Versions.LoadVersion. */
	export interface GoogleCloudDialogflowCxV3LoadVersionRequestFormProperties {

		/** This field is used to prevent accidental overwrite of other agent resources, which can potentially impact other flow's behavior. If `allow_override_agent_resources` is false, conflicted agent-level resources will not be overridden (i.e. intents, entities, webhooks). */
		allowOverrideAgentResources: FormControl<boolean | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3LoadVersionRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3LoadVersionRequestFormProperties>({
	...
	/** The response message for Environments.LookupEnvironmentHistory. */
	export interface GoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponseFormProperties {

		/** Token to retrieve the next page of results, or empty if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response of MatchIntent. */
	export interface GoogleCloudDialogflowCxV3MatchIntentResponseFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3MatchIntentResponseFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3MatchIntentResponseFormProperties>({
			text: new FormControl<string | null | undefined>(undefined),
			transcript: new FormControl<string | null | undefined>(undefined),
			triggerEvent: new FormControl<string | null | undefined>(undefined),
			triggerIntent: new FormControl<string | null | undefined>(undefined),
	...
	export interface GoogleCloudDialogflowCxV3RestoreAgentRequest {
		...
		restoreOption?: GoogleCloudDialogflowCxV3RestoreAgentRequestRestoreOption | null;
	}

	/** The request message for Agents.RestoreAgent. */
	export interface GoogleCloudDialogflowCxV3RestoreAgentRequestFormProperties {
		...
		/** Agent restore mode. If not specified, `KEEP` is assumed. */
		restoreOption: FormControl<GoogleCloudDialogflowCxV3RestoreAgentRequestRestoreOption | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3RestoreAgentRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3RestoreAgentRequestFormProperties>({
			agentContent: new FormControl<string | null | undefined>(undefined),
			agentUri: new FormControl<string | null | undefined>(undefined),
			restoreOption: new FormControl<GoogleCloudDialogflowCxV3RestoreAgentRequestRestoreOption | null | undefined>(undefined),
		});
	...
	/** Settings for restoring from a git branch */
	export interface GoogleCloudDialogflowCxV3RestoreAgentRequestGitSourceFormProperties {

		/** tracking branch for the git pull */
		trackingBranch: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3RestoreAgentRequestGitSourceFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3RestoreAgentRequestGitSourceFormProperties>({
			trackingBranch: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudDialogflowCxV3RestoreAgentRequestRestoreOption { RESTORE_OPTION_UNSPECIFIED = 'RESTORE_OPTION_UNSPECIFIED', KEEP = 'KEEP', FALLBACK = 'FALLBACK' }
	...
	/** The request message for Environments.RunContinuousTest. */
	export interface GoogleCloudDialogflowCxV3RunContinuousTestRequestFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3RunContinuousTestRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3RunContinuousTestRequestFormProperties>({
		});
	...
	/** The request message for TestCases.RunTestCase. */
	export interface GoogleCloudDialogflowCxV3RunTestCaseRequestFormProperties {

		/** Optional. Environment name. If not set, draft environment is assumed. Format: `projects//locations//agents//environments/`. */
		environment: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3RunTestCaseRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3RunTestCaseRequestFormProperties>({
			environment: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The request message for Experiments.StartExperiment. */
	export interface GoogleCloudDialogflowCxV3StartExperimentRequestFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3StartExperimentRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3StartExperimentRequestFormProperties>({
		});
	...
	/** The request message for Experiments.StopExperiment. */
	export interface GoogleCloudDialogflowCxV3StopExperimentRequestFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3StopExperimentRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3StopExperimentRequestFormProperties>({
		});
	...
	/** The request to set the feedback for a bot answer. */
	export interface GoogleCloudDialogflowCxV3SubmitAnswerFeedbackRequestFormProperties {
	...
	export function CreateGoogleCloudDialogflowCxV3SubmitAnswerFeedbackRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3SubmitAnswerFeedbackRequestFormProperties>({
			responseId: new FormControl<string | null | undefined>(undefined),
	...
	/** The request message for Flows.TrainFlow. */
	export interface GoogleCloudDialogflowCxV3TrainFlowRequestFormProperties {
	}
	export function CreateGoogleCloudDialogflowCxV3TrainFlowRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3TrainFlowRequestFormProperties>({
		});
	...
	/** The request message for Agents.ValidateAgent. */
	export interface GoogleCloudDialogflowCxV3ValidateAgentRequestFormProperties {

		/** If not specified, the agent's default language is used. */
		languageCode: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ValidateAgentRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ValidateAgentRequestFormProperties>({
			languageCode: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The request message for Flows.ValidateFlow. */
	export interface GoogleCloudDialogflowCxV3ValidateFlowRequestFormProperties {

		/** If not specified, the agent's default language is used. */
		languageCode: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudDialogflowCxV3ValidateFlowRequestFormGroup() {
		return new FormGroup<GoogleCloudDialogflowCxV3ValidateFlowRequestFormProperties>({
			languageCode: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 * @return {GoogleCloudDialogflowCxV3CalculateCoverageResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_calculateCoverage(agent: string, type: Dialogflow_projects_locations_agents_testCases_calculateCoverageType | null | undefined): Observable<GoogleCloudDialogflowCxV3CalculateCoverageResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3CalculateCoverageResponse>(this.baseUri + 'v3/' + (agent == null ? '' : encodeURIComponent(agent)) + '/testCases:calculateCoverage&type=' + type, {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3CompareVersionsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_versions_compareVersions(baseVersion: string, requestBody: GoogleCloudDialogflowCxV3CompareVersionsRequest): Observable<GoogleCloudDialogflowCxV3CompareVersionsResponse> {
			return this.http.post<GoogleCloudDialogflowCxV3CompareVersionsResponse>(this.baseUri + 'v3/' + (baseVersion == null ? '' : encodeURIComponent(baseVersion)) + ':compareVersions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Dialogflow_projects_locations_agents_environments_deployFlow(environment: string, requestBody: GoogleCloudDialogflowCxV3DeployFlowRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (environment == null ? '' : encodeURIComponent(environment)) + ':deployFlow', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_runContinuousTest(environment: string, requestBody: GoogleCloudDialogflowCxV3RunContinuousTestRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (environment == null ? '' : encodeURIComponent(environment)) + ':runContinuousTest', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Dialogflow_projects_locations_securitySettings_delete(name: string, force: boolean | null | undefined): Observable<GoogleProtobufEmpty> {
			return this.http.delete<GoogleProtobufEmpty>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + '&force=' + force, {});
		}
		...
		Dialogflow_projects_operations_get(name: string, languageCode: string | null | undefined): Observable<GoogleLongrunningOperation> {
			return this.http.get<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + '&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3SecuritySettings} Successful response
		 */
		Dialogflow_projects_locations_securitySettings_patch(name: string, updateMask: string | null | undefined, requestBody: GoogleCloudDialogflowCxV3SecuritySettings): Observable<GoogleCloudDialogflowCxV3SecuritySettings> {
			return this.http.patch<GoogleCloudDialogflowCxV3SecuritySettings>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Dialogflow_projects_locations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudLocationListLocationsResponse> {
			return this.http.get<GoogleCloudLocationListLocationsResponse>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + '/locations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Dialogflow_projects_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleLongrunningListOperationsResponse> {
			return this.http.get<GoogleLongrunningListOperationsResponse>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + '/operations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Dialogflow_projects_operations_cancel(name: string): Observable<GoogleProtobufEmpty> {
			return this.http.post<GoogleProtobufEmpty>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':cancel', null, {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_export(name: string, requestBody: GoogleCloudDialogflowCxV3ExportFlowRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':export', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_versions_load(name: string, requestBody: GoogleCloudDialogflowCxV3LoadVersionRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':load', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_lookupEnvironmentHistory(name: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':lookupEnvironmentHistory&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_restore(name: string, requestBody: GoogleCloudDialogflowCxV3RestoreAgentRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':restore', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_run(name: string, requestBody: GoogleCloudDialogflowCxV3RunTestCaseRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':run', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Experiment} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_experiments_start(name: string, requestBody: GoogleCloudDialogflowCxV3StartExperimentRequest): Observable<GoogleCloudDialogflowCxV3Experiment> {
			return this.http.post<GoogleCloudDialogflowCxV3Experiment>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':start', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Experiment} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_experiments_stop(name: string, requestBody: GoogleCloudDialogflowCxV3StopExperimentRequest): Observable<GoogleCloudDialogflowCxV3Experiment> {
			return this.http.post<GoogleCloudDialogflowCxV3Experiment>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':stop', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_train(name: string, requestBody: GoogleCloudDialogflowCxV3TrainFlowRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':train', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3FlowValidationResult} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_validate(name: string, requestBody: GoogleCloudDialogflowCxV3ValidateFlowRequest): Observable<GoogleCloudDialogflowCxV3FlowValidationResult> {
			return this.http.post<GoogleCloudDialogflowCxV3FlowValidationResult>(this.baseUri + 'v3/' + (name == null ? '' : encodeURIComponent(name)) + ':validate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListAgentsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListAgentsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListAgentsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/agents&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Agent} Successful response
		 */
		Dialogflow_projects_locations_agents_create(parent: string, requestBody: GoogleCloudDialogflowCxV3Agent): Observable<GoogleCloudDialogflowCxV3Agent> {
			return this.http.post<GoogleCloudDialogflowCxV3Agent>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/agents', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListChangelogsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_changelogs_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListChangelogsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListChangelogsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/changelogs&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListContinuousTestResultsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_continuousTestResults_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListContinuousTestResultsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListContinuousTestResultsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/continuousTestResults&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListDeploymentsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_deployments_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListDeploymentsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListDeploymentsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/deployments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListSessionEntityTypesResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_sessions_entityTypes_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListSessionEntityTypesResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListSessionEntityTypesResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/entityTypes&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3SessionEntityType} Successful response
		 */
		Dialogflow_projects_locations_agents_sessions_entityTypes_create(parent: string, languageCode: string | null | undefined, requestBody: GoogleCloudDialogflowCxV3SessionEntityType): Observable<GoogleCloudDialogflowCxV3SessionEntityType> {
			return this.http.post<GoogleCloudDialogflowCxV3SessionEntityType>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/entityTypes&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListEnvironmentsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListEnvironmentsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListEnvironmentsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/environments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_create(parent: string, requestBody: GoogleCloudDialogflowCxV3Environment): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/environments', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListExperimentsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_experiments_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListExperimentsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListExperimentsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/experiments&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Experiment} Successful response
		 */
		Dialogflow_projects_locations_agents_environments_experiments_create(parent: string, requestBody: GoogleCloudDialogflowCxV3Experiment): Observable<GoogleCloudDialogflowCxV3Experiment> {
			return this.http.post<GoogleCloudDialogflowCxV3Experiment>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/experiments', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListFlowsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_list(parent: string, languageCode: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListFlowsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListFlowsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/flows&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Flow} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_create(parent: string, languageCode: string | null | undefined, requestBody: GoogleCloudDialogflowCxV3Flow): Observable<GoogleCloudDialogflowCxV3Flow> {
			return this.http.post<GoogleCloudDialogflowCxV3Flow>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/flows&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_import(parent: string, requestBody: GoogleCloudDialogflowCxV3ImportFlowRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/flows:import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListGeneratorsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_generators_list(parent: string, languageCode: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListGeneratorsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListGeneratorsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/generators&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Generator} Successful response
		 */
		Dialogflow_projects_locations_agents_generators_create(parent: string, languageCode: string | null | undefined, requestBody: GoogleCloudDialogflowCxV3Generator): Observable<GoogleCloudDialogflowCxV3Generator> {
			return this.http.post<GoogleCloudDialogflowCxV3Generator>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/generators&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListIntentsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_intents_list(parent: string, intentView: Dialogflow_projects_locations_agents_intents_listIntentView | null | undefined, languageCode: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListIntentsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListIntentsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/intents&intentView=' + intentView + '&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Intent} Successful response
		 */
		Dialogflow_projects_locations_agents_intents_create(parent: string, languageCode: string | null | undefined, requestBody: GoogleCloudDialogflowCxV3Intent): Observable<GoogleCloudDialogflowCxV3Intent> {
			return this.http.post<GoogleCloudDialogflowCxV3Intent>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/intents&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_intents_export(parent: string, requestBody: GoogleCloudDialogflowCxV3ExportIntentsRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/intents:export', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_intents_import(parent: string, requestBody: GoogleCloudDialogflowCxV3ImportIntentsRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/intents:import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListPagesResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_pages_list(parent: string, languageCode: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListPagesResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListPagesResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/pages&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Page} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_pages_create(parent: string, languageCode: string | null | undefined, requestBody: GoogleCloudDialogflowCxV3Page): Observable<GoogleCloudDialogflowCxV3Page> {
			return this.http.post<GoogleCloudDialogflowCxV3Page>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/pages&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListTestCaseResultsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_results_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListTestCaseResultsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListTestCaseResultsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/results&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListSecuritySettingsResponse} Successful response
		 */
		Dialogflow_projects_locations_securitySettings_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListSecuritySettingsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListSecuritySettingsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/securitySettings&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3SecuritySettings} Successful response
		 */
		Dialogflow_projects_locations_securitySettings_create(parent: string, requestBody: GoogleCloudDialogflowCxV3SecuritySettings): Observable<GoogleCloudDialogflowCxV3SecuritySettings> {
			return this.http.post<GoogleCloudDialogflowCxV3SecuritySettings>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/securitySettings', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3ListTestCasesResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Dialogflow_projects_locations_agents_testCases_listView | null | undefined): Observable<GoogleCloudDialogflowCxV3ListTestCasesResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListTestCasesResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/testCases&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3TestCase} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_create(parent: string, requestBody: GoogleCloudDialogflowCxV3TestCase): Observable<GoogleCloudDialogflowCxV3TestCase> {
			return this.http.post<GoogleCloudDialogflowCxV3TestCase>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/testCases', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleProtobufEmpty} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_batchDelete(parent: string, requestBody: GoogleCloudDialogflowCxV3BatchDeleteTestCasesRequest): Observable<GoogleProtobufEmpty> {
			return this.http.post<GoogleProtobufEmpty>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/testCases:batchDelete', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_batchRun(parent: string, requestBody: GoogleCloudDialogflowCxV3BatchRunTestCasesRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/testCases:batchRun', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_export(parent: string, requestBody: GoogleCloudDialogflowCxV3ExportTestCasesRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/testCases:export', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_testCases_import(parent: string, requestBody: GoogleCloudDialogflowCxV3ImportTestCasesRequest): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/testCases:import', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_transitionRouteGroups_list(parent: string, languageCode: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/transitionRouteGroups&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3TransitionRouteGroup} Successful response
		 */
		Dialogflow_projects_locations_agents_transitionRouteGroups_create(parent: string, languageCode: string | null | undefined, requestBody: GoogleCloudDialogflowCxV3TransitionRouteGroup): Observable<GoogleCloudDialogflowCxV3TransitionRouteGroup> {
			return this.http.post<GoogleCloudDialogflowCxV3TransitionRouteGroup>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/transitionRouteGroups&languageCode=' + (languageCode == null ? '' : encodeURIComponent(languageCode)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListVersionsResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_versions_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListVersionsResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListVersionsResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/versions&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleLongrunningOperation} Successful response
		 */
		Dialogflow_projects_locations_agents_flows_versions_create(parent: string, requestBody: GoogleCloudDialogflowCxV3Version): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/versions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken The next_page_token value returned from a previous list request.
		 * @return {GoogleCloudDialogflowCxV3ListWebhooksResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_webhooks_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudDialogflowCxV3ListWebhooksResponse> {
			return this.http.get<GoogleCloudDialogflowCxV3ListWebhooksResponse>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/webhooks&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3Webhook} Successful response
		 */
		Dialogflow_projects_locations_agents_webhooks_create(parent: string, requestBody: GoogleCloudDialogflowCxV3Webhook): Observable<GoogleCloudDialogflowCxV3Webhook> {
			return this.http.post<GoogleCloudDialogflowCxV3Webhook>(this.baseUri + 'v3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/webhooks', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3DetectIntentResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_sessions_detectIntent(session: string, requestBody: GoogleCloudDialogflowCxV3DetectIntentRequest): Observable<GoogleCloudDialogflowCxV3DetectIntentResponse> {
			return this.http.post<GoogleCloudDialogflowCxV3DetectIntentResponse>(this.baseUri + 'v3/' + (session == null ? '' : encodeURIComponent(session)) + ':detectIntent', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3FulfillIntentResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_sessions_fulfillIntent(session: string, requestBody: GoogleCloudDialogflowCxV3FulfillIntentRequest): Observable<GoogleCloudDialogflowCxV3FulfillIntentResponse> {
			return this.http.post<GoogleCloudDialogflowCxV3FulfillIntentResponse>(this.baseUri + 'v3/' + (session == null ? '' : encodeURIComponent(session)) + ':fulfillIntent', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} session Required. The name of the session this query is sent to. Format: `projects//locations//agents//sessions/` or `projects//locations//agents//environments//sessions/`. If `Environment ID` is not specified, we assume default 'draft' environment. It's up to the API caller to choose an appropriate `Session ID`. It can be a random number or some type of session identifiers (preferably hashed). The length of the `Session ID` must not exceed 36 characters. For more information, see the [sessions guide](https://cloud.google.com/dialogflow/cx/docs/concept/session).
		 * @return {GoogleCloudDialogflowCxV3MatchIntentResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_sessions_matchIntent(session: string, requestBody: GoogleCloudDialogflowCxV3MatchIntentRequest): Observable<GoogleCloudDialogflowCxV3MatchIntentResponse> {
			return this.http.post<GoogleCloudDialogflowCxV3MatchIntentResponse>(this.baseUri + 'v3/' + (session == null ? '' : encodeURIComponent(session)) + ':matchIntent', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3DetectIntentResponse} Successful response
		 */
		Dialogflow_projects_locations_agents_sessions_serverStreamingDetectIntent(session: string, requestBody: GoogleCloudDialogflowCxV3DetectIntentRequest): Observable<GoogleCloudDialogflowCxV3DetectIntentResponse> {
			return this.http.post<GoogleCloudDialogflowCxV3DetectIntentResponse>(this.baseUri + 'v3/' + (session == null ? '' : encodeURIComponent(session)) + ':serverStreamingDetectIntent', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudDialogflowCxV3AnswerFeedback} Successful response
		 */
		Dialogflow_projects_locations_agents_sessions_submitAnswerFeedback(session: string, requestBody: GoogleCloudDialogflowCxV3SubmitAnswerFeedbackRequest): Observable<GoogleCloudDialogflowCxV3AnswerFeedback> {
			return this.http.post<GoogleCloudDialogflowCxV3AnswerFeedback>(this.baseUri + 'v3/' + (session == null ? '' : encodeURIComponent(session)) + ':submitAnswerFeedback', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
