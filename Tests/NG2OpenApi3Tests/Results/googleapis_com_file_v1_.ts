...
export namespace MyNS {
	...
	export enum InstanceState { STATE_UNSPECIFIED = 0, CREATING = 1, READY = 2, REPAIRING = 3, DELETING = 4, ERROR = 5, RESTORING = 6, SUSPENDED = 7, SUSPENDING = 8, RESUMING = 9, REVERTING = 10 }
	...
	export enum SnapshotState { STATE_UNSPECIFIED = 0, CREATING = 1, READY = 2, DELETING = 3 }
