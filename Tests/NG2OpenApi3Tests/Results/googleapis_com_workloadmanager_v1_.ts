...
export namespace MyNS {
	...
	export enum ResourceStatusState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', CREATING = 'CREATING', ACTIVE = 'ACTIVE', DELETING = 'DELETING' }
	...
	export enum ExecutionRunType { TYPE_UNSPECIFIED = 'TYPE_UNSPECIFIED', ONE_TIME = 'ONE_TIME', SCHEDULED = 'SCHEDULED' }

	export enum ExecutionState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', RUNNING = 'RUNNING', SUCCEEDED = 'SUCCEEDED', FAILED = 'FAILED' }
	...
	export enum SapDiscoveryComponentApplicationPropertiesApplicationType { APPLICATION_TYPE_UNSPECIFIED = 'APPLICATION_TYPE_UNSPECIFIED', NETWEAVER = 'NETWEAVER' }
	...
	export enum SapDiscoveryComponentDatabasePropertiesDatabaseType { DATABASE_TYPE_UNSPECIFIED = 'DATABASE_TYPE_UNSPECIFIED', HANA = 'HANA', MAX_DB = 'MAX_DB', DB2 = 'DB2' }
	...
	export enum SapDiscoveryResourceResourceKind { RESOURCE_KIND_UNSPECIFIED = 'RESOURCE_KIND_UNSPECIFIED', RESOURCE_KIND_INSTANCE = 'RESOURCE_KIND_INSTANCE', RESOURCE_KIND_DISK = 'RESOURCE_KIND_DISK', RESOURCE_KIND_ADDRESS = 'RESOURCE_KIND_ADDRESS', RESOURCE_KIND_FILESTORE = 'RESOURCE_KIND_FILESTORE', RESOURCE_KIND_HEALTH_CHECK = 'RESOURCE_KIND_HEALTH_CHECK', RESOURCE_KIND_FORWARDING_RULE = 'RESOURCE_KIND_FORWARDING_RULE', RESOURCE_KIND_BACKEND_SERVICE = 'RESOURCE_KIND_BACKEND_SERVICE', RESOURCE_KIND_SUBNETWORK = 'RESOURCE_KIND_SUBNETWORK', RESOURCE_KIND_NETWORK = 'RESOURCE_KIND_NETWORK', RESOURCE_KIND_PUBLIC_ADDRESS = 'RESOURCE_KIND_PUBLIC_ADDRESS', RESOURCE_KIND_INSTANCE_GROUP = 'RESOURCE_KIND_INSTANCE_GROUP' }

	export enum SapDiscoveryResourceResourceType { RESOURCE_TYPE_UNSPECIFIED = 'RESOURCE_TYPE_UNSPECIFIED', RESOURCE_TYPE_COMPUTE = 'RESOURCE_TYPE_COMPUTE', RESOURCE_TYPE_STORAGE = 'RESOURCE_TYPE_STORAGE', RESOURCE_TYPE_NETWORK = 'RESOURCE_TYPE_NETWORK' }

	export enum SapDiscoveryComponentTopologyType { TOPOLOGY_TYPE_UNSPECIFIED = 'TOPOLOGY_TYPE_UNSPECIFIED', TOPOLOGY_SCALE_UP = 'TOPOLOGY_SCALE_UP', TOPOLOGY_SCALE_OUT = 'TOPOLOGY_SCALE_OUT' }
	...
	export enum SapValidationValidationDetailSapValidationType { SAP_VALIDATION_TYPE_UNSPECIFIED = 'SAP_VALIDATION_TYPE_UNSPECIFIED', SYSTEM = 'SYSTEM', COROSYNC = 'COROSYNC', PACEMAKER = 'PACEMAKER', HANA = 'HANA', NETWEAVER = 'NETWEAVER', HANA_SECURITY = 'HANA_SECURITY', CUSTOM = 'CUSTOM' }
	...
	export enum SqlserverValidationValidationDetailType { SQLSERVER_VALIDATION_TYPE_UNSPECIFIED = 'SQLSERVER_VALIDATION_TYPE_UNSPECIFIED', OS = 'OS', DB_LOG_DISK_SEPARATION = 'DB_LOG_DISK_SEPARATION', DB_MAX_PARALLELISM = 'DB_MAX_PARALLELISM', DB_CXPACKET_WAITS = 'DB_CXPACKET_WAITS', DB_TRANSACTION_LOG_HANDLING = 'DB_TRANSACTION_LOG_HANDLING', DB_VIRTUAL_LOG_FILE_COUNT = 'DB_VIRTUAL_LOG_FILE_COUNT', DB_BUFFER_POOL_EXTENSION = 'DB_BUFFER_POOL_EXTENSION', DB_MAX_SERVER_MEMORY = 'DB_MAX_SERVER_MEMORY', INSTANCE_METRICS = 'INSTANCE_METRICS', DB_INDEX_FRAGMENTATION = 'DB_INDEX_FRAGMENTATION', DB_TABLE_INDEX_COMPRESSION = 'DB_TABLE_INDEX_COMPRESSION', DB_BACKUP_POLICY = 'DB_BACKUP_POLICY' }
