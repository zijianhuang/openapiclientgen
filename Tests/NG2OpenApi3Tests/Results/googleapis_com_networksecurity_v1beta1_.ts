...
export namespace MyNS {
	...
	/** Specification of certificate provider. Defines the mechanism to obtain the certificate and private key for peer to peer authentication. */
	export interface GoogleCloudNetworksecurityV1beta1CertificateProviderFormProperties {
	}
	export function CreateGoogleCloudNetworksecurityV1beta1CertificateProviderFormGroup() {
		return new FormGroup<GoogleCloudNetworksecurityV1beta1CertificateProviderFormProperties>({
		});
	...
	/** Specification of the GRPC Endpoint. */
	export interface GoogleCloudNetworksecurityV1beta1GrpcEndpointFormProperties {

		/** Required. The target URI of the gRPC endpoint. Only UDS path is supported, and should start with "unix:". */
		targetUri: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudNetworksecurityV1beta1GrpcEndpointFormGroup() {
		return new FormGroup<GoogleCloudNetworksecurityV1beta1GrpcEndpointFormProperties>({
	...
	export interface FirewallEndpoint {
		...
		state?: FirewallEndpointState | null;
	...
	/** Message describing Endpoint object */
	export interface FirewallEndpointFormProperties {

		/** Optional. Project to bill on endpoint uptime usage. */
		billingProjectId: FormControl<string | null | undefined>,
		...
		/** Output only. Current state of the endpoint. */
		state: FormControl<FirewallEndpointState | null | undefined>,

		/** Output only. Update time stamp */
		updateTime: FormControl<string | null | undefined>,
	}
	export function CreateFirewallEndpointFormGroup() {
		return new FormGroup<FirewallEndpointFormProperties>({
			billingProjectId: new FormControl<string | null | undefined>(undefined),
			createTime: new FormControl<string | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			labels: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			reconciling: new FormControl<boolean | null | undefined>(undefined),
			state: new FormControl<FirewallEndpointState | null | undefined>(undefined),
			updateTime: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** This is a subset of the FirewallEndpointAssociation message, containing fields to be used by the consumer. */
	export interface FirewallEndpointAssociationReferenceFormProperties {
	...
	export function CreateFirewallEndpointAssociationReferenceFormGroup() {
		return new FormGroup<FirewallEndpointAssociationReferenceFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
	...
	/** Message describing Association object */
	export interface FirewallEndpointAssociationFormProperties {
	...
	export function CreateFirewallEndpointAssociationFormGroup() {
		return new FormGroup<FirewallEndpointAssociationFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
	...
	/** Message for response to listing Associations */
	export interface ListFirewallEndpointAssociationsResponseFormProperties {

		/** A token identifying a page of results the server should return. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListFirewallEndpointAssociationsResponseFormGroup() {
		return new FormGroup<ListFirewallEndpointAssociationsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Message for response to listing Endpoints */
	export interface ListFirewallEndpointsResponseFormProperties {

		/** A token identifying a page of results the server should return. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListFirewallEndpointsResponseFormGroup() {
		return new FormGroup<ListFirewallEndpointsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Response returned by the ListSecurityProfileGroups method. */
	export interface ListSecurityProfileGroupsResponseFormProperties {

		/** If there might be more results than those appearing in this response, then `next_page_token` is included. To get the next set of results, call this method again using the value of `next_page_token` as `page_token`. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListSecurityProfileGroupsResponseFormGroup() {
		return new FormGroup<ListSecurityProfileGroupsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** SecurityProfileGroup is a resource that defines the behavior for various ProfileTypes. Next ID: 8 */
	export interface SecurityProfileGroupFormProperties {
		...
		/** Optional. Reference to a SecurityProfile with the threat prevention configuration for the SecurityProfileGroup. */
		threatPreventionProfile: FormControl<string | null | undefined>,

		/** Output only. Last resource update timestamp. */
		updateTime: FormControl<string | null | undefined>,
	}
	export function CreateSecurityProfileGroupFormGroup() {
		return new FormGroup<SecurityProfileGroupFormProperties>({
			createTime: new FormControl<string | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			etag: new FormControl<string | null | undefined>(undefined),
			labels: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			threatPreventionProfile: new FormControl<string | null | undefined>(undefined),
			updateTime: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface SecurityProfileFormProperties {
		...
		/** Immutable. The single ProfileType that the SecurityProfile resource configures. */
		type: FormControl<SecurityProfileType | null | undefined>,
	...
	export function CreateSecurityProfileFormGroup() {
		return new FormGroup<SecurityProfileFormProperties>({
			...
			labels: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			type: new FormControl<SecurityProfileType | null | undefined>(undefined),
			updateTime: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** ThreatPreventionProfile defines an action for specific threat signatures or severity levels. */
	export interface ThreatPreventionProfileFormProperties {
	}
	export function CreateThreatPreventionProfileFormGroup() {
		return new FormGroup<ThreatPreventionProfileFormProperties>({
		});
	...
	export interface SeverityOverride {
		...
		action?: SeverityOverrideAction | null;

		/** Required. Severity level to match. */
		severity?: SeverityOverrideSeverity | null;
	}

	/** Defines what action to take for a specific severity match. */
	export interface SeverityOverrideFormProperties {

		/** Required. Threat action override. */
		action: FormControl<SeverityOverrideAction | null | undefined>,

		/** Required. Severity level to match. */
		severity: FormControl<SeverityOverrideSeverity | null | undefined>,
	}
	export function CreateSeverityOverrideFormGroup() {
		return new FormGroup<SeverityOverrideFormProperties>({
			action: new FormControl<SeverityOverrideAction | null | undefined>(undefined),
			severity: new FormControl<SeverityOverrideSeverity | null | undefined>(undefined),
		});
	...
	export interface ThreatOverride {
		...
		type?: ThreatOverrideType | null;
	}

	/** Defines what action to take for a specific threat_id match. */
	export interface ThreatOverrideFormProperties {

		/** Required. Threat action override. For some threat types, only a subset of actions applies. */
		action: FormControl<SeverityOverrideAction | null | undefined>,

		/** Required. Vendor-specific ID of a threat to override. */
		threatId: FormControl<string | null | undefined>,

		/** Output only. Type of the threat (read only). */
		type: FormControl<ThreatOverrideType | null | undefined>,
	}
	export function CreateThreatOverrideFormGroup() {
		return new FormGroup<ThreatOverrideFormProperties>({
			action: new FormControl<SeverityOverrideAction | null | undefined>(undefined),
			threatId: new FormControl<string | null | undefined>(undefined),
			type: new FormControl<ThreatOverrideType | null | undefined>(undefined),
		});
	...
	export class MyClient {
		...
		Networksecurity_projects_locations_addressGroups_addItems(addressGroup: string, requestBody: AddAddressGroupItemsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (addressGroup == null ? '' : encodeURIComponent(addressGroup)) + ':addItems', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_addressGroups_cloneItems(addressGroup: string, requestBody: CloneAddressGroupItemsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (addressGroup == null ? '' : encodeURIComponent(addressGroup)) + ':cloneItems', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_addressGroups_listReferences(addressGroup: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAddressGroupReferencesResponse> {
			return this.http.get<ListAddressGroupReferencesResponse>(this.baseUri + 'v1beta1/' + (addressGroup == null ? '' : encodeURIComponent(addressGroup)) + ':listReferences&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_addressGroups_removeItems(addressGroup: string, requestBody: RemoveAddressGroupItemsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (addressGroup == null ? '' : encodeURIComponent(addressGroup)) + ':removeItems', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_urlLists_get(name: string): Observable<UrlList> {
			return this.http.get<UrlList>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Networksecurity_projects_locations_addressGroups_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAddressGroupsResponse> {
			return this.http.get<ListAddressGroupsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/addressGroups&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_authorizationPolicies_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAuthorizationPoliciesResponse> {
			return this.http.get<ListAuthorizationPoliciesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/authorizationPolicies&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_authorizationPolicies_create(parent: string, authorizationPolicyId: string | null | undefined, requestBody: AuthorizationPolicy): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/authorizationPolicies&authorizationPolicyId=' + (authorizationPolicyId == null ? '' : encodeURIComponent(authorizationPolicyId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_clientTlsPolicies_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListClientTlsPoliciesResponse> {
			return this.http.get<ListClientTlsPoliciesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clientTlsPolicies&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_clientTlsPolicies_create(parent: string, clientTlsPolicyId: string | null | undefined, requestBody: ClientTlsPolicy): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clientTlsPolicies&clientTlsPolicyId=' + (clientTlsPolicyId == null ? '' : encodeURIComponent(clientTlsPolicyId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists Associations in a given project and location.
		 * Get v1beta1/{parent}/firewallEndpointAssociations
		 ...
		 * @return {ListFirewallEndpointAssociationsResponse} Successful response
		 */
		Networksecurity_projects_locations_firewallEndpointAssociations_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListFirewallEndpointAssociationsResponse> {
			return this.http.get<ListFirewallEndpointAssociationsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/firewallEndpointAssociations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new FirewallEndpointAssociation in a given project and location.
		 * Post v1beta1/{parent}/firewallEndpointAssociations
		 ...
		 * @return {Operation} Successful response
		 */
		Networksecurity_projects_locations_firewallEndpointAssociations_create(parent: string, firewallEndpointAssociationId: string | null | undefined, requestId: string | null | undefined, requestBody: FirewallEndpointAssociation): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/firewallEndpointAssociations&firewallEndpointAssociationId=' + (firewallEndpointAssociationId == null ? '' : encodeURIComponent(firewallEndpointAssociationId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists FirewallEndpoints in a given project and location.
		 * Get v1beta1/{parent}/firewallEndpoints
		 ...
		 *     Type: int, -2,147,483,648 to 2,147,483,647
		 * @param {string} pageToken A token identifying a page of results the server should return.
		 * @return {ListFirewallEndpointsResponse} Successful response
		 */
		Networksecurity_organizations_locations_firewallEndpoints_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListFirewallEndpointsResponse> {
			return this.http.get<ListFirewallEndpointsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/firewallEndpoints&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new FirewallEndpoint in a given project and location.
		 * Post v1beta1/{parent}/firewallEndpoints
		 * @param {string} parent Required. Value for parent.
		 ...
		 * @return {Operation} Successful response
		 */
		Networksecurity_organizations_locations_firewallEndpoints_create(parent: string, firewallEndpointId: string | null | undefined, requestId: string | null | undefined, requestBody: FirewallEndpoint): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/firewallEndpoints&firewallEndpointId=' + (firewallEndpointId == null ? '' : encodeURIComponent(firewallEndpointId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_gatewaySecurityPolicies_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListGatewaySecurityPoliciesResponse> {
			return this.http.get<ListGatewaySecurityPoliciesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/gatewaySecurityPolicies&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_gatewaySecurityPolicies_create(parent: string, gatewaySecurityPolicyId: string | null | undefined, requestBody: GatewaySecurityPolicy): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/gatewaySecurityPolicies&gatewaySecurityPolicyId=' + (gatewaySecurityPolicyId == null ? '' : encodeURIComponent(gatewaySecurityPolicyId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_gatewaySecurityPolicies_rules_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListGatewaySecurityPolicyRulesResponse> {
			return this.http.get<ListGatewaySecurityPolicyRulesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/rules&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_gatewaySecurityPolicies_rules_create(parent: string, gatewaySecurityPolicyRuleId: string | null | undefined, requestBody: GatewaySecurityPolicyRule): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/rules&gatewaySecurityPolicyRuleId=' + (gatewaySecurityPolicyRuleId == null ? '' : encodeURIComponent(gatewaySecurityPolicyRuleId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists SecurityProfileGroups in a given organization and location.
		 * Get v1beta1/{parent}/securityProfileGroups
		 * @param {string} parent Required. The project or organization and location from which the SecurityProfileGroups should be listed, specified in the format `projects|organizations/locations/{location}`.
		 ...
		 * @return {ListSecurityProfileGroupsResponse} Successful response
		 */
		Networksecurity_organizations_locations_securityProfileGroups_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSecurityProfileGroupsResponse> {
			return this.http.get<ListSecurityProfileGroupsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/securityProfileGroups&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new SecurityProfileGroup in a given organization and location.
		 * Post v1beta1/{parent}/securityProfileGroups
		 * @param {string} parent Required. The parent resource of the SecurityProfileGroup. Must be in the format `projects|organizations/locations/{location}`.
		 ...
		 * @return {Operation} Successful response
		 */
		Networksecurity_organizations_locations_securityProfileGroups_create(parent: string, securityProfileGroupId: string | null | undefined, requestBody: SecurityProfileGroup): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/securityProfileGroups&securityProfileGroupId=' + (securityProfileGroupId == null ? '' : encodeURIComponent(securityProfileGroupId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists SecurityProfiles in a given organization and location.
		 * Get v1beta1/{parent}/securityProfiles
		 * @param {string} parent Required. The project or organization and location from which the SecurityProfiles should be listed, specified in the format `projects|organizations/locations/{location}`.
		 ...
		 * @return {ListSecurityProfilesResponse} Successful response
		 */
		Networksecurity_organizations_locations_securityProfiles_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSecurityProfilesResponse> {
			return this.http.get<ListSecurityProfilesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/securityProfiles&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a new SecurityProfile in a given organization and location.
		 * Post v1beta1/{parent}/securityProfiles
		 * @param {string} parent Required. The parent resource of the SecurityProfile. Must be in the format `projects|organizations/locations/{location}`.
		 ...
		 * @return {Operation} Successful response
		 */
		Networksecurity_organizations_locations_securityProfiles_create(parent: string, securityProfileId: string | null | undefined, requestBody: SecurityProfile): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/securityProfiles&securityProfileId=' + (securityProfileId == null ? '' : encodeURIComponent(securityProfileId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_serverTlsPolicies_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListServerTlsPoliciesResponse> {
			return this.http.get<ListServerTlsPoliciesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/serverTlsPolicies&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_serverTlsPolicies_create(parent: string, serverTlsPolicyId: string | null | undefined, requestBody: ServerTlsPolicy): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/serverTlsPolicies&serverTlsPolicyId=' + (serverTlsPolicyId == null ? '' : encodeURIComponent(serverTlsPolicyId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_tlsInspectionPolicies_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListTlsInspectionPoliciesResponse> {
			return this.http.get<ListTlsInspectionPoliciesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/tlsInspectionPolicies&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_tlsInspectionPolicies_create(parent: string, tlsInspectionPolicyId: string | null | undefined, requestBody: TlsInspectionPolicy): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/tlsInspectionPolicies&tlsInspectionPolicyId=' + (tlsInspectionPolicyId == null ? '' : encodeURIComponent(tlsInspectionPolicyId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_urlLists_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListUrlListsResponse> {
			return this.http.get<ListUrlListsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/urlLists&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networksecurity_projects_locations_urlLists_create(parent: string, urlListId: string | null | undefined, requestBody: UrlList): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/urlLists&urlListId=' + (urlListId == null ? '' : encodeURIComponent(urlListId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networksecurity_projects_locations_serverTlsPolicies_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<GoogleIamV1Policy> {
			return this.http.get<GoogleIamV1Policy>(this.baseUri + 'v1beta1/' + (resource == null ? '' : encodeURIComponent(resource)) + ':getIamPolicy&options_requestedPolicyVersion=' + options_requestedPolicyVersion, {});
		}
		...
		Networksecurity_projects_locations_serverTlsPolicies_testIamPermissions(resource: string, requestBody: GoogleIamV1TestIamPermissionsRequest): Observable<GoogleIamV1TestIamPermissionsResponse> {
			return this.http.post<GoogleIamV1TestIamPermissionsResponse>(this.baseUri + 'v1beta1/' + (resource == null ? '' : encodeURIComponent(resource)) + ':testIamPermissions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
