...
export namespace MyNS {
	...
	export enum GoogleCloudRecaptchaenterpriseV1AccountVerificationInfoLatestVerificationResult { RESULT_UNSPECIFIED = 0, SUCCESS_USER_VERIFIED = 1, ERROR_USER_NOT_VERIFIED = 2, ERROR_SITE_ONBOARDING_INCOMPLETE = 3, ERROR_RECIPIENT_NOT_ALLOWED = 4, ERROR_RECIPIENT_ABUSE_LIMIT_EXHAUSTED = 5, ERROR_CRITICAL_INTERNAL = 6, ERROR_CUSTOMER_QUOTA_EXHAUSTED = 7, ERROR_VERIFICATION_BYPASSED = 8, ERROR_VERDICT_MISMATCH = 9 }
	...
	export enum GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequestAnnotation { ANNOTATION_UNSPECIFIED = 0, LEGITIMATE = 1, FRAUDULENT = 2, PASSWORD_CORRECT = 3, PASSWORD_INCORRECT = 4 }
	...
	export enum GoogleCloudRecaptchaenterpriseV1TokenPropertiesInvalidReason { INVALID_REASON_UNSPECIFIED = 0, UNKNOWN_INVALID_REASON = 1, MALFORMED = 2, EXPIRED = 3, DUPE = 4, MISSING = 5, BROWSER_ERROR = 6 }
	...
	export enum GoogleCloudRecaptchaenterpriseV1TestingOptionsTestingChallenge { TESTING_CHALLENGE_UNSPECIFIED = 0, NOCAPTCHA = 1, UNSOLVABLE_CHALLENGE = 2 }
	...
	export enum GoogleCloudRecaptchaenterpriseV1WafSettingsWafFeature { WAF_FEATURE_UNSPECIFIED = 0, CHALLENGE_PAGE = 1, SESSION_TOKEN = 2, ACTION_TOKEN = 3, EXPRESS = 4 }

	export enum GoogleCloudRecaptchaenterpriseV1WafSettingsWafService { WAF_SERVICE_UNSPECIFIED = 0, CA = 1, FASTLY = 2 }
	...
	export enum GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSecurityPreference { CHALLENGE_SECURITY_PREFERENCE_UNSPECIFIED = 0, USABILITY = 1, BALANCE = 2, SECURITY = 3 }

	export enum GoogleCloudRecaptchaenterpriseV1WebKeySettingsIntegrationType { INTEGRATION_TYPE_UNSPECIFIED = 0, SCORE = 1, CHECKBOX = 2, INVISIBLE = 3 }
