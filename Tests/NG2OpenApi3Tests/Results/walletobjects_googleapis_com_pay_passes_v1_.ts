...
export namespace MyNS {
	...
	export enum EventTicketClassMultipleDevicesAndHoldersAllowedStatus { STATUS_UNSPECIFIED = 0, MULTIPLE_HOLDERS = 1, multipleHolders = 2, ONE_USER_ALL_DEVICES = 3, oneUserAllDevices = 4, ONE_USER_ONE_DEVICE = 5, oneUserOneDevice = 6 }
