...
export namespace MyNS {
	...
	export enum EventTicketClassMultipleDevicesAndHoldersAllowedStatus { STATUS_UNSPECIFIED = 'STATUS_UNSPECIFIED', MULTIPLE_HOLDERS = 'MULTIPLE_HOLDERS', multipleHolders = 'multipleHolders', ONE_USER_ALL_DEVICES = 'ONE_USER_ALL_DEVICES', oneUserAllDevices = 'oneUserAllDevices', ONE_USER_ONE_DEVICE = 'ONE_USER_ONE_DEVICE', oneUserOneDevice = 'oneUserOneDevice' }
