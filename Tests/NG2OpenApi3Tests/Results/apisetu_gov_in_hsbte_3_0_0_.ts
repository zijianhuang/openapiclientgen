...
export namespace MyNS {
	...
	export interface DgmstPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<DgmstPostBodyFormat | null | undefined>,
	...
	export function CreateDgmstPostBodyFormGroup() {
		return new FormGroup<DgmstPostBodyFormProperties>({
			format: new FormControl<DgmstPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export enum DgmstPostBodyFormat { pdf = 'pdf' }
