...
export namespace MyNS {
	...
	export enum AndroidModelForm { DEVICE_FORM_UNSPECIFIED = 0, VIRTUAL = 1, PHYSICAL = 2, EMULATOR = 3 }
	...
	export enum PerAndroidVersionInfoDeviceCapacity { DEVICE_CAPACITY_UNSPECIFIED = 0, DEVICE_CAPACITY_HIGH = 1, DEVICE_CAPACITY_MEDIUM = 2, DEVICE_CAPACITY_LOW = 3, DEVICE_CAPACITY_NONE = 4 }
	...
	export enum AndroidRoboTestRoboMode { ROBO_MODE_UNSPECIFIED = 0, ROBO_VERSION_1 = 1, ROBO_VERSION_2 = 2 }
	...
	export enum DeviceSessionState { SESSION_STATE_UNSPECIFIED = 0, REQUESTED = 1, PENDING = 2, ACTIVE = 3, EXPIRED = 4, FINISHED = 5, UNAVAILABLE = 6, ERROR = 7 }
	...
	export enum Testing_testEnvironmentCatalog_getEnvironmentType { ENVIRONMENT_TYPE_UNSPECIFIED = 0, ANDROID = 1, IOS = 2, NETWORK_CONFIGURATION = 3, PROVIDED_SOFTWARE = 4, DEVICE_IP_BLOCKS = 5 }
