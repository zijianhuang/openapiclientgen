...
export namespace MyNS {
	...
	/** App Engine HTTP queue. The task will be delivered to the App Engine application hostname specified by its AppEngineHttpQueue and AppEngineHttpRequest. The documentation for AppEngineHttpRequest explains how the task's host URL is constructed. Using AppEngineHttpQueue requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform` */
	export interface AppEngineHttpQueueFormProperties {
	}
	export function CreateAppEngineHttpQueueFormGroup() {
		return new FormGroup<AppEngineHttpQueueFormProperties>({
		});
	...
	export interface QueueFormProperties {
		...
		/** Immutable. The type of a queue (push or pull). `Queue.type` is an immutable property of the queue that is set at the queue creation time. When left unspecified, the default value of `PUSH` is selected. */
		type: FormControl<QueueType | null | undefined>,
	}
	export function CreateQueueFormGroup() {
		return new FormGroup<QueueFormProperties>({
			...
			type: new FormControl<QueueType | null | undefined>(undefined),
		});
	...
	export enum QueueType { TYPE_UNSPECIFIED = 'TYPE_UNSPECIFIED', PULL = 'PULL', PUSH = 'PUSH' }
	...
	export class MyClient {
		...
		Cloudtasks_projects_locations_queues_tasks_delete(name: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Cloudtasks_projects_locations_queues_tasks_get(name: string, responseView: TaskView | null | undefined): Observable<Task> {
			return this.http.get<Task>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + '&responseView=' + responseView, {});
		}
		...
		Cloudtasks_projects_locations_queues_patch(name: string, updateMask: string | null | undefined, requestBody: Queue): Observable<Queue> {
			return this.http.patch<Queue>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationsResponse> {
			return this.http.get<ListLocationsResponse>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + '/locations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Cloudtasks_projects_locations_queues_pause(name: string, requestBody: PauseQueueRequest): Observable<Queue> {
			return this.http.post<Queue>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':pause', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_purge(name: string, requestBody: PurgeQueueRequest): Observable<Queue> {
			return this.http.post<Queue>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':purge', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_resume(name: string, requestBody: ResumeQueueRequest): Observable<Queue> {
			return this.http.post<Queue>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':resume', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_tasks_run(name: string, requestBody: RunTaskRequest): Observable<Task> {
			return this.http.post<Task>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':run', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_list(parent: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, readMask: string | null | undefined): Observable<ListQueuesResponse> {
			return this.http.get<ListQueuesResponse>(this.baseUri + 'v2beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/queues&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&readMask=' + (readMask == null ? '' : encodeURIComponent(readMask)), {});
		}
		...
		Cloudtasks_projects_locations_queues_create(parent: string, requestBody: Queue): Observable<Queue> {
			return this.http.post<Queue>(this.baseUri + 'v2beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/queues', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_tasks_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined, responseView: TaskView | null | undefined): Observable<ListTasksResponse> {
			return this.http.get<ListTasksResponse>(this.baseUri + 'v2beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/tasks&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&responseView=' + responseView, {});
		}
		...
		Cloudtasks_projects_locations_queues_tasks_create(parent: string, requestBody: CreateTaskRequest): Observable<Task> {
			return this.http.post<Task>(this.baseUri + 'v2beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/tasks', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_tasks_buffer(queue: string, taskId: string, requestBody: BufferTaskRequest): Observable<BufferTaskResponse> {
			return this.http.post<BufferTaskResponse>(this.baseUri + 'v2beta3/' + (queue == null ? '' : encodeURIComponent(queue)) + '/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + ':buffer', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_getIamPolicy(resource: string, requestBody: GetIamPolicyRequest): Observable<Policy> {
			return this.http.post<Policy>(this.baseUri + 'v2beta3/' + (resource == null ? '' : encodeURIComponent(resource)) + ':getIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
			return this.http.post<Policy>(this.baseUri + 'v2beta3/' + (resource == null ? '' : encodeURIComponent(resource)) + ':setIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_testIamPermissions(resource: string, requestBody: TestIamPermissionsRequest): Observable<TestIamPermissionsResponse> {
			return this.http.post<TestIamPermissionsResponse>(this.baseUri + 'v2beta3/' + (resource == null ? '' : encodeURIComponent(resource)) + ':testIamPermissions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
