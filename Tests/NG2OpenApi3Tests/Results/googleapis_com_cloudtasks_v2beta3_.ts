...
export namespace MyNS {
	...
	export enum QueueType { TYPE_UNSPECIFIED = 0, PULL = 1, PUSH = 2 }
	...
	export class MyClient {
		...
		Cloudtasks_projects_locations_queues_tasks_get(name: string, responseView: Task_View | null | undefined): Observable<Task_> {
			return this.http.get<Task_>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + '&responseView=' + responseView, {});
		}
		...
		Cloudtasks_projects_locations_queues_tasks_run(name: string, requestBody: RunTaskRequest): Observable<Task_> {
			return this.http.post<Task_>(this.baseUri + 'v2beta3/' + (name == null ? '' : encodeURIComponent(name)) + ':run', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Cloudtasks_projects_locations_queues_tasks_create(parent: string, requestBody: CreateTaskRequest): Observable<Task_> {
			return this.http.post<Task_>(this.baseUri + 'v2beta3/' + (parent == null ? '' : encodeURIComponent(parent)) + '/tasks', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
