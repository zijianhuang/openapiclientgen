...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {RatcrPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Ratcr(requestBody: RatcrPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'ratcr/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface RatcrPostBody {
		certificateParameters?: RatcrPostBodyCertificateParameters;
	...
	export interface RatcrPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<RatcrPostBodyFormat | null | undefined>,
	...
	export function CreateRatcrPostBodyFormGroup() {
		return new FormGroup<RatcrPostBodyFormProperties>({
			format: new FormControl<RatcrPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface RatcrPostBodyCertificateParameters {
	...
	export interface RatcrPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		rationCardNo: FormControl<string | null | undefined>,
	}
	export function CreateRatcrPostBodyCertificateParametersFormGroup() {
		return new FormGroup<RatcrPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rationCardNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
