...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {EpfscPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Epfsc(requestBody: EpfscPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'epfsc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {PecerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Pecer(requestBody: PecerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'pecer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {UncrdPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Uncrd(requestBody: UncrdPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'uncrd/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface EpfscPostBody {
		certificateParameters?: EpfscPostBodyCertificateParameters;
	...
	export interface EpfscPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<EpfscPostBodyFormat | null | undefined>,
	...
	export function CreateEpfscPostBodyFormGroup() {
		return new FormGroup<EpfscPostBodyFormProperties>({
			format: new FormControl<EpfscPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface EpfscPostBodyCertificateParameters {
	...
	export interface EpfscPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		SCNO: FormControl<string | null | undefined>,
	}
	export function CreateEpfscPostBodyCertificateParametersFormGroup() {
		return new FormGroup<EpfscPostBodyCertificateParametersFormProperties>({
			...
			SCNO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PecerPostBodyFormProperties {
	...
	export function CreatePecerPostBodyFormGroup() {
		return new FormGroup<PecerPostBodyFormProperties>({
			format: new FormControl<EpfscPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PecerPostBodyCertificateParameters {
	...
	export interface PecerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		PPONO: FormControl<string | null | undefined>,
	}
	export function CreatePecerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PecerPostBodyCertificateParametersFormProperties>({
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			PPONO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface UncrdPostBody {
		certificateParameters?: UncrdPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface UncrdPostBodyFormProperties {
	...
	export function CreateUncrdPostBodyFormGroup() {
		return new FormGroup<UncrdPostBodyFormProperties>({
			format: new FormControl<EpfscPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface UncrdPostBodyCertificateParameters {
	...
	export interface UncrdPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		UAN: FormControl<string | null | undefined>,
	}
	export function CreateUncrdPostBodyCertificateParametersFormGroup() {
		return new FormGroup<UncrdPostBodyCertificateParametersFormProperties>({
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			UAN: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
