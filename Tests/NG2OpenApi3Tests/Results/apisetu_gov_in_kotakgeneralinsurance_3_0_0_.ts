...
export namespace MyNS {
	...
	export function CreateCripcPostBodyCertificateParametersFormGroup() {
		return new FormGroup<CripcPostBodyCertificateParametersFormProperties>({
			...
			Val: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Verification: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
