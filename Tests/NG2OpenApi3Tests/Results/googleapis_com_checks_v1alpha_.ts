...
export namespace MyNS {
	...
	export enum GoogleChecksReportV1alphaAnalyzeUploadRequestAppBinaryFileType { APP_BINARY_FILE_TYPE_UNSPECIFIED = 'APP_BINARY_FILE_TYPE_UNSPECIFIED', ANDROID_APK = 'ANDROID_APK', ANDROID_AAB = 'ANDROID_AAB', IOS_IPA = 'IOS_IPA' }
	...
	export enum GoogleChecksReportV1alphaAppBundleReleaseType { APP_BUNDLE_RELEASE_TYPE_UNSPECIFIED = 'APP_BUNDLE_RELEASE_TYPE_UNSPECIFIED', PUBLIC = 'PUBLIC', PRE_RELEASE = 'PRE_RELEASE' }
	...
	export enum GoogleChecksReportV1alphaCheckCitationType { CITATION_TYPE_UNSPECIFIED = 'CITATION_TYPE_UNSPECIFIED', COPPA = 'COPPA', GDPR = 'GDPR', FERPA = 'FERPA', CAL_OPPA = 'CAL_OPPA', CCPA = 'CCPA', SOPIPA = 'SOPIPA', LGPD = 'LGPD', CPRA = 'CPRA', VCDPA = 'VCDPA', GOOGLE_PLAY_POLICY = 'GOOGLE_PLAY_POLICY', APP_STORE_POLICY = 'APP_STORE_POLICY', CPA = 'CPA', CTDPA = 'CTDPA', UCPA = 'UCPA', PIPEDA = 'PIPEDA', ALBERTA_PIPA = 'ALBERTA_PIPA', QUEBEC_ACT = 'QUEBEC_ACT', QUEBEC_BILL_64 = 'QUEBEC_BILL_64', CHINA_PIPL = 'CHINA_PIPL' }
	...
	export enum GoogleChecksReportV1alphaCheckDataTypeEvidenceDataType { DATA_TYPE_UNSPECIFIED = 'DATA_TYPE_UNSPECIFIED', DATA_TYPE_APPROXIMATE_LOCATION = 'DATA_TYPE_APPROXIMATE_LOCATION', DATA_TYPE_PRECISE_LOCATION = 'DATA_TYPE_PRECISE_LOCATION', DATA_TYPE_PERSONAL_NAME = 'DATA_TYPE_PERSONAL_NAME', DATA_TYPE_EMAIL_ADDRESS = 'DATA_TYPE_EMAIL_ADDRESS', DATA_TYPE_USER_IDS = 'DATA_TYPE_USER_IDS', DATA_TYPE_PHYSICAL_ADDRESS = 'DATA_TYPE_PHYSICAL_ADDRESS', DATA_TYPE_PHONE_NUMBER = 'DATA_TYPE_PHONE_NUMBER', DATA_TYPE_RACE_AND_ETHNICITY = 'DATA_TYPE_RACE_AND_ETHNICITY', DATA_TYPE_POLITICAL_OR_RELIGIOUS_BELIEFS = 'DATA_TYPE_POLITICAL_OR_RELIGIOUS_BELIEFS', DATA_TYPE_SEXUAL_ORIENTATION = 'DATA_TYPE_SEXUAL_ORIENTATION', DATA_TYPE_OTHER_PERSONAL_INFO = 'DATA_TYPE_OTHER_PERSONAL_INFO', DATA_TYPE_PAYMENT_INFO = 'DATA_TYPE_PAYMENT_INFO', DATA_TYPE_PURCHASE_HISTORY = 'DATA_TYPE_PURCHASE_HISTORY', DATA_TYPE_CREDIT_SCORE = 'DATA_TYPE_CREDIT_SCORE', DATA_TYPE_OTHER_FINANCIAL_INFO = 'DATA_TYPE_OTHER_FINANCIAL_INFO', DATA_TYPE_HEALTH_INFO = 'DATA_TYPE_HEALTH_INFO', DATA_TYPE_FITNESS_INFO = 'DATA_TYPE_FITNESS_INFO', DATA_TYPE_EMAILS = 'DATA_TYPE_EMAILS', DATA_TYPE_TEXT_MESSAGES = 'DATA_TYPE_TEXT_MESSAGES', DATA_TYPE_PHOTOS = 'DATA_TYPE_PHOTOS', DATA_TYPE_VIDEOS = 'DATA_TYPE_VIDEOS', DATA_TYPE_VOICE_OR_SOUND_RECORDINGS = 'DATA_TYPE_VOICE_OR_SOUND_RECORDINGS', DATA_TYPE_MUSIC_FILES = 'DATA_TYPE_MUSIC_FILES', DATA_TYPE_OTHER_AUDIO_FILES = 'DATA_TYPE_OTHER_AUDIO_FILES', DATA_TYPE_FILES_AND_DOCS = 'DATA_TYPE_FILES_AND_DOCS', DATA_TYPE_CALENDAR_EVENTS = 'DATA_TYPE_CALENDAR_EVENTS', DATA_TYPE_CONTACTS = 'DATA_TYPE_CONTACTS', DATA_TYPE_APP_INTERACTIONS = 'DATA_TYPE_APP_INTERACTIONS', DATA_TYPE_IN_APP_SEARCH_HISTORY = 'DATA_TYPE_IN_APP_SEARCH_HISTORY', DATA_TYPE_INSTALLED_APPS = 'DATA_TYPE_INSTALLED_APPS', DATA_TYPE_OTHER_USER_GENERATED_CONTENT = 'DATA_TYPE_OTHER_USER_GENERATED_CONTENT', DATA_TYPE_OTHER_ACTIONS = 'DATA_TYPE_OTHER_ACTIONS', DATA_TYPE_WEB_BROWSING_HISTORY = 'DATA_TYPE_WEB_BROWSING_HISTORY', DATA_TYPE_CRASH_LOGS = 'DATA_TYPE_CRASH_LOGS', DATA_TYPE_PERFORMANCE_DIAGNOSTICS = 'DATA_TYPE_PERFORMANCE_DIAGNOSTICS', DATA_TYPE_OTHER_APP_PERFORMANCE_DATA = 'DATA_TYPE_OTHER_APP_PERFORMANCE_DATA', DATA_TYPE_DEVICE_OR_OTHER_IDS = 'DATA_TYPE_DEVICE_OR_OTHER_IDS' }
	...
	export enum GoogleChecksReportV1alphaDataTypeEndpointEvidenceExfiltratedDataType { EXFILTRATED_DATA_TYPE_UNSPECIFIED = 'EXFILTRATED_DATA_TYPE_UNSPECIFIED', EXFILTRATED_DATA_TYPE_PHONE_NUMBER = 'EXFILTRATED_DATA_TYPE_PHONE_NUMBER', EXFILTRATED_DATA_TYPE_PRECISE_LOCATION = 'EXFILTRATED_DATA_TYPE_PRECISE_LOCATION', EXFILTRATED_DATA_TYPE_CONTACT_NAME = 'EXFILTRATED_DATA_TYPE_CONTACT_NAME', EXFILTRATED_DATA_TYPE_CONTACT_EMAIL = 'EXFILTRATED_DATA_TYPE_CONTACT_EMAIL', EXFILTRATED_DATA_TYPE_CONTACT_PHONE_NUMBER = 'EXFILTRATED_DATA_TYPE_CONTACT_PHONE_NUMBER', EXFILTRATED_DATA_TYPE_INCOMING_TEXT_NUMBER = 'EXFILTRATED_DATA_TYPE_INCOMING_TEXT_NUMBER', EXFILTRATED_DATA_TYPE_INCOMING_TEXT_MESSAGE = 'EXFILTRATED_DATA_TYPE_INCOMING_TEXT_MESSAGE', EXFILTRATED_DATA_TYPE_OUTGOING_TEXT_NUMBER = 'EXFILTRATED_DATA_TYPE_OUTGOING_TEXT_NUMBER', EXFILTRATED_DATA_TYPE_OUTGOING_TEXT_MESSAGE = 'EXFILTRATED_DATA_TYPE_OUTGOING_TEXT_MESSAGE', EXFILTRATED_DATA_TYPE_ADVERTISING_ID = 'EXFILTRATED_DATA_TYPE_ADVERTISING_ID', EXFILTRATED_DATA_TYPE_ANDROID_ID = 'EXFILTRATED_DATA_TYPE_ANDROID_ID', EXFILTRATED_DATA_TYPE_IMEI = 'EXFILTRATED_DATA_TYPE_IMEI', EXFILTRATED_DATA_TYPE_IMSI = 'EXFILTRATED_DATA_TYPE_IMSI', EXFILTRATED_DATA_TYPE_SIM_SERIAL_NUMBER = 'EXFILTRATED_DATA_TYPE_SIM_SERIAL_NUMBER', EXFILTRATED_DATA_TYPE_SSID = 'EXFILTRATED_DATA_TYPE_SSID', EXFILTRATED_DATA_TYPE_ACCOUNT = 'EXFILTRATED_DATA_TYPE_ACCOUNT', EXFILTRATED_DATA_TYPE_EXTERNAL_ACCOUNT = 'EXFILTRATED_DATA_TYPE_EXTERNAL_ACCOUNT', EXFILTRATED_DATA_TYPE_INSTALLED_PACKAGES = 'EXFILTRATED_DATA_TYPE_INSTALLED_PACKAGES' }
	...
	export enum GoogleChecksReportV1alphaCheckSeverity { CHECK_SEVERITY_UNSPECIFIED = 'CHECK_SEVERITY_UNSPECIFIED', PRIORITY = 'PRIORITY', POTENTIAL = 'POTENTIAL', OPPORTUNITY = 'OPPORTUNITY' }

	export enum GoogleChecksReportV1alphaCheckState { CHECK_STATE_UNSPECIFIED = 'CHECK_STATE_UNSPECIFIED', PASSED = 'PASSED', FAILED = 'FAILED', UNCHECKED = 'UNCHECKED' }
	...
	export enum GoogleChecksReportV1alphaCheckType { CHECK_TYPE_UNSPECIFIED = 'CHECK_TYPE_UNSPECIFIED', STORE_LISTING_PRIVACY_POLICY_LINK_PRESENT = 'STORE_LISTING_PRIVACY_POLICY_LINK_PRESENT', PRIVACY_POLICY_UPDATE_DATE_RECENT = 'PRIVACY_POLICY_UPDATE_DATE_RECENT', PRIVACY_POLICY_GDPR_GENERAL_RULES = 'PRIVACY_POLICY_GDPR_GENERAL_RULES', PRIVACY_POLICY_CCPA_GENERAL_RULES = 'PRIVACY_POLICY_CCPA_GENERAL_RULES', PRIVACY_POLICY_COLLECTION_CATEGORIES_DATA_NOTICE = 'PRIVACY_POLICY_COLLECTION_CATEGORIES_DATA_NOTICE', PRIVACY_POLICY_PROCESSING_PURPOSE_DATA_NOTICE = 'PRIVACY_POLICY_PROCESSING_PURPOSE_DATA_NOTICE', PRIVACY_POLICY_SHARING_CATEGORIES_DATA_NOTICE = 'PRIVACY_POLICY_SHARING_CATEGORIES_DATA_NOTICE', PRIVACY_POLICY_DATA_RETENTION_NOTICE = 'PRIVACY_POLICY_DATA_RETENTION_NOTICE', PRIVACY_POLICY_CONTACT_DETAILS_NOTICE = 'PRIVACY_POLICY_CONTACT_DETAILS_NOTICE', PRIVACY_POLICY_CHILDREN_GENERAL_RULES = 'PRIVACY_POLICY_CHILDREN_GENERAL_RULES', PRIVACY_POLICY_DATA_TYPE_PHONE_NUMBER = 'PRIVACY_POLICY_DATA_TYPE_PHONE_NUMBER', PRIVACY_POLICY_DATA_TYPE_USER_ACCOUNT_INFO = 'PRIVACY_POLICY_DATA_TYPE_USER_ACCOUNT_INFO', PRIVACY_POLICY_DATA_TYPE_PRECISE_LOCATION = 'PRIVACY_POLICY_DATA_TYPE_PRECISE_LOCATION', PRIVACY_POLICY_DATA_TYPE_DEVICE_ID = 'PRIVACY_POLICY_DATA_TYPE_DEVICE_ID', PRIVACY_POLICY_DATA_TYPE_APPS_ON_DEVICE = 'PRIVACY_POLICY_DATA_TYPE_APPS_ON_DEVICE', PRIVACY_POLICY_DATA_TYPE_CONTACTS = 'PRIVACY_POLICY_DATA_TYPE_CONTACTS', PRIVACY_POLICY_DATA_TYPE_TEXT_MESSAGES = 'PRIVACY_POLICY_DATA_TYPE_TEXT_MESSAGES', PRIVACY_POLICY_DATA_TYPE_PII = 'PRIVACY_POLICY_DATA_TYPE_PII', PRIVACY_POLICY_DATA_TYPE_PII_CATEGORIES = 'PRIVACY_POLICY_DATA_TYPE_PII_CATEGORIES', PRIVACY_POLICY_DATA_TYPE_HEALTH_AND_BIOMETRIC = 'PRIVACY_POLICY_DATA_TYPE_HEALTH_AND_BIOMETRIC', PRIVACY_POLICY_BRAZIL_LGPD_GENERAL_RULES = 'PRIVACY_POLICY_BRAZIL_LGPD_GENERAL_RULES', PRIVACY_POLICY_VIRGINIA_VCDPA_GENERAL_RULES = 'PRIVACY_POLICY_VIRGINIA_VCDPA_GENERAL_RULES', PRIVACY_POLICY_AFFILIATION_MENTION = 'PRIVACY_POLICY_AFFILIATION_MENTION', PRIVACY_POLICY_RIGHT_TO_DELETE_NOTICE = 'PRIVACY_POLICY_RIGHT_TO_DELETE_NOTICE', PRIVACY_POLICY_RIGHT_TO_ACCESS_NOTICE = 'PRIVACY_POLICY_RIGHT_TO_ACCESS_NOTICE', PRIVACY_POLICY_RIGHT_TO_RECTIFICATION_NOTICE = 'PRIVACY_POLICY_RIGHT_TO_RECTIFICATION_NOTICE', PRIVACY_POLICY_RIGHT_TO_KNOW_ABOUT_SELLING_NOTICE = 'PRIVACY_POLICY_RIGHT_TO_KNOW_ABOUT_SELLING_NOTICE', PRIVACY_POLICY_RIGHT_TO_KNOW_ABOUT_SHARING_NOTICE = 'PRIVACY_POLICY_RIGHT_TO_KNOW_ABOUT_SHARING_NOTICE', PRIVACY_POLICY_RIGHT_TO_OPT_OUT_FROM_SELLING_NOTICE = 'PRIVACY_POLICY_RIGHT_TO_OPT_OUT_FROM_SELLING_NOTICE', PRIVACY_POLICY_METHOD_TO_OPT_OUT_FROM_SELLING_OR_SHARING_NOTICE = 'PRIVACY_POLICY_METHOD_TO_OPT_OUT_FROM_SELLING_OR_SHARING_NOTICE', PRIVACY_POLICY_DATA_CONTROLLER_IDENTITY = 'PRIVACY_POLICY_DATA_CONTROLLER_IDENTITY', PRIVACY_POLICY_DPO_CONTACT_DETAILS = 'PRIVACY_POLICY_DPO_CONTACT_DETAILS', PRIVACY_POLICY_RIGHT_TO_LODGE_A_COMPLAINT = 'PRIVACY_POLICY_RIGHT_TO_LODGE_A_COMPLAINT', PRIVACY_POLICY_LEGAL_BASIS = 'PRIVACY_POLICY_LEGAL_BASIS', PRIVACY_POLICY_CHILDREN_INFO_COLLECTION = 'PRIVACY_POLICY_CHILDREN_INFO_COLLECTION', PRIVACY_POLICY_CHILDREN_INFO_USAGE_PURPOSES = 'PRIVACY_POLICY_CHILDREN_INFO_USAGE_PURPOSES', PRIVACY_POLICY_CHILDREN_INFO_DISCLOSURE_PRACTICES = 'PRIVACY_POLICY_CHILDREN_INFO_DISCLOSURE_PRACTICES', PRIVACY_POLICY_CHILDREN_INFO_PUBLICITY = 'PRIVACY_POLICY_CHILDREN_INFO_PUBLICITY', PRIVACY_POLICY_PARENTS_METHOD_OF_INFO_DELETION = 'PRIVACY_POLICY_PARENTS_METHOD_OF_INFO_DELETION', PRIVACY_POLICY_PARENTS_METHOD_TO_INFO_REVIEW = 'PRIVACY_POLICY_PARENTS_METHOD_TO_INFO_REVIEW', PRIVACY_POLICY_PARENTS_METHOD_TO_STOP_FURTHER_INFO_COLLECTION_USE = 'PRIVACY_POLICY_PARENTS_METHOD_TO_STOP_FURTHER_INFO_COLLECTION_USE', PRIVACY_POLICY_PARENTS_RIGHT_TO_INFO_DELETION = 'PRIVACY_POLICY_PARENTS_RIGHT_TO_INFO_DELETION', PRIVACY_POLICY_PARENTS_RIGHT_TO_INFO_REVIEW = 'PRIVACY_POLICY_PARENTS_RIGHT_TO_INFO_REVIEW', PRIVACY_POLICY_PARENTS_RIGHT_TO_STOP_FURTHER_INFO_COLLECTION_USE = 'PRIVACY_POLICY_PARENTS_RIGHT_TO_STOP_FURTHER_INFO_COLLECTION_USE', PRIVACY_POLICY_PSL_APPROXIMATE_LOCATION = 'PRIVACY_POLICY_PSL_APPROXIMATE_LOCATION', PRIVACY_POLICY_PSL_PRECISE_LOCATION = 'PRIVACY_POLICY_PSL_PRECISE_LOCATION', PRIVACY_POLICY_PSL_NAME = 'PRIVACY_POLICY_PSL_NAME', PRIVACY_POLICY_PSL_EMAIL_ADDRESS = 'PRIVACY_POLICY_PSL_EMAIL_ADDRESS', PRIVACY_POLICY_PSL_USER_IDENTIFIERS = 'PRIVACY_POLICY_PSL_USER_IDENTIFIERS', PRIVACY_POLICY_PSL_ADDRESS = 'PRIVACY_POLICY_PSL_ADDRESS', PRIVACY_POLICY_PSL_PHONE_NUMBER = 'PRIVACY_POLICY_PSL_PHONE_NUMBER', PRIVACY_POLICY_PSL_RACE_AND_ETHNICITY = 'PRIVACY_POLICY_PSL_RACE_AND_ETHNICITY', PRIVACY_POLICY_PSL_CREDIT_SCORE = 'PRIVACY_POLICY_PSL_CREDIT_SCORE', PRIVACY_POLICY_PSL_PURCHASE_HISTORY = 'PRIVACY_POLICY_PSL_PURCHASE_HISTORY', PRIVACY_POLICY_PSL_HEALTH_INFO = 'PRIVACY_POLICY_PSL_HEALTH_INFO', PRIVACY_POLICY_PSL_FITNESS_INFO = 'PRIVACY_POLICY_PSL_FITNESS_INFO', PRIVACY_POLICY_PSL_EMAIL_MESSAGES = 'PRIVACY_POLICY_PSL_EMAIL_MESSAGES', PRIVACY_POLICY_PSL_TEXT_MESSAGES = 'PRIVACY_POLICY_PSL_TEXT_MESSAGES', PRIVACY_POLICY_PSL_PHOTOS = 'PRIVACY_POLICY_PSL_PHOTOS', PRIVACY_POLICY_PSL_VIDEOS = 'PRIVACY_POLICY_PSL_VIDEOS', PRIVACY_POLICY_PSL_MUSIC_FILES = 'PRIVACY_POLICY_PSL_MUSIC_FILES', PRIVACY_POLICY_PSL_VOICE_OR_SOUND_RECORDINGS = 'PRIVACY_POLICY_PSL_VOICE_OR_SOUND_RECORDINGS', PRIVACY_POLICY_PSL_FILES_AND_DOCS = 'PRIVACY_POLICY_PSL_FILES_AND_DOCS', PRIVACY_POLICY_PSL_CALENDAR_EVENTS = 'PRIVACY_POLICY_PSL_CALENDAR_EVENTS', PRIVACY_POLICY_PSL_CONTACTS = 'PRIVACY_POLICY_PSL_CONTACTS', PRIVACY_POLICY_PSL_APP_INTERACTIONS = 'PRIVACY_POLICY_PSL_APP_INTERACTIONS', PRIVACY_POLICY_PSL_IN_APP_SEARCH_HISTORY = 'PRIVACY_POLICY_PSL_IN_APP_SEARCH_HISTORY', PRIVACY_POLICY_PSL_WEB_BROWSING_HISTORY = 'PRIVACY_POLICY_PSL_WEB_BROWSING_HISTORY', PRIVACY_POLICY_PSL_INSTALLED_APPS = 'PRIVACY_POLICY_PSL_INSTALLED_APPS', PRIVACY_POLICY_PSL_CRASH_LOGS = 'PRIVACY_POLICY_PSL_CRASH_LOGS', PRIVACY_POLICY_PSL_DIAGNOSTICS = 'PRIVACY_POLICY_PSL_DIAGNOSTICS', PRIVACY_POLICY_PSL_DEVICE_OR_OTHER_IDS = 'PRIVACY_POLICY_PSL_DEVICE_OR_OTHER_IDS', DATA_MONITORING_NEW_ENDPOINT = 'DATA_MONITORING_NEW_ENDPOINT', DATA_MONITORING_NEW_PERMISSION = 'DATA_MONITORING_NEW_PERMISSION', DATA_MONITORING_NEW_DATA_TYPE = 'DATA_MONITORING_NEW_DATA_TYPE', DATA_MONITORING_NEW_SDK = 'DATA_MONITORING_NEW_SDK', DATA_MONITORING_ENCRYPTION = 'DATA_MONITORING_ENCRYPTION', DATA_MONITORING_NEW_DATA_TYPE_VERSION_DIFF = 'DATA_MONITORING_NEW_DATA_TYPE_VERSION_DIFF', DATA_MONITORING_NEW_ENDPOINT_VERSION_DIFF = 'DATA_MONITORING_NEW_ENDPOINT_VERSION_DIFF', DATA_MONITORING_NEW_PERMISSION_VERSION_DIFF = 'DATA_MONITORING_NEW_PERMISSION_VERSION_DIFF', DATA_MONITORING_NEW_SDK_VERSION_DIFF = 'DATA_MONITORING_NEW_SDK_VERSION_DIFF', DATA_MONITORING_SDKS_DENYLIST_VIOLATION = 'DATA_MONITORING_SDKS_DENYLIST_VIOLATION', DATA_MONITORING_PERMISSIONS_DENYLIST_VIOLATION = 'DATA_MONITORING_PERMISSIONS_DENYLIST_VIOLATION', DATA_MONITORING_ENDPOINTS_DENYLIST_VIOLATION = 'DATA_MONITORING_ENDPOINTS_DENYLIST_VIOLATION', DATA_MONITORING_OUTDATED_SDK_VERSION = 'DATA_MONITORING_OUTDATED_SDK_VERSION', DATA_MONITORING_CRITICAL_SDK_ISSUE = 'DATA_MONITORING_CRITICAL_SDK_ISSUE' }
