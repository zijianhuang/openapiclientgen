...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @return {GetInfoForObservedBeaconsResponse} Successful response
		 */
		Proximitybeacon_beaconinfo_getforobserved(requestBody: GetInfoForObservedBeaconsRequest): Observable<GetInfoForObservedBeaconsResponse> {
			return this.http.post<GetInfoForObservedBeaconsResponse>(this.baseUri + 'v1beta1/beaconinfo:getforobserved', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ListBeaconsResponse} Successful response
		 */
		Proximitybeacon_beacons_list(pageSize: number | null | undefined, pageToken: string | null | undefined, projectId: string | null | undefined, q: string | null | undefined): Observable<ListBeaconsResponse> {
			return this.http.get<ListBeaconsResponse>(this.baseUri + 'v1beta1/beacons?pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)) + '&q=' + (q == null ? '' : encodeURIComponent(q)), {});
		}
		 ...
		 * @return {Beacon} Successful response
		 */
		Proximitybeacon_beacons_register(projectId: string | null | undefined, requestBody: Beacon): Observable<Beacon> {
			return this.http.post<Beacon>(this.baseUri + 'v1beta1/beacons:register?projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {EphemeralIdRegistrationParams} Successful response
		 */
		Proximitybeacon_getEidparams(): Observable<EphemeralIdRegistrationParams> {
			return this.http.get<EphemeralIdRegistrationParams>(this.baseUri + 'v1beta1/eidparams', {});
		}
		 ...
		 * @return {ListNamespacesResponse} Successful response
		 */
		Proximitybeacon_namespaces_list(projectId: string | null | undefined): Observable<ListNamespacesResponse> {
			return this.http.get<ListNamespacesResponse>(this.baseUri + 'v1beta1/namespaces?projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), {});
		}
		 ...
		 */
		Proximitybeacon_beacons_attachments_delete(attachmentName: string, projectId: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta1/' + (attachmentName == null ? '' : encodeURIComponent(attachmentName)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), {});
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Proximitybeacon_beacons_delete(beaconName: string, projectId: string | null | undefined): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), {});
		}
		 ...
		 * @return {Beacon} Successful response
		 */
		Proximitybeacon_beacons_get(beaconName: string, projectId: string | null | undefined): Observable<Beacon> {
			return this.http.get<Beacon>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), {});
		}
		 ...
		 * @return {Beacon} Successful response
		 */
		Proximitybeacon_beacons_update(beaconName: string, projectId: string | null | undefined, requestBody: Beacon): Observable<Beacon> {
			return this.http.put<Beacon>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} namespacedType Specifies the namespace and type of attachment to include in response in namespace/type format. Accepts `*` to specify "all types in all namespaces".
		 ...
		 * @return {ListBeaconAttachmentsResponse} Successful response
		 */
		Proximitybeacon_beacons_attachments_list(beaconName: string, namespacedType: string | null | undefined, projectId: string | null | undefined): Observable<ListBeaconAttachmentsResponse> {
			return this.http.get<ListBeaconAttachmentsResponse>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + '/attachments&namespacedType=' + (namespacedType == null ? '' : encodeURIComponent(namespacedType)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), {});
		}
		 ...
		 * @return {BeaconAttachment} Successful response
		 */
		Proximitybeacon_beacons_attachments_create(beaconName: string, projectId: string | null | undefined, requestBody: BeaconAttachment): Observable<BeaconAttachment> {
			return this.http.post<BeaconAttachment>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + '/attachments&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} namespacedType Specifies the namespace and type of attachments to delete in `namespace/type` format. Accepts `*` to specify "all types in all namespaces". Optional.
		 ...
		 * @return {DeleteAttachmentsResponse} Successful response
		 */
		Proximitybeacon_beacons_attachments_batchDelete(beaconName: string, namespacedType: string | null | undefined, projectId: string | null | undefined): Observable<DeleteAttachmentsResponse> {
			return this.http.post<DeleteAttachmentsResponse>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + '/attachments:batchDelete&namespacedType=' + (namespacedType == null ? '' : encodeURIComponent(namespacedType)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), null, {});
		}
		 ...
		 * @param {Proximitybeacon_beacons_diagnostics_listAlertFilter} alertFilter Requests only beacons that have the given alert. For example, to find beacons that have low batteries use `alert_filter=LOW_BATTERY`.
		 ...
		 * @return {ListDiagnosticsResponse} Successful response
		 */
		Proximitybeacon_beacons_diagnostics_list(beaconName: string, alertFilter: Proximitybeacon_beacons_diagnostics_listAlertFilter | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined, projectId: string | null | undefined): Observable<ListDiagnosticsResponse> {
			return this.http.get<ListDiagnosticsResponse>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + '/diagnostics&alertFilter=' + alertFilter + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), {});
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Proximitybeacon_beacons_activate(beaconName: string, projectId: string | null | undefined): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + ':activate&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), null, {});
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Proximitybeacon_beacons_deactivate(beaconName: string, projectId: string | null | undefined): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + ':deactivate&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), null, {});
		}
		 ...
		 * @return {Empty} Successful response
		 */
		Proximitybeacon_beacons_decommission(beaconName: string, projectId: string | null | undefined): Observable<Empty> {
			return this.http.post<Empty>(this.baseUri + 'v1beta1/' + (beaconName == null ? '' : encodeURIComponent(beaconName)) + ':decommission&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), null, {});
		}
		 ...
		 * @return {Namespace} Successful response
		 */
		Proximitybeacon_namespaces_update(namespaceName: string, projectId: string | null | undefined, requestBody: Namespace): Observable<Namespace> {
			return this.http.put<Namespace>(this.baseUri + 'v1beta1/' + (namespaceName == null ? '' : encodeURIComponent(namespaceName)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
