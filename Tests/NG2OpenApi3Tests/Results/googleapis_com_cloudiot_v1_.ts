...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Cloudiot_projects_locations_registries_devices_delete(name: string): Observable<Empty> {
		 ...
		 */
		Cloudiot_projects_locations_registries_devices_get(name: string, fieldMask: string | null | undefined): Observable<Device> {
			return this.http.get<Device>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&fieldMask=' + (fieldMask == null ? '' : encodeURIComponent(fieldMask)), {});
		}
		 ...
		 * @return {Device} Successful response
		 */
		Cloudiot_projects_locations_registries_devices_patch(name: string, updateMask: string | null | undefined, requestBody: Device): Observable<Device> {
			return this.http.patch<Device>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ListDeviceConfigVersionsResponse} Successful response
		 */
		Cloudiot_projects_locations_registries_devices_configVersions_list(name: string, numVersions: number | null | undefined): Observable<ListDeviceConfigVersionsResponse> {
			return this.http.get<ListDeviceConfigVersionsResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/configVersions&numVersions=' + numVersions, {});
		}
		 ...
		 * @return {ListDeviceStatesResponse} Successful response
		 */
		Cloudiot_projects_locations_registries_devices_states_list(name: string, numStates: number | null | undefined): Observable<ListDeviceStatesResponse> {
			return this.http.get<ListDeviceStatesResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/states&numStates=' + numStates, {});
		}
		 ...
		 * @param {string} name Required. The name of the device. For example, `projects/p0/locations/us-central1/registries/registry0/devices/device0` or `projects/p0/locations/us-central1/registries/registry0/devices/{num_id}`.
		 * @return {DeviceConfig} Successful response
		 */
		Cloudiot_projects_locations_registries_devices_modifyCloudToDeviceConfig(name: string, requestBody: ModifyCloudToDeviceConfigRequest): Observable<DeviceConfig> {
			return this.http.post<DeviceConfig>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':modifyCloudToDeviceConfig', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} name Required. The name of the device. For example, `projects/p0/locations/us-central1/registries/registry0/devices/device0` or `projects/p0/locations/us-central1/registries/registry0/devices/{num_id}`.
		 * @return {SendCommandToDeviceResponse} Successful response
		 */
		Cloudiot_projects_locations_registries_devices_sendCommandToDevice(name: string, requestBody: SendCommandToDeviceRequest): Observable<SendCommandToDeviceResponse> {
			return this.http.post<SendCommandToDeviceResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':sendCommandToDevice', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} gatewayListOptions_associationsDeviceId If set, returns only the gateways with which the specified device is associated. The device ID can be numeric (`num_id`) or the user-defined string (`id`). For example, if `456` is specified, returns only the gateways to which the device with `num_id` 456 is bound.
		 * @param {string} gatewayListOptions_associationsGatewayId If set, only devices associated with the specified gateway are returned. The gateway ID can be numeric (`num_id`) or the user-defined string (`id`). For example, if `123` is specified, only devices bound to the gateway with `num_id` 123 are returned.
		 * @param {GatewayConfigGatewayType} gatewayListOptions_gatewayType If `GATEWAY` is specified, only gateways are returned. If `NON_GATEWAY` is specified, only non-gateway devices are returned. If `GATEWAY_TYPE_UNSPECIFIED` is specified, all devices are returned.
		 ...
		 */
		Cloudiot_projects_locations_registries_groups_devices_list(parent: string, deviceIds: Array<string> | null | undefined, deviceNumIds: Array<string> | null | undefined, fieldMask: string | null | undefined, gatewayListOptions_associationsDeviceId: string | null | undefined, gatewayListOptions_associationsGatewayId: string | null | undefined, gatewayListOptions_gatewayType: GatewayConfigGatewayType | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDevicesResponse> {
			return this.http.get<ListDevicesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/devices&' + deviceIds?.map(z => `deviceIds=${encodeURIComponent(z)}`).join('&') + '&' + deviceNumIds?.map(z => `deviceNumIds=${encodeURIComponent(z)}`).join('&') + '&fieldMask=' + (fieldMask == null ? '' : encodeURIComponent(fieldMask)) + '&gatewayListOptions_associationsDeviceId=' + (gatewayListOptions_associationsDeviceId == null ? '' : encodeURIComponent(gatewayListOptions_associationsDeviceId)) + '&gatewayListOptions_associationsGatewayId=' + (gatewayListOptions_associationsGatewayId == null ? '' : encodeURIComponent(gatewayListOptions_associationsGatewayId)) + '&gatewayListOptions_gatewayType=' + gatewayListOptions_gatewayType + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {Device} Successful response
		 */
		Cloudiot_projects_locations_registries_devices_create(parent: string, requestBody: Device): Observable<Device> {
			return this.http.post<Device>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/devices', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ListDeviceRegistriesResponse} Successful response
		 */
		Cloudiot_projects_locations_registries_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDeviceRegistriesResponse> {
			return this.http.get<ListDeviceRegistriesResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registries&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {DeviceRegistry} Successful response
		 */
		Cloudiot_projects_locations_registries_create(parent: string, requestBody: DeviceRegistry): Observable<DeviceRegistry> {
			return this.http.post<DeviceRegistry>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/registries', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {BindDeviceToGatewayResponse} Successful response
		 */
		Cloudiot_projects_locations_registries_bindDeviceToGateway(parent: string, requestBody: BindDeviceToGatewayRequest): Observable<BindDeviceToGatewayResponse> {
			return this.http.post<BindDeviceToGatewayResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':bindDeviceToGateway', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} parent Required. The name of the registry. For example, `projects/example-project/locations/us-central1/registries/my-registry`.
		 * @return {UnbindDeviceFromGatewayResponse} Successful response
		 */
		Cloudiot_projects_locations_registries_unbindDeviceFromGateway(parent: string, requestBody: UnbindDeviceFromGatewayRequest): Observable<UnbindDeviceFromGatewayResponse> {
			return this.http.post<UnbindDeviceFromGatewayResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':unbindDeviceFromGateway', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Cloudiot_projects_locations_registries_groups_getIamPolicy(resource: string, requestBody: GetIamPolicyRequest): Observable<Policy> {
		 ...
		 * @return {Policy} Successful response
		 */
		Cloudiot_projects_locations_registries_groups_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
		 ...
		 */
		Cloudiot_projects_locations_registries_groups_testIamPermissions(resource: string, requestBody: TestIamPermissionsRequest): Observable<TestIamPermissionsResponse> {
