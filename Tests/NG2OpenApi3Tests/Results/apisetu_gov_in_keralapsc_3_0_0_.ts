...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {OtcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Otcer(requestBody: OtcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'otcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface OtcerPostBody {
		certificateParameters?: OtcerPostBodyCertificateParameters;
	...
	export interface OtcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<OtcerPostBodyFormat | null | undefined>,
	...
	export function CreateOtcerPostBodyFormGroup() {
		return new FormGroup<OtcerPostBodyFormProperties>({
			format: new FormControl<OtcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface OtcerPostBodyCertificateParameters {
	...
	export interface OtcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateOtcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<OtcerPostBodyCertificateParametersFormProperties>({
	...
	export enum OtcerPostBodyFormat { pdf = 'pdf' }
