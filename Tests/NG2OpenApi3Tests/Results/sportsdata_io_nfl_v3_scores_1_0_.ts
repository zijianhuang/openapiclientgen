...
export namespace MyNS {
	...
	export interface TeamDepthChart {
		Defense?: Array<DepthChart>;
		Offense?: Array<DepthChart>;
		SpecialTeams?: Array<DepthChart>;
		TeamID?: number | null;
	}
	...
	export class MyClient {
		 ...
		 * @return {any} 
		 */
		XPing(format: TeamsAllFormat, seconds: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + format + '/Ping/' + (seconds == null ? '' : encodeURIComponent(seconds)) + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} 
		 */
		PlayersByTeamBasic(format: TeamsAllFormat, team: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + format + '/PlayersBasic/' + (team == null ? '' : encodeURIComponent(team)) + '', { observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ScheduleBasic(format: TeamsAllFormat, season: string): Observable<Array<ScheduleBasic>> {
		 ...
		 */
		ScoresByWeekBasic(format: TeamsAllFormat, season: string, week: string): Observable<Array<ScoreBasic>> {
			return this.http.get<Array<ScoreBasic>>(this.baseUri + format + '/ScoresBasic/' + (season == null ? '' : encodeURIComponent(season)) + '/' + (week == null ? '' : encodeURIComponent(week)) + '', {});
		}
		 ...
		 * @return {Array<Score>} 
		 */
		ScoresByDate(format: TeamsAllFormat, date: string): Observable<Array<Score>> {
			return this.http.get<Array<Score>>(this.baseUri + format + '/ScoresByDate/' + (date == null ? '' : encodeURIComponent(date)) + '', {});
		}
		 ...
		 * @param {TeamsAllFormat} format Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
		 * @return {Array<TeamBasic>} 
		 */
		TeamsBasic(format: TeamsAllFormat): Observable<Array<TeamBasic>> {
