...
export namespace MyNS {
	...
	export enum EndpointForwardingRuleTarget { FORWARDING_RULE_TARGET_UNSPECIFIED = 0, INSTANCE = 1, LOAD_BALANCER = 2, VPN_GATEWAY = 3, PSC = 4 }
	...
	export enum EndpointNetworkType { NETWORK_TYPE_UNSPECIFIED = 0, GCP_NETWORK = 1, NON_GCP_NETWORK = 2 }
	...
	export enum ProbingDetailsAbortCause { PROBING_ABORT_CAUSE_UNSPECIFIED = 0, PERMISSION_DENIED = 1, NO_SOURCE_LOCATION = 2 }
	...
	export enum ProbingDetailsResult { PROBING_RESULT_UNSPECIFIED = 0, REACHABLE = 1, UNREACHABLE = 2, REACHABILITY_INCONSISTENT = 3, UNDETERMINED = 4 }
	...
	export enum ReachabilityDetailsResult { RESULT_UNSPECIFIED = 0, REACHABLE = 1, UNREACHABLE = 2, AMBIGUOUS = 3, UNDETERMINED = 4 }
	...
	export enum DeliverInfoTarget { TARGET_UNSPECIFIED = 0, INSTANCE = 1, INTERNET = 2, GOOGLE_API = 3, GKE_MASTER = 4, CLOUD_SQL_INSTANCE = 5, PSC_PUBLISHED_SERVICE = 6, PSC_GOOGLE_API = 7, PSC_VPC_SC = 8, SERVERLESS_NEG = 9, STORAGE_BUCKET = 10 }
	...
	export enum DropInfoCause { CAUSE_UNSPECIFIED = 0, UNKNOWN_EXTERNAL_ADDRESS = 1, FOREIGN_IP_DISALLOWED = 2, FIREWALL_RULE = 3, NO_ROUTE = 4, ROUTE_BLACKHOLE = 5, ROUTE_WRONG_NETWORK = 6, ROUTE_NEXT_HOP_IP_ADDRESS_NOT_RESOLVED = 7, ROUTE_NEXT_HOP_RESOURCE_NOT_FOUND = 8, NO_ROUTE_FROM_INTERNET_TO_PRIVATE_IPV6_ADDRESS = 9, VPN_TUNNEL_LOCAL_SELECTOR_MISMATCH = 10, VPN_TUNNEL_REMOTE_SELECTOR_MISMATCH = 11, PRIVATE_TRAFFIC_TO_INTERNET = 12, PRIVATE_GOOGLE_ACCESS_DISALLOWED = 13, PRIVATE_GOOGLE_ACCESS_VIA_VPN_TUNNEL_UNSUPPORTED = 14, NO_EXTERNAL_ADDRESS = 15, UNKNOWN_INTERNAL_ADDRESS = 16, FORWARDING_RULE_MISMATCH = 17, FORWARDING_RULE_NO_INSTANCES = 18, FIREWALL_BLOCKING_LOAD_BALANCER_BACKEND_HEALTH_CHECK = 19, INSTANCE_NOT_RUNNING = 20, GKE_CLUSTER_NOT_RUNNING = 21, CLOUD_SQL_INSTANCE_NOT_RUNNING = 22, TRAFFIC_TYPE_BLOCKED = 23, GKE_MASTER_UNAUTHORIZED_ACCESS = 24, CLOUD_SQL_INSTANCE_UNAUTHORIZED_ACCESS = 25, DROPPED_INSIDE_GKE_SERVICE = 26, DROPPED_INSIDE_CLOUD_SQL_SERVICE = 27, GOOGLE_MANAGED_SERVICE_NO_PEERING = 28, GOOGLE_MANAGED_SERVICE_NO_PSC_ENDPOINT = 29, GKE_PSC_ENDPOINT_MISSING = 30, CLOUD_SQL_INSTANCE_NO_IP_ADDRESS = 31, GKE_CONTROL_PLANE_REGION_MISMATCH = 32, PUBLIC_GKE_CONTROL_PLANE_TO_PRIVATE_DESTINATION = 33, GKE_CONTROL_PLANE_NO_ROUTE = 34, CLOUD_SQL_INSTANCE_NOT_CONFIGURED_FOR_EXTERNAL_TRAFFIC = 35, PUBLIC_CLOUD_SQL_INSTANCE_TO_PRIVATE_DESTINATION = 36, CLOUD_SQL_INSTANCE_NO_ROUTE = 37, CLOUD_FUNCTION_NOT_ACTIVE = 38, VPC_CONNECTOR_NOT_SET = 39, VPC_CONNECTOR_NOT_RUNNING = 40, FORWARDING_RULE_REGION_MISMATCH = 41, PSC_CONNECTION_NOT_ACCEPTED = 42, PSC_ENDPOINT_ACCESSED_FROM_PEERED_NETWORK = 43, PSC_NEG_PRODUCER_ENDPOINT_NO_GLOBAL_ACCESS = 44, CLOUD_RUN_REVISION_NOT_READY = 45, DROPPED_INSIDE_PSC_SERVICE_PRODUCER = 46, LOAD_BALANCER_HAS_NO_PROXY_SUBNET = 47, CLOUD_NAT_NO_ADDRESSES = 48 }
	...
	export enum FirewallInfoFirewallRuleType { FIREWALL_RULE_TYPE_UNSPECIFIED = 0, HIERARCHICAL_FIREWALL_POLICY_RULE = 1, VPC_FIREWALL_RULE = 2, IMPLIED_VPC_FIREWALL_RULE = 3, SERVERLESS_VPC_ACCESS_MANAGED_FIREWALL_RULE = 4, NETWORK_FIREWALL_POLICY_RULE = 5, NETWORK_REGIONAL_FIREWALL_POLICY_RULE = 6, UNSUPPORTED_FIREWALL_POLICY_RULE = 7, TRACKING_STATE = 8 }
	...
	export enum ForwardInfoTarget { TARGET_UNSPECIFIED = 0, PEERING_VPC = 1, VPN_GATEWAY = 2, INTERCONNECT = 3, GKE_MASTER = 4, IMPORTED_CUSTOM_ROUTE_NEXT_HOP = 5, CLOUD_SQL_INSTANCE = 6, ANOTHER_PROJECT = 7, NCC_HUB = 8, ROUTER_APPLIANCE = 9 }
	...
	export enum GoogleServiceInfoGoogleServiceType { GOOGLE_SERVICE_TYPE_UNSPECIFIED = 0, IAP = 1, GFE_PROXY_OR_HEALTH_CHECK_PROBER = 2, CLOUD_DNS = 3, GOOGLE_API = 4, GOOGLE_API_PSC = 5, GOOGLE_API_VPC_SC = 6 }
	...
	export enum LoadBalancerInfoBackendType { BACKEND_TYPE_UNSPECIFIED = 0, BACKEND_SERVICE = 1, TARGET_POOL = 2, TARGET_INSTANCE = 3 }
	...
	export enum LoadBalancerBackendHealthCheckFirewallState { HEALTH_CHECK_FIREWALL_STATE_UNSPECIFIED = 0, CONFIGURED = 1, MISCONFIGURED = 2 }

	export enum LoadBalancerInfoLoadBalancerType { LOAD_BALANCER_TYPE_UNSPECIFIED = 0, INTERNAL_TCP_UDP = 1, NETWORK_TCP_UDP = 2, HTTP_PROXY = 3, TCP_PROXY = 4, SSL_PROXY = 5 }
	...
	export enum LoadBalancerBackendInfoHealthCheckFirewallsConfigState { HEALTH_CHECK_FIREWALLS_CONFIG_STATE_UNSPECIFIED = 0, FIREWALLS_CONFIGURED = 1, FIREWALLS_PARTIALLY_CONFIGURED = 2, FIREWALLS_NOT_CONFIGURED = 3, FIREWALLS_UNSUPPORTED = 4 }
	...
	export enum NatInfoType { TYPE_UNSPECIFIED = 0, INTERNAL_TO_EXTERNAL = 1, EXTERNAL_TO_INTERNAL = 2, CLOUD_NAT = 3, PRIVATE_SERVICE_CONNECT = 4 }
	...
	export enum RouteInfoNextHopType { NEXT_HOP_TYPE_UNSPECIFIED = 0, NEXT_HOP_IP = 1, NEXT_HOP_INSTANCE = 2, NEXT_HOP_NETWORK = 3, NEXT_HOP_PEERING = 4, NEXT_HOP_INTERCONNECT = 5, NEXT_HOP_VPN_TUNNEL = 6, NEXT_HOP_VPN_GATEWAY = 7, NEXT_HOP_INTERNET_GATEWAY = 8, NEXT_HOP_BLACKHOLE = 9, NEXT_HOP_ILB = 10, NEXT_HOP_ROUTER_APPLIANCE = 11, NEXT_HOP_NCC_HUB = 12 }

	export enum RouteInfoRouteScope { ROUTE_SCOPE_UNSPECIFIED = 0, NETWORK = 1, NCC_HUB = 2 }

	export enum RouteInfoRouteType { ROUTE_TYPE_UNSPECIFIED = 0, SUBNET = 1, STATIC = 2, DYNAMIC = 3, PEERING_SUBNET = 4, PEERING_STATIC = 5, PEERING_DYNAMIC = 6, POLICY_BASED = 7 }

	export enum StepState { STATE_UNSPECIFIED = 0, START_FROM_INSTANCE = 1, START_FROM_INTERNET = 2, START_FROM_GOOGLE_SERVICE = 3, START_FROM_PRIVATE_NETWORK = 4, START_FROM_GKE_MASTER = 5, START_FROM_CLOUD_SQL_INSTANCE = 6, START_FROM_CLOUD_FUNCTION = 7, START_FROM_APP_ENGINE_VERSION = 8, START_FROM_CLOUD_RUN_REVISION = 9, APPLY_INGRESS_FIREWALL_RULE = 10, APPLY_EGRESS_FIREWALL_RULE = 11, APPLY_ROUTE = 12, APPLY_FORWARDING_RULE = 13, ANALYZE_LOAD_BALANCER_BACKEND = 14, SPOOFING_APPROVED = 15, ARRIVE_AT_INSTANCE = 16, ARRIVE_AT_INTERNAL_LOAD_BALANCER = 17, ARRIVE_AT_EXTERNAL_LOAD_BALANCER = 18, ARRIVE_AT_VPN_GATEWAY = 19, ARRIVE_AT_VPN_TUNNEL = 20, ARRIVE_AT_VPC_CONNECTOR = 21, NAT = 22, PROXY_CONNECTION = 23, DELIVER = 24, DROP = 25, FORWARD = 26, ABORT = 27, VIEWER_PERMISSION_MISSING = 28 }
	...
	export enum VpnTunnelInfoRoutingType { ROUTING_TYPE_UNSPECIFIED = 0, ROUTE_BASED = 1, POLICY_BASED = 2, DYNAMIC = 3 }
	...
	export class MyClient {
		...
		Networkmanagement_projects_locations_global_connectivityTests_rerun(name: string, requestBody: RerunConnectivityTestRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':rerun', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Networkmanagement_projects_locations_global_connectivityTests_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListConnectivityTestsResponse> {
			return this.http.get<ListConnectivityTestsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/connectivityTests&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Networkmanagement_projects_locations_global_connectivityTests_create(parent: string, testId: string | null | undefined, requestBody: ConnectivityTest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/connectivityTests&testId=' + (testId == null ? '' : encodeURIComponent(testId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
