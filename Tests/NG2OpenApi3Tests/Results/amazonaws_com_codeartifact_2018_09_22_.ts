...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		CopyPackageVersions(domain: string, domain_owner: string | null | undefined, source_repository: string, destination_repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, requestBody: CopyPackageVersionsPostBody): Observable<CopyPackageVersionsResult> {
			return this.http.post<CopyPackageVersionsResult>(this.baseUri + 'v1/package/versions/copy#domain&source-repository&destination-repository&format&package?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&source_repository=' + (source_repository == null ? '' : encodeURIComponent(source_repository)) + '&destination_repository=' + (destination_repository == null ? '' : encodeURIComponent(destination_repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&_package=' + (_package == null ? '' : encodeURIComponent(_package)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} _namespace <p>The namespace of the requested package. The package component that specifies its namespace depends on its type. For example:</p> <ul> <li> <p> The namespace of a Maven package is its <code>groupId</code>. The namespace is required when requesting Maven packages. </p> </li> <li> <p> The namespace of an npm package is its <code>scope</code>. </p> </li> <li> <p> Python and NuGet packages do not contain a corresponding component, packages of those formats do not have a namespace. </p> </li> <li> <p> The namespace of a generic package is its <code>namespace</code>. </p> </li> </ul>
		 * @param {string} _package The name of the requested package.
		 * @return {DescribePackageResult} Success
		 */
		DescribePackage(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string): Observable<DescribePackageResult> {
		 ...
		 * @param {string} _namespace <p>The namespace of the package to be updated. The package component that specifies its namespace depends on its type. For example:</p> <ul> <li> <p> The namespace of a Maven package is its <code>groupId</code>. </p> </li> <li> <p> The namespace of an npm package is its <code>scope</code>. </p> </li> <li> <p> Python and NuGet packages do not contain a corresponding component, packages of those formats do not have a namespace. </p> </li> <li> <p> The namespace of a generic package is its <code>namespace</code>. </p> </li> </ul>
		 * @param {string} _package The name of the package to be updated.
		 * @return {PutPackageOriginConfigurationResult} Success
		 */
		PutPackageOriginConfiguration(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, requestBody: PutPackageOriginConfigurationPostBody): Observable<PutPackageOriginConfigurationResult> {
			return this.http.post<PutPackageOriginConfigurationResult>(this.baseUri + 'v1/package#domain&repository&format&package?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&_package=' + (_package == null ? '' : encodeURIComponent(_package)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		DescribePackageVersion(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, version: string): Observable<DescribePackageVersionResult> {
			return this.http.get<DescribePackageVersionResult>(this.baseUri + 'v1/package/version#domain&repository&format&package&version?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&_package=' + (_package == null ? '' : encodeURIComponent(_package)) + '&version=' + (version == null ? '' : encodeURIComponent(version)), {});
		}
		 ...
		 * @param {string} _namespace <p>The namespace of the package versions to be disposed. The package version component that specifies its namespace depends on its type. For example:</p> <ul> <li> <p> The namespace of a Maven package version is its <code>groupId</code>. </p> </li> <li> <p> The namespace of an npm package version is its <code>scope</code>. </p> </li> <li> <p> Python and NuGet package versions do not contain a corresponding component, package versions of those formats do not have a namespace. </p> </li> <li> <p> The namespace of a generic package is its <code>namespace</code>. </p> </li> </ul>
		 ...
		 */
		DisposePackageVersions(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, requestBody: DisposePackageVersionsPostBody): Observable<DisposePackageVersionsResult> {
		 ...
		 * @param {string} _namespace <p>The namespace of the package version with the requested asset file. The package version component that specifies its namespace depends on its type. For example:</p> <ul> <li> <p> The namespace of a Maven package version is its <code>groupId</code>. </p> </li> <li> <p> The namespace of an npm package version is its <code>scope</code>. </p> </li> <li> <p> Python and NuGet package versions do not contain a corresponding component, package versions of those formats do not have a namespace. </p> </li> <li> <p> The namespace of a generic package is its <code>namespace</code>. </p> </li> </ul>
		 ...
		 */
		GetPackageVersionAsset(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, version: string, asset: string, revision: string | null | undefined): Observable<GetPackageVersionAssetResult> {
			return this.http.get<GetPackageVersionAssetResult>(this.baseUri + 'v1/package/version/asset#domain&repository&format&package&version&asset?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&_package=' + (_package == null ? '' : encodeURIComponent(_package)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&asset=' + (asset == null ? '' : encodeURIComponent(asset)) + '&revision=' + (revision == null ? '' : encodeURIComponent(revision)), {});
		}
		 ...
		 */
		GetPackageVersionReadme(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, version: string): Observable<GetPackageVersionReadmeResult> {
		 ...
		 * @param {string} _namespace <p>The namespace of the package version that contains the requested package version assets. The package version component that specifies its namespace depends on its type. For example:</p> <ul> <li> <p> The namespace of a Maven package version is its <code>groupId</code>. </p> </li> <li> <p> The namespace of an npm package version is its <code>scope</code>. </p> </li> <li> <p> Python and NuGet package versions do not contain a corresponding component, package versions of those formats do not have a namespace. </p> </li> <li> <p> The namespace of a generic package is its <code>namespace</code>. </p> </li> </ul>
		 ...
		 */
		ListPackageVersionAssets(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, version: string, max_results: number | null | undefined, next_token: string | null | undefined, maxResults: string | null | undefined, nextToken: string | null | undefined): Observable<ListPackageVersionAssetsResult> {
			return this.http.post<ListPackageVersionAssetsResult>(this.baseUri + 'v1/package/version/assets#domain&repository&format&package&version?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&_package=' + (_package == null ? '' : encodeURIComponent(_package)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), null, {});
		}
		 ...
		 * @param {string} _namespace <p>The namespace of the package version with the requested dependencies. The package version component that specifies its namespace depends on its type. For example:</p> <ul> <li> <p> The namespace of a Maven package version is its <code>groupId</code>. </p> </li> <li> <p> The namespace of an npm package version is its <code>scope</code>. </p> </li> <li> <p> Python and NuGet package versions do not contain a corresponding component, package versions of those formats do not have a namespace. </p> </li> <li> <p> The namespace of a generic package is its <code>namespace</code>. </p> </li> </ul>
		 * @param {string} _package  The name of the package versions' package. 
		 * @param {string} version  A string that contains the package version (for example, <code>3.5.2</code>). 
		 * @param {string} next_token  The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results. 
		 * @return {ListPackageVersionDependenciesResult} Success
		 */
		ListPackageVersionDependencies(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, version: string, next_token: string | null | undefined): Observable<ListPackageVersionDependenciesResult> {
			return this.http.post<ListPackageVersionDependenciesResult>(this.baseUri + 'v1/package/version/dependencies#domain&repository&format&package&version?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&_package=' + (_package == null ? '' : encodeURIComponent(_package)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)), null, {});
		}
		 ...
		 * @param {string} _namespace <p>The namespace of the package that contains the requested package versions. The package component that specifies its namespace depends on its type. For example:</p> <ul> <li> <p> The namespace of a Maven package is its <code>groupId</code>. </p> </li> <li> <p> The namespace of an npm package is its <code>scope</code>. </p> </li> <li> <p> Python and NuGet packages do not contain a corresponding component, packages of those formats do not have a namespace. </p> </li> <li> <p> The namespace of a generic package is its <code>namespace</code>. </p> </li> </ul>
		 ...
		 */
		ListPackageVersions(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, status: PackageVersionStatus | null | undefined, sortBy: PackageVersionSortType | null | undefined, max_results: number | null | undefined, next_token: string | null | undefined, originType: PackageVersionOriginType | null | undefined, maxResults: string | null | undefined, nextToken: string | null | undefined): Observable<ListPackageVersionsResult> {
			return this.http.post<ListPackageVersionsResult>(this.baseUri + 'v1/package/versions#domain&repository&format&package?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&_package=' + (_package == null ? '' : encodeURIComponent(_package)) + '&status=' + status + '&sortBy=' + sortBy + '&max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&originType=' + originType + '&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), null, {});
		}
		 ...
		 */
		ListPackages(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat | null | undefined, _namespace: string | null | undefined, package_prefix: string | null | undefined, max_results: number | null | undefined, next_token: string | null | undefined, publish: AllowPublish | null | undefined, upstream: AllowPublish | null | undefined, maxResults: string | null | undefined, nextToken: string | null | undefined): Observable<ListPackagesResult> {
			return this.http.post<ListPackagesResult>(this.baseUri + 'v1/packages#domain&repository?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&package_prefix=' + (package_prefix == null ? '' : encodeURIComponent(package_prefix)) + '&max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&publish=' + publish + '&upstream=' + upstream + '&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), null, {});
		}
		 ...
		 * @param {string} _namespace The namespace of the package version to publish.
		 ...
		 */
		PublishPackageVersion(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, version: string, asset: string, unfinished: boolean | null | undefined, requestBody: PublishPackageVersionPostBody): Observable<PublishPackageVersionResult> {
			return this.http.post<PublishPackageVersionResult>(this.baseUri + 'v1/package/version/publish#domain&repository&format&package&version&asset&x-amz-content-sha256?domain=' + (domain == null ? '' : encodeURIComponent(domain)) + '&domain_owner=' + (domain_owner == null ? '' : encodeURIComponent(domain_owner)) + '&repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&format=' + format + '&_namespace=' + (_namespace == null ? '' : encodeURIComponent(_namespace)) + '&_package=' + (_package == null ? '' : encodeURIComponent(_package)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&asset=' + (asset == null ? '' : encodeURIComponent(asset)) + '&unfinished=' + unfinished, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} _namespace <p>The namespace of the package version to be updated. The package version component that specifies its namespace depends on its type. For example:</p> <ul> <li> <p> The namespace of a Maven package version is its <code>groupId</code>. </p> </li> <li> <p> The namespace of an npm package version is its <code>scope</code>. </p> </li> <li> <p> Python and NuGet package versions do not contain a corresponding component, package versions of those formats do not have a namespace. </p> </li> <li> <p> The namespace of a generic package is its <code>namespace</code>. </p> </li> </ul>
		 ...
		 */
		UpdatePackageVersionsStatus(domain: string, domain_owner: string | null | undefined, repository: string, format: PackageFormat, _namespace: string | null | undefined, _package: string, requestBody: UpdatePackageVersionsStatusPostBody): Observable<UpdatePackageVersionsStatusResult> {
