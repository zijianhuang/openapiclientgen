...
export namespace MyNS {
	...
	/** Config for FACE_DETECTION. */
	export interface GoogleCloudVideointelligenceV1_FaceDetectionConfigFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1_FaceDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1_FaceDetectionConfigFormProperties>({
	...
	export enum GoogleCloudVideointelligenceV1_LabelDetectionConfigLabelDetectionMode { LABEL_DETECTION_MODE_UNSPECIFIED = 'LABEL_DETECTION_MODE_UNSPECIFIED', SHOT_MODE = 'SHOT_MODE', FRAME_MODE = 'FRAME_MODE', SHOT_AND_FRAME_MODE = 'SHOT_AND_FRAME_MODE' }
	...
	/** Config for PERSON_DETECTION. */
	export interface GoogleCloudVideointelligenceV1_PersonDetectionConfigFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1_PersonDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1_PersonDetectionConfigFormProperties>({
			includeAttributes: new FormControl<boolean | null | undefined>(undefined),
			includeBoundingBoxes: new FormControl<boolean | null | undefined>(undefined),
	...
	export class MyClient {
		 ...
		 * @return {GoogleProtobuf_Empty} Successful response
		 */
		Videointelligence_operations_projects_locations_operations_delete(name: string): Observable<GoogleProtobuf_Empty> {
			return this.http.delete<GoogleProtobuf_Empty>(this.baseUri + 'v1/operations/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 */
		Videointelligence_operations_projects_locations_operations_get(name: string): Observable<GoogleLongrunning_Operation> {
			return this.http.get<GoogleLongrunning_Operation>(this.baseUri + 'v1/operations/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * @return {GoogleProtobuf_Empty} Successful response
		 */
		Videointelligence_operations_projects_locations_operations_cancel(name: string): Observable<GoogleProtobuf_Empty> {
			return this.http.post<GoogleProtobuf_Empty>(this.baseUri + 'v1/operations/' + (name == null ? '' : encodeURIComponent(name)) + ':cancel', null, {});
		}
		 ...
		 * @return {GoogleLongrunning_Operation} Successful response
		 */
		Videointelligence_videos_annotate(requestBody: GoogleCloudVideointelligenceV1_AnnotateVideoRequest): Observable<GoogleLongrunning_Operation> {
			return this.http.post<GoogleLongrunning_Operation>(this.baseUri + 'v1/videos:annotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleProtobuf_Empty} Successful response
		 */
		Videointelligence_projects_locations_operations_delete(name: string): Observable<GoogleProtobuf_Empty> {
			return this.http.delete<GoogleProtobuf_Empty>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * @return {GoogleLongrunning_Operation} Successful response
		 */
		Videointelligence_projects_locations_operations_get(name: string): Observable<GoogleLongrunning_Operation> {
			return this.http.get<GoogleLongrunning_Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 */
		Videointelligence_projects_locations_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleLongrunning_ListOperationsResponse> {
			return this.http.get<GoogleLongrunning_ListOperationsResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/operations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleProtobuf_Empty} Successful response
		 */
		Videointelligence_projects_locations_operations_cancel(name: string, requestBody: GoogleLongrunning_CancelOperationRequest): Observable<GoogleProtobuf_Empty> {
			return this.http.post<GoogleProtobuf_Empty>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':cancel', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
