...
export namespace MyNS {
	...
	export enum TensorflowTensorProtoDtype { DT_INVALID = 0, DT_FLOAT = 1, DT_DOUBLE = 2, DT_INT32 = 3, DT_UINT8 = 4, DT_INT16 = 5, DT_INT8 = 6, DT_STRING = 7, DT_COMPLEX64 = 8, DT_INT64 = 9, DT_BOOL = 10, DT_QINT8 = 11, DT_QUINT8 = 12, DT_QINT32 = 13, DT_BFLOAT16 = 14, DT_QINT16 = 15, DT_QUINT16 = 16, DT_UINT16 = 17, DT_COMPLEX128 = 18, DT_HALF = 19, DT_RESOURCE = 20, DT_VARIANT = 21, DT_UINT32 = 22, DT_UINT64 = 23, DT_FLOAT_REF = 24, DT_DOUBLE_REF = 25, DT_INT32_REF = 26, DT_UINT8_REF = 27, DT_INT16_REF = 28, DT_INT8_REF = 29, DT_STRING_REF = 30, DT_COMPLEX64_REF = 31, DT_INT64_REF = 32, DT_BOOL_REF = 33, DT_QINT8_REF = 34, DT_QUINT8_REF = 35, DT_QINT32_REF = 36, DT_BFLOAT16_REF = 37, DT_QINT16_REF = 38, DT_QUINT16_REF = 39, DT_UINT16_REF = 40, DT_COMPLEX128_REF = 41, DT_HALF_REF = 42, DT_RESOURCE_REF = 43, DT_VARIANT_REF = 44, DT_UINT32_REF = 45, DT_UINT64_REF = 46 }
	...
	export enum MetricType { COUNTER = 0, GAUGE = 1, TIMER = 2 }
	...
	export enum StatusStatus { SUCCESS = 0, FAILURE = 1 }
	...
	export enum StatusStatusFlag { SUCCESS = 0, FAILURE = 1 }
	 ...
	 * should have a corresponding value below (verified by types_test).
	 */
	export enum TensorflowDataType { DT_INVALID = 0, DT_FLOAT = 1, DT_DOUBLE = 2, DT_INT32 = 3, DT_UINT8 = 4, DT_INT16 = 5, DT_INT8 = 6, DT_STRING = 7, DT_COMPLEX64 = 8, DT_INT64 = 9, DT_BOOL = 10, DT_QINT8 = 11, DT_QUINT8 = 12, DT_QINT32 = 13, DT_BFLOAT16 = 14, DT_QINT16 = 15, DT_QUINT16 = 16, DT_UINT16 = 17, DT_COMPLEX128 = 18, DT_HALF = 19, DT_RESOURCE = 20, DT_VARIANT = 21, DT_UINT32 = 22, DT_UINT64 = 23, DT_FLOAT_REF = 24, DT_DOUBLE_REF = 25, DT_INT32_REF = 26, DT_UINT8_REF = 27, DT_INT16_REF = 28, DT_INT8_REF = 29, DT_STRING_REF = 30, DT_COMPLEX64_REF = 31, DT_INT64_REF = 32, DT_BOOL_REF = 33, DT_QINT8_REF = 34, DT_QUINT8_REF = 35, DT_QINT32_REF = 36, DT_BFLOAT16_REF = 37, DT_QINT16_REF = 38, DT_QUINT16_REF = 39, DT_UINT16_REF = 40, DT_COMPLEX128_REF = 41, DT_HALF_REF = 42, DT_RESOURCE_REF = 43, DT_VARIANT_REF = 44, DT_UINT32_REF = 45, DT_UINT64_REF = 46 }
