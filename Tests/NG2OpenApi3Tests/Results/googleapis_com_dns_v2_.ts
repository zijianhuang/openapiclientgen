...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Dns_projects_get(project: string, location: string, clientOperationId: string | null | undefined): Observable<Project> {
			return this.http.get<Project>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}
		 ...
		 */
		Dns_managedZones_list(project: string, location: string, dnsName: string | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<ManagedZonesListResponse> {
			return this.http.get<ManagedZonesListResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones&dnsName=' + (dnsName == null ? '' : encodeURIComponent(dnsName)) + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Dns_managedZones_create(project: string, location: string, clientOperationId: string | null | undefined, requestBody: ManagedZone): Observable<ManagedZone> {
			return this.http.post<ManagedZone>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Dns_managedZones_delete(project: string, location: string, managedZone: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {ManagedZone} Successful response
		 */
		Dns_managedZones_get(project: string, location: string, managedZone: string, clientOperationId: string | null | undefined): Observable<ManagedZone> {
			return this.http.get<ManagedZone>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}
		 ...
		 */
		Dns_managedZones_patch(project: string, location: string, managedZone: string, clientOperationId: string | null | undefined, requestBody: ManagedZone): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Dns_managedZones_update(project: string, location: string, managedZone: string, clientOperationId: string | null | undefined, requestBody: ManagedZone): Observable<Operation> {
		 ...
		 */
		Dns_changes_list(project: string, location: string, managedZone: string, maxResults: number | null | undefined, pageToken: string | null | undefined, sortBy: Dns_changes_listSortBy | null | undefined, sortOrder: string | null | undefined): Observable<ChangesListResponse> {
			return this.http.get<ChangesListResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/changes&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&sortBy=' + sortBy + '&sortOrder=' + (sortOrder == null ? '' : encodeURIComponent(sortOrder)), {});
		}
		 ...
		 */
		Dns_changes_create(project: string, location: string, managedZone: string, clientOperationId: string | null | undefined, requestBody: Change): Observable<Change> {
			return this.http.post<Change>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/changes&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Change} Successful response
		 */
		Dns_changes_get(project: string, location: string, managedZone: string, changeId: string, clientOperationId: string | null | undefined): Observable<Change> {
			return this.http.get<Change>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/changes/' + (changeId == null ? '' : encodeURIComponent(changeId)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}
		 ...
		 */
		Dns_dnsKeys_list(project: string, location: string, managedZone: string, digestType: string | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<DnsKeysListResponse> {
			return this.http.get<DnsKeysListResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/dnsKeys&digestType=' + (digestType == null ? '' : encodeURIComponent(digestType)) + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Dns_dnsKeys_get(project: string, location: string, managedZone: string, dnsKeyId: string, clientOperationId: string | null | undefined, digestType: string | null | undefined): Observable<DnsKey> {
			return this.http.get<DnsKey>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/dnsKeys/' + (dnsKeyId == null ? '' : encodeURIComponent(dnsKeyId)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)) + '&digestType=' + (digestType == null ? '' : encodeURIComponent(digestType)), {});
		}
		 ...
		 */
		Dns_managedZoneOperations_list(project: string, location: string, managedZone: string, maxResults: number | null | undefined, pageToken: string | null | undefined, sortBy: Dns_managedZoneOperations_listSortBy | null | undefined): Observable<ManagedZoneOperationsListResponse> {
			return this.http.get<ManagedZoneOperationsListResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/operations&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&sortBy=' + sortBy, {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Dns_managedZoneOperations_get(project: string, location: string, managedZone: string, operation: string, clientOperationId: string | null | undefined): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/operations/' + (operation == null ? '' : encodeURIComponent(operation)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}
		 ...
		 */
		Dns_resourceRecordSets_list(project: string, location: string, managedZone: string, maxResults: number | null | undefined, name: string | null | undefined, pageToken: string | null | undefined, type: string | null | undefined): Observable<ResourceRecordSetsListResponse> {
			return this.http.get<ResourceRecordSetsListResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/rrsets&maxResults=' + maxResults + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&type=' + (type == null ? '' : encodeURIComponent(type)), {});
		}
		 ...
		 */
		Dns_resourceRecordSets_create(project: string, location: string, managedZone: string, clientOperationId: string | null | undefined, requestBody: ResourceRecordSet): Observable<ResourceRecordSet> {
			return this.http.post<ResourceRecordSet>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/rrsets&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Successful response
		 */
		Dns_resourceRecordSets_delete(project: string, location: string, managedZone: string, name: string, type: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/managedZones/' + (managedZone == null ? '' : encodeURIComponent(managedZone)) + '/rrsets/' + (name == null ? '' : encodeURIComponent(name)) + '/' + (type == null ? '' : encodeURIComponent(type)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {ResourceRecordSet} Successful response
		 */
		Dns_resourceRecordSets_get(project: string, location: string, managedZone: string, name: string, type: string, clientOperationId: string | null | undefined): Observable<ResourceRecordSet> {
		 ...
		 * @return {ResourceRecordSet} Successful response
		 */
		Dns_resourceRecordSets_patch(project: string, location: string, managedZone: string, name: string, type: string, clientOperationId: string | null | undefined, requestBody: ResourceRecordSet): Observable<ResourceRecordSet> {
		 ...
		 */
		Dns_policies_list(project: string, location: string, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<PoliciesListResponse> {
			return this.http.get<PoliciesListResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/policies&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Dns_policies_create(project: string, location: string, clientOperationId: string | null | undefined, requestBody: Policy): Observable<Policy> {
			return this.http.post<Policy>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/policies&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Successful response
		 */
		Dns_policies_delete(project: string, location: string, policy: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/policies/' + (policy == null ? '' : encodeURIComponent(policy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {Policy} Successful response
		 */
		Dns_policies_get(project: string, location: string, policy: string, clientOperationId: string | null | undefined): Observable<Policy> {
			return this.http.get<Policy>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/policies/' + (policy == null ? '' : encodeURIComponent(policy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}
		 ...
		 */
		Dns_policies_patch(project: string, location: string, policy: string, clientOperationId: string | null | undefined, requestBody: Policy): Observable<PoliciesPatchResponse> {
			return this.http.patch<PoliciesPatchResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/policies/' + (policy == null ? '' : encodeURIComponent(policy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Dns_policies_update(project: string, location: string, policy: string, clientOperationId: string | null | undefined, requestBody: Policy): Observable<PoliciesUpdateResponse> {
		 ...
		 */
		Dns_responsePolicies_list(project: string, location: string, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<ResponsePoliciesListResponse> {
			return this.http.get<ResponsePoliciesListResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Dns_responsePolicies_create(project: string, location: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicy): Observable<ResponsePolicy> {
			return this.http.post<ResponsePolicy>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Successful response
		 */
		Dns_responsePolicies_delete(project: string, location: string, responsePolicy: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {ResponsePolicy} Successful response
		 */
		Dns_responsePolicies_get(project: string, location: string, responsePolicy: string, clientOperationId: string | null | undefined): Observable<ResponsePolicy> {
			return this.http.get<ResponsePolicy>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}
		 ...
		 */
		Dns_responsePolicies_patch(project: string, location: string, responsePolicy: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicy): Observable<ResponsePoliciesPatchResponse> {
			return this.http.patch<ResponsePoliciesPatchResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Dns_responsePolicies_update(project: string, location: string, responsePolicy: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicy): Observable<ResponsePoliciesUpdateResponse> {
		 ...
		 */
		Dns_responsePolicyRules_list(project: string, location: string, responsePolicy: string, maxResults: number | null | undefined, pageToken: string | null | undefined): Observable<ResponsePolicyRulesListResponse> {
			return this.http.get<ResponsePolicyRulesListResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Dns_responsePolicyRules_create(project: string, location: string, responsePolicy: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicyRule): Observable<ResponsePolicyRule> {
			return this.http.post<ResponsePolicyRule>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Successful response
		 */
		Dns_responsePolicyRules_delete(project: string, location: string, responsePolicy: string, responsePolicyRule: string, clientOperationId: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules/' + (responsePolicyRule == null ? '' : encodeURIComponent(responsePolicyRule)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {ResponsePolicyRule} Successful response
		 */
		Dns_responsePolicyRules_get(project: string, location: string, responsePolicy: string, responsePolicyRule: string, clientOperationId: string | null | undefined): Observable<ResponsePolicyRule> {
			return this.http.get<ResponsePolicyRule>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules/' + (responsePolicyRule == null ? '' : encodeURIComponent(responsePolicyRule)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), {});
		}
		 ...
		 */
		Dns_responsePolicyRules_patch(project: string, location: string, responsePolicy: string, responsePolicyRule: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicyRule): Observable<ResponsePolicyRulesPatchResponse> {
			return this.http.patch<ResponsePolicyRulesPatchResponse>(this.baseUri + 'dns/v2/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/responsePolicies/' + (responsePolicy == null ? '' : encodeURIComponent(responsePolicy)) + '/rules/' + (responsePolicyRule == null ? '' : encodeURIComponent(responsePolicyRule)) + '&clientOperationId=' + (clientOperationId == null ? '' : encodeURIComponent(clientOperationId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Dns_responsePolicyRules_update(project: string, location: string, responsePolicy: string, responsePolicyRule: string, clientOperationId: string | null | undefined, requestBody: ResponsePolicyRule): Observable<ResponsePolicyRulesUpdateResponse> {
		...
		Dns_managedZones_getIamPolicy(resource: string, requestBody: GoogleIamV1GetIamPolicyRequest): Observable<GoogleIamV1Policy> {
			return this.http.post<GoogleIamV1Policy>(this.baseUri + 'dns/v2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':getIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Dns_managedZones_setIamPolicy(resource: string, requestBody: GoogleIamV1SetIamPolicyRequest): Observable<GoogleIamV1Policy> {
			return this.http.post<GoogleIamV1Policy>(this.baseUri + 'dns/v2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':setIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Dns_managedZones_testIamPermissions(resource: string, requestBody: GoogleIamV1TestIamPermissionsRequest): Observable<GoogleIamV1TestIamPermissionsResponse> {
			return this.http.post<GoogleIamV1TestIamPermissionsResponse>(this.baseUri + 'dns/v2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':testIamPermissions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
