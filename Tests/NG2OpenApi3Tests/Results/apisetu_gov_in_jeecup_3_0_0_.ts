...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {AdcrdPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Adcrd(requestBody: AdcrdPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'adcrd/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface AdcrdPostBody {
		certificateParameters?: AdcrdPostBodyCertificateParameters;
	...
	export interface AdcrdPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<AdcrdPostBodyFormat | null | undefined>,
	...
	export function CreateAdcrdPostBodyFormGroup() {
		return new FormGroup<AdcrdPostBodyFormProperties>({
			format: new FormControl<AdcrdPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface AdcrdPostBodyCertificateParameters {
	...
	export interface AdcrdPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		ExamYear: FormControl<string | null | undefined>,
	...
	export function CreateAdcrdPostBodyCertificateParametersFormGroup() {
		return new FormGroup<AdcrdPostBodyCertificateParametersFormProperties>({
			...
			ExamYear: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum AdcrdPostBodyFormat { pdf = 'pdf' }
