...
export namespace MyNS {
	...
	export interface LpgsvPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		LPGId: FormControl<string | null | undefined>,

		/**
		 * SV No
		 * Required
		 */
		SVNo: FormControl<string | null | undefined>,
	...
	export function CreateLpgsvPostBodyCertificateParametersFormGroup() {
		return new FormGroup<LpgsvPostBodyCertificateParametersFormProperties>({
			...
			GENDER: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			LPGId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			SVNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			UID: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
