...
export namespace MyNS {
	...
	export class MyClient {
		...
		Oslogin_users_sshPublicKeys_get(name: string): Observable<SshPublicKey> {
			return this.http.get<SshPublicKey>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Oslogin_users_sshPublicKeys_patch(name: string, updateMask: string | null | undefined, requestBody: SshPublicKey): Observable<SshPublicKey> {
			return this.http.patch<SshPublicKey>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Oslogin_users_getLoginProfile(name: string, projectId: string | null | undefined, systemId: string | null | undefined, view: Oslogin_users_getLoginProfileView | null | undefined): Observable<LoginProfile> {
			return this.http.get<LoginProfile>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + '/loginProfile&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)) + '&systemId=' + (systemId == null ? '' : encodeURIComponent(systemId)) + '&view=' + view, {});
		}
		...
		Oslogin_users_sshPublicKeys_create(parent: string, requestBody: SshPublicKey): Observable<SshPublicKey> {
			return this.http.post<SshPublicKey>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/sshPublicKeys', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Oslogin_users_projects_zones_signSshPublicKey(parent: string, requestBody: SignSshPublicKeyRequest): Observable<SignSshPublicKeyResponse> {
			return this.http.post<SignSshPublicKeyResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + ':signSshPublicKey', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
