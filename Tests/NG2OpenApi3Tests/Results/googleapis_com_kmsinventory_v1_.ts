...
export namespace MyNS {
	...
	export enum GoogleCloudKmsV1KeyOperationAttestationFormat { ATTESTATION_FORMAT_UNSPECIFIED = 0, CAVIUM_V1_COMPRESSED = 1, CAVIUM_V2_COMPRESSED = 2 }
	...
	export enum GoogleCloudKmsV1CryptoKeyVersionProtectionLevel { PROTECTION_LEVEL_UNSPECIFIED = 0, SOFTWARE = 1, HSM = 2, EXTERNAL = 3, EXTERNAL_VPC = 4 }

	export enum GoogleCloudKmsV1CryptoKeyVersionState { CRYPTO_KEY_VERSION_STATE_UNSPECIFIED = 0, PENDING_GENERATION = 1, ENABLED = 2, DISABLED = 3, DESTROYED = 4, DESTROY_SCHEDULED = 5, PENDING_IMPORT = 6, IMPORT_FAILED = 7, GENERATION_FAILED = 8, PENDING_EXTERNAL_DESTRUCTION = 9, EXTERNAL_DESTRUCTION_FAILED = 10 }

	export enum GoogleCloudKmsV1CryptoKeyPurpose { CRYPTO_KEY_PURPOSE_UNSPECIFIED = 0, ENCRYPT_DECRYPT = 1, ASYMMETRIC_SIGN = 2, ASYMMETRIC_DECRYPT = 3, RAW_ENCRYPT_DECRYPT = 4, MAC = 5 }
