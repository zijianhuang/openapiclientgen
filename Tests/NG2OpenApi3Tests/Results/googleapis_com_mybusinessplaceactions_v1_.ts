...
export namespace MyNS {
	...
	export enum PlaceActionLinkPlaceActionType { PLACE_ACTION_TYPE_UNSPECIFIED = 0, APPOINTMENT = 1, ONLINE_APPOINTMENT = 2, DINING_RESERVATION = 3, FOOD_ORDERING = 4, FOOD_DELIVERY = 5, FOOD_TAKEOUT = 6, SHOP_ONLINE = 7 }

	export enum PlaceActionLinkProviderType { PROVIDER_TYPE_UNSPECIFIED = 0, MERCHANT = 1, AGGREGATOR_3P = 2 }
