...
export namespace MyNS {
	...
	export enum AccountRole { ACCOUNT_ROLE_UNSPECIFIED = 0, PRIMARY_OWNER = 1, OWNER = 2, MANAGER = 3, SITE_MANAGER = 4 }

	export enum AccountType { ACCOUNT_TYPE_UNSPECIFIED = 0, PERSONAL = 1, LOCATION_GROUP = 2, USER_GROUP = 3, ORGANIZATION = 4 }

	export enum AccountVerificationState { VERIFICATION_STATE_UNSPECIFIED = 0, VERIFIED = 1, UNVERIFIED = 2, VERIFICATION_REQUESTED = 3 }

	export enum AccountVettedState { VETTED_STATE_UNSPECIFIED = 0, NOT_VETTED = 1, VETTED = 2, INVALID = 3 }
	...
	export enum AdminRole { ADMIN_ROLE_UNSPECIFIED = 0, PRIMARY_OWNER = 1, OWNER = 2, MANAGER = 3, SITE_MANAGER = 4 }
	...
	export enum InvitationTargetType { TARGET_TYPE_UNSPECIFIED = 0, ACCOUNTS_ONLY = 1, LOCATIONS_ONLY = 2 }
