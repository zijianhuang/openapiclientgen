...
export namespace MyNS {
	...
	export enum GoogleCloudAssetV1p7beta1PartitionSpecPartitionKey { PARTITION_KEY_UNSPECIFIED = 0, READ_TIME = 1, REQUEST_TIME = 2 }
	...
	export enum GoogleCloudAssetV1p7beta1ExportAssetsRequestContentType { CONTENT_TYPE_UNSPECIFIED = 0, RESOURCE = 1, IAM_POLICY = 2, ORG_POLICY = 3, ACCESS_POLICY = 4, RELATIONSHIP = 5 }
