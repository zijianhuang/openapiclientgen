...
export namespace MyNS {
	...
	/** A BigQuery destination for exporting assets to. */
	export interface GoogleCloudAssetV1p7beta1BigQueryDestinationFormProperties {
	...
	export function CreateGoogleCloudAssetV1p7beta1BigQueryDestinationFormGroup() {
		return new FormGroup<GoogleCloudAssetV1p7beta1BigQueryDestinationFormProperties>({
	...
	export interface GoogleCloudAssetV1p7beta1PartitionSpec {
		...
		partitionKey?: GoogleCloudAssetV1p7beta1PartitionSpecPartitionKey | null;
	}

	/** Specifications of BigQuery partitioned table as export destination. */
	export interface GoogleCloudAssetV1p7beta1PartitionSpecFormProperties {

		/** The partition key for BigQuery partitioned table. */
		partitionKey: FormControl<GoogleCloudAssetV1p7beta1PartitionSpecPartitionKey | null | undefined>,
	}
	export function CreateGoogleCloudAssetV1p7beta1PartitionSpecFormGroup() {
		return new FormGroup<GoogleCloudAssetV1p7beta1PartitionSpecFormProperties>({
			partitionKey: new FormControl<GoogleCloudAssetV1p7beta1PartitionSpecPartitionKey | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudAssetV1p7beta1PartitionSpecPartitionKey { PARTITION_KEY_UNSPECIFIED = 'PARTITION_KEY_UNSPECIFIED', READ_TIME = 'READ_TIME', REQUEST_TIME = 'REQUEST_TIME' }
	...
	export interface GoogleCloudAssetV1p7beta1ExportAssetsRequest {
		...
		contentType?: GoogleCloudAssetV1p7beta1ExportAssetsRequestContentType | null;
	...
	/** Export asset request. */
	export interface GoogleCloudAssetV1p7beta1ExportAssetsRequestFormProperties {

		/** Asset content type. If not specified, no content but the asset name will be returned. */
		contentType: FormControl<GoogleCloudAssetV1p7beta1ExportAssetsRequestContentType | null | undefined>,

		/** Timestamp to take an asset snapshot. This can only be set to a timestamp between the current time and the current time minus 35 days (inclusive). If not specified, the current time will be used. Due to delays in resource data collection and indexing, there is a volatile window during which running the same query may get different results. */
		readTime: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudAssetV1p7beta1ExportAssetsRequestFormGroup() {
		return new FormGroup<GoogleCloudAssetV1p7beta1ExportAssetsRequestFormProperties>({
			contentType: new FormControl<GoogleCloudAssetV1p7beta1ExportAssetsRequestContentType | null | undefined>(undefined),
			readTime: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudAssetV1p7beta1ExportAssetsRequestContentType { CONTENT_TYPE_UNSPECIFIED = 'CONTENT_TYPE_UNSPECIFIED', RESOURCE = 'RESOURCE', IAM_POLICY = 'IAM_POLICY', ORG_POLICY = 'ORG_POLICY', ACCESS_POLICY = 'ACCESS_POLICY', RELATIONSHIP = 'RELATIONSHIP' }
	...
	/** Output configuration for export assets destination. */
	export interface GoogleCloudAssetV1p7beta1OutputConfigFormProperties {
	}
	export function CreateGoogleCloudAssetV1p7beta1OutputConfigFormGroup() {
		return new FormGroup<GoogleCloudAssetV1p7beta1OutputConfigFormProperties>({
		});
	...
	/** A Cloud Storage location. */
	export interface GoogleCloudAssetV1p7beta1GcsDestinationFormProperties {
	...
	export function CreateGoogleCloudAssetV1p7beta1GcsDestinationFormGroup() {
		return new FormGroup<GoogleCloudAssetV1p7beta1GcsDestinationFormProperties>({
	...
	export class MyClient {
		 ...
		 */
		Cloudasset_operations_get(name: string): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'v1p7beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Cloudasset_exportAssets(parent: string, requestBody: GoogleCloudAssetV1p7beta1ExportAssetsRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1p7beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + ':exportAssets', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
