...
export namespace MyNS {
	...
	export enum GoogleCloudPolicysimulatorV1AccessStateDiffAccessChange { ACCESS_CHANGE_TYPE_UNSPECIFIED = 'ACCESS_CHANGE_TYPE_UNSPECIFIED', NO_CHANGE = 'NO_CHANGE', UNKNOWN_CHANGE = 'UNKNOWN_CHANGE', ACCESS_REVOKED = 'ACCESS_REVOKED', ACCESS_GAINED = 'ACCESS_GAINED', ACCESS_MAYBE_REVOKED = 'ACCESS_MAYBE_REVOKED', ACCESS_MAYBE_GAINED = 'ACCESS_MAYBE_GAINED' }
	...
	export enum GoogleCloudPolicysimulatorV1ExplainedAccessAccessState { ACCESS_STATE_UNSPECIFIED = 'ACCESS_STATE_UNSPECIFIED', GRANTED = 'GRANTED', NOT_GRANTED = 'NOT_GRANTED', UNKNOWN_CONDITIONAL = 'UNKNOWN_CONDITIONAL', UNKNOWN_INFO_DENIED = 'UNKNOWN_INFO_DENIED' }
