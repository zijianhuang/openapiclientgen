...
export namespace MyNS {
	...
	export interface GoogleCloudPolicysimulatorV1AccessStateDiff {
		...
		accessChange?: GoogleCloudPolicysimulatorV1AccessStateDiffAccessChange | null;
	...
	/** A summary and comparison of the principal's access under the current (baseline) policies and the proposed (simulated) policies for a single access tuple. */
	export interface GoogleCloudPolicysimulatorV1AccessStateDiffFormProperties {

		/** How the principal's access, specified in the AccessState field, changed between the current (baseline) policies and proposed (simulated) policies. */
		accessChange: FormControl<GoogleCloudPolicysimulatorV1AccessStateDiffAccessChange | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1AccessStateDiffFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1AccessStateDiffFormProperties>({
			accessChange: new FormControl<GoogleCloudPolicysimulatorV1AccessStateDiffAccessChange | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudPolicysimulatorV1AccessStateDiffAccessChange { ACCESS_CHANGE_TYPE_UNSPECIFIED = 0, NO_CHANGE = 1, UNKNOWN_CHANGE = 2, ACCESS_REVOKED = 3, ACCESS_GAINED = 4, ACCESS_MAYBE_REVOKED = 5, ACCESS_MAYBE_GAINED = 6 }
	...
	export interface GoogleCloudPolicysimulatorV1ExplainedAccess {
		...
		accessState?: GoogleCloudPolicysimulatorV1ExplainedAccessAccessState | null;
	...
	/** Details about how a set of policies, listed in ExplainedPolicy, resulted in a certain AccessState when replaying an access tuple. */
	export interface GoogleCloudPolicysimulatorV1ExplainedAccessFormProperties {

		/** Whether the principal in the access tuple has permission to access the resource in the access tuple under the given policies. */
		accessState: FormControl<GoogleCloudPolicysimulatorV1ExplainedAccessAccessState | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1ExplainedAccessFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1ExplainedAccessFormProperties>({
			accessState: new FormControl<GoogleCloudPolicysimulatorV1ExplainedAccessAccessState | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudPolicysimulatorV1ExplainedAccessAccessState { ACCESS_STATE_UNSPECIFIED = 0, GRANTED = 1, NOT_GRANTED = 2, UNKNOWN_CONDITIONAL = 3, UNKNOWN_INFO_DENIED = 4 }
	...
	export interface GoogleCloudPolicysimulatorV1ExplainedPolicy {
		...
		access?: GoogleCloudPolicysimulatorV1ExplainedAccessAccessState | null;
		...
		relevance?: GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null;
	}

	/** Details about how a specific IAM Policy contributed to the access check. */
	export interface GoogleCloudPolicysimulatorV1ExplainedPolicyFormProperties {

		/** Indicates whether _this policy_ provides the specified permission to the specified principal for the specified resource. This field does _not_ indicate whether the principal actually has the permission for the resource. There might be another policy that overrides this policy. To determine whether the principal actually has the permission, use the `access` field in the TroubleshootIamPolicyResponse. */
		access: FormControl<GoogleCloudPolicysimulatorV1ExplainedAccessAccessState | null | undefined>,

		/** The full resource name that identifies the resource. For example, `//compute.googleapis.com/projects/my-project/zones/us-central1-a/instances/my-instance`. If the user who created the Replay does not have access to the policy, this field is omitted. For examples of full resource names for Google Cloud services, see https://cloud.google.com/iam/help/troubleshooter/full-resource-names. */
		fullResourceName: FormControl<string | null | undefined>,

		/** The relevance of this policy to the overall determination in the TroubleshootIamPolicyResponse. If the user who created the Replay does not have access to the policy, this field is omitted. */
		relevance: FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1ExplainedPolicyFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1ExplainedPolicyFormProperties>({
			access: new FormControl<GoogleCloudPolicysimulatorV1ExplainedAccessAccessState | null | undefined>(undefined),
			fullResourceName: new FormControl<string | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudPolicysimulatorV1BindingExplanation {
		...
		memberships?: {[id: string]: GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership };
		...
		rolePermission?: GoogleCloudPolicysimulatorV1BindingExplanationRolePermission | null;

		/** The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy. */
		rolePermissionRelevance?: GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null;
	}

	/** Details about how a binding in a policy affects a principal's ability to use a permission. */
	export interface GoogleCloudPolicysimulatorV1BindingExplanationFormProperties {

		/** Required. Indicates whether _this binding_ provides the specified permission to the specified principal for the specified resource. This field does _not_ indicate whether the principal actually has the permission for the resource. There might be another binding that overrides this binding. To determine whether the principal actually has the permission, use the `access` field in the TroubleshootIamPolicyResponse. */
		access: FormControl<GoogleCloudPolicysimulatorV1ExplainedAccessAccessState | null | undefined>,

		/** Indicates whether each principal in the binding includes the principal specified in the request, either directly or indirectly. Each key identifies a principal in the binding, and each value indicates whether the principal in the binding includes the principal in the request. For example, suppose that a binding includes the following principals: * `user:alice@example.com` * `group:product-eng@example.com` The principal in the replayed access tuple is `user:bob@example.com`. This user is a principal of the group `group:product-eng@example.com`. For the first principal in the binding, the key is `user:alice@example.com`, and the `membership` field in the value is set to `MEMBERSHIP_NOT_INCLUDED`. For the second principal in the binding, the key is `group:product-eng@example.com`, and the `membership` field in the value is set to `MEMBERSHIP_INCLUDED`. */
		memberships: FormControl<{[id: string]: GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership } | null | undefined>,
		...
		/** Indicates whether the role granted by this binding contains the specified permission. */
		rolePermission: FormControl<GoogleCloudPolicysimulatorV1BindingExplanationRolePermission | null | undefined>,

		/** The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy. */
		rolePermissionRelevance: FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1BindingExplanationFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1BindingExplanationFormProperties>({
			access: new FormControl<GoogleCloudPolicysimulatorV1ExplainedAccessAccessState | null | undefined>(undefined),
			memberships: new FormControl<{[id: string]: GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership } | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
			role: new FormControl<string | null | undefined>(undefined),
			rolePermission: new FormControl<GoogleCloudPolicysimulatorV1BindingExplanationRolePermission | null | undefined>(undefined),
			rolePermissionRelevance: new FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});
	...
	export interface GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership {
		...
		membership?: GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipMembership | null;
	...
	/** Details about whether the binding includes the principal. */
	export interface GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipFormProperties {

		/** Indicates whether the binding includes the principal. */
		membership: FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipMembership | null | undefined>,

		/** The relevance of the principal's status to the overall determination for the binding. */
		relevance: FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipFormProperties>({
			membership: new FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipMembership | null | undefined>(undefined),
			relevance: new FormControl<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance | null | undefined>(undefined),
		});

	}

	export enum GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipMembership { MEMBERSHIP_UNSPECIFIED = 0, MEMBERSHIP_INCLUDED = 1, MEMBERSHIP_NOT_INCLUDED = 2, MEMBERSHIP_UNKNOWN_INFO_DENIED = 3, MEMBERSHIP_UNKNOWN_UNSUPPORTED = 4 }

	export enum GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance { HEURISTIC_RELEVANCE_UNSPECIFIED = 0, NORMAL = 1, HIGH = 2 }

	export enum GoogleCloudPolicysimulatorV1BindingExplanationRolePermission { ROLE_PERMISSION_UNSPECIFIED = 0, ROLE_PERMISSION_INCLUDED = 1, ROLE_PERMISSION_NOT_INCLUDED = 2, ROLE_PERMISSION_UNKNOWN_INFO_DENIED = 3 }
	...
	/** Information about the principal, resource, and permission to check. */
	export interface GoogleCloudPolicysimulatorV1AccessTupleFormProperties {
	...
	export function CreateGoogleCloudPolicysimulatorV1AccessTupleFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1AccessTupleFormProperties>({
			fullResourceName: new FormControl<string | null | undefined>(undefined),
	...
	/** Response message for Simulator.ListReplayResults. */
	export interface GoogleCloudPolicysimulatorV1ListReplayResultsResponseFormProperties {

		/** A token that you can use to retrieve the next page of ReplayResult objects. If this field is omitted, there are no subsequent pages. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudPolicysimulatorV1ListReplayResultsResponseFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1ListReplayResultsResponseFormProperties>({
	...
	/** The result of replaying a single access tuple against a simulated state. */
	export interface GoogleCloudPolicysimulatorV1ReplayResultFormProperties {
	...
	export function CreateGoogleCloudPolicysimulatorV1ReplayResultFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1ReplayResultFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
	...
	/** The difference between the results of evaluating an access tuple under the current (baseline) policies and under the proposed (simulated) policies. This difference explains how a principal's access could change if the proposed policies were applied. */
	export interface GoogleCloudPolicysimulatorV1ReplayDiffFormProperties {
	}
	export function CreateGoogleCloudPolicysimulatorV1ReplayDiffFormGroup() {
		return new FormGroup<GoogleCloudPolicysimulatorV1ReplayDiffFormProperties>({
		});
	...
	export class MyClient {
		...
		Policysimulator_projects_locations_replays_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleLongrunningListOperationsResponse> {
			return this.http.get<GoogleLongrunningListOperationsResponse>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 */
		Policysimulator_projects_locations_replays_create(parent: string, requestBody: GoogleCloudPolicysimulatorV1Replay): Observable<GoogleLongrunningOperation> {
			return this.http.post<GoogleLongrunningOperation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/replays', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {GoogleCloudPolicysimulatorV1ListReplayResultsResponse} Successful response
		 */
		Policysimulator_projects_locations_replays_results_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleCloudPolicysimulatorV1ListReplayResultsResponse> {
			return this.http.get<GoogleCloudPolicysimulatorV1ListReplayResultsResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/results&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
	}
