...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {SkmstPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Skmst(requestBody: SkmstPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'skmst/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface SkcerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<SkcerPostBodyFormat | null | undefined>,
	...
	export function CreateSkcerPostBodyFormGroup() {
		return new FormGroup<SkcerPostBodyFormProperties>({
			format: new FormControl<SkcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface SkcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		RollNumber: FormControl<string | null | undefined>,
	...
	export function CreateSkcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SkcerPostBodyCertificateParametersFormProperties>({
			...
			RollNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export interface SkmstPostBodyFormProperties {
	...
	export function CreateSkmstPostBodyFormGroup() {
		return new FormGroup<SkmstPostBodyFormProperties>({
			format: new FormControl<SkcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SkmstPostBodyCertificateParameters {
	...
	export interface SkmstPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		Sem: FormControl<string | null | undefined>,
	...
	export function CreateSkmstPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SkmstPostBodyCertificateParametersFormProperties>({
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			RollNumber: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Sem: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Session: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
