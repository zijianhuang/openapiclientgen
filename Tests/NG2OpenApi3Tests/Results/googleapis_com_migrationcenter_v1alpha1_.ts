...
export namespace MyNS {
	...
	export enum VirtualMachineDetailsOsFamily { OS_FAMILY_UNKNOWN = 0, OS_FAMILY_WINDOWS = 1, OS_FAMILY_LINUX = 2, OS_FAMILY_UNIX = 3 }
	...
	export enum VirtualMachineArchitectureDetailsHyperthreading { HYPER_THREADING_UNSPECIFIED = 0, HYPER_THREADING_DISABLED = 1, HYPER_THREADING_ENABLED = 2 }
	...
	export enum GCSPayloadInfoFormat { IMPORT_JOB_FORMAT_UNSPECIFIED = 0, IMPORT_JOB_FORMAT_CMDB = 1, IMPORT_JOB_FORMAT_RVTOOLS_XLSX = 2, IMPORT_JOB_FORMAT_RVTOOLS_CSV = 3, IMPORT_JOB_FORMAT_EXPORTED_AWS_CSV = 4, IMPORT_JOB_FORMAT_EXPORTED_AZURE_CSV = 5, IMPORT_JOB_FORMAT_MANUAL_CSV = 6 }
	...
	export enum VirtualMachinePreferencesSizingOptimizationCustomParametersAggregationMethod { AGGREGATION_METHOD_UNSPECIFIED = 0, AGGREGATION_METHOD_AVERAGE = 1, AGGREGATION_METHOD_MEDIAN = 2, AGGREGATION_METHOD_NINETY_FIFTH_PERCENTILE = 3, AGGREGATION_METHOD_PEAK = 4 }

	export enum VirtualMachinePreferencesSizingOptimizationStrategy { SIZING_OPTIMIZATION_STRATEGY_UNSPECIFIED = 0, SIZING_OPTIMIZATION_STRATEGY_SAME_AS_SOURCE = 1, SIZING_OPTIMIZATION_STRATEGY_MODERATE = 2, SIZING_OPTIMIZATION_STRATEGY_AGGRESSIVE = 3, SIZING_OPTIMIZATION_STRATEGY_CUSTOM = 4 }
	...
	export enum Migrationcenter_projects_locations_assets_listView { ASSET_VIEW_UNSPECIFIED = 0, ASSET_VIEW_BASIC = 1, ASSET_VIEW_FULL = 2, ASSET_VIEW_STANDARD = 3 }
