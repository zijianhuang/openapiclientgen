...
export namespace MyNS {
	...
	export enum WorkerPoolState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', CREATING = 'CREATING', RUNNING = 'RUNNING', DELETING = 'DELETING', DELETED = 'DELETED' }
	...
	export class MyClient {
		 ...
		 * @param {string} name Required. The name of the `WorkerPool` to delete. Format: projects/{project}/workerPools/{workerPool}
		 * @return {Empty} Successful response
		 */
		Cloudbuild_projects_workerPools_delete(name: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)), {});
		}

		/**
		 * Returns details of a `WorkerPool`.
		 * Get v1alpha2/{name}
		 * @param {string} name Required. The name of the `WorkerPool` to retrieve. Format: projects/{project}/workerPools/{workerPool}
		 * @return {WorkerPool} Successful response
		 */
		Cloudbuild_projects_workerPools_get(name: string): Observable<WorkerPool> {
			return this.http.get<WorkerPool>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)), {});
		}

		/**
		 * Updates a `WorkerPool`.
		 * Patch v1alpha2/{name}
		 * @param {string} name Output only. The resource name of the `WorkerPool`. Format of the name is `projects/{project_id}/workerPools/{worker_pool_id}`, where the value of {worker_pool_id} is provided in the CreateWorkerPool request.
		 * @param {string} updateMask A mask specifying which fields in `WorkerPool` should be updated.
		 * @return {WorkerPool} Successful response
		 */
		Cloudbuild_projects_workerPools_patch(name: string, updateMask: string | null | undefined, requestBody: WorkerPool): Observable<WorkerPool> {
			return this.http.patch<WorkerPool>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} parent Required. The parent, which owns this collection of `WorkerPools`. Format: projects/{project}
		...
		Cloudbuild_projects_workerPools_list(parent: string): Observable<ListWorkerPoolsResponse> {
			return this.http.get<ListWorkerPoolsResponse>(this.baseUri + 'v1alpha2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workerPools', {});
		}

		/**
		 * Creates a `WorkerPool` to run the builds, and returns the new worker pool.
		 * Post v1alpha2/{parent}/workerPools
		 * @param {string} parent Required. The parent resource where this book will be created. Format: projects/{project}
		 ...
		 * @return {WorkerPool} Successful response
		 */
		Cloudbuild_projects_workerPools_create(parent: string, workerPoolId: string | null | undefined, requestBody: WorkerPool): Observable<WorkerPool> {
			return this.http.post<WorkerPool>(this.baseUri + 'v1alpha2/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workerPools&workerPoolId=' + (workerPoolId == null ? '' : encodeURIComponent(workerPoolId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
