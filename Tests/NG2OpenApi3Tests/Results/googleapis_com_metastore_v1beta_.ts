...
export namespace MyNS {
	...
	export interface NetworkConfigFormProperties {
		...
		/** Enables custom routes to be imported and exported for the Dataproc Metastore service's peered VPC network. */
		customRoutesEnabled: FormControl<boolean | null | undefined>,
	}
	export function CreateNetworkConfigFormGroup() {
		return new FormGroup<NetworkConfigFormProperties>({
			customRoutesEnabled: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	export enum BackendMetastoreMetastoreType { METASTORE_TYPE_UNSPECIFIED = 'METASTORE_TYPE_UNSPECIFIED', DATAPLEX = 'DATAPLEX', BIGQUERY = 'BIGQUERY', DATAPROC_METASTORE = 'DATAPROC_METASTORE' }
	...
	export interface DataplexConfig {
		...
		lakeResources?: {[id: string]: Lake };
	}

	/** Specifies how metastore metadata should be integrated with the Dataplex service. */
	export interface DataplexConfigFormProperties {

		/** A reference to the Lake resources that this metastore service is attached to. The key is the lake resource name. Example: projects/{project_number}/locations/{location_id}/lakes/{lake_id}. */
		lakeResources: FormControl<{[id: string]: Lake } | null | undefined>,
	}
	export function CreateDataplexConfigFormGroup() {
		return new FormGroup<DataplexConfigFormProperties>({
			lakeResources: new FormControl<{[id: string]: Lake } | null | undefined>(undefined),
		});
	...
	/** Represents a Lake resource */
	export interface LakeFormProperties {

		/** The Lake resource name. Example: projects/{project_number}/locations/{location_id}/lakes/{lake_id} */
		name: FormControl<string | null | undefined>,
	}
	export function CreateLakeFormGroup() {
		return new FormGroup<LakeFormProperties>({
			name: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request message for DataprocMetastore.RemoveIamPolicy. */
	export interface RemoveIamPolicyRequestFormProperties {

		/** Optional. Removes IAM policy attached to database or table asynchronously when it is set. The default is false. */
		asynchronous: FormControl<boolean | null | undefined>,
	}
	export function CreateRemoveIamPolicyRequestFormGroup() {
		return new FormGroup<RemoveIamPolicyRequestFormProperties>({
			asynchronous: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	/** Response message for DataprocMetastore.RemoveIamPolicy. */
	export interface RemoveIamPolicyResponseFormProperties {

		/** True if the policy is successfully removed. */
		success: FormControl<boolean | null | undefined>,
	}
	export function CreateRemoveIamPolicyResponseFormGroup() {
		return new FormGroup<RemoveIamPolicyResponseFormProperties>({
	...
	export class MyClient {
		...
		Metastore_projects_locations_services_backups_delete(name: string, requestId: string | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), {});
		}
		...
		Metastore_projects_locations_services_metadataImports_get(name: string): Observable<MetadataImport> {
			return this.http.get<MetadataImport>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Metastore_projects_locations_services_metadataImports_patch(name: string, requestId: string | null | undefined, updateMask: string | null | undefined, requestBody: MetadataImport): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta/' + (name == null ? '' : encodeURIComponent(name)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Metastore_projects_locations_services_backups_create(parent: string, backupId: string | null | undefined, requestId: string | null | undefined, requestBody: Backup): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/backups&backupId=' + (backupId == null ? '' : encodeURIComponent(backupId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Metastore_projects_locations_federations_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListFederationsResponse> {
			return this.http.get<ListFederationsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/federations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Metastore_projects_locations_federations_create(parent: string, federationId: string | null | undefined, requestId: string | null | undefined, requestBody: Federation): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/federations&federationId=' + (federationId == null ? '' : encodeURIComponent(federationId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Metastore_projects_locations_services_metadataImports_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListMetadataImportsResponse> {
			return this.http.get<ListMetadataImportsResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/metadataImports&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Metastore_projects_locations_services_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListServicesResponse> {
			return this.http.get<ListServicesResponse>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/services&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Metastore_projects_locations_services_create(parent: string, requestId: string | null | undefined, serviceId: string | null | undefined, requestBody: Service): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (parent == null ? '' : encodeURIComponent(parent)) + '/services&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)) + '&serviceId=' + (serviceId == null ? '' : encodeURIComponent(serviceId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Metastore_projects_locations_services_databases_tables_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<Policy> {
		 ...
		 * @return {RemoveIamPolicyResponse} Successful response
		 */
		Metastore_projects_locations_services_removeIamPolicy(resource: string, requestBody: RemoveIamPolicyRequest): Observable<RemoveIamPolicyResponse> {
			return this.http.post<RemoveIamPolicyResponse>(this.baseUri + 'v1beta/' + (resource == null ? '' : encodeURIComponent(resource)) + ':removeIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Policy} Successful response
		 */
		Metastore_projects_locations_services_databases_tables_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
		 ...
		 */
		Metastore_projects_locations_services_databases_tables_testIamPermissions(resource: string, requestBody: TestIamPermissionsRequest): Observable<TestIamPermissionsResponse> {
		...
		Metastore_projects_locations_services_alterLocation(service: string, requestBody: AlterMetadataResourceLocationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (service == null ? '' : encodeURIComponent(service)) + ':alterLocation', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Metastore_projects_locations_services_alterTableProperties(service: string, requestBody: AlterTablePropertiesRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (service == null ? '' : encodeURIComponent(service)) + ':alterTableProperties', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Metastore_projects_locations_services_exportMetadata(service: string, requestBody: ExportMetadataRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (service == null ? '' : encodeURIComponent(service)) + ':exportMetadata', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Metastore_projects_locations_services_moveTableToDatabase(service: string, requestBody: MoveTableToDatabaseRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (service == null ? '' : encodeURIComponent(service)) + ':moveTableToDatabase', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Metastore_projects_locations_services_queryMetadata(service: string, requestBody: QueryMetadataRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (service == null ? '' : encodeURIComponent(service)) + ':queryMetadata', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Metastore_projects_locations_services_restore(service: string, requestBody: RestoreServiceRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/' + (service == null ? '' : encodeURIComponent(service)) + ':restore', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
