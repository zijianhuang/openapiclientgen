...
export namespace MyNS {
	...
	export class MyClient {
		...
		Appengine_apps_create(requestBody: Application): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/apps', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {Appengine_apps_getIncludeExtraData} includeExtraData Optional. Options to include extra data
		...
		Appengine_apps_get(appsId: string, includeExtraData: Appengine_apps_getIncludeExtraData | null | undefined): Observable<Application> {
			return this.http.get<Application>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '&includeExtraData=' + includeExtraData, {});
		}
		...
		Appengine_apps_patch(appsId: string, updateMask: string | null | undefined, requestBody: Application): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_authorizedCertificates_list(appsId: string, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Appengine_apps_authorizedCertificates_listView | null | undefined): Observable<ListAuthorizedCertificatesResponse> {
			return this.http.get<ListAuthorizedCertificatesResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/authorizedCertificates&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Appengine_apps_authorizedCertificates_create(appsId: string, requestBody: AuthorizedCertificate): Observable<AuthorizedCertificate> {
			return this.http.post<AuthorizedCertificate>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/authorizedCertificates', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_authorizedCertificates_delete(appsId: string, authorizedCertificatesId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/authorizedCertificates/' + (authorizedCertificatesId == null ? '' : encodeURIComponent(authorizedCertificatesId)), {});
		}
		...
		Appengine_apps_authorizedCertificates_get(appsId: string, authorizedCertificatesId: string, view: Appengine_apps_authorizedCertificates_listView | null | undefined): Observable<AuthorizedCertificate> {
			return this.http.get<AuthorizedCertificate>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/authorizedCertificates/' + (authorizedCertificatesId == null ? '' : encodeURIComponent(authorizedCertificatesId)) + '&view=' + view, {});
		}
		...
		Appengine_apps_authorizedDomains_list(appsId: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListAuthorizedDomainsResponse> {
			return this.http.get<ListAuthorizedDomainsResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/authorizedDomains&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_apps_domainMappings_list(appsId: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListDomainMappingsResponse> {
			return this.http.get<ListDomainMappingsResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/domainMappings&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_apps_domainMappings_create(appsId: string, overrideStrategy: Appengine_apps_domainMappings_createOverrideStrategy | null | undefined, requestBody: DomainMapping): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/domainMappings&overrideStrategy=' + overrideStrategy, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_domainMappings_delete(appsId: string, domainMappingsId: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/domainMappings/' + (domainMappingsId == null ? '' : encodeURIComponent(domainMappingsId)), {});
		}
		...
		Appengine_apps_domainMappings_get(appsId: string, domainMappingsId: string): Observable<DomainMapping> {
			return this.http.get<DomainMapping>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/domainMappings/' + (domainMappingsId == null ? '' : encodeURIComponent(domainMappingsId)), {});
		}
		...
		Appengine_apps_domainMappings_patch(appsId: string, domainMappingsId: string, updateMask: string | null | undefined, requestBody: DomainMapping): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/domainMappings/' + (domainMappingsId == null ? '' : encodeURIComponent(domainMappingsId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_firewall_ingressRules_list(appsId: string, matchingAddress: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListIngressRulesResponse> {
			return this.http.get<ListIngressRulesResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/firewall/ingressRules&matchingAddress=' + (matchingAddress == null ? '' : encodeURIComponent(matchingAddress)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_apps_firewall_ingressRules_create(appsId: string, requestBody: FirewallRule): Observable<FirewallRule> {
			return this.http.post<FirewallRule>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/firewall/ingressRules', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_firewall_ingressRules_delete(appsId: string, ingressRulesId: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/firewall/ingressRules/' + (ingressRulesId == null ? '' : encodeURIComponent(ingressRulesId)), {});
		}
		...
		Appengine_apps_firewall_ingressRules_get(appsId: string, ingressRulesId: string): Observable<FirewallRule> {
			return this.http.get<FirewallRule>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/firewall/ingressRules/' + (ingressRulesId == null ? '' : encodeURIComponent(ingressRulesId)), {});
		}
		...
		Appengine_apps_firewall_ingressRules_patch(appsId: string, ingressRulesId: string, updateMask: string | null | undefined, requestBody: FirewallRule): Observable<FirewallRule> {
			return this.http.patch<FirewallRule>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/firewall/ingressRules/' + (ingressRulesId == null ? '' : encodeURIComponent(ingressRulesId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_firewall_ingressRules_batchUpdate(appsId: string, requestBody: BatchUpdateIngressRulesRequest): Observable<BatchUpdateIngressRulesResponse> {
			return this.http.post<BatchUpdateIngressRulesResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/firewall/ingressRules:batchUpdate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_locations_list(appsId: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationsResponse> {
			return this.http.get<ListLocationsResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/locations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_apps_locations_get(appsId: string, locationsId: string): Observable<Location> {
			return this.http.get<Location>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/locations/' + (locationsId == null ? '' : encodeURIComponent(locationsId)), {});
		}
		...
		Appengine_apps_operations_list(appsId: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListOperationsResponse> {
			return this.http.get<ListOperationsResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/operations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_apps_operations_get(appsId: string, operationsId: string): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/operations/' + (operationsId == null ? '' : encodeURIComponent(operationsId)), {});
		}
		...
		Appengine_apps_services_list(appsId: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListServicesResponse> {
			return this.http.get<ListServicesResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_apps_services_delete(appsId: string, servicesId: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)), {});
		}
		 ...
		 */
		Appengine_apps_services_get(appsId: string, servicesId: string, includeExtraData: Appengine_apps_getIncludeExtraData | null | undefined): Observable<Service> {
			return this.http.get<Service>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '&includeExtraData=' + includeExtraData, {});
		}
		...
		Appengine_apps_services_patch(appsId: string, servicesId: string, migrateTraffic: boolean | null | undefined, updateMask: string | null | undefined, requestBody: Service): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '&migrateTraffic=' + migrateTraffic + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_services_versions_list(appsId: string, servicesId: string, pageSize: number | null | undefined, pageToken: string | null | undefined, view: Appengine_apps_services_versions_listView | null | undefined): Observable<ListVersionsResponse> {
			return this.http.get<ListVersionsResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&view=' + view, {});
		}
		...
		Appengine_apps_services_versions_create(appsId: string, servicesId: string, requestBody: Version): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_services_versions_delete(appsId: string, servicesId: string, versionsId: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions/' + (versionsId == null ? '' : encodeURIComponent(versionsId)), {});
		}
		 ...
		 */
		Appengine_apps_services_versions_get(appsId: string, servicesId: string, versionsId: string, includeExtraData: Appengine_apps_getIncludeExtraData | null | undefined, view: Appengine_apps_services_versions_listView | null | undefined): Observable<Version> {
			return this.http.get<Version>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions/' + (versionsId == null ? '' : encodeURIComponent(versionsId)) + '&includeExtraData=' + includeExtraData + '&view=' + view, {});
		}
		...
		Appengine_apps_services_versions_patch(appsId: string, servicesId: string, versionsId: string, updateMask: string | null | undefined, requestBody: Version): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions/' + (versionsId == null ? '' : encodeURIComponent(versionsId)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_apps_services_versions_instances_list(appsId: string, servicesId: string, versionsId: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInstancesResponse> {
			return this.http.get<ListInstancesResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions/' + (versionsId == null ? '' : encodeURIComponent(versionsId)) + '/instances&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_apps_services_versions_instances_delete(appsId: string, servicesId: string, versionsId: string, instancesId: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions/' + (versionsId == null ? '' : encodeURIComponent(versionsId)) + '/instances/' + (instancesId == null ? '' : encodeURIComponent(instancesId)), {});
		}
		...
		Appengine_apps_services_versions_instances_get(appsId: string, servicesId: string, versionsId: string, instancesId: string): Observable<Instance> {
			return this.http.get<Instance>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions/' + (versionsId == null ? '' : encodeURIComponent(versionsId)) + '/instances/' + (instancesId == null ? '' : encodeURIComponent(instancesId)), {});
		}
		...
		Appengine_apps_services_versions_instances_debug(appsId: string, servicesId: string, versionsId: string, instancesId: string, requestBody: DebugInstanceRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + '/services/' + (servicesId == null ? '' : encodeURIComponent(servicesId)) + '/versions/' + (versionsId == null ? '' : encodeURIComponent(versionsId)) + '/instances/' + (instancesId == null ? '' : encodeURIComponent(instancesId)) + ':debug', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all the available runtimes for the application.
		 * Get v1beta/apps/{appsId}:listRuntimes
		...
		Appengine_apps_listRuntimes(appsId: string, environment: RuntimeEnvironment | null | undefined): Observable<ListRuntimesResponse> {
			return this.http.get<ListRuntimesResponse>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + ':listRuntimes&environment=' + environment, {});
		}
		...
		Appengine_apps_repair(appsId: string, requestBody: RepairApplicationRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta/apps/' + (appsId == null ? '' : encodeURIComponent(appsId)) + ':repair', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Appengine_projects_locations_list(projectsId: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationsResponse> {
			return this.http.get<ListLocationsResponse>(this.baseUri + 'v1beta/projects/' + (projectsId == null ? '' : encodeURIComponent(projectsId)) + '/locations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_projects_locations_get(projectsId: string, locationsId: string): Observable<Location> {
			return this.http.get<Location>(this.baseUri + 'v1beta/projects/' + (projectsId == null ? '' : encodeURIComponent(projectsId)) + '/locations/' + (locationsId == null ? '' : encodeURIComponent(locationsId)), {});
		}
		...
		Appengine_projects_locations_operations_list(projectsId: string, locationsId: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListOperationsResponse> {
			return this.http.get<ListOperationsResponse>(this.baseUri + 'v1beta/projects/' + (projectsId == null ? '' : encodeURIComponent(projectsId)) + '/locations/' + (locationsId == null ? '' : encodeURIComponent(locationsId)) + '/operations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Appengine_projects_locations_operations_get(projectsId: string, locationsId: string, operationsId: string): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'v1beta/projects/' + (projectsId == null ? '' : encodeURIComponent(projectsId)) + '/locations/' + (locationsId == null ? '' : encodeURIComponent(locationsId)) + '/operations/' + (operationsId == null ? '' : encodeURIComponent(operationsId)), {});
		}
	}
