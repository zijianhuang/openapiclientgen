...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {CyipcPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Cyipc(requestBody: CyipcPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'cyipc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	...
	export interface CyipcPostBody {
		certificateParameters?: CyipcPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface CyipcPostBodyFormProperties {
	...
	export function CreateCyipcPostBodyFormGroup() {
		return new FormGroup<CyipcPostBodyFormProperties>({
			format: new FormControl<CripcPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface CyipcPostBodyCertificateParameters {
	...
	export interface CyipcPostBodyCertificateParametersFormProperties {
	...
	export function CreateCyipcPostBodyCertificateParametersFormGroup() {
		return new FormGroup<CyipcPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			policy_number: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
