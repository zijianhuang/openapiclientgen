...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * Post createAuthUri
		 * @return {CreateAuthUriResponse} Successful response
		 */
		Identitytoolkit_relyingparty_createAuthUri(requestBody: IdentitytoolkitRelyingpartyCreateAuthUriRequest): Observable<CreateAuthUriResponse> {
			return this.http.post<CreateAuthUriResponse>(this.baseUri + 'createAuthUri', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Delete user account.
		 * Post deleteAccount
		 * @return {DeleteAccountResponse} Successful response
		 */
		Identitytoolkit_relyingparty_deleteAccount(requestBody: IdentitytoolkitRelyingpartyDeleteAccountRequest): Observable<DeleteAccountResponse> {
			return this.http.post<DeleteAccountResponse>(this.baseUri + 'deleteAccount', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Batch download user accounts.
		 * Post downloadAccount
		 * @return {DownloadAccountResponse} Successful response
		 */
		Identitytoolkit_relyingparty_downloadAccount(requestBody: IdentitytoolkitRelyingpartyDownloadAccountRequest): Observable<DownloadAccountResponse> {
			return this.http.post<DownloadAccountResponse>(this.baseUri + 'downloadAccount', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Reset password for a user.
		 * Post emailLinkSignin
		 * @return {EmailLinkSigninResponse} Successful response
		 */
		Identitytoolkit_relyingparty_emailLinkSignin(requestBody: IdentitytoolkitRelyingpartyEmailLinkSigninRequest): Observable<EmailLinkSigninResponse> {
			return this.http.post<EmailLinkSigninResponse>(this.baseUri + 'emailLinkSignin', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Returns the account info.
		 * Post getAccountInfo
		 * @return {GetAccountInfoResponse} Successful response
		 */
		Identitytoolkit_relyingparty_getAccountInfo(requestBody: IdentitytoolkitRelyingpartyGetAccountInfoRequest): Observable<GetAccountInfoResponse> {
			return this.http.post<GetAccountInfoResponse>(this.baseUri + 'getAccountInfo', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Get a code for user action confirmation.
		 * Post getOobConfirmationCode
		 * @return {GetOobConfirmationCodeResponse} Successful response
		 */
		Identitytoolkit_relyingparty_getOobConfirmationCode(requestBody: Relyingparty): Observable<GetOobConfirmationCodeResponse> {
			return this.http.post<GetOobConfirmationCodeResponse>(this.baseUri + 'getOobConfirmationCode', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {IdentitytoolkitRelyingpartyGetProjectConfigResponse} Successful response
		 */
		Identitytoolkit_relyingparty_getProjectConfig(delegatedProjectNumber: string | null | undefined, projectNumber: string | null | undefined): Observable<IdentitytoolkitRelyingpartyGetProjectConfigResponse> {
			return this.http.get<IdentitytoolkitRelyingpartyGetProjectConfigResponse>(this.baseUri + 'getProjectConfig?delegatedProjectNumber=' + (delegatedProjectNumber == null ? '' : encodeURIComponent(delegatedProjectNumber)) + '&projectNumber=' + (projectNumber == null ? '' : encodeURIComponent(projectNumber)), {});
		}

		/**
		 * Get recaptcha secure param.
		 * Get getRecaptchaParam
		 * @return {GetRecaptchaParamResponse} Successful response
		 */
		Identitytoolkit_relyingparty_getRecaptchaParam(): Observable<GetRecaptchaParamResponse> {
			return this.http.get<GetRecaptchaParamResponse>(this.baseUri + 'getRecaptchaParam', {});
		}

		/**
		 * Get token signing public key.
		 * Get publicKeys
		 * @return {IdentitytoolkitRelyingpartyGetPublicKeysResponse} Successful response
		 */
		Identitytoolkit_relyingparty_getPublicKeys(): Observable<IdentitytoolkitRelyingpartyGetPublicKeysResponse> {
			return this.http.get<IdentitytoolkitRelyingpartyGetPublicKeysResponse>(this.baseUri + 'publicKeys', {});
		}

		/**
		 * Reset password for a user.
		 * Post resetPassword
		 * @return {ResetPasswordResponse} Successful response
		 */
		Identitytoolkit_relyingparty_resetPassword(requestBody: IdentitytoolkitRelyingpartyResetPasswordRequest): Observable<ResetPasswordResponse> {
			return this.http.post<ResetPasswordResponse>(this.baseUri + 'resetPassword', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Send SMS verification code.
		 * Post sendVerificationCode
		 * @return {IdentitytoolkitRelyingpartySendVerificationCodeResponse} Successful response
		 */
		Identitytoolkit_relyingparty_sendVerificationCode(requestBody: IdentitytoolkitRelyingpartySendVerificationCodeRequest): Observable<IdentitytoolkitRelyingpartySendVerificationCodeResponse> {
			return this.http.post<IdentitytoolkitRelyingpartySendVerificationCodeResponse>(this.baseUri + 'sendVerificationCode', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Set account info for a user.
		 * Post setAccountInfo
		 * @return {SetAccountInfoResponse} Successful response
		 */
		Identitytoolkit_relyingparty_setAccountInfo(requestBody: IdentitytoolkitRelyingpartySetAccountInfoRequest): Observable<SetAccountInfoResponse> {
			return this.http.post<SetAccountInfoResponse>(this.baseUri + 'setAccountInfo', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Set project configuration.
		 * Post setProjectConfig
		 * @return {IdentitytoolkitRelyingpartySetProjectConfigResponse} Successful response
		 */
		Identitytoolkit_relyingparty_setProjectConfig(requestBody: IdentitytoolkitRelyingpartySetProjectConfigRequest): Observable<IdentitytoolkitRelyingpartySetProjectConfigResponse> {
			return this.http.post<IdentitytoolkitRelyingpartySetProjectConfigResponse>(this.baseUri + 'setProjectConfig', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Sign out user.
		 * Post signOutUser
		 * @return {IdentitytoolkitRelyingpartySignOutUserResponse} Successful response
		 */
		Identitytoolkit_relyingparty_signOutUser(requestBody: IdentitytoolkitRelyingpartySignOutUserRequest): Observable<IdentitytoolkitRelyingpartySignOutUserResponse> {
			return this.http.post<IdentitytoolkitRelyingpartySignOutUserResponse>(this.baseUri + 'signOutUser', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Signup new user.
		 * Post signupNewUser
		 * @return {SignupNewUserResponse} Successful response
		 */
		Identitytoolkit_relyingparty_signupNewUser(requestBody: IdentitytoolkitRelyingpartySignupNewUserRequest): Observable<SignupNewUserResponse> {
			return this.http.post<SignupNewUserResponse>(this.baseUri + 'signupNewUser', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Batch upload existing user accounts.
		 * Post uploadAccount
		 * @return {UploadAccountResponse} Successful response
		 */
		Identitytoolkit_relyingparty_uploadAccount(requestBody: IdentitytoolkitRelyingpartyUploadAccountRequest): Observable<UploadAccountResponse> {
			return this.http.post<UploadAccountResponse>(this.baseUri + 'uploadAccount', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Verifies the assertion returned by the IdP.
		 * Post verifyAssertion
		 * @return {VerifyAssertionResponse} Successful response
		 */
		Identitytoolkit_relyingparty_verifyAssertion(requestBody: IdentitytoolkitRelyingpartyVerifyAssertionRequest): Observable<VerifyAssertionResponse> {
			return this.http.post<VerifyAssertionResponse>(this.baseUri + 'verifyAssertion', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Verifies the developer asserted ID token.
		 * Post verifyCustomToken
		 * @return {VerifyCustomTokenResponse} Successful response
		 */
		Identitytoolkit_relyingparty_verifyCustomToken(requestBody: IdentitytoolkitRelyingpartyVerifyCustomTokenRequest): Observable<VerifyCustomTokenResponse> {
			return this.http.post<VerifyCustomTokenResponse>(this.baseUri + 'verifyCustomToken', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Verifies the user entered password.
		 * Post verifyPassword
		 * @return {VerifyPasswordResponse} Successful response
		 */
		Identitytoolkit_relyingparty_verifyPassword(requestBody: IdentitytoolkitRelyingpartyVerifyPasswordRequest): Observable<VerifyPasswordResponse> {
			return this.http.post<VerifyPasswordResponse>(this.baseUri + 'verifyPassword', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Verifies ownership of a phone number and creates/updates the user account accordingly.
		 * Post verifyPhoneNumber
		 * @return {IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse} Successful response
		 */
		Identitytoolkit_relyingparty_verifyPhoneNumber(requestBody: IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest): Observable<IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse> {
			return this.http.post<IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse>(this.baseUri + 'verifyPhoneNumber', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
