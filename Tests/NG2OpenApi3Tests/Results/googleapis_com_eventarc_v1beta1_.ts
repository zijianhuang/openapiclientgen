...
export namespace MyNS {
	...
	/** Represents a Cloud Run service destination. */
	export interface CloudRunServiceFormProperties {
	...
	export function CreateCloudRunServiceFormGroup() {
		return new FormGroup<CloudRunServiceFormProperties>({
	...
	export interface Trigger {
		...
		matchingCriteria?: Array<MatchingCriteria>;
	...
	/** Matches events based on exact matches on the CloudEvents attributes. */
	export interface MatchingCriteriaFormProperties {
	...
	export function CreateMatchingCriteriaFormGroup() {
		return new FormGroup<MatchingCriteriaFormProperties>({
	...
	export class MyClient {
		 ...
		 * @param {boolean} validateOnly Required. If set, validate the request and preview the review, but do not actually post it.
		 * @return {Operation} Successful response
		 */
		Eventarc_projects_locations_triggers_delete(name: string, allowMissing: boolean | null | undefined, etag: string | null | undefined, validateOnly: boolean | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&allowMissing=' + allowMissing + '&etag=' + (etag == null ? '' : encodeURIComponent(etag)) + '&validateOnly=' + validateOnly, {});
		}
		...
		Eventarc_projects_locations_triggers_get(name: string): Observable<Trigger> {
			return this.http.get<Trigger>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}

		/**
		 * Update a single trigger.
		 * Patch v1beta1/{name}
		 * @param {string} name Required. The resource name of the trigger. Must be unique within the location on the project and must in `projects/{project}/locations/{location}/triggers/{trigger}` format.
		 ...
		 * @param {string} updateMask The fields to be updated; only fields explicitly provided will be updated. If no field mask is provided, all provided fields in the request will be updated. To update all fields, provide a field mask of "*".
		 * @param {boolean} validateOnly Required. If set, validate the request and preview the review, but do not actually post it.
		 * @return {Operation} Successful response
		 */
		Eventarc_projects_locations_triggers_patch(name: string, allowMissing: boolean | null | undefined, updateMask: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: Trigger): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&allowMissing=' + allowMissing + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Eventarc_projects_locations_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListOperationsResponse> {
		 ...
		 */
		Eventarc_projects_locations_operations_cancel(name: string, requestBody: CancelOperationRequest): Observable<Empty> {
		 ...
		 * @param {string} orderBy The sorting order of the resources returned. Value should be a comma separated list of fields. The default sorting oder is ascending. To specify descending order for a field, append a ` desc` suffix; for example: `name desc, trigger_id`.
		 ...
		 */
		Eventarc_projects_locations_triggers_list(parent: string, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListTriggersResponse> {
			return this.http.get<ListTriggersResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/triggers&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {Operation} Successful response
		 */
		Eventarc_projects_locations_triggers_create(parent: string, triggerId: string | null | undefined, validateOnly: boolean | null | undefined, requestBody: Trigger): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/triggers&triggerId=' + (triggerId == null ? '' : encodeURIComponent(triggerId)) + '&validateOnly=' + validateOnly, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
