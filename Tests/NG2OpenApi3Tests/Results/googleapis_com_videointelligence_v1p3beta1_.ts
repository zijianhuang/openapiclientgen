...
export namespace MyNS {
	...
	export enum GoogleCloudVideointelligenceV1_VideoAnnotationProgressFeature { FEATURE_UNSPECIFIED = 'FEATURE_UNSPECIFIED', LABEL_DETECTION = 'LABEL_DETECTION', SHOT_CHANGE_DETECTION = 'SHOT_CHANGE_DETECTION', EXPLICIT_CONTENT_DETECTION = 'EXPLICIT_CONTENT_DETECTION', FACE_DETECTION = 'FACE_DETECTION', SPEECH_TRANSCRIPTION = 'SPEECH_TRANSCRIPTION', TEXT_DETECTION = 'TEXT_DETECTION', OBJECT_TRACKING = 'OBJECT_TRACKING', LOGO_RECOGNITION = 'LOGO_RECOGNITION', PERSON_DETECTION = 'PERSON_DETECTION' }
	...
	export enum GoogleCloudVideointelligenceV1_ExplicitContentFramePornographyLikelihood { LIKELIHOOD_UNSPECIFIED = 'LIKELIHOOD_UNSPECIFIED', VERY_UNLIKELY = 'VERY_UNLIKELY', UNLIKELY = 'UNLIKELY', POSSIBLE = 'POSSIBLE', LIKELY = 'LIKELY', VERY_LIKELY = 'VERY_LIKELY' }
	...
	export enum GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationProgressFeature { FEATURE_UNSPECIFIED = 'FEATURE_UNSPECIFIED', LABEL_DETECTION = 'LABEL_DETECTION', SHOT_CHANGE_DETECTION = 'SHOT_CHANGE_DETECTION', EXPLICIT_CONTENT_DETECTION = 'EXPLICIT_CONTENT_DETECTION', FACE_DETECTION = 'FACE_DETECTION', SPEECH_TRANSCRIPTION = 'SPEECH_TRANSCRIPTION', TEXT_DETECTION = 'TEXT_DETECTION', OBJECT_TRACKING = 'OBJECT_TRACKING', LOGO_RECOGNITION = 'LOGO_RECOGNITION', CELEBRITY_RECOGNITION = 'CELEBRITY_RECOGNITION', PERSON_DETECTION = 'PERSON_DETECTION' }
	...
	export interface GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest {
		...
		features?: Array<GoogleCloudVideointelligenceV1p3beta1_VideoAnnotationProgressFeature>;
	...
	/** Video annotation request. */
	export interface GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequestFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequestFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequestFormProperties>({
	...
	/** Video context and/or feature-specific parameters. */
	export interface GoogleCloudVideointelligenceV1p3beta1_VideoContextFormProperties {
	}
	export function CreateGoogleCloudVideointelligenceV1p3beta1_VideoContextFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_VideoContextFormProperties>({
		});
	...
	/** Config for EXPLICIT_CONTENT_DETECTION. */
	export interface GoogleCloudVideointelligenceV1p3beta1_ExplicitContentDetectionConfigFormProperties {

		/** Model to use for explicit content detection. Supported values: "builtin/stable" (the default if unset) and "builtin/latest". */
		model: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudVideointelligenceV1p3beta1_ExplicitContentDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_ExplicitContentDetectionConfigFormProperties>({
	...
	/** Config for FACE_DETECTION. */
	export interface GoogleCloudVideointelligenceV1p3beta1_FaceDetectionConfigFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1p3beta1_FaceDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_FaceDetectionConfigFormProperties>({
	...
	export interface GoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfig {
		...
		labelDetectionMode?: GoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfigLabelDetectionMode | null;
	...
	/** Config for LABEL_DETECTION. */
	export interface GoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfigFormProperties {
		...
		/** What labels should be detected with LABEL_DETECTION, in addition to video-level labels or segment-level labels. If unspecified, defaults to `SHOT_MODE`. */
		labelDetectionMode: FormControl<GoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfigLabelDetectionMode | null | undefined>,
	...
	export function CreateGoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfigFormProperties>({
			frameConfidenceThreshold: new FormControl<number | null | undefined>(undefined),
			labelDetectionMode: new FormControl<GoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfigLabelDetectionMode | null | undefined>(undefined),
			model: new FormControl<string | null | undefined>(undefined),
	...
	export enum GoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfigLabelDetectionMode { LABEL_DETECTION_MODE_UNSPECIFIED = 'LABEL_DETECTION_MODE_UNSPECIFIED', SHOT_MODE = 'SHOT_MODE', FRAME_MODE = 'FRAME_MODE', SHOT_AND_FRAME_MODE = 'SHOT_AND_FRAME_MODE' }
	...
	/** Config for OBJECT_TRACKING. */
	export interface GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingConfigFormProperties {

		/** Model to use for object tracking. Supported values: "builtin/stable" (the default if unset) and "builtin/latest". */
		model: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudVideointelligenceV1p3beta1_ObjectTrackingConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_ObjectTrackingConfigFormProperties>({
			model: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Config for PERSON_DETECTION. */
	export interface GoogleCloudVideointelligenceV1p3beta1_PersonDetectionConfigFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1p3beta1_PersonDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_PersonDetectionConfigFormProperties>({
			includeAttributes: new FormControl<boolean | null | undefined>(undefined),
			includeBoundingBoxes: new FormControl<boolean | null | undefined>(undefined),
	...
	/** Config for SHOT_CHANGE_DETECTION. */
	export interface GoogleCloudVideointelligenceV1p3beta1_ShotChangeDetectionConfigFormProperties {

		/** Model to use for shot change detection. Supported values: "builtin/stable" (the default if unset), "builtin/latest", and "builtin/legacy". */
		model: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudVideointelligenceV1p3beta1_ShotChangeDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_ShotChangeDetectionConfigFormProperties>({
			model: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Config for SPEECH_TRANSCRIPTION. */
	export interface GoogleCloudVideointelligenceV1p3beta1_SpeechTranscriptionConfigFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1p3beta1_SpeechTranscriptionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_SpeechTranscriptionConfigFormProperties>({
	...
	/** Provides "hints" to the speech recognizer to favor specific words and phrases in the results. */
	export interface GoogleCloudVideointelligenceV1p3beta1_SpeechContextFormProperties {
	}
	export function CreateGoogleCloudVideointelligenceV1p3beta1_SpeechContextFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_SpeechContextFormProperties>({
		});
	...
	/** Config for TEXT_DETECTION. */
	export interface GoogleCloudVideointelligenceV1p3beta1_TextDetectionConfigFormProperties {

		/** Model to use for text detection. Supported values: "builtin/stable" (the default if unset) and "builtin/latest". */
		model: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudVideointelligenceV1p3beta1_TextDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1p3beta1_TextDetectionConfigFormProperties>({
			model: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 */
		Videointelligence_videos_annotate(requestBody: GoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest): Observable<GoogleLongrunning_Operation> {
			return this.http.post<GoogleLongrunning_Operation>(this.baseUri + 'v1p3beta1/videos:annotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
