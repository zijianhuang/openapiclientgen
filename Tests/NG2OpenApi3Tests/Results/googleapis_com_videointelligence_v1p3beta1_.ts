...
export namespace MyNS {
	...
	export enum GoogleCloudVideointelligenceV1p3beta1_LabelDetectionConfigLabelDetectionMode { LABEL_DETECTION_MODE_UNSPECIFIED = 0, SHOT_MODE = 1, FRAME_MODE = 2, SHOT_AND_FRAME_MODE = 3 }
