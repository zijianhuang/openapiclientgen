...
export namespace MyNS {
	...
	export enum AcceleratorConfigType { ACCELERATOR_TYPE_UNSPECIFIED = 0, NVIDIA_TESLA_P100 = 1, NVIDIA_TESLA_V100 = 2, NVIDIA_TESLA_P4 = 3, NVIDIA_TESLA_T4 = 4, NVIDIA_TESLA_A100 = 5, NVIDIA_A100_80GB = 6, NVIDIA_L4 = 7, NVIDIA_TESLA_T4_VWS = 8, NVIDIA_TESLA_P100_VWS = 9, NVIDIA_TESLA_P4_VWS = 10 }
	...
	export enum BootDiskDiskEncryption { DISK_ENCRYPTION_UNSPECIFIED = 0, GMEK = 1, CMEK = 2 }

	export enum BootDiskDiskType { DISK_TYPE_UNSPECIFIED = 0, PD_STANDARD = 1, PD_SSD = 2, PD_BALANCED = 3, PD_EXTREME = 4 }
	...
	export enum EventType { EVENT_TYPE_UNSPECIFIED = 0, IDLE = 1, HEARTBEAT = 2, HEALTH = 3, MAINTENANCE = 4, METADATA_CHANGE = 5 }
	...
	export enum NetworkInterfaceNicType { NIC_TYPE_UNSPECIFIED = 0, VIRTIO_NET = 1, GVNIC = 2 }
	...
	export enum InstanceHealthState { HEALTH_STATE_UNSPECIFIED = 0, HEALTHY = 1, UNHEALTHY = 2, AGENT_NOT_INSTALLED = 3, AGENT_NOT_RUNNING = 4 }

	export enum InstanceState { STATE_UNSPECIFIED = 0, STARTING = 1, PROVISIONING = 2, ACTIVE = 3, STOPPING = 4, STOPPED = 5, DELETED = 6, UPGRADING = 7, INITIALIZING = 8, SUSPENDING = 9, SUSPENDED = 10 }
