...
export namespace MyNS {
	...
	export class MyClient {
		...
		Speech_operations_list(filter: string | null | undefined, name: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListOperationsResponse> {
			return this.http.get<ListOperationsResponse>(this.baseUri + 'v1p1beta1/operations?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Speech_operations_get(name: string): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'v1p1beta1/operations/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Speech_speech_longrunningrecognize(requestBody: LongRunningRecognizeRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1p1beta1/speech:longrunningrecognize', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Speech_speech_recognize(requestBody: RecognizeRequest): Observable<RecognizeResponse> {
			return this.http.post<RecognizeResponse>(this.baseUri + 'v1p1beta1/speech:recognize', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Delete a phrase set.
		 * Delete v1p1beta1/{name}
		...
		Speech_projects_locations_phraseSets_delete(name: string): Observable<Empty> {
			return this.http.delete<Empty>(this.baseUri + 'v1p1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Speech_projects_locations_phraseSets_get(name: string): Observable<PhraseSet> {
			return this.http.get<PhraseSet>(this.baseUri + 'v1p1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}

		/**
		 * Update a phrase set.
		 * Patch v1p1beta1/{name}
		...
		Speech_projects_locations_phraseSets_patch(name: string, updateMask: string | null | undefined, requestBody: PhraseSet): Observable<PhraseSet> {
			return this.http.patch<PhraseSet>(this.baseUri + 'v1p1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&updateMask=' + (updateMask == null ? '' : encodeURIComponent(updateMask)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * List custom classes.
		 * Get v1p1beta1/{parent}/customClasses
		...
		Speech_projects_locations_customClasses_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCustomClassesResponse> {
			return this.http.get<ListCustomClassesResponse>(this.baseUri + 'v1p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/customClasses&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Create a custom class.
		 * Post v1p1beta1/{parent}/customClasses
		...
		Speech_projects_locations_customClasses_create(parent: string, requestBody: CreateCustomClassRequest): Observable<CustomClass> {
			return this.http.post<CustomClass>(this.baseUri + 'v1p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/customClasses', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * List phrase sets.
		 * Get v1p1beta1/{parent}/phraseSets
		...
		Speech_projects_locations_phraseSets_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListPhraseSetResponse> {
			return this.http.get<ListPhraseSetResponse>(this.baseUri + 'v1p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/phraseSets&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Create a set of phrase hints. Each item in the set can be a single word or a multi-word phrase. The items in the PhraseSet are favored by the recognition model when you send a call that includes the PhraseSet.
		 * Post v1p1beta1/{parent}/phraseSets
		...
		Speech_projects_locations_phraseSets_create(parent: string, requestBody: CreatePhraseSetRequest): Observable<PhraseSet> {
			return this.http.post<PhraseSet>(this.baseUri + 'v1p1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/phraseSets', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
