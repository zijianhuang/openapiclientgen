...
export namespace MyNS {
	...
	export interface BtcerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<BtcerPostBodyFormat | null | undefined>,
	...
	export function CreateBtcerPostBodyFormGroup() {
		return new FormGroup<BtcerPostBodyFormProperties>({
			format: new FormControl<BtcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export interface EwcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		DSN: FormControl<string | null | undefined>,
	}
	export function CreateEwcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<EwcerPostBodyCertificateParametersFormProperties>({
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			DSN: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface ObcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		DSNNo: FormControl<string | null | undefined>,

		/**
		 * Father Name
		 * Required
		 */
		Father: FormControl<string | null | undefined>,
	...
	export function CreateObcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<ObcerPostBodyCertificateParametersFormProperties>({
			DOB: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			DSNNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			Father: new FormControl<string | null | undefined>(undefined, [Validators.required]),
