...
export namespace MyNS {
	...
	export enum AgentPoolState { STATE_UNSPECIFIED = 'STATE_UNSPECIFIED', CREATING = 'CREATING', CREATED = 'CREATED', DELETING = 'DELETING' }
	...
	export enum S3CompatibleMetadataAuthMethod { AUTH_METHOD_UNSPECIFIED = 'AUTH_METHOD_UNSPECIFIED', AUTH_METHOD_AWS_SIGNATURE_V4 = 'AUTH_METHOD_AWS_SIGNATURE_V4', AUTH_METHOD_AWS_SIGNATURE_V2 = 'AUTH_METHOD_AWS_SIGNATURE_V2' }

	export enum S3CompatibleMetadataListApi { LIST_API_UNSPECIFIED = 'LIST_API_UNSPECIFIED', LIST_OBJECTS_V2 = 'LIST_OBJECTS_V2', LIST_OBJECTS = 'LIST_OBJECTS' }

	export enum S3CompatibleMetadataProtocol { NETWORK_PROTOCOL_UNSPECIFIED = 'NETWORK_PROTOCOL_UNSPECIFIED', NETWORK_PROTOCOL_HTTPS = 'NETWORK_PROTOCOL_HTTPS', NETWORK_PROTOCOL_HTTP = 'NETWORK_PROTOCOL_HTTP' }

	export enum S3CompatibleMetadataRequestModel { REQUEST_MODEL_UNSPECIFIED = 'REQUEST_MODEL_UNSPECIFIED', REQUEST_MODEL_VIRTUAL_HOSTED_STYLE = 'REQUEST_MODEL_VIRTUAL_HOSTED_STYLE', REQUEST_MODEL_PATH_STYLE = 'REQUEST_MODEL_PATH_STYLE' }
	...
	export enum NotificationConfigPayloadFormat { PAYLOAD_FORMAT_UNSPECIFIED = 'PAYLOAD_FORMAT_UNSPECIFIED', NONE = 'NONE', JSON = 'JSON' }
	...
	export enum TransferJobStatus { STATUS_UNSPECIFIED = 'STATUS_UNSPECIFIED', ENABLED = 'ENABLED', DISABLED = 'DISABLED', DELETED = 'DELETED' }
	...
	export enum MetadataOptionsAcl { ACL_UNSPECIFIED = 'ACL_UNSPECIFIED', ACL_DESTINATION_BUCKET_DEFAULT = 'ACL_DESTINATION_BUCKET_DEFAULT', ACL_PRESERVE = 'ACL_PRESERVE' }

	export enum MetadataOptionsGid { GID_UNSPECIFIED = 'GID_UNSPECIFIED', GID_SKIP = 'GID_SKIP', GID_NUMBER = 'GID_NUMBER' }

	export enum MetadataOptionsKmsKey { KMS_KEY_UNSPECIFIED = 'KMS_KEY_UNSPECIFIED', KMS_KEY_DESTINATION_BUCKET_DEFAULT = 'KMS_KEY_DESTINATION_BUCKET_DEFAULT', KMS_KEY_PRESERVE = 'KMS_KEY_PRESERVE' }

	export enum MetadataOptionsMode { MODE_UNSPECIFIED = 'MODE_UNSPECIFIED', MODE_SKIP = 'MODE_SKIP', MODE_PRESERVE = 'MODE_PRESERVE' }

	export enum MetadataOptionsStorageClass { STORAGE_CLASS_UNSPECIFIED = 'STORAGE_CLASS_UNSPECIFIED', STORAGE_CLASS_DESTINATION_BUCKET_DEFAULT = 'STORAGE_CLASS_DESTINATION_BUCKET_DEFAULT', STORAGE_CLASS_PRESERVE = 'STORAGE_CLASS_PRESERVE', STORAGE_CLASS_STANDARD = 'STORAGE_CLASS_STANDARD', STORAGE_CLASS_NEARLINE = 'STORAGE_CLASS_NEARLINE', STORAGE_CLASS_COLDLINE = 'STORAGE_CLASS_COLDLINE', STORAGE_CLASS_ARCHIVE = 'STORAGE_CLASS_ARCHIVE' }

	export enum MetadataOptionsSymlink { SYMLINK_UNSPECIFIED = 'SYMLINK_UNSPECIFIED', SYMLINK_SKIP = 'SYMLINK_SKIP', SYMLINK_PRESERVE = 'SYMLINK_PRESERVE' }

	export enum MetadataOptionsTemporaryHold { TEMPORARY_HOLD_UNSPECIFIED = 'TEMPORARY_HOLD_UNSPECIFIED', TEMPORARY_HOLD_SKIP = 'TEMPORARY_HOLD_SKIP', TEMPORARY_HOLD_PRESERVE = 'TEMPORARY_HOLD_PRESERVE' }

	export enum MetadataOptionsTimeCreated { TIME_CREATED_UNSPECIFIED = 'TIME_CREATED_UNSPECIFIED', TIME_CREATED_SKIP = 'TIME_CREATED_SKIP', TIME_CREATED_PRESERVE_AS_CUSTOM_TIME = 'TIME_CREATED_PRESERVE_AS_CUSTOM_TIME' }

	export enum MetadataOptionsUid { UID_UNSPECIFIED = 'UID_UNSPECIFIED', UID_SKIP = 'UID_SKIP', UID_NUMBER = 'UID_NUMBER' }

	export enum TransferOptionsOverwriteWhen { OVERWRITE_WHEN_UNSPECIFIED = 'OVERWRITE_WHEN_UNSPECIFIED', DIFFERENT = 'DIFFERENT', NEVER = 'NEVER', ALWAYS = 'ALWAYS' }
	...
	export enum TransferOperationStatus { STATUS_UNSPECIFIED = 'STATUS_UNSPECIFIED', IN_PROGRESS = 'IN_PROGRESS', PAUSED = 'PAUSED', SUCCESS = 'SUCCESS', FAILED = 'FAILED', ABORTED = 'ABORTED', QUEUED = 'QUEUED', SUSPENDING = 'SUSPENDING' }
