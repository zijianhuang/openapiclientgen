...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {NbcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Nbcer(requestBody: NbcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'nbcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface NbcerPostBody {
		certificateParameters?: NbcerPostBodyCertificateParameters;
	...
	export interface NbcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<NbcerPostBodyFormat | null | undefined>,
	...
	export function CreateNbcerPostBodyFormGroup() {
		return new FormGroup<NbcerPostBodyFormProperties>({
			format: new FormControl<NbcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface NbcerPostBodyCertificateParameters {
	...
	export interface NbcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateNbcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<NbcerPostBodyCertificateParametersFormProperties>({
