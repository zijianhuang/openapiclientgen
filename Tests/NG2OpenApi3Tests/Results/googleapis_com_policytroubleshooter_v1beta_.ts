...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * Post v1beta/iam:troubleshoot
		 * @return {GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyResponse} Successful response
		 */
		Policytroubleshooter_iam_troubleshoot(requestBody: GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest): Observable<GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyResponse> {
			return this.http.post<GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyResponse>(this.baseUri + 'v1beta/iam:troubleshoot', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
