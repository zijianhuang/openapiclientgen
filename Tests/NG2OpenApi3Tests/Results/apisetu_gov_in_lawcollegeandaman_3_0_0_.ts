...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {TrcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Trcer(requestBody: TrcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'trcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface TrcerPostBody {
		certificateParameters?: TrcerPostBodyCertificateParameters;
	...
	export interface TrcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<TrcerPostBodyFormat | null | undefined>,
	...
	export function CreateTrcerPostBodyFormGroup() {
		return new FormGroup<TrcerPostBodyFormProperties>({
			format: new FormControl<TrcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface TrcerPostBodyCertificateParameters {
	...
	export interface TrcerPostBodyCertificateParametersFormProperties {

		/**
		 * Admn No.
		 * Required
		 */
		ADMN_NO: FormControl<string | null | undefined>,
	...
	export function CreateTrcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<TrcerPostBodyCertificateParametersFormProperties>({
			ADMN_NO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
