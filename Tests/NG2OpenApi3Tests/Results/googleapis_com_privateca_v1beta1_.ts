...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Privateca_projects_locations_operations_delete(name: string): Observable<Empty> {
		 ...
		 */
		Privateca_projects_locations_reusableConfigs_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<Policy> {
		 ...
		 * @return {Policy} Successful response
		 */
		Privateca_projects_locations_reusableConfigs_setIamPolicy(resource: string, requestBody: SetIamPolicyRequest): Observable<Policy> {
		 ...
		 */
		Privateca_projects_locations_reusableConfigs_testIamPermissions(resource: string, requestBody: TestIamPermissionsRequest): Observable<TestIamPermissionsResponse> {
