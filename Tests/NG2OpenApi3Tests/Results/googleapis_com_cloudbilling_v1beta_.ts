...
export namespace MyNS {
	...
	export enum CacheFillRegionsDestinationRegion { CACHE_FILL_DESTINATION_REGION_UNSPECIFIED = 0, CACHE_FILL_DESTINATION_REGION_ASIA_PACIFIC = 1, CACHE_FILL_DESTINATION_REGION_EUROPE = 2, CACHE_FILL_DESTINATION_REGION_NORTH_AMERICA = 3, CACHE_FILL_DESTINATION_REGION_OCEANIA = 4, CACHE_FILL_DESTINATION_REGION_SOUTH_AMERICA = 5, CACHE_FILL_DESTINATION_REGION_CHINA = 6, CACHE_FILL_DESTINATION_REGION_OTHERS = 7 }

	export enum CacheFillRegionsSourceRegion { CACHE_FILL_SOURCE_REGION_UNSPECIFIED = 0, CACHE_FILL_REGION_ASIA_PACIFIC = 1, CACHE_FILL_SOURCE_REGION_EUROPE = 2, CACHE_FILL_SOURCE_REGION_NORTH_AMERICA = 3, CACHE_FILL_SOURCE_REGION_OCEANIA = 4, CACHE_FILL_SOURCE_REGION_SOUTH_AMERICA = 5 }
	...
	export enum CloudCdnEgressWorkloadCacheEgressDestination { CACHE_EGRESS_DESTINATION_UNSPECIFIED = 0, CACHE_EGRESS_DESTINATION_ASIA_PACIFIC = 1, CACHE_EGRESS_DESTINATION_CHINA = 2, CACHE_EGRESS_DESTINATION_EUROPE = 3, CACHE_EGRESS_DESTINATION_NORTH_AMERICA = 4, CACHE_EGRESS_DESTINATION_OCEANIA = 5, CACHE_EGRESS_DESTINATION_LATIN_AMERICA = 6, CACHE_EGRESS_DESTINATION_OTHER_DESTINATIONS = 7 }
	...
	export enum CloudCdnWorkloadCacheFillOriginService { CACHE_FILL_ORIGIN_SERVICE_UNSPECIFIED = 0, CACHE_FILL_ORIGIN_SERVICE_GOOGLE_CLOUD_STORAGE_BUCKET = 1, CACHE_FILL_ORIGIN_SERVICE_BACKEND_SERVICE = 2 }
	...
	export enum CloudInterconnectEgressWorkloadInterconnectConnectionLocation { INTERCONNECT_CONNECTION_LOCATION_UNSPECIFIED = 0, INTERCONNECT_CONNECTION_LOCATION_ASIA = 1, INTERCONNECT_CONNECTION_LOCATION_EUROPE = 2, INTERCONNECT_CONNECTION_LOCATION_NORTH_AMERICA = 3, INTERCONNECT_CONNECTION_LOCATION_SOUTH_AMERICA = 4, INTERCONNECT_CONNECTION_LOCATION_AUSTRALIA = 5 }
	...
	export enum VlanAttachmentBandwidth { BANDWIDTH_UNSPECIFIED = 0, BANDWIDTH_BPS_50M = 1, BANDWIDTH_BPS_100M = 2, BANDWIDTH_BPS_200M = 3, BANDWIDTH_BPS_300M = 4, BANDWIDTH_BPS_400M = 5, BANDWIDTH_BPS_500M = 6, BANDWIDTH_BPS_1G = 7, BANDWIDTH_BPS_2G = 8, BANDWIDTH_BPS_5G = 9, BANDWIDTH_BPS_10G = 10, BANDWIDTH_BPS_20G = 11, BANDWIDTH_BPS_50G = 12 }

	export enum CloudInterconnectWorkloadInterconnectType { INTERCONNECT_TYPE_UNSPECIFIED = 0, INTERCONNECT_TYPE_DEDICATED = 1, INTERCONNECT_TYPE_PARTNER = 2 }

	export enum CloudInterconnectWorkloadLinkType { LINK_TYPE_UNSPECIFIED = 0, LINK_TYPE_ETHERNET_10G_LR = 1, LINK_TYPE_ETHERNET_100G_LR = 2 }
	...
	export enum CloudStorageEgressWorkloadDestinationContinent { DESTINATION_CONTINENT_UNSPECIFIED = 0, DESTINATION_CONTINENT_ASIA_PACIFIC = 1, DESTINATION_CONTINENT_AUTRALIA = 2, DESTINATION_CONTINENT_EUROPE = 3, DESTINATION_CONTINENT_NORTH_AMERICA = 4, DESTINATION_CONTINENT_SOUTH_AMERICA = 5 }

	export enum CloudStorageEgressWorkloadSourceContinent { SOURCE_CONTINENT_UNSPECIFIED = 0, SOURCE_CONTINENT_ASIA_PACIFIC = 1, SOURCE_CONTINENT_AUSTRALIA = 2, SOURCE_CONTINENT_EUROPE = 3, SOURCE_CONTINENT_NORTH_AMERICA = 4, SOURCE_CONTINENT_SOUTH_AMERICA = 5 }
	...
	export enum VmResourceBasedCudPlan { COMMITMENT_PLAN_UNSPECIFIED = 0, TWELVE_MONTH = 1, THIRTY_SIX_MONTH = 2 }
	...
	export enum PersistentDiskScope { SCOPE_UNSPECIFIED = 0, SCOPE_ZONAL = 1, SCOPE_REGIONAL = 2 }
	...
	export enum PremiumTierEgressWorkloadDestinationContinent { DESTINATION_CONTINENT_UNSPECIFIED = 0, DESTINATION_CONTINENT_ASIA_PACIFIC = 1, DESTINATION_CONTINENT_AFRICA = 2, DESTINATION_CONTINENT_NORTH_AMERICA = 3, DESTINATION_CONTINENT_AUTRALIA = 4, DESTINATION_CONTINENT_CENTRAL_AMERICA = 5, DESTINATION_CONTINENT_CHINA = 6, DESTINATION_CONTINENT_EASTERN_EUROPE = 7, DESTINATION_CONTINENT_WESTERN_EUROPE = 8, DESTINATION_CONTINENT_EMEA = 9, DESTINATION_CONTINENT_INDIA = 10, DESTINATION_CONTINENT_MIDDLE_EAST = 11, DESTINATION_CONTINENT_SOUTH_AMERICA = 12 }
	...
	export enum GoogleCloudBillingBillingaccountpricesV1betaAggregationInfoInterval { INTERVAL_UNSPECIFIED = 0, INTERVAL_MONTHLY = 1, INTERVAL_DAILY = 2 }

	export enum GoogleCloudBillingBillingaccountpricesV1betaAggregationInfoLevel { LEVEL_UNSPECIFIED = 0, LEVEL_ACCOUNT = 1, LEVEL_PROJECT = 2 }
	...
	export enum GoogleCloudBillingBillingaccountskugroupskusV1betaGeoTaxonomyType { TYPE_UNSPECIFIED = 0, TYPE_GLOBAL = 1, TYPE_REGIONAL = 2, TYPE_MULTI_REGIONAL = 3 }
