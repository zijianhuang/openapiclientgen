...
export namespace MyNS {
	...
	export class MyClient {
		...
		Redis_projects_locations_instances_getAuthString(name: string): Observable<InstanceAuthString> {
			return this.http.get<InstanceAuthString>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/authString', {});
		}

		/**
		 * Gets the details of certificate authority information for Redis cluster.
		 * Get v1/{name}/certificateAuthority
		...
		Redis_projects_locations_clusters_getCertificateAuthority(name: string): Observable<CertificateAuthority> {
			return this.http.get<CertificateAuthority>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + '/certificateAuthority', {});
		}
		...
		Redis_projects_locations_instances_rescheduleMaintenance(name: string, requestBody: RescheduleMaintenanceRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':rescheduleMaintenance', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Redis_projects_locations_clusters_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListClustersResponse> {
			return this.http.get<ListClustersResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clusters&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Redis_projects_locations_clusters_create(parent: string, clusterId: string | null | undefined, requestId: string | null | undefined, requestBody: Cluster): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/clusters&clusterId=' + (clusterId == null ? '' : encodeURIComponent(clusterId)) + '&requestId=' + (requestId == null ? '' : encodeURIComponent(requestId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
