...
export namespace MyNS {
	...
	/** Directory Services configuration for Kerberos-based authentication. */
	export interface DirectoryServicesConfigFormProperties {
	}
	export function CreateDirectoryServicesConfigFormGroup() {
		return new FormGroup<DirectoryServicesConfigFormProperties>({
		});
	...
	/** ManagedActiveDirectoryConfig contains all the parameters for connecting to Managed Active Directory. */
	export interface ManagedActiveDirectoryConfigFormProperties {
	...
	export function CreateManagedActiveDirectoryConfigFormGroup() {
		return new FormGroup<ManagedActiveDirectoryConfigFormProperties>({
	...
	export interface Instance {
		...
		protocol?: InstanceProtocol | null;
	...
	export interface InstanceFormProperties {
		...
		/** Output only. The increase/decrease capacity step size. */
		capacityStepSizeGb: FormControl<string | null | undefined>,
		...
		/** Output only. The max capacity of the instance. */
		maxCapacityGb: FormControl<string | null | undefined>,

		/** The max number of shares allowed. */
		maxShareCount: FormControl<string | null | undefined>,

		/** Indicates whether this instance uses a multi-share configuration with which it can have more than one file-share or none at all. File-shares are added, updated and removed through the separate file-share APIs. */
		multiShareEnabled: FormControl<boolean | null | undefined>,

		/** Output only. The resource name of the instance, in the format `projects/{project_id}/locations/{location_id}/instances/{instance_id}`. */
		name: FormControl<string | null | undefined>,

		/** Immutable. The protocol indicates the access protocol for all shares in the instance. This field is immutable and it cannot be changed after the instance has been created. Default value: `NFS_V3`. */
		protocol: FormControl<InstanceProtocol | null | undefined>,
	...
	export function CreateInstanceFormGroup() {
		return new FormGroup<InstanceFormProperties>({
			capacityGb: new FormControl<string | null | undefined>(undefined),
			capacityStepSizeGb: new FormControl<string | null | undefined>(undefined),
			createTime: new FormControl<string | null | undefined>(undefined),
			description: new FormControl<string | null | undefined>(undefined),
			etag: new FormControl<string | null | undefined>(undefined),
			kmsKeyName: new FormControl<string | null | undefined>(undefined),
			labels: new FormControl<{[id: string]: string } | null | undefined>(undefined),
			maxCapacityGb: new FormControl<string | null | undefined>(undefined),
			maxShareCount: new FormControl<string | null | undefined>(undefined),
			multiShareEnabled: new FormControl<boolean | null | undefined>(undefined),
			name: new FormControl<string | null | undefined>(undefined),
			protocol: new FormControl<InstanceProtocol | null | undefined>(undefined),
			satisfiesPzi: new FormControl<boolean | null | undefined>(undefined),
			satisfiesPzs: new FormControl<boolean | null | undefined>(undefined),
	...
	/** ListSharesResponse is the result of ListSharesRequest. */
	export interface ListSharesResponseFormProperties {

		/** The token you can use to retrieve the next page of results. Not returned if there are no more results in the list. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListSharesResponseFormGroup() {
		return new FormGroup<ListSharesResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface ShareFormProperties {
		...
		/** Output only. The share state. */
		state: FormControl<ShareState | null | undefined>,
	}
	export function CreateShareFormGroup() {
		return new FormGroup<ShareFormProperties>({
			...
			name: new FormControl<string | null | undefined>(undefined),
			state: new FormControl<ShareState | null | undefined>(undefined),
		});
	...
	export class MyClient {
		...
		File_projects_locations_list(name: string, filter: string | null | undefined, includeUnrevealedLocations: boolean | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListLocationsResponse> {
			return this.http.get<ListLocationsResponse>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '/locations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&includeUnrevealedLocations=' + includeUnrevealedLocations + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		File_projects_locations_instances_revert(name: string, requestBody: RevertInstanceRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + ':revert', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		File_projects_locations_instances_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListInstancesResponse> {
			return this.http.get<ListInstancesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/instances&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @param {number} pageSize The maximum number of items to return.
		 * @param {string} pageToken The next_page_token value to use if there are additional results to retrieve for this list request.
		 * @return {ListSharesResponse} Successful response
		 */
		File_projects_locations_instances_shares_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSharesResponse> {
			return this.http.get<ListSharesResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/shares&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a share.
		 * Post v1beta1/{parent}/shares
		 ...
		 * @return {Operation} Successful response
		 */
		File_projects_locations_instances_shares_create(parent: string, shareId: string | null | undefined, requestBody: Share): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/shares&shareId=' + (shareId == null ? '' : encodeURIComponent(shareId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all snapshots in a project for either a specified location or for all locations.
		 * Get v1beta1/{parent}/snapshots
		...
		File_projects_locations_instances_snapshots_list(parent: string, filter: string | null | undefined, orderBy: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListSnapshotsResponse> {
			return this.http.get<ListSnapshotsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/snapshots&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a snapshot.
		 * Post v1beta1/{parent}/snapshots
		...
		File_projects_locations_instances_snapshots_create(parent: string, snapshotId: string | null | undefined, requestBody: Snapshot): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/snapshots&snapshotId=' + (snapshotId == null ? '' : encodeURIComponent(snapshotId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
