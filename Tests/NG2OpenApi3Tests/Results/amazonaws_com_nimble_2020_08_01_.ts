...
export namespace MyNS {
	...
	export enum LaunchProfileState { CREATE_IN_PROGRESS = 0, READY = 1, UPDATE_IN_PROGRESS = 2, DELETE_IN_PROGRESS = 3, DELETED = 4, DELETE_FAILED = 5, CREATE_FAILED = 6, UPDATE_FAILED = 7 }

	export enum LaunchProfileStatusCode { LAUNCH_PROFILE_CREATED = 0, LAUNCH_PROFILE_UPDATED = 1, LAUNCH_PROFILE_DELETED = 2, LAUNCH_PROFILE_CREATE_IN_PROGRESS = 3, LAUNCH_PROFILE_UPDATE_IN_PROGRESS = 4, LAUNCH_PROFILE_DELETE_IN_PROGRESS = 5, INTERNAL_ERROR = 6, STREAMING_IMAGE_NOT_FOUND = 7, STREAMING_IMAGE_NOT_READY = 8, LAUNCH_PROFILE_WITH_STREAM_SESSIONS_NOT_DELETED = 9, ENCRYPTION_KEY_ACCESS_DENIED = 10, ENCRYPTION_KEY_NOT_FOUND = 11, INVALID_SUBNETS_PROVIDED = 12, INVALID_INSTANCE_TYPES_PROVIDED = 13, INVALID_SUBNETS_COMBINATION = 14 }
	...
	export enum AutomaticTerminationMode { DEACTIVATED = 0, ACTIVATED = 1 }

	export enum StreamingClipboardMode { ENABLED = 0, DISABLED = 1 }

	export enum StreamingInstanceType { 'g4dn.xlarge' = 0, 'g4dn.2xlarge' = 1, 'g4dn.4xlarge' = 2, 'g4dn.8xlarge' = 3, 'g4dn.12xlarge' = 4, 'g4dn.16xlarge' = 5, 'g3.4xlarge' = 6, 'g3s.xlarge' = 7, 'g5.xlarge' = 8, 'g5.2xlarge' = 9, 'g5.4xlarge' = 10, 'g5.8xlarge' = 11, 'g5.16xlarge' = 12 }
	...
	export enum SessionBackupMode { AUTOMATIC = 0, DEACTIVATED = 1 }
	...
	export enum StreamingSessionStorageMode { UPLOAD = 0 }
	...
	export enum LaunchProfileValidationState { VALIDATION_NOT_STARTED = 0, VALIDATION_IN_PROGRESS = 1, VALIDATION_SUCCESS = 2, VALIDATION_FAILED = 3, VALIDATION_FAILED_INTERNAL_SERVER_ERROR = 4 }

	export enum LaunchProfileValidationStatusCode { VALIDATION_NOT_STARTED = 0, VALIDATION_IN_PROGRESS = 1, VALIDATION_SUCCESS = 2, VALIDATION_FAILED_INVALID_SUBNET_ROUTE_TABLE_ASSOCIATION = 3, VALIDATION_FAILED_SUBNET_NOT_FOUND = 4, VALIDATION_FAILED_INVALID_SECURITY_GROUP_ASSOCIATION = 5, VALIDATION_FAILED_INVALID_ACTIVE_DIRECTORY = 6, VALIDATION_FAILED_UNAUTHORIZED = 7, VALIDATION_FAILED_INTERNAL_SERVER_ERROR = 8 }

	export enum LaunchProfileValidationType { VALIDATE_ACTIVE_DIRECTORY_STUDIO_COMPONENT = 0, VALIDATE_SUBNET_ASSOCIATION = 1, VALIDATE_NETWORK_ACL_ASSOCIATION = 2, VALIDATE_SECURITY_GROUP_ASSOCIATION = 3 }

	export enum SessionPersistenceMode { DEACTIVATED = 0, ACTIVATED = 1 }
	...
	export enum StreamingImageEncryptionConfigurationKeyType { CUSTOMER_MANAGED_KEY = 0 }

	export enum StreamingImageState { CREATE_IN_PROGRESS = 0, READY = 1, DELETE_IN_PROGRESS = 2, DELETED = 3, UPDATE_IN_PROGRESS = 4, UPDATE_FAILED = 5, CREATE_FAILED = 6, DELETE_FAILED = 7 }


	/** The status code. */
	export enum StreamingImageStatusCode { STREAMING_IMAGE_CREATE_IN_PROGRESS = 0, STREAMING_IMAGE_READY = 1, STREAMING_IMAGE_DELETE_IN_PROGRESS = 2, STREAMING_IMAGE_DELETED = 3, STREAMING_IMAGE_UPDATE_IN_PROGRESS = 4, INTERNAL_ERROR = 5, ACCESS_DENIED = 6 }
	...
	export enum StreamingSessionState { CREATE_IN_PROGRESS = 0, DELETE_IN_PROGRESS = 1, READY = 2, DELETED = 3, CREATE_FAILED = 4, DELETE_FAILED = 5, STOP_IN_PROGRESS = 6, START_IN_PROGRESS = 7, STOPPED = 8, STOP_FAILED = 9, START_FAILED = 10 }

	export enum StreamingSessionStatusCode { STREAMING_SESSION_READY = 0, STREAMING_SESSION_DELETED = 1, STREAMING_SESSION_CREATE_IN_PROGRESS = 2, STREAMING_SESSION_DELETE_IN_PROGRESS = 3, INTERNAL_ERROR = 4, INSUFFICIENT_CAPACITY = 5, ACTIVE_DIRECTORY_DOMAIN_JOIN_ERROR = 6, NETWORK_CONNECTION_ERROR = 7, INITIALIZATION_SCRIPT_ERROR = 8, DECRYPT_STREAMING_IMAGE_ERROR = 9, NETWORK_INTERFACE_ERROR = 10, STREAMING_SESSION_STOPPED = 11, STREAMING_SESSION_STARTED = 12, STREAMING_SESSION_STOP_IN_PROGRESS = 13, STREAMING_SESSION_START_IN_PROGRESS = 14, AMI_VALIDATION_ERROR = 15 }

	export enum VolumeRetentionMode { RETAIN = 0, DELETE = 1 }
	...
	export enum StreamingSessionStreamState { READY = 0, CREATE_IN_PROGRESS = 1, DELETE_IN_PROGRESS = 2, DELETED = 3, CREATE_FAILED = 4, DELETE_FAILED = 5 }

	export enum StreamingSessionStreamStatusCode { STREAM_CREATE_IN_PROGRESS = 0, STREAM_READY = 1, STREAM_DELETE_IN_PROGRESS = 2, STREAM_DELETED = 3, INTERNAL_ERROR = 4, NETWORK_CONNECTION_ERROR = 5 }
	...
	/** The status code. */
	export enum StudioStatusCode { STUDIO_CREATED = 0, STUDIO_DELETED = 1, STUDIO_UPDATED = 2, STUDIO_CREATE_IN_PROGRESS = 3, STUDIO_UPDATE_IN_PROGRESS = 4, STUDIO_DELETE_IN_PROGRESS = 5, STUDIO_WITH_LAUNCH_PROFILES_NOT_DELETED = 6, STUDIO_WITH_STUDIO_COMPONENTS_NOT_DELETED = 7, STUDIO_WITH_STREAMING_IMAGES_NOT_DELETED = 8, AWS_SSO_NOT_ENABLED = 9, AWS_SSO_ACCESS_DENIED = 10, ROLE_NOT_OWNED_BY_STUDIO_OWNER = 11, ROLE_COULD_NOT_BE_ASSUMED = 12, INTERNAL_ERROR = 13, ENCRYPTION_KEY_NOT_FOUND = 14, ENCRYPTION_KEY_ACCESS_DENIED = 15, AWS_SSO_CONFIGURATION_REPAIRED = 16, AWS_SSO_CONFIGURATION_REPAIR_IN_PROGRESS = 17, AWS_STS_REGION_DISABLED = 18 }
	...
	export enum StudioEncryptionConfigurationKeyType { AWS_OWNED_KEY = 0, CUSTOMER_MANAGED_KEY = 1 }
	...
	export enum LaunchProfilePlatform { LINUX = 0, WINDOWS = 1 }

	export enum StudioComponentInitializationScriptRunContext { SYSTEM_INITIALIZATION = 0, USER_INITIALIZATION = 1 }
	...
	export enum StudioComponentStatusCode { ACTIVE_DIRECTORY_ALREADY_EXISTS = 0, STUDIO_COMPONENT_CREATED = 1, STUDIO_COMPONENT_UPDATED = 2, STUDIO_COMPONENT_DELETED = 3, ENCRYPTION_KEY_ACCESS_DENIED = 4, ENCRYPTION_KEY_NOT_FOUND = 5, STUDIO_COMPONENT_CREATE_IN_PROGRESS = 6, STUDIO_COMPONENT_UPDATE_IN_PROGRESS = 7, STUDIO_COMPONENT_DELETE_IN_PROGRESS = 8, INTERNAL_ERROR = 9 }

	export enum StudioComponentSubtype { AWS_MANAGED_MICROSOFT_AD = 0, AMAZON_FSX_FOR_WINDOWS = 1, AMAZON_FSX_FOR_LUSTRE = 2, CUSTOM = 3 }

	export enum StudioComponentType { ACTIVE_DIRECTORY = 0, SHARED_FILE_SYSTEM = 1, COMPUTE_FARM = 2, LICENSE_SERVICE = 3, CUSTOM = 4 }
	...
	export enum LaunchProfilePersona { USER = 0 }
	...
	export enum StudioPersona { ADMINISTRATOR = 0 }
	...
	export enum StudioComponentState { CREATE_IN_PROGRESS = 0, READY = 1, UPDATE_IN_PROGRESS = 2, DELETE_IN_PROGRESS = 3, DELETED = 4, DELETE_FAILED = 5, CREATE_FAILED = 6, UPDATE_FAILED = 7 }
	...
	export enum StudioState { CREATE_IN_PROGRESS = 0, READY = 1, UPDATE_IN_PROGRESS = 2, DELETE_IN_PROGRESS = 3, DELETED = 4, DELETE_FAILED = 5, CREATE_FAILED = 6, UPDATE_FAILED = 7 }
