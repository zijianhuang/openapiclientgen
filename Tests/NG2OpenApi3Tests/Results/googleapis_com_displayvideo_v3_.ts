...
export namespace MyNS {
	...
	export enum AdGroupAdGroupFormat { AD_GROUP_FORMAT_UNSPECIFIED = 0, AD_GROUP_FORMAT_IN_STREAM = 1, AD_GROUP_FORMAT_VIDEO_DISCOVERY = 2, AD_GROUP_FORMAT_BUMPER = 3, AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM = 4, AD_GROUP_FORMAT_AUDIO = 5, AD_GROUP_FORMAT_RESPONSIVE = 6, AD_GROUP_FORMAT_REACH = 7, AD_GROUP_FORMAT_MASTHEAD = 8 }
	...
	export enum AdGroupEntityStatus { ENTITY_STATUS_UNSPECIFIED = 0, ENTITY_STATUS_ACTIVE = 1, ENTITY_STATUS_ARCHIVED = 2, ENTITY_STATUS_DRAFT = 3, ENTITY_STATUS_PAUSED = 4, ENTITY_STATUS_SCHEDULED_FOR_DELETION = 5 }
	...
	export enum TargetingExpansionConfigAudienceExpansionLevel { UNKNOWN = 0, NO_REACH = 1, LEAST_REACH = 2, MID_REACH = 3, MOST_REACH = 4 }
	...
	export enum AlgorithmRulesRulesetAggregationType { RULE_AGGREGATION_TYPE_UNSPECIFIED = 0, SUM_OF_VALUES = 1, PRODUCT_OF_VALUES = 2, MAXIMUM_VALUE = 3 }
	...
	export enum AlgorithmRulesSignalComparisonComparisonOperator { COMPARISON_OPERATOR_UNSPECIFIED = 0, EQUAL = 1, GREATER_THAN = 2, LESS_THAN = 3, GREATER_THAN_OR_EQUAL_TO = 4, LESS_THAN_OR_EQUAL_TO = 5 }
	...
	export enum AlgorithmRulesComparisonValueDeviceTypeValue { RULE_DEVICE_TYPE_UNSPECIFIED = 0, RULE_DEVICE_TYPE_COMPUTER = 1, RULE_DEVICE_TYPE_CONNECTED_TV = 2, RULE_DEVICE_TYPE_SMART_PHONE = 3, RULE_DEVICE_TYPE_TABLET = 4, RULE_DEVICE_TYPE_CONNECTED_DEVICE = 5, RULE_DEVICE_TYPE_SET_TOP_BOX = 6 }
	...
	export enum AlgorithmRulesSignalImpressionSignal { IMPRESSION_SIGNAL_UNSPECIFIED = 0, DAY_AND_TIME = 1, DEVICE_TYPE = 2, AD_POSITION = 3, OPERATING_SYSTEM_ID = 4, MOBILE_MODEL_ID = 5, EXCHANGE = 6, ENVIRONMENT = 7, COUNTRY_ID = 8, CITY_ID = 9, BROWSER_ID = 10, CREATIVE_DIMENSION = 11 }
	...
	export enum CustomBiddingAlgorithmCustomBiddingAlgorithmType { CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED = 0, SCRIPT_BASED = 1, ADS_DATA_HUB_BASED = 2, GOAL_BUILDER_BASED = 3, RULE_BASED = 4 }
	...
	export enum CustomBiddingModelDetailsReadinessState { READINESS_STATE_UNSPECIFIED = 0, READINESS_STATE_ACTIVE = 1, READINESS_STATE_INSUFFICIENT_DATA = 2, READINESS_STATE_TRAINING = 3, READINESS_STATE_NO_VALID_SCRIPT = 4, READINESS_STATE_EVALUATION_FAILURE = 5 }
	...
	export enum CustomBiddingAlgorithmRulesErrorErrorCode { ERROR_CODE_UNSPECIFIED = 0, SYNTAX_ERROR = 1, CONSTRAINT_VIOLATION_ERROR = 2, INTERNAL_ERROR = 3 }
	...
	export enum CustomBiddingAlgorithmRulesState { STATE_UNSPECIFIED = 0, ACCEPTED = 1, REJECTED = 2 }
	...
	export enum KpiKpiType { KPI_TYPE_UNSPECIFIED = 0, KPI_TYPE_CPM = 1, KPI_TYPE_CPC = 2, KPI_TYPE_CPA = 3, KPI_TYPE_CTR = 4, KPI_TYPE_VIEWABILITY = 5, KPI_TYPE_CPIAVC = 6, KPI_TYPE_CPE = 7, KPI_TYPE_CLICK_CVR = 8, KPI_TYPE_IMPRESSION_CVR = 9, KPI_TYPE_VCPM = 10, KPI_TYPE_VTR = 11, KPI_TYPE_AUDIO_COMPLETION_RATE = 12, KPI_TYPE_VIDEO_COMPLETION_RATE = 13, KPI_TYPE_OTHER = 14 }
