...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {DelcsPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Delcs(requestBody: DelcsPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'delcs/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {PalcsPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Palcs(requestBody: PalcsPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'palcs/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {RelcsPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Relcs(requestBody: RelcsPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'relcs/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface DelcsPostBody {
		certificateParameters?: DelcsPostBodyCertificateParameters;
	...
	export interface DelcsPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<DelcsPostBodyFormat | null | undefined>,
	...
	export function CreateDelcsPostBodyFormGroup() {
		return new FormGroup<DelcsPostBodyFormProperties>({
			format: new FormControl<DelcsPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface DelcsPostBodyCertificateParameters {
	...
	export interface DelcsPostBodyCertificateParametersFormProperties {

		/**
		 * Application No.
		 * Required
		 */
		applicationNo: FormControl<string | null | undefined>,

		/**
		 * License No.
		 * Required
		 */
		licenseNo: FormControl<string | null | undefined>,
	}
	export function CreateDelcsPostBodyCertificateParametersFormGroup() {
		return new FormGroup<DelcsPostBodyCertificateParametersFormProperties>({
			applicationNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			licenseNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PalcsPostBody {
		certificateParameters?: PalcsPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface PalcsPostBodyFormProperties {
	...
	export function CreatePalcsPostBodyFormGroup() {
		return new FormGroup<PalcsPostBodyFormProperties>({
			format: new FormControl<DelcsPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface PalcsPostBodyCertificateParameters {
	...
	export interface PalcsPostBodyCertificateParametersFormProperties {
	...
	export function CreatePalcsPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PalcsPostBodyCertificateParametersFormProperties>({
			applicationNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			licenseNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface RelcsPostBody {
		certificateParameters?: RelcsPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface RelcsPostBodyFormProperties {
	...
	export function CreateRelcsPostBodyFormGroup() {
		return new FormGroup<RelcsPostBodyFormProperties>({
			format: new FormControl<DelcsPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface RelcsPostBodyCertificateParameters {
	...
	export interface RelcsPostBodyCertificateParametersFormProperties {
	...
	export function CreateRelcsPostBodyCertificateParametersFormGroup() {
		return new FormGroup<RelcsPostBodyCertificateParametersFormProperties>({
			applicationNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			licenseNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
