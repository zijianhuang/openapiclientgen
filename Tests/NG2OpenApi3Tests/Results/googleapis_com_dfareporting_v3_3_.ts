...
export namespace MyNS {
	...
	export enum MobileAppDirectory { UNKNOWN = 'UNKNOWN', APPLE_APP_STORE = 'APPLE_APP_STORE', GOOGLE_PLAY_STORE = 'GOOGLE_PLAY_STORE' }
	...
	export enum CreativeAuthoringSource { CREATIVE_AUTHORING_SOURCE_DCM = 'CREATIVE_AUTHORING_SOURCE_DCM', CREATIVE_AUTHORING_SOURCE_DBM = 'CREATIVE_AUTHORING_SOURCE_DBM', CREATIVE_AUTHORING_SOURCE_STUDIO = 'CREATIVE_AUTHORING_SOURCE_STUDIO', CREATIVE_AUTHORING_SOURCE_GWD = 'CREATIVE_AUTHORING_SOURCE_GWD' }
	...
	export enum UniversalAdIdRegistry { OTHER = 'OTHER', 'AD_ID.ORG' = 'AD_ID.ORG', CLEARCAST = 'CLEARCAST', DCM = 'DCM' }
	...
	export enum ReportType { STANDARD = 'STANDARD', REACH = 'REACH', PATH_TO_CONVERSION = 'PATH_TO_CONVERSION', CROSS_DIMENSION_REACH = 'CROSS_DIMENSION_REACH', FLOODLIGHT = 'FLOODLIGHT' }
