...
export namespace MyNS {
	...
	export enum MobileAppDirectory { UNKNOWN = 0, APPLE_APP_STORE = 1, GOOGLE_PLAY_STORE = 2 }
	...
	export enum CreativeAuthoringSource { CREATIVE_AUTHORING_SOURCE_DCM = 0, CREATIVE_AUTHORING_SOURCE_DBM = 1, CREATIVE_AUTHORING_SOURCE_STUDIO = 2, CREATIVE_AUTHORING_SOURCE_GWD = 3 }
	...
	export enum UniversalAdIdRegistry { OTHER = 0, 'AD_ID.ORG' = 1, CLEARCAST = 2, DCM = 3 }
	...
	export enum ReportType { STANDARD = 0, REACH = 1, PATH_TO_CONVERSION = 2, CROSS_DIMENSION_REACH = 3, FLOODLIGHT = 4 }
