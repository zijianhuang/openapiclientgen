...
export namespace MyNS {
	...
	export interface SkcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		COURSE_NO: FormControl<string | null | undefined>,
		 ...
		 * Required
		 */
		certificate_type: FormControl<string | null | undefined>,
	}
	export function CreateSkcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SkcerPostBodyCertificateParametersFormProperties>({
			COURSE_NO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			certificate_type: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
