...
export namespace MyNS {
	...
	export enum InstanceConfigInstanceSize { INSTANCE_SIZE_UNSPECIFIED = 0, STANDARD_SMALL = 1, STANDARD_MEDIUM = 2, STANDARD_LARGE = 3, STANDARD_XLARGE = 4, STANDARD_2XLARGE = 5, STANDARD_3XLARGE = 6, DEV_XSMALL = 7 }
	...
	export enum ContactCenterState { STATE_UNSPECIFIED = 0, STATE_DEPLOYING = 1, STATE_DEPLOYED = 2, STATE_TERMINATING = 3, STATE_FAILED = 4, STATE_TERMINATING_FAILED = 5, STATE_TERMINATED = 6, STATE_IN_GRACE_PERIOD = 7 }
