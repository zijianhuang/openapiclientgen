...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {MrcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Mrcer(requestBody: MrcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'mrcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}

	export interface MrcerPostBody {
		certificateParameters?: MrcerPostBodyCertificateParameters;
	...
	export interface MrcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<MrcerPostBodyFormat | null | undefined>,
	...
	export function CreateMrcerPostBodyFormGroup() {
		return new FormGroup<MrcerPostBodyFormProperties>({
			format: new FormControl<MrcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface MrcerPostBodyCertificateParameters {
	...
	export interface MrcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateMrcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<MrcerPostBodyCertificateParametersFormProperties>({
	...
	export enum MrcerPostBodyFormat { pdf = 'pdf' }
