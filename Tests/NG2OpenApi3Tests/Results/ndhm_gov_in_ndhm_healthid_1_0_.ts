...
export namespace MyNS {
	...
	export enum AuthAccountAadhaarBioRequestAuthType { FINGERSCAN = 0, IRIS = 1, OTP = 2 }
	...
	export enum AuthInitRequestAuthMethod { AADHAAR_OTP = 0, MOBILE_OTP = 1, PASSWORD = 2, DEMOGRAPHICS = 3, AADHAAR_BIO = 4 }
	...
	export enum CreateHidMobileRequestBenefitDocType { VOTER_ID_CARD = 0, RATION_CARD = 1, PAN_CARD = 2, DRIVING_LICENSE = 3, PENSIONER_PHOTO_CARD = 4, KISSAN_PHOTO_PASSBOOK = 5, FREEDOM_FIGHTER_PHOTO_CARD = 6, CERTIFICATE_IDENTIFY = 7, DISABILITY_ID_CARD = 8, MNREGA_JOB_CARD = 9, BIRTH_CERTIFICATE = 10, MARRIAGE_CERTIFICATE = 11, OTHER_GOVERNMENT_ID = 12, ADOPTION_CERTIFICATE = 13 }
	...
	export enum ResponseEntityStatusCode { '100 CONTINUE' = 0, '101 SWITCHING_PROTOCOLS' = 1, '102 PROCESSING' = 2, '103 CHECKPOINT' = 3, '200 OK' = 4, '201 CREATED' = 5, '202 ACCEPTED' = 6, '203 NON_AUTHORITATIVE_INFORMATION' = 7, '204 NO_CONTENT' = 8, '205 RESET_CONTENT' = 9, '206 PARTIAL_CONTENT' = 10, '207 MULTI_STATUS' = 11, '208 ALREADY_REPORTED' = 12, '226 IM_USED' = 13, '300 MULTIPLE_CHOICES' = 14, '301 MOVED_PERMANENTLY' = 15, '302 FOUND' = 16, '302 MOVED_TEMPORARILY' = 17, '303 SEE_OTHER' = 18, '304 NOT_MODIFIED' = 19, '305 USE_PROXY' = 20, '307 TEMPORARY_REDIRECT' = 21, '308 PERMANENT_REDIRECT' = 22, '400 BAD_REQUEST' = 23, '401 UNAUTHORIZED' = 24, '402 PAYMENT_REQUIRED' = 25, '403 FORBIDDEN' = 26, '404 NOT_FOUND' = 27, '405 METHOD_NOT_ALLOWED' = 28, '406 NOT_ACCEPTABLE' = 29, '407 PROXY_AUTHENTICATION_REQUIRED' = 30, '408 REQUEST_TIMEOUT' = 31, '409 CONFLICT' = 32, '410 GONE' = 33, '411 LENGTH_REQUIRED' = 34, '412 PRECONDITION_FAILED' = 35, '413 PAYLOAD_TOO_LARGE' = 36, '413 REQUEST_ENTITY_TOO_LARGE' = 37, '414 URI_TOO_LONG' = 38, '414 REQUEST_URI_TOO_LONG' = 39, '415 UNSUPPORTED_MEDIA_TYPE' = 40, '416 REQUESTED_RANGE_NOT_SATISFIABLE' = 41, '417 EXPECTATION_FAILED' = 42, '418 I_AM_A_TEAPOT' = 43, '419 INSUFFICIENT_SPACE_ON_RESOURCE' = 44, '420 METHOD_FAILURE' = 45, '421 DESTINATION_LOCKED' = 46, '422 UNPROCESSABLE_ENTITY' = 47, '423 LOCKED' = 48, '424 FAILED_DEPENDENCY' = 49, '426 UPGRADE_REQUIRED' = 50, '428 PRECONDITION_REQUIRED' = 51, '429 TOO_MANY_REQUESTS' = 52, '431 REQUEST_HEADER_FIELDS_TOO_LARGE' = 53, '451 UNAVAILABLE_FOR_LEGAL_REASONS' = 54, '500 INTERNAL_SERVER_ERROR' = 55, '501 NOT_IMPLEMENTED' = 56, '502 BAD_GATEWAY' = 57, '503 SERVICE_UNAVAILABLE' = 58, '504 GATEWAY_TIMEOUT' = 59, '505 HTTP_VERSION_NOT_SUPPORTED' = 60, '506 VARIANT_ALSO_NEGOTIATES' = 61, '507 INSUFFICIENT_STORAGE' = 62, '508 LOOP_DETECTED' = 63, '509 BANDWIDTH_LIMIT_EXCEEDED' = 64, '510 NOT_EXTENDED' = 65, '511 NETWORK_AUTHENTICATION_REQUIRED' = 66 }
