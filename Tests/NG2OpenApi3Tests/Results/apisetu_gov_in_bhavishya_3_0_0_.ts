...
export namespace MyNS {
	...
	export interface PecerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		PPO: FormControl<string | null | undefined>,
	}
	export function CreatePecerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PecerPostBodyCertificateParametersFormProperties>({
			...
			GENDER: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			PAN: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			PPO: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
