...
export namespace MyNS {
	...
	export enum GoogleCloudBillingBudgetsV1beta1FilterCalendarPeriod { CALENDAR_PERIOD_UNSPECIFIED = 'CALENDAR_PERIOD_UNSPECIFIED', MONTH = 'MONTH', QUARTER = 'QUARTER', YEAR = 'YEAR' }

	export enum GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatment { CREDIT_TYPES_TREATMENT_UNSPECIFIED = 'CREDIT_TYPES_TREATMENT_UNSPECIFIED', INCLUDE_ALL_CREDITS = 'INCLUDE_ALL_CREDITS', EXCLUDE_ALL_CREDITS = 'EXCLUDE_ALL_CREDITS', INCLUDE_SPECIFIED_CREDITS = 'INCLUDE_SPECIFIED_CREDITS' }
	...
	export enum GoogleCloudBillingBudgetsV1beta1BudgetOwnershipScope { OWNERSHIP_SCOPE_UNSPECIFIED = 'OWNERSHIP_SCOPE_UNSPECIFIED', ALL_USERS = 'ALL_USERS', BILLING_ACCOUNT = 'BILLING_ACCOUNT' }
	...
	export enum GoogleCloudBillingBudgetsV1beta1ThresholdRuleSpendBasis { BASIS_UNSPECIFIED = 'BASIS_UNSPECIFIED', CURRENT_SPEND = 'CURRENT_SPEND', FORECASTED_SPEND = 'FORECASTED_SPEND' }
