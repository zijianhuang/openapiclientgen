...
export namespace MyNS {
	...
	export enum GoogleCloudIntegrationsV1alphaIntegrationTemplateVersionDatabasePersistencePolicy { DATABASE_PERSISTENCE_POLICY_UNSPECIFIED = 0, DATABASE_PERSISTENCE_DISABLED = 1 }

	export enum GoogleCloudIntegrationsV1alphaIntegrationTemplateVersionStatus { UNKNOWN = 0, DRAFT = 1, ACTIVE = 2, ARCHIVED = 3, SNAPSHOT = 4 }
