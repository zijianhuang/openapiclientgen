...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * Get 2018-06-18/origin-access-identity/cloudfront
		 ...
		 * @return {void} Success
		 */
		ListCloudFrontOriginAccessIdentities2018_06_18(Marker: string | null | undefined, MaxItems: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/origin-access-identity/cloudfront?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * List distributions.
		 * Get 2018-06-18/distribution
		 ...
		 * @return {void} Success
		 */
		ListDistributions2018_06_18(Marker: string | null | undefined, MaxItems: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/distribution?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * List all field-level encryption configurations that have been created in CloudFront for this account.
		 * Get 2018-06-18/field-level-encryption
		 ...
		 * @return {void} Success
		 */
		ListFieldLevelEncryptionConfigs2018_06_18(Marker: string | null | undefined, MaxItems: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/field-level-encryption?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Request a list of field-level encryption profiles that have been created in CloudFront for this account.
		 * Get 2018-06-18/field-level-encryption-profile
		 ...
		 * @return {void} Success
		 */
		ListFieldLevelEncryptionProfiles2018_06_18(Marker: string | null | undefined, MaxItems: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/field-level-encryption-profile?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Lists invalidation batches.
		 * Get 2018-06-18/distribution/{DistributionId}/invalidation
		 ...
		 * @return {void} Success
		 */
		ListInvalidations2018_06_18(DistributionId: string, Marker: string | null | undefined, MaxItems: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/distribution/' + (DistributionId == null ? '' : encodeURIComponent(DistributionId)) + '/invalidation&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * List all public keys that have been added to CloudFront for this account.
		 * Get 2018-06-18/public-key
		 ...
		 * @return {void} Success
		 */
		ListPublicKeys2018_06_18(Marker: string | null | undefined, MaxItems: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/public-key?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * List streaming distributions.
		 * Get 2018-06-18/streaming-distribution
		 ...
		 * @return {void} Success
		 */
		ListStreamingDistributions2018_06_18(Marker: string | null | undefined, MaxItems: string | null | undefined): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/streaming-distribution?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Delete an origin access identity.
		 * Delete 2018-06-18/origin-access-identity/cloudfront/{Id}
		 * @param {string} Id The origin access identity's ID.
		 * @return {void} 
		 */
		DeleteCloudFrontOriginAccessIdentity2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '2018-06-18/origin-access-identity/cloudfront/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the information about an origin access identity.
		 * Get 2018-06-18/origin-access-identity/cloudfront/{Id}
		 * @param {string} Id The identity's ID.
		 * @return {void} Success
		 */
		GetCloudFrontOriginAccessIdentity2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/origin-access-identity/cloudfront/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Delete a distribution.
		 * Delete 2018-06-18/distribution/{Id}
		 * @param {string} Id The distribution ID. 
		 * @return {void} 
		 */
		DeleteDistribution2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '2018-06-18/distribution/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the information about a distribution.
		 * Get 2018-06-18/distribution/{Id}
		 * @param {string} Id The distribution's ID.
		 * @return {void} Success
		 */
		GetDistribution2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/distribution/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Remove a field-level encryption configuration.
		 * Delete 2018-06-18/field-level-encryption/{Id}
		 * @param {string} Id The ID of the configuration you want to delete from CloudFront.
		 * @return {void} 
		 */
		DeleteFieldLevelEncryptionConfig2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '2018-06-18/field-level-encryption/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the field-level encryption configuration information.
		 * Get 2018-06-18/field-level-encryption/{Id}
		 * @param {string} Id Request the ID for the field-level encryption configuration information.
		 * @return {void} Success
		 */
		GetFieldLevelEncryption2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/field-level-encryption/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Remove a field-level encryption profile.
		 * Delete 2018-06-18/field-level-encryption-profile/{Id}
		 * @param {string} Id Request the ID of the profile you want to delete from CloudFront.
		 * @return {void} 
		 */
		DeleteFieldLevelEncryptionProfile2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '2018-06-18/field-level-encryption-profile/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the field-level encryption profile information.
		 * Get 2018-06-18/field-level-encryption-profile/{Id}
		 * @param {string} Id Get the ID for the field-level encryption profile information.
		 * @return {void} Success
		 */
		GetFieldLevelEncryptionProfile2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/field-level-encryption-profile/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Remove a public key you previously added to CloudFront.
		 * Delete 2018-06-18/public-key/{Id}
		 * @param {string} Id The ID of the public key you want to remove from CloudFront.
		 * @return {void} 
		 */
		DeletePublicKey2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '2018-06-18/public-key/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the public key information.
		 * Get 2018-06-18/public-key/{Id}
		 * @param {string} Id Request the ID for the public key.
		 * @return {void} Success
		 */
		GetPublicKey2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/public-key/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * Delete 2018-06-18/streaming-distribution/{Id}
		 * @param {string} Id The distribution ID. 
		 * @return {void} 
		 */
		DeleteStreamingDistribution2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '2018-06-18/streaming-distribution/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Gets information about a specified RTMP distribution, including the distribution configuration.
		 * Get 2018-06-18/streaming-distribution/{Id}
		 * @param {string} Id The streaming distribution's ID.
		 * @return {void} Success
		 */
		GetStreamingDistribution2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/streaming-distribution/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the configuration information about an origin access identity.
		 * Get 2018-06-18/origin-access-identity/cloudfront/{Id}/config
		 * @param {string} Id The identity's ID. 
		 * @return {void} Success
		 */
		GetCloudFrontOriginAccessIdentityConfig2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/origin-access-identity/cloudfront/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the configuration information about a distribution.
		 * Get 2018-06-18/distribution/{Id}/config
		 * @param {string} Id The distribution's ID.
		 * @return {void} Success
		 */
		GetDistributionConfig2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/distribution/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the field-level encryption configuration information.
		 * Get 2018-06-18/field-level-encryption/{Id}/config
		 * @param {string} Id Request the ID for the field-level encryption configuration information.
		 * @return {void} Success
		 */
		GetFieldLevelEncryptionConfig2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/field-level-encryption/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the field-level encryption profile configuration information.
		 * Get 2018-06-18/field-level-encryption-profile/{Id}/config
		 * @param {string} Id Get the ID for the field-level encryption profile configuration information.
		 * @return {void} Success
		 */
		GetFieldLevelEncryptionProfileConfig2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/field-level-encryption-profile/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the information about an invalidation.
		 * Get 2018-06-18/distribution/{DistributionId}/invalidation/{Id}
		 * @param {string} DistributionId The distribution's ID.
		 * @param {string} Id The identifier for the invalidation request, for example, <code>IDFDVBD632BHDS5</code>.
		 * @return {void} Success
		 */
		GetInvalidation2018_06_18(DistributionId: string, Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/distribution/' + (DistributionId == null ? '' : encodeURIComponent(DistributionId)) + '/invalidation/' + (Id == null ? '' : encodeURIComponent(Id)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * Return public key configuration informaation
		 * Get 2018-06-18/public-key/{Id}/config
		 * @param {string} Id Request the ID for the public key configuration.
		 * @return {void} Success
		 */
		GetPublicKeyConfig2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/public-key/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { observe: 'response', responseType: 'text' });
		}

		/**
		 * Get the configuration information about a streaming distribution.
		 * Get 2018-06-18/streaming-distribution/{Id}/config
		 * @param {string} Id The streaming distribution's ID.
		 * @return {void} Success
		 */
		GetStreamingDistributionConfig2018_06_18(Id: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/streaming-distribution/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { observe: 'response', responseType: 'text' });
		}

		/**
		 * List the distributions that are associated with a specified AWS WAF web ACL.
		 * Get 2018-06-18/distributionsByWebACLId/{WebACLId}
		 ...
		 * @return {void} Success
		 */
		ListDistributionsByWebACLId2018_06_18(Marker: string | null | undefined, MaxItems: string | null | undefined, WebACLId: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/distributionsByWebACLId/' + (WebACLId == null ? '' : encodeURIComponent(WebACLId)) + '?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { observe: 'response', responseType: 'text' });
		}

		/**
		 * List tags for a CloudFront resource.
		 * Get 2018-06-18/tagging#Resource
		 * @param {string} Resource  An ARN of a CloudFront resource.
		 * @return {void} Success
		 */
		ListTagsForResource2018_06_18(Resource: string): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '2018-06-18/tagging#Resource?Resource=' + (Resource == null ? '' : encodeURIComponent(Resource)), { observe: 'response', responseType: 'text' });
		}
	}

	export enum TagResource2018_06_18Operation { Tag = 'Tag' }

	export enum UntagResource2018_06_18Operation { Untag = 'Untag' }
