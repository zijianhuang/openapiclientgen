...
export namespace MyNS {
	...
	export enum EcoCertificationEcoCertificate { ECO_CERTIFICATE_UNSPECIFIED = 0, ISO14001 = 1, ISO50001 = 2, ASIAN_ECOTOURISM = 3, BIOSPHERE_RESPOSNIBLE_TOURISM = 4, BUREAU_VERITAS = 5, CONTROL_UNION = 6, EARTHCHECK = 7, ECO_CERTIFICATION_MALTA = 8, ECOTOURISM_AUSTRALIAS_ECO = 9, GREAT_GREEN_DEAL = 10, GREEN_GLOBE = 11, GREEN_GROWTH2050 = 12, GREEN_KEY = 13, GREEN_KEY_ECO_RATING = 14, GREEN_SEAL = 15, GREEN_STAR = 16, GREEN_TOURISM_ACTIVE = 17, HILTON_LIGHTSTAY = 18, HOSTELLING_INTERNATIONALS_QUALITY_AND_SUSTAINABILITY = 19, HOTELES_MAS_VERDES = 20, NORDIC_SWAN_ECOLABEL = 21, PREFERRED_BY_NATURE_SUSTAINABLE_TOURISM = 22, SUSTAINABLE_TRAVEL_IRELAND = 23, TOF_TIGERS_INITITIVES_PUG = 24, TRAVELIFE = 25, UNITED_CERTIFICATION_SYSTEMS_LIMITED = 26, VIREO_SRL = 27 }
	...
	export enum SustainabilityCertificationsBreeamCertification { BREEAM_CERTIFICATION_UNSPECIFIED = 0, NO_BREEAM_CERTIFICATION = 1, BREEAM_PASS = 2, BREEAM_GOOD = 3, BREEAM_VERY_GOOD = 4, BREEAM_EXCELLENT = 5, BREEAM_OUTSTANDING = 6 }

	export enum SustainabilityCertificationsLeedCertification { LEED_CERTIFICATION_UNSPECIFIED = 0, NO_LEED_CERTIFICATION = 1, LEED_CERTIFIED = 2, LEED_SILVER = 3, LEED_GOLD = 4, LEED_PLATINUM = 5 }
