...
export namespace MyNS {
	...
	export function CreateEvaluateExpressionOutputFormGroup() {
		return new FormGroup<EvaluateExpressionOutputFormProperties>({
			evaluatedExpression: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export function CreatePollForTaskInputFormGroup() {
		return new FormGroup<PollForTaskInputFormProperties>({
			workerGroup: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export function CreateQueryObjectsInputFormGroup() {
		return new FormGroup<QueryObjectsInputFormProperties>({
			pipelineId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			sphere: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			marker: new FormControl<string | null | undefined>(undefined),
	...
	export function CreateReportTaskRunnerHeartbeatInputFormGroup() {
		return new FormGroup<ReportTaskRunnerHeartbeatInputFormProperties>({
			taskrunnerId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export function CreateSetTaskStatusInputFormGroup() {
		return new FormGroup<SetTaskStatusInputFormProperties>({
			taskId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			taskStatus: new FormControl<TaskStatus | null | undefined>(undefined, [Validators.required]),
