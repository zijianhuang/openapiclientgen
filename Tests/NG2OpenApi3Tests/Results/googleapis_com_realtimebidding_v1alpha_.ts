...
export namespace MyNS {
	...
	export enum BiddingFunctionState { STATE_UNSPECIFIED = 0, ACTIVE = 1, ARCHIVED = 2 }

	export enum BiddingFunctionType { FUNCTION_TYPE_UNSPECIFIED = 0, TURTLEDOVE_SIMULATION_BIDDING_FUNCTION = 1, FLEDGE_BIDDING_FUNCTION = 2 }
