...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Apigateway_projects_locations_operations_get(name: string): Observable<ApigatewayOperation> {
			return this.http.get<ApigatewayOperation>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		...
		Apigateway_projects_locations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ApigatewayListLocationsResponse> {
			return this.http.get<ApigatewayListLocationsResponse>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)) + '/locations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Apigateway_projects_locations_operations_list(name: string, filter: string | null | undefined, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ApigatewayListOperationsResponse> {
			return this.http.get<ApigatewayListOperationsResponse>(this.baseUri + 'v1alpha2/' + (name == null ? '' : encodeURIComponent(name)) + '/operations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		...
		Apigateway_projects_locations_gateways_getIamPolicy(resource: string, options_requestedPolicyVersion: number | null | undefined): Observable<ApigatewayPolicy> {
			return this.http.get<ApigatewayPolicy>(this.baseUri + 'v1alpha2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':getIamPolicy&options_requestedPolicyVersion=' + options_requestedPolicyVersion, {});
		}
		...
		Apigateway_projects_locations_gateways_setIamPolicy(resource: string, requestBody: ApigatewaySetIamPolicyRequest): Observable<ApigatewayPolicy> {
			return this.http.post<ApigatewayPolicy>(this.baseUri + 'v1alpha2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':setIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Apigateway_projects_locations_gateways_testIamPermissions(resource: string, requestBody: ApigatewayTestIamPermissionsRequest): Observable<ApigatewayTestIamPermissionsResponse> {
			return this.http.post<ApigatewayTestIamPermissionsResponse>(this.baseUri + 'v1alpha2/' + (resource == null ? '' : encodeURIComponent(resource)) + ':testIamPermissions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
