...
export namespace MyNS {
	...
	/** Video annotation request. */
	export interface GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequestFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1beta2_AnnotateVideoRequestFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequestFormProperties>({
	...
	/** Video context and/or feature-specific parameters. */
	export interface GoogleCloudVideointelligenceV1beta2_VideoContextFormProperties {
	}
	export function CreateGoogleCloudVideointelligenceV1beta2_VideoContextFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_VideoContextFormProperties>({
		});
	...
	/** Config for EXPLICIT_CONTENT_DETECTION. */
	export interface GoogleCloudVideointelligenceV1beta2_ExplicitContentDetectionConfigFormProperties {

		/** Model to use for explicit content detection. Supported values: "builtin/stable" (the default if unset) and "builtin/latest". */
		model: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudVideointelligenceV1beta2_ExplicitContentDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_ExplicitContentDetectionConfigFormProperties>({
	...
	/** Config for FACE_DETECTION. */
	export interface GoogleCloudVideointelligenceV1beta2_FaceDetectionConfigFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1beta2_FaceDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_FaceDetectionConfigFormProperties>({
	...
	export interface GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig {
		...
		labelDetectionMode?: GoogleCloudVideointelligenceV1beta2_LabelDetectionConfigLabelDetectionMode | null;
	...
	/** Config for LABEL_DETECTION. */
	export interface GoogleCloudVideointelligenceV1beta2_LabelDetectionConfigFormProperties {
		...
		/** What labels should be detected with LABEL_DETECTION, in addition to video-level labels or segment-level labels. If unspecified, defaults to `SHOT_MODE`. */
		labelDetectionMode: FormControl<GoogleCloudVideointelligenceV1beta2_LabelDetectionConfigLabelDetectionMode | null | undefined>,
	...
	export function CreateGoogleCloudVideointelligenceV1beta2_LabelDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_LabelDetectionConfigFormProperties>({
			frameConfidenceThreshold: new FormControl<number | null | undefined>(undefined),
			labelDetectionMode: new FormControl<GoogleCloudVideointelligenceV1beta2_LabelDetectionConfigLabelDetectionMode | null | undefined>(undefined),
			model: new FormControl<string | null | undefined>(undefined),
	...
	export enum GoogleCloudVideointelligenceV1beta2_LabelDetectionConfigLabelDetectionMode { LABEL_DETECTION_MODE_UNSPECIFIED = 'LABEL_DETECTION_MODE_UNSPECIFIED', SHOT_MODE = 'SHOT_MODE', FRAME_MODE = 'FRAME_MODE', SHOT_AND_FRAME_MODE = 'SHOT_AND_FRAME_MODE' }
	...
	/** Config for OBJECT_TRACKING. */
	export interface GoogleCloudVideointelligenceV1beta2_ObjectTrackingConfigFormProperties {

		/** Model to use for object tracking. Supported values: "builtin/stable" (the default if unset) and "builtin/latest". */
		model: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudVideointelligenceV1beta2_ObjectTrackingConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_ObjectTrackingConfigFormProperties>({
			model: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Config for PERSON_DETECTION. */
	export interface GoogleCloudVideointelligenceV1beta2_PersonDetectionConfigFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1beta2_PersonDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_PersonDetectionConfigFormProperties>({
			includeAttributes: new FormControl<boolean | null | undefined>(undefined),
			includeBoundingBoxes: new FormControl<boolean | null | undefined>(undefined),
	...
	/** Config for SHOT_CHANGE_DETECTION. */
	export interface GoogleCloudVideointelligenceV1beta2_ShotChangeDetectionConfigFormProperties {

		/** Model to use for shot change detection. Supported values: "builtin/stable" (the default if unset), "builtin/latest", and "builtin/legacy". */
		model: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudVideointelligenceV1beta2_ShotChangeDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_ShotChangeDetectionConfigFormProperties>({
			model: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Config for SPEECH_TRANSCRIPTION. */
	export interface GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfigFormProperties {
	...
	export function CreateGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfigFormProperties>({
	...
	/** Provides "hints" to the speech recognizer to favor specific words and phrases in the results. */
	export interface GoogleCloudVideointelligenceV1beta2_SpeechContextFormProperties {
	}
	export function CreateGoogleCloudVideointelligenceV1beta2_SpeechContextFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_SpeechContextFormProperties>({
		});
	...
	/** Config for TEXT_DETECTION. */
	export interface GoogleCloudVideointelligenceV1beta2_TextDetectionConfigFormProperties {

		/** Model to use for text detection. Supported values: "builtin/stable" (the default if unset) and "builtin/latest". */
		model: FormControl<string | null | undefined>,
	}
	export function CreateGoogleCloudVideointelligenceV1beta2_TextDetectionConfigFormGroup() {
		return new FormGroup<GoogleCloudVideointelligenceV1beta2_TextDetectionConfigFormProperties>({
			model: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 */
		Videointelligence_videos_annotate(requestBody: GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest): Observable<GoogleLongrunning_Operation> {
			return this.http.post<GoogleLongrunning_Operation>(this.baseUri + 'v1beta2/videos:annotate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
