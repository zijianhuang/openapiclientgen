...
export namespace MyNS {
	...
	export enum RetryBackoffMode { BACKOFF_MODE_UNSPECIFIED = 0, BACKOFF_MODE_LINEAR = 1, BACKOFF_MODE_EXPONENTIAL = 2 }
	...
	export enum AutomationEventType { TYPE_UNSPECIFIED = 0, TYPE_PUBSUB_NOTIFICATION_FAILURE = 1, TYPE_RESOURCE_STATE_CHANGE = 2, TYPE_PROCESS_ABORTED = 3, TYPE_RESTRICTION_VIOLATED = 4, TYPE_RESOURCE_DELETED = 5, TYPE_ROLLOUT_UPDATE = 6, TYPE_RENDER_STATUES_CHANGE = 7 }
	...
	export enum RetryAttemptState { REPAIR_STATE_UNSPECIFIED = 0, REPAIR_STATE_SUCCEEDED = 1, REPAIR_STATE_CANCELLED = 2, REPAIR_STATE_FAILED = 3, REPAIR_STATE_IN_PROGRESS = 4, REPAIR_STATE_PENDING = 5, REPAIR_STATE_SKIPPED = 6 }
	...
	export enum AutomationRunState { STATE_UNSPECIFIED = 0, SUCCEEDED = 1, CANCELLED = 2, FAILED = 3, IN_PROGRESS = 4, PENDING = 5 }
	...
	export enum JobState { STATE_UNSPECIFIED = 0, PENDING = 1, DISABLED = 2, IN_PROGRESS = 3, SUCCEEDED = 4, FAILED = 5, ABORTED = 6, SKIPPED = 7, IGNORED = 8 }
	...
	export enum DeployJobRunFailureCause { FAILURE_CAUSE_UNSPECIFIED = 0, CLOUD_BUILD_UNAVAILABLE = 1, EXECUTION_FAILED = 2, DEADLINE_EXCEEDED = 3, MISSING_RESOURCES_FOR_CANARY = 4, CLOUD_BUILD_REQUEST_FAILED = 5, DEPLOY_FEATURE_NOT_SUPPORTED = 6 }
	...
	export enum PostdeployJobRunFailureCause { FAILURE_CAUSE_UNSPECIFIED = 0, CLOUD_BUILD_UNAVAILABLE = 1, EXECUTION_FAILED = 2, DEADLINE_EXCEEDED = 3, CLOUD_BUILD_REQUEST_FAILED = 4 }
	...
	export enum JobRunState { STATE_UNSPECIFIED = 0, IN_PROGRESS = 1, SUCCEEDED = 2, FAILED = 3, TERMINATING = 4, TERMINATED = 5 }
	...
	export enum VerifyJobRunFailureCause { FAILURE_CAUSE_UNSPECIFIED = 0, CLOUD_BUILD_UNAVAILABLE = 1, EXECUTION_FAILED = 2, DEADLINE_EXCEEDED = 3, VERIFICATION_CONFIG_NOT_FOUND = 4, CLOUD_BUILD_REQUEST_FAILED = 5 }
	...
	export enum SkaffoldSupportedConditionSkaffoldSupportState { SKAFFOLD_SUPPORT_STATE_UNSPECIFIED = 0, SKAFFOLD_SUPPORT_STATE_SUPPORTED = 1, SKAFFOLD_SUPPORT_STATE_MAINTENANCE_MODE = 2, SKAFFOLD_SUPPORT_STATE_UNSUPPORTED = 3 }

	export enum ReleaseRenderState { RENDER_STATE_UNSPECIFIED = 0, SUCCEEDED = 1, FAILED = 2, IN_PROGRESS = 3 }
	...
	export enum TargetRenderFailureCause { FAILURE_CAUSE_UNSPECIFIED = 0, CLOUD_BUILD_UNAVAILABLE = 1, EXECUTION_FAILED = 2, CLOUD_BUILD_REQUEST_FAILED = 3, VERIFICATION_CONFIG_NOT_FOUND = 4, CUSTOM_ACTION_NOT_FOUND = 5, DEPLOYMENT_STRATEGY_NOT_SUPPORTED = 6, RENDER_FEATURE_NOT_SUPPORTED = 7 }
	...
	export enum TargetRenderRenderingState { TARGET_RENDER_STATE_UNSPECIFIED = 0, SUCCEEDED = 1, FAILED = 2, IN_PROGRESS = 3 }
	...
	export enum RolloutApprovalState { APPROVAL_STATE_UNSPECIFIED = 0, NEEDS_APPROVAL = 1, DOES_NOT_NEED_APPROVAL = 2, APPROVED = 3, REJECTED = 4 }

	export enum RolloutDeployFailureCause { FAILURE_CAUSE_UNSPECIFIED = 0, CLOUD_BUILD_UNAVAILABLE = 1, EXECUTION_FAILED = 2, DEADLINE_EXCEEDED = 3, RELEASE_FAILED = 4, RELEASE_ABANDONED = 5, VERIFICATION_CONFIG_NOT_FOUND = 6, CLOUD_BUILD_REQUEST_FAILED = 7, OPERATION_FEATURE_NOT_SUPPORTED = 8 }
	...
	export enum PhaseState { STATE_UNSPECIFIED = 0, PENDING = 1, IN_PROGRESS = 2, SUCCEEDED = 3, FAILED = 4, ABORTED = 5, SKIPPED = 6 }

	export enum RolloutState { STATE_UNSPECIFIED = 0, SUCCEEDED = 1, FAILED = 2, IN_PROGRESS = 3, PENDING_APPROVAL = 4, APPROVAL_REJECTED = 5, PENDING = 6, PENDING_RELEASE = 7, CANCELLING = 8, CANCELLED = 9, HALTED = 10 }
	...
	export enum RolloutUpdateEventRolloutUpdateType { ROLLOUT_UPDATE_TYPE_UNSPECIFIED = 0, PENDING = 1, PENDING_RELEASE = 2, IN_PROGRESS = 3, CANCELLING = 4, CANCELLED = 5, HALTED = 6, SUCCEEDED = 7, FAILED = 8, APPROVAL_REQUIRED = 9, APPROVED = 10, REJECTED = 11, ADVANCE_REQUIRED = 12, ADVANCED = 13 }
