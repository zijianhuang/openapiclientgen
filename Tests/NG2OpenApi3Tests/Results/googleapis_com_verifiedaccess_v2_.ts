...
export namespace MyNS {
	...
	export enum DeviceSignalsDiskEncryption { DISK_ENCRYPTION_UNSPECIFIED = 'DISK_ENCRYPTION_UNSPECIFIED', DISK_ENCRYPTION_UNKNOWN = 'DISK_ENCRYPTION_UNKNOWN', DISK_ENCRYPTION_DISABLED = 'DISK_ENCRYPTION_DISABLED', DISK_ENCRYPTION_ENCRYPTED = 'DISK_ENCRYPTION_ENCRYPTED' }

	export enum DeviceSignalsOperatingSystem { OPERATING_SYSTEM_UNSPECIFIED = 'OPERATING_SYSTEM_UNSPECIFIED', CHROME_OS = 'CHROME_OS', CHROMIUM_OS = 'CHROMIUM_OS', WINDOWS = 'WINDOWS', MAC_OS_X = 'MAC_OS_X', LINUX = 'LINUX' }

	export enum DeviceSignalsOsFirewall { OS_FIREWALL_UNSPECIFIED = 'OS_FIREWALL_UNSPECIFIED', OS_FIREWALL_UNKNOWN = 'OS_FIREWALL_UNKNOWN', OS_FIREWALL_DISABLED = 'OS_FIREWALL_DISABLED', OS_FIREWALL_ENABLED = 'OS_FIREWALL_ENABLED' }

	export enum DeviceSignalsPasswordProtectionWarningTrigger { PASSWORD_PROTECTION_WARNING_TRIGGER_UNSPECIFIED = 'PASSWORD_PROTECTION_WARNING_TRIGGER_UNSPECIFIED', POLICY_UNSET = 'POLICY_UNSET', PASSWORD_PROTECTION_OFF = 'PASSWORD_PROTECTION_OFF', PASSWORD_REUSE = 'PASSWORD_REUSE', PHISHING_REUSE = 'PHISHING_REUSE' }

	export enum DeviceSignalsRealtimeUrlCheckMode { REALTIME_URL_CHECK_MODE_UNSPECIFIED = 'REALTIME_URL_CHECK_MODE_UNSPECIFIED', REALTIME_URL_CHECK_MODE_DISABLED = 'REALTIME_URL_CHECK_MODE_DISABLED', REALTIME_URL_CHECK_MODE_ENABLED_MAIN_FRAME = 'REALTIME_URL_CHECK_MODE_ENABLED_MAIN_FRAME' }

	export enum DeviceSignalsSafeBrowsingProtectionLevel { SAFE_BROWSING_PROTECTION_LEVEL_UNSPECIFIED = 'SAFE_BROWSING_PROTECTION_LEVEL_UNSPECIFIED', INACTIVE = 'INACTIVE', STANDARD = 'STANDARD', ENHANCED = 'ENHANCED' }

	export enum DeviceSignalsScreenLockSecured { SCREEN_LOCK_SECURED_UNSPECIFIED = 'SCREEN_LOCK_SECURED_UNSPECIFIED', SCREEN_LOCK_SECURED_UNKNOWN = 'SCREEN_LOCK_SECURED_UNKNOWN', SCREEN_LOCK_SECURED_DISABLED = 'SCREEN_LOCK_SECURED_DISABLED', SCREEN_LOCK_SECURED_ENABLED = 'SCREEN_LOCK_SECURED_ENABLED' }

	export enum DeviceSignalsSecureBootMode { SECURE_BOOT_MODE_UNSPECIFIED = 'SECURE_BOOT_MODE_UNSPECIFIED', SECURE_BOOT_MODE_UNKNOWN = 'SECURE_BOOT_MODE_UNKNOWN', SECURE_BOOT_MODE_DISABLED = 'SECURE_BOOT_MODE_DISABLED', SECURE_BOOT_MODE_ENABLED = 'SECURE_BOOT_MODE_ENABLED' }

	export enum DeviceSignalsTrigger { TRIGGER_UNSPECIFIED = 'TRIGGER_UNSPECIFIED', TRIGGER_BROWSER_NAVIGATION = 'TRIGGER_BROWSER_NAVIGATION', TRIGGER_LOGIN_SCREEN = 'TRIGGER_LOGIN_SCREEN' }
