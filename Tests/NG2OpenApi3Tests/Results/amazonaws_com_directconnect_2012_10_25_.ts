...
export namespace MyNS {
	...
	export interface DirectConnectGatewayAssociationFormProperties {
		...
		associationState: FormControl<DirectConnectGatewayAssociationState | null | undefined>,
	...
	export function CreateDirectConnectGatewayAssociationFormGroup() {
		return new FormGroup<DirectConnectGatewayAssociationFormProperties>({
			...
			associationState: new FormControl<DirectConnectGatewayAssociationState | null | undefined>(undefined),
	...
	export enum DirectConnectGatewayAssociationState { associating = 'associating', associated = 'associated', disassociating = 'disassociating', disassociated = 'disassociated', updating = 'updating' }
	...
	export enum GatewayType { virtualPrivateGateway = 'virtualPrivateGateway', transitGateway = 'transitGateway' }
	...
	export interface ConnectionFormProperties {
		...
		awsLogicalDeviceId: FormControl<string | null | undefined>,
		hasLogicalRedundancy: FormControl<HasLogicalRedundancy | null | undefined>,
		providerName: FormControl<string | null | undefined>,
		macSecCapable: FormControl<boolean | null | undefined>,
		portEncryptionStatus: FormControl<string | null | undefined>,
	...
	export function CreateConnectionFormGroup() {
		return new FormGroup<ConnectionFormProperties>({
			...
			awsLogicalDeviceId: new FormControl<string | null | undefined>(undefined),
			hasLogicalRedundancy: new FormControl<HasLogicalRedundancy | null | undefined>(undefined),
			providerName: new FormControl<string | null | undefined>(undefined),
			macSecCapable: new FormControl<boolean | null | undefined>(undefined),
			portEncryptionStatus: new FormControl<string | null | undefined>(undefined),
			encryptionMode: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum ConnectionState { ordering = 'ordering', requested = 'requested', pending = 'pending', available = 'available', down = 'down', deleting = 'deleting', deleted = 'deleted', rejected = 'rejected', unknown = 'unknown' }

	export enum HasLogicalRedundancy { unknown = 'unknown', yes = 'yes', no = 'no' }
	...
	/** Information about the MAC Security (MACsec) secret key. */
	export interface MacSecKeyFormProperties {
		secretARN: FormControl<string | null | undefined>,
		ckn: FormControl<string | null | undefined>,
		state: FormControl<string | null | undefined>,
		startOn: FormControl<string | null | undefined>,
	}
	export function CreateMacSecKeyFormGroup() {
		return new FormGroup<MacSecKeyFormProperties>({
			secretARN: new FormControl<string | null | undefined>(undefined),
			ckn: new FormControl<string | null | undefined>(undefined),
			state: new FormControl<string | null | undefined>(undefined),
			startOn: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface VirtualInterfaceFormProperties {
		...
		addressFamily: FormControl<AddressFamily | null | undefined>,
		virtualInterfaceState: FormControl<VirtualInterfaceState | null | undefined>,
		...
		awsDeviceV2: FormControl<string | null | undefined>,
		awsLogicalDeviceId: FormControl<string | null | undefined>,
		siteLinkEnabled: FormControl<boolean | null | undefined>,
	}
	export function CreateVirtualInterfaceFormGroup() {
		return new FormGroup<VirtualInterfaceFormProperties>({
			...
			addressFamily: new FormControl<AddressFamily | null | undefined>(undefined),
			virtualInterfaceState: new FormControl<VirtualInterfaceState | null | undefined>(undefined),
			...
			awsDeviceV2: new FormControl<string | null | undefined>(undefined),
			awsLogicalDeviceId: new FormControl<string | null | undefined>(undefined),
			siteLinkEnabled: new FormControl<boolean | null | undefined>(undefined),
		});

	}

	export enum AddressFamily { ipv4 = 'ipv4', ipv6 = 'ipv6' }

	export enum VirtualInterfaceState { confirming = 'confirming', verifying = 'verifying', pending = 'pending', available = 'available', down = 'down', deleting = 'deleting', deleted = 'deleted', rejected = 'rejected', unknown = 'unknown' }
	...
	export interface BGPPeerFormProperties {
		...
		amazonAddress: FormControl<string | null | undefined>,
		customerAddress: FormControl<string | null | undefined>,
		bgpPeerState: FormControl<BGPPeerState | null | undefined>,
		bgpStatus: FormControl<BGPStatus | null | undefined>,
		awsDeviceV2: FormControl<string | null | undefined>,
		awsLogicalDeviceId: FormControl<string | null | undefined>,
	}
	export function CreateBGPPeerFormGroup() {
		return new FormGroup<BGPPeerFormProperties>({
			...
			amazonAddress: new FormControl<string | null | undefined>(undefined),
			customerAddress: new FormControl<string | null | undefined>(undefined),
			bgpPeerState: new FormControl<BGPPeerState | null | undefined>(undefined),
			bgpStatus: new FormControl<BGPStatus | null | undefined>(undefined),
			awsDeviceV2: new FormControl<string | null | undefined>(undefined),
			awsLogicalDeviceId: new FormControl<string | null | undefined>(undefined),
		});
	...
	export enum BGPPeerState { verifying = 'verifying', pending = 'pending', available = 'available', deleting = 'deleting', deleted = 'deleted' }

	export enum BGPStatus { up = 'up', down = 'down', unknown = 'unknown' }
	...
	export interface AssociateMacSecKeyResponseFormProperties {
		connectionId: FormControl<string | null | undefined>,
	}
	export function CreateAssociateMacSecKeyResponseFormGroup() {
		return new FormGroup<AssociateMacSecKeyResponseFormProperties>({
			connectionId: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface AssociateMacSecKeyRequestFormProperties {
	...
	export function CreateAssociateMacSecKeyRequestFormGroup() {
		return new FormGroup<AssociateMacSecKeyRequestFormProperties>({
			connectionId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			secretARN: new FormControl<string | null | undefined>(undefined),
			ckn: new FormControl<string | null | undefined>(undefined),
	...
	export interface ConfirmCustomerAgreementResponseFormProperties {
		status: FormControl<string | null | undefined>,
	}
	export function CreateConfirmCustomerAgreementResponseFormGroup() {
		return new FormGroup<ConfirmCustomerAgreementResponseFormProperties>({
	...
	export interface ConfirmCustomerAgreementRequestFormProperties {
		agreementName: FormControl<string | null | undefined>,
	}
	export function CreateConfirmCustomerAgreementRequestFormGroup() {
		return new FormGroup<ConfirmCustomerAgreementRequestFormProperties>({
			agreementName: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface CreateConnectionRequestFormProperties {
		...
		lagId: FormControl<string | null | undefined>,
		providerName: FormControl<string | null | undefined>,
		requestMACSec: FormControl<boolean | null | undefined>,
	}
	export function CreateCreateConnectionRequestFormGroup() {
		return new FormGroup<CreateConnectionRequestFormProperties>({
			...
			lagId: new FormControl<string | null | undefined>(undefined),
			providerName: new FormControl<string | null | undefined>(undefined),
			requestMACSec: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	export interface DirectConnectGatewayFormProperties {
		...
		amazonSideAsn: FormControl<number | null | undefined>,
		ownerAccount: FormControl<string | null | undefined>,
		directConnectGatewayState: FormControl<DirectConnectGatewayState | null | undefined>,
		stateChangeError: FormControl<string | null | undefined>,
	}
	export function CreateDirectConnectGatewayFormGroup() {
		return new FormGroup<DirectConnectGatewayFormProperties>({
			...
			amazonSideAsn: new FormControl<number | null | undefined>(undefined),
			ownerAccount: new FormControl<string | null | undefined>(undefined),
			directConnectGatewayState: new FormControl<DirectConnectGatewayState | null | undefined>(undefined),
			stateChangeError: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum DirectConnectGatewayState { pending = 'pending', available = 'available', deleting = 'deleting', deleted = 'deleted' }
	...
	export interface DirectConnectGatewayAssociationProposalFormProperties {
		...
		directConnectGatewayId: FormControl<string | null | undefined>,
		directConnectGatewayOwnerAccount: FormControl<string | null | undefined>,
		proposalState: FormControl<DirectConnectGatewayAssociationProposalState | null | undefined>,
	}
	export function CreateDirectConnectGatewayAssociationProposalFormGroup() {
		return new FormGroup<DirectConnectGatewayAssociationProposalFormProperties>({
			...
			directConnectGatewayId: new FormControl<string | null | undefined>(undefined),
			directConnectGatewayOwnerAccount: new FormControl<string | null | undefined>(undefined),
			proposalState: new FormControl<DirectConnectGatewayAssociationProposalState | null | undefined>(undefined),
		});

	}

	export enum DirectConnectGatewayAssociationProposalState { requested = 'requested', accepted = 'accepted', deleted = 'deleted' }
	...
	export interface InterconnectFormProperties {
		...
		interconnectState: FormControl<InterconnectState | null | undefined>,
		region: FormControl<string | null | undefined>,
		location: FormControl<string | null | undefined>,
		bandwidth: FormControl<string | null | undefined>,
		loaIssueTime: FormControl<Date | null | undefined>,
	...
	export function CreateInterconnectFormGroup() {
		return new FormGroup<InterconnectFormProperties>({
			...
			interconnectState: new FormControl<InterconnectState | null | undefined>(undefined),
			region: new FormControl<string | null | undefined>(undefined),
			location: new FormControl<string | null | undefined>(undefined),
			bandwidth: new FormControl<string | null | undefined>(undefined),
			loaIssueTime: new FormControl<Date | null | undefined>(undefined),
	...
	export enum InterconnectState { requested = 'requested', pending = 'pending', available = 'available', down = 'down', deleting = 'deleting', deleted = 'deleted', unknown = 'unknown' }
	...
	export interface LagFormProperties {
		...
		lagState: FormControl<InterconnectState | null | undefined>,
		location: FormControl<string | null | undefined>,
		region: FormControl<string | null | undefined>,
	...
	export function CreateLagFormGroup() {
		return new FormGroup<LagFormProperties>({
			...
			lagState: new FormControl<InterconnectState | null | undefined>(undefined),
			location: new FormControl<string | null | undefined>(undefined),
			region: new FormControl<string | null | undefined>(undefined),
	...
	export interface NewPrivateVirtualInterfaceFormProperties {
		...
		virtualGatewayId: FormControl<string | null | undefined>,
		directConnectGatewayId: FormControl<string | null | undefined>,
		enableSiteLink: FormControl<boolean | null | undefined>,
	}
	export function CreateNewPrivateVirtualInterfaceFormGroup() {
		return new FormGroup<NewPrivateVirtualInterfaceFormProperties>({
			...
			virtualGatewayId: new FormControl<string | null | undefined>(undefined),
			directConnectGatewayId: new FormControl<string | null | undefined>(undefined),
			enableSiteLink: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	export interface LoaFormProperties {
		...
		loaContentType: FormControl<LoaContentType | null | undefined>,
	}
	export function CreateLoaFormGroup() {
		return new FormGroup<LoaFormProperties>({
			...
			loaContentType: new FormControl<LoaContentType | null | undefined>(undefined),
		});

	}

	export enum LoaContentType { 'application/pdf' = 'application/pdf' }
	...
	export interface DescribeCustomerMetadataResponseFormProperties {
		nniPartnerType: FormControl<NniPartnerType | null | undefined>,
	}
	export function CreateDescribeCustomerMetadataResponseFormGroup() {
		return new FormGroup<DescribeCustomerMetadataResponseFormProperties>({
			nniPartnerType: new FormControl<NniPartnerType | null | undefined>(undefined),
		});
	...
	/** The name and status of a customer agreement.  */
	export interface CustomerAgreementFormProperties {
		agreementName: FormControl<string | null | undefined>,
		status: FormControl<string | null | undefined>,
	}
	export function CreateCustomerAgreementFormGroup() {
		return new FormGroup<CustomerAgreementFormProperties>({
			agreementName: new FormControl<string | null | undefined>(undefined),
			status: new FormControl<string | null | undefined>(undefined),
		});
	...
	export enum NniPartnerType { v1 = 'v1', v2 = 'v2', nonPartner = 'nonPartner' }
	...
	export interface DirectConnectGatewayAttachmentFormProperties {
		...
		attachmentState: FormControl<DirectConnectGatewayAttachmentState | null | undefined>,
		attachmentType: FormControl<DirectConnectGatewayAttachmentType | null | undefined>,
		stateChangeError: FormControl<string | null | undefined>,
	}
	export function CreateDirectConnectGatewayAttachmentFormGroup() {
		return new FormGroup<DirectConnectGatewayAttachmentFormProperties>({
			...
			attachmentState: new FormControl<DirectConnectGatewayAttachmentState | null | undefined>(undefined),
			attachmentType: new FormControl<DirectConnectGatewayAttachmentType | null | undefined>(undefined),
			stateChangeError: new FormControl<string | null | undefined>(undefined),
		});

	}

	export enum DirectConnectGatewayAttachmentState { attaching = 'attaching', attached = 'attached', detaching = 'detaching', detached = 'detached' }

	export enum DirectConnectGatewayAttachmentType { TransitVirtualInterface = 'TransitVirtualInterface', PrivateVirtualInterface = 'PrivateVirtualInterface' }
	...
	export interface DescribeRouterConfigurationResponseFormProperties {
		customerRouterConfig: FormControl<string | null | undefined>,
		virtualInterfaceId: FormControl<string | null | undefined>,
		virtualInterfaceName: FormControl<string | null | undefined>,
	}
	export function CreateDescribeRouterConfigurationResponseFormGroup() {
		return new FormGroup<DescribeRouterConfigurationResponseFormProperties>({
			customerRouterConfig: new FormControl<string | null | undefined>(undefined),
			virtualInterfaceId: new FormControl<string | null | undefined>(undefined),
			virtualInterfaceName: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Information about the virtual router. */
	export interface RouterTypeFormProperties {
		...
		xsltTemplateName: FormControl<string | null | undefined>,
		xsltTemplateNameForMacSec: FormControl<string | null | undefined>,
		routerTypeIdentifier: FormControl<string | null | undefined>,
	}
	export function CreateRouterTypeFormGroup() {
		return new FormGroup<RouterTypeFormProperties>({
			...
			xsltTemplateName: new FormControl<string | null | undefined>(undefined),
			xsltTemplateNameForMacSec: new FormControl<string | null | undefined>(undefined),
			routerTypeIdentifier: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Provides the details about a virtual interface's router. */
	export interface DescribeRouterConfigurationRequestFormProperties {

		/** Required */
		virtualInterfaceId: FormControl<string | null | undefined>,
		routerTypeIdentifier: FormControl<string | null | undefined>,
	}
	export function CreateDescribeRouterConfigurationRequestFormGroup() {
		return new FormGroup<DescribeRouterConfigurationRequestFormProperties>({
			virtualInterfaceId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			routerTypeIdentifier: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface DisassociateMacSecKeyResponseFormProperties {
		connectionId: FormControl<string | null | undefined>,
	}
	export function CreateDisassociateMacSecKeyResponseFormGroup() {
		return new FormGroup<DisassociateMacSecKeyResponseFormProperties>({
			connectionId: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface DisassociateMacSecKeyRequestFormProperties {
	...
	export function CreateDisassociateMacSecKeyRequestFormGroup() {
		return new FormGroup<DisassociateMacSecKeyRequestFormProperties>({
			connectionId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
	...
	export interface UpdateDirectConnectGatewayResponseFormProperties {
	}
	export function CreateUpdateDirectConnectGatewayResponseFormGroup() {
		return new FormGroup<UpdateDirectConnectGatewayResponseFormProperties>({
		});
	...
	export interface UpdateDirectConnectGatewayRequestFormProperties {

		/** Required */
		directConnectGatewayId: FormControl<string | null | undefined>,

		/** Required */
		newDirectConnectGatewayName: FormControl<string | null | undefined>,
	}
	export function CreateUpdateDirectConnectGatewayRequestFormGroup() {
		return new FormGroup<UpdateDirectConnectGatewayRequestFormProperties>({
			directConnectGatewayId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			newDirectConnectGatewayName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export enum LagState { requested = 'requested', pending = 'pending', available = 'available', down = 'down', deleting = 'deleting', deleted = 'deleted', unknown = 'unknown' }
	...
	export class MyClient {
		 ...
		 * @return {AssociateMacSecKeyResponse} Success
		 */
		AssociateMacSecKey(requestBody: AssociateMacSecKeyRequest): Observable<AssociateMacSecKeyResponse> {
			return this.http.post<AssociateMacSecKeyResponse>(this.baseUri + '#X-Amz-Target=OvertureService.AssociateMacSecKey', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ConfirmCustomerAgreementResponse} Success
		 */
		ConfirmCustomerAgreement(requestBody: ConfirmCustomerAgreementRequest): Observable<ConfirmCustomerAgreementResponse> {
			return this.http.post<ConfirmCustomerAgreementResponse>(this.baseUri + '#X-Amz-Target=OvertureService.ConfirmCustomerAgreement', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {DescribeCustomerMetadataResponse} Success
		 */
		DescribeCustomerMetadata(): Observable<DescribeCustomerMetadataResponse> {
			return this.http.post<DescribeCustomerMetadataResponse>(this.baseUri + '#X-Amz-Target=OvertureService.DescribeCustomerMetadata', null, {});
		}
		 ...
		 * @return {DescribeRouterConfigurationResponse} Success
		 */
		DescribeRouterConfiguration(requestBody: DescribeRouterConfigurationRequest): Observable<DescribeRouterConfigurationResponse> {
			return this.http.post<DescribeRouterConfigurationResponse>(this.baseUri + '#X-Amz-Target=OvertureService.DescribeRouterConfiguration', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {DisassociateMacSecKeyResponse} Success
		 */
		DisassociateMacSecKey(requestBody: DisassociateMacSecKeyRequest): Observable<DisassociateMacSecKeyResponse> {
			return this.http.post<DisassociateMacSecKeyResponse>(this.baseUri + '#X-Amz-Target=OvertureService.DisassociateMacSecKey', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Connection} Success
		 */
		UpdateConnection(requestBody: UpdateConnectionRequest): Observable<Connection> {
			return this.http.post<Connection>(this.baseUri + '#X-Amz-Target=OvertureService.UpdateConnection', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates the name of a current Direct Connect gateway.
		 * Post #X-Amz-Target=OvertureService.UpdateDirectConnectGateway
		 * @return {UpdateDirectConnectGatewayResponse} Success
		 */
		UpdateDirectConnectGateway(requestBody: UpdateDirectConnectGatewayRequest): Observable<UpdateDirectConnectGatewayResponse> {
			return this.http.post<UpdateDirectConnectGatewayResponse>(this.baseUri + '#X-Amz-Target=OvertureService.UpdateDirectConnectGateway', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	...
	export enum AcceptDirectConnectGatewayAssociationProposalX_Amz_Target { 'OvertureService.AcceptDirectConnectGatewayAssociationProposal' = 'OvertureService.AcceptDirectConnectGatewayAssociationProposal' }

	export enum AllocateConnectionOnInterconnectX_Amz_Target { 'OvertureService.AllocateConnectionOnInterconnect' = 'OvertureService.AllocateConnectionOnInterconnect' }

	export enum AllocateHostedConnectionX_Amz_Target { 'OvertureService.AllocateHostedConnection' = 'OvertureService.AllocateHostedConnection' }

	export enum AllocatePrivateVirtualInterfaceX_Amz_Target { 'OvertureService.AllocatePrivateVirtualInterface' = 'OvertureService.AllocatePrivateVirtualInterface' }

	export enum AllocatePublicVirtualInterfaceX_Amz_Target { 'OvertureService.AllocatePublicVirtualInterface' = 'OvertureService.AllocatePublicVirtualInterface' }

	export enum AllocateTransitVirtualInterfaceX_Amz_Target { 'OvertureService.AllocateTransitVirtualInterface' = 'OvertureService.AllocateTransitVirtualInterface' }

	export enum AssociateConnectionWithLagX_Amz_Target { 'OvertureService.AssociateConnectionWithLag' = 'OvertureService.AssociateConnectionWithLag' }

	export enum AssociateHostedConnectionX_Amz_Target { 'OvertureService.AssociateHostedConnection' = 'OvertureService.AssociateHostedConnection' }

	export enum AssociateMacSecKeyX_Amz_Target { 'OvertureService.AssociateMacSecKey' = 'OvertureService.AssociateMacSecKey' }

	export enum AssociateVirtualInterfaceX_Amz_Target { 'OvertureService.AssociateVirtualInterface' = 'OvertureService.AssociateVirtualInterface' }

	export enum ConfirmConnectionX_Amz_Target { 'OvertureService.ConfirmConnection' = 'OvertureService.ConfirmConnection' }

	export enum ConfirmCustomerAgreementX_Amz_Target { 'OvertureService.ConfirmCustomerAgreement' = 'OvertureService.ConfirmCustomerAgreement' }

	export enum ConfirmPrivateVirtualInterfaceX_Amz_Target { 'OvertureService.ConfirmPrivateVirtualInterface' = 'OvertureService.ConfirmPrivateVirtualInterface' }

	export enum ConfirmPublicVirtualInterfaceX_Amz_Target { 'OvertureService.ConfirmPublicVirtualInterface' = 'OvertureService.ConfirmPublicVirtualInterface' }

	export enum ConfirmTransitVirtualInterfaceX_Amz_Target { 'OvertureService.ConfirmTransitVirtualInterface' = 'OvertureService.ConfirmTransitVirtualInterface' }

	export enum CreateBGPPeerX_Amz_Target { 'OvertureService.CreateBGPPeer' = 'OvertureService.CreateBGPPeer' }

	export enum CreateConnectionX_Amz_Target { 'OvertureService.CreateConnection' = 'OvertureService.CreateConnection' }

	export enum CreateDirectConnectGatewayX_Amz_Target { 'OvertureService.CreateDirectConnectGateway' = 'OvertureService.CreateDirectConnectGateway' }

	export enum CreateDirectConnectGatewayAssociationX_Amz_Target { 'OvertureService.CreateDirectConnectGatewayAssociation' = 'OvertureService.CreateDirectConnectGatewayAssociation' }

	export enum CreateDirectConnectGatewayAssociationProposalX_Amz_Target { 'OvertureService.CreateDirectConnectGatewayAssociationProposal' = 'OvertureService.CreateDirectConnectGatewayAssociationProposal' }

	export enum CreateInterconnectX_Amz_Target { 'OvertureService.CreateInterconnect' = 'OvertureService.CreateInterconnect' }

	export enum CreateLagX_Amz_Target { 'OvertureService.CreateLag' = 'OvertureService.CreateLag' }

	export enum CreatePrivateVirtualInterfaceX_Amz_Target { 'OvertureService.CreatePrivateVirtualInterface' = 'OvertureService.CreatePrivateVirtualInterface' }

	export enum CreatePublicVirtualInterfaceX_Amz_Target { 'OvertureService.CreatePublicVirtualInterface' = 'OvertureService.CreatePublicVirtualInterface' }

	export enum CreateTransitVirtualInterfaceX_Amz_Target { 'OvertureService.CreateTransitVirtualInterface' = 'OvertureService.CreateTransitVirtualInterface' }

	export enum DeleteBGPPeerX_Amz_Target { 'OvertureService.DeleteBGPPeer' = 'OvertureService.DeleteBGPPeer' }

	export enum DeleteConnectionX_Amz_Target { 'OvertureService.DeleteConnection' = 'OvertureService.DeleteConnection' }

	export enum DeleteDirectConnectGatewayX_Amz_Target { 'OvertureService.DeleteDirectConnectGateway' = 'OvertureService.DeleteDirectConnectGateway' }

	export enum DeleteDirectConnectGatewayAssociationX_Amz_Target { 'OvertureService.DeleteDirectConnectGatewayAssociation' = 'OvertureService.DeleteDirectConnectGatewayAssociation' }

	export enum DeleteDirectConnectGatewayAssociationProposalX_Amz_Target { 'OvertureService.DeleteDirectConnectGatewayAssociationProposal' = 'OvertureService.DeleteDirectConnectGatewayAssociationProposal' }

	export enum DeleteInterconnectX_Amz_Target { 'OvertureService.DeleteInterconnect' = 'OvertureService.DeleteInterconnect' }

	export enum DeleteLagX_Amz_Target { 'OvertureService.DeleteLag' = 'OvertureService.DeleteLag' }

	export enum DeleteVirtualInterfaceX_Amz_Target { 'OvertureService.DeleteVirtualInterface' = 'OvertureService.DeleteVirtualInterface' }

	export enum DescribeConnectionLoaX_Amz_Target { 'OvertureService.DescribeConnectionLoa' = 'OvertureService.DescribeConnectionLoa' }

	export enum DescribeConnectionsX_Amz_Target { 'OvertureService.DescribeConnections' = 'OvertureService.DescribeConnections' }

	export enum DescribeConnectionsOnInterconnectX_Amz_Target { 'OvertureService.DescribeConnectionsOnInterconnect' = 'OvertureService.DescribeConnectionsOnInterconnect' }

	export enum DescribeCustomerMetadataX_Amz_Target { 'OvertureService.DescribeCustomerMetadata' = 'OvertureService.DescribeCustomerMetadata' }

	export enum DescribeDirectConnectGatewayAssociationProposalsX_Amz_Target { 'OvertureService.DescribeDirectConnectGatewayAssociationProposals' = 'OvertureService.DescribeDirectConnectGatewayAssociationProposals' }

	export enum DescribeDirectConnectGatewayAssociationsX_Amz_Target { 'OvertureService.DescribeDirectConnectGatewayAssociations' = 'OvertureService.DescribeDirectConnectGatewayAssociations' }

	export enum DescribeDirectConnectGatewayAttachmentsX_Amz_Target { 'OvertureService.DescribeDirectConnectGatewayAttachments' = 'OvertureService.DescribeDirectConnectGatewayAttachments' }

	export enum DescribeDirectConnectGatewaysX_Amz_Target { 'OvertureService.DescribeDirectConnectGateways' = 'OvertureService.DescribeDirectConnectGateways' }

	export enum DescribeHostedConnectionsX_Amz_Target { 'OvertureService.DescribeHostedConnections' = 'OvertureService.DescribeHostedConnections' }

	export enum DescribeInterconnectLoaX_Amz_Target { 'OvertureService.DescribeInterconnectLoa' = 'OvertureService.DescribeInterconnectLoa' }

	export enum DescribeInterconnectsX_Amz_Target { 'OvertureService.DescribeInterconnects' = 'OvertureService.DescribeInterconnects' }

	export enum DescribeLagsX_Amz_Target { 'OvertureService.DescribeLags' = 'OvertureService.DescribeLags' }

	export enum DescribeLoaX_Amz_Target { 'OvertureService.DescribeLoa' = 'OvertureService.DescribeLoa' }

	export enum DescribeLocationsX_Amz_Target { 'OvertureService.DescribeLocations' = 'OvertureService.DescribeLocations' }

	export enum DescribeRouterConfigurationX_Amz_Target { 'OvertureService.DescribeRouterConfiguration' = 'OvertureService.DescribeRouterConfiguration' }

	export enum DescribeTagsX_Amz_Target { 'OvertureService.DescribeTags' = 'OvertureService.DescribeTags' }

	export enum DescribeVirtualGatewaysX_Amz_Target { 'OvertureService.DescribeVirtualGateways' = 'OvertureService.DescribeVirtualGateways' }

	export enum DescribeVirtualInterfacesX_Amz_Target { 'OvertureService.DescribeVirtualInterfaces' = 'OvertureService.DescribeVirtualInterfaces' }

	export enum DisassociateConnectionFromLagX_Amz_Target { 'OvertureService.DisassociateConnectionFromLag' = 'OvertureService.DisassociateConnectionFromLag' }

	export enum DisassociateMacSecKeyX_Amz_Target { 'OvertureService.DisassociateMacSecKey' = 'OvertureService.DisassociateMacSecKey' }

	export enum ListVirtualInterfaceTestHistoryX_Amz_Target { 'OvertureService.ListVirtualInterfaceTestHistory' = 'OvertureService.ListVirtualInterfaceTestHistory' }

	export enum StartBgpFailoverTestX_Amz_Target { 'OvertureService.StartBgpFailoverTest' = 'OvertureService.StartBgpFailoverTest' }

	export enum StopBgpFailoverTestX_Amz_Target { 'OvertureService.StopBgpFailoverTest' = 'OvertureService.StopBgpFailoverTest' }

	export enum TagResourceX_Amz_Target { 'OvertureService.TagResource' = 'OvertureService.TagResource' }

	export enum UntagResourceX_Amz_Target { 'OvertureService.UntagResource' = 'OvertureService.UntagResource' }

	export enum UpdateConnectionX_Amz_Target { 'OvertureService.UpdateConnection' = 'OvertureService.UpdateConnection' }

	export enum UpdateDirectConnectGatewayX_Amz_Target { 'OvertureService.UpdateDirectConnectGateway' = 'OvertureService.UpdateDirectConnectGateway' }

	export enum UpdateDirectConnectGatewayAssociationX_Amz_Target { 'OvertureService.UpdateDirectConnectGatewayAssociation' = 'OvertureService.UpdateDirectConnectGatewayAssociation' }

	export enum UpdateLagX_Amz_Target { 'OvertureService.UpdateLag' = 'OvertureService.UpdateLag' }

	export enum UpdateVirtualInterfaceAttributesX_Amz_Target { 'OvertureService.UpdateVirtualInterfaceAttributes' = 'OvertureService.UpdateVirtualInterfaceAttributes' }
