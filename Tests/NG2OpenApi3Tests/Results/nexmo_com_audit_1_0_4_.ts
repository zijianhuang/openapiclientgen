...
export namespace MyNS {
	...
	export enum AuditEventEvent_type { USER_STATUS = 0, USER_UPDATE = 1, USER_BILLING_UPDATE = 2, USER_CREATE = 3, USER_LOGIN = 4, USER_LOGOUT = 5, USER_PRODUCT_SEARCH = 6, USER_API_KEYS_UPDATE = 7, ACCOUNT_SECRET_DELETE = 8, ACCOUNT_SECRET_CREATE = 9, ACCOUNT_UPDATE_SPAMMER = 10, ACCOUNT_UPDATE_SETTINGS_API = 11, NUMBER_ASSIGN = 12, NUMBER_UPDATED = 13, NUMBER_RELEASE = 14, NUMBER_LINKED = 15, NUMBER_UNLINKED = 16, APP_CREATE = 17, APP_UPDATE = 18, APP_DELETE = 19, APP_DISABLE = 20, APP_ENABLE = 21, IP_WHITELIST_CREATE = 22, IP_WHITELIST_DELETE = 23, AUTORELOAD_ENABLE = 24, AUTORELOAD_UPDATE = 25, AUTORELOAD_DISABLE = 26 }

	export enum AuditEventSource { CD = 0, DEVAPI = 1 }

	export enum AuditEventSource_description { 'Customer Dashboard' = 0, 'Developer API' = 1 }
	...
	export enum CallbackUrlMethod { GET = 0, POST = 1 }
	...
	export enum ContextNumberUpdateVoice_type { tel = 0, sip = 1, vxml = 2, app = 3 }
	...
	/** The type of the audit event. */
	export enum EventTypes { USER_STATUS = 0, USER_UPDATE = 1, USER_BILLING_UPDATE = 2, USER_CREATE = 3, USER_LOGIN = 4, USER_LOGOUT = 5, USER_PRODUCT_SEARCH = 6, USER_API_KEYS_UPDATE = 7, ACCOUNT_SECRET_DELETE = 8, ACCOUNT_SECRET_CREATE = 9, ACCOUNT_UPDATE_SPAMMER = 10, ACCOUNT_UPDATE_SETTINGS_API = 11, NUMBER_ASSIGN = 12, NUMBER_UPDATED = 13, NUMBER_RELEASE = 14, NUMBER_LINKED = 15, NUMBER_UNLINKED = 16, APP_CREATE = 17, APP_UPDATE = 18, APP_DELETE = 19, APP_DISABLE = 20, APP_ENABLE = 21, IP_WHITELIST_CREATE = 22, IP_WHITELIST_DELETE = 23, AUTORELOAD_ENABLE = 24, AUTORELOAD_UPDATE = 25, AUTORELOAD_DISABLE = 26 }
