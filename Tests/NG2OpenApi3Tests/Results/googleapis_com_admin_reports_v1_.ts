...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {string} groupIdFilter Comma separated group ids (obfuscated) on which user activities are filtered, i.e. the response will contain activities for only those users that are a part of at least one of the group ids mentioned here. Format: "id:abc123,id:xyz456"
		 ...
		 * @return {Activities} Successful response
		 */
		Reports_activities_list(userKey: string, applicationName: Reports_activities_listApplicationName, actorIpAddress: string | null | undefined, customerId: string | null | undefined, endTime: string | null | undefined, eventName: string | null | undefined, filters: string | null | undefined, groupIdFilter: string | null | undefined, maxResults: number | null | undefined, orgUnitID: string | null | undefined, pageToken: string | null | undefined, startTime: string | null | undefined): Observable<Activities> {
			return this.http.get<Activities>(this.baseUri + 'admin/reports/v1/activity/users/' + (userKey == null ? '' : encodeURIComponent(userKey)) + '/applications/' + applicationName + '&actorIpAddress=' + (actorIpAddress == null ? '' : encodeURIComponent(actorIpAddress)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&endTime=' + (endTime == null ? '' : encodeURIComponent(endTime)) + '&eventName=' + (eventName == null ? '' : encodeURIComponent(eventName)) + '&filters=' + (filters == null ? '' : encodeURIComponent(filters)) + '&groupIdFilter=' + (groupIdFilter == null ? '' : encodeURIComponent(groupIdFilter)) + '&maxResults=' + maxResults + '&orgUnitID=' + (orgUnitID == null ? '' : encodeURIComponent(orgUnitID)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&startTime=' + (startTime == null ? '' : encodeURIComponent(startTime)), {});
		}
		 ...
		 */
		Reports_activities_watch(userKey: string, applicationName: Reports_activities_listApplicationName, actorIpAddress: string | null | undefined, customerId: string | null | undefined, endTime: string | null | undefined, eventName: string | null | undefined, filters: string | null | undefined, groupIdFilter: string | null | undefined, maxResults: number | null | undefined, orgUnitID: string | null | undefined, pageToken: string | null | undefined, startTime: string | null | undefined, requestBody: Channel): Observable<Channel> {
			return this.http.post<Channel>(this.baseUri + 'admin/reports/v1/activity/users/' + (userKey == null ? '' : encodeURIComponent(userKey)) + '/applications/' + applicationName + '/watch&actorIpAddress=' + (actorIpAddress == null ? '' : encodeURIComponent(actorIpAddress)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&endTime=' + (endTime == null ? '' : encodeURIComponent(endTime)) + '&eventName=' + (eventName == null ? '' : encodeURIComponent(eventName)) + '&filters=' + (filters == null ? '' : encodeURIComponent(filters)) + '&groupIdFilter=' + (groupIdFilter == null ? '' : encodeURIComponent(groupIdFilter)) + '&maxResults=' + maxResults + '&orgUnitID=' + (orgUnitID == null ? '' : encodeURIComponent(orgUnitID)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&startTime=' + (startTime == null ? '' : encodeURIComponent(startTime)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Retrieves a report which is a collection of properties and statistics for a specific customer's account. For more information, see the Customers Usage Report guide. For more information about the customer report's parameters, see the Customers Usage parameters reference guides.
		 * Get admin/reports/v1/usage/dates/{date}
		 * @param {string} date Represents the date the usage occurred, based on UTC-8:00 (Pacific Standard Time). The timestamp is in the [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601), `yyyy-mm-dd`.
		 * @param {string} customerId The unique ID of the customer to retrieve data for.
		 ...
		 * @return {UsageReports} Successful response
		 */
		Reports_customerUsageReports_get(date: string, customerId: string | null | undefined, pageToken: string | null | undefined, parameters: string | null | undefined): Observable<UsageReports> {
			return this.http.get<UsageReports>(this.baseUri + 'admin/reports/v1/usage/dates/' + (date == null ? '' : encodeURIComponent(date)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), {});
		}
		 ...
		 * @return {UsageReports} Successful response
		 */
		Reports_userUsageReport_get(userKey: string, date: string, customerId: string | null | undefined, filters: string | null | undefined, groupIdFilter: string | null | undefined, maxResults: number | null | undefined, orgUnitID: string | null | undefined, pageToken: string | null | undefined, parameters: string | null | undefined): Observable<UsageReports> {
			return this.http.get<UsageReports>(this.baseUri + 'admin/reports/v1/usage/users/' + (userKey == null ? '' : encodeURIComponent(userKey)) + '/dates/' + (date == null ? '' : encodeURIComponent(date)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&filters=' + (filters == null ? '' : encodeURIComponent(filters)) + '&groupIdFilter=' + (groupIdFilter == null ? '' : encodeURIComponent(groupIdFilter)) + '&maxResults=' + maxResults + '&orgUnitID=' + (orgUnitID == null ? '' : encodeURIComponent(orgUnitID)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), {});
		}
		 ...
		 * @return {UsageReports} Successful response
		 */
		Reports_entityUsageReports_get(entityType: Reports_entityUsageReports_getEntityType, entityKey: string, date: string, customerId: string | null | undefined, filters: string | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined, parameters: string | null | undefined): Observable<UsageReports> {
			return this.http.get<UsageReports>(this.baseUri + 'admin/reports/v1/usage/' + entityType + '/' + (entityKey == null ? '' : encodeURIComponent(entityKey)) + '/dates/' + (date == null ? '' : encodeURIComponent(date)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&filters=' + (filters == null ? '' : encodeURIComponent(filters)) + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), {});
		}
