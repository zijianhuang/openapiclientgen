...
export namespace MyNS {
	...
	export enum SuffixOption { OPTION_UNSPECIFIED = 'OPTION_UNSPECIFIED', UNGUESSABLE = 'UNGUESSABLE', SHORT = 'SHORT', CUSTOM = 'CUSTOM' }
	...
	export enum ManagedShortLinkVisibility { UNSPECIFIED_VISIBILITY = 'UNSPECIFIED_VISIBILITY', UNARCHIVED = 'UNARCHIVED', ARCHIVED = 'ARCHIVED', NEVER_SHOWN = 'NEVER_SHOWN' }
	...
	export enum DynamicLinkWarningWarningCode { CODE_UNSPECIFIED = 'CODE_UNSPECIFIED', NOT_IN_PROJECT_ANDROID_PACKAGE_NAME = 'NOT_IN_PROJECT_ANDROID_PACKAGE_NAME', NOT_INTEGER_ANDROID_PACKAGE_MIN_VERSION = 'NOT_INTEGER_ANDROID_PACKAGE_MIN_VERSION', UNNECESSARY_ANDROID_PACKAGE_MIN_VERSION = 'UNNECESSARY_ANDROID_PACKAGE_MIN_VERSION', NOT_URI_ANDROID_LINK = 'NOT_URI_ANDROID_LINK', UNNECESSARY_ANDROID_LINK = 'UNNECESSARY_ANDROID_LINK', NOT_URI_ANDROID_FALLBACK_LINK = 'NOT_URI_ANDROID_FALLBACK_LINK', BAD_URI_SCHEME_ANDROID_FALLBACK_LINK = 'BAD_URI_SCHEME_ANDROID_FALLBACK_LINK', NOT_IN_PROJECT_IOS_BUNDLE_ID = 'NOT_IN_PROJECT_IOS_BUNDLE_ID', NOT_IN_PROJECT_IPAD_BUNDLE_ID = 'NOT_IN_PROJECT_IPAD_BUNDLE_ID', UNNECESSARY_IOS_URL_SCHEME = 'UNNECESSARY_IOS_URL_SCHEME', NOT_NUMERIC_IOS_APP_STORE_ID = 'NOT_NUMERIC_IOS_APP_STORE_ID', UNNECESSARY_IOS_APP_STORE_ID = 'UNNECESSARY_IOS_APP_STORE_ID', NOT_URI_IOS_FALLBACK_LINK = 'NOT_URI_IOS_FALLBACK_LINK', BAD_URI_SCHEME_IOS_FALLBACK_LINK = 'BAD_URI_SCHEME_IOS_FALLBACK_LINK', NOT_URI_IPAD_FALLBACK_LINK = 'NOT_URI_IPAD_FALLBACK_LINK', BAD_URI_SCHEME_IPAD_FALLBACK_LINK = 'BAD_URI_SCHEME_IPAD_FALLBACK_LINK', BAD_DEBUG_PARAM = 'BAD_DEBUG_PARAM', BAD_AD_PARAM = 'BAD_AD_PARAM', DEPRECATED_PARAM = 'DEPRECATED_PARAM', UNRECOGNIZED_PARAM = 'UNRECOGNIZED_PARAM', TOO_LONG_PARAM = 'TOO_LONG_PARAM', NOT_URI_SOCIAL_IMAGE_LINK = 'NOT_URI_SOCIAL_IMAGE_LINK', BAD_URI_SCHEME_SOCIAL_IMAGE_LINK = 'BAD_URI_SCHEME_SOCIAL_IMAGE_LINK', NOT_URI_SOCIAL_URL = 'NOT_URI_SOCIAL_URL', BAD_URI_SCHEME_SOCIAL_URL = 'BAD_URI_SCHEME_SOCIAL_URL', LINK_LENGTH_TOO_LONG = 'LINK_LENGTH_TOO_LONG', LINK_WITH_FRAGMENTS = 'LINK_WITH_FRAGMENTS', NOT_MATCHING_IOS_BUNDLE_ID_AND_STORE_ID = 'NOT_MATCHING_IOS_BUNDLE_ID_AND_STORE_ID' }
	...
	export enum DynamicLinkEventStatEvent { DYNAMIC_LINK_EVENT_UNSPECIFIED = 'DYNAMIC_LINK_EVENT_UNSPECIFIED', CLICK = 'CLICK', REDIRECT = 'REDIRECT', APP_INSTALL = 'APP_INSTALL', APP_FIRST_OPEN = 'APP_FIRST_OPEN', APP_RE_OPEN = 'APP_RE_OPEN' }

	export enum DynamicLinkEventStatPlatform { DYNAMIC_LINK_PLATFORM_UNSPECIFIED = 'DYNAMIC_LINK_PLATFORM_UNSPECIFIED', ANDROID = 'ANDROID', IOS = 'IOS', DESKTOP = 'DESKTOP', OTHER = 'OTHER' }
	...
	export enum GetIosPostInstallAttributionRequestRetrievalMethod { UNKNOWN_PAYLOAD_RETRIEVAL_METHOD = 'UNKNOWN_PAYLOAD_RETRIEVAL_METHOD', IMPLICIT_WEAK_MATCH = 'IMPLICIT_WEAK_MATCH', EXPLICIT_WEAK_MATCH = 'EXPLICIT_WEAK_MATCH', EXPLICIT_STRONG_AFTER_WEAK_MATCH = 'EXPLICIT_STRONG_AFTER_WEAK_MATCH' }

	export enum GetIosPostInstallAttributionRequestVisualStyle { UNKNOWN_VISUAL_STYLE = 'UNKNOWN_VISUAL_STYLE', DEFAULT_STYLE = 'DEFAULT_STYLE', CUSTOM_STYLE = 'CUSTOM_STYLE' }
	...
	export enum GetIosPostInstallAttributionResponseAttributionConfidence { UNKNOWN_ATTRIBUTION_CONFIDENCE = 'UNKNOWN_ATTRIBUTION_CONFIDENCE', WEAK = 'WEAK', DEFAULT = 'DEFAULT', UNIQUE = 'UNIQUE' }

	export enum GetIosPostInstallAttributionResponseRequestIpVersion { UNKNOWN_IP_VERSION = 'UNKNOWN_IP_VERSION', IP_V4 = 'IP_V4', IP_V6 = 'IP_V6' }
