...
export namespace MyNS {
	...
	export interface CmafPackageFormProperties {
		IncludeEncoderConfigurationInSegments: FormControl<boolean | null | undefined>,
	...
	export function CreateCmafPackageFormGroup() {
		return new FormGroup<CmafPackageFormProperties>({
			IncludeEncoderConfigurationInSegments: new FormControl<boolean | null | undefined>(undefined),
	...
	export interface DashManifestFormProperties {
		...
		ScteMarkersSource: FormControl<ScteMarkersSource | null | undefined>,
	}
	export function CreateDashManifestFormGroup() {
		return new FormGroup<DashManifestFormProperties>({
			...
			ScteMarkersSource: new FormControl<ScteMarkersSource | null | undefined>(undefined),
		});
	...
	export interface DescribePackagingGroupResponse {
		ApproximateAssetCount?: number | null;
		Arn?: string;
		Authorization?: Authorization;
		CreatedAt?: string;
		DomainName?: string;
	...
	export interface DescribePackagingGroupResponseFormProperties {
		ApproximateAssetCount: FormControl<number | null | undefined>,
		Arn: FormControl<string | null | undefined>,
		CreatedAt: FormControl<string | null | undefined>,
		DomainName: FormControl<string | null | undefined>,
		Id: FormControl<string | null | undefined>,
	...
	export function CreateDescribePackagingGroupResponseFormGroup() {
		return new FormGroup<DescribePackagingGroupResponseFormProperties>({
			ApproximateAssetCount: new FormControl<number | null | undefined>(undefined),
			Arn: new FormControl<string | null | undefined>(undefined),
			CreatedAt: new FormControl<string | null | undefined>(undefined),
			DomainName: new FormControl<string | null | undefined>(undefined),
			Id: new FormControl<string | null | undefined>(undefined),
	...
	export class MyClient {
		...
		ConfigureLogs(id: string, requestBody: ConfigureLogsPutBody): Observable<ConfigureLogsResponse> {
			return this.http.put<ConfigureLogsResponse>(this.baseUri + 'packaging_groups/' + (id == null ? '' : encodeURIComponent(id)) + '/configure_logs', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	...
	export interface CreatePackagingGroupPostBody {
		...
		/** Configure egress access logging. */
		egressAccessLogs?: CreatePackagingGroupPostBodyEgressAccessLogs;
	...
	export interface CreatePackagingGroupPostBodyEgressAccessLogs {
		LogGroupName?: string;
	}
	export interface CreatePackagingGroupPostBodyEgressAccessLogsFormProperties {
		LogGroupName: FormControl<string | null | undefined>,
	}
	export function CreateCreatePackagingGroupPostBodyEgressAccessLogsFormGroup() {
		return new FormGroup<CreatePackagingGroupPostBodyEgressAccessLogsFormProperties>({
			LogGroupName: new FormControl<string | null | undefined>(undefined),
		});
