...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 */
		Libraryagent_shelves_list(pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleExampleLibraryagentV1ListShelvesResponse> {
			return this.http.get<GoogleExampleLibraryagentV1ListShelvesResponse>(this.baseUri + 'v1/shelves?pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @return {GoogleExampleLibraryagentV1Book} Successful response
		 */
		Libraryagent_shelves_books_get(name: string): Observable<GoogleExampleLibraryagentV1Book> {
			return this.http.get<GoogleExampleLibraryagentV1Book>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * @return {GoogleExampleLibraryagentV1Book} Successful response
		 */
		Libraryagent_shelves_books_borrow(name: string): Observable<GoogleExampleLibraryagentV1Book> {
			return this.http.post<GoogleExampleLibraryagentV1Book>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':borrow', null, {});
		}
		 ...
		 * @return {GoogleExampleLibraryagentV1Book} Successful response
		 */
		Libraryagent_shelves_books_return(name: string): Observable<GoogleExampleLibraryagentV1Book> {
			return this.http.post<GoogleExampleLibraryagentV1Book>(this.baseUri + 'v1/' + (name == null ? '' : encodeURIComponent(name)) + ':return', null, {});
		}
		 ...
		 */
		Libraryagent_shelves_books_list(parent: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<GoogleExampleLibraryagentV1ListBooksResponse> {
			return this.http.get<GoogleExampleLibraryagentV1ListBooksResponse>(this.baseUri + 'v1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/books&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
	}
