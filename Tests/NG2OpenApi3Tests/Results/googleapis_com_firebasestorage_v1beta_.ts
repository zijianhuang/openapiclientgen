...
export namespace MyNS {
	...
	export enum GoogleFirebaseStorageControlplaneV1alphaMigrateLocationDestructivelyMetadataState { STATE_UNSPECIFIED = 0, PENDING = 1, CREATING_TEMP_BUCKET = 2, TRANSFERRING_TO_TEMP = 3, DELETING_SOURCE_BUCKET = 4, CREATING_DESTINATION_BUCKET = 5, TRANSFERRING_TO_DESTINATION = 6, DELETING_TEMP_BUCKET = 7, SUCCEEDED = 8, FAILED = 9, ROLLING_BACK = 10, ROLLED_BACK = 11 }
