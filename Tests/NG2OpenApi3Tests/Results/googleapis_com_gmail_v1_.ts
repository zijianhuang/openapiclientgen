...
export namespace MyNS {
	...
	/** The client-side encryption (CSE) configuration for the email address of an authenticated user. Gmail uses CSE configurations to save drafts of client-side encrypted email messages, and to sign and send encrypted email messages. */
	export interface CseIdentityFormProperties {

		/** The email address for the sending identity. The email address must be the primary email address of the authenticated user. */
		emailAddress: FormControl<string | null | undefined>,

		/** If a key pair is associated, the ID of the key pair, CseKeyPair. */
		primaryKeyPairId: FormControl<string | null | undefined>,
	}
	export function CreateCseIdentityFormGroup() {
		return new FormGroup<CseIdentityFormProperties>({
			emailAddress: new FormControl<string | null | undefined>(undefined),
			primaryKeyPairId: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** The configuration of a CSE identity that uses different key pairs for signing and encryption. */
	export interface SignAndEncryptKeyPairsFormProperties {

		/** The ID of the CseKeyPair that encrypts signed outgoing mail. */
		encryptionKeyPairId: FormControl<string | null | undefined>,

		/** The ID of the CseKeyPair that signs outgoing mail. */
		signingKeyPairId: FormControl<string | null | undefined>,
	}
	export function CreateSignAndEncryptKeyPairsFormGroup() {
		return new FormGroup<SignAndEncryptKeyPairsFormProperties>({
			encryptionKeyPairId: new FormControl<string | null | undefined>(undefined),
			signingKeyPairId: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface CseKeyPair {
		...
		enablementState?: CseKeyPairEnablementState | null;
	...
	/** A client-side encryption S/MIME key pair, which is comprised of a public key, its certificate chain, and metadata for its paired private key. Gmail uses the key pair to complete the following tasks: - Sign outgoing client-side encrypted messages. - Save and reopen drafts of client-side encrypted messages. - Save and reopen sent messages. - Decrypt incoming or archived S/MIME messages. */
	export interface CseKeyPairFormProperties {

		/** Output only. If a key pair is set to `DISABLED`, the time that the key pair's state changed from `ENABLED` to `DISABLED`. This field is present only when the key pair is in state `DISABLED`. */
		disableTime: FormControl<string | null | undefined>,

		/** Output only. The current state of the key pair. */
		enablementState: FormControl<CseKeyPairEnablementState | null | undefined>,

		/** Output only. The immutable ID for the client-side encryption S/MIME key pair. */
		keyPairId: FormControl<string | null | undefined>,

		/** Output only. The public key and its certificate chain, in [PEM](https://en.wikipedia.org/wiki/Privacy-Enhanced_Mail) format. */
		pem: FormControl<string | null | undefined>,

		/** Input only. The public key and its certificate chain. The chain must be in [PKCS#7](https://en.wikipedia.org/wiki/PKCS_7) format and use PEM encoding and ASCII armor. */
		pkcs7: FormControl<string | null | undefined>,
	}
	export function CreateCseKeyPairFormGroup() {
		return new FormGroup<CseKeyPairFormProperties>({
			disableTime: new FormControl<string | null | undefined>(undefined),
			enablementState: new FormControl<CseKeyPairEnablementState | null | undefined>(undefined),
			keyPairId: new FormControl<string | null | undefined>(undefined),
			pem: new FormControl<string | null | undefined>(undefined),
			pkcs7: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Metadata for a private key instance. */
	export interface CsePrivateKeyMetadataFormProperties {

		/** Output only. The immutable ID for the private key metadata instance. */
		privateKeyMetadataId: FormControl<string | null | undefined>,
	}
	export function CreateCsePrivateKeyMetadataFormGroup() {
		return new FormGroup<CsePrivateKeyMetadataFormProperties>({
			privateKeyMetadataId: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Metadata for hardware keys. */
	export interface HardwareKeyMetadataFormProperties {

		/** Description about the hardware key. */
		description: FormControl<string | null | undefined>,
	}
	export function CreateHardwareKeyMetadataFormGroup() {
		return new FormGroup<HardwareKeyMetadataFormProperties>({
	...
	/** Metadata for private keys managed by an external key access control list service. For details about managing key access, see [Google Workspace CSE API Reference](https://developers.google.com/workspace/cse/reference). */
	export interface KaclsKeyMetadataFormProperties {

		/** Opaque data generated and used by the key access control list service. Maximum size: 8 KiB. */
		kaclsData: FormControl<string | null | undefined>,

		/** The URI of the key access control list service that manages the private key. */
		kaclsUri: FormControl<string | null | undefined>,
	}
	export function CreateKaclsKeyMetadataFormGroup() {
		return new FormGroup<KaclsKeyMetadataFormProperties>({
			kaclsData: new FormControl<string | null | undefined>(undefined),
			kaclsUri: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Requests to turn off a client-side encryption key pair. */
	export interface DisableCseKeyPairRequestFormProperties {
	}
	export function CreateDisableCseKeyPairRequestFormGroup() {
		return new FormGroup<DisableCseKeyPairRequestFormProperties>({
		});
	...
	/** Requests to turn on a client-side encryption key pair. */
	export interface EnableCseKeyPairRequestFormProperties {
	}
	export function CreateEnableCseKeyPairRequestFormGroup() {
		return new FormGroup<EnableCseKeyPairRequestFormProperties>({
		});
	...
	export interface ListCseIdentitiesResponseFormProperties {

		/** Pagination token to be passed to a subsequent ListCseIdentities call in order to retrieve the next page of identities. If this value is not returned or is the empty string, then no further pages remain. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListCseIdentitiesResponseFormGroup() {
		return new FormGroup<ListCseIdentitiesResponseFormProperties>({
	...
	export interface ListCseKeyPairsResponseFormProperties {

		/** Pagination token to be passed to a subsequent ListCseKeyPairs call in order to retrieve the next page of key pairs. If this value is not returned, then no further pages remain. */
		nextPageToken: FormControl<string | null | undefined>,
	}
	export function CreateListCseKeyPairsResponseFormGroup() {
		return new FormGroup<ListCseKeyPairsResponseFormProperties>({
			nextPageToken: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Request to obliterate a CSE key pair. */
	export interface ObliterateCseKeyPairRequestFormProperties {
	}
	export function CreateObliterateCseKeyPairRequestFormGroup() {
		return new FormGroup<ObliterateCseKeyPairRequestFormProperties>({
		});
	...
	export interface WatchRequest {
		...
		labelFilterBehavior?: WatchRequestLabelFilterAction | null;
	...
	export interface WatchRequestFormProperties {
		...
		/** Filtering behavior of `labelIds list` specified. This field replaces `label_filter_action`; if set, `label_filter_action` is ignored. */
		labelFilterBehavior: FormControl<WatchRequestLabelFilterAction | null | undefined>,
	...
	export function CreateWatchRequestFormGroup() {
		return new FormGroup<WatchRequestFormProperties>({
			...
			labelFilterBehavior: new FormControl<WatchRequestLabelFilterAction | null | undefined>(undefined),
	...
	export class MyClient {
		 ...
		 */
		Gmail_users_drafts_list(userId: string, includeSpamTrash: boolean | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined, q: string | null | undefined): Observable<ListDraftsResponse> {
			return this.http.get<ListDraftsResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/drafts&includeSpamTrash=' + includeSpamTrash + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&q=' + (q == null ? '' : encodeURIComponent(q)), {});
		}
		 ...
		 * @return {Draft} Successful response
		 */
		Gmail_users_drafts_get(userId: string, id: string, format: Gmail_users_drafts_getFormat | null | undefined): Observable<Draft> {
			return this.http.get<Draft>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/drafts/' + (id == null ? '' : encodeURIComponent(id)) + '&format=' + format, {});
		}
		 ...
		 */
		Gmail_users_history_list(userId: string, historyTypes: Array<string> | null | undefined, labelId: string | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined, startHistoryId: string | null | undefined): Observable<ListHistoryResponse> {
			return this.http.get<ListHistoryResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/history&' + historyTypes?.map(z => `historyTypes=${encodeURIComponent(z)}`).join('&') + '&labelId=' + (labelId == null ? '' : encodeURIComponent(labelId)) + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&startHistoryId=' + (startHistoryId == null ? '' : encodeURIComponent(startHistoryId)), {});
		}
		 ...
		 * @param {string} userId The user's email address. The special value `me` can be used to indicate the authenticated user.
		 * @return {ListLabelsResponse} Successful response
		 */
		Gmail_users_labels_list(userId: string): Observable<ListLabelsResponse> {
			return this.http.get<ListLabelsResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/labels', {});
		}
		 ...
		 * @param {string} userId The user's email address. The special value `me` can be used to indicate the authenticated user.
		 * @return {Label} Successful response
		 */
		Gmail_users_labels_create(userId: string, requestBody: Label): Observable<Label> {
			return this.http.post<Label>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/labels', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Label} Successful response
		 */
		Gmail_users_labels_get(userId: string, id: string): Observable<Label> {
			return this.http.get<Label>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/labels/' + (id == null ? '' : encodeURIComponent(id)), {});
		}
		 ...
		 * @return {Label} Successful response
		 */
		Gmail_users_labels_patch(userId: string, id: string, requestBody: Label): Observable<Label> {
			return this.http.patch<Label>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/labels/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Label} Successful response
		 */
		Gmail_users_labels_update(userId: string, id: string, requestBody: Label): Observable<Label> {
			return this.http.put<Label>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/labels/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Gmail_users_messages_list(userId: string, includeSpamTrash: boolean | null | undefined, labelIds: Array<string> | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined, q: string | null | undefined): Observable<ListMessagesResponse> {
			return this.http.get<ListMessagesResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/messages&includeSpamTrash=' + includeSpamTrash + '&' + labelIds?.map(z => `labelIds=${encodeURIComponent(z)}`).join('&') + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&q=' + (q == null ? '' : encodeURIComponent(q)), {});
		}
		 ...
		 */
		Gmail_users_messages_get(userId: string, id: string, format: Gmail_users_drafts_getFormat | null | undefined, metadataHeaders: Array<string> | null | undefined): Observable<Message> {
			return this.http.get<Message>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/messages/' + (id == null ? '' : encodeURIComponent(id)) + '&format=' + format + '&' + metadataHeaders?.map(z => `metadataHeaders=${encodeURIComponent(z)}`).join('&'), {});
		}
		 ...
		 * @return {Message} Successful response
		 */
		Gmail_users_messages_modify(userId: string, id: string, requestBody: ModifyMessageRequest): Observable<Message> {
			return this.http.post<Message>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/messages/' + (id == null ? '' : encodeURIComponent(id)) + '/modify', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Message} Successful response
		 */
		Gmail_users_messages_trash(userId: string, id: string): Observable<Message> {
			return this.http.post<Message>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/messages/' + (id == null ? '' : encodeURIComponent(id)) + '/trash', null, {});
		}
		 ...
		 * @return {Message} Successful response
		 */
		Gmail_users_messages_untrash(userId: string, id: string): Observable<Message> {
			return this.http.post<Message>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/messages/' + (id == null ? '' : encodeURIComponent(id)) + '/untrash', null, {});
		}
		 ...
		 * @return {MessagePartBody} Successful response
		 */
		Gmail_users_messages_attachments_get(userId: string, messageId: string, id: string): Observable<MessagePartBody> {
			return this.http.get<MessagePartBody>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/messages/' + (messageId == null ? '' : encodeURIComponent(messageId)) + '/attachments/' + (id == null ? '' : encodeURIComponent(id)), {});
		}
		 ...
		 */
		Gmail_users_getProfile(userId: string): Observable<Profile> {
			return this.http.get<Profile>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/profile', {});
		}
		 ...
		 * @return {AutoForwarding} Successful response
		 */
		Gmail_users_settings_getAutoForwarding(userId: string): Observable<AutoForwarding> {
			return this.http.get<AutoForwarding>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/autoForwarding', {});
		}
		 ...
		 * @return {AutoForwarding} Successful response
		 */
		Gmail_users_settings_updateAutoForwarding(userId: string, requestBody: AutoForwarding): Observable<AutoForwarding> {
			return this.http.put<AutoForwarding>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/autoForwarding', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Gmail_users_settings_cse_identities_list(userId: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCseIdentitiesResponse> {
			return this.http.get<ListCseIdentitiesResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/identities&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @param {string} userId The requester's primary email address. To indicate the authenticated user, you can use the special value `me`.
		 * @return {CseIdentity} Successful response
		 */
		Gmail_users_settings_cse_identities_create(userId: string, requestBody: CseIdentity): Observable<CseIdentity> {
			return this.http.post<CseIdentity>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/identities', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Successful response
		 */
		Gmail_users_settings_cse_identities_delete(userId: string, cseEmailAddress: string): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/identities/' + (cseEmailAddress == null ? '' : encodeURIComponent(cseEmailAddress)), { observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {CseIdentity} Successful response
		 */
		Gmail_users_settings_cse_identities_get(userId: string, cseEmailAddress: string): Observable<CseIdentity> {
			return this.http.get<CseIdentity>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/identities/' + (cseEmailAddress == null ? '' : encodeURIComponent(cseEmailAddress)), {});
		}
		 ...
		 * @return {CseIdentity} Successful response
		 */
		Gmail_users_settings_cse_identities_patch(userId: string, emailAddress: string, requestBody: CseIdentity): Observable<CseIdentity> {
			return this.http.patch<CseIdentity>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/identities/' + (emailAddress == null ? '' : encodeURIComponent(emailAddress)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Gmail_users_settings_cse_keypairs_list(userId: string, pageSize: number | null | undefined, pageToken: string | null | undefined): Observable<ListCseKeyPairsResponse> {
			return this.http.get<ListCseKeyPairsResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/keypairs&pageSize=' + pageSize + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}
		 ...
		 * @param {string} userId The requester's primary email address. To indicate the authenticated user, you can use the special value `me`.
		 * @return {CseKeyPair} Successful response
		 */
		Gmail_users_settings_cse_keypairs_create(userId: string, requestBody: CseKeyPair): Observable<CseKeyPair> {
			return this.http.post<CseKeyPair>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/keypairs', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {CseKeyPair} Successful response
		 */
		Gmail_users_settings_cse_keypairs_get(userId: string, keyPairId: string): Observable<CseKeyPair> {
			return this.http.get<CseKeyPair>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/keypairs/' + (keyPairId == null ? '' : encodeURIComponent(keyPairId)), {});
		}
		 ...
		 * @return {CseKeyPair} Successful response
		 */
		Gmail_users_settings_cse_keypairs_disable(userId: string, keyPairId: string, requestBody: DisableCseKeyPairRequest): Observable<CseKeyPair> {
			return this.http.post<CseKeyPair>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/keypairs/' + (keyPairId == null ? '' : encodeURIComponent(keyPairId)) + ':disable', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {CseKeyPair} Successful response
		 */
		Gmail_users_settings_cse_keypairs_enable(userId: string, keyPairId: string, requestBody: EnableCseKeyPairRequest): Observable<CseKeyPair> {
			return this.http.post<CseKeyPair>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/keypairs/' + (keyPairId == null ? '' : encodeURIComponent(keyPairId)) + ':enable', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Successful response
		 */
		Gmail_users_settings_cse_keypairs_obliterate(userId: string, keyPairId: string, requestBody: ObliterateCseKeyPairRequest): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/cse/keypairs/' + (keyPairId == null ? '' : encodeURIComponent(keyPairId)) + ':obliterate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {ListDelegatesResponse} Successful response
		 */
		Gmail_users_settings_delegates_list(userId: string): Observable<ListDelegatesResponse> {
			return this.http.get<ListDelegatesResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/delegates', {});
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {Delegate} Successful response
		 */
		Gmail_users_settings_delegates_create(userId: string, requestBody: Delegate): Observable<Delegate> {
			return this.http.post<Delegate>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/delegates', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Delegate} Successful response
		 */
		Gmail_users_settings_delegates_get(userId: string, delegateEmail: string): Observable<Delegate> {
			return this.http.get<Delegate>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/delegates/' + (delegateEmail == null ? '' : encodeURIComponent(delegateEmail)), {});
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {ListFiltersResponse} Successful response
		 */
		Gmail_users_settings_filters_list(userId: string): Observable<ListFiltersResponse> {
			return this.http.get<ListFiltersResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/filters', {});
		}
		 ...
		 */
		Gmail_users_settings_filters_create(userId: string, requestBody: Filter): Observable<Filter> {
			return this.http.post<Filter>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/filters', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Filter} Successful response
		 */
		Gmail_users_settings_filters_get(userId: string, id: string): Observable<Filter> {
			return this.http.get<Filter>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/filters/' + (id == null ? '' : encodeURIComponent(id)), {});
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {ListForwardingAddressesResponse} Successful response
		 */
		Gmail_users_settings_forwardingAddresses_list(userId: string): Observable<ListForwardingAddressesResponse> {
			return this.http.get<ListForwardingAddressesResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/forwardingAddresses', {});
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {ForwardingAddress} Successful response
		 */
		Gmail_users_settings_forwardingAddresses_create(userId: string, requestBody: ForwardingAddress): Observable<ForwardingAddress> {
			return this.http.post<ForwardingAddress>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/forwardingAddresses', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ForwardingAddress} Successful response
		 */
		Gmail_users_settings_forwardingAddresses_get(userId: string, forwardingEmail: string): Observable<ForwardingAddress> {
			return this.http.get<ForwardingAddress>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/forwardingAddresses/' + (forwardingEmail == null ? '' : encodeURIComponent(forwardingEmail)), {});
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {ImapSettings} Successful response
		 */
		Gmail_users_settings_getImap(userId: string): Observable<ImapSettings> {
			return this.http.get<ImapSettings>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/imap', {});
		}
		 ...
		 * @return {ImapSettings} Successful response
		 */
		Gmail_users_settings_updateImap(userId: string, requestBody: ImapSettings): Observable<ImapSettings> {
			return this.http.put<ImapSettings>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/imap', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {LanguageSettings} Successful response
		 */
		Gmail_users_settings_getLanguage(userId: string): Observable<LanguageSettings> {
			return this.http.get<LanguageSettings>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/language', {});
		}
		 ...
		 * @return {LanguageSettings} Successful response
		 */
		Gmail_users_settings_updateLanguage(userId: string, requestBody: LanguageSettings): Observable<LanguageSettings> {
			return this.http.put<LanguageSettings>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/language', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {PopSettings} Successful response
		 */
		Gmail_users_settings_getPop(userId: string): Observable<PopSettings> {
			return this.http.get<PopSettings>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/pop', {});
		}
		 ...
		 * @return {PopSettings} Successful response
		 */
		Gmail_users_settings_updatePop(userId: string, requestBody: PopSettings): Observable<PopSettings> {
			return this.http.put<PopSettings>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/pop', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {ListSendAsResponse} Successful response
		 */
		Gmail_users_settings_sendAs_list(userId: string): Observable<ListSendAsResponse> {
			return this.http.get<ListSendAsResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/sendAs', {});
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {SendAs} Successful response
		 */
		Gmail_users_settings_sendAs_create(userId: string, requestBody: SendAs): Observable<SendAs> {
			return this.http.post<SendAs>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/sendAs', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {SendAs} Successful response
		 */
		Gmail_users_settings_sendAs_get(userId: string, sendAsEmail: string): Observable<SendAs> {
			return this.http.get<SendAs>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/sendAs/' + (sendAsEmail == null ? '' : encodeURIComponent(sendAsEmail)), {});
		}
		 ...
		 * @return {SendAs} Successful response
		 */
		Gmail_users_settings_sendAs_patch(userId: string, sendAsEmail: string, requestBody: SendAs): Observable<SendAs> {
			return this.http.patch<SendAs>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/sendAs/' + (sendAsEmail == null ? '' : encodeURIComponent(sendAsEmail)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {SendAs} Successful response
		 */
		Gmail_users_settings_sendAs_update(userId: string, sendAsEmail: string, requestBody: SendAs): Observable<SendAs> {
			return this.http.put<SendAs>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/sendAs/' + (sendAsEmail == null ? '' : encodeURIComponent(sendAsEmail)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {ListSmimeInfoResponse} Successful response
		 */
		Gmail_users_settings_sendAs_smimeInfo_list(userId: string, sendAsEmail: string): Observable<ListSmimeInfoResponse> {
			return this.http.get<ListSmimeInfoResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/sendAs/' + (sendAsEmail == null ? '' : encodeURIComponent(sendAsEmail)) + '/smimeInfo', {});
		}
		 ...
		 * @param {string} userId The user's email address. The special value `me` can be used to indicate the authenticated user.
		 * @param {string} sendAsEmail The email address that appears in the "From:" header for mail sent using this alias.
		 * @return {SmimeInfo} Successful response
		 */
		Gmail_users_settings_sendAs_smimeInfo_insert(userId: string, sendAsEmail: string, requestBody: SmimeInfo): Observable<SmimeInfo> {
			return this.http.post<SmimeInfo>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/sendAs/' + (sendAsEmail == null ? '' : encodeURIComponent(sendAsEmail)) + '/smimeInfo', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {SmimeInfo} Successful response
		 */
		Gmail_users_settings_sendAs_smimeInfo_get(userId: string, sendAsEmail: string, id: string): Observable<SmimeInfo> {
			return this.http.get<SmimeInfo>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/sendAs/' + (sendAsEmail == null ? '' : encodeURIComponent(sendAsEmail)) + '/smimeInfo/' + (id == null ? '' : encodeURIComponent(id)), {});
		}
		 ...
		 * @param {string} userId User's email address. The special value "me" can be used to indicate the authenticated user.
		 * @return {VacationSettings} Successful response
		 */
		Gmail_users_settings_getVacation(userId: string): Observable<VacationSettings> {
			return this.http.get<VacationSettings>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/vacation', {});
		}
		 ...
		 * @return {VacationSettings} Successful response
		 */
		Gmail_users_settings_updateVacation(userId: string, requestBody: VacationSettings): Observable<VacationSettings> {
			return this.http.put<VacationSettings>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings/vacation', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Gmail_users_threads_list(userId: string, includeSpamTrash: boolean | null | undefined, labelIds: Array<string> | null | undefined, maxResults: number | null | undefined, pageToken: string | null | undefined, q: string | null | undefined): Observable<ListThreadsResponse> {
			return this.http.get<ListThreadsResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/threads&includeSpamTrash=' + includeSpamTrash + '&' + labelIds?.map(z => `labelIds=${encodeURIComponent(z)}`).join('&') + '&maxResults=' + maxResults + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)) + '&q=' + (q == null ? '' : encodeURIComponent(q)), {});
		}
		 ...
		 * @param {Array<string>} metadataHeaders When given and format is METADATA, only include headers specified.
		 * @return {Thread} Successful response
		 */
		Gmail_users_threads_get(userId: string, id: string, format: Gmail_users_threads_getFormat | null | undefined, metadataHeaders: Array<string> | null | undefined): Observable<Thread> {
			return this.http.get<Thread>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/threads/' + (id == null ? '' : encodeURIComponent(id)) + '&format=' + format + '&' + metadataHeaders?.map(z => `metadataHeaders=${encodeURIComponent(z)}`).join('&'), {});
		}
		 ...
		 * @return {Thread} Successful response
		 */
		Gmail_users_threads_modify(userId: string, id: string, requestBody: ModifyThreadRequest): Observable<Thread> {
			return this.http.post<Thread>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/threads/' + (id == null ? '' : encodeURIComponent(id)) + '/modify', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {Thread} Successful response
		 */
		Gmail_users_threads_trash(userId: string, id: string): Observable<Thread> {
			return this.http.post<Thread>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/threads/' + (id == null ? '' : encodeURIComponent(id)) + '/trash', null, {});
		}
		 ...
		 * @return {Thread} Successful response
		 */
		Gmail_users_threads_untrash(userId: string, id: string): Observable<Thread> {
			return this.http.post<Thread>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/threads/' + (id == null ? '' : encodeURIComponent(id)) + '/untrash', null, {});
		}
		 ...
		 * @param {string} userId The user's email address. The special value `me` can be used to indicate the authenticated user.
		 * @return {WatchResponse} Successful response
		 */
		Gmail_users_watch(userId: string, requestBody: WatchRequest): Observable<WatchResponse> {
			return this.http.post<WatchResponse>(this.baseUri + 'gmail/v1/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/watch', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
