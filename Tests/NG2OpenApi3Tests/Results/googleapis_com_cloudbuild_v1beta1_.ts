...
export namespace MyNS {
	...
	export interface WorkerConfigFormProperties {
		...
		/** If true, workers are created without any public address, which prevents network egress to public IPs. */
		noExternalIp: FormControl<boolean | null | undefined>,
	}
	export function CreateWorkerConfigFormGroup() {
		return new FormGroup<WorkerConfigFormProperties>({
			...
			noExternalIp: new FormControl<boolean | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 * Delete v1beta1/{name}
		 * @param {string} name Required. The name of the `WorkerPool` to delete. Format: `projects/{project}/locations/{workerPool}/workerPools/{workerPool}`.
		 * @param {string} etag Optional. If this is provided, it must match the server's etag on the workerpool for the request to be processed.
		 * @return {Operation} Successful response
		 */
		Cloudbuild_projects_locations_workerPools_delete(name: string, etag: string | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)) + '&etag=' + (etag == null ? '' : encodeURIComponent(etag)), {});
		}
		 ...
		 */
		Cloudbuild_projects_locations_workerPools_get(name: string): Observable<WorkerPool> {
			return this.http.get<WorkerPool>(this.baseUri + 'v1beta1/' + (name == null ? '' : encodeURIComponent(name)), {});
		}
		 ...
		 * @param {string} updateMask A mask specifying which fields in `WorkerPool` to update.
		 * @return {Operation} Successful response
		 */
		Cloudbuild_projects_locations_workerPools_patch(name: string, updateMask: string | null | undefined, requestBody: WorkerPool): Observable<Operation> {
		 ...
		 * Get v1beta1/{parent}/workerPools
		 ...
		 */
		Cloudbuild_projects_locations_workerPools_list(parent: string): Observable<ListWorkerPoolsResponse> {
			return this.http.get<ListWorkerPoolsResponse>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workerPools', {});
		}
		 ...
		 * Post v1beta1/{parent}/workerPools
		 ...
		 * @return {Operation} Successful response
		 */
		Cloudbuild_projects_locations_workerPools_create(parent: string, workerPoolId: string | null | undefined, requestBody: WorkerPool): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'v1beta1/' + (parent == null ? '' : encodeURIComponent(parent)) + '/workerPools&workerPoolId=' + (workerPoolId == null ? '' : encodeURIComponent(workerPoolId)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
