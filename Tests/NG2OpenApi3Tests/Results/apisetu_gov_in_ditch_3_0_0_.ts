...
export namespace MyNS {
	...
	export interface IncerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<IncerPostBodyFormat | null | undefined>,
	...
	export function CreateIncerPostBodyFormGroup() {
		return new FormGroup<IncerPostBodyFormProperties>({
			format: new FormControl<IncerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
	...
	export enum IncerPostBodyFormat { pdf = 'pdf' }
