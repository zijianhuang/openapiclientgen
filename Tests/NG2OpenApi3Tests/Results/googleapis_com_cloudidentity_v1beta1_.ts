...
export namespace MyNS {
	...
	export enum AndroidAttributesOwnershipPrivilege { OWNERSHIP_PRIVILEGE_UNSPECIFIED = 'OWNERSHIP_PRIVILEGE_UNSPECIFIED', DEVICE_ADMINISTRATOR = 'DEVICE_ADMINISTRATOR', PROFILE_OWNER = 'PROFILE_OWNER', DEVICE_OWNER = 'DEVICE_OWNER' }
	...
	export enum DeviceUserCompromisedState { COMPROMISED_STATE_UNSPECIFIED = 'COMPROMISED_STATE_UNSPECIFIED', COMPROMISED = 'COMPROMISED', NOT_COMPROMISED = 'NOT_COMPROMISED' }

	export enum DeviceUserManagementState { MANAGEMENT_STATE_UNSPECIFIED = 'MANAGEMENT_STATE_UNSPECIFIED', WIPING = 'WIPING', WIPED = 'WIPED', APPROVED = 'APPROVED', BLOCKED = 'BLOCKED', PENDING_APPROVAL = 'PENDING_APPROVAL', UNENROLLED = 'UNENROLLED' }

	export enum DeviceUserPasswordState { PASSWORD_STATE_UNSPECIFIED = 'PASSWORD_STATE_UNSPECIFIED', PASSWORD_SET = 'PASSWORD_SET', PASSWORD_NOT_SET = 'PASSWORD_NOT_SET' }
	...
	export enum DeviceCompromisedState { COMPROMISED_STATE_UNSPECIFIED = 'COMPROMISED_STATE_UNSPECIFIED', COMPROMISED = 'COMPROMISED', UNCOMPROMISED = 'UNCOMPROMISED' }

	export enum DeviceDeviceType { DEVICE_TYPE_UNSPECIFIED = 'DEVICE_TYPE_UNSPECIFIED', ANDROID = 'ANDROID', IOS = 'IOS', GOOGLE_SYNC = 'GOOGLE_SYNC', WINDOWS = 'WINDOWS', MAC_OS = 'MAC_OS', LINUX = 'LINUX', CHROME_OS = 'CHROME_OS' }

	export enum DeviceEncryptionState { ENCRYPTION_STATE_UNSPECIFIED = 'ENCRYPTION_STATE_UNSPECIFIED', UNSUPPORTED_BY_DEVICE = 'UNSUPPORTED_BY_DEVICE', ENCRYPTED = 'ENCRYPTED', NOT_ENCRYPTED = 'NOT_ENCRYPTED' }
	...
	export enum CertificateAttributesValidationState { CERTIFICATE_VALIDATION_STATE_UNSPECIFIED = 'CERTIFICATE_VALIDATION_STATE_UNSPECIFIED', VALIDATION_SUCCESSFUL = 'VALIDATION_SUCCESSFUL', VALIDATION_FAILED = 'VALIDATION_FAILED' }

	export enum DeviceManagementState { MANAGEMENT_STATE_UNSPECIFIED = 'MANAGEMENT_STATE_UNSPECIFIED', APPROVED = 'APPROVED', BLOCKED = 'BLOCKED', PENDING = 'PENDING', UNPROVISIONED = 'UNPROVISIONED', WIPING = 'WIPING', WIPED = 'WIPED' }

	export enum DeviceOwnerType { DEVICE_OWNERSHIP_UNSPECIFIED = 'DEVICE_OWNERSHIP_UNSPECIFIED', COMPANY = 'COMPANY', BYOD = 'BYOD' }
	...
	export enum ClientStateComplianceState { COMPLIANCE_STATE_UNSPECIFIED = 'COMPLIANCE_STATE_UNSPECIFIED', COMPLIANT = 'COMPLIANT', NON_COMPLIANT = 'NON_COMPLIANT' }

	export enum ClientStateHealthScore { HEALTH_SCORE_UNSPECIFIED = 'HEALTH_SCORE_UNSPECIFIED', VERY_POOR = 'VERY_POOR', POOR = 'POOR', NEUTRAL = 'NEUTRAL', GOOD = 'GOOD', VERY_GOOD = 'VERY_GOOD' }
	...
	export enum ClientStateManaged { MANAGED_STATE_UNSPECIFIED = 'MANAGED_STATE_UNSPECIFIED', MANAGED = 'MANAGED', UNMANAGED = 'UNMANAGED' }

	export enum ClientStateOwnerType { OWNER_TYPE_UNSPECIFIED = 'OWNER_TYPE_UNSPECIFIED', OWNER_TYPE_CUSTOMER = 'OWNER_TYPE_CUSTOMER', OWNER_TYPE_PARTNER = 'OWNER_TYPE_PARTNER' }
	...
	export enum OrgMembershipType { ENTITY_TYPE_UNSPECIFIED = 'ENTITY_TYPE_UNSPECIFIED', SHARED_DRIVE = 'SHARED_DRIVE' }
	...
	export enum Cloudidentity_groups_searchView { BASIC = 'BASIC', FULL = 'FULL' }

	export enum Cloudidentity_orgUnits_memberships_listPageSize { BASIC = 'BASIC', FULL = 'FULL' }
