...
export namespace MyNS {
	...
	export enum GoogleCloudRetailV2alphaCatalogAttributeDynamicFacetableOption { DYNAMIC_FACETABLE_OPTION_UNSPECIFIED = 0, DYNAMIC_FACETABLE_ENABLED = 1, DYNAMIC_FACETABLE_DISABLED = 2 }

	export enum GoogleCloudRetailV2alphaCatalogAttributeExactSearchableOption { EXACT_SEARCHABLE_OPTION_UNSPECIFIED = 0, EXACT_SEARCHABLE_ENABLED = 1, EXACT_SEARCHABLE_DISABLED = 2 }
	...
	export enum GoogleCloudRetailV2alphaCatalogAttributeIndexableOption { INDEXABLE_OPTION_UNSPECIFIED = 0, INDEXABLE_ENABLED = 1, INDEXABLE_DISABLED = 2 }

	export enum GoogleCloudRetailV2alphaCatalogAttributeRetrievableOption { RETRIEVABLE_OPTION_UNSPECIFIED = 0, RETRIEVABLE_ENABLED = 1, RETRIEVABLE_DISABLED = 2 }

	export enum GoogleCloudRetailV2alphaCatalogAttributeSearchableOption { SEARCHABLE_OPTION_UNSPECIFIED = 0, SEARCHABLE_ENABLED = 1, SEARCHABLE_DISABLED = 2 }

	export enum GoogleCloudRetailV2alphaCatalogAttributeType { UNKNOWN = 0, TEXTUAL = 1, NUMERICAL = 2 }
	...
	export enum GoogleCloudRetailV2alphaAttributesConfigAttributeConfigLevel { ATTRIBUTE_CONFIG_LEVEL_UNSPECIFIED = 0, PRODUCT_LEVEL_ATTRIBUTE_CONFIG = 1, CATALOG_LEVEL_ATTRIBUTE_CONFIG = 2 }
	...
	export enum GoogleCloudRetailV2alphaEnrollSolutionRequestSolution { SOLUTION_TYPE_UNSPECIFIED = 0, SOLUTION_TYPE_RECOMMENDATION = 1, SOLUTION_TYPE_SEARCH = 2 }
	...
	export enum GoogleCloudRetailV2alphaProductAvailability { AVAILABILITY_UNSPECIFIED = 0, IN_STOCK = 1, OUT_OF_STOCK = 2, PREORDER = 3, BACKORDER = 4 }
	...
	export enum GoogleCloudRetailV2alphaProductType { TYPE_UNSPECIFIED = 0, PRIMARY = 1, VARIANT = 2, COLLECTION = 3 }

	export enum GoogleCloudRetailV2alphaImportProductsRequestReconciliationMode { RECONCILIATION_MODE_UNSPECIFIED = 0, INCREMENTAL = 1, FULL = 2 }
	...
	export enum GoogleCloudRetailV2alphaServingConfigDiversityType { DIVERSITY_TYPE_UNSPECIFIED = 0, RULE_BASED_DIVERSITY = 1, DATA_DRIVEN_DIVERSITY = 2 }
	...
	export enum GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecMode { MODE_UNSPECIFIED = 0, DISABLED = 1, ENABLED = 2 }
	...
	export enum GoogleCloudRetailV2alphaSearchRequestPersonalizationSpecMode { MODE_UNSPECIFIED = 0, AUTO = 1, DISABLED = 2 }
	...
	export enum GoogleCloudRetailV2alphaLoggingConfigLogGenerationRuleLoggingLevel { LOGGING_LEVEL_UNSPECIFIED = 0, LOGGING_DISABLED = 1, LOG_ERRORS_AND_ABOVE = 2, LOG_WARNINGS_AND_ABOVE = 3, LOG_ALL = 4 }
	...
	export enum GoogleCloudRetailV2alphaRejoinUserEventsRequestUserEventRejoinScope { USER_EVENT_REJOIN_SCOPE_UNSPECIFIED = 0, JOINED_EVENTS = 1, UNJOINED_EVENTS = 2 }
	...
	export enum GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpecCondition { CONDITION_UNSPECIFIED = 0, DISABLED = 1, AUTO = 2 }

	export enum GoogleCloudRetailV2alphaSearchRequestRelevanceThreshold { RELEVANCE_THRESHOLD_UNSPECIFIED = 0, HIGH = 1, MEDIUM = 2, LOW = 3, LOWEST = 4 }

	export enum GoogleCloudRetailV2alphaSearchRequestSearchMode { SEARCH_MODE_UNSPECIFIED = 0, PRODUCT_SEARCH_ONLY = 1, FACETED_SEARCH_ONLY = 2 }
	...
	export enum GoogleCloudRetailV2alphaSearchRequestSpellCorrectionSpecMode { MODE_UNSPECIFIED = 0, SUGGESTION_ONLY = 1, AUTO = 2 }
