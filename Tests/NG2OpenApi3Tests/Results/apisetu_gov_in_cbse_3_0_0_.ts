...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {NchscPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Nchsc(requestBody: NchscPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'nchsc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {NctscPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Nctsc(requestBody: NctscPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'nctsc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {NsescPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Nsesc(requestBody: NsescPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'nsesc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {NstscPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Nstsc(requestBody: NstscPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'nstsc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {NtltrPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Ntltr(requestBody: NtltrPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'ntltr/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {NtmksPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Ntmks(requestBody: NtmksPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'ntmks/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {SkhscPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Skhsc(requestBody: SkhscPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'skhsc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {SktscPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Sktsc(requestBody: SktscPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'sktsc/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {SsmgrPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Ssmgr(requestBody: SsmgrPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'ssmgr/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {TetcrPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Tetcr(requestBody: TetcrPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'tetcr/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {TetmsPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Tetms(requestBody: TetmsPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'tetms/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface HpcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		rollno: FormControl<string | null | undefined>,
	...
	export function CreateHpcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<HpcerPostBodyCertificateParametersFormProperties>({
			...
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export enum HpcerPostBodyFormat { pdf = 0 }
	...
	export interface HscerPostBodyFormProperties {
		 ...
		 * Required
		 */
		format: FormControl<HscerPostBodyFormat | null | undefined>,
	...
	export function CreateHscerPostBodyFormGroup() {
		return new FormGroup<HscerPostBodyFormProperties>({
			format: new FormControl<HscerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export enum HscerPostBodyFormat { xml = 0, pdf = 1 }
	...
	export interface NchscPostBody {
		certificateParameters?: NchscPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface NchscPostBodyFormProperties {
	...
	export function CreateNchscPostBodyFormGroup() {
		return new FormGroup<NchscPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NchscPostBodyCertificateParameters {
	...
	export interface NchscPostBodyCertificateParametersFormProperties {
	...
	export function CreateNchscPostBodyCertificateParametersFormGroup() {
		return new FormGroup<NchscPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NctscPostBody {
		certificateParameters?: NctscPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface NctscPostBodyFormProperties {
	...
	export function CreateNctscPostBodyFormGroup() {
		return new FormGroup<NctscPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NctscPostBodyCertificateParameters {
	...
	export interface NctscPostBodyCertificateParametersFormProperties {
	...
	export function CreateNctscPostBodyCertificateParametersFormGroup() {
		return new FormGroup<NctscPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NsescPostBody {
		certificateParameters?: NsescPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface NsescPostBodyFormProperties {
	...
	export function CreateNsescPostBodyFormGroup() {
		return new FormGroup<NsescPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NsescPostBodyCertificateParameters {
	...
	export interface NsescPostBodyCertificateParametersFormProperties {
	...
	export function CreateNsescPostBodyCertificateParametersFormGroup() {
		return new FormGroup<NsescPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NstscPostBody {
		certificateParameters?: NstscPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface NstscPostBodyFormProperties {
	...
	export function CreateNstscPostBodyFormGroup() {
		return new FormGroup<NstscPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NstscPostBodyCertificateParameters {
	...
	export interface NstscPostBodyCertificateParametersFormProperties {
	...
	export function CreateNstscPostBodyCertificateParametersFormGroup() {
		return new FormGroup<NstscPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NtltrPostBody {
		certificateParameters?: NtltrPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface NtltrPostBodyFormProperties {
	...
	export function CreateNtltrPostBodyFormGroup() {
		return new FormGroup<NtltrPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NtltrPostBodyCertificateParameters {
	...
	export interface NtltrPostBodyCertificateParametersFormProperties {
	...
	export function CreateNtltrPostBodyCertificateParametersFormGroup() {
		return new FormGroup<NtltrPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NtmksPostBody {
		certificateParameters?: NtmksPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface NtmksPostBodyFormProperties {
	...
	export function CreateNtmksPostBodyFormGroup() {
		return new FormGroup<NtmksPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface NtmksPostBodyCertificateParameters {
	...
	export interface NtmksPostBodyCertificateParametersFormProperties {
	...
	export function CreateNtmksPostBodyCertificateParametersFormGroup() {
		return new FormGroup<NtmksPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SkhscPostBody {
		certificateParameters?: SkhscPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface SkhscPostBodyFormProperties {
	...
	export function CreateSkhscPostBodyFormGroup() {
		return new FormGroup<SkhscPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SkhscPostBodyCertificateParameters {
	...
	export interface SkhscPostBodyCertificateParametersFormProperties {
	...
	export function CreateSkhscPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SkhscPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SktscPostBody {
		certificateParameters?: SktscPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface SktscPostBodyFormProperties {
	...
	export function CreateSktscPostBodyFormGroup() {
		return new FormGroup<SktscPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SktscPostBodyCertificateParameters {
	...
	export interface SktscPostBodyCertificateParametersFormProperties {
	...
	export function CreateSktscPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SktscPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SsmgrPostBody {
		certificateParameters?: SsmgrPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface SsmgrPostBodyFormProperties {
	...
	export function CreateSsmgrPostBodyFormGroup() {
		return new FormGroup<SsmgrPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface SsmgrPostBodyCertificateParameters {
	...
	export interface SsmgrPostBodyCertificateParametersFormProperties {
	...
	export function CreateSsmgrPostBodyCertificateParametersFormGroup() {
		return new FormGroup<SsmgrPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface TetcrPostBody {
		certificateParameters?: TetcrPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface TetcrPostBodyFormProperties {
	...
	export function CreateTetcrPostBodyFormGroup() {
		return new FormGroup<TetcrPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface TetcrPostBodyCertificateParameters {
	...
	export interface TetcrPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		year_month: FormControl<string | null | undefined>,
	}
	export function CreateTetcrPostBodyCertificateParametersFormGroup() {
		return new FormGroup<TetcrPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year_month: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface TetmsPostBody {
		certificateParameters?: TetmsPostBodyCertificateParameters;
		consentArtifact?: ConsentArtifactSchema;
	...
	export interface TetmsPostBodyFormProperties {
	...
	export function CreateTetmsPostBodyFormGroup() {
		return new FormGroup<TetmsPostBodyFormProperties>({
			format: new FormControl<HpcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface TetmsPostBodyCertificateParameters {
	...
	export interface TetmsPostBodyCertificateParametersFormProperties {
	...
	export function CreateTetmsPostBodyCertificateParametersFormGroup() {
		return new FormGroup<TetmsPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			rollno: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			year_month: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
