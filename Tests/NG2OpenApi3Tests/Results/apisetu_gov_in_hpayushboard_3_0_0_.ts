...
export namespace MyNS {
	...
	export class MyClient {
		 ...
		 * @param {PhcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Phcer(requestBody: PhcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'phcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @param {RpcerPostBody} requestBody Request format
		 * @return {void} The certificate data in response body in PDF, XML or JSON format as requested in format parameter.
		 */
		Rpcer(requestBody: RpcerPostBody): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'rpcer/certificate', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' }, observe: 'response', responseType: 'text' });
		}
	}
	...
	export interface PhcerPostBodyFormProperties {

		/**
		 * The format of the certificate in response.
		 * Required
		 */
		format: FormControl<PhcerPostBodyFormat | null | undefined>,
	...
	export function CreatePhcerPostBodyFormGroup() {
		return new FormGroup<PhcerPostBodyFormProperties>({
			format: new FormControl<PhcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});

	}

	export interface PhcerPostBodyCertificateParameters {
	...
	export interface PhcerPostBodyCertificateParametersFormProperties {
		 ...
		 * Required
		 */
		RegistrationNo: FormControl<string | null | undefined>,
	}
	export function CreatePhcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<PhcerPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			RegistrationNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface RpcerPostBodyFormProperties {
	...
	export function CreateRpcerPostBodyFormGroup() {
		return new FormGroup<RpcerPostBodyFormProperties>({
			format: new FormControl<PhcerPostBodyFormat | null | undefined>(undefined, [Validators.required]),
			txnId: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
	...
	export interface RpcerPostBodyCertificateParameters {
	...
	export interface RpcerPostBodyCertificateParametersFormProperties {
	...
	export function CreateRpcerPostBodyCertificateParametersFormGroup() {
		return new FormGroup<RpcerPostBodyCertificateParametersFormProperties>({
			FullName: new FormControl<string | null | undefined>(undefined, [Validators.required]),
			RegistrationNo: new FormControl<string | null | undefined>(undefined, [Validators.required]),
		});
