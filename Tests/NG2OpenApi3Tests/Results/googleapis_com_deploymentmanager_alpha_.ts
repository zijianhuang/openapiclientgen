...
export namespace MyNS {
	...
	/** Deployment Manager will call these methods during the events of creation/deletion/update/get/setIamPolicy */
	export interface MethodMapFormProperties {

		/** The action identifier for the create method to be used for this collection */
		create: FormControl<string | null | undefined>,
		...
		/** The action identifier for the setIamPolicy method to be used for this collection */
		setIamPolicy: FormControl<string | null | undefined>,

		/** The action identifier for the update method to be used for this collection */
		update: FormControl<string | null | undefined>,
	}
	export function CreateMethodMapFormGroup() {
		return new FormGroup<MethodMapFormProperties>({
			create: new FormControl<string | null | undefined>(undefined),
			delete: new FormControl<string | null | undefined>(undefined),
			get: new FormControl<string | null | undefined>(undefined),
			setIamPolicy: new FormControl<string | null | undefined>(undefined),
			update: new FormControl<string | null | undefined>(undefined),
		});
	...
	export interface OptionsFormProperties {
		...
		/** The json path to the field in the resource JSON body into which the resource name should be mapped. Leaving this empty indicates that there should be no mapping performed. */
		nameProperty: FormControl<string | null | undefined>,
	}
	export function CreateOptionsFormGroup() {
		return new FormGroup<OptionsFormProperties>({
			nameProperty: new FormControl<string | null | undefined>(undefined),
		});
	...
	/** Output object for Deployments */
	export interface DeploymentOutputEntryFormProperties {
	...
	export function CreateDeploymentOutputEntryFormGroup() {
		return new FormGroup<DeploymentOutputEntryFormProperties>({
			key: new FormControl<string | null | undefined>(undefined),
			value: new FormControl<string | null | undefined>(undefined),
		});
	...
	export class MyClient {
		 ...
		 * Get deploymentmanager/alpha/projects/{project}/global/compositeTypes
		...
		Deploymentmanager_compositeTypes_list(project: string, filter: string | null | undefined, maxResults: number | null | undefined, orderBy: string | null | undefined, pageToken: string | null | undefined): Observable<CompositeTypesListResponse> {
			return this.http.get<CompositeTypesListResponse>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/compositeTypes&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a composite type.
		 * Post deploymentmanager/alpha/projects/{project}/global/compositeTypes
		 * @param {string} project The project ID for this request.
		 * @return {Operation} Successful response
		 */
		Deploymentmanager_compositeTypes_insert(project: string, requestBody: CompositeType): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/compositeTypes', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Deletes a composite type.
		 * Delete deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}
		 * @param {string} project The project ID for this request.
		...
		Deploymentmanager_compositeTypes_delete(project: string, compositeType: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/compositeTypes/' + (compositeType == null ? '' : encodeURIComponent(compositeType)), {});
		}

		/**
		 * Gets information about a specific composite type.
		 * Get deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}
		 * @param {string} project The project ID for this request.
		...
		Deploymentmanager_compositeTypes_get(project: string, compositeType: string): Observable<CompositeType> {
			return this.http.get<CompositeType>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/compositeTypes/' + (compositeType == null ? '' : encodeURIComponent(compositeType)), {});
		}

		/**
		 * Patches a composite type.
		 * Patch deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}
		 * @param {string} project The project ID for this request.
		 * @param {string} compositeType The name of the composite type for this request.
		 * @return {Operation} Successful response
		 */
		Deploymentmanager_compositeTypes_patch(project: string, compositeType: string, requestBody: CompositeType): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/compositeTypes/' + (compositeType == null ? '' : encodeURIComponent(compositeType)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates a composite type.
		 * Put deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}
		 * @param {string} project The project ID for this request.
		 * @param {string} compositeType The name of the composite type for this request.
		 * @return {Operation} Successful response
		 */
		Deploymentmanager_compositeTypes_update(project: string, compositeType: string, requestBody: CompositeType): Observable<Operation> {
			return this.http.put<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/compositeTypes/' + (compositeType == null ? '' : encodeURIComponent(compositeType)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all deployments for a given project.
		 * Get deploymentmanager/alpha/projects/{project}/global/deployments
		 * @param {string} project The project ID for this request.
		 * @param {string} filter A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.
		 * @param {number} maxResults The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		 * @param {string} orderBy Sorts list results by a certain order. By default, results are returned in alphanumerical order based on the resource name. You can also sort results in descending order based on the creation timestamp using `orderBy="creationTimestamp desc"`. This sorts results based on the `creationTimestamp` field in reverse chronological order (newest result first). Use this to sort resources like operations so that the newest operation is returned first. Currently, only sorting by `name` or `creationTimestamp desc` is supported.
		...
		Deploymentmanager_deployments_list(project: string, filter: string | null | undefined, maxResults: number | null | undefined, orderBy: string | null | undefined, pageToken: string | null | undefined): Observable<DeploymentsListResponse> {
			return this.http.get<DeploymentsListResponse>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a deployment and all of the resources described by the deployment manifest.
		 * Post deploymentmanager/alpha/projects/{project}/global/deployments
		 * @param {string} project The project ID for this request.
		...
		Deploymentmanager_deployments_insert(project: string, createPolicy: Deploymentmanager_deployments_insertCreatePolicy | null | undefined, preview: boolean | null | undefined, requestBody: Deployment): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments&createPolicy=' + createPolicy + '&preview=' + preview, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Deletes a deployment and all of the resources in the deployment.
		 * Delete deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}
		 * @param {string} project The project ID for this request.
		...
		Deploymentmanager_deployments_delete(project: string, deployment: string, deletePolicy: Deploymentmanager_deployments_deleteDeletePolicy | null | undefined): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)) + '&deletePolicy=' + deletePolicy, {});
		}

		/**
		 * Gets information about a specific deployment.
		 * Get deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		...
		Deploymentmanager_deployments_get(project: string, deployment: string): Observable<Deployment> {
			return this.http.get<Deployment>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)), {});
		}

		/**
		 * Patches a deployment and all of the resources described by the deployment manifest.
		 * Patch deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		 * @param {Deploymentmanager_deployments_insertCreatePolicy} createPolicy Sets the policy to use for creating new resources.
		 * @param {Deploymentmanager_deployments_deleteDeletePolicy} deletePolicy Sets the policy to use for deleting resources.
		...
		Deploymentmanager_deployments_patch(project: string, deployment: string, createPolicy: Deploymentmanager_deployments_insertCreatePolicy | null | undefined, deletePolicy: Deploymentmanager_deployments_deleteDeletePolicy | null | undefined, preview: boolean | null | undefined, requestBody: Deployment): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)) + '&createPolicy=' + createPolicy + '&deletePolicy=' + deletePolicy + '&preview=' + preview, JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates a deployment and all of the resources described by the deployment manifest.
		 * Put deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		 * @param {Deploymentmanager_deployments_insertCreatePolicy} createPolicy Sets the policy to use for creating new resources.
		 * @param {Deploymentmanager_deployments_deleteDeletePolicy} deletePolicy Sets the policy to use for deleting resources.
		 ...
		 * Post deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/cancelPreview
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		 * @return {Operation} Successful response
		 */
		Deploymentmanager_deployments_cancelPreview(project: string, deployment: string, requestBody: DeploymentsCancelPreviewRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)) + '/cancelPreview', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all manifests for a given deployment.
		 * Get deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		 * @param {string} filter A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.
		 * @param {number} maxResults The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		...
		Deploymentmanager_manifests_list(project: string, deployment: string, filter: string | null | undefined, maxResults: number | null | undefined, orderBy: string | null | undefined, pageToken: string | null | undefined): Observable<ManifestsListResponse> {
			return this.http.get<ManifestsListResponse>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)) + '/manifests&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Gets information about a specific manifest.
		 * Get deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests/{manifest}
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		...
		Deploymentmanager_manifests_get(project: string, deployment: string, manifest: string): Observable<Manifest> {
			return this.http.get<Manifest>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)) + '/manifests/' + (manifest == null ? '' : encodeURIComponent(manifest)), {});
		}

		/**
		 * Lists all resources in a given deployment.
		 * Get deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		 * @param {string} filter A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.
		 * @param {number} maxResults The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		...
		Deploymentmanager_resources_list(project: string, deployment: string, filter: string | null | undefined, maxResults: number | null | undefined, orderBy: string | null | undefined, pageToken: string | null | undefined): Observable<ResourcesListResponse> {
			return this.http.get<ResourcesListResponse>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)) + '/resources&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Gets information about a single resource.
		 * Get deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources/{resource}
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		...
		Deploymentmanager_resources_get(project: string, deployment: string, resource: string): Observable<Resource> {
			return this.http.get<Resource>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)) + '/resources/' + (resource == null ? '' : encodeURIComponent(resource)), {});
		}

		/**
		 * Stops an ongoing operation. This does not roll back any work that has already been completed, but prevents any new work from being started.
		 * Post deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/stop
		 * @param {string} project The project ID for this request.
		 * @param {string} deployment The name of the deployment for this request.
		 * @return {Operation} Successful response
		 */
		Deploymentmanager_deployments_stop(project: string, deployment: string, requestBody: DeploymentsStopRequest): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (deployment == null ? '' : encodeURIComponent(deployment)) + '/stop', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Gets the access control policy for a resource. May be empty if no such policy or resource exists.
		 * Get deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/getIamPolicy
		...
		Deploymentmanager_deployments_getIamPolicy(project: string, resource: string, optionsRequestedPolicyVersion: number | null | undefined): Observable<Policy> {
			return this.http.get<Policy>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (resource == null ? '' : encodeURIComponent(resource)) + '/getIamPolicy&optionsRequestedPolicyVersion=' + optionsRequestedPolicyVersion, {});
		}

		/**
		 * Sets the access control policy on the specified resource. Replaces any existing policy.
		 * Post deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/setIamPolicy
		 * @param {string} project Project ID for this request.
		 * @param {string} resource Name or id of the resource for this request.
		 * @return {Policy} Successful response
		 */
		Deploymentmanager_deployments_setIamPolicy(project: string, resource: string, requestBody: GlobalSetPolicyRequest): Observable<Policy> {
			return this.http.post<Policy>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (resource == null ? '' : encodeURIComponent(resource)) + '/setIamPolicy', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Returns permissions that a caller has on the specified resource.
		 * Post deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/testIamPermissions
		 * @param {string} project Project ID for this request.
		 * @param {string} resource Name or id of the resource for this request.
		...
		Deploymentmanager_deployments_testIamPermissions(project: string, resource: string, requestBody: TestPermissionsRequest): Observable<TestPermissionsResponse> {
			return this.http.post<TestPermissionsResponse>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/deployments/' + (resource == null ? '' : encodeURIComponent(resource)) + '/testIamPermissions', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all operations for a project.
		 * Get deploymentmanager/alpha/projects/{project}/global/operations
		 * @param {string} project The project ID for this request.
		 * @param {string} filter A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.
		 * @param {number} maxResults The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		 * @param {string} orderBy Sorts list results by a certain order. By default, results are returned in alphanumerical order based on the resource name. You can also sort results in descending order based on the creation timestamp using `orderBy="creationTimestamp desc"`. This sorts results based on the `creationTimestamp` field in reverse chronological order (newest result first). Use this to sort resources like operations so that the newest operation is returned first. Currently, only sorting by `name` or `creationTimestamp desc` is supported.
		...
		Deploymentmanager_operations_list(project: string, filter: string | null | undefined, maxResults: number | null | undefined, orderBy: string | null | undefined, pageToken: string | null | undefined): Observable<OperationsListResponse> {
			return this.http.get<OperationsListResponse>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/operations&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Gets information about a specific operation.
		 * Get deploymentmanager/alpha/projects/{project}/global/operations/{operation}
		 * @param {string} project The project ID for this request.
		...
		Deploymentmanager_operations_get(project: string, operation: string): Observable<Operation> {
			return this.http.get<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/operations/' + (operation == null ? '' : encodeURIComponent(operation)), {});
		}

		/**
		 * Lists all resource type providers for Deployment Manager.
		 * Get deploymentmanager/alpha/projects/{project}/global/typeProviders
		 * @param {string} project The project ID for this request.
		 * @param {string} filter A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.
		 * @param {number} maxResults The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		 * @param {string} orderBy Sorts list results by a certain order. By default, results are returned in alphanumerical order based on the resource name. You can also sort results in descending order based on the creation timestamp using `orderBy="creationTimestamp desc"`. This sorts results based on the `creationTimestamp` field in reverse chronological order (newest result first). Use this to sort resources like operations so that the newest operation is returned first. Currently, only sorting by `name` or `creationTimestamp desc` is supported.
		...
		Deploymentmanager_typeProviders_list(project: string, filter: string | null | undefined, maxResults: number | null | undefined, orderBy: string | null | undefined, pageToken: string | null | undefined): Observable<TypeProvidersListResponse> {
			return this.http.get<TypeProvidersListResponse>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/typeProviders&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Creates a type provider.
		 * Post deploymentmanager/alpha/projects/{project}/global/typeProviders
		 * @param {string} project The project ID for this request.
		 * @return {Operation} Successful response
		 */
		Deploymentmanager_typeProviders_insert(project: string, requestBody: TypeProvider): Observable<Operation> {
			return this.http.post<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/typeProviders', JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Deletes a type provider.
		 * Delete deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}
		 * @param {string} project The project ID for this request.
		...
		Deploymentmanager_typeProviders_delete(project: string, typeProvider: string): Observable<Operation> {
			return this.http.delete<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/typeProviders/' + (typeProvider == null ? '' : encodeURIComponent(typeProvider)), {});
		}

		/**
		 * Gets information about a specific type provider.
		 * Get deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}
		 * @param {string} project The project ID for this request.
		 * @param {string} typeProvider The name of the type provider for this request.
		...
		Deploymentmanager_typeProviders_get(project: string, typeProvider: string): Observable<TypeProvider> {
			return this.http.get<TypeProvider>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/typeProviders/' + (typeProvider == null ? '' : encodeURIComponent(typeProvider)), {});
		}

		/**
		 * Patches a type provider.
		 * Patch deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}
		 * @param {string} project The project ID for this request.
		 * @param {string} typeProvider The name of the type provider for this request.
		 * @return {Operation} Successful response
		 */
		Deploymentmanager_typeProviders_patch(project: string, typeProvider: string, requestBody: TypeProvider): Observable<Operation> {
			return this.http.patch<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/typeProviders/' + (typeProvider == null ? '' : encodeURIComponent(typeProvider)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Updates a type provider.
		 * Put deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}
		 * @param {string} project The project ID for this request.
		 * @param {string} typeProvider The name of the type provider for this request.
		 * @return {Operation} Successful response
		 */
		Deploymentmanager_typeProviders_update(project: string, typeProvider: string, requestBody: TypeProvider): Observable<Operation> {
			return this.http.put<Operation>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/typeProviders/' + (typeProvider == null ? '' : encodeURIComponent(typeProvider)), JSON.stringify(requestBody), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } });
		}

		/**
		 * Lists all the type info for a TypeProvider.
		 * Get deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}/types
		 * @param {string} project The project ID for this request.
		 * @param {string} typeProvider The name of the type provider for this request.
		 * @param {string} filter A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.
		 * @param {number} maxResults The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		...
		Deploymentmanager_typeProviders_getType(project: string, typeProvider: string, type: string): Observable<TypeInfo> {
			return this.http.get<TypeInfo>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/typeProviders/' + (typeProvider == null ? '' : encodeURIComponent(typeProvider)) + '/types/' + (type == null ? '' : encodeURIComponent(type)), {});
		}

		/**
		 * Lists all resource types for Deployment Manager.
		 * Get deploymentmanager/alpha/projects/{project}/global/types
		 * @param {string} project The project ID for this request.
		 * @param {string} filter A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.
		 * @param {number} maxResults The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		 * @param {string} orderBy Sorts list results by a certain order. By default, results are returned in alphanumerical order based on the resource name. You can also sort results in descending order based on the creation timestamp using `orderBy="creationTimestamp desc"`. This sorts results based on the `creationTimestamp` field in reverse chronological order (newest result first). Use this to sort resources like operations so that the newest operation is returned first. Currently, only sorting by `name` or `creationTimestamp desc` is supported.
		...
		Deploymentmanager_types_list(project: string, filter: string | null | undefined, maxResults: number | null | undefined, orderBy: string | null | undefined, pageToken: string | null | undefined): Observable<TypesListResponse> {
			return this.http.get<TypesListResponse>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/types&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&pageToken=' + (pageToken == null ? '' : encodeURIComponent(pageToken)), {});
		}

		/**
		 * Gets information about a specific type.
		 * Get deploymentmanager/alpha/projects/{project}/global/types/{type}
		 * @param {string} project The project ID for this request.
		 * @param {string} type The name of the type for this request.
		 * @return {Type} Successful response
		 */
		Deploymentmanager_types_get(project: string, type: string): Observable<Type> {
			return this.http.get<Type>(this.baseUri + 'deploymentmanager/alpha/projects/' + (project == null ? '' : encodeURIComponent(project)) + '/global/types/' + (type == null ? '' : encodeURIComponent(type)), {});
		}
	}
