...
export namespace MyNS {
	...
	export enum GoogleCloudAssuredworkloadsV1AcknowledgeViolationRequestAcknowledgeType { ACKNOWLEDGE_TYPE_UNSPECIFIED = 0, SINGLE_VIOLATION = 1, EXISTING_CHILD_RESOURCE_VIOLATIONS = 2 }
	...
	export enum GoogleCloudAssuredworkloadsV1ViolationState { STATE_UNSPECIFIED = 0, RESOLVED = 1, UNRESOLVED = 2, EXCEPTION = 3 }

	export enum GoogleCloudAssuredworkloadsV1ViolationViolationType { VIOLATION_TYPE_UNSPECIFIED = 0, ORG_POLICY = 1, RESOURCE = 2 }
	...
	export enum GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponseEkmProvisioningErrorDomain { EKM_PROVISIONING_ERROR_DOMAIN_UNSPECIFIED = 0, UNSPECIFIED_ERROR = 1, GOOGLE_SERVER_ERROR = 2, EXTERNAL_USER_ERROR = 3, EXTERNAL_PARTNER_ERROR = 4, TIMEOUT_ERROR = 5 }

	export enum GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponseEkmProvisioningErrorMapping { EKM_PROVISIONING_ERROR_MAPPING_UNSPECIFIED = 0, INVALID_SERVICE_ACCOUNT = 1, MISSING_METRICS_SCOPE_ADMIN_PERMISSION = 2, MISSING_EKM_CONNECTION_ADMIN_PERMISSION = 3 }

	export enum GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponseEkmProvisioningState { EKM_PROVISIONING_STATE_UNSPECIFIED = 0, EKM_PROVISIONING_STATE_PENDING = 1, EKM_PROVISIONING_STATE_FAILED = 2, EKM_PROVISIONING_STATE_COMPLETED = 3 }

	export enum GoogleCloudAssuredworkloadsV1WorkloadKajEnrollmentState { KAJ_ENROLLMENT_STATE_UNSPECIFIED = 0, KAJ_ENROLLMENT_STATE_PENDING = 1, KAJ_ENROLLMENT_STATE_COMPLETE = 2 }
	...
	export enum GoogleCloudAssuredworkloadsV1WorkloadPartner { PARTNER_UNSPECIFIED = 0, LOCAL_CONTROLS_BY_S3NS = 1, SOVEREIGN_CONTROLS_BY_T_SYSTEMS = 2, SOVEREIGN_CONTROLS_BY_SIA_MINSAIT = 3, SOVEREIGN_CONTROLS_BY_PSN = 4 }
	...
	export enum GoogleCloudAssuredworkloadsV1WorkloadResourceSettingsResourceType { RESOURCE_TYPE_UNSPECIFIED = 0, CONSUMER_PROJECT = 1, CONSUMER_FOLDER = 2, ENCRYPTION_KEYS_PROJECT = 3, KEYRING = 4 }
	...
	export enum GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponseSetupStatus { SETUP_STATE_UNSPECIFIED = 0, STATUS_PENDING = 1, STATUS_COMPLETE = 2 }
	...
	export enum GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesRequestRestrictionType { RESTRICTION_TYPE_UNSPECIFIED = 0, ALLOW_ALL_GCP_RESOURCES = 1, ALLOW_COMPLIANT_RESOURCES = 2, APPEND_COMPLIANT_RESOURCES = 3 }
