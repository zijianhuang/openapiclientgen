...
namespace MyNS
{
	...
	[System.Runtime.Serialization.DataContractAttribute(Name = "http://openapidemo.com/09/2019")]
	...
	public partial class PetClient
	{
		...
		{
			var requestUri = "pet/findByStatus?status=" + Uri.EscapeDataString(status);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCode();
		...
		{
			var requestUri = "pet/findByTags?tags=" + Uri.EscapeDataString(tags);
			var responseMessage = await client.GetAsync(requestUri);
			try
			{
				responseMessage.EnsureSuccessStatusCode();
	...
	public partial class StoreClient
	{
		...
		public StoreClient(System.Net.Http.HttpClient client)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
	...
	public partial class UserClient
	{
		...
		public UserClient(System.Net.Http.HttpClient client)
		{
			if (client == null)
				throw new ArgumentNullException("Null HttpClient.", "client");
