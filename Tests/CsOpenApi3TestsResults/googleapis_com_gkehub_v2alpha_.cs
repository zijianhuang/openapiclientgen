...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Gkehub_projects_locations_operations_get v2alpha/{name}
		/// </summary>
		...
		/// Gkehub_projects_locations_list v2alpha/{name}/locations
		/// </summary>
		...
		/// Gkehub_projects_locations_operations_list v2alpha/{name}/operations
		/// </summary>
		...
		/// Gkehub_projects_locations_operations_cancel v2alpha/{name}:cancel
		/// </summary>
		...
		{
			var requestUri = "v2alpha/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":cancel";
