...
namespace MyNS
{
	...
	public class NodeConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="composerInternalIpv4CidrBlock")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="composerNetworkAttachment")]
		...
		public System.Nullable<System.Int32> MaxPodsPerNode { get; set; }
	...
	public class PrivateEnvironmentConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="enablePrivateBuildsOnly")]
		public System.Nullable<System.Boolean> EnablePrivateBuildsOnly { get; set; }
	...
	public class SoftwareConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="webServerPluginsMode")]
		public System.Nullable<SoftwareConfigWebServerPluginsMode> WebServerPluginsMode { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum SoftwareConfigWebServerPluginsMode
	{
	...
	public class WorkloadsConfig
	{
		...
		/// Configuration for resources used by Airflow DAG processors.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="dagProcessor")]
		public DagProcessorResource DagProcessor { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class RestartWebServerRequest
	{
	}
	...
	public partial class Misc
	{
		...
		/// Composer_projects_locations_environments_checkUpgrade v1beta1/{environment}:checkUpgrade
		/// </summary>
		/// <param name="environment">The resource name of the environment to check upgrade for, in the form: "projects/{projectId}/locations/{locationId}/environments/{environmentId}"</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Composer_projects_locations_environments_checkUpgradeAsync(string environment, CheckUpgradeRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (environment==null? "" : System.Uri.EscapeDataString(environment))+":checkUpgrade";
		...
		/// Composer_projects_locations_environments_databaseFailover v1beta1/{environment}:databaseFailover
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (environment==null? "" : System.Uri.EscapeDataString(environment))+":databaseFailover";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Composer_projects_locations_environments_executeAirflowCommand v1beta1/{environment}:executeAirflowCommand
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (environment==null? "" : System.Uri.EscapeDataString(environment))+":executeAirflowCommand";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Composer_projects_locations_environments_fetchDatabaseProperties v1beta1/{environment}:fetchDatabaseProperties
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (environment==null? "" : System.Uri.EscapeDataString(environment))+":fetchDatabaseProperties";
		...
		/// Composer_projects_locations_environments_loadSnapshot v1beta1/{environment}:loadSnapshot
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (environment==null? "" : System.Uri.EscapeDataString(environment))+":loadSnapshot";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Composer_projects_locations_environments_pollAirflowCommand v1beta1/{environment}:pollAirflowCommand
		/// </summary>
		/// <param name="environment">The resource name of the environment in the form: "projects/{projectId}/locations/{locationId}/environments/{environmentId}"</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (environment==null? "" : System.Uri.EscapeDataString(environment))+":pollAirflowCommand";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Composer_projects_locations_environments_saveSnapshot v1beta1/{environment}:saveSnapshot
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (environment==null? "" : System.Uri.EscapeDataString(environment))+":saveSnapshot";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Composer_projects_locations_environments_stopAirflowCommand v1beta1/{environment}:stopAirflowCommand
		/// </summary>
		/// <param name="environment">The resource name of the environment in the form: "projects/{projectId}/locations/{locationId}/environments/{environmentId}".</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (environment==null? "" : System.Uri.EscapeDataString(environment))+":stopAirflowCommand";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Composer_projects_locations_operations_delete v1beta1/{name}
		/// </summary>
		...
		/// Composer_projects_locations_operations_get v1beta1/{name}
		/// </summary>
		...
		/// Composer_projects_locations_environments_patch v1beta1/{name}
		/// </summary>
		...
		/// Composer_projects_locations_operations_list v1beta1/{name}/operations
		/// </summary>
		...
		/// <summary>
		/// Restart Airflow web server.
		/// Composer_projects_locations_environments_restartWebServer v1beta1/{name}:restartWebServer
		/// </summary>
		/// <param name="name">The resource name of the environment to restart the web server for, in the form: "projects/{projectId}/locations/{locationId}/environments/{environmentId}"</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Composer_projects_locations_environments_restartWebServerAsync(string name, RestartWebServerRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":restartWebServer";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// List environments.
		/// Composer_projects_locations_environments_list v1beta1/{parent}/environments
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/environments&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Composer_projects_locations_environments_create v1beta1/{parent}/environments
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/environments";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Composer_projects_locations_imageVersions_list v1beta1/{parent}/imageVersions
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/imageVersions&includePastReleases="+includePastReleases+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
