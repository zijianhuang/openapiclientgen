...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		{
			var requestUri = "api/projects/"+id+ (_format==null? "" : System.Uri.EscapeDataString(_format))+"?format=" + format+"";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		{
			var requestUri = "api/projects"+ (_format==null? "" : System.Uri.EscapeDataString(_format))+"?updatedSince="+updatedSince+"&format=" + format;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
