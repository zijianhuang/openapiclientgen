...
namespace MyNS
{
	...
	public class CustomAttribute
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="keywordSearchable")]
		public System.Nullable<System.Boolean> KeywordSearchable { get; set; }
	...
	public class Location
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="radiusMiles")]
		public System.Nullable<System.Double> RadiusMiles { get; set; }
	}
	...
	public class BatchCreateJobsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="jobResults")]
		public JobResult[] JobResults { get; set; }
	}
	...
	public class ClientEvent
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="eventNotes")]
	...
	public class RequestMetadata
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="allowMissingIds")]
		public System.Nullable<System.Boolean> AllowMissingIds { get; set; }
	...
	public class SearchJobsRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="keywordMatchMode")]
		public System.Nullable<SearchJobsRequestKeywordMatchMode> KeywordMatchMode { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maxPageSize")]
	...
	public enum SearchJobsRequestDiversificationLevel
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		MAX_THREE_PER_COMPANY = 5,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		DIVERSIFY_BY_LOOSER_SIMILARITY = 6,
	}
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum SearchJobsRequestKeywordMatchMode
	{
	...
	public class SpellingCorrection
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="correctedHtml")]
	...
	public partial class Misc
	{
		...
		/// Jobs_projects_tenants_jobs_delete v4/{name}
		/// </summary>
		/// <param name="name">Required. The resource name of the job to be deleted. The format is "projects/{project_id}/tenants/{tenant_id}/jobs/{job_id}". For example, "projects/foo/tenants/bar/jobs/baz".</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Jobs_projects_tenants_jobs_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Jobs_projects_tenants_jobs_get v4/{name}
		/// </summary>
		/// <param name="name">Required. The resource name of the job to retrieve. The format is "projects/{project_id}/tenants/{tenant_id}/jobs/{job_id}". For example, "projects/foo/tenants/bar/jobs/baz".</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Jobs_projects_tenants_jobs_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// Jobs_projects_tenants_jobs_patch v4/{name}
		/// </summary>
		...
		/// <param name="updateMask">Strongly recommended for the best service experience. If update_mask is provided, only the specified fields in job are updated. Otherwise all the fields are updated. A field mask to restrict the fields that are updated. Only top level fields of Job are supported.</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Jobs_projects_tenants_jobs_patchAsync(string name, string updateMask, Job requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Jobs_projects_tenants_clientEvents_create v4/{parent}/clientEvents
		/// </summary>
		/// <param name="parent">Required. Resource name of the tenant under which the event is created. The format is "projects/{project_id}/tenants/{tenant_id}", for example, "projects/foo/tenants/bar".</param>
		/// <returns>Successful response</returns>
		public async Task<ClientEvent> Jobs_projects_tenants_clientEvents_createAsync(string parent, ClientEvent requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/clientEvents";
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ClientEvent>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Jobs_projects_tenants_companies_list v4/{parent}/companies
		/// </summary>
		/// <param name="parent">Required. Resource name of the tenant under which the company is created. The format is "projects/{project_id}/tenants/{tenant_id}", for example, "projects/foo/tenants/bar".</param>
		/// <param name="pageSize">The maximum number of companies to be returned, at most 100. Default is 100 if a non-positive number is provided.</param>
		/// <param name="pageToken">The starting indicator from which to return results.</param>
		/// <param name="requireOpenJobs">Set to true if the companies requested must have open jobs. Defaults to false. If true, at most page_size of companies are fetched, among which only those with open jobs are returned.</param>
		/// <returns>Successful response</returns>
		public async Task<ListCompaniesResponse> Jobs_projects_tenants_companies_listAsync(string parent, int pageSize, string pageToken, bool requireOpenJobs, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/companies&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&requireOpenJobs="+requireOpenJobs;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListCompaniesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Jobs_projects_tenants_companies_create v4/{parent}/companies
		/// </summary>
		/// <param name="parent">Required. Resource name of the tenant under which the company is created. The format is "projects/{project_id}/tenants/{tenant_id}", for example, "projects/foo/tenants/bar".</param>
		/// <returns>Successful response</returns>
		public async Task<Company> Jobs_projects_tenants_companies_createAsync(string parent, Company requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/companies";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Jobs_projects_tenants_jobs_list v4/{parent}/jobs
		/// </summary>
		/// <param name="parent">Required. The resource name of the tenant under which the job is created. The format is "projects/{project_id}/tenants/{tenant_id}". For example, "projects/foo/tenants/bar".</param>
		/// <param name="filter">Required. The filter string specifies the jobs to be enumerated. Supported operator: =, AND The fields eligible for filtering are: * `companyName` * `requisitionId` * `status` Available values: OPEN, EXPIRED, ALL. Defaults to OPEN if no value is specified. At least one of `companyName` and `requisitionId` must present or an INVALID_ARGUMENT error is thrown. Sample Query: * companyName = "projects/foo/tenants/bar/companies/baz" * companyName = "projects/foo/tenants/bar/companies/baz" AND requisitionId = "req-1" * companyName = "projects/foo/tenants/bar/companies/baz" AND status = "EXPIRED" * requisitionId = "req-1" * requisitionId = "req-1" AND status = "EXPIRED"</param>
		/// <param name="jobView">The desired job attributes returned for jobs in the search response. Defaults to JobView.JOB_VIEW_FULL if no value is specified.</param>
		/// <param name="pageSize">The maximum number of jobs to be returned per page of results. If job_view is set to JobView.JOB_VIEW_ID_ONLY, the maximum allowed page size is 1000. Otherwise, the maximum allowed page size is 100. Default is 100 if empty or a number < 1 is specified.</param>
		/// <param name="pageToken">The starting point of a query result.</param>
		/// <returns>Successful response</returns>
		public async Task<ListJobsResponse> Jobs_projects_tenants_jobs_listAsync(string parent, string filter, SearchJobsRequestJobView jobView, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&jobView=" + jobView+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Jobs_projects_tenants_jobs_create v4/{parent}/jobs
		/// </summary>
		/// <param name="parent">Required. The resource name of the tenant under which the job is created. The format is "projects/{project_id}/tenants/{tenant_id}". For example, "projects/foo/tenants/bar".</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Jobs_projects_tenants_jobs_createAsync(string parent, Job requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Jobs_projects_tenants_jobs_batchCreate v4/{parent}/jobs:batchCreate
		/// </summary>
		/// <param name="parent">Required. The resource name of the tenant under which the job is created. The format is "projects/{project_id}/tenants/{tenant_id}". For example, "projects/foo/tenants/bar".</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Jobs_projects_tenants_jobs_batchCreateAsync(string parent, BatchCreateJobsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs:batchCreate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Jobs_projects_tenants_jobs_batchDelete v4/{parent}/jobs:batchDelete
		/// </summary>
		/// <param name="parent">Required. The resource name of the tenant under which the job is created. The format is "projects/{project_id}/tenants/{tenant_id}". For example, "projects/foo/tenants/bar". The parent of all of the jobs specified in `names` must match this field.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Jobs_projects_tenants_jobs_batchDeleteAsync(string parent, BatchDeleteJobsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs:batchDelete";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Jobs_projects_tenants_jobs_batchUpdate v4/{parent}/jobs:batchUpdate
		/// </summary>
		/// <param name="parent">Required. The resource name of the tenant under which the job is created. The format is "projects/{project_id}/tenants/{tenant_id}". For example, "projects/foo/tenants/bar".</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Jobs_projects_tenants_jobs_batchUpdateAsync(string parent, BatchUpdateJobsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs:batchUpdate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Jobs_projects_tenants_jobs_search v4/{parent}/jobs:search
		/// </summary>
		/// <param name="parent">Required. The resource name of the tenant to search within. The format is "projects/{project_id}/tenants/{tenant_id}". For example, "projects/foo/tenants/bar".</param>
		/// <returns>Successful response</returns>
		public async Task<SearchJobsResponse> Jobs_projects_tenants_jobs_searchAsync(string parent, SearchJobsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs:search";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SearchJobsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Jobs_projects_tenants_jobs_searchForAlert v4/{parent}/jobs:searchForAlert
		/// </summary>
		/// <param name="parent">Required. The resource name of the tenant to search within. The format is "projects/{project_id}/tenants/{tenant_id}". For example, "projects/foo/tenants/bar".</param>
		/// <returns>Successful response</returns>
		public async Task<SearchJobsResponse> Jobs_projects_tenants_jobs_searchForAlertAsync(string parent, SearchJobsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs:searchForAlert";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Jobs_projects_tenants_list v4/{parent}/tenants
		/// </summary>
		/// <param name="parent">Required. Resource name of the project under which the tenant is created. The format is "projects/{project_id}", for example, "projects/foo".</param>
		/// <param name="pageSize">The maximum number of tenants to be returned, at most 100. Default is 100 if a non-positive number is provided.</param>
		/// <param name="pageToken">The starting indicator from which to return results.</param>
		/// <returns>Successful response</returns>
		public async Task<ListTenantsResponse> Jobs_projects_tenants_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tenants&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListTenantsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Jobs_projects_tenants_create v4/{parent}/tenants
		/// </summary>
		/// <param name="parent">Required. Resource name of the project under which the tenant is created. The format is "projects/{project_id}", for example, "projects/foo".</param>
		/// <returns>Successful response</returns>
		public async Task<Tenant> Jobs_projects_tenants_createAsync(string parent, Tenant requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tenants";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Tenant>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Jobs_projects_tenants_completeQuery v4/{tenant}:completeQuery
		/// </summary>
		/// <param name="tenant">Required. Resource name of tenant the completion is performed within. The format is "projects/{project_id}/tenants/{tenant_id}", for example, "projects/foo/tenants/bar".</param>
		/// <param name="company">If provided, restricts completion to specified company. The format is "projects/{project_id}/tenants/{tenant_id}/companies/{company_id}", for example, "projects/foo/tenants/bar/companies/baz".</param>
		/// <param name="languageCodes">The list of languages of the query. This is the BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see [Tags for Identifying Languages](https://tools.ietf.org/html/bcp47). The maximum number of allowed characters is 255.</param>
		...
		/// <param name="scope">The scope of the completion. The defaults is CompletionScope.PUBLIC.</param>
		/// <param name="type">The completion topic. The default is CompletionType.COMBINED.</param>
		/// <returns>Successful response</returns>
		public async Task<CompleteQueryResponse> Jobs_projects_tenants_completeQueryAsync(string tenant, string company, string[] languageCodes, int pageSize, string query, Jobs_projects_tenants_completeQueryScope scope, CompletionResultType type, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v4/"+ (tenant==null? "" : System.Uri.EscapeDataString(tenant))+":completeQuery&company=" + (company==null? "" : System.Uri.EscapeDataString(company))+"&"+string.Join("&", languageCodes.Select(z => $"languageCodes={System.Uri.EscapeDataString(z.ToString())}"))+"&pageSize="+pageSize+"&query=" + (query==null? "" : System.Uri.EscapeDataString(query))+"&scope=" + scope+"&type=" + type;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CompleteQueryResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
	...
	public enum Jobs_projects_tenants_completeQueryScope
	{
