...
namespace MyNS
{
	...
	public class AttestationAuthenticator
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pkixPublicKeySet")]
		public PkixPublicKeySet PkixPublicKeySet { get; set; }
	}
	...
	public class PkixPublicKeySet
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pkixPublicKeys")]
		public PkixPublicKey[] PkixPublicKeys { get; set; }
	}
	...
	public class AttestationSource
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="containerAnalysisAttestationProjects")]
		public string[] ContainerAnalysisAttestationProjects { get; set; }
	}
	...
	public class Attestor
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="userOwnedGrafeasNote")]
	...
	public class Check
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="alwaysDeny")]
		public System.Nullable<System.Boolean> AlwaysDeny { get; set; }
		...
		public ImageAllowlist ImageAllowlist { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="imageFreshnessCheck")]
		public ImageFreshnessCheck ImageFreshnessCheck { get; set; }
		
		/// <summary>
		/// Require a signed [DSSE](https://github.com/secure-systems-lab/dsse) attestation with type SimpleSigning.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="simpleSigningAttestationCheck")]
		public SimpleSigningAttestationCheck SimpleSigningAttestationCheck { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="slsaCheck")]
		public SlsaCheck SlsaCheck { get; set; }
		
		/// <summary>
		/// A trusted directory check, which rejects images that do not come from the set of user-configured trusted directories.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="trustedDirectoryCheck")]
		public TrustedDirectoryCheck TrustedDirectoryCheck { get; set; }
		
		/// <summary>
		/// An image vulnerability check, which rejects images that violate the configured vulnerability rules.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="vulnerabilityCheck")]
		public VulnerabilityCheck VulnerabilityCheck { get; set; }
	}
	...
	public class ImageAllowlist
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="allowPattern")]
	...
	public class ImageFreshnessCheck
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maxUploadAgeDays")]
		public System.Nullable<System.Int32> MaxUploadAgeDays { get; set; }
	}
	...
	public class SimpleSigningAttestationCheck
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="attestationAuthenticators")]
		public AttestationAuthenticator[] AttestationAuthenticators { get; set; }
	...
	public class SlsaCheck
	{
		...
		public VerificationRule[] Rules { get; set; }
	}
	...
	public class VerificationRule
	{
		...
		/// Specifies the locations for fetching the provenance attestations.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="attestationSource")]
		public AttestationSource AttestationSource { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="configBasedBuildRequired")]
		public System.Nullable<System.Boolean> ConfigBasedBuildRequired { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="trustedBuilder")]
		public System.Nullable<VerificationRuleTrustedBuilder> TrustedBuilder { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="trustedSourceRepoPatterns")]
		public string[] TrustedSourceRepoPatterns { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum VerificationRuleTrustedBuilder
	{
	...
	public class TrustedDirectoryCheck
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="trustedDirPatterns")]
		public string[] TrustedDirPatterns { get; set; }
	}
	...
	public class VulnerabilityCheck
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="allowedCves")]
		public string[] AllowedCves { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="blockedCves")]
		public string[] BlockedCves { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="containerAnalysisVulnerabilityProjects")]
		public string[] ContainerAnalysisVulnerabilityProjects { get; set; }
		
		/// <summary>
		/// Required. The threshold for severity for which a fix is currently available. This field is required and must be set.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maximumFixableSeverity")]
		public System.Nullable<VulnerabilityCheckMaximumFixableSeverity> MaximumFixableSeverity { get; set; }
		
		/// <summary>
		/// Required. The threshold for severity for which a fix isn't currently available. This field is required and must be set.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maximumUnfixableSeverity")]
		public VulnerabilityCheckMaximumFixableSeverity MaximumUnfixableSeverity { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum VulnerabilityCheckMaximumFixableSeverity
	{
	...
	public class Scope
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="kubernetesServiceAccount")]
	...
	public class GkePolicy
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="checkSets")]
		public CheckSet[] CheckSets { get; set; }
	...
	public class ListPlatformPoliciesResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="platformPolicies")]
		public PlatformPolicy[] PlatformPolicies { get; set; }
	}
	...
	public class PlatformPolicy
	{
		...
		/// A Binary Authorization policy for a GKE cluster. This is one type of policy that can occur as a `PlatformPolicy`.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="gkePolicy")]
		public GkePolicy GkePolicy { get; set; }
	...
	public partial class Misc
	{
		...
		/// Binaryauthorization_projects_attestors_validateAttestationOccurrence v1/{attestor}:validateAttestationOccurrence
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (attestor==null? "" : System.Uri.EscapeDataString(attestor))+":validateAttestationOccurrence";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<ValidateAttestationOccurrenceResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Binaryauthorization_projects_platforms_policies_delete v1/{name}
		/// </summary>
		/// <param name="name">Required. The name of the platform policy to delete, in the format `projects/*/platforms/*/policies/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Binaryauthorization_projects_platforms_policies_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Binaryauthorization_systempolicy_getPolicy v1/{name}
		/// </summary>
		...
		/// Binaryauthorization_projects_platforms_policies_replacePlatformPolicy v1/{name}
		/// </summary>
		/// <param name="name">Output only. The relative resource name of the Binary Authorization platform policy, in the form of `projects/*/platforms/*/policies/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<PlatformPolicy> Binaryauthorization_projects_platforms_policies_replacePlatformPolicyAsync(string name, PlatformPolicy requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PlatformPolicy>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Binaryauthorization_projects_attestors_list v1/{parent}/attestors
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/attestors&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAttestorsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Binaryauthorization_projects_attestors_create v1/{parent}/attestors
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/attestors&attestorId=" + (attestorId==null? "" : System.Uri.EscapeDataString(attestorId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Attestor>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Binaryauthorization_projects_platforms_policies_list v1/{parent}/policies
		/// </summary>
		/// <param name="parent">Required. The resource name of the platform associated with the platform policies using the format `projects/*/platforms/*`.</param>
		/// <param name="pageSize">Requested page size. The server may return fewer results than requested. If unspecified, the server picks an appropriate default.</param>
		/// <param name="pageToken">A token identifying a page of results the server should return. Typically, this is the value of ListPlatformPoliciesResponse.next_page_token returned from the previous call to the `ListPlatformPolicies` method.</param>
		/// <returns>Successful response</returns>
		public async Task<ListPlatformPoliciesResponse> Binaryauthorization_projects_platforms_policies_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListPlatformPoliciesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Binaryauthorization_projects_platforms_policies_create v1/{parent}/policies
		/// </summary>
		/// <param name="parent">Required. The parent of this platform policy.</param>
		/// <param name="policyId">Required. The platform policy ID.</param>
		/// <returns>Successful response</returns>
		public async Task<PlatformPolicy> Binaryauthorization_projects_platforms_policies_createAsync(string parent, string policyId, PlatformPolicy requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/policies&policyId=" + (policyId==null? "" : System.Uri.EscapeDataString(policyId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Binaryauthorization_projects_policy_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		...
		public async Task<IamPolicy> Binaryauthorization_projects_policy_getIamPolicyAsync(string resource, int options_requestedPolicyVersion, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<IamPolicy>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Binaryauthorization_projects_policy_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Binaryauthorization_projects_policy_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
