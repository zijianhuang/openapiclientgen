...
namespace MyNS
{
	...
	public class GoogleIdentityStsV1ExchangeOauthTokenRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="codeVerifier")]
	...
	public class GoogleIdentityStsV1IntrospectTokenRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="tokenTypeHint")]
	...
	public partial class Misc
	{
		...
		/// Sts_introspect v1/introspect
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<GoogleIdentityStsV1IntrospectTokenResponse> Sts_introspectAsync(GoogleIdentityStsV1IntrospectTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/introspect";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GoogleIdentityStsV1IntrospectTokenResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Sts_oauthtoken v1/oauthtoken
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<GoogleIdentityStsV1ExchangeOauthTokenResponse> Sts_oauthtokenAsync(GoogleIdentityStsV1ExchangeOauthTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/oauthtoken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleIdentityStsV1ExchangeOauthTokenResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<GoogleIdentityStsV1ExchangeTokenResponse> Sts_tokenAsync(GoogleIdentityStsV1ExchangeTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleIdentityStsV1ExchangeTokenResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
