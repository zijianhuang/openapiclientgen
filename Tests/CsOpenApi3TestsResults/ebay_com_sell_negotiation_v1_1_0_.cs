...
namespace MyNS
{
	...
	public class CreateOffersRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="allowCounterOffer")]
		public System.Nullable<System.Boolean> AllowCounterOffer { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="offeredItems")]
	...
	public class Offer
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="offerStatus")]
	...
	public class User
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maskedUsername")]
	...
	public class PagedEligibleItemCollection
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="eligibleItems")]
	...
	public partial class Misc
	{
		...
		public async Task<PagedEligibleItemCollection> FindEligibleItemsAsync(string limit, string offset, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "find_eligible_items?limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<PagedEligibleItemCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// <returns>Success</returns>
		public async Task<SendOfferToInterestedBuyersCollectionResponse> SendOfferToInterestedBuyersAsync(CreateOffersRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SendOfferToInterestedBuyersCollectionResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
