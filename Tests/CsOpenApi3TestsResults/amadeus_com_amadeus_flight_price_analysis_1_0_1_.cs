...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Max length: 3
		// </param>
		/// <param name="destinationIataCode">airport code, following [IATA standard](http://www.iata.org/publications/Pages/code-search.aspx), to which the traveler is going.
		/// Min length: 3
		/// Max length: 3
		// </param>
		...
		/// <param name="currencyCode">the preferred currency for display. Currency is specified in the [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) format, e.g. EUR for Euro
		/// Min length: 3
		/// Max length: 3
		// </param>
