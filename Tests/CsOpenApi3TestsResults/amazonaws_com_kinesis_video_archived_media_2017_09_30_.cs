...
namespace MyNS
{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class UnsupportedStreamMediaTypeException
	{
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class MissingCodecPrivateDataException
	{
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class InvalidCodecPrivateDataException
	{
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class InvalidMediaFrameException
	{
	}
	...
	public class Fragment
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.DateTimeOffset ProducerTimestamp { get; set; }
	...
	public class GetDASHStreamingSessionURLInput
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public DASHPlaybackMode PlaybackMode { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public DASHDisplayFragmentNumber DisplayFragmentTimestamp { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public DASHDisplayFragmentNumber DisplayFragmentNumber { get; set; }
	...
	public class GetHLSStreamingSessionURLInput
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public HLSDiscontinuityMode DiscontinuityMode { get; set; }
	...
	public class GetImagesInput
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public ClipFragmentSelectorType ImageSelectorType { get; set; }
	...
	public partial class Misc
	{
		...
		public async Task<GetClipOutput> GetClipAsync(GetClipPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GetClipOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task<GetDASHStreamingSessionURLOutput> GetDASHStreamingSessionURLAsync(GetDASHStreamingSessionURLPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetDASHStreamingSessionURLOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task<GetHLSStreamingSessionURLOutput> GetHLSStreamingSessionURLAsync(GetHLSStreamingSessionURLPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetHLSStreamingSessionURLOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>Success</returns>
		public async Task<GetImagesOutput> GetImagesAsync(string MaxResults, string NextToken, GetImagesPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "getImages?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetImagesOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task<GetMediaForFragmentListOutput> GetMediaForFragmentListAsync(GetMediaForFragmentListPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetMediaForFragmentListOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		public async Task<ListFragmentsOutput> ListFragmentsAsync(string MaxResults, string NextToken, ListFragmentsPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "listFragments?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListFragmentsOutput>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
	...
	public class GetClipPostBody
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public GetClipPostBodyClipFragmentSelector ClipFragmentSelector { get; set; }
	}
	
	public class GetClipPostBodyClipFragmentSelector
	{
	...
	public class GetDASHStreamingSessionURLPostBody
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember()]
		public GetDASHStreamingSessionURLPostBodyDASHFragmentSelector DASHFragmentSelector { get; set; }
	...
	public class GetDASHStreamingSessionURLPostBodyDASHFragmentSelector
	{
	...
	public class GetHLSStreamingSessionURLPostBody
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember()]
		public GetHLSStreamingSessionURLPostBodyHLSFragmentSelector HLSFragmentSelector { get; set; }
	...
	public class GetHLSStreamingSessionURLPostBodyHLSFragmentSelector
	{
	...
	public class GetImagesPostBody
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember()]
		public System.Collections.Generic.Dictionary<string, string> FormatConfig { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember()]
		[System.ComponentModel.DataAnnotations.Range(1, 3840)]
		public System.Nullable<System.Int32> WidthPixels { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember()]
		[System.ComponentModel.DataAnnotations.Range(1, 2160)]
		public System.Nullable<System.Int32> HeightPixels { get; set; }
	...
	public class GetMediaForFragmentListPostBody
	{
	...
	public class ListFragmentsPostBody
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember()]
		public ListFragmentsPostBodyFragmentSelector FragmentSelector { get; set; }
	}
	
	public class ListFragmentsPostBodyFragmentSelector
	{
