	...
	public partial class Misc
	{
		...
		public async Task<CreateAppResult> CreateAppAsync(CreateAppPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<CreateAppResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// ListApps apps
		/// </summary>
		/// <param name="nextToken"> A pagination token. If non-null, the pagination token is returned in a result. Pass its value in another request to retrieve more entries. 
		/// Max length: 2000
		// </param>
		/// <param name="maxResults"> The maximum number of records to list in a single response. 
		/// Minimum: 0
		/// Maximum: 100
		// </param>
		/// <returns>Success</returns>
		public async Task<ListAppsResult> ListAppsAsync(string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAppsResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="appId"> The unique ID for an Amplify app. 
		/// Min length: 1
		/// Max length: 20
		// </param>
		/// <returns>Success</returns>
		public async Task<CreateBackendEnvironmentResult> CreateBackendEnvironmentAsync(string appId, CreateBackendEnvironmentPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateBackendEnvironmentResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="environmentName"> The name of the backend environment 
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <param name="nextToken"> A pagination token. Set to null to start listing backend environments from the start. If a non-null pagination token is returned in a result, pass its value in here to list more backend environments. 
		/// Max length: 2000
		// </param>
		/// <param name="maxResults"> The maximum number of records to list in a single response. 
		/// Minimum: 0
		...
		public async Task<ListBackendEnvironmentsResult> ListBackendEnvironmentsAsync(string appId, string environmentName, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListBackendEnvironmentsResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CreateBranchResult> CreateBranchAsync(string appId, CreateBranchPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateBranchResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="nextToken"> A pagination token. Set to null to start listing branches from the start. If a non-null pagination token is returned in a result, pass its value in here to list more branches. 
		/// Max length: 2000
		// </param>
		/// <param name="maxResults"> The maximum number of records to list in a single response. 
		/// Minimum: 0
		...
		public async Task<ListBranchesResult> ListBranchesAsync(string appId, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListBranchesResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="branchName"> The name for the branch, for the job. 
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <returns>Success</returns>
		public async Task<CreateDeploymentResult> CreateDeploymentAsync(string appId, string branchName, CreateDeploymentPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateDeploymentResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CreateDomainAssociationResult> CreateDomainAssociationAsync(string appId, CreateDomainAssociationPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateDomainAssociationResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="nextToken"> A pagination token. Set to null to start listing apps from the start. If non-null, a pagination token is returned in a result. Pass its value in here to list more projects. 
		/// Max length: 2000
		// </param>
		/// <param name="maxResults"> The maximum number of records to list in a single response. 
		/// Minimum: 0
		...
		public async Task<ListDomainAssociationsResult> ListDomainAssociationsAsync(string appId, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListDomainAssociationsResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CreateWebhookResult> CreateWebhookAsync(string appId, CreateWebhookPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateWebhookResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="nextToken"> A pagination token. Set to null to start listing webhooks from the start. If non-null,the pagination token is returned in a result. Pass its value in here to list more webhooks. 
		/// Max length: 2000
		// </param>
		/// <param name="maxResults"> The maximum number of records to list in a single response. 
		/// Minimum: 0
		...
		public async Task<ListWebhooksResult> ListWebhooksAsync(string appId, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListWebhooksResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<DeleteAppResult> DeleteAppAsync(string appId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteAppResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetAppResult> GetAppAsync(string appId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetAppResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateAppResult> UpdateAppAsync(string appId, UpdateAppPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateAppResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="appId"> The unique ID of an Amplify app. 
		/// Min length: 1
		/// Max length: 20
		// </param>
		/// <param name="environmentName"> The name of a backend environment of an Amplify app. 
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <returns>Success</returns>
		public async Task<DeleteBackendEnvironmentResult> DeleteBackendEnvironmentAsync(string appId, string environmentName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteBackendEnvironmentResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="environmentName"> The name for the backend environment. 
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <returns>Success</returns>
		public async Task<GetBackendEnvironmentResult> GetBackendEnvironmentAsync(string appId, string environmentName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetBackendEnvironmentResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="branchName"> The name for the branch. 
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <returns>Success</returns>
		public async Task<DeleteBranchResult> DeleteBranchAsync(string appId, string branchName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteBranchResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetBranchResult> GetBranchAsync(string appId, string branchName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetBranchResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateBranchResult> UpdateBranchAsync(string appId, string branchName, UpdateBranchPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateBranchResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<DeleteDomainAssociationResult> DeleteDomainAssociationAsync(string appId, string domainName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteDomainAssociationResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetDomainAssociationResult> GetDomainAssociationAsync(string appId, string domainName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetDomainAssociationResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateDomainAssociationResult> UpdateDomainAssociationAsync(string appId, string domainName, UpdateDomainAssociationPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateDomainAssociationResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 255
		// </param>
		/// <param name="jobId"> The unique ID for the job. 
		/// Max length: 255
		// </param>
		/// <returns>Success</returns>
		public async Task<DeleteJobResult> DeleteJobAsync(string appId, string branchName, string jobId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteJobResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="branchName"> The branch name for the job. 
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <param name="jobId"> The unique ID for the job. 
		...
		/// </summary>
		/// <param name="webhookId"> The unique ID for a webhook. 
		/// Max length: 255
		// </param>
		/// <returns>Success</returns>
		public async Task<DeleteWebhookResult> DeleteWebhookAsync(string webhookId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteWebhookResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetWebhookResult> GetWebhookAsync(string webhookId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetWebhookResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateWebhookResult> UpdateWebhookAsync(string webhookId, UpdateWebhookPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateWebhookResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GenerateAccessLogsResult> GenerateAccessLogsAsync(string appId, GenerateAccessLogsPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GenerateAccessLogsResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="artifactId"> The unique ID for an artifact. 
		/// Max length: 255
		// </param>
		/// <returns>Success</returns>
		public async Task<GetArtifactUrlResult> GetArtifactUrlAsync(string artifactId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetArtifactUrlResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 20
		// </param>
		/// <param name="branchName"> The name of a branch that is part of an Amplify app. 
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <param name="jobId"> The unique ID for a job. 
		/// Max length: 255
		// </param>
		/// <param name="nextToken"> A pagination token. Set to null to start listing artifacts from start. If a non-null pagination token is returned in a result, pass its value in here to list more artifacts. 
		/// Max length: 2000
		// </param>
		/// <param name="maxResults"> The maximum number of records to list in a single response. 
		/// Minimum: 0
		...
		/// Max length: 20
		// </param>
		/// <param name="branchName"> The name for a branch. 
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <param name="nextToken"> A pagination token. Set to null to start listing steps from the start. If a non-null pagination token is returned in a result, pass its value in here to list more steps. 
		/// Max length: 2000
		// </param>
		/// <param name="maxResults"> The maximum number of records to list in a single response. 
		/// Minimum: 0
		...
		public async Task<StartJobResult> StartJobAsync(string appId, string branchName, StartJobPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<StartJobResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="resourceArn"> The Amazon Resource Name (ARN) to use to list tags. 
		/// Min length: 0
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="resourceArn"> The Amazon Resource Name (ARN) to use to tag a resource. 
		/// Min length: 0
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		public async Task<StartDeploymentResult> StartDeploymentAsync(string appId, string branchName, StartDeploymentPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<StartDeploymentResult>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="resourceArn"> The Amazon Resource Name (ARN) to use to untag a resource. 
		/// Min length: 0
		/// Max length: 2048
		// </param>
		/// <param name="tagKeys"> The tag keys to use to untag a resource. 
		/// Minimum items: 1
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
