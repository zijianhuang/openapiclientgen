...
namespace MyNS
{
	...
	public class Queue
	{
		...
		/// App Engine HTTP queue. The task will be delivered to the App Engine application hostname specified by its AppEngineHttpQueue and AppEngineHttpRequest. The documentation for AppEngineHttpRequest explains how the task's host URL is constructed. Using AppEngineHttpQueue requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform`
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="appEngineHttpQueue")]
		...
		public System.Nullable<QueueType> Type { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// Cloudtasks_projects_locations_queues_tasks_delete v2beta3/{name}
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// <summary>
		/// Gets a task.
		/// Cloudtasks_projects_locations_queues_tasks_get v2beta3/{name}
		/// </summary>
		/// <param name="name">Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`</param>
		...
		{
			var requestUri = "v2beta3/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&responseView=" + responseView;
		...
		/// Cloudtasks_projects_locations_queues_patch v2beta3/{name}
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
		...
		/// Cloudtasks_projects_locations_list v2beta3/{name}/locations
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/locations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudtasks_projects_locations_queues_pause v2beta3/{name}:pause
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":pause";
		...
		/// Cloudtasks_projects_locations_queues_purge v2beta3/{name}:purge
		/// </summary>
		/// <param name="name">Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2beta3/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":purge";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_resume v2beta3/{name}:resume
		/// </summary>
		/// <param name="name">Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2beta3/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":resume";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_tasks_run v2beta3/{name}:run
		/// </summary>
		/// <param name="name">Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2beta3/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":run";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_list v2beta3/{parent}/queues
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/queues&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&readMask=" + (readMask==null? "" : System.Uri.EscapeDataString(readMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudtasks_projects_locations_queues_create v2beta3/{parent}/queues
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/queues";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_tasks_list v2beta3/{parent}/tasks
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tasks&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&responseView=" + responseView;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudtasks_projects_locations_queues_tasks_create v2beta3/{parent}/tasks
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tasks";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_tasks_buffer v2beta3/{queue}/tasks/{taskId}:buffer
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (queue==null? "" : System.Uri.EscapeDataString(queue))+"/tasks/"+ (taskId==null? "" : System.Uri.EscapeDataString(taskId))+":buffer";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_getIamPolicy v2beta3/{resource}:getIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":getIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_setIamPolicy v2beta3/{resource}:setIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":setIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_testIamPermissions v2beta3/{resource}:testIamPermissions
		/// </summary>
		...
		{
			var requestUri = "v2beta3/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":testIamPermissions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
