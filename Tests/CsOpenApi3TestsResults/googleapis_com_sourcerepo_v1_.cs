...
namespace MyNS
{
	...
	public class Repo
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="mirrorConfig")]
		public MirrorConfig MirrorConfig { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pubsubConfigs")]
		public System.Collections.Generic.Dictionary<string, PubsubConfig> PubsubConfigs { get; set; }
	...
	public class MirrorConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="deployKeyId")]
	...
	public class PubsubConfig
	{
		...
		public System.Nullable<PubsubConfigMessageFormat> MessageFormat { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum PubsubConfigMessageFormat
	{
	...
	public class ProjectConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="enablePrivateKeyCheck")]
		public System.Nullable<System.Boolean> EnablePrivateKeyCheck { get; set; }
	...
	public partial class Misc
	{
		...
		/// <summary>
		/// Deletes a repo.
		/// Sourcerepo_projects_repos_delete v1/{name}
		/// </summary>
		/// <param name="name">The name of the repo to delete. Values are of the form `projects//repos/`.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Sourcerepo_projects_repos_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sourcerepo_projects_repos_get v1/{name}
		/// </summary>
		/// <param name="name">The name of the requested repository. Values are of the form `projects//repos/`.</param>
		/// <returns>Successful response</returns>
		public async Task<Repo> Sourcerepo_projects_repos_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Repo>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Sourcerepo_projects_repos_patch v1/{name}
		/// </summary>
		/// <param name="name">The name of the requested repository. Values are of the form `projects//repos/`.</param>
		/// <returns>Successful response</returns>
		public async Task<Repo> Sourcerepo_projects_repos_patchAsync(string name, UpdateRepoRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// Sourcerepo_projects_getConfig v1/{name}/config
		/// </summary>
		/// <param name="name">The name of the requested project. Values are of the form `projects/`.</param>
		/// <returns>Successful response</returns>
		public async Task<ProjectConfig> Sourcerepo_projects_getConfigAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/config";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ProjectConfig>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Sourcerepo_projects_updateConfig v1/{name}/config
		/// </summary>
		/// <param name="name">The name of the requested project. Values are of the form `projects/`.</param>
		/// <returns>Successful response</returns>
		public async Task<ProjectConfig> Sourcerepo_projects_updateConfigAsync(string name, UpdateProjectConfigRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/config";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
		...
		/// Sourcerepo_projects_repos_list v1/{name}/repos
		/// </summary>
		/// <param name="name">The project ID whose repos should be listed. Values are of the form `projects/`.</param>
		/// <param name="pageSize">Maximum number of repositories to return; between 1 and 500. If not set or zero, defaults to 100 at the server.</param>
		/// <param name="pageToken">Resume listing repositories where a prior ListReposResponse left off. This is an opaque token that must be obtained from a recent, prior ListReposResponse's next_page_token field.</param>
		/// <returns>Successful response</returns>
		public async Task<ListReposResponse> Sourcerepo_projects_repos_listAsync(string name, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/repos&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListReposResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Sourcerepo_projects_repos_sync v1/{name}:sync
		/// </summary>
		/// <param name="name">The name of the repo to synchronize. Values are of the form `projects//repos/`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Sourcerepo_projects_repos_syncAsync(string name, SyncRepoRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":sync";
		...
		/// Sourcerepo_projects_repos_create v1/{parent}/repos
		/// </summary>
		/// <param name="parent">The project in which to create the repo. Values are of the form `projects/`.</param>
		/// <returns>Successful response</returns>
		public async Task<Repo> Sourcerepo_projects_repos_createAsync(string parent, Repo requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/repos";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Sourcerepo_projects_repos_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Sourcerepo_projects_repos_getIamPolicyAsync(string resource, int options_requestedPolicyVersion, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sourcerepo_projects_repos_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Sourcerepo_projects_repos_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sourcerepo_projects_repos_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Sourcerepo_projects_repos_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
