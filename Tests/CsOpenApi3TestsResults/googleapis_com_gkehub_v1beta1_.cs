...
namespace MyNS
{
	...
	public class GenerateExclusivityManifestResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="crManifest")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="crdManifest")]
	...
	public partial class Misc
	{
		...
		/// Gkehub_projects_locations_operations_delete v1beta1/{name}
		/// </summary>
		...
		public async Task<Empty> Gkehub_projects_locations_operations_deleteAsync(string name, bool force, string requestId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Gkehub_projects_locations_operations_get v1beta1/{name}
		/// </summary>
		...
		/// Gkehub_projects_locations_memberships_patch v1beta1/{name}
		/// </summary>
		/// <param name="name">Required. The membership resource name in the format: `projects/[project_id]/locations/global/memberships/[membership_id]`</param>
		/// <param name="requestId">Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).</param>
		/// <param name="updateMask">Required. Mask of fields to update. At least one field path must be specified in this mask.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Gkehub_projects_locations_memberships_patchAsync(string name, string requestId, string updateMask, Membership requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Gkehub_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// Gkehub_projects_locations_operations_list v1beta1/{name}/operations
		/// </summary>
		...
		/// Gkehub_projects_locations_operations_cancel v1beta1/{name}:cancel
		/// </summary>
		...
		/// Gkehub_projects_locations_memberships_generateConnectManifest v1beta1/{name}:generateConnectManifest
		/// </summary>
		...
		/// <param name="connectAgent_name">Do not set.</param>
		/// <param name="connectAgent_namespace">Optional. Namespace for GKE Connect agent resources. Defaults to `gke-connect`. The Connect Agent is authorized automatically when run in the default namespace. Otherwise, explicit authorization must be granted with an additional IAM binding.</param>
		/// <param name="connectAgent_proxy">Optional. URI of a proxy if connectivity from the agent to gkeconnect.googleapis.com requires the use of a proxy. Format must be in the form `http(s)://{proxy_address}`, depending on the HTTP/HTTPS protocol supported by the proxy. This will direct the connect agent's outbound traffic through a HTTP(S) proxy.</param>
		...
		/// <returns>Successful response</returns>
		public async Task<GenerateConnectManifestResponse> Gkehub_projects_locations_memberships_generateConnectManifestAsync(string name, string connectAgent_name, string connectAgent_namespace, string connectAgent_proxy, string imagePullSecretContent, bool isUpgrade, string registry, string version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":generateConnectManifest&connectAgent.name=" + (connectAgent_name==null? "" : System.Uri.EscapeDataString(connectAgent_name))+"&connectAgent.namespace=" + (connectAgent_namespace==null? "" : System.Uri.EscapeDataString(connectAgent_namespace))+"&connectAgent.proxy=" + (connectAgent_proxy==null? "" : System.Uri.EscapeDataString(connectAgent_proxy))+"&imagePullSecretContent=" + (imagePullSecretContent==null? "" : System.Uri.EscapeDataString(imagePullSecretContent))+"&isUpgrade="+isUpgrade+"&registry=" + (registry==null? "" : System.Uri.EscapeDataString(registry))+"&version=" + (version==null? "" : System.Uri.EscapeDataString(version));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Gkehub_projects_locations_memberships_generateExclusivityManifest v1beta1/{name}:generateExclusivityManifest
		/// </summary>
		/// <param name="name">Required. The Membership resource name in the format `projects/*/locations/*/memberships/*`.</param>
		/// <param name="crManifest">Optional. The YAML manifest of the membership CR retrieved by `kubectl get memberships membership`. Leave empty if the resource does not exist.</param>
		/// <param name="crdManifest">Optional. The YAML manifest of the membership CRD retrieved by `kubectl get customresourcedefinitions membership`. Leave empty if the resource does not exist.</param>
		/// <returns>Successful response</returns>
		public async Task<GenerateExclusivityManifestResponse> Gkehub_projects_locations_memberships_generateExclusivityManifestAsync(string name, string crManifest, string crdManifest, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":generateExclusivityManifest&crManifest=" + (crManifest==null? "" : System.Uri.EscapeDataString(crManifest))+"&crdManifest=" + (crdManifest==null? "" : System.Uri.EscapeDataString(crdManifest));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GenerateExclusivityManifestResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Gkehub_projects_locations_memberships_list v1beta1/{parent}/memberships
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/memberships&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Gkehub_projects_locations_memberships_create v1beta1/{parent}/memberships
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/memberships&membershipId=" + (membershipId==null? "" : System.Uri.EscapeDataString(membershipId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Gkehub_projects_locations_memberships_validateExclusivity v1beta1/{parent}/memberships:validateExclusivity
		/// </summary>
		/// <param name="parent">Required. The parent (project and location) where the Memberships will be created. Specified in the format `projects/*/locations/*`.</param>
		/// <param name="crManifest">Optional. The YAML of the membership CR in the cluster. Empty if the membership CR does not exist.</param>
		/// <param name="intendedMembership">Required. The intended membership name under the `parent`. This method only does validation in anticipation of a CreateMembership call with the same name.</param>
		/// <returns>Successful response</returns>
		public async Task<ValidateExclusivityResponse> Gkehub_projects_locations_memberships_validateExclusivityAsync(string parent, string crManifest, string intendedMembership, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/memberships:validateExclusivity&crManifest=" + (crManifest==null? "" : System.Uri.EscapeDataString(crManifest))+"&intendedMembership=" + (intendedMembership==null? "" : System.Uri.EscapeDataString(intendedMembership));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ValidateExclusivityResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Gkehub_projects_locations_memberships_getIamPolicy v1beta1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Gkehub_projects_locations_memberships_setIamPolicy v1beta1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Gkehub_projects_locations_memberships_testIamPermissions v1beta1/{resource}:testIamPermissions
		/// </summary>
