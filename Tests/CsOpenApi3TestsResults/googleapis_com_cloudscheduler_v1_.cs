...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// <summary>
		/// Deletes a job.
		/// Cloudscheduler_projects_locations_jobs_delete v1/{name}
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Cloudscheduler_projects_locations_jobs_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// Gets a job.
		/// Cloudscheduler_projects_locations_jobs_get v1/{name}
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		...
		/// Cloudscheduler_projects_locations_jobs_patch v1/{name}
		/// </summary>
		...
		/// Cloudscheduler_projects_locations_list v1/{name}/locations
		/// </summary>
		...
		/// Cloudscheduler_projects_locations_jobs_pause v1/{name}:pause
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		...
		/// Cloudscheduler_projects_locations_jobs_resume v1/{name}:resume
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		...
		/// Cloudscheduler_projects_locations_jobs_run v1/{name}:run
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		...
		/// <summary>
		/// Lists jobs.
		/// Cloudscheduler_projects_locations_jobs_list v1/{parent}/jobs
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListJobsResponse> Cloudscheduler_projects_locations_jobs_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// Creates a job.
		/// Cloudscheduler_projects_locations_jobs_create v1/{parent}/jobs
		/// </summary>
		/// <param name="parent">Required. The location name. For example: `projects/PROJECT_ID/locations/LOCATION_ID`.</param>
		/// <returns>Successful response</returns>
