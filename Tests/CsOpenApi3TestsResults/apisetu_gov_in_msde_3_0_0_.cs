...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task IticrAsync(IticrPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "iticr/certificate";
	...
	public class IticrPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public IticrPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public IticrPostBodyFormat Format { get; set; }
	...
	public class IticrPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum IticrPostBodyFormat
	{
