...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Managedidentities_projects_locations_global_domains_checkMigrationPermission v1beta1/{domain}:checkMigrationPermission
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":checkMigrationPermission";
		...
		/// Managedidentities_projects_locations_global_domains_disableMigration v1beta1/{domain}:disableMigration
		/// </summary>
		/// <param name="domain">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":disableMigration";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_domainJoinMachine v1beta1/{domain}:domainJoinMachine
		/// </summary>
		/// <param name="domain">Required. The domain resource name using the form: projects/{project_id}/locations/global/domains/{domain_name}</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":domainJoinMachine";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_enableMigration v1beta1/{domain}:enableMigration
		/// </summary>
		/// <param name="domain">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":enableMigration";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_extendSchema v1beta1/{domain}:extendSchema
		/// </summary>
		/// <param name="domain">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (domain==null? "" : System.Uri.EscapeDataString(domain))+":extendSchema";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_peerings_delete v1beta1/{name}
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_peerings_get v1beta1/{name}
		/// </summary>
		/// <param name="name">Required. Peering resource name using the form: `projects/{project_id}/locations/global/peerings/{peering_id}`</param>
		...
		/// Managedidentities_projects_locations_global_peerings_patch v1beta1/{name}
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_domains_getLdapssettings v1beta1/{name}/ldapssettings
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/ldapssettings";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Managedidentities_projects_locations_global_domains_updateLdapssettings v1beta1/{name}/ldapssettings
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/ldapssettings&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_domains_attachTrust v1beta1/{name}:attachTrust
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":attachTrust";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_operations_cancel v1beta1/{name}:cancel
		/// </summary>
		...
		/// <summary>
		/// Removes an AD trust.
		/// Managedidentities_projects_locations_global_domains_detachTrust v1beta1/{name}:detachTrust
		/// </summary>
		/// <param name="name">Required. The resource domain name, project name, and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":detachTrust";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_reconfigureTrust v1beta1/{name}:reconfigureTrust
		/// </summary>
		/// <param name="name">Required. The resource domain name, project name and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":reconfigureTrust";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_resetAdminPassword v1beta1/{name}:resetAdminPassword
		/// </summary>
		/// <param name="name">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":resetAdminPassword";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_restore v1beta1/{name}:restore
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":restore";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_validateTrust v1beta1/{name}:validateTrust
		/// </summary>
		/// <param name="name">Required. The resource domain name, project name, and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":validateTrust";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_backups_list v1beta1/{parent}/backups
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/backups&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Managedidentities_projects_locations_global_domains_backups_create v1beta1/{parent}/backups
		/// </summary>
		/// <param name="parent">Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`</param>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/backups&backupId=" + (backupId==null? "" : System.Uri.EscapeDataString(backupId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_list v1beta1/{parent}/domains
		/// </summary>
		...
		/// <param name="pageToken">The `next_page_token` value returned from a previous ListDomainsRequest request, if any.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/domains&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Managedidentities_projects_locations_global_domains_create v1beta1/{parent}/domains
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/domains&domainName=" + (domainName==null? "" : System.Uri.EscapeDataString(domainName));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_peerings_list v1beta1/{parent}/peerings
		/// </summary>
		/// <param name="parent">Required. The resource name of the domain location using the form: `projects/{project_id}/locations/global`</param>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/peerings&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Managedidentities_projects_locations_global_peerings_create v1beta1/{parent}/peerings
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/peerings&peeringId=" + (peeringId==null? "" : System.Uri.EscapeDataString(peeringId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Managedidentities_projects_locations_global_domains_sqlIntegrations_list v1beta1/{parent}/sqlIntegrations
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/sqlIntegrations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Managedidentities_projects_locations_global_peerings_getIamPolicy v1beta1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_peerings_setIamPolicy v1beta1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Managedidentities_projects_locations_global_peerings_testIamPermissions v1beta1/{resource}:testIamPermissions
		/// </summary>
