...
namespace MyNS
{
	...
	public class CreateJobOutput
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<CreateJobOutputJobType> JobType { get; set; }
	...
	public partial class Misc
	{
		...
		public async Task GET_CancelJobAsync(string JobId, string APIVersion, GET_CancelJobOperation Operation, GET_CancelJobOperation Action, GET_CancelJobVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Operation=CancelJob&Action=CancelJob?JobId=" + (JobId==null? "" : System.Uri.EscapeDataString(JobId))+"&APIVersion=" + (APIVersion==null? "" : System.Uri.EscapeDataString(APIVersion))+"&Operation=" + Operation+"&Action=" + Action+"&Version=" + Version;
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_CreateJobAsync(CreateJobOutputJobType JobType, string Manifest, string ManifestAddendum, bool ValidateOnly, string APIVersion, GET_CreateJobOperation Operation, GET_CreateJobOperation Action, GET_CreateJobVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Operation=CreateJob&Action=CreateJob?JobType=" + JobType+"&Manifest=" + (Manifest==null? "" : System.Uri.EscapeDataString(Manifest))+"&ManifestAddendum=" + (ManifestAddendum==null? "" : System.Uri.EscapeDataString(ManifestAddendum))+"&ValidateOnly="+ValidateOnly+"&APIVersion=" + (APIVersion==null? "" : System.Uri.EscapeDataString(APIVersion))+"&Operation=" + Operation+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		public async Task GET_GetShippingLabelAsync(
					...
					string street3, 
					string APIVersion, 
					GET_GetShippingLabelOperation Operation, 
					GET_GetShippingLabelOperation Action, 
					GET_GetShippingLabelVersion Version, 
					Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Operation=GetShippingLabel&Action=GetShippingLabel?"+string.Join("&", jobIds.Select(z => $"jobIds={System.Uri.EscapeDataString(z.ToString())}"))+"&name=" + (name==null? "" : System.Uri.EscapeDataString(name))+"&company=" + (company==null? "" : System.Uri.EscapeDataString(company))+"&phoneNumber=" + (phoneNumber==null? "" : System.Uri.EscapeDataString(phoneNumber))+"&country=" + (country==null? "" : System.Uri.EscapeDataString(country))+"&stateOrProvince=" + (stateOrProvince==null? "" : System.Uri.EscapeDataString(stateOrProvince))+"&city=" + (city==null? "" : System.Uri.EscapeDataString(city))+"&postalCode=" + (postalCode==null? "" : System.Uri.EscapeDataString(postalCode))+"&street1=" + (street1==null? "" : System.Uri.EscapeDataString(street1))+"&street2=" + (street2==null? "" : System.Uri.EscapeDataString(street2))+"&street3=" + (street3==null? "" : System.Uri.EscapeDataString(street3))+"&APIVersion=" + (APIVersion==null? "" : System.Uri.EscapeDataString(APIVersion))+"&Operation=" + Operation+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_GetStatusAsync(string JobId, string APIVersion, GET_GetStatusOperation Operation, GET_GetStatusOperation Action, GET_GetStatusVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Operation=GetStatus&Action=GetStatus?JobId=" + (JobId==null? "" : System.Uri.EscapeDataString(JobId))+"&APIVersion=" + (APIVersion==null? "" : System.Uri.EscapeDataString(APIVersion))+"&Operation=" + Operation+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_ListJobsAsync(int MaxJobs, string Marker, string APIVersion, GET_ListJobsOperation Operation, GET_ListJobsOperation Action, GET_ListJobsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Operation=ListJobs&Action=ListJobs?MaxJobs="+MaxJobs+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&APIVersion=" + (APIVersion==null? "" : System.Uri.EscapeDataString(APIVersion))+"&Operation=" + Operation+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_UpdateJobAsync(string JobId, string Manifest, CreateJobOutputJobType JobType, bool ValidateOnly, string APIVersion, GET_UpdateJobOperation Operation, GET_UpdateJobOperation Action, GET_UpdateJobVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Operation=UpdateJob&Action=UpdateJob?JobId=" + (JobId==null? "" : System.Uri.EscapeDataString(JobId))+"&Manifest=" + (Manifest==null? "" : System.Uri.EscapeDataString(Manifest))+"&JobType=" + JobType+"&ValidateOnly="+ValidateOnly+"&APIVersion=" + (APIVersion==null? "" : System.Uri.EscapeDataString(APIVersion))+"&Operation=" + Operation+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
	...
	public enum GET_CancelJobOperation
	{
	...
	public enum GET_CancelJobVersion
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="2010-06-01")]
		_2010Minus06Minus01 = 0,
	}
	
	public enum POST_CancelJobVersion
	{
	...
	public enum GET_CreateJobOperation
	{
	...
	public enum GET_CreateJobVersion
	{
	...
	public enum POST_CreateJobVersion
	{
	...
	public enum GET_GetShippingLabelOperation
	{
	...
	public enum GET_GetShippingLabelVersion
	{
	...
	public enum POST_GetShippingLabelVersion
	{
	...
	public enum GET_GetStatusOperation
	{
	...
	public enum GET_GetStatusVersion
	{
	...
	public enum POST_GetStatusVersion
	{
	...
	public enum GET_ListJobsOperation
	{
	...
	public enum GET_ListJobsVersion
	{
	...
	public enum POST_ListJobsVersion
	{
	...
	public enum GET_UpdateJobOperation
	{
	...
	public enum GET_UpdateJobVersion
	{
	...
	public enum POST_UpdateJobVersion
	{
