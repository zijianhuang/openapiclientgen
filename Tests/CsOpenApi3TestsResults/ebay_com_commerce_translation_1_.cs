...
namespace MyNS
{
	...
	public class TranslateRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="translationContext")]
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <returns>OK</returns>
		public async Task<TranslateResponse> TranslateAsync(TranslateRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<TranslateResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
