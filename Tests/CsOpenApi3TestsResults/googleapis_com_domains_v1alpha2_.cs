...
namespace MyNS
{
	...
	public class ConfigureContactSettingsRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="contactNotices")]
		public string[] ContactNotices { get; set; }
		
		/// <summary>
		/// Defines the contact information associated with a `Registration`. [ICANN](https://icann.org/) requires all domain names to have associated contact information. The `registrant_contact` is considered the domain's legal owner, and often the other contacts are identical.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="contactSettings")]
	...
	public class ContactSettings
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="adminContact")]
		...
		public System.Nullable<ContactSettingsPrivacy> Privacy { get; set; }
		
		/// <summary>
		/// Details required for a contact associated with a `Registration`.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="registrantContact")]
		public Contact RegistrantContact { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class ConfigureDnsSettingsRequest
	{
	...
	public class DnsSettings
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="customDns")]
		public CustomDns CustomDns { get; set; }
		
		/// <summary>
		/// The list of glue records for this `Registration`. Commonly empty.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="glueRecords")]
		public GlueRecord[] GlueRecords { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="googleDomainsDns")]
		public GoogleDomainsDns GoogleDomainsDns { get; set; }
	}
	...
	public class CustomDns
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="dsRecords")]
		public DsRecord[] DsRecords { get; set; }
	...
	public class DsRecord
	{
		...
		public System.Nullable<DsRecordAlgorithm> Algorithm { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="digestType")]
		public System.Nullable<DsRecordDigestType> DigestType { get; set; }
	...
	public class GoogleDomainsDns
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="dsState")]
		public System.Nullable<GoogleDomainsDnsDsState> DsState { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class ConfigureManagementSettingsRequest
	{
		
		/// <summary>
		/// Defines renewal, billing, and transfer settings for a `Registration`.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="managementSettings")]
	...
	public class ManagementSettings
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="preferredRenewalMethod")]
		public System.Nullable<ManagementSettingsPreferredRenewalMethod> PreferredRenewalMethod { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="renewalMethod")]
		public ManagementSettingsPreferredRenewalMethod RenewalMethod { get; set; }
		
		/// <summary>
		/// Controls whether the domain can be transferred to another registrar.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="transferLockState")]
		public System.Nullable<ManagementSettingsTransferLockState> TransferLockState { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum ManagementSettingsPreferredRenewalMethod
	{
	...
	public class Domain
	{
		...
		public System.Nullable<DomainResourceState> ResourceState { get; set; }
		
		/// <summary>
		/// Represents an amount of money with its currency type.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="yearlyPrice")]
		public Money YearlyPrice { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum DomainResourceState
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class ExportRegistrationRequest
	{
	}
	...
	public class Registration
	{
		...
		/// Defines the contact information associated with a `Registration`. [ICANN](https://icann.org/) requires all domain names to have associated contact information. The `registrant_contact` is considered the domain's legal owner, and often the other contacts are identical.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pendingContactSettings")]
		public ContactSettings PendingContactSettings { get; set; }
		
		/// <summary>
		/// Output only. The reason the domain registration failed. Only set for domains in REGISTRATION_FAILED state.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="registerFailureReason")]
		public System.Nullable<RegistrationRegisterFailureReason> RegisterFailureReason { get; set; }
		
		/// <summary>
		/// Output only. The state of the `Registration`
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="state")]
		public System.Nullable<RegistrationState> State { get; set; }
		
		/// <summary>
		/// Output only. Set of options for the `contact_settings.privacy` field that this `Registration` supports.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="supportedPrivacy")]
		public ContactSettingsPrivacy[] SupportedPrivacy { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="transferFailureReason")]
		public System.Nullable<RegistrationTransferFailureReason> TransferFailureReason { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum RegistrationRegisterFailureReason
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum RegistrationTransferFailureReason
	{
	...
	public class RegisterDomainRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="domainNotices")]
	...
	public class RegisterParameters
	{
		...
		public System.Nullable<RegisterParametersAvailability> Availability { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum RegisterParametersAvailability
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class ResetAuthorizationCodeRequest
	{
	}
	...
	public class RetrieveRegisterParametersResponse
	{
		...
		/// Parameters required to register a new domain.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="registerParameters")]
		public RegisterParameters RegisterParameters { get; set; }
	}
	...
	public class RetrieveTransferParametersResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="transferParameters")]
	...
	public class TransferParameters
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="currentRegistrar")]
		public string CurrentRegistrar { get; set; }
		
		/// <summary>
		/// The URL of the registrar that currently manages the domain.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="currentRegistrarUri")]
		public string CurrentRegistrarUri { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="transferLockState")]
		public ManagementSettingsTransferLockState TransferLockState { get; set; }
	...
	public partial class Misc
	{
		...
		/// Domains_projects_locations_registrations_retrieveImportableDomains v1alpha2/{location}/registrations:retrieveImportableDomains
		/// </summary>
		...
		/// <param name="pageToken">When set to the `next_page_token` from a prior response, provides the next page of results.</param>
		/// <returns>Successful response</returns>
		public async Task<RetrieveImportableDomainsResponse> Domains_projects_locations_registrations_retrieveImportableDomainsAsync(string location, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/registrations:retrieveImportableDomains&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<RetrieveImportableDomainsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Domains_projects_locations_registrations_retrieveRegisterParameters v1alpha2/{location}/registrations:retrieveRegisterParameters
		/// </summary>
		/// <param name="location">Required. The location. Must be in the format `projects/*/locations/*`.</param>
		/// <param name="domainName">Required. The domain name. Unicode domain names must be expressed in Punycode format.</param>
		/// <returns>Successful response</returns>
		public async Task<RetrieveRegisterParametersResponse> Domains_projects_locations_registrations_retrieveRegisterParametersAsync(string location, string domainName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/registrations:retrieveRegisterParameters&domainName=" + (domainName==null? "" : System.Uri.EscapeDataString(domainName));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<RetrieveRegisterParametersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Domains_projects_locations_registrations_retrieveTransferParameters v1alpha2/{location}/registrations:retrieveTransferParameters
		/// </summary>
		/// <param name="location">Required. The location. Must be in the format `projects/*/locations/*`.</param>
		/// <param name="domainName">Required. The domain name. Unicode domain names must be expressed in Punycode format.</param>
		/// <returns>Successful response</returns>
		public async Task<RetrieveTransferParametersResponse> Domains_projects_locations_registrations_retrieveTransferParametersAsync(string location, string domainName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/registrations:retrieveTransferParameters&domainName=" + (domainName==null? "" : System.Uri.EscapeDataString(domainName));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<RetrieveTransferParametersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Domains_projects_locations_registrations_searchDomains v1alpha2/{location}/registrations:searchDomains
		/// </summary>
		/// <param name="location">Required. The location. Must be in the format `projects/*/locations/*`.</param>
		/// <param name="query">Required. String used to search for available domain names.</param>
		/// <returns>Successful response</returns>
		public async Task<SearchDomainsResponse> Domains_projects_locations_registrations_searchDomainsAsync(string location, string query, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (location==null? "" : System.Uri.EscapeDataString(location))+"/registrations:searchDomains&query=" + (query==null? "" : System.Uri.EscapeDataString(query));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SearchDomainsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Domains_projects_locations_registrations_delete v1alpha2/{name}
		/// </summary>
		/// <param name="name">Required. The name of the `Registration` to delete, in the format `projects/*/locations/*/registrations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Domains_projects_locations_registrations_get v1alpha2/{name}
		/// </summary>
		/// <param name="name">Required. The name of the `Registration` to get, in the format `projects/*/locations/*/registrations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Registration> Domains_projects_locations_registrations_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (name==null? "" : System.Uri.EscapeDataString(name));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_patch v1alpha2/{name}
		/// </summary>
		/// <param name="name">Output only. Name of the `Registration` resource, in the format `projects/*/locations/*/registrations/`.</param>
		/// <param name="updateMask">Required. The field mask describing which fields to update as a comma-separated list. For example, if only the labels are being updated, the `update_mask` is `"labels"`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_patchAsync(string name, string updateMask, Registration requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Domains_projects_locations_list v1alpha2/{name}/locations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListLocationsResponse> Domains_projects_locations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Domains_projects_locations_operations_list v1alpha2/{name}/operations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Domains_projects_locations_operations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Domains_projects_locations_registrations_export v1alpha2/{name}:export
		/// </summary>
		/// <param name="name">Required. The name of the `Registration` to export, in the format `projects/*/locations/*/registrations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_exportAsync(string name, ExportRegistrationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":export";
		...
		/// Domains_projects_locations_registrations_list v1alpha2/{parent}/registrations
		/// </summary>
		/// <param name="parent">Required. The project and location from which to list `Registration`s, specified in the format `projects/*/locations/*`.</param>
		/// <param name="filter">Filter expression to restrict the `Registration`s returned. The expression must specify the field name, a comparison operator, and the value that you want to use for filtering. The value must be a string, a number, a boolean, or an enum value. The comparison operator should be one of =, !=, >, <, >=, <=, or : for prefix or wildcard matches. For example, to filter to a specific domain name, use an expression like `domainName="example.com"`. You can also check for the existence of a field; for example, to find domains using custom DNS settings, use an expression like `dnsSettings.customDns:*`. You can also create compound filters by combining expressions with the `AND` and `OR` operators. For example, to find domains that are suspended or have specific issues flagged, use an expression like `(state=SUSPENDED) OR (issue:*)`.</param>
		/// <param name="pageSize">Maximum number of results to return.</param>
		/// <param name="pageToken">When set to the `next_page_token` from a prior response, provides the next page of results.</param>
		/// <returns>Successful response</returns>
		public async Task<ListRegistrationsResponse> Domains_projects_locations_registrations_listAsync(string parent, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/registrations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListRegistrationsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Domains_projects_locations_registrations_import v1alpha2/{parent}/registrations:import
		/// </summary>
		/// <param name="parent">Required. The parent resource of the Registration. Must be in the format `projects/*/locations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_importAsync(string parent, ImportDomainRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/registrations:import";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_register v1alpha2/{parent}/registrations:register
		/// </summary>
		/// <param name="parent">Required. The parent resource of the `Registration`. Must be in the format `projects/*/locations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_registerAsync(string parent, RegisterDomainRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/registrations:register";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_transfer v1alpha2/{parent}/registrations:transfer
		/// </summary>
		/// <param name="parent">Required. The parent resource of the `Registration`. Must be in the format `projects/*/locations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_transferAsync(string parent, TransferDomainRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/registrations:transfer";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_configureContactSettings v1alpha2/{registration}:configureContactSettings
		/// </summary>
		/// <param name="registration">Required. The name of the `Registration` whose contact settings are being updated, in the format `projects/*/locations/*/registrations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_configureContactSettingsAsync(string registration, ConfigureContactSettingsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":configureContactSettings";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_configureDnsSettings v1alpha2/{registration}:configureDnsSettings
		/// </summary>
		/// <param name="registration">Required. The name of the `Registration` whose DNS settings are being updated, in the format `projects/*/locations/*/registrations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_configureDnsSettingsAsync(string registration, ConfigureDnsSettingsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":configureDnsSettings";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_configureManagementSettings v1alpha2/{registration}:configureManagementSettings
		/// </summary>
		/// <param name="registration">Required. The name of the `Registration` whose management settings are being updated, in the format `projects/*/locations/*/registrations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Domains_projects_locations_registrations_configureManagementSettingsAsync(string registration, ConfigureManagementSettingsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":configureManagementSettings";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Domains_projects_locations_registrations_resetAuthorizationCode v1alpha2/{registration}:resetAuthorizationCode
		/// </summary>
		/// <param name="registration">Required. The name of the `Registration` whose authorization code is being reset, in the format `projects/*/locations/*/registrations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<AuthorizationCode> Domains_projects_locations_registrations_resetAuthorizationCodeAsync(string registration, ResetAuthorizationCodeRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":resetAuthorizationCode";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AuthorizationCode>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Domains_projects_locations_registrations_retrieveAuthorizationCode v1alpha2/{registration}:retrieveAuthorizationCode
		/// </summary>
		/// <param name="registration">Required. The name of the `Registration` whose authorization code is being retrieved, in the format `projects/*/locations/*/registrations/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<AuthorizationCode> Domains_projects_locations_registrations_retrieveAuthorizationCodeAsync(string registration, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha2/"+ (registration==null? "" : System.Uri.EscapeDataString(registration))+":retrieveAuthorizationCode";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Domains_projects_locations_registrations_getIamPolicy v1alpha2/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Domains_projects_locations_registrations_getIamPolicyAsync(string resource, int options_requestedPolicyVersion, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Domains_projects_locations_registrations_setIamPolicy v1alpha2/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Domains_projects_locations_registrations_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Domains_projects_locations_registrations_testIamPermissions v1alpha2/{resource}:testIamPermissions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Domains_projects_locations_registrations_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
