...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// <param name="Port">The port on which the load balancer is listening. You cannot specify a port for a Gateway Load Balancer.
		/// Minimum: 1
		/// Maximum: 65535
		// </param>
		...
		/// <param name="Tags">The tags to assign to the listener.
		/// Minimum items: 1
		// </param>
		/// <returns>Success</returns>
		...
		/// <param name="Tags">The tags to assign to the load balancer.
		/// Minimum items: 1
		// </param>
		...
		/// <param name="CustomerOwnedIpv4Pool">[Application Load Balancers on Outposts] The ID of the customer-owned address pool (CoIP pool).
		/// Max length: 256
		// </param>
		/// <returns>Success</returns>
		...
		/// <param name="Priority">The rule priority. A listener can't have multiple rules with the same priority.
		/// Minimum: 1
		/// Maximum: 50000
		// </param>
		/// <param name="Actions">The actions.</param>
		/// <param name="Tags">The tags to assign to the rule.
		/// Minimum items: 1
		// </param>
		/// <returns>Success</returns>
		...
		/// <param name="Port">The port on which the targets receive traffic. This port is used unless you specify a port override when registering the target. If the target is a Lambda function, this parameter does not apply. If the protocol is GENEVE, the supported port is 6081.
		/// Minimum: 1
		/// Maximum: 65535
		// </param>
		...
		/// <param name="Tags">The tags to assign to the target group.
		/// Minimum items: 1
		// </param>
		...
		/// </summary>
		/// <param name="ListenerArn">The Amazon Resource Name (ARN) of the listener.</param>
		/// <param name="Port">The port for connections from clients to the load balancer. You cannot specify a port for a Gateway Load Balancer.
		/// Minimum: 1
		/// Maximum: 65535
		// </param>
		...
		/// </summary>
		/// <param name="LoadBalancerArn">The Amazon Resource Name (ARN) of the load balancer.</param>
		/// <param name="Attributes">The load balancer attributes.
		/// Maximum items: 20
		// </param>
		/// <returns>Success</returns>
		...
		/// <param name="HealthCheckIntervalSeconds">The approximate amount of time, in seconds, between health checks of an individual target.
		/// Minimum: 5
		/// Maximum: 300
		// </param>
		/// <param name="HealthCheckTimeoutSeconds">[HTTP/HTTPS health checks] The amount of time, in seconds, during which no response means a failed health check.
		/// Minimum: 2
		/// Maximum: 120
		// </param>
		/// <param name="HealthyThresholdCount">The number of consecutive health checks successes required before considering an unhealthy target healthy.
		/// Minimum: 2
		/// Maximum: 10
		// </param>
		/// <param name="UnhealthyThresholdCount">The number of consecutive health check failures required before considering the target unhealthy.
		/// Minimum: 2
		/// Maximum: 10
		// </param>
		/// <param name="Matcher">[HTTP/HTTPS health checks] The HTTP or gRPC codes to use when checking for a successful response from a target. For target groups with a protocol of TCP, TCP_UDP, UDP or TLS the range is 200-599. For target groups with a protocol of HTTP or HTTPS, the range is 200-499. For target groups with a protocol of GENEVE, the range is 200-399.</param>
