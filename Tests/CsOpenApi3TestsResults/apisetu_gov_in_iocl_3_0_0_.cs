...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task LpgsvAsync(LpgsvPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "lpgsv/certificate";
		...
		/// Lpgtv lpgtv/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task LpgtvAsync(LpgtvPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "lpgtv/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public class LpgsvPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public LpgsvPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public LpgsvPostBodyFormat Format { get; set; }
	...
	public class LpgsvPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum LpgsvPostBodyFormat
	{
	...
	public class LpgtvPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public LpgtvPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class LpgtvPostBodyCertificateParameters
	{
