...
namespace MyNS
{
	...
	public class GoogleSearchIdeahubV1betaIdea
	{
		...
		public GoogleSearchIdeahubV1betaTopic[] Topics { get; set; }
	}
	...
	public class GoogleSearchIdeahubV1betaIdeaActivity
	{
		...
		public System.Nullable<GoogleSearchIdeahubV1betaIdeaActivityType> Type { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleSearchIdeahubV1betaIdeaActivityType
	{
	...
	public class GoogleSearchIdeahubV1betaListAvailableLocalesResponse
	{
		...
		public GoogleSearchIdeahubV1betaAvailableLocale[] AvailableLocales { get; set; }
	...
	public class GoogleSearchIdeahubV1betaListIdeasResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="ideas")]
		public GoogleSearchIdeahubV1betaIdea[] Ideas { get; set; }
	...
	public partial class Misc
	{
		...
		/// Ideahub_platforms_properties_topicStates_patch v1beta/{name}
		/// </summary>
		...
		public async Task<GoogleSearchIdeahubV1betaTopicState> Ideahub_platforms_properties_topicStates_patchAsync(string name, string updateMask, GoogleSearchIdeahubV1betaTopicState requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GoogleSearchIdeahubV1betaTopicState>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Ideahub_platforms_properties_ideaActivities_create v1beta/{parent}/ideaActivities
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleSearchIdeahubV1betaIdeaActivity> Ideahub_platforms_properties_ideaActivities_createAsync(string parent, GoogleSearchIdeahubV1betaIdeaActivity requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/ideaActivities";
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleSearchIdeahubV1betaIdeaActivity>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Ideahub_platforms_properties_ideas_list v1beta/{parent}/ideas
		/// </summary>
		/// <param name="parent">Required. If defined, specifies the creator for which to filter by. Format: publishers/{publisher}/properties/{property}</param>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleSearchIdeahubV1betaListIdeasResponse> Ideahub_platforms_properties_ideas_listAsync(string parent, string filter, string orderBy, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/ideas&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleSearchIdeahubV1betaListIdeasResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Ideahub_platforms_properties_locales_list v1beta/{parent}/locales
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleSearchIdeahubV1betaListAvailableLocalesResponse> Ideahub_platforms_properties_locales_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/locales&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleSearchIdeahubV1betaListAvailableLocalesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
