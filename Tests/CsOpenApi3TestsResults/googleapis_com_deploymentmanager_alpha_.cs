...
namespace MyNS
{
	...
	public class CollectionOverride
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="methodMap")]
	...
	public class MethodMap
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="setIamPolicy")]
		public string SetIamPolicy { get; set; }
	...
	public class Options
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="nameProperty")]
	...
	public class Deployment
	{
		...
		public DeploymentOutputEntry[] Outputs { get; set; }
	...
	public class Resource
	{
		...
		/// The credential used by Deployment Manager and TypeProvider. Only one of the options is permitted.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="lastUsedCredential")]
		public Credential LastUsedCredential { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="runtimePolicies")]
		public string[] RuntimePolicies { get; set; }
	...
	public partial class Misc
	{
		...
		/// Deploymentmanager_compositeTypes_list deploymentmanager/alpha/projects/{project}/global/compositeTypes
		/// </summary>
		...
		public async Task<CompositeTypesListResponse> Deploymentmanager_compositeTypes_listAsync(string project, string filter, int maxResults, string orderBy, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<CompositeTypesListResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Deploymentmanager_compositeTypes_insert deploymentmanager/alpha/projects/{project}/global/compositeTypes
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/compositeTypes";
		...
		/// Deploymentmanager_compositeTypes_delete deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/compositeTypes/"+ (compositeType==null? "" : System.Uri.EscapeDataString(compositeType));
		...
		/// Deploymentmanager_compositeTypes_get deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		...
		public async Task<CompositeType> Deploymentmanager_compositeTypes_getAsync(string project, string compositeType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CompositeType>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_compositeTypes_patch deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="compositeType">The name of the composite type for this request.</param>
		/// <returns>Successful response</returns>
		...
		/// Deploymentmanager_compositeTypes_update deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="compositeType">The name of the composite type for this request.</param>
		/// <returns>Successful response</returns>
		...
		/// Deploymentmanager_deployments_list deploymentmanager/alpha/projects/{project}/global/deployments
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="filter">A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.</param>
		/// <param name="maxResults">The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxResults="+maxResults+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeploymentsListResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_deployments_insert deploymentmanager/alpha/projects/{project}/global/deployments
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments&createPolicy=" + createPolicy+"&preview="+preview;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Deploymentmanager_deployments_delete deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"&deletePolicy=" + deletePolicy;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Deploymentmanager_deployments_get deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Deployment>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_deployments_patch deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		/// <param name="createPolicy">Sets the policy to use for creating new resources.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"&createPolicy=" + createPolicy+"&deletePolicy=" + deletePolicy+"&preview="+preview;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Deploymentmanager_deployments_update deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		/// <param name="createPolicy">Sets the policy to use for creating new resources.</param>
		...
		/// Deploymentmanager_deployments_cancelPreview deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/cancelPreview
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"/cancelPreview";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Deploymentmanager_manifests_list deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		/// <param name="filter">A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"/manifests&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxResults="+maxResults+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ManifestsListResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_manifests_get deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests/{manifest}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"/manifests/"+ (manifest==null? "" : System.Uri.EscapeDataString(manifest));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Deploymentmanager_resources_list deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		/// <param name="filter">A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"/resources&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxResults="+maxResults+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ResourcesListResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_resources_get deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources/{resource}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"/resources/"+ (resource==null? "" : System.Uri.EscapeDataString(resource));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Resource>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_deployments_stop deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/stop
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="deployment">The name of the deployment for this request.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"/stop";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Deploymentmanager_deployments_getIamPolicy deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/getIamPolicy
		/// </summary>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+"/getIamPolicy&optionsRequestedPolicyVersion="+optionsRequestedPolicyVersion;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Deploymentmanager_deployments_setIamPolicy deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/setIamPolicy
		/// </summary>
		/// <param name="project">Project ID for this request.</param>
		/// <param name="resource">Name or id of the resource for this request.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+"/setIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Deploymentmanager_deployments_testIamPermissions deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/testIamPermissions
		/// </summary>
		/// <param name="project">Project ID for this request.</param>
		/// <param name="resource">Name or id of the resource for this request.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/deployments/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+"/testIamPermissions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TestPermissionsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_operations_list deploymentmanager/alpha/projects/{project}/global/operations
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="filter">A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.</param>
		/// <param name="maxResults">The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/operations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxResults="+maxResults+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Deploymentmanager_operations_get deploymentmanager/alpha/projects/{project}/global/operations/{operation}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/operations/"+ (operation==null? "" : System.Uri.EscapeDataString(operation));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Deploymentmanager_typeProviders_list deploymentmanager/alpha/projects/{project}/global/typeProviders
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="filter">A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.</param>
		/// <param name="maxResults">The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/typeProviders&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxResults="+maxResults+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TypeProvidersListResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_typeProviders_insert deploymentmanager/alpha/projects/{project}/global/typeProviders
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/typeProviders";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Deploymentmanager_typeProviders_delete deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/typeProviders/"+ (typeProvider==null? "" : System.Uri.EscapeDataString(typeProvider));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Deploymentmanager_typeProviders_get deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="typeProvider">The name of the type provider for this request.</param>
		/// <returns>Successful response</returns>
		public async Task<TypeProvider> Deploymentmanager_typeProviders_getAsync(string project, string typeProvider, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TypeProvider>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_typeProviders_patch deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="typeProvider">The name of the type provider for this request.</param>
		/// <returns>Successful response</returns>
		...
		/// Deploymentmanager_typeProviders_update deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="typeProvider">The name of the type provider for this request.</param>
		/// <returns>Successful response</returns>
		...
		/// Deploymentmanager_typeProviders_listTypes deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}/types
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="typeProvider">The name of the type provider for this request.</param>
		/// <param name="filter">A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/typeProviders/"+ (typeProvider==null? "" : System.Uri.EscapeDataString(typeProvider))+"/types&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxResults="+maxResults+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TypeProvidersListTypesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_typeProviders_getType deploymentmanager/alpha/projects/{project}/global/typeProviders/{typeProvider}/types/{type}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="typeProvider">The name of the type provider for this request.</param>
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/typeProviders/"+ (typeProvider==null? "" : System.Uri.EscapeDataString(typeProvider))+"/types/"+ (type==null? "" : System.Uri.EscapeDataString(type));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TypeInfo>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_types_list deploymentmanager/alpha/projects/{project}/global/types
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="filter">A filter expression that filters resources listed in the response. Most Compute resources support two types of filter expressions: expressions that support regular expressions and expressions that follow API improvement proposal AIP-160. These two types of filter expressions cannot be mixed in one request. If you want to use AIP-160, your expression must specify the field name, an operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The operator must be either `=`, `!=`, `>`, `<`, `<=`, `>=` or `:`. For example, if you are filtering Compute Engine instances, you can exclude instances named `example-instance` by specifying `name != example-instance`. The `:*` comparison can be used to test whether a key has been defined. For example, to find all objects with `owner` label use: ``` labels.owner:* ``` You can also filter nested fields. For example, you could specify `scheduling.automaticRestart = false` to include instances only if they are not scheduled for automatic restarts. You can use filtering on nested fields to filter based on resource labels. To filter on multiple expressions, provide each separate expression within parentheses. For example: ``` (scheduling.automaticRestart = true) (cpuPlatform = "Intel Skylake") ``` By default, each expression is an `AND` expression. However, you can include `AND` and `OR` expressions explicitly. For example: ``` (cpuPlatform = "Intel Skylake") OR (cpuPlatform = "Intel Broadwell") AND (scheduling.automaticRestart = true) ``` If you want to use a regular expression, use the `eq` (equal) or `ne` (not equal) operator against a single un-parenthesized expression with or without quotes or against multiple parenthesized expressions. Examples: `fieldname eq unquoted literal` `fieldname eq 'single quoted literal'` `fieldname eq "double quoted literal"` `(fieldname1 eq literal) (fieldname2 ne "literal")` The literal value is interpreted as a regular expression using Google RE2 library syntax. The literal value must match the entire field. For example, to filter for instances that do not end with name "instance", you would use `name ne .*instance`. You cannot combine constraints on multiple fields using regular expressions.</param>
		/// <param name="maxResults">The maximum number of results per page that should be returned. If the number of available results is larger than `maxResults`, Compute Engine returns a `nextPageToken` that can be used to get the next page of results in subsequent list requests. Acceptable values are `0` to `500`, inclusive. (Default: `500`)
		...
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/types&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&maxResults="+maxResults+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TypesListResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Deploymentmanager_types_get deploymentmanager/alpha/projects/{project}/global/types/{type}
		/// </summary>
		/// <param name="project">The project ID for this request.</param>
		/// <param name="type">The name of the type for this request.</param>
		/// <returns>Successful response</returns>
		public async Task<Type> Deploymentmanager_types_getAsync(string project, string type, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "deploymentmanager/alpha/projects/"+ (project==null? "" : System.Uri.EscapeDataString(project))+"/global/types/"+ (type==null? "" : System.Uri.EscapeDataString(type));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Type>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
