...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// ProjectedPlayerSeasonStatsWithAdp {format}/PlayerSeasonProjectionStats/{season}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season.
		///<br>Examples: <code>2017</code>, <code>2018</code>.</param>
		public async Task<PlayerSeasonProjection[]> ProjectedPlayerSeasonStatsWithAdpAsync(DepthChartsFormat format, string season, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
