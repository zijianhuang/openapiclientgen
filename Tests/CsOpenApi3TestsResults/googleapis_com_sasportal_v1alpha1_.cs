...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Sasportal_customers_list v1alpha1/customers
		/// </summary>
		...
		public async Task<SasPortalListCustomersResponse> Sasportal_customers_listAsync(int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_customers_checkHasProvisionedDeployment v1alpha1/customers:checkHasProvisionedDeployment
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalCheckHasProvisionedDeploymentResponse> Sasportal_customers_checkHasProvisionedDeploymentAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_customers_listLegacyOrganizations v1alpha1/customers:listLegacyOrganizations
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalListLegacyOrganizationsResponse> Sasportal_customers_listLegacyOrganizationsAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_customers_migrateOrganization v1alpha1/customers:migrateOrganization
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalOperation> Sasportal_customers_migrateOrganizationAsync(SasPortalMigrateOrganizationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_customers_provisionDeployment v1alpha1/customers:provisionDeployment
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalProvisionDeploymentResponse> Sasportal_customers_provisionDeploymentAsync(SasPortalProvisionDeploymentRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_customers_setupSasAnalytics v1alpha1/customers:setupSasAnalytics
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalOperation> Sasportal_customers_setupSasAnalyticsAsync(SasPortalSetupSasAnalyticsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_installer_generateSecret v1alpha1/installer:generateSecret
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalGenerateSecretResponse> Sasportal_installer_generateSecretAsync(SasPortalGenerateSecretRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_installer_validate v1alpha1/installer:validate
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalValidateInstallerResponse> Sasportal_installer_validateAsync(SasPortalValidateInstallerRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_policies_get v1alpha1/policies:get
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalPolicy> Sasportal_policies_getAsync(SasPortalGetPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_policies_set v1alpha1/policies:set
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalPolicy> Sasportal_policies_setAsync(SasPortalSetPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_policies_test v1alpha1/policies:test
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SasPortalTestPermissionsResponse> Sasportal_policies_testAsync(SasPortalTestPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// Deletes a node.
		/// Sasportal_nodes_nodes_delete v1alpha1/{name}
		/// </summary>
		/// <param name="name">Required. The name of the node.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalEmpty> Sasportal_nodes_nodes_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_nodes_nodes_get v1alpha1/{name}
		/// </summary>
		/// <param name="name">Required. The name of the node.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalNode> Sasportal_nodes_nodes_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// Sasportal_nodes_nodes_patch v1alpha1/{name}
		/// </summary>
		/// <param name="name">Output only. Resource name.</param>
		/// <param name="updateMask">Fields to be updated.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalNode> Sasportal_nodes_nodes_patchAsync(string name, string updateMask, SasPortalNode requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_nodes_nodes_move v1alpha1/{name}:move
		/// </summary>
		/// <param name="name">Required. The name of the node to move.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalOperation> Sasportal_nodes_nodes_moveAsync(string name, SasPortalMoveNodeRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// Signs a device.
		/// Sasportal_nodes_devices_signDevice v1alpha1/{name}:signDevice
		/// </summary>
		/// <param name="name">Output only. The resource path name.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalEmpty> Sasportal_nodes_devices_signDeviceAsync(string name, SasPortalSignDeviceRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_nodes_devices_updateSigned v1alpha1/{name}:updateSigned
		/// </summary>
		/// <param name="name">Required. The name of the device to update.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalDevice> Sasportal_nodes_devices_updateSignedAsync(string name, SasPortalUpdateSignedDeviceRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// Lists deployments.
		/// Sasportal_nodes_nodes_deployments_list v1alpha1/{parent}/deployments
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<SasPortalListDeploymentsResponse> Sasportal_nodes_nodes_deployments_listAsync(string parent, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_nodes_nodes_deployments_create v1alpha1/{parent}/deployments
		/// </summary>
		/// <param name="parent">Required. The parent resource name where the deployment is to be created.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalDeployment> Sasportal_nodes_nodes_deployments_createAsync(string parent, SasPortalDeployment requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_nodes_nodes_devices_list v1alpha1/{parent}/devices
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<SasPortalListDevicesResponse> Sasportal_nodes_nodes_devices_listAsync(string parent, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_nodes_nodes_devices_create v1alpha1/{parent}/devices
		/// </summary>
		/// <param name="parent">Required. The name of the parent resource.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalDevice> Sasportal_nodes_nodes_devices_createAsync(string parent, SasPortalDevice requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Sasportal_nodes_nodes_devices_createSigned v1alpha1/{parent}/devices:createSigned
		/// </summary>
		/// <param name="parent">Required. The name of the parent resource.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalDevice> Sasportal_nodes_nodes_devices_createSignedAsync(string parent, SasPortalCreateSignedDeviceRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// Lists nodes.
		/// Sasportal_nodes_nodes_nodes_list v1alpha1/{parent}/nodes
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<SasPortalListNodesResponse> Sasportal_nodes_nodes_nodes_listAsync(string parent, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <summary>
		/// Creates a new node.
		/// Sasportal_nodes_nodes_nodes_create v1alpha1/{parent}/nodes
		/// </summary>
		/// <param name="parent">Required. The parent resource name where the node is to be created.</param>
		/// <returns>Successful response</returns>
		public async Task<SasPortalNode> Sasportal_nodes_nodes_nodes_createAsync(string parent, SasPortalNode requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
