...
namespace MyNS
{
	...
	public class ChannelDetails
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="isGlobalMaster")]
	...
	public class Occupancy
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="presenceConnections")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="presenceMembers")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="presenceSubscribers")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="publishers")]
	...
	public class DeviceDetails
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="deviceSecret")]
		...
		public System.Nullable<DeviceDetailsFormFactor> FormFactor { get; set; }
		...
		public System.Nullable<DeviceDetailsPlatform> Platform { get; set; }
		
		/// <summary>
		/// Push recipient details for a device.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="push.recipient")]
		public Recipient Push_recipient { get; set; }
		
		/// <summary>
		/// the current state of the push device.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="push.state")]
		public System.Nullable<DeviceDetailsPush_state> Push_state { get; set; }
	}
	...
	public class Recipient
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="registrationToken")]
		...
		public System.Nullable<RecipientTransportType> TransportType { get; set; }
	}
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum DeviceDetailsPush_state
	{
	...
	public class Notification
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="collapseKey")]
	...
	public class PresenceMessage
	{
		...
		public System.Nullable<PresenceMessageAction> Action { get; set; }
	...
	public partial class Misc
	{
		...
		public async Task GetMetadataOfAllChannelsAsync(int limit, string prefix, GetMetadataOfAllChannelsBy by, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "channels?limit="+limit+"&prefix=" + (prefix==null? "" : System.Uri.EscapeDataString(prefix))+"&by=" + by;
		...
		{
			var requestUri = "channels/"+ (channel_id==null? "" : System.Uri.EscapeDataString(channel_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				...
				return JsonSerializer.Deserialize<ChannelDetails>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="channel_id">The [Channel's ID](https://www.ably.io/documentation/rest/channels).</param>
		public async Task GetMessagesByChannelAsync(string channel_id, string start, int limit, string end, GetMessagesByChannelDirection direction, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "channels/"+ (channel_id==null? "" : System.Uri.EscapeDataString(channel_id))+"/messages&start=" + (start==null? "" : System.Uri.EscapeDataString(start))+"&limit="+limit+"&end=" + (end==null? "" : System.Uri.EscapeDataString(end))+"&direction=" + direction;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		{
			var requestUri = "channels/"+ (channel_id==null? "" : System.Uri.EscapeDataString(channel_id))+"/messages";
		...
		{
			var requestUri = "channels/"+ (channel_id==null? "" : System.Uri.EscapeDataString(channel_id))+"/presence&clientId=" + (clientId==null? "" : System.Uri.EscapeDataString(clientId))+"&connectionId=" + (connectionId==null? "" : System.Uri.EscapeDataString(connectionId))+"&limit="+limit;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PresenceMessage[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="channel_id">The [Channel's ID](https://www.ably.io/documentation/rest/channels).</param>
		public async Task GetPresenceHistoryOfChannelAsync(string channel_id, string start, int limit, string end, GetMessagesByChannelDirection direction, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "channels/"+ (channel_id==null? "" : System.Uri.EscapeDataString(channel_id))+"/presence/history&start=" + (start==null? "" : System.Uri.EscapeDataString(start))+"&limit="+limit+"&end=" + (end==null? "" : System.Uri.EscapeDataString(end))+"&direction=" + direction;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		public async Task RequestAccessTokenAsync(string keyName, TokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "keys/"+ (keyName==null? "" : System.Uri.EscapeDataString(keyName))+"/requestToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		{
			var requestUri = "push/channelSubscriptions?channel=" + (channel==null? "" : System.Uri.EscapeDataString(channel))+"&deviceId=" + (deviceId==null? "" : System.Uri.EscapeDataString(deviceId))+"&clientId=" + (clientId==null? "" : System.Uri.EscapeDataString(clientId));
		...
		/// <param name="limit">The maximum number of records to return.
		/// Maximum: 1000
		// </param>
		...
		{
			var requestUri = "push/channelSubscriptions?channel=" + (channel==null? "" : System.Uri.EscapeDataString(channel))+"&deviceId=" + (deviceId==null? "" : System.Uri.EscapeDataString(deviceId))+"&clientId=" + (clientId==null? "" : System.Uri.EscapeDataString(clientId))+"&limit="+limit;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		public async Task SubscribePushDeviceToChannelAsync(SubscribePushDeviceToChannelPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		{
			var requestUri = "push/deviceRegistrations?deviceId=" + (deviceId==null? "" : System.Uri.EscapeDataString(deviceId))+"&clientId=" + (clientId==null? "" : System.Uri.EscapeDataString(clientId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		{
			var requestUri = "push/deviceRegistrations?deviceId=" + (deviceId==null? "" : System.Uri.EscapeDataString(deviceId))+"&clientId=" + (clientId==null? "" : System.Uri.EscapeDataString(clientId))+"&limit="+limit;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		{
			var requestUri = "push/deviceRegistrations/"+ (device_id==null? "" : System.Uri.EscapeDataString(device_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// PatchPushDeviceDetails push/deviceRegistrations/{device_id}
		/// </summary>
		/// <param name="device_id">Device's ID.</param>
		public async Task PatchPushDeviceDetailsAsync(string device_id, DeviceDetails requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "push/deviceRegistrations/"+ (device_id==null? "" : System.Uri.EscapeDataString(device_id));
		...
		{
			var requestUri = "push/deviceRegistrations/"+ (device_id==null? "" : System.Uri.EscapeDataString(device_id))+"/resetUpdateToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		public async Task PublishPushNotificationToDevicesAsync(PublishPushNotificationToDevicesPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task GetStatsAsync(string start, int limit, string end, GetMessagesByChannelDirection direction, GetStatsUnit unit, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "stats?start=" + (start==null? "" : System.Uri.EscapeDataString(start))+"&limit="+limit+"&end=" + (end==null? "" : System.Uri.EscapeDataString(end))+"&direction=" + direction+"&unit=" + unit;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
	...
	public enum GetMetadataOfAllChannelsBy
	{
	...
	public enum GetMessagesByChannelDirection
	{
	...
	public class SubscribePushDeviceToChannelPostBody
	{
	...
	public class PublishPushNotificationToDevicesPostBody
	{
