...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<QueryForecastResponse> QueryForecastAsync(QueryForecastRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<QueryForecastResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// QueryWhatIfForecast #X-Amz-Target=AmazonForecastRuntime.QueryWhatIfForecast
		/// </summary>
		/// <returns>Success</returns>
		public async Task<QueryWhatIfForecastResponse> QueryWhatIfForecastAsync(QueryWhatIfForecastRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=AmazonForecastRuntime.QueryWhatIfForecast";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<QueryWhatIfForecastResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
	...
	public enum QueryForecastX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AmazonForecastRuntime.QueryForecast")]
		AmazonForecastRuntime_QueryForecast = 0,
	}
	
	public enum QueryWhatIfForecastX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="AmazonForecastRuntime.QueryWhatIfForecast")]
		AmazonForecastRuntime_QueryWhatIfForecast = 0,
	}
}
