...
namespace MyNS
{
	...
	public class MembershipFeatureSpec
	{
		...
		public MembershipSpec Cloudbuild { get; set; }
	...
	public class MembershipSpec
	{
		...
		public System.Nullable<MembershipSpecSecurityPolicy> SecurityPolicy { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum MembershipSpecSecurityPolicy
	{
	...
	public partial class Misc
	{
		...
		/// Gkehub_projects_locations_scopes_rbacrolebindings_delete v1beta/{name}
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&force="+force+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
		...
		/// Gkehub_projects_locations_scopes_rbacrolebindings_get v1beta/{name}
		/// </summary>
		/// <param name="name">Required. The RBACRoleBinding resource name in the format `projects/*/locations/*/scopes/*/rbacrolebindings/*`.</param>
		/// <returns>Successful response</returns>
		...
		/// Gkehub_projects_locations_scopes_rbacrolebindings_patch v1beta/{name}
		/// </summary>
		...
		/// Gkehub_projects_locations_list v1beta/{name}/locations
		/// </summary>
		...
		/// Gkehub_projects_locations_operations_list v1beta/{name}/operations
		/// </summary>
		...
		/// Gkehub_projects_locations_operations_cancel v1beta/{name}:cancel
		/// </summary>
		...
		/// Gkehub_projects_locations_memberships_generateConnectManifest v1beta/{name}:generateConnectManifest
		/// </summary>
		...
		/// Gkehub_projects_locations_memberships_bindings_list v1beta/{parent}/bindings
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/bindings&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Gkehub_projects_locations_memberships_bindings_create v1beta/{parent}/bindings
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/bindings&membershipBindingId=" + (membershipBindingId==null? "" : System.Uri.EscapeDataString(membershipBindingId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Gkehub_projects_locations_features_list v1beta/{parent}/features
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/features&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Adds a new Feature.
		/// Gkehub_projects_locations_features_create v1beta/{parent}/features
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/features&featureId=" + (featureId==null? "" : System.Uri.EscapeDataString(featureId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Gkehub_projects_locations_fleets_list v1beta/{parent}/fleets
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/fleets&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Creates a fleet.
		/// Gkehub_projects_locations_fleets_create v1beta/{parent}/fleets
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/fleets";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Gkehub_projects_locations_memberships_list v1beta/{parent}/memberships
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/memberships&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Gkehub_projects_locations_memberships_create v1beta/{parent}/memberships
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/memberships&membershipId=" + (membershipId==null? "" : System.Uri.EscapeDataString(membershipId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Gkehub_projects_locations_scopes_namespaces_list v1beta/{parent}/namespaces
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/namespaces&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Gkehub_projects_locations_scopes_namespaces_create v1beta/{parent}/namespaces
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/namespaces&scopeNamespaceId=" + (scopeNamespaceId==null? "" : System.Uri.EscapeDataString(scopeNamespaceId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Gkehub_projects_locations_scopes_rbacrolebindings_list v1beta/{parent}/rbacrolebindings
		/// </summary>
		/// <param name="parent">Required. The parent (project and location) where the Features will be listed. Specified in the format `projects/*/locations/*/scopes/*`.</param>
		/// <param name="pageSize">Optional. When requesting a 'page' of resources, `page_size` specifies number of resources to return. If unspecified or set to 0, all resources will be returned.</param>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/rbacrolebindings&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Gkehub_projects_locations_scopes_rbacrolebindings_create v1beta/{parent}/rbacrolebindings
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/rbacrolebindings&rbacrolebindingId=" + (rbacrolebindingId==null? "" : System.Uri.EscapeDataString(rbacrolebindingId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAML v1beta/{parent}/rbacrolebindings:generateMembershipRBACRoleBindingYAML
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/rbacrolebindings:generateMembershipRBACRoleBindingYAML&rbacrolebindingId=" + (rbacrolebindingId==null? "" : System.Uri.EscapeDataString(rbacrolebindingId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Lists Scopes.
		/// Gkehub_projects_locations_scopes_list v1beta/{parent}/scopes
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/scopes&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Creates a Scope.
		/// Gkehub_projects_locations_scopes_create v1beta/{parent}/scopes
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/scopes&scopeId=" + (scopeId==null? "" : System.Uri.EscapeDataString(scopeId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Gkehub_projects_locations_scopes_getIamPolicy v1beta/{resource}:getIamPolicy
		/// </summary>
		...
		/// Gkehub_projects_locations_scopes_setIamPolicy v1beta/{resource}:setIamPolicy
		/// </summary>
		...
		/// Gkehub_projects_locations_scopes_testIamPermissions v1beta/{resource}:testIamPermissions
		/// </summary>
