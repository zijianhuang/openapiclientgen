...
namespace MyNS
{
	...
	public class IpReputation
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="numIps")]
		public string NumIps { get; set; }
	...
	public partial class Misc
	{
		...
		/// Gmailpostmastertools_domains_list v1beta1/domains
		/// </summary>
		...
		{
			var requestUri = "v1beta1/domains?pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
		...
		/// Gmailpostmastertools_domains_trafficStats_get v1beta1/{name}
		/// </summary>
		...
		public async Task<TrafficStats> Gmailpostmastertools_domains_trafficStats_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TrafficStats>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Gmailpostmastertools_domains_trafficStats_list v1beta1/{parent}/trafficStats
		/// </summary>
		...
		public async Task<ListTrafficStatsResponse> Gmailpostmastertools_domains_trafficStats_listAsync(string parent, int endDate_day, int endDate_month, int endDate_year, int pageSize, string pageToken, int startDate_day, int startDate_month, int startDate_year, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListTrafficStatsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
