	...
	public partial class Misc
	{
		...
		public async Task<Notifyv1credential> FetchCredentialAsync(string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Notifyv1credential>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="ServiceSid">The SID of the [Service](https://www.twilio.com/docs/notify/api/service-resource) to read the resource from.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		public async Task<ListBindingReturn> ListBindingAsync(string ServiceSid, System.DateOnly StartDate, System.DateOnly EndDate, string[] Identity, string[] Tag, int PageSize, int Page, string PageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListBindingReturn>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="ServiceSid">The SID of the [Service](https://www.twilio.com/docs/notify/api/service-resource) to delete the resource from.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Binding resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="ServiceSid">The SID of the [Service](https://www.twilio.com/docs/notify/api/service-resource) to fetch the resource from.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Binding resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Notifyv1servicebinding> FetchBindingAsync(string ServiceSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Notifyv1servicebinding>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<Notifyv1service> FetchServiceAsync(string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Notifyv1service>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
