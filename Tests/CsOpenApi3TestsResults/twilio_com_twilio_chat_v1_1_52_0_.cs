...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Credential resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Credential resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Chatv1credential> FetchCredentialAsync(string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Chatv1credential>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="ServiceSid">The SID of the [Service](https://www.twilio.com/docs/api/chat/rest/services) to read the resources from.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="ServiceSid">The SID of the [Service](https://www.twilio.com/docs/api/chat/rest/services) to delete the resource from.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Invite resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="ServiceSid">The SID of the [Service](https://www.twilio.com/docs/api/chat/rest/services) to fetch the resource from.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Invite resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Chatv1servicechannelinvite> FetchInviteAsync(string ServiceSid, string ChannelSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Chatv1servicechannelinvite>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Member resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Member resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Chatv1servicechannelmember> FetchMemberAsync(string ServiceSid, string ChannelSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Chatv1servicechannelmember>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 34
		// </param>
		/// <param name="ChannelSid">The unique ID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the message to read belongs to. Can be the Channel's `sid` or `unique_name`.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// Max length: 34
		// </param>
		/// <param name="ChannelSid">The unique ID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the message to delete belongs to.  Can be the Channel resource's `sid` or `unique_name`.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Message resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// Max length: 34
		// </param>
		/// <param name="ChannelSid">The unique ID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the message to fetch belongs to. Can be the Channel's `sid` or `unique_name`.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Message resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Chatv1servicechannelmessage> FetchMessageAsync(string ServiceSid, string ChannelSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Chatv1servicechannelmessage>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<Chatv1servicechannel> FetchChannelAsync(string ServiceSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Chatv1servicechannel>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 34
		// </param>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Role resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// Max length: 34
		// </param>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Role resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Chatv1servicerole> FetchRoleAsync(string ServiceSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Chatv1servicerole>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<Chatv1serviceuser> FetchUserAsync(string ServiceSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Chatv1serviceuser>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="Sid">The Twilio-provided string that uniquely identifies the Service resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Chatv1service> FetchServiceAsync(string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Chatv1service>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
