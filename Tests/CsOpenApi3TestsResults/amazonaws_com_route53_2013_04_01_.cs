...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="HostedZoneId">A unique string used to identify a hosted zone.
		/// Max length: 32
		// </param>
		/// <param name="Name">A string used to identify a key-signing key (KSK). <code>Name</code> can include numbers, letters, and underscores (_). <code>Name</code> must be unique for each key-signing key in the same hosted zone.
		/// Min length: 3
		/// Max length: 128
		// </param>
		...
		/// <param name="nexttoken"><p>An opaque pagination token to indicate where the service is to begin enumerating results.</p> <p>If no value is provided, the listing of results starts from the beginning.</p>
		/// Max length: 1024
		// </param>
		...
		/// <param name="ResourceId">The ID of the resource for which you want to retrieve tags.
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// <param name="delegationsetid">If you're using reusable delegation sets and you want to list all of the hosted zones that are associated with a reusable delegation set, specify the ID of that reusable delegation set. 
		/// Max length: 32
		// </param>
		/// <param name="MaxItems">Pagination limit</param>
		/// <param name="Marker">Pagination token</param>
		...
		/// </summary>
		/// <param name="Id">The ID of the hosted zone for which you want a list of VPCs that can be associated with the hosted zone.
		/// Max length: 32
		// </param>
		...
		/// Max length: 32
		// </param>
		/// <param name="Name">A string used to identify a key-signing key (KSK).
		/// Min length: 3
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="HealthCheckId">The ID of the health check that you want to delete.
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="HealthCheckId">The identifier that Amazon Route 53 assigned to the health check when you created it. When you add or update a resource record set, you use this value to specify which health check to use. The value can be up to 64 characters long.
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the hosted zone you want to delete.
		/// Max length: 32
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the hosted zone that you want to get information about.
		/// Max length: 32
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the configuration that you want to delete. 
		/// Min length: 1
		/// Max length: 36
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the configuration for DNS query logging that you want to get information about.
		/// Min length: 1
		/// Max length: 36
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the reusable delegation set that you want to delete.
		/// Max length: 32
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the reusable delegation set that you want to get a list of name servers for.
		/// Max length: 32
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the traffic policy that you want to delete.
		/// Min length: 1
		/// Max length: 36
		// </param>
		/// <param name="Version">The version number of the traffic policy that you want to delete.
		/// Minimum: 1
		/// Maximum: 1000
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the traffic policy that you want to get information about.
		/// Min length: 1
		/// Max length: 36
		// </param>
		/// <param name="Version">The version number of the traffic policy that you want to get information about.
		/// Minimum: 1
		/// Maximum: 1000
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id"><p>The ID of the traffic policy instance that you want to delete. </p> <important> <p>When you delete a traffic policy instance, Amazon Route 53 also deletes all of the resource record sets that were created when you created the traffic policy instance.</p> </important>
		/// Min length: 1
		/// Max length: 36
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the traffic policy instance that you want to get information about.
		/// Min length: 1
		/// Max length: 36
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">A unique string used to identify a hosted zone.
		/// Max length: 32
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Id">The ID of the change batch request. The value that you specify here is the value that <code>ChangeResourceRecordSets</code> returned in the <code>Id</code> element when you submitted the request.
		/// Min length: 1
		/// Max length: 6500
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 2
		// </param>
		/// <param name="countrycode">Amazon Route 53 uses the two-letter country codes that are specified in <a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO standard 3166-1 alpha-2</a>.
		/// Min length: 1
		/// Max length: 2
		// </param>
		...
		/// <param name="Id">The ID of the hosted zone that you want to get a limit for.
		/// Max length: 32
		// </param>
		/// <returns>Success</returns>
		...
		/// <param name="Id">The ID of the delegation set that you want to get the limit for.
		/// Max length: 32
		// </param>
		/// <returns>Success</returns>
		...
		/// <param name="location">The name of the CIDR collection location.
		/// Min length: 1
		/// Max length: 16
		// </param>
		/// <param name="nexttoken">An opaque pagination token to indicate where the service is to begin enumerating results.
		/// Max length: 1024
		// </param>
		...
		/// </summary>
		/// <param name="vpcid">The ID of the Amazon VPC that you want to list hosted zones for.
		/// Max length: 1024
		// </param>
		/// <param name="vpcregion">For the Amazon VPC that you specified for <code>VPCId</code>, the Amazon Web Services Region that you created the VPC in. 
		/// Min length: 1
		/// Max length: 64
		// </param>
		...
		/// </summary>
		/// <param name="Id">The ID of the hosted zone that contains the resource record sets that you want to list.
		/// Max length: 32
		// </param>
		/// <param name="name">The first name in the lexicographic ordering of resource record sets that you want to list. If the specified record name doesn't exist, the results begin with the first resource record set that has a name greater than the value of <code>name</code>.
		/// Max length: 1024
		// </param>
		...
		/// </summary>
		/// <param name="id">The ID of the hosted zone that you want to list traffic policy instances for.
		/// Max length: 32
		// </param>
		...
		/// </summary>
		/// <param name="id">The ID of the traffic policy for which you want to list traffic policy instances.
		/// Min length: 1
		/// Max length: 36
		// </param>
		/// <param name="version">The version of the traffic policy for which you want to list traffic policy instances. The version must be associated with the traffic policy that is specified by <code>TrafficPolicyId</code>.
		/// Minimum: 1
		/// Maximum: 1000
		// </param>
		...
		/// </summary>
		/// <param name="Id">Specify the value of <code>Id</code> of the traffic policy for which you want to list all versions.
		/// Min length: 1
		/// Max length: 36
		// </param>
		...
		/// </summary>
		/// <param name="hostedzoneid">The ID of the hosted zone that you want Amazon Route 53 to simulate a query for.
		/// Max length: 32
		// </param>
		/// <param name="recordname">The name of the resource record set that you want Amazon Route 53 to simulate a query for.
		/// Max length: 1024
		// </param>
		/// <param name="recordtype">The type of the resource record set.</param>
		/// <param name="resolverip">If you want to simulate a request from a specific DNS resolver, specify the IP address for that resolver. If you omit this value, <code>TestDnsAnswer</code> uses the IP address of a DNS resolver in the Amazon Web Services US East (N. Virginia) Region (<code>us-east-1</code>).
		/// Max length: 45
		// </param>
		/// <param name="edns0clientsubnetip">If the resolver that you specified for resolverip supports EDNS0, specify the IPv4 or IPv6 address of a client in the applicable location, for example, <code>192.0.2.44</code> or <code>2001:db8:85a3::8a2e:370:7334</code>.
		/// Max length: 45
		// </param>
