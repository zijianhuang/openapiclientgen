...
namespace MyNS
{
	...
	public class AppEngineHttpTarget
	{
		...
		public System.Nullable<AppEngineHttpTargetHttpMethod> HttpMethod { get; set; }
	...
	public class HttpTarget
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="httpMethod")]
		public AppEngineHttpTargetHttpMethod HttpMethod { get; set; }
	...
	public class Job
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="attemptDeadline")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="legacyAppEngineCron")]
		public System.Nullable<System.Boolean> LegacyAppEngineCron { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pubsubTarget")]
		public PubsubTarget PubsubTarget { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="userUpdateTime")]
	...
	public class RetryConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maxBackoffDuration")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="minBackoffDuration")]
	...
	public partial class Misc
	{
		...
		/// <summary>
		/// Deletes a job.
		/// Cloudscheduler_projects_locations_jobs_delete v1beta1/{name}
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <param name="legacyAppEngineCron">This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the job in the __cron queue with the corresponding name will be deleted instead.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Cloudscheduler_projects_locations_jobs_deleteAsync(string name, bool legacyAppEngineCron, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&legacyAppEngineCron="+legacyAppEngineCron;
		...
		/// <summary>
		/// Gets a job.
		/// Cloudscheduler_projects_locations_jobs_get v1beta1/{name}
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Cloudscheduler_projects_locations_jobs_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudscheduler_projects_locations_jobs_patch v1beta1/{name}
		/// </summary>
		/// <param name="name">Optionally caller-specified in CreateJob, after which it becomes output only. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`. * `PROJECT_ID` can contain letters ([A-Za-z]), numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more information, see [Identifying projects](https://cloud.google.com/resource-manager/docs/creating-managing-projects#identifying_projects) * `LOCATION_ID` is the canonical ID for the job's location. The list of available locations can be obtained by calling ListLocations. For more information, see https://cloud.google.com/about/locations/. * `JOB_ID` can contain only letters ([A-Za-z]), numbers ([0-9]), hyphens (-), or underscores (_). The maximum length is 500 characters.</param>
		/// <param name="updateMask">A mask used to specify which fields of the job are being updated.</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Cloudscheduler_projects_locations_jobs_patchAsync(string name, string updateMask, Job requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudscheduler_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListLocationsResponse> Cloudscheduler_projects_locations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudscheduler_projects_locations_jobs_pause v1beta1/{name}:pause
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Cloudscheduler_projects_locations_jobs_pauseAsync(string name, PauseJobRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudscheduler_projects_locations_jobs_resume v1beta1/{name}:resume
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Cloudscheduler_projects_locations_jobs_resumeAsync(string name, ResumeJobRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudscheduler_projects_locations_jobs_run v1beta1/{name}:run
		/// </summary>
		/// <param name="name">Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Cloudscheduler_projects_locations_jobs_runAsync(string name, RunJobRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":run";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Lists jobs.
		/// Cloudscheduler_projects_locations_jobs_list v1beta1/{parent}/jobs
		/// </summary>
		/// <param name="parent">Required. The location name. For example: `projects/PROJECT_ID/locations/LOCATION_ID`.</param>
		/// <param name="filter">`filter` can be used to specify a subset of jobs. If `filter` equals `target_config="HttpConfig"`, then the http target jobs are retrieved. If `filter` equals `target_config="PubSubConfig"`, then the Pub/Sub target jobs are retrieved. If `filter` equals `labels.foo=value1 labels.foo=value2` then only jobs which are labeled with foo=value1 AND foo=value2 will be returned.</param>
		/// <param name="legacyAppEngineCron">This field is used to manage the legacy App Engine Cron jobs using the Cloud Scheduler API. If the field is set to true, the jobs in the __cron queue will be listed instead.</param>
		/// <param name="pageSize">Requested page size. The maximum page size is 500. If unspecified, the page size will be the maximum. Fewer jobs than requested might be returned, even if more jobs exist; use next_page_token to determine if more jobs exist.</param>
		/// <param name="pageToken">A token identifying a page of results the server will return. To request the first page results, page_token must be empty. To request the next page of results, page_token must be the value of next_page_token returned from the previous call to ListJobs. It is an error to switch the value of filter or order_by while iterating through pages.</param>
		/// <returns>Successful response</returns>
		public async Task<ListJobsResponse> Cloudscheduler_projects_locations_jobs_listAsync(string parent, string filter, bool legacyAppEngineCron, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/jobs&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&legacyAppEngineCron="+legacyAppEngineCron+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Creates a job.
		/// Cloudscheduler_projects_locations_jobs_create v1beta1/{parent}/jobs
		/// </summary>
		/// <param name="parent">Required. The location name. For example: `projects/PROJECT_ID/locations/LOCATION_ID`.</param>
		/// <returns>Successful response</returns>
		public async Task<Job> Cloudscheduler_projects_locations_jobs_createAsync(string parent, Job requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
