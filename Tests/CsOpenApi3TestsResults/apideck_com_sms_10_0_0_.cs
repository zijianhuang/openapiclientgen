...
namespace MyNS
{
	...
	public class Message
	{
		...
		public System.Nullable<MessageDirection> Direction { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="messaging_service_id")]
		public string Messaging_service_id { get; set; }
		
		/// <summary>
		/// The number of media files associated with the message.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="number_of_media_files")]
		public System.Nullable<System.Int32> Number_of_media_files { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="number_of_units")]
		public System.Nullable<System.Int32> Number_of_units { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public System.Nullable<MessageStatus> Status { get; set; }
	...
	public enum MessageDirection
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute(Value="outbound-call")]
		outboundMinuscall = 2,
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="outbound-reply")]
		outboundMinusreply = 3,
	...
	public class MessagePrice
	{
		...
		[System.Runtime.Serialization.DataMember(Name="per_unit")]
	...
	public partial class Misc
	{
		...
		public async Task<GetMessagesResponse> MessagesAllAsync(bool raw, string cursor, int limit, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "sms/messages?raw="+raw+"&cursor=" + (cursor==null? "" : System.Uri.EscapeDataString(cursor))+"&limit="+limit+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GetMessagesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Create Message
		/// Create Message
		/// MessagesAdd sms/messages
		/// </summary>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		public async Task MessagesAddAsync(bool raw, Message requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "sms/messages?raw="+raw;
		...
		/// Delete Message
		/// Delete Message
		/// MessagesDelete sms/messages/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <returns>Messages</returns>
		public async Task<DeleteMessageResponse> MessagesDeleteAsync(string id, bool raw, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "sms/messages/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw;
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteMessageResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Get Message
		/// Get Message
		/// MessagesOne sms/messages/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <param name="fields">The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields "name", "email" and "addresses.city". If any other fields are available, they will be excluded.</param>
		/// <returns>Messages</returns>
		public async Task<GetMessageResponse> MessagesOneAsync(string id, bool raw, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "sms/messages/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetMessageResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Update Message
		/// Update Message
		/// MessagesUpdate sms/messages/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <returns>Messages</returns>
		public async Task<UpdateMessageResponse> MessagesUpdateAsync(string id, bool raw, Message requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "sms/messages/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw;
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateMessageResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
