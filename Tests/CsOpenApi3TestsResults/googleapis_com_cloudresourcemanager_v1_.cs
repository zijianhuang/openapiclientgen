...
namespace MyNS
{
	...
	public class Constraint
	{
		...
		public BooleanConstraint BooleanConstraint { get; set; }
		
		/// <summary>
		/// The evaluation behavior of this constraint in the absence of 'Policy'.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="constraintDefault")]
		public System.Nullable<ConstraintConstraintDefault> ConstraintDefault { get; set; }
		...
		public ListConstraint ListConstraint { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum ConstraintConstraintDefault
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GetAncestryRequest
	{
	}
	...
	public class ListOrgPoliciesResponse
	{
		...
		public OrgPolicy[] Policies { get; set; }
	}
	...
	public class OrgPolicy
	{
		...
		public BooleanPolicy BooleanPolicy { get; set; }
		...
		public ListPolicy ListPolicy { get; set; }
		...
		public RestoreDefault RestoreDefault { get; set; }
	...
	public class ListPolicy
	{
		...
		public System.Nullable<ListPolicyAllValues> AllValues { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum ListPolicyAllValues
	{
	...
	public class Organization
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="lifecycleState")]
		public System.Nullable<OrganizationLifecycleState> LifecycleState { get; set; }
	...
	public partial class Misc
	{
		...
		/// Cloudresourcemanager_liens_list v1/liens
		/// </summary>
		...
		{
			var requestUri = "v1/liens?pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&parent=" + (parent==null? "" : System.Uri.EscapeDataString(parent));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<ListLiensResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Cloudresourcemanager_liens_create v1/liens
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<Lien> Cloudresourcemanager_liens_createAsync(Lien requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Lien>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudresourcemanager_organizations_search v1/organizations:search
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<SearchOrganizationsResponse> Cloudresourcemanager_organizations_searchAsync(SearchOrganizationsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/organizations:search";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SearchOrganizationsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <returns>Successful response</returns>
		public async Task<ListProjectsResponse> Cloudresourcemanager_projects_listAsync(string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudresourcemanager_projects_create v1/projects
		/// </summary>
		/// <returns>Successful response</returns>
		...
		/// Cloudresourcemanager_projects_delete v1/projects/{projectId}
		/// </summary>
		/// <param name="projectId">The Project ID (for example, `foo-bar-123`). Required.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Cloudresourcemanager_projects_deleteAsync(string projectId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects/"+ (projectId==null? "" : System.Uri.EscapeDataString(projectId));
		...
		/// Cloudresourcemanager_projects_get v1/projects/{projectId}
		/// </summary>
		/// <param name="projectId">Required. The Project ID (for example, `my-project-123`).</param>
		/// <returns>Successful response</returns>
		public async Task<Project> Cloudresourcemanager_projects_getAsync(string projectId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects/"+ (projectId==null? "" : System.Uri.EscapeDataString(projectId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_update v1/projects/{projectId}
		/// </summary>
		/// <param name="projectId">The project ID (for example, `my-project-123`). Required.</param>
		/// <returns>Successful response</returns>
		public async Task<Project> Cloudresourcemanager_projects_updateAsync(string projectId, Project requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects/"+ (projectId==null? "" : System.Uri.EscapeDataString(projectId));
		...
		/// Cloudresourcemanager_projects_getAncestry v1/projects/{projectId}:getAncestry
		/// </summary>
		/// <param name="projectId">Required. The Project ID (for example, `my-project-123`).</param>
		/// <returns>Successful response</returns>
		public async Task<GetAncestryResponse> Cloudresourcemanager_projects_getAncestryAsync(string projectId, GetAncestryRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects/"+ (projectId==null? "" : System.Uri.EscapeDataString(projectId))+":getAncestry";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetAncestryResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudresourcemanager_projects_undelete v1/projects/{projectId}:undelete
		/// </summary>
		/// <param name="projectId">Required. The project ID (for example, `foo-bar-123`).</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Cloudresourcemanager_projects_undeleteAsync(string projectId, UndeleteProjectRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects/"+ (projectId==null? "" : System.Uri.EscapeDataString(projectId))+":undelete";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_getIamPolicy v1/projects/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Cloudresourcemanager_projects_getIamPolicyAsync(string resource, GetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":getIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_setIamPolicy v1/projects/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Cloudresourcemanager_projects_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":setIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_testIamPermissions v1/projects/{resource}:testIamPermissions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Cloudresourcemanager_projects_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/projects/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":testIamPermissions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_liens_delete v1/{name}
		/// </summary>
		/// <param name="name">Required. The name/identifier of the Lien to delete.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Cloudresourcemanager_liens_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudresourcemanager_organizations_get v1/{name}
		/// </summary>
		/// <param name="name">The resource name of the Organization to fetch. This is the organization's relative path in the API, formatted as "organizations/[organizationId]". For example, "organizations/1234".</param>
		/// <returns>Successful response</returns>
		public async Task<Organization> Cloudresourcemanager_organizations_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Organization>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudresourcemanager_projects_clearOrgPolicy v1/{resource}:clearOrgPolicy
		/// </summary>
		/// <param name="resource">Name of the resource for the `Policy` to clear.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Cloudresourcemanager_projects_clearOrgPolicyAsync(string resource, ClearOrgPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":clearOrgPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_getEffectiveOrgPolicy v1/{resource}:getEffectiveOrgPolicy
		/// </summary>
		/// <param name="resource">The name of the resource to start computing the effective `Policy`.</param>
		/// <returns>Successful response</returns>
		public async Task<OrgPolicy> Cloudresourcemanager_projects_getEffectiveOrgPolicyAsync(string resource, GetEffectiveOrgPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":getEffectiveOrgPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<OrgPolicy>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudresourcemanager_organizations_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		/// <param name="resource">REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.</param>
		/// <returns>Successful response</returns>
		public async Task<Policy> Cloudresourcemanager_organizations_getIamPolicyAsync(string resource, GetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudresourcemanager_projects_getOrgPolicy v1/{resource}:getOrgPolicy
		/// </summary>
		/// <param name="resource">Name of the resource the `Policy` is set on.</param>
		/// <returns>Successful response</returns>
		public async Task<OrgPolicy> Cloudresourcemanager_projects_getOrgPolicyAsync(string resource, GetOrgPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":getOrgPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_listAvailableOrgPolicyConstraints v1/{resource}:listAvailableOrgPolicyConstraints
		/// </summary>
		/// <param name="resource">Name of the resource to list `Constraints` for.</param>
		/// <returns>Successful response</returns>
		public async Task<ListAvailableOrgPolicyConstraintsResponse> Cloudresourcemanager_projects_listAvailableOrgPolicyConstraintsAsync(string resource, ListAvailableOrgPolicyConstraintsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":listAvailableOrgPolicyConstraints";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAvailableOrgPolicyConstraintsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudresourcemanager_projects_listOrgPolicies v1/{resource}:listOrgPolicies
		/// </summary>
		/// <param name="resource">Name of the resource to list Policies for.</param>
		/// <returns>Successful response</returns>
		public async Task<ListOrgPoliciesResponse> Cloudresourcemanager_projects_listOrgPoliciesAsync(string resource, ListOrgPoliciesRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":listOrgPolicies";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListOrgPoliciesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudresourcemanager_organizations_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		/// <param name="resource">REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.</param>
		/// <returns>Successful response</returns>
		public async Task<Policy> Cloudresourcemanager_organizations_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudresourcemanager_projects_setOrgPolicy v1/{resource}:setOrgPolicy
		/// </summary>
		/// <param name="resource">Resource name of the resource to attach the `Policy`.</param>
		/// <returns>Successful response</returns>
		public async Task<OrgPolicy> Cloudresourcemanager_projects_setOrgPolicyAsync(string resource, SetOrgPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":setOrgPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_organizations_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
		/// <param name="resource">REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.</param>
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Cloudresourcemanager_organizations_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
