...
namespace MyNS
{
	...
	public class PerXdsConfig
	{
		...
		public System.Nullable<PerXdsConfigStatus> Status { get; set; }
	}
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum PerXdsConfigStatus
	{
	...
	public partial class Misc
	{
		...
		/// <summary>
		/// Trafficdirector_discovery_client_status v2/discovery:client_status
		/// </summary>
		...
		{
			var requestUri = "v2/discovery:client_status";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<ClientStatusResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
