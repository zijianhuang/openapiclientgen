...
namespace MyNS
{
	...
	public class LogicalInterface
	{
		...
		public System.Nullable<LogicalInterfaceType> Type { get; set; }
	}
	...
	public class ServerNetworkTemplate
	{
		...
		public LogicalInterface[] LogicalInterfaces { get; set; }
	...
	public partial class Misc
	{
		...
		/// Baremetalsolution_operations_delete v1/{name}
		/// </summary>
		/// <param name="name">The name of the operation resource to be deleted.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Baremetalsolution_operations_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Baremetalsolution_operations_list v1/{name}
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Baremetalsolution_operations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Baremetalsolution_operations_cancel v1/{name}:cancel
		/// </summary>
		/// <param name="name">The name of the operation resource to be cancelled.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Baremetalsolution_operations_cancelAsync(string name, CancelOperationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
