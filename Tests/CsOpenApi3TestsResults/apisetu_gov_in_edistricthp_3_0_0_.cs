...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task AecmwAsync(AecmwPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "aecmw/certificate";
		...
		/// Aemtw aemtw/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task AemtwAsync(AemtwPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "aemtw/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Agcer agcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task AgcerAsync(AgcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "agcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Alimw alimw/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task AlimwAsync(AlimwPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "alimw/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Arcmw arcmw/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task ArcmwAsync(ArcmwPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "arcmw/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Armtw armtw/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task ArmtwAsync(ArmtwPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "armtw/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Bacer bacer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task BacerAsync(BacerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "bacer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Bhcer bhcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task BhcerAsync(BhcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "bhcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Bpcrd bpcrd/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task BpcrdAsync(BpcrdPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "bpcrd/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Btcer btcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task BtcerAsync(BtcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "btcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cecer cecer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task CecerAsync(CecerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "cecer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Chcer chcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task ChcerAsync(ChcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "chcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Clcer clcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task ClcerAsync(ClcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "clcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Coprg coprg/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task CoprgAsync(CoprgPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "coprg/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dccer dccer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task DccerAsync(DccerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "dccer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dpicr dpicr/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task DpicrAsync(DpicrPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "dpicr/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Dtcer dtcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task DtcerAsync(DtcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "dtcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Ercer ercer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task ErcerAsync(ErcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ercer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Ffcer ffcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task FfcerAsync(FfcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ffcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Igcer igcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task IgcerAsync(IgcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "igcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Mnrga mnrga/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task MnrgaAsync(MnrgaPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "mnrga/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Obcer obcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task ObcerAsync(ObcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "obcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Racer racer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task RacerAsync(RacerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "racer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Rmcer rmcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task RmcerAsync(RmcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "rmcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Secer secer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task SecerAsync(SecerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "secer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Shcer shcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task ShcerAsync(ShcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "shcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Sicrd sicrd/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task SicrdAsync(SicrdPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "sicrd/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Srcer srcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task SrcerAsync(SrcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "srcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public class AecmwPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public AecmwPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public AecmwPostBodyFormat Format { get; set; }
	...
	public class AecmwPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum AecmwPostBodyFormat
	{
	...
	public class AemtwPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public AemtwPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class AemtwPostBodyCertificateParameters
	{
	...
	public class AgcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public AgcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class AgcerPostBodyCertificateParameters
	{
	...
	public class AlimwPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public AlimwPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class AlimwPostBodyCertificateParameters
	{
	...
	public class ArcmwPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public ArcmwPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class ArcmwPostBodyCertificateParameters
	{
	...
	public class ArmtwPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public ArmtwPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class ArmtwPostBodyCertificateParameters
	{
	...
	public class BacerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public BacerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class BacerPostBodyCertificateParameters
	{
	...
	public class BhcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public BhcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class BhcerPostBodyCertificateParameters
	{
	...
	public class BpcrdPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public BpcrdPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class BpcrdPostBodyCertificateParameters
	{
	...
	public class BtcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public BtcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class BtcerPostBodyCertificateParameters
	{
	...
	public class CecerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public CecerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class CecerPostBodyCertificateParameters
	{
	...
	public class ChcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public ChcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class ChcerPostBodyCertificateParameters
	{
	...
	public class ClcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public ClcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class ClcerPostBodyCertificateParameters
	{
	...
	public class CoprgPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public CoprgPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class CoprgPostBodyCertificateParameters
	{
	...
	public class DccerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public DccerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class DccerPostBodyCertificateParameters
	{
	...
	public class DpicrPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public DpicrPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class DpicrPostBodyCertificateParameters
	{
	...
	public class DtcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public DtcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class DtcerPostBodyCertificateParameters
	{
	...
	public class ErcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public ErcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class ErcerPostBodyCertificateParameters
	{
	...
	public class FfcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public FfcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class FfcerPostBodyCertificateParameters
	{
	...
	public class IgcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public IgcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class IgcerPostBodyCertificateParameters
	{
	...
	public class MnrgaPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public MnrgaPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class MnrgaPostBodyCertificateParameters
	{
	...
	public class ObcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public ObcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class ObcerPostBodyCertificateParameters
	{
	...
	public class RacerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public RacerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class RacerPostBodyCertificateParameters
	{
	...
	public class RmcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public RmcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class RmcerPostBodyCertificateParameters
	{
	...
	public class SecerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public SecerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class SecerPostBodyCertificateParameters
	{
	...
	public class ShcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public ShcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class ShcerPostBodyCertificateParameters
	{
	...
	public class SicrdPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public SicrdPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class SicrdPostBodyCertificateParameters
	{
	...
	public class SrcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public SrcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class SrcerPostBodyCertificateParameters
	{
