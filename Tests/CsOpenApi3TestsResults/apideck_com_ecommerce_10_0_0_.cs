...
namespace MyNS
{
	...
	public class EcommerceCustomer
	{
		...
		public EcommerceCustomerAddresses[] EcommerceCustomerAddresses { get; set; }
		...
		public LinkedEcommerceOrder[] Orders { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public System.Nullable<EcommerceCustomerStatus> Status { get; set; }
	...
	public class EcommerceCustomerAddresses
	{
		...
		[System.Runtime.Serialization.DataMember(Name="type")]
		public System.Nullable<EcommerceCustomerAddressesType> Type { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum EcommerceCustomerAddressesType
	{
	...
	public class LinkedEcommerceOrder
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public System.Nullable<LinkedEcommerceOrderStatus> Status { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum LinkedEcommerceOrderStatus
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum EcommerceCustomerStatus
	{
	...
	public class EcommerceOrder
	{
		...
		public EcommerceAddress Billing_address { get; set; }
		...
		public EcommerceDiscount[] Discounts { get; set; }
		
		/// <summary>
		/// Current fulfillment status of the order.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="fulfillment_status")]
		public System.Nullable<EcommerceOrderFulfillment_status> Fulfillment_status { get; set; }
		...
		public EcommerceOrderLineItem[] Line_items { get; set; }
		...
		public System.Nullable<EcommerceOrderPayment_status> Payment_status { get; set; }
		
		/// <summary>
		/// An object representing a shipping or billing address.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="shipping_address")]
		public EcommerceAddress Shipping_address { get; set; }
		
		/// <summary>
		/// Shipping cost, if any.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="shipping_cost")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public LinkedEcommerceOrderStatus Status { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum EcommerceOrderFulfillment_status
	{
	...
	public class EcommerceOrderLineItem
	{
		...
		public EcommerceOrderLineItemOptions[] EcommerceOrderLineItemOptions { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum EcommerceOrderPayment_status
	{
	...
	public class EcommerceProduct
	{
		...
		public EcommerceProductCategories[] EcommerceProductCategories { get; set; }
		...
		public EcommerceProductImages[] EcommerceProductImages { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="options")]
		public EcommerceProductOptions[] EcommerceProductOptions { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public EcommerceCustomerStatus Status { get; set; }
		...
		public EcommerceProductVariants[] EcommerceProductVariants { get; set; }
	...
	public class EcommerceProductVariants
	{
		...
		[System.Runtime.Serialization.DataMember(Name="images")]
		public EcommerceProductVariantsImages[] EcommerceProductVariantsImages { get; set; }
		...
		[System.Runtime.Serialization.DataMember(Name="options")]
		public EcommerceProductVariantsOptions[] EcommerceProductVariantsOptions { get; set; }
	...
	public class EcommerceStore
	{
		...
		/// Pattern: ^https?://
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="admin_url")]
		...
		/// Pattern: ^https?://
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="store_url")]
		[System.ComponentModel.DataAnnotations.RegularExpressionAttribute(@"^https?://")]
	...
	public partial class Misc
	{
		...
		/// List Customers
		/// List Customers
		/// CustomersAll ecommerce/customers
		/// </summary>
		...
		public async Task<GetEcommerceCustomersResponse> CustomersAllAsync(bool raw, string cursor, int limit, EcommerceCustomersFilter filter, PassThroughQuery pass_through, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ecommerce/customers?raw="+raw+"&cursor=" + (cursor==null? "" : System.Uri.EscapeDataString(cursor))+"&limit="+limit+"&filter=" + filter+"&pass_through=" + pass_through+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GetEcommerceCustomersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Get Customer
		/// Get Customer
		/// CustomersOne ecommerce/customers/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <param name="fields">The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields "name", "email" and "addresses.city". If any other fields are available, they will be excluded.</param>
		/// <returns>Customers</returns>
		public async Task<GetEcommerceCustomerResponse> CustomersOneAsync(string id, bool raw, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ecommerce/customers/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetEcommerceCustomerResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetEcommerceOrdersResponse> OrdersAllAsync(bool raw, string cursor, int limit, EcommerceOrdersFilter filter, PassThroughQuery pass_through, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ecommerce/orders?raw="+raw+"&cursor=" + (cursor==null? "" : System.Uri.EscapeDataString(cursor))+"&limit="+limit+"&filter=" + filter+"&pass_through=" + pass_through+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetEcommerceOrdersResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Get Order
		/// Get Order
		/// OrdersOne ecommerce/orders/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <param name="fields">The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields "name", "email" and "addresses.city". If any other fields are available, they will be excluded.</param>
		/// <returns>Orders</returns>
		public async Task<GetEcommerceOrderResponse> OrdersOneAsync(string id, bool raw, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ecommerce/orders/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetEcommerceOrderResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// List Products
		/// List Products
		/// ProductsAll ecommerce/products
		/// </summary>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <param name="cursor">Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response.</param>
		/// <param name="limit">Number of results to return. Minimum 1, Maximum 200, Default 20
		...
		public async Task<GetProductsResponse> ProductsAllAsync(bool raw, string cursor, int limit, PassThroughQuery pass_through, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ecommerce/products?raw="+raw+"&cursor=" + (cursor==null? "" : System.Uri.EscapeDataString(cursor))+"&limit="+limit+"&pass_through=" + pass_through+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Get Product
		/// Get Product
		/// ProductsOne ecommerce/products/{id}
		/// </summary>
		/// <param name="id">ID of the record you are acting upon.</param>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <param name="fields">The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields "name", "email" and "addresses.city". If any other fields are available, they will be excluded.</param>
		/// <returns>Products</returns>
		public async Task<GetProductResponse> ProductsOneAsync(string id, bool raw, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ecommerce/products/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Get Store
		/// Get Store
		/// StoresOne ecommerce/store
		/// </summary>
		/// <param name="raw">Include raw response. Mostly used for debugging purposes</param>
		/// <param name="fields">The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields "name", "email" and "addresses.city". If any other fields are available, they will be excluded.</param>
		/// <returns>Stores</returns>
		public async Task<GetStoreResponse> StoresOneAsync(bool raw, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "ecommerce/store?raw="+raw+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetStoreResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
