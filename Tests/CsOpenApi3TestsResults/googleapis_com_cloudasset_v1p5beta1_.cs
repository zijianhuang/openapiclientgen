...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Cloudasset_assets_list v1p5beta1/{parent}/assets
		/// </summary>
		/// <param name="parent">Required. Name of the organization or project the assets belong to. Format: "organizations/[organization-number]" (such as "organizations/123"), "projects/[project-id]" (such as "projects/my-project-id"), or "projects/[project-number]" (such as "projects/12345").</param>
		...
		public async Task<ListAssetsResponse> Cloudasset_assets_listAsync(string parent, string[] assetTypes, Cloudasset_assets_listContentType contentType, int pageSize, string pageToken, string readTime, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1p5beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/assets&"+string.Join("&", assetTypes.Select(z => $"assetTypes={System.Uri.EscapeDataString(z.ToString())}"))+"&contentType=" + contentType+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&readTime=" + (readTime==null? "" : System.Uri.EscapeDataString(readTime));
	...
	public enum Cloudasset_assets_listContentType
	{
