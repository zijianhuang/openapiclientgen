	...
	public partial class Misc
	{
		...
		public async Task<ListTrunkReturn> ListTrunkAsync(int PageSize, int Page, string PageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<ListTrunkReturn>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// </summary>
		/// <param name="Sid">The unique string that we created to identify the Trunk resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="Sid">The unique string that we created to identify the Trunk resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Trunkingv1trunk> FetchTrunkAsync(string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Trunkingv1trunk>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to read the credential lists.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="PageSize">How many resources to return in each list page. The default is 50, and the maximum is 1000.
		...
		public async Task<ListCredentialListReturn> ListCredentialListAsync(string TrunkSid, int PageSize, int Page, string PageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListCredentialListReturn>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to delete the credential list.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The unique string that we created to identify the CredentialList resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to fetch the credential list.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The unique string that we created to identify the CredentialList resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Trunkingv1trunkcredential_list> FetchCredentialListAsync(string TrunkSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Trunkingv1trunkcredential_list>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to read the IP Access Control Lists.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="PageSize">How many resources to return in each list page. The default is 50, and the maximum is 1000.
		...
		public async Task<ListIpAccessControlListReturn> ListIpAccessControlListAsync(string TrunkSid, int PageSize, int Page, string PageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListIpAccessControlListReturn>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to delete the IP Access Control List.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The unique string that we created to identify the IpAccessControlList resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to fetch the IP Access Control List.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The unique string that we created to identify the IpAccessControlList resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Trunkingv1trunkip_access_control_list> FetchIpAccessControlListAsync(string TrunkSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Trunkingv1trunkip_access_control_list>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to read the OriginationUrl.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="PageSize">How many resources to return in each list page. The default is 50, and the maximum is 1000.
		...
		public async Task<ListOriginationUrlReturn> ListOriginationUrlAsync(string TrunkSid, int PageSize, int Page, string PageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListOriginationUrlReturn>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to delete the OriginationUrl.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The unique string that we created to identify the OriginationUrl resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to fetch the OriginationUrl.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The unique string that we created to identify the OriginationUrl resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Trunkingv1trunkorigination_url> FetchOriginationUrlAsync(string TrunkSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Trunkingv1trunkorigination_url>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to read the PhoneNumber resources.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="PageSize">How many resources to return in each list page. The default is 50, and the maximum is 1000.
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to delete the PhoneNumber resource.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The unique string that we created to identify the PhoneNumber resource to delete.
		/// Min length: 34
		/// Max length: 34
		// </param>
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to fetch the PhoneNumber resource.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <param name="Sid">The unique string that we created to identify the PhoneNumber resource to fetch.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Trunkingv1trunkphone_number> FetchPhoneNumberAsync(string TrunkSid, string Sid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Trunkingv1trunkphone_number>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="TrunkSid">The SID of the Trunk from which to fetch the recording settings.
		/// Min length: 34
		/// Max length: 34
		// </param>
		/// <returns>OK</returns>
		public async Task<Trunkingv1trunkrecording> FetchRecordingAsync(string TrunkSid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Trunkingv1trunkrecording>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
