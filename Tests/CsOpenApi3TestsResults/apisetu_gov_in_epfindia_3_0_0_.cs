...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task EpfscAsync(EpfscPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "epfsc/certificate";
		...
		/// Pecer pecer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task PecerAsync(PecerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "pecer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Uncrd uncrd/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task UncrdAsync(UncrdPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "uncrd/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public class EpfscPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public EpfscPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public EpfscPostBodyFormat Format { get; set; }
	...
	public class EpfscPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum EpfscPostBodyFormat
	{
	...
	public class PecerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public PecerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class PecerPostBodyCertificateParameters
	{
	...
	public class UncrdPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public UncrdPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class UncrdPostBodyCertificateParameters
	{
