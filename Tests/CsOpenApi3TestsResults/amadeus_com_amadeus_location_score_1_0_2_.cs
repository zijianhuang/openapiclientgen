...
namespace MyNS
{
	...
	public class Category_rated_areas
	{
	}
	...
	public partial class Misc
	{
		...
		/// Get_category_rated_areas location/analytics/category-rated-areas
		/// </summary>
		/// <param name="latitude">Latitude in decimal coordinates</param>
		/// <param name="longitude">Longitude in decimal coordinates</param>
		/// <returns>Successful Reply</returns>
		public async Task Get_category_rated_areasAsync(double latitude, double longitude, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "location/analytics/category-rated-areas?latitude="+latitude+"&longitude="+longitude;
