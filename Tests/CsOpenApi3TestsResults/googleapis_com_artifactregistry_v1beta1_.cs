...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Artifactregistry_projects_locations_repositories_packages_versions_delete v1beta1/{name}
		/// </summary>
		...
		/// <summary>
		/// Gets a version
		/// Artifactregistry_projects_locations_repositories_packages_versions_get v1beta1/{name}
		/// </summary>
		...
		/// <summary>
		/// Updates a tag.
		/// Artifactregistry_projects_locations_repositories_packages_tags_patch v1beta1/{name}
		/// </summary>
		...
		/// Artifactregistry_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// <summary>
		/// Lists files.
		/// Artifactregistry_projects_locations_repositories_files_list v1beta1/{parent}/files
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/files&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Lists packages.
		/// Artifactregistry_projects_locations_repositories_packages_list v1beta1/{parent}/packages
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/packages&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Lists repositories.
		/// Artifactregistry_projects_locations_repositories_list v1beta1/{parent}/repositories
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/repositories&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Artifactregistry_projects_locations_repositories_create v1beta1/{parent}/repositories
		/// </summary>
		...
		/// <summary>
		/// Lists tags.
		/// Artifactregistry_projects_locations_repositories_packages_tags_list v1beta1/{parent}/tags
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tags&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Creates a tag.
		/// Artifactregistry_projects_locations_repositories_packages_tags_create v1beta1/{parent}/tags
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tags&tagId=" + (tagId==null? "" : System.Uri.EscapeDataString(tagId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Lists versions.
		/// Artifactregistry_projects_locations_repositories_packages_versions_list v1beta1/{parent}/versions
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/versions&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Artifactregistry_projects_locations_repositories_getIamPolicy v1beta1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Artifactregistry_projects_locations_repositories_setIamPolicy v1beta1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Artifactregistry_projects_locations_repositories_testIamPermissions v1beta1/{resource}:testIamPermissions
		/// </summary>
