...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task PmjayAsync(PmjayPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "pmjay/certificate";
	...
	public class PmjayPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public PmjayPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public PmjayPostBodyFormat Format { get; set; }
	...
	public class PmjayPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum PmjayPostBodyFormat
	{
