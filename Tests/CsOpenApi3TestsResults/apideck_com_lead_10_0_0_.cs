...
namespace MyNS
{
	...
	public class LeadsSort
	{
		...
		public System.Nullable<LeadsSortBy> By { get; set; }
		
		/// <summary>
		/// The direction in which to sort the results
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="direction")]
		public System.Nullable<LeadsSortDirection> Direction { get; set; }
	}
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum LeadsSortDirection
	{
	...
	public partial class Misc
	{
		...
		public async Task<GetLeadsResponse> LeadsAllAsync(bool raw, string cursor, int limit, LeadsFilter filter, LeadsSort sort, string fields, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "lead/leads?raw="+raw+"&cursor=" + (cursor==null? "" : System.Uri.EscapeDataString(cursor))+"&limit="+limit+"&filter=" + filter+"&sort=" + sort+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
		...
		{
			var requestUri = "lead/leads?raw="+raw;
		...
		{
			var requestUri = "lead/leads/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw;
		...
		{
			var requestUri = "lead/leads/"+ (id==null? "" : System.Uri.EscapeDataString(id))+"&raw="+raw+"&fields=" + (fields==null? "" : System.Uri.EscapeDataString(fields));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
