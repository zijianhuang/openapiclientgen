...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Oslogin_users_sshPublicKeys_delete v1alpha/{name}
		/// </summary>
		...
		/// <param name="operatingSystemType">The type of operating system associated with the account.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Oslogin_users_sshPublicKeys_deleteAsync(string name, PosixAccountOperatingSystemType operatingSystemType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&operatingSystemType=" + operatingSystemType;
		...
		/// Oslogin_users_sshPublicKeys_get v1alpha/{name}
		/// </summary>
		...
		/// Oslogin_users_sshPublicKeys_patch v1alpha/{name}
		/// </summary>
		/// <param name="name">Required. The fingerprint of the public key to update. Public keys are identified by their SHA-256 fingerprint. The fingerprint of the public key is in format `users/{user}/sshPublicKeys/{fingerprint}`.</param>
		...
		/// Oslogin_users_getLoginProfile v1alpha/{name}/loginProfile
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<LoginProfile> Oslogin_users_getLoginProfileAsync(string name, PosixAccountOperatingSystemType operatingSystemType, string projectId, string systemId, Oslogin_users_getLoginProfileView view, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/loginProfile&operatingSystemType=" + operatingSystemType+"&projectId=" + (projectId==null? "" : System.Uri.EscapeDataString(projectId))+"&systemId=" + (systemId==null? "" : System.Uri.EscapeDataString(systemId))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Oslogin_users_sshPublicKeys_create v1alpha/{parent}/sshPublicKeys
		/// </summary>
		...
		{
			var requestUri = "v1alpha/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/sshPublicKeys";
		...
		/// Oslogin_users_importSshPublicKey v1alpha/{parent}:importSshPublicKey
		/// </summary>
		...
		{
			var requestUri = "v1alpha/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":importSshPublicKey&projectId=" + (projectId==null? "" : System.Uri.EscapeDataString(projectId))+"&"+string.Join("&", regions.Select(z => $"regions={System.Uri.EscapeDataString(z.ToString())}"))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Oslogin_users_projects_zones_signSshPublicKey v1alpha/{parent}:signSshPublicKey
		/// </summary>
		...
		{
			var requestUri = "v1alpha/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":signSshPublicKey";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SignSshPublicKeyResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
