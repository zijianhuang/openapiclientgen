...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Get v1/agreements
		/// </summary>
		/// <param name="keys">Keys for Agreements whose details are to be retrieved</param>
		/// <returns>Request was successful</returns>
		public async Task<LegalAgreement[]> GetAsync(string[] keys, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/agreements?"+string.Join("&", keys.Select(z => $"keys={System.Uri.EscapeDataString(z.ToString())}"));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<LegalAgreement[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
