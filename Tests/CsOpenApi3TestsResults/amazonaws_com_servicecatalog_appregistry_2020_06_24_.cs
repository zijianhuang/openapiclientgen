...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="application"> The name, ID, or ARN of the application. 
		/// Min length: 1
		/// Max length: 256
		// </param>
		/// <param name="attributeGroup"> The name, ID, or ARN of the attribute group that holds the attributes to describe the application. 
		/// Min length: 1
		/// Max length: 512
		// </param>
		...
		public async Task<AssociateAttributeGroupResponse> AssociateAttributeGroupAsync(string application, string attributeGroup, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<AssociateAttributeGroupResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		public async Task<DisassociateAttributeGroupResponse> DisassociateAttributeGroupAsync(string application, string attributeGroup, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DisassociateAttributeGroupResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="resource">The name or ID of the resource of which the application will be associated.
		/// Min length: 1
		/// Max length: 256
		// </param>
		/// <returns>Success</returns>
		public async Task<AssociateResourceResponse> AssociateResourceAsync(string application, ResourceType resourceType, string resource, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AssociateResourceResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="application">The name or ID of the application.
		/// Min length: 1
		/// Max length: 256
		// </param>
		/// <param name="resourceType">The type of the resource that is being disassociated.</param>
		/// <param name="resource">The name or ID of the resource.
		/// Min length: 1
		/// Max length: 256
		// </param>
		/// <returns>Success</returns>
		public async Task<DisassociateResourceResponse> DisassociateResourceAsync(string application, ResourceType resourceType, string resource, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DisassociateResourceResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <param name="resource">The name or ID of the resource associated with the application.
		/// Min length: 1
		/// Max length: 256
		// </param>
		/// <returns>Success</returns>
		public async Task<GetAssociatedResourceResponse> GetAssociatedResourceAsync(string application, ResourceType resourceType, string resource, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetAssociatedResourceResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="nextToken">The token to use to get the next page of results after a previous API call. 
		/// Min length: 1
		/// Max length: 2024
		// </param>
		/// <param name="maxResults">The upper bound of the number of results to return (cannot exceed 25). If this parameter is omitted, it defaults to 25. This value is optional.
		/// Minimum: 1
		/// Maximum: 100
		// </param>
		/// <returns>Success</returns>
		...
		public async Task<ListAttributeGroupsResponse> ListAttributeGroupsAsync(string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAttributeGroupsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="application"> The name, ID, or ARN of the application that will be updated. 
		/// Min length: 1
		/// Max length: 256
		// </param>
		/// <returns>Success</returns>
		...
		public async Task<DeleteAttributeGroupResponse> DeleteAttributeGroupAsync(string attributeGroup, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteAttributeGroupResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<GetAttributeGroupResponse> GetAttributeGroupAsync(string attributeGroup, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetAttributeGroupResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UpdateAttributeGroupResponse> UpdateAttributeGroupAsync(string attributeGroup, UpdateAttributeGroupPatchBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateAttributeGroupResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListAssociatedAttributeGroupsResponse> ListAssociatedAttributeGroupsAsync(string application, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAssociatedAttributeGroupsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ListAssociatedResourcesResponse> ListAssociatedResourcesAsync(string application, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAssociatedResourcesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 256
		// </param>
		/// <param name="nextToken">This token retrieves the next page of results after a previous API call.
		/// Min length: 1
		/// Max length: 2024
		// </param>
		/// <param name="maxResults">The upper bound of the number of results to return. The value cannot exceed 25. If you omit this parameter, it defaults to 25. This value is optional.
		/// Minimum: 1
		/// Maximum: 100
		// </param>
		/// <returns>Success</returns>
		public async Task<ListAttributeGroupsForApplicationResponse> ListAttributeGroupsForApplicationAsync(string application, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAttributeGroupsForApplicationResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="resourceArn">The Amazon resource name (ARN) that specifies the resource.
		/// Min length: 1
		/// Max length: 1600
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="resourceType">The type of resource of which the application will be associated.</param>
		/// <param name="resource">An entity you can work with and specify with a name or ID. Examples include an Amazon EC2 instance, an Amazon Web Services CloudFormation stack, or an Amazon S3 bucket.
		/// Min length: 1
		/// Max length: 256
		// </param>
		/// <returns>Success</returns>
		public async Task<SyncResourceResponse> SyncResourceAsync(ResourceType resourceType, string resource, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SyncResourceResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 1600
		// </param>
		/// <param name="tagKeys">A list of the tag keys to remove from the specified resource.
		/// Minimum items: 0
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
	...
	public class CreateAttributeGroupPostBody
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="attributes")]
		[System.ComponentModel.DataAnnotations.Length(1, 8000)]
