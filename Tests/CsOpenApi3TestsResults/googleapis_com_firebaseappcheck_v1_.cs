...
namespace MyNS
{
	...
	public class GoogleFirebaseAppcheckV1BatchGetAppAttestConfigsResponse
	{
		...
		public GoogleFirebaseAppcheckV1AppAttestConfig[] Configs { get; set; }
	}
	...
	public class GoogleFirebaseAppcheckV1BatchGetDeviceCheckConfigsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="configs")]
		public GoogleFirebaseAppcheckV1DeviceCheckConfig[] Configs { get; set; }
	}
	...
	public class GoogleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="configs")]
		public GoogleFirebaseAppcheckV1PlayIntegrityConfig[] Configs { get; set; }
	}
	...
	public class GoogleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="configs")]
		public GoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig[] Configs { get; set; }
	}
	...
	public class GoogleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="configs")]
		public GoogleFirebaseAppcheckV1RecaptchaV3Config[] Configs { get; set; }
	}
	...
	public class GoogleFirebaseAppcheckV1BatchGetSafetyNetConfigsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="configs")]
		public GoogleFirebaseAppcheckV1SafetyNetConfig[] Configs { get; set; }
	}
	...
	public class GoogleFirebaseAppcheckV1BatchUpdateServicesRequest
	{
		...
		public GoogleFirebaseAppcheckV1UpdateServiceRequest[] Requests { get; set; }
	...
	public class GoogleFirebaseAppcheckV1UpdateServiceRequest
	{
		...
		public GoogleFirebaseAppcheckV1Service Service { get; set; }
	...
	public class GoogleFirebaseAppcheckV1Service
	{
		...
		public System.Nullable<GoogleFirebaseAppcheckV1ServiceEnforcementMode> EnforcementMode { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleFirebaseAppcheckV1ServiceEnforcementMode
	{
	...
	public class GoogleFirebaseAppcheckV1BatchUpdateServicesResponse
	{
		...
		public GoogleFirebaseAppcheckV1Service[] Services { get; set; }
	}
	...
	public class GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationResponse
	{
		...
		public GoogleFirebaseAppcheckV1AppCheckToken AppCheckToken { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleFirebaseAppcheckV1GenerateAppAttestChallengeRequest
	{
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeRequest
	{
	}
	...
	public class GoogleFirebaseAppcheckV1ListDebugTokensResponse
	{
		...
		public GoogleFirebaseAppcheckV1DebugToken[] DebugTokens { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleFirebaseAppcheckV1PublicJwk
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleFirebaseAppcheckV1PublicJwkSet
	{
		...
		public GoogleFirebaseAppcheckV1PublicJwk[] Keys { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// Firebaseappcheck_projects_apps_exchangeAppAttestAssertion v1/{app}:exchangeAppAttestAssertion
		/// </summary>
		...
		public async Task<GoogleFirebaseAppcheckV1AppCheckToken> Firebaseappcheck_projects_apps_exchangeAppAttestAssertionAsync(string app, GoogleFirebaseAppcheckV1ExchangeAppAttestAssertionRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangeAppAttestAssertion";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1AppCheckToken>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// Firebaseappcheck_projects_apps_exchangeAppAttestAttestation v1/{app}:exchangeAppAttestAttestation
		/// </summary>
		/// <param name="app">Required. The relative resource name of the iOS app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationResponse> Firebaseappcheck_projects_apps_exchangeAppAttestAttestationAsync(string app, GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangeAppAttestAttestation";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_exchangeCustomToken v1/{app}:exchangeCustomToken
		/// </summary>
		/// <param name="app">Required. The relative resource name of the app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1AppCheckToken> Firebaseappcheck_projects_apps_exchangeCustomTokenAsync(string app, GoogleFirebaseAppcheckV1ExchangeCustomTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangeCustomToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firebaseappcheck_projects_apps_exchangeDebugToken v1/{app}:exchangeDebugToken
		/// </summary>
		/// <param name="app">Required. The relative resource name of the app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1AppCheckToken> Firebaseappcheck_projects_apps_exchangeDebugTokenAsync(string app, GoogleFirebaseAppcheckV1ExchangeDebugTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangeDebugToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firebaseappcheck_projects_apps_exchangeDeviceCheckToken v1/{app}:exchangeDeviceCheckToken
		/// </summary>
		/// <param name="app">Required. The relative resource name of the iOS app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1AppCheckToken> Firebaseappcheck_projects_apps_exchangeDeviceCheckTokenAsync(string app, GoogleFirebaseAppcheckV1ExchangeDeviceCheckTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangeDeviceCheckToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firebaseappcheck_projects_apps_exchangePlayIntegrityToken v1/{app}:exchangePlayIntegrityToken
		/// </summary>
		/// <param name="app">Required. The relative resource name of the Android app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1AppCheckToken> Firebaseappcheck_projects_apps_exchangePlayIntegrityTokenAsync(string app, GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangePlayIntegrityToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firebaseappcheck_projects_apps_exchangeRecaptchaEnterpriseToken v1/{app}:exchangeRecaptchaEnterpriseToken
		/// </summary>
		/// <param name="app">Required. The relative resource name of the web app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1AppCheckToken> Firebaseappcheck_projects_apps_exchangeRecaptchaEnterpriseTokenAsync(string app, GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangeRecaptchaEnterpriseToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firebaseappcheck_projects_apps_exchangeRecaptchaV3Token v1/{app}:exchangeRecaptchaV3Token
		/// </summary>
		/// <param name="app">Required. The relative resource name of the web app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1AppCheckToken> Firebaseappcheck_projects_apps_exchangeRecaptchaV3TokenAsync(string app, GoogleFirebaseAppcheckV1ExchangeRecaptchaV3TokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangeRecaptchaV3Token";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firebaseappcheck_projects_apps_exchangeSafetyNetToken v1/{app}:exchangeSafetyNetToken
		/// </summary>
		/// <param name="app">Required. The relative resource name of the Android app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1AppCheckToken> Firebaseappcheck_projects_apps_exchangeSafetyNetTokenAsync(string app, GoogleFirebaseAppcheckV1ExchangeSafetyNetTokenRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":exchangeSafetyNetToken";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Firebaseappcheck_projects_apps_generateAppAttestChallenge v1/{app}:generateAppAttestChallenge
		/// </summary>
		/// <param name="app">Required. The relative resource name of the iOS app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1GenerateAppAttestChallengeResponse> Firebaseappcheck_projects_apps_generateAppAttestChallengeAsync(string app, GoogleFirebaseAppcheckV1GenerateAppAttestChallengeRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":generateAppAttestChallenge";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1GenerateAppAttestChallengeResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_generatePlayIntegrityChallenge v1/{app}:generatePlayIntegrityChallenge
		/// </summary>
		/// <param name="app">Required. The relative resource name of the app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse> Firebaseappcheck_projects_apps_generatePlayIntegrityChallengeAsync(string app, GoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (app==null? "" : System.Uri.EscapeDataString(app))+":generatePlayIntegrityChallenge";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_debugTokens_delete v1/{name}
		/// </summary>
		/// <param name="name">Required. The relative resource name of the DebugToken to delete, in the format: ``` projects/{project_number}/apps/{app_id}/debugTokens/{debug_token_id} ```</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleProtobufEmpty> Firebaseappcheck_projects_apps_debugTokens_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Firebaseappcheck_projects_services_get v1/{name}
		/// </summary>
		/// <param name="name">Required. The relative resource name of the Service to retrieve, in the format: ``` projects/{project_number}/services/{service_id} ``` Note that the `service_id` element must be a supported service ID. Currently, the following service IDs are supported: * `firebasestorage.googleapis.com` (Cloud Storage for Firebase) * `firebasedatabase.googleapis.com` (Firebase Realtime Database) * `firestore.googleapis.com` (Cloud Firestore)</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1Service> Firebaseappcheck_projects_services_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1Service>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_services_patch v1/{name}
		/// </summary>
		/// <param name="name">Required. The relative resource name of the service configuration object, in the format: ``` projects/{project_number}/services/{service_id} ``` Note that the `service_id` element must be a supported service ID. Currently, the following service IDs are supported: * `firebasestorage.googleapis.com` (Cloud Storage for Firebase) * `firebasedatabase.googleapis.com` (Firebase Realtime Database) * `firestore.googleapis.com` (Cloud Firestore)</param>
		/// <param name="updateMask">Required. A comma-separated list of names of fields in the Service to update. Example: `enforcement_mode`.</param>
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1Service> Firebaseappcheck_projects_services_patchAsync(string name, string updateMask, GoogleFirebaseAppcheckV1Service requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Firebaseappcheck_projects_apps_appAttestConfig_batchGet v1/{parent}/apps/-/appAttestConfig:batchGet
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1BatchGetAppAttestConfigsResponse> Firebaseappcheck_projects_apps_appAttestConfig_batchGetAsync(string parent, string[] names, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/apps/-/appAttestConfig:batchGet&"+string.Join("&", names.Select(z => $"names={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1BatchGetAppAttestConfigsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_deviceCheckConfig_batchGet v1/{parent}/apps/-/deviceCheckConfig:batchGet
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1BatchGetDeviceCheckConfigsResponse> Firebaseappcheck_projects_apps_deviceCheckConfig_batchGetAsync(string parent, string[] names, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/apps/-/deviceCheckConfig:batchGet&"+string.Join("&", names.Select(z => $"names={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1BatchGetDeviceCheckConfigsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_playIntegrityConfig_batchGet v1/{parent}/apps/-/playIntegrityConfig:batchGet
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse> Firebaseappcheck_projects_apps_playIntegrityConfig_batchGetAsync(string parent, string[] names, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/apps/-/playIntegrityConfig:batchGet&"+string.Join("&", names.Select(z => $"names={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_recaptchaEnterpriseConfig_batchGet v1/{parent}/apps/-/recaptchaEnterpriseConfig:batchGet
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse> Firebaseappcheck_projects_apps_recaptchaEnterpriseConfig_batchGetAsync(string parent, string[] names, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/apps/-/recaptchaEnterpriseConfig:batchGet&"+string.Join("&", names.Select(z => $"names={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_recaptchaV3Config_batchGet v1/{parent}/apps/-/recaptchaV3Config:batchGet
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse> Firebaseappcheck_projects_apps_recaptchaV3Config_batchGetAsync(string parent, string[] names, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/apps/-/recaptchaV3Config:batchGet&"+string.Join("&", names.Select(z => $"names={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_safetyNetConfig_batchGet v1/{parent}/apps/-/safetyNetConfig:batchGet
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1BatchGetSafetyNetConfigsResponse> Firebaseappcheck_projects_apps_safetyNetConfig_batchGetAsync(string parent, string[] names, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/apps/-/safetyNetConfig:batchGet&"+string.Join("&", names.Select(z => $"names={System.Uri.EscapeDataString(z.ToString())}"));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1BatchGetSafetyNetConfigsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_debugTokens_list v1/{parent}/debugTokens
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1ListDebugTokensResponse> Firebaseappcheck_projects_apps_debugTokens_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/debugTokens&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1ListDebugTokensResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_apps_debugTokens_create v1/{parent}/debugTokens
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1DebugToken> Firebaseappcheck_projects_apps_debugTokens_createAsync(string parent, GoogleFirebaseAppcheckV1DebugToken requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/debugTokens";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1DebugToken>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_services_list v1/{parent}/services
		/// </summary>
		...
		/// <param name="pageSize">The maximum number of Services to return in the response. Only explicitly configured services are returned. The server may return fewer than this at its own discretion. If no value is specified (or too large a value is specified), the server will impose its own limit.</param>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1ListServicesResponse> Firebaseappcheck_projects_services_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/services&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1ListServicesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Firebaseappcheck_projects_services_batchUpdate v1/{parent}/services:batchUpdate
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleFirebaseAppcheckV1BatchUpdateServicesResponse> Firebaseappcheck_projects_services_batchUpdateAsync(string parent, GoogleFirebaseAppcheckV1BatchUpdateServicesRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/services:batchUpdate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleFirebaseAppcheckV1BatchUpdateServicesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
