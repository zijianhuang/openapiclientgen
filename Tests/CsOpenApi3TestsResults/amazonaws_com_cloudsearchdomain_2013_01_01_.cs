...
namespace MyNS
{
	...
	public class SearchStatus
	{
		...
		[System.Runtime.Serialization.DataMember(Name="timems")]
		public System.Nullable<System.Int32> Timems { get; set; }
		
		[System.Runtime.Serialization.DataMember(Name="rid")]
	...
	public class Hits
	{
		...
		[System.Runtime.Serialization.DataMember(Name="hit")]
	...
	public class Hit
	{
		...
		[System.Runtime.Serialization.DataMember(Name="exprs")]
	...
	public class SuggestResponse
	{
		...
		[System.Runtime.Serialization.DataMember(Name="suggest")]
	...
	public class UploadDocumentsResponse
	{
		...
		[System.Runtime.Serialization.DataMember(Name="adds")]
	...
	public partial class Misc
	{
		...
		{
			var requestUri = "2013-01-01/search#format=sdk&pretty=true&q?cursor=" + (cursor==null? "" : System.Uri.EscapeDataString(cursor))+"&expr=" + (expr==null? "" : System.Uri.EscapeDataString(expr))+"&facet=" + (facet==null? "" : System.Uri.EscapeDataString(facet))+"&fq=" + (fq==null? "" : System.Uri.EscapeDataString(fq))+"&highlight=" + (highlight==null? "" : System.Uri.EscapeDataString(highlight))+"&partial="+partial+"&q=" + (q==null? "" : System.Uri.EscapeDataString(q))+"&q.options=" + (q_options==null? "" : System.Uri.EscapeDataString(q_options))+"&q.parser=" + q_parser+"&return=" + (_return==null? "" : System.Uri.EscapeDataString(_return))+"&size="+size+"&sort=" + (sort==null? "" : System.Uri.EscapeDataString(sort))+"&start="+start+"&stats=" + (stats==null? "" : System.Uri.EscapeDataString(stats))+"&format=" + format+"&pretty=" + pretty;
		...
		/// <returns>Success</returns>
		public async Task<SuggestResponse> SuggestAsync(string q, string suggester, int size, SearchFormat format, SuggestPretty pretty, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "2013-01-01/suggest#format=sdk&pretty=true&q&suggester?q=" + (q==null? "" : System.Uri.EscapeDataString(q))+"&suggester=" + (suggester==null? "" : System.Uri.EscapeDataString(suggester))+"&size="+size+"&format=" + format+"&pretty=" + pretty;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SuggestResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task<UploadDocumentsResponse> UploadDocumentsAsync(SearchFormat format, UploadDocumentsPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "2013-01-01/documents/batch#format=sdk&Content-Type?format=" + format;
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UploadDocumentsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
	...
	public enum UploadDocumentsContent_Type
	{
	...
	public class UploadDocumentsPostBody
	{
