...
namespace MyNS
{
	...
	public class GoogleCloudServicebrokerV1alpha1__Binding
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__CreateBindingResponse
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__CreateServiceInstanceResponse
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__DashboardClient
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__DeleteBindingResponse
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__DeleteServiceInstanceResponse
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__GetBindingResponse
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__ListBindingsResponse
	{
		...
		public GoogleCloudServicebrokerV1alpha1__Binding[] Bindings { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__ListCatalogResponse
	{
		...
		public GoogleCloudServicebrokerV1alpha1__Service[] Services { get; set; }
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__Service
	{
		...
		public GoogleCloudServicebrokerV1alpha1__DashboardClient Dashboard_client { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="instance_retrievable")]
		public System.Nullable<System.Boolean> Instance_retrievable { get; set; }
		...
		public GoogleCloudServicebrokerV1alpha1__Plan[] Plans { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__Plan
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__ListServiceInstancesResponse
	{
		...
		public GoogleCloudServicebrokerV1alpha1__ServiceInstance[] Instances { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__ServiceInstance
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__Operation
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudServicebrokerV1alpha1__UpdateServiceInstanceResponse
	{
	...
	public partial class Misc
	{
		...
		/// Servicebroker_projects_brokers_v2_service_instances_get v1alpha1/{name}
		/// </summary>
		/// <param name="name">The resource name of the instance to return.</param>
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_v2_service_instances_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Servicebroker_projects_brokers_instances_service_bindings_list v1alpha1/{parent}/service_bindings
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_instances_service_bindings_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/service_bindings&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// This API is an extension and not part of the OSB spec.
		/// Hence the path is a standard Google API URL.
		/// Servicebroker_projects_brokers_service_instances_list v1alpha1/{parent}/service_instances
		/// </summary>
		...
		///returned by a previous list request to get the next page of results.</param>
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_service_instances_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/service_instances&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Servicebroker_projects_brokers_v2_catalog_list v1alpha1/{parent}/v2/catalog
		/// </summary>
		/// <param name="parent">Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.</param>
		/// <param name="pageSize">Specifies the number of results to return per page. If there are fewer
		///elements than the specified number, returns all elements.
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/v2/catalog&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Servicebroker_projects_brokers_v2_service_instances_delete v1alpha1/{parent}/v2/service_instances/{instanceId}
		/// </summary>
		/// <param name="parent">Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.</param>
		/// <param name="instanceId">The instance id to deprovision.</param>
		...
		/// <param name="serviceId">The service id of the service instance.</param>
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_v2_service_instances_deleteAsync(string parent, string instanceId, bool acceptsIncomplete, string planId, string serviceId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/v2/service_instances/"+ (instanceId==null? "" : System.Uri.EscapeDataString(instanceId))+"&acceptsIncomplete="+acceptsIncomplete+"&planId=" + (planId==null? "" : System.Uri.EscapeDataString(planId))+"&serviceId=" + (serviceId==null? "" : System.Uri.EscapeDataString(serviceId));
		...
		/// Servicebroker_projects_brokers_v2_service_instances_getLast_operation v1alpha1/{parent}/v2/service_instances/{instanceId}/last_operation
		/// </summary>
		/// <param name="parent">Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.</param>
		/// <param name="instanceId">The instance id for which to return the last operation status.</param>
		...
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_v2_service_instances_getLast_operationAsync(string parent, string instanceId, string operation, string planId, string serviceId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/v2/service_instances/"+ (instanceId==null? "" : System.Uri.EscapeDataString(instanceId))+"/last_operation&operation=" + (operation==null? "" : System.Uri.EscapeDataString(operation))+"&planId=" + (planId==null? "" : System.Uri.EscapeDataString(planId))+"&serviceId=" + (serviceId==null? "" : System.Uri.EscapeDataString(serviceId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Servicebroker_projects_brokers_v2_service_instances_service_bindings_get v1alpha1/{parent}/v2/service_instances/{instanceId}/service_bindings/{bindingId}
		/// </summary>
		/// <param name="parent">Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.</param>
		/// <param name="instanceId">Instance id to which the binding is bound.</param>
		/// <param name="bindingId">The binding id.</param>
		/// <param name="planId">Plan id.</param>
		/// <param name="serviceId">Service id.</param>
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_v2_service_instances_service_bindings_getAsync(string parent, string instanceId, string bindingId, string planId, string serviceId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/v2/service_instances/"+ (instanceId==null? "" : System.Uri.EscapeDataString(instanceId))+"/service_bindings/"+ (bindingId==null? "" : System.Uri.EscapeDataString(bindingId))+"&planId=" + (planId==null? "" : System.Uri.EscapeDataString(planId))+"&serviceId=" + (serviceId==null? "" : System.Uri.EscapeDataString(serviceId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Only last (or current) operation can be polled.
		/// Servicebroker_projects_brokers_v2_service_instances_service_bindings_getLast_operation v1alpha1/{parent}/v2/service_instances/{instanceId}/service_bindings/{bindingId}/last_operation
		/// </summary>
		/// <param name="parent">Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.</param>
		/// <param name="instanceId">The instance id that the binding is bound to.</param>
		/// <param name="bindingId">The binding id for which to return the last operation</param>
		/// <param name="operation">If `operation` was returned during mutation operation, this field must be
		///populated with the provided value.</param>
		/// <param name="planId">Plan id.</param>
		/// <param name="serviceId">Service id.</param>
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_v2_service_instances_service_bindings_getLast_operationAsync(string parent, string instanceId, string bindingId, string operation, string planId, string serviceId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/v2/service_instances/"+ (instanceId==null? "" : System.Uri.EscapeDataString(instanceId))+"/service_bindings/"+ (bindingId==null? "" : System.Uri.EscapeDataString(bindingId))+"/last_operation&operation=" + (operation==null? "" : System.Uri.EscapeDataString(operation))+"&planId=" + (planId==null? "" : System.Uri.EscapeDataString(planId))+"&serviceId=" + (serviceId==null? "" : System.Uri.EscapeDataString(serviceId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// Servicebroker_projects_brokers_v2_service_instances_service_bindings_create v1alpha1/{parent}/v2/service_instances/{instanceId}/service_bindings/{binding_id}
		/// </summary>
		/// <param name="parent">The GCP container.
		///Must match
		///`projects/[PROJECT_ID]/brokers/[BROKER_ID]`.</param>
		...
		/// <param name="acceptsIncomplete">See CreateServiceInstanceRequest for details.</param>
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_v2_service_instances_service_bindings_createAsync(string parent, string instanceId, string binding_id, bool acceptsIncomplete, GoogleCloudServicebrokerV1alpha1__Binding requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/v2/service_instances/"+ (instanceId==null? "" : System.Uri.EscapeDataString(instanceId))+"/service_bindings/"+ (binding_id==null? "" : System.Uri.EscapeDataString(binding_id))+"&acceptsIncomplete="+acceptsIncomplete;
		...
		/// Servicebroker_projects_brokers_v2_service_instances_patch v1alpha1/{parent}/v2/service_instances/{instance_id}
		/// </summary>
		/// <param name="parent">Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.</param>
		...
		/// <param name="acceptsIncomplete">See CreateServiceInstanceRequest for details.</param>
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_v2_service_instances_patchAsync(string parent, string instance_id, bool acceptsIncomplete, GoogleCloudServicebrokerV1alpha1__ServiceInstance requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/v2/service_instances/"+ (instance_id==null? "" : System.Uri.EscapeDataString(instance_id))+"&acceptsIncomplete="+acceptsIncomplete;
		...
		/// Servicebroker_projects_brokers_v2_service_instances_create v1alpha1/{parent}/v2/service_instances/{instance_id}
		/// </summary>
		/// <param name="parent">Parent must match `projects/[PROJECT_ID]/brokers/[BROKER_ID]`.</param>
		/// <param name="instance_id">The id of the service instance. Must be unique within GCP project.
		///Maximum length is 64, GUID recommended.
		...
		///asynchronous.</param>
		/// <returns>Successful response</returns>
		public async Task Servicebroker_projects_brokers_v2_service_instances_createAsync(string parent, string instance_id, bool acceptsIncomplete, GoogleCloudServicebrokerV1alpha1__ServiceInstance requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/v2/service_instances/"+ (instance_id==null? "" : System.Uri.EscapeDataString(instance_id))+"&acceptsIncomplete="+acceptsIncomplete;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
		...
		/// set.
		/// Servicebroker_getIamPolicy v1alpha1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Servicebroker_setIamPolicy v1alpha1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Servicebroker_testIamPermissions v1alpha1/{resource}:testIamPermissions
		/// </summary>
