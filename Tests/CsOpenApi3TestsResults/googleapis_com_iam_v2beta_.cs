...
namespace MyNS
{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleIamV2betaDenyRule
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleIamV2betaListPoliciesResponse
	{
		...
		public GoogleIamV2betaPolicy[] Policies { get; set; }
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleIamV2betaPolicy
	{
		...
		public GoogleIamV2betaPolicyRule[] Rules { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleIamV2betaPolicyRule
	{
		...
		public GoogleIamV2betaDenyRule DenyRule { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleIamV2betaPolicyOperationMetadata
	{
	...
	public partial class Misc
	{
		...
		/// Iam_policies_delete v2beta/{name}
		/// </summary>
		...
		{
			var requestUri = "v2beta/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&etag=" + (etag==null? "" : System.Uri.EscapeDataString(etag));
		...
		/// Iam_policies_operations_get v2beta/{name}
		/// </summary>
		...
		/// Iam_policies_update v2beta/{name}
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleLongrunningOperation> Iam_policies_updateAsync(string name, GoogleIamV2betaPolicy requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// Iam_policies_listPolicies v2beta/{parent}
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleIamV2betaListPoliciesResponse> Iam_policies_listPoliciesAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleIamV2betaListPoliciesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <summary>
		/// Creates a policy.
		/// Iam_policies_createPolicy v2beta/{parent}
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleLongrunningOperation> Iam_policies_createPolicyAsync(string parent, string policyId, GoogleIamV2betaPolicy requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"&policyId=" + (policyId==null? "" : System.Uri.EscapeDataString(policyId));
