...
namespace MyNS
{
	...
	public class Action
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="disableImagePrefetch")]
		public System.Nullable<System.Boolean> DisableImagePrefetch { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="disableStandardErrorCapture")]
		public System.Nullable<System.Boolean> DisableStandardErrorCapture { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="enableFuse")]
		public System.Nullable<System.Boolean> EnableFuse { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="publishExposedPorts")]
		public System.Nullable<System.Boolean> PublishExposedPorts { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="runInBackground")]
		public System.Nullable<System.Boolean> RunInBackground { get; set; }
	...
	public class Event
	{
		...
		/// An event generated when a container is forcibly terminated by the worker. Currently, this only occurs when the container outlives the timeout specified by the user.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="containerKilled")]
		public ContainerKilledEvent ContainerKilled { get; set; }
		
		/// <summary>
		/// An event generated when a container starts.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="containerStarted")]
		public ContainerStartedEvent ContainerStarted { get; set; }
		
		/// <summary>
		/// An event generated when a container exits.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="containerStopped")]
		public ContainerStoppedEvent ContainerStopped { get; set; }
		
		/// <summary>
		/// An event generated whenever a resource limitation or transient error delays execution of a pipeline that was otherwise ready to run.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="delayed")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pullStarted")]
		public PullStartedEvent PullStarted { get; set; }
		
		/// <summary>
		/// An event generated when the worker stops pulling an image.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pullStopped")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="unexpectedExitStatus")]
		public UnexpectedExitStatusEvent UnexpectedExitStatus { get; set; }
		
		/// <summary>
		/// An event generated after a worker VM has been assigned to run the pipeline.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="workerAssigned")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="workerReleased")]
	...
	public partial class Misc
	{
		...
		/// Lifesciences_projects_locations_operations_get v2beta/{name}
		/// </summary>
		/// <param name="name">The name of the operation resource.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Lifesciences_projects_locations_operations_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Lifesciences_projects_locations_list v2beta/{name}/locations
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListLocationsResponse> Lifesciences_projects_locations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Lifesciences_projects_locations_operations_list v2beta/{name}/operations
		/// </summary>
		/// <param name="name">The name of the operation's parent resource.</param>
		/// <param name="filter">A string for filtering Operations. The following filter fields are supported: * createTime: The time this job was created * events: The set of event (names) that have occurred while running the pipeline. The : operator can be used to determine if a particular event has occurred. * error: If the pipeline is running, this value is NULL. Once the pipeline finishes, the value is the standard Google error code. * labels.key or labels."key with space" where key is a label key. * done: If the pipeline is running, this value is false. Once the pipeline finishes, the value is true.</param>
		/// <param name="pageSize">The maximum number of results to return. The maximum value is 256.</param>
		/// <param name="pageToken">The standard list page token.</param>
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Lifesciences_projects_locations_operations_listAsync(string name, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Lifesciences_projects_locations_operations_cancel v2beta/{name}:cancel
		/// </summary>
		/// <param name="name">The name of the operation resource to be cancelled.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Lifesciences_projects_locations_operations_cancelAsync(string name, CancelOperationRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":cancel";
		...
		/// Lifesciences_projects_locations_pipelines_run v2beta/{parent}/pipelines:run
		/// </summary>
		/// <param name="parent">The project and location that this request should be executed against.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Lifesciences_projects_locations_pipelines_runAsync(string parent, RunPipelineRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/pipelines:run";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
