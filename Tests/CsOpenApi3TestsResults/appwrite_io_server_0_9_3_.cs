...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task<LogList> AccountGetLogsAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<LogList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<Preferences> AccountGetPrefsAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Preferences>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<SessionList> AccountGetSessionsAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SessionList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// DatabaseListCollections database/collections
		/// </summary>
		...
		public async Task<CollectionList> DatabaseListCollectionsAsync(string search, int limit, int offset, string orderType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "database/collections?search=" + (search==null? "" : System.Uri.EscapeDataString(search))+"&limit="+limit+"&offset="+offset+"&orderType=" + (orderType==null? "" : System.Uri.EscapeDataString(orderType));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CollectionList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// DatabaseCreateCollection database/collections
		/// </summary>
		public async Task DatabaseCreateCollectionAsync(DatabaseCreateCollectionPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "database/collections";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// DatabaseDeleteCollection database/collections/{collectionId}
		/// </summary>
		/// <param name="collectionId">Collection unique ID.</param>
		public async Task DatabaseDeleteCollectionAsync(string collectionId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "database/collections/"+ (collectionId==null? "" : System.Uri.EscapeDataString(collectionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// DatabaseGetCollection database/collections/{collectionId}
		/// </summary>
		/// <param name="collectionId">Collection unique ID.</param>
		/// <returns>Collection</returns>
		public async Task<Collection> DatabaseGetCollectionAsync(string collectionId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "database/collections/"+ (collectionId==null? "" : System.Uri.EscapeDataString(collectionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// DatabaseUpdateCollection database/collections/{collectionId}
		/// </summary>
		/// <param name="collectionId">Collection unique ID.</param>
		/// <returns>Collection</returns>
		public async Task<Collection> DatabaseUpdateCollectionAsync(string collectionId, DatabaseUpdateCollectionPutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "database/collections/"+ (collectionId==null? "" : System.Uri.EscapeDataString(collectionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
		...
		/// <param name="offset">Results offset. The default value is 0. Use this param to manage pagination.</param>
		/// <param name="orderType">Order result by ASC or DESC order.</param>
		/// <returns>Functions List</returns>
		public async Task<FunctionList> FunctionsListAsync(string search, int limit, int offset, string orderType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions?search=" + (search==null? "" : System.Uri.EscapeDataString(search))+"&limit="+limit+"&offset="+offset+"&orderType=" + (orderType==null? "" : System.Uri.EscapeDataString(orderType));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<FunctionList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// FunctionsCreate functions
		/// </summary>
		public async Task FunctionsCreateAsync(FunctionsCreatePostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// FunctionsDelete functions/{functionId}
		/// </summary>
		/// <param name="functionId">Function unique ID.</param>
		public async Task FunctionsDeleteAsync(string functionId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions/"+ (functionId==null? "" : System.Uri.EscapeDataString(functionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// FunctionsGet functions/{functionId}
		/// </summary>
		/// <param name="functionId">Function unique ID.</param>
		/// <returns>Function</returns>
		public async Task<Function> FunctionsGetAsync(string functionId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions/"+ (functionId==null? "" : System.Uri.EscapeDataString(functionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// FunctionsUpdate functions/{functionId}
		/// </summary>
		/// <param name="functionId">Function unique ID.</param>
		/// <returns>Function</returns>
		public async Task<Function> FunctionsUpdateAsync(string functionId, FunctionsUpdatePutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions/"+ (functionId==null? "" : System.Uri.EscapeDataString(functionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Put, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
		...
		public async Task<ExecutionList> FunctionsListExecutionsAsync(string functionId, string search, int limit, int offset, string orderType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ExecutionList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<Execution> FunctionsGetExecutionAsync(string functionId, string executionId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Execution>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// FunctionsUpdateTag functions/{functionId}/tag
		/// </summary>
		/// <param name="functionId">Function unique ID.</param>
		/// <returns>Function</returns>
		public async Task<Function> FunctionsUpdateTagAsync(string functionId, FunctionsUpdateTagPatchBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions/"+ (functionId==null? "" : System.Uri.EscapeDataString(functionId))+"/tag";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// FunctionsListTags functions/{functionId}/tags
		/// </summary>
		/// <param name="functionId">Function unique ID.</param>
		/// <param name="search">Search term to filter your list results. Max length: 256 chars.</param>
		/// <param name="limit">Results limit value. By default will return maximum 25 results. Maximum of 100 results allowed per request.</param>
		...
		public async Task<TagList> FunctionsListTagsAsync(string functionId, string search, int limit, int offset, string orderType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions/"+ (functionId==null? "" : System.Uri.EscapeDataString(functionId))+"/tags&search=" + (search==null? "" : System.Uri.EscapeDataString(search))+"&limit="+limit+"&offset="+offset+"&orderType=" + (orderType==null? "" : System.Uri.EscapeDataString(orderType));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TagList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// FunctionsDeleteTag functions/{functionId}/tags/{tagId}
		/// </summary>
		/// <param name="functionId">Function unique ID.</param>
		/// <param name="tagId">Tag unique ID.</param>
		public async Task FunctionsDeleteTagAsync(string functionId, string tagId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions/"+ (functionId==null? "" : System.Uri.EscapeDataString(functionId))+"/tags/"+ (tagId==null? "" : System.Uri.EscapeDataString(tagId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// FunctionsGetTag functions/{functionId}/tags/{tagId}
		/// </summary>
		/// <param name="functionId">Function unique ID.</param>
		/// <param name="tagId">Tag unique ID.</param>
		/// <returns>Tag</returns>
		public async Task<Tag> FunctionsGetTagAsync(string functionId, string tagId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "functions/"+ (functionId==null? "" : System.Uri.EscapeDataString(functionId))+"/tags/"+ (tagId==null? "" : System.Uri.EscapeDataString(tagId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// HealthGetAntiVirus health/anti-virus
		/// </summary>
		public async Task HealthGetAntiVirusAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/anti-virus";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetCache health/cache
		/// </summary>
		public async Task HealthGetCacheAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/cache";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetDB health/db
		/// </summary>
		public async Task HealthGetDBAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/db";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetQueueCertificates health/queue/certificates
		/// </summary>
		public async Task HealthGetQueueCertificatesAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/queue/certificates";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Get Functions Queue
		/// HealthGetQueueFunctions health/queue/functions
		/// </summary>
		public async Task HealthGetQueueFunctionsAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/queue/functions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetQueueLogs health/queue/logs
		/// </summary>
		public async Task HealthGetQueueLogsAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/queue/logs";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetQueueTasks health/queue/tasks
		/// </summary>
		public async Task HealthGetQueueTasksAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/queue/tasks";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetQueueUsage health/queue/usage
		/// </summary>
		public async Task HealthGetQueueUsageAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/queue/usage";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetQueueWebhooks health/queue/webhooks
		/// </summary>
		public async Task HealthGetQueueWebhooksAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/queue/webhooks";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetStorageLocal health/storage/local
		/// </summary>
		public async Task HealthGetStorageLocalAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/storage/local";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// HealthGetTime health/time
		/// </summary>
		public async Task HealthGetTimeAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "health/time";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		public async Task<Locale> LocaleGetAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Locale>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<ContinentList> LocaleGetContinentsAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ContinentList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CountryList> LocaleGetCountriesAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CountryList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<PhoneList> LocaleGetCountriesPhonesAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PhoneList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CurrencyList> LocaleGetCurrenciesAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CurrencyList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<LanguageList> LocaleGetLanguagesAsync(Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<LanguageList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<TeamList> TeamsListAsync(string search, int limit, int offset, string orderType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TeamList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<MembershipList> TeamsGetMembershipsAsync(string teamId, string search, int limit, int offset, string orderType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<MembershipList>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<Membership> TeamsUpdateMembershipRolesAsync(string teamId, string membershipId, TeamsUpdateMembershipRolesPatchBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Membership>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<UserList> UsersListAsync(string search, int limit, int offset, string orderType, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users?search=" + (search==null? "" : System.Uri.EscapeDataString(search))+"&limit="+limit+"&offset="+offset+"&orderType=" + (orderType==null? "" : System.Uri.EscapeDataString(orderType));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// UsersCreate users
		/// </summary>
		public async Task UsersCreateAsync(UsersCreatePostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// UsersDelete users/{userId}
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		public async Task UsersDeleteAsync(string userId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <param name="userId">User unique ID.</param>
		/// <returns>User</returns>
		public async Task<User> UsersGetAsync(string userId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// UsersGetLogs users/{userId}/logs
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		/// <returns>Logs List</returns>
		public async Task<LogList> UsersGetLogsAsync(string userId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"/logs";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// UsersGetPrefs users/{userId}/prefs
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		/// <returns>Preferences</returns>
		public async Task<Preferences> UsersGetPrefsAsync(string userId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"/prefs";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// UsersUpdatePrefs users/{userId}/prefs
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		/// <returns>Preferences</returns>
		public async Task<Preferences> UsersUpdatePrefsAsync(string userId, UsersUpdatePrefsPatchBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"/prefs";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
		...
		/// UsersDeleteSessions users/{userId}/sessions
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		public async Task UsersDeleteSessionsAsync(string userId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"/sessions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// UsersGetSessions users/{userId}/sessions
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		/// <returns>Sessions List</returns>
		public async Task<SessionList> UsersGetSessionsAsync(string userId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"/sessions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// UsersDeleteSession users/{userId}/sessions/{sessionId}
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		/// <param name="sessionId">User unique session ID.</param>
		public async Task UsersDeleteSessionAsync(string userId, string sessionId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"/sessions/"+ (sessionId==null? "" : System.Uri.EscapeDataString(sessionId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// UsersUpdateStatus users/{userId}/status
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		/// <returns>User</returns>
		public async Task<User> UsersUpdateStatusAsync(string userId, UsersUpdateStatusPatchBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"/status";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// UsersUpdateVerification users/{userId}/verification
		/// </summary>
		/// <param name="userId">User unique ID.</param>
		/// <returns>User</returns>
		public async Task<User> UsersUpdateVerificationAsync(string userId, UsersUpdateVerificationPatchBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "users/"+ (userId==null? "" : System.Uri.EscapeDataString(userId))+"/verification";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public class DatabaseCreateCollectionPostBody
	{
	...
	public class DatabaseUpdateCollectionPutBody
	{
	...
	public class FunctionsCreatePostBody
	{
	...
	public class FunctionsUpdatePutBody
	{
	...
	public class FunctionsUpdateTagPatchBody
	{
	...
	public class UsersCreatePostBody
	{
	...
	public class UsersUpdatePrefsPatchBody
	{
	...
	public class UsersUpdateStatusPatchBody
	{
	...
	public class UsersUpdateVerificationPatchBody
	{
