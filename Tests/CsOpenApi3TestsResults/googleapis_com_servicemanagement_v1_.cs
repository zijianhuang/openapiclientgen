...
namespace MyNS
{
	...
	public class ChangeReport
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="configChanges")]
		public ConfigChange[] ConfigChanges { get; set; }
	}
	...
	public class ConfigChange
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="advices")]
		...
		public System.Nullable<ConfigChangeChangeType> ChangeType { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum ConfigChangeChangeType
	{
	...
	public class ConfigFile
	{
		...
		public System.Nullable<ConfigFileFileType> FileType { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum ConfigFileFileType
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class DeleteServiceStrategy
	{
	}
	...
	public class Diagnostic
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="kind")]
		public System.Nullable<DiagnosticKind> Kind { get; set; }
	...
	public class FlowErrorDetails
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="flowStepId")]
	...
	public class GenerateConfigReportRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="newConfig")]
		public System.Collections.Generic.Dictionary<string, object> NewConfig { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="oldConfig")]
		public System.Collections.Generic.Dictionary<string, object> OldConfig { get; set; }
	}
	...
	public class GenerateConfigReportResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="changeReports")]
		public ChangeReport[] ChangeReports { get; set; }
	...
	public class ListServiceConfigsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="serviceConfigs")]
		public Service[] ServiceConfigs { get; set; }
	}
	...
	public class Rollout
	{
		...
		/// Strategy used to delete a service. This strategy is a placeholder only used by the system generated rollout to delete a service.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="deleteServiceStrategy")]
		public DeleteServiceStrategy DeleteServiceStrategy { get; set; }
		...
		public System.Nullable<RolloutStatus> Status { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="trafficPercentStrategy")]
		public TrafficPercentStrategy TrafficPercentStrategy { get; set; }
	}
	...
	public class TrafficPercentStrategy
	{
		...
		public System.Collections.Generic.Dictionary<string, double> Percentages { get; set; }
	}
	...
	public class ListServicesResponse
	{
		...
		public ManagedService[] Services { get; set; }
	}
	...
	public class OperationMetadata
	{
		...
		public System.Nullable<System.Int32> ProgressPercentage { get; set; }
	...
	public class Step
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="status")]
		public System.Nullable<StepStatus> Status { get; set; }
	}
	...
	public class SubmitConfigSourceResponse
	{
		...
		/// `Service` is the root object of Google API service configuration (service config). It describes the basic information about a logical service, such as the service name and the user-facing title, and delegates other aspects to sub-sections. Each sub-section is either a proto message or a repeated proto message that configures a specific aspect, such as auth. For more information, see each proto message definition. Example: type: google.api.Service name: calendar.googleapis.com title: Google Calendar API apis: - name: google.calendar.v3.Calendar visibility: rules: - selector: "google.calendar.v3.*" restriction: PREVIEW backend: rules: - selector: "google.calendar.v3.*" address: calendar.example.com authentication: providers: - id: google_calendar_auth jwks_uri: https://www.googleapis.com/oauth2/v1/certs issuer: https://securetoken.google.com rules: - selector: "*" requirements: provider_id: google_calendar_auth
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="serviceConfig")]
	...
	public partial class Misc
	{
		...
		/// Servicemanagement_operations_list v1/operations
		/// </summary>
		/// <param name="filter">A string for filtering Operations. The following filter fields are supported: * serviceName: Required. Only `=` operator is allowed. * startTime: The time this job was started, in ISO 8601 format. Allowed operators are `>=`, `>`, `<=`, and `<`. * status: Can be `done`, `in_progress`, or `failed`. Allowed operators are `=`, and `!=`. Filter expression supports conjunction (AND) and disjunction (OR) logical operators. However, the serviceName restriction must be at the top-level and can only be combined with other restrictions via the AND logical operator. Examples: * `serviceName={some-service}.googleapis.com` * `serviceName={some-service}.googleapis.com AND startTime>="2017-02-01"` * `serviceName={some-service}.googleapis.com AND status=done` * `serviceName={some-service}.googleapis.com AND (status=done OR startTime>="2017-02-01")`</param>
		/// <param name="name">Not used.</param>
		/// <param name="pageSize">The maximum number of operations to return. If unspecified, defaults to 50. The maximum value is 100.</param>
		/// <param name="pageToken">The standard list page token.</param>
		/// <returns>Successful response</returns>
		public async Task<ListOperationsResponse> Servicemanagement_operations_listAsync(string filter, string name, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Servicemanagement_services_list v1/services
		/// </summary>
		/// <param name="consumerId">Include services consumed by the specified consumer. The Google Service Management implementation accepts the following forms: - project:</param>
		/// <param name="pageSize">The max number of items to include in the response list. Page size is 50 if not specified. Maximum value is 500.</param>
		/// <param name="pageToken">Token identifying which result to start with; returned by a previous list call.</param>
		/// <param name="producerProjectId">Include services produced by the specified project.</param>
		/// <returns>Successful response</returns>
		public async Task<ListServicesResponse> Servicemanagement_services_listAsync(string consumerId, int pageSize, string pageToken, string producerProjectId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services?consumerId=" + (consumerId==null? "" : System.Uri.EscapeDataString(consumerId))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&producerProjectId=" + (producerProjectId==null? "" : System.Uri.EscapeDataString(producerProjectId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Servicemanagement_services_create v1/services
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicemanagement_services_createAsync(ManagedService requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services";
		...
		/// Servicemanagement_services_delete v1/services/{serviceName}
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicemanagement_services_deleteAsync(string serviceName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName));
		...
		/// Servicemanagement_services_get v1/services/{serviceName}
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the `ServiceManager` overview for naming requirements. For example: `example.googleapis.com`.</param>
		/// <returns>Successful response</returns>
		public async Task<ManagedService> Servicemanagement_services_getAsync(string serviceName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// Servicemanagement_services_getConfig v1/services/{serviceName}/config
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <param name="configId">Required. The id of the service configuration resource. This field must be specified for the server to return all fields, including `SourceInfo`.</param>
		/// <param name="view">Specifies which parts of the Service Config should be returned in the response.</param>
		/// <returns>Successful response</returns>
		public async Task<Service> Servicemanagement_services_getConfigAsync(string serviceName, string configId, Servicemanagement_services_getConfigView view, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+"/config&configId=" + (configId==null? "" : System.Uri.EscapeDataString(configId))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Servicemanagement_services_configs_list v1/services/{serviceName}/configs
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <param name="pageSize">The max number of items to include in the response list. Page size is 50 if not specified. Maximum value is 100.</param>
		/// <param name="pageToken">The token of the page to retrieve.</param>
		/// <returns>Successful response</returns>
		public async Task<ListServiceConfigsResponse> Servicemanagement_services_configs_listAsync(string serviceName, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+"/configs&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListServiceConfigsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Servicemanagement_services_configs_create v1/services/{serviceName}/configs
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <returns>Successful response</returns>
		public async Task<Service> Servicemanagement_services_configs_createAsync(string serviceName, Service requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+"/configs";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// <summary>
		/// Gets a service configuration (version) for a managed service.
		/// Servicemanagement_services_configs_get v1/services/{serviceName}/configs/{configId}
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <param name="configId">Required. The id of the service configuration resource. This field must be specified for the server to return all fields, including `SourceInfo`.</param>
		/// <param name="view">Specifies which parts of the Service Config should be returned in the response.</param>
		/// <returns>Successful response</returns>
		public async Task<Service> Servicemanagement_services_configs_getAsync(string serviceName, string configId, Servicemanagement_services_getConfigView view, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+"/configs/"+ (configId==null? "" : System.Uri.EscapeDataString(configId))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Servicemanagement_services_configs_submit v1/services/{serviceName}/configs:submit
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicemanagement_services_configs_submitAsync(string serviceName, SubmitConfigSourceRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+"/configs:submit";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Servicemanagement_services_rollouts_list v1/services/{serviceName}/rollouts
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <param name="filter">Required. Use `filter` to return subset of rollouts. The following filters are supported: -- By status. For example, `filter='status=SUCCESS'` -- By strategy. For example, `filter='strategy=TrafficPercentStrategy'`</param>
		/// <param name="pageSize">The max number of items to include in the response list. Page size is 50 if not specified. Maximum value is 100.</param>
		/// <param name="pageToken">The token of the page to retrieve.</param>
		/// <returns>Successful response</returns>
		public async Task<ListServiceRolloutsResponse> Servicemanagement_services_rollouts_listAsync(string serviceName, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+"/rollouts&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListServiceRolloutsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Servicemanagement_services_rollouts_create v1/services/{serviceName}/rollouts
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicemanagement_services_rollouts_createAsync(string serviceName, Rollout requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+"/rollouts";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Servicemanagement_services_rollouts_get v1/services/{serviceName}/rollouts/{rolloutId}
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <param name="rolloutId">Required. The id of the rollout resource.</param>
		/// <returns>Successful response</returns>
		public async Task<Rollout> Servicemanagement_services_rollouts_getAsync(string serviceName, string rolloutId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+"/rollouts/"+ (rolloutId==null? "" : System.Uri.EscapeDataString(rolloutId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Rollout>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Servicemanagement_services_undelete v1/services/{serviceName}:undelete
		/// </summary>
		/// <param name="serviceName">Required. The name of the service. See the [overview](https://cloud.google.com/service-management/overview) for naming requirements. For example: `example.googleapis.com`.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicemanagement_services_undeleteAsync(string serviceName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services/"+ (serviceName==null? "" : System.Uri.EscapeDataString(serviceName))+":undelete";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
		...
		/// Servicemanagement_services_generateConfigReport v1/services:generateConfigReport
		/// </summary>
		/// <returns>Successful response</returns>
		public async Task<GenerateConfigReportResponse> Servicemanagement_services_generateConfigReportAsync(GenerateConfigReportRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/services:generateConfigReport";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GenerateConfigReportResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Servicemanagement_operations_get v1/{name}
		/// </summary>
		/// <param name="name">The name of the operation resource.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicemanagement_operations_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Servicemanagement_services_consumers_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Servicemanagement_services_consumers_getIamPolicyAsync(string resource, GetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Servicemanagement_services_consumers_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Servicemanagement_services_consumers_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Servicemanagement_services_consumers_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<TestIamPermissionsResponse> Servicemanagement_services_consumers_testIamPermissionsAsync(string resource, TestIamPermissionsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
	...
	public enum Servicemanagement_services_getConfigView
	{
