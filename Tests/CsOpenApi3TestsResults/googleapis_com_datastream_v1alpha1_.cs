...
namespace MyNS
{
	...
	public class ConnectionProfile
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="noConnectivity")]
		public NoConnectivitySettings NoConnectivity { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class NoConnectivitySettings
	{
	}
	...
	public class PrivateConnectivity
	{
		...
		[System.Runtime.Serialization.DataMember(Name="privateConnectionName")]
	...
	public class DestinationConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="destinationConnectionProfileName")]
	...
	public class GcsDestinationConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="gcsFileFormat")]
		public System.Nullable<GcsDestinationConfigGcsFileFormat> GcsFileFormat { get; set; }
	...
	public class DiscoverConnectionProfileRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="recursionDepth")]
		public System.Nullable<System.Int32> RecursionDepth { get; set; }
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class FetchErrorsRequest
	{
	}
	...
	public class SourceConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="sourceConnectionProfileName")]
	...
	public class MysqlSourceConfig
	{
		...
		/// MySQL database structure
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="rejectlist")]
	...
	public class Validation
	{
		...
		public System.Nullable<ValidationStatus> Status { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// Datastream_projects_locations_streams_delete v1alpha1/{name}
		/// </summary>
		...
		/// Datastream_projects_locations_streams_objects_get v1alpha1/{name}
		/// </summary>
		...
		public async Task<StreamObject> Datastream_projects_locations_streams_objects_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<StreamObject>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_streams_patch v1alpha1/{name}
		/// </summary>
		/// <param name="name">Output only. The stream's name.</param>
		/// <param name="force">Optional. Execute the update without validating it.</param>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&force="+force+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask))+"&validateOnly="+validateOnly;
		...
		/// Datastream_projects_locations_list v1alpha1/{name}/locations
		/// </summary>
		...
		/// Datastream_projects_locations_operations_list v1alpha1/{name}/operations
		/// </summary>
		...
		/// Datastream_projects_locations_operations_cancel v1alpha1/{name}:cancel
		/// </summary>
		...
		/// Datastream_projects_locations_fetchStaticIps v1alpha1/{name}:fetchStaticIps
		/// </summary>
		/// <param name="name">Required. The name resource of the Response type. Must be in the format `projects/*/locations/*`.</param>
		...
		{
			var requestUri = "v1alpha1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":fetchStaticIps&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<FetchStaticIpsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_streams_objects_startBackfillJob v1alpha1/{object}:startBackfillJob
		/// </summary>
		/// <param name="_object">Required. The name of the stream object resource to start a backfill job for.</param>
		/// <returns>Successful response</returns>
		public async Task<StartBackfillJobResponse> Datastream_projects_locations_streams_objects_startBackfillJobAsync(string _object, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (_object==null? "" : System.Uri.EscapeDataString(_object))+":startBackfillJob";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<StartBackfillJobResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_streams_objects_stopBackfillJob v1alpha1/{object}:stopBackfillJob
		/// </summary>
		/// <param name="_object">Required. The name of the stream object resource to stop the backfill job for.</param>
		/// <returns>Successful response</returns>
		public async Task<StopBackfillJobResponse> Datastream_projects_locations_streams_objects_stopBackfillJobAsync(string _object, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (_object==null? "" : System.Uri.EscapeDataString(_object))+":stopBackfillJob";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var responseMessage = await httpClient.SendAsync(httpRequestMessage);
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<StopBackfillJobResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_connectionProfiles_list v1alpha1/{parent}/connectionProfiles
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/connectionProfiles&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListConnectionProfilesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_connectionProfiles_create v1alpha1/{parent}/connectionProfiles
		/// </summary>
		...
		/// <param name="requestId">Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Datastream_projects_locations_connectionProfiles_createAsync(string parent, string connectionProfileId, string requestId, ConnectionProfile requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/connectionProfiles&connectionProfileId=" + (connectionProfileId==null? "" : System.Uri.EscapeDataString(connectionProfileId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Datastream_projects_locations_connectionProfiles_discover v1alpha1/{parent}/connectionProfiles:discover
		/// </summary>
		/// <param name="parent">Required. The parent resource of the ConnectionProfile type. Must be in the format `projects/*/locations/*`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/connectionProfiles:discover";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DiscoverConnectionProfileResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_streams_objects_list v1alpha1/{parent}/objects
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/objects&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListStreamObjectsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_privateConnections_list v1alpha1/{parent}/privateConnections
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/privateConnections&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListPrivateConnectionsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_privateConnections_create v1alpha1/{parent}/privateConnections
		/// </summary>
		...
		/// <param name="requestId">Optional. A request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Datastream_projects_locations_privateConnections_createAsync(string parent, string privateConnectionId, string requestId, PrivateConnection requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/privateConnections&privateConnectionId=" + (privateConnectionId==null? "" : System.Uri.EscapeDataString(privateConnectionId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Datastream_projects_locations_privateConnections_routes_list v1alpha1/{parent}/routes
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/routes&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListRoutesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Datastream_projects_locations_privateConnections_routes_create v1alpha1/{parent}/routes
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/routes&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&routeId=" + (routeId==null? "" : System.Uri.EscapeDataString(routeId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Datastream_projects_locations_streams_list v1alpha1/{parent}/streams
		/// </summary>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/streams&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&orderBy=" + (orderBy==null? "" : System.Uri.EscapeDataString(orderBy))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Datastream_projects_locations_streams_create v1alpha1/{parent}/streams
		/// </summary>
		/// <param name="parent">Required. The parent that owns the collection of streams.</param>
		...
		/// <param name="validateOnly">Optional. Only validate the stream, but do not create any resources. The default is false.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1alpha1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/streams&force="+force+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId))+"&streamId=" + (streamId==null? "" : System.Uri.EscapeDataString(streamId))+"&validateOnly="+validateOnly;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Datastream_projects_locations_streams_fetchErrors v1alpha1/{stream}:fetchErrors
		/// </summary>
		/// <param name="stream">Name of the Stream resource for which to fetch any errors.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Datastream_projects_locations_streams_fetchErrorsAsync(string stream, FetchErrorsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1alpha1/"+ (stream==null? "" : System.Uri.EscapeDataString(stream))+":fetchErrors";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
