...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="OpenIDConnectProviderArn">The Amazon Resource Name (ARN) of the IAM OpenID Connect (OIDC) provider resource to add the client ID to. You can get a list of OIDC provider ARNs by using the <a>ListOpenIDConnectProviders</a> operation.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <param name="ClientID">The client ID (also known as audience) to add to the IAM OpenID Connect provider resource.
		/// Min length: 1
		/// Max length: 255
		// </param>
		...
		/// Max length: 128
		// </param>
		/// <param name="RoleName"><p>The name of the role to add.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="GroupName"><p>The name of the group to update.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="UserName"><p>The name of the user to add.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="PolicyArn"><p>The Amazon Resource Name (ARN) of the IAM policy you want to attach.</p> <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p>
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="OldPassword">The IAM user's current password.
		/// Min length: 1
		/// Max length: 128
		// </param>
		...
		/// </summary>
		/// <param name="AccountAlias"><p>The account alias to create.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of lowercase letters, digits, and dashes. You cannot start or finish with a dash, nor can you have two dashes in a row.</p>
		/// Min length: 3
		/// Max length: 63
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 512
		// </param>
		/// <param name="GroupName"><p>The name of the group to create. Do not include the path in this value.</p> <p>IAM user, group, role, and policy names must be unique within the account. Names are not distinguished by case. For example, you cannot create resources named both "MyResource" and "myresource".</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="PolicyName"><p>The friendly name of the policy.</p> <p>IAM user, group, role, and policy names must be unique within the account. Names are not distinguished by case. For example, you cannot create resources named both "MyResource" and "myresource".</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		...
		/// Max length: 131072
		// </param>
		/// <param name="Description"><p>A friendly description of the policy.</p> <p>Typically used to store information about the permissions defined in the policy. For example, "Grants access to production DynamoDB tables."</p> <p>The policy description is immutable. After a value is assigned, it cannot be changed.</p>
		/// Max length: 1000
		// </param>
		...
		/// Max length: 131072
		// </param>
		/// <param name="Description">A description of the role.
		/// Max length: 1000
		// </param>
		...
		/// Max length: 10000000
		// </param>
		/// <param name="Name"><p>The name of the provider to create.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		...
		/// Max length: 128
		// </param>
		/// <param name="Description">The description of the role.
		/// Max length: 1000
		// </param>
		...
		/// Max length: 512
		// </param>
		/// <param name="UserName"><p>The name of the user to create.</p> <p>IAM user, group, role, and policy names must be unique within the account. Names are not distinguished by case. For example, you cannot create resources named both "MyResource" and "myresource".</p>
		/// Min length: 1
		/// Max length: 64
		// </param>
		...
		/// Max length: 128
		// </param>
		/// <param name="AccessKeyId"><p>The access key ID for the access key ID and secret access key you want to delete.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that can consist of any upper or lowercased letter or digit.</p>
		/// Min length: 16
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="OpenIDConnectProviderArn">The Amazon Resource Name (ARN) of the IAM OpenID Connect provider resource object to delete. You can get a list of OpenID Connect provider resource ARNs by using the <a>ListOpenIDConnectProviders</a> operation.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="PolicyArn"><p>The Amazon Resource Name (ARN) of the IAM policy you want to delete.</p> <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p>
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="RoleName"><p>The name of the role to delete.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="RoleName">The name (friendly name, not ARN) of the IAM role from which you want to remove the permissions boundary.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="SAMLProviderArn">The Amazon Resource Name (ARN) of the SAML provider to delete.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 64
		// </param>
		/// <param name="SSHPublicKeyId"><p>The unique identifier for the SSH public key.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that can consist of any upper or lowercased letter or digit.</p>
		/// Min length: 20
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="RoleName">The name of the service-linked role to be deleted.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="CertificateId"><p>The ID of the signing certificate to delete.</p> <p>The format of this parameter, as described by its <a href="http://wikipedia.org/wiki/regex">regex</a> pattern, is a string of characters that can be upper- or lower-cased letters or digits.</p>
		/// Min length: 24
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="UserName"><p>The name of the user to delete.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="UserName">The name (friendly name, not ARN) of the IAM user from which you want to remove the permissions boundary.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="PolicyArn"><p>The Amazon Resource Name (ARN) of the IAM policy you want to detach.</p> <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p>
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Arn">The ARN of the IAM resource (user, group, role, or managed policy) used to generate information about when the resource was last used in an attempt to access an Amazon Web Services service.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		...
		/// </summary>
		/// <param name="AccessKeyId"><p>The identifier of an access key.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that can consist of any upper or lowercased letter or digit.</p>
		/// Min length: 16
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// Maximum: 1000
		// </param>
		/// <param name="Marker">Use this parameter only when paginating results and only after you receive a response indicating that the results are truncated. Set it to the value of the <code>Marker</code> element in the response that you received to indicate where the next call should start.
		/// Min length: 1
		/// Max length: 320
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="GroupName"><p>The name of the group.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="Marker">Use this parameter only when paginating results and only after you receive a response indicating that the results are truncated. Set it to the value of the <code>Marker</code> element in the response that you received to indicate where the next call should start.
		...
		/// </summary>
		/// <param name="SerialNumber">Serial number that uniquely identifies the MFA device. For this API, we only accept FIDO security key <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference-arns.html">ARNs</a>.
		/// Min length: 9
		/// Max length: 256
		// </param>
		/// <param name="UserName">The friendly name identifying the user.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="JobId">The identifier of the request generated by the <a>GenerateOrganizationsAccessReport</a> operation.
		/// Min length: 36
		/// Max length: 36
		// </param>
		/// <param name="MaxItems"><p>Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the <code>IsTruncated</code> response element is <code>true</code>.</p> <p>If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the <code>IsTruncated</code> response element returns <code>true</code>, and <code>Marker</code> contains a value to include in the subsequent call that tells the service where to continue from.</p>
		...
		/// </summary>
		/// <param name="JobId">The ID of the request generated by the <code>GenerateServiceLastAccessedDetails</code> operation.
		/// Min length: 36
		/// Max length: 36
		// </param>
		...
		/// </summary>
		/// <param name="DeletionTaskId">The deletion task identifier. This identifier is returned by the <a>DeleteServiceLinkedRole</a> operation in the format <code>task/aws-service-role/&lt;service-principal-name&gt;/&lt;role-name&gt;/&lt;task-uuid&gt;</code>.
		/// Min length: 1
		/// Max length: 1000
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="UserName"><p>The name of the user.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="Marker">Use this parameter only when paginating results and only after you receive a response indicating that the results are truncated. Set it to the value of the <code>Marker</code> element in the response that you received to indicate where the next call should start.
		...
		/// Max length: 320
		// </param>
		/// <param name="Arn">The ARN of the IAM identity (user, group, or role) whose policies you want to list.
		/// Min length: 20
		/// Max length: 2048
		// </param>
		...
		/// Max length: 128
		// </param>
		/// <param name="PolicyName"><p>The name of the policy document.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		...
		/// </summary>
		/// <param name="RoleName">The name (friendly name, not ARN) of the IAM role for which you want to set the permissions boundary.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <param name="PermissionsBoundary"><p>The ARN of the managed policy that is used to set the permissions boundary for the role.</p> <p>A permissions boundary policy defines the maximum permissions that identity-based policies can grant to an entity, but does not grant permissions. Permissions boundaries do not define the maximum permissions that a resource-based policy can grant to an entity. To learn more, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM entities</a> in the <i>IAM User Guide</i>.</p> <p>For more information about policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#access_policy-types">Policy types </a> in the <i>IAM User Guide</i>.</p>
		...
		/// </summary>
		/// <param name="UserName">The name (friendly name, not ARN) of the IAM user for which you want to set the permissions boundary.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <param name="PermissionsBoundary"><p>The ARN of the managed policy that is used to set the permissions boundary for the user.</p> <p>A permissions boundary policy defines the maximum permissions that identity-based policies can grant to an entity, but does not grant permissions. Permissions boundaries do not define the maximum permissions that a resource-based policy can grant to an entity. To learn more, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM entities</a> in the <i>IAM User Guide</i>.</p> <p>For more information about policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html#access_policy-types">Policy types </a> in the <i>IAM User Guide</i>.</p>
		...
		/// Max length: 2048
		// </param>
		/// <param name="ClientID">The client ID (also known as audience) to remove from the IAM OIDC provider resource. For more information about client IDs, see <a>CreateOpenIDConnectProvider</a>.
		/// Min length: 1
		/// Max length: 255
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="RoleName"><p>The name of the role to remove.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="UserName"><p>The name of the user to remove.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 64
		// </param>
		/// <param name="ServiceSpecificCredentialId"><p>The unique identifier of the service-specific credential.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that can consist of any upper or lowercased letter or digit.</p>
		/// Min length: 20
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 256
		// </param>
		/// <param name="AuthenticationCode1"><p>An authentication code emitted by the device.</p> <p>The format for this parameter is a sequence of six digits.</p>
		/// Min length: 6
		/// Max length: 6
		// </param>
		/// <param name="AuthenticationCode2"><p>A subsequent authentication code emitted by the device.</p> <p>The format for this parameter is a sequence of six digits.</p>
		/// Min length: 6
		/// Max length: 6
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="Tags">The list of tags that you want to attach to the IAM instance profile. Each tag consists of a key name and an associated value.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 256
		// </param>
		/// <param name="Tags">The list of tags that you want to attach to the IAM virtual MFA device. Each tag consists of a key name and an associated value.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 2048
		// </param>
		/// <param name="Tags">The list of tags that you want to attach to the OIDC identity provider in IAM. Each tag consists of a key name and an associated value.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 2048
		// </param>
		/// <param name="Tags">The list of tags that you want to attach to the IAM customer managed policy. Each tag consists of a key name and an associated value.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 64
		// </param>
		/// <param name="Tags">The list of tags that you want to attach to the IAM role. Each tag consists of a key name and an associated value.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 2048
		// </param>
		/// <param name="Tags">The list of tags that you want to attach to the SAML identity provider in IAM. Each tag consists of a key name and an associated value.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="Tags">The list of tags that you want to attach to the IAM server certificate. Each tag consists of a key name and an associated value.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="Tags">The list of tags that you want to attach to the IAM user. Each tag consists of a key name and an associated value.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="TagKeys">A list of key names as a simple array of strings. The tags with matching keys are removed from the specified instance profile.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 2048
		// </param>
		/// <param name="TagKeys">A list of key names as a simple array of strings. The tags with matching keys are removed from the specified OIDC provider.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 2048
		// </param>
		/// <param name="TagKeys">A list of key names as a simple array of strings. The tags with matching keys are removed from the specified policy.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 64
		// </param>
		/// <param name="TagKeys">A list of key names as a simple array of strings. The tags with matching keys are removed from the specified role.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 2048
		// </param>
		/// <param name="TagKeys">A list of key names as a simple array of strings. The tags with matching keys are removed from the specified SAML identity provider.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="TagKeys">A list of key names as a simple array of strings. The tags with matching keys are removed from the specified IAM server certificate.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="TagKeys">A list of key names as a simple array of strings. The tags with matching keys are removed from the specified user.
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="AccessKeyId"><p>The access key ID of the secret access key you want to update.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that can consist of any upper or lowercased letter or digit.</p>
		/// Min length: 16
		/// Max length: 128
		// </param>
		...
		/// </summary>
		/// <param name="MinimumPasswordLength"><p>The minimum number of characters allowed in an IAM user password.</p> <p>If you do not specify a value for this parameter, then the operation uses the default value of <code>6</code>.</p>
		/// Minimum: 6
		/// Maximum: 128
		// </param>
		...
		/// <param name="MaxPasswordAge"><p>The number of days that an IAM user password is valid.</p> <p>If you do not specify a value for this parameter, then the operation uses the default value of <code>0</code>. The result is that IAM user passwords never expire.</p>
		/// Minimum: 1
		/// Maximum: 1095
		// </param>
		...
		/// Max length: 512
		// </param>
		/// <param name="NewGroupName"><p>New name for the IAM group. Only include this if changing the group's name.</p> <p>IAM user, group, role, and policy names must be unique within the account. Names are not distinguished by case. For example, you cannot create resources named both "MyResource" and "myresource".</p>
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="RoleName">The name of the role that you want to modify.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <param name="Description">The new description that you want to apply to the specified role.
		/// Max length: 1000
		// </param>
		/// <param name="MaxSessionDuration"><p>The maximum session duration (in seconds) that you want to set for the specified role. If you do not specify a value for this setting, the default value of one hour is applied. This setting can have a value from 1 hour to 12 hours.</p> <p>Anyone who assumes the role from the CLI or API can use the <code>DurationSeconds</code> API parameter or the <code>duration-seconds</code> CLI parameter to request a longer session. The <code>MaxSessionDuration</code> setting determines the maximum duration that can be requested using the <code>DurationSeconds</code> parameter. If users don't specify a value for the <code>DurationSeconds</code> parameter, their security credentials are valid for one hour by default. This applies when you use the <code>AssumeRole*</code> API operations or the <code>assume-role*</code> CLI operations but does not apply when you use those operations to create a console URL. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use.html">Using IAM roles</a> in the <i>IAM User Guide</i>.</p>
		/// Minimum: 3600
		...
		/// Max length: 10000000
		// </param>
		/// <param name="SAMLProviderArn"><p>The Amazon Resource Name (ARN) of the SAML provider to update.</p> <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p>
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 128
		// </param>
		/// <param name="CertificateId"><p>The ID of the signing certificate you want to update.</p> <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that can consist of any upper or lowercased letter or digit.</p>
		/// Min length: 24
		/// Max length: 128
		// </param>
		...
		/// Max length: 512
		// </param>
		/// <param name="NewUserName"><p>New name for the user. Include this parameter only if you're changing the user's name.</p> <p>IAM user, group, role, and policy names must be unique within the account. Names are not distinguished by case. For example, you cannot create resources named both "MyResource" and "myresource".</p>
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
