...
namespace MyNS
{
	...
	public class PagespeedApiFormatStringV2
	{
		...
		public PagespeedApiFormatStringV2Args[] PagespeedApiFormatStringV2Args { get; set; }
	...
	public class PagespeedApiFormatStringV2Args
	{
		...
		public PagespeedApiFormatStringV2ArgsRects[] PagespeedApiFormatStringV2ArgsRects { get; set; }
		...
		public PagespeedApiFormatStringV2ArgsSecondary_rects[] PagespeedApiFormatStringV2ArgsSecondary_rects { get; set; }
	...
	public class PagespeedApiFormatStringV2ArgsSecondary_rects
	{
	...
	public class PagespeedApiImageV2
	{
		...
		public PagespeedApiImageV2Page_rect Page_rect { get; set; }
	...
	public class PagespeedApiImageV2Page_rect
	{
	...
	public class Result
	{
		...
		public ResultFormattedResults FormattedResults { get; set; }
		...
		public ResultPageStats PageStats { get; set; }
		...
		public System.Collections.Generic.Dictionary<string, ResultRuleGroups> RuleGroups { get; set; }
		
		[System.Runtime.Serialization.DataMember(Name="screenshot")]
		public PagespeedApiImageV2 Screenshot { get; set; }
		...
		public ResultVersion Version { get; set; }
	}
	...
	public class ResultFormattedResults
	{
		...
		public System.Collections.Generic.Dictionary<string, ResultFormattedResultsRuleResults> RuleResults { get; set; }
	}
	...
	public class ResultFormattedResultsRuleResults
	{
		...
		public PagespeedApiFormatStringV2 Summary { get; set; }
		
		/// <summary>
		/// List of blocks of URLs. Each block may contain a heading and a list of URLs. Each URL may optionally include additional details.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="urlBlocks")]
		public ResultFormattedResultsRuleResultsUrlBlocks[] ResultFormattedResultsRuleResultsUrlBlocks { get; set; }
	}
	...
	public class ResultFormattedResultsRuleResultsUrlBlocks
	{
		...
		public PagespeedApiFormatStringV2 Header { get; set; }
		
		/// <summary>
		/// List of entries that provide information about URLs in the url block. Optional.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="urls")]
		public ResultFormattedResultsRuleResultsUrlBlocksUrls[] ResultFormattedResultsRuleResultsUrlBlocksUrls { get; set; }
	}
	...
	public class ResultFormattedResultsRuleResultsUrlBlocksUrls
	{
		...
		public PagespeedApiFormatStringV2[] Details { get; set; }
		
		[System.Runtime.Serialization.DataMember(Name="result")]
		public PagespeedApiFormatStringV2 Result { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// <param name="strategy">The analysis strategy to use</param>
		/// <returns>Successful response</returns>
		public async Task Pagespeedonline_pagespeedapi_runpagespeedAsync(string url, bool filter_third_party_resources, string locale, string[] rule, bool screenshot, Pagespeedonline_pagespeedapi_runpagespeedStrategy strategy, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "runPagespeed?url=" + (url==null? "" : System.Uri.EscapeDataString(url))+"&filter_third_party_resources="+filter_third_party_resources+"&locale=" + (locale==null? "" : System.Uri.EscapeDataString(locale))+"&"+string.Join("&", rule.Select(z => $"rule={System.Uri.EscapeDataString(z.ToString())}"))+"&screenshot="+screenshot+"&strategy=" + strategy;
