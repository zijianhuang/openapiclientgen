...
namespace MyNS
{
	...
	public class Connector
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="lastRestartTime")]
	...
	public partial class Misc
	{
		...
		/// Vpcaccess_projects_locations_connectors_delete v1beta1/{name}
		/// </summary>
		...
		/// Vpcaccess_projects_locations_operations_get v1beta1/{name}
		/// </summary>
		...
		/// Vpcaccess_projects_locations_connectors_patch v1beta1/{name}
		/// </summary>
		...
		/// Vpcaccess_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// Vpcaccess_projects_locations_operations_list v1beta1/{name}/operations
		/// </summary>
		...
		/// Vpcaccess_projects_locations_connectors_list v1beta1/{parent}/connectors
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/connectors&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Vpcaccess_projects_locations_connectors_create v1beta1/{parent}/connectors
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/connectors&connectorId=" + (connectorId==null? "" : System.Uri.EscapeDataString(connectorId));
