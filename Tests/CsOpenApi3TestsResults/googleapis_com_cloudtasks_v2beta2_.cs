...
namespace MyNS
{
	...
	public class Task_
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pullMessage")]
		public PullMessage PullMessage { get; set; }
	...
	public class TaskStatus
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="attemptDispatchCount")]
		public System.Nullable<System.Int32> AttemptDispatchCount { get; set; }
		
		/// <summary>
		/// Output only. The number of attempts which have received a response. This field is not calculated for pull tasks.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="attemptResponseCount")]
		public System.Nullable<System.Int32> AttemptResponseCount { get; set; }
		
		/// <summary>
		/// The status of a task attempt.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="firstAttemptStatus")]
		public AttemptStatus FirstAttemptStatus { get; set; }
		
		/// <summary>
		/// The status of a task attempt.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="lastAttemptStatus")]
	...
	public class LeaseTasksRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maxTasks")]
		public System.Nullable<System.Int32> MaxTasks { get; set; }
	...
	public class Queue
	{
		...
		/// App Engine HTTP target. The task will be delivered to the App Engine application hostname specified by its AppEngineHttpTarget and AppEngineHttpRequest. The documentation for AppEngineHttpRequest explains how the task's host URL is constructed. Using AppEngineHttpTarget requires [`appengine.applications.get`](https://cloud.google.com/appengine/docs/admin-api/access-control) Google IAM permission for the project and the following scope: `https://www.googleapis.com/auth/cloud-platform`
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="appEngineHttpTarget")]
		public AppEngineHttpTarget AppEngineHttpTarget { get; set; }
		...
		/// Pull target.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="pullTarget")]
		public PullTarget PullTarget { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="taskTtl")]
		public string TaskTtl { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="tombstoneTtl")]
		public string TombstoneTtl { get; set; }
	}
	...
	public class RateLimits
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maxConcurrentTasks")]
		public System.Nullable<System.Int32> MaxConcurrentTasks { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="maxTasksDispatchedPerSecond")]
		public System.Nullable<System.Double> MaxTasksDispatchedPerSecond { get; set; }
	}
	...
	public class RetryConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="unlimitedAttempts")]
		public System.Nullable<System.Boolean> UnlimitedAttempts { get; set; }
	}
	...
	public class QueueStats
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="concurrentDispatchesCount")]
		public string ConcurrentDispatchesCount { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="effectiveExecutionRate")]
		public System.Nullable<System.Double> EffectiveExecutionRate { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="executedLastMinuteCount")]
		public string ExecutedLastMinuteCount { get; set; }
		
		/// <summary>
		/// Output only. An estimation of the nearest time in the future where a task in the queue is scheduled to be executed.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="oldestEstimatedArrivalTime")]
		public string OldestEstimatedArrivalTime { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="tasksCount")]
	...
	public partial class Misc
	{
		...
		/// Cloudtasks_api_queue_update api/queue/update
		/// </summary>
		/// <param name="appId">Required. The App ID is supplied as an HTTP parameter. Unlike internal usage of App ID, it does not include a region prefix. Rather, the App ID represents the Project ID against which to make the request.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Cloudtasks_api_queue_updateAsync(string appId, HttpBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "api/queue/update?appId=" + (appId==null? "" : System.Uri.EscapeDataString(appId));
		...
		/// Cloudtasks_projects_locations_queues_tasks_delete v2beta2/{name}
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// <summary>
		/// Gets a task.
		/// Cloudtasks_projects_locations_queues_tasks_get v2beta2/{name}
		/// </summary>
		/// <param name="name">Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`</param>
		...
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&responseView=" + responseView;
		...
		/// Cloudtasks_projects_locations_queues_patch v2beta2/{name}
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Queue>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudtasks_projects_locations_list v2beta2/{name}/locations
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/locations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudtasks_projects_locations_queues_tasks_acknowledge v2beta2/{name}:acknowledge
		/// </summary>
		/// <param name="name">Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Cloudtasks_projects_locations_queues_tasks_acknowledgeAsync(string name, AcknowledgeTaskRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":acknowledge";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_tasks_cancelLease v2beta2/{name}:cancelLease
		/// </summary>
		/// <param name="name">Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`</param>
		/// <returns>Successful response</returns>
		public async Task<Task_> Cloudtasks_projects_locations_queues_tasks_cancelLeaseAsync(string name, CancelLeaseRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":cancelLease";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_pause v2beta2/{name}:pause
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":pause";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_purge v2beta2/{name}:purge
		/// </summary>
		/// <param name="name">Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":purge";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_tasks_renewLease v2beta2/{name}:renewLease
		/// </summary>
		/// <param name="name">Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`</param>
		/// <returns>Successful response</returns>
		public async Task<Task_> Cloudtasks_projects_locations_queues_tasks_renewLeaseAsync(string name, RenewLeaseRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":renewLease";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_resume v2beta2/{name}:resume
		/// </summary>
		/// <param name="name">Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":resume";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_tasks_run v2beta2/{name}:run
		/// </summary>
		/// <param name="name">Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2beta2/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":run";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_list v2beta2/{parent}/queues
		/// </summary>
		/// <param name="parent">Required. The location name. For example: `projects/PROJECT_ID/locations/LOCATION_ID`</param>
		/// <param name="filter">`filter` can be used to specify a subset of queues. Any Queue field can be used as a filter and several operators as supported. For example: `<=, <, >=, >, !=, =, :`. The filter syntax is the same as described in [Stackdriver's Advanced Logs Filters](https://cloud.google.com/logging/docs/view/advanced_filters). Sample filter "app_engine_http_target: *". Note that using filters might cause fewer queues than the requested_page size to be returned.</param>
		...
		/// <param name="readMask">Optional. Read mask is used for a more granular control over what the API returns. If the mask is not present all fields will be returned except [Queue.stats]. [Queue.stats] will be returned only if it was explicitly specified in the mask.</param>
		/// <returns>Successful response</returns>
		public async Task<ListQueuesResponse> Cloudtasks_projects_locations_queues_listAsync(string parent, string filter, int pageSize, string pageToken, string readMask, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/queues&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&readMask=" + (readMask==null? "" : System.Uri.EscapeDataString(readMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudtasks_projects_locations_queues_create v2beta2/{parent}/queues
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/queues";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_tasks_list v2beta2/{parent}/tasks
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tasks&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&responseView=" + responseView;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListTasksResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudtasks_projects_locations_queues_tasks_create v2beta2/{parent}/tasks
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tasks";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_tasks_lease v2beta2/{parent}/tasks:lease
		/// </summary>
		/// <param name="parent">Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`</param>
		/// <returns>Successful response</returns>
		public async Task<LeaseTasksResponse> Cloudtasks_projects_locations_queues_tasks_leaseAsync(string parent, LeaseTasksRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v2beta2/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/tasks:lease";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<LeaseTasksResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudtasks_projects_locations_queues_tasks_buffer v2beta2/{queue}/tasks/{taskId}:buffer
		/// </summary>
		...
		/// <param name="taskId">Optional. Task ID for the task being created. If not provided, a random task ID is assigned to the task.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v2beta2/"+ (queue==null? "" : System.Uri.EscapeDataString(queue))+"/tasks/"+ (taskId==null? "" : System.Uri.EscapeDataString(taskId))+":buffer";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<BufferTaskResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Cloudtasks_projects_locations_queues_getIamPolicy v2beta2/{resource}:getIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":getIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_setIamPolicy v2beta2/{resource}:setIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":setIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudtasks_projects_locations_queues_testIamPermissions v2beta2/{resource}:testIamPermissions
		/// </summary>
		...
		{
			var requestUri = "v2beta2/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":testIamPermissions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
