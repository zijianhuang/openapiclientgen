...
namespace MyNS
{
	...
	public class DefaultData
	{
		...
		[System.ComponentModel.DataAnnotations.MaxLength(2097152)]
		public string[] Names { get; set; }
		
		/// <summary>
		/// Maximum items: 2097152
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="ndarray")]
		[System.ComponentModel.DataAnnotations.MaxLength(2097152)]
		public AnyValue[] Ndarray { get; set; }
	...
	public class TensorflowTensorProto
	{
		...
		[System.ComponentModel.DataAnnotations.MaxLength(2097152)]
		[System.ComponentModel.DataAnnotations.RegularExpressionAttribute(@"^.{1,2097152}")]
		...
		[System.ComponentModel.DataAnnotations.RegularExpressionAttribute(@".* maxLength: 2097152")]
	...
	public partial class Misc
	{
		...
		/// <summary>
		/// SendFeedback seldon/{namespace}/{deployment}/api/v1.0/feedback
		/// </summary>
		/// <param name="_namespace">Max length: 2097152</param>
		/// <param name="deployment">Max length: 2097152</param>
		/// <returns>A successful response.</returns>
		public async Task<SeldonMessage> SendFeedbackAsync(string _namespace, string deployment, Feedback requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "seldon/"+ (_namespace==null? "" : System.Uri.EscapeDataString(_namespace))+"/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"/api/v1.0/feedback";
		...
		/// <summary>
		/// Predict seldon/{namespace}/{deployment}/api/v1.0/predictions
		/// </summary>
		/// <param name="_namespace">Max length: 2097152</param>
		/// <param name="deployment">Max length: 2097152</param>
		/// <returns>A successful response.</returns>
		public async Task<SeldonMessage> PredictAsync(string _namespace, string deployment, SeldonMessage requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "seldon/"+ (_namespace==null? "" : System.Uri.EscapeDataString(_namespace))+"/"+ (deployment==null? "" : System.Uri.EscapeDataString(deployment))+"/api/v1.0/predictions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
