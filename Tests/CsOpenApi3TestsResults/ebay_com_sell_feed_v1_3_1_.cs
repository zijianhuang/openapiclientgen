...
namespace MyNS
{
	...
	public class CreateInventoryTaskRequest
	{
		...
		public InventoryFilterCriteria FilterCriteria { get; set; }
	...
	public class InventoryFilterCriteria
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="listingFormat")]
	...
	public class CreateOrderTaskRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="filterCriteria")]
		public OrderFilterCriteria FilterCriteria { get; set; }
	...
	public class OrderFilterCriteria
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="creationDateRange")]
		public DateRange CreationDateRange { get; set; }
		
		/// <summary>
		/// The type that defines the fields for a date range.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="modifiedDateRange")]
		public DateRange ModifiedDateRange { get; set; }
	...
	public class CreateServiceMetricsTaskRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="filterCriteria")]
		public CustomerServiceMetricsFilterCriteria FilterCriteria { get; set; }
	...
	public class CustomerServiceMetricsFilterCriteria
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="customerServiceMetricType")]
		public string CustomerServiceMetricType { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="evaluationMarketplaceId")]
		public string EvaluationMarketplaceId { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="listingCategories")]
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="shippingRegions")]
		public string[] ShippingRegions { get; set; }
	}
	...
	public class CreateUserScheduleRequest
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="preferredTriggerDayOfMonth")]
		public System.Nullable<System.Int32> PreferredTriggerDayOfMonth { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="preferredTriggerDayOfWeek")]
		public string PreferredTriggerDayOfWeek { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="preferredTriggerHour")]
		public string PreferredTriggerHour { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="scheduleTemplateId")]
	...
	public class CustomerServiceMetricTaskCollection
	{
		...
		public ServiceMetricsTask[] Tasks { get; set; }
	...
	public class ServiceMetricsTask
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="detailHref")]
	...
	public class FormDataContentDisposition
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="readDate")]
	...
	public class InventoryTask
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="uploadSummary")]
	...
	public class InventoryTaskCollection
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="tasks")]
		public InventoryTask[] Tasks { get; set; }
	...
	public class OrderTaskCollection
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="tasks")]
		public OrderTask[] Tasks { get; set; }
	...
	public class ScheduleTemplateCollection
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="scheduleTemplates")]
		public ScheduleTemplateResponse[] ScheduleTemplates { get; set; }
	...
	public class ScheduleTemplateResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="supportedConfigurations")]
		public SupportedConfiguration[] SupportedConfigurations { get; set; }
	}
	...
	public class UserScheduleCollection
	{
		...
		public UserScheduleResponse[] Schedules { get; set; }
	...
	public partial class Misc
	{
		...
		/// GetCustomerServiceMetricTasks customer_service_metric_task
		/// </summary>
		/// <param name="date_range">The task creation date range. The results are filtered to include only tasks with a creation date that is equal to the dates specified or is within the specified range. Do not use with the <code>look_back_days</code> parameter.<p><strong>Format: </strong>UTC</p><p>For example, tasks within a range: </p><p><code>yyyy-MM-ddThh:mm:ss.SSSZ..yyyy-MM-ddThh:mm:ss.SSSZ </code></p><p>Tasks created on March 8, 2020</p><p><code>2020-03-08T00:00.00.000Z..2020-03-09T00:00:00.000Z</code></p><p><b>Maximum: </b>90 days</p></param>
		/// <param name="feed_type">The feed type associated with the task. The only presently supported value is <code>CUSTOMER_SERVICE_METRICS_REPORT</code>.</param>
		/// <param name="limit">The number of customer service metric tasks to return per page of the result set. Use this parameter in conjunction with the offset parameter to control the pagination of the output. <p>For example, if <strong>offset</strong> is set to 10 and <strong>limit</strong> is set to 10, the call retrieves tasks 11 thru 20 from the result set.</p><p>If this parameter is omitted, the default value is used.</p><p> <span class="tablenote"><strong>Note:</strong>This feature employs a zero-based list, where the first item in the list has an offset of <code>0</code>.</span></p><p><b>Default:</b> 10 <p><b>Maximum:</b> 500</p></param>
		/// <param name="look_back_days">The number of previous days in which to search for tasks. Do not use with the <code>date_range</code> parameter. If both <code>date_range</code> and <code>look_back_days</code> are omitted, this parameter's default value is used. <p><b>Default value:</b> 7</p><p><b>Range:</b> 1-90 (inclusive)</p></param>
		/// <param name="offset">The number of customer service metric tasks to skip in the result set before returning the first task in the paginated response. <p>Combine <strong>offset</strong> with the <strong>limit</strong> query parameter to control the items returned in the response. For example, if you supply an <strong>offset</strong> of <code>0</code> and a <strong>limit</strong> of <code>10</code>, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If <strong>offset</strong> is <code>10</code> and <strong>limit</strong> is <code>20</code>, the first page of the response contains items 11-30 from the complete result set. <br /><br /><b>Default: </b>0</param>
		/// <returns>Success</returns>
		public async Task<CustomerServiceMetricTaskCollection> GetCustomerServiceMetricTasksAsync(string date_range, string feed_type, string limit, string look_back_days, string offset, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "customer_service_metric_task?date_range=" + (date_range==null? "" : System.Uri.EscapeDataString(date_range))+"&feed_type=" + (feed_type==null? "" : System.Uri.EscapeDataString(feed_type))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&look_back_days=" + (look_back_days==null? "" : System.Uri.EscapeDataString(look_back_days))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<CustomerServiceMetricTaskCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// CreateCustomerServiceMetricTask customer_service_metric_task
		/// </summary>
		/// <param name="requestBody">Request payload containing version, feedType, and optional filterCriteria.</param>
		public async Task CreateCustomerServiceMetricTaskAsync(CreateServiceMetricsTaskRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "customer_service_metric_task";
		...
		/// GetCustomerServiceMetricTask customer_service_metric_task/{task_id}
		/// </summary>
		/// <param name="task_id">Use this path parameter to specify the task ID value for the customer service metric task to retrieve.</param>
		/// <returns>Success</returns>
		public async Task<ServiceMetricsTask> GetCustomerServiceMetricTaskAsync(string task_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "customer_service_metric_task/"+ (task_id==null? "" : System.Uri.EscapeDataString(task_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ServiceMetricsTask>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// GetInventoryTasks inventory_task
		/// </summary>
		/// <param name="feed_type">The feed type associated with the inventory task. Either <strong>feed_type</strong> or <strong>schedule_id</strong> is required. Do not use with the <strong>schedule_id</strong> parameter. Presently, only one feed type is available:<ul><li><code>LMS_ACTIVE_INVENTORY_REPORT</code></li></ul></param>
		/// <param name="schedule_id">The ID of the schedule for which to retrieve the latest result file. This ID is generated when the schedule was created by the <strong>createSchedule</strong> method. Schedules apply to downloaded reports (<code>LMS_ACTIVE_INVENTORY_REPORT</code>). Either <strong>schedule_id</strong> or <strong>feed_type</strong> is  required. Do not use with the <strong>feed_type</strong> parameter.</param>
		/// <param name="look_back_days">The number of previous days in which to search for tasks. Do not use with the <code>date_range</code> parameter. If both <code>date_range</code> and <code>look_back_days</code> are omitted, this parameter's default value is used.  <br /><br /><b>Default: </b> 7 <br /><br /><b>Range: </b> 1-90 (inclusive)</param>
		/// <param name="date_range">Specifies the range of task creation dates used to filter the results. The results are filtered to include only tasks with a creation date that is equal to this date or is within specified range. <p> <span class="tablenote"><strong>Note:</strong> Maximum date range window size is 90 days.</span></p><br /><b>Valid Format (UTC): </b><code>yyyy-MM-ddThh:mm:ss.SSSZ..yyyy-MM-ddThh:mm:ss.SSSZ</code><br /><br />For example: Tasks created on March 31, 2021<br /> <code>2021-03-31T00:00:00.000Z..2021-03-31T00:00:00.000Z</code><br /><br /></param>
		/// <param name="limit">The maximum number of tasks that can be returned on each page of the paginated response. Use this parameter in conjunction with the <strong>offset</strong> parameter to control the pagination of the output. <p> <span class="tablenote"><strong>Note:</strong> This feature employs a zero-based list, where the first item in the list has an offset of <code>0</code>.</span></p><p>For example, if <strong>offset</strong> is set to 10 and <strong>limit</strong> is set to 10, the call retrieves tasks 11 thru 20 from the result set.</p><p>If this parameter is omitted, the default value is used. <br /><br /><b>Default: </b> 10 <br /><br /><b>Maximum: </b>500</param>
		/// <param name="offset">The number of tasks to skip in the result set before returning the first task in the paginated response. <p>Combine <strong>offset</strong> with the <strong>limit</strong> query parameter to control the items returned in the response. For example, if you supply an <strong>offset</strong> of <code>0</code> and a <strong>limit</strong> of <code>10</code>, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If <strong>offset</strong> is <code>10</code> and <strong>limit</strong> is <code>20</code>, the first page of the response contains items 11-30 from the complete result set. If this query parameter is not set, the default value is used and the first page of records is returned. <br /><br /><b>Default: </b>0</param>
		/// <returns>Success</returns>
		public async Task<InventoryTaskCollection> GetInventoryTasksAsync(string feed_type, string schedule_id, string look_back_days, string date_range, string limit, string offset, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "inventory_task?feed_type=" + (feed_type==null? "" : System.Uri.EscapeDataString(feed_type))+"&schedule_id=" + (schedule_id==null? "" : System.Uri.EscapeDataString(schedule_id))+"&look_back_days=" + (look_back_days==null? "" : System.Uri.EscapeDataString(look_back_days))+"&date_range=" + (date_range==null? "" : System.Uri.EscapeDataString(date_range))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<InventoryTaskCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// CreateInventoryTask inventory_task
		/// </summary>
		/// <param name="requestBody">The request payload containing the version, feedType, and optional filterCriteria.</param>
		public async Task CreateInventoryTaskAsync(CreateInventoryTaskRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "inventory_task";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// GetInventoryTask inventory_task/{task_id}
		/// </summary>
		/// <param name="task_id">The ID of the task. This ID was generated when the task was created by the <strong>createInventoryTask</strong> method</param>
		/// <returns>Success</returns>
		public async Task<InventoryTask> GetInventoryTaskAsync(string task_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "inventory_task/"+ (task_id==null? "" : System.Uri.EscapeDataString(task_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<InventoryTask>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// GetOrderTasks order_task
		/// </summary>
		/// <param name="date_range">The order tasks creation date range. This range is used to filter the results. The filtered results are filtered to include only tasks with a creation date that is equal to this date or is within specified range. Only orders less than 90 days old can be retrieved. Do not use with the <strong>look_back_days</strong> parameter. <br /><br /><b>Format: </b>UTC   <br /><br /> <b> For example: </b> <br /><br />Tasks within a range  <br /> <code>yyyy-MM-ddThh:mm:ss.SSSZ..yyyy-MM-ddThh:mm:ss.SSSZ </code> <br /><br /> Tasks created on September 8, 2019<br /> <code>2019-09-08T00:00:00.000Z..2019-09-09T00:00:00.000Z</code><br /></param>
		/// <param name="feed_type">The feed type associated with the task. The only presently supported value is <code>LMS_ORDER_REPORT</code>. Do not use with the <strong>schedule_id</strong> parameter. Since schedules are based on feed types, you can specify a schedule (<strong>schedule_id</strong>) that returns the needed <strong>feed_type</strong>.</param>
		/// <param name="limit">The maximum number of order tasks that can be returned on each page of the paginated response. Use this parameter in conjunction with the <strong>offset</strong> parameter to control the pagination of the output. <p> <span class="tablenote"><strong>Note:</strong> This feature employs a zero-based list, where the first item in the list has an offset of <code>0</code>.</span></p><p>For example, if <strong>offset</strong> is set to 10 and <strong>limit</strong> is set to 10, the call retrieves order tasks 11 thru 20 from the result set.</p><p>If this parameter is omitted, the default value is used.</p><p><b>Default:</b> 10 <p><b>Maximum:</b> 500</p></param>
		/// <param name="look_back_days">The number of previous days in which to search for tasks. Do not use with the <strong>date_range</strong> parameter. If both <strong>date_range</strong> and <strong>look_back_days</strong> are omitted, this parameter's default value is used.  <br /><br /><b>Default: </b> 7 <br /><br /><b>Range: </b> 1-90 (inclusive)  </param>
		/// <param name="offset">The number of order tasks to skip in the result set before returning the first order in the paginated response. <p>Combine <strong>offset</strong> with the <strong>limit</strong> query parameter to control the items returned in the response. For example, if you supply an <strong>offset</strong> of <code>0</code> and a <strong>limit</strong> of <code>10</code>, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If <strong>offset</strong> is <code>10</code> and <strong>limit</strong> is <code>20</code>, the first page of the response contains items 11-30 from the complete result set. If this query parameter is not set, the default value is used and the first page of records is returned.<br /><br /><b>Default: </b>0</param>
		/// <param name="schedule_id">The schedule ID associated with the order task. A schedule periodically generates a report for the feed type specified by the schedule template (see <strong>scheduleTemplateId</strong> in <strong>createSchedule</strong>). Do not use with the <strong>feed_type</strong> parameter. Since schedules are based on feed types, you can specify a schedule (<strong>schedule_id</strong>) that returns the needed <strong>feed_type</strong>.</param>
		/// <returns>Success</returns>
		public async Task<OrderTaskCollection> GetOrderTasksAsync(string date_range, string feed_type, string limit, string look_back_days, string offset, string schedule_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "order_task?date_range=" + (date_range==null? "" : System.Uri.EscapeDataString(date_range))+"&feed_type=" + (feed_type==null? "" : System.Uri.EscapeDataString(feed_type))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&look_back_days=" + (look_back_days==null? "" : System.Uri.EscapeDataString(look_back_days))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&schedule_id=" + (schedule_id==null? "" : System.Uri.EscapeDataString(schedule_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<OrderTaskCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// CreateOrderTask order_task
		/// </summary>
		/// <param name="requestBody">description not needed</param>
		public async Task CreateOrderTaskAsync(CreateOrderTaskRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "order_task";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// GetOrderTask order_task/{task_id}
		/// </summary>
		/// <param name="task_id">The ID of the task. This ID is generated when the task was created by the <b> createOrderTask</b> method.</param>
		/// <returns>Success</returns>
		public async Task<OrderTask> GetOrderTaskAsync(string task_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "order_task/"+ (task_id==null? "" : System.Uri.EscapeDataString(task_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<OrderTask>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="feed_type">The <strong>feedType</strong> associated with the schedule.</param>
		/// <param name="limit">The maximum number of schedules that can be returned on each page of the paginated response. Use this parameter in conjunction with the <strong>offset</strong> parameter to control the pagination of the output. <p> <span class="tablenote"><strong>Note:</strong> This feature employs a zero-based list, where the first item in the list has an offset of <code>0</code>.</span></p><p>For example, if <strong>offset</strong> is set to 10 and <strong>limit</strong> is set to 10, the call retrieves schedules 11 thru 20 from the result set.</p><p>If this parameter is omitted, the default value is used. <br /><br /><b>Default: </b> 10 <br /><br /><b>Maximum: </b>500</param>
		/// <param name="offset">The number of schedules to skip in the result set before returning the first schedule in the paginated response. <p>Combine <strong>offset</strong> with the <strong>limit</strong> query parameter to control the items returned in the response. For example, if you supply an <strong>offset</strong> of <code>0</code> and a <strong>limit</strong> of <code>10</code>, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If <strong>offset</strong> is <code>10</code> and <strong>limit</strong> is <code>20</code>, the first page of the response contains items 11-30 from the complete result set. If this query parameter is not set, the default value is used and the first page of records is returned.<br /><br /><b>Default: </b>0</param>
		/// <returns>Success</returns>
		public async Task<UserScheduleCollection> GetSchedulesAsync(string feed_type, string limit, string offset, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "schedule?feed_type=" + (feed_type==null? "" : System.Uri.EscapeDataString(feed_type))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UserScheduleCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="requestBody">In the request payload: <strong>feedType</strong> and <strong>scheduleTemplateId</strong> are required; <strong>scheduleName</strong> is optional; <strong>preferredTriggerHour</strong>, <strong>preferredTriggerDayOfWeek</strong>, <strong>preferredTriggerDayOfMonth</strong>, <strong>scheduleStartDate</strong>, <strong>scheduleEndDate</strong>, and <strong>schemaVersion</strong> are conditional.</param>
		public async Task CreateScheduleAsync(CreateUserScheduleRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// </summary>
		/// <param name="schedule_id">The <strong>schedule_id</strong> of the schedule to delete. This ID was generated when the task was created. If you do not know the schedule_id, use the <strong>getSchedules</strong> method to return all schedules based on a specified feed_type and find the schedule_id of the schedule to delete.</param>
		public async Task DeleteScheduleAsync(string schedule_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "schedule/"+ (schedule_id==null? "" : System.Uri.EscapeDataString(schedule_id));
		...
		/// GetSchedule schedule/{schedule_id}
		/// </summary>
		/// <param name="schedule_id">The ID of the schedule for which to retrieve the details. This ID is generated when the schedule was created by the <strong>createSchedule</strong> method.</param>
		/// <returns>Success</returns>
		public async Task<UserScheduleResponse> GetScheduleAsync(string schedule_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "schedule/"+ (schedule_id==null? "" : System.Uri.EscapeDataString(schedule_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UserScheduleResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="schedule_id">The ID of the schedule to update. This ID is generated when the schedule was created by the <strong>createSchedule</strong> method.</param>
		/// <param name="requestBody">In the request payload: <strong>scheduleName</strong> is optional; <strong>preferredTriggerHour</strong>, <strong>preferredTriggerDayOfWeek</strong>, <strong>preferredTriggerDayOfMonth</strong>, <strong>scheduleStartDate</strong>, <strong>scheduleEndDate</strong>, and <strong>schemaVersion</strong> are conditional.</param>
		public async Task UpdateScheduleAsync(string schedule_id, UpdateUserScheduleRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "schedule/"+ (schedule_id==null? "" : System.Uri.EscapeDataString(schedule_id));
		...
		/// GetLatestResultFile schedule/{schedule_id}/download_result_file
		/// </summary>
		/// <param name="schedule_id">The ID of the schedule for which to retrieve the latest result file. This ID is generated when the schedule was created by the <strong>createSchedule</strong> method.</param>
		/// <returns>Success</returns>
		public async Task GetLatestResultFileAsync(string schedule_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "schedule/"+ (schedule_id==null? "" : System.Uri.EscapeDataString(schedule_id))+"/download_result_file";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// GetScheduleTemplates schedule_template
		/// </summary>
		/// <param name="feed_type">The feed type of the schedule templates to retrieve.</param>
		/// <param name="limit">The maximum number of schedule templates that can be returned on each page of the paginated response. Use this parameter in conjunction with the <strong>offset</strong> parameter to control the pagination of the output. <p> <span class="tablenote"><strong>Note:</strong> This feature employs a zero-based list, where the first item in the list has an offset of <code>0</code>.</span></p><p>For example, if <strong>offset</strong> is set to 10 and <strong>limit</strong> is set to 10, the call retrieves schedule templates 11 thru 20 from the result set.</p><p>If this parameter is omitted, the default value is used. <br /><br /><b>Default: </b> 10 <br /><br /><b>Maximum: </b>500</param>
		/// <param name="offset">The number of schedule templates to skip in the result set before returning the first template in the paginated response. <p>Combine <strong>offset</strong> with the <strong>limit</strong> query parameter to control the items returned in the response. For example, if you supply an <strong>offset</strong> of <code>0</code> and a <strong>limit</strong> of <code>10</code>, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If <strong>offset</strong> is <code>10</code> and <strong>limit</strong> is <code>20</code>, the first page of the response contains items 11-30 from the complete result set. If this query parameter is not set, the default value is used and the first page of records is returned.<br /><br /><b>Default: </b>0</param>
		/// <returns>Success</returns>
		public async Task<ScheduleTemplateCollection> GetScheduleTemplatesAsync(string feed_type, string limit, string offset, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "schedule_template?feed_type=" + (feed_type==null? "" : System.Uri.EscapeDataString(feed_type))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ScheduleTemplateCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// GetScheduleTemplate schedule_template/{schedule_template_id}
		/// </summary>
		/// <param name="schedule_template_id">The ID of the template to retrieve. If you do not know the <strong>schedule_template_id</strong>, refer to the documentation or use the <strong>getScheduleTemplates</strong> method to find the available schedule templates.</param>
		/// <returns>Success</returns>
		public async Task<ScheduleTemplateResponse> GetScheduleTemplateAsync(string schedule_template_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "schedule_template/"+ (schedule_template_id==null? "" : System.Uri.EscapeDataString(schedule_template_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ScheduleTemplateResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// GetTasks task
		/// </summary>
		/// <param name="date_range">Specifies the range of task creation dates used to filter the results. The results are filtered to include only tasks with a creation date that is equal to this date or is within specified range. Only tasks that are less than 90 days can be retrieved. <p> <span class="tablenote"><strong>Note:</strong> Maximum date range window size is 90 days.</span></p> <br /><b>Valid Format (UTC):</b><code>yyyy-MM-ddThh:mm:ss.SSSZ..yyyy-MM-ddThh:mm:ss.SSSZ </code><br /><br />For example: Tasks created on September 8, 2019<br /> <code>2019-09-08T00:00:00.000Z..2019-09-09T00:00:00.000Z</code></param>
		/// <param name="feed_type">The feed type associated with the tasks to be returned. Only use a <strong>feedType</strong> that is available for your API: <ul><li>Order Feeds: <code>LMS_ORDER_ACK, LMS_ORDER_REPORT</code></li><li>Large Merchant Services (LMS) Feeds: See <a href="/api-docs/sell/static/feed/lms-feeds-quick-reference.html#Availabl" target="_blank">Available FeedTypes</a></li></ul><br/>Do not use with the <strong>schedule_id</strong> parameter. Since schedules are based on feed types, you can specify a schedule (<strong>schedule_id</strong>) that returns the needed <strong>feed_type</strong>.</param>
		/// <param name="limit">The maximum number of tasks that can be returned on each page of the paginated response. Use this parameter in conjunction with the <strong>offset</strong> parameter to control the pagination of the output. <p> <span class="tablenote"><strong>Note:</strong> This feature employs a zero-based list, where the first item in the list has an offset of <code>0</code>.</span></p><p>For example, if <strong>offset</strong> is set to 10 and <strong>limit</strong> is set to 10, the call retrieves tasks 11 thru 20 from the result set.</p><p>If this parameter is omitted, the default value is used. <br /><br /><b>Default: </b> 10 <br /><br /><b>Maximum: </b>500</param>
		/// <param name="look_back_days">The number of previous days in which to search for tasks. Do not use with the <code>date_range</code> parameter. If both <code>date_range</code> and <code>look_back_days</code> are omitted, this parameter's default value is used.  <br /><br /><b>Default: </b> 7 <br /><br /><b>Range: </b> 1-90 (inclusive)</param>
		/// <param name="offset">The number of tasks to skip in the result set before returning the first task in the paginated response. <p>Combine <strong>offset</strong> with the <strong>limit</strong> query parameter to control the items returned in the response. For example, if you supply an <strong>offset</strong> of <code>0</code> and a <strong>limit</strong> of <code>10</code>, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If <strong>offset</strong> is <code>10</code> and <strong>limit</strong> is <code>20</code>, the first page of the response contains items 11-30 from the complete result set. If this query parameter is not set, the default value is used and the first page of records is returned. <br /><br /><b>Default: </b>0</param>
		/// <param name="schedule_id">The schedule ID associated with the task. A schedule periodically generates a report for the feed type specified by the schedule template (see <strong>scheduleTemplateId</strong> in <strong>createSchedule</strong>). Do not use with the <strong>feed_type</strong> parameter. Since schedules are based on feed types, you can specify a schedule (<strong>schedule_id</strong>) that returns the needed <strong>feed_type</strong>.</param>
		/// <returns>Success</returns>
		public async Task<TaskCollection> GetTasksAsync(string date_range, string feed_type, string limit, string look_back_days, string offset, string schedule_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "task?date_range=" + (date_range==null? "" : System.Uri.EscapeDataString(date_range))+"&feed_type=" + (feed_type==null? "" : System.Uri.EscapeDataString(feed_type))+"&limit=" + (limit==null? "" : System.Uri.EscapeDataString(limit))+"&look_back_days=" + (look_back_days==null? "" : System.Uri.EscapeDataString(look_back_days))+"&offset=" + (offset==null? "" : System.Uri.EscapeDataString(offset))+"&schedule_id=" + (schedule_id==null? "" : System.Uri.EscapeDataString(schedule_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<TaskCollection>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="requestBody">description not needed</param>
		public async Task CreateTaskAsync(CreateTaskRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "task";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
		...
		/// </summary>
		/// <param name="task_id">The ID of the task. This ID was generated when the task was created.</param>
		/// <returns>Success</returns>
		public async Task<Task_> GetTaskAsync(string task_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "task/"+ (task_id==null? "" : System.Uri.EscapeDataString(task_id));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// GetInputFile task/{task_id}/download_input_file
		/// </summary>
		/// <param name="task_id">The task ID associated with the file to be downloaded.</param>
		/// <returns>Success</returns>
		public async Task GetInputFileAsync(string task_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "task/"+ (task_id==null? "" : System.Uri.EscapeDataString(task_id))+"/download_input_file";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// GetResultFile task/{task_id}/download_result_file
		/// </summary>
		/// <param name="task_id">The ID of the task associated with the file you want to download. This ID was generated when the task was created.</param>
		/// <returns>Success</returns>
		public async Task GetResultFileAsync(string task_id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "task/"+ (task_id==null? "" : System.Uri.EscapeDataString(task_id))+"/download_result_file";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
