...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Cloudresourcemanager_organizations_list v1beta1/organizations
		/// </summary>
		/// <param name="filter">An optional query string used to filter the Organizations to return in the response. Filter rules are case-insensitive. Organizations may be filtered by `owner.directoryCustomerId` or by `domain`, where the domain is a G Suite domain, for example: * Filter `owner.directorycustomerid:123456789` returns Organization resources with `owner.directory_customer_id` equal to `123456789`. * Filter `domain:google.com` returns Organization resources corresponding to the domain `google.com`. This field is optional.</param>
		/// <param name="pageSize">The maximum number of Organizations to return in the response. This field is optional.</param>
		/// <param name="pageToken">A pagination token returned from a previous call to `ListOrganizations` that indicates from where listing should continue. This field is optional.</param>
		/// <returns>Successful response</returns>
		public async Task<ListOrganizationsResponse> Cloudresourcemanager_organizations_listAsync(string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/organizations?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<ListOrganizationsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		{
			var requestUri = "v1beta1/projects?filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudresourcemanager_projects_create v1beta1/projects
		/// </summary>
		/// <param name="useLegacyStack">A now unused experiment opt-out option.</param>
		/// <returns>Successful response</returns>
		public async Task<Project> Cloudresourcemanager_projects_createAsync(bool useLegacyStack, Project requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/projects?useLegacyStack="+useLegacyStack;
		...
		/// Cloudresourcemanager_projects_delete v1beta1/projects/{projectId}
		/// </summary>
		...
		{
			var requestUri = "v1beta1/projects/"+ (projectId==null? "" : System.Uri.EscapeDataString(projectId));
		...
		/// Cloudresourcemanager_projects_get v1beta1/projects/{projectId}
		/// </summary>
		...
		/// Cloudresourcemanager_projects_update v1beta1/projects/{projectId}
		/// </summary>
		...
		/// Cloudresourcemanager_projects_getAncestry v1beta1/projects/{projectId}:getAncestry
		/// </summary>
		/// <param name="projectId">Required. The Project ID (for example, `my-project-123`).</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/projects/"+ (projectId==null? "" : System.Uri.EscapeDataString(projectId))+":getAncestry";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_undelete v1beta1/projects/{projectId}:undelete
		/// </summary>
		...
		{
			var requestUri = "v1beta1/projects/"+ (projectId==null? "" : System.Uri.EscapeDataString(projectId))+":undelete";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_getIamPolicy v1beta1/projects/{resource}:getIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v1beta1/projects/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":getIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_setIamPolicy v1beta1/projects/{resource}:setIamPolicy
		/// </summary>
		...
		{
			var requestUri = "v1beta1/projects/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":setIamPolicy";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_projects_testIamPermissions v1beta1/projects/{resource}:testIamPermissions
		/// </summary>
		...
		{
			var requestUri = "v1beta1/projects/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":testIamPermissions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Cloudresourcemanager_organizations_get v1beta1/{name}
		/// </summary>
		...
		/// <param name="organizationId">The id of the Organization resource to fetch. This field is deprecated and will be removed in v1. Use name instead.</param>
		/// <returns>Successful response</returns>
		public async Task<Organization> Cloudresourcemanager_organizations_getAsync(string name, string organizationId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"&organizationId=" + (organizationId==null? "" : System.Uri.EscapeDataString(organizationId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Cloudresourcemanager_organizations_update v1beta1/{name}
		/// </summary>
		/// <param name="name">Output only. The resource name of the organization. This is the organization's relative path in the API. Its format is "organizations/[organization_id]". For example, "organizations/1234".</param>
		/// <returns>Successful response</returns>
		public async Task<Organization> Cloudresourcemanager_organizations_updateAsync(string name, Organization requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Cloudresourcemanager_organizations_getIamPolicy v1beta1/{resource}:getIamPolicy
		/// </summary>
		/// <param name="resource">REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.</param>
		/// <returns>Successful response</returns>
		...
		/// Cloudresourcemanager_organizations_setIamPolicy v1beta1/{resource}:setIamPolicy
		/// </summary>
		/// <param name="resource">REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.</param>
		/// <returns>Successful response</returns>
		...
		/// Cloudresourcemanager_organizations_testIamPermissions v1beta1/{resource}:testIamPermissions
		/// </summary>
		/// <param name="resource">REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.</param>
		/// <returns>Successful response</returns>
