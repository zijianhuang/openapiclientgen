...
namespace MyNS
{
	...
	public class APIError
	{
		...
		public APIErrorErrors[] APIErrorErrors { get; set; }
	}
	...
	public class VeteranStatusConfirmation
	{
		...
		///
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="veteran_status")]
		public System.Nullable<VeteranStatusConfirmationVeteran_status> Veteran_status { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum VeteranStatusConfirmationVeteran_status
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		confirmed = 0,
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="not confirmed")]
		not_confirmed = 1,
	}
	...
	public class VeteranStatusRequest
	{
		...
		public System.Nullable<VeteranStatusRequestGender> Gender { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum VeteranStatusRequestGender
	{
	...
	public partial class Misc
	{
		...
		/// GetVeteranStatus status
		/// </summary>
		/// <returns>Confirmation status successfully retrieved</returns>
		public async Task<VeteranStatusConfirmation> GetVeteranStatusAsync(VeteranStatusRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<VeteranStatusConfirmation>(streamContent, jsonSerializerSettings);
			}
			finally
			{
