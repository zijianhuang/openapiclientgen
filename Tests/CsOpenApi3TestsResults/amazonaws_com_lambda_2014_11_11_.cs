	...
	public partial class Misc
	{
		...
		public async Task<EventSourceConfiguration> AddEventSourceAsync(AddEventSourcePostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<EventSourceConfiguration>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// <param name="FunctionName">The name of the AWS Lambda function.
		/// Min length: 1
		/// Max length: 64
		// </param>
		...
		/// <param name="MaxItems">Optional integer. Specifies the maximum number of event sources to return in response. This value must be greater than 0.
		/// Minimum: 1
		/// Maximum: 10000
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="FunctionName">The Lambda function to delete.
		/// Min length: 1
		/// Max length: 64
		// </param>
		...
		/// </summary>
		/// <param name="FunctionName">The Lambda function name.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="FunctionName">The name of the Lambda function for which you want to retrieve the configuration information.
		/// Min length: 1
		/// Max length: 64
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="FunctionName">The name of the Lambda function.
		/// Min length: 1
		/// Max length: 64
		// </param>
		...
		/// <param name="Description">A short user-defined function description. Lambda does not use this value. Assign a meaningful description as you see fit.
		/// Min length: 0
		/// Max length: 256
		// </param>
		/// <param name="Timeout">The function execution time at which Lambda should terminate the function. Because the execution time has cost implications, we recommend you set this value based on your expected execution time. The default is 3 seconds. 
		/// Minimum: 1
		/// Maximum: 60
		// </param>
		...
		/// <param name="MaxItems">Optional integer. Specifies the maximum number of AWS Lambda functions to return in response. This parameter value must be greater than 0.
		/// Minimum: 1
		/// Maximum: 10000
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="FunctionName">The name you want to assign to the function you are uploading. The function names appear in the console and are returned in the <a>ListFunctions</a> API. Function names are used to specify functions to other AWS Lambda APIs, such as <a>InvokeAsync</a>. 
		/// Min length: 1
		/// Max length: 64
		// </param>
