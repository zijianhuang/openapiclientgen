...
namespace MyNS
{
	...
	public class GoogleCloudRedisV1beta1LocationMetadata
	{
		...
		public System.Collections.Generic.Dictionary<string, GoogleCloudRedisV1beta1ZoneMetadata> AvailableZones { get; set; }
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudRedisV1beta1ZoneMetadata
	{
	}
	...
	public partial class Misc
	{
		...
		/// Redis_projects_locations_operations_delete v1beta1/{name}
		/// </summary>
		...
		/// Redis_projects_locations_operations_get v1beta1/{name}
		/// </summary>
		...
		/// Redis_projects_locations_instances_patch v1beta1/{name}
		/// </summary>
		...
		/// Redis_projects_locations_instances_getAuthString v1beta1/{name}/authString
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/authString";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<InstanceAuthString>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Redis_projects_locations_clusters_getCertificateAuthority v1beta1/{name}/certificateAuthority
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/certificateAuthority";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CertificateAuthority>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Redis_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// Redis_projects_locations_operations_list v1beta1/{name}/operations
		/// </summary>
		...
		/// Redis_projects_locations_operations_cancel v1beta1/{name}:cancel
		/// </summary>
		...
		/// Redis_projects_locations_instances_export v1beta1/{name}:export
		/// </summary>
		/// <param name="name">Required. Redis instance resource name using the form: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where `location_id` refers to a GCP region.</param>
		/// <returns>Successful response</returns>
		...
		/// Redis_projects_locations_instances_failover v1beta1/{name}:failover
		/// </summary>
		/// <param name="name">Required. Redis instance resource name using the form: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where `location_id` refers to a GCP region.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":failover";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Redis_projects_locations_instances_import v1beta1/{name}:import
		/// </summary>
		/// <param name="name">Required. Redis instance resource name using the form: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where `location_id` refers to a GCP region.</param>
		/// <returns>Successful response</returns>
		...
		/// Redis_projects_locations_instances_rescheduleMaintenance v1beta1/{name}:rescheduleMaintenance
		/// </summary>
		/// <param name="name">Required. Redis instance resource name using the form: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where `location_id` refers to a GCP region.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":rescheduleMaintenance";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Redis_projects_locations_instances_upgrade v1beta1/{name}:upgrade
		/// </summary>
		/// <param name="name">Required. Redis instance resource name using the form: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where `location_id` refers to a GCP region.</param>
		/// <returns>Successful response</returns>
		...
		/// Redis_projects_locations_clusters_list v1beta1/{parent}/clusters
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/clusters&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Redis_projects_locations_clusters_create v1beta1/{parent}/clusters
		/// </summary>
		/// <param name="parent">Required. The resource name of the cluster location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a GCP region.</param>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/clusters&clusterId=" + (clusterId==null? "" : System.Uri.EscapeDataString(clusterId))+"&requestId=" + (requestId==null? "" : System.Uri.EscapeDataString(requestId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Redis_projects_locations_instances_list v1beta1/{parent}/instances
		/// </summary>
		...
		/// Redis_projects_locations_instances_create v1beta1/{parent}/instances
		/// </summary>
		/// <param name="parent">Required. The resource name of the instance location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a GCP region.</param>
