...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task SslcrAsync(SslcrPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "sslcr/certificate";
	...
	public class SslcrPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public SslcrPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public SslcrPostBodyFormat Format { get; set; }
	...
	public class SslcrPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum SslcrPostBodyFormat
	{
