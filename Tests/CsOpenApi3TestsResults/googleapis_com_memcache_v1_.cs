...
namespace MyNS
{
	...
	public class GoogleCloudMemcacheV1LocationMetadata
	{
		...
		public System.Collections.Generic.Dictionary<string, GoogleCloudMemcacheV1ZoneMetadata> AvailableZones { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class GoogleCloudMemcacheV1ZoneMetadata
	{
	}
	...
	public class GoogleCloudMemcacheV1UpgradeInstanceRequest
	{
		...
		public System.Nullable<GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersion> MemcacheVersion { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersion
	{
	...
	public class Instance
	{
		...
		public GoogleCloudMemcacheV1MaintenancePolicy MaintenancePolicy { get; set; }
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="memcacheVersion")]
		public GoogleCloudMemcacheV1UpgradeInstanceRequestMemcacheVersion MemcacheVersion { get; set; }
	...
	public partial class Misc
	{
		...
		/// Memcache_projects_locations_instances_rescheduleMaintenance v1/{instance}:rescheduleMaintenance
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (instance==null? "" : System.Uri.EscapeDataString(instance))+":rescheduleMaintenance";
		...
		/// Memcache_projects_locations_operations_delete v1/{name}
		/// </summary>
		...
		/// Memcache_projects_locations_operations_get v1/{name}
		/// </summary>
		...
		/// Memcache_projects_locations_instances_patch v1/{name}
		/// </summary>
		...
		/// Memcache_projects_locations_list v1/{name}/locations
		/// </summary>
		...
		/// Memcache_projects_locations_operations_list v1/{name}/operations
		/// </summary>
		...
		/// Memcache_projects_locations_instances_applyParameters v1/{name}:applyParameters
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":applyParameters";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Memcache_projects_locations_operations_cancel v1/{name}:cancel
		/// </summary>
		...
		/// Memcache_projects_locations_instances_updateParameters v1/{name}:updateParameters
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":updateParameters";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Memcache_projects_locations_instances_upgrade v1/{name}:upgrade
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Operation> Memcache_projects_locations_instances_upgradeAsync(string name, GoogleCloudMemcacheV1UpgradeInstanceRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Memcache_projects_locations_instances_list v1/{parent}/instances
		/// </summary>
		...
		/// Memcache_projects_locations_instances_create v1/{parent}/instances
		/// </summary>
		/// <param name="parent">Required. The resource name of the instance location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a GCP region</param>
