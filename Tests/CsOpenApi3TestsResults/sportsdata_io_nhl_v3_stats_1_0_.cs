...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </param>
		public async Task<TeamLine[]> LineCombinationsBySeasonAsync(TeamsAllFormat format, string season, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <param name="playerid">Unique FantasyData Player ID.
		///Example:<code>30000651</code>.</param>
		/// <param name="numberofgames">How many games to return. Example <code>all</code>, <code>10</code>, <code>25</code></param>
		public async Task<PlayerGame[]> PlayerGameLogsBySeasonAsync(TeamsAllFormat format, string season, string playerid, string numberofgames, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <br>Examples: <code>2016</code>, <code>2017</code>.
		/// </param>
		public async Task<TeamSeason[]> TeamStatsAllowedByPositionAsync(TeamsAllFormat format, string season, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
