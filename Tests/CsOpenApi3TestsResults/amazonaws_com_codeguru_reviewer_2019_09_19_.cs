	...
	public partial class Misc
	{
		...
		public async Task<AssociateRepositoryResponse> AssociateRepositoryAsync(AssociateRepositoryPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<AssociateRepositoryResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// </summary>
		/// <param name="ProviderType">List of provider types to use as a filter.
		/// Minimum items: 1
		/// Maximum items: 3
		// </param>
		...
		/// Maximum items: 5
		// </param>
		/// <param name="Name">List of repository names to use as a filter.
		/// Minimum items: 1
		/// Maximum items: 3
		// </param>
		/// <param name="Owner">List of owners to use as a filter. For Amazon Web Services CodeCommit, it is the name of the CodeCommit account that was used to associate the repository. For other repository source providers, such as Bitbucket and GitHub Enterprise Server, this is name of the account that was used to associate the repository. 
		/// Minimum items: 1
		/// Maximum items: 3
		// </param>
		...
		public async Task<ListRepositoryAssociationsResponse> ListRepositoryAssociationsAsync(ProviderType[] ProviderType, RepositoryAssociationState[] State, string[] Name, string[] Owner, int MaxResults, string NextToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListRepositoryAssociationsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<CreateCodeReviewResponse> CreateCodeReviewAsync(CreateCodeReviewPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateCodeReviewResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="CodeReviewArn">The Amazon Resource Name (ARN) of the <a href="https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_CodeReview.html">CodeReview</a> object. 
		/// Min length: 1
		/// Max length: 1600
		// </param>
		/// <returns>Success</returns>
		public async Task<DescribeCodeReviewResponse> DescribeCodeReviewAsync(string CodeReviewArn, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DescribeCodeReviewResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 1600
		// </param>
		/// <param name="RecommendationId">The recommendation ID that can be used to track the provided recommendations and then to collect the feedback.
		/// Min length: 1
		/// Max length: 64
		// </param>
		...
		public async Task<DescribeRecommendationFeedbackResponse> DescribeRecommendationFeedbackAsync(string CodeReviewArn, string RecommendationId, string UserId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DescribeRecommendationFeedbackResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<DescribeRepositoryAssociationResponse> DescribeRepositoryAssociationAsync(string AssociationArn, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DescribeRepositoryAssociationResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<DisassociateRepositoryResponse> DisassociateRepositoryAsync(string AssociationArn, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DisassociateRepositoryResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="ProviderTypes">List of provider types for filtering that needs to be applied before displaying the result. For example, <code>providerTypes=[GitHub]</code> lists code reviews from GitHub.
		/// Minimum items: 1
		/// Maximum items: 3
		// </param>
		...
		/// Maximum items: 3
		// </param>
		/// <param name="RepositoryNames">List of repository names for filtering that needs to be applied before displaying the result.
		/// Minimum items: 1
		/// Maximum items: 100
		// </param>
		/// <param name="Type">The type of code reviews to list in the response.</param>
		/// <param name="MaxResults">The maximum number of results that are returned per call. The default is 100.
		/// Minimum: 1
		/// Maximum: 100
		// </param>
		/// <param name="NextToken">If <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged.
		/// Min length: 1
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		public async Task<ListCodeReviewsResponse> ListCodeReviewsAsync(ProviderType[] ProviderTypes, JobState[] States, string[] RepositoryNames, Type Type, int MaxResults, string NextToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListCodeReviewsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Maximum items: 100
		// </param>
		/// <param name="RecommendationIds">Used to query the recommendation feedback for a given recommendation.
		/// Minimum items: 1
		/// Maximum items: 100
		// </param>
		/// <returns>Success</returns>
		public async Task<ListRecommendationFeedbackResponse> ListRecommendationFeedbackAsync(string NextToken, int MaxResults, string CodeReviewArn, string[] UserIds, string[] RecommendationIds, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListRecommendationFeedbackResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		public async Task<PutRecommendationFeedbackResponse> PutRecommendationFeedbackAsync(PutRecommendationFeedbackPutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PutRecommendationFeedbackResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 1600
		// </param>
		/// <param name="tagKeys">A list of the keys for each tag you want to remove from an associated repository.
		/// Minimum items: 1
		/// Maximum items: 50
		// </param>
		/// <returns>Success</returns>
