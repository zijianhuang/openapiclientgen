...
namespace MyNS
{
	...
	public class GetRoutingControlStateResponse
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public RoutingControlState RoutingControlState { get; set; }
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public class EndpointTemporarilyUnavailableException
	{
	}
	...
	public class UpdateRoutingControlStatesRequest
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public UpdateRoutingControlStateEntry[] UpdateRoutingControlStateEntries { get; set; }
	...
	public partial class Misc
	{
		...
		/// GetRoutingControlState #X-Amz-Target=ToggleCustomerAPI.GetRoutingControlState
		/// </summary>
		/// <returns>Success</returns>
		public async Task<GetRoutingControlStateResponse> GetRoutingControlStateAsync(GetRoutingControlStateRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=ToggleCustomerAPI.GetRoutingControlState";
			...
			try
			{
				...
				return JsonSerializer.Deserialize<GetRoutingControlStateResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// ListRoutingControls #X-Amz-Target=ToggleCustomerAPI.ListRoutingControls
		/// </summary>
		/// <param name="MaxResults">Pagination limit</param>
		/// <param name="NextToken">Pagination token</param>
		/// <returns>Success</returns>
		public async Task<ListRoutingControlsResponse> ListRoutingControlsAsync(string MaxResults, string NextToken, ListRoutingControlsRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=ToggleCustomerAPI.ListRoutingControls?MaxResults=" + (MaxResults==null? "" : System.Uri.EscapeDataString(MaxResults))+"&NextToken=" + (NextToken==null? "" : System.Uri.EscapeDataString(NextToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListRoutingControlsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// UpdateRoutingControlState #X-Amz-Target=ToggleCustomerAPI.UpdateRoutingControlState
		/// </summary>
		/// <returns>Success</returns>
		public async Task<UpdateRoutingControlStateResponse> UpdateRoutingControlStateAsync(UpdateRoutingControlStateRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=ToggleCustomerAPI.UpdateRoutingControlState";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateRoutingControlStateResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// UpdateRoutingControlStates #X-Amz-Target=ToggleCustomerAPI.UpdateRoutingControlStates
		/// </summary>
		/// <returns>Success</returns>
		public async Task<UpdateRoutingControlStatesResponse> UpdateRoutingControlStatesAsync(UpdateRoutingControlStatesRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#X-Amz-Target=ToggleCustomerAPI.UpdateRoutingControlStates";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateRoutingControlStatesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
	...
	public enum GetRoutingControlStateX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="ToggleCustomerAPI.GetRoutingControlState")]
		ToggleCustomerAPI_GetRoutingControlState = 0,
	}
	
	public enum ListRoutingControlsX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="ToggleCustomerAPI.ListRoutingControls")]
		ToggleCustomerAPI_ListRoutingControls = 0,
	}
	
	public enum UpdateRoutingControlStateX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="ToggleCustomerAPI.UpdateRoutingControlState")]
		ToggleCustomerAPI_UpdateRoutingControlState = 0,
	}
	
	public enum UpdateRoutingControlStatesX_Amz_Target
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute(Value="ToggleCustomerAPI.UpdateRoutingControlStates")]
		ToggleCustomerAPI_UpdateRoutingControlStates = 0,
	}
}
