...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task RsbycAsync(RsbycPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "rsbyc/certificate";
	...
	public class RsbycPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public RsbycPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public RsbycPostBodyFormat Format { get; set; }
	...
	public class RsbycPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum RsbycPostBodyFormat
	{
