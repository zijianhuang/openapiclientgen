...
namespace MyNS
{
	...
	public class GoogleCloudPolicysimulatorV1AccessStateDiff
	{
		...
		public System.Nullable<GoogleCloudPolicysimulatorV1AccessStateDiffAccessChange> AccessChange { get; set; }
		
		/// <summary>
		/// Details about how a set of policies, listed in ExplainedPolicy, resulted in a certain AccessState when replaying an access tuple.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="baseline")]
		public GoogleCloudPolicysimulatorV1ExplainedAccess Baseline { get; set; }
		
		/// <summary>
		/// Details about how a set of policies, listed in ExplainedPolicy, resulted in a certain AccessState when replaying an access tuple.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="simulated")]
		public GoogleCloudPolicysimulatorV1ExplainedAccess Simulated { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleCloudPolicysimulatorV1AccessStateDiffAccessChange
	{
	...
	public class GoogleCloudPolicysimulatorV1ExplainedAccess
	{
		...
		public System.Nullable<GoogleCloudPolicysimulatorV1ExplainedAccessAccessState> AccessState { get; set; }
		...
		public GoogleCloudPolicysimulatorV1ExplainedPolicy[] Policies { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleCloudPolicysimulatorV1ExplainedAccessAccessState
	{
	...
	public class GoogleCloudPolicysimulatorV1ExplainedPolicy
	{
		...
		public GoogleCloudPolicysimulatorV1ExplainedAccessAccessState Access { get; set; }
		...
		public GoogleCloudPolicysimulatorV1BindingExplanation[] BindingExplanations { get; set; }
		...
		public GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance Relevance { get; set; }
	}
	...
	public class GoogleCloudPolicysimulatorV1BindingExplanation
	{
		...
		public System.Collections.Generic.Dictionary<string, GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership> Memberships { get; set; }
		...
		public System.Nullable<GoogleCloudPolicysimulatorV1BindingExplanationRolePermission> RolePermission { get; set; }
		
		/// <summary>
		/// The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="rolePermissionRelevance")]
		public GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance RolePermissionRelevance { get; set; }
	}
	...
	public class GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership
	{
		...
		public System.Nullable<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipMembership> Membership { get; set; }
		
		/// <summary>
		/// The relevance of the principal's status to the overall determination for the binding.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="relevance")]
		public System.Nullable<GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance> Relevance { get; set; }
	}
	
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipMembership
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembershipRelevance
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum GoogleCloudPolicysimulatorV1BindingExplanationRolePermission
	{
	...
	public class GoogleCloudPolicysimulatorV1ListReplayResultsResponse
	{
		...
		public GoogleCloudPolicysimulatorV1ReplayResult[] ReplayResults { get; set; }
	}
	...
	public class GoogleCloudPolicysimulatorV1ReplayResult
	{
		...
		public GoogleCloudPolicysimulatorV1AccessTuple AccessTuple { get; set; }
		
		/// <summary>
		/// The difference between the results of evaluating an access tuple under the current (baseline) policies and under the proposed (simulated) policies. This difference explains how a principal's access could change if the proposed policies were applied.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="diff")]
		public GoogleCloudPolicysimulatorV1ReplayDiff Diff { get; set; }
	...
	public class GoogleCloudPolicysimulatorV1ReplayDiff
	{
		...
		public GoogleCloudPolicysimulatorV1AccessStateDiff AccessDiff { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// Policysimulator_projects_locations_replays_operations_list v1/{name}
		/// </summary>
		...
		/// Policysimulator_projects_locations_replays_create v1/{parent}/replays
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleLongrunningOperation> Policysimulator_projects_locations_replays_createAsync(string parent, GoogleCloudPolicysimulatorV1Replay requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/replays";
		...
		/// Policysimulator_projects_locations_replays_results_list v1/{parent}/results
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<GoogleCloudPolicysimulatorV1ListReplayResultsResponse> Policysimulator_projects_locations_replays_results_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/results&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GoogleCloudPolicysimulatorV1ListReplayResultsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
