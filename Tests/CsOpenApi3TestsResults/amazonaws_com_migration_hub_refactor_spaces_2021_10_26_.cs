...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="EnvironmentIdentifier">The unique identifier of the environment.
		/// Min length: 14
		/// Max length: 14
		// </param>
		...
		/// </summary>
		/// <param name="EnvironmentIdentifier">The ID of the environment. 
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="maxResults">The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned <code>nextToken</code> value.
		/// Minimum: 1
		/// Maximum: 100
		// </param>
		...
		/// </summary>
		/// <param name="ApplicationIdentifier">The ID of the application within which the route is being created.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="EnvironmentIdentifier">The ID of the environment in which the route is created.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <returns>Success</returns>
		public async Task<CreateRouteResponse> CreateRouteAsync(string ApplicationIdentifier, string EnvironmentIdentifier, CreateRoutePostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreateRouteResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="ApplicationIdentifier">The ID of the application. 
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="EnvironmentIdentifier">The ID of the environment. 
		...
		/// </summary>
		/// <param name="ApplicationIdentifier">The ID of the application which the service is created.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="EnvironmentIdentifier">The ID of the environment in which the service is created.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Identifier">Amazon Resource Name (ARN) of the resource associated with the policy. 
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="Identifier">The Amazon Resource Name (ARN) of the resource associated with the policy. 
		/// Min length: 20
		/// Max length: 2048
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="ApplicationIdentifier">The ID of the application to delete the route from.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="EnvironmentIdentifier">The ID of the environment to delete the route from.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="RouteIdentifier">The ID of the route to delete.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <returns>Success</returns>
		public async Task<DeleteRouteResponse> DeleteRouteAsync(string ApplicationIdentifier, string EnvironmentIdentifier, string RouteIdentifier, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeleteRouteResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Max length: 14
		// </param>
		/// <param name="RouteIdentifier">The ID of the route.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <returns>Success</returns>
		public async Task<GetRouteResponse> GetRouteAsync(string ApplicationIdentifier, string EnvironmentIdentifier, string RouteIdentifier, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetRouteResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="ApplicationIdentifier"> The ID of the application within which the route is being updated. 
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="EnvironmentIdentifier"> The ID of the environment in which the route is being updated. 
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="RouteIdentifier"> The unique identifier of the route to update. 
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <returns>Success</returns>
		public async Task<UpdateRouteResponse> UpdateRouteAsync(string ApplicationIdentifier, string EnvironmentIdentifier, string RouteIdentifier, UpdateRoutePatchBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdateRouteResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="ApplicationIdentifier"><p>Deletes a Refactor Spaces service.</p> <note> <p>The <code>RefactorSpacesSecurityGroup</code> security group must be removed from all Amazon Web Services resources in the virtual private cloud (VPC) prior to deleting a service with a URL endpoint in a VPC.</p> </note>
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="EnvironmentIdentifier">The ID of the environment that the service is in.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <param name="ServiceIdentifier">The ID of the service to delete.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <returns>Success</returns>
		...
		/// Max length: 14
		// </param>
		/// <param name="ServiceIdentifier">The ID of the service.
		/// Min length: 14
		/// Max length: 14
		// </param>
		/// <returns>Success</returns>
		...
		public async Task<ListEnvironmentVpcsResponse> ListEnvironmentVpcsAsync(string EnvironmentIdentifier, int maxResults, string nextToken, string MaxResults, string NextToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListEnvironmentVpcsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
