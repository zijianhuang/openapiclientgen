...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// Appengine_apps_get v1/apps/{appsId}
		/// </summary>
		/// <param name="appsId">Part of `name`. Name of the Application resource to get. Example: apps/myapp.</param>
		/// <param name="includeExtraData">Options to include extra data</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"&includeExtraData=" + includeExtraData;
		...
		/// Appengine_apps_patch v1/apps/{appsId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
		...
		/// Appengine_apps_authorizedCertificates_list v1/apps/{appsId}/authorizedCertificates
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/authorizedCertificates&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAuthorizedCertificatesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_authorizedCertificates_create v1/apps/{appsId}/authorizedCertificates
		/// </summary>
		/// <param name="appsId">Part of `parent`. Name of the parent Application resource. Example: apps/myapp.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/authorizedCertificates";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AuthorizedCertificate>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_authorizedCertificates_delete v1/apps/{appsId}/authorizedCertificates/{authorizedCertificatesId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/authorizedCertificates/"+ (authorizedCertificatesId==null? "" : System.Uri.EscapeDataString(authorizedCertificatesId));
		...
		/// Appengine_apps_authorizedCertificates_get v1/apps/{appsId}/authorizedCertificates/{authorizedCertificatesId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/authorizedCertificates/"+ (authorizedCertificatesId==null? "" : System.Uri.EscapeDataString(authorizedCertificatesId))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_authorizedCertificates_patch v1/apps/{appsId}/authorizedCertificates/{authorizedCertificatesId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/authorizedCertificates/"+ (authorizedCertificatesId==null? "" : System.Uri.EscapeDataString(authorizedCertificatesId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_authorizedDomains_list v1/apps/{appsId}/authorizedDomains
		/// </summary>
		/// <param name="appsId">Part of `parent`. Name of the parent Application resource. Example: apps/myapp.</param>
		/// <param name="pageSize">Maximum results to return per page.</param>
		/// <param name="pageToken">Continuation token for fetching the next page of results.</param>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/authorizedDomains&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListAuthorizedDomainsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_domainMappings_list v1/apps/{appsId}/domainMappings
		/// </summary>
		/// <param name="appsId">Part of `parent`. Name of the parent Application resource. Example: apps/myapp.</param>
		/// <param name="pageSize">Maximum results to return per page.</param>
		/// <param name="pageToken">Continuation token for fetching the next page of results.</param>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/domainMappings&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListDomainMappingsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_domainMappings_create v1/apps/{appsId}/domainMappings
		/// </summary>
		/// <param name="appsId">Part of `parent`. Name of the parent Application resource. Example: apps/myapp.</param>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/domainMappings&overrideStrategy=" + overrideStrategy;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_domainMappings_delete v1/apps/{appsId}/domainMappings/{domainMappingsId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/domainMappings/"+ (domainMappingsId==null? "" : System.Uri.EscapeDataString(domainMappingsId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_domainMappings_get v1/apps/{appsId}/domainMappings/{domainMappingsId}
		/// </summary>
		...
		public async Task<DomainMapping> Appengine_apps_domainMappings_getAsync(string appsId, string domainMappingsId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DomainMapping>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_domainMappings_patch v1/apps/{appsId}/domainMappings/{domainMappingsId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/domainMappings/"+ (domainMappingsId==null? "" : System.Uri.EscapeDataString(domainMappingsId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_firewall_ingressRules_list v1/apps/{appsId}/firewall/ingressRules
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/firewall/ingressRules&matchingAddress=" + (matchingAddress==null? "" : System.Uri.EscapeDataString(matchingAddress))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListIngressRulesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_firewall_ingressRules_create v1/apps/{appsId}/firewall/ingressRules
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/firewall/ingressRules";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_firewall_ingressRules_delete v1/apps/{appsId}/firewall/ingressRules/{ingressRulesId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/firewall/ingressRules/"+ (ingressRulesId==null? "" : System.Uri.EscapeDataString(ingressRulesId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_firewall_ingressRules_get v1/apps/{appsId}/firewall/ingressRules/{ingressRulesId}
		/// </summary>
		...
		/// Appengine_apps_firewall_ingressRules_patch v1/apps/{appsId}/firewall/ingressRules/{ingressRulesId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/firewall/ingressRules/"+ (ingressRulesId==null? "" : System.Uri.EscapeDataString(ingressRulesId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_firewall_ingressRules_batchUpdate v1/apps/{appsId}/firewall/ingressRules:batchUpdate
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/firewall/ingressRules:batchUpdate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<BatchUpdateIngressRulesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_locations_list v1/apps/{appsId}/locations
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/locations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_locations_get v1/apps/{appsId}/locations/{locationsId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/locations/"+ (locationsId==null? "" : System.Uri.EscapeDataString(locationsId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Location>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_operations_list v1/apps/{appsId}/operations
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/operations&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_operations_get v1/apps/{appsId}/operations/{operationsId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/operations/"+ (operationsId==null? "" : System.Uri.EscapeDataString(operationsId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_services_list v1/apps/{appsId}/services
		/// </summary>
		/// <param name="appsId">Part of `parent`. Name of the parent Application resource. Example: apps/myapp.</param>
		/// <param name="pageSize">Maximum results to return per page.</param>
		/// <param name="pageToken">Continuation token for fetching the next page of results.</param>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_services_delete v1/apps/{appsId}/services/{servicesId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_services_get v1/apps/{appsId}/services/{servicesId}
		/// </summary>
		/// <param name="appsId">Part of `name`. Name of the resource requested. Example: apps/myapp/services/default.</param>
		/// <param name="servicesId">Part of `name`. See documentation of `appsId`.</param>
		/// <returns>Successful response</returns>
		public async Task<Service> Appengine_apps_services_getAsync(string appsId, string servicesId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
		...
		/// Appengine_apps_services_patch v1/apps/{appsId}/services/{servicesId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"&migrateTraffic="+migrateTraffic+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_services_versions_list v1/apps/{appsId}/services/{servicesId}/versions
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"/versions&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_services_versions_create v1/apps/{appsId}/services/{servicesId}/versions
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"/versions";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_services_versions_delete v1/apps/{appsId}/services/{servicesId}/versions/{versionsId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"/versions/"+ (versionsId==null? "" : System.Uri.EscapeDataString(versionsId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_services_versions_get v1/apps/{appsId}/services/{servicesId}/versions/{versionsId}
		/// </summary>
		/// <param name="appsId">Part of `name`. Name of the resource requested. Example: apps/myapp/services/default/versions/v1.</param>
		/// <param name="servicesId">Part of `name`. See documentation of `appsId`.</param>
		/// <param name="versionsId">Part of `name`. See documentation of `appsId`.</param>
		/// <param name="view">Controls the set of fields returned in the Get response.</param>
		/// <returns>Successful response</returns>
		public async Task<Version> Appengine_apps_services_versions_getAsync(string appsId, string servicesId, string versionsId, Appengine_apps_services_versions_listView view, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"/versions/"+ (versionsId==null? "" : System.Uri.EscapeDataString(versionsId))+"&view=" + view;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Version>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_services_versions_patch v1/apps/{appsId}/services/{servicesId}/versions/{versionsId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"/versions/"+ (versionsId==null? "" : System.Uri.EscapeDataString(versionsId))+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Patch, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_services_versions_instances_list v1/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"/versions/"+ (versionsId==null? "" : System.Uri.EscapeDataString(versionsId))+"/instances&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_services_versions_instances_delete v1/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"/versions/"+ (versionsId==null? "" : System.Uri.EscapeDataString(versionsId))+"/instances/"+ (instancesId==null? "" : System.Uri.EscapeDataString(instancesId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Delete, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Appengine_apps_services_versions_instances_get v1/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}
		/// </summary>
		/// <param name="appsId">Part of `name`. Name of the resource requested. Example: apps/myapp/services/default/versions/v1/instances/instance-1.</param>
		/// <param name="servicesId">Part of `name`. See documentation of `appsId`.</param>
		/// <param name="versionsId">Part of `name`. See documentation of `appsId`.</param>
		...
		public async Task<Instance> Appengine_apps_services_versions_instances_getAsync(string appsId, string servicesId, string versionsId, string instancesId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Instance>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_services_versions_instances_debug v1/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}:debug
		/// </summary>
		/// <param name="appsId">Part of `name`. Name of the resource requested. Example: apps/myapp/services/default/versions/v1/instances/instance-1.</param>
		/// <param name="servicesId">Part of `name`. See documentation of `appsId`.</param>
		/// <param name="versionsId">Part of `name`. See documentation of `appsId`.</param>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+"/services/"+ (servicesId==null? "" : System.Uri.EscapeDataString(servicesId))+"/versions/"+ (versionsId==null? "" : System.Uri.EscapeDataString(versionsId))+"/instances/"+ (instancesId==null? "" : System.Uri.EscapeDataString(instancesId))+":debug";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Appengine_apps_listRuntimes v1/apps/{appsId}:listRuntimes
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+":listRuntimes&environment=" + environment;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListRuntimesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Appengine_apps_repair v1/apps/{appsId}:repair
		/// </summary>
		...
		{
			var requestUri = "v1/apps/"+ (appsId==null? "" : System.Uri.EscapeDataString(appsId))+":repair";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
