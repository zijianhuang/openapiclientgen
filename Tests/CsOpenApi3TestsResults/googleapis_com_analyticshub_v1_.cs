...
namespace MyNS
{
	...
	public class DataExchange
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="sharingEnvironmentConfig")]
	...
	public class SharingEnvironmentConfig
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="dcrExchangeConfig")]
		public DcrExchangeConfig DcrExchangeConfig { get; set; }
		
		/// <summary>
		/// Default Analytics Hub data exchange, used for secured data sharing.
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="defaultExchangeConfig")]
		public DefaultExchangeConfig DefaultExchangeConfig { get; set; }
	}
	...
	public class ListSharedResourceSubscriptionsResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember(Name="sharedResourceSubscriptions")]
		public Subscription[] SharedResourceSubscriptions { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// Analyticshub_projects_locations_subscriptions_delete v1/{name}
		/// </summary>
		/// <param name="name">Required. Resource name of the subscription to delete. e.g. projects/123/locations/US/subscriptions/456</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Analyticshub_projects_locations_subscriptions_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Analyticshub_projects_locations_subscriptions_get v1/{name}
		/// </summary>
		/// <param name="name">Required. Resource name of the subscription. e.g. projects/123/locations/US/subscriptions/456</param>
		/// <returns>Successful response</returns>
		public async Task<Subscription> Analyticshub_projects_locations_subscriptions_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (name==null? "" : System.Uri.EscapeDataString(name));
		...
		/// Analyticshub_projects_locations_dataExchanges_listings_patch v1/{name}
		/// </summary>
		...
		public async Task<Listing> Analyticshub_projects_locations_dataExchanges_listings_patchAsync(string name, string updateMask, Listing requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<Listing>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Analyticshub_projects_locations_subscriptions_refresh v1/{name}:refresh
		/// </summary>
		/// <param name="name">Required. Resource name of the Subscription to refresh. e.g. `projects/subscriberproject/locations/US/subscriptions/123`</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Analyticshub_projects_locations_subscriptions_refreshAsync(string name, RefreshSubscriptionRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Analyticshub_projects_locations_subscriptions_revoke v1/{name}:revoke
		/// </summary>
		/// <param name="name">Required. Resource name of the subscription to revoke. e.g. projects/123/locations/US/subscriptions/456</param>
		/// <returns>Successful response</returns>
		public async Task<RevokeSubscriptionResponse> Analyticshub_projects_locations_subscriptions_revokeAsync(string name, RevokeSubscriptionRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<RevokeSubscriptionResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Analyticshub_projects_locations_dataExchanges_listings_subscribe v1/{name}:subscribe
		/// </summary>
		...
		public async Task<SubscribeListingResponse> Analyticshub_projects_locations_dataExchanges_listings_subscribeAsync(string name, SubscribeListingRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SubscribeListingResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Analyticshub_organizations_locations_dataExchanges_list v1/{organization}/dataExchanges
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (organization==null? "" : System.Uri.EscapeDataString(organization))+"/dataExchanges&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListOrgDataExchangesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Analyticshub_projects_locations_dataExchanges_list v1/{parent}/dataExchanges
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/dataExchanges&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListDataExchangesResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Analyticshub_projects_locations_dataExchanges_create v1/{parent}/dataExchanges
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/dataExchanges&dataExchangeId=" + (dataExchangeId==null? "" : System.Uri.EscapeDataString(dataExchangeId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DataExchange>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Analyticshub_projects_locations_dataExchanges_listings_list v1/{parent}/listings
		/// </summary>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/listings&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListListingsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Analyticshub_projects_locations_dataExchanges_listings_create v1/{parent}/listings
		/// </summary>
		/// <param name="parent">Required. The parent resource path of the listing. e.g. `projects/myproject/locations/US/dataExchanges/123`.</param>
		...
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/listings&listingId=" + (listingId==null? "" : System.Uri.EscapeDataString(listingId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Analyticshub_projects_locations_subscriptions_list v1/{parent}/subscriptions
		/// </summary>
		/// <param name="parent">Required. The parent resource path of the subscription. e.g. projects/myproject/locations/US</param>
		/// <param name="filter">The filter expression may be used to filter by Data Exchange or Listing.</param>
		/// <param name="pageSize">The maximum number of results to return in a single response page.</param>
		/// <param name="pageToken">Page token, returned by a previous call.</param>
		/// <returns>Successful response</returns>
		public async Task<ListSubscriptionsResponse> Analyticshub_projects_locations_subscriptions_listAsync(string parent, string filter, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/subscriptions&filter=" + (filter==null? "" : System.Uri.EscapeDataString(filter))+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// <summary>
		/// Gets the IAM policy.
		/// Analyticshub_projects_locations_subscriptions_getIamPolicy v1/{resource}:getIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Analyticshub_projects_locations_subscriptions_getIamPolicyAsync(string resource, GetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Analyticshub_projects_locations_dataExchanges_listings_listSubscriptions v1/{resource}:listSubscriptions
		/// </summary>
		/// <param name="resource">Required. Resource name of the requested target. This resource may be either a Listing or a DataExchange. e.g. projects/123/locations/US/dataExchanges/456 OR e.g. projects/123/locations/US/dataExchanges/456/listings/789</param>
		/// <param name="includeDeletedSubscriptions">If selected, includes deleted subscriptions in the response (up to 63 days after deletion).</param>
		/// <param name="pageSize">The maximum number of results to return in a single response page.</param>
		/// <param name="pageToken">Page token, returned by a previous call.</param>
		/// <returns>Successful response</returns>
		public async Task<ListSharedResourceSubscriptionsResponse> Analyticshub_projects_locations_dataExchanges_listings_listSubscriptionsAsync(string resource, bool includeDeletedSubscriptions, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1/"+ (resource==null? "" : System.Uri.EscapeDataString(resource))+":listSubscriptions&includeDeletedSubscriptions="+includeDeletedSubscriptions+"&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListSharedResourceSubscriptionsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// <summary>
		/// Sets the IAM policy.
		/// Analyticshub_projects_locations_subscriptions_setIamPolicy v1/{resource}:setIamPolicy
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Policy> Analyticshub_projects_locations_subscriptions_setIamPolicyAsync(string resource, SetIamPolicyRequest requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Analyticshub_projects_locations_dataExchanges_listings_testIamPermissions v1/{resource}:testIamPermissions
		/// </summary>
