...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="botId">The identifier of the bot that contains the session data.
		/// Min length: 10
		/// Max length: 10
		// </param>
		/// <param name="botAliasId">The alias identifier in use for the bot that contains the session data.</param>
		/// <param name="localeId">The locale where the session is in use.
		/// Min length: 1
		// </param>
		/// <param name="sessionId">The identifier of the session to delete.
		/// Min length: 2
		/// Max length: 100
		// </param>
		...
		/// Min length: 1
		// </param>
		/// <param name="sessionId">The identifier of the session to return.
		/// Min length: 2
		/// Max length: 100
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="botId">The identifier of the bot that receives the session data.
		/// Min length: 10
		/// Max length: 10
		// </param>
		...
		/// Min length: 1
		// </param>
		/// <param name="sessionId">The identifier of the session that receives the session data.
		/// Min length: 2
		/// Max length: 100
		// </param>
		/// <returns>Success</returns>
		public async Task<PutSessionResponse> PutSessionAsync(string botId, string botAliasId, string localeId, string sessionId, PutSessionPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<PutSessionResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="botId">The identifier of the bot that processes the request.
		/// Min length: 10
		/// Max length: 10
		// </param>
		...
		/// Min length: 1
		// </param>
		/// <param name="sessionId">The identifier of the user session that is having the conversation.
		/// Min length: 2
		/// Max length: 100
		// </param>
		/// <returns>Success</returns>
		public async Task<RecognizeTextResponse> RecognizeTextAsync(string botId, string botAliasId, string localeId, string sessionId, RecognizeTextPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<RecognizeTextResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="botId">The identifier of the bot that should receive the request.
		/// Min length: 10
		/// Max length: 10
		// </param>
		...
		/// Min length: 1
		// </param>
		/// <param name="sessionId">The identifier of the session in use.
		/// Min length: 2
		/// Max length: 100
		// </param>
		/// <returns>Success</returns>
		public async Task<RecognizeUtteranceResponse> RecognizeUtteranceAsync(string botId, string botAliasId, string localeId, string sessionId, RecognizeUtterancePostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<RecognizeUtteranceResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
