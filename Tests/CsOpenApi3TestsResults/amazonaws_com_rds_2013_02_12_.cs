...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_CopyDBSnapshotAsync(string SourceDBSnapshotIdentifier, string TargetDBSnapshotIdentifier, GET_CopyDBSnapshotAction Action, GET_CopyDBSnapshotVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=CopyDBSnapshot?SourceDBSnapshotIdentifier=" + (SourceDBSnapshotIdentifier==null? "" : System.Uri.EscapeDataString(SourceDBSnapshotIdentifier))+"&TargetDBSnapshotIdentifier=" + (TargetDBSnapshotIdentifier==null? "" : System.Uri.EscapeDataString(TargetDBSnapshotIdentifier))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_CreateDBParameterGroupAsync(string DBParameterGroupName, string DBParameterGroupFamily, string Description, GET_CreateDBParameterGroupAction Action, GET_CreateDBParameterGroupVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=CreateDBParameterGroup?DBParameterGroupName=" + (DBParameterGroupName==null? "" : System.Uri.EscapeDataString(DBParameterGroupName))+"&DBParameterGroupFamily=" + (DBParameterGroupFamily==null? "" : System.Uri.EscapeDataString(DBParameterGroupFamily))+"&Description=" + (Description==null? "" : System.Uri.EscapeDataString(Description))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_CreateDBSecurityGroupAsync(string DBSecurityGroupName, string DBSecurityGroupDescription, GET_CreateDBSecurityGroupAction Action, GET_CreateDBSecurityGroupVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=CreateDBSecurityGroup?DBSecurityGroupName=" + (DBSecurityGroupName==null? "" : System.Uri.EscapeDataString(DBSecurityGroupName))+"&DBSecurityGroupDescription=" + (DBSecurityGroupDescription==null? "" : System.Uri.EscapeDataString(DBSecurityGroupDescription))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_CreateDBSnapshotAsync(string DBSnapshotIdentifier, string DBInstanceIdentifier, GET_CreateDBSnapshotAction Action, GET_CreateDBSnapshotVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=CreateDBSnapshot?DBSnapshotIdentifier=" + (DBSnapshotIdentifier==null? "" : System.Uri.EscapeDataString(DBSnapshotIdentifier))+"&DBInstanceIdentifier=" + (DBInstanceIdentifier==null? "" : System.Uri.EscapeDataString(DBInstanceIdentifier))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_CreateDBSubnetGroupAsync(string DBSubnetGroupName, string DBSubnetGroupDescription, string[] SubnetIds, GET_CreateDBSubnetGroupAction Action, GET_CreateDBSubnetGroupVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_CreateEventSubscriptionAsync(string SubscriptionName, string SnsTopicArn, string SourceType, string[] EventCategories, string[] SourceIds, bool Enabled, GET_CreateEventSubscriptionAction Action, GET_CreateEventSubscriptionVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=CreateEventSubscription?SubscriptionName=" + (SubscriptionName==null? "" : System.Uri.EscapeDataString(SubscriptionName))+"&SnsTopicArn=" + (SnsTopicArn==null? "" : System.Uri.EscapeDataString(SnsTopicArn))+"&SourceType=" + (SourceType==null? "" : System.Uri.EscapeDataString(SourceType))+"&"+string.Join("&", EventCategories.Select(z => $"EventCategories={System.Uri.EscapeDataString(z.ToString())}"))+"&"+string.Join("&", SourceIds.Select(z => $"SourceIds={System.Uri.EscapeDataString(z.ToString())}"))+"&Enabled="+Enabled+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_CreateOptionGroupAsync(string OptionGroupName, string EngineName, string MajorEngineVersion, string OptionGroupDescription, GET_CreateOptionGroupAction Action, GET_CreateOptionGroupVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=CreateOptionGroup?OptionGroupName=" + (OptionGroupName==null? "" : System.Uri.EscapeDataString(OptionGroupName))+"&EngineName=" + (EngineName==null? "" : System.Uri.EscapeDataString(EngineName))+"&MajorEngineVersion=" + (MajorEngineVersion==null? "" : System.Uri.EscapeDataString(MajorEngineVersion))+"&OptionGroupDescription=" + (OptionGroupDescription==null? "" : System.Uri.EscapeDataString(OptionGroupDescription))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeDBEngineVersionsAsync(string Engine, string EngineVersion, string DBParameterGroupFamily, int MaxRecords, string Marker, bool DefaultOnly, bool ListSupportedCharacterSets, GET_DescribeDBEngineVersionsAction Action, GET_DescribeDBEngineVersionsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeDBEngineVersions?Engine=" + (Engine==null? "" : System.Uri.EscapeDataString(Engine))+"&EngineVersion=" + (EngineVersion==null? "" : System.Uri.EscapeDataString(EngineVersion))+"&DBParameterGroupFamily=" + (DBParameterGroupFamily==null? "" : System.Uri.EscapeDataString(DBParameterGroupFamily))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&DefaultOnly="+DefaultOnly+"&ListSupportedCharacterSets="+ListSupportedCharacterSets+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeDBInstancesAsync(string DBInstanceIdentifier, int MaxRecords, string Marker, GET_DescribeDBInstancesAction Action, GET_DescribeDBInstancesVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeDBInstances?DBInstanceIdentifier=" + (DBInstanceIdentifier==null? "" : System.Uri.EscapeDataString(DBInstanceIdentifier))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeDBLogFilesAsync(string DBInstanceIdentifier, string FilenameContains, int FileLastWritten, int FileSize, int MaxRecords, string Marker, GET_DescribeDBLogFilesAction Action, GET_DescribeDBLogFilesVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeDBLogFiles?DBInstanceIdentifier=" + (DBInstanceIdentifier==null? "" : System.Uri.EscapeDataString(DBInstanceIdentifier))+"&FilenameContains=" + (FilenameContains==null? "" : System.Uri.EscapeDataString(FilenameContains))+"&FileLastWritten="+FileLastWritten+"&FileSize="+FileSize+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeDBParameterGroupsAsync(string DBParameterGroupName, int MaxRecords, string Marker, GET_DescribeDBParameterGroupsAction Action, GET_DescribeDBParameterGroupsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeDBParameterGroups?DBParameterGroupName=" + (DBParameterGroupName==null? "" : System.Uri.EscapeDataString(DBParameterGroupName))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeDBParametersAsync(string DBParameterGroupName, string Source, int MaxRecords, string Marker, GET_DescribeDBParametersAction Action, GET_DescribeDBParametersVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeDBParameters?DBParameterGroupName=" + (DBParameterGroupName==null? "" : System.Uri.EscapeDataString(DBParameterGroupName))+"&Source=" + (Source==null? "" : System.Uri.EscapeDataString(Source))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeDBSecurityGroupsAsync(string DBSecurityGroupName, int MaxRecords, string Marker, GET_DescribeDBSecurityGroupsAction Action, GET_DescribeDBSecurityGroupsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeDBSecurityGroups?DBSecurityGroupName=" + (DBSecurityGroupName==null? "" : System.Uri.EscapeDataString(DBSecurityGroupName))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeDBSnapshotsAsync(string DBInstanceIdentifier, string DBSnapshotIdentifier, string SnapshotType, int MaxRecords, string Marker, GET_DescribeDBSnapshotsAction Action, GET_DescribeDBSnapshotsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeDBSubnetGroupsAsync(string DBSubnetGroupName, int MaxRecords, string Marker, GET_DescribeDBSubnetGroupsAction Action, GET_DescribeDBSubnetGroupsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeDBSubnetGroups?DBSubnetGroupName=" + (DBSubnetGroupName==null? "" : System.Uri.EscapeDataString(DBSubnetGroupName))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeEngineDefaultParametersAsync(string DBParameterGroupFamily, int MaxRecords, string Marker, GET_DescribeEngineDefaultParametersAction Action, GET_DescribeEngineDefaultParametersVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeEngineDefaultParameters?DBParameterGroupFamily=" + (DBParameterGroupFamily==null? "" : System.Uri.EscapeDataString(DBParameterGroupFamily))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeEventSubscriptionsAsync(string SubscriptionName, int MaxRecords, string Marker, GET_DescribeEventSubscriptionsAction Action, GET_DescribeEventSubscriptionsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeEventSubscriptions?SubscriptionName=" + (SubscriptionName==null? "" : System.Uri.EscapeDataString(SubscriptionName))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeEventsAsync(string SourceIdentifier, GET_DescribeEventsSourceType SourceType, System.DateTimeOffset StartTime, System.DateTimeOffset EndTime, int Duration, string[] EventCategories, int MaxRecords, string Marker, GET_DescribeEventsAction Action, GET_DescribeEventsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeEvents?SourceIdentifier=" + (SourceIdentifier==null? "" : System.Uri.EscapeDataString(SourceIdentifier))+"&SourceType=" + SourceType+"&StartTime=" + StartTime.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss.fffffffZ")+"&EndTime=" + EndTime.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss.fffffffZ")+"&Duration="+Duration+"&"+string.Join("&", EventCategories.Select(z => $"EventCategories={System.Uri.EscapeDataString(z.ToString())}"))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeOptionGroupOptionsAsync(string EngineName, string MajorEngineVersion, int MaxRecords, string Marker, GET_DescribeOptionGroupOptionsAction Action, GET_DescribeOptionGroupOptionsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeOptionGroupOptions?EngineName=" + (EngineName==null? "" : System.Uri.EscapeDataString(EngineName))+"&MajorEngineVersion=" + (MajorEngineVersion==null? "" : System.Uri.EscapeDataString(MajorEngineVersion))+"&MaxRecords="+MaxRecords+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeOptionGroupsAsync(string OptionGroupName, string Marker, int MaxRecords, string EngineName, string MajorEngineVersion, GET_DescribeOptionGroupsAction Action, GET_DescribeOptionGroupsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=DescribeOptionGroups?OptionGroupName=" + (OptionGroupName==null? "" : System.Uri.EscapeDataString(OptionGroupName))+"&Marker=" + (Marker==null? "" : System.Uri.EscapeDataString(Marker))+"&MaxRecords="+MaxRecords+"&EngineName=" + (EngineName==null? "" : System.Uri.EscapeDataString(EngineName))+"&MajorEngineVersion=" + (MajorEngineVersion==null? "" : System.Uri.EscapeDataString(MajorEngineVersion))+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_DescribeReservedDBInstancesOfferingsAsync(string ReservedDBInstancesOfferingId, string DBInstanceClass, string Duration, string ProductDescription, string OfferingType, bool MultiAZ, int MaxRecords, string Marker, GET_DescribeReservedDBInstancesOfferingsAction Action, GET_DescribeReservedDBInstancesOfferingsVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// </summary>
		/// <returns>Success</returns>
		public async Task GET_PurchaseReservedDBInstancesOfferingAsync(string ReservedDBInstancesOfferingId, string ReservedDBInstanceId, int DBInstanceCount, GET_PurchaseReservedDBInstancesOfferingAction Action, GET_PurchaseReservedDBInstancesOfferingVersion Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "#Action=PurchaseReservedDBInstancesOffering?ReservedDBInstancesOfferingId=" + (ReservedDBInstancesOfferingId==null? "" : System.Uri.EscapeDataString(ReservedDBInstancesOfferingId))+"&ReservedDBInstanceId=" + (ReservedDBInstanceId==null? "" : System.Uri.EscapeDataString(ReservedDBInstanceId))+"&DBInstanceCount="+DBInstanceCount+"&Action=" + Action+"&Version=" + Version;
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
	...
	public enum GET_AddSourceIdentifierToSubscriptionVersion
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute(Value="2013-02-12")]
		_2013Minus02Minus12 = 0,
	}
