...
namespace MyNS
{
	...
	public class ListConnectionsResponse
	{
		...
		public GoogleCloudServicenetworkingV1betaConnection[] Connections { get; set; }
	}
	...
	public partial class Misc
	{
		...
		/// Servicenetworking_operations_get v1beta/{name}
		/// </summary>
		/// <param name="name">The name of the operation resource.</param>
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicenetworking_operations_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Servicenetworking_services_updateConnections v1beta/{name}/connections
		/// </summary>
		/// <param name="name">The service producer peering service that is managing peering connectivity for a service producer organization. For Google services that support this functionality, this is `services/servicenetworking.googleapis.com`.</param>
		...
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicenetworking_services_updateConnectionsAsync(string name, bool force, string updateMask, GoogleCloudServicenetworkingV1betaConnection requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta/"+ (name==null? "" : System.Uri.EscapeDataString(name))+"/connections&force="+force+"&updateMask=" + (updateMask==null? "" : System.Uri.EscapeDataString(updateMask));
		...
		/// Servicenetworking_services_connections_list v1beta/{parent}/connections
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/connections&network=" + (network==null? "" : System.Uri.EscapeDataString(network));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Servicenetworking_services_connections_create v1beta/{parent}/connections
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<Operation> Servicenetworking_services_connections_createAsync(string parent, GoogleCloudServicenetworkingV1betaConnection requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/connections";
		...
		/// Servicenetworking_services_addSubnetwork v1beta/{parent}:addSubnetwork
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":addSubnetwork";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Servicenetworking_services_searchRange v1beta/{parent}:searchRange
		/// </summary>
		...
		{
			var requestUri = "v1beta/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":searchRange";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
