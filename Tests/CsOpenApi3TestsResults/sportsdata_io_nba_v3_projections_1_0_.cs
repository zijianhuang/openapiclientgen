...
namespace MyNS
{
	...
	public class Lineup
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Boolean> Starting { get; set; }
	...
	public partial class Misc
	{
		...
		public async Task<TeamDepthChart[]> DepthChartsAsync(DepthChartsFormat format, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<DfsSlate[]> DfsSlatesByDateAsync(DepthChartsFormat format, string date, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		public async Task<Player[]> InjuredPlayersAsync(DepthChartsFormat format, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="date">The date of the game(s). <br>Examples: <code>2015-JUL-31</code>, <code>2015-SEP-01</code>.</param>
		public async Task<PlayerGameProjection[]> ProjectedPlayerGameStatsByDateWInjuriesDfsSalariesAsync(DepthChartsFormat format, string date, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<PlayerGameProjection> ProjectedPlayerGameStatsByPlayerWInjuriesDfsSalariesAsync(DepthChartsFormat format, string date, string playerid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// ProjectedPlayerSeasonStats {format}/PlayerSeasonProjectionStats/{season}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season (with optional season type).<br>Examples: <code>2018</code>, <code>2019</code>, etc.</param>
		public async Task<PlayerSeasonProjection[]> ProjectedPlayerSeasonStatsAsync(DepthChartsFormat format, string season, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// ProjectedPlayerSeasonStatsByPlayer {format}/PlayerSeasonProjectionStatsByPlayer/{season}/{playerid}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season (with optional season type).<br>Examples: <code>2018</code>, <code>2019</code>, etc.</param>
		/// <param name="playerid">Unique FantasyData Player ID. Example:<code>20000571</code>.</param>
		public async Task<PlayerSeasonProjection> ProjectedPlayerSeasonStatsByPlayerAsync(DepthChartsFormat format, string season, string playerid, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/PlayerSeasonProjectionStatsByPlayer/"+ (season==null? "" : System.Uri.EscapeDataString(season))+"/"+ (playerid==null? "" : System.Uri.EscapeDataString(playerid));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// ProjectedPlayerSeasonStatsByTeam {format}/PlayerSeasonProjectionStatsByTeam/{season}/{team}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="season">Year of the season (with optional season type).<br>Examples: <code>2018</code>, <code>2019</code>, etc.</param>
		/// <param name="team">The abbreviation of the requested team.
		///<br>Examples: <code>MIA</code>, <code>PHI</code>.</param>
		public async Task<PlayerSeasonProjection[]> ProjectedPlayerSeasonStatsByTeamAsync(DepthChartsFormat format, string season, string team, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// StartingLineupsByDate {format}/StartingLineupsByDate/{date}
		/// </summary>
		/// <param name="format">Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.</param>
		/// <param name="date">The date of the game(s). <br> Examples: <code>2021-OCT-12</code>, <code>2021-DEC-09</code>.</param>
		public async Task<StartingLineups[]> StartingLineupsByDateAsync(DepthChartsFormat format, string date, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = ""+format+"/StartingLineupsByDate/"+ (date==null? "" : System.Uri.EscapeDataString(date));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<StartingLineups[]>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
