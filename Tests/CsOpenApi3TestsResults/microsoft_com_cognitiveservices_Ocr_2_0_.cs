...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task BatchReadFileAsync(ImageUrl requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<ReadOperationResult> GetReadOperationResultAsync(string operationId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// <param name="requestBody">A JSON document with a URL pointing to the image that is to be analyzed.</param>
		public async Task RecognizeTextAsync(RecognizeTextMode mode, ImageUrl requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		public async Task<TextOperationResult> GetTextOperationResultAsync(string operationId, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
