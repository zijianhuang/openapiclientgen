...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		public async Task PhcerAsync(PhcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "phcer/certificate";
		...
		/// Rpcer rpcer/certificate
		/// </summary>
		/// <param name="requestBody">Request format</param>
		/// <returns>The certificate data in response body in PDF, XML or JSON format as requested in format parameter.</returns>
		public async Task RpcerAsync(RpcerPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "rpcer/certificate";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
	...
	public class PhcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public PhcerPostBodyCertificateParameters CertificateParameters { get; set; }
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember(Name="format")]
		public PhcerPostBodyFormat Format { get; set; }
	...
	public class PhcerPostBodyCertificateParameters
	{
	...
	[System.Runtime.Serialization.DataContract(Namespace="http://fonlow.com/TestOpenApi/2024/04")]
	public enum PhcerPostBodyFormat
	{
	...
	public class RpcerPostBody
	{
		
		[System.Runtime.Serialization.DataMember(Name="certificateParameters")]
		public RpcerPostBodyCertificateParameters CertificateParameters { get; set; }
	...
	public class RpcerPostBodyCertificateParameters
	{
