...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// <summary>
		/// Deletes a Secret.
		/// Secretmanager_projects_secrets_delete v1beta1/{name}
		/// </summary>
		/// <param name="name">Required. The resource name of the Secret to delete in the format `projects/*/secrets/*`.</param>
		/// <returns>Successful response</returns>
		public async Task<Empty> Secretmanager_projects_secrets_deleteAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// Secretmanager_projects_secrets_versions_get v1beta1/{name}
		/// </summary>
		/// <param name="name">Required. The resource name of the SecretVersion in the format `projects/*/secrets/*/versions/*`. `projects/*/secrets/*/versions/latest` is an alias to the `latest` SecretVersion.</param>
		/// <returns>Successful response</returns>
		public async Task<SecretVersion> Secretmanager_projects_secrets_versions_getAsync(string name, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<SecretVersion>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Secretmanager_projects_secrets_patch v1beta1/{name}
		/// </summary>
		...
		/// Secretmanager_projects_locations_list v1beta1/{name}/locations
		/// </summary>
		...
		/// Secretmanager_projects_secrets_versions_access v1beta1/{name}:access
		/// </summary>
		/// <param name="name">Required. The resource name of the SecretVersion in the format `projects/*/secrets/*/versions/*`.</param>
		/// <returns>Successful response</returns>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":access";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<AccessSecretVersionResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Secretmanager_projects_secrets_versions_destroy v1beta1/{name}:destroy
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (name==null? "" : System.Uri.EscapeDataString(name))+":destroy";
		...
		/// Secretmanager_projects_secrets_versions_disable v1beta1/{name}:disable
		/// </summary>
		...
		/// Secretmanager_projects_secrets_versions_enable v1beta1/{name}:enable
		/// </summary>
		...
		/// <summary>
		/// Lists Secrets.
		/// Secretmanager_projects_secrets_list v1beta1/{parent}/secrets
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListSecretsResponse> Secretmanager_projects_secrets_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/secrets&pageSize="+pageSize+"&pageToken=" + (pageToken==null? "" : System.Uri.EscapeDataString(pageToken));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Get, requestUri);
			if (handleHeaders != null)
			{
				handleHeaders(httpRequestMessage.Headers);
		...
		/// Secretmanager_projects_secrets_create v1beta1/{parent}/secrets
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+"/secrets&secretId=" + (secretId==null? "" : System.Uri.EscapeDataString(secretId));
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Secretmanager_projects_secrets_versions_list v1beta1/{parent}/versions
		/// </summary>
		...
		/// <returns>Successful response</returns>
		public async Task<ListSecretVersionsResponse> Secretmanager_projects_secrets_versions_listAsync(string parent, int pageSize, string pageToken, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListSecretVersionsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// Secretmanager_projects_secrets_addVersion v1beta1/{parent}:addVersion
		/// </summary>
		...
		{
			var requestUri = "v1beta1/"+ (parent==null? "" : System.Uri.EscapeDataString(parent))+":addVersion";
			using var httpRequestMessage = new System.Net.Http.HttpRequestMessage(System.Net.Http.HttpMethod.Post, requestUri);
			var content = System.Net.Http.Json.JsonContent.Create(requestBody, mediaType: null, jsonSerializerSettings);
			httpRequestMessage.Content = content;
			if (handleHeaders != null)
		...
		/// Secretmanager_projects_secrets_getIamPolicy v1beta1/{resource}:getIamPolicy
		/// </summary>
		...
		/// Secretmanager_projects_secrets_setIamPolicy v1beta1/{resource}:setIamPolicy
		/// </summary>
		...
		/// Secretmanager_projects_secrets_testIamPermissions v1beta1/{resource}:testIamPermissions
		/// </summary>
