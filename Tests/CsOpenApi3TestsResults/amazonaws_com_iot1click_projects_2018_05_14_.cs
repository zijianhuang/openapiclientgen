...
namespace MyNS
{
	...
	public partial class Misc
	{
		...
		/// </summary>
		/// <param name="projectName">The name of the project containing the placement in which to associate the device.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="placementName">The name of the placement in which to associate the device.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="deviceTemplateName">The device template name to associate with the device ID.
		/// Min length: 1
		/// Max length: 128
		// </param>
		...
		public async Task<AssociateDeviceWithPlacementResponse> AssociateDeviceWithPlacementAsync(string projectName, string placementName, string deviceTemplateName, AssociateDeviceWithPlacementPutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				...
				return JsonSerializer.Deserialize<AssociateDeviceWithPlacementResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
		...
		/// </summary>
		/// <param name="projectName">The name of the project that contains the placement.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="placementName">The name of the placement that the device should be removed from.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="deviceTemplateName">The device ID that should be removed from the placement.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		public async Task<DisassociateDeviceFromPlacementResponse> DisassociateDeviceFromPlacementAsync(string projectName, string placementName, string deviceTemplateName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DisassociateDeviceFromPlacementResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="projectName">The name of the project in which to create the placement.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		public async Task<CreatePlacementResponse> CreatePlacementAsync(string projectName, CreatePlacementPostBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<CreatePlacementResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="projectName">The project containing the placements to be listed.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="nextToken">The token to retrieve the next set of results.
		/// Min length: 1
		/// Max length: 1024
		// </param>
		/// <param name="maxResults">The maximum number of results to return per request. If not set, a default value of 100 is used.
		/// Minimum: 1
		/// Maximum: 250
		// </param>
		/// <returns>Success</returns>
		public async Task<ListPlacementsResponse> ListPlacementsAsync(string projectName, string nextToken, int maxResults, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<ListPlacementsResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="placementName">The name of the empty placement to delete.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="projectName">The project containing the empty placement to delete.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		public async Task<DeletePlacementResponse> DeletePlacementAsync(string placementName, string projectName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DeletePlacementResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="placementName">The name of the placement within a project.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="projectName">The project containing the placement to be described.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		public async Task<DescribePlacementResponse> DescribePlacementAsync(string placementName, string projectName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<DescribePlacementResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="placementName">The name of the placement to update.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="projectName">The name of the project containing the placement to be updated.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		public async Task<UpdatePlacementResponse> UpdatePlacementAsync(string placementName, string projectName, UpdatePlacementPutBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<UpdatePlacementResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
		...
		/// </summary>
		/// <param name="projectName">The name of the empty project to delete.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="projectName">The name of the project to be described.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="projectName">The name of the project to be updated.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		...
		/// </summary>
		/// <param name="projectName">The name of the project containing the placement.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <param name="placementName">The name of the placement to get the devices from.
		/// Min length: 1
		/// Max length: 128
		// </param>
		/// <returns>Success</returns>
		public async Task<GetDevicesInPlacementResponse> GetDevicesInPlacementAsync(string projectName, string placementName, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			...
			try
			{
				responseMessage.EnsureSuccessStatusCodeEx();
				var streamContent = await responseMessage.Content.ReadAsStreamAsync();
				return JsonSerializer.Deserialize<GetDevicesInPlacementResponse>(streamContent, jsonSerializerSettings);
			}
			finally
			{
				responseMessage.Dispose();
