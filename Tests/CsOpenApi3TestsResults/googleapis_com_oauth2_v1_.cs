...
namespace MyNS
{
	...
	public class Tokeninfo
	{
		...
		public System.Nullable<System.Int32> Issued_at { get; set; }
	...
	public partial class Misc
	{
		...
		/// <summary>
		/// Get token info
		/// Oauth2_tokeninfo oauth2/v1/tokeninfo
		/// </summary>
		/// <param name="access_token">The oauth2 access token</param>
		...
		{
			var requestUri = "oauth2/v1/tokeninfo?access_token=" + (access_token==null? "" : System.Uri.EscapeDataString(access_token))+"&id_token=" + (id_token==null? "" : System.Uri.EscapeDataString(id_token));
			...
			try
			{
				...
				return JsonSerializer.Deserialize<Tokeninfo>(streamContent, jsonSerializerSettings);
			}
			finally
			{
