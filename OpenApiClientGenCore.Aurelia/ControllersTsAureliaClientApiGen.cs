...
namespace Fonlow.CodeDom.Web.Ts
{
	...
	public class ControllersTsAureliaClientApiGen : ControllersTsClientApiGenBase
	{
		...
		public ControllersTsAureliaClientApiGen(ISettings settings, JSOutput jsOutput) : base(settings, jsOutput, () => new ClientApiTsAureliaFunctionGen(settings, jsOutput))
		{
		}
